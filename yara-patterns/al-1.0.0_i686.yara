...
rule pthread_attr_destroy_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		size = "3"
		objfiles = "wcsftime@libc.a, mutex@libpthread.a, clnt_raw@libc.a, condvar@libpthread.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule endprotoent_f468964b8937d2560c1930edef041633 {
	meta:
		...
		size = "92"
		objfiles = "getnetent@libc.a, getproto@libc.a"
	strings:
...
rule gamma_r_dcd2577c0ed36bc9168a2bfe155bb6fa {
	meta:
...
rule __gcov_flush_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		size = "5"
		objfiles = "_clear_cache@libgcc.a, _enable_execute_stack@libgcc.a, _gcov_merge_add@libgcov.a, _gcov@libgcov.a, _gcov_merge_delta@libgcov.a"
	strings:
...
rule thread_self_ff5ff5468472ed8724cee51a9db2fab4 {
	meta:
		...
		size = "68"
		objfiles = "mutex@libpthread.a, spinlock@libpthread.a, signals@libpthread.a, condvar@libpthread.a, errno@libpthread.a"
	strings:
...
rule __libc_fcntl_f9446f0ba6865ef36141367a0e4d0af5 {
	meta:
...
rule fileno_d1aff121aa302794d76ffd1091af3fc3 {
	meta:
...
rule fputs_656d0461fb753b5b2210fd391d402010 {
	meta:
...
rule nearbyint_43d14f09cd1937d3c6566890fcfbdbc4 {
	meta:
...
rule __libc_read_2be93fe5a4927a92aea2ff27d46d36a5 {
	meta:
...
rule __libc_waitpid_94d3925005c9f6c3778188d300b054a5 {
	meta:
		...
		size = "26"
		objfiles = "wcstoull@libc.a, strtoull@libc.a, strtoul@libc.a, wcstoul@libc.a, waitpid@libc.a"
	strings:
...
rule hcreate_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		...
		size = "21"
		objfiles = "srand48@libc.a, hsearch@libc.a, inet_ntoa@libc.a, ether_addr@libc.a, asctime@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "spinlock@libpthread.a, manager@libpthread.a, condvar@libpthread.a, semaphore@libpthread.a, pthread@libpthread.a"
	strings:
...
rule __pthread_once_fork_prepare_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		...
		size = "17"
		objfiles = "getlogin@libc.a, hsearch@libc.a, mutex@libpthread.a, _flushlbf@libc.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		size = "30"
		objfiles = "sscanf@libc.a, asprintf@libc.a, swscanf@libc.a, fwscanf@libc.a, syslog@libc.a"
	strings:
...
rule ilogbf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		size = "19"
		objfiles = "ilogbf@libm.a, llroundf@libm.a, lrintf@libm.a, lroundf@libm.a, llrintf@libm.a"
	strings:
...
rule acosf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		size = "27"
		objfiles = "erff@libm.a, expf@libm.a, log2f@libm.a, roundf@libm.a, sinhf@libm.a"
	strings:
...
rule atan2f_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		size = "35"
		objfiles = "scalbf@libm.a, remainderf@libm.a, powf@libm.a, hypotf@libm.a, atan2f@libm.a"
	strings:
...
rule getgrnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		size = "40"
		objfiles = "fgetgrent@libc.a, getspnam@libc.a, sgetspent@libc.a, fgetpwent@libc.a, getgrgid@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		aliases = "__i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx"
		size = "4"
		objfiles = "_fixunsxfdi@libgcc.a, _fixunssfsi@libgcc.a, unwind_sjlj@libgcc_eh.a, _fixunsdfdi@libgcc.a, _fixunssfdi@libgcc.a"
	strings:
...
rule __get_pc_thunk_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		size = "4"
		objfiles = "_addvsi3@libgcc.a, _divsc3@libgcc.a, _popcountsi2@libgcc.a, _fixsfdi@libgcc.a, _negvdi2@libgcc.a"
	strings:
...
rule floatformat_always_valid_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		size = "6"
		objfiles = "xdr@libc.a, floatformat@libiberty.a, _stdlib_mb_cur_max@libc.a, oldsemaphore@libpthread.a, auth_none@libc.a"
	strings:
