...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "clnt_raw@libc.a, grantpt@libc.a, mutex@libpthread.a, xdr_stdio@libc.a, wcsftime@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule fabs_471b6b283f2125caeaf21fe2cb9bce5d {
	meta:
...
rule isnan_a3058c025a33bf28be8c671cddf6ddc1 {
	meta:
...
rule pex_unix_cleanup_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_enable_execute_stack@libgcc.a, hex@libiberty.a, _gcov@libgcov.a, _gcov_merge_single@libgcov.a, _gcov_merge_add@libgcov.a"
	strings:
...
rule uname_7e66b1637da67ceef6bb5036a6a72cd1 {
	meta:
...
rule wcstouq_94d3925005c9f6c3778188d300b054a5 {
	meta:
		...
		type = "func"
		size = "26"
		objfiles = "strtoull@libc.a, waitpid@libc.a, wcstoull@libc.a, strtoul@libc.a, wcstoul@libc.a"
	strings:
...
rule srand48_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		...
		type = "func"
		size = "21"
		objfiles = "srand48@libc.a, hsearch@libc.a, inet_ntoa@libc.a, asctime@libc.a, ether_addr@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "manager@libpthread.a, pthread@libpthread.a, semaphore@libpthread.a, join@libpthread.a, condvar@libpthread.a"
	strings:
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		type = "func"
		size = "19"
		objfiles = "lrintf@libm.a, ilogbf@libm.a, lroundf@libm.a, llroundf@libm.a, llrintf@libm.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "atanhf@libm.a, cosf@libm.a, rintf@libm.a, expm1f@libm.a, atanf@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "fmodf@libm.a, powf@libm.a, copysignf@libm.a, remainderf@libm.a, atan2f@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "fgetpwent@libc.a, getgrgid@libc.a, getpwnam@libc.a, getpwuid@libc.a, getspnam@libc.a"
	strings:
...
rule thread_self_e74c8f77ff3f89dbea0e2d9a5b4c5494 {
	meta:
		...
		type = "func"
		size = "63"
		objfiles = "pthread@libpthread.a, mutex@libpthread.a, errno@libpthread.a, semaphore@libpthread.a, join@libpthread.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "clnt_raw@libc.a, xdr_mem@libc.a, pthread@libpthread.a, clnt_unix@libc.a, nsl@libnsl.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "mq_close@librt.a, w_jn@libm.a, w_atan2@libm.a, mntent@libc.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
