...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "attr@libpthread.a, auth_none@libc.a, rwlock@libpthread.a, clnt_raw@libc.a, svc_auth@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "gthr_gnat@libgcc_eh.a, _gcov_merge_delta@libgcov.a, _gcov_merge_add@libgcov.a, _gcov_merge_single@libgcov.a, _enable_execute_stack@libgcc.a"
	strings:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "specific@libpthread.a, semaphore@libpthread.a, signals@libpthread.a, spinlock@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule wcstouq_94d3925005c9f6c3778188d300b054a5 {
	meta:
		...
		type = "func"
		size = "26"
		objfiles = "strtoull@libc.a, waitpid@libc.a, wcstoul@libc.a, wcstoull@libc.a, strtoul@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "semaphore@libpthread.a, spinlock@libpthread.a, rwlock@libpthread.a, join@libpthread.a, manager@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "dprintf@libc.a, fprintf@libc.a, asprintf@libc.a, fscanf@libc.a, swscanf@libc.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "cosf@libm.a, coshf@libm.a, atanf@libm.a, sqrtf@libm.a, erfcf@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "atan2f@libm.a, copysignf@libm.a, nextafterf@libm.a, hypotf@libm.a, fmodf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "getgrgid@libc.a, getspnam@libc.a, fgetgrent@libc.a, sgetspent@libc.a, fgetpwent@libc.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "resolv@libresolv.a, events@libpthread.a, clnt_udp@libc.a, clnt_unix@libc.a, signals@libpthread.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "s_nearbyint@libm.a, w_hypot@libm.a, w_log10@libm.a, mq_close@librt.a, w_atan2@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
