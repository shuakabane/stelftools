...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "unwind_sjlj@libgcc.a, _udiv_w_sdiv@libgcc.a, svc_auth@libc.a, mutex@libpthread.a, grantpt@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule thread_self_fc567cf57d3f04fc77b3c53a5a9fe529 {
	meta:
		...
		type = "func"
		size = "69"
		objfiles = "mutex@libpthread.a, errno@libpthread.a, condvar@libpthread.a, rwlock@libpthread.a, specific@libpthread.a"
	strings:
...
rule syslog_4f17e5776fd93321a6b366d662782192 {
	meta:
		...
		type = "func"
		size = "142"
		objfiles = "swscanf@libc.a, dprintf@libc.a, syslog@libc.a, asprintf@libc.a, fscanf@libc.a"
	strings:
...
rule sgetspent_5abd21e9b7de4fda56e36ae3f07cbf5b {
	meta:
		...
		type = "func"
		size = "39"
		objfiles = "fgetgrent@libc.a, getpwuid@libc.a, fgetpwent@libc.a, getspnam@libc.a, fgetspent@libc.a"
	strings:
...
rule srand48_aedd30f4a92f36ce8e0b990c7b4f97a2 {
	meta:
		...
		type = "func"
		size = "10"
		objfiles = "asctime@libc.a, hsearch@libc.a, inet_ntoa@libc.a, ether_addr@libc.a, srand48@libc.a"
	strings:
		$pattern = { ( CC | BE ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule lgamma_8c47b9c6008fc75a3442b25215b4f0fe {
	meta:
		...
		type = "func"
		size = "10"
		objfiles = "mutex@libpthread.a, e_lgamma@libm.a, e_gamma@libm.a, w_lgamma@libm.a, getlogin@libc.a"
	strings:
		$pattern = { ( CC | BF ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "svc_raw@libc.a, noophooks@libc.a, lckpwdf@libc.a, nsl@libnsl.a, xdr_mem@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule truncf_76fb52706816ef3df3c8d6c20b0aa675 {
	meta:
		...
		type = "func"
		size = "19"
		objfiles = "asinhf@libm.a, tanf@libm.a, erfcf@libm.a, asinf@libm.a, cbrtf@libm.a"
	strings:
...
rule lroundf_d3b5b767a0285b8ef7c579a0959a22b2 {
	meta:
		...
		type = "func"
		size = "9"
		objfiles = "ilogbf@libm.a, lroundf@libm.a, llrintf@libm.a, llroundf@libm.a, lrintf@libm.a"
	strings:
...
rule remainderf_b655e1a82b86ef778f64370fab64b292 {
	meta:
		...
		type = "func"
		size = "23"
		objfiles = "remainderf@libm.a, nextafterf@libm.a, copysignf@libm.a, powf@libm.a, fmodf@libm.a"
	strings:
...
rule __gnat_default_unlock_32a093eff127b3eedaa06c147dc0694b {
	meta:
		...
		type = "func"
		size = "2"
		objfiles = "gthr_gnat@libgcc.a, _gcov_merge_add@libgcov.a, _gcov_merge_delta@libgcov.a, _gcov_merge_single@libgcov.a, _gcov@libgcov.a"
	strings:
		$pattern = { ( CC | F3 ) C3 }
	condition:
		$pattern
