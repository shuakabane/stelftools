...
rule pthread_attr_destroy_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		size = "3"
		objfiles = "svc_auth@libc.a, auth_none@libc.a, mutex@libpthread.a, wcsftime@libc.a, rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __gcov_flush_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		size = "5"
		objfiles = "_gcov_merge_single@libgcov.a, _gcov_merge_add@libgcov.a, _gcov_merge_delta@libgcov.a, _clear_cache@libgcc.a, gthr_gnat@libgcc_eh.a"
	strings:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		...
		size = "68"
		objfiles = "signals@libpthread.a, mutex@libpthread.a, join@libpthread.a, rwlock@libpthread.a, errno@libpthread.a"
	strings:
...
rule hcreate_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		...
		size = "21"
		objfiles = "srand48@libc.a, ether_addr@libc.a, inet_ntoa@libc.a, asctime@libc.a, hsearch@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "join@libpthread.a, rwlock@libpthread.a, manager@libpthread.a, pthread@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		size = "30"
		objfiles = "fwscanf@libc.a, fscanf@libc.a, dprintf@libc.a, fprintf@libc.a, asprintf@libc.a"
	strings:
...
rule acosf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		size = "27"
		objfiles = "tgammaf@libm.a, ceilf@libm.a, asinf@libm.a, roundf@libm.a, atanf@libm.a"
	strings:
...
rule atan2f_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		size = "35"
		objfiles = "copysignf@libm.a, powf@libm.a, nextafterf@libm.a, hypotf@libm.a, fmodf@libm.a"
	strings:
...
rule getgrnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		size = "40"
		objfiles = "fgetpwent@libc.a, sgetspent@libc.a, fgetspent@libc.a, getspnam@libc.a, getgrnam@libc.a"
	strings:
...
rule floatformat_always_valid_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		size = "6"
		objfiles = "auth_none@libc.a, _stdlib_mb_cur_max@libc.a, floatformat@libiberty.a, xdr@libc.a, oldsemaphore@libpthread.a"
	strings:
