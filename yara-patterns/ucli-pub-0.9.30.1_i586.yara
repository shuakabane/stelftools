...
rule _svcauth_null_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "pthread_condattr_init, __GI_wcsftime, grantpt, authnone_refresh, wcsftime, __GI_pthread_condattr_destroy, __pthread_return_0, __GI_pthread_attr_destroy, __pthread_mutex_trylock, __GI_pthread_condattr_init, __pthread_mutexattr_destroy, __pthread_mutex_lock, pthread_attr_destroy, __pthread_mutex_init, pthread_rwlockattr_destroy, clntraw_control, pthread_condattr_destroy, __pthread_mutex_unlock, pthread_mutexattr_destroy, xdrstdio_inline, _svcauth_null"
		size = "3"
		objfiles = "auth_none@libc.a, wcsftime@libc.a, xdr_stdio@libc.a, attr@libpthread.a, rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __libc_statfs_4e50f52197fe0f98bf0d418994561253 {
	meta:
...
rule __libc_fstatfs_626538cf26dc5d87ceb849275f79ae92 {
	meta:
		aliases = "__GI___libc_fstatfs, fstatfs, __GI_fstatfs, __libc_fstatfs"
		size = "50"
...
rule getpid_79b35d357e5e26b5da72e4f104bc68d1 {
	meta:
...
rule __GI_getuid_f9f1b6a7048b12a12ee4d9d5fc6d99c6 {
	meta:
...
rule getc_unlocked_a8c421194d2423dabb3cc9829e1d3697 {
	meta:
		aliases = "__GI_getc_unlocked, __GI_fgetc_unlocked, fgetc_unlocked, __GI___fgetc_unlocked, __fgetc_unlocked, getc_unlocked"
		size = "220"
...
rule endprotoent_0d96bf4fc2561ebab2649fbb03aaf667 {
	meta:
		aliases = "__GI_endprotoent, endservent, __GI_endnetent, __GI_endservent, endnetent, endprotoent"
		size = "92"
...
rule waitpid_7fafe2d4042f052134436ac4f9e768f2 {
	meta:
		aliases = "lseek, accept, __GI_waitpid, sendmsg, waitpid"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule msync_f76fa2a31d5e51010722d3c9bb015e20 {
	meta:
		aliases = "read, connect, recvmsg, write, msync"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __res_init_8428edf922574b15d88a3ea678dc72a9 {
	meta:
...
rule _Unwind_FindEnclosingFunction_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "_Unwind_GetRegionStart, __gthread_active_p, __udiv_w_sdiv, _Unwind_GetDataRelBase, _Unwind_GetTextRelBase, _Unwind_FindEnclosingFunction"
		size = "7"
...
rule getspnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "getpwnam_r, __GI_getgrnam_r, __GI_getpwnam_r, __GI_getspnam_r, getgrnam_r, getspnam_r"
		size = "153"
...
rule __GI_memcmp_b4224e76d4efefe15b438c7c9cd081e1 {
	meta:
...
rule __GI_llround_89d63973a6272cc6695f35e6a1821e76 {
	meta:
...
rule __gcov_merge_add_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "pex_unix_cleanup, __gnat_default_lock, __gcov_merge_delta, __gnat_default_unlock, __gcov_flush, __gcov_init, __gcov_merge_single, __clear_cache, __enable_execute_stack, hex_init, __gcov_merge_add"
		size = "5"
		objfiles = "gthr_gnat@libgcc.a, hex@libiberty.a, _gcov_merge_single@libgcov.a, _gcov_merge_add@libgcov.a, _clear_cache@libgcc.a"
	strings:
...
rule siglongjmp_be9e6548214836180c2cfadd5a9f8fd0 {
	meta:
		aliases = "longjmp, __libc_longjmp, _longjmp, __libc_siglongjmp, siglongjmp"
		size = "51"
...
rule strxfrm_7e4500289543f3f39d6355a7c0813a78 {
	meta:
...
rule fgetgrent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetpwent_r, __GI_fgetspent_r, fgetspent_r, fgetpwent_r, __GI_fgetgrent_r, fgetgrent_r"
		size = "55"
...
rule __GI_readdir64_6c298d060a8d31d21d5a79c26aec2088 {
	meta:
...
rule __libc_open_2a38df59c17c094e7cfb77be502adffc {
	meta:
...
rule __dl_iterate_phdr_0fc0f88f4c3260f0322ad3d56942bdc3 {
	meta:
...
rule __GI_fileno_47b2021f9ad3c9dae34d9b79ccbd71b9 {
	meta:
		aliases = "fileno, __GI_fgetwc, fgetwc, getwc, __GI_fileno"
		size = "92"
...
rule __GI_fputws_27a00bae78ad279095482cf1967e990f {
	meta:
		aliases = "__GI_fputs, fputs, putwc, fputws, fputwc, __GI_fputws"
		size = "95"
...
rule __GI_getpwent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "getpwent_r, getspent_r, __GI_getspent_r, getgrent_r, __GI_getgrent_r, __GI_getpwent_r"
		size = "171"
		objfiles = "getspent_r@libc.a, getpwent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule pipe_11450804b95a038606daff666c2fcaa2 {
	meta:
...
rule strtouq_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "wcstouq, __GI_wcstoul, strtoul, wcstoull, wcstoul, strtoull, __GI_waitpid, __GI_wcstoull, __GI_strtoul, __libc_waitpid, __GI_strtoull, wcstoumax, strtoumax, waitpid, strtouq"
		size = "26"
...
rule __GI_strtoll_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "__GI_strtol, wcstoll, __GI_wcstol, wcstoq, wcstoimax, strtoq, strtoll, strtol, __GI_wcstoll, strtoimax, wcstol, __GI_strtoll"
		size = "26"
...
rule sigismember_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "__GI_sigdelset, sigdelset, __GI_sigaddset, sigaddset, sigismember"
		size = "42"
...
rule __GI_strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "gamma, __GI_lgamma, strtok, __ieee754_gamma, __ieee754_lgamma, lgamma, __GI_strtok"
		size = "25"
		objfiles = "w_lgamma@libm.a, e_lgamma@libm.a, w_gamma@libm.a, strtok@libc.a, e_gamma@libm.a"
	strings:
...
rule __GI_atol_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "atoll, atoi, __GI_atoi, atol, __GI_atol"
		size = "20"
...
rule __GI_inet_ntoa_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "inet_ntoa, hcreate, srand48, __GI_asctime, asctime, ether_ntoa, __GI_inet_ntoa"
		size = "21"
...
rule mkstemp64_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "iswalnum, __GI_iswalnum, timelocal, mktime, mkstemp64"
		size = "18"
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "spinlock@libpthread.a, pthread@libpthread.a, rwlock@libpthread.a, manager@libpthread.a, join@libpthread.a"
	strings:
...
rule _flushlbf_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "hdestroy, __GI_getlogin, __pthread_once_fork_prepare, getlogin, __pthread_once_fork_parent, _flushlbf"
		size = "17"
...
rule __GI_fprintf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "fwscanf, __GI_asprintf, fwprintf, fprintf, syslog, swscanf, fscanf, __GI_syslog, sscanf, dprintf, __GI_sscanf, asprintf, __GI_fscanf, __GI_fprintf"
		size = "30"
		objfiles = "asprintf@libc.a, fwprintf@libc.a, dprintf@libc.a, fscanf@libc.a, syslog@libc.a"
	strings:
...
rule llrintf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "lroundf, lrintf, ilogbf, llroundf, llrintf"
		size = "19"
		objfiles = "llroundf@libm.a, lroundf@libm.a, llrintf@libm.a, ilogbf@libm.a, lrintf@libm.a"
	strings:
...
rule logf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "log10f, atanhf, expm1f, asinf, sinhf, acoshf, ceilf, roundf, fabsf, expf, rintf, tanf, logbf, coshf, cbrtf, atanf, erfcf, tgammaf, tanhf, log1pf, cosf, sinf, sqrtf, asinhf, truncf, lgammaf, acosf, erff, floorf, logf"
		size = "27"
		objfiles = "tanhf@libm.a, tgammaf@libm.a, coshf@libm.a, tanf@libm.a, log10f@libm.a"
	strings:
...
rule nextafterf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "copysignf, atan2f, powf, fmodf, remainderf, hypotf, nextafterf"
		size = "35"
		objfiles = "fmodf@libm.a, hypotf@libm.a, nextafterf@libm.a, atan2f@libm.a, copysignf@libm.a"
	strings:
...
rule getpwuid_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "sgetspent, getpwnam, getgrgid, fgetgrent, fgetspent, getgrnam, getspnam, fgetpwent, getpwuid"
		size = "40"
		objfiles = "getgrnam@libc.a, getpwnam@libc.a, getgrgid@libc.a, getspnam@libc.a, sgetspent@libc.a"
	strings:
...
rule thread_self_e74c8f77ff3f89dbea0e2d9a5b4c5494 {
	meta:
		aliases = "thread_self"
		size = "63"
		objfiles = "spinlock@libpthread.a, pthread@libpthread.a, errno@libpthread.a, rwlock@libpthread.a, mutex@libpthread.a"
	strings:
...
rule pthread_mutexattr_gettype_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_rwlockattr_getkind_np, pthread_mutexattr_getkind_np, __GI_pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype, pthread_attr_getdetachstate, pthread_mutexattr_gettype"
		size = "15"
...
rule pthread_mutexattr_setkind_np_c966b71060253b953a535d91cc13d1cf {
	meta:
		aliases = "pthread_mutexattr_settype, __pthread_mutexattr_setkind_np, __pthread_mutexattr_settype, pthread_mutexattr_setkind_np"
		size = "23"
		objfiles = "mutex@libpthread.a"
	strings:
...
rule __GI__stdlib_mb_cur_max_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "authnone_validate, xdr_void, _stdlib_mb_cur_max, __GI_xdr_void, old_sem_extricate_func, __GI__stdlib_mb_cur_max"
		size = "6"
...
rule svcraw_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_tcp@libc.a, svc_udp@libc.a, svc_unix@libc.a, svc_authux@libc.a, svc_raw@libc.a"
	strings:
