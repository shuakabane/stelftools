...
rule glob_pattern_p_8c5bf7ded8ba16741023e0f1eee79a50 {
	meta:
...
rule hypot_e30ae263b30d51abf54e7d76686c7637 {
	meta:
		aliases = "__ieee754_hypot, __GI_hypot, hypot"
		size = "769"
...
rule __libc_read_da25ffcefbb795280d6a85dd56de2310 {
	meta:
...
rule __libc_lseek_d8817a2b20d2b8a8527cf60ac853ffd1 {
	meta:
...
rule setpgid_b547c224049d05c3d1c12351dabcb25c {
	meta:
...
rule nrand48_r_a32005692c3cdd0182b134e163c5d80c {
	meta:
...
rule xdr_u_long_184ccabdc28a66212a02833ebd3011ba {
	meta:
...
rule fcntl_27a71e017d47b8ecb37086c38a4cdf6a {
	meta:
		aliases = "__GI___libc_fcntl, __GI___fcntl_nocancel, __fcntl_nocancel, __libc_fcntl, __GI_fcntl, fcntl"
		size = "87"
...
rule ioctl_4eb36ae44a70c07c5bab600470188f1c {
	meta:
...
rule atanh_de86d0b0b160083eaf24dc1e52ecbfd9 {
	meta:
		aliases = "__ieee754_atanh, __GI_atanh, atanh"
		size = "207"
...
rule cosh_795af30ef0c93dea7bfe36a321fa520e {
	meta:
		aliases = "__ieee754_cosh, __GI_cosh, cosh"
		size = "293"
...
rule setservent_a75f460ba1a57e8f72bf836bf9f6395f {
	meta:
		aliases = "__GI_setnetent, setnetent, __GI_setprotoent, setprotoent, __GI_setservent, setservent"
		size = "110"
		objfiles = "getproto@libc.a, getservice@libc.a, getnet@libc.a"
	strings:
...
rule endservent_f468964b8937d2560c1930edef041633 {
	meta:
		aliases = "__GI_endnetent, endnetent, __GI_endprotoent, endprotoent, __GI_endservent, endservent"
		size = "92"
		objfiles = "getproto@libc.a, getservice@libc.a, getnet@libc.a"
	strings:
...
rule endspent_f2d51fc60c1735f3fbcd30a501506aaa {
	meta:
...
rule lseek_74030486c498b35deba130245259f53b {
	meta:
		aliases = "recvmsg, connect, write, lseek"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule waitpid_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "sendmsg, accept, __GI_waitpid, read, msync, waitpid"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule pread_a442f4706a8c29f1a18c27f8c866616e {
	meta:
		aliases = "epoll_wait, send, recv, pwrite, pread"
		size = "60"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule scalbn_fb3de27cecf8f253228eddf40f0dccab {
	meta:
		aliases = "__GI_scalbln, scalbln, __GI_scalbn, scalbn"
		size = "293"
...
rule stat_bbb3103b992f0b3bdeafbc72864c7398 {
	meta:
...
rule vswprintf_837d6635ad7a615580a8e442d059dddd {
	meta:
...
rule readdir64_r_dd96b8f6377a207c43b5c576ffd089d8 {
	meta:
...
rule vsyslog_981225d4a2b2eda255ee593d5f29d6da {
	meta:
...
rule pow_9fe5697af0c59e15bfe39656982c3880 {
	meta:
		aliases = "__ieee754_pow, __GI_pow, pow"
		size = "1938"
...
rule strstr_bdb33dace401f312d68d1aab7edfd552 {
	meta:
...
rule getspnam_r_cc5f26c3b0fc4b0f9817cca9b8118eee {
	meta:
...
rule fflush_unlocked_e8af3554fa3c97d5b700c618bd8b2925 {
	meta:
...
rule sqrt_d4f2e8021838ae04fcdabb4f802d818e {
	meta:
		aliases = "__ieee754_sqrt, __GI_sqrt, sqrt"
		size = "458"
...
rule gethostbyaddr_r_7b78c2c764d49b806530042d48f9172d {
	meta:
...
rule strerror_r_1056850e9364232993d8ab7498d5b02f {
	meta:
...
rule nearbyint_e880e6d9c845e6d62b55a63d1131f51b {
	meta:
		aliases = "__GI_rint, rint, __GI_nearbyint, nearbyint"
		size = "346"
...
rule gamma_r_9a0e4b77eb2bc81c180419eb9a0dc9fc {
	meta:
		aliases = "lgamma_r, __ieee754_lgamma_r, gamma_r"
		size = "1710"
...
rule base_of_encoded_value_318f51e5d8200f25449bd12b99bdc306 {
	meta:
		aliases = "base_of_encoded_value, base_of_encoded_value"
		size = "124"
...
rule read_uleb128_6b1ba2eb7f30574936c35dbf8461dcf2 {
	meta:
		aliases = "read_uleb128, read_uleb128, read_uleb128"
		size = "63"
...
rule read_sleb128_608b251d0db12df7bf4a7797e59f50ee {
	meta:
		aliases = "read_sleb128, read_sleb128"
		size = "97"
...
rule glob64_dcf006b5f62b97e9d73ac2bdb5a6b22a {
	meta:
...
rule __gcov_flush_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		size = "5"
		objfiles = "_gcov_merge_single@libgcov.a, _clear_cache@libgcc.a, _gcov_merge_delta@libgcov.a, _gcov_merge_add@libgcov.a, _enable_execute_stack@libgcc.a"
	strings:
...
rule thread_self_ff5ff5468472ed8724cee51a9db2fab4 {
	meta:
		...
		size = "68"
		objfiles = "semaphore@libpthread.a, errno@libpthread.a, condvar@libpthread.a, rwlock@libpthread.a, cancel@libpthread.a"
	strings:
...
rule wcswidth_a8a8d41ac18fba6317bbb5bcefd8d7f3 {
	meta:
...
rule log_63f3470ea5d80d9455ca54bd4485ea37 {
	meta:
		aliases = "__ieee754_log, __GI_log, log"
		size = "520"
...
rule putc_unlocked_37814e0cd8130bd524be30599725db3b {
	meta:
		aliases = "__GI___fputc_unlocked, __fputc_unlocked, __GI_fputc_unlocked, fputc_unlocked, __GI_putc_unlocked, putc_unlocked"
		size = "190"
...
rule if_nametoindex_a8ad4e146f5c65dd7de491489a0105bd {
	meta:
...
rule sem_post_7db2931ed9e069b249669a3ae2a8c50a {
	meta:
...
rule vsscanf_8876302da695eb8be78b4ec4f580177e {
	meta:
...
rule asin_840155dd38d435ed8e4e4d71968036ef {
	meta:
		aliases = "__ieee754_asin, __GI_asin, asin"
		size = "548"
...
rule wait4_11b24a1ec47bd6e5ac0fa431ceda6098 {
	meta:
...
rule index_a896babb1add290c02798b8a3eb170f5 {
	meta:
...
rule sigtimedwait_ec8486b266d5975c4a69d1bf36e092d1 {
	meta:
		aliases = "__sigtimedwait, __GI_sigtimedwait, sigtimedwait"
		size = "58"
...
rule pthread_kill_other_threads_np_127b807f6ca8995a3353ec6f9a547bc9 {
	meta:
...
rule fputs_93c608f5c03035cb7b8ea2b514c58aa7 {
	meta:
...
rule getspent_r_0ebd27d559293f3957ce17608b106181 {
	meta:
...
rule fstatfs64_e2fe8981872cbcd00c43d38bac0c8dbb {
	meta:
...
rule waitpid_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "wcstoull, wcstoumax, wcstouq, wcstoul, strtoull, strtoumax, strtouq, __GI_strtoul, strtoul, __libc_waitpid, __GI_waitpid, waitpid"
		size = "26"
		objfiles = "strtoull@libc.a, waitpid@libc.a, wcstoul@libc.a, strtoul@libc.a, wcstoull@libc.a"
	strings:
...
rule strtol_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "wcstoll, wcstoimax, wcstoq, wcstol, __GI_strtoll, strtoll, strtoimax, strtoq, __GI_strtol, strtol"
		size = "26"
		objfiles = "strtoll@libc.a, strtol@libc.a, wcstoll@libc.a, wcstol@libc.a"
	strings:
...
rule __rpc_thread_svc_max_pollfd_6737293ba998fc2e4738c0fa72910ff3 {
	meta:
...
rule gamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__GI_strtok, strtok, __ieee754_lgamma, __GI_lgamma, lgamma, gamma"
		size = "25"
		objfiles = "e_lgamma_r@libm.a, strtok@libc.a"
	strings:
...
rule atoi_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "atoll, atol, __GI_atoi, atoi"
		size = "20"
...
rule vprintf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "vwscanf, vwprintf, vscanf, vprintf"
		size = "26"
...
rule hcreate_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "srand48, ether_ntoa, __GI_inet_ntoa, inet_ntoa, __GI_asctime, asctime, hcreate"
		size = "21"
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "semaphore@libpthread.a, condvar@libpthread.a, join@libpthread.a, rwlock@libpthread.a, pthread@libpthread.a"
	strings:
...
rule __pthread_once_fork_prepare_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__GI_getlogin, getlogin, __open_etc_hosts, _flushlbf, hdestroy, __pthread_once_fork_parent, __pthread_once_fork_prepare"
		size = "17"
		objfiles = "hsearch@libc.a, getlogin@libc.a, read_etc_hosts_r@libc.a, _flushlbf@libc.a, mutex@libpthread.a"
	strings:
...
rule printf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		...
		size = "32"
		objfiles = "wprintf@libc.a, printf@libc.a, scanf@libc.a, wscanf@libc.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		size = "30"
		objfiles = "fwprintf@libc.a, fprintf@libc.a, dprintf@libc.a, fwscanf@libc.a, fscanf@libc.a"
	strings:
...
rule ilogbf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "lroundf, lrintf, llroundf, llrintf, ilogbf"
		size = "19"
		objfiles = "llrintf@libm.a, lroundf@libm.a, llroundf@libm.a, ilogbf@libm.a, lrintf@libm.a"
	strings:
...
rule acosf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "truncf, tanhf, tanf, sqrtf, sinhf, sinf, significandf, roundf, rintf, logf, logbf, log2f, log1pf, log10f, lgammaf, gammaf, floorf, fabsf, expm1f, expf, exp2f, erff, erfcf, coshf, cosf, ceilf, cbrtf, atanhf, atanf, asinhf, asinf, acoshf, acosf"
		size = "27"
		objfiles = "log2f@libm.a, atanf@libm.a, exp2f@libm.a, acosf@libm.a, acoshf@libm.a"
	strings:
...
rule atan2f_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "scalbf, remainderf, powf, hypotf, fmodf, copysignf, atan2f"
		size = "35"
		objfiles = "hypotf@libm.a, remainderf@libm.a, scalbf@libm.a, atan2f@libm.a, powf@libm.a"
	strings:
...
rule getgrnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		size = "40"
		objfiles = "getgrgid@libc.a, getpwnam@libc.a, getgrnam@libc.a, getspnam@libc.a, fgetpwent@libc.a"
	strings:
...
rule acosh_de3c7e7b69d8e343cd5c68dbd96fd252 {
	meta:
		aliases = "__ieee754_acosh, __GI_acosh, acosh"
		size = "236"
...
rule acos_19f07b604fed0419d5b4c5d578ba0605 {
	meta:
		aliases = "__ieee754_acos, __GI_acos, acos"
		size = "556"
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		aliases = "__i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx, __i686.get_pc_thunk.cx"
		size = "4"
		objfiles = "_floatundidf@libgcc.a, unwind_dw2_fde_glibc@libgcc_eh.a, _fixunsdfsi@libgcc.a, _floatdidf@libgcc.a, _fixunsdfdi@libgcc.a"
	strings:
...
rule __get_pc_thunk_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		aliases = "__i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __i686.get_pc_thunk.bx, __get_pc_thunk_bx, __i686.get_pc_thunk.bx, __get_pc_thunk_bx"
		size = "4"
		objfiles = "_negvsi2@libgcc.a, _powisf2@libgcc.a, _divxc3@libgcc.a, _floatdisf@libgcc.a, _powidf2@libgcc.a"
	strings:
...
rule htonl_f0b2ac96b2a9c6535f6815b42030bed8 {
	meta:
		aliases = "__GI_htonl, __GI_ntohl, ntohl, htonl"
		size = "7"
		objfiles = "ntohl@libc.a"
	strings:
...
rule pthread_attr_getschedparam_bf01487b64a973dd33d77632c300357d {
	meta:
		aliases = "__new_sem_getvalue, sem_getvalue, __GI_pthread_attr_getschedparam, pthread_attr_getschedparam"
		size = "16"
...
rule svcunixfd_create_e63fbd4454ec064dc8f9d0b775e2be85 {
	meta:
		...
		size = "17"
		objfiles = "svc_unix@libc.a, setenv@libc.a, svc_tcp@libc.a"
	strings:
...
rule ffsl_feb723aec7491e08bab0f2405a8fa304 {
	meta:
...
rule btowc_8c3fda039e322768be4ebeeb0538551d {
	meta:
		aliases = "wctob, __GI_btowc, btowc"
		size = "17"
...
rule floatformat_always_valid_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		size = "6"
		objfiles = "_stdlib_mb_cur_max@libc.a, auth_none@libc.a, floatformat@libiberty.a, xdr@libc.a, oldsemaphore@libpthread.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_unix@libc.a, svc_udp@libc.a, svc_raw@libc.a, svc_tcp@libc.a, svc_authux@libc.a"
	strings:
...
rule __clone_8ef3be04e211ed0fcf605010e196ea48 {
	meta:
		aliases = "clone, __clone"
		size = "108"
