...
rule __pthread_mutex_unlock_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "__pthread_mutex_lock, __pthread_return_0, wcsftime, __GI_pthread_condattr_destroy, __pthread_mutex_init, __GI_pthread_attr_destroy, pthread_attr_destroy, xdrstdio_inline, __pthread_mutexattr_destroy, __GI_pthread_condattr_init, _svcauth_null, authnone_refresh, pthread_condattr_destroy, clntraw_control, pthread_mutexattr_destroy, __GI_wcsftime, pthread_condattr_init, pthread_rwlockattr_destroy, grantpt, __pthread_mutex_trylock, __pthread_mutex_unlock"
		size = "3"
		objfiles = "clnt_raw@libc.a, rwlock@libpthread.a, auth_none@libc.a, mutex@libpthread.a, condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule thread_self_c490e55fdc4e0d42e26befc1658d19a1 {
	meta:
		aliases = "thread_self"
		size = "63"
		objfiles = "rwlock@libpthread.a, errno@libpthread.a, signals@libpthread.a, join@libpthread.a, condvar@libpthread.a"
	strings:
...
rule __GI_fstatfs_b82c33a72680209b48b544d1edec1c80 {
	meta:
		aliases = "fstatfs, __GI___libc_fstatfs, __libc_fstatfs, __GI_fstatfs"
		size = "50"
...
rule __pthread_mutex_unlock_65d849127bebd6d144b9d461ba9eb542 {
	meta:
...
rule __GI___fgetc_unlocked_7234bf2292c7e7a4e6fb4c246bfcefbf {
	meta:
		aliases = "__GI_getc_unlocked, __fgetc_unlocked, __GI_fgetc_unlocked, fgetc_unlocked, getc_unlocked, __GI___fgetc_unlocked"
		size = "220"
...
rule __GI_endservent_f468964b8937d2560c1930edef041633 {
	meta:
		aliases = "__GI_endnetent, endprotoent, __GI_endprotoent, endservent, endnetent, __GI_endservent"
		size = "92"
...
rule wait_bbe948c091b68f15128a29caf991f3c8 {
	meta:
		aliases = "tcdrain, fsync, system, wait"
		size = "48"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule recvmsg_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "connect, msync, read, write, recvmsg"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI___isnan_2e948270bc091a5709464aab0f086307 {
	meta:
		aliases = "__GI_isnan, isnan, __isnan, __GI___isnan"
		size = "40"
...
rule __GI___isinf_8fae0a869cda9672f88bf94835574c14 {
	meta:
		aliases = "__isinf, __GI_isinf, isinf, __GI___isinf"
		size = "43"
...
rule __udiv_w_sdiv_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "_Unwind_GetRegionStart, _Unwind_FindEnclosingFunction, _Unwind_GetTextRelBase, __gthread_active_p, _Unwind_GetDataRelBase, __udiv_w_sdiv"
		size = "7"
...
rule __GI_getpwnam_r_cc5f26c3b0fc4b0f9817cca9b8118eee {
	meta:
		aliases = "getgrnam_r, getspnam_r, __GI_getgrnam_r, __GI_getspnam_r, getpwnam_r, __GI_getpwnam_r"
		size = "152"
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__clear_cache, __gcov_merge_add, __gnat_default_lock, __enable_execute_stack, __gcov_merge_delta, __gcov_flush, __gcov_merge_single, pex_unix_cleanup, __gcov_init, hex_init, __gnat_default_unlock"
		size = "5"
		objfiles = "_gcov@libgcov.a, _clear_cache@libgcc.a, pex_unix@libiberty.a, _gcov_merge_add@libgcov.a, hex@libiberty.a"
	strings:
...
rule strlcpy_cc28fde6a217fb7206145cb9a1baff29 {
	meta:
		aliases = "__GI_strlcpy, strxfrm, __GI_strxfrm, strlcpy"
		size = "61"
...
rule fgetspent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "fgetpwent_r, __GI_fgetpwent_r, fgetgrent_r, __GI_fgetspent_r, __GI_fgetgrent_r, fgetspent_r"
		size = "55"
...
rule open_ba06cb787400df0dffd6649ff5a6d12f {
	meta:
		aliases = "__GI_open, __GI___libc_open, __libc_open, open"
		size = "75"
...
rule dl_iterate_phdr_bb6ace87e508a1473ec656a82e689308 {
	meta:
...
rule __GI_fileno_d1aff121aa302794d76ffd1091af3fc3 {
	meta:
		aliases = "__GI_fgetwc, fgetwc, fileno, getwc, __GI_fileno"
		size = "92"
...
rule fputs_656d0461fb753b5b2210fd391d402010 {
	meta:
		aliases = "__GI_fputws, fputwc, __GI_fputs, putwc, fputws, fputs"
		size = "95"
...
rule __GI_wctrans_50e80352cc999abf107e4f9290013692 {
	meta:
		aliases = "__GI_wctype, wctype, wctrans, __GI_wctrans"
		size = "61"
...
rule __GI_waitpid_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "wcstoul, strtoul, waitpid, __GI_wcstoul, __libc_waitpid, wcstoull, strtouq, __GI_wcstoull, strtoull, __GI_strtoul, wcstoumax, wcstouq, __GI_strtoull, strtoumax, __GI_waitpid"
		size = "26"
		objfiles = "wcstoul@libc.a, waitpid@libc.a, wcstoull@libc.a, strtoul@libc.a, strtoull@libc.a"
	strings:
...
rule wcstoll_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "strtoq, __GI_strtoll, __GI_wcstoll, __GI_wcstol, wcstol, strtoimax, wcstoimax, strtol, strtoll, __GI_strtol, wcstoq, wcstoll"
		size = "26"
...
rule __GI_sigdelset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigdelset, sigaddset, __GI_sigaddset, sigismember, __GI_sigdelset"
		size = "42"
...
rule gamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__GI_strtok, __ieee754_gamma, __GI_gamma, __GI_lgamma, strtok, __ieee754_lgamma, lgamma, gamma"
		size = "25"
		objfiles = "strtok@libc.a, w_gamma@libm.a, w_lgamma@libm.a, e_lgamma@libm.a, e_gamma@libm.a"
	strings:
...
rule __GI_atol_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "atol, atoi, __GI_atoi, atoll, __GI_atol"
		size = "20"
...
rule ether_ntoa_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "hcreate, inet_ntoa, __GI_asctime, asctime, srand48, __GI_inet_ntoa, ether_ntoa"
		size = "21"
		objfiles = "inet_ntoa@libc.a, hsearch@libc.a, asctime@libc.a, srand48@libc.a, ether_addr@libc.a"
	strings:
...
rule __GI_sigpause_6bf719c25f6fbaef08052b0889ae3660 {
	meta:
		aliases = "atof, mkstemp, sigpause, __GI_sigpause"
		size = "18"
...
rule mkstemp64_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "mktime, iswalnum, timelocal, __GI_iswalnum, mkstemp64"
		size = "18"
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "rwlock@libpthread.a, join@libpthread.a, manager@libpthread.a, condvar@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule hdestroy_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "_flushlbf, __pthread_once_fork_parent, __GI_getlogin, __pthread_once_fork_prepare, getlogin, hdestroy"
		size = "17"
		objfiles = "hsearch@libc.a, getlogin@libc.a, mutex@libpthread.a, _flushlbf@libc.a"
	strings:
...
rule __GI_printf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "wprintf, wscanf, scanf, printf, __GI_printf"
		size = "32"
...
rule swscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "__GI_sscanf, __GI_fprintf, asprintf, fwscanf, dprintf, sscanf, fwprintf, fscanf, __GI_asprintf, __GI_fscanf, fprintf, __GI_syslog, syslog, swscanf"
		size = "30"
		objfiles = "fprintf@libc.a, syslog@libc.a, fwprintf@libc.a, fwscanf@libc.a, sscanf@libc.a"
	strings:
...
rule lrintf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		size = "19"
		objfiles = "lroundf@libm.a, llroundf@libm.a, llrintf@libm.a, lrintf@libm.a, ilogbf@libm.a"
	strings:
...
rule floorf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "expm1f, logbf, tanf, truncf, acosf, cosf, fabsf, tanhf, roundf, rintf, sinhf, logf, erfcf, atanf, cbrtf, coshf, ceilf, expf, asinhf, log10f, asinf, acoshf, erff, atanhf, sqrtf, log1pf, sinf, lgammaf, floorf"
		size = "27"
		objfiles = "asinhf@libm.a, atanhf@libm.a, logf@libm.a, erfcf@libm.a, expm1f@libm.a"
	strings:
...
rule atan2f_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "hypotf, powf, remainderf, nextafterf, fmodf, copysignf, atan2f"
		size = "35"
		objfiles = "hypotf@libm.a, fmodf@libm.a, remainderf@libm.a, powf@libm.a, copysignf@libm.a"
	strings:
...
rule getpwnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "getgrnam, fgetgrent, getpwuid, getspnam, getgrgid, sgetspent, fgetpwent, fgetspent, getpwnam"
		size = "40"
		objfiles = "getpwuid@libc.a, getgrnam@libc.a, fgetpwent@libc.a, sgetspent@libc.a, fgetgrent@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		size = "4"
		objfiles = "_fixunssfsi@libgcc.a, _fixunssfdi@libgcc.a, _fixunsdfsi@libgcc.a, unwind_dw2_fde_glibc@libgcc.a, unwind_sjlj@libgcc.a"
	strings:
...
rule __get_pc_thunk_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		size = "4"
		objfiles = "unwind_dw2_fde_glibc@libgcc.a, _powisf2@libgcc.a, atexits@uclibc_nonshared.a, crtbeginS, _fixsfdi@libgcc.a"
	strings:
...
rule pthread_attr_getdetachstate_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_mutexattr_gettype, pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype, pthread_rwlockattr_getkind_np, __GI_pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np, pthread_attr_getdetachstate"
		size = "15"
...
rule __GI_wcscmp_d12081b632ea83b04fb875937ca6d645 {
	meta:
...
rule __GI_finite_52f0fe301eafa063e375e8223ee96caa {
	meta:
		aliases = "finite, __GI___finite, __finite, __GI_finite"
		size = "20"
...
rule __GI__stdlib_mb_cur_max_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "xdr_void, old_sem_extricate_func, authnone_validate, _stdlib_mb_cur_max, __GI_xdr_void, __GI__stdlib_mb_cur_max"
		size = "6"
...
rule _svcauth_short_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_authux@libc.a, svc_unix@libc.a, svc_udp@libc.a, svc_tcp@libc.a, svc_raw@libc.a"
	strings:
