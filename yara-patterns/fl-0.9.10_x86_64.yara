...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "svc_auth@libc.a, wcsftime@libc.a, mutex@libpthread.a, clnt_raw@libc.a, grantpt@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule wcstoumax_0b8614121f4839ecf9cde74d5b6b8c69 {
	meta:
		aliases = "__GI_strtoul, __GI_strtoull, __GI_waitpid, __GI_wcstoul, __GI_wcstoull, __libc_waitpid, strtoul, strtoull, strtoumax, strtouq, waitpid, wcstoul, wcstoull, wcstoumax"
		type = "func"
		size = "7"
...
rule __xstat_conv_32aef6b2e2551a9cd9c7e564a4b85ff4 {
	meta:
...
rule shm_open_fbed546521a74eded765ec1f4466d289 {
	meta:
		aliases = "shm_open"
		type = "func"
		size = "137"
	...
	strings:
		$pattern = { ( CC | 41 ) 55 41 54 41 89 F4 55 83 CD FF 53 89 D3 48 83 EC 08 E8 6A FF FF FF 48 85 C0 49 89 C5 74 60 48 89 C7 89 DA 31 C0 44 89 E6 E8 ?? ?? ?? ?? 85 C0 89 C5 78 35 31 D2 89 C7 BE 01 00 00 00 31 C0 E8 ?? ?? ?? ?? 85 C0 78 17 83 C8 01 BE 02 00 00 00 89 EF 89 C2 31 C0 E8 ?? ?? ?? ?? 85 C0 79 0A 89 EF 83 CD FF E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 44 8B 20 48 89 C3 4C 89 EF E8 ?? ?? ?? ?? 44 89 23 59 5B 89 E8 5D 41 5C 41 5D C3 }
	condition:
		$pattern
}
...
rule thread_self_fc567cf57d3f04fc77b3c53a5a9fe529 {
	meta:
		...
		type = "func"
		size = "69"
		objfiles = "join@libpthread.a, mutex@libpthread.a, signals@libpthread.a, spinlock@libpthread.a, specific@libpthread.a"
	strings:
...
rule syslog_4f17e5776fd93321a6b366d662782192 {
	meta:
		...
		type = "func"
		size = "142"
		objfiles = "sscanf@libc.a, fwscanf@libc.a, asprintf@libc.a, dprintf@libc.a, syslog@libc.a"
	strings:
...
rule sgetspent_5abd21e9b7de4fda56e36ae3f07cbf5b {
	meta:
		...
		type = "func"
		size = "39"
		objfiles = "fgetgrent@libc.a, getpwnam@libc.a, getgrgid@libc.a, sgetspent@libc.a, fgetpwent@libc.a"
	strings:
...
rule mknodat_c4474f97f3c0b8f63f68606a6580bfc7 {
	meta:
...
rule ppoll_5627594c0473ed27dc62b56c1ab4b5fe {
	meta:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "_stdlib_mb_cur_max@libc.a, auth_none@libc.a, oldsemaphore@libpthread.a, floatformat@libiberty.a, xdr@libc.a"
	strings:
...
rule lgamma_8c47b9c6008fc75a3442b25215b4f0fe {
	meta:
		...
		type = "func"
		size = "10"
		objfiles = "mutex@libpthread.a, w_gamma@libm.a, w_lgamma@libm.a, hsearch@libc.a, e_gamma@libm.a"
	strings:
		$pattern = { ( CC | BF ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "clnt_raw@libc.a, xdr_mem@libc.a, auth_unix@libc.a, clnt_unix@libc.a, auth_none@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "llseek@libc.a, w_cosh@libm.a, w_log2@libm.a, w_log@libm.a, w_sinh@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule truncf_76fb52706816ef3df3c8d6c20b0aa675 {
	meta:
		...
		type = "func"
		size = "19"
		objfiles = "coshf@libm.a, frexpf@libm.a, asinhf@libm.a, sinhf@libm.a, asinf@libm.a"
	strings:
...
rule lroundf_d3b5b767a0285b8ef7c579a0959a22b2 {
	meta:
		...
		type = "func"
		size = "9"
		objfiles = "ilogbf@libm.a, lroundf@libm.a, llroundf@libm.a, lrintf@libm.a, llrintf@libm.a"
	strings:
...
rule remainderf_b655e1a82b86ef778f64370fab64b292 {
	meta:
		...
		type = "func"
		size = "23"
		objfiles = "nextafterf@libm.a, copysignf@libm.a, powf@libm.a, atan2f@libm.a, remainderf@libm.a"
	strings:
...
rule pex_unix_cleanup_32a093eff127b3eedaa06c147dc0694b {
	meta:
		...
		type = "func"
		size = "2"
		objfiles = "_gcov_merge_add@libgcov.a, pex_unix@libiberty.a, _gcov_merge_delta@libgcov.a, _gcov_merge_single@libgcov.a, hex@libiberty.a"
	strings:
		$pattern = { ( CC | F3 ) C3 }
	condition:
		$pattern
