...
rule pthread_attr_destroy_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		size = "3"
		objfiles = "rwlock@libpthread.a, __uClibc_main@libc.a, wcsftime@libc.a, grantpt@libc.a, attr@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		size = "8"
		objfiles = "manager@libpthread.a, rwlock@libpthread.a, pthread@libpthread.a, semaphore@libpthread.a, join@libpthread.a"
	strings:
...
rule fcntl64_dd171915b59dc95dbd1aa31a573fa92c {
	meta:
...
rule setservent_d716461598951d0849294acc7e5437cd {
	meta:
...
rule setprotoent_d93becebaefdfd2ceefb5b3142a474bd {
	meta:
		aliases = "__GI_setnetent, setnetent, __GI_setprotoent, setprotoent"
		size = "96"
...
rule getwc_unlocked_6f34687e446fc8d1d525222dc0d98f2b {
	meta:
...
rule getprotobynumber_r_d9b5ae1dc53693e4f67fc2309ecb39b3 {
	meta:
...
rule fclose_5297119a87e715676084c894fa7db389 {
	meta:
...
rule gethostbyaddr_r_183324c2f4f9d6c03f2b7a4096f208c4 {
	meta:
...
rule gethostbyname2_r_9c51323abd9b2021b71e9f800598cb53 {
	meta:
...
rule getnetent_r_47882cceb4a187f5b7368279938be002 {
	meta:
...
rule __gcov_flush_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		size = "5"
		objfiles = "_gcov_merge_add@libgcov.a, _gcov_merge_single@libgcov.a, _enable_execute_stack@libgcc.a, _clear_cache@libgcc.a, gthr_gnat@libgcc_eh.a"
	strings:
...
rule thread_self_4d574e5856a30bb564cca31edbbe6aeb {
	meta:
		...
		size = "68"
		objfiles = "rwlock@libpthread.a, cancel@libpthread.a, pthread@libpthread.a, condvar@libpthread.a, errno@libpthread.a"
	strings:
...
rule mknod_f1bc454f7923b9b594a6631c5d06cdd1 {
	meta:
...
rule getspent_r_343fc5878297abdfbd7a84dc38cc5e15 {
	meta:
...
rule seed48_r_88b76737e28130625373c731b2b859e4 {
	meta:
...
rule __open_etc_hosts_4b4b020f95e78d1c2d908fe427dc4a97 {
	meta:
		aliases = "__GI_getlogin, getlogin, __open_etc_hosts"
		size = "12"
...
rule waitpid_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		...
		size = "23"
		objfiles = "waitpid@libc.a, strtoul@libc.a, wcstoull@libc.a, wcstoul@libc.a, strtoull@libc.a"
	strings:
...
rule getgrnam_55f8a496d4b651e19d576b899468cf9d {
	meta:
		...
		size = "38"
		objfiles = "fgetpwent@libc.a, fgetspent@libc.a, fgetgrent@libc.a, getpwnam@libc.a, getgrgid@libc.a"
	strings:
...
rule syslog_3674412569e427ab0f649983548971e5 {
	meta:
		...
		size = "28"
		objfiles = "asprintf@libc.a, fprintf@libc.a, syslog@libc.a, swscanf@libc.a, dprintf@libc.a"
	strings:
...
rule getprotobyname_2bfff9c1b3a2263e20d37eabcd209d61 {
	meta:
...
rule acosf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		...
		size = "27"
		objfiles = "rintf@libm.a, coshf@libm.a, tanf@libm.a, asinhf@libm.a, erfcf@libm.a"
	strings:
...
rule atan2f_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		...
		size = "35"
		objfiles = "hypotf@libm.a, fmodf@libm.a, remainderf@libm.a, atan2f@libm.a, scalbf@libm.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_tcp@libc.a, svc_udp@libc.a, svc_raw@libc.a, svc_unix@libc.a, svc_authux@libc.a"
	strings:
...
rule vprintf_8656ba417f55ecd54498627fc6f064b6 {
	meta:
		...
		size = "23"
		objfiles = "vprintf@libc.a, vwscanf@libc.a, vwprintf@libc.a, vscanf@libc.a"
	strings:
