...
rule pthread_attr_destroy_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		size = "3"
		objfiles = "svc_auth@libc.a, auth_none@libc.a, condvar@libpthread.a, wcsftime@libc.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		aliases = "suspend, suspend, suspend, suspend, restart, suspend, suspend"
		size = "8"
		objfiles = "manager@libpthread.a, condvar@libpthread.a, spinlock@libpthread.a, join@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule close_0f16be773a16c7f1ada0f23bb98e42f6 {
	meta:
		aliases = "wait, tcdrain, system, fsync, close"
		size = "43"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule waitpid_7e8310e1353bbbc8133a54fecec14b99 {
	meta:
		aliases = "sendmsg, recvmsg, connect, accept, write, __GI_waitpid, read, msync, lseek, waitpid"
		size = "51"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule mbrtowc_ee55d7ad7e46a23a7a6df0319d7222ac {
	meta:
...
rule mq_receive_ab437036bdc503b3efe105177bd491a7 {
	meta:
		...
		size = "35"
		objfiles = "mq_send@librt.a, mq_receive@librt.a, pread_write@libc.a"
	strings:
...
rule __libc_nanosleep_66d8ad1e996b2f0928eecec048fcd516 {
	meta:
		aliases = "__GI_nanosleep, nanosleep, __libc_nanosleep"
		size = "44"
...
rule imaxdiv_f00e2ee514764ab5affc6f502585946f {
	meta:
...
rule __gcov_flush_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		size = "5"
		objfiles = "_enable_execute_stack@libgcc.a, _gcov_merge_add@libgcov.a, gthr_gnat@libgcc_eh.a, _gcov_merge_delta@libgcov.a, _gcov@libgcov.a"
	strings:
...
rule thread_self_4d574e5856a30bb564cca31edbbe6aeb {
	meta:
		...
		size = "68"
		objfiles = "condvar@libpthread.a, specific@libpthread.a, spinlock@libpthread.a, signals@libpthread.a, join@libpthread.a"
	strings:
...
rule wcsxfrm_531c207e747b0f75ca250818a7b364ec {
	meta:
		aliases = "__wcslcpy, __GI_wcsxfrm, wcsxfrm"
		size = "62"
...
rule _longjmp_7d28f6943d4fb5439b29a882aee6266a {
	meta:
...
rule __libc_fcntl_da85f709305ed54422288aa9feffe344 {
	meta:
		aliases = "__GI_fcntl, fcntl, __libc_fcntl"
		size = "82"
...
rule fileno_f742656956ff575187512389884c869a {
	meta:
...
rule __libc_close_a02017293cde43f33c14807fe58a266e {
	meta:
...
rule __libc_lseek_74cc41bbf636237fd7de2859afe9d2e0 {
	meta:
...
rule __pthread_once_fork_prepare_c97d8f5517fef4824426922a1b3eb9e1 {
	meta:
		aliases = "_flushlbf, hdestroy, __pthread_once_fork_parent, __pthread_once_fork_prepare"
		size = "12"
...
rule hcreate_e214931d143cca1a32199edb31adc4a0 {
	meta:
		aliases = "ether_aton, ether_ntoa, __GI_inet_ntoa, inet_ntoa, __GI_asctime, asctime, hcreate"
		size = "17"
...
rule __libc_waitpid_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		aliases = "__GI_wcstoull, wcstoull, wcstoumax, wcstouq, __GI_wcstoul, wcstoul, __GI_strtoull, strtoull, strtoumax, strtouq, __GI_strtoul, strtoul, __GI_waitpid, waitpid, __libc_waitpid"
		size = "23"
		objfiles = "strtoull@libc.a, wcstoull@libc.a, wcstoul@libc.a, strtoul@libc.a, waitpid@libc.a"
	strings:
...
rule timelocal_0410fd2bb80bbf0bc944c8d2d2133af7 {
	meta:
		...
		size = "14"
		objfiles = "mkstemp64@libc.a, mktime@libc.a, iswalnum@libc.a"
	strings:
...
rule strtol_fe8e5520a3eef7a03748f1ff8e71080f {
	meta:
		...
		size = "23"
		objfiles = "wcstol@libc.a, wcstoll@libc.a, strtoll@libc.a, strtol@libc.a"
	strings:
...
rule iswalpha_60617713272f358c39f6fe181a7829f8 {
	meta:
		aliases = "__GI_gethostbyname, gethostbyname, __GI_iswalpha, iswalpha"
		size = "14"
...
rule getgrent_b0755d037b60fb5500574f607e9b1509 {
	meta:
...
rule getgrnam_55f8a496d4b651e19d576b899468cf9d {
	meta:
		aliases = "fgetpwent, getgrgid, fgetgrent, getspnam, getpwnam, sgetspent, getpwuid, fgetspent, getgrnam"
		size = "38"
		objfiles = "getpwnam@libc.a, getgrgid@libc.a, fgetgrent@libc.a, sgetspent@libc.a, getspnam@libc.a"
	strings:
...
rule syslog_3674412569e427ab0f649983548971e5 {
	meta:
		aliases = "fwscanf, swscanf, __GI_fwprintf, fwprintf, __GI_fscanf, fscanf, __GI_sscanf, sscanf, __GI_asprintf, asprintf, dprintf, __GI_fprintf, fprintf, __GI_syslog, syslog"
		size = "28"
		objfiles = "fwscanf@libc.a, asprintf@libc.a, fscanf@libc.a, sscanf@libc.a, swscanf@libc.a"
	strings:
...
rule __libc_connect_391ad6447a9e0b5b8c769dfc035016cc {
	meta:
...
rule acosf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		...
		size = "27"
		objfiles = "logf@libm.a, erff@libm.a, log10f@libm.a, atanhf@libm.a, truncf@libm.a"
	strings:
...
rule __libc_send_07dbfb200062873ba35d40d012be56c2 {
	meta:
...
rule atan2f_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		...
		size = "35"
		objfiles = "hypotf@libm.a, scalbf@libm.a, powf@libm.a, atan2f@libm.a, fmodf@libm.a"
	strings:
...
rule rindex_bcc34327154efdfb74e18a0ac6c906cc {
	meta:
...
rule floatformat_always_valid_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		size = "6"
		objfiles = "auth_none@libc.a, floatformat@libiberty.a, _stdlib_mb_cur_max@libc.a, xdr@libc.a, oldsemaphore@libpthread.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_raw@libc.a, svc_authux@libc.a, svc_tcp@libc.a, svc_unix@libc.a, svc_udp@libc.a"
	strings:
...
rule vprintf_8656ba417f55ecd54498627fc6f064b6 {
	meta:
		aliases = "vwscanf, vwprintf, __GI_vscanf, vscanf, vprintf"
		size = "23"
		objfiles = "vwprintf@libc.a, vscanf@libc.a, vprintf@libc.a, vwscanf@libc.a"
	strings:
