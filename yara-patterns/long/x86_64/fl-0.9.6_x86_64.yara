...
rule __GI_wcswidth_9306ae589cef1e583d22806c4cc1f68a {
	meta:
...
rule __GI_strtof_3cb1ef1313d9618f38d69ea4ff44828f {
	meta:
...
rule __GI_erfc_275fba6d5001901acd25ab2188826fef {
	meta:
...
rule opendir_0c5c2fc39c5c274e8bdcf7d0004ef0c3 {
	meta:
...
rule fstat_cc894928f3bf2ad2cc69366014fc1338 {
	meta:
		aliases = "__GI_fstat, fstat64, __GI_fstat64, fstat"
		size = "82"
...
rule __GI_wcscasecmp_0ad9d37e485803e18659390d6c4f837f {
	meta:
...
rule __GI_remquo_e2c989a09f5b28aaf90f94893c3b34f3 {
	meta:
...
rule fstatat_a44cbcdf4d631b7dcd479d4e190eaca4 {
	meta:
...
rule __GI_fgetwc_5cbe594d01d37de7b04e47bc8cfb7e00 {
	meta:
...
rule __GI_getutid_318fd190641581536e04e3f35b029906 {
	meta:
...
rule __GI_ungetc_a965224ac477a14e7dc110ef44ea174b {
	meta:
...
rule __GI_xprt_register_dc33293a0491a2a17d3ec9eb5ac0a4a6 {
	meta:
...
rule __GI_clnt_sperror_eab800d32e62411fefd2368e8df992e7 {
	meta:
...
rule __GI_getmntent_r_7ec8f4ba924974a4112885f898918317 {
	meta:
...
rule __GI_pthread_getschedparam_6c69ce1cd2691830da6ce4c25bec8e9f {
	meta:
...
rule __GI_getgrent_r_682c74159ccc7457f3e7bc40c12c8a6d {
	meta:
		aliases = "getpwent_r, __GI_getpwent_r, getspent_r, __GI_getspent_r, getgrent_r, __GI_getgrent_r"
		size = "173"
...
rule __GI_svc_unregister_ea5aec2f1864be43794be61762f9d223 {
	meta:
...
rule __GI_xdr_pmaplist_24998e2acfa974889817c0725e936c86 {
	meta:
...
rule __GI_svc_getreqset_db6ad65ba65549bc107679ef7ede9434 {
	meta:
...
rule __GI_pmap_set_b29de437835aa17c8cdd3e911eb9c42e {
	meta:
...
rule __GI_getprotoent_r_458c8eddeff22ca7d7d67225af11eea5 {
	meta:
...
rule readdir_r_68e0d8674e022ae200db1850f148e77f {
	meta:
		aliases = "__GI_readdir64_r, readdir64_r, __GI_readdir_r, readdir_r"
		size = "217"
...
rule __GI_statvfs_2ab0070f3728d992991bf090f77d481f {
	meta:
...
rule __GI_strftime_aa3b1bc8286570645dc53ce2757e3ce3 {
	meta:
...
rule __GI_ttyname_r_f9d54f68fde72932b482bca1d48086ed {
	meta:
...
rule __GI_vsyslog_418d5e8ce2bc85e13729b325bfa08a42 {
	meta:
...
rule bcmp_7063472372ec2530a20570ed1c90e1cd {
	meta:
...
rule __GI_vfscanf_24901e348d1da1c6956efee386e35f41 {
	meta:
...
rule __GI_inet_ntop_76df1b8950a132654ebcbe2dd6c0602e {
	meta:
...
rule __GI_tcsetattr_18c2a17aa6c473be1bb49484f32d3b6d {
	meta:
...
rule __GI_fflush_unlocked_3768501ede607f86986e5c361dec002b {
	meta:
...
rule __GI_xdrrec_create_0b900b14bc8364e1edda25836095c352 {
	meta:
...
rule __GI_getnameinfo_4d178e2fd2df9533404ad46f464712c4 {
	meta:
...
rule getgrnam_r_4637c8554922e4eeefe27c93a1236c5c {
	meta:
		aliases = "__GI_getgrnam_r, getspnam_r, getpwnam_r, __GI_getspnam_r, __GI_getpwnam_r, getgrnam_r"
		size = "160"
...
rule regexec_dc974462233d03b819c896771cadf3df {
	meta:
...
rule __GI_gethostbyname_r_6134815e9c440d42397ff4f7a4b39c5c {
	meta:
...
rule __GI_mallinfo_7f2568bbb9e96c2413dff6c93d517b1d {
	meta:
...
rule pwrite64_2c0a2c8c89c90d8efbb22d49bc3bca89 {
	meta:
		aliases = "__libc_pwrite64, pwrite, __libc_pwrite, pwrite64"
		size = "11"
		objfiles = "pread_write@libc.a"
	strings:
...
rule pread_563e2730dde361fdbd45736f26daff64 {
	meta:
		aliases = "pread64, __libc_pread64, __libc_pread, pread"
		size = "8"
		objfiles = "pread_write@libc.a"
	strings:
...
rule __libc_recv_a9fc4c9a1d9715abba65179cb62f82e2 {
	meta:
		aliases = "__GI_send, __libc_send, __GI_recv, recv, send, __libc_recv"
		size = "11"
...
rule __GI_inet_network_89a8da4a6dfda1543ce5225220ab1747 {
	meta:
...
rule thread_self_fc567cf57d3f04fc77b3c53a5a9fe529 {
	meta:
		aliases = "thread_self"
		size = "69"
		objfiles = "pthread@libpthread.a, join@libpthread.a, rwlock@libpthread.a, condvar@libpthread.a, errno@libpthread.a"
	strings:
...
rule __GI_sigsetmask_a5d8992ca3939ad6c58262bf0af7d3c1 {
	meta:
...
rule dprintf_4f17e5776fd93321a6b366d662782192 {
	meta:
		aliases = "swscanf, sscanf, fprintf, fwprintf, fscanf, syslog, __GI_asprintf, fwscanf, __GI_fprintf, __GI_fscanf, __GI_sscanf, asprintf, __GI_syslog, dprintf"
		size = "142"
		objfiles = "dprintf@libc.a, fprintf@libc.a, swscanf@libc.a, syslog@libc.a, fscanf@libc.a"
	strings:
...
rule wscanf_e0fef7b1e267e11058ce53fdb7788479 {
	meta:
		aliases = "scanf, printf, __GI_printf, wprintf, wscanf"
		size = "157"
...
rule fputwc_unlocked_dff6ff38344fedac15f8073d0cc82306 {
	meta:
...
rule __GI_scalbln_0eaadaa55299edf3bd63e1af552ca1ba {
	meta:
...
rule __GI_scalbn_32432596dda4f9ed89726a0ebb7551fe {
	meta:
...
rule __GI_cfsetospeed_fa76ad5eb2894f9727ef8b1a2d14e2a6 {
	meta:
...
rule __GI_tcgetpgrp_9dbfbd35910cb68dcbf9e671199050cb {
	meta:
...
rule wcsnrtombs_660f8e89c21b197bd4ef9aeda284f3c6 {
	meta:
...
rule __re_search_48b88084187d753e0c48b28a3c9997ab {
	meta:
...
rule fgetpwent_5abd21e9b7de4fda56e36ae3f07cbf5b {
	meta:
		aliases = "fgetspent, getspnam, sgetspent, getpwnam, getgrnam, getgrgid, fgetgrent, getpwuid, fgetpwent"
		size = "39"
		objfiles = "getspnam@libc.a, fgetspent@libc.a, getpwnam@libc.a, getgrgid@libc.a, getpwuid@libc.a"
	strings:
...
rule __GI_mempcpy_a580c734598d06385b3712b4ad44ce11 {
	meta:
...
rule __GI_mbrlen_d52feeb84af285cb920ea268f5bb037a {
	meta:
...
rule __GI_sigprocmask_701f20587654fc5958f4746ee1f7115e {
	meta:
...
rule __GI_hdestroy_r_14bd5f46cb557fedfca2adc4e3381923 {
	meta:
...
rule __GI_strcpy_d7f2ed2a5bda2f1a4612d1410c2db50c {
	meta:
		aliases = "stpcpy, strcpy, __GI_stpcpy, __GI_strcpy"
		size = "213"
...
rule __GI_vscanf_82bf1537bdb72391a082982fc38abd5f {
	meta:
		aliases = "vwprintf, vscanf, vprintf, vwscanf, __GI_vscanf"
		size = "18"
...
rule __GI_memrchr_b3d947f00e1ec3ce210b5df3672b90ff {
	meta:
...
rule __GI_asinh_3a9afc2df0e77d12646c0afc4ed66601 {
	meta:
...
rule openat_0d084955d55182deea6d1a021f86b71a {
	meta:
...
rule __libc_lseek_3f65aa6662a7058346ff895ee6de7e6d {
	meta:
...
rule __libc_sendmsg_fc70c4357f5f95d134db2a6802889f98 {
	meta:
...
rule __GI_recvmsg_14def53d269bb5722f34f27ad2f3ed06 {
	meta:
...
rule __GI_poll_8a8ff1272ec459539e5abc5a0aa49180 {
	meta:
...
rule __GI___libc_fcntl_67c3ecc77d3ef4d4bcac028181e2197e {
	meta:
		aliases = "__libc_fcntl, fcntl64, fcntl, __GI_fcntl, __libc_fcntl64, __GI_fcntl64, __GI___libc_fcntl"
		size = "100"
...
rule __GI_dup2_ef2a7fc8c0d275bc740d0392ce6643b4 {
	meta:
...
rule __GI_listen_a5f99806bc9dc6b33609d1b4bf54c704 {
	meta:
...
rule __GI_read_c6e1fc2efc5cbff7a61083e904a45c10 {
	meta:
...
rule __GI_close_88a6d7d0f522c8d65a97dc2ff3baa692 {
	meta:
...
rule __GI_fchdir_628f5e03a5d1cc322380f56452cf44d2 {
	meta:
...
rule __GI___libc_fstatfs_af87f6abc1d4b29a536360a3decc850a {
	meta:
...
rule __GI_tanh_baeea9ed930152dc7a3a0c08680a722e {
	meta:
...
rule __regfree_888cdda41486620f0eb8138084a53f9e {
	meta:
...
rule __GI_select_eca936c475871f03a11e1f63b3193afa {
	meta:
...
rule __GI_utimensat_943c66ae647ebbd7f38e3f0fa940656a {
	meta:
...
rule __GI_connect_5c1ad78febb33d8a86da1750247a6a60 {
	meta:
...
rule __GI_ldexp_e5d9cee36ca170ed13d4d0473762960a {
	meta:
...
rule __GI_getrlimit_53abd820a7baef0175de297f4c6624c4 {
	meta:
		aliases = "getrlimit64, getrlimit, __GI_getrlimit"
		size = "39"
...
rule setrlimit_b6aa7b384ab0cd110f752e8da5f90418 {
	meta:
...
rule __GI_munmap_581cfaa042a40f4fbe4b37f97f307536 {
	meta:
...
rule __libc_pause_7f795ff181c269ac95907652e22eaf6a {
	meta:
...
rule __libc_nanosleep_d7ebdd0dd3a1c6a0846326fe08ad754d {
	meta:
...
rule __libc_fork_f1720d0c174360aed1d43b8bd114378b {
	meta:
...
rule __GI_truncate_429263e4ac6dc8aa2d4e394a7e3d15b7 {
	meta:
...
rule __GI_getuid_b5d9cf79b6eba76d3a75ecf05ae23df7 {
	meta:
...
rule __GI___libc_statfs_76811c3e5f45b690cfcb933522f1df2b {
	meta:
...
rule __GI_settimeofday_5382b4403b6f5f3bde36c3e2b4fabf73 {
	meta:
...
rule __GI_endprotoent_d7e3fd16505c9238e0851a2064f1f0bc {
	meta:
		aliases = "endservent, endprotoent, __GI_endservent, __GI_endprotoent"
		size = "90"
		objfiles = "getproto@libc.a, getservice@libc.a"
	strings:
...
rule endgrent_335155307178b13d6c68d900ad3e4402 {
	meta:
...
rule __GI_setservent_353389afcffdbe91369d812b6a0deaa9 {
	meta:
		aliases = "setservent, setprotoent, setnetent, __GI_setprotoent, __GI_setnetent, __GI_setservent"
		size = "115"
...
rule __GI_getrpcent_df8bea5513198a28018bc3ef8e3468f2 {
	meta:
...
rule __GI_strrchr_9d4984b0ebb3046048b975babcba1092 {
	meta:
...
rule __GI_erand48_r_479ae23ab5ef854bdd007efecaf3cc77 {
	meta:
...
rule __GI_glob_5e8f98256a96f83094f86bf928ed90a5 {
	meta:
		aliases = "__GI_glob64, glob64, glob, __GI_glob"
		size = "1488"
		objfiles = "glob@libc.a, glob64@libc.a"
	strings:
...
rule __GI_ruserpass_0800708dacf332078c105f6fb92c0be5 {
	meta:
...
rule __pthread_set_own_extricate_if_76da68e49fd047986d012f8c39b9f16a {
	meta:
		...
		size = "65"
		objfiles = "join@libpthread.a, condvar@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule __GI_xdr_hyper_d75816feb68ac638a377da8097fc74a9 {
	meta:
...
rule fgetpwent_r_67bf5c69defe49bb1b609a3c6bc27dcd {
	meta:
		aliases = "__GI_fgetgrent_r, fgetgrent_r, __GI_fgetspent_r, fgetspent_r, __GI_fgetpwent_r, fgetpwent_r"
		size = "43"
...
rule __GI_xdr_callmsg_08123761d2406bdb623e2a8eda74dae7 {
	meta:
...
rule __getdents_525770fb71243fbb3c5f7f0af40e7d32 {
	meta:
...
rule __GI___ns_name_ntop_ea57f76d8b93a760e5c4974c33ab9974 {
	meta:
...
rule __pthread_mutex_lock_2b570bf80064d800e67677ca7112de87 {
	meta:
...
rule bsd_signal_3e51a54835ab33f1abe6514b9646a1b8 {
	meta:
...
rule readdir_f2df44eefd066c3bf11f5fc1c63d9d6a {
	meta:
		aliases = "__GI_readdir64, __GI_readdir, readdir64, readdir"
		size = "143"
...
rule __GI_strsignal_b11c7a9b69a8587c5009cad4936dfa96 {
	meta:
...
rule pthread_mutexattr_getkind_np_bf2bcf99b78042f4e0796c0c15ef442e {
	meta:
		aliases = "__pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, __GI_pthread_attr_getdetachstate, __pthread_mutexattr_gettype, pthread_mutexattr_gettype, pthread_rwlockattr_getkind_np, pthread_mutexattr_getkind_np"
		size = "7"
...
rule pthread_attr_getscope_05935359c1ce9b131d550f05f2a33b38 {
	meta:
		aliases = "__GI_pthread_attr_getscope, sem_getvalue, __new_sem_getvalue, pthread_attr_getscope"
		size = "8"
...
rule __GI_rawmemchr_b4ed49151941069ba118aa175498e7d9 {
	meta:
...
rule __GI_strchrnul_3001fb4f11b6c04a49b985b728539567 {
	meta:
...
rule __GI_trunc_d05d2901ebf2edd69502b11b09e6a6e8 {
	meta:
...
rule __GI_ceil_a20348c4daa6850d8fd355250984902a {
	meta:
...
rule fopen_unlocked_d993b610c11b067a471e30a0ae91dd59 {
	meta:
...
rule strsigno_52387f5c0191590995ef61e0bd8f5e67 {
	meta:
...
rule cosf_76fb52706816ef3df3c8d6c20b0aa675 {
	meta:
		aliases = "fabsf, ldexpf, coshf, expm1f, expf, asinf, log2f, tanf, cbrtf, truncf, tgammaf, rintf, atanf, sinf, sqrtf, log1pf, atanhf, logbf, floorf, sinhf, exp2f, ceilf, logf, scalblnf, tanhf, scalbnf, asinhf, acosf, frexpf, acoshf, erff, roundf, lgammaf, log10f, erfcf, cosf"
		size = "19"
		objfiles = "erfcf@libm.a, ceilf@libm.a, frexpf@libm.a, sinf@libm.a, ldexpf@libm.a"
	strings:
...
rule fmodf_b655e1a82b86ef778f64370fab64b292 {
	meta:
		aliases = "hypotf, atan2f, powf, copysignf, nextafterf, remainderf, fmodf"
		size = "23"
		objfiles = "atan2f@libm.a, hypotf@libm.a, powf@libm.a, copysignf@libm.a, remainderf@libm.a"
	strings:
