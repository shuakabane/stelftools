...
rule __GI_getc_unlocked_a8c421194d2423dabb3cc9829e1d3697 {
	meta:
		aliases = "fgetc_unlocked, __GI_fgetc_unlocked, __fgetc_unlocked, __GI___fgetc_unlocked, getc_unlocked, __GI_getc_unlocked"
		size = "220"
...
rule __GI_endnetent_0d96bf4fc2561ebab2649fbb03aaf667 {
	meta:
		aliases = "endnetent, endprotoent, __GI_endprotoent, __GI_endnetent"
		size = "92"
...
rule recvmsg_f76fa2a31d5e51010722d3c9bb015e20 {
	meta:
		aliases = "msync, connect, read, write, recvmsg"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "join@libpthread.a, mutex@libpthread.a, specific@libpthread.a, signals@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetpwent_r, fgetspent_r, __GI_fgetgrent_r, fgetgrent_r, __GI_fgetspent_r, fgetpwent_r"
		size = "55"
...
rule __libc_open_d3dad7f46fcc1e13edfffe8dca3ae8ff {
	meta:
...
rule __GI_fgetwc_47b2021f9ad3c9dae34d9b79ccbd71b9 {
	meta:
		aliases = "fileno, fgetwc, getwc, __GI_fileno, __GI_fgetwc"
		size = "92"
...
rule fputwc_27a00bae78ad279095482cf1967e990f {
	meta:
		aliases = "putwc, __GI_fputs, fputs, fputws, __GI_fputws, fputwc"
		size = "95"
...
rule __GI_fwrite_6bf25374bc468acb0c81effce8a40356 {
	meta:
...
rule getpwent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "getspent_r, getgrent_r, __GI_getpwent_r, __GI_getspent_r, __GI_getgrent_r, getpwent_r"
		size = "171"
		objfiles = "getpwent_r@libc.a, getgrent_r@libc.a, getspent_r@libc.a"
	strings:
...
rule __GI_wcstoull_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "wcstoull, __libc_waitpid, __GI_waitpid, wcstouq, __GI_strtoull, __GI_wcstoul, strtoul, waitpid, wcstoumax, wcstoul, strtoull, strtouq, __GI_strtoul, strtoumax, __GI_wcstoull"
		size = "26"
...
rule strtol_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "strtoimax, __GI_wcstoll, __GI_wcstol, strtoll, wcstoimax, __GI_strtoll, wcstoll, strtoq, wcstol, __GI_strtol, wcstoq, strtol"
		size = "26"
...
rule gamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__GI_strtok, strtok, __GI_lgamma, lgamma, __ieee754_lgamma, __ieee754_gamma, gamma"
		size = "25"
...
rule wcstold_1da02766b2a304b7f969428fc4c15b06 {
	meta:
		aliases = "__GI_wcstold, strtold, __GI_strtold, wcstold"
		size = "22"
...
rule __GI_atol_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "atol, __GI_atoi, atoll, atoi, __GI_atol"
		size = "20"
...
rule ldexpf_312f3131b70190222fba14e3c3defea1 {
	meta:
		aliases = "frexpf, scalblnf, scalbnf, ldexpf"
		size = "34"
...
rule ether_ntoa_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "inet_ntoa, __GI_asctime, asctime, srand48, hcreate, __GI_inet_ntoa, ether_ntoa"
		size = "21"
		objfiles = "hsearch@libc.a, ether_addr@libc.a, srand48@libc.a, asctime@libc.a, inet_ntoa@libc.a"
	strings:
...
rule mkstemp_6bf719c25f6fbaef08052b0889ae3660 {
	meta:
		aliases = "sigpause, __GI_sigpause, atof, mkstemp"
		size = "18"
...
rule iswalnum_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "__GI_iswalnum, timelocal, mktime, mkstemp64, iswalnum"
		size = "18"
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "join@libpthread.a, rwlock@libpthread.a, pthread@libpthread.a, condvar@libpthread.a, manager@libpthread.a"
	strings:
...
rule getlogin_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__GI_getlogin, __pthread_once_fork_prepare, hdestroy, __pthread_once_fork_parent, _flushlbf, getlogin"
		size = "17"
...
rule wprintf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "scanf, __GI_printf, wscanf, printf, wprintf"
		size = "32"
...
rule __GI_syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "fwprintf, __GI_sscanf, __GI_asprintf, sscanf, fscanf, asprintf, dprintf, syslog, swscanf, __GI_fprintf, fprintf, fwscanf, __GI_fscanf, __GI_syslog"
		size = "30"
		objfiles = "fwprintf@libc.a, fwscanf@libc.a, asprintf@libc.a, sscanf@libc.a, dprintf@libc.a"
	strings:
...
rule llrintf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "lroundf, lrintf, llroundf, ilogbf, llrintf"
		size = "19"
...
rule sqrtf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "expm1f, fabsf, acoshf, expf, log10f, tgammaf, cbrtf, erff, truncf, acosf, tanf, tanhf, lgammaf, atanf, asinf, logf, sinhf, logbf, asinhf, atanhf, coshf, floorf, cosf, rintf, erfcf, log1pf, sinf, roundf, ceilf, sqrtf"
		size = "27"
		objfiles = "rintf@libm.a, erfcf@libm.a, expm1f@libm.a, coshf@libm.a, cosf@libm.a"
	strings:
...
rule copysignf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "powf, atan2f, hypotf, remainderf, nextafterf, fmodf, copysignf"
		size = "35"
		objfiles = "remainderf@libm.a, atan2f@libm.a, copysignf@libm.a, fmodf@libm.a, nextafterf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetspent, getspnam, getpwuid, getpwnam, fgetpwent, getgrnam, fgetgrent, getgrgid, sgetspent"
		size = "40"
		objfiles = "fgetspent@libc.a, fgetpwent@libc.a, getpwuid@libc.a, sgetspent@libc.a, getspnam@libc.a"
	strings:
...
rule pthread_mutexattr_gettype_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, __pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, pthread_mutexattr_gettype"
		size = "15"
