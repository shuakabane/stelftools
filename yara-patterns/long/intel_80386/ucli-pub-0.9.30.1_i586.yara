...
rule statfs_4e50f52197fe0f98bf0d418994561253 {
	meta:
...
rule __GI___libc_fstatfs_626538cf26dc5d87ceb849275f79ae92 {
	meta:
...
rule __libc_nanosleep_73e90979a3dcfd70c3a1b9915a43a160 {
	meta:
...
rule __GI_geteuid_35bb592f3cb6ad0a2ce7945ed508d73f {
	meta:
...
rule sendmsg_7fafe2d4042f052134436ac4f9e768f2 {
	meta:
		aliases = "__GI_waitpid, accept, waitpid, lseek, sendmsg"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule pthread_setcancelstate_e69152c49fe6d340d85f388edd355f68 {
	meta:
...
rule rexec_af_e9d54071fde049b4cde08fe635685162 {
	meta:
...
rule getnameinfo_8c21d5518f5b10ee342d790847c4dbb0 {
	meta:
...
rule __GI_getspnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "__GI_getgrnam_r, getspnam_r, __GI_getpwnam_r, getpwnam_r, getgrnam_r, __GI_getspnam_r"
		size = "153"
...
rule __GI___xpg_strerror_r_cff65ef553823e1a5abd20aee7fa9291 {
	meta:
...
rule __libc_longjmp_be9e6548214836180c2cfadd5a9f8fd0 {
	meta:
...
rule __GI_fgetspent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "fgetgrent_r, __GI_fgetpwent_r, fgetspent_r, fgetpwent_r, __GI_fgetgrent_r, __GI_fgetspent_r"
		size = "55"
...
rule __GI_wcswidth_990b7f1012a6f0a1507106d51fe8bec2 {
	meta:
...
rule __GI_fileno_47b2021f9ad3c9dae34d9b79ccbd71b9 {
	meta:
		aliases = "getwc, fileno, __GI_fgetwc, fgetwc, __GI_fileno"
		size = "92"
...
rule __GI_fputws_27a00bae78ad279095482cf1967e990f {
	meta:
		aliases = "__GI_fputs, fputwc, fputws, fputs, putwc, __GI_fputws"
		size = "95"
...
rule getspent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "__GI_getpwent_r, getgrent_r, getpwent_r, __GI_getgrent_r, __GI_getspent_r, getspent_r"
		size = "171"
		objfiles = "getpwent_r@libc.a, getspent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule __GI_fwrite_unlocked_3fab115914527fad40096310b76317e4 {
	meta:
...
rule strtoumax_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "__GI_wcstoul, wcstoul, wcstoull, __GI_strtoull, __GI_waitpid, __libc_waitpid, __GI_wcstoull, wcstoumax, strtoull, strtoul, waitpid, strtouq, __GI_strtoul, wcstouq, strtoumax"
		size = "26"
		objfiles = "strtoull@libc.a, wcstoull@libc.a, waitpid@libc.a, strtoul@libc.a, wcstoul@libc.a"
	strings:
...
rule wcstoq_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "__GI_strtoll, strtoll, wcstoll, wcstol, strtoimax, __GI_strtol, strtoq, __GI_wcstol, __GI_wcstoll, wcstoimax, strtol, wcstoq"
		size = "26"
...
rule gamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__GI_lgamma, lgamma, __ieee754_lgamma, __ieee754_gamma, strtok, __GI_strtok, gamma"
		size = "25"
...
rule __GI_asctime_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "hcreate, __GI_inet_ntoa, srand48, ether_ntoa, asctime, inet_ntoa, __GI_asctime"
		size = "21"
		objfiles = "hsearch@libc.a, asctime@libc.a, ether_addr@libc.a, srand48@libc.a, inet_ntoa@libc.a"
	strings:
...
rule timelocal_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "mktime, iswalnum, __GI_iswalnum, mkstemp64, timelocal"
		size = "18"
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "pthread@libpthread.a, condvar@libpthread.a, join@libpthread.a, manager@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule __GI_getlogin_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "_flushlbf, __pthread_once_fork_prepare, getlogin, hdestroy, __pthread_once_fork_parent, __GI_getlogin"
		size = "17"
...
rule wprintf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "printf, scanf, wscanf, __GI_printf, wprintf"
		size = "32"
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "fscanf, swscanf, __GI_sscanf, __GI_fprintf, sscanf, dprintf, fprintf, fwprintf, fwscanf, asprintf, __GI_fscanf, __GI_asprintf, __GI_syslog, syslog"
		size = "30"
		objfiles = "fwprintf@libc.a, fwscanf@libc.a, sscanf@libc.a, fscanf@libc.a, swscanf@libc.a"
	strings:
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		size = "19"
		objfiles = "lrintf@libm.a, llrintf@libm.a, ilogbf@libm.a, llroundf@libm.a, lroundf@libm.a"
	strings:
...
rule log10f_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "sinf, roundf, tanf, erfcf, floorf, cosf, acosf, tanhf, rintf, ceilf, atanhf, tgammaf, lgammaf, coshf, truncf, logf, cbrtf, atanf, sqrtf, acoshf, asinf, expf, asinhf, erff, log1pf, expm1f, fabsf, logbf, sinhf, log10f"
		size = "27"
		objfiles = "sinhf@libm.a, erff@libm.a, asinhf@libm.a, floorf@libm.a, tanf@libm.a"
	strings:
...
rule nextafterf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "fmodf, powf, remainderf, copysignf, atan2f, hypotf, nextafterf"
		size = "35"
		objfiles = "atan2f@libm.a, nextafterf@libm.a, copysignf@libm.a, fmodf@libm.a, powf@libm.a"
	strings:
...
rule getgrnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "getspnam, fgetspent, fgetgrent, sgetspent, getgrgid, fgetpwent, getpwuid, getpwnam, getgrnam"
		size = "40"
		objfiles = "getgrnam@libc.a, sgetspent@libc.a, getpwuid@libc.a, fgetpwent@libc.a, fgetspent@libc.a"
	strings:
...
rule thread_self_e74c8f77ff3f89dbea0e2d9a5b4c5494 {
	meta:
		aliases = "thread_self"
		size = "63"
		objfiles = "pthread@libpthread.a, condvar@libpthread.a, join@libpthread.a, errno@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule pthread_attr_getdetachstate_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, __pthread_mutexattr_getkind_np, pthread_mutexattr_gettype, pthread_mutexattr_getkind_np, pthread_attr_getdetachstate"
		size = "15"
