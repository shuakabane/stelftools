...
rule fgetc_unlocked_a8c421194d2423dabb3cc9829e1d3697 {
	meta:
		aliases = "__fgetc_unlocked, __GI_getc_unlocked, __GI_fgetc_unlocked, getc_unlocked, __GI___fgetc_unlocked, fgetc_unlocked"
		size = "220"
...
rule __GI_ilogb_c96da378650055942c79983514fda9d4 {
	meta:
...
rule sendmsg_7fafe2d4042f052134436ac4f9e768f2 {
	meta:
		aliases = "accept, __GI_waitpid, waitpid, lseek, sendmsg"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule connect_f76fa2a31d5e51010722d3c9bb015e20 {
	meta:
		aliases = "read, write, msync, recvmsg, connect"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule getpwnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "getspnam_r, __GI_getpwnam_r, getgrnam_r, __GI_getspnam_r, __GI_getgrnam_r, getpwnam_r"
		size = "153"
...
rule __GI_mbsnrtowcs_4f77dce0ece09bf25cdafcaabfe8c73c {
	meta:
...
rule fgetwc_unlocked_21bd577895234fd115521111c2dcd85e {
	meta:
...
rule __GI_nextafter_cc4eb8d44f42c856ff9168a42499711a {
	meta:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "signals@libpthread.a, mutex@libpthread.a, errno@libpthread.a, spinlock@libpthread.a, specific@libpthread.a"
	strings:
...
rule __GI___ns_name_uncompress_6eeb195eae0093de4003f6d7afd80c45 {
	meta:
...
rule __GI_sigaction_82b15281d822de0ae568ffe35db55563 {
	meta:
...
rule __GI_pthread_getschedparam_dd22a2c219c8350f3e7309bac1705749 {
	meta:
...
rule siglongjmp_be9e6548214836180c2cfadd5a9f8fd0 {
	meta:
		aliases = "__libc_longjmp, longjmp, __libc_siglongjmp, _longjmp, siglongjmp"
		size = "51"
...
rule __GI_fgetgrent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetpwent_r, fgetspent_r, __GI_fgetspent_r, fgetpwent_r, fgetgrent_r, __GI_fgetgrent_r"
		size = "55"
...
rule __GI_fileno_47b2021f9ad3c9dae34d9b79ccbd71b9 {
	meta:
		aliases = "getwc, fgetwc, fileno, __GI_fgetwc, __GI_fileno"
		size = "92"
...
rule __GI_fputws_27a00bae78ad279095482cf1967e990f {
	meta:
		aliases = "putwc, fputwc, fputws, __GI_fputs, fputs, __GI_fputws"
		size = "95"
...
rule getspent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "getpwent_r, getgrent_r, __GI_getspent_r, __GI_getpwent_r, __GI_getgrent_r, getspent_r"
		size = "171"
		objfiles = "getgrent_r@libc.a, getpwent_r@libc.a, getspent_r@libc.a"
	strings:
...
rule __GI_strtoul_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "strtoull, __GI_wcstoul, __GI_wcstoull, __GI_waitpid, wcstouq, wcstoumax, strtoul, strtoumax, waitpid, __GI_strtoull, wcstoul, __libc_waitpid, wcstoull, strtouq, __GI_strtoul"
		size = "26"
		objfiles = "wcstoull@libc.a, wcstoul@libc.a, strtoull@libc.a, waitpid@libc.a, strtoul@libc.a"
	strings:
...
rule strtoq_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "wcstoq, wcstoimax, __GI_strtol, wcstoll, strtoll, strtol, __GI_wcstol, wcstol, strtoimax, __GI_wcstoll, __GI_strtoll, strtoq"
		size = "26"
...
rule __GI_sigdelset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "__GI_sigaddset, sigaddset, sigdelset, sigismember, __GI_sigdelset"
		size = "42"
...
rule gamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__ieee754_lgamma, __GI_lgamma, __GI_strtok, lgamma, __ieee754_gamma, strtok, gamma"
		size = "25"
		objfiles = "e_lgamma@libm.a, strtok@libc.a, w_gamma@libm.a, w_lgamma@libm.a, e_gamma@libm.a"
	strings:
...
rule atol_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "__GI_atoi, __GI_atol, atoll, atoi, atol"
		size = "20"
...
rule ldexpf_312f3131b70190222fba14e3c3defea1 {
	meta:
		aliases = "scalblnf, frexpf, scalbnf, ldexpf"
		size = "34"
...
rule __GI_inet_ntoa_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "srand48, asctime, __GI_asctime, hcreate, ether_ntoa, inet_ntoa, __GI_inet_ntoa"
		size = "21"
		objfiles = "inet_ntoa@libc.a, asctime@libc.a, ether_addr@libc.a, hsearch@libc.a, srand48@libc.a"
	strings:
...
rule iswalnum_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "timelocal, mkstemp64, mktime, __GI_iswalnum, iswalnum"
		size = "18"
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "manager@libpthread.a, spinlock@libpthread.a, join@libpthread.a, condvar@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule __pthread_once_fork_prepare_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "hdestroy, getlogin, _flushlbf, __pthread_once_fork_parent, __GI_getlogin, __pthread_once_fork_prepare"
		size = "17"
...
rule __GI_syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "swscanf, __GI_asprintf, dprintf, fscanf, fwscanf, __GI_fscanf, __GI_fprintf, sscanf, fwprintf, syslog, __GI_sscanf, fprintf, asprintf, __GI_syslog"
		size = "30"
		objfiles = "asprintf@libc.a, fprintf@libc.a, fwprintf@libc.a, dprintf@libc.a, sscanf@libc.a"
	strings:
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "llroundf, ilogbf, llrintf, lrintf, lroundf"
		size = "19"
		objfiles = "llrintf@libm.a, lroundf@libm.a, llroundf@libm.a, lrintf@libm.a, ilogbf@libm.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "tgammaf, tanf, log1pf, sinf, logbf, erfcf, roundf, asinf, expf, tanhf, acoshf, atanhf, sinhf, lgammaf, ceilf, cbrtf, coshf, sqrtf, logf, log10f, cosf, expm1f, floorf, asinhf, erff, rintf, fabsf, atanf, acosf, truncf"
		size = "27"
		objfiles = "truncf@libm.a, fabsf@libm.a, atanhf@libm.a, acoshf@libm.a, logbf@libm.a"
	strings:
...
rule atan2f_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "nextafterf, fmodf, remainderf, hypotf, copysignf, powf, atan2f"
		size = "35"
		objfiles = "fmodf@libm.a, copysignf@libm.a, atan2f@libm.a, remainderf@libm.a, hypotf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetgrent, getpwnam, getpwuid, getgrgid, getgrnam, getspnam, fgetspent, fgetpwent, sgetspent"
		size = "40"
		objfiles = "getspnam@libc.a, getgrnam@libc.a, fgetspent@libc.a, getpwuid@libc.a, getgrgid@libc.a"
	strings:
...
rule __GI_pthread_attr_getdetachsta_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_rwlockattr_getkind_np, pthread_mutexattr_gettype, pthread_mutexattr_getkind_np, __pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, __pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate"
		size = "15"
