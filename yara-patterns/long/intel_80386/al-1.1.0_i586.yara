...
rule close_0f16be773a16c7f1ada0f23bb98e42f6 {
	meta:
		aliases = "system, wait, tcdrain, fsync, close"
		size = "43"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule read_7e8310e1353bbbc8133a54fecec14b99 {
	meta:
		aliases = "sendmsg, connect, recvmsg, write, lseek, waitpid, msync, accept, __GI_waitpid, read"
		size = "51"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule send_9682517cc44b317b96a763e93de956b5 {
	meta:
		aliases = "pwrite, recv, pread, epoll_wait, send"
		size = "55"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __libc_fcntl_76652a2735a2b958640d7575b4657042 {
	meta:
		aliases = "__GI_fcntl, __GI___libc_fcntl, fcntl, __libc_fcntl"
		size = "84"
		objfiles = "__syscall_fcntl@libc.a"
	strings:
...
rule getc_unlocked_51c788b0fa8040705eca5d5cfb82a5b7 {
	meta:
		aliases = "__fgetc_unlocked, fgetc_unlocked, __GI_getc_unlocked, __GI___fgetc_unlocked, __GI_fgetc_unlocked, getc_unlocked"
		size = "204"
...
rule __GI_setnetent_d93becebaefdfd2ceefb5b3142a474bd {
	meta:
		aliases = "__GI_setprotoent, setnetent, setprotoent, __GI_setnetent"
		size = "96"
...
rule setutent_11fafa420a8fa2ce780158be4170bf2c {
	meta:
		...
		size = "52"
		objfiles = "utent@libc.a, gethostent_r@libc.a"
	strings:
...
rule gethostent_r_55d6e5e11fe8bc7d6c5971c40b4b4bb8 {
	meta:
...
rule __GI_frexp_7143e11d73d4084cd27c3234d23490eb {
	meta:
...
rule __GI_vswprintf_499f2b4e3819bdd621d4c8c4ba104b9a {
	meta:
...
rule __GI_unlink_c68e1a53c37d61bae770abf08d26a239 {
	meta:
...
rule __GI_chown_bba969156cd163734669aa889b327802 {
	meta:
...
rule __libc_nanosleep_66d8ad1e996b2f0928eecec048fcd516 {
	meta:
...
rule __GI_setregid_eae054507792e0edb5b8681e09bf0f12 {
	meta:
...
rule __GI___uc_malloc_8f32e0da30d8125e51bb3d721e8b83e0 {
	meta:
...
rule __GI_jrand48_r_cd005c97c51685bfd3ed5b1a1e13b05d {
	meta:
...
rule __GI_sigsuspend_c132e4879a3e7c4f009823f03272ce77 {
	meta:
...
rule __GI_fstatvfs_baaf9c470f4da22b2025dc23c9f1ab8e {
	meta:
		aliases = "statvfs, __GI_statvfs, fstatvfs, __GI_fstatvfs"
		size = "644"
...
rule vfwscanf_c1dc7dfeba75c8dd0f8197ac99985fb2 {
	meta:
...
rule getdelim_073834abe671506281c015c95df6070b {
	meta:
...
rule __GI_hsearch_r_e28b32c9f73609be3432f95e4ef1452b {
	meta:
...
rule __ieee754_remainder_64042736c9c48070529e5a6399904eaf {
	meta:
		aliases = "remainder, drem, __GI_remainder, __ieee754_remainder"
		size = "343"
...
rule __GI_fmod_bb6cbd1196062eec618f60a42babd54c {
	meta:
...
rule __GI_getaddrinfo_ec970c6bcb0f0db4b9ea28ebe679d68a {
	meta:
...
rule getpwuid_r_bd71f4213c840b6491270d73c0492b51 {
	meta:
		aliases = "__GI_getpwuid_r, __GI_getgrgid_r, getgrgid_r, getpwuid_r"
		size = "127"
...
rule __GI_getspnam_r_58c1fbfb60120a75998e512e626f63ff {
	meta:
		aliases = "__GI_getgrnam_r, getspnam_r, getgrnam_r, __GI_getpwnam_r, getpwnam_r, __GI_getspnam_r"
		size = "135"
...
rule thread_self_4d574e5856a30bb564cca31edbbe6aeb {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "cancel@libpthread.a, semaphore@libpthread.a, join@libpthread.a, mutex@libpthread.a, condvar@libpthread.a"
	strings:
...
rule __GI_sigwaitinfo_1303058ecda4e833738dce0b70cef66e {
	meta:
...
rule __GI_putc_unlocked_41f491c81c0dc935d6f1b2b6a74edb56 {
	meta:
		aliases = "__GI___fputc_unlocked, putc_unlocked, __fputc_unlocked, fputc_unlocked, __GI_fputc_unlocked, __GI_putc_unlocked"
		size = "181"
...
rule fgetgrent_r_867a2d8b3238f5fbc1223b818c9f02c6 {
	meta:
		aliases = "fgetpwent_r, fgetspent_r, __GI_fgetgrent_r, __GI_fgetpwent_r, __GI_fgetspent_r, fgetgrent_r"
		size = "51"
...
rule __libc_siglongjmp_7d28f6943d4fb5439b29a882aee6266a {
	meta:
		aliases = "_longjmp, siglongjmp, __libc_longjmp, longjmp, __libc_siglongjmp"
		size = "45"
...
rule ftell_33f7bc8996c82d515dcb10a3c1bd2801 {
	meta:
...
rule __GI_sigprocmask_f728ab3da42a3e78a7f5cd79500cdcab {
	meta:
...
rule __GI_fgetwc_0a75ddc87c4aea60d140217f8ec57027 {
	meta:
		aliases = "fgetwc, getwc, __GI_fileno, fileno, __GI_fgetwc"
		size = "88"
...
rule fputs_86b4d74f9690b5f44470619e581c4d7e {
	meta:
		aliases = "fputwc, putwc, __GI_fputs, fputws, __GI_fputws, fputs"
		size = "93"
...
rule __GI_fputc_14eaaea6263612e6e05d80dd2179b2b4 {
	meta:
		aliases = "fputc, __GI_putc, putc, __GI_fputc"
		size = "135"
...
rule __GI_fgets_304b1b2126f2cca456100d94eda2de43 {
	meta:
...
rule fread_85c852565cd287354c8d6fba48cb7fae {
	meta:
		aliases = "__GI_fread, __GI_fwrite, fwrite, fread"
		size = "102"
...
rule __GI_getgrent_r_343fc5878297abdfbd7a84dc38cc5e15 {
	meta:
		aliases = "__GI_getpwent_r, getpwent_r, getspent_r, getgrent_r, __GI_getspent_r, __GI_getgrent_r"
		size = "161"
		objfiles = "getspent_r@libc.a, getgrent_r@libc.a, getpwent_r@libc.a"
	strings:
...
rule __GI_remove_4b1c7930347cb901867647a027b6a839 {
	meta:
...
rule __GI_statfs64_095fbf9f6896701eec527ee6f92d8102 {
	meta:
		aliases = "fstatfs64, __GI_fstatfs64, statfs64, __GI_statfs64"
		size = "155"
...
rule __libc_select_e66bc1121c5404ac1a39196e83f9475a {
	meta:
...
rule __GI_localtime_561e289bbb8d25a3dda9354419d8108d {
	meta:
		aliases = "localtime, seed48, __GI_localtime"
		size = "22"
...
rule asctime_e214931d143cca1a32199edb31adc4a0 {
	meta:
		aliases = "hcreate, __GI_inet_ntoa, ether_ntoa, inet_ntoa, __GI_asctime, ether_aton, asctime"
		size = "17"
		objfiles = "ether_addr@libc.a, hsearch@libc.a, asctime@libc.a, inet_ntoa@libc.a"
	strings:
...
rule __ieee754_lgamma_ce767ada53bd455cecd0660edb8a7c87 {
	meta:
		aliases = "strtok, __GI_strtok, lgamma, __GI_lgamma, gamma, __ieee754_lgamma"
		size = "22"
...
rule strtoumax_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		aliases = "strtouq, strtoul, __libc_waitpid, strtoull, wcstouq, wcstoumax, wcstoul, wcstoull, __GI_strtoul, waitpid, __GI_waitpid, strtoumax"
		size = "23"
		objfiles = "waitpid@libc.a, wcstoull@libc.a, strtoull@libc.a, wcstoul@libc.a, strtoul@libc.a"
	strings:
...
rule iswalnum_0410fd2bb80bbf0bc944c8d2d2133af7 {
	meta:
		aliases = "timelocal, mktime, __GI_iswalnum, iswalnum"
		size = "14"
...
rule wcstoll_fe8e5520a3eef7a03748f1ff8e71080f {
	meta:
		aliases = "__GI_strtoll, strtoq, strtol, strtoimax, __GI_strtol, wcstoq, wcstol, strtoll, wcstoimax, wcstoll"
		size = "23"
...
rule atoi_40657ce09f1f30b9225c7cb14e45ae11 {
	meta:
		aliases = "__GI_atoi, atoll, atol, atoi"
		size = "17"
...
rule fgetgrent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		aliases = "getpwuid, fgetpwent, getgrnam, fgetspent, getpwnam, getgrgid, getspnam, sgetspent, fgetgrent"
		size = "38"
		objfiles = "getpwnam@libc.a, getpwuid@libc.a, sgetspent@libc.a, fgetspent@libc.a, getgrgid@libc.a"
	strings:
...
rule __GI_inet_makeaddr_958d5a1e238fe469627f7e5194277b96 {
	meta:
...
rule __GI_printf_d49bdeb5a2c59b42a4876d324b1f6480 {
	meta:
		aliases = "printf, wprintf, wscanf, scanf, __GI_printf"
		size = "30"
...
rule fwprintf_3674412569e427ab0f649983548971e5 {
	meta:
		aliases = "__GI_sscanf, __GI_asprintf, __GI_syslog, sscanf, asprintf, fwscanf, fprintf, __GI_fscanf, dprintf, syslog, __GI_fprintf, fscanf, swscanf, fwprintf"
		size = "28"
		objfiles = "asprintf@libc.a, fwprintf@libc.a, dprintf@libc.a, sscanf@libc.a, fscanf@libc.a"
	strings:
...
rule __GI_wcstof_8a2523e8a23a59f0c88500a8ca4cd794 {
	meta:
		aliases = "wcstof, strtof, __GI_strtof, __GI_wcstof"
		size = "49"
...
rule roundf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		aliases = "erfcf, tanhf, gammaf, asinhf, floorf, log2f, asinf, rintf, logbf, exp2f, atanhf, lgammaf, significandf, expm1f, acosf, sqrtf, erff, tanf, coshf, sinhf, ceilf, cosf, log1pf, logf, expf, atanf, acoshf, log10f, cbrtf, fabsf, truncf, sinf, roundf"
		size = "27"
		objfiles = "tanhf@libm.a, fabsf@libm.a, coshf@libm.a, sinhf@libm.a, gammaf@libm.a"
	strings:
...
rule __GI_send_07dbfb200062873ba35d40d012be56c2 {
	meta:
...
rule hypotf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		aliases = "powf, atan2f, scalbf, fmodf, remainderf, copysignf, hypotf"
		size = "35"
		objfiles = "remainderf@libm.a, hypotf@libm.a, atan2f@libm.a, copysignf@libm.a, powf@libm.a"
	strings:
...
rule scalb_a340ad76e482c8ea690866034d72d342 {
	meta:
...
rule __GI_isatty_c0d5cefd87942a2fcd3a963af3b5ee17 {
	meta:
...
rule __GI_ntohs_abb47f3111edd8b51bf0127264a91b58 {
	meta:
		aliases = "htons, ntohs, __GI_htons, __GI_ntohs"
		size = "12"
...
rule pthread_mutexattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__pthread_mutexattr_gettype, pthread_mutexattr_gettype, pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, __pthread_mutexattr_getkind_np, __GI_pthread_attr_getdetachstate, pthread_mutexattr_getkind_np"
		size = "15"
...
rule __new_sem_getvalue_bf01487b64a973dd33d77632c300357d {
	meta:
		aliases = "__GI_pthread_attr_getschedparam, pthread_attr_getschedparam, sem_getvalue, __new_sem_getvalue"
		size = "16"
...
rule ffsl_a33b31de334684ae134e31ce0e92ecf8 {
	meta:
		aliases = "ffs, __GI_ffs, ffsl"
		size = "65"
		objfiles = "ffs@libc.a"
	strings:
...
rule drand48_r_b3aacb3ccfb17d803b012961cc545010 {
	meta:
...
rule sigaddset_016a84adaadaa75b24de597e41b23cce {
	meta:
		aliases = "sigismember, sigdelset, __GI_sigdelset, __GI_sigaddset, sigaddset"
		size = "33"
...
rule __GI_towupper_48138e3d9f8c60c2c473cafe14662f16 {
	meta:
		aliases = "towlower, towupper, __GI_towlower, __GI_towupper"
		size = "21"
...
rule __GI_toupper_d7d4521aee6b4c2c35428947fe099a90 {
	meta:
		aliases = "__GI_tolower, toupper, tolower, __GI_toupper"
		size = "29"
...
rule __GI_srand48_r_959dec397fbe0727d98d1139b954def5 {
	meta:
...
rule lrintf_f5f2daa96b9e124cf33f93c469bdf2db {
	meta:
		...
		size = "18"
		objfiles = "lroundf@libm.a, ilogbf@libm.a, lrintf@libm.a"
	strings:
