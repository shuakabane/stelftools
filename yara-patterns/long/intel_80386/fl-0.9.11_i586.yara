...
rule __GI_fgetc_unlocked_a8c421194d2423dabb3cc9829e1d3697 {
	meta:
		aliases = "__fgetc_unlocked, __GI___fgetc_unlocked, getc_unlocked, fgetc_unlocked, __GI_getc_unlocked, __GI_fgetc_unlocked"
		size = "220"
...
rule sendmsg_7fafe2d4042f052134436ac4f9e768f2 {
	meta:
		aliases = "accept, waitpid, lseek, __GI_waitpid, sendmsg"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule connect_f76fa2a31d5e51010722d3c9bb015e20 {
	meta:
		aliases = "recvmsg, read, write, msync, connect"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule getpwnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "getspnam_r, __GI_getpwnam_r, __GI_getspnam_r, getgrnam_r, __GI_getgrnam_r, getpwnam_r"
		size = "153"
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "pthread@libpthread.a, condvar@libpthread.a, specific@libpthread.a, cancel@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule longjmp_be9e6548214836180c2cfadd5a9f8fd0 {
	meta:
		aliases = "__libc_longjmp, _longjmp, __libc_siglongjmp, siglongjmp, longjmp"
		size = "51"
...
rule fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetpwent_r, __GI_fgetspent_r, __GI_fgetgrent_r, fgetspent_r, fgetgrent_r, fgetpwent_r"
		size = "55"
...
rule __GI_putc_unlocked_3285cd6d795474f19a1a1b20ef0fa5ce {
	meta:
		aliases = "__fputc_unlocked, __GI___fputc_unlocked, putc_unlocked, fputc_unlocked, __GI_putc_unlocked"
		size = "197"
...
rule fputwc_27a00bae78ad279095482cf1967e990f {
	meta:
		aliases = "putwc, __GI_fputs, fputs, __GI_fputws, fputws, fputwc"
		size = "95"
...
rule __GI_getgrent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "__GI_getpwent_r, getpwent_r, __GI_getspent_r, getgrent_r, getspent_r, __GI_getgrent_r"
		size = "171"
		objfiles = "getspent_r@libc.a, getgrent_r@libc.a, getpwent_r@libc.a"
	strings:
...
rule wcstoull_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "__GI_strtoull, __GI_strtoul, wcstoul, waitpid, wcstoumax, strtouq, strtoul, __libc_waitpid, strtoumax, strtoull, __GI_waitpid, __GI_wcstoul, __GI_wcstoull, wcstouq, wcstoull"
		size = "26"
		objfiles = "wcstoull@libc.a, waitpid@libc.a, strtoull@libc.a, wcstoul@libc.a, strtoul@libc.a"
	strings:
...
rule wcstoq_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "__GI_wcstoll, wcstoll, __GI_strtol, wcstoimax, wcstol, __GI_wcstol, __GI_strtoll, strtol, strtoll, strtoq, strtoimax, wcstoq"
		size = "26"
...
rule __GI_sigaddset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "__GI_sigdelset, sigaddset, sigdelset, sigismember, __GI_sigaddset"
		size = "42"
...
rule __GI_strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__ieee754_lgamma, lgamma, strtok, __ieee754_gamma, __GI_lgamma, gamma, __GI_strtok"
		size = "25"
		objfiles = "w_gamma@libm.a, e_lgamma@libm.a, w_lgamma@libm.a, strtok@libc.a, e_gamma@libm.a"
	strings:
...
rule vscanf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "vprintf, vwscanf, __GI_vscanf, vwprintf, vscanf"
		size = "26"
...
rule __GI_inet_ntoa_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "inet_ntoa, __GI_asctime, hcreate, asctime, srand48, ether_ntoa, __GI_inet_ntoa"
		size = "21"
...
rule mktime_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "__GI_iswalnum, iswalnum, timelocal, mkstemp64, mktime"
		size = "18"
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "manager@libpthread.a, pthread@libpthread.a, condvar@libpthread.a, semaphore@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule __GI_printf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "printf, wscanf, wprintf, scanf, __GI_printf"
		size = "32"
...
rule __GI_sscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "fwscanf, fwprintf, dprintf, __GI_asprintf, syslog, fscanf, swscanf, __GI_fscanf, sscanf, __GI_fprintf, fprintf, asprintf, __GI_syslog, __GI_sscanf"
		size = "30"
		objfiles = "fwscanf@libc.a, swscanf@libc.a, asprintf@libc.a, fscanf@libc.a, fwprintf@libc.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "sqrtf, log1pf, rintf, cosf, exp2f, log2f, expf, logf, tgammaf, acoshf, atanf, asinf, erff, ceilf, tanf, roundf, logbf, asinhf, erfcf, lgammaf, atanhf, floorf, sinf, acosf, expm1f, cbrtf, sinhf, log10f, fabsf, tanhf, coshf, truncf"
		size = "27"
		objfiles = "log10f@libm.a, coshf@libm.a, cbrtf@libm.a, erff@libm.a, truncf@libm.a"
	strings:
...
rule fmodf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "copysignf, powf, hypotf, atan2f, nextafterf, remainderf, fmodf"
		size = "35"
		objfiles = "atan2f@libm.a, powf@libm.a, remainderf@libm.a, fmodf@libm.a, nextafterf@libm.a"
	strings:
...
rule fgetpwent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetspent, getpwuid, sgetspent, getgrgid, fgetgrent, getpwnam, getgrnam, getspnam, fgetpwent"
		size = "40"
		objfiles = "fgetgrent@libc.a, getgrgid@libc.a, getgrnam@libc.a, sgetspent@libc.a, getspnam@libc.a"
	strings:
...
rule __pthread_mutexattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__GI_pthread_attr_getdetachstate, pthread_attr_getdetachstate, __pthread_mutexattr_gettype, pthread_mutexattr_gettype, pthread_mutexattr_getkind_np, pthread_rwlockattr_getkind_np, __pthread_mutexattr_getkind_np"
		size = "15"
