...
rule thread_self_c490e55fdc4e0d42e26befc1658d19a1 {
	meta:
		aliases = "thread_self"
		size = "63"
		objfiles = "signals@libpthread.a, spinlock@libpthread.a, condvar@libpthread.a, rwlock@libpthread.a, specific@libpthread.a"
	strings:
...
rule tanh_057b5f11ac3e237f5e490f64f5e43124 {
	meta:
...
rule __GI_chmod_5dbe4bc3c3f46328e4caab444a5f62b7 {
	meta:
...
rule __GI_ftruncate_4449a9234ea60ad1ba38d1631f9127c0 {
	meta:
...
rule __GI_statfs_fe4c4ed6da0f7c02e800f2646b568a0e {
	meta:
...
rule __libc_nanosleep_5abb4c31fc964b91fb91c97a7bf7befd {
	meta:
...
rule __GI_setregid_887898ed031c14fee3eaaada59b906c3 {
	meta:
...
rule getgroups_f614a02aafaabc42bb8125e364465ccf {
	meta:
...
rule fork_9d8a7d9235dcf23dd24b00a08a33a462 {
	meta:
...
rule __libc_getpid_b7da2aa04fd95ef682539c9dfe64e8b8 {
	meta:
...
rule __GI_setsid_493034b74e295e7beb7e87a46e5c8ab4 {
	meta:
...
rule geteuid_5302c694997bfa5dadb0ea9a6eb18173 {
	meta:
...
rule __GI_tan_b1cdddae498d1812f5b25646a8611d13 {
	meta:
...
rule __GI_fgetc_unlocked_7234bf2292c7e7a4e6fb4c246bfcefbf {
	meta:
		aliases = "getc_unlocked, __GI___fgetc_unlocked, __fgetc_unlocked, __GI_getc_unlocked, fgetc_unlocked, __GI_fgetc_unlocked"
		size = "220"
...
rule __GI_endprotoent_f468964b8937d2560c1930edef041633 {
	meta:
		aliases = "__GI_endnetent, __GI_endservent, endnetent, endprotoent, endservent, __GI_endprotoent"
		size = "92"
...
rule __GI_fesetenv_be7e77f0b2ec56bfe4b193852bb1638d {
	meta:
...
rule lseek_74030486c498b35deba130245259f53b {
	meta:
		aliases = "waitpid, accept, sendmsg, __GI_waitpid, lseek"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule write_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "recvmsg, read, msync, connect, write"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule send_a442f4706a8c29f1a18c27f8c866616e {
	meta:
		aliases = "recv, pwrite, pread, send"
		size = "60"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule pthread_setcancelstate_0e90322326fea79db1acaf55b49a3d30 {
	meta:
...
rule __GI_pthread_setcanceltype_2ab64cb6e58039f6b0c4441eab1468b3 {
	meta:
...
rule strptime_9e8985a0e125843cad1c001dd5681e95 {
	meta:
...
rule __register_frame_info_table_d6106f15d97437adc9bd5bc1f810eb70 {
	meta:
...
rule __GI_svc_getreq_poll_b8fb88bf1c4f323668e2554da915edf8 {
	meta:
...
rule __GI_readdir_r_a1e3d359e4935e213fe3d6c607f2383d {
	meta:
...
rule readdir64_r_1081932f71761a7c9b925af6dec6feaa {
	meta:
...
rule fstatvfs64_4fcd95d4af1b8b6f04289615985784f8 {
	meta:
...
rule rexec_af_d65828ce36a7f502c65d3d112098d469 {
	meta:
...
rule __GI_getnameinfo_4464fb2a94e9d35b9537a71baa450817 {
	meta:
...
rule ttyname_r_b67758bbd87c205045f397375ed19a61 {
	meta:
...
rule strstr_8aa0dcfaf4a28834acfc382fd4103606 {
	meta:
...
rule __GI_scalbn_09d86b090a113c76126922fc9c726d6a {
	meta:
...
rule initstate_r_245e83a5aaed6a26234e73e8fa0b6a51 {
	meta:
...
rule __GI_lround_fd6babc83b846fcfebec17d0e0a1ed2a {
	meta:
...
rule __GI_getprotoent_r_30f943bff0b17d0122101642dfeada22 {
	meta:
...
rule __GI_setvbuf_987f9c64ca2562b9be128f300402911a {
	meta:
...
rule __GI_ungetwc_99a5fecd4bdbb039b30d3d9110e8dcc1 {
	meta:
...
rule ungetc_ef663f044abdb103b734f62199046d9a {
	meta:
...
rule __GI_getservbyport_r_3087e643530881b728d39a7439a46fa9 {
	meta:
...
rule __GI_nextafter_8791e6aae0a553879b0543670fbf76ab {
	meta:
...
rule __GI_inet_pton_c28fb113b85b11e1a85f35d981f0a142 {
	meta:
...
rule __GI_modf_6ac0c605cb477bb59a41e698d40f7385 {
	meta:
...
rule __GI_clntunix_create_8e8e7cd32e8438b30dc3601ddeb68a94 {
	meta:
...
rule strerror_r_da1818b2da809f0679c2f8e4e838042c {
	meta:
...
rule clntudp_bufcreate_053b6a384d7bd37a706435229d702ff2 {
	meta:
...
rule cbrt_15d3d983023c19007482a0886c3ad2a0 {
	meta:
...
rule inet_ntop_47fee9c6f5ddbb88c424dd079f983a04 {
	meta:
...
rule __GI_gethostbyaddr_r_05eec8fffbf98d8fd0998a7a4c1156c7 {
	meta:
...
rule strftime_5fbc2d0f01c9ab6a983ddbe5d097e176 {
	meta:
...
rule ruserpass_7c19c8c5dac6380d9e4e3b7c019fb259 {
	meta:
...
rule __GI_sigaction_1fcdb0492ecb4a35c05c89da6e6e7dd2 {
	meta:
...
rule memrchr_83fb48196ea9fce60c609d30b79a18fb {
	meta:
...
rule __pthread_attr_setguardsize_45e2d246f736eed8f7ba828df405e17a {
	meta:
...
rule __GI_fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "fgetspent_r, __GI_fgetgrent_r, fgetpwent_r, fgetgrent_r, __GI_fgetspent_r, __GI_fgetpwent_r"
		size = "55"
...
rule __GI_xdr_u_hyper_fe6ce849cf8dcbb3b49467d2a0b317df {
	meta:
...
rule __fputc_unlocked_8f40897f050da839500afb25c4130c6b {
	meta:
		aliases = "__GI_putc_unlocked, __GI___fputc_unlocked, putc_unlocked, fputc_unlocked, __fputc_unlocked"
		size = "187"
...
rule readdir_ea2e9ae48785e171964cd9b74970761b {
	meta:
...
rule __GI_copysign_50de29ca81b8f9e15f59ed6d22023fbf {
	meta:
...
rule log1p_87977e40518325bb3ef1d71ad377bd5b {
	meta:
...
rule __GI_frexp_c7abcb398bc2d80f3cddd8ba50d96c4d {
	meta:
...
rule __GI_lseek64_15f8f44765d19bb5fec6920960413a45 {
	meta:
...
rule __GI_xdr_string_2ae6c9cd4e118597eb367b68bdaef814 {
	meta:
...
rule fgetwc_d1aff121aa302794d76ffd1091af3fc3 {
	meta:
		aliases = "fileno, __GI_fgetwc, getwc, __GI_fileno, fgetwc"
		size = "92"
...
rule __GI_putc_5cbbfd0580f428cba5f80ac4f86f73d5 {
	meta:
...
rule fputs_656d0461fb753b5b2210fd391d402010 {
	meta:
		aliases = "putwc, __GI_fputws, fputwc, __GI_fputs, fputws, fputs"
		size = "95"
...
rule __GI_getpwent_r_d8fe13829bbc6de00d0924445c5077f8 {
	meta:
		aliases = "__GI_getgrent_r, getgrent_r, getpwent_r, getspent_r, __GI_getspent_r, __GI_getpwent_r"
		size = "171"
		objfiles = "getgrent_r@libc.a, getspent_r@libc.a, getpwent_r@libc.a"
	strings:
...
rule mknod_5ca62fb42469489dd6b2bfe5e7be44da {
	meta:
...
rule __GI_splice_9062480e102a82398dfcc2908c667bc0 {
	meta:
...
rule close_0b461328d02cf4abf607f4f99475e435 {
	meta:
...
rule __GI_alarm_a5f558934c6d1d53eea1d3de6839af99 {
	meta:
...
rule pipe_13ac064fe910e4b6be1f754bfb2b14e6 {
	meta:
...
rule ntp_adjtime_7833bc4c95b9e8212f0646ee27c5fcf4 {
	meta:
...
rule __GI_execve_9f5c5ef7099e75b3c17060e30967a57e {
	meta:
...
rule __libc_writev_4e3cdeed5c3f24f7adab865639c344d0 {
	meta:
...
rule __libc_poll_c3a743a93f3238f74f7f7e6034acecd8 {
	meta:
...
rule chown_e2c33e758f0ac17baf108fce1fcffe06 {
	meta:
...
rule wcstoul_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "strtoul, waitpid, strtoull, strtouq, __GI_strtoul, __GI_wcstoul, strtoumax, __GI_wcstoull, wcstoull, wcstoumax, __GI_strtoull, __GI_waitpid, __libc_waitpid, wcstouq, wcstoul"
		size = "26"
		objfiles = "wcstoul@libc.a, wcstoull@libc.a, strtoull@libc.a, waitpid@libc.a, strtoul@libc.a"
	strings:
...
rule __GI_strtoll_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "wcstoq, wcstol, strtoimax, __GI_wcstoll, __GI_strtol, strtoq, __GI_wcstol, strtol, wcstoll, strtoll, wcstoimax, __GI_strtoll"
		size = "26"
...
rule sigismember_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "__GI_sigaddset, __GI_sigdelset, sigdelset, sigaddset, sigismember"
		size = "42"
...
rule __GI_lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "strtok, __GI_strtok, gamma, __ieee754_gamma, __ieee754_lgamma, lgamma, __GI_lgamma"
		size = "25"
...
rule vprintf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "__GI_vscanf, vwscanf, vscanf, vwprintf, vprintf"
		size = "26"
...
rule asctime_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "__GI_asctime, srand48, __GI_inet_ntoa, hcreate, inet_ntoa, ether_ntoa, asctime"
		size = "21"
		objfiles = "ether_addr@libc.a, asctime@libc.a, hsearch@libc.a, inet_ntoa@libc.a, srand48@libc.a"
	strings:
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "manager@libpthread.a, spinlock@libpthread.a, condvar@libpthread.a, rwlock@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule __pthread_once_fork_prepare_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "hdestroy, __pthread_once_fork_parent, getlogin, _flushlbf, __GI_getlogin, __pthread_once_fork_prepare"
		size = "17"
...
rule scanf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "__GI_printf, wscanf, wprintf, printf, scanf"
		size = "32"
...
rule __GI_fscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "syslog, __GI_asprintf, __GI_sscanf, swscanf, dprintf, fwscanf, __GI_fprintf, fprintf, asprintf, sscanf, __GI_syslog, fwprintf, fscanf, __GI_fscanf"
		size = "30"
		objfiles = "fprintf@libc.a, asprintf@libc.a, fscanf@libc.a, fwscanf@libc.a, swscanf@libc.a"
	strings:
...
rule llroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "llrintf, lrintf, ilogbf, lroundf, llroundf"
		size = "19"
		objfiles = "lrintf@libm.a, llrintf@libm.a, lroundf@libm.a, llroundf@libm.a, ilogbf@libm.a"
	strings:
...
rule tanf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "truncf, asinf, sinf, atanhf, asinhf, erff, acoshf, expf, floorf, tanhf, ceilf, coshf, logbf, fabsf, cbrtf, sinhf, erfcf, cosf, rintf, lgammaf, expm1f, sqrtf, logf, log1pf, roundf, log10f, acosf, tgammaf, atanf, tanf"
		size = "27"
		objfiles = "acoshf@libm.a, tanhf@libm.a, tanf@libm.a, asinhf@libm.a, lgammaf@libm.a"
	strings:
...
rule nextafterf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "powf, hypotf, fmodf, remainderf, copysignf, atan2f, nextafterf"
		size = "35"
		objfiles = "atan2f@libm.a, fmodf@libm.a, powf@libm.a, copysignf@libm.a, hypotf@libm.a"
	strings:
...
rule fmin_943c1f59024ecc2993b9d7c0defc2e99 {
	meta:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "getgrgid, getpwnam, fgetgrent, getpwuid, fgetpwent, fgetspent, getspnam, getgrnam, sgetspent"
		size = "40"
		objfiles = "getgrgid@libc.a, getspnam@libc.a, sgetspent@libc.a, getpwuid@libc.a, getgrnam@libc.a"
	strings:
...
rule pthread_attr_getdetachstate_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, pthread_rwlockattr_getkind_np, __GI_pthread_attr_getdetachstate, pthread_mutexattr_gettype, pthread_attr_getdetachstate"
		size = "15"
...
rule __GI___isinff_3008b927f3adc9ce70ecb6608f718f86 {
	meta:
