...
rule __ieee754_hypot_40d6dc07de69a88c5b186729e931aed9 {
	meta:
...
rule close_593d4632d655ae75a9db77d772cf7bf1 {
	meta:
		aliases = "fsync, system, wait, tcdrain, close"
		size = "43"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule accept_966d33990ea41d94ea545ad487f15973 {
	meta:
		aliases = "__GI_waitpid, read, recvmsg, msync, sendmsg, write, lseek, connect, waitpid, accept"
		size = "51"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule pread_c2940d127b00fb25b0bbd004ee5c830a {
	meta:
...
rule __GI_xdr_bool_1c35d36f053432b6ea9a4b980595b137 {
	meta:
...
rule __GI_fgetc_unlocked_e8150f2fa63846a8bbb3e1cc896ad04e {
	meta:
		aliases = "__fgetc_unlocked, fgetc_unlocked, __GI___fgetc_unlocked, getc_unlocked, __GI_getc_unlocked, __GI_fgetc_unlocked"
		size = "204"
...
rule endservent_72360ebb209b9039bf09d12a444ae7a0 {
	meta:
		aliases = "__GI_endservent, endnetent, __GI_endnetent, endservent"
		size = "83"
...
rule gethostent_r_a1f7ac782fa93fc501e73f54459eaddf {
	meta:
...
rule __libc_system_8ecfb275c1be1db014de920f648b5dda {
	meta:
...
rule __GI_ilogb_38b607259ad31840eb96d47d29da359e {
	meta:
...
rule __GI_cosh_ece81f619972620e9478be34f630f9bf {
	meta:
...
rule __GI_getttyent_faf727a10ead25314f426547b218d9fc {
	meta:
...
rule __GI_scalbln_8d78df67fdb38402e3327549072edb4c {
	meta:
...
rule __ieee754_log10_aa3d9dc5089043dd544c7c0247a10399 {
	meta:
...
rule __GI_stat_1511767dc3e599aaacf5d934dfa6799e {
	meta:
...
rule __GI_vswscanf_2381d69cf8516d10586081e8ee335d36 {
	meta:
...
rule __GI_stat64_3db0bbef9b7d109dcf13513208beb270 {
	meta:
...
rule imaxabs_7e56ecd29126203efd64d0b46dd8d488 {
	meta:
...
rule mq_receive_8810fe4c8dbaf93db0b2807cdd400643 {
	meta:
...
rule __libc_sigsuspend_4a19b92285673d68e6e8c9d1d53a1e18 {
	meta:
...
rule __GI___fsetlocking_4741a05d9e8a78091574276d70fc3a85 {
	meta:
...
rule __GI_towctrans_7d275e5480f892f2a597f49e4380823a {
	meta:
...
rule __GI___cmsg_nxthdr_724519eda3349abcc503a059a1241534 {
	meta:
...
rule __GI_jrand48_r_83d71c2efab5bd20099a70fdf8bf06fd {
	meta:
...
rule __GI_wmempcpy_09e02fba98b8369af5caa50aad44449f {
	meta:
...
rule __GI_svc_getreq_common_57a0d413456f44295f1efe192c17507c {
	meta:
...
rule __GI_fstatvfs_df3c1346be5dc07be898b02e33405ccf {
	meta:
		aliases = "__GI_statvfs, fstatvfs, statvfs, __GI_fstatvfs"
		size = "644"
...
rule vsyslog_3ae5b9dea30b08ffafccb3d04b5ba5f9 {
	meta:
...
rule __GI_authunix_create_afba51aa8e9a1832bb13d64745718585 {
	meta:
...
rule __GI_pow_211572ad36c9bb18e72d21d2bca46c61 {
	meta:
...
rule __GI_vfscanf_4e5c57fd2debd4b6493df6d3145749e7 {
	meta:
...
rule __GI_vfwscanf_ddfe785c3d138f245179b8f80bd3178a {
	meta:
...
rule __fork_fdb6b782f0184581cdaeeb68511b8f25 {
	meta:
		aliases = "fork, __fork"
		size = "218"
		objfiles = "ptfork@libpthread.a"
...
rule __GI_fread_unlocked_843501bd2ccb359faa555e3f57215150 {
	meta:
...
rule __GI_svc_unregister_d12f76dbae7c6bc6ffa0d970a721e4ef {
	meta:
...
rule __GI_xdr_rmtcall_args_8449496508876ae113a9be21674f9594 {
	meta:
...
rule __GI_qsort_b8cdef38fcdabb15ffed29015421d2f4 {
	meta:
...
rule __GI_xdrrec_create_ef55de97bb256a55e86c16813db6f8c1 {
	meta:
...
rule __GI_srandom_r_7c19d8c8f71e7f45238ef7aa61bdecc2 {
	meta:
...
rule __GI_getprotobyname_r_f052a7a79f1a57e84fd13df66f67c559 {
	meta:
...
rule getservbyname_r_e1bc00674f859a06e76116767eaea206 {
	meta:
...
rule readdir64_r_6e1612c9b595f57fa660aa0c258dcdf3 {
	meta:
...
rule __GI_ungetc_74a22af303c1fe58706f08b2830ec2c8 {
	meta:
...
rule __GI_getservbyport_r_246f8d86306f15620e3aab50feb1be77 {
	meta:
...
rule __GI_bindresvport_69f433838b65feeccd745de58a45f740 {
	meta:
...
rule __GI_re_search_2_37927055d100e14ef1ec9072d573a69f {
	meta:
...
rule __GI_getdelim_ecf3f953469f08dfbbf5406ac8f97cd0 {
	meta:
...
rule setvbuf_70d7d584bd35e7a46b4f1ae62211121d {
	meta:
...
rule __GI_lockf64_6515790c518f87941165642e2a45d3d6 {
	meta:
...
rule __GI_fnmatch_db83f20ef4f68d0bc90d3d4d911cb3c8 {
	meta:
...
rule fclose_16ba0b1c77df02f5e46b53f941b60179 {
	meta:
...
rule __GI_llround_d31f96c0a4bb9cbaa3d035debaffda5d {
	meta:
...
rule __GI_rtime_c007a86eb49b48f5e65a30629d6fc44d {
	meta:
...
rule __GI_mallinfo_75ec96a606a94ec3814f71e2390a6d49 {
	meta:
...
rule __ieee754_remainder_9b7e963d6d8f0cd0936e1d4c9b1a8f40 {
	meta:
		aliases = "__GI_remainder, drem, remainder, __ieee754_remainder"
		size = "343"
...
rule __GI_fmod_249a1f99426ab1ef9f347dab3822962f {
	meta:
...
rule __GI_gethostbyname_r_41ee15139029d7e66e2989b91bc8807e {
	meta:
...
rule __ieee754_atan2_2d90a78732b78f753276456c8a03e6bd {
	meta:
		aliases = "atan2, __GI_atan2, __ieee754_atan2"
		size = "580"
...
rule __GI_getaddrinfo_87def59f0f5d3423c8eb44425be9daaf {
	meta:
...
rule __GI_inet_ntop_92d01706f9a6f94471131d9e394b7868 {
	meta:
...
rule lgamma_r_c498904ebf352a16b39ba8037b79f02c {
	meta:
...
rule __GI_random_r_6b6a63362071605ce2ab2cdaa5d33b23 {
	meta:
...
rule imaxdiv_f333841d9a07cbf89331fe9c04214ea1 {
	meta:
...
rule getcwd_740ab8eeda78801b355fafd24103699f {
	meta:
...
rule __GI_wcsncasecmp_f81dbf6be026e6d1c9d68b296f455965 {
	meta:
...
rule __GI_pthread_setschedparam_9ddc41bf18899d5af4701d98265e9e95 {
	meta:
...
rule __GI_getpwuid_r_23a0aeab15032686cb04abc9bea484b7 {
	meta:
...
rule getpwnam_r_e612ed03d06dd4fd4054bcb61abc8918 {
	meta:
		aliases = "__GI_getpwnam_r, __GI_getspnam_r, getspnam_r, __GI_getgrnam_r, getgrnam_r, getpwnam_r"
		size = "135"
...
rule __GI_execl_ffb2d5202edd9e8e0369bf2a5057ea38 {
	meta:
...
rule __GI_pthread_setcancelstate_b17f5eef4028722aff03a376567e7699 {
	meta:
...
rule __GI_ruserpass_b0fcba2f41a631c66b773975b64c5c3b {
	meta:
...
rule glob_abae3945ca4dfa410e51354622de102e {
	meta:
...
rule __GI_execvp_89b6ed237a8ecee95d02c03d67a4cc3a {
	meta:
...
rule __GI_if_nameindex_ebb2de93c5c0abe22b9929065865d993 {
	meta:
...
rule __GI_nanf_be95debb65daa58c7b4c180af5f92103 {
	meta:
...
rule thread_self_dd5dae98b7dbe953d0d7e291f00b93db {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "signals@libpthread.a, cancel@libpthread.a, semaphore@libpthread.a, spinlock@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule __floatundidf_7a575897b2cc0ade6d72ff041b51e8dc {
	meta:
...
rule tmpfile_ec5e35392bd89df16638e8945983bded {
	meta:
...
rule __GI_vdprintf_9ac66d3e42641fbf3e35db76ae99e05b {
	meta:
...
rule __GI_xdr_rmtcallres_972909abe554c43e0d9a12ab3d2fd29b {
	meta:
...
rule __GI_fputc_unlocked_b15a6f9755d891f780cb639030287476 {
	meta:
		aliases = "fputc_unlocked, __fputc_unlocked, putc_unlocked, __GI___fputc_unlocked, __GI_putc_unlocked, __GI_fputc_unlocked"
		size = "181"
...
rule __GI_xdr_u_hyper_55a0c2d179cb9873044057b28c6ab0de {
	meta:
...
rule __GI___sigpause_e67da14d73a48c09cb4e447845acde4d {
	meta:
...
rule __GI_erand48_r_1dcbb47d4f0a5905d425bd85778ec04d {
	meta:
...
rule getrpcbyname_r_b2e70190f74df4d60c42f28644af9501 {
	meta:
...
rule __GI_exit_a73758aecd6a9080c88eac6b66d2d196 {
	meta:
...
rule __GI_atan_e122777cdcb3ce1672d60ca8b2e05419 {
	meta:
...
rule __ieee754_log2_bb87ad3d58a27abdf099f8b3dcfaf93e {
	meta:
...
rule __ieee754_log_c6a025aea17bd7ca73846953b8d35a4b {
	meta:
...
rule __new_sem_post_b0a272ed3c9f9fd5644e909ad64516e5 {
	meta:
...
rule __GI_vsscanf_46a954b23af42684f0ea79be03c1bf3d {
	meta:
...
rule __GI_opendir_864cd6c19690f8731160095061a4f5a2 {
	meta:
...
rule globfree_0870b4fc6a52ef2349f3f72211a53a44 {
	meta:
		aliases = "__GI_globfree, globfree64, __GI_globfree64, globfree"
		size = "62"
...
rule __GI_if_freenameindex_3f7c2458a6eef477f57398b2e7cac097 {
	meta:
...
rule __GI_tsearch_38c1ed5e6dc9299a4be993c3274f2068 {
	meta:
...
rule __GI_xdr_pmap_6e62b5ab24950e2c481b22101c1cbcea {
	meta:
...
rule __libc_siglongjmp_80874c12c0923f06960ef9b6fc6b2db8 {
	meta:
		aliases = "_longjmp, __libc_longjmp, longjmp, siglongjmp, __libc_siglongjmp"
		size = "45"
...
rule __GI_fgetspent_r_e1f38611a4b1ad9d822de85e67acd783 {
	meta:
		aliases = "__GI_fgetpwent_r, fgetpwent_r, fgetgrent_r, fgetspent_r, __GI_fgetgrent_r, __GI_fgetspent_r"
		size = "51"
...
rule ftell_824e97517a9adc96dee5b0400f95e7fa {
	meta:
...
rule fcntl_cb85df3c9cec5dbfb22e733ab1ae2fc2 {
	meta:
...
rule __GI_lockf_7b76ef6682cdc618299093ea1fdb4690 {
	meta:
...
rule __GI_xdr_string_77f45c227253890d928cd47a6454b6ca {
	meta:
...
rule __libc_lseek64_205810a655cfee9b1a5deaa827939798 {
	meta:
...
rule __GI_vfprintf_f9bad97e6029b81c8b2a1af067d3f755 {
	meta:
...
rule __GI_fgetwc_114aa4157b4b9566192d34ac8548075b {
	meta:
		aliases = "getwc, __GI_fileno, fgetwc, fileno, __GI_fgetwc"
		size = "81"
...
rule __GI_fputws_7d61cd477258541349acca99333ccc23 {
	meta:
		aliases = "__GI_fputs, putwc, fputws, fputs, fputwc, __GI_fputws"
		size = "86"
...
rule __GI_fgets_3ca1629c86e6c54373efd3d5f15d3e6e {
	meta:
...
rule __GI_fread_e64e0c6a030ccd39c5f6aff237204ea1 {
	meta:
...
rule __GI_fputc_616f35da021ce09db47b602dae5f627e {
	meta:
...
rule getgrent_r_7ee86d6829de12dd3af398a00bb65158 {
	meta:
		aliases = "getspent_r, __GI_getspent_r, __GI_getpwent_r, __GI_getgrent_r, getpwent_r, getgrent_r"
		size = "161"
		objfiles = "getpwent_r@libc.a, getspent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule ftello64_d3fe9056786954a4d5c5e5dd9a6efdfe {
	meta:
...
rule __GI_authnone_create_148e20ea4579f60f9a702b6c8f08ac5a {
	meta:
...
rule __GI_nearbyint_fdb847fb272d9befe638b0a435d08156 {
	meta:
		aliases = "nearbyint, __GI_rint, rint, __GI_nearbyint"
		size = "327"
...
rule __GI_strsignal_5d7e3043aa37b2804c239965b9f0a776 {
	meta:
...
rule __GI_seed48_r_c09d0a77d71dbcf7470907820ac5840a {
	meta:
...
rule __libc_sigaction_b944632e69a6593723094f3779dca7d7 {
	meta:
...
rule __GI_tcgetattr_d578d04f2e9caf9475ae7483b21ade1b {
	meta:
...
rule fstatat_1f93b9cbc9800e7ee4773ceffb55c968 {
	meta:
...
rule __GI_svc_getreq_af6e18308dd96e0db0c79fd37df00397 {
	meta:
...
rule __GI_fcntl64_a496320a67c0d8484db8e1de14cc1ca6 {
	meta:
...
rule __GI_alarm_a3c502f6052e2dbdcaef346d7e266354 {
	meta:
...
rule __GI_fchdir_51d3fd19259c5eaa616029dded24645c {
	meta:
...
rule __GI_write_e6e1c27559753b2051b4158f85614a49 {
	meta:
...
rule __GI_lseek_74cc41bbf636237fd7de2859afe9d2e0 {
	meta:
		aliases = "lseek, __libc_lseek, __GI_lseek"
		size = "48"
...
rule __GI_readlink_21edbc286df1e9f4b0f84ca78da85305 {
	meta:
...
rule inet_ntoa_e214931d143cca1a32199edb31adc4a0 {
	meta:
		aliases = "__GI_inet_ntoa, __GI_asctime, ether_ntoa, asctime, ether_aton, hcreate, inet_ntoa"
		size = "17"
		objfiles = "asctime@libc.a, inet_ntoa@libc.a, ether_addr@libc.a, hsearch@libc.a"
	strings:
...
rule __GI_strtok_ce767ada53bd455cecd0660edb8a7c87 {
	meta:
		aliases = "gamma, __ieee754_lgamma, __GI_lgamma, strtok, lgamma, __GI_strtok"
		size = "22"
...
rule __GI_strtold_218c186b4d9e0825b5f6d16570a16a45 {
	meta:
...
rule __GI_wcstoul_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		aliases = "__GI_waitpid, strtoumax, __GI_strtoul, wcstoul, wcstoull, __GI_strtoull, strtouq, __GI_wcstoull, waitpid, strtoul, wcstouq, strtoull, __libc_waitpid, wcstoumax, __GI_wcstoul"
		size = "23"
		objfiles = "wcstoull@libc.a, waitpid@libc.a, strtoul@libc.a, wcstoul@libc.a, strtoull@libc.a"
	strings:
...
rule mktime_0410fd2bb80bbf0bc944c8d2d2133af7 {
	meta:
		aliases = "mkstemp64, iswalnum, __GI_iswalnum, timelocal, mktime"
		size = "14"
...
rule wcstol_fe8e5520a3eef7a03748f1ff8e71080f {
	meta:
		aliases = "__GI_wcstol, strtol, __GI_strtoll, __GI_strtol, strtoll, wcstoimax, strtoimax, strtoq, wcstoll, wcstoq, __GI_wcstoll, wcstol"
		size = "23"
...
rule __GI_iswdigit_e83006ca42bcd5f8a005429c5301f208 {
	meta:
		aliases = "iswdigit, __GI_iswdigit"
		size = "14"
...
rule __GI_atoi_40657ce09f1f30b9225c7cb14e45ae11 {
	meta:
		aliases = "atol, __GI_atol, atoll, atoi, __GI_atoi"
		size = "17"
...
rule fgetspent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		aliases = "getpwnam, sgetspent, getgrgid, getpwuid, getgrnam, fgetpwent, getspnam, fgetgrent, fgetspent"
		size = "38"
		objfiles = "fgetpwent@libc.a, getspnam@libc.a, getpwnam@libc.a, getgrgid@libc.a, getgrnam@libc.a"
	strings:
...
rule inet_makeaddr_85efe30aed676f0eb0798dc3958215ba {
	meta:
...
rule wscanf_d49bdeb5a2c59b42a4876d324b1f6480 {
	meta:
		aliases = "printf, scanf, wprintf, __GI_printf, wscanf"
		size = "30"
...
rule fprintf_3674412569e427ab0f649983548971e5 {
	meta:
		aliases = "__GI_syslog, asprintf, fwscanf, swscanf, syslog, fscanf, fwprintf, dprintf, __GI_sscanf, __GI_asprintf, __GI_fwprintf, __GI_fprintf, sscanf, __GI_fscanf, fprintf"
		size = "28"
		objfiles = "fwprintf@libc.a, swscanf@libc.a, asprintf@libc.a, sscanf@libc.a, fprintf@libc.a"
	strings:
...
rule __GI_wcstof_8a2523e8a23a59f0c88500a8ca4cd794 {
	meta:
		aliases = "strtof, wcstof, __GI_strtof, __GI_wcstof"
		size = "49"
...
rule __GI___finite_ce9eb944c626935fdb87885be0b5d84a {
	meta:
...
rule asinhf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		aliases = "sinhf, atanhf, coshf, acosf, asinf, ceilf, gammaf, expm1f, tanhf, sinf, rintf, erfcf, tanf, cosf, sqrtf, lgammaf, truncf, fabsf, cbrtf, log2f, expf, floorf, atanf, exp2f, logf, logbf, acoshf, erff, log10f, roundf, significandf, log1pf, asinhf"
		size = "27"
		objfiles = "gammaf@libm.a, expf@libm.a, asinf@libm.a, acoshf@libm.a, atanf@libm.a"
	strings:
...
rule __GI_setnetent_4df162fa78943270536f2e1af5743cf4 {
	meta:
		aliases = "setprotoent, __GI_setservent, __GI_setprotoent, setnetent, setservent, __GI_setnetent"
		size = "106"
...
rule __GI_wcstod_dabd39a3a649dc519b1084bccffdb2ef {
	meta:
		aliases = "strtod, __GI_strtod, wcstod, __GI_wcstod"
		size = "49"
...
rule __GI_fabs_67d4c36ed885bd2f48ec733bd7370a67 {
	meta:
...
rule hypotf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		aliases = "remainderf, powf, copysignf, fmodf, scalbf, atan2f, hypotf"
		size = "35"
		objfiles = "remainderf@libm.a, scalbf@libm.a, copysignf@libm.a, hypotf@libm.a, fmodf@libm.a"
	strings:
...
rule __GI_tan_951073aa1c1922cd218edaee463f6f7b {
	meta:
...
rule __GI_expm1_ab0b1207f9019936da7e43ba732c59dd {
	meta:
...
rule __GI_sysconf_7e5be7e701249ed34ab964024b85d365 {
	meta:
...
rule ntohs_abb47f3111edd8b51bf0127264a91b58 {
	meta:
		aliases = "__GI_ntohs, htons, __GI_htons, ntohs"
		size = "12"
...
rule __pthread_mutexattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__pthread_mutexattr_gettype, pthread_mutexattr_getkind_np, __GI_pthread_attr_getdetachstate, pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np"
		size = "15"
...
rule svcunixfd_create_e63fbd4454ec064dc8f9d0b775e2be85 {
	meta:
		aliases = "svcfd_create, setenv, __GI_setenv, svcunixfd_create"
		size = "17"
...
rule sigwaitinfo_2aa34826b54f8b832f45f541b8504e96 {
	meta:
...
rule ffs_fa76d4818df8af69962f2ee9af2c2efb {
	meta:
...
rule __GI_sigemptyset_9cccfab68f4bd16a32525f638f9dcc39 {
	meta:
		aliases = "pthread_rwlockattr_init, sigemptyset, __GI_sigemptyset"
		size = "20"
...
rule sigismember_016a84adaadaa75b24de597e41b23cce {
	meta:
		aliases = "sigdelset, sigaddset, __GI_sigdelset, __GI_sigaddset, sigismember"
		size = "33"
...
rule __GI_cfsetispeed_36ab95136b839447e465e0cec37e6429 {
	meta:
...
rule __GI_stpcpy_e85acb712e464efe694ecc781bc67b25 {
	meta:
...
rule __GI_setttyent_82b66c6f26b823e923265f38525e206e {
	meta:
...
rule __GI_fmax_089335b2787679981a1badfdfb4c3d8f {
	meta:
...
rule __GI_fmin_659b7df0831594bc581b7ab5f5974ab9 {
	meta:
...
rule __GI_ldexp_b953d56f97e155fd314280048846f9b2 {
	meta:
...
rule vwprintf_8656ba417f55ecd54498627fc6f064b6 {
	meta:
		aliases = "vscanf, vprintf, __GI_vscanf, vwscanf, vwprintf"
		size = "23"
