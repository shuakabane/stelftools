...
rule __bsd_signal_126cff4a00751967edf4b225069665be {
	meta:
		aliases = "__GI_signal, signal, bsd_signal, __bsd_signal"
		size = "175"
...
rule __GI_getdomainname_697f99fee411f6ddffe6bd60370a0f43 {
	meta:
		aliases = "__GI___libc_getdomainname, getdomainname, __libc_getdomainname, __GI_getdomainname"
		size = "101"
...
rule getc_unlocked_a8c421194d2423dabb3cc9829e1d3697 {
	meta:
		aliases = "__GI_fgetc_unlocked, __fgetc_unlocked, __GI_getc_unlocked, fgetc_unlocked, __GI___fgetc_unlocked, getc_unlocked"
		size = "220"
...
rule endservent_0d96bf4fc2561ebab2649fbb03aaf667 {
	meta:
		aliases = "__GI_endnetent, __GI_endprotoent, endnetent, __GI_endservent, endprotoent, endservent"
		size = "92"
...
rule accept_7fafe2d4042f052134436ac4f9e768f2 {
	meta:
		aliases = "sendmsg, __GI_waitpid, lseek, waitpid, accept"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __isnan_a3058c025a33bf28be8c671cddf6ddc1 {
	meta:
		aliases = "isnan, __GI_isnan, __GI___isnan, __isnan"
		size = "40"
...
rule svc_getreqset_ede7b418cd436d6e818b68e0d8cccb49 {
	meta:
...
rule __GI_getpwnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "__GI_getgrnam_r, getpwnam_r, getspnam_r, __GI_getspnam_r, getgrnam_r, __GI_getpwnam_r"
		size = "153"
...
rule re_search_2_b2429092296656604f63d346b4c12565 {
	meta:
...
rule xdr_pmaplist_b6bf74fcfa9535389edf49e4bd94c3fd {
	meta:
...
rule ungetc_8cb994fb4b11e35d8980e489541905bc {
	meta:
...
rule __GI_getservbyport_r_5488893ebab3061976099b0254362f4b {
	meta:
...
rule __GI_remquo_d898589449af2c47a77aaa210c27b611 {
	meta:
...
rule __GI_llrint_d908fd95bd2999d664d58145c46d1df9 {
	meta:
...
rule strftime_7f1f776ce962d433bcddbef5ed89c9e5 {
	meta:
...
rule longjmp_be9e6548214836180c2cfadd5a9f8fd0 {
	meta:
		aliases = "_longjmp, siglongjmp, __libc_longjmp, __libc_siglongjmp, longjmp"
		size = "51"
...
rule fgetspent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetspent_r, __GI_fgetpwent_r, fgetgrent_r, __GI_fgetgrent_r, fgetpwent_r, fgetspent_r"
		size = "55"
...
rule xdr_u_hyper_99c9ab42ade2823d0f03f88b4f0bbb5e {
	meta:
...
rule getgrent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "getpwent_r, __GI_getpwent_r, __GI_getgrent_r, getspent_r, __GI_getspent_r, getgrent_r"
		size = "171"
		objfiles = "getpwent_r@libc.a, getgrent_r@libc.a, getspent_r@libc.a"
	strings:
...
rule __GI_strcat_13d9dfae57f820c45bb3e84f017ac3e4 {
	meta:
...
rule __GI_adjtimex_df2913791bdd2249948e5a92539887fe {
	meta:
...
rule strtouq_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "wcstoul, strtoul, __libc_waitpid, wcstoumax, __GI_strtoull, __GI_waitpid, strtoumax, __GI_wcstoull, wcstoull, strtoull, __GI_strtoul, waitpid, __GI_wcstoul, wcstouq, strtouq"
		size = "26"
...
rule __GI_wcstoll_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "wcstol, strtoll, __GI_strtoll, strtoq, __GI_strtol, __GI_wcstol, wcstoimax, strtol, strtoimax, wcstoq, wcstoll, __GI_wcstoll"
		size = "26"
...
rule sigaddset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigdelset, __GI_sigaddset, __GI_sigdelset, sigismember, sigaddset"
		size = "42"
...
rule lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "strtok, __GI_lgamma, __ieee754_gamma, __GI_strtok, __GI_gamma, gamma, __ieee754_lgamma, lgamma"
		size = "25"
...
rule __GI_atoi_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "__GI_atol, atol, atoi, atoll, __GI_atoi"
		size = "20"
...
rule ether_ntoa_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "asctime, __GI_inet_ntoa, inet_ntoa, __GI_asctime, hcreate, srand48, ether_ntoa"
		size = "21"
		objfiles = "srand48@libc.a, inet_ntoa@libc.a, ether_addr@libc.a, asctime@libc.a, hsearch@libc.a"
	strings:
...
rule timelocal_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "mkstemp64, mktime, __GI_iswalnum, iswalnum, timelocal"
		size = "18"
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "manager@libpthread.a, rwlock@libpthread.a, join@libpthread.a, spinlock@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule _flushlbf_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__GI_getlogin, hdestroy, getlogin, __pthread_once_fork_prepare, __pthread_once_fork_parent, _flushlbf"
		size = "17"
...
rule asprintf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "syslog, fprintf, fscanf, __GI_fprintf, swscanf, sscanf, __GI_asprintf, __GI_syslog, __GI_sscanf, dprintf, __GI_fscanf, fwprintf, fwscanf, asprintf"
		size = "30"
		objfiles = "asprintf@libc.a, fwprintf@libc.a, fscanf@libc.a, fwscanf@libc.a, sscanf@libc.a"
	strings:
...
rule floorf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "atanf, acosf, truncf, sinf, cosf, asinf, lgammaf, asinhf, rintf, expf, expm1f, atanhf, tanhf, acoshf, sinhf, logbf, coshf, erff, erfcf, log10f, fabsf, tanf, cbrtf, roundf, ceilf, log1pf, sqrtf, logf, floorf"
		size = "27"
		objfiles = "fabsf@libm.a, truncf@libm.a, logbf@libm.a, ceilf@libm.a, lgammaf@libm.a"
	strings:
...
rule fmodf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "atan2f, powf, nextafterf, remainderf, hypotf, copysignf, fmodf"
		size = "35"
		objfiles = "powf@libm.a, fmodf@libm.a, atan2f@libm.a, remainderf@libm.a, copysignf@libm.a"
	strings:
...
rule getgrnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "sgetspent, fgetspent, getgrgid, getpwuid, getpwnam, fgetpwent, fgetgrent, getspnam, getgrnam"
		size = "40"
		objfiles = "getspnam@libc.a, fgetspent@libc.a, getgrnam@libc.a, getpwuid@libc.a, getpwnam@libc.a"
	strings:
...
rule thread_self_e74c8f77ff3f89dbea0e2d9a5b4c5494 {
	meta:
		aliases = "thread_self"
		size = "63"
		objfiles = "errno@libpthread.a, mutex@libpthread.a, cancel@libpthread.a, rwlock@libpthread.a, join@libpthread.a"
	strings:
...
rule __pthread_mutexattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_rwlockattr_getkind_np, __GI_pthread_attr_getdetachstate, pthread_mutexattr_getkind_np, pthread_mutexattr_gettype, __pthread_mutexattr_gettype, pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np"
		size = "15"
...
rule isinff_857eb5077641af5ea7a2e12f74cef8dc {
	meta:
