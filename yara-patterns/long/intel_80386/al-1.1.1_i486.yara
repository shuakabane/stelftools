...
rule write_966d33990ea41d94ea545ad487f15973 {
	meta:
		aliases = "accept, recvmsg, lseek, sendmsg, __GI_waitpid, read, connect, waitpid, msync, write"
		size = "51"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule pread_c2940d127b00fb25b0bbd004ee5c830a {
	meta:
		aliases = "recv, send, epoll_wait, pwrite, pread"
		size = "55"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule fgetc_unlocked_e8150f2fa63846a8bbb3e1cc896ad04e {
	meta:
		aliases = "getc_unlocked, __GI_getc_unlocked, __fgetc_unlocked, __GI_fgetc_unlocked, __GI___fgetc_unlocked, fgetc_unlocked"
		size = "204"
...
rule __GI_setprotoent_d93becebaefdfd2ceefb5b3142a474bd {
	meta:
		aliases = "__GI_setnetent, setprotoent, setnetent, __GI_setprotoent"
		size = "96"
...
rule __GI_endnetent_a4fe55b18bbe578f070411ce5006e39f {
	meta:
		aliases = "endprotoent, __GI_endprotoent, endnetent, __GI_endnetent"
		size = "83"
		objfiles = "getproto@libc.a, getnet@libc.a"
	strings:
...
rule __GI_sleep_bae4534def951448e746ae63ab38f764 {
	meta:
...
rule __GI_log10_aa3d9dc5089043dd544c7c0247a10399 {
	meta:
...
rule __libc_pread_8810fe4c8dbaf93db0b2807cdd400643 {
	meta:
		aliases = "mq_send, pread, mq_receive, __libc_pread"
		size = "35"
...
rule __GI___sigismember_153421a36092b719bf7f04011c9e23e0 {
	meta:
...
rule __GI_pthread_attr_init_43eb6ff4d784a86498903132c51c3320 {
	meta:
...
rule statvfs_df3c1346be5dc07be898b02e33405ccf {
	meta:
		aliases = "fstatvfs, __GI_statvfs, __GI_fstatvfs, statvfs"
		size = "644"
...
rule fstatvfs64_21f0316f257d26668d182dc685b5d9cd {
	meta:
...
rule __GI_rexec_af_38198af33aa5325c8c96972672a5cba4 {
	meta:
...
rule __GI_pow_b195aadcefdb096b8e2df0a7ae6a1be2 {
	meta:
...
rule __GI_vasprintf_5718aa84c9ba4727a31d2365b682977f {
	meta:
...
rule __ieee754_remainder_9b7e963d6d8f0cd0936e1d4c9b1a8f40 {
	meta:
		aliases = "drem, __GI_remainder, remainder, __ieee754_remainder"
		size = "343"
...
rule rint_c33b757d88fac953ad50fae5e08e6958 {
	meta:
		aliases = "__GI_rint, nearbyint, __GI_nearbyint, rint"
		size = "342"
...
rule __GI_vswprintf_08a6bd358f7f203da5e5224ee6066fca {
	meta:
...
rule gamma_r_7de14a464c6bb1cd24db5656c0ab97c0 {
	meta:
...
rule __GI_getcwd_3b096e9205fbd87755a3a828137b0166 {
	meta:
...
rule getgrgid_r_23a0aeab15032686cb04abc9bea484b7 {
	meta:
...
rule __GI_getspnam_r_e612ed03d06dd4fd4054bcb61abc8918 {
	meta:
...
rule thread_self_dd5dae98b7dbe953d0d7e291f00b93db {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "mutex@libpthread.a, signals@libpthread.a, condvar@libpthread.a, cancel@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule __wcslcpy_e97ef870b7c7966b8f02f4ca69f4f7a0 {
	meta:
...
rule __GI_putc_unlocked_b15a6f9755d891f780cb639030287476 {
	meta:
		aliases = "fputc_unlocked, __GI_fputc_unlocked, __fputc_unlocked, __GI___fputc_unlocked, putc_unlocked, __GI_putc_unlocked"
		size = "181"
...
rule __libc_longjmp_80874c12c0923f06960ef9b6fc6b2db8 {
	meta:
		aliases = "longjmp, _longjmp, __libc_siglongjmp, siglongjmp, __libc_longjmp"
		size = "45"
...
rule fgetgrent_r_e1f38611a4b1ad9d822de85e67acd783 {
	meta:
		aliases = "__GI_fgetspent_r, fgetpwent_r, fgetspent_r, __GI_fgetgrent_r, __GI_fgetpwent_r, fgetgrent_r"
		size = "51"
...
rule __GI_vfprintf_e596a54f7e8a74fcff96a713d3fd1d7c {
	meta:
...
rule __GI_fgetwc_4ad83eeaa60553f98b832d8b316ee87f {
	meta:
...
rule fputwc_2addd2dd28334c1098b0e5698a927b1e {
	meta:
		aliases = "fputws, fputs, putwc, __GI_fputs, __GI_fputws, fputwc"
		size = "93"
...
rule fputc_616f35da021ce09db47b602dae5f627e {
	meta:
...
rule __GI_getpwent_r_7ee86d6829de12dd3af398a00bb65158 {
	meta:
		aliases = "getpwent_r, getgrent_r, getspent_r, __GI_getspent_r, __GI_getgrent_r, __GI_getpwent_r"
		size = "161"
		objfiles = "getspent_r@libc.a, getgrent_r@libc.a, getpwent_r@libc.a"
	strings:
...
rule __GI_inet_ntoa_e214931d143cca1a32199edb31adc4a0 {
	meta:
		aliases = "inet_ntoa, hcreate, ether_ntoa, __GI_asctime, asctime, ether_aton, __GI_inet_ntoa"
		size = "17"
...
rule strtok_ce767ada53bd455cecd0660edb8a7c87 {
	meta:
		aliases = "gamma, __GI_lgamma, __GI_strtok, __ieee754_lgamma, lgamma, strtok"
		size = "22"
...
rule wcstouq_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		aliases = "strtouq, wcstoull, __libc_waitpid, strtoumax, __GI_waitpid, waitpid, __GI_strtoul, strtoull, wcstoul, strtoul, wcstoumax, wcstouq"
		size = "23"
...
rule __GI_strtoll_fe8e5520a3eef7a03748f1ff8e71080f {
	meta:
		aliases = "strtol, strtoimax, wcstol, wcstoimax, strtoq, wcstoq, strtoll, wcstoll, __GI_strtol, __GI_strtoll"
		size = "23"
...
rule __GI_atoi_40657ce09f1f30b9225c7cb14e45ae11 {
	meta:
		aliases = "atol, atoi, atoll, __GI_atoi"
		size = "17"
...
rule getpwuid_55f8a496d4b651e19d576b899468cf9d {
	meta:
		aliases = "sgetspent, getspnam, fgetpwent, getpwnam, getgrgid, fgetspent, getgrnam, fgetgrent, getpwuid"
		size = "38"
		objfiles = "getgrnam@libc.a, getpwnam@libc.a, getpwuid@libc.a, getgrgid@libc.a, getspnam@libc.a"
	strings:
...
rule __libc_open64_6e27fa1a3b0055d4fad61e0c8063a637 {
	meta:
...
rule scanf_d49bdeb5a2c59b42a4876d324b1f6480 {
	meta:
...
rule __GI_asprintf_3674412569e427ab0f649983548971e5 {
	meta:
		aliases = "swscanf, sscanf, __GI_fprintf, fprintf, syslog, fscanf, dprintf, asprintf, fwprintf, fwscanf, __GI_syslog, __GI_sscanf, __GI_fscanf, __GI_asprintf"
		size = "28"
		objfiles = "fscanf@libc.a, sscanf@libc.a, fwprintf@libc.a, fwscanf@libc.a, syslog@libc.a"
	strings:
...
rule __GI___isnan_5dbc52f56dac7dcce0f5c7447d891486 {
	meta:
...
rule tanf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		aliases = "log1pf, log2f, cbrtf, gammaf, rintf, tanhf, exp2f, floorf, atanhf, erff, asinhf, acosf, logf, sinf, significandf, asinf, lgammaf, truncf, ceilf, erfcf, coshf, logbf, sinhf, atanf, roundf, cosf, acoshf, fabsf, expm1f, log10f, expf, sqrtf, tanf"
		size = "27"
		objfiles = "logbf@libm.a, sqrtf@libm.a, expf@libm.a, logf@libm.a, roundf@libm.a"
	strings:
...
rule scalbf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		aliases = "copysignf, fmodf, powf, hypotf, atan2f, remainderf, scalbf"
		size = "35"
		objfiles = "scalbf@libm.a, atan2f@libm.a, copysignf@libm.a, powf@libm.a, fmodf@libm.a"
	strings:
...
rule ntohs_abb47f3111edd8b51bf0127264a91b58 {
	meta:
		aliases = "htons, __GI_htons, __GI_ntohs, ntohs"
		size = "12"
...
rule pthread_attr_getdetachstate_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype, pthread_rwlockattr_getkind_np, __GI_pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np, pthread_mutexattr_gettype, pthread_attr_getdetachstate"
		size = "15"
...
rule __GI_sigaddset_016a84adaadaa75b24de597e41b23cce {
	meta:
		aliases = "sigdelset, sigismember, sigaddset, __GI_sigdelset, __GI_sigaddset"
		size = "33"
...
rule __GI_strrchr_bcc34327154efdfb74e18a0ac6c906cc {
	meta:
...
rule gmtime_r_4ffe811b206b5540a8cd0461ad5ed514 {
	meta:
		...
		size = "19"
		objfiles = "gmtime_r@libc.a, bzero@libc.a, mkstemp@libc.a, mq_getsetattr@librt.a"
	strings:
...
rule vprintf_8656ba417f55ecd54498627fc6f064b6 {
	meta:
		aliases = "vscanf, vwprintf, vwscanf, vprintf"
		size = "23"
...
rule verrx_e995d28d2bc805c6592260c44650cadd {
	meta:
		aliases = "__GI_verrx, verr, __GI_verr, verrx"
		size = "22"
		objfiles = "err@libc.a"
	strings:
