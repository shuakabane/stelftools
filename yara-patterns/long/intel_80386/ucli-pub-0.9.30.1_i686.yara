...
rule thread_self_c490e55fdc4e0d42e26befc1658d19a1 {
	meta:
		aliases = "thread_self"
		size = "63"
		objfiles = "mutex@libpthread.a, signals@libpthread.a, spinlock@libpthread.a, pthread@libpthread.a, condvar@libpthread.a"
	strings:
...
rule fgetc_unlocked_7234bf2292c7e7a4e6fb4c246bfcefbf {
	meta:
		aliases = "__fgetc_unlocked, __GI_getc_unlocked, getc_unlocked, __GI_fgetc_unlocked, __GI___fgetc_unlocked, fgetc_unlocked"
		size = "220"
...
rule endprotoent_f468964b8937d2560c1930edef041633 {
	meta:
		aliases = "endservent, __GI_endnetent, __GI_endprotoent, endnetent, __GI_endservent, endprotoent"
		size = "92"
...
rule wait_bbe948c091b68f15128a29caf991f3c8 {
	meta:
		aliases = "system, tcdrain, fsync, wait"
		size = "48"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_waitpid_74030486c498b35deba130245259f53b {
	meta:
		aliases = "waitpid, accept, lseek, sendmsg, __GI_waitpid"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_pthread_setschedparam_a23d99c97da121dbbb34e50fb93b0064 {
	meta:
...
rule __GI_rexec_af_81f411d8a529b45185e99a432f58d915 {
	meta:
...
rule strlcpy_cc28fde6a217fb7206145cb9a1baff29 {
	meta:
		aliases = "__GI_strxfrm, __GI_strlcpy, strxfrm, strlcpy"
		size = "61"
...
rule fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetgrent_r, __GI_fgetspent_r, __GI_fgetpwent_r, fgetgrent_r, fgetspent_r, fgetpwent_r"
		size = "55"
...
rule __GI_putc_unlocked_8f40897f050da839500afb25c4130c6b {
	meta:
		aliases = "__GI___fputc_unlocked, __fputc_unlocked, fputc_unlocked, putc_unlocked, __GI_putc_unlocked"
		size = "187"
...
rule fileno_d1aff121aa302794d76ffd1091af3fc3 {
	meta:
		aliases = "__GI_fileno, fgetwc, getwc, __GI_fgetwc, fileno"
		size = "92"
...
rule __GI_fputws_656d0461fb753b5b2210fd391d402010 {
	meta:
		aliases = "fputs, fputws, putwc, fputwc, __GI_fputs, __GI_fputws"
		size = "95"
...
rule getpwent_r_d8fe13829bbc6de00d0924445c5077f8 {
	meta:
		aliases = "__GI_getpwent_r, __GI_getspent_r, getspent_r, __GI_getgrent_r, getgrent_r, getpwent_r"
		size = "171"
		objfiles = "getpwent_r@libc.a, getgrent_r@libc.a, getspent_r@libc.a"
	strings:
...
rule __GI_strcmp_124e63b6cd601cb0633c0125291d4f19 {
	meta:
		aliases = "strcoll, strcmp, __GI_strcoll, __GI_strcmp"
		size = "29"
...
rule __libc_lseek_f0210736af9ab2dbe6a658a87075a134 {
	meta:
		aliases = "__GI_lseek, __GI___libc_lseek, lseek, __libc_lseek"
		size = "54"
...
rule wctrans_50e80352cc999abf107e4f9290013692 {
	meta:
		aliases = "__GI_wctype, __GI_wctrans, wctype, wctrans"
		size = "61"
...
rule strtoul_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "strtoull, wcstoul, strtoumax, __GI_wcstoul, waitpid, __GI_strtoull, wcstouq, wcstoumax, __libc_waitpid, __GI_wcstoull, strtouq, __GI_strtoul, __GI_waitpid, wcstoull, strtoul"
		size = "26"
		objfiles = "strtoul@libc.a, waitpid@libc.a, wcstoull@libc.a, wcstoul@libc.a, strtoull@libc.a"
	strings:
...
rule __GI_wcstol_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "strtoimax, wcstol, strtoll, strtoq, wcstoimax, wcstoll, __GI_strtoll, __GI_strtol, wcstoq, __GI_wcstoll, strtol, __GI_wcstol"
		size = "26"
...
rule sigismember_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigaddset, __GI_sigdelset, __GI_sigaddset, sigdelset, sigismember"
		size = "42"
...
rule __GI_lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "gamma, strtok, __GI_strtok, __ieee754_lgamma, __ieee754_gamma, lgamma, __GI_lgamma"
		size = "25"
		objfiles = "w_lgamma@libm.a, e_lgamma@libm.a, e_gamma@libm.a, w_gamma@libm.a, strtok@libc.a"
	strings:
...
rule atoi_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "atol, __GI_atoi, __GI_atol, atoll, atoi"
		size = "20"
...
rule asctime_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "inet_ntoa, __GI_asctime, __GI_inet_ntoa, ether_ntoa, srand48, hcreate, asctime"
		size = "21"
...
rule __GI_sigpause_6bf719c25f6fbaef08052b0889ae3660 {
	meta:
		aliases = "mkstemp, sigpause, atof, __GI_sigpause"
		size = "18"
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "spinlock@libpthread.a, pthread@libpthread.a, manager@libpthread.a, condvar@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule hdestroy_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "getlogin, __GI_getlogin, _flushlbf, __pthread_once_fork_parent, __pthread_once_fork_prepare, hdestroy"
		size = "17"
...
rule wprintf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "scanf, wscanf, __GI_printf, printf, wprintf"
		size = "32"
...
rule fwprintf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "fprintf, __GI_sscanf, fscanf, dprintf, __GI_asprintf, syslog, asprintf, swscanf, sscanf, fwscanf, __GI_fprintf, __GI_syslog, __GI_fscanf, fwprintf"
		size = "30"
		objfiles = "sscanf@libc.a, swscanf@libc.a, fscanf@libc.a, fprintf@libc.a, fwscanf@libc.a"
	strings:
...
rule ilogbf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "lroundf, llrintf, lrintf, llroundf, ilogbf"
		size = "19"
...
rule asinhf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "tgammaf, sinf, log1pf, atanf, truncf, expf, roundf, floorf, erfcf, rintf, acosf, asinf, lgammaf, logf, log10f, cosf, atanhf, coshf, sqrtf, acoshf, fabsf, sinhf, tanf, ceilf, erff, logbf, cbrtf, tanhf, expm1f, asinhf"
		size = "27"
		objfiles = "atanhf@libm.a, log10f@libm.a, ceilf@libm.a, acoshf@libm.a, sqrtf@libm.a"
	strings:
...
rule nextafterf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "atan2f, copysignf, fmodf, powf, remainderf, hypotf, nextafterf"
		size = "35"
		objfiles = "remainderf@libm.a, powf@libm.a, copysignf@libm.a, atan2f@libm.a, fmodf@libm.a"
	strings:
...
rule fgetpwent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "sgetspent, fgetgrent, fgetspent, getgrgid, getgrnam, getspnam, getpwnam, getpwuid, fgetpwent"
		size = "40"
		objfiles = "fgetspent@libc.a, getgrnam@libc.a, getgrgid@libc.a, fgetgrent@libc.a, sgetspent@libc.a"
	strings:
...
rule __GI_pthread_attr_getdetachsta_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np, pthread_mutexattr_gettype, pthread_rwlockattr_getkind_np, pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate"
		size = "15"
