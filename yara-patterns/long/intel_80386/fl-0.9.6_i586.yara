...
rule __fgetc_unlocked_a8c421194d2423dabb3cc9829e1d3697 {
	meta:
		aliases = "fgetc_unlocked, getc_unlocked, __GI___fgetc_unlocked, __GI_fgetc_unlocked, __GI_getc_unlocked, __fgetc_unlocked"
		size = "220"
...
rule __GI_endnetent_0d96bf4fc2561ebab2649fbb03aaf667 {
	meta:
		aliases = "endprotoent, __GI_endprotoent, endnetent, endservent, __GI_endservent, __GI_endnetent"
		size = "92"
...
rule __GI_waitpid_7fafe2d4042f052134436ac4f9e768f2 {
	meta:
		aliases = "accept, waitpid, lseek, sendmsg, __GI_waitpid"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule getpwnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "__GI_getspnam_r, getgrnam_r, __GI_getpwnam_r, __GI_getgrnam_r, getspnam_r, getpwnam_r"
		size = "153"
...
rule inet_pton_fa170ebcf4611cc9ffd9d6fd97489a18 {
	meta:
...
rule _longjmp_be9e6548214836180c2cfadd5a9f8fd0 {
	meta:
		aliases = "__libc_longjmp, longjmp, __libc_siglongjmp, siglongjmp, _longjmp"
		size = "51"
...
rule fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetgrent_r, __GI_fgetpwent_r, fgetgrent_r, __GI_fgetspent_r, fgetspent_r, fgetpwent_r"
		size = "55"
...
rule __GI_open_2a38df59c17c094e7cfb77be502adffc {
	meta:
		aliases = "__libc_open, open, __GI___libc_open, __GI_open"
		size = "75"
...
rule putwc_27a00bae78ad279095482cf1967e990f {
	meta:
		aliases = "fputwc, __GI_fputs, fputws, fputs, __GI_fputws, putwc"
		size = "95"
...
rule __GI_wcstoul_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "__GI_wcstoull, __GI_strtoull, __libc_waitpid, __GI_strtoul, strtoull, waitpid, strtoumax, strtouq, strtoul, wcstouq, wcstoul, __GI_waitpid, wcstoull, wcstoumax, __GI_wcstoul"
		size = "26"
		objfiles = "waitpid@libc.a, strtoull@libc.a, wcstoul@libc.a, wcstoull@libc.a, strtoul@libc.a"
	strings:
...
rule strtoimax_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "__GI_strtoll, strtoll, strtoq, __GI_strtol, wcstoimax, wcstol, strtol, wcstoll, wcstoq, __GI_wcstol, __GI_wcstoll, strtoimax"
		size = "26"
...
rule __GI_sigaddset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigismember, __GI_sigdelset, sigaddset, sigdelset, __GI_sigaddset"
		size = "42"
...
rule strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__ieee754_lgamma, __ieee754_gamma, gamma, __GI_lgamma, lgamma, __GI_strtok, strtok"
		size = "25"
		objfiles = "strtok@libc.a, w_lgamma@libm.a, w_gamma@libm.a, e_gamma@libm.a, e_lgamma@libm.a"
	strings:
...
rule __GI_atol_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "atoi, __GI_atoi, atol, atoll, __GI_atol"
		size = "20"
...
rule __GI_inet_ntoa_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "hcreate, inet_ntoa, srand48, ether_ntoa, __GI_asctime, asctime, __GI_inet_ntoa"
		size = "21"
...
rule mktime_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "iswalnum, mkstemp64, __GI_iswalnum, timelocal, mktime"
		size = "18"
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "pthread@libpthread.a, spinlock@libpthread.a, rwlock@libpthread.a, join@libpthread.a, manager@libpthread.a"
	strings:
...
rule hdestroy_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__pthread_once_fork_prepare, __pthread_once_fork_parent, __GI_getlogin, getlogin, _flushlbf, hdestroy"
		size = "17"
...
rule __GI_printf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "wscanf, printf, wprintf, scanf, __GI_printf"
		size = "32"
...
rule asprintf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "dprintf, swscanf, fwscanf, __GI_fprintf, sscanf, __GI_syslog, syslog, __GI_sscanf, fwprintf, fprintf, __GI_asprintf, __GI_fscanf, fscanf, asprintf"
		size = "30"
		objfiles = "swscanf@libc.a, sscanf@libc.a, fwprintf@libc.a, asprintf@libc.a, dprintf@libc.a"
	strings:
...
rule llroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "ilogbf, lroundf, lrintf, llrintf, llroundf"
		size = "19"
...
rule floorf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "erff, atanhf, asinhf, coshf, atanf, lgammaf, cosf, truncf, ceilf, fabsf, erfcf, expm1f, asinf, tanhf, roundf, expf, logbf, log1pf, rintf, tgammaf, sinhf, tanf, sqrtf, logf, cbrtf, acosf, acoshf, sinf, log10f, floorf"
		size = "27"
		objfiles = "tgammaf@libm.a, sqrtf@libm.a, asinf@libm.a, sinf@libm.a, atanf@libm.a"
	strings:
...
rule atan2f_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "hypotf, nextafterf, powf, copysignf, fmodf, remainderf, atan2f"
		size = "35"
		objfiles = "nextafterf@libm.a, remainderf@libm.a, copysignf@libm.a, fmodf@libm.a, hypotf@libm.a"
	strings:
...
rule fgetgrent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "getspnam, getgrgid, getgrnam, getpwuid, sgetspent, fgetpwent, fgetspent, getpwnam, fgetgrent"
		size = "40"
		objfiles = "fgetpwent@libc.a, getpwuid@libc.a, fgetspent@libc.a, getspnam@libc.a, getgrgid@libc.a"
	strings:
...
rule thread_self_e74c8f77ff3f89dbea0e2d9a5b4c5494 {
	meta:
		aliases = "thread_self"
		size = "63"
		objfiles = "signals@libpthread.a, errno@libpthread.a, pthread@libpthread.a, spinlock@libpthread.a, mutex@libpthread.a"
	strings:
...
rule pthread_rwlockattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np, pthread_mutexattr_getkind_np, pthread_mutexattr_gettype, __pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np"
		size = "15"
...
rule __GI_tolower_d7d4521aee6b4c2c35428947fe099a90 {
	meta:
		aliases = "toupper, tolower, __GI_toupper, __GI_tolower"
		size = "29"
