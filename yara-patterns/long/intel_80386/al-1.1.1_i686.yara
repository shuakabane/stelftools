...
rule __GI___cxa_atexit_9cad7aea5399451845ad99a50317bb80 {
	meta:
...
rule __libc_open_683dbe0625bda01b2f9f7235b0271ff6 {
	meta:
		aliases = "__GI_open, open, __libc_open"
		size = "69"
...
rule __GI_xdrrec_eof_e18c662a76987d19602136da1e03de18 {
	meta:
...
rule __GI_pipe_06dc478c3b896f13b863deff463823a6 {
	meta:
...
rule fsync_c2c9c14bcc4a4e891341c73e5d1509c7 {
	meta:
...
rule lseek_d8817a2b20d2b8a8527cf60ac853ffd1 {
	meta:
		aliases = "__libc_lseek, __GI_lseek, lseek"
		size = "53"
...
rule __GI_setresgid_c43e86869e5e7e970d5ab0432d3c1c07 {
	meta:
...
rule __GI_chown_0590e5bcf3e4a8be1649fa0414b6f260 {
	meta:
...
rule __GI_getpriority_afb2c13c59c0a927838aa03a6b5e8188 {
	meta:
...
rule __GI_nanosleep_7003dabb70336a01d375fc682b704659 {
	meta:
...
rule __GI_fork_2527c0759d3c9058972affd170efda8f {
	meta:
...
rule setrpcent_6474dd4ada60da321e90507b37cb598b {
	meta:
...
rule pthread_attr_init_a2d86148113264d2c53db523f9384e58 {
	meta:
...
rule __GI___glibc_strerror_r_77129e3bd059540a7f0c353f85700415 {
	meta:
...
rule regfree_d1e81aca2240e7ee121d3a613c884cb4 {
	meta:
...
rule fcntl_27a71e017d47b8ecb37086c38a4cdf6a {
	meta:
		aliases = "__GI___fcntl_nocancel, __GI___libc_fcntl, __libc_fcntl, __fcntl_nocancel, __GI_fcntl, fcntl"
		size = "87"
...
rule __GI_fgetc_unlocked_7234bf2292c7e7a4e6fb4c246bfcefbf {
	meta:
		aliases = "__fgetc_unlocked, __GI___fgetc_unlocked, __GI_getc_unlocked, fgetc_unlocked, getc_unlocked, __GI_fgetc_unlocked"
		size = "220"
...
rule __GI_fcntl64_714a98e066548dfcab7807f82a85a98a {
	meta:
...
rule __GI_tanh_dad850c43b7cb02dfcfc68eb46a9eb16 {
	meta:
...
rule srandom_2ba6753950d552504adb42e45f782e94 {
	meta:
...
rule __GI_endutent_60f61d2ea7fe2d073e25de9de0a96ccd {
	meta:
		aliases = "endutent, __GI_endutent"
		size = "85"
		objfiles = "utent@libc.a"
	strings:
...
rule setnetent_a75f460ba1a57e8f72bf836bf9f6395f {
	meta:
		aliases = "__GI_setprotoent, __GI_setnetent, setprotoent, __GI_setservent, setservent, setnetent"
		size = "110"
		objfiles = "getservice@libc.a, getproto@libc.a, getnet@libc.a"
	strings:
...
rule __GI_endprotoent_f468964b8937d2560c1930edef041633 {
	meta:
		aliases = "__GI_endnetent, endprotoent, endservent, endnetent, __GI_endservent, __GI_endprotoent"
		size = "92"
		objfiles = "getservice@libc.a, getproto@libc.a, getnet@libc.a"
	strings:
...
rule write_74030486c498b35deba130245259f53b {
	meta:
		aliases = "connect, lseek, recvmsg, write"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_waitpid_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "accept, read, waitpid, sendmsg, msync, __GI_waitpid"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule send_a442f4706a8c29f1a18c27f8c866616e {
	meta:
		aliases = "recv, pread, pwrite, epoll_wait, send"
		size = "60"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_frexp_d7290d43acaef44556c9cef51c5cf683 {
	meta:
...
rule __GI_scalbln_fb3de27cecf8f253228eddf40f0dccab {
	meta:
		aliases = "__GI_scalbn, scalbln, scalbn, __GI_scalbln"
		size = "293"
...
rule __GI_trunc_271cd1225ce2ecfc4690c5453540b39c {
	meta:
...
rule __ieee754_sinh_1c35c4e6706ce0b82a255e622b797ea3 {
	meta:
...
rule __GI_signal_dfcab1d766cb0568fa9e1c7ab3e72086 {
	meta:
		aliases = "bsd_signal, signal, __GI_signal"
		size = "142"
...
rule fstat64_3eb578abc5a627921cbc5ed83973bba1 {
	meta:
...
rule __GI_strpbrk_c3f279d4cd0516c265dc72d9ea47ddf2 {
	meta:
...
rule __GI_wcspbrk_cdd88d21c3f86c1ae4cbaac47f47a095 {
	meta:
...
rule __cmsg_nxthdr_3895bfe91d84b99dd72f3d5831d6eb74 {
	meta:
...
rule mq_send_4c7fdb29fd0d88a8091d52445b4b26c9 {
	meta:
		aliases = "__libc_pread, pread, mq_receive, mq_send"
		size = "35"
		objfiles = "mq_receive@librt.a, mq_send@librt.a, pread_write@libc.a"
	strings:
...
rule mq_timedsend_f43e4b84e8fd8c29e8cf51fdfd7b4207 {
	meta:
		...
		size = "35"
		objfiles = "mq_receive@librt.a, mq_send@librt.a"
	strings:
...
rule system_45be89b26f652cd63b96b28d8b5c1901 {
	meta:
...
rule mbrtowc_7e0d23a3704f952b82e5f66f11b67d62 {
	meta:
...
rule fdopen_unlocked_4055eda460634cf049c59e12199515a6 {
	meta:
		aliases = "fopen_unlocked, freopen_unlocked, fdopen_unlocked"
		size = "32"
		objfiles = "fopen_unlocked@libiberty.a"
	strings:
...
rule inet_network_128f05748ca3d69ba50c2e475a02cefb {
	meta:
...
rule __GI_svc_getreq_common_5803ba96f1ecceefca4628e199a7c561 {
	meta:
...
rule statvfs_2895ef6a5cac4ed657859fa2228c319f {
	meta:
		aliases = "__GI_statvfs, fstatvfs, __GI_fstatvfs, statvfs"
		size = "694"
...
rule __GI_ttyname_r_f331c4ba14a42a281941578306697f52 {
	meta:
...
rule __GI___ns_name_unpack_22ca98241acfad1f8d7d9b9519768cf7 {
	meta:
...
rule lldiv_b9d8ade3263168cf92646191bfc56c61 {
	meta:
...
rule __GI_setstate_r_3e8dc7edb59ded119e421b6c85efcd7e {
	meta:
...
rule getcwd_268ec49512df4ab4e6cd5f0b2ff7c9a2 {
	meta:
...
rule __GI_fgets_unlocked_d99d4954a8ef59046198b97511102d62 {
	meta:
...
rule __GI_sgetspent_r_9fc1af74478b4e94d0e5e3f199c2b800 {
	meta:
...
rule asctime_r_72033e360ed0cd877bdc27fc87c5356b {
	meta:
...
rule xdr_array_a8dff53bbe10ec47a96845d9e4eea576 {
	meta:
...
rule __GI_getgrgid_r_93d25cc325f005cc326e65e0a7ae696e {
	meta:
		aliases = "getgrgid_r, getpwuid_r, __GI_getpwuid_r, __GI_getgrgid_r"
		size = "141"
...
rule getgrnam_r_cc5f26c3b0fc4b0f9817cca9b8118eee {
	meta:
		aliases = "getpwnam_r, getspnam_r, __GI_getspnam_r, __GI_getgrnam_r, __GI_getpwnam_r, getgrnam_r"
		size = "152"
		objfiles = "getgrnam_r@libc.a, getpwnam_r@libc.a, getspnam_r@libc.a"
	strings:
...
rule getwc_unlocked_45bcdf6af301497df63f71f5b181b0ea {
	meta:
		aliases = "fgetwc_unlocked, __GI_fgetwc_unlocked, getwc_unlocked"
		size = "291"
...
rule re_search_2_f75877af709114739c3f24ff0453a001 {
	meta:
...
rule __GI___ns_name_ntop_e86e7d2137c485e59a59b7fe73891ace {
	meta:
...
rule ungetwc_575eed155b07ce08d1419641961e8c74 {
	meta:
...
rule ungetc_e74a1a50dc0bbd9b6a319395a5a404cd {
	meta:
...
rule ptsname_r_a990e7ad925503924636e3469ae65c74 {
	meta:
...
rule __GI_getprotobyname_r_ef52e89a92ef43e7f97fa4f5cac34803 {
	meta:
...
rule __GI_rresvport_3c6d772aef4ef59bdaacae18c480c6ec {
	meta:
...
rule __GI_memcmp_59308768507e091460e9d0dd5222f40a {
	meta:
...
rule inet_pton_78d81d57052c794f5af45d379ac7988c {
	meta:
...
rule sqrt_d4f2e8021838ae04fcdabb4f802d818e {
	meta:
...
rule getnetbyname_r_7c9be3faeb21465ba5e26b9dafa85583 {
	meta:
...
rule __GI_llround_0a43be2acac6c7e4afd83abd67d033ff {
	meta:
...
rule fmod_4e5655beffe0507eca74e8c584dd7f4f {
	meta:
		aliases = "__ieee754_fmod, __GI_fmod, fmod"
		size = "802"
...
rule __GI_clnttcp_create_2fd2f09b458b7629937f670ad1a7d0ea {
	meta:
...
rule clntunix_create_8724f0f1e77617b5c1861ecbaf712a75 {
	meta:
...
rule regexec_0270e96b8b4110986bdbd332c01a09ef {
	meta:
...
rule getaddrinfo_c5a8ee727bb93bdecdf30e93497996a8 {
	meta:
...
rule gethostbyname2_r_da48ffdcc0d22f0ae733c445e0011020 {
	meta:
...
rule __GI_rint_e880e6d9c845e6d62b55a63d1131f51b {
	meta:
		aliases = "rint, nearbyint, __GI_nearbyint, __GI_rint"
		size = "346"
...
rule __ieee754_remainder_09f81c3fd011841c6da9fb98ce19a2d6 {
	meta:
		aliases = "drem, remainder, __GI_remainder, __ieee754_remainder"
		size = "356"
...
rule atan2_2b84b7aac911b7c7fbdd563f0db2d381 {
	meta:
		aliases = "__ieee754_atan2, __GI_atan2, atan2"
		size = "581"
...
rule inet_ntop_cb4794542bacd3224e804d5b701ea2bc {
	meta:
...
rule __GI_vswprintf_9dae925b244fc04e02349dc8e53fa6c0 {
	meta:
...
rule __GI_random_r_21df100edf4572ca634cf5fde9d73f4b {
	meta:
...
rule __GI_getnetent_r_60123557147529fe364591676fdf146f {
	meta:
		aliases = "getnetent_r, __GI_getnetent_r"
		size = "335"
		objfiles = "getnet@libc.a"
	strings:
...
rule __GI_srandom_r_3aa6382036d83744f1f3bb4170390292 {
	meta:
...
rule __gthread_mutex_lock_8e32d675115a89f09922963dd96d399e {
	meta:
...
rule _pthread_cleanup_pop_restore_209f53a55b56508aac7e6cecd3595499 {
	meta:
...
rule __GI_execle_900f9665e55760501035516b93e04462 {
	meta:
...
rule __GI_glob_6650dbf8b49f7d7a3e7142009347fe27 {
	meta:
...
rule pthread_setcancelstate_f6dfc3e46ff600d6c6bfb696e3308826 {
	meta:
...
rule pthread_setcanceltype_c94c1a076e9de667fd6f6740b62073e7 {
	meta:
...
rule thread_self_ff5ff5468472ed8724cee51a9db2fab4 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "specific@libpthread.a, spinlock@libpthread.a, signals@libpthread.a, condvar@libpthread.a, errno@libpthread.a"
	strings:
...
rule tsearch_9cba3e81770dce55ebc9afb6cfea74bf {
	meta:
...
rule __GI_pthread_getschedparam_26e08ae21e31fbb8580070419a2701ea {
	meta:
...
rule __GI_sigwaitinfo_f186859f5c68ed036584959a1770f4a9 {
	meta:
		aliases = "__sigwaitinfo, sigwaitinfo, __GI_sigwaitinfo"
		size = "56"
...
rule __GI_globfree_3e9560fbee530230acd5a885ce7f07b9 {
	meta:
		aliases = "globfree64, globfree, __GI_globfree64, __GI_globfree"
		size = "76"
...
rule log_63f3470ea5d80d9455ca54bd4485ea37 {
	meta:
...
rule getrpcbynumber_ad9032efc830e5445632914253f08275 {
	meta:
...
rule __libc_siglongjmp_7f4abd0851d75fdee71ce179f2eb7116 {
	meta:
		aliases = "siglongjmp, _longjmp, __libc_longjmp, longjmp, __libc_siglongjmp"
		size = "55"
...
rule __GI_strlcpy_5f3d5198d069617a2c1546a336ce06cf {
	meta:
		aliases = "strlcpy, strxfrm, __GI_strlcpy"
		size = "59"
...
rule __GI_fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetspent_r, fgetpwent_r, fgetspent_r, fgetgrent_r, __GI_fgetgrent_r, __GI_fgetpwent_r"
		size = "55"
...
rule __GI_fputc_unlocked_37814e0cd8130bd524be30599725db3b {
	meta:
		aliases = "__GI___fputc_unlocked, putc_unlocked, __fputc_unlocked, __GI_putc_unlocked, fputc_unlocked, __GI_fputc_unlocked"
		size = "190"
...
rule __GI_getutent_5a6ac1b3b115cd17fed0c6c10f5be0b2 {
	meta:
		aliases = "getutent, __GI_getutent"
		size = "62"
		objfiles = "utent@libc.a"
	strings:
...
rule erf_8c6fdbc56bfa9ee92ff3a2861cad0caa {
	meta:
...
rule asin_840155dd38d435ed8e4e4d71968036ef {
	meta:
...
rule __libc_pread64_fdc4decd0846a01166c0d9d3b0a16348 {
	meta:
...
rule opendir_63a029f963ec2ceccec2e0dc592da06b {
	meta:
...
rule lockf_ad41319c8ff873a9e0d0629316b9fcb2 {
	meta:
...
rule __dl_iterate_phdr_b4946b3de8d2f7c4df46e4ffe23e5c7d {
	meta:
...
rule __GI_sigaction_81a579fbc42273d774fcf9cfd3c69295 {
	meta:
...
rule __GI_strcspn_a654a3750f115587d24d348acf958e70 {
	meta:
...
rule __GI_vfprintf_961c6882b239b75a0ed0b57b19286bff {
	meta:
...
rule getwc_39649a304ac71cdf4f647408584c6ce2 {
	meta:
		aliases = "__GI_fgetwc, fileno, __GI_fileno, fgetwc, getwc"
		size = "99"
...
rule fputwc_93c608f5c03035cb7b8ea2b514c58aa7 {
	meta:
		aliases = "__GI_fputws, putwc, __GI_fputs, fputs, fputws, fputwc"
		size = "102"
...
rule putc_281b52666df515955cee9f93dd40e500 {
	meta:
		aliases = "__GI_putc, __GI_fputc, fputc, putc"
		size = "150"
...
rule fgetws_c7ab7cbc0955bbd63e6b83999394dd51 {
	meta:
...
rule __GI_fwrite_de9382d5d68bece0a177a27b1bb63137 {
	meta:
...
rule closedir_8bdc030e485bc537171a43972bc0f327 {
	meta:
...
rule __GI_getpwent_r_0ebd27d559293f3957ce17608b106181 {
	meta:
		aliases = "getgrent_r, getspent_r, __GI_getgrent_r, getpwent_r, __GI_getspent_r, __GI_getpwent_r"
		size = "171"
		objfiles = "getgrent_r@libc.a, getspent_r@libc.a, getpwent_r@libc.a"
	strings:
...
rule erfc_1c9d009aec92743007b0add2b13bcd0e {
	meta:
...
rule __pthread_mutex_trylock_2359351772e8a4d7144d41f067d937c1 {
	meta:
...
rule __GI_statfs64_e2fe8981872cbcd00c43d38bac0c8dbb {
	meta:
...
rule rawmemchr_678722102f23171778f35fe759a3867e {
	meta:
...
rule __GI_waitpid_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "strtoull, strtoumax, wcstouq, strtouq, wcstoumax, waitpid, __GI_strtoul, wcstoul, wcstoull, strtoul, __libc_waitpid, __GI_waitpid"
		size = "26"
		objfiles = "waitpid@libc.a, strtoul@libc.a, strtoull@libc.a, wcstoull@libc.a, wcstoul@libc.a"
	strings:
...
rule __GI_strtoll_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "wcstoimax, wcstoq, strtoimax, strtoq, __GI_strtol, strtol, strtoll, wcstoll, wcstol, __GI_strtoll"
		size = "26"
		objfiles = "strtol@libc.a, strtoll@libc.a, wcstol@libc.a, wcstoll@libc.a"
	strings:
...
rule __initbuf_af0dea88dd623e832b305564140fd62c {
	meta:
		aliases = "__initbuf"
		size = "46"
		objfiles = "getproto@libc.a, getnet@libc.a"
	strings:
...
rule sigismember_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigaddset, sigdelset, __GI_sigaddset, __GI_sigdelset, sigismember"
		size = "42"
...
rule setttyent_07ac4232c0c7d6254b3f9cff3334babb {
	meta:
...
rule __GI___signbit_536a34fab7dcffc64c139646fb1bb5bd {
	meta:
...
rule __GI___rpc_thread_createerr_83e8589a66e08e3d7f7ecd2ef782dabc {
	meta:
...
rule __ieee754_lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "gamma, __GI_strtok, __GI_lgamma, lgamma, strtok, __ieee754_lgamma"
		size = "25"
...
rule atoll_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "__GI_atoi, atol, atoi, atoll"
		size = "20"
...
rule lrand48_r_c7069002931132f2dfc08888133d95bf {
	meta:
		aliases = "__GI_lrand48_r, drand48_r, mrand48_r, lrand48_r"
		size = "22"
...
rule inet_makeaddr_a1ed8657b31e3725a6c4d3601565bd3b {
	meta:
...
rule mkostemp_1a2c0490f5b8cdeeb9221e9da900869e {
	meta:
		aliases = "gmtime_r, bzero, mq_getattr, mkostemp"
		size = "22"
		objfiles = "gmtime_r@libc.a, mq_getsetattr@librt.a, bzero@libc.a, mkstemp@libc.a"
	strings:
...
rule vwscanf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "vwprintf, vprintf, vscanf, vwscanf"
		size = "26"
		objfiles = "vscanf@libc.a, vwscanf@libc.a, vprintf@libc.a, vwprintf@libc.a"
	strings:
...
rule mkstemp_f8ab71052a2c5ac93e65c0449d5ff783 {
	meta:
		aliases = "mkstemp64, mkstemp"
		size = "21"
		objfiles = "mkstemp64@libc.a, mkstemp@libc.a"
	strings:
...
rule asctime_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "__GI_inet_ntoa, hcreate, ether_ntoa, inet_ntoa, __GI_asctime, srand48, asctime"
		size = "21"
		objfiles = "hsearch@libc.a, asctime@libc.a, srand48@libc.a, inet_ntoa@libc.a, ether_addr@libc.a"
	strings:
...
rule localtime_0ae95ce91e5b77a2d2152eeb67234a6c {
	meta:
		aliases = "__GI_localtime, seed48, localtime"
		size = "26"
...
rule iswalnum_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "__GI_iswalnum, mktime, timelocal, iswalnum"
		size = "18"
...
rule gethostbyname_44c9108329ea01c01c96bfbe167c0d14 {
	meta:
		aliases = "iswalpha, __GI_gethostbyname, gethostbyname"
		size = "18"
		objfiles = "gethostbyname@libc.a, iswalpha@libc.a"
	strings:
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "spinlock@libpthread.a, manager@libpthread.a, condvar@libpthread.a, rwlock@libpthread.a, join@libpthread.a"
	strings:
...
rule _flushlbf_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "hdestroy, getlogin, __GI_getlogin, __pthread_once_fork_prepare, __open_etc_hosts, __pthread_once_fork_parent, _flushlbf"
		size = "17"
		objfiles = "getlogin@libc.a, hsearch@libc.a, read_etc_hosts_r@libc.a, _flushlbf@libc.a, mutex@libpthread.a"
	strings:
...
rule __GI_re_search_2183e4d8f03ca681e9ba33fafe22c649 {
	meta:
		aliases = "re_search, __GI_re_search"
		size = "42"
		objfiles = "regex_old@libc.a"
	strings:
...
rule xdrstdio_putint32_446f7039efc650c3a7d8de0845419b08 {
	meta:
...
rule scanf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "__GI_printf, printf, wscanf, wprintf, scanf"
		size = "32"
...
rule fwprintf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "__GI_syslog, fwscanf, fscanf, fprintf, __GI_fscanf, syslog, __GI_asprintf, __GI_fprintf, sscanf, swscanf, asprintf, __GI_sscanf, dprintf, fwprintf"
		size = "30"
		objfiles = "fwprintf@libc.a, sscanf@libc.a, fprintf@libc.a, syslog@libc.a, fwscanf@libc.a"
	strings:
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "llroundf, llrintf, lrintf, ilogbf, lroundf"
		size = "19"
		objfiles = "llroundf@libm.a, lrintf@libm.a, llrintf@libm.a, ilogbf@libm.a, lroundf@libm.a"
	strings:
...
rule erff_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "expm1f, tanf, atanhf, sinhf, significandf, log2f, logbf, erfcf, log1pf, asinf, floorf, lgammaf, acoshf, rintf, cosf, log10f, acosf, atanf, asinhf, truncf, ceilf, logf, tanhf, roundf, gammaf, sqrtf, exp2f, sinf, expf, fabsf, cbrtf, coshf, erff"
		size = "27"
		objfiles = "erfcf@libm.a, cosf@libm.a, sinhf@libm.a, lgammaf@libm.a, cbrtf@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "hypotf, copysignf, scalbf, powf, atan2f, fmodf, remainderf"
		size = "35"
		objfiles = "atan2f@libm.a, scalbf@libm.a, remainderf@libm.a, hypotf@libm.a, fmodf@libm.a"
	strings:
...
rule getservbyport_f5f52c5a65a4a139c99a519427d2801d {
	meta:
...
rule getprotobynumber_1c2ca1e9afd0068febc3199b68160d72 {
	meta:
...
rule ilogb_78663a7c013b95fe5c3df254f23ac384 {
	meta:
...
rule __GI_fmin_4922489c17678736a5558ceb804536c3 {
	meta:
...
rule getgrnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetpwent, getgrgid, fgetgrent, getspnam, getpwuid, sgetspent, fgetspent, getpwnam, getgrnam"
		size = "40"
		objfiles = "getpwuid@libc.a, fgetspent@libc.a, getspnam@libc.a, fgetpwent@libc.a, getgrnam@libc.a"
	strings:
...
rule __GI_cos_58d947ac4c8a595e79382ab8f32eef92 {
	meta:
...
rule log1p_5f8c103a92a76772575c475840832dc1 {
	meta:
...
rule __GI_exp_3a89ca36e0cd59d0b24a53c3ad9716c8 {
	meta:
		aliases = "exp, __ieee754_exp, __GI_exp"
		size = "491"
...
rule getpagesize_3024c64e997e377124e64769a36ebb91 {
	meta:
...
rule __GI_vwarnx_44876ef1aeecd091b1403e996f12ba69 {
	meta:
...
rule pthread_mutexattr_gettype_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np, __GI_pthread_attr_getdetachstate, pthread_mutexattr_getkind_np, pthread_rwlockattr_getkind_np, __pthread_mutexattr_gettype, pthread_mutexattr_gettype"
		size = "15"
...
rule pthread_attr_getschedparam_bf01487b64a973dd33d77632c300357d {
	meta:
		aliases = "sem_getvalue, __GI_pthread_attr_getschedparam, __new_sem_getvalue, pthread_attr_getschedparam"
		size = "16"
...
rule setenv_e63fbd4454ec064dc8f9d0b775e2be85 {
	meta:
		aliases = "svcfd_create, svcunixfd_create, __GI_setenv, setenv"
		size = "17"
		objfiles = "svc_unix@libc.a, svc_tcp@libc.a, setenv@libc.a"
	strings:
...
rule pthread_rwlockattr_init_9cccfab68f4bd16a32525f638f9dcc39 {
	meta:
		aliases = "__GI_sigemptyset, sigemptyset, pthread_rwlockattr_init"
		size = "20"
...
rule towlower_48138e3d9f8c60c2c473cafe14662f16 {
	meta:
		aliases = "towupper, __GI_towupper, __GI_towlower, towlower"
		size = "21"
...
rule __GI_wcscoll_e91a61111c295dab6c061b7848cdcf0d {
	meta:
...
rule tolower_d7d4521aee6b4c2c35428947fe099a90 {
	meta:
		aliases = "__GI_tolower, toupper, __GI_toupper, tolower"
		size = "29"
...
rule __GI_isblank_5417f1fb8e36c6e932252b09ead9d0c1 {
	meta:
...
rule __GI_isalpha_ae2fe3c00f0d2b34d5515092d9ace8ee {
	meta:
		aliases = "isalpha, __GI_isalpha"
		size = "17"
...
rule __fpclassifyf_476febbfbab64225d1076cc2b842d146 {
	meta:
...
rule __pthread_mutexattr_settype_c966b71060253b953a535d91cc13d1cf {
	meta:
		aliases = "__pthread_mutexattr_setkind_np, pthread_mutexattr_settype, pthread_mutexattr_setkind_np, __pthread_mutexattr_settype"
		size = "23"
		objfiles = "mutex@libpthread.a"
	strings:
...
rule localeconv_910d4405aa4463b5e5308bfee7d955ef {
	meta:
...
rule __GI_getgid_43841467502e2c11272083900f672688 {
	meta:
...
rule __GI_getegid_b99714489a7ddffc84a058ac1c8dc2d6 {
	meta:
...
rule __GI_fma_394493ef54a844d9006d78ae6390ed25 {
	meta:
