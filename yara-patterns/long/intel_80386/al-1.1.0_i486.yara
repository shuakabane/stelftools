...
rule close_593d4632d655ae75a9db77d772cf7bf1 {
	meta:
		aliases = "wait, tcdrain, fsync, system, close"
		size = "43"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule write_966d33990ea41d94ea545ad487f15973 {
	meta:
		aliases = "sendmsg, recvmsg, msync, lseek, connect, waitpid, accept, read, __GI_waitpid, write"
		size = "51"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule epoll_wait_c2940d127b00fb25b0bbd004ee5c830a {
	meta:
		aliases = "pread, send, recv, pwrite, epoll_wait"
		size = "55"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_fcntl64_8b863a195b65166308d9e6b45aa5501d {
	meta:
...
rule fgetc_unlocked_e8150f2fa63846a8bbb3e1cc896ad04e {
	meta:
		aliases = "__GI_getc_unlocked, __GI___fgetc_unlocked, __GI_fgetc_unlocked, __fgetc_unlocked, getc_unlocked, fgetc_unlocked"
		size = "204"
...
rule sighold_5e4987a68d7b81f344dc4555a7641c11 {
	meta:
...
rule endnetent_a4fe55b18bbe578f070411ce5006e39f {
	meta:
		aliases = "__GI_endprotoent, __GI_endnetent, endprotoent, endnetent"
		size = "83"
		objfiles = "getnet@libc.a, getproto@libc.a"
	strings:
...
rule __GI_gethostent_r_851ea925ba67f4db77298336aa6ceb65 {
	meta:
...
rule bsd_signal_fc9fe89dd9159edeaad7e7210c81353b {
	meta:
...
rule __GI_pmap_unset_cefb065dfae3c12ceba0fb217d42321e {
	meta:
...
rule __GI_lstat_5e1476ed1da0a799cf9631d901d57855 {
	meta:
...
rule __GI_fstatvfs_df3c1346be5dc07be898b02e33405ccf {
	meta:
		aliases = "__GI_statvfs, statvfs, fstatvfs, __GI_fstatvfs"
		size = "644"
...
rule __GI_vsyslog_0e15fa08caf63aca07cf937fb68b5ad7 {
	meta:
...
rule __GI_getprotobyname_r_9d4cfd852722360d517271ac1a4acfef {
	meta:
...
rule __GI_readdir_r_baefc56fbac74ac58064e56c685b177d {
	meta:
...
rule __GI_setvbuf_4722100226023b8ae72bba6802f44122 {
	meta:
...
rule drem_9b7e963d6d8f0cd0936e1d4c9b1a8f40 {
	meta:
		aliases = "__ieee754_remainder, remainder, __GI_remainder, drem"
		size = "343"
...
rule __GI_gethostbyaddr_r_252d1a1c395aca6c6dac2df84f0d3204 {
	meta:
...
rule nearbyint_c33b757d88fac953ad50fae5e08e6958 {
	meta:
		aliases = "rint, __GI_rint, __GI_nearbyint, nearbyint"
		size = "342"
...
rule getspnam_r_e612ed03d06dd4fd4054bcb61abc8918 {
	meta:
		aliases = "__GI_getpwnam_r, __GI_getgrnam_r, getpwnam_r, __GI_getspnam_r, getgrnam_r, getspnam_r"
		size = "135"
...
rule thread_self_dd5dae98b7dbe953d0d7e291f00b93db {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "spinlock@libpthread.a, specific@libpthread.a, semaphore@libpthread.a, condvar@libpthread.a, cancel@libpthread.a"
	strings:
...
rule putc_unlocked_b15a6f9755d891f780cb639030287476 {
	meta:
		aliases = "__fputc_unlocked, __GI_fputc_unlocked, __GI_putc_unlocked, fputc_unlocked, __GI___fputc_unlocked, putc_unlocked"
		size = "181"
...
rule _longjmp_80874c12c0923f06960ef9b6fc6b2db8 {
	meta:
		aliases = "longjmp, __libc_siglongjmp, __libc_longjmp, siglongjmp, _longjmp"
		size = "45"
...
rule fgetgrent_r_e1f38611a4b1ad9d822de85e67acd783 {
	meta:
		aliases = "fgetpwent_r, __GI_fgetpwent_r, fgetspent_r, __GI_fgetspent_r, __GI_fgetgrent_r, fgetgrent_r"
		size = "51"
...
rule __GI_vfwprintf_ae36769e02c39fcbe7bcfdabeb553a85 {
	meta:
...
rule fileno_4ad83eeaa60553f98b832d8b316ee87f {
	meta:
		aliases = "fgetwc, __GI_fileno, __GI_fgetwc, getwc, fileno"
		size = "88"
...
rule fputws_2addd2dd28334c1098b0e5698a927b1e {
	meta:
		aliases = "__GI_fputs, __GI_fputws, fputwc, fputs, putwc, fputws"
		size = "93"
...
rule __GI_fgets_d10e34421d17195167bce077ef9a47f4 {
	meta:
...
rule getpwent_r_7ee86d6829de12dd3af398a00bb65158 {
	meta:
		aliases = "__GI_getspent_r, getgrent_r, __GI_getpwent_r, getspent_r, __GI_getgrent_r, getpwent_r"
		size = "161"
		objfiles = "getspent_r@libc.a, getgrent_r@libc.a, getpwent_r@libc.a"
	strings:
...
rule __GI_ftello64_e0cb90bef7249129641678e05ea255b6 {
	meta:
...
rule __GI_ctime_d075ea8487bd6855710a9e02889c5cb2 {
	meta:
...
rule ether_aton_e214931d143cca1a32199edb31adc4a0 {
	meta:
		aliases = "hcreate, asctime, __GI_asctime, ether_ntoa, __GI_inet_ntoa, inet_ntoa, ether_aton"
		size = "17"
...
rule lgamma_ce767ada53bd455cecd0660edb8a7c87 {
	meta:
		aliases = "__GI_strtok, gamma, __GI_lgamma, strtok, __ieee754_lgamma, lgamma"
		size = "22"
...
rule wcstoumax_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		aliases = "wcstoul, wcstouq, strtouq, strtoumax, strtoul, __GI_strtoul, waitpid, __libc_waitpid, wcstoull, strtoull, __GI_waitpid, wcstoumax"
		size = "23"
...
rule strtol_fe8e5520a3eef7a03748f1ff8e71080f {
	meta:
		aliases = "wcstoll, strtoq, __GI_strtol, __GI_strtoll, wcstoq, strtoimax, strtoll, wcstol, wcstoimax, strtol"
		size = "23"
...
rule fgetspent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		aliases = "getpwnam, getgrgid, getspnam, fgetpwent, sgetspent, fgetgrent, getgrnam, getpwuid, fgetspent"
		size = "38"
		objfiles = "getspnam@libc.a, fgetpwent@libc.a, fgetgrent@libc.a, fgetspent@libc.a, getgrgid@libc.a"
	strings:
...
rule __GI_printf_d49bdeb5a2c59b42a4876d324b1f6480 {
	meta:
		aliases = "scanf, wprintf, wscanf, printf, __GI_printf"
		size = "30"
...
rule fwprintf_3674412569e427ab0f649983548971e5 {
	meta:
		aliases = "syslog, dprintf, __GI_fprintf, asprintf, fwscanf, sscanf, __GI_syslog, swscanf, __GI_asprintf, __GI_fscanf, fscanf, __GI_sscanf, fprintf, fwprintf"
		size = "28"
		objfiles = "sscanf@libc.a, fprintf@libc.a, asprintf@libc.a, syslog@libc.a, fwprintf@libc.a"
	strings:
...
rule logbf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		aliases = "rintf, roundf, coshf, atanhf, truncf, acosf, log2f, log1pf, acoshf, asinhf, logf, lgammaf, cbrtf, erfcf, sinhf, significandf, sinf, tanhf, tanf, floorf, atanf, cosf, gammaf, expm1f, fabsf, erff, ceilf, log10f, sqrtf, expf, exp2f, asinf, logbf"
		size = "27"
		objfiles = "sqrtf@libm.a, significandf@libm.a, log2f@libm.a, roundf@libm.a, asinf@libm.a"
	strings:
...
rule scalbf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		aliases = "powf, fmodf, hypotf, copysignf, atan2f, remainderf, scalbf"
		size = "35"
		objfiles = "scalbf@libm.a, fmodf@libm.a, copysignf@libm.a, powf@libm.a, hypotf@libm.a"
	strings:
...
rule __GI_htons_abb47f3111edd8b51bf0127264a91b58 {
	meta:
		aliases = "__GI_ntohs, ntohs, htons, __GI_htons"
		size = "12"
...
rule pthread_rwlockattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, __GI_pthread_attr_getdetachstate, __pthread_mutexattr_gettype, pthread_rwlockattr_getkind_np"
		size = "15"
...
rule svcfd_create_e63fbd4454ec064dc8f9d0b775e2be85 {
	meta:
		aliases = "setenv, __GI_setenv, svcunixfd_create, svcfd_create"
		size = "17"
...
rule __GI_sigdelset_016a84adaadaa75b24de597e41b23cce {
	meta:
...
rule __GI_cfsetospeed_c9dee19717e8162947de03fa44ec1d3b {
	meta:
...
rule toupper_d7d4521aee6b4c2c35428947fe099a90 {
	meta:
		aliases = "__GI_toupper, __GI_tolower, tolower, toupper"
		size = "29"
...
rule __GI_verr_e995d28d2bc805c6592260c44650cadd {
	meta:
		aliases = "verrx, __GI_verrx, verr, __GI_verr"
		size = "22"
		objfiles = "err@libc.a"
	strings:
