...
rule __GI_xdrrec_eof_045f37614bfed502b95473752736585f {
	meta:
...
rule __GI___libc_statfs_66b9353b0907b20e9d3c17ba1263b522 {
	meta:
		aliases = "__GI_statfs, statfs, __libc_statfs, __GI___libc_statfs"
		size = "49"
...
rule __GI_fgetc_unlocked_a8c421194d2423dabb3cc9829e1d3697 {
	meta:
		aliases = "__GI___fgetc_unlocked, fgetc_unlocked, getc_unlocked, __fgetc_unlocked, __GI_getc_unlocked, __GI_fgetc_unlocked"
		size = "220"
...
rule __GI_endnetent_0d96bf4fc2561ebab2649fbb03aaf667 {
	meta:
		aliases = "__GI_endprotoent, endprotoent, endnetent, __GI_endnetent"
		size = "92"
...
rule __GI_waitpid_7fafe2d4042f052134436ac4f9e768f2 {
	meta:
		aliases = "sendmsg, accept, waitpid, lseek, __GI_waitpid"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule connect_f76fa2a31d5e51010722d3c9bb015e20 {
	meta:
		aliases = "recvmsg, write, msync, read, connect"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_getcwd_1c6ac4b3fa553a87cb6769561527d2ef {
	meta:
...
rule getspnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "__GI_getgrnam_r, __GI_getspnam_r, getgrnam_r, __GI_getpwnam_r, getpwnam_r, getspnam_r"
		size = "153"
...
rule __GI_wcsnrtombs_a0950682703bb68c5966382ce403bae3 {
	meta:
...
rule __GI_pthread_setcanceltype_cec9b0cead7bc96aa226dff38cf7932b {
	meta:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "pthread@libpthread.a, mutex@libpthread.a, join@libpthread.a, specific@libpthread.a, cancel@libpthread.a"
	strings:
...
rule strlcpy_0fda2a604b0b5c1c17a1edf68666a4c0 {
	meta:
...
rule __GI___libc_fcntl_4f8304f8fb43f6ff31436762fc2e60eb {
	meta:
		aliases = "__GI_fcntl, fcntl, __libc_fcntl, __GI___libc_fcntl"
		size = "87"
...
rule __GI_getspent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "getspent_r, getgrent_r, __GI_getgrent_r, getpwent_r, __GI_getpwent_r, __GI_getspent_r"
		size = "171"
		objfiles = "getpwent_r@libc.a, getgrent_r@libc.a, getspent_r@libc.a"
	strings:
...
rule __GI_strncat_5c4732bec88df1b6af4ee955f5c6c6e7 {
	meta:
...
rule __GI_waitpid_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "wcstouq, strtoul, wcstoumax, wcstoul, __GI_wcstoull, strtoull, strtouq, waitpid, strtoumax, __GI_strtoull, __GI_wcstoul, wcstoull, __GI_strtoul, __libc_waitpid, __GI_waitpid"
		size = "26"
		objfiles = "strtoul@libc.a, wcstoul@libc.a, waitpid@libc.a, wcstoull@libc.a, strtoull@libc.a"
	strings:
...
rule __GI_strtoll_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "wcstoimax, strtoll, __GI_wcstol, strtoimax, strtoq, wcstoll, wcstoq, wcstol, __GI_strtol, strtol, __GI_wcstoll, __GI_strtoll"
		size = "26"
...
rule lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "strtok, __ieee754_gamma, __GI_lgamma, gamma, __ieee754_lgamma, __GI_strtok, lgamma"
		size = "25"
...
rule fputwc_unlocked_173166608ee9ab184afff2d4ff75d1ae {
	meta:
...
rule scalbnf_312f3131b70190222fba14e3c3defea1 {
	meta:
		aliases = "ldexpf, frexpf, scalblnf, scalbnf"
		size = "34"
...
rule __GI_asctime_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "inet_ntoa, asctime, hcreate, ether_ntoa, srand48, __GI_inet_ntoa, __GI_asctime"
		size = "21"
...
rule timelocal_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "__GI_iswalnum, iswalnum, mktime, mkstemp64, timelocal"
		size = "18"
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "pthread@libpthread.a, join@libpthread.a, manager@libpthread.a, rwlock@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule getlogin_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "hdestroy, __pthread_once_fork_prepare, __GI_getlogin, __pthread_once_fork_parent, _flushlbf, getlogin"
		size = "17"
...
rule fscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "__GI_asprintf, __GI_fprintf, __GI_fscanf, dprintf, fprintf, swscanf, fwprintf, sscanf, __GI_syslog, syslog, asprintf, fwscanf, __GI_sscanf, fscanf"
		size = "30"
		objfiles = "dprintf@libc.a, fprintf@libc.a, fscanf@libc.a, fwscanf@libc.a, sscanf@libc.a"
	strings:
...
rule llroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		size = "19"
		objfiles = "llroundf@libm.a, llrintf@libm.a, lroundf@libm.a, ilogbf@libm.a, lrintf@libm.a"
	strings:
...
rule tanhf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "sqrtf, erfcf, coshf, lgammaf, sinf, cosf, floorf, log1pf, truncf, expm1f, ceilf, logf, logbf, rintf, log10f, erff, acosf, expf, tgammaf, cbrtf, acoshf, atanhf, atanf, sinhf, asinhf, asinf, fabsf, tanf, roundf, tanhf"
		size = "27"
		objfiles = "logf@libm.a, log10f@libm.a, tgammaf@libm.a, fabsf@libm.a, sinf@libm.a"
	strings:
...
rule fmodf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "copysignf, remainderf, hypotf, powf, atan2f, nextafterf, fmodf"
		size = "35"
		objfiles = "nextafterf@libm.a, atan2f@libm.a, remainderf@libm.a, powf@libm.a, hypotf@libm.a"
	strings:
...
rule fgetpwent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "getgrnam, sgetspent, getpwuid, fgetgrent, fgetspent, getgrgid, getpwnam, getspnam, fgetpwent"
		size = "40"
		objfiles = "fgetpwent@libc.a, fgetspent@libc.a, getpwuid@libc.a, getgrgid@libc.a, fgetgrent@libc.a"
	strings:
...
rule __GI_pthread_attr_getdetachsta_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, pthread_rwlockattr_getkind_np, pthread_attr_getdetachstate, pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate"
		size = "15"
