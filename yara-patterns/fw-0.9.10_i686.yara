...
rule pthread_attr_destroy_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		size = "3"
		objfiles = "clnt_raw@libc.a, __uClibc_main@libc.a, mutex@libpthread.a, wcsftime@libc.a, attr@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __gcov_flush_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		size = "5"
		objfiles = "_gcov_merge_add@libgcov.a, _gcov@libgcov.a, _clear_cache@libgcc.a, _enable_execute_stack@libgcc.a, _gcov_merge_delta@libgcov.a"
	strings:
...
rule thread_self_8edc8dc4e86c2e49d2a4a127f12d8902 {
	meta:
		...
		size = "68"
		objfiles = "signals@libpthread.a, errno@libpthread.a, join@libpthread.a, spinlock@libpthread.a, mutex@libpthread.a"
	strings:
...
rule strtol_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		...
		size = "26"
		objfiles = "wcstoll@libc.a, wcstol@libc.a, strtoll@libc.a, strtol@libc.a"
	strings:
...
rule __ieee754_gamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		...
		size = "25"
		objfiles = "w_gamma@libm.a, e_gamma@libm.a, strtok@libc.a, w_lgamma@libm.a, e_lgamma@libm.a"
	strings:
...
rule hcreate_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		...
		size = "21"
		objfiles = "hsearch@libc.a, asctime@libc.a, inet_ntoa@libc.a, srand48@libc.a, ether_addr@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "manager@libpthread.a, join@libpthread.a, spinlock@libpthread.a, semaphore@libpthread.a, pthread@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		size = "30"
		objfiles = "fwprintf@libc.a, fwscanf@libc.a, dprintf@libc.a, fprintf@libc.a, syslog@libc.a"
	strings:
...
rule ilogbf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		size = "19"
		objfiles = "lroundf@libm.a, llrintf@libm.a, lrintf@libm.a, llroundf@libm.a, ilogbf@libm.a"
	strings:
...
rule acosf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "truncf, tgammaf, tanhf, tanf, sqrtf, sinhf, sinf, roundf, rintf, logf, logbf, log1pf, log10f, lgammaf, floorf, fabsf, expm1f, expf, erff, erfcf, coshf, cosf, ceilf, cbrtf, atanhf, atanf, asinhf, asinf, acoshf, acosf"
		size = "27"
		objfiles = "coshf@libm.a, cbrtf@libm.a, erff@libm.a, logf@libm.a, asinf@libm.a"
	strings:
...
rule atan2f_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		size = "35"
		objfiles = "atan2f@libm.a, hypotf@libm.a, fmodf@libm.a, nextafterf@libm.a, powf@libm.a"
	strings:
...
rule getgrnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		size = "40"
		objfiles = "fgetspent@libc.a, fgetpwent@libc.a, fgetgrent@libc.a, getpwuid@libc.a, sgetspent@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		size = "4"
		objfiles = "_floatdidf@libgcc.a, unwind_dw2_fde_glibc@libgcc_eh.a, _fixunsdfsi@libgcc.a, _floatdixf@libgcc.a, _floatundixf@libgcc.a"
	strings:
...
rule __get_pc_thunk_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		size = "4"
		objfiles = "_fixdfdi@libgcc.a, _muldc3@libgcc.a, crtendS, _negvsi2@libgcc.a, _popcountsi2@libgcc.a"
	strings:
...
rule floatformat_always_valid_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		size = "6"
		objfiles = "_stdlib_mb_cur_max@libc.a, oldsemaphore@libpthread.a, auth_none@libc.a, floatformat@libiberty.a, xdr@libc.a"
	strings:
