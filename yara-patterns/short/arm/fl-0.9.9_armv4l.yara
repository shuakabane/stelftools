...
rule C_alloca_3144ab39ce92d2ea90573c766714c94f {
	meta:
		aliases = "C_alloca"
		size = "229"
		objfiles = "alloca@libiberty.a"
	strings:
		$pattern = { ( CC | 41 ) 55 49 89 FD 41 54 55 53 48 83 EC 18 8B 05 ?? ?? ?? ?? 85 C0 0F 84 B5 00 00 00 48 8B 3D ?? ?? ?? ?? 44 8B 25 ?? ?? ?? ?? 48 8D 6C 24 0F 48 85 FF 74 7D 0F 1F 44 00 00 41 83 FC 00 7E 52 48 39 6F 08 77 54 4D 85 ED 48 89 3D ?? ?? ?? ?? 74 6E 49 8D 7D 10 E8 ?? ?? ?? ?? 48 85 C0 74 7C 48 8B 15 ?? ?? ?? ?? 48 89 05 ?? ?? ?? ?? 48 89 10 48 8D 54 24 0F 48 89 50 08 48 83 C4 18 48 83 C0 10 5B 5D 41 5C 41 5D C3 66 0F 1F 84 00 00 00 00 00 74 B2 48 39 6F 08 73 AC 48 8B 1F E8 ?? ?? ?? ?? 48 85 DB 74 0B 48 89 DF EB 8E 66 0F 1F 44 00 00 31 FF 4D 85 ED 48 89 3D ?? ?? ?? ?? 75 92 48 83 C4 18 31 C0 5B 5D 41 5C }
	condition:
		$pattern
}
...
rule strncmp_1ceabbd748ccfd85420fa0d0d3f22462 {
	meta:
		aliases = "strncmp"
		size = "51"
		objfiles = "strncmp@libiberty.a"
	strings:
		$pattern = { ( CC | 48 ) 01 FA EB 19 0F 1F 00 0F B6 07 0F B6 0E 48 83 C7 01 48 83 C6 01 38 C8 75 16 84 C0 74 05 48 39 D7 75 E5 31 C0 C3 66 2E 0F 1F 84 00 00 00 00 00 29 C8 C3 }
	condition:
		$pattern
}
...
rule __re_set_registers_78a52c8468d38fd610d23d781e1a131a {
	meta:
...
rule getlogin_fc8ec5668766e9d4bf46e8a92f82ac48 {
	meta:
		aliases = "__GI_getlogin, _flushlbf, hdestroy, __pthread_once_fork_parent, __pthread_once_fork_prepare, getlogin"
		size = "12"
...
rule __gthread_mutex_unlock_6784a51311637d8b420ae445bb38bfaa {
	meta:
		aliases = "_Unwind_GetDataRelBase, pthread_condattr_init, __pthread_mutexattr_destroy, __pthread_mutex_unlock, clntraw_control, __pthread_mutex_lock, _Unwind_GetTextRelBase, _Unwind_GetRegionStart, _svcauth_null, __GI_pthread_attr_destroy, __GI_pthread_condattr_destroy, __GI_wcsftime, xdrstdio_inline, _Unwind_FindEnclosingFunction, __udiv_w_sdiv, __pthread_mutex_trylock, pthread_condattr_destroy, pthread_rwlockattr_destroy, __GI_pthread_condattr_init, wcsftime, authnone_refresh, __gthread_mutex_lock, pthread_attr_destroy, __pthread_return_0, __pthread_mutex_init, grantpt, __gthread_active_p, pthread_mutexattr_destroy, __gthread_mutex_unlock"
		size = "8"
		objfiles = "auth_none@libc.a, grantpt@libc.a, rwlock@libpthread.a, __uClibc_main@libc.a, _udiv_w_sdiv@libgcc.a"
	strings:
...
rule ether_ntoa_c102ded2904d5b1c7d2f9a901aa4e61b {
	meta:
		aliases = "__GI_inet_ntoa, inet_ntoa, asctime, hcreate, ether_aton, srand48, __GI_asctime, ether_ntoa"
		size = "12"
		objfiles = "srand48@libc.a, inet_ntoa@libc.a, hsearch@libc.a, ether_addr@libc.a, asctime@libc.a"
	strings:
...
rule atoll_deef6c6063aa04a17c5a206f19cbcf02 {
	meta:
		aliases = "atoi, __GI_atoi, __GI_atol, atol, atoll"
		size = "12"
...
rule _setjmp_7cbf426d061c005a73514c9fc2b9103b {
	meta:
		aliases = "atof, sigpause, __GI_sigpause, mkstemp, _setjmp"
		size = "8"
		objfiles = "bsd__setjmp@libc.a, sigpause@libc.a, mkstemp@libc.a, atof@libc.a"
	strings:
...
rule __GI_strtok_9126d5dc6e7144618f0e6e40fd40fbef {
	meta:
		aliases = "__ieee754_gamma, gamma, __GI_lgamma, __ieee754_lgamma, strtok, lgamma, __GI_strtok"
		size = "12"
		objfiles = "e_lgamma@libm.a, w_lgamma@libm.a, e_gamma@libm.a, strtok@libc.a, w_gamma@libm.a"
	strings:
...
rule wcscoll_a3b541edbf35adc36810dbf35431bc47 {
	meta:
		aliases = "wcscmp, __GI_wcscmp, __GI_wcscoll, wcscoll"
		size = "52"
...
rule __GI_strtold_fc92c81c76d09d9760b582222f719bcc {
	meta:
		aliases = "wcstold, strtold, __GI_wcstold, __GI_strtold"
		size = "8"
...
rule sigdelset_fd9ce6819bfc06c14eb42fa50fbc768c {
	meta:
		aliases = "__GI_sigaddset, sigaddset, sigismember, __GI_sigdelset, sigdelset"
		size = "48"
...
rule __pthread_mutexattr_gettype_0b416f364d729a7dc563889c583f0308 {
	meta:
		aliases = "pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, pthread_mutexattr_gettype, pthread_mutexattr_getkind_np, __GI_pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype"
		size = "16"
...
rule __aeabi_ui2f_8bdab7fc7baffea2941b8641de057444 {
	meta:
...
rule __libc_waitpid_843f778e2f492a8c473fdc97c05cc653 {
	meta:
		aliases = "__GI_wcstoul, __GI_strtoul, __GI_wcstoull, __GI_strtoull, __GI_waitpid, waitpid, strtoull, wcstoul, strtoumax, wcstoumax, wcstouq, strtouq, wcstoull, strtoul, __libc_waitpid"
		size = "8"
...
rule pthread_condattr_setpshared_fe029dee1c86b07e98c7bc55f938804d {
	meta:
...
rule authnone_validate_1ce4a30a252936ca418941b102aaafc1 {
	meta:
		aliases = "old_sem_extricate_func, __GI_xdr_void, _stdlib_mb_cur_max, xdr_void, __GI__stdlib_mb_cur_max, authnone_validate"
		size = "8"
...
rule mktime_7ed5691c266e6284422b683ded03d596 {
	meta:
		aliases = "__GI_iswalnum, iswalnum, setjmp, timelocal, mkstemp64, mktime"
		size = "8"
		objfiles = "mkstemp64@libc.a, iswalnum@libc.a, mktime@libc.a, bsd_setjmp@libc.a"
	strings:
...
rule wcstoimax_9e5ba6842b34889a4f189c941dd42ba4 {
	meta:
		aliases = "__GI_strtol, wcstol, strtoq, wcstoq, __GI_strtoll, strtoimax, strtol, __GI_wcstol, strtoll, __GI_wcstoll, wcstoll, wcstoimax"
		size = "8"
...
rule __eqsf2_20190a500a376de588b255af7f06cddf {
	meta:
		aliases = "__nesf2, __cmpsf2, __eqsf2"
		size = "96"
		objfiles = "_cmpsf2@libgcc.a"
	strings:
...
rule __cmpdf2_8d2cd9eee0fdc8c659f057219ecbfdad {
	meta:
		aliases = "__eqdf2, __nedf2, __cmpdf2"
		size = "132"
		objfiles = "_cmpdf2@libgcc.a"
	strings:
...
rule rendezvous_stat_ae78ace192a33af724e3cae5712c1237 {
	meta:
		aliases = "svcraw_stat, _svcauth_short, svcudp_stat, rendezvous_stat"
		size = "8"
		objfiles = "svc_raw@libc.a, svc_authux@libc.a, svc_unix@libc.a, svc_tcp@libc.a, svc_udp@libc.a"
	strings:
...
rule __GI___signbit_4b8f21fb04c77b43d51bc2a86522ce44 {
	meta:
		aliases = "__GI___signbitf, __signbitf, __signbit, __GI___signbit"
		size = "8"
...
rule __aeabi_fneg_91f9f13c92a8ce442cf9c1dcc6a7dfff {
	meta:
		aliases = "__aeabi_dneg, __negsf2, __negdf2, __aeabi_fneg"
		size = "8"
...
rule setenv_3852165bc678d1a6955c2fb37b9cba81 {
	meta:
...
rule pthread_attr_getschedpolicy_b1929ea2af7ddfbad2e7cee3aaf5d5bb {
	meta:
...
rule pthread_getconcurrency_5762a499c2b87f8f0b5af31c6e1fff14 {
	meta:
		aliases = "_Unwind_SjLj_GetContext, __libc_current_sigrtmax, __libc_current_sigrtmin, __pthread_getconcurrency, pthread_getconcurrency"
		size = "16"
...
rule __libc_posix_fadvise64_8763f11501fb1d5618cf24457a340477 {
	meta:
...
rule mq_receive_34983e4a6eddf636c1210e403db40ad6 {
	meta:
		aliases = "mq_send, mq_receive"
		size = "28"
...
rule sysv_signal_9e77f553c58be841b3cf121bef23a2af {
	meta:
...
rule re_compile_pattern_41788eaaa12e858d98616ab23a4a929f {
	meta:
...
rule call_frame_dummy_997de91c60dfeaa7966cf399b0caa4a3 {
	meta:
		...
		size = "8"
		objfiles = "crtbeginT, crtbeginS, crtbegin, crtendS, crtend"
	strings:
...
rule fgetpwent_782ead4dc851d14a304b763550b392bd {
	meta:
		aliases = "sgetspent, fgetgrent, getpwnam, getspnam, fgetspent, getgrgid, getgrnam, getpwuid, fgetpwent"
		size = "52"
		objfiles = "getgrnam@libc.a, fgetpwent@libc.a, fgetspent@libc.a, getgrgid@libc.a, getpwuid@libc.a"
	strings:
...
rule lrintf_c4ff7ef54e5728e438def535189f6899 {
	meta:
		aliases = "llrintf, ctime, ilogbf, llroundf, lroundf, __GI_ctime, lrintf"
		size = "16"
		objfiles = "ilogbf@libm.a, llrintf@libm.a, lroundf@libm.a, ctime@libc.a, llroundf@libm.a"
	strings:
...
rule clnt_perror_8213424d9423719eb0f7c5bff68b7e51 {
	meta:
		aliases = "clnt_pcreateerror, __GI_clnt_perror, clnt_perrno, clnt_perror"
		size = "28"
...
rule expm1f_3a1a777b192db480491cbf217784f1e6 {
	meta:
		aliases = "acosf, log10f, ceilf, tanhf, floorf, rintf, fabsf, asinhf, asinf, acoshf, sqrtf, sinhf, log1pf, logbf, cosf, lgammaf, tanf, roundf, cbrtf, logf, atanhf, truncf, expf, erfcf, tgammaf, coshf, sinf, erff, atanf, expm1f"
		size = "20"
		objfiles = "asinhf@libm.a, rintf@libm.a, lgammaf@libm.a, expm1f@libm.a, sinhf@libm.a"
	strings:
...
rule __aeabi_fcmpgt_f52cbcbfa58e06c8588cd1fb7e67afd3 {
	meta:
		aliases = "__aeabi_dcmplt, __aeabi_fcmplt, __aeabi_dcmpgt, __aeabi_fcmpgt"
		size = "20"
		objfiles = "_cmpdf2@libgcc.a, _cmpsf2@libgcc.a"
	strings:
...
rule setstate_r_2449db236061028783199de811f855c9 {
	meta:
...
rule realpath_ac2c7aa66d0b98a1b01f9e9d361f94f1 {
	meta:
		aliases = "realpath"
		size = "804"
		objfiles = "realpath@libc.a"
	strings:
		$pattern = { 0D C0 A0 E1 F0 DF 2D E9 01 DA 4D E2 04 B0 4C E2 14 D0 4D E2 00 50 50 E2 01 70 A0 E1 03 00 00 1A ?? ?? ?? EB 05 70 A0 E1 16 30 A0 E3 6E 00 00 EA 00 40 D5 E5 00 00 54 E3 03 00 00 1A ?? ?? ?? EB 04 70 A0 E1 02 30 A0 E3 67 00 00 EA 00 00 51 E3 00 20 A0 13 01 DA 4D 02 01 3A 4B 02 01 1A 4B 12 01 10 A0 03 2C 20 01 15 04 D0 4D 02 2C 10 03 05 05 00 A0 E1 0D 70 A0 01 ?? ?? ?? EB 98 32 9F E5 03 00 50 E1 00 20 A0 E1 45 00 00 8A 29 00 4B E2 00 00 62 E0 05 10 A0 E1 00 60 A0 E1 ?? ?? ?? EB 00 30 D6 E5 FF 1E 87 E2 2F 00 53 E3 01 2A 4B E2 0E 10 81 E2 07 50 A0 01 34 10 02 E5 01 60 86 02 01 30 C5 04 0C 00 00 0A }
	condition:
		$pattern
}
...
rule if_nameindex_b7ddcebf5468f414b2996a77199776e4 {
	meta:
...
rule __GI___libc_open64_514b27a82d8ef887189958fd0549252f {
	meta:
...
rule fwscanf_b894f9a4909b4c2528ee0248ddf88a00 {
	meta:
		aliases = "sscanf, fwprintf, __GI_syslog, asprintf, fscanf, __GI_fscanf, fprintf, __GI_asprintf, syslog, __GI_fprintf, __GI_sscanf, dprintf, swscanf, fwscanf"
		size = "48"
		objfiles = "fwprintf@libc.a, asprintf@libc.a, fscanf@libc.a, swscanf@libc.a, syslog@libc.a"
	strings:
...
rule fcntl_e11235c302c78487c0691882cb8b2dbd {
	meta:
		aliases = "__libc_fcntl, __GI___libc_fcntl, __GI_fcntl, fcntl"
		size = "100"
...
rule __GI___libc_open_6386fddfbd0437a794e8de24796d33bc {
	meta:
		aliases = "__GI_open, open, __libc_open, __GI___libc_open"
		size = "92"
...
rule __gcov_merge_single_ff401781bc6d986f859a23f7108da64e {
	meta:
		aliases = "clnttcp_abort, __stub1, authnone_verf, clntudp_abort, __aeabi_idiv0, __gcov_init, __gcov_flush, authnone_destroy, svcraw_destroy, __stub2, __enable_execute_stack, _pthread_cleanup_push_defer, __aeabi_ldiv0, pthread_null_sighandler, clntraw_geterr, __linuxthreads_create_event, _pthread_cleanup_pop_restore, clntraw_destroy, __gcov_merge_add, clntraw_abort, __pthread_return_void, __linuxthreads_reap_event, xdrmem_destroy, __cyg_profile_func_enter, __gnat_default_unlock, noop_handler, __gnat_default_lock, authunix_nextverf, __gcov_merge_delta, pthread_handle_sigdebug, clntunix_abort, __div0, __cyg_profile_func_exit, __linuxthreads_death_event, __gcov_merge_single"
		size = "4"
		objfiles = "svc_raw@libc.a, resolv@libresolv.a, clnt_tcp@libc.a, auth_unix@libc.a, _dvmd_tls@libgcc.a"
	strings:
		$pattern = { 0E F0 A0 E1 }
	condition:
		$pattern
...
rule wscanf_0304853a5bbd79b71a43422fdd25bd20 {
	meta:
		aliases = "__GI_printf, printf, wprintf, scanf, wscanf"
		size = "60"
...
rule futimes_9c1d097d4fdcde156e94e9fe518c6d03 {
	meta:
		aliases = "__GI_futimes, futimes"
		size = "120"
		objfiles = "futimes@libc.a"
	strings:
		$pattern = { 10 40 2D E9 00 00 51 E3 10 D0 4D E2 0B 00 00 0A 00 30 91 E5 00 30 8D E5 04 30 91 E5 FA 2F A0 E3 92 03 03 E0 04 30 8D E5 08 30 91 E5 08 30 8D E5 0C 30 91 E5 92 03 03 E0 0C 30 8D E5 0D 10 A0 E1 00 30 A0 E3 01 20 A0 E1 03 10 A0 E1 5C 01 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 10 D0 8D E2 10 80 BD E8 }
	condition:
		$pattern
}
...
rule pthread_attr_init_31c15af14bd5cb148f34d1aeb60c8ab1 {
	meta:
...
rule frexpf_c8dbe55e46fc4c058d4ac1e5f9bc8e6a {
	meta:
...
rule close_06e8dc28926387eeb84f9d2d16b42772 {
	meta:
		aliases = "fsync, system, tcdrain, wait, close"
		size = "60"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule getc_unlocked_ba13e73ea0c557d155bb10f1906ac51b {
	meta:
		aliases = "__fgetc_unlocked, fgetc_unlocked, __GI___fgetc_unlocked, __GI_getc_unlocked, __GI_fgetc_unlocked, getc_unlocked"
		size = "304"
...
rule __GI_lseek_907e4dd8519212da476d92911d86f5c8 {
	meta:
		aliases = "__libc_lseek, __GI___libc_lseek, lseek, __GI_lseek"
		size = "44"
...
rule __libc_getpid_b756ed38d47092e6de99d7c88c3f8677 {
	meta:
...
rule __libc_connect_c7e422bce6f558bc36d513f71d02064a {
	meta:
...
rule __GI_accept_74d504d25242b01999387e060b16bf64 {
	meta:
...
rule __GI_utime_07a34cf10b4353b7f622aa273a356f70 {
	meta:
...
rule strsignal_e4947ba7f5fdea78235f2b87198a4913 {
	meta:
...
rule sendmsg_ce59f0d876b135736b8eeef4794499db {
	meta:
...
rule __libc_recvmsg_d88b8a07bfeca37d4f71c32ddfb7ab6c {
	meta:
...
rule times_e85c3f872bd2cc7c0506c65d3cdb0bb9 {
	meta:
...
rule fstatfs_3901152236d21195c12b59f64b62114d {
	meta:
		aliases = "__libc_fstatfs, __GI___libc_fstatfs, __GI_fstatfs, fstatfs"
		size = "44"
...
rule fsync_541587bbd6b19f9263035adca9478cff {
	meta:
...
rule __libc_nanosleep_a14c692c82c0930d820e3f36cd51c687 {
	meta:
...
rule poll_2bd42a77426b787f5c0acabd477524c7 {
	meta:
...
rule getgid_d6e3fe4e539a1852bdb5e5d236b27488 {
	meta:
...
rule setresuid_dbe79c7fa53896743acc87e2a96897ca {
	meta:
...
rule qzero_b8cf4bf27e3b0ecd0b0b17420aa78a04 {
	meta:
		aliases = "qone, qzero"
		size = "596"
...
rule __GI_signal_e35a51f9f771c9521d36ab9e0328a7e0 {
	meta:
...
rule posix_fadvise_fb70b4640fbee30a5ba733cb0adb8cad {
	meta:
...
rule __GI_fgetgrent_r_e8080a1c2fc51c486b5e54e9e6df8922 {
	meta:
		aliases = "fgetpwent_r, fgetgrent_r, fgetspent_r, __GI_fgetspent_r, __GI_fgetpwent_r, __GI_fgetgrent_r"
		size = "56"
...
rule __libc_recvfrom_ad0d3dd18cca54fa722ba12b8faff003 {
	meta:
...
rule sem_wait_c939bcc8b1278aa661aceddf895515f6 {
	meta:
...
rule __GI___fputc_unlocked_5e36d1201230a94a099b0e739248355a {
	meta:
		aliases = "__fputc_unlocked, putc_unlocked, fputc_unlocked, __GI_putc_unlocked, __GI___fputc_unlocked"
		size = "260"
...
rule endprotoent_c3462f56f9929520ab241c1eb9066968 {
	meta:
		aliases = "__GI_endnetent, endservent, __GI_endprotoent, __GI_endservent, endnetent, endprotoent"
		size = "148"
...
rule setprotoent_4fac06ced0537d7c958ab606f1f198e7 {
	meta:
		aliases = "setservent, __GI_setservent, __GI_setnetent, setnetent, __GI_setprotoent, setprotoent"
		size = "172"
		objfiles = "getproto@libc.a, getservice@libc.a, getnetent@libc.a"
	strings:
...
rule endrpcent_f154f94cc9e53ef5fab24d949804ebdb {
	meta:
...
rule sighold_b1da14fe7a899b6cc1a7a1faf1c29a35 {
	meta:
...
rule abort_bf0f8f3175946d6257baa6922f3941c0 {
	meta:
...
rule wctrans_b6e1aa4997f51081955c25d2f6a49a1e {
	meta:
...
rule __uClibc_init_85a87fc9ae2fd5df867ff266980d50df {
	meta:
...
rule _longjmp_789ce6fea0e89014516e8152aa1f9b75 {
	meta:
		aliases = "siglongjmp, __libc_siglongjmp, longjmp, __libc_longjmp, _longjmp"
		size = "52"
...
rule thread_self_de6f3a4eb83e3f77b08ef501701ed5e1 {
	meta:
		aliases = "thread_self"
		size = "124"
		objfiles = "pthread@libpthread.a, semaphore@libpthread.a, rwlock@libpthread.a, condvar@libpthread.a, join@libpthread.a"
	strings:
...
rule __GI_strtof_c5421df7119fbd0b4ad58db4de7788f6 {
	meta:
		aliases = "__GI_wcstof, strtof, wcstof, __GI_strtof"
		size = "52"
...
rule __libc_lseek64_9ae0326b6bdf9190b82a1daaf61fcd32 {
	meta:
...
rule fmodf_4a44cd37ef35a0b922cd1ed5d81e2ab8 {
	meta:
		aliases = "powf, hypotf, remainderf, copysignf, nextafterf, atan2f, fmodf"
		size = "56"
		objfiles = "nextafterf@libm.a, fmodf@libm.a, atan2f@libm.a, copysignf@libm.a, powf@libm.a"
	strings:
...
rule sendmsg_1823f96336634c69108f5ddfbc5d7589 {
	meta:
		aliases = "read, accept, write, __GI_waitpid, connect, waitpid, lseek, recvmsg, msync, sendmsg"
		size = "76"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_pthread_cond_wait_a262a265157b8fa7643fb81fe27d86af {
	meta:
...
rule if_nametoindex_496273942700caebc66bea33317939e1 {
	meta:
...
rule putc_60ed37c17c0065234bf7a07494647792 {
	meta:
		aliases = "fputc, __GI_fputc, __GI_putc, putc"
		size = "212"
...
rule __GI_fileno_f330e9cb98e8883cb9149cfdf83c99af {
	meta:
		aliases = "getwc, fileno, fgetwc, __GI_fgetwc, __GI_fileno"
		size = "132"
...
rule __GI_getdomainname_a536411d8281989efcf80a4b1a855393 {
	meta:
		aliases = "__libc_getdomainname, __GI___libc_getdomainname, getdomainname, __GI_getdomainname"
		size = "112"
...
rule __new_sem_post_1fd37cd7d5a6e1de5020bdfb7ca49f56 {
	meta:
...
rule towlower_f7cd71ed709ec94d5000e2fd1a8c0960 {
	meta:
		aliases = "__GI_towlower, towupper, __GI_towupper, towlower"
		size = "48"
...
rule hypot_e511a389f9fe0cc6331c9b2cfbb8cbb8 {
	meta:
		aliases = "vfork, nearbyint, yn, __GI_xdr_enum, drem, setmntent, rand, asin, mq_close, y1, lgamma_r, __GI_exp, __GI_cosh, acosh, __GI_pow, __GI_sinh, restart, __GI_memcpy, xdr_u_int, __GI_xdr_u_int, xdr_u_longlong_t, sinh, __decode_packet, exp, pow, log, xdr_int, xdr_enum, scalb, __GI_log10, fmod, __GI_sqrt, __GI_xdr_int, __GI_remainder, sqrt, j0, __GI_cabs, __GI_atan2, __GI_hypot, __GI_acos, __GI_asin, acos, remainder, __GI_acosh, xdr_longlong_t, __GI_nearbyint, __GI_log, j1, cabs, __GI_atanh"
		size = "4"
		objfiles = "semaphore@libpthread.a, manager@libpthread.a, w_atan2@libm.a, xdr@libc.a, w_drem@libm.a"
	strings:
		$pattern = { ?? ?? ?? EA }
	condition:
		$pattern
...
rule re_match_2_74aa8a96218beee221d17910ef6a2ae9 {
	meta:
...
rule pone_1fc427caff281b3e587bded0bcbb1732 {
	meta:
		aliases = "pzero, pone"
		size = "532"
		objfiles = "e_j0@libm.a, e_j1@libm.a"
...
rule shm_open_2bbb292c5432f2d846f9dd798869c993 {
	meta:
		aliases = "shm_open"
		size = "136"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { F0 40 2D E9 01 40 A0 E1 02 50 A0 E1 DF FF FF EB 00 70 50 E2 00 60 E0 03 18 00 00 0A 04 10 A0 E1 05 20 A0 E1 ?? ?? ?? EB 00 60 50 E2 0D 00 00 BA 01 10 A0 E3 00 20 A0 E3 ?? ?? ?? EB 00 00 50 E3 05 00 00 BA 01 20 80 E3 02 10 A0 E3 06 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 02 00 00 AA 06 00 A0 E1 ?? ?? ?? EB 00 60 E0 E3 ?? ?? ?? EB 00 50 90 E5 00 40 A0 E1 07 00 A0 E1 ?? ?? ?? EB 00 50 84 E5 06 00 A0 E1 F0 80 BD E8 }
	condition:
		$pattern
}
...
rule opendir_32d77bd433df2ad1d93315b3bb14b250 {
	meta:
...
rule fputs_4d4fcca9f185327cd7eba12530eff5d8 {
	meta:
		aliases = "fputws, __GI_fputws, fputwc, putwc, __GI_fputs, fputs"
		size = "140"
...
rule __GI_ungetc_95ace9b2c4c1f9e869cd4da120a3ec01 {
	meta:
...
rule __GI_ungetwc_6a6005d57ecd46c5a3e6226c2cc902bb {
	meta:
...
rule __regcomp_da45b1d993b5838073b6d2eacd2e1520 {
	meta:
...
rule __GI_getnetent_2d155d189e4ddb560d2d8cabaaba1155 {
	meta:
...
rule __GI_getgrent_r_99821bf27485a6a4b744561d515384a2 {
	meta:
		aliases = "getpwent_r, __GI_getspent_r, getspent_r, __GI_getpwent_r, getgrent_r, __GI_getgrent_r"
		size = "240"
		objfiles = "getpwent_r@libc.a, getspent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule xdr_union_3a0d819d52ec105a179fd2f390016870 {
	meta:
...
rule gethostent_r_a1317e1ce234dd5155a8c093379a0c45 {
	meta:
...
rule __GI_fgets_1c22a52eabcbd370417e7f9e11ed3242 {
	meta:
...
rule __GI___res_query_94398c0c526beef5383abf315e024e1e {
	meta:
...
rule __GI_fwrite_510fa6aabf0cdb63b100e153964ea7c0 {
	meta:
...
rule __libc_pselect_65f6b6a8e656eff7847be55a5e7dd77c {
	meta:
...
rule fstatvfs_c7d4199ebe188ea37beeacba8b6667db {
	meta:
...
rule pthread_cond_timedwait_7a8db939967c6ba58c56554f4f5ec488 {
	meta:
...
rule getprotobyname_r_a5123283d26368b61e43a758cc532501 {
	meta:
...
rule __GI_inet_pton_9adb0cd8152b18f4e73bb9e35a78ca27 {
	meta:
...
rule gethostbyname2_r_3c6bcdf64fa7f6ece95c3771c5afef1a {
	meta:
...
rule __GI_srandom_r_8f861f29977dac9077966677b181e61b {
	meta:
...
rule _ppfs_parsespec_f352d2d03e86c4872046708cfacc2c67 {
	meta:
		aliases = "_ppfs_parsespec"
		size = "1312"
		objfiles = "_ppfs_parsespec@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 10 30 90 E5 50 D0 4D E2 80 50 13 E2 00 20 A0 E3 08 30 A0 E3 2C 30 8D E5 44 20 8D E5 48 20 8D E5 28 30 8D E5 00 70 A0 E1 18 B0 90 E5 00 10 90 05 11 00 00 0A 02 00 A0 E1 00 30 97 E5 00 31 83 E0 04 10 53 E5 50 C0 8D E2 00 20 8C E0 48 10 42 E5 04 30 13 E5 03 00 51 E1 01 00 80 E2 20 01 00 1A 00 00 51 E3 01 00 00 0A 1F 00 50 E3 F1 FF FF 9A 00 30 A0 E3 27 30 CD E5 09 10 8D E2 00 A0 A0 E3 0A E0 A0 E1 03 80 E0 E3 0A C0 A0 E1 02 41 A0 E3 01 90 A0 E3 00 00 00 EA 06 10 A0 E1 00 30 D1 E5 2A 00 53 E3 50 30 8D 02 9E 38 23 00 01 60 A0 11 01 60 81 02 0C 20 A0 E1 28 C0 03 05 06 00 00 EA 28 34 9F E5 }
	condition:
		$pattern
}
...
rule __GI_getservent_r_735b2247886bc6616fd716ba68576355 {
	meta:
...
rule __GI___res_init_c41719a01792f4e8c19f9c4f4bef6a9d {
	meta:
...
rule __GI_strftime_c4bc49080ce9056e8833f0cfaeee93b4 {
	meta:
...
rule __GI_strptime_37496062e79f235e6bd1d405bca690b0 {
	meta:
...
rule __GI_gethostbyname_r_36d99a2947ea200e352d20a4afbfd6ad {
	meta:
...
rule vsyslog_2a8d86213429db491d6c9259d7113f70 {
	meta:
...
rule gethostbyaddr_r_08c8dd3d3e981874fed71649b45a8ef1 {
	meta:
...
rule __GI_mknod_fa0dcfb2ccfe5be6b77d2ce2bca87ac2 {
	meta:
