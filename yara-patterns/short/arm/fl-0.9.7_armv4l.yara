...
rule __floatunsidf_23521c865a6d18d29fa87845da30c18d {
	meta:
...
rule dirname_5b904f5c22603628a1f51d3c671f5657 {
	meta:
		aliases = "dirname"
		size = "152"
		objfiles = "dirname@libc.a"
	strings:
		$pattern = { 00 00 50 E3 00 20 A0 11 00 10 A0 11 02 00 00 1A 1D 00 00 EA 01 30 81 E2 03 10 A0 E1 00 30 D1 E5 00 00 53 E3 2F 00 53 13 01 30 A0 01 01 00 00 0A F7 FF FF EA 01 30 83 E2 00 C0 D3 E5 2F 00 5C E3 FB FF FF 0A 00 00 5C E3 01 20 A0 11 F1 FF FF 1A 00 00 52 E1 09 00 00 1A 00 30 D0 E5 2F 00 53 E3 09 00 00 1A 01 30 D0 E5 2F 00 53 E3 01 20 80 E2 02 00 00 1A 01 30 D2 E5 00 00 53 E3 01 20 82 02 00 30 A0 E3 00 30 C2 E5 0E F0 A0 E1 00 00 9F E5 0E F0 A0 E1 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule mbsinit_22404d3b0cae3b99b04a4837eac19514 {
	meta:
...
rule l64a_03f9988728971bf7222f019d52f578be {
	meta:
		aliases = "l64a"
		size = "88"
		objfiles = "l64a@libc.a"
	strings:
		$pattern = { 00 00 50 E3 04 E0 2D E5 3C 00 9F 05 04 F0 9D 04 38 C0 9F E5 38 E0 9F E5 00 10 A0 E3 03 00 00 EA 03 30 DE E7 20 03 A0 E1 01 30 C2 E7 01 10 81 E2 00 00 50 E3 3F 30 00 E2 0C 20 A0 E1 F7 FF FF 1A 01 00 CC E7 04 00 9F E5 04 F0 9D E4 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_endmntent_97124c49c617aedb0ecf25df58fc465d {
	meta:
...
rule calloc_7eddfc043ecaf2d2efbfbbee4da82b04 {
	meta:
		aliases = "calloc"
		size = "92"
		objfiles = "calloc@libc.a"
	strings:
		$pattern = { 00 00 50 E3 30 40 2D E9 01 50 A0 E1 90 01 04 E0 09 00 00 0A 00 10 A0 E1 04 00 A0 E1 ?? ?? ?? EB 00 00 55 E1 04 00 00 0A ?? ?? ?? EB 00 50 A0 E3 0C 30 A0 E3 00 30 80 E5 05 00 00 EA 04 00 A0 E1 ?? ?? ?? EB 00 50 50 E2 04 20 A0 11 00 10 A0 13 ?? ?? ?? 1B 05 00 A0 E1 30 80 BD E8 }
	condition:
		$pattern
}
...
rule dlsym_ed84dd74e4627c350ad5f52eb3cb6377 {
	meta:
		aliases = "dlsym"
		size = "240"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { 00 00 50 E3 D8 30 9F 05 30 40 2D E9 01 50 A0 E1 0E 40 A0 E1 00 10 93 05 24 00 00 0A 01 00 70 E3 00 10 A0 E1 B8 30 9F E5 0F 00 00 0A 00 30 93 E5 03 00 50 E1 AC 30 9F 15 00 30 93 15 03 00 00 1A 1A 00 00 EA 00 00 53 E1 18 00 00 0A 04 30 93 E5 00 00 53 E3 FA FF FF 1A 8C 30 9F E5 09 20 A0 E3 00 00 A0 E3 00 20 83 E5 30 80 BD E8 00 20 93 E5 00 E0 A0 E3 0B 00 00 EA 00 00 92 E5 14 C0 90 E5 04 00 5C E1 06 00 00 2A 00 00 5E E3 02 00 00 0A 14 30 9E E5 0C 00 53 E1 01 00 00 2A 10 10 92 E5 00 E0 A0 E1 10 20 92 E5 00 00 52 E3 F1 FF FF 1A 2C 30 9F E5 00 30 93 E5 03 00 51 E1 00 20 A0 13 00 20 91 05 02 31 A0 E3 }
	condition:
		$pattern
}

rule free_7276261a9770c9cf5d4506344611afa8 {
	meta:
		aliases = "free"
		size = "228"
		objfiles = "free@libc.a"
	strings:
		$pattern = { 00 00 50 E3 F0 40 2D E9 F0 80 BD 08 04 50 10 E5 B4 70 9F E5 04 40 40 E2 B0 60 9F E5 B0 00 9F E5 0F E0 A0 E1 06 F0 A0 E1 04 10 A0 E1 05 20 A0 E1 07 00 A0 E1 ?? ?? ?? EB 98 30 9F E5 00 50 90 E5 00 30 93 E5 83 01 55 E1 00 40 A0 E1 0B 00 00 3A 84 00 9F E5 0F E0 A0 E1 06 F0 A0 E1 00 00 A0 E3 ?? ?? ?? EB 0C 30 84 E2 00 00 53 E1 05 00 00 0A 64 00 9F E5 64 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 4C 00 9F E5 0E 00 00 EA 04 20 94 E5 00 00 52 E3 08 30 94 15 08 30 82 15 09 00 94 E9 00 00 53 E3 04 00 83 15 00 00 87 05 30 30 9F E5 20 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 65 E2 ?? ?? ?? EB 14 00 9F E5 F0 40 BD E8 }
	condition:
		$pattern
}
...
rule __GI___fsetlocking_e3c13499a8ba90c2c333a5d3dc6f1e63 {
	meta:
...
rule xdrstdio_putbytes_26f44c67f0f768d3737b069f6d38412f {
	meta:
...
rule sem_init_10af9c11183921c48c4bf715f33c08fa {
	meta:
...
rule __libc_pthread_init_e58b6c68de6f2c99d5beb6298a089abb {
	meta:
		aliases = "__GI___h_errno_location, __GI___errno_location, __errno_location, __h_errno_location, __libc_pthread_init"
		size = "12"
...
rule __GI_getlogin_fc8ec5668766e9d4bf46e8a92f82ac48 {
	meta:
		aliases = "__pthread_once_fork_parent, hdestroy, __pthread_once_fork_prepare, _flushlbf, getlogin, __GI_getlogin"
		size = "12"
...
rule _Unwind_GetDataRelBase_6784a51311637d8b420ae445bb38bfaa {
	meta:
		aliases = "__pthread_mutex_unlock, __udiv_w_sdiv, __gthread_mutex_unlock, pthread_condattr_destroy, pthread_rwlockattr_destroy, _Unwind_GetTextRelBase, __GI_pthread_condattr_init, pthread_mutexattr_destroy, __GI_wcsftime, _svcauth_null, __pthread_mutex_lock, clntraw_control, wcsftime, _Unwind_GetRegionStart, __gthread_mutex_lock, grantpt, __pthread_mutexattr_destroy, authnone_refresh, __pthread_mutex_trylock, xdrstdio_inline, __GI_pthread_condattr_destroy, __gthread_active_p, _Unwind_FindEnclosingFunction, __GI_pthread_attr_destroy, __pthread_mutex_init, __pthread_return_0, pthread_attr_destroy, pthread_condattr_init, _Unwind_GetDataRelBase"
		size = "8"
		objfiles = "svc_auth@libc.a, xdr_stdio@libc.a, _udiv_w_sdiv@libgcc.a, attr@libpthread.a, grantpt@libc.a"
	strings:
...
rule __GI_asctime_c102ded2904d5b1c7d2f9a901aa4e61b {
	meta:
		aliases = "ether_ntoa, ether_aton, asctime, hcreate, srand48, __GI_inet_ntoa, inet_ntoa, __GI_asctime"
		size = "12"
...
rule atoll_deef6c6063aa04a17c5a206f19cbcf02 {
	meta:
		aliases = "__GI_atol, atoi, __GI_atoi, atol, atoll"
		size = "12"
...
rule _setjmp_7cbf426d061c005a73514c9fc2b9103b {
	meta:
		aliases = "atof, __GI_sigpause, mkstemp, sigpause, _setjmp"
		size = "8"
		objfiles = "sigpause@libc.a, bsd__setjmp@libc.a, mkstemp@libc.a, atof@libc.a"
	strings:
...
rule __GI_pthread_cond_broadcast_157430ec5bd3517bc3836be4d62cc1ba {
	meta:
		aliases = "pthread_cond_broadcast, __GI_pthread_cond_broadcast"
		size = "88"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { 00 10 A0 E3 F0 40 2D E9 01 50 A0 E1 00 40 A0 E1 ?? ?? ?? EB 08 60 94 E5 04 00 A0 E1 08 50 84 E5 ?? ?? ?? EB 05 70 A0 E1 01 50 85 E2 05 00 00 EA 08 40 96 E5 B9 51 C6 E5 08 70 86 E5 06 00 A0 E1 ED FF FF EB 04 60 A0 E1 00 00 56 E3 F7 FF FF 1A 06 00 A0 E1 F0 80 BD E8 }
	condition:
		$pattern
}
...
rule __ieee754_atanh_e76d0f990370587ee08428e61f26bf21 {
	meta:
...
rule lgamma_9126d5dc6e7144618f0e6e40fd40fbef {
	meta:
		aliases = "__ieee754_lgamma, __GI_lgamma, __ieee754_gamma, gamma, strtok, __GI_strtok, lgamma"
		size = "12"
		objfiles = "w_lgamma@libm.a, w_gamma@libm.a, e_lgamma@libm.a, strtok@libc.a, e_gamma@libm.a"
	strings:
...
rule __GI_wcscpy_60b1f0d2c1c9e9c2f1ebb68525f00d5a {
	meta:
...
rule htonl_f0439868045060aec9db8c8f877016ab {
	meta:
		aliases = "ntohl, htonl"
		size = "32"
...
rule fopen64_d73e744ca7841fca2d43bd74ed252036 {
	meta:
...
rule wcstold_fc92c81c76d09d9760b582222f719bcc {
	meta:
...
rule __GI_vwarnx_cef0584fafe4a59a3080816a940a5713 {
	meta:
...
rule sigismember_fd9ce6819bfc06c14eb42fa50fbc768c {
	meta:
		aliases = "__GI_sigdelset, sigdelset, sigaddset, __GI_sigaddset, sigismember"
		size = "48"
...
rule __pthread_mutexattr_getkind_np_0b416f364d729a7dc563889c583f0308 {
	meta:
		aliases = "__pthread_mutexattr_gettype, pthread_mutexattr_gettype, pthread_mutexattr_getkind_np, pthread_rwlockattr_getkind_np, pthread_attr_getdetachstate, __GI_pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np"
		size = "16"
...
rule __heap_alloc_65d0c0e1c682f22ae9f03f36958c701a {
	meta:
		aliases = "__heap_alloc"
		size = "140"
		objfiles = "heap_alloc@libc.a"
	strings:
		$pattern = { 00 30 91 E5 04 E0 2D E5 03 30 83 E2 03 20 C3 E3 00 E0 A0 E1 0B 00 52 E3 00 00 90 E5 0C 20 A0 93 16 00 00 EA 00 C0 90 E5 02 00 5C E1 12 00 00 3A 2C 30 82 E2 03 00 5C E1 0C 30 62 20 00 30 80 25 09 00 00 2A 04 20 90 E5 00 00 52 E3 08 30 90 15 08 30 82 15 08 20 90 E5 04 30 90 E5 00 00 52 E3 00 30 8E 05 04 30 82 15 0C 20 A0 E1 0C 30 80 E2 03 00 6C E0 00 20 81 E5 04 F0 9D E4 04 00 90 E5 00 00 50 E3 E6 FF FF 1A 04 F0 9D E4 }
	condition:
		$pattern
}
...
rule wcstoumax_843f778e2f492a8c473fdc97c05cc653 {
	meta:
		aliases = "__GI_strtoull, strtoull, wcstouq, wcstoull, strtoumax, __libc_waitpid, wcstoul, __GI_wcstoull, strtouq, waitpid, __GI_wcstoul, __GI_strtoul, __GI_waitpid, strtoul, wcstoumax"
		size = "8"
		objfiles = "waitpid@libc.a, wcstoul@libc.a, strtoull@libc.a, strtoul@libc.a, wcstoull@libc.a"
	strings:
...
rule ffs_8918bf46bc0226922438e003d2d934e0 {
	meta:
...
rule pthread_cancel_592deb728b81ff52ab1ffa2d8d3b391a {
	meta:
		aliases = "pthread_cancel"
		size = "240"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { 00 3B A0 E1 DC 20 9F E5 23 3B A0 E1 F0 40 2D E9 03 62 82 E0 00 50 A0 E1 00 10 A0 E3 06 00 A0 E1 ?? ?? ?? EB 08 40 96 E5 00 00 54 E3 02 00 00 0A 10 30 94 E5 05 00 53 E1 1F 00 00 0A 06 00 A0 E1 ?? ?? ?? EB 03 00 A0 E3 F0 80 BD E8 06 00 A0 E1 ?? ?? ?? EB 10 00 00 EA BC 31 94 E5 00 00 53 E3 14 70 94 E5 03 50 A0 01 05 00 00 0A 00 00 93 E5 04 10 A0 E1 0F E0 A0 E1 04 F0 93 E5 B8 01 C4 E5 00 50 A0 E1 06 00 A0 E1 ?? ?? ?? EB 00 00 55 E3 03 00 00 0A 04 00 A0 E1 ?? ?? ?? EB 00 00 A0 E3 F0 80 BD E8 40 30 9F E5 07 00 A0 E1 00 10 93 E5 ?? ?? ?? EB 05 00 A0 E1 F0 80 BD E8 42 30 D4 E5 40 20 D4 E5 00 30 53 E2 }
	condition:
		$pattern
}
...
rule pthread_mutexattr_setpshared_fe029dee1c86b07e98c7bc55f938804d {
	meta:
...
rule __getutent_f2fec9e1d0635d175d272c2ef88fab84 {
	meta:
		aliases = "__getutent"
		size = "56"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 01 00 70 E3 04 E0 2D E5 02 00 00 1A CF FF FF EB 00 00 A0 E3 04 F0 9D E4 14 10 9F E5 06 2D A0 E3 ?? ?? ?? EB 06 0D 50 E3 F8 FF FF 1A 00 00 9F E5 04 F0 9D E4 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule seteuid_6a9f10f29cd6a8b190eb4840a9cb8159 {
	meta:
...
rule __GI__stdlib_mb_cur_max_1ce4a30a252936ca418941b102aaafc1 {
	meta:
		aliases = "old_sem_extricate_func, __GI_xdr_void, _stdlib_mb_cur_max, authnone_validate, xdr_void, __GI__stdlib_mb_cur_max"
		size = "8"
		objfiles = "oldsemaphore@libpthread.a, xdr@libc.a, _stdlib_mb_cur_max@libc.a, auth_none@libc.a"
	strings:
...
rule pthread_getspecific_dc895c98b76c64823e95a2971ce09dfd {
	meta:
		aliases = "pthread_getspecific"
		size = "76"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { 01 0B 50 E3 10 40 2D E9 00 40 A0 E1 0B 00 00 2A C7 FF FF EB A4 32 A0 E1 03 01 80 E0 EC 00 90 E5 00 00 50 E3 05 00 00 0A 18 30 9F E5 84 31 93 E7 00 00 53 E3 1F 30 04 12 03 01 90 17 10 80 BD 18 00 00 A0 E3 10 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule pthread_setspecific_f67dbcdecb51bfc85e4a377a55009bb3 {
	meta:
		aliases = "pthread_setspecific"
		size = "132"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { 01 0B 50 E3 F0 41 2D E9 00 40 A0 E1 01 80 A0 E1 18 00 00 2A 64 30 9F E5 80 31 93 E7 00 00 53 E3 14 00 00 0A 70 FF FF EB A4 62 A0 E1 06 31 80 E0 E0 50 83 E2 0C 30 95 E5 00 00 53 E3 00 70 A0 E1 06 00 00 1A 20 00 A0 E3 04 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 0C 00 A0 03 F0 81 BD 08 0C 00 85 E5 06 31 87 E0 EC 20 93 E5 00 00 A0 E3 1F 30 04 E2 03 81 82 E7 F0 81 BD E8 16 00 A0 E3 F0 81 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule timelocal_7ed5691c266e6284422b683ded03d596 {
	meta:
		aliases = "setjmp, mktime, mkstemp64, iswalnum, __GI_iswalnum, timelocal"
		size = "8"
		objfiles = "iswalnum@libc.a, mkstemp64@libc.a, bsd_setjmp@libc.a, mktime@libc.a"
	strings:
...
rule __udivsi3_d1c9bc83f74de32950c43b311311f773 {
	meta:
...
rule __floatundisf_1dad0a4ba6bae6e64bc334c9810cc219 {
	meta:
...
rule __aeabi_l2d_59a44d4aa9b2a12b1a3fb3a810efccf0 {
	meta:
...
rule __libc_creat_e4e7b589e2583f0c6c103523c2dd83b2 {
	meta:
...
rule drand48_r_2145ca4e0ef4524858602e20f56948c7 {
	meta:
		aliases = "__GI_lrand48_r, lrand48_r, mrand48_r, drand48_r"
		size = "12"
...
rule vwscanf_f2068c4f7ded18dcf76a6cb2fc8fc546 {
	meta:
		aliases = "__GI_vscanf, vwprintf, vscanf, vprintf, vwscanf"
		size = "28"
...
rule wcstoll_9e5ba6842b34889a4f189c941dd42ba4 {
	meta:
		aliases = "__GI_strtol, __GI_wcstol, strtoimax, strtoq, wcstol, wcstoimax, __GI_strtoll, strtoll, __GI_wcstoll, strtol, wcstoq, wcstoll"
		size = "8"
...
rule cfsetispeed_5057c194bfc983a7399d967529dfe19a {
	meta:
...
rule __nedf2_8d2cd9eee0fdc8c659f057219ecbfdad {
	meta:
...
rule svcudp_stat_ae78ace192a33af724e3cae5712c1237 {
	meta:
		aliases = "svcraw_stat, _svcauth_short, rendezvous_stat, svcudp_stat"
		size = "8"
		objfiles = "svc_authux@libc.a, svc_tcp@libc.a, svc_raw@libc.a, svc_udp@libc.a, svc_unix@libc.a"
	strings:
...
rule fseek_383b7bec52d509eb219b77b3119cabc4 {
	meta:
...
rule __GI_strncpy_79ca62f8da926e4bc17e66c18effc261 {
	meta:
...
rule __GI_globfree64_160075541114568eaf84686c5688c956 {
	meta:
...
rule __libc_current_sigrtmax_5762a499c2b87f8f0b5af31c6e1fff14 {
	meta:
		aliases = "_Unwind_SjLj_GetContext, __pthread_getconcurrency, pthread_getconcurrency, __libc_current_sigrtmin, __libc_current_sigrtmax"
		size = "16"
...
rule getwchar_unlocked_050e28cf6bc58150f630cc4dc9018b17 {
	meta:
		aliases = "getwchar, _dl_app_fini_array, _dl_app_init_array, getwchar_unlocked"
		size = "16"
...
rule __GI_inet_makeaddr_d04e68bac40850946c8110574aafc900 {
	meta:
...
rule posix_fadvise64_8763f11501fb1d5618cf24457a340477 {
	meta:
		aliases = "__libc_posix_fadvise64, posix_fadvise64"
		size = "92"
		objfiles = "posix_fadvise64@libc.a"
	strings:
		$pattern = { 04 D0 4D E2 F0 41 2D E9 18 30 8D E5 18 30 8D E2 18 00 93 E8 02 70 A0 E1 04 50 A0 E1 C4 6F A0 E1 C2 8F A0 E1 03 40 A0 E1 02 30 A0 E1 01 20 A0 E1 20 10 9D E5 0E 01 90 EF 01 0A 70 E3 02 00 00 9A 26 00 70 E3 00 00 60 12 00 00 00 1A 00 00 A0 E3 F0 41 BD E8 04 D0 8D E2 0E F0 A0 E1 }
	condition:
		$pattern
}
...
rule clntudp_bufcreate_66013c6eaf6e1fe011c250f8838540bf {
	meta:
...
rule xdrstdio_putlong_354e427dddce3db9b91234379c0d5a09 {
	meta:
...
rule __GI_brk_2051d3115b995997700bb9d99c44224f {
	meta:
...
rule __heap_alloc_at_94a8075db1b84c83bc1ce5049145c824 {
	meta:
		aliases = "__heap_alloc_at"
		size = "140"
		objfiles = "heap_alloc_at@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 00 C0 90 E5 00 E0 A0 E1 19 00 00 EA 00 00 9C E5 03 30 60 E0 01 00 53 E1 14 00 00 8A 17 00 00 1A 03 30 82 E2 03 20 C3 E3 02 00 50 E1 13 00 00 3A 2C 30 82 E2 03 00 50 E1 00 30 62 20 00 30 8C 25 02 00 A0 21 04 F0 9D 24 04 20 9C E5 00 00 52 E3 08 30 9C 15 08 30 82 15 08 20 9C E5 04 30 9C E5 00 00 52 E3 04 30 82 15 00 30 8E 05 04 F0 9D E4 04 C0 9C E5 00 00 5C E3 0C 30 8C E2 E2 FF FF 1A 00 00 A0 E3 04 F0 9D E4 }
	condition:
		$pattern
}
...
rule __sysv_signal_9e77f553c58be841b3cf121bef23a2af {
	meta:
		aliases = "sysv_signal, __sysv_signal"
		size = "132"
		objfiles = "sysv_signal@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 01 00 71 E3 00 00 50 13 46 DF 4D E2 00 30 A0 C3 01 30 A0 D3 04 00 00 DA 40 00 50 E3 03 C0 A0 D1 20 20 A0 D3 8C 10 8D D5 05 00 00 DA ?? ?? ?? EB 16 30 A0 E3 00 20 E0 E3 00 30 80 E5 0C 00 00 EA 88 C0 03 E5 01 20 52 E2 46 1F 8D E2 02 31 81 E0 FA FF FF 5A 0D 20 A0 E1 0E 32 A0 E3 8C 10 8D E2 10 31 8D E5 ?? ?? ?? EB 00 00 50 E3 00 20 9D A5 00 20 E0 B3 02 00 A0 E1 46 DF 8D E2 00 80 BD E8 }
	condition:
		$pattern
}
...
rule sigignore_a4cff5814f738a22dfadb1732c4084d6 {
	meta:
		aliases = "sigignore"
		size = "80"
		objfiles = "sigignore@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 01 30 A0 E3 8C D0 4D E2 20 20 A0 E3 00 10 A0 E3 00 30 8D E5 00 00 00 EA 8C 10 03 E5 01 20 52 E2 01 30 82 E2 8C C0 8D E2 03 31 8C E0 F9 FF FF 5A 00 30 A0 E3 03 20 A0 E1 0D 10 A0 E1 84 30 8D E5 ?? ?? ?? EB 8C D0 8D E2 00 80 BD E8 }
	condition:
		$pattern
}

rule re_match_ce8ff1feab2582833bd46083bb95aadc {
	meta:
		aliases = "__re_match, re_match"
		size = "60"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 01 C0 A0 E1 10 D0 4D E2 00 10 A0 E3 04 30 8D E5 0C 30 A0 E1 14 C0 9D E5 02 E0 A0 E1 01 20 A0 E1 08 C0 8D E5 0C E0 8D E5 00 E0 8D E5 9B F8 FF EB 10 D0 8D E2 00 80 BD E8 }
	condition:
		$pattern
}
...
rule sigsetmask_696f014f3d426f0b6e387f4334cc3487 {
	meta:
		aliases = "__GI_sigsetmask, sigsetmask"
		size = "72"
		objfiles = "sigsetmask@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 01 DC 4D E2 80 00 8D E5 84 10 8D E2 1E 30 A0 E3 00 20 A0 E3 01 30 53 E2 04 20 81 E4 FC FF FF 5A 80 10 8D E2 0D 20 A0 E1 02 00 A0 E3 ?? ?? ?? EB 00 00 50 E3 00 00 9D A5 00 00 E0 B3 01 DC 8D E2 00 80 BD E8 }
	condition:
		$pattern
}

rule __GI_sigblock_b703704b6659a378838de554426f184f {
	meta:
		aliases = "sigblock, __GI_sigblock"
		size = "68"
		objfiles = "sigblock@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 01 DC 4D E2 80 00 8D E5 84 20 8D E2 1E 30 A0 E3 00 00 A0 E3 01 30 53 E2 04 00 82 E4 FC FF FF 5A 80 10 8D E2 0D 20 A0 E1 ?? ?? ?? EB 00 00 50 E3 00 00 9D A5 00 00 E0 B3 01 DC 8D E2 00 80 BD E8 }
	condition:
		$pattern
}

rule __re_compile_pattern_41788eaaa12e858d98616ab23a4a929f {
	meta:
		aliases = "re_compile_pattern, __re_compile_pattern"
		size = "92"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 02 30 A0 E1 1C 20 D2 E5 06 20 C2 E3 1C 20 C3 E5 1C 20 D3 E5 10 20 C2 E3 1C 20 C3 E5 1C 20 D3 E5 80 20 82 E3 1C 20 C3 E5 1C 20 9F E5 00 20 92 E5 A6 F6 FF EB 00 00 50 E3 10 30 9F 15 00 21 93 17 0C 30 9F 15 03 00 82 10 04 F0 9D E4 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule inet_addr_7fdd0658971bb539d45b78cafcda374f {
	meta:
...
rule jrand48_ecd7978fb77bf0d3de708665c907813c {
	meta:
...
rule call___do_global_ctors_aux_997de91c60dfeaa7966cf399b0caa4a3 {
	meta:
		...
		size = "8"
		objfiles = "crtbeginS, crtend, crtbeginT, crtendS, crtbegin"
	strings:
...
rule fgetpwent_782ead4dc851d14a304b763550b392bd {
	meta:
		aliases = "getpwnam, getgrgid, getgrnam, fgetgrent, getpwuid, getspnam, sgetspent, fgetspent, fgetpwent"
		size = "52"
		objfiles = "getspnam@libc.a, getpwnam@libc.a, fgetspent@libc.a, fgetgrent@libc.a, fgetpwent@libc.a"
	strings:
...
rule lrand48_86fdf4ee84ebc235f19e8e735c9d8875 {
	meta:
...
rule __open_etc_hosts_616952462c9c1c8723f83dae96cb979a {
	meta:
		aliases = "__open_etc_hosts"
		size = "52"
		objfiles = "read_etc_hosts_r@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 1C 00 9F E5 1C 10 9F E5 ?? ?? ?? EB 00 00 50 E3 04 F0 9D 14 10 00 9F E5 08 10 9F E5 04 E0 9D E4 ?? ?? ?? EA ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule svcerr_noprog_020638c92f7867b5021d37b61fd85b54 {
	meta:
...
rule ftell_bf951bc17031556e0a73a0c404c867fd {
	meta:
...
rule lroundf_c4ff7ef54e5728e438def535189f6899 {
	meta:
		aliases = "ctime, llrintf, lrintf, ilogbf, __GI_ctime, llroundf, lroundf"
		size = "16"
		objfiles = "ilogbf@libm.a, ctime@libc.a, lrintf@libm.a, lroundf@libm.a, llrintf@libm.a"
	strings:
...
rule clnt_perror_8213424d9423719eb0f7c5bff68b7e51 {
	meta:
		aliases = "clnt_perrno, clnt_pcreateerror, __GI_clnt_perror, clnt_perror"
		size = "28"
...
rule __rpc_thread_svc_max_pollfd_0b9056522680c6961eb801651d1ea121 {
	meta:
...
rule sem_close_a40f80df3b43c7c733efb6877e131639 {
	meta:
		aliases = "sem_unlink, get_kernel_syms, create_module, sem_close"
		size = "24"
...
rule atanf_3a1a777b192db480491cbf217784f1e6 {
	meta:
		aliases = "cosf, asinf, sinhf, fabsf, cbrtf, floorf, tgammaf, erfcf, asinhf, acosf, truncf, logbf, log10f, rintf, tanf, ceilf, expf, lgammaf, sqrtf, erff, atanhf, acoshf, coshf, roundf, log1pf, sinf, expm1f, tanhf, logf, atanf"
		size = "20"
		objfiles = "tgammaf@libm.a, lgammaf@libm.a, rintf@libm.a, log10f@libm.a, tanf@libm.a"
	strings:
...
rule iswdigit_d8492d48836847b8f74a4ffb37c125c7 {
	meta:
...
rule __GI_iswgraph_3b8445acdfa3fb809057c5bf3de36338 {
	meta:
...
rule __GI_iswlower_f3a02b88d432bcca5e9fb88be9329047 {
	meta:
...
rule _seterr_reply_07cae55faea079970e18a0cf0731c719 {
	meta:
		aliases = "__GI__seterr_reply, _seterr_reply"
		size = "288"
		objfiles = "rpc_prot@libc.a"
	strings:
		$pattern = { 08 C0 90 E5 00 00 5C E3 02 00 00 0A 01 00 5C E3 2C 00 00 1A 1D 00 00 EA 18 20 90 E5 00 00 52 E3 00 C0 81 05 0E F0 A0 01 05 00 52 E3 02 F1 9F 97 11 00 00 EA ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 08 30 A0 E3 16 00 00 EA 09 30 A0 E3 14 00 00 EA 0A 30 A0 E3 12 00 00 EA 0B 30 A0 E3 10 00 00 EA 0C 30 A0 E3 0E 00 00 EA 00 30 A0 E3 0C 00 00 EA 10 30 A0 E3 00 30 81 E5 00 30 A0 E3 04 30 81 E5 0B 00 00 EA 0C 20 90 E5 01 00 52 E3 03 00 00 0A 06 00 52 E3 00 20 81 05 0B 00 00 0A 02 00 00 EA 07 30 A0 E3 00 30 81 E5 07 00 00 EA 10 30 A0 E3 08 10 81 E8 08 20 81 E5 03 00 00 EA }
	condition:
		$pattern
}
...
rule __aeabi_fcmplt_f52cbcbfa58e06c8588cd1fb7e67afd3 {
	meta:
		aliases = "__aeabi_dcmpgt, __aeabi_fcmpgt, __aeabi_dcmplt, __aeabi_fcmplt"
		size = "20"
		objfiles = "_cmpsf2@libgcc.a, _cmpdf2@libgcc.a"
	strings:
...
rule __aeabi_dcmpge_ff7f5d7fa2e5dc60f94d507ce6a3303e {
	meta:
		aliases = "__aeabi_dcmple, __aeabi_fcmple, __aeabi_fcmpge, __aeabi_dcmpge"
		size = "20"
		objfiles = "_cmpsf2@libgcc.a, _cmpdf2@libgcc.a"
	strings:
...
rule __GI_iswpunct_f7d611ea152ad8aecf42b9e691f883eb {
	meta:
...
rule __GI_iswupper_7b240e0bc01c0469da1249cc1ff44baa {
	meta:
...
rule sem_destroy_6e201bb76263977e147e0bd5072f6407 {
	meta:
...
rule random_r_897b8f12b805f1b9b6c0e1be7b6b4d9e {
	meta:
		aliases = "__GI_random_r, random_r"
		size = "140"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { 0C 30 90 E5 00 00 53 E3 10 40 2D E9 00 C0 A0 E1 01 40 A0 E1 08 E0 90 E5 08 00 00 1A 00 20 9E E5 60 30 9F E5 92 03 03 E0 03 3A 83 E2 39 30 83 E2 02 31 C3 E3 00 30 8E E5 00 30 81 E5 0F 00 00 EA 00 20 90 E5 04 00 90 E5 00 10 92 E5 04 30 90 E4 01 30 83 E0 04 30 82 E4 18 10 9C E5 A3 30 A0 E1 01 00 52 E1 00 30 84 E5 0E 20 A0 21 01 00 00 2A 01 00 50 E1 0E 00 A0 21 04 00 8C E5 00 20 8C E5 00 00 A0 E3 10 80 BD E8 6D 4E C6 41 }
	condition:
		$pattern
}
...
rule __re_set_syntax_bb868efe73ff5e9c3feb73348674049b {
	meta:
...
rule nan_a39d345c67ca09ce0e9ece32b1021de2 {
	meta:
...
rule __GI_execvp_ff37fb5c349e756eb8ef056f1d02d0fc {
	meta:
...
rule __GI_open64_514b27a82d8ef887189958fd0549252f {
	meta:
		aliases = "open64, __GI___libc_open64, __libc_open64, __GI_open64"
		size = "56"
...
rule syslog_b894f9a4909b4c2528ee0248ddf88a00 {
	meta:
		aliases = "__GI_sscanf, asprintf, __GI_asprintf, __GI_fscanf, dprintf, fwscanf, __GI_syslog, __GI_fprintf, sscanf, fscanf, swscanf, fprintf, fwprintf, syslog"
		size = "48"
		objfiles = "sscanf@libc.a, swscanf@libc.a, fwscanf@libc.a, fwprintf@libc.a, syslog@libc.a"
	strings:
...
rule mq_open_3342cf6f28f8ffc3ac41c7ab915006ef {
	meta:
		aliases = "mq_open"
		size = "140"
		objfiles = "mq_open@librt.a"
	strings:
		$pattern = { 0E 00 2D E9 10 40 2D E9 00 30 D0 E5 04 D0 4D E2 2F 00 53 E3 0C 10 9D E5 04 00 00 0A ?? ?? ?? EB 16 30 A0 E3 00 20 E0 E3 00 30 80 E5 11 00 00 EA 40 20 11 E2 10 20 9D 15 18 30 8D 12 02 30 A0 01 02 28 A0 E1 00 30 8D 15 22 28 A0 E1 14 30 9D 15 01 00 80 E2 12 01 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 40 E0 E3 04 20 A0 E1 02 00 A0 E1 04 D0 8D E2 10 40 BD E8 0C D0 8D E2 0E F0 A0 E1 }
	condition:
		$pattern
}

rule __libc_fcntl_e11235c302c78487c0691882cb8b2dbd {
	meta:
...
rule __libc_open_6386fddfbd0437a794e8de24796d33bc {
	meta:
		aliases = "__GI___libc_open, __GI_open, open, __libc_open"
		size = "92"
...
rule __GI___libc_fcntl64_ea772faf4a859bf12c55c86e5c62dd83 {
	meta:
		aliases = "fcntl64, __GI_fcntl64, __libc_fcntl64, __GI___libc_fcntl64"
		size = "80"
...
rule _dl_dprintf_2b4f71d0439e50b5216483438738761f {
	meta:
		aliases = "_dl_dprintf"
		size = "884"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { 0E 00 2D E9 F0 4F 2D E9 1C D0 4D E2 40 E0 9D E5 00 00 5E E3 00 70 A0 E1 CA 00 00 0A 34 33 9F E5 00 50 A0 E3 00 10 93 E5 00 40 E0 E3 22 30 A0 E3 03 20 A0 E3 05 00 A0 E1 C0 00 90 EF 01 0A 70 E3 14 33 9F 85 00 20 60 82 00 20 83 85 04 00 A0 81 08 33 9F E5 01 00 70 E3 00 00 83 E5 0D 00 00 1A 1D 20 A0 E3 F8 12 9F E5 07 00 A0 E1 04 00 90 EF 01 0A 70 E3 E0 32 9F 85 00 20 60 82 00 20 83 85 14 00 A0 E3 01 00 90 EF 01 0A 70 E3 C8 32 9F 85 00 20 60 82 00 20 83 85 C0 32 9F E5 01 C0 4E E2 00 60 93 E5 0C 20 A0 E1 01 30 F2 E5 00 00 53 E3 FC FF FF 1A 9C 32 9F E5 00 30 93 E5 02 20 6E E0 01 30 43 E2 03 00 52 E1 }
	condition:
		$pattern
}

rule clntudp_abort_ff401781bc6d986f859a23f7108da64e {
	meta:
		aliases = "__pthread_return_void, __gcov_init, _pthread_cleanup_push_defer, __linuxthreads_create_event, xdrmem_destroy, authnone_destroy, __gcov_merge_add, pthread_handle_sigdebug, __gcov_merge_delta, authnone_verf, _pthread_cleanup_pop_restore, __linuxthreads_reap_event, __gcov_merge_single, __gnat_default_unlock, __cyg_profile_func_enter, clntraw_destroy, __aeabi_ldiv0, __gnat_default_lock, clntunix_abort, __cyg_profile_func_exit, __gcov_flush, __stub1, clntraw_abort, clntraw_geterr, svcraw_destroy, __stub2, clnttcp_abort, __aeabi_idiv0, authunix_nextverf, noop_handler, __linuxthreads_death_event, __div0, pthread_null_sighandler, __enable_execute_stack, clntudp_abort"
		size = "4"
		objfiles = "clnt_unix@libc.a, pthread@libpthread.a, clnt_udp@libc.a, clnt_raw@libc.a, signals@libpthread.a"
	strings:
		$pattern = { 0E F0 A0 E1 }
	condition:
		$pattern
...
rule __GI_printf_0304853a5bbd79b71a43422fdd25bd20 {
	meta:
		aliases = "scanf, printf, wprintf, wscanf, __GI_printf"
		size = "60"
...
rule freeaddrinfo_44f800c99271ba1b2621309a7dc8bec2 {
	meta:
...
rule pthread_handle_sigrestart_f6334eb7920c3f22182aa967735452d5 {
	meta:
		aliases = "pthread_handle_sigrestart"
		size = "40"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { 10 40 2D E9 00 40 A0 E1 97 FD FF EB 24 30 90 E5 00 00 53 E3 20 40 80 E5 10 80 BD 08 03 00 A0 E1 01 10 A0 E3 ?? ?? ?? EB }
	condition:
		$pattern
}
...
rule __raise_95d5c8be653a1bd4a1826b148e18757e {
	meta:
...
rule __sigwait_b8477292c188e15723b6e8247c31ecbd {
	meta:
...
rule ldexpf_c8dbe55e46fc4c058d4ac1e5f9bc8e6a {
	meta:
		aliases = "scalblnf, scalbnf, frexpf, ldexpf"
		size = "28"
		objfiles = "ldexpf@libm.a, scalblnf@libm.a, frexpf@libm.a, scalbnf@libm.a"
	strings:
...
rule __libc_fork_d4efd04ef7802809f64b53fefe9497ea {
	meta:
...
rule sethostid_af66871bac3613651cf4c1675899a72a {
	meta:
		aliases = "sethostid"
		size = "132"
		objfiles = "hostid@libc.a"
	strings:
		$pattern = { 10 40 2D E9 04 D0 4D E2 00 00 8D E5 ?? ?? ?? EB 00 00 50 E3 02 00 00 1A ?? ?? ?? EB 00 00 50 E3 04 00 00 0A ?? ?? ?? EB 01 30 A0 E3 03 40 A0 E1 00 30 80 E5 0E 00 00 EA 40 00 9F E5 41 10 A0 E3 69 2F A0 E3 ?? ?? ?? EB 00 40 50 E2 00 40 E0 B3 07 00 00 BA 0D 10 A0 E1 04 20 A0 E3 ?? ?? ?? EB 04 00 50 E3 04 00 A0 E1 00 40 E0 13 00 40 A0 03 ?? ?? ?? EB 04 00 A0 E1 04 D0 8D E2 10 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule xdrstdio_getlong_0e4f154178cf39a2dee3bc608068e7b4 {
	meta:
...
rule fsync_06e8dc28926387eeb84f9d2d16b42772 {
	meta:
		aliases = "tcdrain, wait, close, system, fsync"
		size = "60"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule tgamma_68d018117446c2a0ba245d5dd4863220 {
	meta:
...
rule __libc_close_390c52ad9010a56a027efa6f5f6013ed {
	meta:
...
rule clock_getres_5045f4d5bf8b7ef5098ada957daacdbc {
	meta:
...
rule __libc_sigsuspend_d912cdcac22736d5130c4f477a585453 {
	meta:
...
rule setsockopt_214ee73e08f08d91d0812ff33f372caf {
	meta:
...
rule __GI_gethostbyname_3a522632acaa2f6f525a6fd7fc370f98 {
	meta:
...
rule __GI_time_315eae241d1d8b588cfdcd9bc8a20183 {
	meta:
		aliases = "time, __GI_time"
		size = "44"
		objfiles = "time@libc.a"
	strings:
		$pattern = { 10 40 2D E9 0D 00 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 10 80 BD 98 ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 10 80 BD E8 }
	condition:
		$pattern
}
...
rule __fgetc_unlocked_ba13e73ea0c557d155bb10f1906ac51b {
	meta:
		aliases = "fgetc_unlocked, __GI_fgetc_unlocked, __GI_getc_unlocked, getc_unlocked, __GI___fgetc_unlocked, __fgetc_unlocked"
		size = "304"
...
rule ftime_a8a4153f9ae5adbbad5a89a9a0f4a1e2 {
	meta:
		aliases = "ftime"
		size = "116"
		objfiles = "ftime@libc.a"
	strings:
		$pattern = { 10 40 2D E9 10 D0 4D E2 00 40 A0 E1 0D 10 A0 E1 08 00 8D E2 ?? ?? ?? EB 00 00 50 E3 00 00 E0 B3 11 00 00 BA 0C 00 9D E5 08 30 9D E5 F9 0F 80 E2 00 30 84 E5 FA 1F A0 E3 03 00 80 E2 ?? ?? ?? EB 00 50 9D E8 40 24 A0 E1 4C 14 A0 E1 4E 34 A0 E1 09 30 C4 E5 05 20 C4 E5 07 10 C4 E5 06 C0 C4 E5 08 E0 C4 E5 04 00 C4 E5 00 00 A0 E3 10 D0 8D E2 10 80 BD E8 }
	condition:
		$pattern
}

rule setpwent_bc2a1861fc6600e47eca4f25d514c5e3 {
	meta:
...
rule clearenv_ddaa95103099ea88a9961e82423c1f0f {
	meta:
		aliases = "clearenv"
		size = "164"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { 10 40 2D E9 10 D0 4D E2 0D 00 A0 E1 74 10 9F E5 74 20 9F E5 74 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 6C 30 9F E5 60 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 60 40 9F E5 60 30 9F E5 00 00 93 E5 00 30 94 E5 03 00 50 E1 04 00 00 1A 00 00 50 E3 02 00 00 0A ?? ?? ?? EB 00 30 A0 E3 00 30 84 E5 38 30 9F E5 00 40 A0 E3 0D 00 A0 E1 00 40 83 E5 01 10 A0 E3 28 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 10 D0 8D E2 10 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule waitid_61f2eabd33f335020c958f9fd25591b0 {
	meta:
		aliases = "waitid"
		size = "44"
		objfiles = "waitid@libc.a"
	strings:
		$pattern = { 10 40 2D E9 18 01 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 10 80 BD 98 ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 10 80 BD E8 }
	condition:
		$pattern
}

rule __GI__authenticate_92c76f6593b83aa1cb682bc53c14c1db {
	meta:
...
rule socket_bbed504a677cdf7aa866e4c24580cc39 {
	meta:
...
rule pause_df08d50df298ca9cd4866601a46e7d8d {
	meta:
...
rule __libc_accept_74d504d25242b01999387e060b16bf64 {
	meta:
...
rule __GI_send_41b527ce5555580abc5a4597ab739997 {
	meta:
...
rule __GI_recv_d8ce7f1eeb317cc2ea1494f89b2164ee {
	meta:
...
rule __GI_endttyent_51df05e6d3407d2144fdb344e81d1c9e {
	meta:
...
rule recvmsg_d88b8a07bfeca37d4f71c32ddfb7ab6c {
	meta:
...
rule __GI_times_e85c3f872bd2cc7c0506c65d3cdb0bb9 {
	meta:
		aliases = "times, __GI_times"
		size = "44"
		objfiles = "times@libc.a"
	strings:
		$pattern = { 10 40 2D E9 2B 00 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 10 80 BD 98 ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 10 80 BD E8 }
	condition:
		$pattern
}
...
rule __GI_stat_ea62d3122079fd2ee49b15bf3d365e57 {
	meta:
...
rule __GI_lstat_1711b2b52ebf6040ea2fb0f5d5ee9705 {
	meta:
...
rule __GI_setsid_db1cc7edabfa5a77f1b5e690141308b5 {
	meta:
...
rule __GI_readlink_a09ae056a9f3cbf29a6a05b4e05e9dbb {
	meta:
...
rule __GI_vmsplice_91066cdd804ba9819dd7d689027518fe {
	meta:
...
rule munmap_7b823e0a342d46186cd8467de7ca9f8f {
	meta:
...
rule truncate_88ef88fe7f4738b8b07119b4a2729aba {
	meta:
...
rule __GI_setpriority_f6ef6e89f68de90b0976b95d2dd7ad76 {
	meta:
...
rule statfs_9355947002b7c6df6de989bd3965d1c6 {
	meta:
		aliases = "__libc_statfs, __GI_statfs, __GI___libc_statfs, statfs"
		size = "44"
...
rule __GI___libc_fstatfs_3901152236d21195c12b59f64b62114d {
	meta:
...
rule __GI_setitimer_f7ad9da154ce29b988aa5e9b33e284e6 {
	meta:
...
rule __GI_wait4_34df717d0a5d741d02f77e5b7ec895fb {
	meta:
...
rule __GI_mbrtowc_b932182b4a0b904bf0ff19a304875127 {
	meta:
...
rule __GI_poll_2bd42a77426b787f5c0acabd477524c7 {
	meta:
...
rule pthread_key_delete_1c813c530f987532c680fc52ea789f88 {
	meta:
		aliases = "pthread_key_delete"
		size = "208"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { 10 40 2D E9 B0 30 9F E5 00 40 A0 E1 AC 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 01 0B 54 E3 03 00 00 2A 9C 10 9F E5 84 31 91 E7 00 00 53 E3 05 00 00 1A 88 00 9F E5 8C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 16 00 A0 E3 10 80 BD E8 7C 30 9F E5 00 30 93 E5 84 21 81 E0 01 00 73 E3 00 30 A0 E3 04 30 82 E5 84 31 81 E7 0E 00 00 0A 3E FF FF EB A4 32 A0 E1 1F E0 04 E2 03 31 A0 E1 00 20 A0 E1 2C C0 D2 E5 00 00 5C E3 02 10 83 E0 02 00 00 1A EC 10 91 E5 00 00 51 E3 0E C1 81 17 00 20 92 E5 00 00 52 E1 F5 FF FF 1A 1C 30 9F E5 10 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 A0 E3 10 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule getuid_a2afc5bbec862a9c24a2aef61991a3c4 {
	meta:
...
rule geteuid_ddfa9e0aadca818cea003099b7ae1af3 {
	meta:
...
rule __GI_getegid_9a35cfc8d97ecfa6e4317b1f470e40b2 {
	meta:
...
rule __GI_setregid_4cf7ea8a3ed6da8c9d0f0a08dfacc873 {
	meta:
...
rule gethostid_6b633b81585f4d9b39387f3fee7de536 {
	meta:
		aliases = "gethostid"
		size = "220"
		objfiles = "hostid@libc.a"
	strings:
		$pattern = { 10 40 2D E9 CC 00 9F E5 6F DF 4D E2 00 10 A0 E3 ?? ?? ?? EB 00 40 50 E2 08 00 00 BA 6E 1F 8D E2 04 20 A0 E3 ?? ?? ?? EB 00 00 50 E3 24 00 00 0A 04 00 A0 E1 ?? ?? ?? EB B8 01 9D E5 23 00 00 EA 55 4F 8D E2 03 40 84 E2 04 00 A0 E1 40 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 17 00 00 BA 57 31 DD E5 00 00 53 E3 14 00 00 0A 6D CF 8D E2 0C 20 8D E2 01 20 42 E2 00 C0 8D E5 04 00 A0 E1 6B CF 8D E2 66 1F 8D E2 53 3F A0 E3 04 C0 8D E5 ?? ?? ?? EB B4 21 9D E5 00 00 52 E3 07 00 00 0A 10 30 92 E5 1B 0E 8D E2 00 10 93 E5 0C 20 92 E5 ?? ?? ?? EB B0 31 9D E5 63 08 A0 E1 04 00 00 EA 00 00 A0 E3 02 00 00 EA 04 00 A0 E1 }
	condition:
		$pattern
}

rule getgroups_2ebdf83eaf6d77760c02fca7aad4325b {
	meta:
...
rule memrchr_cc6da8dfc8b4243d10185c29be27a762 {
	meta:
...
rule __GI_exit_c699065025a9271dbd3f3b1fe556f9a4 {
	meta:
...
rule qone_b8cf4bf27e3b0ecd0b0b17420aa78a04 {
	meta:
		aliases = "qzero, qone"
		size = "596"
		objfiles = "e_j0@libm.a, e_j1@libm.a"
	strings:
		$pattern = { 18 32 9F E5 02 21 C0 E3 03 00 52 E1 F0 4D 2D E9 00 A0 A0 E1 01 B0 A0 E1 04 62 9F C5 04 82 9F C5 10 00 00 CA 00 32 9F E5 03 00 52 E1 FC 61 9F C5 FC 81 9F C5 0B 00 00 CA F8 31 9F E5 03 00 52 E1 F4 61 9F C5 F4 81 9F C5 06 00 00 CA F0 31 9F E5 01 01 52 E3 03 80 A0 A1 00 80 A0 B3 E4 31 9F E5 03 60 A0 A1 00 60 A0 B3 0A 20 A0 E1 0B 30 A0 E1 0A 00 A0 E1 0B 10 A0 E1 ?? ?? ?? EB 00 20 A0 E1 01 30 A0 E1 C0 01 9F E5 00 10 A0 E3 ?? ?? ?? EB 28 20 86 E2 0C 00 92 E8 00 40 A0 E1 01 50 A0 E1 ?? ?? ?? EB 20 20 86 E2 0C 00 92 E8 ?? ?? ?? EB 00 20 A0 E1 01 30 A0 E1 04 00 A0 E1 05 10 A0 E1 ?? ?? ?? EB 18 20 86 E2 }
	condition:
		$pattern
}
...
rule pthread_attr_getstackaddr_b55cec3b28132e2b71195e212a7232e1 {
	meta:
...
rule llrint_8c69e0ed2430d1453c96585da66c3bb6 {
	meta:
...
rule __isinf_7160d4c12946ee8b3c58a69ec4309068 {
	meta:
...
rule __ieee754_sqrt_407f785407bd66ae3b911b0999e66719 {
	meta:
...
rule sched_setaffinity_5e1bc334cd858511fed460d1c74dcf76 {
	meta:
		aliases = "sched_setaffinity"
		size = "308"
		objfiles = "sched_setaffinity@libc.a"
	strings:
		$pattern = { 28 31 9F E5 00 30 93 E5 0D C0 A0 E1 00 00 53 E3 F0 DD 2D E9 04 B0 4C E2 00 A0 A0 E1 01 80 A0 E1 02 70 A0 E1 23 00 00 1A 84 D0 4D E2 0D 60 A0 E1 80 50 A0 E3 05 00 00 EA 0D D0 61 E0 02 30 8D E0 06 00 53 E1 02 50 A0 11 02 50 85 00 0D 60 A0 E1 ?? ?? ?? EB F2 00 90 EF 85 20 A0 E1 06 30 82 E2 03 10 C3 E3 16 00 70 E3 00 30 A0 13 01 30 A0 03 01 0A 70 E3 00 30 A0 93 00 00 53 E3 00 40 A0 E1 EC FF FF 1A 01 0A 70 E3 00 30 A0 93 01 30 A0 83 00 00 50 E3 01 30 83 03 00 00 53 E3 8C 30 9F 05 00 00 83 05 03 00 00 0A ?? ?? ?? EB 00 30 64 E2 00 20 E0 E3 08 00 00 EA 70 30 9F E5 00 20 93 E5 08 00 00 EA 02 30 D7 E7 }
	condition:
		$pattern
}
...
rule __GI___sigpause_dafdb77bb5ed3f6ee2df92735bcf6dfe {
	meta:
		aliases = "__sigpause, __GI___sigpause"
		size = "120"
		objfiles = "sigpause@libc.a"
	strings:
		$pattern = { 30 40 2D E9 00 00 51 E3 80 D0 4D E2 00 50 A0 E1 00 00 8D 05 0D 40 A0 E1 04 00 8D 02 1E 30 A0 03 0B 00 00 0A 00 00 A0 E3 00 10 A0 E1 0D 20 A0 E1 ?? ?? ?? EB 00 00 50 E3 0B 00 00 BA 0D 00 A0 E1 05 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 03 00 00 AA 05 00 00 EA 01 30 53 E2 04 10 80 E4 FC FF FF 5A 0D 00 A0 E1 ?? ?? ?? EB 00 00 00 EA 00 00 E0 E3 80 D0 8D E2 30 80 BD E8 }
	condition:
		$pattern
}

rule __pthread_kill_other_threads_n_e2ac4afd48671e4ecc877450b9666d5b {
	meta:
		aliases = "pthread_kill_other_threads_np, __pthread_kill_other_threads_np"
		size = "132"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { 30 40 2D E9 00 00 A0 E3 00 10 A0 E1 8C D0 4D E2 A5 FF FF EB 0D 50 A0 E1 ?? ?? ?? EB 04 00 8D E2 ?? ?? ?? EB 4C 30 9F E5 00 40 A0 E3 00 00 93 E5 0D 10 A0 E1 04 20 A0 E1 84 40 8D E5 00 40 8D E5 ?? ?? ?? EB 30 30 9F E5 0D 10 A0 E1 00 00 93 E5 04 20 A0 E1 ?? ?? ?? EB 20 30 9F E5 00 00 93 E5 04 00 50 E1 0D 10 A0 C1 04 20 A0 C1 ?? ?? ?? CB 8C D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_pthread_cond_signal_a1e588912131617514334671abfc9309 {
	meta:
		aliases = "pthread_cond_signal, __GI_pthread_cond_signal"
		size = "80"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { 30 40 2D E9 00 10 A0 E3 00 50 A0 E1 ?? ?? ?? EB 08 40 95 E5 00 00 54 E3 08 30 94 15 08 30 85 15 00 30 A0 13 08 30 84 15 05 00 A0 E1 ?? ?? ?? EB 00 00 54 E3 03 00 00 0A 01 30 A0 E3 B9 31 C4 E5 04 00 A0 E1 BC FE FF EB 00 00 A0 E3 30 80 BD E8 }
	condition:
		$pattern
}
...
rule wcstod_4007dc262a6002cff4be8e25166dae44 {
	meta:
...
rule xdr_callhdr_f0f6e5ace29920ca70681a931750b245 {
	meta:
...
rule __GI_xdr_pmap_481f6d833e18cfff8d0eeb193e1619ac {
	meta:
...
rule __pthread_set_own_extricate_if_78559313385f6c555b2d1254b4314ac4 {
	meta:
	...
	strings:
		$pattern = { 30 40 2D E9 00 50 51 E2 00 40 A0 E1 03 00 00 0A 40 30 D0 E5 00 00 53 E3 30 80 BD 18 02 00 00 EA 1C 00 90 E5 04 10 A0 E1 ?? ?? ?? EB 00 00 55 E3 BC 51 84 E5 30 80 BD 18 1C 00 94 E5 30 40 BD E8 ?? ?? ?? EA }
	condition:
		$pattern
}

rule xdr_u_short_7e94a2ec36a214087cbfbe13fbd17c15 {
	meta:
...
rule xdr_short_aeba2c897fb0c40087a7a52ab4543721 {
	meta:
...
rule if_freenameindex_e582b144e4be2421604a95f25b75a871 {
	meta:
...
rule vswprintf_aeb34b33fb0c088f86901263f0e11723 {
	meta:
...
rule __GI_wcsnrtombs_3c2f6d344e8c69f85b762e2ad93500fc {
	meta:
		aliases = "wcsnrtombs, __GI_wcsnrtombs"
		size = "172"
		objfiles = "wcsnrtombs@libc.a"
	strings:
		$pattern = { 30 40 2D E9 01 00 50 E1 00 00 50 13 10 D0 4D E2 00 E0 A0 E1 01 40 A0 13 05 00 00 1A 00 00 50 E3 0E 40 A0 01 0D E0 A0 11 00 40 A0 13 0D E0 A0 01 00 30 E0 03 02 00 53 E1 03 50 A0 31 02 50 A0 21 00 20 91 E5 05 00 A0 E1 0F 00 00 EA 00 30 92 E5 7F 00 53 E3 FF C0 03 E2 04 20 82 E2 04 00 00 9A ?? ?? ?? EB 54 30 A0 E3 00 20 E0 E3 00 30 80 E5 0A 00 00 EA 00 00 5C E3 00 C0 CE E5 0C 20 A0 01 03 00 00 0A 04 E0 8E E0 01 00 40 E2 00 00 50 E3 ED FF FF 1A 0D 00 5E E1 00 20 81 15 05 20 60 E0 02 00 A0 E1 10 D0 8D E2 30 80 BD E8 }
	condition:
		$pattern
}

rule bsd_signal_e35a51f9f771c9521d36ab9e0328a7e0 {
	meta:
		aliases = "signal, __bsd_signal, __GI_signal, bsd_signal"
		size = "192"
		objfiles = "signal@libc.a"
	strings:
		$pattern = { 30 40 2D E9 01 00 71 E3 00 00 50 13 46 DF 4D E2 00 40 A0 E1 00 30 A0 C3 01 30 A0 D3 04 00 00 DA 40 00 50 E3 03 00 A0 D1 20 20 A0 D3 8C 10 8D D5 05 00 00 DA ?? ?? ?? EB 16 30 A0 E3 00 20 E0 E3 00 30 80 E5 19 00 00 EA 88 00 03 E5 01 20 52 E2 46 1F 8D E2 02 31 81 E0 FA FF FF 5A 8C 50 8D E2 04 00 85 E2 04 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 0D 00 00 BA 04 10 A0 E1 3C 00 9F E5 ?? ?? ?? EB 00 00 50 E3 01 32 A0 03 00 30 A0 13 0D 20 A0 E1 05 10 A0 E1 04 00 A0 E1 10 31 8D E5 ?? ?? ?? EB 00 00 50 E3 00 20 9D A5 00 00 00 AA 00 20 E0 E3 02 00 A0 E1 46 DF 8D E2 30 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __libc_posix_fadvise_fb70b4640fbee30a5ba733cb0adb8cad {
	meta:
		aliases = "posix_fadvise, __libc_posix_fadvise"
		size = "52"
		objfiles = "posix_fadvise@libc.a"
	strings:
		$pattern = { 30 40 2D E9 01 C0 A0 E1 02 50 A0 E1 02 40 A0 E1 C5 5F A0 E1 01 20 A0 E1 03 10 A0 E1 CC 3F A0 E1 0E 01 90 EF 01 0A 70 E3 00 00 A0 93 00 00 60 82 30 80 BD E8 }
	condition:
		$pattern
}
...
rule sigset_ee7cdc289b6f499a18e4d09e4c094f5f {
	meta:
		aliases = "sigset"
		size = "320"
		objfiles = "sigset@libc.a"
	strings:
		$pattern = { 30 40 2D E9 02 00 51 E3 66 DF 4D E2 00 40 A0 E1 20 20 A0 03 00 10 A0 03 01 00 00 0A 12 00 00 EA 80 10 03 E5 01 20 52 E2 66 0F 8D E2 02 31 80 E0 FA FF FF 5A 46 5F 8D E2 04 10 A0 E1 05 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 38 00 00 BA 00 00 A0 E3 00 20 A0 E1 05 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 02 20 A0 A3 32 00 00 AA 30 00 00 EA 01 00 71 E3 00 00 50 13 00 30 A0 C3 01 30 A0 D3 04 00 00 DA 40 00 50 E3 03 00 A0 D1 20 20 A0 D3 8C 10 8D D5 05 00 00 DA ?? ?? ?? EB 16 30 A0 E3 00 20 E0 E3 00 30 80 E5 22 00 00 EA 08 01 03 E5 01 20 52 E2 66 1F 8D E2 02 31 81 E0 FA FF FF 5A 00 50 A0 E3 8C 10 8D E2 04 00 A0 E1 }
	condition:
		$pattern
}
...
rule __GI_jrand48_r_60a3f9a5c31e465d6f6770a3495a7cb5 {
	meta:
...
rule __GI_xdr_replymsg_b597f0d32228ff0bf6eabf83784f3a8e {
	meta:
...
rule __GI_fgetgrent_r_e8080a1c2fc51c486b5e54e9e6df8922 {
	meta:
		aliases = "__GI_fgetspent_r, fgetspent_r, fgetpwent_r, fgetgrent_r, __GI_fgetpwent_r, __GI_fgetgrent_r"
		size = "56"
...
rule xdr_authunix_parms_2c81db2f08943685f20edb6d848e8cb0 {
	meta:
...
rule __GI_sendto_e053056c3c5d6506b1d81dc8dfa56fba {
	meta:
...
rule __GI_recvfrom_ad0d3dd18cca54fa722ba12b8faff003 {
	meta:
...
rule getservbyport_eeb9756b126cd751cf15777f2f4a0edd {
	meta:
...
rule __new_sem_wait_c939bcc8b1278aa661aceddf895515f6 {
	meta:
		aliases = "sem_wait, __new_sem_wait"
		size = "320"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { 30 40 2D E9 0C D0 4D E2 00 40 A0 E1 5C FF FF EB 24 31 9F E5 08 00 8D E5 08 10 9D E5 04 00 A0 E1 04 30 8D E5 00 40 8D E5 ?? ?? ?? EB 08 30 94 E5 00 00 53 E3 04 00 00 DA 01 30 43 E2 08 30 84 E5 04 00 A0 E1 ?? ?? ?? EB 38 00 00 EA 08 20 9D E5 00 30 A0 E3 BA 31 C2 E5 08 00 9D E5 0D 10 A0 E1 F0 FE FF EB 08 30 9D E5 42 30 D3 E5 00 00 53 E3 04 00 00 0A 08 30 9D E5 40 30 D3 E5 00 00 53 E3 01 50 A0 03 03 00 00 0A 08 10 9D E5 0C 00 84 E2 C4 FE FF EB 00 50 A0 E3 04 00 A0 E1 ?? ?? ?? EB 00 00 55 E3 03 00 00 0A 08 00 9D E5 00 10 A0 E3 DC FE FF EB 1A 00 00 EA 08 00 9D E5 61 FF FF EB 08 30 9D E5 BA 31 D3 E5 }
	condition:
		$pattern
}

rule putc_unlocked_5e36d1201230a94a099b0e739248355a {
	meta:
...
rule __GI_mmap_a044b12ba38e4ab9f01e93ae87f0f3d0 {
	meta:
		aliases = "mmap, __GI_mmap"
		size = "96"
		objfiles = "mmap@libc.a"
	strings:
		$pattern = { 30 40 2D E9 10 50 9D E5 05 CA A0 E1 2C CA A0 E1 00 00 5C E3 04 00 00 0A ?? ?? ?? EB 16 30 A0 E3 00 20 E0 E3 00 30 80 E5 0A 00 00 EA 25 56 A0 E1 0C 40 9D E5 C0 00 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 40 E0 E3 04 20 A0 E1 02 00 A0 E1 30 80 BD E8 }
	condition:
		$pattern
}
...
rule endutent_e813c98e8c38366ef58450e9cb3de8b6 {
	meta:
		aliases = "endutent"
		size = "128"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 30 40 2D E9 10 D0 4D E2 0D 00 A0 E1 54 10 9F E5 54 20 9F E5 54 30 9F E5 54 40 9F E5 0F E0 A0 E1 03 F0 A0 E1 40 00 9F E5 48 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 94 E5 01 00 70 E3 0D 50 A0 E1 ?? ?? ?? 1B 00 30 E0 E3 00 30 84 E5 0D 00 A0 E1 01 10 A0 E3 20 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 10 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule endnetent_c3462f56f9929520ab241c1eb9066968 {
	meta:
		aliases = "__GI_endprotoent, endprotoent, endservent, __GI_endservent, __GI_endnetent, endnetent"
		size = "148"
...
rule setnetent_4fac06ced0537d7c958ab606f1f198e7 {
	meta:
		aliases = "__GI_setprotoent, __GI_setnetent, __GI_setservent, setservent, setprotoent, setnetent"
		size = "172"
		objfiles = "getproto@libc.a, getnetent@libc.a, getservice@libc.a"
	strings:
...
rule fgetc_9fcc99d35dfa90724fd2f7a2296cbe78 {
	meta:
...
rule putenv_76a438d314c265563444353f33fa65b1 {
	meta:
		aliases = "putenv"
		size = "92"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { 30 40 2D E9 3D 10 A0 E3 00 50 A0 E1 ?? ?? ?? EB 00 40 50 E2 0B 00 00 0A 04 10 65 E0 05 00 A0 E1 ?? ?? ?? EB 05 20 A0 E1 00 10 A0 E3 01 30 A0 E3 00 40 A0 E1 ?? ?? ?? EB 00 50 A0 E1 04 00 A0 E1 ?? ?? ?? EB 02 00 00 EA 05 00 A0 E1 ?? ?? ?? EB 04 50 A0 E1 05 00 A0 E1 30 80 BD E8 }
	condition:
		$pattern
}
...
rule setutent_d0b5d0804b9df9f50248fc61156a9fa8 {
	meta:
		aliases = "__GI_setutent, setutent"
		size = "108"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 30 40 2D E9 4C 40 9F E5 10 D0 4D E2 48 10 9F E5 04 20 A0 E1 0D 00 A0 E1 40 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 38 30 9F E5 04 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 1E FF FF EB 0D 00 A0 E1 01 10 A0 E3 20 30 9F E5 0D 50 A0 E1 0F E0 A0 E1 03 F0 A0 E1 10 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule getutent_3b64a3beb21deb3440da07f111afbb61 {
	meta:
		aliases = "getutent"
		size = "128"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 30 40 2D E9 5C 40 9F E5 10 D0 4D E2 04 20 A0 E1 54 10 9F E5 0D 00 A0 E1 50 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 44 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 3C 30 9F E5 00 00 93 E5 68 FF FF EB 01 10 A0 E3 00 40 A0 E1 2C 30 9F E5 0D 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 0D 50 A0 E1 04 00 A0 E1 10 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule closelog_intern_4cede782cb2d8070bb209ca27498984e {
	meta:
...
rule __pthread_manager_sighandler_1ab9de6b2d4b81c33cb3912f7ee34858 {
	meta:
		aliases = "__pthread_manager_sighandler"
		size = "148"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { 30 40 2D E9 7C 30 9F E5 00 30 93 E5 00 00 53 E3 94 D0 4D E2 00 30 A0 13 03 00 00 1A 68 30 9F E5 00 30 93 E5 00 30 53 E2 01 30 A0 13 00 00 53 E3 50 30 9F E5 01 20 A0 E3 00 20 83 E5 0F 00 00 0A 00 30 A0 E3 00 30 8D E5 06 30 83 E2 04 30 8D E5 38 50 9F E5 0D 40 A0 E1 0D 10 A0 E1 94 20 A0 E3 00 00 95 E5 ?? ?? ?? EB 01 00 70 E3 03 00 00 1A ?? ?? ?? EB 00 30 90 E5 04 00 53 E3 F5 FF FF 0A 94 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule sigrelse_b1da14fe7a899b6cc1a7a1faf1c29a35 {
	meta:
		aliases = "sighold, sigrelse"
		size = "92"
		objfiles = "sighold@libc.a, sigrelse@libc.a"
	strings:
		$pattern = { 30 40 2D E9 80 D0 4D E2 00 50 A0 E1 00 10 A0 E3 02 00 A0 E3 0D 20 A0 E1 ?? ?? ?? EB 00 00 50 E3 0D 40 A0 E1 09 00 00 BA 05 10 A0 E1 0D 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 04 00 00 BA 0D 10 A0 E1 00 20 A0 E3 02 00 A0 E3 ?? ?? ?? EB 00 00 00 EA 00 00 E0 E3 80 D0 8D E2 30 80 BD E8 }
	condition:
		$pattern
}

rule siginterrupt_f832d5cc309f2d5734c8a8402bbabb28 {
	meta:
		aliases = "siginterrupt"
		size = "136"
		objfiles = "sigintr@libc.a"
	strings:
		$pattern = { 30 40 2D E9 8C D0 4D E2 01 50 A0 E1 0D 20 A0 E1 00 10 A0 E3 00 40 A0 E1 ?? ?? ?? EB 00 00 50 E3 14 00 00 BA 00 00 55 E3 05 00 00 0A 50 00 9F E5 04 10 A0 E1 ?? ?? ?? EB 84 30 9D E5 01 32 C3 E3 04 00 00 EA 38 00 9F E5 04 10 A0 E1 ?? ?? ?? EB 84 30 9D E5 01 32 83 E3 04 00 A0 E1 0D 10 A0 E1 00 20 A0 E3 84 30 8D E5 ?? ?? ?? EB 00 00 50 E3 00 00 A0 A3 00 00 00 AA 00 00 E0 E3 8C D0 8D E2 30 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __setutent_5c7ebd6cbe627520f976116ff2e1d7e9 {
	meta:
		aliases = "__setutent"
		size = "176"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 30 40 2D E9 9C 40 9F E5 00 30 94 E5 01 00 73 E3 1E 00 00 1A 90 50 9F E5 02 10 A0 E3 00 00 95 E5 ?? ?? ?? EB 00 00 50 E3 00 00 84 E5 05 00 00 AA 00 00 95 E5 00 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 00 00 84 E5 0B 00 00 BA 00 20 A0 E3 00 00 94 E5 01 10 A0 E3 ?? ?? ?? EB 00 20 50 E2 05 00 00 BA 00 00 94 E5 01 20 82 E3 02 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 05 00 00 AA 00 20 E0 E3 24 30 9F E5 02 00 A0 E1 00 20 83 E5 30 40 BD E8 ?? ?? ?? EA 10 30 9F E5 00 10 A0 E3 00 00 93 E5 01 20 A0 E1 30 40 BD E8 ?? ?? ?? EA ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule funlockfile_8a02de413851b21c7f717ae1aecb121b {
	meta:
...
rule nl_langinfo_016de9d33e146d3a7b35c451e264ea7f {
	meta:
...
rule srand48_r_f5ecc680d3d8b004af94ce15c68d4c63 {
	meta:
...
rule rint_6c7ce7972e6f1df89dbae5a3da36aef9 {
	meta:
...
rule __GI_abort_bf0f8f3175946d6257baa6922f3941c0 {
	meta:
		aliases = "abort, __GI_abort"
		size = "328"
		objfiles = "abort@libc.a"
	strings:
		$pattern = { 43 DF 4D E2 2C 01 9F E5 2C 31 9F E5 0F E0 A0 E1 03 F0 A0 E1 20 20 A0 E3 00 10 A0 E3 02 00 00 EA 43 0F 8D E2 02 31 80 E0 80 10 03 E5 01 20 52 E2 FA FF FF 5A 8C 40 8D E2 04 00 A0 E1 06 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 00 20 A0 01 04 10 A0 01 01 00 A0 03 ?? ?? ?? 0B E0 20 9F E5 00 30 92 E5 00 00 53 E3 0B 00 00 1A 01 30 83 E2 00 30 82 E5 CC 30 9F E5 BC 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 06 00 A0 E3 ?? ?? ?? EB A8 00 9F E5 A8 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 A0 C0 9F E5 00 30 9C E5 01 00 53 E3 16 00 00 1A 01 30 83 E2 00 10 A0 E3 8C 20 A0 E3 0D 00 A0 E1 00 30 8C E5 ?? ?? ?? EB 00 30 A0 E3 20 20 A0 E3 }
	condition:
		$pattern
}

rule wctype_b6e1aa4997f51081955c25d2f6a49a1e {
	meta:
...
rule __GI___uClibc_init_85a87fc9ae2fd5df867ff266980d50df {
	meta:
		aliases = "__uClibc_init, __GI___uClibc_init"
		size = "92"
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { 44 20 9F E5 00 30 92 E5 00 00 53 E3 04 E0 2D E5 04 F0 9D 14 01 30 83 E2 30 10 9F E5 00 30 82 E5 2C 30 9F E5 01 2A A0 E3 00 00 51 E3 00 20 83 E5 0F E0 A0 11 01 F0 A0 11 18 30 9F E5 00 00 53 E3 04 F0 9D 04 04 E0 9D E4 ?? ?? ?? EA ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule scalbln_a6b926f816048a821a7abd7a7b93b5ab {
	meta:
		aliases = "__GI_scalbln, scalbln"
		size = "376"
		objfiles = "s_scalbln@libm.a"
	strings:
		$pattern = { 44 31 9F E5 03 30 00 E0 43 CA B0 E1 F0 41 2D E9 00 60 A0 E1 01 70 A0 E1 01 50 A0 E1 00 E0 A0 E1 02 80 A0 E1 01 40 A0 E1 0C 00 00 1A 02 31 C0 E3 01 30 93 E1 41 00 00 0A 00 30 A0 E3 0C 21 9F E5 ?? ?? ?? EB 00 31 9F E5 03 30 00 E0 43 3A A0 E1 00 60 A0 E1 01 70 A0 E1 00 E0 A0 E1 36 C0 43 E2 EC 30 9F E5 03 00 5C E1 05 00 00 1A 06 00 A0 E1 07 10 A0 E1 06 20 A0 E1 07 30 A0 E1 ?? ?? ?? EB 2C 00 00 EA CC 20 9F E5 CC 30 9F E5 08 10 8C E0 03 00 51 E1 02 00 58 D1 07 00 00 DA 06 20 A0 E1 07 30 A0 E1 B4 00 9F E5 B4 10 9F E5 ?? ?? ?? EB A8 20 9F E5 A8 30 9F E5 1D 00 00 EA A4 30 9F E5 03 00 58 E1 09 00 00 BA }
	condition:
		$pattern
}
...
rule scalbn_54e9504ca7f56e217c16e0021a04a400 {
	meta:
		aliases = "__GI_scalbn, scalbn"
		size = "392"
		objfiles = "s_scalbn@libm.a"
	strings:
		$pattern = { 54 31 9F E5 03 30 00 E0 43 CA B0 E1 F0 41 2D E9 00 60 A0 E1 01 70 A0 E1 01 50 A0 E1 00 E0 A0 E1 02 80 A0 E1 01 40 A0 E1 12 00 00 1A 02 31 C0 E3 01 30 93 E1 45 00 00 0A 00 30 A0 E3 1C 21 9F E5 ?? ?? ?? EB 18 31 9F E5 01 70 A0 E1 03 00 58 E1 00 60 A0 E1 00 10 A0 E1 06 00 A0 B1 07 10 A0 B1 2B 00 00 BA F0 30 9F E5 03 30 01 E0 43 3A A0 E1 01 E0 A0 E1 36 C0 43 E2 E8 30 9F E5 03 00 5C E1 05 00 00 1A 06 00 A0 E1 07 10 A0 E1 06 20 A0 E1 07 30 A0 E1 ?? ?? ?? EB 2A 00 00 EA C8 30 9F E5 08 10 8C E0 03 00 51 E1 0C 00 00 CA 00 00 51 E3 05 00 00 DA 7F 24 CE E3 0F 26 C2 E3 01 3A 82 E1 07 40 A0 E1 03 60 A0 E1 }
	condition:
		$pattern
}
...
rule siglongjmp_789ce6fea0e89014516e8152aa1f9b75 {
	meta:
		aliases = "_longjmp, __libc_longjmp, __libc_siglongjmp, longjmp, siglongjmp"
		size = "52"
...
rule thread_self_de6f3a4eb83e3f77b08ef501701ed5e1 {
	meta:
		aliases = "thread_self"
		size = "124"
		objfiles = "errno@libpthread.a, specific@libpthread.a, join@libpthread.a, semaphore@libpthread.a, spinlock@libpthread.a"
	strings:
		$pattern = { 5C 30 9F E5 00 30 93 E5 03 00 5D E1 0D 20 A0 E1 50 00 9F 25 0E F0 A0 21 4C 30 9F E5 00 30 93 E5 03 00 5D E1 04 00 00 3A 40 30 9F E5 00 30 93 E5 03 00 5D E1 38 00 9F 35 0E F0 A0 31 34 30 9F E5 00 30 93 E5 00 00 53 E3 00 00 00 0A ?? ?? ?? EA A2 3A E0 E1 83 3A E0 E1 77 0F 43 E2 03 00 40 E2 0E F0 A0 E1 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule xdrrec_create_c6ba4af85aa3850660026b37be90718e {
	meta:
...
rule updwtmp_57c50a1c89e4a246a6a6b07bc175748c {
	meta:
		aliases = "updwtmp"
		size = "96"
		objfiles = "wtent@libc.a"
	strings:
		$pattern = { 70 40 2D E9 00 20 A0 E3 01 60 A0 E1 48 10 9F E5 ?? ?? ?? EB 00 40 50 E2 70 80 BD B8 01 10 A0 E3 00 20 A0 E3 ?? ?? ?? EB 00 50 50 E2 70 80 BD 18 06 10 A0 E1 04 00 A0 E1 06 2D A0 E3 ?? ?? ?? EB 04 00 A0 E1 05 10 A0 E1 05 20 A0 E1 ?? ?? ?? EB 04 00 A0 E1 70 40 BD E8 ?? ?? ?? EA 01 04 00 00 }
	condition:
		$pattern
}
...
rule __libc_sigaction_4e4d2c4f0bba6e7c425006ee7a6da10d {
	meta:
...
rule __GI_closedir_8e3c94723cadb293d233ad7878d984e0 {
	meta:
...
rule __GI_pthread_attr_setschedpara_7bd2c1294432a6f6f658d37ff0243f26 {
	meta:
...
rule fflush_948fa1fcbd688714d3b3a9a07424d35b {
	meta:
...
rule __GI_xdr_u_hyper_f765ea3d163cb6505a5349e6fba3a69d {
	meta:
...
rule __GI_wcscasecmp_d9aa0f77c542f096edd7a16acd9739db {
	meta:
...
rule re_comp_c713fe66f8c632878eb978eeaa37d0a1 {
	meta:
		aliases = "re_comp"
		size = "216"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { 70 40 2D E9 00 60 50 E2 B0 40 9F E5 04 00 00 1A 00 30 94 E5 00 00 53 E3 A4 00 9F 05 70 80 BD 08 24 00 00 EA 00 30 94 E5 00 00 53 E3 04 50 A0 E1 0D 00 00 1A C8 00 A0 E3 ?? ?? ?? EB 00 00 50 E3 00 00 84 E5 06 00 00 0A C8 30 A0 E3 01 0C A0 E3 04 30 84 E5 ?? ?? ?? EB 00 00 50 E3 10 00 84 E5 01 00 00 1A 5C 00 9F E5 70 80 BD E8 4C 40 9F E5 1C 30 D4 E5 80 30 83 E3 1C 30 C4 E5 06 00 A0 E1 ?? ?? ?? EB 40 30 9F E5 00 10 A0 E1 00 20 93 E5 06 00 A0 E1 04 30 A0 E1 C3 F6 FF EB 00 00 50 E3 04 00 00 0A 24 30 9F E5 00 21 93 E7 20 30 9F E5 03 00 82 E0 70 80 BD E8 00 00 A0 E3 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_lseek64_9ae0326b6bdf9190b82a1daaf61fcd32 {
	meta:
		aliases = "lseek64, __libc_lseek64, __GI_lseek64"
		size = "100"
		objfiles = "llseek@libc.a"
	strings:
		$pattern = { 70 40 2D E9 01 50 A0 E1 08 D0 4D E2 02 60 A0 E1 02 10 A0 E1 03 40 A0 E1 05 20 A0 E1 0D 30 A0 E1 8C 00 90 EF 01 0A 70 E3 00 40 A0 E1 04 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 20 E0 E3 00 30 80 E5 01 00 00 EA 00 20 50 E2 02 00 00 0A 02 00 A0 E1 C0 1F A0 E1 00 00 00 EA 03 00 9D E8 08 D0 8D E2 70 80 BD E8 }
	condition:
		$pattern
}
...
rule remainderf_4a44cd37ef35a0b922cd1ed5d81e2ab8 {
	meta:
		aliases = "fmodf, copysignf, hypotf, atan2f, nextafterf, powf, remainderf"
		size = "56"
		objfiles = "powf@libm.a, fmodf@libm.a, hypotf@libm.a, copysignf@libm.a, nextafterf@libm.a"
	strings:
...
rule __GI_ldexp_56e903529f3d2514160cc428c0acd184 {
	meta:
...
rule __GI_waitpid_1823f96336634c69108f5ddfbc5d7589 {
	meta:
		aliases = "read, write, connect, lseek, accept, waitpid, msync, sendmsg, recvmsg, __GI_waitpid"
		size = "76"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule pthread_rwlock_tryrdlock_00a3dff27097b65be52f8334c95a337b {
	meta:
...
rule pthread_cond_wait_a262a265157b8fa7643fb81fe27d86af {
	meta:
		aliases = "__GI_pthread_cond_wait, pthread_cond_wait"
		size = "408"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { 70 40 2D E9 0C D0 4D E2 01 60 A0 E1 00 50 A0 E1 46 FF FF EB 0C 30 96 E5 03 00 53 E3 00 00 53 13 08 00 8D E5 04 00 00 0A 08 20 9D E5 08 30 96 E5 02 00 53 E1 16 00 A0 13 51 00 00 1A 48 31 9F E5 08 20 9D E5 04 30 8D E5 00 30 A0 E3 00 50 8D E5 B9 31 C2 E5 08 00 9D E5 0D 10 A0 E1 0B FF FF EB 05 00 A0 E1 08 10 9D E5 ?? ?? ?? EB 08 30 9D E5 42 30 D3 E5 00 00 53 E3 04 00 00 0A 08 30 9D E5 40 30 D3 E5 00 00 53 E3 01 40 A0 03 03 00 00 0A 08 10 9D E5 08 00 85 E2 C7 FE FF EB 00 40 A0 E3 05 00 A0 E1 ?? ?? ?? EB 00 00 54 E3 03 00 00 0A 08 00 9D E5 00 10 A0 E3 F4 FE FF EB 24 00 00 EA 06 00 A0 E1 C4 30 9F E5 }
	condition:
		$pattern
}

rule pthread_rwlock_rdlock_4bbe41e6abce0b7878a100fcb9fb189c {
	meta:
...
rule getutline_3949ed91f24cbd35518c52cba5e4ad57 {
	meta:
		aliases = "getutline"
		size = "176"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 70 40 2D E9 10 D0 4D E2 00 40 A0 E1 84 10 9F E5 0D 00 A0 E1 80 20 9F E5 80 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 70 00 9F E5 74 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 6C 60 9F E5 08 50 84 E2 09 00 00 EA 00 30 94 E5 06 30 43 E2 03 38 A0 E1 01 08 53 E3 04 00 00 8A 08 00 84 E2 05 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 03 00 00 0A 00 00 96 E5 21 FF FF EB 00 40 50 E2 F1 FF FF 1A 0D 00 A0 E1 01 10 A0 E3 24 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule utmpname_69cb99b513c84e41a5f5d1d2b40bba49 {
	meta:
		aliases = "utmpname"
		size = "188"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 70 40 2D E9 10 D0 4D E2 00 50 A0 E1 88 10 9F E5 0D 00 A0 E1 84 20 9F E5 84 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 74 00 9F E5 78 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 55 E3 09 00 00 0A 68 60 9F E5 68 40 9F E5 00 00 96 E5 04 00 50 E1 ?? ?? ?? 1B 05 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 04 00 A0 01 00 00 86 E5 48 40 9F E5 00 00 94 E5 01 00 70 E3 ?? ?? ?? 1B 00 30 E0 E3 0D 00 A0 E1 00 30 84 E5 01 10 A0 E3 2C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 A0 E3 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __close_nameservers_e4220f727b8030dc59699aabedb6519d {
	meta:
		aliases = "__close_nameservers"
		size = "220"
		objfiles = "closenameservers@libc.a"
	strings:
		$pattern = { 70 40 2D E9 10 D0 4D E2 0D 00 A0 E1 A4 10 9F E5 A4 20 9F E5 A4 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 94 00 9F E5 98 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 90 40 9F E5 90 50 9F E5 00 60 A0 E3 04 00 00 EA 02 01 95 E7 00 20 84 E5 ?? ?? ?? EB 00 30 94 E5 03 61 85 E7 00 30 94 E5 00 00 53 E3 01 20 43 E2 F6 FF FF CA 05 00 00 EA 02 01 95 E7 00 20 84 E5 ?? ?? ?? EB 00 30 94 E5 03 61 85 E7 02 00 00 EA 48 40 9F E5 48 50 9F E5 00 60 A0 E3 00 30 94 E5 00 00 53 E3 01 20 43 E2 F2 FF FF CA 0D 00 A0 E1 01 10 A0 E3 2C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_if_nametoindex_496273942700caebc66bea33317939e1 {
	meta:
		aliases = "if_nametoindex, __GI_if_nametoindex"
		size = "144"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { 70 40 2D E9 20 D0 4D E2 00 60 A0 E1 ?? ?? ?? EB 00 50 50 E2 19 00 00 BA 06 10 A0 E1 10 20 A0 E3 0D 00 A0 E1 ?? ?? ?? EB 05 00 A0 E1 0D 20 A0 E1 54 10 9F E5 ?? ?? ?? EB 00 00 50 E3 0D 40 A0 E1 0A 00 00 AA ?? ?? ?? EB 00 40 90 E5 00 60 A0 E1 05 00 A0 E1 ?? ?? ?? EB 16 00 54 E3 26 30 A0 03 00 00 A0 03 00 30 86 05 05 00 00 0A 03 00 00 EA 05 00 A0 E1 ?? ?? ?? EB 10 00 9D E5 00 00 00 EA 00 00 A0 E3 20 D0 8D E2 70 80 BD E8 33 89 00 00 }
	condition:
		$pattern
}
...
rule __GI_fgetwc_f330e9cb98e8883cb9149cfdf83c99af {
	meta:
		aliases = "__GI_fileno, fgetwc, getwc, fileno, __GI_fgetwc"
		size = "132"
...
rule __ns_name_uncompress_cd777b96e7823f66de90030b1d9e1ad9 {
	meta:
...
rule __GI_getdomainname_a536411d8281989efcf80a4b1a855393 {
	meta:
		aliases = "getdomainname, __libc_getdomainname, __GI___libc_getdomainname, __GI_getdomainname"
		size = "112"
...
rule __pthread_wait_for_restart_sig_c4844d4ff2c0f270d58aef43afea09c4 {
	meta:
		aliases = "__pthread_wait_for_restart_signal"
		size = "92"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { 70 40 2D E9 80 D0 4D E2 00 60 A0 E1 00 10 A0 E3 0D 20 A0 E1 02 00 A0 E3 0D 40 A0 E1 ?? ?? ?? EB 30 50 9F E5 0D 00 A0 E1 00 10 95 E5 ?? ?? ?? EB 00 30 A0 E3 20 30 86 E5 0D 00 A0 E1 ?? ?? ?? EB 20 20 96 E5 00 30 95 E5 03 00 52 E1 F9 FF FF 1A 80 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __old_sem_wait_955f18e1db143748f7042e466ea228ef {
	meta:
		aliases = "__old_sem_wait"
		size = "440"
		objfiles = "oldsemaphore@libpthread.a"
	strings:
		$pattern = { 70 40 2D E9 90 31 9F E5 00 30 93 E5 0C D0 4D E2 03 00 5D E1 00 50 A0 E1 0D 20 A0 E1 7C 01 9F 25 12 00 00 2A 78 31 9F E5 00 30 93 E5 03 00 5D E1 04 00 00 3A 6C 31 9F E5 00 30 93 E5 03 00 5D E1 64 01 9F 35 09 00 00 3A 60 31 9F E5 00 30 93 E5 00 00 53 E3 01 00 00 0A ?? ?? ?? EB 03 00 00 EA A2 3A E0 E1 83 3A E0 E1 77 0F 43 E2 03 00 40 E2 00 30 A0 E3 00 30 8D E5 34 31 9F E5 08 00 8D E5 04 30 8D E5 0D 60 A0 E1 08 00 9D E5 0D 10 A0 E1 C9 FF FF EB 00 10 95 E5 01 00 51 E3 00 30 A0 03 01 30 01 12 00 00 53 E3 08 40 9D 05 08 30 9D 05 02 40 41 12 08 10 83 05 05 00 A0 E1 04 20 A0 E1 6B FF FF EB 00 00 50 E3 }
	condition:
		$pattern
}

rule pthread_onexit_process_f2fe9ceb2daad5a7e4236aa987a11b8e {
	meta:
		aliases = "pthread_onexit_process"
		size = "180"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { 70 40 2D E9 94 60 9F E5 00 30 96 E5 00 00 53 E3 94 D0 4D E2 00 50 A0 E1 1E 00 00 BA 6A FF FF EB 02 30 A0 E3 29 00 8D E8 00 40 A0 E1 0D 50 A0 E1 0D 10 A0 E1 94 20 A0 E3 00 00 96 E5 ?? ?? ?? EB 01 00 70 E3 03 00 00 1A ?? ?? ?? EB 00 30 90 E5 04 00 53 E3 F5 FF FF 0A 04 00 A0 E1 E6 FF FF EB 3C 30 9F E5 00 30 93 E5 03 00 54 E1 09 00 00 1A 30 30 9F E5 02 21 A0 E3 14 00 93 E5 00 10 A0 E3 ?? ?? ?? EB 20 30 9F E5 00 20 A0 E3 00 20 83 E5 18 30 9F E5 00 20 83 E5 94 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule sem_post_1fd37cd7d5a6e1de5020bdfb7ca49f56 {
	meta:
		aliases = "__new_sem_post, sem_post"
		size = "288"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { 70 40 2D E9 94 D0 4D E2 00 40 A0 E1 0C FF FF EB 54 60 90 E5 00 00 56 E3 20 00 00 1A 00 10 A0 E1 04 00 A0 E1 ?? ?? ?? EB 0C 50 94 E5 00 00 55 E3 0F 00 00 1A 08 30 94 E5 06 01 73 E3 06 00 00 1A ?? ?? ?? EB 22 30 A0 E3 00 30 80 E5 04 00 A0 E1 ?? ?? ?? EB 00 20 E0 E3 2C 00 00 EA 01 30 83 E2 08 30 84 E5 04 00 A0 E1 ?? ?? ?? EB 05 20 A0 E1 26 00 00 EA 08 30 95 E5 04 00 A0 E1 0C 30 84 E5 08 60 85 E5 ?? ?? ?? EB 01 30 A0 E3 BA 31 C5 E5 05 00 A0 E1 ?? ?? ?? EB 06 20 A0 E1 1B 00 00 EA 74 30 9F E5 00 30 93 E5 00 00 53 E3 07 00 00 AA ?? ?? ?? EB 00 00 50 E3 04 00 00 AA ?? ?? ?? EB 0B 30 A0 E3 00 20 E0 E3 }
	condition:
		$pattern
}
...
rule cos_1599077e396e0671e7a82dd9578c0a04 {
	meta:
...
rule __GI_strchr_751ee7706823363fd76afffeb48237e6 {
	meta:
...
rule initstate_r_127469cffa9cf94d1f8f630d32ba5c6f {
	meta:
...
rule wctob_af3dfcf50b4a136e32fd17666457bac4 {
	meta:
...
rule __fixunsdfsi_0b11c0b82088c8df9ab9bfcfd468f975 {
	meta:
...
rule tolower_c7c2da1e9dd8d42a29407c7a7cc35a23 {
	meta:
...
rule _dl_protect_relro_79abb0fd3b488f58f5d0f44d150618cc {
	meta:
		aliases = "_dl_protect_relro"
		size = "152"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { 84 30 9F E5 00 C0 A0 E1 D4 10 90 E5 00 00 90 E5 00 20 93 E5 D8 30 9C E5 00 10 81 E0 00 20 62 E2 03 30 81 E0 02 30 03 E0 01 00 02 E0 03 00 50 E1 04 E0 2D E5 04 F0 9D 04 03 10 60 E0 01 20 A0 E3 7D 00 90 EF 01 0A 70 E3 40 30 9F 85 00 20 60 82 00 20 83 85 01 00 00 8A 00 00 50 E3 04 F0 9D A4 04 20 9C E5 02 00 A0 E3 24 10 9F E5 ?? ?? ?? EB 00 00 A0 E3 01 00 90 EF 01 0A 70 E3 0C 30 9F 85 00 20 60 82 00 20 83 85 04 F0 9D E4 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_frexp_fa2278ee8e4df06e955ca082d608ea2e {
	meta:
...
rule __pthread_do_exit_ae95e625c54209d2edbeed2a21631b9e {
	meta:
...
rule pthread_start_thread_a29a8981da191ae105b9b7b71da29d29 {
	meta:
		aliases = "pthread_start_thread"
		size = "220"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { 98 D0 4D E2 00 40 A0 E1 ?? ?? ?? EB 64 10 84 E2 14 00 84 E5 00 20 A0 E3 02 00 A0 E3 ?? ?? ?? EB E4 10 94 E5 00 00 51 E3 14 00 94 A5 E8 20 84 A2 07 00 00 AA 90 30 9F E5 18 30 93 E5 00 00 53 E3 04 00 00 DA 00 10 A0 E3 98 20 8D E2 04 10 22 E5 14 00 94 E5 ?? ?? ?? EB 70 30 9F E5 00 30 93 E5 00 00 53 E3 13 00 00 0A 64 30 9F E5 00 30 93 E5 00 00 53 E3 0F 00 00 DA 05 30 A0 E3 04 30 8D E5 00 40 8D E5 4C 60 9F E5 00 00 96 E5 0D 10 A0 E1 94 20 A0 E3 ?? ?? ?? EB 01 00 70 E3 03 00 00 1A ?? ?? ?? EB 00 30 90 E5 04 00 53 E3 F5 FF FF 0A 04 00 A0 E1 ?? ?? ?? EB 60 00 94 E5 0F E0 A0 E1 5C F0 94 E5 0D 10 A0 E1 }
	condition:
		$pattern
}

rule _dl_linux_resolver_7966fb7ba5be5a37205e0ee27e9b93c0 {
	meta:
		aliases = "_dl_linux_resolver"
		size = "208"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { 9C 30 90 E5 F0 40 2D E9 81 61 83 E0 04 20 96 E5 58 10 90 E5 22 34 A0 E1 03 12 91 E7 FF 20 02 E2 54 30 90 E5 16 00 52 E3 00 40 A0 E1 01 50 83 E0 0A 00 00 0A 84 30 9F E5 02 00 A0 E3 00 20 93 E5 7C 10 9F E5 ?? ?? ?? EB 01 00 A0 E3 01 00 90 EF 01 0A 70 E3 6C 30 9F 85 00 20 60 82 00 20 83 85 04 20 A0 E1 1C 10 94 E5 05 00 A0 E1 01 30 A0 E3 00 70 96 E5 00 60 94 E5 ?? ?? ?? EB 00 40 50 E2 0B 00 00 1A 34 20 9F E5 05 30 A0 E1 00 20 92 E5 02 00 80 E2 30 10 9F E5 ?? ?? ?? EB 01 00 A0 E3 01 00 90 EF 01 0A 70 E3 18 30 9F 85 00 20 60 82 00 20 83 85 04 00 A0 E1 07 40 86 E7 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_sqrt_e511a389f9fe0cc6331c9b2cfbb8cbb8 {
	meta:
		aliases = "__GI_sinh, y0, xdr_u_longlong_t, lgamma_r, __GI_xdr_int, __GI_exp, acosh, atanh, __GI_acos, y1, suspend, hypot, jn, __GI_hypot, __GI_memcpy, __GI_asin, asin, vfork, remainder, __GI_log10, sinh, __GI_atanh, xdr_int, __GI_atan2, j0, memmove, __GI_nearbyint, xdr_longlong_t, cosh, exp, log, cabs, __deregister_frame_info, fmod, __ieee754_gamma_r, acos, restart, mq_close, nearbyint, rand, yn, __GI_xdr_u_int, __GI_log, __GI_fmod, __GI_setmntent, __GI_cabs, __GI_pow, drem, log10, log2"
		size = "4"
		objfiles = "join@libpthread.a, w_cabs@libm.a, pthread@libpthread.a, w_hypot@libm.a, rwlock@libpthread.a"
	strings:
		$pattern = { ?? ?? ?? EA }
	condition:
		$pattern
...
rule svctcp_rendezvous_abort_0623554f92079a9a4209055793432711 {
	meta:
...
rule __re_match_2_74aa8a96218beee221d17910ef6a2ae9 {
	meta:
...
rule vfork_704a65e4313fd53c8769931b1a84edbd {
	meta:
...
rule __pthread_initialize_e4834838dae4a690aeac993e2d3fbc76 {
	meta:
...
rule __GI_asinh_950a2d088a9587c4704d41d73af3c2ec {
	meta:
...
rule pzero_1fc427caff281b3e587bded0bcbb1732 {
	meta:
		aliases = "pone, pzero"
		size = "532"
		objfiles = "e_j0@libm.a, e_j1@libm.a"
	strings:
		$pattern = { DC 31 9F E5 02 21 C0 E3 03 00 52 E1 F0 41 2D E9 D0 61 9F C5 D0 81 9F C5 10 00 00 CA CC 31 9F E5 03 00 52 E1 C8 61 9F C5 C8 81 9F C5 0B 00 00 CA C4 31 9F E5 03 00 52 E1 C0 61 9F C5 C0 81 9F C5 06 00 00 CA BC 31 9F E5 01 01 52 E3 03 80 A0 A1 00 80 A0 B3 B0 31 9F E5 03 60 A0 A1 00 60 A0 B3 00 20 A0 E1 01 30 A0 E1 ?? ?? ?? EB 00 20 A0 E1 01 30 A0 E1 94 01 9F E5 00 10 A0 E3 ?? ?? ?? EB 28 20 86 E2 0C 00 92 E8 00 40 A0 E1 01 50 A0 E1 ?? ?? ?? EB 20 20 86 E2 0C 00 92 E8 ?? ?? ?? EB 00 20 A0 E1 01 30 A0 E1 04 00 A0 E1 05 10 A0 E1 ?? ?? ?? EB 18 20 86 E2 0C 00 92 E8 ?? ?? ?? EB 00 20 A0 E1 01 30 A0 E1 }
	condition:
		$pattern
}

rule do_dlclose_16b689e79379e89a5da472e3748a76a0 {
	meta:
		aliases = "do_dlclose"
		size = "768"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { E0 32 9F E5 00 30 93 E5 03 00 50 E1 F0 4F 2D E9 00 70 A0 E1 01 90 A0 E1 B0 00 00 0A C8 32 9F E5 00 30 93 E5 00 10 A0 E3 03 00 00 EA 07 00 53 E1 08 00 00 0A 03 10 A0 E1 04 30 93 E5 00 00 53 E3 F9 FF FF 1A A4 32 9F E5 09 20 A0 E3 01 00 A0 E3 00 20 83 E5 F0 8F BD E8 00 00 51 E3 04 20 97 E5 84 32 9F 05 04 20 81 15 00 20 83 05 00 10 97 E5 20 20 D1 E5 21 30 D1 E5 03 24 82 E1 01 00 52 E3 00 80 A0 03 5C B2 9F 05 08 A0 A0 01 7A 00 00 0A 01 20 42 E2 42 34 A0 E1 07 00 A0 E1 21 30 C1 E5 20 20 C1 E5 ?? ?? ?? EB 00 00 A0 E3 F0 8F BD E8 08 30 97 E5 08 61 93 E7 20 30 96 E5 01 30 43 E2 03 38 A0 E1 23 38 A0 E1 }
	condition:
		$pattern
}
...
rule pthread_once_1d895936d5cddc5572777ff2e55a7641 {
	meta:
...
rule __GI_fgetwc_unlocked_fab2ef58a648e230d1536677e5ca902f {
	meta:
...
rule __GI_pthread_getschedparam_bbc40c7e933aa70dc99435248814878c {
	meta:
...
rule __heap_free_e769d8a5ef39a9a8a6754d8688fab375 {
	meta:
		aliases = "__heap_free"
		size = "240"
		objfiles = "heap_free@libc.a"
	strings:
		$pattern = { F0 40 2D E9 00 40 90 E5 02 E0 81 E0 00 60 A0 E3 03 00 00 EA 01 00 53 E1 05 00 00 2A 04 60 A0 E1 04 40 94 E5 00 00 54 E3 0C 30 84 E2 F8 FF FF 1A 26 00 00 EA 00 C0 94 E5 03 30 6C E0 0E 00 53 E1 22 00 00 8A 0C 70 82 E0 0A 00 00 1A 00 00 56 E3 1B 00 00 0A 0C 30 86 E2 03 00 51 E1 18 00 00 1A 00 30 96 E5 08 20 96 E5 04 10 A0 E1 03 70 87 E0 DD FF FF EB 12 00 00 EA 04 50 94 E5 00 00 55 E3 0A 00 00 0A 00 C0 95 E5 0C 30 85 E2 03 30 6C E0 03 00 5E E1 05 00 00 1A 06 20 A0 E1 05 10 A0 E1 0C 70 87 E0 D0 FF FF EB 05 40 A0 E1 04 00 00 EA 02 40 84 E0 05 30 A0 E1 06 20 A0 E1 04 10 A0 E1 C1 FF FF EB 04 50 A0 E1 }
	condition:
		$pattern
}
...
rule get_input_bytes_073888cfacff37754656e81a6874bd23 {
	meta:
		aliases = "get_input_bytes"
		size = "120"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { F0 40 2D E9 00 50 A0 E1 01 70 A0 E1 02 60 A0 E1 13 00 00 EA 2C 20 85 E2 0C 00 92 E8 02 30 53 E0 02 10 A0 E1 03 00 00 1A CA FF FF EB 00 00 50 E3 0B 00 00 1A F0 80 BD E8 03 00 56 E1 06 40 A0 B1 03 40 A0 A1 07 00 A0 E1 04 20 A0 E1 ?? ?? ?? EB 2C 30 95 E5 04 30 83 E0 2C 30 85 E5 06 60 64 E0 04 70 87 E0 00 00 56 E3 05 00 A0 E1 E8 FF FF CA 01 00 A0 E3 F0 80 BD E8 }
	condition:
		$pattern
}
...
rule pthread_atfork_d4b75fabb942731f755b0da68a73c469 {
	meta:
		aliases = "pthread_atfork"
		size = "160"
		objfiles = "ptfork@libpthread.a"
	strings:
		$pattern = { F0 40 2D E9 00 50 A0 E1 18 00 A0 E3 01 60 A0 E1 02 70 A0 E1 ?? ?? ?? EB 00 40 50 E2 0C 00 80 02 F0 80 BD 08 5C 30 9F E5 5C 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 05 10 A0 E1 04 20 A0 E1 4C 00 9F E5 00 30 A0 E3 71 FF FF EB 06 10 A0 E1 08 20 84 E2 3C 00 9F E5 01 30 A0 E3 6C FF FF EB 07 10 A0 E1 10 20 84 E2 2C 00 9F E5 01 30 A0 E3 67 FF FF EB 24 30 9F E5 10 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 A0 E3 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_fgets_unlocked_fe9f9edcd867da158960b3b9d0ff3094 {
	meta:
...
rule __GI_fgetws_unlocked_2d307553a3ebd45996f0415abf64f020 {
	meta:
...
rule sleep_946887b8a66756732206c628f00e5cc4 {
	meta:
		aliases = "__GI_sleep, sleep"
		size = "416"
		objfiles = "sleep@libc.a"
	strings:
		$pattern = { F0 40 2D E9 00 C0 50 E2 65 DF 4D E2 0C 00 A0 01 20 20 A0 13 00 10 A0 13 01 00 00 1A 5C 00 00 EA 88 10 03 E5 01 20 52 E2 65 0F 8D E2 02 31 80 E0 FA FF FF 5A 43 6F 8D E2 00 50 A0 E3 06 00 A0 E1 11 10 A0 E3 8C C1 8D E5 90 51 8D E5 ?? ?? ?? EB 05 00 50 E1 4D 00 00 BA 8C 40 8D E2 05 00 A0 E1 06 10 A0 E1 04 20 A0 E1 ?? ?? ?? EB 05 00 50 E1 46 00 00 1A 04 00 A0 E1 11 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 20 30 A0 03 01 00 00 0A 31 00 00 EA 88 00 02 E5 01 30 53 E2 65 1F 8D E2 03 21 81 E0 FA FF FF 5A 43 0F 8D E2 11 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 35 00 00 BA 11 00 A0 E3 00 10 A0 E3 0D 20 A0 E1 ?? ?? ?? EB }
	condition:
		$pattern
}
...
rule cabsf_459666b6e5c366097adb268169965fad {
	meta:
		aliases = "cargf, cabsf"
		size = "64"
...
rule __GI_clnt_spcreateerror_2fbdd55efec76ece4ec15e29a5e4837a {
	meta:
...
rule fseeko64_bf70414258ba19f219e8bc9a26fccd37 {
	meta:
...
rule __GI_fmax_64cb3e26b4c0fa32c6e3d5a8012fc7be {
	meta:
...
rule __ieee754_scalb_61b20d72d464673a0d1b73f78a955dff {
	meta:
...
rule send_9f456afe647f211a108d8f577808cae8 {
	meta:
...
rule __GI_svc_unregister_e6bc97ea5006768f462e3dc79899210a {
	meta:
...
rule sigaction_7823dd2fc3bb2506d1ac76864e6b3700 {
	meta:
...
rule encrypt_c75837d44a116a61edd3c1a892e8c609 {
	meta:
		aliases = "encrypt"
		size = "252"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { F0 40 2D E9 0C D0 4D E2 00 60 A0 E1 01 50 A0 E1 B2 FC FF EB 00 00 A0 E3 F4 FD FF EB D4 70 9F E5 00 C0 A0 E3 06 10 A0 E1 0C 40 A0 E1 10 00 00 EA 0C 20 8D E2 0C 31 82 E0 03 E0 A0 E1 04 00 A0 E1 08 40 03 E5 07 00 00 EA 00 30 D1 E5 01 00 13 E3 00 31 97 17 08 20 1E 15 02 30 83 11 08 30 0E 15 01 10 81 E2 01 00 80 E2 1F 00 50 E3 F5 FF FF DA 01 C0 8C E2 01 00 5C E3 EC FF FF DA 00 00 55 E3 04 20 8D E2 01 C0 A0 03 00 C0 E0 13 03 00 9D E9 04 30 82 E2 00 C0 8D E5 B6 FE FF EB 54 50 9F E5 00 00 A0 E3 00 40 A0 E1 0A 00 00 EA 01 21 95 E7 08 30 1C E5 03 00 12 E1 0E 20 81 E1 01 10 81 E2 00 30 A0 03 01 30 A0 13 }
	condition:
		$pattern
}
...
rule __GI_opendir_32d77bd433df2ad1d93315b3bb14b250 {
	meta:
		aliases = "opendir, __GI_opendir"
		size = "256"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { F0 40 2D E9 12 1B A0 E3 58 D0 4D E2 ?? ?? ?? EB 00 70 50 E2 00 60 A0 B3 34 00 00 BA 0D 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 05 00 00 BA 07 00 A0 E1 02 10 A0 E3 01 20 A0 E3 ?? ?? ?? EB 00 00 50 E3 07 00 00 AA ?? ?? ?? EB 00 50 A0 E1 07 00 A0 E1 00 40 95 E5 ?? ?? ?? EB 00 60 A0 E3 00 40 85 E5 22 00 00 EA 30 00 A0 E3 ?? ?? ?? EB 00 00 50 E3 12 00 00 0A 00 40 A0 E3 10 40 80 E5 30 30 9D E5 02 0C 53 E3 14 30 80 E5 02 3C A0 33 14 30 80 35 00 60 A0 E1 00 70 80 E5 08 40 80 E5 04 40 80 E5 14 10 96 E5 01 00 A0 E3 ?? ?? ?? EB 00 00 50 E3 0C 00 86 E5 08 00 00 1A 06 00 A0 E1 ?? ?? ?? EB 07 00 A0 E1 ?? ?? ?? EB }
	condition:
		$pattern
}
...
rule _dl_map_cache_0388161d07f468bcb14a98b54c402af5 {
	meta:
		aliases = "_dl_map_cache"
		size = "604"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { F0 40 2D E9 2C E2 9F E5 00 00 9E E5 01 00 70 E3 44 D0 4D E2 85 00 00 0A 00 00 50 E3 82 00 00 1A 14 62 9F E5 04 10 8D E2 06 00 A0 E1 6A 00 90 EF 01 0A 70 E3 00 50 A0 E1 00 20 60 82 09 00 00 8A 00 00 50 E3 0C 00 00 1A 00 20 A0 E1 00 10 A0 E1 06 00 A0 E1 05 00 90 EF 01 0A 70 E3 00 C0 A0 E1 03 00 00 9A 00 20 60 E2 D0 31 9F E5 00 20 83 E5 01 00 00 EA 00 00 50 E3 04 00 00 AA 00 20 E0 E3 B0 31 9F E5 02 00 A0 E1 00 20 83 E5 67 00 00 EA 18 10 9D E5 A8 71 9F E5 01 30 A0 E3 00 40 A0 E1 00 10 87 E5 03 20 A0 E1 05 00 A0 E1 C0 00 90 EF 01 0A 70 E3 84 31 9F 85 00 20 60 82 00 00 E0 83 00 00 8E E5 00 20 83 85 }
	condition:
		$pattern
}

rule fputws_4d4fcca9f185327cd7eba12530eff5d8 {
	meta:
		aliases = "fputs, __GI_fputws, putwc, fputwc, __GI_fputs, fputws"
		size = "140"
...
rule __pthread_reset_main_thread_100dcdad3869a8ae5adc964578977396 {
	meta:
		aliases = "__pthread_reset_main_thread"
		size = "160"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { F0 40 2D E9 43 FF FF EB 74 70 9F E5 00 30 97 E5 01 00 73 E3 00 60 A0 E1 0E 00 00 0A 64 40 9F E5 00 00 94 E5 ?? ?? ?? EB 5C 30 9F E5 00 20 A0 E3 58 50 9F E5 00 20 83 E5 00 00 97 E5 00 20 84 E5 ?? ?? ?? EB 00 00 95 E5 ?? ?? ?? EB 00 30 E0 E3 00 30 87 E5 00 30 85 E5 ?? ?? ?? EB 30 30 9F E5 4C 30 86 E5 2C 30 9F E5 00 60 83 E5 28 30 9F E5 14 00 86 E5 44 30 86 E5 00 60 86 E5 04 60 86 E5 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __fork_56aad627aac57013dcb90a09637332c2 {
	meta:
		aliases = "fork, __fork"
		size = "404"
		objfiles = "ptfork@libpthread.a"
	strings:
		$pattern = { F0 40 2D E9 58 01 9F E5 58 41 9F E5 04 D0 4D E2 0F E0 A0 E1 04 F0 A0 E1 4C 31 9F E5 00 00 93 E5 48 31 9F E5 00 70 93 E5 44 31 9F E5 00 60 93 E5 E9 FF FF EB ?? ?? ?? EB 38 01 9F E5 0F E0 A0 E1 04 F0 A0 E1 30 01 9F E5 0F E0 A0 E1 04 F0 A0 E1 ?? ?? ?? EB 00 50 50 E2 31 00 00 1A 1C 61 9F E5 00 00 56 E3 11 00 00 0A 14 31 9F E5 0D 00 A0 E1 0D 40 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 31 9F E5 05 10 A0 E1 0D 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 E4 00 9F E5 0D 10 A0 E1 0F E0 A0 E1 06 F0 A0 E1 E4 30 9F E5 0D 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 C0 00 9F E5 05 10 A0 E1 0F E0 A0 E1 06 F0 A0 E1 00 00 56 E3 11 00 00 0A }
	condition:
		$pattern
}
...
rule __xpg_strerror_r_dec5e9c33145504e227fc8f6f8fc0710 {
	meta:
...
rule __GI_strncasecmp_d1a051945027a14319f4f3b11a5d8717 {
	meta:
...
rule __pthread_timedsuspend_new_c6a1d821ec6e7e66424a387df87dc660 {
	meta:
		aliases = "__pthread_timedsuspend_new"
		size = "268"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { F0 40 2D E9 7D DF 4D E2 04 00 8D E5 00 10 8D E5 08 00 8D E2 01 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 01 00 A0 13 31 00 00 1A 04 20 9D E5 59 4F 8D E2 08 30 8D E2 24 30 82 E5 20 00 82 E5 04 00 A0 E1 ?? ?? ?? EB B8 30 9F E5 04 00 A0 E1 00 10 93 E5 ?? ?? ?? EB 04 10 A0 E1 01 00 A0 E3 E4 20 8D E2 ?? ?? ?? EB 9C 70 9F E5 7B 6F 8D E2 FA 5F A0 E3 79 4F 8D E2 00 10 A0 E3 06 00 A0 E1 ?? ?? ?? EB F0 31 9D E5 93 05 02 E0 00 C0 9D E5 04 30 9C E5 00 C0 9C E5 03 20 62 E0 EC 31 9D E5 00 10 A0 E3 01 00 52 E1 0C 30 63 E0 E4 31 8D E5 01 30 43 B2 E4 31 8D B5 E4 31 9D E5 E8 21 8D E5 07 20 82 B0 E8 21 8D B5 00 00 53 E3 }
	condition:
		$pattern
}
...
rule regexec_f04a988119f9554514cd4b50992b9460 {
	meta:
...
rule _stdio_fopen_2d8a78e5101040ad6a5bb67dbf1d9beb {
	meta:
		aliases = "_stdio_fopen"
		size = "732"
		objfiles = "_fopen@libc.a"
	strings:
		$pattern = { F0 41 2D E9 00 C0 D1 E5 72 00 5C E3 20 D0 4D E2 00 60 A0 E1 02 80 A0 E1 03 50 A0 E1 10 00 00 0A 77 00 5C E3 80 42 9F 05 0E 00 00 0A 61 00 5C E3 78 42 9F 05 0B 00 00 0A ?? ?? ?? EB 16 30 A0 E3 00 00 58 E3 00 30 80 E5 93 00 00 0A 01 30 D8 E5 20 00 13 E3 90 00 00 0A 08 00 A0 E1 ?? ?? ?? EB 8D 00 00 EA 00 40 A0 E3 01 30 D1 E5 62 00 53 E3 01 30 A0 11 01 30 81 02 01 30 D3 E5 2B 00 53 E3 01 30 84 03 01 40 83 02 00 00 58 E3 0A 00 00 1A 50 00 A0 E3 ?? ?? ?? EB 00 80 50 E2 7F 00 00 0A 00 20 A0 E3 20 30 A0 E3 01 30 C8 E5 08 20 88 E5 00 20 C8 E5 38 00 88 E2 ?? ?? ?? EB 00 00 55 E3 13 00 00 BA E8 21 9F E5 }
	condition:
		$pattern
}
...
rule rwlock_have_already_7f42322f4dbc815b5267dea6e48c382a {
	meta:
		aliases = "rwlock_have_already"
		size = "224"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { F0 41 2D E9 01 50 A0 E1 18 10 91 E5 01 00 51 E3 03 70 A0 E1 00 30 A0 13 00 60 A0 E1 02 80 A0 E1 00 40 90 E5 03 20 A0 11 03 00 A0 11 26 00 00 1A 00 00 54 E3 01 00 00 1A A3 FF FF EB 00 40 A0 E1 C0 01 94 E5 03 00 00 EA 04 30 90 E5 05 00 53 E1 03 00 00 0A 00 00 90 E5 00 00 50 E3 F9 FF FF 1A 01 00 00 EA 00 00 50 E3 15 00 00 1A C8 31 94 E5 00 00 53 E3 12 00 00 CA C4 01 94 E5 00 00 50 E3 00 30 90 15 C4 31 84 15 0C 00 A0 03 ?? ?? ?? 0B 00 00 50 E3 05 00 00 0A C0 31 94 E5 00 30 80 E5 01 30 A0 E3 08 30 80 E5 04 50 80 E5 C0 01 84 E5 00 30 A0 01 00 30 A0 13 00 20 A0 13 01 20 A0 03 01 00 00 EA 00 20 A0 E3 }
	condition:
		$pattern
}
...
rule __decode_question_25a6822595ffae319e74ec6a064ed81e {
	meta:
		aliases = "__decode_question"
		size = "112"
		objfiles = "decodeq@libc.a"
	strings:
		$pattern = { F0 41 2D E9 01 DC 4D E2 02 50 A0 E1 01 3C A0 E3 0D 20 A0 E1 00 60 A0 E1 01 70 A0 E1 ?? ?? ?? EB 00 40 50 E2 0D 80 A0 E1 0D 00 00 BA 0D 00 A0 E1 ?? ?? ?? EB 07 30 84 E0 00 00 85 E5 06 20 83 E0 03 10 D6 E7 01 30 D2 E5 01 34 83 E1 04 30 85 E5 03 30 D2 E5 02 20 D2 E5 02 34 83 E1 08 30 85 E5 04 40 84 E2 04 00 A0 E1 01 DC 8D E2 F0 81 BD E8 }
	condition:
		$pattern
}

rule vasprintf_1b5110e58fe9c08b9f1b747ce35facbb {
	meta:
...
rule xdr_rmtcall_args_47ad1d165afaa0d7d32fbf91ddb6ec0d {
	meta:
...
rule __GI_getpwent_r_99821bf27485a6a4b744561d515384a2 {
	meta:
		aliases = "getpwent_r, __GI_getgrent_r, getgrent_r, getspent_r, __GI_getspent_r, __GI_getpwent_r"
		size = "240"
		objfiles = "getpwent_r@libc.a, getspent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule fgetws_1c22a52eabcbd370417e7f9e11ed3242 {
	meta:
...
rule __error_at_line_24ebdbb40ff72b535feeb82c3544dbb1 {
	meta:
...
rule __getutid_1052c7c8587b85172805cd8b82c6e008 {
	meta:
		aliases = "__getutid"
		size = "164"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { F0 41 2D E9 94 80 9F E5 00 60 A0 E1 28 70 80 E2 19 00 00 EA 01 30 D6 E5 00 C0 D6 E5 03 C4 8C E1 01 30 4C E2 03 38 A0 E1 0C E8 A0 E1 03 08 53 E3 4E E8 A0 E1 0C 58 A0 E1 05 00 00 8A 01 30 D4 E5 00 C0 D4 E5 03 3C A0 E1 43 C8 8C E1 45 08 5C E1 10 00 00 0A 08 00 5E E3 05 00 5E 13 03 00 00 0A 06 00 5E E3 01 00 00 0A 07 00 5E E3 02 00 00 1A ?? ?? ?? EB 00 00 50 E3 06 00 00 0A 00 00 98 E5 D0 FF FF EB 00 40 50 E2 07 10 A0 E1 04 20 A0 E3 28 00 84 E2 DE FF FF 1A 04 00 A0 E1 F0 81 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule pthread_join_20070f7d1b9ce2ac5337e9d468a21e9a {
	meta:
		aliases = "pthread_join"
		size = "484"
		objfiles = "join@libpthread.a"
	strings:
		$pattern = { F0 41 2D E9 A0 D0 4D E2 00 70 A0 E1 01 80 A0 E1 7E FF FF EB BC 21 9F E5 07 3B A0 E1 23 3B A0 E1 03 52 82 E0 9C 00 8D E5 AC 31 9F E5 9C 10 9D E5 05 00 A0 E1 98 30 8D E5 94 50 8D E5 ?? ?? ?? EB 08 40 95 E5 00 00 54 E3 02 00 00 0A 10 30 94 E5 07 00 53 E1 03 00 00 0A 05 00 A0 E1 ?? ?? ?? EB 03 00 A0 E3 59 00 00 EA 9C 30 9D E5 03 00 54 E1 03 00 00 1A 05 00 A0 E1 ?? ?? ?? EB 23 00 A0 E3 52 00 00 EA 2D 30 D4 E5 00 00 53 E3 02 00 00 1A 38 30 94 E5 00 00 53 E3 03 00 00 0A 05 00 A0 E1 ?? ?? ?? EB 16 00 A0 E3 48 00 00 EA 2C 30 D4 E5 00 00 53 E3 2B 00 00 1A 9C 00 9D E5 94 10 8D E2 41 FF FF EB 9C 30 9D E5 }
	condition:
		$pattern
}
...
rule __GI_svc_getreqset_a00d7b48bcb4925aff59cf55eab0eead {
	meta:
...
rule readunix_2c52f28a247a95c363e6c5a8a5f2902e {
	meta:
		aliases = "readunix"
		size = "424"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { F0 45 2D E9 00 50 A0 E1 34 D0 4D E2 01 A0 A0 E1 0C 00 90 E5 FA 1F A0 E3 02 60 A0 E1 ?? ?? ?? EB 08 20 95 E5 00 00 56 E3 FA 3F A0 E3 92 03 27 E0 06 40 A0 01 57 00 00 0A 00 30 95 E5 28 30 8D E5 01 30 A0 E3 2C 30 CD E5 00 30 A0 E3 2D 30 CD E5 28 80 8D E2 01 10 A0 E3 07 20 A0 E1 08 00 A0 E1 ?? ?? ?? EB 01 00 70 E3 00 40 A0 E1 05 00 00 0A 00 00 50 E3 05 30 A0 03 00 40 E0 03 84 30 85 05 44 00 00 0A 07 00 00 EA ?? ?? ?? EB 00 30 90 E5 04 00 53 E3 EE FF FF 0A 04 30 A0 E3 84 30 85 E5 00 30 90 E5 34 00 00 EA 01 40 A0 E3 34 30 8D E2 04 40 23 E5 20 C0 8D E2 00 70 95 E5 0C C0 8D E5 DC C0 9F E5 14 C0 8D E5 }
	condition:
		$pattern
}
...
rule __res_query_94398c0c526beef5383abf315e024e1e {
	meta:
		aliases = "__GI___res_query, __res_query"
		size = "324"
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { F0 45 2D E9 01 10 51 E2 01 10 A0 13 00 70 A0 E1 00 00 50 E3 01 00 A0 11 01 00 81 03 44 D0 4D E2 00 10 A0 E3 00 00 50 E3 40 10 8D E5 02 80 A0 E1 03 A0 A0 E1 03 00 00 0A ?? ?? ?? EB 00 40 E0 E3 03 30 A0 E3 24 00 00 EA 08 60 8D E2 00 10 A0 E1 28 20 A0 E3 30 50 8D E2 06 00 A0 E1 ?? ?? ?? EB ?? ?? ?? EB BC 20 9F E5 BC 10 9F E5 05 00 A0 E1 B8 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 B0 30 9F E5 A0 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 A4 30 9F E5 00 40 93 E5 05 00 A0 E1 01 10 A0 E3 98 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 04 20 A0 E1 40 C0 8D E2 07 00 A0 E1 08 10 A0 E1 80 30 9F E5 00 C0 8D E5 04 60 8D E5 ?? ?? ?? EB }
	condition:
		$pattern
}

rule __GI_svc_register_33d9e72e67fda01996018d82114b18c1 {
	meta:
...
rule sem_timedwait_105e932001dac8aa37c5c467bebcdf23 {
	meta:
...
rule __form_query_d8215a4baaac5051ca12af99ff34ceaa {
	meta:
		aliases = "__form_query"
		size = "132"
		objfiles = "formquery@libc.a"
	strings:
		$pattern = { F0 45 2D E9 3C D0 4D E2 58 A0 9D E5 03 80 A0 E1 00 50 A0 E1 01 60 A0 E1 02 70 A0 E1 00 10 A0 E3 30 20 A0 E3 0D 00 A0 E1 ?? ?? ?? EB 01 30 A0 E3 0D 00 A0 E1 08 10 A0 E1 0A 20 A0 E1 00 50 8D E5 30 60 8D E5 34 70 8D E5 38 30 8D E5 20 30 8D E5 ?? ?? ?? EB 00 40 50 E2 06 00 00 BA 04 10 88 E0 0A 20 64 E0 30 00 8D E2 ?? ?? ?? EB 00 00 50 E3 00 40 A0 B1 00 40 84 A0 04 00 A0 E1 3C D0 8D E2 F0 85 BD E8 }
	condition:
		$pattern
}
...
rule round_5e41ddf7ef8450c1bafa8b5ee39d29f7 {
	meta:
...
rule pthread_initialize_51c86d667a4aff4660160b65b75182e6 {
	meta:
		aliases = "pthread_initialize"
		size = "456"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { F0 45 2D E9 88 21 9F E5 00 40 92 E5 00 00 54 E3 45 DF 4D E2 5C 00 00 1A 01 35 4D E2 A3 3A A0 E1 83 3A A0 E1 00 30 82 E5 ?? ?? ?? EB 64 31 9F E5 64 21 9F E5 00 50 93 E5 60 31 9F E5 4C 30 82 E5 5C 31 9F E5 44 30 82 E5 58 31 9F E5 04 10 A0 E1 14 00 82 E5 00 40 83 E5 03 00 00 EA 34 30 95 E5 01 00 53 E3 34 10 85 15 20 50 95 E5 00 00 55 E3 F9 FF FF 1A 43 4F 8D E2 04 10 A0 E1 03 00 A0 E3 ?? ?? ?? EB ?? ?? ?? EB 80 00 A0 E1 0C 31 9D E5 02 26 60 E2 02 00 53 E1 04 10 A0 81 03 00 A0 83 0C 21 8D 85 ?? ?? ?? 8B FC 30 9F E5 04 40 8D E2 04 00 A0 E1 00 30 8D E5 0D 60 A0 E1 ?? ?? ?? EB E8 70 9F E5 05 20 A0 E1 }
	condition:
		$pattern
}

rule pselect_65f6b6a8e656eff7847be55a5e7dd77c {
	meta:
		aliases = "__libc_pselect, pselect"
		size = "156"
		objfiles = "pselect@libc.a"
	strings:
		$pattern = { F0 45 2D E9 8C D0 4D E2 A8 40 9D E5 00 00 54 E3 00 60 A0 E1 01 70 A0 E1 02 80 A0 E1 03 A0 A0 E1 AC 50 9D E5 05 00 00 0A 00 30 94 E5 04 00 94 E5 FA 1F A0 E3 84 30 8D E5 ?? ?? ?? EB 88 00 8D E5 00 00 55 E3 02 00 A0 13 05 10 A0 11 04 20 8D 12 ?? ?? ?? 1B 00 00 54 E3 04 C0 A0 01 84 C0 8D 12 06 00 A0 E1 07 10 A0 E1 08 20 A0 E1 0A 30 A0 E1 00 C0 8D E5 ?? ?? ?? EB 00 00 55 E3 00 40 A0 E1 02 00 A0 13 04 10 8D 12 00 20 A0 13 ?? ?? ?? 1B 04 00 A0 E1 8C D0 8D E2 F0 85 BD E8 }
	condition:
		$pattern
}
...
rule pthread_create_9b6e7e4de69c8c35ad4c9e290d69ad4b {
	meta:
		aliases = "pthread_create"
		size = "192"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { F0 45 2D E9 B0 C0 9F E5 00 C0 9C E5 00 00 5C E3 94 D0 4D E2 00 A0 A0 E1 01 60 A0 E1 02 70 A0 E1 03 80 A0 E1 03 00 00 AA ?? ?? ?? EB 00 00 50 E3 0B 00 A0 B3 1E 00 00 BA E9 FD FF EB 00 30 A0 E3 00 50 A0 E1 03 10 A0 E1 02 00 A0 E3 14 20 8D E2 08 60 8D E5 0D 40 A0 E1 0C 70 8D E5 10 80 8D E5 00 50 8D E5 04 30 8D E5 ?? ?? ?? EB 48 60 9F E5 0D 10 A0 E1 94 20 A0 E3 00 00 96 E5 ?? ?? ?? EB 01 00 70 E3 03 00 00 1A ?? ?? ?? EB 00 30 90 E5 04 00 53 E3 F5 FF FF 0A 05 00 A0 E1 5C FE FF EB 34 30 95 E5 00 00 53 E3 30 30 95 05 34 00 95 E5 00 30 8A 05 94 D0 8D E2 F0 85 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_getdelim_b4837ce40ce8275638f345095532fc08 {
	meta:
...
rule clnttcp_create_d3e367022e6de1d1fa048729df934130 {
	meta:
...
rule __decode_answer_e891c4495c87c5cd4e9c153e0458d556 {
	meta:
		aliases = "__decode_answer"
		size = "216"
		objfiles = "decodea@libc.a"
	strings:
		$pattern = { F0 47 2D E9 01 DC 4D E2 02 70 A0 E1 03 50 A0 E1 0D 20 A0 E1 01 3C A0 E3 00 80 A0 E1 01 60 A0 E1 ?? ?? ?? EB 00 40 50 E2 0D 90 A0 E1 26 00 00 BA 07 30 66 E0 0A 70 84 E2 07 A0 53 E0 0A 40 A0 41 21 00 00 4A 0D 00 A0 E1 ?? ?? ?? EB 06 40 84 E0 00 00 85 E5 04 00 88 E0 04 20 D8 E7 01 30 D0 E5 02 34 83 E1 04 30 85 E5 02 C0 80 E2 02 20 D0 E5 01 30 DC E5 02 34 83 E1 08 30 85 E5 02 20 8C E2 03 30 D2 E5 02 10 DC E5 01 E0 D2 E5 01 3C 83 E1 02 20 D2 E5 0E 38 83 E1 02 34 83 E1 0C 30 85 E5 09 30 D0 E5 06 20 DC E5 0A 00 80 E2 02 34 83 E1 0A 40 84 E2 03 00 5A E1 14 00 85 E5 10 30 85 E5 18 40 85 E5 00 40 E0 B3 }
	condition:
		$pattern
}

rule getpwuid_r_d059c4ebfab1936be1f69c7e7258a6bc {
	meta:
...
rule getspnam_r_f0f9c54b72d68aa234b440f56dbd90cc {
	meta:
		aliases = "__GI_getgrnam_r, __GI_getspnam_r, getpwnam_r, getgrnam_r, __GI_getpwnam_r, getspnam_r"
		size = "176"
...
rule __GI_statvfs_c7d4199ebe188ea37beeacba8b6667db {
	meta:
...
rule _dl_add_elf_hash_table_462b3a7239c34e5aa69068c8cd2e562f {
	meta:
		aliases = "_dl_add_elf_hash_table"
		size = "284"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { F0 47 2D E9 0C 61 9F E5 00 50 96 E5 00 00 55 E3 00 80 A0 E1 01 70 A0 E1 02 A0 A0 E1 03 90 A0 E1 0C 00 00 1A E8 00 A0 E3 ?? ?? ?? EB 05 10 A0 E1 00 40 A0 E1 00 20 A0 E1 E8 30 A0 E3 00 00 86 E5 00 00 00 EA 01 10 C2 E4 01 30 53 E2 FC FF FF 2A 10 00 00 EA 04 50 A0 E1 0C 40 95 E5 00 00 54 E3 FB FF FF 1A E8 00 A0 E3 ?? ?? ?? EB 04 10 A0 E1 00 20 A0 E1 E8 30 A0 E3 0C 00 85 E5 00 00 00 EA 01 10 C2 E4 01 30 53 E2 FC FF FF 2A 0C 30 95 E5 10 50 83 E5 03 40 A0 E1 00 50 A0 E3 0C 50 84 E5 22 50 C4 E5 23 50 C4 E5 08 00 A0 E1 ?? ?? ?? EB 10 10 9A E5 03 30 A0 E3 05 00 51 E1 01 02 84 E9 18 30 84 E5 08 00 00 0A }
	condition:
		$pattern
}

rule __GI_pthread_cond_timedwait_7a8db939967c6ba58c56554f4f5ec488 {
	meta:
		aliases = "pthread_cond_timedwait, __GI_pthread_cond_timedwait"
		size = "520"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { F0 47 2D E9 0C D0 4D E2 01 60 A0 E1 00 50 A0 E1 02 90 A0 E1 C7 FF FF EB 0C 30 96 E5 03 00 53 E3 00 00 53 13 08 00 8D E5 04 00 00 0A 08 20 9D E5 08 30 96 E5 02 00 53 E1 16 00 A0 13 6C 00 00 1A B4 31 9F E5 08 20 9D E5 04 30 8D E5 00 30 A0 E3 00 50 8D E5 B9 31 C2 E5 08 00 9D E5 0D 10 A0 E1 8C FF FF EB 05 00 A0 E1 08 10 9D E5 ?? ?? ?? EB 08 30 9D E5 42 30 D3 E5 00 00 53 E3 04 00 00 0A 08 30 9D E5 40 30 D3 E5 00 00 53 E3 01 40 A0 03 03 00 00 0A 08 10 9D E5 08 00 85 E2 48 FF FF EB 00 40 A0 E3 05 00 A0 E1 ?? ?? ?? EB 00 00 54 E3 03 00 00 0A 08 00 9D E5 00 10 A0 E3 75 FF FF EB 3F 00 00 EA 06 00 A0 E1 }
	condition:
		$pattern
}
...
rule __GI_getservbyport_r_0efbbf6e0cd2ca66e29c71df8f5d69f0 {
	meta:
...
rule __GI_pmap_getport_92797642e0c9cab354081e0186a2774d {
	meta:
...
rule __GI_fclose_fb010ccb69c513b0d7d639ebfa9910b3 {
	meta:
...
rule __ieee754_yn_96a1422d2f8b5376d59479b5893efed4 {
	meta:
		aliases = "__ieee754_yn"
		size = "776"
		objfiles = "e_jn@libm.a"
	strings:
		$pattern = { F0 4F 2D E9 00 30 62 E2 01 70 A0 E1 02 30 83 E1 02 80 A0 E1 02 40 A0 E1 02 10 A0 E1 02 C1 C7 E3 CC 22 9F E5 A3 3F 8C E1 02 00 53 E1 08 D0 4D E2 07 E0 A0 E1 00 A0 A0 E1 05 00 00 9A 07 00 A0 E1 08 10 A0 E1 07 20 A0 E1 08 30 A0 E1 ?? ?? ?? EB 06 00 00 EA 01 10 9C E1 07 00 00 1A 94 02 9F E5 00 10 A0 E3 00 20 A0 E3 00 30 A0 E3 ?? ?? ?? EB 00 50 A0 E1 01 60 A0 E1 99 00 00 EA 00 00 57 E3 00 00 A0 B3 00 10 A0 B3 00 20 A0 B1 01 30 A0 B1 F5 FF FF BA 00 00 50 E3 00 A0 60 B2 01 30 0A B2 83 30 A0 B1 01 90 63 B2 06 00 00 BA 01 90 A0 13 04 00 00 1A 07 00 A0 E1 08 10 A0 E1 08 D0 8D E2 F0 4F BD E8 ?? ?? ?? EA }
	condition:
		$pattern
}
...
rule _time_tzset_aa4496e1bcafab0686c2dbd19592147a {
	meta:
		aliases = "_time_tzset"
		size = "1264"
		objfiles = "tzset@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 00 30 A0 E3 88 D0 4D E2 84 14 9F E5 84 24 9F E5 84 30 8D E5 00 90 A0 E1 7C 34 9F E5 74 00 8D E2 0F E0 A0 E1 03 F0 A0 E1 70 34 9F E5 64 04 9F E5 0F E0 A0 E1 03 F0 A0 E1 64 04 9F E5 ?? ?? ?? EB 00 40 50 E2 1D 00 00 1A 58 04 9F E5 04 10 A0 E1 ?? ?? ?? EB 00 60 50 E2 16 00 00 BA 44 40 A0 E3 0D 50 A0 E1 05 10 A0 E1 04 20 A0 E1 06 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 0B 00 00 BA 02 00 00 0A 00 40 54 E0 00 50 85 E0 F5 FF FF 1A 0D 00 55 E1 05 00 00 9A 01 30 55 E5 0A 00 53 E3 00 30 A0 03 0D 40 A0 01 01 30 45 05 00 00 00 0A 00 40 A0 E3 06 00 A0 E1 ?? ?? ?? EB 00 00 54 E3 02 00 00 0A 00 30 D4 E5 }
	condition:
		$pattern
}
...
rule des_setkey_4e14a87d0964d4c1701d2f6e90560d90 {
	meta:
		aliases = "des_setkey"
		size = "800"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { F0 4F 2D E9 00 40 A0 E1 14 D0 4D E2 9D FE FF EB 00 50 94 E8 FF 08 0E E2 FF 18 0C E2 2C 3C A0 E1 2E 2C A0 E1 21 34 83 E1 20 24 82 E1 FF 1C 0C E2 FF 0C 0E E2 00 24 82 E1 01 34 83 E1 0C 9C 83 E1 0E BC 82 E1 09 00 9B E1 07 00 00 0A A0 32 9F E5 00 30 93 E5 03 00 59 E1 03 00 00 1A 94 32 9F E5 00 30 93 E5 03 00 5B E1 9F 00 00 0A 88 52 9F E5 88 42 9F E5 A9 37 A0 E1 A9 23 A0 E1 7F 3F 03 E2 7F 2F 02 E2 04 C0 83 E0 04 E0 82 E0 05 20 82 E0 00 84 92 E5 00 22 9C E5 A9 CC A0 E1 0C 61 94 E7 89 00 A0 E1 05 30 83 E0 7F 0F 00 E2 00 12 93 E5 04 60 8D E5 04 60 80 E0 AB 3C A0 E1 0C C1 95 E7 00 66 96 E5 00 74 9E E5 }
	condition:
		$pattern
}

rule realpath_b2e638c73cf5bad9b16a86ff28127caf {
	meta:
		aliases = "realpath"
		size = "676"
		objfiles = "realpath@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 00 50 50 E2 01 DA 4D E2 0C D0 4D E2 01 70 A0 E1 03 00 00 1A ?? ?? ?? EB 05 70 A0 E1 16 30 A0 E3 5C 00 00 EA 00 40 D5 E5 00 00 54 E3 03 00 00 1A ?? ?? ?? EB 04 70 A0 E1 02 30 A0 E3 55 00 00 EA ?? ?? ?? EB 4C 32 9F E5 03 00 50 E1 00 20 A0 E1 3F 00 00 8A 01 0A 8D E2 0B 00 80 E2 00 00 62 E0 05 10 A0 E1 00 60 A0 E1 ?? ?? ?? EB 00 30 D6 E5 2F 00 53 E3 FF BE 87 E2 07 50 A0 01 0E B0 8B E2 01 30 C5 04 01 60 86 02 0C 00 00 0A 07 00 A0 E1 04 12 9F E5 ?? ?? ?? EB 00 00 50 E3 78 00 00 0A 07 00 A0 E1 ?? ?? ?? EB 00 50 87 E0 01 30 55 E5 2F 00 53 E3 2F 30 A0 13 00 30 C7 17 01 50 85 12 00 20 A0 E3 }
	condition:
		$pattern
}

rule bindresvport_c9c424b7338be5e65e5c0295cd9f9e0a {
	meta:
...
rule __decode_dotted_4531d8a513442e9cf81f7649c5e897d1 {
	meta:
		aliases = "__decode_dotted"
		size = "204"
		objfiles = "decoded@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 00 A0 50 E2 04 D0 4D E2 00 80 A0 13 02 90 A0 E1 00 30 8D E5 01 B0 A0 13 08 00 A0 11 1F 00 00 1A 25 00 00 EA 00 00 5B E3 C0 30 04 E2 01 80 88 12 C0 00 53 E3 01 50 81 E2 07 00 00 1A 05 20 DA E7 00 00 5B E3 3F 30 04 E2 01 80 88 12 03 14 82 E1 00 70 A0 E1 00 B0 A0 E3 0F 00 00 EA 00 60 84 E0 00 30 9D E5 01 70 86 E2 03 00 57 E1 12 00 00 2A 05 10 8A E0 00 00 89 E0 04 20 A0 E1 ?? ?? ?? EB 05 10 84 E0 01 30 DA E7 00 00 5B E3 04 80 88 10 00 00 53 E3 2E 30 A0 13 06 30 C9 E7 07 00 A0 E1 01 40 DA E7 00 00 54 E3 DD FF FF 1A 00 00 5B E3 01 80 88 12 08 00 A0 E1 00 00 00 EA 00 00 E0 E3 04 D0 8D E2 }
	condition:
		$pattern
}
...
rule __ieee754_atan2_9ab475f1b7ede2c192fcf2b05a3bb6e1 {
	meta:
...
rule svcudp_bufcreate_f824f82e443cd50addbd34708778e993 {
	meta:
...
rule __ieee754_log_4996a36e159142cf3e9064acdcf5f7c6 {
	meta:
...
rule rexec_af_184d382bd75e5e6d2d6dd1183898be5b {
	meta:
		aliases = "__GI_rexec_af, rexec_af"
		size = "1060"
		objfiles = "rexec@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 01 18 A0 E1 63 DF 4D E2 21 C4 A0 E1 FF CC 0C E2 4F 6F 8D E2 00 A0 A0 E1 18 20 8D E5 14 30 8D E5 B8 41 9D E5 0C 20 8D E5 10 30 8D E5 CC 23 9F E5 21 3C 8C E1 06 00 A0 E1 20 10 A0 E3 57 5F 8D E2 B4 B1 9D E5 ?? ?? ?? EB 00 30 A0 E3 03 10 A0 E1 20 20 A0 E3 05 00 A0 E1 04 48 A0 E1 5B 31 CD E5 24 48 A0 E1 ?? ?? ?? EB 02 70 A0 E3 00 00 9A E5 06 10 A0 E1 05 20 A0 E1 01 60 A0 E3 61 3F 8D E2 60 41 8D E5 64 61 8D E5 5C 71 8D E5 ?? ?? ?? EB 00 50 50 E2 D5 00 00 1A 84 31 9D E5 18 10 93 E5 00 00 51 E3 0C 00 00 0A 54 43 9F E5 54 23 9F E5 04 00 A0 E1 ?? ?? ?? EB 00 54 C4 E5 00 40 8A E5 84 31 9D E5 }
	condition:
		$pattern
}
...
rule __md5_crypt_257572c146b31b684584b886dbc5a857 {
	meta:
		aliases = "__md5_crypt"
		size = "720"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { F0 4F 2D E9 01 40 A0 E1 03 20 A0 E3 C4 D0 4D E2 00 A0 A0 E1 A4 12 9F E5 04 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 04 80 A0 11 03 80 84 02 08 50 A0 E1 08 20 88 E2 00 00 00 EA 01 50 85 E2 00 30 D5 E5 00 00 53 E3 24 00 53 13 01 00 00 0A 02 00 55 E1 F8 FF FF 3A 58 40 8D E2 04 00 A0 E1 16 FF FF EB 0A 00 A0 E1 ?? ?? ?? EB 00 70 A0 E1 0A 10 A0 E1 04 00 A0 E1 07 20 A0 E1 8F FF FF EB 05 90 68 E0 04 00 A0 E1 34 12 9F E5 03 20 A0 E3 8A FF FF EB 08 10 A0 E1 09 20 A0 E1 04 00 A0 E1 86 FF FF EB 0D 00 A0 E1 04 FF FF EB 0D 00 A0 E1 0A 10 A0 E1 07 20 A0 E1 80 FF FF EB 0D 00 A0 E1 08 10 A0 E1 09 20 A0 E1 7C FF FF EB }
	condition:
		$pattern
}
...
rule __ieee754_jn_151c1170229171d77a7f2d38f527e19e {
	meta:
		aliases = "__ieee754_jn"
		size = "1920"
		objfiles = "e_jn@libm.a"
	strings:
		$pattern = { F0 4F 2D E9 01 50 A0 E1 40 D0 4D E2 00 30 62 E2 10 50 8D E5 02 30 83 E1 02 60 A0 E1 02 40 A0 E1 02 10 A0 E1 10 20 9D E5 02 71 C2 E3 18 27 9F E5 A3 3F 87 E1 02 00 53 E1 00 00 8D E5 07 00 00 9A 05 00 A0 E1 06 10 A0 E1 05 20 A0 E1 06 30 A0 E1 ?? ?? ?? EB 00 50 A0 E1 01 60 A0 E1 B6 01 00 EA 00 30 9D E5 00 00 53 E3 09 00 00 AA 00 C0 9D E5 10 20 9D E5 02 31 85 E2 00 C0 6C E2 02 21 82 E2 06 40 A0 E1 03 50 A0 E1 00 C0 8D E5 10 20 8D E5 05 00 00 EA 04 00 00 1A 05 00 A0 E1 06 10 A0 E1 40 D0 8D E2 F0 4F BD E8 ?? ?? ?? EA 00 30 9D E5 01 00 53 E3 04 00 00 1A 05 00 A0 E1 06 10 A0 E1 40 D0 8D E2 F0 4F BD E8 }
	condition:
		$pattern
}
...
rule vfwscanf_b46a1d7ff394e5501571038eee40cc67 {
	meta:
...
rule inet_pton_9adb0cd8152b18f4e73bb9e35a78ca27 {
	meta:
		aliases = "__GI_inet_pton, inet_pton"
		size = "516"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 02 00 50 E3 14 D0 4D E2 01 50 A0 E1 00 20 8D E5 02 00 00 0A 0A 00 50 E3 70 00 00 1A 03 00 00 EA 01 00 A0 E1 00 10 9D E5 C0 FF FF EB 6F 00 00 EA 04 00 8D E2 00 10 A0 E3 10 20 A0 E3 ?? ?? ?? EB 00 30 D5 E5 3A 00 53 E3 00 60 A0 E1 10 80 80 E2 02 00 00 1A 01 30 F5 E5 3A 00 53 E3 5D 00 00 1A 00 90 A0 E3 05 A0 A0 E1 09 B0 A0 E1 09 70 A0 E1 30 00 00 EA 7C 01 9F E5 04 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 01 50 85 E2 06 00 00 0A 64 21 9F E5 00 30 62 E0 07 72 83 E1 5C 31 9F E5 03 00 57 E1 23 00 00 9A 4B 00 00 EA 3A 00 54 E3 15 00 00 1A 00 00 5B E3 04 00 00 1A 00 00 59 E3 45 00 00 1A 06 90 A0 E1 }
	condition:
		$pattern
}

rule inet_ntop_7134310c3aa363735ad1655c20be19d9 {
	meta:
		aliases = "__GI_inet_ntop, inet_ntop"
		size = "620"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 02 00 50 E3 58 D0 4D E2 01 80 A0 E1 04 20 8D E5 00 30 8D E5 02 00 00 0A 0A 00 50 E3 88 00 00 1A 04 00 00 EA 01 00 A0 E1 00 20 9D E5 04 10 9D E5 9A FF FF EB 80 00 00 EA 38 00 8D E2 00 10 A0 E3 20 20 A0 E3 ?? ?? ?? EB 00 00 A0 E3 08 30 80 E0 00 10 D8 E7 01 20 D3 E5 A0 3F 80 E0 01 24 82 E1 C3 30 A0 E1 02 00 80 E2 58 10 8D E2 03 31 81 E0 0F 00 50 E3 20 20 03 E5 F3 FF FF DA 00 60 E0 E3 00 10 A0 E3 06 20 A0 E1 06 C0 A0 E1 01 00 A0 E3 13 00 00 EA 58 E0 8D E2 01 31 8E E0 20 30 13 E5 00 00 53 E3 04 00 00 1A 01 00 72 E3 01 20 A0 01 00 40 A0 01 01 40 84 12 08 00 00 EA 01 00 72 E3 06 00 00 0A }
	condition:
		$pattern
}

rule __GI_gethostbyname2_r_3c6bcdf64fa7f6ece95c3771c5afef1a {
	meta:
		aliases = "gethostbyname2_r, __GI_gethostbyname2_r"
		size = "776"
		objfiles = "gethostbyname2_r@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 02 00 51 E3 4C D0 4D E2 01 40 A0 E1 02 60 A0 E1 03 80 A0 E1 00 A0 A0 E1 70 90 9D E5 78 B0 9D E5 07 00 00 1A 74 C0 9D E5 02 10 A0 E1 03 20 A0 E1 09 30 A0 E1 00 C0 8D E5 04 B0 8D E5 ?? ?? ?? EB A6 00 00 EA 0A 00 51 E3 A1 00 00 1A ?? ?? ?? EB 74 20 9D E5 00 70 A0 E3 00 00 5A E3 00 70 82 E5 9B 00 00 0A ?? ?? ?? EB 74 C0 9D E5 04 10 A0 E1 00 50 A0 E1 00 40 90 E5 06 20 A0 E1 00 70 80 E5 08 30 A0 E1 0A 00 A0 E1 00 12 8D E8 08 B0 8D E5 ?? ?? ?? EB 00 00 50 E3 90 00 00 0A 00 30 9B E5 01 00 53 E3 04 00 00 0A 04 00 53 E3 09 00 00 0A 01 00 73 E3 89 00 00 1A 03 00 00 EA 02 00 50 E3 00 70 A0 13 }
	condition:
		$pattern
}

rule __ieee754_y1_90b556793734e68a902dfee6fa197609 {
	meta:
		aliases = "__ieee754_y1"
		size = "1256"
		objfiles = "e_j1@libm.a"
	strings:
		$pattern = { F0 4F 2D E9 02 31 C0 E3 14 D0 4D E2 08 30 8D E5 08 C0 9D E5 54 34 9F E5 03 00 5C E1 00 A0 A0 E1 01 B0 A0 E1 01 50 A0 E1 01 40 A0 E1 0C 00 00 DA 00 20 A0 E1 01 30 A0 E1 ?? ?? ?? EB 00 20 A0 E1 01 30 A0 E1 0A 00 A0 E1 0B 10 A0 E1 ?? ?? ?? EB 00 20 A0 E1 18 04 9F E5 01 30 A0 E1 00 10 A0 E3 06 00 00 EA 08 30 9D E5 01 30 93 E1 05 00 00 1A 00 04 9F E5 00 10 A0 E3 00 20 A0 E3 00 30 A0 E3 ?? ?? ?? EB F7 00 00 EA 00 00 50 E3 00 00 A0 B3 00 10 A0 B3 00 20 A0 B1 01 30 A0 B1 F7 FF FF BA 08 C0 9D E5 07 01 7C E3 6A 00 00 DA ?? ?? ?? EB 00 60 A0 E1 01 70 A0 E1 0A 00 A0 E1 0B 10 A0 E1 ?? ?? ?? EB 00 40 A0 E1 }
	condition:
		$pattern
}

rule __ieee754_y0_edcb2b9d62f5d4f897514059f0f952cb {
	meta:
		aliases = "__ieee754_y0"
		size = "1232"
		objfiles = "e_j0@libm.a"
	strings:
		$pattern = { F0 4F 2D E9 02 31 C0 E3 14 D0 4D E2 10 30 8D E5 10 C0 9D E5 3C 34 9F E5 03 00 5C E1 00 80 A0 E1 01 90 A0 E1 01 50 A0 E1 01 40 A0 E1 0C 00 00 DA 00 20 A0 E1 01 30 A0 E1 ?? ?? ?? EB 00 20 A0 E1 01 30 A0 E1 08 00 A0 E1 09 10 A0 E1 ?? ?? ?? EB 00 20 A0 E1 00 04 9F E5 01 30 A0 E1 00 10 A0 E3 06 00 00 EA 10 30 9D E5 01 30 93 E1 05 00 00 1A E8 03 9F E5 00 10 A0 E3 00 20 A0 E3 00 30 A0 E3 ?? ?? ?? EB F1 00 00 EA 00 00 50 E3 00 00 A0 B3 00 10 A0 B3 00 20 A0 B1 01 30 A0 B1 F7 FF FF BA 10 C0 9D E5 07 01 7C E3 68 00 00 DA ?? ?? ?? EB 03 00 8D E8 08 00 A0 E1 09 10 A0 E1 ?? ?? ?? EB 00 A0 A0 E1 01 B0 A0 E1 }
	condition:
		$pattern
}

rule __ieee754_j0_f2fe4bc36cc08f48bfb769793063c9ba {
	meta:
		aliases = "__ieee754_j0"
		size = "1256"
		objfiles = "e_j0@libm.a"
	strings:
		$pattern = { F0 4F 2D E9 02 31 C0 E3 24 D0 4D E2 18 30 8D E5 18 20 9D E5 60 34 9F E5 03 00 52 E1 00 60 A0 E1 01 70 A0 E1 01 40 A0 E1 07 00 00 DA 00 20 A0 E1 01 30 A0 E1 ?? ?? ?? EB 00 20 A0 E1 3C 04 9F E5 01 30 A0 E1 00 10 A0 E3 4D 00 00 EA ?? ?? ?? EB 18 30 9D E5 07 01 73 E3 00 A0 A0 E1 01 B0 A0 E1 69 00 00 DA ?? ?? ?? EB 03 00 8D E8 0A 00 A0 E1 0B 10 A0 E1 ?? ?? ?? EB 00 80 A0 E1 01 90 A0 E1 08 20 A0 E1 09 30 A0 E1 03 00 9D E8 ?? ?? ?? EB EC 33 9F E5 18 20 9D E5 03 00 52 E1 08 00 8D E5 0C 10 8D E5 2A 00 00 CA 0A 20 A0 E1 0B 30 A0 E1 0A 00 A0 E1 0B 10 A0 E1 ?? ?? ?? EB ?? ?? ?? EB 08 20 A0 E1 00 40 A0 E1 }
	condition:
		$pattern
}
...
rule __ieee754_hypot_a52c9145ea0c8b9aa1faad5c1e296e7c {
	meta:
...
rule __ieee754_remainder_f10a09247b6aea03a880dc86e2889bdb {
	meta:
...
rule __wcstofpmax_0b0612ba9af9d7fc2700e22f3e49a3bc {
	meta:
		aliases = "__wcstofpmax"
		size = "904"
		objfiles = "__wcstofpmax@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 02 B0 A0 E1 10 D0 4D E2 00 60 A0 E1 04 00 8D E5 00 10 8D E5 00 00 00 EA 04 60 86 E2 00 00 96 E5 ?? ?? ?? EB 00 00 50 E3 FA FF FF 1A 00 30 96 E5 2B 00 53 E3 05 00 00 0A 2D 00 53 E3 01 20 A0 03 0C 00 8D 15 0C 20 8D 05 01 00 00 0A 01 00 00 EA 0C 00 8D E5 04 60 86 E2 00 30 A0 E3 00 70 A0 E3 00 80 A0 E3 00 A0 E0 E3 08 30 8D E5 19 00 00 EA 00 00 5A E3 01 A0 8A B2 00 00 5A E3 07 00 A0 E1 08 10 A0 E1 E4 22 9F E5 00 30 A0 E3 04 60 86 E2 01 00 00 1A 30 00 59 E3 0E 00 00 0A 01 A0 8A E2 11 00 5A E3 0B 00 00 CA ?? ?? ?? EB 00 40 A0 E1 30 00 49 E2 01 50 A0 E1 ?? ?? ?? EB 00 20 A0 E1 01 30 A0 E1 }
	condition:
		$pattern
}

rule __ieee754_fmod_10b9ebfa70a9daf3597b26e6d6a8e33f {
	meta:
...
rule _dl_do_reloc_117943e0f93672590bfa7e345df187be {
	meta:
		aliases = "_dl_do_reloc"
		size = "380"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { F0 4F 2D E9 04 C0 92 E5 00 A0 A0 E1 00 00 92 E5 00 20 9A E5 2C 74 B0 E1 02 80 80 E0 03 60 A0 E1 24 B0 9D E5 FF 40 0C E2 07 90 A0 01 1D 00 00 0A 07 52 A0 E1 05 00 93 E7 14 00 54 E3 02 30 A0 03 00 30 A0 13 16 00 54 E3 01 30 83 03 00 00 8B E0 0A 20 A0 E1 ?? ?? ?? EB 00 90 50 E2 05 30 86 E0 10 00 00 1A 0C 30 D3 E5 23 32 A0 E1 02 00 53 E3 0C 00 00 0A 05 30 96 E7 EC 20 9F E5 03 30 8B E0 00 20 92 E5 02 00 80 E2 E0 10 9F E5 ?? ?? ?? EB 01 00 A0 E3 01 00 90 EF 01 0A 70 E3 D0 30 9F 85 00 20 60 82 00 20 83 85 14 00 54 E3 22 00 00 0A 06 00 00 CA 01 00 54 E3 0D 00 00 0A 02 00 54 E3 08 00 00 0A 00 00 54 E3 }
	condition:
		$pattern
}
...
rule __GI_svc_getreq_common_da26280470e25ef8d6fa3a9f56eedde3 {
	meta:
...
rule _dl_lookup_hash_cee45c8f3251648f67bbb5aa157ebdc9 {
	meta:
		aliases = "_dl_lookup_hash"
		size = "340"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { F0 4F 2D E9 08 D0 4D E2 04 30 8D E5 00 B0 A0 E1 02 30 03 E2 01 70 A0 E1 02 80 A0 E1 00 A0 E0 E3 00 30 8D E5 3C 00 00 EA 00 50 97 E5 24 30 95 E5 23 34 A0 E1 01 30 23 E2 00 00 58 E3 00 30 A0 03 01 30 03 12 00 00 53 E3 0A 00 00 0A 05 00 58 E1 34 20 98 15 04 00 00 1A 06 00 00 EA 04 30 92 E5 05 00 53 E1 03 00 00 0A 00 20 92 E5 00 00 52 E3 F9 FF FF 1A 27 00 00 EA 00 30 9D E5 00 00 53 E3 02 00 00 0A 18 30 95 E5 01 00 53 E3 21 00 00 0A 28 10 95 E5 00 00 51 E3 1E 00 00 0A 01 00 7A E3 58 90 95 E5 0B C0 A0 01 01 A0 8A 02 05 00 00 0A 07 00 00 EA 0A 32 80 E0 0F 22 03 E2 03 30 22 E0 22 AC 23 E0 01 C0 8C E2 }
	condition:
		$pattern
}

rule srandom_r_8f861f29977dac9077966677b181e61b {
	meta:
		aliases = "__GI_srandom_r, srandom_r"
		size = "208"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 0C 30 91 E5 04 00 53 E3 04 D0 4D E2 01 60 A0 E1 00 00 E0 83 27 00 00 8A 00 00 50 E3 08 70 91 E5 01 00 A0 03 00 00 53 E3 00 00 87 E5 20 00 00 0A 10 90 91 E5 84 B0 9F E5 00 50 A0 E1 07 A0 A0 E1 01 80 A0 E3 09 00 00 EA ?? ?? ?? EB 70 40 9F E5 70 10 9F E5 90 04 04 E0 05 00 A0 E1 ?? ?? ?? EB 90 0B 03 E0 03 50 54 E0 06 51 45 42 04 50 AA E5 09 00 58 E1 05 00 A0 E1 48 10 9F E5 01 80 88 E2 F0 FF FF BA 0A 30 A0 E3 99 03 04 E0 14 30 96 E5 0D 50 A0 E1 03 31 87 E0 88 00 86 E8 00 00 00 EA ?? ?? ?? EB 01 40 54 E2 06 00 A0 E1 0D 10 A0 E1 FA FF FF 5A 00 00 A0 E3 04 D0 8D E2 F0 8F BD E8 14 0B 00 00 }
	condition:
		$pattern
}
...
rule _ppfs_parsespec_f0cf9fc8bf4da8e401674d2817014d37 {
	meta:
		aliases = "_ppfs_parsespec"
		size = "1200"
		objfiles = "_ppfs_parsespec@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 10 30 90 E5 40 D0 4D E2 80 50 13 E2 00 20 A0 E3 08 30 A0 E3 38 30 8D E5 28 20 8D E5 2C 20 8D E5 34 30 8D E5 00 70 A0 E1 18 B0 90 E5 00 10 90 05 11 00 00 0A 02 00 A0 E1 00 30 97 E5 00 31 83 E0 04 10 53 E5 40 C0 8D E2 00 20 8C E0 38 10 42 E5 04 30 13 E5 03 00 51 E1 01 00 80 E2 06 01 00 1A 00 00 51 E3 01 00 00 0A 1F 00 50 E3 F1 FF FF 9A 00 30 A0 E3 27 30 CD E5 09 10 8D E2 00 A0 A0 E3 0A E0 A0 E1 03 80 E0 E3 0A C0 A0 E1 02 41 A0 E3 01 90 A0 E3 00 00 00 EA 06 10 A0 E1 00 30 D1 E5 2A 00 53 E3 40 30 8D 02 9E 38 23 00 01 60 A0 11 01 60 81 02 0C 20 A0 E1 0C C0 03 05 06 00 00 EA C0 33 9F E5 }
	condition:
		$pattern
}
...
rule __GI_hsearch_r_b816ff14cf77adabd90b725825e21897 {
	meta:
...
rule __add_to_environ_21402f54dce03bd0a52d2a5acc900809 {
	meta:
		aliases = "__add_to_environ"
		size = "556"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 14 D0 4D E2 00 30 8D E5 01 80 A0 E1 02 70 A0 E1 00 A0 A0 E1 ?? ?? ?? EB 00 00 58 E3 00 60 A0 E1 08 B0 A0 01 02 00 00 0A 08 00 A0 E1 ?? ?? ?? EB 01 B0 80 E2 04 00 8D E2 CC 11 9F E5 CC 21 9F E5 CC 31 9F E5 0F E0 A0 E1 03 F0 A0 E1 C4 31 9F E5 B8 01 9F E5 0F E0 A0 E1 03 F0 A0 E1 B8 31 9F E5 00 50 93 E5 00 00 55 E3 05 90 A0 01 00 90 A0 13 08 00 00 1A 11 00 00 EA ?? ?? ?? EB 00 00 50 E3 02 00 00 1A 06 30 D4 E7 3D 00 53 E3 06 00 00 0A 01 90 89 E2 04 50 85 E2 00 40 95 E5 00 00 54 E2 0A 10 A0 E1 06 20 A0 E1 F2 FF FF 1A 00 00 55 E3 02 00 00 0A 00 30 95 E5 00 00 53 E3 2F 00 00 1A 58 31 9F E5 }
	condition:
		$pattern
}
...
rule __strtofpmax_a01b894a0a6a67a77687f2ee1d7d116f {
	meta:
		aliases = "__strtofpmax"
		size = "916"
		objfiles = "__strtofpmax@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 14 D0 4D E2 04 00 8D E5 04 80 9D E5 68 03 9F E5 02 B0 A0 E1 00 10 8D E5 00 00 00 EA 01 80 88 E2 00 20 D8 E5 00 10 90 E5 82 30 D1 E7 20 30 13 E2 08 10 8D E5 F8 FF FF 1A 2B 00 52 E3 05 00 00 0A 2D 00 52 E3 01 20 A0 03 10 30 8D 15 10 20 8D 05 01 00 00 0A 01 00 00 EA 10 30 8D E5 01 80 88 E2 00 30 A0 E3 00 60 A0 E3 00 70 A0 E3 00 A0 E0 E3 0C 30 8D E5 19 00 00 EA 00 00 5A E3 01 A0 8A B2 00 00 5A E3 06 00 A0 E1 07 10 A0 E1 EC 22 9F E5 00 30 A0 E3 01 80 88 E2 01 00 00 1A 30 00 59 E3 0E 00 00 0A 01 A0 8A E2 11 00 5A E3 0B 00 00 CA ?? ?? ?? EB 00 40 A0 E1 30 00 49 E2 01 50 A0 E1 ?? ?? ?? EB }
	condition:
		$pattern
}

rule __res_init_c41719a01792f4e8c19f9c4f4bef6a9d {
	meta:
		aliases = "__GI___res_init, __res_init"
		size = "424"
		objfiles = "res_init@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 14 D0 4D E2 70 11 9F E5 70 21 9F E5 0D 00 A0 E1 6C 31 9F E5 6C 41 9F E5 0F E0 A0 E1 03 F0 A0 E1 64 31 9F E5 54 01 9F E5 0F E0 A0 E1 03 F0 A0 E1 ?? ?? ?? EB ?? ?? ?? EB 05 30 A0 E3 00 30 84 E5 04 30 A0 E3 04 30 84 E5 01 30 A0 E3 08 30 84 E5 ?? ?? ?? EB 34 31 9F E5 64 21 D4 E5 00 C0 93 E5 40 34 A0 E1 41 30 C4 E5 02 30 A0 E3 0E 20 C2 E3 10 30 C4 E5 33 30 83 E2 00 10 A0 E3 01 20 82 E3 13 30 C4 E5 00 00 5C E3 00 30 E0 E3 64 21 C4 E5 C4 31 84 E5 40 00 C4 E5 14 10 84 E5 11 10 C4 E5 12 10 C4 E5 09 00 00 0A E4 E0 9F E5 01 20 A0 E1 04 00 A0 E1 02 00 00 EA 02 31 9E E7 44 30 81 E5 01 20 82 E2 }
	condition:
		$pattern
}

rule pthread_reap_children_88bb62caa2610d1e2a548d281892a872 {
	meta:
		aliases = "pthread_reap_children"
		size = "308"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { F0 4F 2D E9 18 61 9F E5 04 D0 4D E2 14 B1 9F E5 14 91 9F E5 0D A0 A0 E1 01 80 A0 E3 0C 70 A0 E3 37 00 00 EA 00 10 96 E5 00 50 91 E5 20 00 00 EA 14 30 95 E5 00 00 53 E1 00 20 95 E5 1B 00 00 1A 04 30 95 E5 04 30 82 E5 04 30 95 E5 1C 00 95 E5 00 20 83 E5 00 10 A0 E3 ?? ?? ?? EB 9C 31 95 E5 00 00 53 E3 2E 80 C5 E5 08 00 00 0A BC 20 9F E5 00 30 92 E5 A0 21 95 E5 02 30 83 E1 02 0B 13 E3 A8 71 85 15 AC 51 85 15 00 50 8B 15 ?? ?? ?? 1B 2D 40 D5 E5 1C 00 95 E5 ?? ?? ?? EB 00 00 54 E3 05 00 00 0A 05 00 A0 E1 A0 FF FF EB 02 00 00 EA 02 50 A0 E1 01 00 55 E1 DC FF FF 1A 00 30 99 E5 00 00 53 E3 03 00 00 0A }
	condition:
		$pattern
}

rule __des_crypt_52c21285385e087ddefafce6ddfa4b2e {
	meta:
		aliases = "__des_crypt"
		size = "384"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { F0 4F 2D E9 18 D0 4D E2 00 40 A0 E1 01 50 A0 E1 73 FC FF EB 08 20 8D E2 02 00 A0 E1 05 00 00 EA 00 30 D4 E5 83 30 A0 E1 00 30 C2 E5 01 30 D2 E4 00 00 53 E3 01 40 84 12 02 30 60 E0 08 00 53 E3 F6 FF FF 1A C4 FD FF EB 28 B1 9F E5 00 40 D5 E5 01 00 D5 E5 00 40 CB E5 01 30 D5 E5 00 00 53 E3 04 30 A0 01 01 30 CB E5 4B FC FF EB 00 53 A0 E1 04 00 A0 E1 48 FC FF EB 00 00 85 E1 9C FD FF EB 00 00 A0 E3 19 C0 A0 E3 00 10 A0 E1 14 20 8D E2 10 30 8D E2 00 C0 8D E5 77 FE FF EB 00 00 50 E3 04 00 8D E5 00 00 A0 13 30 00 00 1A 10 20 8D E2 04 04 92 E8 0A 18 A0 E1 22 18 81 E1 02 21 A0 E1 B4 30 9F E5 21 E9 A0 E1 }
	condition:
		$pattern
}

rule __re_search_2_e96e6a941277190fe00b3f981bfe3092 {
	meta:
...
rule __time_localtime_tzi_b133449265709b9407a632a15fe05f11 {
	meta:
		aliases = "__time_localtime_tzi"
		size = "848"
		objfiles = "_time_localtime_tzi@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 1C D0 4D E2 04 00 8D E5 00 00 A0 E3 00 20 8D E5 08 00 8D E5 01 80 A0 E1 08 10 9D E5 18 20 A0 E3 91 02 02 E0 03 00 9D E8 02 30 90 E7 00 00 91 E5 00 13 9F E5 93 3A 63 E2 01 00 50 E1 2A 3D 83 E2 00 10 9D E5 00 30 63 C2 02 40 81 E0 00 30 83 E0 08 20 A0 E1 06 10 E0 D3 07 10 A0 C3 18 00 8D E2 18 30 8D E5 ?? ?? ?? EB 08 20 9D E5 20 20 88 E5 10 30 94 E4 C0 52 9F E5 00 30 63 E2 04 60 A0 E1 24 30 88 E5 03 00 00 EA ?? ?? ?? EB 00 00 50 E3 17 00 00 0A 00 50 95 E5 04 40 85 E2 00 00 55 E3 04 00 A0 E1 06 10 A0 E1 F6 FF FF 1A 06 00 A0 E1 07 10 A0 E3 ?? ?? ?? EB 06 00 50 E3 0E 00 00 8A 0C 00 A0 E3 }
	condition:
		$pattern
}

rule inet_ntop4_ec5925ba1c8736a528f9cac4ba73b37e {
	meta:
		aliases = "inet_ntop4"
		size = "348"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 1C D0 4D E2 04 10 8D E5 00 20 8D E5 40 11 9F E5 02 20 A0 E3 00 B0 A0 E1 0B 00 8D E2 ?? ?? ?? EB 0D 00 8D E2 00 10 A0 E3 0F 20 A0 E3 ?? ?? ?? EB 00 60 A0 E3 06 A0 A0 E1 2B 00 00 EA 0A 40 DB E7 04 00 A0 E1 ?? ?? ?? EB 30 30 80 E2 11 30 45 E5 11 30 55 E5 01 60 86 E2 1C 20 8D E2 30 00 53 E3 0A 10 A0 E3 04 00 A0 E1 06 80 82 E0 0A 90 8B E0 09 00 00 1A ?? ?? ?? EB 0A 10 A0 E3 FF 00 00 E2 ?? ?? ?? EB 30 00 80 E2 FF 00 00 E2 30 00 50 E3 06 70 A0 11 11 00 45 E5 06 00 00 EA ?? ?? ?? EB 0A 10 A0 E3 FF 00 00 E2 ?? ?? ?? EB 30 00 80 E2 11 00 48 E5 01 70 86 E2 00 00 D9 E5 0A 10 A0 E3 ?? ?? ?? EB }
	condition:
		$pattern
}
...
rule __read_etc_hosts_r_f866f86aedae6ae9bf7dbc802b8a99b4 {
	meta:
		aliases = "__read_etc_hosts_r"
		size = "804"
		objfiles = "read_etc_hosts_r@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 1C D0 4D E2 44 60 9D E5 00 C0 66 E2 03 C0 1C E2 04 20 8D E5 0C 00 8D E5 08 10 8D E5 00 30 8D E5 40 90 9D E5 48 20 9D E5 03 00 00 0A 0C 00 52 E1 B5 00 00 3A 02 20 6C E0 0C 60 86 E0 1F 00 52 E3 B1 00 00 9A 00 00 9D E5 20 10 86 E2 01 00 50 E3 18 10 8D E5 20 70 42 E2 27 00 00 0A 50 00 9D E5 00 30 E0 E3 03 00 57 E3 00 30 80 E5 A6 00 00 9A 24 30 42 E2 07 00 53 E3 A3 00 00 9A 0F 00 57 E3 A1 00 00 9A 30 30 42 E2 07 00 53 E3 9E 00 00 9A 2C 70 42 E2 38 30 42 E2 07 00 53 E1 03 70 A0 31 2C 40 86 22 38 40 86 32 4F 00 57 E3 24 50 86 E2 30 80 86 E2 94 00 00 9A ?? ?? ?? EB 00 00 50 E3 0C 00 8D E5 }
	condition:
		$pattern
}

rule sigwait_ff29de43535dd2c14bb6bb65ee1f0d98 {
	meta:
		aliases = "sigwait"
		size = "380"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { F0 4F 2D E9 1F DE 4D E2 5B 4F 8D E2 00 10 8D E5 00 60 A0 E1 54 FF FF EB 48 51 9F E5 00 30 A0 E1 04 00 A0 E1 EC 31 8D E5 ?? ?? ?? EB 04 00 A0 E1 00 10 95 E5 ?? ?? ?? EB 2C B1 9F E5 05 90 A0 E1 04 A0 A0 E1 E0 80 8D E2 01 40 A0 E3 E4 70 8D E2 00 50 A0 E3 1D 00 00 EA ?? ?? ?? EB 00 00 50 E3 19 00 00 0A 04 21 9F E5 00 30 92 E5 03 00 54 E1 15 00 00 0A 00 30 99 E5 03 00 54 E1 12 00 00 0A EC 20 9F E5 00 30 92 E5 03 00 54 E1 04 10 A0 E1 0A 00 A0 E1 0C 00 00 0A ?? ?? ?? EB D4 20 9F E5 04 31 92 E7 01 00 53 E3 07 00 00 8A 07 00 A0 E1 E0 B0 8D E5 ?? ?? ?? EB 04 00 A0 E1 08 10 A0 E1 05 20 A0 E1 64 51 8D E5 }
	condition:
		$pattern
}
...
rule __res_search_ee0baceb9f06dc4673a7f6eebc4bb845 {
	meta:
		aliases = "__res_search"
		size = "844"
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 24 D0 4D E2 14 40 8D E2 00 80 A0 E1 0C 10 8D E5 04 00 A0 E1 10 13 9F E5 08 20 8D E5 03 90 A0 E1 08 23 9F E5 08 33 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 33 9F E5 F4 02 9F E5 0F E0 A0 E1 03 F0 A0 E1 F4 32 9F E5 04 00 A0 E1 01 10 A0 E3 08 40 93 E5 E8 32 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 59 E3 00 00 58 13 04 00 00 0A 01 00 14 E3 07 00 00 1A ?? ?? ?? EB 01 00 70 E3 04 00 00 1A ?? ?? ?? EB 00 30 E0 E3 03 20 A0 E1 00 30 80 E5 A3 00 00 EA ?? ?? ?? EB 00 40 A0 E3 00 40 80 E5 10 00 8D E5 ?? ?? ?? EB 04 A0 A0 E1 01 30 A0 E3 00 60 A0 E1 08 20 A0 E1 00 30 80 E5 02 00 00 EA 2E 00 53 E3 01 A0 8A 02 }
	condition:
		$pattern
}

rule do_des_61e63a1ba1be200661f095709c677236 {
	meta:
		aliases = "do_des"
		size = "1044"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { F0 4F 2D E9 24 D0 4D E2 48 70 9D E5 00 00 57 E3 01 B0 A0 E1 10 20 8D E5 0C 30 8D E5 01 00 A0 03 EE 00 00 0A BC 83 9F C5 BC C3 9F C5 18 80 8D C5 1C C0 8D C5 06 00 00 CA 48 30 9D E5 AC 13 9F E5 AC 23 9F E5 00 30 63 E2 18 10 8D E5 1C 20 8D E5 48 30 8D E5 9C 63 9F E5 9C 43 9F E5 FF 30 00 E2 03 31 A0 E1 20 17 A0 E1 04 C0 83 E0 FF 1F 01 E2 06 30 83 E0 20 7C A0 E1 20 53 A0 E1 00 0C 93 E5 04 30 81 E0 06 10 81 E0 00 14 91 E5 07 81 96 E7 00 34 93 E5 FF 5F 05 E2 08 10 8D E5 2B 2C A0 E1 00 30 8D E5 08 00 80 E1 04 30 85 E0 08 80 9D E5 06 50 85 E0 07 A1 94 E7 02 21 A0 E1 00 58 95 E5 00 CC 9C E5 04 70 82 E0 }
	condition:
		$pattern
}

rule __encode_packet_745668eb81da73e7489459d07b59f77b {
	meta:
		aliases = "__encode_packet"
		size = "312"
		objfiles = "encodep@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 28 40 8D E2 50 00 94 E8 01 A0 A0 E1 02 90 A0 E1 04 10 A0 E1 06 20 A0 E1 03 B0 A0 E1 00 80 A0 E1 ?? ?? ?? EB 00 00 50 E3 F0 8F BD B8 00 50 84 E0 00 70 A0 E3 06 40 60 E0 00 60 A0 E1 07 00 00 EA 07 01 9A E7 ?? ?? ?? EB 00 00 50 E3 F0 8F BD B8 00 60 86 E0 00 50 85 E0 04 40 60 E0 01 70 87 E2 20 30 98 E5 03 00 57 E1 05 10 A0 E1 04 20 A0 E1 F2 FF FF 3A 00 70 A0 E3 07 00 00 EA 07 01 99 E7 ?? ?? ?? EB 00 00 50 E3 F0 8F BD B8 00 60 86 E0 00 50 85 E0 04 40 60 E0 01 70 87 E2 24 30 98 E5 03 00 57 E1 05 10 A0 E1 04 20 A0 E1 F2 FF FF 3A 00 70 A0 E3 07 00 00 EA 07 01 9B E7 ?? ?? ?? EB 00 00 50 E3 }
	condition:
		$pattern
}
...
rule freopen_363347caee720536f0d7d85d81f0cd84 {
	meta:
...
rule fstatfs64_85a6d178126e4d2a8a8106a6ffe186e2 {
	meta:
		aliases = "__GI_statfs64, __GI_fstatfs64, statfs64, fstatfs64"
		size = "188"
...
rule _vfprintf_internal_0ee170975bd7efcca782311705f8519e {
	meta:
		aliases = "_vfprintf_internal"
		size = "1512"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 4D DF 4D E2 0C 60 8D E2 00 90 A0 E1 06 00 A0 E1 02 50 A0 E1 01 40 A0 E1 ?? ?? ?? EB 00 00 50 E3 0C 00 00 AA 0C 40 9D E5 04 00 A0 E1 ?? ?? ?? EB 00 10 50 E2 00 10 E0 03 08 10 8D 05 60 01 00 0A 09 20 A0 E1 04 00 A0 E1 ?? ?? ?? EB 00 20 E0 E3 08 20 8D E5 5A 01 00 EA 06 00 A0 E1 05 10 A0 E1 A4 B0 8D E2 ?? ?? ?? EB 00 30 A0 E3 7F C0 8B E2 08 30 8D E5 04 C0 8D E5 04 20 A0 E1 00 30 D4 E5 00 00 53 E3 25 00 53 13 00 00 A0 03 01 00 A0 13 01 40 84 12 F8 FF FF 1A 02 00 54 E1 0A 00 00 0A 04 50 62 E0 00 00 55 E3 02 00 A0 C1 05 10 A0 C1 09 20 A0 C1 ?? ?? ?? CB 05 00 50 E1 3E 01 00 1A 08 10 9D E5 }
	condition:
		$pattern
}
...
rule gethostbyname_r_36d99a2947ea200e352d20a4afbfd6ad {
	meta:
		aliases = "__GI_gethostbyname_r, gethostbyname_r"
		size = "888"
		objfiles = "gethostbyname_r@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 50 D0 4D E2 02 70 A0 E1 74 20 9D E5 00 B0 50 E2 00 60 A0 E3 01 A0 A0 E1 03 40 A0 E1 00 60 82 E5 16 00 80 02 C9 00 00 0A ?? ?? ?? EB 74 C0 9D E5 00 80 90 E5 00 60 80 E5 04 C0 8D E5 78 C0 9D E5 00 50 A0 E1 02 10 A0 E3 0B 00 A0 E1 0A 20 A0 E1 07 30 A0 E1 00 40 8D E5 08 C0 8D E5 ?? ?? ?? EB 00 00 50 E3 B9 00 00 0A 78 20 9D E5 00 30 92 E5 01 00 53 E3 06 00 00 0A 04 00 53 E3 04 00 00 0A 01 00 73 E3 B1 00 00 1A 00 30 95 E5 02 00 53 E3 AE 00 00 1A 00 30 67 E2 03 30 13 E2 00 80 85 E5 03 00 00 0A 03 00 54 E1 A7 00 00 3A 04 40 63 E0 03 70 87 E0 78 30 9D E5 00 C0 E0 E3 03 00 54 E3 00 C0 83 E5 }
	condition:
		$pattern
}

rule clnttcp_call_e2f3930f098e1e3311c5e5777d943a53 {
	meta:
		aliases = "clnttcp_call"
		size = "740"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 50 D0 4D E2 1C 10 8D E5 08 50 90 E5 10 10 95 E5 08 30 8D E5 7C 30 8D E2 18 00 93 E8 00 00 51 E3 0C 20 8D E5 30 20 85 E2 14 20 8D E5 08 30 85 05 0C 40 85 05 74 30 9D E5 00 00 53 E3 00 70 A0 E1 4C 60 85 E2 06 00 00 1A 08 30 95 E5 00 00 53 E3 03 00 00 1A 0C 30 95 E5 00 80 53 E2 01 80 A0 13 00 00 00 EA 01 80 A0 E3 02 20 A0 E3 18 20 8D E5 30 30 85 E2 24 20 85 E2 0C 00 8D E8 00 A0 A0 E3 2C 90 8D E2 20 B0 8D E2 4C A0 85 E5 24 A0 85 E5 14 20 9D E5 00 30 92 E5 01 30 43 E2 00 30 82 E5 23 CC A0 E1 FF 28 03 E2 22 C4 8C E1 FF 2C 03 E2 02 C4 8C E1 03 3C 8C E1 50 40 95 E5 48 20 95 E5 06 00 A0 E1 }
	condition:
		$pattern
}

rule clntunix_call_831c2642f423f8fcb9a77a98431db5b1 {
	meta:
		aliases = "clntunix_call"
		size = "740"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 50 D0 4D E2 1C 10 8D E5 08 50 90 E5 10 10 95 E5 08 30 8D E5 7C 30 8D E2 18 00 93 E8 00 00 51 E3 0C 20 8D E5 90 20 85 E2 14 20 8D E5 08 30 85 05 0C 40 85 05 74 30 9D E5 00 00 53 E3 00 70 A0 E1 AC 60 85 E2 06 00 00 1A 08 30 95 E5 00 00 53 E3 03 00 00 1A 0C 30 95 E5 00 80 53 E2 01 80 A0 13 00 00 00 EA 01 80 A0 E3 02 20 A0 E3 18 20 8D E5 90 30 85 E2 84 20 85 E2 0C 00 8D E8 00 A0 A0 E3 2C 90 8D E2 20 B0 8D E2 AC A0 85 E5 84 A0 85 E5 14 20 9D E5 00 30 92 E5 01 30 43 E2 00 30 82 E5 23 CC A0 E1 FF 28 03 E2 22 C4 8C E1 FF 2C 03 E2 02 C4 8C E1 03 3C 8C E1 B0 40 95 E5 A8 20 95 E5 06 00 A0 E1 }
	condition:
		$pattern
}

rule __GI_vsyslog_2a8d86213429db491d6c9259d7113f70 {
	meta:
		aliases = "vsyslog, __GI_vsyslog"
		size = "988"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 53 DE 4D E2 49 4E 8D E2 00 50 A0 E1 00 20 8D E5 01 B0 A0 E1 8C 20 A0 E3 00 10 A0 E3 04 00 A0 E1 ?? ?? ?? EB 60 33 9F E5 04 00 84 E2 90 34 8D E5 ?? ?? ?? EB 01 2B 8D E2 04 10 A0 E1 04 20 82 E2 0D 00 A0 E3 ?? ?? ?? EB ?? ?? ?? EB 00 A0 A0 E1 51 0E 8D E2 34 13 9F E5 34 23 9F E5 0C 00 80 E2 30 33 9F E5 00 90 9A E5 0F E0 A0 E1 03 F0 A0 E1 24 33 9F E5 18 03 9F E5 0F E0 A0 E1 03 F0 A0 E1 18 33 9F E5 00 10 93 E5 07 20 05 E2 01 30 A0 E3 13 32 11 E0 AF 00 00 0A FF 2F C5 E3 03 20 C2 E3 00 00 52 E3 AB 00 00 1A F4 32 9F E5 00 30 93 E5 00 00 53 E3 03 00 00 BA E8 32 9F E5 00 30 93 E5 00 00 53 E3 }
	condition:
		$pattern
}
...
rule __GI_gethostbyaddr_r_08c8dd3d3e981874fed71649b45a8ef1 {
	meta:
		aliases = "gethostbyaddr_r, __GI_gethostbyaddr_r"
		size = "912"
		objfiles = "gethostbyaddr_r@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 58 D0 4D E2 10 20 8D E5 84 20 9D E5 00 40 50 E2 00 00 A0 E3 01 80 A0 E1 03 A0 A0 E1 00 00 82 E5 7C 70 9D E5 80 50 9D E5 C8 00 00 0A 00 10 A0 E1 28 20 A0 E3 1C 00 8D E2 ?? ?? ?? EB 10 30 9D E5 02 00 53 E3 02 00 00 0A 0A 00 53 E3 BF 00 00 1A 01 00 00 EA 04 00 58 E3 00 00 00 EA 10 00 58 E3 BA 00 00 1A 84 C0 9D E5 08 C0 8D E5 88 C0 9D E5 04 00 A0 E1 08 10 A0 E1 10 20 9D E5 0A 30 A0 E1 00 70 8D E5 04 50 8D E5 0C C0 8D E5 ?? ?? ?? EB 00 00 50 E3 B0 00 00 0A 88 20 9D E5 00 30 92 E5 01 00 53 E3 01 00 00 0A 04 00 53 E3 AA 00 00 1A ?? ?? ?? EB 88 C0 9D E5 00 30 E0 E3 03 00 55 E3 00 30 8C E5 }
	condition:
		$pattern
}
...
rule vfscanf_da1a928a883a1998858176d28830fbd2 {
	meta:
...
rule _vfwprintf_internal_bf8f891b1d0606ab7a4af292739a7008 {
	meta:
		aliases = "_vfwprintf_internal"
		size = "1716"
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 92 DF 4D E2 01 50 A0 E1 00 B0 A0 E1 00 10 A0 E3 02 60 A0 E1 43 0F 8D E2 98 20 A0 E3 ?? ?? ?? EB 24 C1 9D E5 00 E0 A0 E3 92 1F 8D E2 01 C0 4C E2 8D 3F 8D E2 24 C1 8D E5 04 50 21 E5 80 C0 A0 E3 0E 00 A0 E1 00 20 E0 E3 1C C1 8D E5 0C 51 8D E5 34 E2 8D E5 ?? ?? ?? EB 01 00 70 E3 34 36 9F 05 0C 31 8D 05 23 00 00 0A 09 30 A0 E3 4D 2F 8D E2 08 10 A0 E3 01 30 53 E2 04 10 82 E4 FC FF FF 1A 05 20 A0 E1 43 4F 8D E2 0C 00 00 EA 25 00 53 E3 09 00 00 1A 04 30 B2 E5 25 00 53 E3 04 00 A0 E1 05 00 00 0A 0C 21 8D E5 ?? ?? ?? EB 00 00 50 E3 10 00 00 BA 0C 21 9D E5 00 00 00 EA 04 20 82 E2 00 30 92 E5 }
	condition:
		$pattern
}
...
rule __open_nameservers_2d4ed7d420afc851c95510d2ff79682c {
	meta:
		aliases = "__open_nameservers"
		size = "708"
		objfiles = "opennameservers@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 A4 D0 4D E2 94 00 8D E2 70 12 9F E5 70 22 9F E5 70 32 9F E5 0F E0 A0 E1 03 F0 A0 E1 68 32 9F E5 5C 02 9F E5 0F E0 A0 E1 03 F0 A0 E1 5C 32 9F E5 00 30 93 E5 00 00 53 E3 89 00 00 CA 50 02 9F E5 50 12 9F E5 ?? ?? ?? EB 00 80 50 E2 74 00 00 1A 44 02 9F E5 3C 12 9F E5 ?? ?? ?? EB 00 80 50 E2 6F 00 00 1A 7B 00 00 EA 01 10 81 E2 00 20 D1 E5 00 00 52 E3 04 00 00 0A 20 02 9F E5 00 30 90 E5 82 30 D3 E7 20 00 13 E3 F6 FF FF 1A 0A 00 52 E3 00 00 52 13 65 00 00 0A 23 00 52 E3 09 70 A0 11 1C 00 00 1A 61 00 00 EA A4 20 8D E2 07 31 82 E0 01 70 87 E2 24 10 03 E5 00 00 00 EA 01 10 81 E2 00 20 D1 E5 }
	condition:
		$pattern
}
...
rule __pthread_destroy_specifics_9d2de95de362ad09ef86167c5abb99f5 {
	meta:
		aliases = "__pthread_destroy_specifics"
		size = "252"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { F0 4F 2D E9 B7 FF FF EB 00 80 A0 E3 01 10 A0 E3 00 60 A0 E1 08 70 A0 E1 01 B0 A0 E1 1C 00 00 EA 05 31 86 E0 E0 20 83 E2 0C 30 92 E5 00 00 53 E3 02 90 A0 11 07 40 A0 11 85 A2 A0 11 0B 00 00 1A 0F 00 00 EA 0C 30 99 E5 04 20 92 E5 04 01 93 E7 00 00 52 E3 00 00 50 13 03 00 00 0A 04 71 83 E7 0F E0 A0 E1 02 F0 A0 E1 0B 10 A0 E1 01 40 84 E2 80 00 9F E5 04 30 8A E0 1F 00 54 E3 83 21 80 E0 EF FF FF DA 01 50 85 E2 1F 00 55 E3 E3 FF FF DA 01 80 88 E2 03 00 58 E3 00 40 A0 C3 01 40 01 D2 00 00 54 E3 07 50 A0 11 07 10 A0 11 F5 FF FF 1A 1C 00 96 E5 06 10 A0 E1 ?? ?? ?? EB 04 70 A0 E1 04 00 00 EA 0C 30 95 E5 }
	condition:
		$pattern
}
...
rule __dns_lookup_7afac1283835c6dc2febe2f086649dbe {
	meta:
		aliases = "__dns_lookup"
		size = "2008"
		objfiles = "dnslookup@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 CC D0 4D E2 18 00 8D E5 02 0C A0 E3 14 10 8D E5 10 20 8D E5 0C 30 8D E5 F4 90 9D E5 ?? ?? ?? EB 00 80 A0 E1 74 07 9F E5 ?? ?? ?? EB 00 00 50 E3 00 00 58 13 00 10 A0 13 01 10 A0 03 08 00 8D E5 04 10 8D E5 A9 01 00 0A 10 20 9D E5 00 00 52 E3 A6 01 00 0A 18 10 9D E5 00 30 D1 E5 00 00 53 E3 A2 01 00 0A 01 00 A0 E1 ?? ?? ?? EB 18 20 9D E5 00 00 82 E0 01 30 50 E5 A8 40 8D E2 2E 00 53 E3 00 30 A0 13 01 30 A0 03 14 27 9F E5 14 17 9F E5 2C 30 8D E5 04 00 A0 E1 0C 77 9F E5 0F E0 A0 E1 07 F0 A0 E1 04 67 9F E5 F4 06 9F E5 0F E0 A0 E1 06 F0 A0 E1 F8 36 9F E5 10 10 9D E5 00 00 93 E5 ?? ?? ?? EB }
	condition:
		$pattern
}
...
rule __ieee754_j1_fb8b6d6de89462971433b3ff65741b27 {
	meta:
		aliases = "__ieee754_j1"
		size = "1116"
		objfiles = "e_j1@libm.a"
	strings:
		$pattern = { F0 4F 2D E9 EC 33 9F E5 02 21 C0 E3 10 D0 4D E2 03 00 52 E1 00 A0 A0 E1 01 B0 A0 E1 01 40 A0 E1 05 00 8D E8 05 00 00 DA 00 20 A0 E1 01 30 A0 E1 C4 03 9F E5 00 10 A0 E3 ?? ?? ?? EB EB 00 00 EA 04 30 9D E5 07 01 73 E3 73 00 00 DA ?? ?? ?? EB 00 A0 A0 E1 01 B0 A0 E1 ?? ?? ?? EB 00 60 A0 E1 01 70 A0 E1 0A 00 A0 E1 0B 10 A0 E1 ?? ?? ?? EB 00 40 A0 E1 01 50 A0 E1 04 20 A0 E1 05 30 A0 E1 06 00 A0 E1 07 10 A0 E1 ?? ?? ?? EB 6C 33 9F E5 04 20 9D E5 03 00 52 E1 00 80 A0 E1 01 90 A0 E1 2A 00 00 CA 0A 20 A0 E1 0B 30 A0 E1 0A 00 A0 E1 0B 10 A0 E1 ?? ?? ?? EB ?? ?? ?? EB 04 20 A0 E1 08 00 8D E5 0C 10 8D E5 }
	condition:
		$pattern
}
...
rule __ieee754_exp_1540522ab97876c25dd8b5100e794f9b {
	meta:
...
rule _dl_load_elf_shared_library_b4c332018f09e2864ca47e109875a3ee {
	meta:
		aliases = "_dl_load_elf_shared_library"
		size = "2856"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { F0 4F 2D E9 FC D0 4D E2 08 20 8D E5 00 20 A0 E3 00 30 A0 E1 0C 10 8D E5 08 00 9D E5 02 10 A0 E1 05 00 90 EF 01 0A 70 E3 00 A0 A0 E1 B0 3A 9F 85 00 10 60 82 00 10 83 85 01 00 00 8A 00 00 50 E3 03 00 00 AA 9C 3A 9F E5 02 60 A0 E1 01 20 A0 E3 9A 02 00 EA BC 10 8D E2 6C 00 90 EF 01 0A 70 E3 7C 3A 9F 85 00 10 60 82 00 10 83 85 01 00 00 8A 00 00 50 E3 0B 00 00 AA 68 3A 9F E5 01 10 A0 E3 00 10 83 E5 0A 00 A0 E1 06 00 90 EF 01 0A 70 E3 8C 02 00 9A 48 3A 9F E5 00 10 60 E2 02 60 A0 E1 00 10 83 E5 8B 02 00 EA 00 00 53 E3 06 00 00 0A C5 30 DD E5 03 34 A0 E1 02 5B 13 E2 02 00 00 1A 0A 00 A0 E1 06 00 90 EF }
	condition:
		$pattern
}
...
rule __re_compile_fastmap_a342cb75268928847a9d8fc0bcd8cb7d {
	meta:
...
rule __pthread_manager_a0d4ba70326487217d64b0e35b1d4639 {
	meta:
		aliases = "__pthread_manager"
		size = "1872"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { F4 36 9F E5 05 DD 4D E2 50 20 83 E2 B8 40 8D E2 48 10 83 E2 4C 20 83 E5 44 10 83 E5 0C 00 8D E5 04 00 A0 E1 ?? ?? ?? EB D0 36 9F E5 04 00 A0 E1 00 10 93 E5 ?? ?? ?? EB 04 00 A0 E1 05 10 A0 E3 ?? ?? ?? EB B8 36 9F E5 00 30 93 E5 00 00 53 E3 04 00 00 0A AC 36 9F E5 00 10 93 E5 00 00 51 E3 04 00 A0 C1 ?? ?? ?? CB B8 10 8D E2 00 20 A0 E3 02 00 A0 E3 ?? ?? ?? EB 8C 36 9F E5 00 30 93 E5 18 00 93 E5 ?? ?? ?? EB 24 40 8D E2 0C 00 9D E5 04 10 A0 E1 94 20 A0 E3 ?? ?? ?? EB 01 00 70 E3 03 00 00 1A ?? ?? ?? EB 00 30 90 E5 04 00 53 E3 F5 FF FF 0A 01 30 A0 E3 0C 10 9D E5 3C 31 CD E5 00 30 A0 E3 3D 31 CD E5 }
	condition:
		$pattern
}
...
rule __pthread_initialize_manager_b5d71273c2a6b92dd99429c86eb07713 {
	meta:
		aliases = "__pthread_initialize_manager"
		size = "584"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { FC 31 9F E5 70 40 2D E9 00 20 93 E5 F4 31 9F E5 00 10 93 E5 00 00 52 E3 01 30 A0 E3 9C D0 4D E2 00 30 81 E5 83 FF FF 0B DC 41 9F E5 00 00 94 E5 80 00 A0 E1 20 00 40 E2 ?? ?? ?? EB CC 51 9F E5 00 00 50 E3 00 00 85 E5 00 00 E0 03 6A 00 00 0A 00 20 94 E5 20 30 40 E2 B4 61 9F E5 82 30 83 E0 94 00 8D E2 00 30 86 E5 ?? ?? ?? EB 01 00 70 E3 00 40 A0 E1 02 00 00 1A 00 00 95 E5 ?? ?? ?? EB 37 00 00 EA 8C 31 9F E5 00 20 93 E5 00 00 52 E3 84 31 9F 15 9C 21 83 15 7C 21 9F E5 9C 31 92 E5 00 00 53 E3 1E 00 00 0A 70 31 9F E5 A0 21 92 E5 00 30 93 E5 02 30 83 E1 80 00 13 E3 18 00 00 0A 5C 51 9F E5 00 10 A0 E3 }
	condition:
		$pattern
}
...
rule ustat_6ccef12a6dc840553b757e4aa37698c7 {
	meta:
		aliases = "ustat"
		size = "72"
		objfiles = "ustat@libc.a"
	strings:
		$pattern = { FF 30 00 E2 20 04 A0 E1 01 0C 80 E1 00 34 83 E1 03 38 A0 E1 30 40 2D E9 02 10 A0 E1 23 08 A0 E1 3E 00 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 40 E0 E3 04 00 A0 E1 30 80 BD E8 }
	condition:
		$pattern
}
