...
rule __floatsidf_886c702c19c479260a77a11c5a2b3496 {
	meta:
...
rule clone_b11b85e1f742ed1627866f38ea7b50c5 {
	meta:
		aliases = "__clone, clone"
		size = "88"
		objfiles = "clone@libc.a"
	strings:
		$pattern = { 00 00 50 E3 00 00 51 13 15 00 E0 03 10 00 00 0A 08 10 41 E2 04 30 81 E5 00 00 81 E5 02 00 A0 E1 10 00 2D E9 04 20 9D E5 08 30 9D E5 0C 40 9D E5 78 00 90 EF 00 00 B0 E1 05 00 00 BA 10 00 BD 18 0E F0 A0 11 04 00 9D E5 0F E0 A0 E1 00 F0 9D E5 ?? ?? ?? EA ?? ?? ?? EA }
	condition:
		$pattern
}
...
rule abs_982289527251259ce2e4944925414d59 {
	meta:
		aliases = "labs, __absvsi2, abs"
		size = "12"
		objfiles = "labs@libc.a, _absvsi2@libgcc.a"
	strings:
...
rule __GI_perror_64b0f4823a1c1ce33ff44b2e6dd45b0b {
	meta:
...
rule confstr_070f1405b299e7ba0e6391bef7d1d1f3 {
	meta:
		aliases = "confstr"
		size = "140"
		objfiles = "confstr@libc.a"
	strings:
		$pattern = { 00 00 50 E3 70 40 2D E9 01 50 A0 E1 02 40 A0 E1 6C 10 9F 05 0E 60 A0 03 08 00 00 0A 03 00 50 E3 04 00 00 0A ?? ?? ?? EB 00 60 A0 E3 16 30 A0 E3 00 30 80 E5 10 00 00 EA 48 10 9F E5 12 60 A0 E3 00 00 54 E3 00 00 55 13 0B 00 00 0A 04 00 56 E1 03 00 00 8A 05 00 A0 E1 06 20 A0 E1 ?? ?? ?? EB 05 00 00 EA 01 20 44 E2 05 00 A0 E1 ?? ?? ?? EB 04 20 85 E0 00 30 A0 E3 01 30 42 E5 06 00 A0 E1 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_inet_aton_f969b0dfabe50b8d338e340a5e4bae8d {
	meta:
...
rule _pthread_cleanup_pop_restore_c1a17eded551bc06df3e5ad386215ad4 {
	meta:
		aliases = "_pthread_cleanup_pop_restore"
		size = "32"
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { 00 00 51 E3 04 E0 2D E5 00 30 A0 E1 04 F0 9D 04 04 00 90 E5 0F E0 A0 E1 00 F0 93 E5 04 F0 9D E4 }
	condition:
		$pattern
}

rule __GI_xdrrec_endofrecord_27be5ee1f052b4002c99129e090a5d71 {
	meta:
...
rule strnlen_3a16e42e1b25afa75566a45c10cab1e8 {
	meta:
...
rule __GI_strlcpy_5d445bc672e3f71d5e5815df3d7e3390 {
	meta:
...
rule versionsort_83d05895d963825cf6af6500a45ff860 {
	meta:
...
rule versionsort64_e2b0c6410971199a5d896458bd818c1e {
	meta:
...
rule __errno_location_e58b6c68de6f2c99d5beb6298a089abb {
	meta:
		aliases = "__GI___h_errno_location, __GI___errno_location, __h_errno_location, __res_state, __libc_pthread_init, __errno_location"
		size = "12"
...
rule _flushlbf_fc8ec5668766e9d4bf46e8a92f82ac48 {
	meta:
		aliases = "getlogin, __open_etc_hosts, __pthread_once_fork_prepare, hdestroy, __pthread_once_fork_parent, __GI_getlogin, _flushlbf"
		size = "12"
		objfiles = "mutex@libpthread.a, read_etc_hosts_r@libc.a, hsearch@libc.a, getlogin@libc.a, _flushlbf@libc.a"
	strings:
...
rule _Unwind_FindEnclosingFunction_6784a51311637d8b420ae445bb38bfaa {
	meta:
		aliases = "__gthread_active_p, pthread_attr_destroy, _Unwind_GetRegionStart, __pthread_mutexattr_destroy, __udiv_w_sdiv, __GI_pthread_condattr_destroy, wcsftime, _Unwind_GetDataRelBase, pthread_rwlockattr_destroy, clntraw_control, _svcauth_null, __gthread_mutex_lock, pthread_mutexattr_destroy, __gthread_mutex_unlock, __pthread_mutex_init, __pthread_mutex_trylock, __pthread_mutex_unlock, __GI_pthread_attr_destroy, _Unwind_GetTextRelBase, grantpt, xdrstdio_inline, __pthread_mutex_lock, __pthread_return_0, __GI_pthread_condattr_init, pthread_condattr_destroy, authnone_refresh, pthread_condattr_init, _Unwind_FindEnclosingFunction"
		size = "8"
		objfiles = "xdr_stdio@libc.a, _udiv_w_sdiv@libgcc.a, mutex@libpthread.a, clnt_raw@libc.a, auth_none@libc.a"
	strings:
...
rule __libc_sa_len_49ef6365709ad7d9ad42b8aba0aea5af {
	meta:
		aliases = "__libc_sa_len"
		size = "52"
		objfiles = "sa_len@libc.a"
	strings:
		$pattern = { 00 08 A0 E1 20 08 A0 E1 02 00 50 E3 10 00 A0 03 0E F0 A0 01 0A 00 50 E3 03 00 00 0A 01 00 50 E3 70 00 A0 03 00 00 A0 13 0E F0 A0 E1 1C 00 A0 E3 0E F0 A0 E1 }
	condition:
		$pattern
}
...
rule srand48_c102ded2904d5b1c7d2f9a901aa4e61b {
	meta:
		aliases = "ether_aton, inet_ntoa, asctime, hcreate, __GI_inet_ntoa, ether_ntoa, __GI_asctime, srand48"
		size = "12"
		objfiles = "hsearch@libc.a, srand48@libc.a, asctime@libc.a, ether_addr@libc.a, inet_ntoa@libc.a"
	strings:
...
rule atol_deef6c6063aa04a17c5a206f19cbcf02 {
	meta:
		aliases = "atoi, __GI_atoi, atoll, atol"
		size = "12"
...
rule atof_7cbf426d061c005a73514c9fc2b9103b {
	meta:
		aliases = "_setjmp, sigpause, atof"
		size = "8"
		objfiles = "bsd__setjmp@libc.a, atof@libc.a, sigpause@libc.a"
	strings:
...
rule pthread_cond_broadcast_08952126cd41324e86caf0a4a8024c20 {
	meta:
...
rule __ieee754_lgamma_9126d5dc6e7144618f0e6e40fd40fbef {
	meta:
		aliases = "strtok, lgamma, __GI_strtok, __GI_lgamma, gamma, __ieee754_lgamma"
		size = "12"
...
rule wcscoll_a3b541edbf35adc36810dbf35431bc47 {
	meta:
		aliases = "__GI_wcscoll, wcscmp, __GI_wcscmp, wcscoll"
		size = "52"
...
rule __GI_strcpy_add200a8cd676cf7c447f2cceddef1da {
	meta:
...
rule __GI_wcscat_85260f4a56dae149f3ebc845e5e338c9 {
	meta:
...
rule wcspbrk_060c54492cfae5f406bc497e2cb4a9cb {
	meta:
...
rule __GI_strpbrk_7cef120fdbb5f26a5322dd28e6c78540 {
	meta:
...
rule __GI_ntohl_f0439868045060aec9db8c8f877016ab {
	meta:
...
rule __GI_vwarnx_7c2bd699fa7c9edfa23b3f72e021ceee {
	meta:
		aliases = "vwarnx, __GI_vwarnx"
		size = "8"
		objfiles = "err@libc.a"
	strings:
		$pattern = { 00 20 A0 E3 BD FF FF EA }
	condition:
		$pattern
}
...
rule sigaddset_fd9ce6819bfc06c14eb42fa50fbc768c {
	meta:
		aliases = "__GI_sigaddset, sigdelset, __GI_sigdelset, sigismember, sigaddset"
		size = "48"
...
rule pthread_mutexattr_getkind_np_0b416f364d729a7dc563889c583f0308 {
	meta:
		aliases = "__GI_pthread_attr_getdetachstate, __pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, pthread_mutexattr_gettype, pthread_mutexattr_getkind_np"
		size = "16"
...
rule __aeabi_atexit_f709691e062d392299ffb9a8e40e31de {
	meta:
		aliases = "__aeabi_atexit"
		size = "16"
		objfiles = "aeabi_atexit@libc.a"
	strings:
		$pattern = { 00 30 A0 E1 01 00 A0 E1 03 10 A0 E1 ?? ?? ?? EA }
	condition:
		$pattern
}
...
rule strtoumax_843f778e2f492a8c473fdc97c05cc653 {
	meta:
		aliases = "__GI_strtoul, waitpid, strtouq, __GI_waitpid, wcstouq, strtoull, strtoul, wcstoull, wcstoul, wcstoumax, __libc_waitpid, strtoumax"
		size = "8"
...
rule ffsl_8918bf46bc0226922438e003d2d934e0 {
	meta:
...
rule _start_67bc6d53a9159dd28ed291f37163c145 {
	meta:
		aliases = "_start"
		size = "88"
		objfiles = "Scrt1"
	strings:
		$pattern = { 00 B0 A0 E3 00 E0 A0 E3 04 10 9D E4 0D 20 A0 E1 04 20 2D E5 04 00 2D E5 28 A0 9F E5 24 30 8F E2 03 A0 8A E0 20 C0 9F E5 0C 00 9A E7 04 00 2D E5 18 C0 9F E5 0C 30 9A E7 14 C0 9F E5 0C 00 9A E7 ?? ?? ?? ?? ?? ?? ?? EB ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule strverscmp_a2cf6695fa3a940ca1768f33857d13eb {
	meta:
...
rule pthread_rwlockattr_setkind_np_7bcc34872ff84de30e032d1df0c50b3f {
	meta:
...
rule pthread_attr_setinheritsched_c9dfd86fe3074e75abe54f04069c35e7 {
	meta:
...
rule __GI_seteuid_6a9f10f29cd6a8b190eb4840a9cb8159 {
	meta:
...
rule old_sem_extricate_func_1ce4a30a252936ca418941b102aaafc1 {
	meta:
		aliases = "xdr_void, __GI_xdr_void, authnone_validate, __GI__stdlib_mb_cur_max, _stdlib_mb_cur_max, old_sem_extricate_func"
		size = "8"
		objfiles = "_stdlib_mb_cur_max@libc.a, auth_none@libc.a, xdr@libc.a, oldsemaphore@libpthread.a"
	strings:
...
rule __ieee754_log10_494ce340f3c17c2f1cdb437a6090a2d6 {
	meta:
...
rule __GI___sigismember_cd47bd13fa76ee3371e06c499250e6bc {
	meta:
...
rule dlclose_a12988587fadc14eb9ebaa1085e5950c {
	meta:
		aliases = "dlclose"
		size = "8"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { 01 10 A0 E3 32 FF FF EA }
	condition:
		$pattern
}

rule iswalnum_7ed5691c266e6284422b683ded03d596 {
	meta:
		aliases = "setjmp, mktime, __GI_iswalnum, timelocal, iswalnum"
		size = "8"
		objfiles = "bsd_setjmp@libc.a, mktime@libc.a, iswalnum@libc.a"
	strings:
...
rule __aeabi_l2f_527956a4cba54ded633c5b77f9b19377 {
	meta:
...
rule __floatundidf_eab34c3c5ffc718a52c525c301522271 {
	meta:
...
rule __aeabi_memclr8_0efc9bd82418dead8553fc2005f25bf4 {
	meta:
		aliases = "bzero, __aeabi_memclr4, mq_getattr, mkostemp, __aeabi_memclr, gmtime_r, __aeabi_memclr8"
		size = "12"
		objfiles = "mq_getsetattr@librt.a, bzero@libc.a, gmtime_r@libc.a, mkstemp@libc.a, aeabi_memclr@libc.a"
	strings:
...
rule mkostemp64_c2504e89396002e9111f936c236ff312 {
	meta:
		aliases = "mkostemp64"
		size = "12"
		objfiles = "mkstemp64@libc.a"
	strings:
		$pattern = { 01 20 A0 E1 01 10 A0 E3 ?? ?? ?? EA }
	condition:
		$pattern
}
...
rule vwprintf_f2068c4f7ded18dcf76a6cb2fc8fc546 {
	meta:
		aliases = "vscanf, vprintf, vwscanf, vwprintf"
		size = "28"
...
rule __GI_vwarn_39f9f62a873a72052822ccac1cdc9adf {
	meta:
		aliases = "vwarn, __GI_vwarn"
		size = "8"
		objfiles = "err@libc.a"
	strings:
		$pattern = { 01 20 A0 E3 A2 FF FF EA }
	condition:
		$pattern
}
...
rule __GI_towctrans_450ecab93a5e8136563391a08aa397a5 {
	meta:
...
rule __aeabi_memset_87c2b21d9cfd0301ab3442ccfabf9289 {
	meta:
		aliases = "__aeabi_memset4, __aeabi_memset8, __aeabi_memset"
		size = "16"
		objfiles = "aeabi_memset@libc.a"
	strings:
		$pattern = { 01 30 A0 E1 02 10 A0 E1 03 20 A0 E1 ?? ?? ?? EA }
	condition:
		$pattern
}
...
rule strtoimax_9e5ba6842b34889a4f189c941dd42ba4 {
	meta:
		aliases = "wcstoimax, wcstoq, strtol, strtoq, wcstoll, strtoll, __GI_strtol, wcstol, __GI_strtoll, strtoimax"
		size = "8"
...
rule __GI_cfsetospeed_e54ffa9fca4a97f266df10f2497e5546 {
	meta:
...
rule pthread_attr_setschedpolicy_5e65d41a68945d7a14b6d638fe2d90aa {
	meta:
...
rule _svcauth_short_ae78ace192a33af724e3cae5712c1237 {
	meta:
		aliases = "svcudp_stat, rendezvous_stat, svcraw_stat, _svcauth_short"
		size = "8"
		objfiles = "svc_raw@libc.a, svc_unix@libc.a, svc_tcp@libc.a, svc_authux@libc.a, svc_udp@libc.a"
	strings:
...
rule __GI___signbitf_4b8f21fb04c77b43d51bc2a86522ce44 {
	meta:
		aliases = "__signbitf, __GI___signbit, __signbit, __GI___signbitf"
		size = "8"
...
rule __negdf2_91f9f13c92a8ce442cf9c1dcc6a7dfff {
	meta:
		aliases = "__negsf2, __aeabi_dneg, __aeabi_fneg, __negdf2"
		size = "8"
...
rule gethostbyname_17222c4b56e0ab010d86f312ed5d6f85 {
	meta:
...
rule __subdf3_7e00cb5cbd4c014f146f2e99671140ca {
	meta:
...
rule ilogb_792d82ebe8e9aabcca890e2a6651d5a3 {
	meta:
		aliases = "__GI_ilogb, ilogb"
		size = "116"
		objfiles = "s_ilogb@libm.a"
	strings:
		$pattern = { 02 21 C0 E3 01 06 52 E3 10 40 2D E9 01 40 A0 E1 0D 00 00 AA 01 30 A0 E1 04 10 92 E1 06 01 A0 03 10 80 BD 08 00 00 52 E3 38 00 9F 05 38 00 9F 15 82 35 A0 11 01 00 00 EA 01 00 40 E2 83 30 A0 E1 00 00 53 E3 FB FF FF CA 10 80 BD E8 1C 30 9F E5 03 00 52 E1 42 3A A0 D1 FF 0F 43 D2 02 01 E0 C3 03 00 40 D2 10 80 BD E8 ED FB FF FF 02 FC FF FF FF FF EF 7F }
	condition:
		$pattern
}

rule __GI_openat64_3ed0c5b5c9a70a45d580ece21bfd7151 {
	meta:
		aliases = "openat64, __GI_openat64"
		size = "8"
		objfiles = "openat64@libc.a"
	strings:
		$pattern = { 02 28 82 E3 ?? ?? ?? EA }
	condition:
		$pattern
}
...
rule __floatsisf_fa7be2f3021c58b4ff47704126dc81bd {
	meta:
...
rule logb_d346714b7be1310995a6eccd5ae0df7e {
	meta:
...
rule __pthread_mutexattr_settype_bfe2e818c796d7dd38f1a0656161489e {
	meta:
...
rule iswblank_6c2d4e3d9f49a2d6a2d6bdfd2fd13202 {
	meta:
		aliases = "iswblank"
		size = "8"
...
rule __pthread_mutexattr_init_07a2b4878aa47260ada39f96e63e4140 {
	meta:
...
rule __aeabi_uidivmod_bed41a5928bd8d6776aa3ebccbfb418a {
	meta:
...
rule __GI_memccpy_9adac26429eaccd5e879255b3bd3971c {
	meta:
...
rule __GI_wmemchr_e5a99abfcfa2665b580f750f784b1920 {
	meta:
...
rule wcschrnul_d0ee039838254623384258d214df3d2d {
	meta:
		aliases = "wcschrnul"
		size = "28"
...
rule __GI_svcudp_create_f8f9b8227ad35f4bc4d3729a86a7fbfd {
	meta:
...
rule __libc_current_sigrtmin_5762a499c2b87f8f0b5af31c6e1fff14 {
	meta:
		aliases = "pthread_getconcurrency, __libc_current_sigrtmax, __pthread_getconcurrency, _Unwind_SjLj_GetContext, __libc_current_sigrtmin"
		size = "16"
		objfiles = "pthread@libpthread.a, allocrtsig@libc.a, unwind_sjlj@libgcc_eh.a"
	strings:
...
rule _dl_app_init_array_050e28cf6bc58150f630cc4dc9018b17 {
	meta:
...
rule execv_b1a59bedbd6958509ecb5f54b8dcbab4 {
	meta:
...
rule __GI_strlcat_cd64962b53d3b8e402ed5618343b8078 {
	meta:
...
rule __GI_mknodat_a7d4d68355b066a1d7cb90adefb0a014 {
	meta:
...
rule __GI_glob_pattern_p_d8e6cf8ed5f22edef07aa0dab1d0410b {
	meta:
...
rule __GI_wcswidth_20bb2272596b9cd4e80a3647909c3400 {
	meta:
...
rule __aeabi_assert_ce597521b9ad59932599a8a24f5a3896 {
	meta:
		aliases = "__aeabi_assert"
		size = "12"
		objfiles = "aeabi_assert@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 00 30 A0 E3 ?? ?? ?? EB }
	condition:
		$pattern
}

rule lutimes_71db21667e7999f53e3acf5d602704c8 {
	meta:
		aliases = "lutimes"
		size = "156"
		objfiles = "lutimes@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 00 C0 51 E2 10 D0 4D E2 18 00 00 0A 80 30 9F E5 04 20 9C E5 03 00 52 E1 04 00 00 8A 0C 10 9C E5 00 00 51 E3 01 00 00 BA 03 00 51 E1 04 00 00 DA ?? ?? ?? EB 16 30 A0 E3 00 20 E0 E3 00 30 80 E5 10 00 00 EA FA 3F A0 E3 93 02 02 E0 93 01 01 E0 00 30 9C E5 04 20 8D E5 00 30 8D E5 08 30 9C E5 0D 20 A0 E1 08 30 8D E5 0C 10 8D E5 00 00 00 EA 0C 20 A0 E1 00 10 A0 E1 01 3C A0 E3 63 00 E0 E3 ?? ?? ?? EB 00 20 A0 E1 02 00 A0 E1 10 D0 8D E2 00 80 BD E8 3F 42 0F 00 }
	condition:
		$pattern
}

rule wcsstr_c24dc77fdb81feebfd647206e579a11d {
	meta:
...
rule stpncpy_d8caebb526cb423242b15226d414e77a {
	meta:
		aliases = "stpncpy"
		size = "64"
...
rule clnttcp_control_838480c72d43803c8e8ee70683a60d45 {
	meta:
		aliases = "clnttcp_control"
		size = "388"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 01 10 41 E2 02 C0 A0 E1 08 00 90 E5 0E 00 51 E3 01 F1 9F 97 0E 00 00 EA ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 00 E0 A0 E3 46 00 00 EA 01 30 A0 E3 03 E0 A0 E1 01 00 00 EA 01 E0 A0 E3 00 30 A0 E3 04 30 80 E5 3F 00 00 EA 0A 00 92 E8 01 20 A0 E3 02 E0 A0 E1 0C 30 80 E5 08 10 80 E5 10 20 80 E5 38 00 00 EA 0C 20 90 E5 08 30 90 E5 01 E0 A0 E3 00 30 8C E5 04 20 8C E5 32 00 00 EA 14 30 80 E2 0F 00 93 E8 01 E0 A0 E3 0F 00 8C E8 2D 00 00 EA 00 30 90 E5 }
	condition:
		$pattern
}

rule clntudp_control_bd8f71626c95d7b32227a59ed444748a {
	meta:
		aliases = "clntudp_control"
		size = "444"
		objfiles = "clnt_udp@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 01 10 41 E2 02 C0 A0 E1 08 00 90 E5 0E 00 51 E3 01 F1 9F 97 0E 00 00 EA ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 00 E0 A0 E3 54 00 00 EA 01 30 A0 E3 03 E0 A0 E1 01 00 00 EA 01 E0 A0 E3 00 30 A0 E3 04 30 80 E5 4D 00 00 EA 04 20 92 E5 00 30 9C E5 01 E0 A0 E3 24 30 80 E5 28 20 80 E5 47 00 00 EA 28 20 90 E5 24 30 90 E5 07 00 00 EA 04 20 92 E5 00 30 9C E5 01 E0 A0 E3 1C 30 80 E5 20 20 80 E5 3E 00 00 EA 20 20 90 E5 1C 30 90 E5 01 E0 A0 E3 00 30 8C E5 }
	condition:
		$pattern
}
...
rule __GI_re_search_de99b3bc9eb29b2ed745888652e52299 {
	meta:
...
rule fputwc_unlocked_7caa6be5d6b3a9130f4263d980dd8a3c {
	meta:
...
rule __GI_tcgetpgrp_6df4fc4afad056198489592ff1c09cbe {
	meta:
...
rule getservent_a113d635536d0493244ea39ef31858c1 {
	meta:
		aliases = "getservent"
		size = "56"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 04 D0 4D E2 A3 FE FF EB 1C 30 9F E5 13 2E A0 E3 00 10 93 E5 14 00 9F E5 0D 30 A0 E1 ?? ?? ?? EB 00 00 9D E5 04 D0 8D E2 00 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule getprotoent_e310dd7714018c81591376599eaedc90 {
	meta:
		aliases = "getprotoent"
		size = "56"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 04 D0 4D E2 C2 FE FF EB 1C 30 9F E5 4B 2F A0 E3 00 10 93 E5 14 00 9F E5 0D 30 A0 E1 ?? ?? ?? EB 00 00 9D E5 04 D0 8D E2 00 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule call_frame_dummy_997de91c60dfeaa7966cf399b0caa4a3 {
	meta:
		...
		size = "8"
		objfiles = "crtbeginS, crtendS, crtbegin, crtbeginT, crtend"
	strings:
...
rule fgetgrent_782ead4dc851d14a304b763550b392bd {
	meta:
		aliases = "sgetspent, fgetspent, getgrnam, getspnam, fgetpwent, getpwuid, getpwnam, getgrgid, fgetgrent"
		size = "52"
		objfiles = "getgrnam@libc.a, getpwuid@libc.a, fgetspent@libc.a, fgetgrent@libc.a, fgetpwent@libc.a"
	strings:
...
rule getdtablesize_4afae0664d18865adaff58386ce86a79 {
	meta:
...
rule gethostent_6ed78fd888d132bc937944fa40b3b891 {
	meta:
		aliases = "gethostent"
		size = "56"
		objfiles = "gethostent@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 08 D0 4D E2 ?? ?? ?? EB 1C 10 9F E5 00 00 8D E5 6A 20 A0 E3 04 30 8D E2 10 00 9F E5 ?? ?? ?? EB 04 00 9D E5 08 D0 8D E2 00 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule getnetent_82b94a0abe198b01499bcc7481608714 {
	meta:
		aliases = "getnetent"
		size = "64"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { 04 E0 2D E5 0C D0 4D E2 9C FE FF EB 24 30 9F E5 04 C0 8D E2 00 10 93 E5 4B 2F A0 E3 08 30 8D E2 14 00 9F E5 00 C0 8D E5 ?? ?? ?? EB 08 00 9D E5 0C D0 8D E2 00 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule svcerr_decode_6576fbe8d99769bcd2ff8685395aefd0 {
	meta:
...
rule svctcp_stat_528219036dcb20e6c9ace897fd810347 {
	meta:
...
rule ftello_bf951bc17031556e0a73a0c404c867fd {
	meta:
...
rule lroundf_c4ff7ef54e5728e438def535189f6899 {
	meta:
		aliases = "llrintf, lrintf, ilogbf, llroundf, lroundf"
		size = "16"
...
rule clnt_pcreateerror_8213424d9423719eb0f7c5bff68b7e51 {
	meta:
		aliases = "clnt_perror, __GI_clnt_perror, clnt_perrno, clnt_pcreateerror"
		size = "28"
...
rule __GI___rpc_thread_svc_pollfd_7943d65cbf1030d8c94cdc3be4616c49 {
	meta:
...
rule log10f_3a1a777b192db480491cbf217784f1e6 {
	meta:
		aliases = "log2f, fabsf, gammaf, log1pf, sqrtf, tanf, floorf, coshf, erff, cosf, sinf, logf, ceilf, expm1f, cbrtf, truncf, rintf, erfcf, asinhf, atanhf, tanhf, acoshf, asinf, significandf, acosf, atanf, expf, exp2f, roundf, logbf, lgammaf, sinhf, log10f"
		size = "20"
		objfiles = "acosf@libm.a, erfcf@libm.a, coshf@libm.a, atanf@libm.a, expm1f@libm.a"
	strings:
...
rule pthread_self_8f367ed3219e3d5fd0c0bc2376ef7b6d {
	meta:
...
rule _pthread_cleanup_push_defer_0018b48b72bdd670d87dc6dd79ba806c {
	meta:
		aliases = "_pthread_cleanup_push_defer"
		size = "8"
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { 06 00 80 E8 0E F0 A0 E1 }
	condition:
		$pattern
}
...
rule mkstemp64_799d2f898fc28777be6df400b30fa4b3 {
	meta:
		aliases = "mkstemp, mkstemp64"
		size = "8"
		objfiles = "mkstemp@libc.a, mkstemp64@libc.a"
	strings:
		$pattern = { 06 1D A0 E3 ?? ?? ?? EA }
	condition:
		$pattern
}
...
rule iswprint_e87ecd6007c43af8a4cff8e467fc8f30 {
	meta:
		aliases = "iswprint"
		size = "8"
...
rule __aeabi_fcmplt_f52cbcbfa58e06c8588cd1fb7e67afd3 {
	meta:
		aliases = "__aeabi_fcmpgt, __aeabi_dcmpgt, __aeabi_dcmplt, __aeabi_fcmplt"
		size = "20"
		objfiles = "_cmpsf2@libgcc.a, _cmpdf2@libgcc.a"
	strings:
...
rule __aeabi_dcmpge_ff7f5d7fa2e5dc60f94d507ce6a3303e {
	meta:
		aliases = "__aeabi_fcmple, __aeabi_dcmple, __aeabi_fcmpge, __aeabi_dcmpge"
		size = "20"
		objfiles = "_cmpsf2@libgcc.a, _cmpdf2@libgcc.a"
	strings:
...
rule iswspace_e559dde6399cc52f2862797e0d4a7543 {
	meta:
...
rule error_03cd2cc123bc8b72a0794f34fe3dc316 {
	meta:
...
rule hasmntopt_08b4e65aaf4f38d26d8e654cc6b48e5f {
	meta:
...
rule iswxdigit_0ac1341a542d0c081ad0900148c7008c {
	meta:
		aliases = "iswxdigit"
		size = "8"
...
rule __pthread_mutex_trylock_1eed71c640b5c1ecd7469944cd03519a {
	meta:
...
rule __GI___finite_3075b6565865386272c8000be88223da {
	meta:
...
rule do_dlclose_e0c4061db76993369d59b57e0b721cef {
	meta:
		aliases = "do_dlclose"
		size = "812"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { 0C 33 9F E5 00 30 93 E5 03 00 50 E1 F0 4F 2D E9 00 70 A0 E1 01 90 A0 E1 BB 00 00 0A F4 32 9F E5 00 30 93 E5 00 10 A0 E3 03 00 00 EA 07 00 53 E1 08 00 00 0A 03 10 A0 E1 04 30 93 E5 00 00 53 E3 F9 FF FF 1A D0 32 9F E5 0A 20 A0 E3 01 00 A0 E3 00 20 83 E5 F0 8F BD E8 00 00 51 E3 04 20 97 E5 B0 32 9F 05 04 20 81 15 00 20 83 05 00 10 97 E5 20 20 D1 E5 21 30 D1 E5 03 24 82 E1 01 00 52 E3 05 00 00 1A 24 30 91 E5 01 3A 13 E2 80 B2 9F 05 03 80 A0 01 03 A0 A0 01 7D 00 00 0A 01 20 42 E2 42 34 A0 E1 07 00 A0 E1 21 30 C1 E5 20 20 C1 E5 ?? ?? ?? EB 00 00 A0 E3 F0 8F BD E8 08 30 97 E5 08 61 93 E7 20 30 96 E5 }
	condition:
		$pattern
}

rule __GI_time_70dee9cf10a09cac3c91b6a1e656bd49 {
	meta:
...
rule __GI_pthread_exit_1e423e89f7cf43840d40d6a114185834 {
	meta:
...
rule __GI_nanf_a8a3d1de9b0d64d661bce7f4ac83552b {
	meta:
...
rule __GI_glob_9f4738c76ad8f02cef784ad4581e8465 {
	meta:
...
rule glob64_0e8f35ea345e69137e9dbc269364d0d8 {
	meta:
...
rule if_nameindex_57e717c27391f027286624d55581d591 {
	meta:
		aliases = "__GI_if_nameindex, if_nameindex"
		size = "408"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { 0D C0 A0 E1 F0 DF 2D E9 04 B0 4C E2 08 D0 4D E2 ?? ?? ?? EB 00 70 50 E2 15 00 00 BA 00 30 A0 E3 2C 30 0B E5 80 50 A0 E3 30 60 4B E2 85 40 A0 E1 06 30 84 E2 03 30 C3 E3 0D D0 63 E0 2C 30 1B E5 04 C0 8D E0 03 00 5C E1 05 40 84 00 07 00 A0 E1 38 11 9F E5 06 20 A0 E1 2C D0 0B E5 30 40 0B E5 ?? ?? ?? EB 00 00 50 E3 03 00 00 AA 07 00 A0 E1 06 00 90 EF 00 A0 A0 E3 41 00 00 EA 30 00 1B E5 04 00 50 E1 00 50 A0 E1 E7 FF FF 0A A0 92 A0 E1 01 00 89 E2 80 01 A0 E1 ?? ?? ?? EB 00 A0 50 E2 00 60 A0 13 2D 00 00 1A 07 00 A0 E1 06 00 90 EF ?? ?? ?? EB 69 30 A0 E3 00 30 80 E5 30 00 00 EA 2C 30 1B E5 86 42 83 E0 }
	condition:
		$pattern
}
...
rule gaih_inet_c4db1e8557f2ddcb21c92cb068df9ad4 {
	meta:
		aliases = "gaih_inet"
		size = "2788"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { 0D C0 A0 E1 F0 DF 2D E9 04 B0 4C E2 94 D0 4D E2 02 80 A0 E1 04 20 92 E5 0A 00 52 E3 00 00 52 13 A0 30 0B E5 00 30 98 05 00 20 A0 13 01 20 A0 03 A3 31 A0 01 9C 20 0B 15 01 30 03 02 00 70 A0 E1 01 60 A0 E1 4C 00 4B E2 00 10 A0 E3 10 20 A0 E3 9C 30 0B 05 ?? ?? ?? EB 0C 00 98 E5 00 00 50 E3 14 00 00 1A 08 30 98 E5 00 00 53 E3 11 00 00 1A 19 00 00 EA 00 00 52 E3 03 00 00 0A 00 30 D1 E5 03 3C A0 E1 43 0C 52 E1 08 00 00 1A 00 00 50 E3 12 00 00 0A 01 30 D1 E5 03 3C A0 E1 43 0C 50 E1 0E 00 00 0A 02 30 D1 E5 02 00 13 E3 0B 00 00 1A 08 10 81 E2 00 00 00 EA FC 19 9F E5 03 30 D1 E5 00 00 53 E3 08 20 98 E5 }
	condition:
		$pattern
}
...
rule ruserpass_f0cfe6b390974686bc2b43bc64d46788 {
	meta:
		aliases = "ruserpass"
		size = "836"
...
rule open64_514b27a82d8ef887189958fd0549252f {
	meta:
...
rule fscanf_b894f9a4909b4c2528ee0248ddf88a00 {
	meta:
		aliases = "fwscanf, __GI_asprintf, sscanf, syslog, dprintf, fprintf, __GI_syslog, asprintf, fwprintf, __GI_fscanf, __GI_fprintf, __GI_sscanf, swscanf, fscanf"
		size = "48"
		objfiles = "dprintf@libc.a, asprintf@libc.a, fprintf@libc.a, swscanf@libc.a, sscanf@libc.a"
	strings:
...
rule __fcntl_nocancel_020c542ee4d79c9605a3df9ed7c26a55 {
	meta:
		aliases = "fcntl, __GI___fcntl_nocancel, __GI_fcntl, __libc_fcntl, __GI___libc_fcntl, __fcntl_nocancel"
		size = "100"
		objfiles = "__syscall_fcntl@libc.a"
	strings:
		$pattern = { 0E 00 2D E9 10 40 2D E9 04 D0 4D E2 0C 10 9D E5 0C 30 41 E2 02 00 53 E3 14 30 8D E2 00 30 8D E5 10 20 9D E5 01 00 00 8A DD 00 90 EF 00 00 00 EA 37 00 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 04 D0 8D E2 10 40 BD E8 0C D0 8D E2 0E F0 A0 E1 }
	condition:
		$pattern
}

rule __libc_open_6386fddfbd0437a794e8de24796d33bc {
	meta:
...
rule pthread_handle_sigdebug_ff401781bc6d986f859a23f7108da64e {
	meta:
		aliases = "clntunix_abort, authnone_destroy, __aeabi_unwind_cpp_pr0, __linuxthreads_death_event, clntraw_abort, xdrmem_destroy, __gnat_default_lock, __gcov_flush, clnttcp_abort, __linuxthreads_create_event, __div0, __stub1, __gcov_merge_delta, pthread_null_sighandler, __gcov_merge_add, __linuxthreads_reap_event, authnone_verf, authunix_nextverf, __cyg_profile_func_exit, __cyg_profile_func_enter, __aeabi_unwind_cpp_pr2, clntraw_geterr, svcraw_destroy, __gcov_merge_single, __gcov_init, clntudp_abort, __aeabi_unwind_cpp_pr1, __stub2, __enable_execute_stack, __aeabi_ldiv0, clntraw_destroy, __gnat_default_unlock, noop_handler, __aeabi_idiv0, pthread_handle_sigdebug"
		size = "4"
		objfiles = "_gcov@libgcov.a, clnt_unix@libc.a, _dvmd_tls@libgcc.a, svc_raw@libc.a, auth_none@libc.a"
	strings:
		$pattern = { 0E F0 A0 E1 }
	condition:
		$pattern
...
rule __pthread_kill_other_threads_n_500ce6a5a728fa826815334fe85fbcf5 {
	meta:
...
rule __libc_pause_44d39cd7061e7ac0a8ef0eb14dd64ff1 {
	meta:
		aliases = "pause, __libc_pause"
		size = "44"
		objfiles = "pause@libc.a"
	strings:
		$pattern = { 10 40 2D E9 00 00 A0 E3 08 D0 4D E2 00 10 A0 E1 0D 20 A0 E1 ?? ?? ?? EB 0D 00 A0 E1 0D 40 A0 E1 ?? ?? ?? EB 08 D0 8D E2 10 80 BD E8 }
	condition:
		$pattern
}
...
rule __sigwaitinfo_05e4308b6b5fd9e4ce50521bab264662 {
	meta:
		aliases = "__GI_sigwaitinfo, sigwaitinfo, __sigwaitinfo"
		size = "52"
		objfiles = "__rt_sigwaitinfo@libc.a"
	strings:
		$pattern = { 10 40 2D E9 00 20 A0 E3 08 30 A0 E3 B1 00 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 40 E0 E3 04 00 A0 E1 10 80 BD E8 }
	condition:
		$pattern
}
...
rule wcrtomb_7e8e101d1b6e1ba29cc0c1db789c0891 {
	meta:
...
rule tmpnam_r_dfa874a3e8a53af48948a29c54117eb3 {
	meta:
		aliases = "tmpnam_r"
		size = "72"
		objfiles = "tmpnam_r@libc.a"
	strings:
		$pattern = { 10 40 2D E9 00 40 50 E2 0B 00 00 0A 00 20 A0 E3 14 10 A0 E3 02 30 A0 E1 ?? ?? ?? EB 00 00 50 E3 05 00 00 1A 00 20 A0 E1 03 10 A0 E3 04 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 00 00 00 0A 00 40 A0 E3 04 00 A0 E1 10 80 BD E8 }
	condition:
		$pattern
}

rule __GI_config_close_fc9baf0b9093f8df56c93b5244aca863 {
	meta:
		aliases = "__GI_config_close"
		size = "48"
		objfiles = "parse_config@libc.a"
	strings:
		$pattern = { 10 40 2D E9 00 40 50 E2 10 80 BD 08 00 00 94 E5 ?? ?? ?? EB 14 30 94 E5 00 00 53 E3 04 00 94 15 ?? ?? ?? 1B 04 00 A0 E1 10 40 BD E8 ?? ?? ?? EA }
	condition:
		$pattern
}
...
rule canonicalize_file_name_ccbe109e5175ef779571be66781d195f {
	meta:
		aliases = "canonicalize_file_name"
		size = "44"
		objfiles = "canonicalize@libc.a"
	strings:
		$pattern = { 10 40 2D E9 00 40 A0 E1 01 0A A0 E3 ?? ?? ?? EB 00 10 50 E2 10 80 BD 08 00 30 A0 E3 04 00 A0 E1 00 30 C1 E5 10 40 BD E8 ?? ?? ?? EA }
	condition:
		$pattern
}
...
rule __GI_login_tty_854a04f11b9b9fbe0f37c366af1aa6ef {
	meta:
...
rule raise_df0ba4b637da733d0113c35855deb6cc {
	meta:
		aliases = "__GI_raise, raise"
		size = "48"
...
rule sleep_d03d3c242bbf8a7caba3573e887bc394 {
	meta:
		aliases = "__GI_sleep, sleep"
		size = "168"
		objfiles = "sleep@libc.a"
	strings:
		$pattern = { 10 40 2D E9 00 C0 50 E2 24 D0 4D E2 0C 40 A0 01 20 00 00 0A 00 40 A0 E3 01 38 A0 E3 11 00 A0 E3 04 10 A0 E1 0D 20 A0 E1 14 30 8D E5 1C C0 8D E5 18 40 8D E5 20 40 8D E5 ?? ?? ?? EB 00 30 9D E5 01 00 53 E3 14 10 8D 02 04 00 A0 01 01 20 A0 01 ?? ?? ?? 0B 1C 00 8D E2 00 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 00 40 A0 01 05 00 00 0A 20 10 9D E5 2C 20 9F E5 1C 30 9D E5 02 00 51 E1 03 40 A0 D1 01 40 83 C2 14 30 9D E5 01 28 13 E2 02 00 A0 03 14 10 8D 02 ?? ?? ?? 0B 04 00 A0 E1 24 D0 8D E2 10 80 BD E8 FF 64 CD 1D }
	condition:
		$pattern
}

rule __GI_ppoll_6cf217a123d64a6d95b8569e0ba4cf32 {
	meta:
...
rule tempnam_f6162bacd4418f98a7a12bcf5bce53b1 {
	meta:
		aliases = "tempnam"
		size = "96"
		objfiles = "tempnam@libc.a"
	strings:
		$pattern = { 10 40 2D E9 01 DA 4D E2 10 40 8D E2 0F 40 44 E2 00 20 A0 E1 01 30 A0 E1 04 00 A0 E1 38 10 9F E5 ?? ?? ?? EB 00 00 50 E3 08 00 00 1A 00 20 A0 E1 03 10 A0 E3 04 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 02 00 00 1A 04 00 A0 E1 ?? ?? ?? EB 00 00 00 EA 00 00 A0 E3 01 DA 8D E2 10 80 BD E8 FF 0F 00 00 }
	condition:
		$pattern
}

rule __GI_fork_d4efd04ef7802809f64b53fefe9497ea {
	meta:
...
rule mkdtemp_08c237b03c73a4fdb4d86472e2e55910 {
	meta:
		aliases = "mkdtemp"
		size = "36"
		objfiles = "mkdtemp@libc.a"
	strings:
		$pattern = { 10 40 2D E9 02 10 A0 E3 07 2D A0 E3 00 40 A0 E1 ?? ?? ?? EB 00 00 50 E3 04 00 A0 01 00 00 A0 13 10 80 BD E8 }
	condition:
		$pattern
}

rule __GI_copysign_204b36bcfc565cd75b4bfcf9b6470a5f {
	meta:
...
rule fabs_cdbe71ab2a32c575f93390b1f19b6f4f {
	meta:
...
rule mktemp_4bd3072f070b2a7953ff87fc4295f611 {
	meta:
		aliases = "mktemp"
		size = "40"
		objfiles = "mktemp@libc.a"
	strings:
		$pattern = { 10 40 2D E9 03 10 A0 E3 00 20 A0 E3 00 40 A0 E1 ?? ?? ?? EB 00 00 50 E3 00 30 A0 B3 04 00 A0 E1 00 30 C4 B5 10 80 BD E8 }
	condition:
		$pattern
}
...
rule __GI_write_2c7b76ca9ac99e9009774a69de22914c {
	meta:
...
rule __GI_mbsnrtowcs_2704be0b1151ed83e6e3664d6b5301d4 {
	meta:
...
rule tcdrain_06e8dc28926387eeb84f9d2d16b42772 {
	meta:
		aliases = "fsync, system, close, wait, tcdrain"
		size = "60"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule close_390c52ad9010a56a027efa6f5f6013ed {
	meta:
...
rule __GI_sigprocmask_8d80e825c67c22e552e7421ea541105b {
	meta:
		aliases = "sigprocmask, __GI_sigprocmask"
		size = "48"
		objfiles = "sigprocmask@libc.a"
	strings:
		$pattern = { 10 40 2D E9 08 30 A0 E3 AF 00 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 40 E0 E3 04 00 A0 E1 10 80 BD E8 }
	condition:
		$pattern
}

rule __GI_sigtimedwait_c8a7a4dd60ad1babe13230227d626bf7 {
	meta:
		aliases = "__sigtimedwait, sigtimedwait, __GI_sigtimedwait"
		size = "48"
		objfiles = "__rt_sigtimedwait@libc.a"
	strings:
		$pattern = { 10 40 2D E9 08 30 A0 E3 B1 00 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 40 E0 E3 04 00 A0 E1 10 80 BD E8 }
	condition:
		$pattern
}
...
rule getprotobynumber_17e1a1c1cc51bbea684acfd989813f2f {
	meta:
		aliases = "getprotobynumber"
		size = "68"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { 10 40 2D E9 08 D0 4D E2 00 40 A0 E1 23 FF FF EB 24 30 9F E5 04 C0 8D E2 00 20 93 E5 04 00 A0 E1 18 10 9F E5 4B 3F A0 E3 00 C0 8D E5 ?? ?? ?? EB 04 00 9D E5 08 D0 8D E2 10 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule getprotobyname_0d2e6ef9c9bb5b5cb91b86fcbce74a6b {
	meta:
		aliases = "getprotobyname"
		size = "68"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { 10 40 2D E9 08 D0 4D E2 00 40 A0 E1 D2 FE FF EB 24 30 9F E5 04 C0 8D E2 00 20 93 E5 04 00 A0 E1 18 10 9F E5 4B 3F A0 E3 00 C0 8D E5 ?? ?? ?? EB 04 00 9D E5 08 D0 8D E2 10 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_unlink_f27f77f8c56553005b6b2fda48231bde {
	meta:
...
rule __GI_execve_034c7d56ecda8e98d8d0da7a9a931cb8 {
	meta:
...
rule utimes_f9f9817bcf82666dec0de0e7a6edac61 {
	meta:
...
rule fgetc_unlocked_ba13e73ea0c557d155bb10f1906ac51b {
	meta:
		aliases = "__GI___fgetc_unlocked, getc_unlocked, __fgetc_unlocked, __GI_fgetc_unlocked, __GI_getc_unlocked, fgetc_unlocked"
		size = "304"
...
rule getnetbyname_b9e2831e0e8ba572e6f6ca1c9387cbcd {
	meta:
		aliases = "getnetbyname"
		size = "76"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { 10 40 2D E9 10 D0 4D E2 00 40 A0 E1 AE FE FF EB 2C 30 9F E5 0C C0 8D E2 00 20 93 E5 04 00 A0 E1 00 C0 8D E5 1C 10 9F E5 08 C0 8D E2 4B 3F A0 E3 04 C0 8D E5 ?? ?? ?? EB 0C 00 9D E5 10 D0 8D E2 10 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule setspent_bc2a1861fc6600e47eca4f25d514c5e3 {
	meta:
...
rule __GI_endutent_97d25fff4f27d54602f8d891a417bbfa {
	meta:
		aliases = "endutent, __GI_endutent"
		size = "132"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 10 40 2D E9 10 D0 4D E2 5C 20 9F E5 0D 00 A0 E1 58 10 9F E5 58 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 44 00 9F E5 4C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 44 20 9F E5 00 00 92 E5 00 00 50 E3 0D 40 A0 E1 00 00 00 BA 06 00 90 EF 00 30 E0 E3 00 30 82 E5 0D 00 A0 E1 01 10 A0 E3 20 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 10 D0 8D E2 10 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule lseek_907e4dd8519212da476d92911d86f5c8 {
	meta:
...
rule bind_56ef8fd264a624b1d66dda8a128b4017 {
	meta:
...
rule alarm_97bbb26a0889a56cb05906a9a63e787b {
	meta:
...
rule __GI_listen_fa87a4bc4f118e808afd7edf1a08400a {
	meta:
...
rule __GI_getsockname_0d171e6fa69aca801f16096aeb0950a4 {
	meta:
...
rule dl_cleanup_e52af7c593429f6fd3ba167de63b5ef3 {
	meta:
		aliases = "dl_cleanup"
		size = "48"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { 10 40 2D E9 20 30 9F E5 00 40 93 E5 01 00 00 EA 04 40 94 E5 2C FF FF EB 00 00 54 E3 04 00 A0 E1 01 10 A0 E3 F9 FF FF 1A 10 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __initbuf_83728f1b21b49e27d8a25c42f5337921 {
	meta:
		aliases = "__initbuf"
		size = "48"
		objfiles = "getnet@libc.a, getproto@libc.a"
	strings:
		$pattern = { 10 40 2D E9 20 40 9F E5 00 30 94 E5 00 00 53 E3 10 80 BD 18 4B 0F A0 E3 ?? ?? ?? EB 00 00 50 E3 00 00 84 E5 10 80 BD 18 ?? ?? ?? EB ?? ?? ?? ?? }
	condition:
		$pattern
}

rule getusershell_013bcff3bbc0f3a82bf03dfcd747128f {
	meta:
		aliases = "getusershell"
		size = "48"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { 10 40 2D E9 20 40 9F E5 00 30 94 E5 00 00 53 E3 ?? ?? ?? 0B 00 30 94 E5 00 00 93 E5 00 00 50 E3 04 30 83 12 00 30 84 15 10 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_config_open_624325c6b5108b1f0ac8353a5c903abc {
	meta:
		aliases = "__GI_config_open"
		size = "52"
		objfiles = "parse_config@libc.a"
	strings:
		$pattern = { 10 40 2D E9 24 10 9F E5 ?? ?? ?? EB 00 40 50 E2 04 00 A0 01 10 80 BD 08 18 10 A0 E3 01 00 A0 E3 ?? ?? ?? EB 00 00 50 E3 00 40 80 15 10 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule endhostent_unlocked_2cb47d0e75342d28d164fc82ae16868f {
	meta:
		aliases = "endhostent_unlocked"
		size = "56"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { 10 40 2D E9 24 40 9F E5 00 00 94 E5 00 00 50 E3 02 00 00 0A ?? ?? ?? EB 00 30 A0 E3 00 30 84 E5 0C 30 9F E5 00 20 A0 E3 00 20 83 E5 10 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __initbuf_118b7b5c60ac40baf6f8c8c4d8275402 {
	meta:
		aliases = "__initbuf"
		size = "52"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { 10 40 2D E9 24 40 9F E5 00 30 94 E5 00 00 53 E3 02 00 00 1A 13 0E A0 E3 ?? ?? ?? EB 00 00 84 E5 00 30 94 E5 00 00 53 E3 10 80 BD 18 ?? ?? ?? EB ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_rmdir_4c3468b66e8e960536c5b426c7e27431 {
	meta:
...
rule __libc_sendmsg_db84ab334e99c1d74b80b111b38d38d8 {
	meta:
...
rule pipe_0ef786d962381efc5077e1a95c46a6e2 {
	meta:
...
rule __GI_fstat_831e9d4595c6289896f8d2a3cdf6fe06 {
	meta:
...
rule __GI_openat_9b33a172f411e4a7b1c518e6c9e64017 {
	meta:
...
rule __GI_settimeofday_e906ee848442568a6ad73276e1a4e5fe {
	meta:
...
rule __getutent_c72c3eb1ff5598d91aed79f8ce2c3377 {
	meta:
		aliases = "__getutent"
		size = "108"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 10 40 2D E9 58 40 9F E5 00 30 94 E5 00 00 53 E3 03 00 00 AA C7 FF FF EB 00 30 94 E5 00 00 53 E3 0D 00 00 BA 00 00 94 E5 38 10 9F E5 06 2D A0 E3 03 00 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 02 00 00 EA 06 0D 50 E3 01 00 A0 01 10 80 BD 08 00 00 A0 E3 10 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule ftruncate_3a549f9e99df78ef08deb44153798bc4 {
	meta:
...
rule lstat64_9611e09cbf1e7cad790ab7b06058ff3c {
	meta:
...
rule __GI_fstat64_4017b769b5a27961b0a1361693234282 {
	meta:
...
rule fstatat_cd14db599d3167c8bf9853ab202f0caa {
	meta:
...
rule __libc_fstatfs_3901152236d21195c12b59f64b62114d {
	meta:
...
rule epoll_create1_d1a8dd15796d160102d8a387a290aef6 {
	meta:
		aliases = "epoll_create1"
		size = "44"
		objfiles = "epoll@libc.a"
	strings:
		$pattern = { 10 40 2D E9 65 01 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 10 80 BD 98 ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 10 80 BD E8 }
	condition:
		$pattern
}
...
rule pipe2_6fb7890f0dd36eed397cba281c6d8745 {
	meta:
		aliases = "__GI_pipe2, pipe2"
		size = "44"
		objfiles = "pipe2@libc.a"
	strings:
		$pattern = { 10 40 2D E9 67 01 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 10 80 BD 98 ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 10 80 BD E8 }
	condition:
		$pattern
}
...
rule inotify_init1_65d84520d0926178a04b6640e9f64f59 {
	meta:
		aliases = "inotify_init1"
		size = "44"
		objfiles = "inotify@libc.a"
	strings:
		$pattern = { 10 40 2D E9 68 01 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 10 80 BD 98 ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 10 80 BD E8 }
	condition:
		$pattern
}
...
rule accept4_dee343d403832f0f89dcdc3c914f1e2c {
	meta:
		aliases = "accept4"
		size = "44"
		objfiles = "accept4@libc.a"
	strings:
		$pattern = { 10 40 2D E9 6E 01 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 40 E0 E3 04 00 A0 E1 10 80 BD E8 }
	condition:
		$pattern
}
...
rule uname_4b7eb3f733c87452c29515043f261165 {
	meta:
...
rule adjtimex_b1a233073507c5b51f83a01b78f58152 {
	meta:
...
rule __getpgid_0ed16f478fb9c3cb14e85b8a390f6707 {
	meta:
...
rule __GI_fchdir_137e5acc80587a4d8ce6765d462cdad1 {
	meta:
...
rule mbrtowc_0e30743ea26211f865593ab0c80c1a89 {
	meta:
		aliases = "__GI_mbrtowc, mbrtowc"
		size = "156"
		objfiles = "mbrtowc@libc.a"
	strings:
		$pattern = { 10 40 2D E9 8C C0 9F E5 00 00 53 E3 10 D0 4D E2 03 E0 A0 11 0C E0 A0 01 00 C0 51 E2 00 40 A0 E1 0F C0 CD 05 0C 40 A0 01 0F C0 8D 02 08 00 00 0A 00 30 DC E5 00 00 53 E3 03 00 00 1A 00 00 54 E3 03 00 A0 11 0E 00 00 1A 0F 00 00 EA 00 00 52 E3 0D 00 00 0A 08 00 8D E2 04 10 8D E2 00 20 E0 E3 01 30 A0 E3 04 C0 8D E5 00 E0 8D E5 ?? ?? ?? EB 00 00 50 E3 05 00 00 BA 00 00 54 E3 03 00 00 0A 08 30 9D E5 00 30 84 E5 00 00 00 EA 00 00 A0 E3 10 D0 8D E2 10 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule getrpcent_33044997b988bd6dd7d50efe3a68bb0b {
	meta:
...
rule __libc_nanosleep_13befc3f8b68b1fa1887db66d1897316 {
	meta:
...
rule __GI_setresgid_4f1101a680c54e44de622cf34265340e {
	meta:
...
rule __GI_memchr_8c1436d3c755d0d7459fe2b92a7c4809 {
	meta:
...
rule rawmemchr_8c449240d3231ed329e2d0679bec07dc {
	meta:
...
rule getpid_85816026a048998130568f17b44a7e54 {
	meta:
		aliases = "__GI_getpid, getpid"
		size = "8"
		objfiles = "getpid@libc.a"
	strings:
		$pattern = { 14 00 90 EF 0E F0 A0 E1 }
	condition:
		$pattern
}
...
rule xdrmem_putint32_4fe1e45cb26d363dfedfdf2f7271fc5d {
	meta:
...
rule __GI_isalnum_03e245c133ace13950a353a77a7905ec {
	meta:
...
rule __GI_abort_a01ab6ea243c1fcd6c2b2376e272a398 {
	meta:
		aliases = "abort, __GI_abort"
		size = "256"
		objfiles = "abort@libc.a"
	strings:
		$pattern = { 1C D0 4D E2 E4 30 9F E5 E4 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 C0 A0 E3 20 30 A0 E3 0C 20 A0 E1 01 00 A0 E3 14 10 8D E2 14 30 8D E5 18 C0 8D E5 ?? ?? ?? EB BC 20 9F E5 00 30 92 E5 00 00 53 E3 0B 00 00 1A 01 30 83 E2 00 30 82 E5 A8 30 9F E5 9C 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 06 00 A0 E3 ?? ?? ?? EB 88 00 9F E5 80 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 7C C0 9F E5 00 30 9C E5 01 00 53 E3 0D 00 00 1A 01 30 83 E2 00 30 8C E5 0D 00 A0 E1 00 10 A0 E3 14 20 A0 E3 ?? ?? ?? EB 00 30 E0 E3 0D 10 A0 E1 00 20 A0 E3 06 00 A0 E3 10 30 8D E5 0C 30 8D E5 ?? ?? ?? EB E3 FF FF EA 02 00 53 E3 02 00 00 1A 01 30 83 E2 }
	condition:
		$pattern
}
...
rule __GI_lround_8c0e608a6512757a5da467e3b390a9c1 {
	meta:
...
rule lrint_1a2f6a6ca602a3ccb447655f514f23aa {
	meta:
...
rule __GI_nearbyint_a0769fb04a3a3a546b01966d141a43c3 {
	meta:
		aliases = "__GI_rint, rint, nearbyint, __GI_nearbyint"
		size = "400"
		objfiles = "s_rint@libm.a"
	strings:
		$pattern = { 20 3A A0 E1 F0 41 2D E9 83 3A A0 E1 A3 3A A0 E1 FF CF 43 E2 03 C0 4C E2 33 00 5C E3 08 D0 4D E2 00 40 A0 E1 01 50 A0 E1 00 60 A0 E3 00 70 A0 E3 01 E0 A0 E1 4F 00 00 CA 13 00 5C E3 A0 8F A0 E1 31 00 00 CA 00 00 5C E3 20 00 00 AA 02 31 C0 E3 01 30 93 E1 47 00 00 0A FF 34 C0 E3 0F 36 C3 E3 01 30 83 E1 00 10 63 E2 18 21 9F E5 03 10 81 E1 88 21 82 E0 21 16 A0 E1 A0 08 A0 E1 05 40 A0 E1 02 17 01 E2 60 00 92 E8 80 08 A0 E1 00 30 81 E1 03 20 A0 E1 05 00 A0 E1 04 30 A0 E1 06 10 A0 E1 ?? ?? ?? EB 03 00 8D E8 05 20 A0 E1 06 30 A0 E1 03 00 9D E8 ?? ?? ?? EB 02 31 C0 E3 01 20 A0 E1 88 1F 83 E1 01 40 A0 E1 }
	condition:
		$pattern
}
...
rule getchar_unlocked_c3accbb26318d256e4363dc2acda3fba {
	meta:
...
rule __GI_sqrt_407f785407bd66ae3b911b0999e66719 {
	meta:
...
rule setup_aeabi_stdio_a85619cc5e35cd075a6d29870ddcf611 {
	meta:
		aliases = "setup_aeabi_stdio"
		size = "76"
		objfiles = "aeabi_lcsts@libc.a"
	strings:
		$pattern = { 2C 30 9F E5 00 20 93 E5 28 30 9F E5 00 10 93 E5 24 30 9F E5 00 00 93 E5 20 30 9F E5 00 20 83 E5 1C 30 9F E5 00 10 83 E5 18 30 9F E5 00 00 83 E5 0E F0 A0 E1 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI___sigpause_a7c78ed7711995dd155ad95ea63c4aab {
	meta:
...
rule __new_sem_trywait_8713be2ef33932a12107ee9b8bfbe38f {
	meta:
...
rule gethostid_d5b6bd9183f99030e01d42fc4f8bc5f0 {
	meta:
		aliases = "gethostid"
		size = "248"
		objfiles = "hostid@libc.a"
	strings:
		$pattern = { 30 40 2D E9 00 10 A0 E3 6C D0 4D E2 68 10 8D E5 DC 00 9F E5 05 00 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 10 00 00 EA 00 50 50 E2 0E 00 00 BA 68 10 8D E2 04 20 A0 E3 03 00 90 EF 01 0A 70 E3 00 40 A0 E1 00 30 A0 91 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 30 E0 E3 05 00 A0 E1 06 00 90 EF 00 00 53 E3 1B 00 00 CA 03 50 8D E2 05 00 A0 E1 40 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 15 00 00 BA 03 30 DD E5 00 00 53 E3 12 00 00 0A 44 40 8D E2 00 10 A0 E3 20 20 A0 E3 04 00 A0 E1 ?? ?? ?? EB 05 00 A0 E1 04 20 A0 E1 00 10 A0 E3 64 30 8D E2 ?? ?? ?? EB 00 00 50 E3 }
	condition:
		$pattern
}
...
rule __GI_strtod_4007dc262a6002cff4be8e25166dae44 {
	meta:
...
rule __GI_herror_913b88f85c0df5df1897b8bf9fe30358 {
	meta:
...
rule __GI_xdr_u_long_a4de5514a4b53840d67ea5cb6ead75b3 {
	meta:
...
rule xdr_bool_a51798d9980192c7d59144822f736572 {
	meta:
...
rule regfree_c451c3775b2f258fd2c2862acef7cbcc {
	meta:
...
rule tmpnam_15ffe8e244d6c0e3bfc66d3e83e66fc8 {
	meta:
		aliases = "tmpnam"
		size = "124"
		objfiles = "tmpnam@libc.a"
	strings:
		$pattern = { 30 40 2D E9 00 50 50 E2 14 D0 4D E2 05 40 A0 11 0D 40 A0 01 00 20 A0 E3 04 00 A0 E1 14 10 A0 E3 02 30 A0 E1 ?? ?? ?? EB 00 00 50 E3 0D 00 00 1A 00 20 A0 E1 03 10 A0 E3 04 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 07 00 00 1A 00 00 55 E3 06 00 00 1A 04 10 A0 E1 1C 00 9F E5 14 20 A0 E3 ?? ?? ?? EB 00 50 A0 E1 00 00 00 EA 00 50 A0 E3 05 00 A0 E1 14 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule xdr_accepted_reply_a66191477dce273164cdeddaf1581af8 {
	meta:
...
rule __GI_xdr_opaque_auth_62dfdfd8627a85d888b26643ae2d458e {
	meta:
...
rule setrpcent_9b957710ef19a63cb6153f1eb06cb80e {
	meta:
...
rule __GI_wcsnrtombs_4e90e15625c4cda09043838c2b2b11a4 {
	meta:
...
rule signal_8eb5da6d0c80e6548fa23bc1737be9a2 {
	meta:
...
rule __GI_lseek64_340e70387a80abeb5e832e91760d7ff8 {
	meta:
...
rule nrand48_r_5674055970afc089584ad9e838ba469e {
	meta:
...
rule ftruncate64_a2e7b83dad9ddfd7424572c617378cd9 {
	meta:
...
rule sethostid_24b564f066eda8b0289d4b6443c819e3 {
	meta:
		aliases = "sethostid"
		size = "200"
		objfiles = "hostid@libc.a"
	strings:
		$pattern = { 30 40 2D E9 04 D0 4D E2 00 00 8D E5 ?? ?? ?? EB 00 00 50 E3 02 00 00 1A ?? ?? ?? EB 00 00 50 E3 04 00 00 0A ?? ?? ?? EB 01 30 A0 E3 03 20 A0 E1 00 30 80 E5 1F 00 00 EA 84 00 9F E5 41 10 A0 E3 69 2F A0 E3 05 00 90 EF 01 0A 70 E3 00 40 A0 E1 00 50 A0 91 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 50 E0 E3 00 20 55 E2 11 00 00 BA 02 00 A0 E1 0D 10 A0 E1 04 20 A0 E3 04 00 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 02 00 00 EA 04 00 50 E3 00 30 A0 03 00 00 00 0A 00 30 E0 E3 05 00 A0 E1 06 00 90 EF 03 20 A0 E1 02 00 A0 E1 04 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_fgetspent_r_e8080a1c2fc51c486b5e54e9e6df8922 {
	meta:
		aliases = "fgetpwent_r, fgetspent_r, __GI_fgetgrent_r, fgetgrent_r, __GI_fgetpwent_r, __GI_fgetspent_r"
		size = "56"
...
rule __libc_sendto_de6e362ba4aa771db66e18563e83195b {
	meta:
...
rule __GI_xdrrec_skiprecord_8b65d79471847b92df57cd40e02af64e {
	meta:
...
rule xdrrec_eof_4024b23a0a0bf52f5fe8f269f18d0557 {
	meta:
...
rule epoll_pwait_a81f9010e157db5da9b3093dcc63fdf4 {
	meta:
		aliases = "__libc_epoll_pwait, epoll_pwait"
		size = "52"
		objfiles = "epoll@libc.a"
	strings:
		$pattern = { 30 40 2D E9 0C 40 9D E5 08 50 A0 E3 5A 01 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 30 80 BD 98 ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 30 80 BD E8 }
	condition:
		$pattern
}
...
rule getservbyport_8b0b441171a7ca25362b9ba68888fef1 {
	meta:
		aliases = "__GI_getservbyport, getservbyport"
		size = "80"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { 30 40 2D E9 0C D0 4D E2 00 40 A0 E1 01 50 A0 E1 12 FF FF EB 2C 30 9F E5 13 CE A0 E3 00 30 93 E5 04 00 A0 E1 00 C0 8D E5 05 10 A0 E1 08 C0 8D E2 14 20 9F E5 04 C0 8D E5 ?? ?? ?? EB 08 00 9D E5 0C D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule getservbyname_c8df48b81d066bc85a31f8138801289f {
	meta:
		aliases = "getservbyname"
		size = "80"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { 30 40 2D E9 0C D0 4D E2 00 40 A0 E1 01 50 A0 E1 B5 FE FF EB 2C 30 9F E5 13 CE A0 E3 00 30 93 E5 04 00 A0 E1 00 C0 8D E5 05 10 A0 E1 08 C0 8D E2 14 20 9F E5 04 C0 8D E5 ?? ?? ?? EB 08 00 9D E5 0C D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule sem_wait_cf39f27643025fb8e82eed39944b0666 {
	meta:
...
rule __gnu_Unwind_Find_exidx_32207a8e3f536356e570cce6a58cd176 {
	meta:
		aliases = "__gnu_Unwind_Find_exidx"
		size = "88"
		objfiles = "find_exidx@libc.a"
	strings:
		$pattern = { 30 40 2D E9 0C D0 4D E2 00 40 A0 E3 00 00 8D E5 01 50 A0 E1 38 00 9F E5 0D 10 A0 E1 04 40 8D E5 ?? ?? ?? EB 04 00 50 E1 04 00 A0 D1 06 00 00 DA 08 30 9D E5 07 20 83 E2 00 00 53 E3 02 30 A0 B1 C3 31 A0 E1 00 30 85 E5 04 00 9D E5 0C D0 8D E2 30 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __fputc_unlocked_5e36d1201230a94a099b0e739248355a {
	meta:
		aliases = "__GI_putc_unlocked, fputc_unlocked, __GI_fputc_unlocked, putc_unlocked, __GI___fputc_unlocked, __fputc_unlocked"
		size = "260"
...
rule __GI_getutline_2d11b03ccd862ca1e7f0a0c0455b889f {
	meta:
		aliases = "getutline, __GI_getutline"
		size = "168"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 30 40 2D E9 10 D0 4D E2 00 40 A0 E1 80 10 9F E5 0D 00 A0 E1 7C 20 9F E5 7C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 6C 00 9F E5 70 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 08 50 84 E2 0A 00 00 EA 00 30 94 E5 06 30 43 E2 03 38 A0 E1 01 08 53 E3 05 00 00 8A 08 00 84 E2 05 10 A0 E1 20 20 A0 E3 ?? ?? ?? EB 00 00 50 E3 02 00 00 0A C9 FF FF EB 00 40 50 E2 F1 FF FF 1A 0D 00 A0 E1 01 10 A0 E3 20 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 10 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule pututline_dbd2fdd851162af9db7f0d8a5e845ddd {
	meta:
		aliases = "__GI_pututline, pututline"
		size = "196"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 30 40 2D E9 10 D0 4D E2 00 40 A0 E1 94 50 9F E5 94 10 9F E5 94 20 9F E5 0D 00 A0 E1 90 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 88 30 9F E5 7C 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 01 20 A0 E3 78 10 9F E5 00 00 95 E5 ?? ?? ?? EB 04 00 A0 E1 C8 FF FF EB 00 10 50 E2 60 10 9F 15 01 20 A0 13 02 20 A0 03 00 00 95 15 00 00 95 05 ?? ?? ?? EB 34 30 9F E5 04 10 A0 E1 06 2D A0 E3 00 00 93 E5 ?? ?? ?? EB 01 10 A0 E3 06 0D 50 E3 30 30 9F E5 0D 00 A0 E1 00 40 A0 13 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 10 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 80 FE FF FF ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_gethostbyname2_007171b1e368c83f51f7b1308ffc52d9 {
	meta:
		aliases = "gethostbyname2, __GI_gethostbyname2"
		size = "80"
		objfiles = "gethostbyname2@libc.a"
	strings:
		$pattern = { 30 40 2D E9 10 D0 4D E2 00 50 A0 E1 01 40 A0 E1 ?? ?? ?? EB 6E CF A0 E3 08 00 8D E5 00 C0 8D E5 04 10 A0 E1 0C C0 8D E2 05 00 A0 E1 14 20 9F E5 14 30 9F E5 04 C0 8D E5 ?? ?? ?? EB 0C 00 9D E5 10 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule endpwent_0fda5d4abe92cf31284053aff3167d76 {
	meta:
...
rule endnetent_c3462f56f9929520ab241c1eb9066968 {
	meta:
		aliases = "endprotoent, __GI_endservent, endservent, __GI_endprotoent, __GI_endnetent, endnetent"
		size = "148"
...
rule sethostent_06cdae6b3b19182dfbcb57c25a921039 {
	meta:
		aliases = "sethostent"
		size = "124"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { 30 40 2D E9 10 D0 4D E2 54 20 9F E5 00 40 A0 E1 50 10 9F E5 0D 00 A0 E1 4C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 44 30 9F E5 34 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 54 E3 34 30 9F 15 01 20 A0 13 00 20 83 15 0D 00 A0 E1 01 10 A0 E3 24 30 9F E5 0D 50 A0 E1 0F E0 A0 E1 03 F0 A0 E1 10 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule getnetbyaddr_91c4c254a5fd20eb5b588bb3aaeb714a {
	meta:
		aliases = "getnetbyaddr"
		size = "88"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { 30 40 2D E9 14 D0 4D E2 00 40 A0 E1 01 50 A0 E1 05 FF FF EB 34 30 9F E5 4B CF A0 E3 00 30 93 E5 00 C0 8D E5 10 C0 8D E2 04 C0 8D E5 04 00 A0 E1 0C C0 8D E2 05 10 A0 E1 14 20 9F E5 08 C0 8D E5 ?? ?? ?? EB 10 00 9D E5 14 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule ctime_e1b31ebf3e789729d7f9b3b9299381ce {
	meta:
		aliases = "__GI_ctime, ctime"
		size = "56"
		objfiles = "ctime@libc.a"
	strings:
		$pattern = { 30 40 2D E9 2C D0 4D E2 00 50 A0 E1 2C 20 A0 E3 0D 00 A0 E1 00 10 A0 E3 ?? ?? ?? EB 0D 10 A0 E1 05 00 A0 E1 0D 40 A0 E1 ?? ?? ?? EB ?? ?? ?? EB 2C D0 8D E2 30 80 BD E8 }
	condition:
		$pattern
}
...
rule __uc_malloc_846df3caf02aab710b880a3496358017 {
	meta:
		aliases = "__GI___uc_malloc, __uc_malloc"
		size = "84"
		objfiles = "__uc_malloc@libc.a"
	strings:
		$pattern = { 30 40 2D E9 44 50 9F E5 00 40 A0 E1 04 00 A0 E1 ?? ?? ?? EB 00 30 50 E2 01 30 A0 13 00 00 54 E3 01 30 83 03 00 00 53 E3 30 80 BD 18 00 30 95 E5 00 00 53 E3 01 00 A0 03 ?? ?? ?? 0B ?? ?? ?? EB 04 00 A0 E1 0F E0 A0 E1 00 F0 95 E5 EE FF FF EA ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_sbrk_2b121848a5ad4dd61e0892184f20528d {
	meta:
...
rule endhostent_ff20259108a47fc306a9a39d240d9452 {
	meta:
		aliases = "endhostent"
		size = "108"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { 30 40 2D E9 4C 40 9F E5 10 D0 4D E2 48 10 9F E5 04 20 A0 E1 0D 00 A0 E1 40 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 38 30 9F E5 04 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 ?? ?? ?? EB 0D 00 A0 E1 01 10 A0 E3 20 30 9F E5 0D 50 A0 E1 0F E0 A0 E1 03 F0 A0 E1 10 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_setutent_48b8df73b68279f779b4d281fc16a7c9 {
	meta:
		aliases = "setutent, __GI_setutent"
		size = "108"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 30 40 2D E9 4C 40 9F E5 10 D0 4D E2 48 10 9F E5 04 20 A0 E1 0D 00 A0 E1 40 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 38 30 9F E5 04 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 EA FE FF EB 0D 00 A0 E1 01 10 A0 E3 20 30 9F E5 0D 50 A0 E1 0F E0 A0 E1 03 F0 A0 E1 10 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule getutent_32d4d49888de8b43b381afea99f2286d {
	meta:
		aliases = "__GI_getutent, getutent"
		size = "116"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 30 40 2D E9 54 40 9F E5 10 D0 4D E2 04 20 A0 E1 4C 10 9F E5 0D 00 A0 E1 48 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 40 30 9F E5 04 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 39 FF FF EB 01 10 A0 E3 00 40 A0 E1 28 30 9F E5 0D 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 0D 50 A0 E1 04 00 A0 E1 10 D0 8D E2 30 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule login_4a0504acac1356686a0ad23d92b39f05 {
	meta:
		aliases = "login"
		size = "236"
		objfiles = "login@libutil.a"
	strings:
		$pattern = { 30 40 2D E9 6A DF 4D E2 00 10 A0 E1 06 2D A0 E3 0D 00 A0 E1 ?? ?? ?? EB 00 40 A0 E3 07 30 A0 E3 00 30 CD E5 01 40 CD E5 ?? ?? ?? EB 06 5D 8D E2 04 00 8D E5 02 50 85 E2 03 00 54 E3 04 00 A0 E1 05 10 A0 E1 26 20 A0 E3 01 40 84 E2 03 00 00 0A ?? ?? ?? EB 00 00 50 E3 F6 FF FF 1A 14 00 00 EA 08 00 8D E2 74 10 9F E5 20 20 A0 E3 ?? ?? ?? EB 0A 00 00 EA 06 1D 8D E2 08 00 8D E2 02 10 81 E2 1F 20 A0 E3 ?? ?? ?? EB 00 30 A0 E3 27 30 CD E5 ?? ?? ?? EB 0D 00 A0 E1 ?? ?? ?? EB ?? ?? ?? EB 3C 00 9F E5 0D 10 A0 E1 ?? ?? ?? EB 6A DF 8D E2 30 80 BD E8 06 4D 8D E2 02 40 84 E2 24 10 9F E5 04 00 A0 E1 05 20 A0 E3 }
	condition:
		$pattern
}
...
rule __GI_opendir_8728598e297e20907330a01920da19b9 {
	meta:
		aliases = "opendir, __GI_opendir"
		size = "156"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { 30 40 2D E9 8C 10 9F E5 58 D0 4D E2 05 00 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 07 00 00 EA 00 00 54 E3 05 00 00 BA 0D 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 03 00 00 AA 04 00 A0 E1 06 00 90 EF 00 50 A0 E3 0D 00 00 EA 02 10 A0 E3 01 20 A0 E3 04 00 A0 E1 ?? ?? ?? EB 04 00 A0 E1 30 10 9D E5 B4 FF FF EB 00 50 50 E2 04 00 00 1A 04 00 A0 E1 06 00 90 EF ?? ?? ?? EB 0C 30 A0 E3 00 30 80 E5 05 00 A0 E1 58 D0 8D E2 30 80 BD E8 00 48 08 00 }
	condition:
		$pattern
}
...
rule dlsym_a0eddd10311fbd5f92f70ab7cf52ac70 {
	meta:
		aliases = "dlsym"
		size = "268"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { 30 40 2D E9 F0 30 9F E5 18 00 93 E8 00 00 50 E3 0C D0 4D E2 18 00 8D E9 E0 30 9F 05 01 50 A0 E1 0E 40 A0 E1 00 10 93 05 22 00 00 0A 01 00 70 E3 00 10 A0 E1 C4 30 9F E5 0D 00 00 0A 00 30 93 E5 03 00 50 E1 B8 30 9F 15 00 30 93 15 03 00 00 1A 18 00 00 EA 00 00 53 E1 16 00 00 0A 04 30 93 E5 00 00 53 E3 FA FF FF 1A 00 00 A0 E3 0A 20 A0 E3 1D 00 00 EA 00 20 93 E5 00 E0 A0 E3 0B 00 00 EA 00 00 92 E5 14 C0 90 E5 04 00 5C E1 06 00 00 2A 00 00 5E E3 02 00 00 0A 14 30 9E E5 0C 00 53 E1 01 00 00 2A 10 10 92 E5 00 E0 A0 E1 10 20 92 E5 00 00 52 E3 F1 FF FF 1A 40 30 9F E5 00 30 93 E5 03 00 51 E1 00 20 91 05 }
	condition:
		$pattern
}
...
rule flockfile_8a02de413851b21c7f717ae1aecb121b {
	meta:
...
rule __GI_clnt_sperrno_3286f2069befdb204fd85c0af9c3328a {
	meta:
...
rule __GI_localeconv_5eedfe9e00a039d80b9e7b14c726823c {
	meta:
...
rule atan_c8771cac0583a34a1ad2a5af294d60b8 {
	meta:
...
rule getppid_f7c517417de2dca6cbaeb696b0b79a51 {
	meta:
		aliases = "getppid"
		size = "8"
		objfiles = "getppid@libc.a"
	strings:
		$pattern = { 40 00 90 EF 0E F0 A0 E1 }
	condition:
		$pattern
}
...
rule setup_aeabi_stdio_9042ae3a923c926e4c9727128f502738 {
	meta:
		aliases = "setup_aeabi_stdio"
		size = "100"
		objfiles = "aeabi_lcstss@uclibc_nonshared.a"
	strings:
		$pattern = { 40 20 9F E5 40 30 9F E5 02 20 8F E0 03 00 92 E7 38 30 9F E5 03 10 92 E7 34 30 9F E5 03 30 92 E7 00 C0 91 E5 00 10 93 E5 28 30 9F E5 00 00 90 E5 03 10 82 E7 20 30 9F E5 03 00 82 E7 1C 30 9F E5 03 C0 82 E7 0E F0 A0 E1 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule getpgrp_505857877fad0774c2fbfb4162b5e1d0 {
	meta:
		aliases = "getpgrp"
		size = "8"
		objfiles = "getpgrp@libc.a"
	strings:
		$pattern = { 41 00 90 EF 0E F0 A0 E1 }
	condition:
		$pattern
}
...
rule __GI_wctrans_b6e1aa4997f51081955c25d2f6a49a1e {
	meta:
...
rule __GI_scalbln_950b39ad041b433a13436117bbb2c6ef {
	meta:
...
rule tanh_a1e7afc3b6bd79f1c95fefc346191441 {
	meta:
...
rule siglongjmp_789ce6fea0e89014516e8152aa1f9b75 {
	meta:
		aliases = "__libc_siglongjmp, longjmp, __libc_longjmp, _longjmp, siglongjmp"
		size = "52"
...
rule thread_self_64a341d9e80005fa919d065998c3f9b0 {
	meta:
		aliases = "thread_self"
		size = "124"
		objfiles = "mutex@libpthread.a, semaphore@libpthread.a, cancel@libpthread.a, signals@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule __GI_wcstof_c5421df7119fbd0b4ad58db4de7788f6 {
	meta:
...
rule __GI_tfind_09570e4c929b12e4f4598d87f8146de9 {
	meta:
...
rule xprt_unregister_408965919ca3f2748e5163d9ba0cb8ac {
	meta:
...
rule svctcp_destroy_2fce79638867afdc3b2b470d775a2acc {
	meta:
...
rule _dl_parse_dynamic_info_6f38242618794423caf3d6edb651ff76 {
	meta:
		aliases = "_dl_parse_dynamic_info"
		size = "324"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { 70 40 2D E9 00 40 A0 E3 02 50 A0 E1 03 E0 A0 E1 01 20 A0 E3 04 60 A0 E1 2A 00 00 EA 21 00 5C E3 19 00 00 CA 04 30 90 E5 0C 31 81 E7 00 30 90 E5 15 00 5C E3 04 50 80 05 18 00 53 E3 00 30 90 E5 60 20 81 05 1E 00 53 E3 02 00 00 1A 04 30 90 E5 08 00 13 E3 60 20 81 15 00 30 90 E5 16 00 53 E3 00 30 90 E5 58 20 81 05 1D 00 53 E3 00 30 90 E5 3C 60 81 05 0F 00 53 E3 11 00 00 1A 74 30 91 E5 00 00 53 E3 3C 60 81 15 0D 00 00 EA 19 02 7C E3 0B 00 00 CA 69 02 7C E3 04 30 90 05 88 30 81 05 00 30 90 E5 59 02 73 E3 05 00 00 1A 04 30 90 E5 01 00 13 E3 60 20 81 15 04 30 90 E5 08 00 13 E3 01 4A 84 13 08 00 80 E2 }
	condition:
		$pattern
}
...
rule __GI_fflush_413c71a5dd67f9ca54f6d717a22513c0 {
	meta:
		aliases = "fflush, __GI_fflush"
		size = "180"
		objfiles = "fflush@libc.a"
	strings:
		$pattern = { 70 40 2D E9 00 50 50 E2 10 D0 4D E2 1D 00 00 0A 88 30 9F E5 03 00 55 E1 1A 00 00 0A 34 30 95 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 0A 00 00 0A 38 40 85 E2 0D 00 A0 E1 64 30 9F E5 64 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 54 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 05 00 A0 E1 ?? ?? ?? EB 00 00 56 E3 00 40 A0 E1 08 00 00 0A 0D 00 A0 E1 01 10 A0 E3 30 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 02 00 00 EA 05 00 A0 E1 ?? ?? ?? EB 00 40 A0 E1 04 00 A0 E1 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule ffsll_221ddc25ce8816ed4f2de92a3565f5f6 {
	meta:
		aliases = "ffsll"
		size = "56"
		objfiles = "ffsll@libc.a"
	strings:
		$pattern = { 70 40 2D E9 00 50 A0 E1 01 60 A0 E1 00 30 75 E2 00 40 E6 E2 01 40 04 E0 00 00 54 E3 01 00 00 8A 70 40 BD E8 ?? ?? ?? EA 01 00 A0 E1 ?? ?? ?? EB 20 00 80 E2 70 80 BD E8 }
	condition:
		$pattern
}
...
rule getrpcbyname_b4753be57184238a7cc672ca006ff647 {
	meta:
...
rule fd_to_DIR_e98f6c3485af047a37412f9c3e8f0b08 {
	meta:
		aliases = "fd_to_DIR"
		size = "188"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { 70 40 2D E9 00 60 A0 E1 18 D0 4D E2 30 00 A0 E3 01 40 A0 E1 ?? ?? ?? EB 00 00 50 E3 00 50 A0 01 21 00 00 0A 00 30 A0 E3 02 0C 54 E3 04 30 80 E5 10 30 80 E5 08 30 80 E5 02 3C 83 32 14 40 80 E5 14 30 80 35 00 50 A0 E1 00 60 80 E5 14 10 95 E5 01 00 A0 E3 ?? ?? ?? EB 00 00 50 E3 00 40 A0 E1 0C 00 85 E5 03 00 00 1A 05 00 A0 E1 ?? ?? ?? EB 04 50 A0 E1 0C 00 00 EA 38 30 9F E5 03 C0 A0 E1 0F 00 BC E8 0D E0 A0 E1 0F 00 AE E8 03 00 9C E8 0D C0 A0 E1 03 00 8E E8 0F 00 BC E8 18 C0 85 E2 0F 00 AC E8 03 00 9E E8 03 00 8C E8 05 00 A0 E1 18 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_strndup_f06fd0b48888fa24232c848400bda320 {
	meta:
...
rule strdup_4454023922d5b5b1f9744e3ea9bfa567 {
	meta:
...
rule _pthread_cleanup_pop_restore_112760ba84f37950a7efa1dd633ac0c7 {
	meta:
...
rule __pthread_attr_setguardsize_a6855025b438a014e9ab67ee075a2925 {
	meta:
...
rule powf_4a44cd37ef35a0b922cd1ed5d81e2ab8 {
	meta:
		aliases = "copysignf, remainderf, hypotf, atan2f, scalbf, fmodf, powf"
		size = "56"
		objfiles = "copysignf@libm.a, atan2f@libm.a, powf@libm.a, fmodf@libm.a, scalbf@libm.a"
	strings:
...
rule tmpfile64_0702d14f8a0a8760dc47b85ec448ad36 {
	meta:
		aliases = "tmpfile, tmpfile64"
		size = "160"
		objfiles = "tmpfile@libc.a"
	strings:
		$pattern = { 70 40 2D E9 01 DA 4D E2 10 40 8D E2 0F 40 44 E2 04 00 A0 E1 78 10 9F E5 00 20 A0 E3 74 30 9F E5 ?? ?? ?? EB 00 00 50 E3 15 00 00 1A 00 10 A0 E1 06 2D A0 E3 04 00 A0 E1 ?? ?? ?? EB 00 50 50 E2 0F 00 00 BA 04 00 A0 E1 ?? ?? ?? EB 05 00 A0 E1 44 10 9F E5 ?? ?? ?? EB 00 60 50 E2 09 00 00 1A 05 00 A0 E1 06 00 90 EF 01 0A 70 E3 00 40 A0 E1 04 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 00 EA 00 60 A0 E3 06 00 A0 E1 01 DA 8D E2 70 80 BD E8 FF 0F 00 00 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule connect_1823f96336634c69108f5ddfbc5d7589 {
	meta:
		aliases = "waitpid, accept, __GI_waitpid, read, sendmsg, msync, recvmsg, lseek, write, connect"
		size = "76"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule find_exidx_callback_7fca2b09e53674fbbe2d1e4bef1be67b {
	meta:
		aliases = "find_exidx_callback"
		size = "136"
		objfiles = "find_exidx@libc.a"
	strings:
		$pattern = { 70 40 2D E9 0D 10 D0 E5 0C 30 D0 E5 00 40 90 E5 08 C0 90 E5 00 50 A0 E3 01 04 83 E1 01 60 A0 E3 14 00 00 EA 00 30 9C E5 01 00 53 E3 09 00 00 1A 08 30 9C E5 00 E0 92 E5 03 10 84 E0 01 00 5E E1 0A 00 00 3A 14 30 9C E5 03 30 81 E0 03 00 5E E1 06 50 A0 31 05 00 00 EA 17 02 53 E3 08 30 9C 05 04 30 83 00 04 30 82 05 14 30 9C 05 08 30 82 05 01 00 40 E2 20 C0 8C E2 00 00 50 E3 E8 FF FF 1A 05 00 A0 E1 70 80 BD E8 }
	condition:
		$pattern
}
...
rule __GI_utmpname_730e7a171e981ad076d4c7c6904acf23 {
	meta:
		aliases = "utmpname, __GI_utmpname"
		size = "192"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 70 40 2D E9 10 D0 4D E2 00 50 A0 E1 8C 10 9F E5 0D 00 A0 E1 88 20 9F E5 88 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 78 00 9F E5 7C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 55 E3 09 00 00 0A 6C 60 9F E5 6C 40 9F E5 00 00 96 E5 04 00 50 E1 ?? ?? ?? 1B 05 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 04 00 A0 01 00 00 86 E5 4C 20 9F E5 00 00 92 E5 00 00 50 E3 02 00 00 BA 06 00 90 EF 00 30 E0 E3 00 30 82 E5 0D 00 A0 E1 01 10 A0 E3 2C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 A0 E3 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule setprotoent_e2e969bf839d87ab3cf922ba8bb97869 {
	meta:
		aliases = "__GI_setprotoent, setservent, __GI_setservent, __GI_setnetent, setnetent, setprotoent"
		size = "160"
		objfiles = "getnet@libc.a, getproto@libc.a, getservice@libc.a"
	strings:
		$pattern = { 70 40 2D E9 10 D0 4D E2 70 10 9F E5 70 20 9F E5 70 30 9F E5 00 40 A0 E1 6C 50 9F E5 0D 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 54 00 9F E5 5C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 95 E5 00 00 50 E3 0D 60 A0 E1 ?? ?? ?? 1B 44 00 9F E5 ?? ?? ?? EB 00 00 54 E3 3C 30 9F 15 01 20 A0 13 00 00 85 E5 00 20 83 15 0D 00 A0 E1 01 10 A0 E3 28 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule gethostbyaddr_36837f16767b7c7da620f034471d1304 {
	meta:
		aliases = "__GI_gethostbyaddr, gethostbyaddr"
		size = "92"
		objfiles = "gethostbyaddr@libc.a"
	strings:
		$pattern = { 70 40 2D E9 14 D0 4D E2 00 60 A0 E1 01 40 A0 E1 02 50 A0 E1 ?? ?? ?? EB 34 C0 9F E5 00 C0 8D E5 6E CF A0 E3 0C 00 8D E5 04 C0 8D E5 04 10 A0 E1 10 C0 8D E2 06 00 A0 E1 05 20 A0 E1 14 30 9F E5 08 C0 8D E5 ?? ?? ?? EB 10 00 9D E5 14 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_readdir_a65d6ed1c981fd66e66981e9452202db {
	meta:
...
rule __GI_readdir64_246436ef8a6b03b04399d3899d019660 {
	meta:
...
rule if_nametoindex_b985a8d04d4ce29460677e84e5fe3d35 {
	meta:
		aliases = "__GI_if_nametoindex, if_nametoindex"
		size = "108"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { 70 40 2D E9 20 D0 4D E2 00 60 A0 E1 ?? ?? ?? EB 00 50 50 E2 0C 00 00 BA 06 10 A0 E1 10 20 A0 E3 0D 00 A0 E1 ?? ?? ?? EB 05 00 A0 E1 0D 20 A0 E1 30 10 9F E5 ?? ?? ?? EB 00 00 50 E3 0D 40 A0 E1 03 00 00 AA 05 00 A0 E1 06 00 90 EF 00 00 A0 E3 02 00 00 EA 05 00 A0 E1 06 00 90 EF 10 00 9D E5 20 D0 8D E2 70 80 BD E8 33 89 00 00 }
	condition:
		$pattern
}
...
rule feof_210816f33e7e9e6ec5023f245d835785 {
	meta:
		aliases = "feof"
		size = "140"
		objfiles = "feof@libc.a"
	strings:
		$pattern = { 70 40 2D E9 34 30 90 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 10 D0 4D E2 00 50 A0 E1 0A 00 00 0A 38 40 80 E2 50 30 9F E5 0D 00 A0 E1 4C 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 3C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 01 20 D5 E5 00 30 D5 E5 00 00 56 E3 02 44 83 E1 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 04 E2 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule ferror_0e3c2393171c09b44744dfd741b7c378 {
	meta:
		aliases = "ferror"
		size = "140"
		objfiles = "ferror@libc.a"
	strings:
		$pattern = { 70 40 2D E9 34 30 90 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 10 D0 4D E2 00 50 A0 E1 0A 00 00 0A 38 40 80 E2 50 30 9F E5 0D 00 A0 E1 4C 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 3C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 01 20 D5 E5 00 30 D5 E5 00 00 56 E3 02 44 83 E1 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 08 00 04 E2 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_fileno_c8acf4f22a2e25935e4dd09d6d41842d {
	meta:
		aliases = "fgetwc, fileno, getwc, __GI_fgetwc, __GI_fileno"
		size = "140"
		objfiles = "fileno@libc.a, fgetwc@libc.a"
	strings:
		$pattern = { 70 40 2D E9 34 30 90 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 10 D0 4D E2 00 50 A0 E1 0A 00 00 0A 38 40 80 E2 50 30 9F E5 0D 00 A0 E1 4C 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 3C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 05 00 A0 E1 ?? ?? ?? EB 00 00 56 E3 00 40 A0 E1 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule clearerr_b9bce365efcdffe7721f6490038d3bc0 {
	meta:
		aliases = "clearerr"
		size = "144"
		objfiles = "clearerr@libc.a"
	strings:
		$pattern = { 70 40 2D E9 34 30 90 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 10 D0 4D E2 00 50 A0 E1 0A 00 00 0A 38 40 80 E2 54 30 9F E5 0D 00 A0 E1 50 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 40 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 95 E5 0C 30 C3 E3 43 24 A0 E1 00 00 56 E3 01 20 C5 E5 00 30 C5 E5 0D 00 A0 11 01 10 A0 13 18 30 9F 15 0F E0 A0 11 03 F0 A0 11 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule rewind_cf3041403357531294caf414ed4bc888 {
	meta:
		aliases = "__GI_rewind, rewind"
		size = "160"
		objfiles = "rewind@libc.a"
	strings:
		$pattern = { 70 40 2D E9 34 30 90 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 10 D0 4D E2 00 50 A0 E1 0A 00 00 0A 38 40 80 E2 64 30 9F E5 0D 00 A0 E1 60 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 50 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 95 E5 08 30 C3 E3 43 24 A0 E1 00 10 A0 E3 01 20 C5 E5 00 30 C5 E5 05 00 A0 E1 01 20 A0 E1 ?? ?? ?? EB 00 00 56 E3 0D 00 A0 11 01 10 A0 13 18 30 9F 15 0F E0 A0 11 03 F0 A0 11 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_ftello64_814c7f6a22755e105a891580ffea00c4 {
	meta:
		aliases = "ftello64, __GI_ftello64"
		size = "236"
		objfiles = "ftello64@libc.a"
	strings:
		$pattern = { 70 40 2D E9 34 30 90 E5 01 60 73 E2 00 60 A0 33 18 D0 4D E2 00 30 A0 E3 00 40 A0 E3 00 00 56 E3 00 50 A0 E1 10 30 8D E5 14 40 8D E5 0A 00 00 0A 38 40 80 E2 A0 30 9F E5 0D 00 A0 E1 9C 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 8C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 20 D5 E5 01 30 D5 E5 03 24 82 E1 11 2D 02 E2 11 0D 52 E3 10 40 8D E2 01 20 A0 13 02 20 A0 03 05 00 A0 E1 04 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 04 00 00 BA 05 00 A0 E1 04 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 03 00 00 AA 00 30 E0 E3 00 40 E0 E3 10 30 8D E5 14 40 8D E5 00 00 56 E3 0D 00 A0 11 01 10 A0 13 20 30 9F 15 0F E0 A0 11 }
	condition:
		$pattern
}

rule __GI_fputc_60ed37c17c0065234bf7a07494647792 {
	meta:
		aliases = "putc, fputc, __GI_putc, __GI_fputc"
		size = "212"
...
rule getutid_e69af1f67edd47454cde4f74ab96627f {
	meta:
		aliases = "getutid"
		size = "124"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { 70 40 2D E9 5C 40 9F E5 10 D0 4D E2 04 20 A0 E1 54 10 9F E5 00 60 A0 E1 50 30 9F E5 0D 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 44 30 9F E5 04 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 06 00 A0 E1 9B FF FF EB 01 10 A0 E3 00 40 A0 E1 28 30 9F E5 0D 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 0D 50 A0 E1 04 00 A0 E1 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule daemon_a536f99abe6a44dfe5709ebd23b1d9b8 {
	meta:
		aliases = "daemon"
		size = "304"
		objfiles = "daemon@libc.a"
	strings:
		$pattern = { 70 40 2D E9 60 D0 4D E2 00 50 A0 E1 01 40 A0 E1 ?? ?? ?? EB 01 00 70 E3 37 00 00 0A 00 00 50 E3 39 00 00 0A 00 00 A0 E3 ?? ?? ?? EB 00 00 55 E3 F0 00 9F 05 ?? ?? ?? 0B 00 00 54 E3 30 00 00 1A 04 20 A0 E1 E0 00 9F E5 02 10 A0 E3 05 00 90 EF 01 0A 70 E3 00 40 A0 E1 04 00 00 9A ?? ?? ?? EB 00 50 E0 E3 00 30 64 E2 00 30 80 E5 20 00 00 EA 01 00 70 E3 00 50 A0 E1 1D 00 00 0A 0D 10 A0 E1 ?? ?? ?? EB 00 60 50 E2 19 00 00 1A 10 30 9D E5 0F 3A 03 E2 02 0A 53 E3 0E 00 00 1A 06 10 A0 E1 04 00 A0 E1 ?? ?? ?? EB 01 10 A0 E3 04 00 A0 E1 ?? ?? ?? EB 04 00 A0 E1 02 10 A0 E3 ?? ?? ?? EB 02 00 54 E3 0E 00 00 DA }
	condition:
		$pattern
}

rule __GI_getdomainname_a536411d8281989efcf80a4b1a855393 {
	meta:
...
rule gethostname_fc8e345a0f5b42315d7d42b353956e69 {
	meta:
...
rule strcasecmp_9c4dd0ad3945145242450bfe68b1aa68 {
	meta:
...
rule __GI_tan_96cfc2433269e88cd28f35e1b477876c {
	meta:
...
rule gets_2bed5ead46ea0b80c908b1291239dc24 {
	meta:
		aliases = "gets"
		size = "208"
		objfiles = "gets@libc.a"
	strings:
		$pattern = { 70 40 2D E9 B0 40 9F E5 00 20 94 E5 34 30 92 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 10 D0 4D E2 00 50 A0 E1 01 00 00 1A 05 40 A0 E1 0C 00 00 EA 0D 00 A0 E1 38 20 82 E2 80 10 9F E5 80 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 94 E5 74 30 9F E5 38 00 80 E2 0F E0 A0 E1 03 F0 A0 E1 F1 FF FF EA 01 40 84 E2 ?? ?? ?? EB 01 00 70 E3 FF 30 00 E2 02 00 00 0A 0A 00 53 E3 00 30 C4 E5 F7 FF FF 1A 01 00 70 E3 04 00 55 11 00 30 A0 13 01 30 A0 03 00 50 A0 03 00 30 C4 15 00 00 56 E3 0D 00 A0 11 01 10 A0 13 20 30 9F 15 0F E0 A0 11 03 F0 A0 11 05 00 A0 E1 10 D0 8D E2 70 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule index_751ee7706823363fd76afffeb48237e6 {
	meta:
...
rule __GI_strchrnul_71ca457be5e9ee1b69f67a88f9eb4d76 {
	meta:
...
rule endusershell_21ccb72abb43dd10ff9527d52266e12b {
	meta:
		aliases = "endusershell"
		size = "144"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { 7C 30 9F E5 00 30 93 E5 00 00 53 E3 10 40 2D E9 13 00 00 0A 6C 20 9F E5 6C 30 9F E5 00 20 92 E5 03 40 A0 E1 00 20 83 E5 01 00 00 EA 00 20 84 E5 ?? ?? ?? EB 00 30 94 E5 00 00 53 E3 04 20 83 E2 02 00 00 0A 00 30 93 E5 00 00 53 E2 F6 FF FF 1A 2C 40 9F E5 00 00 94 E5 ?? ?? ?? EB 00 30 A0 E3 00 30 84 E5 1C 40 9F E5 00 00 94 E5 ?? ?? ?? EB 14 30 9F E5 00 20 A0 E3 00 20 83 E5 00 20 84 E5 10 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __ieee754_acosh_8f60c50ec334453da5b4d31e7e51fac2 {
	meta:
		aliases = "__GI_acosh, acosh, __ieee754_acosh"
		size = "412"
...
rule iswctype_1fe478345b4c5df53b4dbcdaa7e627e1 {
	meta:
...
rule towlower_f7cd71ed709ec94d5000e2fd1a8c0960 {
	meta:
...
rule __GI_initstate_r_8e60a771d280b682589029af425ae361 {
	meta:
...
rule toupper_c7c2da1e9dd8d42a29407c7a7cc35a23 {
	meta:
...
rule setenv_bc07b451e59a033d669ce769f742f609 {
	meta:
...
rule __ieee754_cosh_bd5b83259f8a815fa51de0ace60efce6 {
	meta:
...
rule __aeabi_memmove8_e511a389f9fe0cc6331c9b2cfbb8cbb8 {
	meta:
		aliases = "memmove, rand, __GI_xdr_int, memcpy, __aeabi_memcpy4, xdr_longlong_t, xdr_enum, __aeabi_localeconv, mq_close, xdr_u_longlong_t, vfork, cabs, __GI_memmove, __aeabi_memmove, xdr_u_int, __aeabi_memcpy, __GI_cabs, __aeabi_MB_CUR_MAX, suspend, __aeabi_errno_addr, __GI_xdr_u_int, __GI_setmntent, __aeabi_memmove4, xdr_int, __aeabi_memcpy8, setmntent, __deregister_frame_info, __GI_xdr_enum, restart, __GI_memcpy, __aeabi_memmove8"
		size = "4"
		objfiles = "mq_close@librt.a, w_cabs@libm.a, join@libpthread.a, spinlock@libpthread.a, mntent@libc.a"
	strings:
		$pattern = { ?? ?? ?? EA }
	condition:
		$pattern
...
rule puts_4cffde03477a70637b0dc86c2c6a1bb6 {
	meta:
		aliases = "puts"
		size = "188"
		objfiles = "puts@libc.a"
	strings:
		$pattern = { A0 30 9F E5 F0 40 2D E9 00 50 93 E5 34 30 95 E5 01 70 73 E2 00 70 A0 33 00 00 57 E3 10 D0 4D E2 00 60 A0 E1 0A 00 00 0A 38 40 85 E2 0D 00 A0 E1 74 30 9F E5 74 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 64 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 06 00 A0 E1 05 10 A0 E1 ?? ?? ?? EB 01 00 70 E3 00 40 A0 E1 05 00 00 0A 05 10 A0 E1 0A 00 A0 E3 ?? ?? ?? EB 01 00 70 E3 00 40 A0 01 01 40 84 12 00 00 57 E3 0D 00 A0 11 01 10 A0 13 20 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule re_match_2_891b6085cdca20944012a1dd5a945767 {
	meta:
		aliases = "re_match_2"
		size = "4"
		objfiles = "regex_old@libc.a"
...
rule __setutent_3e8fe993483fbe6b91ef200c24394c0c {
	meta:
		aliases = "__setutent"
		size = "200"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { B4 30 9F E5 00 00 93 E5 00 00 50 E3 10 40 2D E9 25 00 00 AA A4 30 9F E5 A4 10 9F E5 00 00 93 E5 05 00 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 70 30 9F E5 00 00 50 E3 00 00 83 E5 0F 00 00 AA 64 30 9F E5 02 17 A0 E3 00 00 93 E5 05 00 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 00 00 E0 E3 30 30 9F E5 00 00 50 E3 00 00 83 E5 10 80 BD B8 20 30 9F E5 00 00 93 E5 02 10 A0 E3 01 20 A0 E3 10 40 BD E8 ?? ?? ?? EA 00 10 A0 E3 01 20 A0 E1 10 40 BD E8 ?? ?? ?? EA ?? ?? ?? ?? ?? ?? ?? ?? 02 00 08 00 }
	condition:
		$pattern
}

rule __GI_vfork_704a65e4313fd53c8769931b1a84edbd {
	meta:
...
rule svcunixfd_create_370c3a9f45fd816616b096b120b6682c {
	meta:
...
rule getuid_018a01d6b3ee4cb003f3469b2f581cfb {
	meta:
		aliases = "__GI_getuid, getuid"
		size = "8"
		objfiles = "getuid@libc.a"
	strings:
		$pattern = { C7 00 90 EF 0E F0 A0 E1 }
	condition:
		$pattern
}

rule getgid_2058611207f892c651c1d76894b5b435 {
	meta:
		aliases = "__GI_getgid, getgid"
		size = "8"
		objfiles = "getgid@libc.a"
	strings:
		$pattern = { C8 00 90 EF 0E F0 A0 E1 }
	condition:
		$pattern
}

rule geteuid_30ffa6f933a03f5ee354acc2603a2e28 {
	meta:
		aliases = "__GI_geteuid, geteuid"
		size = "8"
		objfiles = "geteuid@libc.a"
	strings:
		$pattern = { C9 00 90 EF 0E F0 A0 E1 }
	condition:
		$pattern
}

rule __GI_getegid_dcba7c4206f1beb5f371eab1a90ff9c1 {
	meta:
		aliases = "getegid, __GI_getegid"
		size = "8"
		objfiles = "getegid@libc.a"
	strings:
		$pattern = { CA 00 90 EF 0E F0 A0 E1 }
	condition:
		$pattern
}
...
rule mq_timedsend_767e76f15ba99d71fef66fc5ce30f805 {
	meta:
...
rule __GI_updwtmp_e2b677684d530ac01ff7bd1d57b2bfa2 {
	meta:
		aliases = "updwtmp, __GI_updwtmp"
		size = "144"
		objfiles = "wtent@libc.a"
	strings:
		$pattern = { F0 40 2D E9 00 20 A0 E3 01 70 A0 E1 78 10 9F E5 05 00 90 EF 01 0A 70 E3 00 40 A0 E1 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 F0 80 BD E8 00 50 50 E2 F0 80 BD B8 01 10 A0 E3 ?? ?? ?? EB 00 60 50 E2 F0 80 BD 18 07 10 A0 E1 05 00 A0 E1 06 2D A0 E3 04 00 90 EF 01 0A 70 E3 00 40 A0 E1 02 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 06 10 A0 E1 05 00 A0 E1 06 20 A0 E1 ?? ?? ?? EB 05 00 A0 E1 06 00 90 EF F0 80 BD E8 01 04 00 00 }
	condition:
		$pattern
}

rule __GI_xdr_string_44eff910b3455951a5e993d3bf195ac9 {
	meta:
...
rule __GI_closedir_288715873f86eda590ca47cda7b0562b {
	meta:
		aliases = "closedir, __GI_closedir"
		size = "212"
		objfiles = "closedir@libc.a"
	strings:
		$pattern = { F0 40 2D E9 00 40 90 E5 01 00 74 E3 10 D0 4D E2 00 60 A0 E1 04 00 00 1A ?? ?? ?? EB 09 30 A0 E3 04 20 A0 E1 00 30 80 E5 22 00 00 EA 18 40 80 E2 04 20 A0 E1 88 10 9F E5 0D 00 A0 E1 84 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 70 E0 E3 04 00 A0 E1 74 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 40 96 E5 01 10 A0 E3 64 30 9F E5 0D 00 A0 E1 00 70 86 E5 0F E0 A0 E1 03 F0 A0 E1 0C 00 96 E5 ?? ?? ?? EB 06 00 A0 E1 ?? ?? ?? EB 0D 50 A0 E1 04 00 A0 E1 06 00 90 EF 01 0A 70 E3 00 40 A0 E1 00 00 A0 91 03 00 00 9A ?? ?? ?? EB 00 30 64 E2 00 30 80 E5 07 00 A0 E1 00 20 A0 E1 02 00 A0 E1 10 D0 8D E2 F0 80 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule wcsncasecmp_e408ad5e71607b1d669763b18492d343 {
	meta:
		aliases = "wcsncasecmp"
		size = "140"
...
rule __GI_xprt_register_6f5bceb1a0e21abfc70efe6257ba7f33 {
	meta:
...
rule hcreate_r_02a7558551caefa3f5e57987e43c2875 {
	meta:
...
rule getcwd_2ee8af58a7267e0ede9f35647912b22a {
	meta:
...
rule __res_query_95fab8c3d7cfe678206f83ff0fc1a2cc {
	meta:
...
rule __getutid_8d2ee856653744e9b622581b9e40f011 {
	meta:
		aliases = "__getutid"
		size = "140"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { F0 40 2D E9 01 20 D0 E5 00 30 D0 E5 02 2C A0 E1 42 38 83 E1 01 30 43 E2 00 50 A0 E1 23 61 A0 E1 28 70 80 E2 13 00 00 EA 00 00 56 E3 09 00 00 1A 01 20 D4 E5 01 10 D5 E5 00 00 D4 E5 00 30 D5 E5 02 2C A0 E1 01 1C A0 E1 42 08 80 E1 41 38 83 E1 03 00 50 E1 06 00 00 EA 01 00 56 E3 05 00 00 1A 28 00 84 E2 07 10 A0 E1 04 20 A0 E3 ?? ?? ?? EB 00 00 50 E3 02 00 00 0A 9B FF FF EB 00 40 50 E2 E8 FF FF 1A 04 00 A0 E1 F0 80 BD E8 }
	condition:
		$pattern
}
...
rule __GI_clnt_sperror_d82f279187edad2f26e86575dd83340f {
	meta:
...
rule fseeko64_26428fdc236f8823ac698bdca2030287 {
	meta:
		aliases = "__GI_fseeko64, fseeko64"
		size = "312"
		objfiles = "fseeko64@libc.a"
	strings:
		$pattern = { F0 40 2D E9 02 00 53 E3 18 D0 4D E2 03 60 A0 E1 10 10 8D E5 14 20 8D E5 00 50 A0 E1 04 00 00 9A ?? ?? ?? EB 00 40 E0 E3 16 30 A0 E3 00 30 80 E5 39 00 00 EA 34 30 90 E5 01 70 73 E2 00 70 A0 33 00 00 57 E3 0A 00 00 0A 38 40 80 E2 D4 30 9F E5 0D 00 A0 E1 D0 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 C0 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 D5 E5 40 00 13 E3 03 00 00 0A 05 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 1B 00 00 1A 01 00 56 E3 04 00 00 1A 05 00 A0 E1 10 10 8D E2 ?? ?? ?? EB 00 00 50 E3 14 00 00 BA 06 20 A0 E1 05 00 A0 E1 10 10 8D E2 ?? ?? ?? EB 00 00 50 E3 0E 00 00 BA 00 30 95 E5 }
	condition:
		$pattern
}
...
rule __GI_fmin_ee6e46a63bd9c2985d65018922760db5 {
	meta:
...
rule scalb_61b20d72d464673a0d1b73f78a955dff {
	meta:
		aliases = "__ieee754_scalb, scalb"
		size = "340"
		objfiles = "e_scalb@libm.a"
	strings:
		$pattern = { F0 40 2D E9 02 40 A0 E1 03 50 A0 E1 00 60 A0 E1 01 70 A0 E1 ?? ?? ?? EB 00 00 50 E3 10 00 00 1A 04 00 A0 E1 05 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 0B 00 00 1A 04 00 A0 E1 05 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 11 00 00 1A 04 00 A0 E1 05 10 A0 E1 00 20 A0 E3 00 30 A0 E3 ?? ?? ?? EB 00 00 50 E3 05 00 00 DA 06 00 A0 E1 07 10 A0 E1 04 20 A0 E1 05 30 A0 E1 ?? ?? ?? EB F0 80 BD E8 02 21 84 E2 05 30 A0 E1 06 00 A0 E1 07 10 A0 E1 0E 00 00 EA 04 00 A0 E1 05 10 A0 E1 ?? ?? ?? EB 04 20 A0 E1 05 30 A0 E1 ?? ?? ?? EB 00 00 50 E3 08 00 00 0A 04 20 A0 E1 05 30 A0 E1 04 00 A0 E1 05 10 A0 E1 ?? ?? ?? EB 00 20 A0 E1 }
	condition:
		$pattern
}
...
rule recv_9f456afe647f211a108d8f577808cae8 {
	meta:
		aliases = "send, pread, pwrite, epoll_wait, recv"
		size = "84"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule epoll_pwait_e36755976a355cc322578c7a15ab7b3c {
	meta:
		aliases = "epoll_pwait"
		size = "92"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { F0 40 2D E9 08 D0 4D E2 00 70 A0 E1 01 40 A0 E1 01 00 A0 E3 04 10 8D E2 02 50 A0 E1 03 60 A0 E1 ?? ?? ?? EB 1C C0 9D E5 04 10 A0 E1 05 20 A0 E1 06 30 A0 E1 07 00 A0 E1 00 C0 8D E5 ?? ?? ?? EB 00 10 A0 E3 00 40 A0 E1 04 00 9D E5 ?? ?? ?? EB 04 00 A0 E1 08 D0 8D E2 F0 80 BD E8 }
	condition:
		$pattern
}
...
rule if_indextoname_daf3fde3e273ec8076adbd81e02243c9 {
	meta:
		aliases = "if_indextoname"
		size = "136"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { F0 40 2D E9 20 D0 4D E2 00 50 A0 E1 01 60 A0 E1 ?? ?? ?? EB 00 40 50 E2 00 00 A0 B3 16 00 00 BA 5C 10 9F E5 0D 20 A0 E1 10 50 8D E5 ?? ?? ?? EB 00 00 50 E3 0D 70 A0 E1 09 00 00 AA ?? ?? ?? EB 00 20 A0 E1 00 30 92 E5 04 00 A0 E1 06 00 90 EF 13 00 53 E3 06 30 A0 03 00 00 A0 E3 00 30 82 E5 05 00 00 EA 04 00 A0 E1 06 00 90 EF 10 20 A0 E3 06 00 A0 E1 0D 10 A0 E1 ?? ?? ?? EB 20 D0 8D E2 F0 80 BD E8 10 89 00 00 }
	condition:
		$pattern
}
...
rule fsetpos_6776a953f56100dc2360cc04b5626141 {
	meta:
		aliases = "fsetpos"
		size = "180"
		objfiles = "fsetpos@libc.a"
	strings:
		$pattern = { F0 40 2D E9 34 30 90 E5 01 70 73 E2 00 70 A0 33 00 00 57 E3 10 D0 4D E2 00 50 A0 E1 01 60 A0 E1 0A 00 00 0A 38 40 80 E2 74 30 9F E5 0D 00 A0 E1 70 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 60 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 05 00 A0 E1 00 10 96 E5 00 20 A0 E3 ?? ?? ?? EB 00 40 50 E2 05 00 00 1A 04 20 96 E5 08 10 86 E2 0A 00 91 E8 2C 20 85 E5 02 30 C5 E5 30 10 85 E5 00 00 57 E3 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule fsetpos64_799e2948832cfedbc03acb9351891a06 {
	meta:
		aliases = "fsetpos64"
		size = "180"
		objfiles = "fsetpos64@libc.a"
	strings:
		$pattern = { F0 40 2D E9 34 30 90 E5 01 70 73 E2 00 70 A0 33 00 00 57 E3 10 D0 4D E2 00 50 A0 E1 01 60 A0 E1 0A 00 00 0A 38 40 80 E2 74 30 9F E5 0D 00 A0 E1 70 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 60 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 05 00 A0 E1 06 00 96 E8 00 30 A0 E3 ?? ?? ?? EB 00 40 50 E2 05 00 00 1A 08 20 96 E5 0C 10 86 E2 0A 00 91 E8 2C 20 85 E5 02 30 C5 E5 30 10 85 E5 00 00 57 E3 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule fgetpos_2d9e8b0a4011958104f4809f640fc9f7 {
	meta:
		aliases = "fgetpos"
		size = "180"
		objfiles = "fgetpos@libc.a"
	strings:
		$pattern = { F0 40 2D E9 34 30 90 E5 01 70 73 E2 00 70 A0 33 00 00 57 E3 10 D0 4D E2 00 50 A0 E1 01 60 A0 E1 0A 00 00 0A 38 40 80 E2 74 30 9F E5 0D 00 A0 E1 70 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 60 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 05 00 A0 E1 ?? ?? ?? EB 00 00 86 E5 00 00 50 E3 2C 30 95 A5 30 20 95 A5 04 30 86 A5 08 20 86 A5 02 30 D5 A5 00 40 E0 B3 0C 30 86 A5 00 40 A0 A3 00 00 57 E3 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule fgetpos64_dc0eaf920818d20258d9f4e88208c343 {
	meta:
		aliases = "fgetpos64"
		size = "180"
		objfiles = "fgetpos64@libc.a"
	strings:
		$pattern = { F0 40 2D E9 34 30 90 E5 01 70 73 E2 00 70 A0 33 00 00 57 E3 10 D0 4D E2 00 50 A0 E1 01 60 A0 E1 0A 00 00 0A 38 40 80 E2 74 30 9F E5 0D 00 A0 E1 70 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 60 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 05 00 A0 E1 ?? ?? ?? EB 03 00 86 E8 00 00 51 E3 2C 30 95 A5 30 20 95 A5 08 30 86 A5 0C 20 86 A5 02 30 D5 A5 00 40 E0 B3 10 30 86 A5 00 40 A0 A3 00 00 57 E3 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule fwide_875fad6fff7cc733c649397247a96f15 {
	meta:
		aliases = "fwide"
		size = "208"
		objfiles = "fwide@libc.a"
	strings:
		$pattern = { F0 40 2D E9 34 30 90 E5 01 70 73 E2 00 70 A0 33 00 00 57 E3 10 D0 4D E2 00 50 A0 E1 01 60 A0 E1 0A 00 00 0A 38 40 80 E2 90 30 9F E5 0D 00 A0 E1 8C 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 7C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 56 E3 0B 00 00 0A 00 20 D5 E5 01 30 D5 E5 03 14 82 E1 22 0D 11 E3 06 00 00 1A 00 00 56 E3 80 30 A0 D3 02 3B A0 C3 01 30 83 E1 43 24 A0 E1 01 20 C5 E5 00 30 C5 E5 01 20 D5 E5 00 30 D5 E5 00 00 57 E3 02 44 83 E1 0D 00 A0 11 01 10 A0 13 24 30 9F 15 0F E0 A0 11 03 F0 A0 11 80 30 04 E2 02 0B 04 E2 00 00 63 E0 10 D0 8D E2 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule fputs_de44a2512605de63087ee0719640546b {
	meta:
		aliases = "__GI_fputs, __GI_fputws, fputws, fputwc, putwc, fputs"
		size = "148"
		objfiles = "fputs@libc.a, fputws@libc.a, fputwc@libc.a"
	strings:
		$pattern = { F0 40 2D E9 34 30 91 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 10 D0 4D E2 01 50 A0 E1 00 70 A0 E1 0A 00 00 0A 38 40 81 E2 0D 00 A0 E1 50 30 9F E5 50 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 40 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 07 00 A0 E1 05 10 A0 E1 ?? ?? ?? EB 00 00 56 E3 00 40 A0 E1 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule ungetc_129338ec1c279771b1d9949380bd11a6 {
	meta:
		aliases = "__GI_ungetc, ungetc"
		size = "380"
		objfiles = "ungetc@libc.a"
	strings:
		$pattern = { F0 40 2D E9 34 30 91 E5 01 70 73 E2 00 70 A0 33 00 00 57 E3 10 D0 4D E2 01 50 A0 E1 00 60 A0 E1 0A 00 00 0A 38 40 81 E2 0D 00 A0 E1 38 31 9F E5 38 11 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 28 31 9F E5 0F E0 A0 E1 03 F0 A0 E1 10 10 95 E5 18 30 95 E5 01 00 76 E3 03 00 51 11 0E 00 00 2A 08 30 95 E5 03 00 51 E1 0B 00 00 9A 01 20 51 E5 FF 30 06 E2 03 00 52 E1 07 00 00 1A 00 30 95 E5 04 30 C3 E3 01 10 41 E2 43 24 A0 E1 01 20 C5 E5 10 10 85 E5 00 30 C5 E5 29 00 00 EA 00 30 D5 E5 83 30 03 E2 80 00 53 E3 04 00 00 8A 05 00 A0 E1 80 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 1F 00 00 1A 00 20 D5 E5 }
	condition:
		$pattern
}

rule ungetwc_8b40cb42ec60d0c241ea178ee33cccc0 {
	meta:
		aliases = "__GI_ungetwc, ungetwc"
		size = "308"
		objfiles = "ungetwc@libc.a"
	strings:
		$pattern = { F0 40 2D E9 34 30 91 E5 01 70 73 E2 00 70 A0 33 00 00 57 E3 10 D0 4D E2 01 50 A0 E1 00 60 A0 E1 0A 00 00 0A 38 40 81 E2 0D 00 A0 E1 EC 30 9F E5 EC 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 DC 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 D5 E5 01 10 D5 E5 CC 20 9F E5 01 34 83 E1 02 20 03 E0 02 0B 52 E3 04 00 00 8A 05 00 A0 E1 02 1B A0 E3 ?? ?? ?? EB 00 00 50 E3 1D 00 00 1A 00 20 D5 E5 01 30 D5 E5 03 34 82 E1 02 00 13 E3 04 00 00 0A 01 00 13 E3 16 00 00 1A 28 30 95 E5 00 00 53 E3 13 00 00 1A 01 00 76 E3 11 00 00 0A 00 30 95 E5 01 30 83 E2 03 38 A0 E1 23 38 A0 E1 43 24 A0 E1 01 10 03 E2 }
	condition:
		$pattern
}
...
rule __GI___xpg_strerror_r_dec5e9c33145504e227fc8f6f8fc0710 {
	meta:
...
rule _dl_linux_resolver_7f7dc3b46378061731204e2a7f31d11c {
	meta:
		aliases = "_dl_linux_resolver"
		size = "168"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { F0 40 2D E9 9C 40 90 E5 81 C1 A0 E1 04 30 8C E0 04 30 93 E5 58 20 90 E5 23 34 A0 E1 03 22 92 E7 54 30 90 E5 00 E0 A0 E1 04 70 9C E7 04 D0 4D E2 00 C0 A0 E3 02 50 83 E0 1C 10 9E E5 00 C0 8D E5 00 20 A0 E1 01 30 A0 E3 05 00 A0 E1 00 60 9E E5 ?? ?? ?? EB 00 40 50 E2 0B 00 00 1A 38 20 9F E5 05 30 A0 E1 00 20 92 E5 02 00 80 E2 2C 10 9F E5 ?? ?? ?? EB 01 00 A0 E3 01 00 90 EF 01 0A 70 E3 1C 30 9F 85 00 20 60 82 00 20 83 85 04 00 A0 E1 07 40 86 E7 04 D0 8D E2 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule res_sync_func_0b38f331411233926b12f2e7866b9747 {
	meta:
		aliases = "res_sync_func"
		size = "176"
		objfiles = "res_init@libc.a"
	strings:
		$pattern = { F0 40 2D E9 ?? ?? ?? EB 00 50 A0 E1 88 00 9F E5 88 30 9F E5 00 20 90 E5 03 00 52 E1 13 00 00 0A 7C 10 9F E5 60 20 D5 E5 00 30 91 E5 02 00 53 E1 00 20 81 85 00 40 91 E5 00 70 A0 E1 1C 60 A0 E3 07 00 00 EA 00 30 97 E5 94 36 2E E0 54 30 92 E5 03 C0 A0 E1 0F 00 BC E8 0F 00 AE E8 07 00 9C E8 07 00 8E E8 01 40 54 E2 04 21 85 E0 F4 FF FF 5A 52 30 D5 E5 2C 20 9F E5 00 00 53 E3 05 30 A0 03 00 30 C2 E5 53 30 D5 E5 1C 20 9F E5 00 00 53 E3 03 30 A0 03 00 30 C2 E5 F0 80 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_vdprintf_0a726833e0b62f0d42a2e96595b1e4b7 {
	meta:
...
rule nprocessors_onln_498db879b660be615bd2b193d6776507 {
	meta:
		aliases = "nprocessors_onln"
		size = "280"
		objfiles = "sysconf@libc.a"
	strings:
		$pattern = { F0 40 2D E9 EC 00 9F E5 04 D0 4D E2 00 40 A0 E3 00 40 8D E5 ?? ?? ?? EB 00 50 50 E2 D8 70 9F 15 0D 60 A0 11 10 00 00 1A 17 00 00 EA 00 30 9D E5 00 20 93 E5 00 30 D2 E5 63 00 53 E3 0A 00 00 1A 01 30 D2 E5 70 00 53 E3 07 00 00 1A 02 30 D2 E5 75 00 53 E3 04 00 00 1A 03 30 D2 E5 00 20 97 E5 83 30 D2 E7 08 00 13 E3 01 40 84 12 05 00 A0 E1 0D 10 A0 E1 84 20 9F E5 84 30 9F E5 ?? ?? ?? EB 00 00 50 E3 E8 FF FF 1A 13 00 00 EA 74 00 9F E5 ?? ?? ?? EB 00 50 50 E2 05 40 A0 01 0D 60 A0 11 05 00 00 1A 0C 00 00 EA 00 30 9D E5 00 10 93 E5 ?? ?? ?? EB 00 00 50 E3 01 40 84 02 0D 10 A0 E1 44 20 9F E5 44 30 9F E5 }
	condition:
		$pattern
}
...
rule __GI_getttyent_86b717d6db2a840367e09c93fdb7e016 {
	meta:
...
rule __GI_getmntent_r_88fb9f4ac3d192262a816c1a595cdb26 {
	meta:
...
rule putgrent_7185cd575cfe913b8c56f88b01298517 {
	meta:
		aliases = "putgrent"
		size = "288"
		objfiles = "putgrent@libc.a"
	strings:
		$pattern = { F0 41 2D E9 00 00 51 E3 00 00 50 13 14 D0 4D E2 00 50 A0 E1 01 60 A0 E1 04 00 00 1A ?? ?? ?? EB 00 40 E0 E3 16 30 A0 E3 00 30 80 E5 31 00 00 EA 34 30 91 E5 01 80 73 E2 00 80 A0 33 00 00 58 E3 0A 00 00 0A 38 40 81 E2 04 00 8D E2 B0 30 9F E5 B0 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 A0 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 08 30 95 E5 00 30 8D E5 06 00 A0 E1 8C 10 9F E5 0C 00 95 E8 ?? ?? ?? EB 00 00 50 E3 12 00 00 BA 0C 50 95 E5 78 10 9F E5 78 70 9F E5 00 40 95 E5 00 00 54 E3 06 00 A0 E1 04 20 A0 E1 04 50 85 E2 05 00 00 1A 06 10 A0 E1 0A 00 A0 E3 ?? ?? ?? EB 00 00 50 E3 04 00 00 BA }
	condition:
		$pattern
}

rule rtime_c4f9087c69c958bdf13adf8f99e6fc21 {
	meta:
...
rule vwarn_work_2b38b2f6d2a484c6e94ce2a76e36edb4 {
	meta:
		aliases = "vwarn_work"
		size = "256"
		objfiles = "err@libc.a"
	strings:
		$pattern = { F0 41 2D E9 00 00 52 E3 50 D0 4D E2 00 70 A0 E1 01 80 A0 E1 C0 50 9F 05 05 00 00 0A ?? ?? ?? EB 0D 10 A0 E1 00 00 90 E5 40 20 A0 E3 ?? ?? ?? EB A8 50 9F E5 A8 40 9F E5 00 20 94 E5 34 30 92 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 0A 00 00 0A 40 00 8D E2 8C 30 9F E5 38 20 82 E2 88 10 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 94 E5 7C 30 9F E5 38 00 80 E2 0F E0 A0 E1 03 F0 A0 E1 70 30 9F E5 00 00 94 E5 00 20 93 E5 68 10 9F E5 ?? ?? ?? EB 00 00 57 E3 04 00 00 0A 07 10 A0 E1 08 20 A0 E1 00 00 94 E5 ?? ?? ?? EB 02 50 45 E2 00 00 94 E5 05 10 A0 E1 0D 20 A0 E1 ?? ?? ?? EB 00 00 56 E3 40 00 8D 12 01 10 A0 13 }
	condition:
		$pattern
}

rule xdr_pmaplist_8bb6801dd4a503893b5e620c97211b9d {
	meta:
...
rule __GI_pthread_setschedparam_706249afa1043cc2ab117de980016e73 {
	meta:
...
rule xdr_reference_f8e7396350acc32136b7c1712d24ec7a {
	meta:
...
rule ___path_search_84c7e348e1d446dd907268538ed28671 {
	meta:
		aliases = "___path_search"
		size = "280"
		objfiles = "tempname@libc.a"
	strings:
		$pattern = { F0 41 2D E9 00 60 53 E2 08 D0 4D E2 00 80 A0 E1 01 70 A0 E1 02 40 A0 E1 08 00 00 0A 00 30 D6 E5 00 00 53 E3 05 00 00 0A 06 00 A0 E1 ?? ?? ?? EB 05 00 50 E3 00 50 A0 E1 05 50 A0 C3 01 00 00 EA C4 60 9F E5 04 50 A0 E3 00 00 54 E3 11 00 00 1A B8 00 9F E5 2A FF FF EB 00 00 50 E3 0C 00 00 1A A8 00 9F E5 00 10 A0 E1 ?? ?? ?? EB 00 00 50 E3 03 00 00 0A 94 00 9F E5 21 FF FF EB 00 00 50 E3 03 00 00 1A ?? ?? ?? EB 00 20 E0 E3 02 30 A0 E3 12 00 00 EA 74 40 9F E5 04 00 A0 E1 ?? ?? ?? EB 00 20 A0 E1 00 00 00 EA 01 20 42 E2 01 00 52 E3 04 30 82 E0 02 00 00 DA 01 30 53 E5 2F 00 53 E3 F8 FF FF 0A 08 30 85 E2 }
	condition:
		$pattern
}
...
rule tgamma_5aa9c2e4aae38ccc98e375bf398d6b0c {
	meta:
		aliases = "__GI_tgamma, tgamma"
		size = "228"
		objfiles = "e_lgamma_r@libm.a"
	strings:
		$pattern = { F0 41 2D E9 02 31 C0 E3 01 30 93 E1 04 D0 4D E2 00 60 A0 E1 01 70 A0 E1 00 40 A0 E1 01 50 A0 E1 01 80 A0 E1 00 20 A0 01 B0 00 9F 05 01 30 A0 01 00 10 A0 03 11 00 00 0A 01 06 70 E3 00 30 A0 23 01 30 A0 33 A0 3F 13 E0 0E 00 00 0A ?? ?? ?? EB 06 20 A0 E1 07 30 A0 E1 ?? ?? ?? EB 00 00 50 E3 08 00 00 1A 06 20 A0 E1 07 30 A0 E1 06 00 A0 E1 07 10 A0 E1 ?? ?? ?? EB 00 20 A0 E1 01 30 A0 E1 ?? ?? ?? EB 13 00 00 EA 00 00 58 E3 01 06 74 03 05 00 00 1A 06 00 A0 E1 07 10 A0 E1 06 20 A0 E1 07 30 A0 E1 ?? ?? ?? EB 0A 00 00 EA 0D 20 A0 E1 06 00 A0 E1 07 10 A0 E1 ?? ?? ?? EB ?? ?? ?? EB 00 30 9D E5 00 00 53 E3 }
	condition:
		$pattern
}
...
rule __GI_authunix_create_default_c00a2fdc93ee4260ce6a99874bab3cbf {
	meta:
...
rule __GI_lockf64_f5340e95f98e23286a2d9e5965c0286a {
	meta:
...
rule __GI_getgrent_r_99821bf27485a6a4b744561d515384a2 {
	meta:
		aliases = "__GI_getpwent_r, __GI_getspent_r, getgrent_r, getpwent_r, getspent_r, __GI_getgrent_r"
		size = "240"
		objfiles = "getpwent_r@libc.a, getspent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule __GI_readdir_r_f5162547dc741dd2bb71cf1db790f9c4 {
	meta:
...
rule __GI_gethostent_r_538df7c0b16f5b16617bf11fe71338c0 {
	meta:
		aliases = "gethostent_r, __GI_gethostent_r"
		size = "224"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { F0 41 2D E9 24 D0 4D E2 00 60 A0 E1 01 70 A0 E1 14 00 8D E2 A8 10 9F E5 02 80 A0 E1 A4 50 9F E5 A4 20 9F E5 03 40 A0 E1 A0 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 98 30 9F E5 8C 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 95 E5 00 00 53 E3 05 00 00 1A ?? ?? ?? EB 00 00 50 E3 00 00 85 E5 00 00 84 05 02 50 A0 03 0E 00 00 0A 58 30 9F E5 3C C0 9D E5 00 00 93 E5 00 10 A0 E3 01 30 A0 E3 02 20 A0 E3 C0 01 8D E8 0C 40 8D E5 10 C0 8D E5 ?? ?? ?? EB 40 30 9F E5 00 30 93 E5 00 00 53 E3 00 50 A0 E1 ?? ?? ?? 0B 14 00 8D E2 01 10 A0 E3 28 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 05 00 A0 E1 24 D0 8D E2 F0 81 BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __psfs_parse_spec_dc4e665af4d66bf190df8e98e0199471 {
	meta:
		aliases = "__psfs_parse_spec"
		size = "660"
		objfiles = "__psfs_parse_spec@libc.a"
	strings:
		$pattern = { F0 41 2D E9 30 80 90 E5 00 30 D8 E5 30 30 43 E2 09 00 53 E3 00 40 A0 83 01 50 A0 83 19 00 00 8A 54 E2 9F E5 00 40 A0 E3 0A C0 A0 E3 0E 00 54 E1 30 20 90 D5 01 30 D2 D4 30 20 80 D5 30 10 90 E5 00 20 D1 E5 30 30 43 D2 9C 34 24 D0 30 30 42 E2 09 00 53 E3 F4 FF FF 9A 24 00 52 E3 06 00 00 0A 24 30 90 E5 00 00 53 E3 01 30 E0 B3 40 40 80 B5 24 30 80 B5 38 00 00 BA 79 00 00 EA 01 30 81 E2 30 30 80 E5 00 50 A0 E3 F0 71 9F E5 10 60 A0 E3 07 10 A0 E1 06 C0 A0 E1 30 E0 90 E5 00 20 D1 E5 00 30 DE E5 03 00 52 E1 05 00 00 1A 45 30 D0 E5 01 20 8E E2 0C 30 83 E1 30 20 80 E5 45 30 C0 E5 F2 FF FF EA 01 20 F1 E5 }
	condition:
		$pattern
}

rule vfprintf_2a8b144b501238b25bc50d549211c598 {
	meta:
		aliases = "__GI_vfprintf, vfprintf"
		size = "196"
		objfiles = "vfprintf@libc.a"
	strings:
		$pattern = { F0 41 2D E9 34 30 90 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 10 D0 4D E2 00 50 A0 E1 01 70 A0 E1 02 80 A0 E1 0A 00 00 0A 38 40 80 E2 80 30 9F E5 0D 00 A0 E1 7C 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 6C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 D5 E5 C0 30 03 E2 C0 00 53 E3 05 00 00 0A 05 00 A0 E1 80 10 A0 E3 ?? ?? ?? EB 00 00 50 E3 00 40 E0 13 04 00 00 1A 05 00 A0 E1 07 10 A0 E1 08 20 A0 E1 ?? ?? ?? EB 00 40 A0 E1 00 00 56 E3 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 F0 81 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_vfwprintf_1787895d8e92b8bc84c3dea22a54541b {
	meta:
		aliases = "vfwprintf, __GI_vfwprintf"
		size = "204"
		objfiles = "vfwprintf@libc.a"
	strings:
		$pattern = { F0 41 2D E9 34 30 90 E5 01 60 73 E2 00 60 A0 33 00 00 56 E3 10 D0 4D E2 00 50 A0 E1 01 70 A0 E1 02 80 A0 E1 0A 00 00 0A 38 40 80 E2 88 30 9F E5 0D 00 A0 E1 84 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 74 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 D5 E5 01 20 D5 E5 02 34 83 E1 21 3D 03 E2 21 0D 53 E3 05 00 00 0A 05 00 A0 E1 02 1B A0 E3 ?? ?? ?? EB 00 00 50 E3 00 40 E0 13 04 00 00 1A 05 00 A0 E1 07 10 A0 E1 08 20 A0 E1 ?? ?? ?? EB 00 40 A0 E1 00 00 56 E3 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 F0 81 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule fgetws_e1ad05b39029ecc7794442e9c59040ca {
	meta:
		aliases = "__GI_fgets, fgets, fgetws"
		size = "156"
		objfiles = "fgets@libc.a, fgetws@libc.a"
	strings:
		$pattern = { F0 41 2D E9 34 30 92 E5 01 80 73 E2 00 80 A0 33 00 00 58 E3 10 D0 4D E2 02 50 A0 E1 00 60 A0 E1 01 70 A0 E1 0A 00 00 0A 38 40 82 E2 0D 00 A0 E1 54 30 9F E5 54 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 44 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 06 00 A0 E1 07 10 A0 E1 05 20 A0 E1 ?? ?? ?? EB 00 00 58 E3 00 40 A0 E1 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 F0 81 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule openlog_deb24c53d32a69b33ce7e2d726a8168d {
	meta:
		aliases = "__GI_openlog, openlog"
		size = "132"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { F0 41 2D E9 64 40 9F E5 10 D0 4D E2 00 60 A0 E1 01 70 A0 E1 02 80 A0 E1 54 10 9F E5 04 20 A0 E1 0D 00 A0 E1 4C 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 44 30 9F E5 04 00 A0 E1 0F E0 A0 E1 03 F0 A0 E1 06 00 A0 E1 07 10 A0 E1 08 20 A0 E1 BD FE FF EB 0D 00 A0 E1 01 10 A0 E3 20 30 9F E5 0D 50 A0 E1 0F E0 A0 E1 03 F0 A0 E1 10 D0 8D E2 F0 81 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __cxa_finalize_352d8a1e91a15e22270137d380123a55 {
	meta:
		aliases = "__cxa_finalize"
		size = "140"
		objfiles = "__cxa_finalize@libc.a"
	strings:
		$pattern = { F0 41 2D E9 78 30 9F E5 78 80 9F E5 00 60 93 E5 00 70 A0 E1 16 00 00 EA 00 30 98 E5 00 00 57 E3 06 52 83 E0 02 00 00 0A 0C 30 95 E5 03 00 57 E1 0F 00 00 1A 05 20 A0 E1 00 10 A0 E3 03 40 A0 E3 00 30 92 E5 04 00 53 E1 05 00 00 1A 04 00 A0 E1 0F 3A E0 E3 0F E0 A0 E1 3F F0 43 E2 F7 FF FF 3A 04 30 A0 E1 04 00 53 E1 08 00 95 05 0F E0 A0 01 04 F0 95 05 00 00 56 E3 01 60 46 E2 E5 FF FF 1A F0 81 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule strcasestr_5173c64790cccfc78380696e2beb0819 {
	meta:
...
rule __GI_sysconf_8496513e4b9ccc686652ea1fbddf4bd5 {
	meta:
		aliases = "sysconf, __GI_sysconf"
		size = "1472"
		objfiles = "sysconf@libc.a"
	strings:
		$pattern = { F0 41 2D E9 F0 00 50 E3 00 F1 9F 97 F2 00 00 EA ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_regexec_60852ddf7844e8b9db3412f69df7b0d5 {
	meta:
...
rule setvbuf_b981e251dae273faa61ea98c394f5fcf {
	meta:
		aliases = "__GI_setvbuf, setvbuf"
		size = "416"
		objfiles = "setvbuf@libc.a"
	strings:
		$pattern = { F0 45 2D E9 00 50 A0 E1 34 00 90 E5 01 A0 70 E2 00 A0 A0 33 00 00 5A E3 10 D0 4D E2 01 60 A0 E1 02 70 A0 E1 03 80 A0 E1 0A 00 00 0A 38 40 85 E2 0D 00 A0 E1 50 31 9F E5 50 11 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 40 31 9F E5 0F E0 A0 E1 03 F0 A0 E1 02 00 57 E3 04 00 00 9A ?? ?? ?? EB 00 40 E0 E3 16 30 A0 E3 00 30 80 E5 3C 00 00 EA 00 20 D5 E5 01 30 D5 E5 14 11 9F E5 03 34 82 E1 01 10 03 E0 00 00 51 E3 00 40 E0 13 34 00 00 1A 03 3C C3 E3 00 00 58 E3 02 00 57 13 07 34 83 E1 01 60 A0 01 43 24 A0 E1 00 00 A0 13 01 00 A0 03 01 20 C5 E5 00 30 C5 E5 06 80 A0 01 06 40 A0 01 0D 00 00 0A }
	condition:
		$pattern
}
...
rule tcsetattr_e11e9c1c2c89f9fb2b0d6817f9d6e3d1 {
	meta:
...
rule fread_unlocked_4134e071cdeaef0607b563407762baa3 {
	meta:
...
rule fread_1fbb682d671a10b2789a15ff3c6e9f59 {
	meta:
		aliases = "__GI_fread, fwrite, __GI_fwrite, fread"
		size = "164"
		objfiles = "fread@libc.a, fwrite@libc.a"
	strings:
		$pattern = { F0 45 2D E9 03 50 A0 E1 34 30 93 E5 01 A0 73 E2 00 A0 A0 33 00 00 5A E3 10 D0 4D E2 00 60 A0 E1 01 70 A0 E1 02 80 A0 E1 0A 00 00 0A 38 40 85 E2 0D 00 A0 E1 58 30 9F E5 58 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 48 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 06 00 A0 E1 07 10 A0 E1 08 20 A0 E1 05 30 A0 E1 ?? ?? ?? EB 00 00 5A E3 00 40 A0 E1 0D 00 A0 11 01 10 A0 13 1C 30 9F 15 0F E0 A0 11 03 F0 A0 11 04 00 A0 E1 10 D0 8D E2 F0 85 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_getprotobynumber_r_b049d20322d21e78a9c2c3d045dd5637 {
	meta:
		aliases = "getprotobynumber_r, __GI_getprotobynumber_r"
		size = "208"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { F0 45 2D E9 10 D0 4D E2 00 80 A0 E1 01 50 A0 E1 0D 00 A0 E1 9C 10 9F E5 02 70 A0 E1 03 60 A0 E1 94 20 9F E5 94 30 9F E5 2C A0 9D E5 0F E0 A0 E1 03 F0 A0 E1 88 30 9F E5 7C 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 7C 30 9F E5 00 00 93 E5 ?? ?? ?? EB 02 00 00 EA 08 30 95 E5 03 00 58 E1 06 00 00 0A 05 00 A0 E1 07 10 A0 E1 06 20 A0 E1 0A 30 A0 E1 ?? ?? ?? EB 00 40 50 E2 F5 FF FF 0A 44 30 9F E5 00 30 93 E5 00 00 53 E3 ?? ?? ?? 0B 0D 00 A0 E1 01 10 A0 E3 30 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 9A E5 00 00 50 E3 04 00 A0 01 00 00 A0 13 10 D0 8D E2 F0 85 BD E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? }
	condition:
		$pattern
}

rule getservent_r_86f79094706961cd01e4ea6473710c2b {
	meta:
		aliases = "__GI_getservent_r, getservent_r"
		size = "332"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { F0 45 2D E9 13 0E 52 E3 00 80 A0 E3 14 D0 4D E2 02 50 A0 E1 03 A0 A0 E1 00 60 A0 E1 01 70 A0 E1 10 80 8D E5 00 80 83 E5 22 40 A0 33 38 00 00 3A 0D 00 A0 E1 EC 10 9F E5 EC 20 9F E5 EC 30 9F E5 EC 40 9F E5 0F E0 A0 E1 03 F0 A0 E1 E4 30 9F E5 D4 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 94 E5 00 00 53 E3 D0 30 9F 05 00 00 93 05 ?? ?? ?? 0B 00 00 94 E5 00 00 50 E3 1F 00 00 0A 30 20 45 E2 30 30 A0 E3 08 30 80 E5 10 20 80 E5 04 70 80 E5 10 10 8D E2 A4 20 9F E5 A4 30 9F E5 ?? ?? ?? EB 00 00 50 E3 14 00 00 0A 10 20 9D E5 02 40 A0 E1 04 30 94 E4 00 30 86 E5 04 50 84 E2 04 00 92 E5 10 50 8D E5 ?? ?? ?? EB }
	condition:
		$pattern
}
...
rule __GI_pmap_set_178eaf08229019da2744e39917154e13 {
	meta:
...
rule getprotoent_r_8cf1465b0b65c1d65cfed272403013e7 {
	meta:
		aliases = "__GI_getprotoent_r, getprotoent_r"
		size = "300"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { F0 45 2D E9 4B 0F 52 E3 00 70 A0 E3 14 D0 4D E2 02 50 A0 E1 03 A0 A0 E1 00 60 A0 E1 01 80 A0 E1 10 70 8D E5 00 70 83 E5 22 50 A0 33 30 00 00 3A 0D 00 A0 E1 CC 10 9F E5 CC 20 9F E5 CC 30 9F E5 CC 40 9F E5 0F E0 A0 E1 03 F0 A0 E1 C4 30 9F E5 B4 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 94 E5 00 00 53 E3 B0 30 9F 05 00 00 93 05 ?? ?? ?? 0B 00 00 94 E5 00 00 50 E3 17 00 00 0A 2C 20 45 E2 2C 30 A0 E3 08 30 80 E5 10 20 80 E5 04 80 80 E5 10 10 8D E2 84 20 9F E5 84 30 9F E5 ?? ?? ?? EB 00 00 50 E3 0C 00 00 0A 10 20 9D E5 02 40 A0 E1 04 30 94 E4 00 30 86 E5 04 40 84 E2 04 00 92 E5 10 40 8D E5 ?? ?? ?? EB }
	condition:
		$pattern
}

rule getnetent_r_bbc3d1067c8a8eccfa90d17bdaa6a4ea {
	meta:
		aliases = "__GI_getnetent_r, getnetent_r"
		size = "392"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { F0 45 2D E9 4B 0F 52 E3 00 70 A0 E3 38 D0 4D E2 02 60 A0 E1 03 A0 A0 E1 00 50 A0 E1 01 80 A0 E1 34 70 8D E5 00 70 83 E5 22 40 A0 33 47 00 00 3A 20 00 8D E2 28 11 9F E5 28 21 9F E5 28 31 9F E5 28 41 9F E5 0F E0 A0 E1 03 F0 A0 E1 20 31 9F E5 10 01 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 94 E5 00 00 53 E3 0C 31 9F 05 00 00 93 05 ?? ?? ?? 0B 00 00 94 E5 00 00 50 E3 2E 00 00 0A 2C 20 46 E2 2C 30 A0 E3 08 30 80 E5 10 20 80 E5 04 80 80 E5 34 10 8D E2 E0 20 9F E5 E0 30 9F E5 ?? ?? ?? EB 00 00 50 E3 23 00 00 0A 34 30 9D E5 04 20 93 E4 07 10 A0 E1 00 20 85 E5 0D 00 A0 E1 20 20 A0 E3 34 30 8D E5 ?? ?? ?? EB }
	condition:
		$pattern
}

rule lckpwdf_72b4034cbfb21900524903a00623096d {
	meta:
		aliases = "lckpwdf"
		size = "380"
		objfiles = "lckpwdf@libc.a"
	strings:
		$pattern = { F0 45 2D E9 4C A1 9F E5 00 80 9A E5 01 00 78 E3 58 D0 4D E2 00 00 E0 13 4C 00 00 1A 38 11 9F E5 38 21 9F E5 28 00 8D E2 34 31 9F E5 0F E0 A0 E1 03 F0 A0 E1 2C 31 9F E5 20 01 9F E5 0F E0 A0 E1 03 F0 A0 E1 20 01 9F E5 20 11 9F E5 ?? ?? ?? EB 01 00 70 E3 00 00 8A E5 36 00 00 0A 02 10 A0 E3 01 20 A0 E3 ?? ?? ?? EB 00 10 A0 E3 14 20 A0 E3 0D 00 A0 E1 ?? ?? ?? EB 14 70 8D E2 F0 30 9F E5 0D 10 A0 E1 07 20 A0 E1 50 60 8D E2 0E 00 A0 E3 00 40 A0 E3 00 30 8D E5 0C 80 8D E5 10 80 8D E5 ?? ?? ?? EB 02 3A A0 E3 48 10 8D E2 06 20 A0 E1 01 00 A0 E3 48 30 8D E5 38 50 8D E2 4C 40 8D E5 ?? ?? ?? EB 0F 00 A0 E3 }
	condition:
		$pattern
}
...
rule __GI___dl_iterate_phdr_1e90469de7ece537ba7bebf87f1ab702 {
	meta:
...
rule __GI_getdelim_1854bc0bcdf674a198be132891a0c5b7 {
	meta:
		aliases = "getdelim, __GI_getdelim"
		size = "328"
		objfiles = "getdelim@libc.a"
	strings:
		$pattern = { F0 47 2D E9 00 00 51 E3 00 00 50 13 10 D0 4D E2 00 80 A0 E1 01 60 A0 E1 02 90 A0 E1 03 50 A0 E1 01 00 00 0A 00 00 53 E3 04 00 00 1A ?? ?? ?? EB 00 50 E0 E3 16 30 A0 E3 00 30 80 E5 3A 00 00 EA 34 30 93 E5 01 A0 73 E2 00 A0 A0 33 00 00 5A E3 0A 00 00 0A 38 40 85 E2 0D 00 A0 E1 D4 30 9F E5 D4 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 C4 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 40 98 E5 00 00 54 E3 00 40 86 05 01 70 A0 E3 00 10 96 E5 01 00 57 E1 0A 00 00 3A 04 00 A0 E1 40 10 81 E2 ?? ?? ?? EB 00 00 50 E3 00 40 A0 E1 00 50 E0 03 16 00 00 0A 00 30 96 E5 40 30 83 E2 00 30 86 E5 00 00 88 E5 }
	condition:
		$pattern
}
...
rule vswprintf_0c1eae7f0ede5610479472b04d12a9c0 {
	meta:
		aliases = "__GI_vswprintf, vswprintf"
		size = "208"
		objfiles = "vswprintf@libc.a"
	strings:
		$pattern = { F0 47 2D E9 02 C0 E0 E3 50 D0 4D E2 04 C0 8D E5 53 C0 8C E2 00 C0 CD E5 08 C0 A0 E3 00 40 A0 E1 00 50 A0 E3 38 00 8D E2 01 C0 CD E5 01 C0 A0 E3 01 60 A0 E1 02 70 A0 E1 03 80 A0 E1 34 C0 8D E5 02 50 CD E5 2C 50 8D E5 ?? ?? ?? EB 04 30 E0 E1 23 91 A0 E1 06 00 59 E1 06 90 A0 21 09 31 84 E0 08 20 A0 E1 0D 00 A0 E1 07 10 A0 E1 0C 30 8D E5 20 50 8D E5 1C 40 8D E5 08 40 8D E5 10 40 8D E5 14 40 8D E5 18 40 8D E5 ?? ?? ?? EB 10 20 9D E5 0C 30 9D E5 03 00 52 E1 0D A0 A0 E1 05 00 00 1A 05 00 59 E1 00 00 E0 03 06 00 00 0A 04 30 42 E2 10 30 8D E5 00 00 E0 E3 00 00 59 E3 10 30 9D 15 00 20 A0 13 00 20 83 15 }
	condition:
		$pattern
}
...
rule __GI_getpwuid_r_d059c4ebfab1936be1f69c7e7258a6bc {
	meta:
		aliases = "getgrgid_r, getpwuid_r, __GI_getgrgid_r, __GI_getpwuid_r"
		size = "168"
...
rule getpwnam_r_f0f9c54b72d68aa234b440f56dbd90cc {
	meta:
		aliases = "__GI_getspnam_r, getgrnam_r, __GI_getgrnam_r, __GI_getpwnam_r, getspnam_r, getpwnam_r"
		size = "176"
...
rule _dl_do_reloc_cc3deba4ef297cc6036afc40e78a35e5 {
	meta:
		aliases = "_dl_do_reloc"
		size = "392"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { F0 47 2D E9 04 E0 92 E5 2E C4 A0 E1 0C 52 A0 E1 05 60 83 E0 0C D0 4D E2 03 A0 A0 E1 00 00 5C E3 00 30 A0 E3 00 90 A0 E1 08 30 8D E5 04 60 8D E5 00 80 90 E5 00 70 92 E5 FF 40 0E E2 04 50 96 05 1C 00 00 0A 11 00 54 E3 16 00 54 13 05 C0 9A E7 01 20 A0 03 03 00 00 0A 13 00 54 E3 12 00 54 13 00 20 A0 13 01 20 A0 03 14 00 54 E3 2C 00 9D E5 02 30 A0 03 00 30 A0 13 0C 00 80 E0 02 30 83 E1 04 C0 8D E2 09 20 A0 E1 00 C0 8D E5 ?? ?? ?? EB 00 50 50 E2 07 00 00 1A 0C 20 D6 E5 0F 30 02 E2 06 00 53 E3 03 00 00 0A 22 32 A0 E1 02 00 53 E3 01 00 80 12 2F 00 00 1A 14 00 54 E3 08 A0 87 E0 22 00 00 0A 06 00 00 CA }
	condition:
		$pattern
}

rule __GI_fstatvfs_c7d4199ebe188ea37beeacba8b6667db {
	meta:
		aliases = "fstatvfs, __GI_statvfs, statvfs, __GI_fstatvfs"
		size = "668"
...
rule pthread_cond_timedwait_c7b6a67247de97ca0ba5d43977772852 {
	meta:
...
rule __GI_getprotobyname_r_15204725ee1230c1db6e76fcc075e0bd {
	meta:
		aliases = "getprotobyname_r, __GI_getprotobyname_r"
		size = "256"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { F0 47 2D E9 10 D0 4D E2 00 60 A0 E1 01 50 A0 E1 0D 00 A0 E1 CC 10 9F E5 02 A0 A0 E1 03 80 A0 E1 C4 20 9F E5 C4 30 9F E5 30 90 9D E5 0F E0 A0 E1 03 F0 A0 E1 B8 30 9F E5 AC 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 AC 30 9F E5 00 00 93 E5 ?? ?? ?? EB 0E 00 00 EA 06 00 A0 E1 00 10 95 E5 ?? ?? ?? EB 00 00 50 E3 10 00 00 0A 04 40 95 E5 04 00 00 EA 06 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 0A 00 00 0A 04 40 84 E2 00 10 94 E5 00 00 51 E3 F7 FF FF 1A 05 00 A0 E1 0A 10 A0 E1 08 20 A0 E1 09 30 A0 E1 ?? ?? ?? EB 00 70 50 E2 E9 FF FF 0A 44 30 9F E5 00 30 93 E5 00 00 53 E3 ?? ?? ?? 0B 0D 00 A0 E1 01 10 A0 E3 30 30 9F E5 }
	condition:
		$pattern
}
...
rule __GI_ptsname_r_56de14a4e6442f08b7397a476215ab79 {
	meta:
...
rule fclose_5dc5403de1f988b45b1c3ee29db61986 {
	meta:
		aliases = "__GI_fclose, fclose"
		size = "368"
		objfiles = "fclose@libc.a"
	strings:
		$pattern = { F0 47 2D E9 34 30 90 E5 01 80 73 E2 00 80 A0 33 00 00 58 E3 20 D0 4D E2 00 50 A0 E1 0A 00 00 0A 38 40 80 E2 28 31 9F E5 10 00 8D E2 24 11 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 14 31 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 30 D5 E5 40 00 13 E2 05 00 A0 11 ?? ?? ?? 1B 00 70 A0 E1 04 00 95 E5 ?? ?? ?? EB 00 30 E0 E3 00 00 50 E3 04 30 85 E5 DC 10 9F E5 E0 20 9F E5 0D 00 A0 E1 CC 90 9F E5 03 70 A0 B1 CC A0 9F E5 0F E0 A0 E1 09 F0 A0 E1 C4 00 9F E5 0F E0 A0 E1 0A F0 A0 E1 BC 20 9F E5 00 30 92 E5 01 30 83 E2 00 30 82 E5 0D 00 A0 E1 01 10 A0 E3 A8 40 9F E5 0F E0 A0 E1 04 F0 A0 E1 00 30 95 E5 }
	condition:
		$pattern
}

rule putspent_69a3b58c140861a2229ede7d5436141a {
	meta:
		aliases = "putspent"
		size = "316"
		objfiles = "putspent@libc.a"
	strings:
		$pattern = { F0 47 2D E9 34 30 91 E5 01 90 73 E2 00 90 A0 33 00 00 59 E3 10 D0 4D E2 01 50 A0 E1 00 60 A0 E1 0A 00 00 0A 38 40 81 E2 0D 00 A0 E1 E4 30 9F E5 E4 10 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 D4 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 04 20 96 E5 00 00 52 E3 C4 30 9F E5 05 00 A0 E1 02 30 A0 11 BC 10 9F E5 00 20 96 E5 ?? ?? ?? EB 00 00 50 E3 1D 00 00 BA AC 70 9F E5 AC A0 9F E5 00 40 A0 E3 03 80 87 E2 08 00 00 EA 04 30 DA E7 03 20 96 E7 01 00 72 E3 07 10 A0 11 08 10 A0 01 ?? ?? ?? EB 00 00 50 E3 10 00 00 BA 01 40 84 E2 05 00 54 E3 05 00 A0 E1 F3 FF FF 9A 20 20 96 E5 01 00 72 E3 03 00 00 0A }
	condition:
		$pattern
}
...
rule __GI_floor_909cc92b486a14f79bd0241fbc734b85 {
	meta:
...
rule __GI_inet_ntoa_r_4840c0b98dd9553f4806e6e3014f1efc {
	meta:
...
rule fstatvfs64_8a7ef27f4272120623f6abfb9774f8b3 {
	meta:
...
rule __GI_qsort_6745dfad242f05073776e842260044dd {
	meta:
...
rule modf_46f3e1fa328fb58fef883c9c47666f50 {
	meta:
		aliases = "__GI_modf, modf"
		size = "392"
		objfiles = "s_modf@libm.a"
	strings:
		$pattern = { F0 4F 2D E9 00 30 A0 E1 24 D0 4D E2 01 40 A0 E1 1C 30 8D E5 20 40 8D E5 1C E0 9D E5 4E 3A A0 E1 83 3A A0 E1 A3 3A A0 E1 FF CF 43 E2 03 C0 4C E2 00 30 A0 E3 00 40 A0 E3 13 00 5C E3 00 50 A0 E1 01 60 A0 E1 00 20 8D E5 14 30 8D E5 18 40 8D E5 0C 30 8D E5 10 40 8D E5 18 00 8D E9 03 A0 A0 E1 04 B0 A0 E1 03 70 A0 E1 04 80 A0 E1 20 90 9D E5 1A 00 00 CA 00 00 5C E3 02 31 0E B2 00 40 A0 B3 18 00 82 B8 3A 00 00 BA F4 30 9F E5 53 2C A0 E1 0E 30 02 E0 09 30 93 E1 07 00 00 1A 02 E1 0E E2 00 40 9D E5 14 E0 8D E5 18 30 8D E5 60 00 84 E8 14 50 8D E2 60 00 95 E8 2D 00 00 EA 02 20 CE E1 00 70 A0 E3 0C 20 8D E5 }
	condition:
		$pattern
}
...
rule __dns_lookup_fe99ebf42603c8e1d5282c5a5d964c42 {
	meta:
		aliases = "__dns_lookup"
		size = "1920"
		objfiles = "dnslookup@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 00 40 A0 E1 1E DE 4D E2 02 0C A0 E3 03 B0 A0 E1 10 10 8D E5 0C 20 8D E5 ?? ?? ?? EB 00 A0 A0 E1 04 00 A0 E1 ?? ?? ?? EB 14 37 9F E5 03 00 50 E1 14 00 8D E5 00 00 E0 83 00 10 A0 83 20 00 8D 85 30 10 8D 85 AD 01 00 8A 14 20 9D E5 82 00 82 E2 ?? ?? ?? EB 00 00 50 E3 00 00 5A 13 30 00 8D E5 00 50 A0 13 01 50 A0 03 A2 01 00 0A 00 30 D4 E5 00 00 53 E3 9F 01 00 0A 14 C0 9D E5 04 30 8C E0 01 30 53 E5 04 10 A0 E1 0C 20 A0 E1 18 30 8D E5 ?? ?? ?? EB 30 10 9D E5 14 20 9D E5 01 30 81 E2 00 00 E0 E3 02 30 83 E0 20 00 8D E5 2C 50 8D E5 04 30 8D E5 34 00 8D E5 00 90 A0 E1 20 30 9D E5 01 00 73 E3 }
	condition:
		$pattern
}
...
rule __GI_config_read_aa2515e1e087ffd698f63969fad7c47a {
	meta:
		aliases = "__GI_config_read"
		size = "804"
		objfiles = "parse_config@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 00 50 50 E2 20 D0 4D E2 18 10 8D E5 02 80 A0 E1 03 70 A0 E1 BD 00 00 0A FF 90 02 E2 FF 3C 02 E2 23 34 A0 E1 09 21 A0 E1 1C 30 8D E5 01 30 82 E2 14 20 8D E5 10 30 8D E5 02 28 08 E2 01 30 49 E2 0C 20 8D E5 08 30 8D E5 01 27 08 E2 01 38 08 E2 04 20 8D E5 00 30 8D E5 00 B0 A0 E3 01 A0 87 E2 04 30 95 E5 00 00 53 E3 11 00 00 1A 10 30 95 E5 00 00 53 E3 08 30 95 E5 51 20 A0 03 10 20 85 05 00 00 53 E3 10 30 9D 05 08 30 85 05 10 00 95 E5 08 30 95 E5 03 00 80 E0 ?? ?? ?? EB 00 00 50 E3 04 00 85 E5 99 00 00 0A 14 30 95 E5 01 30 83 E3 14 30 85 E5 0C 00 95 E9 03 30 82 E0 0C 30 85 E5 0B 60 A0 E1 }
	condition:
		$pattern
}

rule __GI_bindresvport_c9c424b7338be5e65e5c0295cd9f9e0a {
	meta:
		aliases = "bindresvport, __GI_bindresvport"
		size = "356"
		objfiles = "bindresvport@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 00 50 51 E2 10 D0 4D E2 00 90 A0 E1 07 00 00 1A 0D 00 A0 E1 10 20 A0 E3 ?? ?? ?? EB 01 50 CD E5 02 30 A0 E3 0D 50 A0 E1 00 30 CD E5 09 00 00 EA 00 30 D5 E5 01 20 D5 E5 02 34 83 E1 02 00 53 E3 04 00 00 0A ?? ?? ?? EB 60 30 A0 E3 00 C0 E0 E3 00 30 80 E5 3B 00 00 EA F4 40 9F E5 01 30 D4 E5 00 20 D4 E5 03 3C A0 E1 43 38 92 E1 06 00 00 1A ?? ?? ?? EB 6A 1F A0 E3 ?? ?? ?? EB 96 0F 80 E2 40 34 A0 E1 01 30 C4 E5 00 00 C4 E5 ?? ?? ?? EB 04 60 A0 E1 62 30 A0 E3 00 80 A0 E1 00 C0 E0 E3 00 70 A0 E3 58 B0 A0 E3 02 A0 A0 E3 00 30 80 E5 16 00 00 EA 01 C0 D6 E5 00 30 D6 E5 0C 34 83 E1 01 C0 83 E2 }
	condition:
		$pattern
}
...
rule __GI_inet_network_df6a668c4d7b53111c618e973ba9a301 {
	meta:
...
rule __parsespent_5d51c6b444fbc0bb82289ae24606999b {
	meta:
		aliases = "__parsespent"
		size = "172"
		objfiles = "__parsespent@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 00 70 A0 E3 04 D0 4D E2 94 B0 9F E5 00 60 A0 E1 01 40 A0 E1 0D 90 A0 E1 00 A0 E0 E3 07 80 A0 E1 01 00 57 E3 04 00 A0 E1 3A 10 A0 E3 07 50 DB E7 04 00 00 CA 05 40 86 E7 ?? ?? ?? EB 00 30 50 E2 10 00 00 1A 13 00 00 EA 04 00 A0 E1 0D 10 A0 E1 0A 20 A0 E3 ?? ?? ?? EB 00 30 9D E5 04 00 53 E1 05 00 86 E7 05 A0 86 07 08 00 57 E3 00 00 D3 E5 02 00 00 1A 00 00 50 E3 07 00 00 0A 05 00 00 EA 3A 00 50 E3 03 00 00 1A 01 80 C3 E4 01 70 87 E2 03 40 A0 E1 E1 FF FF EA 16 00 A0 E3 04 D0 8D E2 F0 8F BD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule getaddrinfo_f0588a54b8ad3f65425c3dcf581856c8 {
	meta:
		aliases = "__GI_getaddrinfo, getaddrinfo"
		size = "724"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 00 80 50 E2 40 D0 4D E2 01 50 A0 E1 02 60 A0 E1 00 30 8D E5 05 00 00 0A 00 30 D8 E5 2A 00 53 E3 02 00 00 1A 01 30 D8 E5 00 00 53 E3 00 80 A0 03 00 00 55 E3 05 00 00 0A 00 30 D5 E5 2A 00 53 E3 02 00 00 1A 01 30 D5 E5 00 00 53 E3 00 50 A0 03 05 20 98 E1 97 00 00 0A 00 00 56 E3 05 00 00 1A 10 40 8D E2 06 10 A0 E1 04 00 A0 E1 20 20 A0 E3 ?? ?? ?? EB 04 60 A0 E1 00 20 96 E5 43 3E C2 E3 0F 30 C3 E3 00 00 53 E3 8C 00 00 1A 01 30 78 E2 00 30 A0 33 A2 20 13 E0 88 00 00 1A 00 00 55 E3 15 00 00 0A 00 30 D5 E5 00 00 53 E3 12 00 00 0A 05 00 A0 E1 38 10 8D E2 0A 20 A0 E3 30 50 8D E5 ?? ?? ?? EB }
	condition:
		$pattern
}
...
rule __decode_dotted_28aa584ae9fb6e1ecfccbc6d3a39d594 {
	meta:
		aliases = "__decode_dotted"
		size = "244"
		objfiles = "decoded@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 00 A0 50 E2 00 80 A0 13 04 D0 4D E2 02 B0 A0 E1 03 90 A0 E1 01 C0 A0 13 08 00 A0 11 01 00 00 1A 2F 00 00 EA 07 00 A0 E1 0B 00 51 E1 2C 00 00 AA 01 40 DA E7 00 00 54 E3 25 00 00 0A 00 00 5C E3 C0 30 04 E2 01 80 88 12 C0 00 53 E3 01 10 81 E2 09 00 00 1A 0B 00 51 E1 21 00 00 AA 01 20 DA E7 00 00 5C E3 3F 30 04 E2 01 80 88 12 03 14 82 E1 00 70 A0 E1 00 C0 A0 E3 E9 FF FF EA 00 60 84 E0 28 30 9D E5 01 70 86 E2 03 00 57 E1 14 00 00 2A 01 50 84 E0 0B 00 55 E1 11 00 00 2A 01 10 8A E0 00 00 89 E0 04 20 A0 E1 00 C0 8D E5 ?? ?? ?? EB 00 C0 9D E5 05 30 DA E7 00 00 5C E3 04 80 88 10 00 00 53 E3 }
	condition:
		$pattern
}
...
rule atan2_9ab475f1b7ede2c192fcf2b05a3bb6e1 {
	meta:
...
rule log_4996a36e159142cf3e9064acdcf5f7c6 {
	meta:
...
rule __GI_rexec_af_4fe9ff713ba123e0a031dc3867137cdd {
	meta:
...
rule __GI_xdr_array_af70490755c7ca97d779e05b81f4fac3 {
	meta:
...
rule __GI_vfwscanf_27e6ef2fab2461b57e8b5f903cf2d04d {
	meta:
		aliases = "vfwscanf, __GI_vfwscanf"
		size = "1752"
		objfiles = "vfwscanf@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 01 DC 4D E2 18 60 8D E2 00 30 E0 E3 0C 00 8D E5 08 20 8D E5 01 50 A0 E1 06 00 A0 E1 00 10 A0 E3 24 20 A0 E3 3C 30 8D E5 ?? ?? ?? EB 0C 00 9D E5 34 30 90 E5 01 30 73 E2 00 30 A0 33 00 00 53 E3 10 30 8D E5 0A 00 00 0A 38 40 80 E2 64 36 9F E5 E4 00 8D E2 60 16 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 50 36 9F E5 0F E0 A0 E1 03 F0 A0 E1 A4 40 8D E2 04 00 A0 E1 0C 10 9D E5 ?? ?? ?? EB 38 36 9F E5 D0 30 8D E5 AC 30 9D E5 03 30 D3 E5 00 20 A0 E3 61 10 8D E2 BC 30 CD E5 20 36 9F E5 42 00 81 E2 01 70 A0 E3 02 90 A0 E1 04 A0 A0 E1 00 10 8D E5 04 00 8D E5 E0 30 8D E5 4C 20 8D E5 }
	condition:
		$pattern
}
...
rule remainder_f10a09247b6aea03a880dc86e2889bdb {
	meta:
...
rule dladdr_064f2933db6a847faf5da50f7638473f {
	meta:
		aliases = "dladdr"
		size = "380"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { F0 4F 2D E9 04 D0 4D E2 00 70 A0 E1 01 50 A0 E1 ?? ?? ?? EB 5C 31 9F E5 00 20 93 E5 00 00 A0 E3 09 00 00 EA 14 10 92 E5 07 00 51 E1 05 00 00 2A 00 00 50 E3 02 00 00 0A 14 30 90 E5 01 00 53 E1 00 00 00 2A 02 00 A0 E1 0C 20 92 E5 00 00 52 E3 F3 FF FF 1A 00 00 50 E3 44 00 00 0A 02 E0 A0 E1 04 30 90 E5 14 20 90 E5 54 10 80 E2 02 08 91 E8 0E A0 A0 E1 0E 90 A0 E1 0E 80 A0 E1 00 10 8D E5 00 30 85 E5 04 20 85 E5 2B 00 00 EA 2C 30 90 E5 0A C1 93 E7 25 00 00 EA 0C 12 8B E0 0E 20 D1 E5 0F 30 D1 E5 03 64 92 E1 00 40 90 E5 04 20 91 E5 01 00 00 1A 00 00 52 E3 1A 00 00 0A 0C 30 D1 E5 0F 30 03 E2 06 00 53 E3 }
	condition:
		$pattern
}

rule setusershell_c1fe6e3ba6e787202f60b76949cb8890 {
	meta:
		aliases = "setusershell"
		size = "228"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 04 D0 4D E2 ?? ?? ?? EB B4 00 9F E5 ?? ?? ?? EB B0 20 9F E5 00 00 50 E3 00 00 82 E5 A8 20 9F 05 A8 30 9F 05 00 20 83 05 23 00 00 0A 00 30 A0 E3 04 A0 8D E2 04 30 2A E5 90 B0 9F E5 90 90 9F E5 03 80 A0 E1 0D 00 00 EA 00 00 94 E5 ?? ?? ?? EB 00 30 9D E5 00 50 A0 E1 00 00 84 E5 06 40 85 E0 00 00 93 E5 00 40 87 E5 ?? ?? ?? EB 04 30 84 E2 00 30 87 E5 00 30 A0 E3 06 00 85 E7 04 30 84 E5 40 C0 9F E5 0D 10 A0 E1 48 20 9F E5 48 30 9F E5 00 00 9C E5 ?? ?? ?? EB 08 61 A0 E1 00 00 50 E3 08 10 86 E2 01 80 88 E2 0B 70 A0 E1 09 40 A0 E1 E4 FF FF 1A 00 30 99 E5 00 30 8B E5 04 D0 8D E2 F0 8F BD E8 }
	condition:
		$pattern
}
...
rule _dl_find_hash_dbcd8dd2e1143ee7c076baeb1b086ac3 {
	meta:
		aliases = "_dl_find_hash"
		size = "496"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { F0 4F 2D E9 08 D0 4D E2 2C C0 9D E5 00 00 5C E3 04 00 8D E5 01 70 A0 E1 02 80 A0 E1 03 B0 A0 E1 02 00 00 0A 00 00 9C E5 00 00 50 E3 03 00 00 1A 02 30 0B E2 00 A0 E0 E3 00 30 8D E5 5A 00 00 EA 0D 30 D0 E5 03 30 03 E2 03 00 53 E3 F7 FF FF 1A 58 00 00 EA 00 50 97 E5 24 30 95 E5 23 34 A0 E1 01 30 23 E2 00 00 58 E3 00 30 A0 03 01 30 03 12 00 00 53 E3 0A 00 00 0A 05 00 58 E1 34 20 98 15 04 00 00 1A 06 00 00 EA 04 30 92 E5 05 00 53 E1 03 00 00 0A 00 20 92 E5 00 00 52 E3 F9 FF FF 1A 40 00 00 EA 00 30 9D E5 00 00 53 E3 02 00 00 0A 18 30 95 E5 01 00 53 E3 3A 00 00 0A 28 00 95 E5 00 00 50 E3 37 00 00 0A }
	condition:
		$pattern
}

rule __GI_srandom_r_8ff63182c114958736670f69803f07aa {
	meta:
...
rule __read_etc_hosts_r_1239fe01fae977bf0cd5573b3e100023 {
	meta:
		aliases = "__read_etc_hosts_r"
		size = "480"
		objfiles = "read_etc_hosts_r@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 0C D0 4D E2 38 40 9D E5 00 C0 A0 E3 40 50 9D E5 80 00 54 E3 08 C0 8D E5 00 C0 E0 E3 00 C0 85 E5 00 60 A0 E1 04 10 8D E5 02 80 A0 E1 03 B0 A0 E1 30 70 9D E5 22 90 A0 93 62 00 00 9A 00 00 50 E3 07 00 00 1A ?? ?? ?? EB 00 60 50 E2 04 00 00 1A 3C 20 9D E5 00 60 82 E5 ?? ?? ?? EB 00 90 90 E5 58 00 00 EA 34 20 9D E5 18 20 82 E2 00 20 8D E5 34 20 9D E5 01 30 A0 E3 30 10 44 E2 20 A0 82 E2 30 20 A0 E3 03 90 A0 E1 08 20 86 E5 10 10 86 E5 00 30 85 E5 34 30 9D E5 04 30 86 E5 3E 00 00 EA 08 10 9D E5 01 00 5B E3 04 50 81 E2 04 50 87 E5 44 00 00 0A 02 00 5B E3 05 40 A0 11 08 00 00 1A 00 10 91 E5 }
	condition:
		$pattern
}

rule nextafter_412ac0e1e0974c2b005c17b90c32d3af {
	meta:
...
rule __GI_getservbyname_r_49219ffb0ce229dfef0dfbd274cde822 {
	meta:
...
rule fcloseall_6eb31957b27efe36ec4792183558ef82 {
	meta:
		aliases = "fcloseall"
		size = "340"
		objfiles = "fcloseall@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 10 D0 4D E2 24 21 9F E5 24 11 9F E5 24 71 9F E5 0D 00 A0 E1 0F E0 A0 E1 07 F0 A0 E1 18 61 9F E5 08 01 9F E5 0F E0 A0 E1 06 F0 A0 E1 0C 21 9F E5 00 30 92 E5 01 30 83 E2 00 30 82 E5 00 51 9F E5 01 10 A0 E3 0D 00 A0 E1 0F E0 A0 E1 05 F0 A0 E1 DC 10 9F E5 EC 20 9F E5 0D 00 A0 E1 0F E0 A0 E1 07 F0 A0 E1 DC 00 9F E5 0F E0 A0 E1 06 F0 A0 E1 D4 30 9F E5 0D 00 A0 E1 01 10 A0 E3 00 80 93 E5 0F E0 A0 E1 05 F0 A0 E1 0D 40 A0 E1 0D A0 A0 E1 06 B0 A0 E1 05 90 A0 E1 00 70 A0 E3 1D 00 00 EA 34 30 98 E5 01 50 73 E2 00 50 A0 33 00 00 55 E3 20 60 98 E5 09 00 00 0A 38 40 88 E2 0D 00 A0 E1 6C 10 9F E5 }
	condition:
		$pattern
}

rule __GI___res_init_897022d8a2931533e988a8a0b11e077b {
	meta:
...
rule __GI_getnetbyname_r_f0fb17d591882813a0fcc31142098c55 {
	meta:
		aliases = "getnetbyname_r, __GI_getnetbyname_r"
		size = "264"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 18 D0 4D E2 00 60 A0 E1 01 50 A0 E1 04 00 8D E2 D4 10 9F E5 02 A0 A0 E1 03 80 A0 E1 CC 20 9F E5 CC 30 9F E5 3C B0 9D E5 0F E0 A0 E1 03 F0 A0 E1 C0 30 9F E5 B4 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 B4 30 9F E5 00 00 93 E5 ?? ?? ?? EB 14 90 8D E2 0E 00 00 EA 06 00 A0 E1 00 10 95 E5 ?? ?? ?? EB 00 00 50 E3 11 00 00 0A 04 40 95 E5 04 00 00 EA 06 00 A0 E1 ?? ?? ?? EB 00 00 50 E3 0B 00 00 0A 04 40 84 E2 00 10 94 E5 00 00 51 E3 F7 FF FF 1A 05 00 A0 E1 0A 10 A0 E1 08 20 A0 E1 0B 30 A0 E1 00 90 8D E5 ?? ?? ?? EB 00 70 50 E2 E8 FF FF 0A 44 30 9F E5 00 30 93 E5 00 00 53 E3 ?? ?? ?? 0B 04 00 8D E2 }
	condition:
		$pattern
}

rule getnetbyaddr_r_e84329d75878eb20d884f90317ee067e {
	meta:
		aliases = "__GI_getnetbyaddr_r, getnetbyaddr_r"
		size = "232"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 18 D0 4D E2 00 A0 A0 E1 01 70 A0 E1 04 00 8D E2 B4 10 9F E5 02 40 A0 E1 03 60 A0 E1 AC 20 9F E5 AC 30 9F E5 3C B0 9D E5 40 90 9D E5 0F E0 A0 E1 03 F0 A0 E1 9C 30 9F E5 90 00 9F E5 0F E0 A0 E1 03 F0 A0 E1 90 30 9F E5 00 00 93 E5 ?? ?? ?? EB 14 80 8D E2 05 00 00 EA 0C 30 94 E5 03 00 5A E1 02 00 00 1A 08 30 94 E5 03 00 57 E1 07 00 00 0A 04 00 A0 E1 06 10 A0 E1 0B 20 A0 E1 09 30 A0 E1 00 80 8D E5 ?? ?? ?? EB 00 50 50 E2 F1 FF FF 0A 44 30 9F E5 00 30 93 E5 00 00 53 E3 ?? ?? ?? 0B 04 00 8D E2 01 10 A0 E3 30 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 00 00 99 E5 00 00 50 E3 05 00 A0 01 00 00 A0 13 }
	condition:
		$pattern
}
...
rule mallinfo_efaab0189ca271bb37bbdd442f2d90a6 {
	meta:
...
rule __ieee754_acos_2a4a1cdf2fce00aef47edf2a58ed7c8e {
	meta:
...
rule freopen64_575310280510af13ea89d49848069361 {
	meta:
		aliases = "freopen, freopen64"
		size = "412"
		objfiles = "freopen@libc.a, freopen64@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 34 30 92 E5 01 90 73 E2 00 90 A0 33 24 D0 4D E2 00 00 59 E3 02 50 A0 E1 00 B0 A0 E1 00 10 8D E5 0A 00 00 0A 38 40 82 E2 14 00 8D E2 44 31 9F E5 44 11 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 34 31 9F E5 0F E0 A0 E1 03 F0 A0 E1 04 60 8D E2 20 11 9F E5 24 21 9F E5 06 00 A0 E1 10 81 9F E5 0F E0 A0 E1 08 F0 A0 E1 0C A1 9F E5 0C 01 9F E5 0F E0 A0 E1 0A F0 A0 E1 04 21 9F E5 00 30 92 E5 01 30 83 E2 00 30 82 E5 01 10 A0 E3 06 00 A0 E1 F0 70 9F E5 0F E0 A0 E1 07 F0 A0 E1 01 30 D5 E5 00 10 D5 E5 E0 20 9F E5 03 44 81 E1 02 20 04 E0 30 30 04 E2 30 00 53 E3 42 34 A0 E1 01 30 C5 E5 }
	condition:
		$pattern
}
...
rule statfs64_85a6d178126e4d2a8a8106a6ffe186e2 {
	meta:
...
rule gethostbyaddr_r_81995c6458d5f9e9e05ed7cdff489486 {
	meta:
		aliases = "__GI_gethostbyaddr_r, gethostbyaddr_r"
		size = "684"
		objfiles = "gethostbyaddr_r@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 40 D0 4D E2 6C C0 9D E5 00 60 50 E2 00 00 A0 E3 00 00 8C E5 01 80 A0 E1 10 20 8D E5 03 A0 A0 E1 64 40 8D E2 30 00 94 E8 96 00 00 0A 02 00 52 E3 02 00 00 0A 0A 00 52 E3 92 00 00 1A 01 00 00 EA 04 00 51 E3 00 00 00 EA 10 00 51 E3 8D 00 00 1A 6C C0 9D E5 08 C0 8D E5 70 C0 9D E5 06 00 A0 E1 08 10 A0 E1 10 20 9D E5 0A 30 A0 E1 30 00 8D E8 0C C0 8D E5 ?? ?? ?? EB 00 00 50 E3 84 00 00 0A 70 20 9D E5 00 30 92 E5 01 00 53 E3 01 00 00 0A 04 00 53 E3 7E 00 00 1A 70 C0 9D E5 00 30 E0 E3 10 00 58 E3 00 30 8C E5 78 00 00 8A 00 30 64 E2 03 20 03 E2 05 30 62 E0 18 B0 43 E2 FF 00 5B E3 72 00 00 DA }
	condition:
		$pattern
}

rule _dl_load_elf_shared_library_74e144b08c5531e427455e8811bdea24 {
	meta:
		aliases = "_dl_load_elf_shared_library"
		size = "2872"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { F0 4F 2D E9 41 DF 4D E2 08 20 8D E5 0C 10 8D E5 00 10 A0 E3 00 30 A0 E1 01 20 A0 E1 08 00 9D E5 05 00 90 EF 01 0A 70 E3 00 A0 A0 E1 B4 3A 9F 85 00 20 60 82 00 20 83 85 01 00 00 8A 00 00 50 E3 03 00 00 AA A0 3A 9F E5 01 60 A0 E1 01 20 A0 E3 9B 02 00 EA C4 10 8D E2 6C 00 90 EF 01 0A 70 E3 80 3A 9F 85 00 10 60 82 00 10 83 85 01 00 00 8A 00 00 50 E3 0B 00 00 AA 6C 3A 9F E5 01 10 A0 E3 00 10 83 E5 0A 00 A0 E1 06 00 90 EF 01 0A 70 E3 8D 02 00 9A 4C 3A 9F E5 00 10 60 E2 02 60 A0 E1 00 10 83 E5 8C 02 00 EA 00 00 53 E3 0A 00 00 0A CD 30 DD E5 03 34 A0 E1 02 1B 13 E2 06 00 00 1A 0A 00 A0 E1 06 00 90 EF }
	condition:
		$pattern
}
...
rule strftime_c4bc49080ce9056e8833f0cfaeee93b4 {
	meta:
		aliases = "strftime"
		size = "1476"
		objfiles = "strftime@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 48 D0 4D E2 10 10 8D E5 14 00 8D E5 00 10 A0 E3 03 00 A0 E1 02 40 A0 E1 0C 30 8D E5 ?? ?? ?? EB 84 35 9F E5 30 10 8D E2 03 00 50 E1 00 00 A0 C3 01 00 A0 D3 04 10 8D E5 ?? ?? ?? EB 30 30 8D E2 00 20 A0 E3 0B 30 83 E2 10 B0 9D E5 1C 20 8D E5 08 30 8D E5 04 00 A0 E1 00 00 5B E3 4F 01 00 0A 00 30 D0 E5 00 00 53 E3 0D 00 00 1A 1C C0 9D E5 00 00 5C E3 10 E0 9D 05 14 10 9D 05 0E 00 6B 00 00 C0 C1 05 46 01 00 0A 1C 20 9D E5 48 C0 8D E2 01 20 42 E2 02 31 8C E0 28 00 13 E5 1C 20 8D E5 EC FF FF EA 25 00 53 E3 00 90 A0 11 09 40 A0 11 44 00 00 1A 01 30 D0 E5 25 00 53 E3 01 90 80 E2 00 40 A0 01 }
	condition:
		$pattern
}

rule erfc_b811df69013b6421e7eb1155132ea760 {
	meta:
...
rule _vfprintf_internal_21acd311ebcb4197db4842849bb31bce {
	meta:
		aliases = "_vfprintf_internal"
		size = "1632"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 51 DF 4D E2 0C 60 8D E2 00 90 A0 E1 06 00 A0 E1 02 50 A0 E1 01 40 A0 E1 ?? ?? ?? EB 00 00 50 E3 0A 00 00 AA 0C 40 9D E5 04 00 A0 E1 ?? ?? ?? EB 00 10 50 E2 00 20 E0 03 08 20 8D 05 7C 01 00 0A 04 00 A0 E1 09 20 A0 E1 ?? ?? ?? EB 76 01 00 EA 06 00 A0 E1 05 10 A0 E1 A4 B0 8D E2 ?? ?? ?? EB 00 C0 A0 E3 7F 30 8B E2 08 10 8D E9 04 20 A0 E1 00 30 D4 E5 00 00 53 E3 25 00 53 13 00 00 A0 03 01 00 A0 13 01 40 84 12 F8 FF FF 1A 02 00 54 E1 0A 00 00 0A 04 50 62 E0 00 00 55 E3 02 00 A0 C1 05 10 A0 C1 09 20 A0 C1 ?? ?? ?? CB 05 00 50 E1 5D 01 00 1A 08 C0 9D E5 00 C0 8C E0 08 C0 8D E5 00 30 D4 E5 }
	condition:
		$pattern
}

rule cbrt_9a24abdce87612197b39e8ba65d05489 {
	meta:
...
rule __GI_ioperm_e5fcef059dcbc506a7730068d9847ca0 {
	meta:
...
rule __GI_vfscanf_980a32aa1752e24889b8c7a9f4d94a93 {
	meta:
		aliases = "vfscanf, __GI_vfscanf"
		size = "1676"
		objfiles = "vfscanf@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 7B DF 4D E2 43 6F 8D E2 00 30 E0 E3 00 00 8D E5 01 50 A0 E1 02 B0 A0 E1 06 00 A0 E1 00 10 A0 E3 24 20 A0 E3 30 31 8D E5 ?? ?? ?? EB 00 00 9D E5 34 30 90 E5 01 30 73 E2 00 30 A0 33 00 00 53 E3 08 30 8D E5 0A 00 00 0A 38 40 80 E2 18 36 9F E5 76 0F 8D E2 14 16 9F E5 04 20 A0 E1 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 04 36 9F E5 0F E0 A0 E1 03 F0 A0 E1 66 4F 8D E2 04 00 A0 E1 00 10 9D E5 ?? ?? ?? EB EC 35 9F E5 C4 31 8D E5 A0 31 9D E5 03 30 D3 E5 00 20 A0 E3 01 70 A0 E3 B0 31 CD E5 C8 31 9D E5 02 A0 A0 E1 04 80 A0 E1 07 90 A0 E1 D4 31 8D E5 40 21 8D E5 44 01 00 EA B1 31 DD E5 02 11 E0 E3 }
	condition:
		$pattern
}

rule __gen_tempname_8763cae68a5eb536891f2325451ea874 {
	meta:
		aliases = "__gen_tempname"
		size = "708"
		objfiles = "tempname@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 7C D0 4D E2 04 10 8D E5 00 A0 A0 E1 00 20 8D E5 ?? ?? ?? EB 00 B0 A0 E1 0A 00 A0 E1 ?? ?? ?? EB 00 10 9B E5 05 00 50 E3 10 10 8D E5 08 00 00 9A 00 30 8A E0 06 30 43 E2 08 30 8D E5 03 00 A0 E1 5C 12 9F E5 ?? ?? ?? EB 00 00 50 E3 0C 00 8D 05 88 00 00 0A 00 00 E0 E3 16 30 A0 E3 8B 00 00 EA 40 02 9F E5 00 10 A0 E3 ?? ?? ?? EB 00 50 50 E2 04 00 00 AA 30 02 9F E5 02 1B A0 E3 ?? ?? ?? EB 00 50 50 E2 08 00 00 BA 76 10 8D E2 06 20 A0 E3 05 00 A0 E1 ?? ?? ?? EB 00 40 A0 E1 05 00 A0 E1 ?? ?? ?? EB 06 00 54 E3 39 00 00 0A 00 10 A0 E3 6C 00 8D E2 ?? ?? ?? EB F0 21 9F E5 70 40 9D E5 00 03 92 E8 }
	condition:
		$pattern
}
...
rule remquo_c2365d9790d608d63cb1d961d526f983 {
	meta:
...
rule __GI_fflush_unlocked_b86d936ebb29c095a3c9255e0e7be611 {
	meta:
		aliases = "fflush_unlocked, __GI_fflush_unlocked"
		size = "464"
		objfiles = "fflush_unlocked@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 A4 31 9F E5 03 00 50 E1 00 A0 A0 E1 14 D0 4D E2 00 A0 A0 03 00 A0 8D 05 03 00 00 0A 01 2C A0 E3 00 00 5A E3 00 20 8D E5 4D 00 00 1A 04 40 8D E2 78 71 9F E5 78 21 9F E5 78 11 9F E5 04 00 A0 E1 0F E0 A0 E1 07 F0 A0 E1 6C 61 9F E5 60 01 9F E5 0F E0 A0 E1 06 F0 A0 E1 60 21 9F E5 00 30 92 E5 01 30 83 E2 00 30 82 E5 54 51 9F E5 01 10 A0 E3 04 00 A0 E1 0F E0 A0 E1 05 F0 A0 E1 34 11 9F E5 40 21 9F E5 04 00 A0 E1 0F E0 A0 E1 07 F0 A0 E1 30 01 9F E5 0F E0 A0 E1 06 F0 A0 E1 08 31 9F E5 04 00 A0 E1 01 10 A0 E3 00 80 93 E5 0F E0 A0 E1 05 F0 A0 E1 07 B0 A0 E1 04 90 A0 E1 06 70 A0 E1 05 60 A0 E1 }
	condition:
		$pattern
}
...
rule __GI_getnameinfo_4b1a8d921058b2a2c52672d68f1c1060 {
	meta:
...
rule __ieee754_pow_cbf9c6e528be01a635cd79d5cd12ea34 {
	meta:
		aliases = "__GI_pow, pow, __ieee754_pow"
		size = "4024"
		objfiles = "e_pow@libm.a"
	strings:
		$pattern = { F0 4F 2D E9 B4 CE 9F E5 78 D0 4D E2 0C 00 50 E1 00 00 51 03 00 50 A0 E1 01 60 A0 E1 00 A0 A0 E1 3C 20 8D E5 40 30 8D E5 64 00 8D E5 01 90 A0 E1 9E 03 00 0A 03 40 A0 E1 02 71 C2 E3 04 00 97 E1 02 80 A0 E1 04 10 A0 E1 02 00 A0 E1 95 03 00 0A 6C 2E 9F E5 02 41 CA E3 02 00 54 E1 0F 00 00 CA 00 B0 A0 13 01 B0 A0 03 00 00 59 E3 00 30 A0 03 01 30 0B 12 00 00 53 E3 08 00 00 1A 02 00 57 E1 06 00 00 CA 00 30 A0 13 01 30 A0 03 00 00 51 E3 00 30 A0 03 01 30 03 12 00 00 53 E3 05 00 00 0A 05 00 A0 E1 06 10 A0 E1 3C 20 8D E2 0C 00 92 E8 ?? ?? ?? EB 78 03 00 EA 00 00 5A E3 1C 00 00 AA 00 3E 9F E5 03 00 57 E1 }
	condition:
		$pattern
}

rule __open_nameservers_ad36a07923b0623e090b02b23797b081 {
	meta:
		aliases = "__open_nameservers"
		size = "1036"
		objfiles = "opennameservers@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 BC 33 9F E5 00 40 93 E5 00 00 54 E3 7E DF 4D E2 0A 00 00 1A 61 1F 8D E2 A8 03 9F E5 ?? ?? ?? EB 00 00 50 E3 C4 41 8D 15 9C 13 9F E5 C4 21 9D E5 00 30 91 E5 02 00 53 E1 00 20 81 15 ?? ?? ?? 1B 88 43 9F E5 00 30 94 E5 00 00 53 E3 D5 00 00 1A 7C 63 9F E5 05 30 83 E2 78 53 9F E5 00 30 C6 E5 03 30 A0 E3 5C 03 9F E5 6C 13 9F E5 00 30 C5 E5 ?? ?? ?? EB 00 B0 50 E2 87 00 00 1A 94 00 00 EA 41 0F 8D E2 CC FF FF EB 00 40 A0 E1 BA FF FF EB C9 FF FF EB 44 13 9F E5 00 50 A0 E1 04 00 A0 E1 ?? ?? ?? EB 00 60 50 E2 31 00 00 1A 05 00 A0 E1 B1 FF FF EB 06 10 A0 E1 00 60 C0 E5 1C 20 A0 E3 07 00 A0 E1 }
	condition:
		$pattern
}
...
rule __ieee754_lgamma_r_b30679f1cdea9ba76e2b2a6d2150e248 {
	meta:
		aliases = "lgamma_r, gamma_r, __ieee754_lgamma_r"
		size = "4628"
		objfiles = "e_lgamma_r@libm.a"
	strings:
		$pattern = { F0 4F 2D E9 CC 3F 9F E5 02 91 C0 E3 28 D0 4D E2 03 00 59 E1 01 30 A0 E3 00 A0 A0 E1 01 B0 A0 E1 00 40 A0 E1 01 50 A0 E1 18 00 8D E5 04 20 8D E5 00 30 82 E5 03 00 00 DA 00 20 A0 E1 01 30 A0 E1 ?? ?? ?? EB DD 03 00 EA 01 40 A0 E1 04 40 99 E1 1C 10 8D E5 05 00 00 1A ?? ?? ?? EB 00 00 50 E3 04 20 9D 15 00 30 E0 13 00 30 82 15 A6 00 00 EA 64 3F 9F E5 03 00 59 E1 0F 00 00 CA 18 30 9D E5 00 00 53 E3 07 00 00 AA 04 40 9D E5 00 30 E0 E3 02 01 80 E2 00 30 84 E5 ?? ?? ?? EB 02 21 80 E2 10 20 8D E5 02 00 00 EA ?? ?? ?? EB 02 31 80 E2 10 30 8D E5 14 10 8D E5 C2 03 00 EA 18 40 9D E5 00 00 54 E3 00 20 A0 A3 }
	condition:
		$pattern
}
...
rule __pgsreader_87d48ff84ac17bdfda2403ef0782d17c {
	meta:
		aliases = "__pgsreader"
		size = "376"
		objfiles = "__pgsreader@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 FF 00 53 E3 10 D0 4D E2 03 60 A0 E1 00 B0 A0 E1 01 80 A0 E1 02 50 A0 E1 34 70 9D E5 04 00 00 8A ?? ?? ?? EB 22 30 A0 E3 03 40 A0 E1 00 30 80 E5 46 00 00 EA 34 30 97 E5 01 90 73 E2 00 90 A0 33 00 00 59 E3 02 00 00 1A 00 40 A0 E3 06 A0 85 E0 0B 00 00 EA 38 40 87 E2 0D 00 A0 E1 F8 10 9F E5 04 20 A0 E1 F4 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 04 00 A0 E1 E8 30 9F E5 0F E0 A0 E1 03 F0 A0 E1 F0 FF FF EA 05 00 A0 E1 06 10 A0 E1 07 20 A0 E1 ?? ?? ?? EB 00 00 50 E3 04 00 00 1A 00 30 D7 E5 04 00 13 E3 22 40 A0 03 02 40 A0 13 21 00 00 EA 05 00 A0 E1 ?? ?? ?? EB 01 20 40 E2 02 30 D5 E7 0A 00 53 E3 }
	condition:
		$pattern
}

rule __GI_vsyslog_4a0747f61ce13058adf1d692b9541183 {
	meta:
		aliases = "vsyslog, __GI_vsyslog"
		size = "896"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { F0 4F 2D E9 FF 4F C0 E3 41 DE 4D E2 03 40 C4 E3 0C D0 4D E2 00 00 54 E3 00 50 A0 E1 04 10 8D E5 00 20 8D E5 C0 00 00 1A ?? ?? ?? EB 00 90 A0 E1 01 0B 8D E2 FC 12 9F E5 FC 22 9F E5 08 00 80 E2 F8 32 9F E5 00 B0 99 E5 0F E0 A0 E1 03 F0 A0 E1 EC 32 9F E5 E0 02 9F E5 0F E0 A0 E1 03 F0 A0 E1 E0 32 9F E5 00 10 93 E5 07 20 05 E2 01 30 A0 E3 13 32 11 E0 A6 00 00 0A CC 32 9F E5 00 30 93 E5 00 00 53 E3 03 00 00 BA C0 32 9F E5 00 30 93 E5 00 00 53 E3 07 00 00 1A B4 32 9F E5 00 10 93 E5 B0 32 9F E5 00 20 93 E5 04 00 A0 E1 08 10 81 E3 82 21 A0 E1 8F FF FF EB FE 0F 15 E3 94 32 9F 05 41 4E 8D E2 00 30 93 05 }
	condition:
		$pattern
}
...
rule __fpclassify_3a2976b0c607dffebcf93d076634edcc {
	meta:
...
rule __aeabi_fmul_992766485331301338b85bebc046c184 {
	meta:
