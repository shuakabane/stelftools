...
rule __GI_pthread_equal_c11f863d6be2c66fb42fa0367477969e {
	meta:
...
rule strnlen_6e1eba747d863bec01a1267f490b134b {
	meta:
...
rule pthread_rwlockattr_destroy_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "pthread_condattr_destroy, pthread_mutexattr_destroy, __pthread_return_0, __pthread_mutex_unlock, __pthread_mutex_trylock, _Unwind_GetTextRelBase, _Unwind_GetRegionStart, grantpt, pthread_attr_destroy, __pthread_mutexattr_destroy, _svcauth_null, authnone_refresh, __gthread_active_p, pthread_condattr_init, _Unwind_FindEnclosingFunction, __pthread_mutex_init, __GI_pthread_condattr_init, clntraw_control, __GI_wcsftime, xdrstdio_inline, __GI_pthread_attr_destroy, __udiv_w_sdiv, _Unwind_GetDataRelBase, wcsftime, __GI_pthread_condattr_destroy, __pthread_mutex_lock, pthread_rwlockattr_destroy"
		size = "3"
		objfiles = "unwind_sjlj@libgcc.a, auth_none@libc.a, _udiv_w_sdiv@libgcc.a, attr@libpthread.a, xdr_stdio@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule strncmp_cde295d64e9c9c761593e29f2406a899 {
	meta:
...
rule __GI_strtoull_0b8614121f4839ecf9cde74d5b6b8c69 {
	meta:
		aliases = "strtoull, wcstoull, wcstoul, wcstoumax, waitpid, __GI_strtoul, strtoumax, __GI_waitpid, strtoul, __GI_wcstoull, __libc_waitpid, __GI_wcstoul, __GI_strtoull"
		size = "7"
		objfiles = "strtoul@libc.a, waitpid@libc.a, wcstoul@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C9 E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule __GI_wcswidth_2cdbe6be34565767cb148611ae565f70 {
	meta:
		aliases = "wcswidth, __GI_wcswidth"
		size = "59"
		objfiles = "wcswidth@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C9 EB 24 81 FA FF 00 00 00 7F 29 83 FA 1F 0F 9E C0 83 EA 7F 83 FA 20 0F 96 C2 08 D0 75 16 48 83 C7 04 FF C1 48 FF CE 48 85 F6 74 0B 8B 17 85 D2 75 D1 EB 03 83 C9 FF 89 C8 C3 }
	condition:
		$pattern
}
...
rule __GI_wcstod_af84d5639ed8c17e7ee2dc6cb47c24b3 {
	meta:
...
rule strtold_b4e14f698767da14cd59fb60f58a9700 {
	meta:
...
rule tsearch_0662a6a5ecaef09fd28835969ec7c252 {
	meta:
...
rule __dl_iterate_phdr_9bbfd535ed158bde63667297cc33e144 {
	meta:
...
rule __GI_rresvport_1a16e1208a810c2a29eaad1d8c3e89f9 {
	meta:
...
rule __GI_getservbyport_5fdedfcefee5bdf29aff5f55f15cd320 {
	meta:
...
rule __GI_fputc_64b5ad6c57df1b91e0dabef124e5b57e {
	meta:
...
rule fstat_cc894928f3bf2ad2cc69366014fc1338 {
	meta:
		aliases = "__GI_fstat, __GI_fstat64, fstat64, fstat"
		size = "82"
...
rule __pthread_once_f7a9de83ac2106807ae73db55c0445fe {
	meta:
...
rule __GI_vdprintf_3e276dae4a6d1b9c31585e063ceac8b6 {
	meta:
...
rule pthread_cond_wait_191d66e58e91d39d83ef5ecc762561d1 {
	meta:
...
rule __GI_xdr_callmsg_89cfa7ca0cc3e1df71901f5e32e1c4f4 {
	meta:
...
rule __GI_xprt_unregister_0dfde0e7fc3c959867216c6ebcfbf2bd {
	meta:
...
rule __GI_ftello64_84ddae23c3618c4855e4b5e151b68507 {
	meta:
...
rule fgetwc_unlocked_54da1f507f3e8937212c8a6de3c67ff0 {
	meta:
...
rule __GI_svc_getreq_common_30bba3b37d68ceb8b1b748ad571aa7fc {
	meta:
...
rule __GI_stat_bbdbc81d4a102245f5e99ec634ac9a5e {
	meta:
		aliases = "__GI_stat64, stat64, stat, __GI_stat"
		size = "79"
...
rule lstat_826d9ac11ad0acf1713647c7ac3276bd {
	meta:
		aliases = "__GI_lstat64, __GI_lstat, lstat64, lstat"
		size = "79"
...
rule sigaction_0ffa411cd4ec61b531cfc9b7465f4ebc {
	meta:
...
rule __GI_ungetc_e49d61bc869cee2c724ff1d23ba9b2a8 {
	meta:
...
rule xdr_pmaplist_c007d1b36b6c47788673e6d0341ac6b9 {
	meta:
...
rule __GI_lockf64_2069361860def5c5f9a2a3288823ab2e {
	meta:
		aliases = "lockf64, __GI_lockf, lockf, __GI_lockf64"
		size = "223"
...
rule __GI_memmem_75ba5eaae0438ab3f9c8c270e70fad6c {
	meta:
...
rule pthread_getschedparam_66986966d8f1f7b86ccb8fbe4e939ceb {
	meta:
...
rule wcsncasecmp_163ff42c9d1f3d01b619c5f5678eecea {
	meta:
...
rule regerror_1dc5e848725cc42ad75eee07eb928399 {
	meta:
...
rule sigaction_550eb7662730f2bda91a5c3acce2faf3 {
	meta:
...
rule getgrent_r_682c74159ccc7457f3e7bc40c12c8a6d {
	meta:
		aliases = "__GI_getpwent_r, getpwent_r, __GI_getspent_r, __GI_getgrent_r, getspent_r, getgrent_r"
		size = "173"
...
rule __GI_fgets_unlocked_a4e9ed5d00fce2849a183e19fe90594a {
	meta:
...
rule svc_unregister_5cb24ce3f426a5440b21827b4a149db4 {
	meta:
...
rule __GI_remquo_bcda67ff6dc8df55b3e0615fe7de40f1 {
	meta:
...
rule fputs_99a800bf3357b96d85730affeec177c2 {
	meta:
		aliases = "__GI_fputs, __GI_fputws, fputws, fputs"
		size = "97"
...
rule xprt_register_044fd21ff280e45bafb9fe5b3208fb04 {
	meta:
...
rule strerror_r_508625972a4ce8019344f4e8571a4864 {
	meta:
...
rule sleep_35c91511c460fe79800ebcb08cb962ae {
	meta:
...
rule __GI_statvfs_7b3c47063842b7177a64ae9fedf9f737 {
	meta:
		aliases = "statvfs, statvfs64, __GI_statvfs"
		size = "658"
		objfiles = "statvfs@libc.a, statvfs64@libc.a"
	strings:
...
rule svc_getreqset_dbec560535f503f0a6d6e646ad618543 {
	meta:
...
rule getenv_87a0e84363f03f18e389588d53c1f6be {
	meta:
...
rule recv_1e8120eeef72e7c40dddea4a05683146 {
	meta:
		aliases = "send, recv"
		size = "82"
		objfiles = "wrapsyscall@libpthread.a"
...
rule __GI_readdir_r_1b15cbe64007e0e7a6e6aa375c1d4ddb {
	meta:
		aliases = "readdir_r, __GI_readdir64_r, readdir64_r, __GI_readdir_r"
		size = "217"
		objfiles = "readdir64_r@libc.a, readdir_r@libc.a"
	strings:
...
rule __GI_fgets_e4126582bb8394683ceec76b3d52a7ff {
	meta:
...
rule rexec_af_83c0b5fc2b0f5734889b41a075d20e02 {
	meta:
...
rule inet_pton_e6d590a3c6adf1e5fa8d3ebd621edd98 {
	meta:
...
rule __GI_vsyslog_681303e2ee6387c3d54650d1cc6e7421 {
	meta:
...
rule __GI_fnmatch_656ae4c7f91aef100b1a93477c27b4d0 {
	meta:
...
rule vfwscanf_35ae2252e022b2f85e3feddc3c2270a6 {
	meta:
...
rule __GI_getaddrinfo_9828334668fdbbad22ec43e1801c3408 {
	meta:
...
rule strptime_51021606085b301736f2225ef9a82633 {
	meta:
...
rule authunix_create_f0c0fb94002dbfb829ebf07bc5954fad {
	meta:
...
rule __GI_inet_ntop_8b2266c712b12e7be9392cb19ae37df3 {
	meta:
...
rule __GI_memmove_a6c06e32b6594ba680c1304533a662f8 {
	meta:
...
rule __GI_getservent_r_567e9e93ffc864febe6be42d5bed0fbe {
	meta:
...
rule regexec_9e3b8d42930314d698ed55f31a20cc73 {
	meta:
...
rule __GI_qsort_0f7ec25e8d9cd7ab4e6525aa1788065c {
	meta:
...
rule __GI_ttyname_r_5d79696a9bcb9b5baad65ecd14d026ff {
	meta:
...
rule getnameinfo_5ab60da4cb7f47716e7e7c64992450da {
	meta:
...
rule getgrgid_r_5c035b786ac3507c7f1cc76b36c88320 {
	meta:
...
rule gethostbyname2_r_0851c070b0c59ae7d3c2fe0c68b00451 {
	meta:
...
rule __GI_vfscanf_0aaf9c5895488a7af787fa3158eced9f {
	meta:
...
rule fread_304e419c6d00e9e0585506a839739d8f {
	meta:
...
rule __GI_svc_register_f85a5fc3f9e287a85fd262028cf0cd1a {
	meta:
...
rule gethostbyname_r_bef19a81278a2969861ffbaafcc735f5 {
	meta:
...
rule __libc_pwrite64_2c0a2c8c89c90d8efbb22d49bc3bca89 {
	meta:
		aliases = "__libc_pwrite, pwrite64, pwrite, __libc_pwrite64"
		size = "11"
		objfiles = "pread_write@libc.a"
	strings:
...
rule __GI_strstr_8759f19610c506ac8a84e4d2f365133e {
	meta:
...
rule __GI_inet_aton_d430df5e8dc60a4c4b9d8502b4fe18bd {
	meta:
...
rule pread64_563e2730dde361fdbd45736f26daff64 {
	meta:
		aliases = "pread, __libc_pread64, __libc_pread, pread64"
		size = "8"
		objfiles = "pread_write@libc.a"
	strings:
...
rule __GI_recv_a9fc4c9a1d9715abba65179cb62f82e2 {
	meta:
		aliases = "send, recv, __libc_recv, __libc_send, __GI_send, __GI_recv"
		size = "11"
...
rule __GI_inet_network_f88d104ad4915a2a6ce264f5f0f83701 {
	meta:
...
rule thread_self_fc567cf57d3f04fc77b3c53a5a9fe529 {
	meta:
		aliases = "thread_self"
		size = "69"
		objfiles = "spinlock@libpthread.a, condvar@libpthread.a, specific@libpthread.a, pthread@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule svc_getreq_788b772a72f30f3825ec8bf48f11c706 {
	meta:
...
rule __GI_snprintf_54d39b834bdc4c8ee49cf3cde03e5a9c {
	meta:
...
rule fwscanf_4f17e5776fd93321a6b366d662782192 {
	meta:
		aliases = "__GI_fscanf, fwprintf, asprintf, fprintf, __GI_sscanf, __GI_fprintf, fscanf, dprintf, sscanf, swscanf, __GI_syslog, syslog, __GI_asprintf, fwscanf"
		size = "142"
		objfiles = "fprintf@libc.a, fwprintf@libc.a, syslog@libc.a, sscanf@libc.a, fscanf@libc.a"
	strings:
...
rule flockfile_79d502e13d9cfbabf1eaba40db91a239 {
	meta:
...
rule cargf_9fc60748e142382af4dea124fe79a3e3 {
	meta:
		aliases = "cargf"
		size = "28"
		objfiles = "cargf@libm.a"
	strings:
		$pattern = { ( CC | 48 ) 83 EC 08 0F 57 C9 66 0F D6 04 24 F3 0F 5A 04 24 E8 ?? ?? ?? ?? F2 0F 5A C0 58 C3 }
	condition:
		$pattern
}
...
rule __GI_endmntent_49595508d2b541074721458c28172100 {
	meta:
...
rule fputwc_unlocked_3414b4db72b739b489ddc01bbc9cd986 {
	meta:
...
rule __GI_setttyent_95ce6ad94da1ad164d34cfb42f2ec101 {
	meta:
...
rule __new_sem_init_dd9c878a446720d137b957690297eadd {
	meta:
...
rule __GI_sigdelset_13bae3359f0ab5285d20861034590b27 {
	meta:
		aliases = "sigismember, sigdelset, __GI_sigaddset, sigaddset, __GI_sigdelset"
		size = "35"
...
rule __re_compile_pattern_a93c1a076ac55b5736d330a76b47aa9c {
	meta:
...
rule __GI_fileno_unlocked_0a902d39b600dfca4801543ca4ed6f79 {
	meta:
...
rule setstate_r_ec7dfa314db8b99f073f23b94e6a4976 {
	meta:
...
rule localtime_702ee4622085efff266ddbf30475b8da {
	meta:
...
rule logb_b448dac608331d358b23b92250f2b3fe {
	meta:
...
rule cfsetispeed_d0e2ca424dbecbdf494a30ddc9b110ea {
	meta:
...
rule __gthread_mutex_lock_9c158610b6bb66e460b6e297c4682a93 {
	meta:
...
rule tcgetpgrp_4f96c08abbc2200693f9131ac85cee82 {
	meta:
...
rule re_match_37d3e2ef8283458e7f6ab1f4edb6fb61 {
	meta:
...
rule __GI_inet_addr_dcd52f4f196142d7785807e8e8b46f07 {
	meta:
...
rule xdrstdio_putint32_fa484968b6bc8779de7ab889964086f5 {
	meta:
...
rule getgrgid_5abd21e9b7de4fda56e36ae3f07cbf5b {
	meta:
		aliases = "getpwuid, getspnam, fgetspent, getpwnam, fgetgrent, sgetspent, fgetpwent, getgrnam, getgrgid"
		size = "39"
		objfiles = "sgetspent@libc.a, getspnam@libc.a, getgrgid@libc.a, getpwnam@libc.a, fgetspent@libc.a"
	strings:
...
rule lrand48_044ee80b5569b3a44865b1caef2ab77b {
	meta:
...
rule __GI_getdtablesize_89a36f61e54641b5dc7f6af1ac3932b2 {
	meta:
...
rule __GI_fdim_c811382213efbb5cdd14c2501cd21e6c {
	meta:
...
rule cos_5d3f21f4b751adb83847cb6512ab30aa {
	meta:
...
rule tan_d8ea805993a6d2a5a0d81b6df970da4f {
	meta:
...
rule sin_3110bb4c8bf547ef5ab95a7fe72eaf83 {
	meta:
...
rule __GI_wcrtomb_728c05a539ac3446797a6bad3bc6b82c {
	meta:
...
rule __GI_svcerr_decode_6c67e5cc9ef18f78716a9574e09709ed {
	meta:
...
rule __GI_strncpy_8430649c32d30b83137b44e94cbae139 {
	meta:
...
rule __GI_mbsrtowcs_d7b7227c3a1e003b4de2c1abe46fab44 {
	meta:
...
rule __GI_strxfrm_36360957cc987d240d738bf0e95613db {
	meta:
		aliases = "__GI_strlcpy, strlcpy, strxfrm, __GI_strxfrm"
		size = "49"
...
rule __GI_tdestroy_f696b196d9af439c7f86c31863e7a10d {
	meta:
...
rule __GI_stpncpy_f8b785f413addbb04f318c96a2f33706 {
	meta:
...
rule __GI_stpcpy_d7f2ed2a5bda2f1a4612d1410c2db50c {
	meta:
		aliases = "__GI_strcpy, stpcpy, strcpy, __GI_stpcpy"
		size = "213"
...
rule mq_getattr_8f97270fe70d65399049aa745a000c2b {
	meta:
		...
		size = "10"
		objfiles = "mq_getsetattr@librt.a, gmtime_r@libc.a"
	strings:
...
rule drand48_r_919a14f8f8c12efcb152a604d74ef694 {
	meta:
...
rule __GI_basename_be13cdad1ac8ea015142f50fe4e9fbae {
	meta:
...
rule __GI_strncat_698b12dba81944c5ad7b93224b411e7e {
	meta:
...
rule __getpagesize_61ad0577939437d124cd2ac55d7e20cf {
	meta:
...
rule memrchr_3d50a47aedaf356858ebc8ef450509b2 {
	meta:
...
rule memccpy_3956e9bff5cbf475aff5f81bf03be7d8 {
	meta:
...
rule __GI_strcasestr_242bf951dda571d61b3f57d148823b71 {
	meta:
...
rule expm1_663e31e549a70fa2016c825aca7a9601 {
	meta:
...
rule ether_aton_r_d0e42ab205fbb408f00af635bea7d2a0 {
	meta:
...
rule vmsplice_851eba89c9ff19aa5c66e93480494d3c {
	meta:
...
rule splice_6c09b5be13ebb514a7f9d0fca4964981 {
	meta:
...
rule __GI_sendto_72e74dc88aebe37f3d166d561afb55b3 {
	meta:
...
rule __GI_socket_125716247ac6605ab298d82f830216b1 {
	meta:
...
rule __libc_lseek_1ec563b9d349b6d0974e33d4cb38a869 {
	meta:
...
rule __GI_poll_e2e4d673cf7b6df9540aa4bceb06c219 {
	meta:
...
rule msync_72fa1b75a3c030095bff4debde552b69 {
	meta:
...
rule fcntl64_67c3ecc77d3ef4d4bcac028181e2197e {
	meta:
		aliases = "__GI_fcntl64, __libc_fcntl, fcntl, __libc_fcntl64, __GI_fcntl, __GI___libc_fcntl, fcntl64"
		size = "100"
...
rule __libc_read_e71aabeec0afc202a527620e7d4a2651 {
	meta:
...
rule write_f867541d5bb573f1a0785335e45b1238 {
	meta:
...
rule __libc_close_edaf20539e9c2f13a3fdf19621d2cbdb {
	meta:
...
rule getsockname_974c4b6199b4d22b1816ee5b1e8ad00c {
	meta:
...
rule __GI_fchdir_1cd2841c03ce8761782d13af7ac8e06d {
	meta:
...
rule getgroups_e3081267117fd2317758946113d32c83 {
	meta:
...
rule fstatfs_53e0a1cd0ffa85d90305c52d009cd2be {
	meta:
...
rule __GI_mq_setattr_b8395fa812b25f337a0643a8a2d81ed6 {
	meta:
...
rule fmax_4ebbc2204bba0d9f6384e93a1d6d35fc {
	meta:
...
rule __GI_significand_903f3a67d55176d4648ce1bc862eed47 {
	meta:
...
rule __GI_xdr_u_short_3970b56ab18de75f5d2ce070e5e2a9c7 {
	meta:
...
rule fgetc_unlocked_820cb18c69c975a81fab1a5cc31ce5b4 {
	meta:
		aliases = "getc_unlocked, __GI_fgetc_unlocked, __fgetc_unlocked, __GI___fgetc_unlocked, __GI_getc_unlocked, fgetc_unlocked"
		size = "222"
...
rule __GI_gethostbyname_14586eed00e7b34b64c625e60f15cb78 {
	meta:
...
rule __GI_xdrrec_eof_46cf85a1f6b656710fd06606d53a6cc3 {
	meta:
...
rule sendfile_4961bb2695df9ae51f1d5037cb15cef2 {
	meta:
...
rule __libc_select_b5b4b9e4a081a252f3efd693d5a3b802 {
	meta:
...
rule __GI_recvfrom_74b3d32b05da33c15dcea04ddd28811d {
	meta:
...
rule __GI___ns_name_ntop_715504b9c46a2157b2028c4f94884f38 {
	meta:
...
rule mmap_9f2f0479527a0506c699600891afa6d9 {
	meta:
...
rule __GI_connect_38112dbd0fb7c43959ab9ab69a43bb46 {
	meta:
...
rule bind_162c8cbd6a00ea9eb87437c0c148cdb8 {
	meta:
...
rule __GI_setresgid_976a020206ac01ca60ac94a74bd01e1f {
	meta:
...
rule setreuid_733dd49297857f84439f6ced2634dd23 {
	meta:
...
rule __GI_setregid_2c8f05c8b266b6602a1db52b3208b2f7 {
	meta:
...
rule __GI_mkdir_9056c2adf3e8cc3fecc6053067f0ddda {
	meta:
...
rule __GI_verr_bc5c0a917a938d43cc792f244dc3dea3 {
	meta:
...
rule __raise_e2704d2067d2413d752ef38f97c1cf95 {
	meta:
...
rule alarm_a5147f195f45212e8eaf7be700333ff0 {
	meta:
...
rule setitimer_b6a1f0f10a1b0117a748a691e322d4f5 {
	meta:
...
rule getrlimit64_caddc80ecb2b5a26053b890fc485daee {
	meta:
...
rule setrlimit_044d8d16b11d93d40152196a35b4d2fc {
	meta:
		aliases = "setrlimit64, __GI_setrlimit, setrlimit"
		size = "40"
...
rule pause_f2da37ab6501d42f25ec99bac1c8f40b {
	meta:
...
rule __GI_nanosleep_e4f8ab62efc2d7c5ad4bbd99230229e2 {
	meta:
...
rule __libc_getpid_0f40364ebad8beae8392c01d0d3b08f6 {
	meta:
...
rule __GI_truncate_0bbcf77b49c7faf81d42e51d75aeeab1 {
	meta:
...
rule rmdir_5b90c040e3890f9a65235e2e5c0ef89b {
	meta:
...
rule unlink_297bf42451fdc70e3d2844dc866a9057 {
	meta:
...
rule __GI_readlink_3e5501f5f103ab81d96262b39fbb491d {
	meta:
...
rule times_2be76c4221cdae4b0af83f15f5443d53 {
	meta:
...
rule getgid_88d855c1890ddaa64b720b77b063113e {
	meta:
...
rule __GI_getegid_36abac95b813331ef0be0c3e71fed9c1 {
	meta:
...
rule __GI_setgroups_43bfc6223d135b4bbb058d09287407e3 {
	meta:
...
rule utime_f5fb7f62a134c762c8aa06df45fc3518 {
	meta:
...
rule __libc_statfs_1c126f3a5c8190dbec554e371451a4c0 {
	meta:
		aliases = "__GI___libc_statfs, statfs, __GI_statfs, __libc_statfs"
		size = "38"
...
rule adjtimex_08da88dfe846731763b76ad7709c3c8a {
	meta:
...
rule __GI_mbrtowc_497c2998aa82b9fd0d57917889375115 {
	meta:
...
rule __GI_settimeofday_f8f60aacfb550c923fad36170db2dcc0 {
	meta:
...
rule time_17cce0a6bc9ba1669ae6f31bd88f8e2d {
	meta:
...
rule utimes_2b4067b3cf6e48a7db31ee0a120e7e20 {
	meta:
...
rule __GI_endnetent_f174803963fbe04ea05a4923c07341ba {
	meta:
		aliases = "endnetent, __GI_endnetent"
		size = "90"
...
rule endservent_d7e3fd16505c9238e0851a2064f1f0bc {
	meta:
		aliases = "__GI_endservent, __GI_endprotoent, endprotoent, endservent"
		size = "90"
		objfiles = "getproto@libc.a, getservice@libc.a"
	strings:
...
rule __GI_setnetent_353389afcffdbe91369d812b6a0deaa9 {
	meta:
		aliases = "setnetent, __GI_setprotoent, setprotoent, setservent, __GI_setservent, __GI_setnetent"
		size = "115"
...
rule __GI_endrpcent_c59588c7853f3faa3d21cf0ed9aca717 {
	meta:
...
rule __GI_freeaddrinfo_5d159e3c02b0282edd39ae3e4bb10317 {
	meta:
...
rule ilogb_6b33920a5d8410af9523320a1a9b1968 {
	meta:
...
rule cbrt_88fe052cec60b555703fd8be45495af5 {
	meta:
...
rule __GI___fpclassify_10dbbe32c2e6d1927040456476ab87bf {
	meta:
...
rule erf_7d953babc3d8ac3402fc4ce020a9c4c8 {
	meta:
...
rule fdopen_748f3c8a063f9a12e0925dd24248683a {
	meta:
...
rule __GI_strrchr_d66962a54c3282d1091d77823c6ae289 {
	meta:
...
rule pthread_cond_signal_2d9f287a2a688358cb6be096b01810f9 {
	meta:
...
rule __GI_pthread_cond_broadcast_3974ccf27c64e258fc334324da669c95 {
	meta:
...
rule __getdents64_a5d80ab41e5a13ce2a458a9d2789dde8 {
	meta:
...
rule glob64_4626557e42945317677348f1a08c0dfd {
	meta:
		aliases = "glob, __GI_glob64, __GI_glob, glob64"
		size = "1443"
		objfiles = "glob@libc.a, glob64@libc.a"
	strings:
...
rule __GI_execlp_565a3b46c26c03b4cc0a433a220426fe {
	meta:
		aliases = "execl, execlp, __GI_execl, __GI_execlp"
		size = "280"
...
rule xdr_u_hyper_fad8744dea551645a69578593ac84096 {
	meta:
...
rule __GI_fgetspent_r_67bf5c69defe49bb1b609a3c6bc27dcd {
	meta:
		aliases = "fgetspent_r, __GI_fgetgrent_r, fgetgrent_r, fgetpwent_r, __GI_fgetpwent_r, __GI_fgetspent_r"
		size = "43"
...
rule fgetc_539950c5b176b846a1a514db270db142 {
	meta:
...
rule __libc_siglongjmp_a604e997d5b680e2fc631f181478479f {
	meta:
...
rule __GI_nan_dd42873838eaef5a9f6dd77150ec622e {
	meta:
...
rule __GI_authnone_create_d06d018dfda877325399247645a91480 {
	meta:
...
rule __GI_statfs64_60f584c2814ea6f96f402226aaa9e636 {
	meta:
...
rule __GI_herror_10d80b46e072d29cf44f91c37cd159da {
	meta:
...
rule __new_sem_wait_4d7d43f0544465d0f6ecd41218cbe4d4 {
	meta:
...
rule bsd_signal_1521eb2f779f07de39542e237dddeb7c {
	meta:
...
rule __ieee754_fmod_79f4a931b9348fea63064306d663adde {
	meta:
		aliases = "__ieee754_fmod"
		size = "715"
		objfiles = "e_fmod@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 53 F2 0F 11 44 24 F8 48 8B 54 24 F8 F2 0F 11 4C 24 F8 48 8B 4C 24 F8 48 89 D0 48 C1 EA 20 41 89 C1 48 89 C8 48 C1 E9 20 41 89 C8 41 89 D3 89 D6 41 81 E0 FF FF FF 7F 41 81 E3 00 00 00 80 41 89 C2 44 89 C3 44 31 DE 09 C3 0F 94 C2 81 FE FF FF EF 7F 0F 9F C0 08 C2 75 15 44 89 D0 F7 D8 44 09 D0 C1 E8 1F 44 09 C0 3D 00 00 F0 7F 76 0D F2 0F 59 C1 F2 0F 5E C0 E9 4C 02 00 00 44 39 C6 7F 1A 0F 9C C2 45 39 D1 0F 92 C0 08 C2 0F 85 36 02 00 00 45 39 D1 0F 84 F7 01 00 00 81 FE FF FF 0F 00 7F 2E 85 F6 44 89 C8 BD ED FB FF FF 74 06 EB 0A FF CD 01 C0 85 C0 7F F8 EB 21 89 F0 BD 02 FC FF FF C1 E0 0B EB 04 FF }
	condition:
		$pattern
}

rule __GI_srandom_r_2b443e6969a77c087f67984d7c8c5e9f {
	meta:
...
rule getrpcbynumber_9c650742e7d04edd7e60097b9f5dc3ef {
	meta:
...
rule __GI_setrpcent_61c778b365faeab435a20aa013b29292 {
	meta:
...
rule ldexp_690a065c84e97804d90a72d74fcb52ac {
	meta:
...
rule __GI___fputc_unlocked_99c41ac40abc6c97904900a096c73867 {
	meta:
...
rule __GI_pthread_setcancelstate_89ee08c4e1559f43cdece5e9a85fc3fe {
	meta:
...
rule readdir64_0323e6b3da4e0d295b68181121d65ce0 {
	meta:
		aliases = "__GI_readdir64, readdir, __GI_readdir, readdir64"
		size = "143"
...
rule __res_init_3a108c439b11173494368ad3381d2ef4 {
	meta:
...
rule __vfork_41f8cf3389267ddf4d394f7dea183433 {
	meta:
...
rule isnanf_96804cff1f09a4e60bb6241a31df43ec {
	meta:
...
rule __finite_ecf4e9cdbf36c46dfe188a91483b410c {
	meta:
		aliases = "__GI___finite, __GI_finite, finite, __finite"
		size = "23"
...
rule __GI_btowc_35d76700792a5470cc5ef6d0f8fd717d {
	meta:
...
rule __GI_pthread_attr_setinheritsc_31120e3e7599263c555d3f89decf0b31 {
	meta:
...
rule pthread_condattr_setpshared_f8ceb03085e464132c8d8fcb56974aad {
	meta:
...
rule __pthread_mutexattr_settype_24f5994df1cb86fe4dbc7c2dceb71691 {
	meta:
		aliases = "pthread_mutexattr_setkind_np, __pthread_mutexattr_setkind_np, pthread_mutexattr_settype, __pthread_mutexattr_settype"
		size = "15"
		objfiles = "mutex@libpthread.a"
	strings:
...
rule __GI_strsignal_cb769e51718e18420790470c7c6f48f5 {
	meta:
...
rule __GI_iswctype_a46416ac0f5a84eabd9b47899bd12fb3 {
	meta:
...
rule inet_makeaddr_2758a5a9ad15785113050ce6b46bf667 {
	meta:
...
rule signalfd_b42aeb8c8c8eb0fb894235b35ae083de {
	meta:
		aliases = "signalfd"
		size = "66"
		objfiles = "signalfd@libc.a"
	strings:
		$pattern = { ( CC | 85 ) D2 53 74 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 2B BA 08 00 00 00 48 63 FF B8 1A 01 00 00 0F 05 48 3D 00 F0 FF FF 48 89 C3 76 0F E8 ?? ?? ?? ?? 89 DA 48 83 CB FF F7 DA 89 10 89 D8 5B C3 }
	condition:
		$pattern
}
...
rule creat_4b349260194dfd68bcfbf931ff7efc9e {
	meta:
...
rule __GI_nl_langinfo_2a59ef421b472a80ea8a0b88a8a74d7a {
	meta:
...
rule strcmp_ddddab28e2e9476e8bcf8637008fb49a {
	meta:
...
rule __GI_pthread_attr_getdetachsta_bf2bcf99b78042f4e0796c0c15ef442e {
	meta:
		aliases = "pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype, pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, __GI_pthread_attr_getdetachstate"
		size = "7"
...
rule __GI_pthread_attr_getscope_05935359c1ce9b131d550f05f2a33b38 {
	meta:
		aliases = "pthread_attr_getscope, sem_getvalue, __new_sem_getvalue, __GI_pthread_attr_getscope"
		size = "8"
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "_stdlib_mb_cur_max, old_sem_extricate_func, __GI_xdr_void, authnone_validate, __GI__stdlib_mb_cur_max, xdr_void"
		size = "6"
		objfiles = "xdr@libc.a, _stdlib_mb_cur_max@libc.a, oldsemaphore@libpthread.a, auth_none@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_udp@libc.a, svc_raw@libc.a, svc_tcp@libc.a, svc_unix@libc.a, svc_authux@libc.a"
	strings:
...
rule mbsnrtowcs_89cdc73fc2b76cb437938243452c0591 {
	meta:
...
rule __GI_strtoll_7e01fe78e53cc3030b461927294d8a96 {
	meta:
		aliases = "strtoll, wcstol, __GI_wcstoll, __GI_strtol, __GI_wcstol, strtoimax, strtol, wcstoll, wcstoimax, __GI_strtoll"
		size = "10"
...
rule sigwaitinfo_45f0e910e2de754f24803d6f7d686e3f {
	meta:
...
rule __GI_atol_7a1238ef70db7b947fbe00265536d22b {
	meta:
		aliases = "atol, atoll, __GI_atol"
		size = "12"
...
rule __GI_sigemptyset_f0990841898392be017d7a4ea7c169a0 {
	meta:
...
rule __GI_strtok_c9fde564b625fabca079897b988aa4a4 {
	meta:
		aliases = "strtok, __GI_strtok"
		size = "10"
...
rule timelocal_ae5deb625d6542f0fb1be4f85b9638ed {
	meta:
		aliases = "iswalnum, mkstemp64, mktime, __GI_iswalnum, timelocal"
		size = "10"
...
rule __GI_iswblank_bed7e514c64bf14cb88ed13f99892ae5 {
	meta:
...
rule __GI_iswgraph_7db32519021c9b397fad93748d444d56 {
	meta:
...
rule __GI_iswxdigit_d10346bdce587ebb0e65da5c485269b7 {
	meta:
...
rule ether_aton_aedd30f4a92f36ce8e0b990c7b4f97a2 {
	meta:
		aliases = "asctime, srand48, ether_ntoa, hcreate, inet_ntoa, __GI_inet_ntoa, __GI_asctime, ether_aton"
		size = "10"
		objfiles = "inet_ntoa@libc.a, ether_addr@libc.a, srand48@libc.a, asctime@libc.a, hsearch@libc.a"
	strings:
		$pattern = { ( CC | BE ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule __ieee754_gamma_8c47b9c6008fc75a3442b25215b4f0fe {
	meta:
		aliases = "__GI_getlogin, getlogin, hdestroy, lgamma, _flushlbf, gamma, __ieee754_lgamma, __GI_gamma, __pthread_once_fork_parent, __GI_lgamma, __pthread_once_fork_prepare, __ieee754_gamma"
		size = "10"
		objfiles = "w_gamma@libm.a, e_lgamma@libm.a, w_lgamma@libm.a, getlogin@libc.a, _flushlbf@libc.a"
	strings:
		$pattern = { ( CC | BF ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule __stub2_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "__linuxthreads_reap_event, clnttcp_abort, clntraw_geterr, __cyg_profile_func_exit, authunix_nextverf, __pthread_return_void, pthread_null_sighandler, clntraw_abort, clntudp_abort, clntraw_destroy, __linuxthreads_create_event, clntunix_abort, __stub1, xdrmem_destroy, authnone_destroy, pthread_handle_sigdebug, _pthread_cleanup_push_defer, __cyg_profile_func_enter, svcraw_destroy, _pthread_cleanup_pop_restore, noop_handler, __linuxthreads_death_event, authnone_verf, __stub2"
		size = "1"
		objfiles = "auth_none@libc.a, nsl@libnsl.a, signals@libpthread.a, events@libpthread.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule svcunixfd_create_8e8d23c71f4f29bd84e7b2c074951f75 {
	meta:
...
rule re_compile_fastmap_0fac84db41cd84c3653e6e129426762c {
	meta:
...
rule __GI_yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "fseek, vfork, __GI_sqrt, __GI_sinh, __GI_acosh, ftell, __GI_y1, atan2, xdr_u_longlong_t, __GI_jn, log10, lgamma_r, drem, __GI_exp, ftello, __GI_lseek64, asin, __GI_atan2, suspend, __GI_atanh, atanh, cabs, fmod, exp, __GI_remainder, sqrt, lseek64, __GI_ftruncate64, __GI_cosh, xdr_longlong_t, nearbyint, __GI_j0, __GI_scalb, acosh, cosh, setmntent, __ieee754_gamma_r, __GI_lgamma_r, __GI_j1, __GI_hypot, __GI_acos, yn, j0, truncate64, __GI_fseek, log, jn, ftruncate64, scalb, __GI_pow"
		size = "5"
		objfiles = "unwind_dw2_fde_glibc@libgcc.a, w_pow@libm.a, w_cosh@libm.a, semaphore@libpthread.a, w_asin@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule wcscmp_25ca9a377c9ce6e76df1724b828a0c39 {
	meta:
...
rule __GI_wcspbrk_4031c7110ff5f81b1aaaa7cfa0066386 {
	meta:
...
rule lrint_5c209059809ea5b07deee5fd6c4297eb {
	meta:
...
rule __GI_isinf_834715cbceed0e539414bad977b171ed {
	meta:
...
rule __GI_isnan_f8ffc086038aea27c5ee096dfed0ed0b {
	meta:
		aliases = "__GI___isnan, __isnan, isnan, __GI_isnan"
		size = "47"
...
rule __GI_fabs_d15ae3e46453ed04b5c85ec554c7799d {
	meta:
...
rule copysign_5c72e606899e70712f77f6af02eb0153 {
	meta:
...
rule __GI_modf_f47fa7e09c9c08ed3fc960448b7c0785 {
	meta:
...
rule __GI_floor_2357a820968a2003aa5e27583d12bcbf {
	meta:
...
rule __GI_round_7b119fb54ab1077c756436b48393af49 {
	meta:
...
rule pzero_6fde904916db62eb21793696ea5b59c9 {
	meta:
		aliases = "pone, pzero"
		size = "218"
		objfiles = "e_j1@libm.a, e_j0@libm.a"
...
rule nextafter_29edca1d11087f54ce688964df50fc19 {
	meta:
...
rule __fma_ad65862bb33b73984fa0adc080d6dff4 {
	meta:
...
rule isinff_29ae7be8410902c0cd417a47eed2693e {
	meta:
		aliases = "__isinff, __GI___isinff, isinff"
		size = "39"
...
rule frexpf_76fb52706816ef3df3c8d6c20b0aa675 {
	meta:
		aliases = "cbrtf, expf, erfcf, truncf, log1pf, atanf, sinhf, tanhf, cosf, roundf, asinf, logf, ceilf, scalbnf, acoshf, coshf, floorf, logbf, tanf, erff, fabsf, asinhf, atanhf, acosf, expm1f, rintf, lgammaf, log10f, sinf, sqrtf, ldexpf, frexpf"
		size = "19"
		objfiles = "ldexpf@libm.a, sinhf@libm.a, tanf@libm.a, asinhf@libm.a, erfcf@libm.a"
	strings:
...
rule lrintf_d3b5b767a0285b8ef7c579a0959a22b2 {
	meta:
		aliases = "llroundf, ilogbf, lroundf, llrintf, lrintf"
		size = "9"
		objfiles = "llrintf@libm.a, lrintf@libm.a, llroundf@libm.a, ilogbf@libm.a, lroundf@libm.a"
	strings:
...
rule powf_b655e1a82b86ef778f64370fab64b292 {
	meta:
		aliases = "fmodf, nextafterf, copysignf, remainderf, hypotf, atan2f, powf"
		size = "23"
		objfiles = "hypotf@libm.a, powf@libm.a, copysignf@libm.a, remainderf@libm.a, fmodf@libm.a"
	strings:
...
rule __enable_execute_stack_32a093eff127b3eedaa06c147dc0694b {
	meta:
		aliases = "__gcov_init, __gcov_merge_add, __gnat_default_lock, __gcov_flush, __gcov_merge_delta, __gcov_merge_single, __clear_cache, __gnat_default_unlock, __enable_execute_stack"
		size = "2"
		objfiles = "_gcov_merge_delta@libgcov.a, _clear_cache@libgcc.a, gthr_gnat@libgcc.a, _gcov_merge_add@libgcov.a, _gcov@libgcov.a"
	strings:
		$pattern = { ( CC | F3 ) C3 }
	condition:
		$pattern
