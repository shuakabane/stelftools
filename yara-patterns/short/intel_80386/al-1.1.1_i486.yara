...
rule clntraw_control_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "wcsftime, grantpt, __GI_pthread_condattr_init, pthread_condattr_init, __pthread_mutex_trylock, pthread_rwlockattr_destroy, pthread_condattr_destroy, __pthread_mutex_init, __pthread_mutex_lock, __pthread_mutexattr_destroy, __pthread_return_0, __GI_pthread_condattr_destroy, __GI_pthread_attr_destroy, pthread_attr_destroy, pthread_mutexattr_destroy, xdrstdio_inline, _svcauth_null, __pthread_mutex_unlock, authnone_refresh, clntraw_control"
		size = "3"
		objfiles = "xdr_stdio@libc.a, grantpt@libc.a, clnt_raw@libc.a, wcsftime@libc.a, attr@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __new_sem_destroy_66ac37ed6944e6782eff71e1fca99447 {
	meta:
...
rule restart_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		size = "8"
		objfiles = "spinlock@libpthread.a, rwlock@libpthread.a, manager@libpthread.a, pthread@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule fsync_593d4632d655ae75a9db77d772cf7bf1 {
	meta:
		aliases = "system, tcdrain, wait, close, fsync"
		size = "43"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_waitpid_966d33990ea41d94ea545ad487f15973 {
	meta:
		aliases = "sendmsg, write, recvmsg, lseek, waitpid, read, msync, connect, accept, __GI_waitpid"
		size = "51"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule pwrite_c2940d127b00fb25b0bbd004ee5c830a {
	meta:
		aliases = "send, recv, pread, epoll_wait, pwrite"
		size = "55"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule epoll_pwait_3fd4b52564f21760479f7720c6235597 {
	meta:
...
rule __GI_ioctl_7e351bfc56b54f9bed0f69a813eb2679 {
	meta:
...
rule __GI___fcntl_nocancel_16b20a95567aa07cbf790921c9d45b2e {
	meta:
		aliases = "__fcntl_nocancel, __GI___fcntl_nocancel"
		size = "84"
...
rule getc_unlocked_e8150f2fa63846a8bbb3e1cc896ad04e {
	meta:
		aliases = "__GI___fgetc_unlocked, __GI_fgetc_unlocked, __fgetc_unlocked, __GI_getc_unlocked, fgetc_unlocked, getc_unlocked"
		size = "204"
...
rule __GI_endutent_70c6068737b28cf95734faeb1f4e4162 {
	meta:
...
rule __GI_setnetent_d93becebaefdfd2ceefb5b3142a474bd {
	meta:
		aliases = "setprotoent, __GI_setprotoent, setnetent, __GI_setnetent"
		size = "96"
...
rule __GI_endservent_f32607158fabbe08179333c5ee2ef86e {
	meta:
...
rule __GI_pututline_4452f045837fc25448cc70baa91c5283 {
	meta:
...
rule __ieee754_atanh_28748105185428e1a8798c76b5f5c193 {
	meta:
...
rule __GI_frexp_3d5b901bea49278d3fc619ceaefe061a {
	meta:
...
rule __GI_sinh_5929730d445d55ac7e265b5785fa5c77 {
	meta:
...
rule __GI_fesetenv_edd50c49b1628c27c5d2a291333ec303 {
	meta:
...
rule scalbln_8d78df67fdb38402e3327549072edb4c {
	meta:
		aliases = "__GI_scalbn, __GI_scalbln, scalbn, scalbln"
		size = "297"
...
rule signal_fc9fe89dd9159edeaad7e7210c81353b {
	meta:
		aliases = "bsd_signal, __GI_signal, signal"
		size = "135"
...
rule __GI_svcerr_decode_e68bd0d26959fb686e5fc7847832b702 {
	meta:
...
rule __GI_fstat_179afcf93d32eff5e5a7cce23b282a72 {
	meta:
...
rule adjtimex_ad7dc23951e0d2e00f1a0f8c91dc5fa1 {
	meta:
...
rule __GI_ether_ntoa_r_a2aa7d475e76f62160efb521df33bbd2 {
	meta:
...
rule __GI___sigdelset_4c865c2b04e52bce1aaab48e6401d397 {
	meta:
...
rule __GI_glob_pattern_p_1b81b3ee1af0bed3fe7a8e6918c85f45 {
	meta:
...
rule __dns_lookup_39ce46123d5a35a7d68fe15c42df164f {
	meta:
		aliases = "__dns_lookup"
		size = "1815"
		objfiles = "dnslookup@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC E0 01 00 00 8B 9C 24 F4 01 00 00 68 00 02 00 00 E8 ?? ?? ?? ?? 89 C5 53 E8 ?? ?? ?? ?? 89 44 24 14 59 5E 3D 7E 03 00 00 76 15 C7 44 24 1C FF FF FF FF C7 44 24 2C 00 00 00 00 E9 8E 06 00 00 8B 44 24 0C 05 82 00 00 00 50 E8 ?? ?? ?? ?? 89 44 24 30 5A 85 ED 0F 84 6A 06 00 00 85 C0 0F 84 62 06 00 00 80 3B 00 0F 84 59 06 00 00 8B 44 24 0C 8A 44 18 FF 88 44 24 13 FF 74 24 0C 53 FF 74 24 34 E8 ?? ?? ?? ?? C7 44 24 28 FF FF FF FF C7 44 24 34 00 00 00 00 C7 44 24 3C FF FF FF FF C7 44 24 40 FF FF FF FF 83 C4 0C 8B 54 24 2C 8B 4C 24 0C 8D 54 0A 01 89 54 24 08 83 7C 24 1C FF 74 0A FF 74 }
	condition:
		$pattern
}

rule __GI_vfscanf_3858337cc4eb1d46438595b8c2b7f4ec {
	meta:
...
rule __GI_xdr_pmaplist_1c6145be0542b218c5878867925f76b2 {
	meta:
...
rule __GI_getmntent_r_7ecb474de368c6205634093d785bd778 {
	meta:
...
rule __GI_xdr_bytes_988e5afec88a2d0e8c1d0cbd5964fc20 {
	meta:
...
rule __GI_inet_network_0aaef1bbec9cbee1e6845d4e084b76f2 {
	meta:
...
rule __GI_fgetwc_unlocked_80ada2a6a62c22e17ec023ecf319c7dd {
	meta:
...
rule __GI_getservbyname_r_d4bf4bbe5acea59e4c15179cc3bee0d4 {
	meta:
...
rule __GI_getprotobynumber_r_4c9deb7056fc9a08bf290336a0b03123 {
	meta:
...
rule __GI_ungetwc_2a584ddfa9c4c53d87f7347c70cd152f {
	meta:
...
rule __GI_ungetc_7ee0202ad94a1be3f2054a8cf1ced550 {
	meta:
...
rule __GI_ceil_8cf17b67713e9b6ced91b4da40060a8b {
	meta:
...
rule __GI_floor_ff0fd13464850e0ec082432a04d89236 {
	meta:
...
rule __GI_ptsname_r_3fb4cc3db051b3145e3923ee7676d260 {
	meta:
...
rule __GI_getdelim_28d1a8a4af9070c9631b7abcb8d3eb9b {
	meta:
...
rule __GI_getservent_r_5d3b7b9fff548678e2c91baeaae919d3 {
	meta:
...
rule __GI_getnetbyaddr_r_9fbd1344cdbda43f916c1d190055190b {
	meta:
...
rule __GI_fseeko64_054c9aa62e71c0988f19961a425a5b32 {
	meta:
...
rule __ieee754_sqrt_8ab5a07ae7eb659de4346f0169c4a358 {
	meta:
...
rule __GI_inet_pton_38bf8e39c54f468650f4ddf5a0d6d0a7 {
	meta:
...
rule __GI_fclose_d6265bda5517bef4c099e6de8d84d901 {
	meta:
...
rule __GI_tcsetattr_e2367f4caa97d4b0af6457852e4f1f69 {
	meta:
...
rule __GI_remainder_9b7e963d6d8f0cd0936e1d4c9b1a8f40 {
	meta:
...
rule __GI___xpg_strerror_r_f47c225702285995fff180a022a4c6cb {
	meta:
...
rule __GI_atan2_2d90a78732b78f753276456c8a03e6bd {
	meta:
...
rule getaddrinfo_df4f6d6a3f4a1d1d471bac0a926f789a {
	meta:
		aliases = "__GI_getaddrinfo, getaddrinfo"
		size = "604"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 8B 54 24 64 8B 74 24 68 83 7C 24 60 00 74 19 8B 44 24 60 80 38 2A 75 10 80 78 01 00 0F 95 C0 0F B6 C0 F7 D8 21 44 24 60 85 D2 74 12 80 3A 2A 75 0D 31 C0 80 7A 01 00 0F 95 C0 F7 D8 21 C2 8B 7C 24 60 09 D7 0F 84 F9 01 00 00 85 F6 75 11 B9 08 00 00 00 8D 5C 24 1C 89 DF 89 F0 F3 AB 89 DE 8B 06 A9 C0 FB FF FF 0F 85 DE 01 00 00 A8 02 74 0B 83 7C 24 60 00 0F 84 CF 01 00 00 85 D2 74 4C 80 3A 00 74 47 89 54 24 3C 6A 0A 8D 44 24 48 50 52 E8 ?? ?? ?? ?? 89 44 24 4C 83 C4 0C 8B 44 24 44 80 38 00 75 0A 8D 44 24 3C 89 44 24 10 EB 24 F6 46 01 04 0F 85 8A 01 00 00 C7 44 24 40 FF FF FF FF }
	condition:
		$pattern
}
...
rule vswprintf_08a6bd358f7f203da5e5224ee6066fca {
	meta:
		aliases = "__GI_vswprintf, vswprintf"
		size = "178"
		objfiles = "vswprintf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 50 8B 74 24 64 8B 7C 24 68 C7 44 24 04 FD FF FF FF 66 C7 04 24 50 08 C6 44 24 02 00 C7 44 24 2C 00 00 00 00 C7 44 24 34 01 00 00 00 89 E5 8D 44 24 38 50 E8 ?? ?? ?? ?? C7 44 24 24 00 00 00 00 89 F3 F7 D3 C1 EB 02 58 39 FB 76 02 89 FB 89 74 24 08 8D 04 9E 89 44 24 0C 89 74 24 10 89 74 24 14 89 74 24 18 89 74 24 1C FF 74 24 70 FF 74 24 70 55 E8 ?? ?? ?? ?? 89 C2 8B 44 24 1C 83 C4 0C 3B 44 24 0C 75 0E 83 CA FF 85 DB 74 15 83 E8 04 89 44 24 10 85 DB 74 0A 8B 44 24 10 C7 00 00 00 00 00 89 D0 83 C4 50 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_mknodat_06ee2524aaf51ac4ff4326df5e45c20a {
	meta:
...
rule __GI_ether_aton_r_f72d467cc72f9be1d5713e96012d2b41 {
	meta:
...
rule __GI_getenv_ae81495e6123469fc8517786b2361132 {
	meta:
...
rule __GI_initstate_r_0f8f6c975f6677ea4d3a0e636dc05f34 {
	meta:
...
rule __GI_xdr_array_8fab093fb016287995d6101e8639a4c7 {
	meta:
...
rule __GI_xdr_reference_251d6b1dc109530ad9571bf40b5d80ee {
	meta:
...
rule getspnam_r_e612ed03d06dd4fd4054bcb61abc8918 {
	meta:
		aliases = "__GI_getspnam_r, getgrnam_r, getpwnam_r, __GI_getgrnam_r, __GI_getpwnam_r, getspnam_r"
		size = "135"
...
rule __udiv_w_sdiv_140843736b3275eead73f559484bfef9 {
	meta:
		...
		size = "7"
		objfiles = "_udiv_w_sdiv@libgcc.a, gthr_gnat@libgcc_eh.a"
	strings:
...
rule __GI_glob64_713ac7bd3deec0b17d396987f1d9bf62 {
	meta:
...
rule __GI_glob_a3946d83e9c1d00f59d69c05adc32c47 {
	meta:
...
rule __GI_execle_195dc35c4c7ab4f31f679d8e882aecf8 {
	meta:
...
rule __gcov_init_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__clear_cache, __gcov_merge_single, __gcov_flush, __gcov_merge_delta, __gnat_default_unlock, __gcov_merge_add, __enable_execute_stack, __gnat_default_lock, __gcov_init"
		size = "5"
		objfiles = "_gcov@libgcov.a, _gcov_merge_delta@libgcov.a, _clear_cache@libgcc.a, _gcov_merge_add@libgcov.a, _gcov_merge_single@libgcov.a"
	strings:
...
rule thread_self_dd5dae98b7dbe953d0d7e291f00b93db {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "spinlock@libpthread.a, errno@libpthread.a, cancel@libpthread.a, specific@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule __GI___ns_name_uncompress_5e2bdcbf38ed01e81be5ca266898d9be {
	meta:
...
rule tmpfile_60c7f9183410a40e0ea70d26e676619c {
	meta:
...
rule strlcpy_74a18f0f542c50646d96143445c1d718 {
	meta:
...
rule putc_unlocked_b15a6f9755d891f780cb639030287476 {
	meta:
		aliases = "__GI_putc_unlocked, __fputc_unlocked, __GI___fputc_unlocked, fputc_unlocked, __GI_fputc_unlocked, putc_unlocked"
		size = "181"
...
rule __GI_xdr_hyper_422d1bce1f1eef0e369761750bc2dd7c {
	meta:
...
rule __GI_erand48_r_4d27f5db64943cd84b53c6f5f5368237 {
	meta:
...
rule __GI_getutent_fe55359de9b3bb93908029041a78b803 {
	meta:
...
rule __ieee754_log_c6a025aea17bd7ca73846953b8d35a4b {
	meta:
		aliases = "__GI_log, log, __ieee754_log"
		size = "523"
...
rule __GI_erf_a65de0a3c51d6e85867ab8f264cba430 {
	meta:
...
rule __GI_opendir_81dda54ebbf1fced341cc3b98436b3e7 {
	meta:
...
rule __GI_sysconf_8fd99dd17857dc9c5f52feb31bc5d998 {
	meta:
...
rule __GI_mknod_1a929ccf484a7adad65f6ae8a013d772 {
	meta:
...
rule svctcp_reply_4f95bb640e086a37d62653507e822a24 {
	meta:
...
rule __GI_xdr_accepted_reply_43befff6bb1c504eeb8a53000b1ee403 {
	meta:
...
rule __libc_siglongjmp_80874c12c0923f06960ef9b6fc6b2db8 {
	meta:
		aliases = "__libc_longjmp, _longjmp, siglongjmp, longjmp, __libc_siglongjmp"
		size = "45"
...
rule __GI_xdr_callhdr_2a7a767a147e68b858a85039ce01c7bd {
	meta:
...
rule __GI_fgetpwent_r_e1f38611a4b1ad9d822de85e67acd783 {
	meta:
		aliases = "fgetspent_r, fgetgrent_r, __GI_fgetgrent_r, fgetpwent_r, __GI_fgetspent_r, __GI_fgetpwent_r"
		size = "51"
...
rule __GI_sigwaitinfo_8e6b2ae5f1bec13f1e9e79104da68d2a {
	meta:
...
rule __GI_sigprocmask_2767846e45001203848067aabe4bf38f {
	meta:
...
rule __pthread_kill_other_threads_n_106bf819f1184a994f013884441ec201 {
	meta:
...
rule fgetwc_4ad83eeaa60553f98b832d8b316ee87f {
	meta:
		aliases = "__GI_fileno, fileno, __GI_fgetwc, getwc, fgetwc"
		size = "88"
...
rule __GI_fflush_fe8671fcff3560954886f3b3711f00c9 {
	meta:
...
rule __GI_fputws_2addd2dd28334c1098b0e5698a927b1e {
	meta:
		aliases = "putwc, fputwc, fputs, fputws, __GI_fputs, __GI_fputws"
		size = "93"
...
rule __GI_fread_c9c2a2239634423bb8634a5ba2d35183 {
	meta:
...
rule __GI_getpwent_r_7ee86d6829de12dd3af398a00bb65158 {
	meta:
		aliases = "getpwent_r, __GI_getspent_r, getgrent_r, getspent_r, __GI_getgrent_r, __GI_getpwent_r"
		size = "161"
		objfiles = "getgrent_r@libc.a, getpwent_r@libc.a, getspent_r@libc.a"
	strings:
...
rule __GI___res_query_59c1e0dbc797fb0f545c259d9d1225e2 {
	meta:
...
rule __GI_vsnprintf_24e73b8a5c5b8bd486b0590a3333b5ad {
	meta:
...
rule __GI_inet_ntoa_r_a29830775dfaa0b46ba1a690b2765a1b {
	meta:
...
rule __GI_getrpcbyname_7723508ecee49dda2e734822d4abfb07 {
	meta:
...
rule __GI_wctrans_fb8a97cdc5747e98711eab6a457c943e {
	meta:
...
rule __GI_abort_654f2f2597df0f5f61f042a4d764a66b {
	meta:
...
rule __pthread_once_fork_prepare_c97d8f5517fef4824426922a1b3eb9e1 {
	meta:
		aliases = "hdestroy, _flushlbf, __pthread_once_fork_parent, __pthread_once_fork_prepare"
		size = "12"
...
rule asctime_e214931d143cca1a32199edb31adc4a0 {
	meta:
		aliases = "__GI_inet_ntoa, inet_ntoa, __GI_asctime, ether_ntoa, ether_aton, hcreate, asctime"
		size = "17"
...
rule gamma_ce767ada53bd455cecd0660edb8a7c87 {
	meta:
		aliases = "strtok, __GI_lgamma, __GI_strtok, __ieee754_lgamma, lgamma, gamma"
		size = "22"
...
rule wcstouq_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		aliases = "strtoull, wcstoumax, __GI_strtoul, strtouq, strtoumax, waitpid, strtoul, __libc_waitpid, wcstoul, wcstoull, __GI_waitpid, wcstouq"
		size = "23"
		objfiles = "wcstoull@libc.a, strtoul@libc.a, strtoull@libc.a, waitpid@libc.a, wcstoul@libc.a"
	strings:
...
rule timelocal_0410fd2bb80bbf0bc944c8d2d2133af7 {
	meta:
		aliases = "__GI_iswalnum, mktime, iswalnum, timelocal"
		size = "14"
...
rule wcstoll_fe8e5520a3eef7a03748f1ff8e71080f {
	meta:
		aliases = "wcstoq, __GI_strtoll, strtoll, strtol, wcstoimax, strtoq, wcstol, __GI_strtol, strtoimax, wcstoll"
		size = "23"
...
rule gethostbyname_60617713272f358c39f6fe181a7829f8 {
	meta:
...
rule fgetgrent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		aliases = "fgetpwent, sgetspent, getgrnam, getpwnam, getspnam, fgetspent, getgrgid, getpwuid, fgetgrent"
		size = "38"
		objfiles = "getpwnam@libc.a, fgetgrent@libc.a, sgetspent@libc.a, getgrnam@libc.a, getspnam@libc.a"
	strings:
...
rule sscanf_3674412569e427ab0f649983548971e5 {
	meta:
		aliases = "swscanf, fwprintf, syslog, __GI_fscanf, asprintf, dprintf, fscanf, fprintf, __GI_sscanf, __GI_syslog, __GI_asprintf, fwscanf, __GI_fprintf, sscanf"
		size = "28"
		objfiles = "fscanf@libc.a, syslog@libc.a, swscanf@libc.a, fprintf@libc.a, fwscanf@libc.a"
	strings:
...
rule log10f_237deda38afdc1ba6e02b05f725d180f {
	meta:
		aliases = "roundf, lgammaf, atanf, fabsf, cbrtf, tanf, expm1f, erff, expf, cosf, truncf, tanhf, asinhf, ceilf, erfcf, sinf, floorf, gammaf, sinhf, acosf, coshf, sqrtf, logbf, significandf, asinf, logf, atanhf, log1pf, exp2f, log2f, acoshf, rintf, log10f"
		size = "27"
		objfiles = "logf@libm.a, cosf@libm.a, sqrtf@libm.a, acoshf@libm.a, atanf@libm.a"
	strings:
...
rule fmodf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		aliases = "atan2f, remainderf, powf, scalbf, hypotf, copysignf, fmodf"
		size = "35"
		objfiles = "remainderf@libm.a, scalbf@libm.a, atan2f@libm.a, powf@libm.a, copysignf@libm.a"
	strings:
...
rule __ieee754_scalb_9bb2c6fa55c4996f45929387cbc45906 {
	meta:
...
rule __GI_exp_459a202c0c58edc95c1005e621e038c9 {
	meta:
...
rule __GI_htons_abb47f3111edd8b51bf0127264a91b58 {
	meta:
		aliases = "htons, ntohs, __GI_ntohs, __GI_htons"
		size = "12"
		objfiles = "ntohl@libc.a"
	strings:
...
rule pthread_rwlockattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__GI_pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, pthread_mutexattr_gettype, __pthread_mutexattr_gettype, pthread_mutexattr_getkind_np, pthread_rwlockattr_getkind_np"
		size = "15"
...
rule __pthread_mutex_init_151653319236b154a45a8df961584873 {
	meta:
...
rule sem_getvalue_bf01487b64a973dd33d77632c300357d {
	meta:
		aliases = "__new_sem_getvalue, __GI_pthread_attr_getschedparam, pthread_attr_getschedparam, sem_getvalue"
		size = "16"
...
rule setenv_e63fbd4454ec064dc8f9d0b775e2be85 {
	meta:
		aliases = "__GI_setenv, svcfd_create, svcunixfd_create, setenv"
		size = "17"
...
rule __GI_lrand48_r_b3aacb3ccfb17d803b012961cc545010 {
	meta:
		aliases = "mrand48_r, drand48_r, lrand48_r, __GI_lrand48_r"
		size = "19"
...
rule pthread_getconcurrency_9306906a3a71020f26be39b72f98096c {
	meta:
		aliases = "__libc_current_sigrtmin, __libc_current_sigrtmax, __pthread_getconcurrency, pthread_getconcurrency"
		size = "6"
		objfiles = "pthread@libpthread.a, allocrtsig@libc.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? C3 }
...
rule __GI_xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "_stdlib_mb_cur_max, xdr_void, old_sem_extricate_func, authnone_validate, __GI__stdlib_mb_cur_max, floatformat_always_valid, __GI_xdr_void"
		size = "6"
		objfiles = "_stdlib_mb_cur_max@libc.a, floatformat@libiberty.a, auth_none@libc.a, xdr@libc.a, oldsemaphore@libpthread.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_unix@libc.a, svc_authux@libc.a, svc_udp@libc.a, svc_tcp@libc.a, svc_raw@libc.a"
	strings:
...
rule __res_state_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__h_errno_location, __GI___h_errno_location, __GI___errno_location, __libc_pthread_init, __errno_location, __res_state"
		size = "6"
		objfiles = "__h_errno_location@libc.a, __errno_location@libc.a, libc_pthread_init@libc.a, _res_state@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C3 }
	condition:
		$pattern
...
rule clntraw_abort_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "clnttcp_abort, __stub1, __linuxthreads_death_event, xdrmem_destroy, clntudp_abort, noop_handler, authunix_nextverf, clntraw_geterr, __cyg_profile_func_enter, clntunix_abort, __cyg_profile_func_exit, clntraw_destroy, authnone_destroy, __linuxthreads_create_event, svcraw_destroy, __stub2, authnone_verf, pthread_handle_sigdebug, pthread_null_sighandler, __linuxthreads_reap_event, clntraw_abort"
		size = "1"
		objfiles = "events@libpthread.a, nsl@libnsl.a, resolv@libresolv.a, clnt_raw@libc.a, auth_none@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule partition_delete_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "__GI_xdr_int, xdr_int, xdr_longlong_t, xdr_u_int, xdr_enum, __GI_setmntent, __GI_xdr_u_int, __GI_cabs, cabs, __pthread_initialize, xdr_u_longlong_t, splay_tree_xmalloc_deallocate, rand, setmntent, vfork, __GI_xdr_enum, mq_close, partition_delete"
		size = "5"
		objfiles = "partition@libiberty.a, ptfork@libpthread.a, splay_tree@libiberty.a, mq_close@librt.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule _dl_app_fini_array_d0a919a1423a1611f85f059ef10ad627 {
	meta:
		aliases = "getwchar, getwchar_unlocked, _dl_app_fini_array"
		size = "13"
...
rule bzero_4ffe811b206b5540a8cd0461ad5ed514 {
	meta:
		aliases = "mkostemp, gmtime_r, mq_getattr, bzero"
		size = "19"
		objfiles = "bzero@libc.a, gmtime_r@libc.a, mkstemp@libc.a, mq_getsetattr@librt.a"
	strings:
...
rule __GI_fdim_9821af0f1e4609ab05c02d150961f2ec {
	meta:
...
rule vscanf_8656ba417f55ecd54498627fc6f064b6 {
	meta:
		aliases = "vwscanf, vprintf, vwprintf, vscanf"
		size = "23"
