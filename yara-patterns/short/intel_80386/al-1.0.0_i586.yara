...
rule getnetbyname_b84d518fbeb2bacf5af5dbb40a89a6f0 {
	meta:
		aliases = "getnetbyname"
		size = "95"
		objfiles = "getnetbynm@libc.a"
	strings:
		$pattern = { ( CC | 0F ) BE 05 ?? ?? ?? ?? 57 56 53 8B 7C 24 10 50 E8 ?? ?? ?? ?? 59 EB 29 57 FF 36 E8 ?? ?? ?? ?? 5B 85 C0 5A 74 26 8B 5E 04 EB 10 57 50 E8 ?? ?? ?? ?? 5A 85 C0 59 74 14 83 C3 04 8B 03 85 C0 75 EA E8 ?? ?? ?? ?? 89 C6 85 C0 75 CC 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule getnetbyaddr_ed939f099928455a0dc043bf934dae1a {
	meta:
		aliases = "getnetbyaddr"
		size = "68"
		objfiles = "getnetbyad@libc.a"
	strings:
		$pattern = { ( CC | 0F ) BE 05 ?? ?? ?? ?? 57 56 53 8B 7C 24 10 8B 74 24 14 50 E8 ?? ?? ?? ?? 58 EB 0A 39 73 08 75 05 39 7B 0C 74 0B E8 ?? ?? ?? ?? 89 C3 85 C0 75 EB 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule clntraw_control_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "__pthread_mutex_init, pthread_mutexattr_destroy, authnone_refresh, pthread_rwlockattr_destroy, __GI_pthread_condattr_destroy, __pthread_mutexattr_destroy, pthread_condattr_init, grantpt, pthread_condattr_destroy, __GI_pthread_attr_destroy, __pthread_return_0, _svcauth_null, __GI_wcsftime, __pthread_mutex_unlock, pthread_attr_destroy, __pthread_mutex_lock, xdrstdio_inline, __pthread_mutex_trylock, __GI_pthread_condattr_init, wcsftime, clntraw_control"
		size = "3"
		objfiles = "clnt_raw@libc.a, rwlock@libpthread.a, condvar@libpthread.a, wcsftime@libc.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule flush_out_c9bc6179d3dc92f70a550d6ed5b0ca7a {
	meta:
		aliases = "flush_out"
		size = "78"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 4A ) 56 0F 95 C2 53 89 C6 8B 48 18 8B 40 10 0F B6 D2 29 C8 4A 83 E8 04 81 E2 00 00 00 80 09 C2 0F CA 89 11 8B 46 0C 8B 5E 10 29 C3 53 50 FF 36 FF 56 08 83 C4 0C 31 D2 39 D8 75 0E 8B 46 0C B2 01 89 46 18 83 C0 04 89 46 10 89 D0 5B 5E C3 }
	condition:
		$pattern
}
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		size = "8"
		objfiles = "semaphore@libpthread.a, spinlock@libpthread.a, join@libpthread.a, rwlock@libpthread.a, manager@libpthread.a"
	strings:
...
rule __cxa_atexit_11e5100e4addc220e7e548a6b9e2ec6f {
	meta:
		aliases = "__GI___cxa_atexit, __cxa_atexit"
		size = "52"
		objfiles = "__cxa_atexit@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 C0 8B 5C 24 08 85 DB 74 27 E8 ?? ?? ?? ?? 89 C2 83 C8 FF 85 D2 74 19 89 5A 04 8B 44 24 0C 89 42 08 8B 44 24 10 C7 02 03 00 00 00 89 42 0C 31 C0 5B C3 }
	condition:
		$pattern
}

rule __stdio_READ_294aa10609546ffbcffd1e460b2278f0 {
	meta:
		aliases = "__stdio_READ"
		size = "62"
		objfiles = "_READ@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 C0 8B 5C 24 08 8B 54 24 10 F6 03 04 75 2C 85 D2 79 05 BA FF FF FF 7F 52 FF 74 24 10 FF 73 04 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 00 7F 0E 75 06 66 83 0B 04 EB 06 66 83 0B 08 31 C0 5B C3 }
	condition:
		$pattern
}

rule __GI_glob_pattern_p_187488d01d8f02adf1a170896b7e5be0 {
	meta:
		aliases = "glob_pattern_p, __GI_glob_pattern_p"
		size = "85"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 C9 8B 5C 24 0C 8B 54 24 08 EB 37 3C 5B 74 16 77 0A 3C 2A 74 37 3C 3F 75 28 EB 31 3C 5C 74 0D 3C 5D 75 1E EB 18 B9 01 00 00 00 EB 15 85 DB 74 11 8D 42 01 80 7A 01 00 74 08 89 C2 EB 04 85 C9 75 0B 42 8A 02 84 C0 75 C3 31 C0 EB 05 B8 01 00 00 00 5B C3 }
	condition:
		$pattern
}

rule __pthread_manager_sighandler_2e63a0d0e9217598559fe3a1d7e005e3 {
	meta:
		aliases = "__pthread_manager_sighandler"
		size = "93"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 31 D2 83 EC 1C A1 ?? ?? ?? ?? 85 C0 75 0C 31 D2 83 3D ?? ?? ?? ?? 00 0F 95 C2 C7 05 ?? ?? ?? ?? 01 00 00 00 85 D2 74 2F C7 04 24 00 00 00 00 C7 44 24 04 06 00 00 00 89 E3 6A 1C 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E2 83 C4 1C 5B C3 }
	condition:
		$pattern
}
...
rule __GI_log10_0d34295cd09e25270017499239b9d477 {
	meta:
		aliases = "log10, __ieee754_log10, __GI_log10"
		size = "229"
		objfiles = "e_log10@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 31 DB 83 EC 24 DD 44 24 2C DD 5C 24 1C 8B 4C 24 20 8B 54 24 1C 81 F9 FF FF 0F 00 7F 48 89 C8 25 FF FF FF 7F 09 D0 75 0D D9 EE D8 3D ?? ?? ?? ?? E9 AA 00 00 00 85 C9 79 11 DD 44 24 2C D8 E0 DC 35 ?? ?? ?? ?? E9 95 00 00 00 DD 44 24 2C D8 0D ?? ?? ?? ?? BB CA FF FF FF DD 54 24 2C DD 5C 24 14 8B 4C 24 18 81 F9 FF FF EF 7F 7E 08 DD 44 24 2C D8 C0 EB 6A 89 C8 81 E1 FF FF 0F 00 C1 F8 14 8D 84 03 01 FC FF FF 89 C2 C1 EA 1F 8D 04 02 50 B8 FF 03 00 00 DB 04 24 83 C4 04 29 D0 C1 E0 14 DD 44 24 2C 09 C8 DD 5C 24 0C 89 44 24 10 FF 74 24 10 FF 74 24 10 DD 5C 24 08 E8 ?? ?? ?? ?? DD 44 24 08 DD 05 ?? ?? }
	condition:
		$pattern
}
...
rule pthread_key_create_c212028da810ae99a26345b10c46fd89 {
	meta:
		aliases = "pthread_key_create"
		size = "95"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 DB 58 EB 35 83 3C DD ?? ?? ?? ?? 00 75 2A 8B 44 24 0C C7 04 DD ?? ?? ?? ?? 01 00 00 00 68 ?? ?? ?? ?? 89 04 DD ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 0C 89 18 31 C0 EB 18 43 81 FB FF 03 00 00 7E C3 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? B8 0B 00 00 00 5B 5B C3 }
	condition:
		$pattern
}

rule pthread_atfork_d197ab44eb24de3ca6cddb41d25caea8 {
	meta:
		aliases = "pthread_atfork"
		size = "103"
		objfiles = "ptfork@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 6A 18 E8 ?? ?? ?? ?? 89 C3 58 85 DB B8 0C 00 00 00 74 51 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 00 89 D9 8B 54 24 10 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 8B 54 24 18 8D 4B 08 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 8B 54 24 20 8D 4B 10 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 C0 83 C4 14 5B C3 }
	condition:
		$pattern
}

rule tempnam_e9febb0b68694733aba2acd4cb6db84f {
	meta:
		aliases = "tempnam"
		size = "76"
		objfiles = "tempnam@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 81 EC 00 10 00 00 FF B4 24 0C 10 00 00 FF B4 24 0C 10 00 00 68 FF 0F 00 00 8D 5C 24 0D 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 17 6A 03 53 E8 ?? ?? ?? ?? 59 85 C0 5A 75 09 53 E8 ?? ?? ?? ?? 5A EB 02 31 C0 81 C4 00 10 00 00 5B C3 }
	condition:
		$pattern
}
...
rule login_9be97ef03f7b29a7395f3b3af3d26d88 {
	meta:
		aliases = "login"
		size = "97"
		objfiles = "login@libutil.a"
	strings:
		$pattern = { ( CC | 53 ) 81 EC 80 01 00 00 89 E0 8B 9C 24 88 01 00 00 68 80 01 00 00 53 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 66 C7 44 24 10 07 00 E8 ?? ?? ?? ?? 89 44 24 14 8D 43 08 6A 20 50 8D 44 24 20 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 20 E8 ?? ?? ?? ?? 81 C4 80 01 00 00 5B C3 }
	condition:
		$pattern
}

rule __GI_gethostname_a2df3537eea71eb6eca7a6fb7ec0c8d8 {
	meta:
		aliases = "gethostname, __GI_gethostname"
		size = "88"
		objfiles = "gethostname@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 81 EC 88 01 00 00 8D 44 24 02 50 E8 ?? ?? ?? ?? 83 CA FF 59 40 74 36 8D 5C 24 43 53 E8 ?? ?? ?? ?? 5A 40 3B 84 24 94 01 00 00 76 10 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 EB 11 53 FF B4 24 94 01 00 00 E8 ?? ?? ?? ?? 58 31 D2 59 89 D0 81 C4 88 01 00 00 5B C3 }
	condition:
		$pattern
}

rule getdomainname_0d7cfce6d7a40946608ffa0ee19cd889 {
	meta:
		aliases = "__GI_getdomainname, getdomainname"
		size = "91"
		objfiles = "getdomainname@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 81 EC 88 01 00 00 8D 44 24 02 50 E8 ?? ?? ?? ?? 83 CA FF 59 40 74 39 8D 9C 24 47 01 00 00 53 E8 ?? ?? ?? ?? 5A 40 3B 84 24 94 01 00 00 76 10 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 EB 11 53 FF B4 24 94 01 00 00 E8 ?? ?? ?? ?? 58 31 D2 59 89 D0 81 C4 88 01 00 00 5B C3 }
	condition:
		$pattern
}

rule __ieee754_hypot_03bbde0c96b22368388ebeef125c0aec {
	meta:
		aliases = "__GI_hypot, hypot, __ieee754_hypot"
		size = "741"
		objfiles = "e_hypot@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 81 EC 98 00 00 00 DD 84 24 A0 00 00 00 DD 54 24 70 DD 84 24 A8 00 00 00 8B 4C 24 74 DD 54 24 68 8B 54 24 6C 81 E1 FF FF FF 7F 81 E2 FF FF FF 7F 39 CA 7E 13 DD 5C 24 78 89 D0 89 CA DD 9C 24 80 00 00 00 89 C1 EB 1D DD D8 DD D8 DD 84 24 A0 00 00 00 DD 5C 24 78 DD 84 24 A8 00 00 00 DD 9C 24 80 00 00 00 DD 44 24 78 89 C8 DD 5C 24 60 89 4C 24 64 29 D0 DD 44 24 60 3D 00 00 C0 03 DD 9C 24 88 00 00 00 DD 84 24 80 00 00 00 DD 5C 24 58 89 54 24 5C DD 44 24 58 DD 94 24 90 00 00 00 7E 0E DD 84 24 88 00 00 00 DE C1 E9 2E 02 00 00 DD D8 31 DB 81 F9 00 00 30 5F 0F 8E 89 00 00 00 81 F9 FF FF EF 7F 7E 42 81 }
	condition:
		$pattern
}

rule get_current_dir_name_efb86dc8649cd3d5ec25e61d25383157 {
	meta:
		aliases = "get_current_dir_name"
		size = "133"
		objfiles = "getdirname@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 81 EC C0 00 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C3 58 85 DB 74 5A 8D 44 24 60 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A 85 C0 59 75 45 89 E0 50 53 E8 ?? ?? ?? ?? 5A 85 C0 59 75 36 8B 54 24 04 8B 04 24 3B 54 24 64 75 29 3B 44 24 60 75 23 8B 54 24 5C 8B 44 24 58 3B 94 24 BC 00 00 00 75 12 3B 84 24 B8 00 00 00 75 09 53 E8 ?? ?? ?? ?? 5B EB 0B 6A 00 6A 00 E8 ?? ?? ?? ?? 5A 59 81 C4 C0 00 00 00 5B C3 }
	condition:
		$pattern
}

rule ntp_gettime_ccb49dab38974dd87f4d90ad86ffacd5 {
	meta:
		aliases = "ntp_gettime"
		size = "61"
		objfiles = "ntp_gettime@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 C4 80 89 E0 8B 9C 24 88 00 00 00 C7 04 24 00 00 00 00 50 E8 ?? ?? ?? ?? 8B 54 24 2C 89 53 04 8B 54 24 28 89 13 8B 54 24 10 89 53 08 8B 54 24 14 89 53 0C 81 C4 84 00 00 00 5B C3 }
	condition:
		$pattern
}
...
rule pause_499190a158b527f80a53f8cad114e325 {
	meta:
		aliases = "pause"
		size = "39"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 89 E0 50 6A 01 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 00 FF 74 24 0C 89 C3 E8 ?? ?? ?? ?? 89 D8 83 C4 14 5B C3 }
	condition:
		$pattern
}

rule system_0f16be773a16c7f1ada0f23bb98e42f6 {
	meta:
		aliases = "tcdrain, fsync, close, wait, system"
		size = "43"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 89 E0 50 6A 01 E8 ?? ?? ?? ?? FF 74 24 14 E8 ?? ?? ?? ?? 6A 00 FF 74 24 10 89 C3 E8 ?? ?? ?? ?? 89 D8 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule nanosleep_82bd8315edcf02aca8cdee56441e9b73 {
	meta:
		aliases = "__GI_nanosleep, nanosleep"
		size = "47"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 89 E0 50 6A 01 E8 ?? ?? ?? ?? FF 74 24 18 FF 74 24 18 E8 ?? ?? ?? ?? 6A 00 FF 74 24 14 89 C3 E8 ?? ?? ?? ?? 89 D8 83 C4 1C 5B C3 }
	condition:
		$pattern
}

rule __GI_waitpid_7e8310e1353bbbc8133a54fecec14b99 {
	meta:
		aliases = "waitpid, recvmsg, accept, read, msync, sendmsg, write, lseek, connect, __GI_waitpid"
		size = "51"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 89 E0 50 6A 01 E8 ?? ?? ?? ?? FF 74 24 1C FF 74 24 1C FF 74 24 1C E8 ?? ?? ?? ?? 6A 00 FF 74 24 18 89 C3 E8 ?? ?? ?? ?? 89 D8 83 C4 20 5B C3 }
	condition:
		$pattern
}

rule send_9682517cc44b317b96a763e93de956b5 {
	meta:
		aliases = "pwrite, pread, recv, send"
		size = "55"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 89 E0 50 6A 01 E8 ?? ?? ?? ?? FF 74 24 20 FF 74 24 20 FF 74 24 20 FF 74 24 20 E8 ?? ?? ?? ?? 6A 00 FF 74 24 1C 89 C3 E8 ?? ?? ?? ?? 89 D8 83 C4 24 5B C3 }
	condition:
		$pattern
}

rule pread64_9215c85a9403b83e9def5fbe427da7b4 {
	meta:
		aliases = "pread64"
		size = "59"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 89 E0 50 6A 01 E8 ?? ?? ?? ?? FF 74 24 24 FF 74 24 24 FF 74 24 24 FF 74 24 24 FF 74 24 24 E8 ?? ?? ?? ?? 6A 00 FF 74 24 20 89 C3 E8 ?? ?? ?? ?? 89 D8 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule recvfrom_7dc26d3bd37d60f67a43dfc81df638df {
	meta:
		aliases = "sendto, recvfrom"
		size = "66"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 89 E0 50 6A 01 E8 ?? ?? ?? ?? FF 74 24 28 FF 74 24 28 FF 74 24 28 FF 74 24 28 FF 74 24 28 FF 74 24 28 E8 ?? ?? ?? ?? 83 C4 20 6A 00 89 C3 FF 74 24 04 E8 ?? ?? ?? ?? 89 D8 83 C4 0C 5B C3 }
	condition:
		$pattern
}
...
rule __GI_xdr_u_long_31792c5aa1f2da0f64cb35a103eeeaa3 {
	meta:
		aliases = "xdr_u_long, __GI_xdr_u_long"
		size = "77"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 4C 24 0C 8B 5C 24 10 8B 11 83 FA 01 74 0E 72 27 B8 01 00 00 00 83 FA 02 74 2B EB 27 8B 41 04 89 E2 52 51 FF 10 5A 85 C0 59 74 18 8B 04 24 89 03 B8 01 00 00 00 EB 0E 8B 41 04 53 51 FF 50 04 59 5B EB 02 31 C0 5A 5B C3 }
	condition:
		$pattern
}

rule xdr_uint8_t_1ba30a6e48be6017b034acff6e1ce20b {
	meta:
		aliases = "xdr_uint8_t"
		size = "86"
		objfiles = "xdr_intXX_t@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 4C 24 0C 8B 5C 24 10 8B 11 83 FA 01 74 22 72 0C B8 01 00 00 00 83 FA 02 74 34 EB 30 0F B6 03 89 04 24 89 E0 8B 51 04 50 51 FF 52 24 5B 5A EB 1E 8B 51 04 89 E0 50 51 FF 52 20 5A 85 C0 59 74 0C 8B 04 24 88 03 B8 01 00 00 00 EB 02 31 C0 59 5B C3 }
	condition:
		$pattern
}

rule __GI_xdr_u_short_83ae1282dc1aee41f28ee75116c39b86 {
	meta:
		aliases = "xdr_u_short, __GI_xdr_u_short"
		size = "86"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 4C 24 0C 8B 5C 24 10 8B 11 83 FA 01 74 22 72 0C B8 01 00 00 00 83 FA 02 74 34 EB 30 0F B7 03 89 04 24 89 E0 8B 51 04 50 51 FF 52 04 5B 5A EB 1E 8B 51 04 89 E0 50 51 FF 12 5A 85 C0 59 74 0D 8B 04 24 66 89 03 B8 01 00 00 00 EB 02 31 C0 5B 5B C3 }
	condition:
		$pattern
}

rule xdr_int8_t_b5dc9c38715cf66c7a65876c736b8dd8 {
	meta:
		aliases = "xdr_int8_t"
		size = "86"
		objfiles = "xdr_intXX_t@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 4C 24 0C 8B 5C 24 10 8B 11 83 FA 01 74 22 72 0C B8 01 00 00 00 83 FA 02 74 34 EB 30 0F BE 03 89 04 24 89 E0 8B 51 04 50 51 FF 52 24 5B 5A EB 1E 8B 41 04 89 E2 52 51 FF 50 20 5A 85 C0 59 74 0C 8B 04 24 88 03 B8 01 00 00 00 EB 02 31 C0 59 5B C3 }
	condition:
		$pattern
}

rule xdr_short_2c72c66cb729e2ff3ac9f8dc815382f6 {
	meta:
		aliases = "__GI_xdr_short, xdr_short"
		size = "86"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 4C 24 0C 8B 5C 24 10 8B 11 83 FA 01 74 22 72 0C B8 01 00 00 00 83 FA 02 74 34 EB 30 0F BF 03 89 04 24 89 E0 8B 51 04 50 51 FF 52 04 59 5B EB 1E 8B 41 04 89 E2 52 51 FF 10 59 85 C0 5A 74 0D 8B 04 24 66 89 03 B8 01 00 00 00 EB 02 31 C0 5A 5B C3 }
	condition:
		$pattern
}

rule xdr_uint16_t_ae94c420ab715101be61baf7f4daf295 {
	meta:
		aliases = "xdr_uint16_t"
		size = "87"
		objfiles = "xdr_intXX_t@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 4C 24 0C 8B 5C 24 10 8B 11 83 FA 01 74 22 72 0C B8 01 00 00 00 83 FA 02 74 35 EB 31 0F B7 03 89 04 24 89 E0 8B 51 04 50 51 FF 52 24 5B 5A EB 1F 8B 51 04 89 E0 50 51 FF 52 20 5A 85 C0 59 74 0D 8B 04 24 66 89 03 B8 01 00 00 00 EB 02 31 C0 59 5B C3 }
	condition:
		$pattern
}

rule xdr_int16_t_eff6f27c2ad18f4da6bb22f6980294ef {
	meta:
		aliases = "xdr_int16_t"
		size = "87"
		objfiles = "xdr_intXX_t@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 4C 24 0C 8B 5C 24 10 8B 11 83 FA 01 74 22 72 0C B8 01 00 00 00 83 FA 02 74 35 EB 31 0F BF 03 89 04 24 89 E0 8B 51 04 50 51 FF 52 24 5B 5A EB 1F 8B 41 04 89 E2 52 51 FF 50 20 5A 85 C0 59 74 0D 8B 04 24 66 89 03 B8 01 00 00 00 EB 02 31 C0 5B 5B C3 }
	condition:
		$pattern
}

rule __GI_xdr_bool_ade373f96063a7fd14e0d01db2a4aafc {
	meta:
		aliases = "xdr_bool, __GI_xdr_bool"
		size = "96"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 4C 24 0C 8B 5C 24 10 8B 11 83 FA 01 74 27 72 0C B8 01 00 00 00 83 FA 02 74 3E EB 3A 31 C0 83 3B 00 0F 95 C0 89 04 24 89 E0 8B 51 04 50 51 FF 52 04 5B 5A EB 23 8B 41 04 89 E2 52 51 FF 10 5A 85 C0 59 74 12 31 C0 83 3C 24 00 0F 95 C0 89 03 B8 01 00 00 00 EB 02 31 C0 5B 5B C3 }
	condition:
		$pattern
}

rule __pthread_manager_adjust_prio_30d2a056fb38f924307e3a6bfd4a8ee4 {
	meta:
		aliases = "__pthread_manager_adjust_prio"
		size = "66"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 5C 24 0C 3B 1D ?? ?? ?? ?? 7E 2F 6A 01 E8 ?? ?? ?? ?? 39 C3 5A 0F 9C C0 0F B6 C0 8D 04 03 89 04 24 89 E0 50 6A 01 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 1D ?? ?? ?? ?? 83 C4 0C 58 5B C3 }
	condition:
		$pattern
}

rule fgetc_unlocked_51c788b0fa8040705eca5d5cfb82a5b7 {
	meta:
		aliases = "__GI_getc_unlocked, getc_unlocked, __GI_fgetc_unlocked, __GI___fgetc_unlocked, __fgetc_unlocked, fgetc_unlocked"
		size = "204"
		objfiles = "fgetc_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 5C 24 0C 8B 43 10 3B 43 18 0F 82 8C 00 00 00 0F B7 03 25 83 00 00 00 3D 80 00 00 00 77 15 68 80 00 00 00 53 E8 ?? ?? ?? ?? 5A 85 C0 59 0F 85 8C 00 00 00 8B 0B 0F B7 D1 F6 C2 02 74 19 83 E2 01 8D 41 FF 66 89 03 8A 54 93 24 C7 43 28 00 00 00 00 0F B6 D2 EB 6C 8B 43 10 39 43 14 75 3D 83 7B 04 FE 75 08 83 C9 04 66 89 0B EB 53 80 E6 03 74 0B 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 8B 43 08 39 43 0C 74 20 89 43 18 53 E8 ?? ?? ?? ?? 59 85 C0 74 2D 8B 43 14 89 43 18 8B 43 10 0F B6 10 40 89 43 10 EB 1E 6A 01 8D 44 24 07 50 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 07 0F B6 54 24 03 EB 03 83 CA FF 89 }
	condition:
		$pattern
}

rule xdr_char_1d7895a8ffa0c9d2bf0ff95fff09035a {
	meta:
		aliases = "xdr_char"
		size = "46"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 5C 24 10 0F B6 03 89 04 24 89 E0 50 FF 74 24 10 E8 ?? ?? ?? ?? 5A 31 D2 59 85 C0 74 07 8B 04 24 B2 01 88 03 89 D0 59 5B C3 }
	condition:
		$pattern
}

rule xdr_u_char_b179cd260b90491fd1fc60827fbbe7b2 {
	meta:
		aliases = "xdr_u_char"
		size = "46"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 5C 24 10 0F B6 03 89 04 24 89 E0 50 FF 74 24 10 E8 ?? ?? ?? ?? 5A 31 D2 59 85 C0 74 07 8B 04 24 B2 01 88 03 89 D0 5B 5B C3 }
	condition:
		$pattern
}

rule getrlimit64_0e2c68a0c99715b96721958763a55fdf {
	meta:
		aliases = "getrlimit64"
		size = "104"
		objfiles = "getrlimit64@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 89 E0 8B 5C 24 14 50 FF 74 24 14 E8 ?? ?? ?? ?? 5A 83 CA FF 59 85 C0 78 45 8B 04 24 83 F8 FF 75 0F C7 03 FF FF FF FF C7 43 04 FF FF FF FF EB 09 89 03 C7 43 04 00 00 00 00 8B 44 24 04 83 F8 FF 75 10 C7 43 08 FF FF FF FF C7 43 0C FF FF FF FF EB 0A 89 43 08 C7 43 0C 00 00 00 00 31 D2 89 D0 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule sighold_73e69e276044ac190a291aabe3ed6f53 {
	meta:
		aliases = "sigrelse, sighold"
		size = "57"
		objfiles = "sigrelse@libc.a, sighold@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 89 E3 53 6A 00 6A 02 E8 ?? ?? ?? ?? FF 74 24 1C 53 E8 ?? ?? ?? ?? 83 C4 14 83 CA FF 85 C0 78 0F 6A 00 53 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 89 C2 89 D0 5A 59 5B C3 }
	condition:
		$pattern
}

rule fcntl_13e566636ea64be5cace05d7b2d9be02 {
	meta:
		aliases = "open64, open, fcntl"
		size = "61"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8D 44 24 04 50 6A 01 E8 ?? ?? ?? ?? 8D 44 24 24 89 44 24 08 FF 74 24 20 FF 74 24 20 FF 74 24 20 E8 ?? ?? ?? ?? 6A 00 FF 74 24 1C 89 C3 E8 ?? ?? ?? ?? 89 D8 83 C4 24 5B C3 }
	condition:
		$pattern
}
...
rule forkpty_22854568a5cdcd210fd16edd00eef58d {
	meta:
		aliases = "forkpty"
		size = "114"
		objfiles = "forkpty@libutil.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 FF 74 24 1C FF 74 24 1C FF 74 24 1C 8D 44 24 0C 50 8D 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 14 40 74 44 E8 ?? ?? ?? ?? 89 C3 83 F8 FF 74 38 85 C0 75 1F FF 74 24 04 E8 ?? ?? ?? ?? FF 74 24 04 E8 ?? ?? ?? ?? 5A 85 C0 59 74 1F 6A 01 E8 ?? ?? ?? ?? 8B 44 24 10 8B 54 24 04 89 10 FF 34 24 E8 ?? ?? ?? ?? 58 EB 03 83 CB FF 89 D8 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_mbrtowc_ee55d7ad7e46a23a7a6df0319d7222ac {
	meta:
		aliases = "mbrtowc, __GI_mbrtowc"
		size = "107"
		objfiles = "mbrtowc@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 0C 8B 54 24 20 8B 5C 24 14 8B 44 24 18 85 D2 75 05 BA ?? ?? ?? ?? 85 C0 75 0D 31 DB 8D 44 24 0B C6 44 24 0B 00 EB 0C 80 38 00 74 33 83 7C 24 1C 00 74 2C 89 04 24 52 6A 01 6A FF 8D 44 24 0C 50 8D 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 14 89 C2 85 C0 78 0E 85 DB 74 0A 8B 44 24 04 89 03 EB 02 31 D2 89 D0 83 C4 0C 5B C3 }
	condition:
		$pattern
}

rule getmntent_51c3a951389e8e66ceaf40befa839f74 {
	meta:
		aliases = "getmntent"
		size = "117"
		objfiles = "mntent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 19 68 00 10 00 00 E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 85 C0 75 05 E8 ?? ?? ?? ?? 68 00 10 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 24 E8 ?? ?? ?? ?? 6A 01 89 C3 8D 44 24 14 50 E8 ?? ?? ?? ?? 89 D8 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule __new_exitfn_efee066bc5d08fe424cdc9ae749657d8 {
	meta:
		aliases = "__new_exitfn"
		size = "165"
		objfiles = "__exit_handler@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 8B 15 ?? ?? ?? ?? 40 83 C4 10 39 C2 7D 37 C1 E2 04 8D 82 40 01 00 00 50 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C3 58 85 DB 5A 75 0D E8 ?? ?? ?? ?? C7 00 0C 00 00 00 EB 33 83 05 ?? ?? ?? ?? 14 89 1D ?? ?? ?? ?? A1 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? 89 C3 40 C1 E3 04 A3 ?? ?? ?? ?? 03 1D ?? ?? ?? ?? C7 03 01 00 00 00 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 89 D8 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule __GI_closelog_23791260e74c0b92bcf3be285ce9d292 {
	meta:
...
rule srand_5a55eb0b773ad73123d997030b6cebe4 {
	meta:
...
rule sethostent_a242fb040b47f8a02397dc7504c1a605 {
	meta:
		aliases = "sethostent"
		size = "62"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 18 00 0F 95 05 ?? ?? ?? ?? 6A 01 53 E8 ?? ?? ?? ?? 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule __GI_openlog_10fce32c1354f36a1840c8dbec88fc81 {
	meta:
...
rule endgrent_e4fcc5f576143fdc424c02508d9d3fe1 {
	meta:
...
rule endservent_3507ba9dffddf7d42c1461ec63ab065f {
	meta:
		aliases = "endnetent, __GI_endnetent, __GI_endservent, endservent"
		size = "83"
		objfiles = "getnetent@libc.a, getservice@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 74 11 50 E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 58 6A 01 C6 05 ?? ?? ?? ?? 00 53 E8 ?? ?? ?? ?? 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule endprotoent_f833c6119cd87105f18bd9908407408c {
	meta:
		aliases = "__GI_endprotoent, endprotoent"
		size = "83"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 74 11 50 E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 59 6A 01 C6 05 ?? ?? ?? ?? 00 53 E8 ?? ?? ?? ?? 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule endutent_5143b2adace9d4f77f0b0860251cb45d {
	meta:
		aliases = "endutent"
		size = "76"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 78 07 50 E8 ?? ?? ?? ?? 58 6A 01 C7 05 ?? ?? ?? ?? FF FF FF FF 53 E8 ?? ?? ?? ?? 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule endhostent_06a172ebcee9e093024c680e59039d44 {
	meta:
		aliases = "endhostent"
		size = "83"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 C6 05 ?? ?? ?? ?? 00 85 C0 74 11 50 E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 5A 6A 01 53 E8 ?? ?? ?? ?? 83 C4 18 5B C3 }
	condition:
		$pattern
}
...
rule clearenv_6d03ed5cf2429ecd7349f895f5bd6dcf {
	meta:
		aliases = "clearenv"
		size = "80"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 C7 05 ?? ?? ?? ?? 00 00 00 00 53 C7 05 ?? ?? ?? ?? 00 00 00 00 E8 ?? ?? ?? ?? 31 C0 83 C4 2C 5B C3 }
	condition:
		$pattern
}

rule ftime_a6a5de9276ac345c71b9d6c6a652c142 {
	meta:
		aliases = "ftime"
		size = "73"
		objfiles = "ftime@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 89 E0 8B 5C 24 18 50 8D 44 24 0C 50 E8 ?? ?? ?? ?? 8B 44 24 10 BA E8 03 00 00 89 03 89 D1 8B 44 24 14 05 E7 03 00 00 99 F7 F9 66 89 43 04 8B 44 24 08 66 89 43 06 8B 44 24 0C 66 89 43 08 31 C0 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule pututline_087c0cb1f13c060c8f648c469c50ab78 {
	meta:
		aliases = "pututline"
		size = "151"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 8B 5C 24 18 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 68 80 FE FF FF FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? 83 C4 1C 85 C0 74 09 6A 01 68 80 FE FF FF EB 04 6A 02 6A 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 68 80 01 00 00 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 3D 80 01 00 00 6A 01 0F 94 C0 0F B6 C0 F7 D8 21 C3 8D 44 24 04 50 E8 ?? ?? ?? ?? 89 D8 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule utmpname_6ffa8c3e21b8757c40971614e9f7e565 {
	meta:
		aliases = "utmpname"
		size = "135"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 8B 5C 24 18 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 DB 74 2D A1 ?? ?? ?? ?? 3D ?? ?? ?? ?? 74 07 50 E8 ?? ?? ?? ?? 59 53 E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 85 C0 75 0A C7 05 ?? ?? ?? ?? ?? ?? ?? ?? A1 ?? ?? ?? ?? 85 C0 78 11 50 E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? FF FF FF FF 58 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 31 C0 83 C4 18 5B C3 }
	condition:
		$pattern
}
...
rule __GI_gethostent_r_ca23f7947e79f3272af80403050fde73 {
	meta:
		aliases = "gethostent_r, __GI_gethostent_r"
		size = "166"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 8B 5C 24 24 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 1B E8 ?? ?? ?? ?? A3 ?? ?? ?? ?? 85 C0 75 0D C7 03 00 00 00 00 BB 02 00 00 00 EB 46 FF 74 24 28 53 FF 74 24 28 FF 74 24 28 FF 74 24 28 6A 01 6A 02 6A 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 24 89 C3 80 3D ?? ?? ?? ?? 00 75 16 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 58 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 89 D8 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule atanh_b6a47c81d144659df098fb5361719940 {
	meta:
		aliases = "__GI_atanh, __ieee754_atanh, atanh"
		size = "202"
		objfiles = "e_atanh@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 DD 44 24 18 DD 54 24 08 8B 44 24 08 8B 5C 24 0C F7 D8 0B 44 24 08 89 DA C1 E8 1F 81 E2 FF FF FF 7F 09 D0 3D 00 00 F0 3F 76 09 D8 E0 D8 F0 E9 82 00 00 00 DD D8 81 FA 00 00 F0 3F 75 0C DD 44 24 18 DC 35 ?? ?? ?? ?? EB 6C 81 FA FF FF 2F 3E 7F 15 DD 44 24 18 DC 05 ?? ?? ?? ?? D9 EE D9 C9 DA E9 DF E0 9E 77 57 DD 44 24 18 81 FA FF FF DF 3F DD 1C 24 89 54 24 04 DD 04 24 D9 C0 D8 C1 7F 12 D9 C0 D8 CA D9 CA DC 2D ?? ?? ?? ?? DE FA DE C1 EB 06 D9 E8 DE E2 DE F1 83 EC 08 DD 1C 24 E8 ?? ?? ?? ?? 58 D8 0D ?? ?? ?? ?? 5A 85 DB DD 54 24 18 79 08 D9 E0 DD 5C 24 18 EB 02 DD D8 DD 44 24 18 83 C4 10 }
	condition:
		$pattern
}

rule ilogb_34c67cb3bf1db2e3629d3c19633cb519 {
	meta:
		aliases = "__GI_ilogb, ilogb"
		size = "115"
		objfiles = "s_ilogb@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 DD 44 24 18 DD 54 24 08 8B 54 24 0C 81 E2 FF FF FF 7F 81 FA FF FF 0F 00 7F 38 DD 1C 24 89 D3 8B 0C 24 B8 01 00 00 80 09 CB 74 3F B8 ED FB FF FF 85 D2 74 05 EB 09 48 01 C9 85 C9 7F F9 EB 2B C1 E2 0B B8 02 FC FF FF EB 03 48 01 D2 85 D2 7F F9 EB 18 DD D8 B8 FF FF FF 7F 81 FA FF FF EF 7F 7F 09 C1 FA 14 8D 82 01 FC FF FF 83 C4 10 5B C3 }
	condition:
		$pattern
}

rule cosh_faf40f4d4b67bd5da2fe190946095f70 {
	meta:
		aliases = "__ieee754_cosh, __GI_cosh, cosh"
		size = "279"
		objfiles = "e_cosh@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 DD 44 24 18 DD 54 24 08 8B 5C 24 0C 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 0F 8F E8 00 00 00 DD D8 81 FB 42 2E D6 3F 7F 3A FF 74 24 1C FF 74 24 1C E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? 59 D9 E8 D9 C1 D8 C1 58 81 FB FF FF 7F 3C 0F 8E B9 00 00 00 D9 CA D8 C8 D9 CA D8 C0 DE FA DE C1 E9 AC 00 00 00 81 FB FF FF 35 40 7F 27 FF 74 24 1C FF 74 24 1C E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? D9 05 ?? ?? ?? ?? D9 C1 D8 C9 D9 C9 DE F2 DE C1 EB 6B 81 FB 41 2E 86 40 7F 1D FF 74 24 1C FF 74 24 1C E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? D8 0D ?? ?? ?? ?? EB 46 DD 44 24 18 81 FB CD 33 86 40 DD 1C 24 8B }
	condition:
		$pattern
}

rule __GI_random_45141f1aa22574fe44ae705ff1f9c25b {
	meta:
...
rule getttyent_27b220ec6b459be287df56bb9f906f47 {
	meta:
		aliases = "__GI_getttyent, getttyent"
		size = "637"
		objfiles = "getttyent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 14 83 3D ?? ?? ?? ?? 00 75 0F E8 ?? ?? ?? ?? 31 DB 85 C0 0F 84 5A 02 00 00 83 3D ?? ?? ?? ?? 00 75 19 68 00 10 00 00 E8 ?? ?? ?? ?? 5B A3 ?? ?? ?? ?? 85 C0 75 05 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C0 38 50 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C0 38 50 E8 ?? ?? ?? ?? 83 C4 10 FF 35 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? 68 00 10 00 00 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 07 31 DB E9 DC 01 00 00 6A 0A 53 E8 ?? ?? ?? ?? 5A 85 C0 59 75 2B 8B 15 ?? ?? ?? ?? 8B 42 10 3B 42 18 73 09 0F B6 08 40 89 42 10 EB 09 52 E8 ?? ?? ?? ?? 5B 89 C1 83 F9 0A 74 A8 41 74 A5 EB D6 43 8A 0B A1 }
	condition:
		$pattern
}

rule siginterrupt_f74d5cd6bb5cc5dc94e7b305a29c8af1 {
	meta:
		aliases = "siginterrupt"
		size = "103"
		objfiles = "sigintr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 14 89 E0 8B 5C 24 1C 50 6A 00 53 E8 ?? ?? ?? ?? 83 C4 0C 83 CA FF 85 C0 78 43 83 7C 24 20 00 74 15 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 81 64 24 0C FF FF FF EF EB 13 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 81 4C 24 0C 00 00 00 10 58 5A 6A 00 8D 44 24 04 50 53 E8 ?? ?? ?? ?? 83 C4 0C 89 C2 89 D0 83 C4 14 5B C3 }
	condition:
		$pattern
}

rule frexp_4279090a95e9bfa81d64aaf9e384fcf7 {
	meta:
		aliases = "__GI_frexp, frexp"
		size = "151"
		objfiles = "s_frexp@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 DD 44 24 20 8B 5C 24 28 DD 54 24 10 8B 4C 24 14 8B 44 24 10 89 CA C7 03 00 00 00 00 81 E2 FF FF FF 7F 81 FA FF FF EF 7F 7F 5E 09 D0 74 5A 81 FA FF FF 0F 00 7F 22 D8 0D ?? ?? ?? ?? DD 54 24 20 DD 5C 24 08 8B 4C 24 0C C7 03 CA FF FF FF 89 CA 81 E2 FF FF FF 7F EB 02 DD D8 8B 03 81 E1 FF FF 0F 80 2D FE 03 00 00 81 C9 00 00 E0 3F C1 FA 14 01 D0 89 03 DD 44 24 20 DD 1C 24 89 4C 24 04 DD 04 24 DD 5C 24 20 EB 02 DD D8 DD 44 24 20 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule __GI_sinh_10a57f98d85edc9d676d794ec8c08960 {
	meta:
		aliases = "__ieee754_sinh, sinh, __GI_sinh"
		size = "317"
		objfiles = "e_sinh@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 DD 44 24 20 DD 54 24 08 8B 44 24 0C 89 C3 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7E 07 D8 C0 E9 09 01 00 00 DD D8 85 C0 79 08 D9 05 ?? ?? ?? ?? EB 06 D9 05 ?? ?? ?? ?? DD 5C 24 10 81 FB FF FF 35 40 7F 70 81 FB FF FF 2F 3E 7F 19 DD 44 24 20 DC 05 ?? ?? ?? ?? D9 E8 D9 C9 DA E9 DF E0 9E 0F 87 CC 00 00 00 FF 74 24 24 FF 74 24 24 E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? 59 D9 C0 58 81 FB FF FF EF 3F 7F 1C DC C1 D9 C9 DD 5C 24 20 D9 C0 D8 C9 D9 C9 DC 05 ?? ?? ?? ?? DE F9 DC 6C 24 20 EB 0A DD D9 D9 E8 D8 C1 D8 F9 DE C1 DD 44 24 10 DE C9 EB 79 81 FB 41 2E 86 40 7F 1B FF 74 24 24 FF 74 24 24 E8 }
	condition:
		$pattern
}
...
rule fesetenv_d9fa88009128bf08391b70bd1aa6b3da {
	meta:
		aliases = "__GI_fesetenv, fesetenv"
		size = "223"
		objfiles = "fesetenv@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C D9 34 24 8B 5C 24 24 83 FB FF 75 2B 8B 04 24 C7 44 24 0C 00 00 00 00 66 83 64 24 04 C2 66 81 64 24 12 00 F8 83 C8 3D 66 C7 44 24 10 00 00 80 E4 F3 66 89 04 24 EB 2F 83 FB FE 66 8B 4C 24 12 75 36 66 81 24 24 C2 F3 C7 44 24 0C 00 00 00 00 66 83 64 24 04 C2 66 81 E1 00 F8 66 C7 44 24 10 00 00 66 89 4C 24 12 C7 44 24 14 00 00 00 00 66 C7 44 24 18 00 00 EB 5A 8B 03 8B 14 24 66 81 E2 C2 F3 66 25 3D 0C 66 81 E1 00 F8 09 D0 66 89 04 24 8B 54 24 04 8B 43 04 83 E2 C2 83 E0 3D 09 D0 66 89 44 24 04 8B 43 0C 89 44 24 0C 8B 43 10 66 89 44 24 10 66 8B 43 12 66 25 FF 07 09 C1 66 89 4C 24 12 8B 43 }
	condition:
		$pattern
}

rule __GI_scalbn_eec6789731b74d15a05297db358b79c2 {
	meta:
		aliases = "scalbln, __GI_scalbln, scalbn, __GI_scalbn"
		size = "297"
		objfiles = "s_scalbn@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 20 DD 44 24 28 8B 5C 24 30 DD 54 24 18 8B 54 24 1C 8B 4C 24 18 89 D0 25 00 00 F0 7F C1 F8 14 75 2F 81 E2 FF FF FF 7F 09 CA 0F 84 EC 00 00 00 D8 0D ?? ?? ?? ?? DD 54 24 28 DD 5C 24 10 8B 54 24 14 89 D0 25 00 00 F0 7F C1 F8 14 83 E8 36 EB 02 DD D8 3D FF 07 00 00 75 0B DD 44 24 28 D8 C0 E9 B1 00 00 00 01 D8 3D FE 07 00 00 7F 36 81 FB B0 3C FF FF 7C 54 85 C0 7E 1D DD 44 24 28 C1 E0 14 81 E2 FF FF 0F 80 DD 5C 24 08 09 D0 89 44 24 0C DD 44 24 08 EB 7F 83 F8 CA 7F 58 81 FB 50 C3 00 00 7E 26 FF 74 24 2C FF 74 24 2C 68 3C E4 37 7E 68 9C 75 00 88 E8 ?? ?? ?? ?? 83 C4 10 DD 5C 24 28 DD 05 ?? ?? }
	condition:
		$pattern
}

rule __GI_trunc_b02f962526bea788ad3ad3a00a700e49 {
	meta:
		aliases = "trunc, __GI_trunc"
		size = "212"
		objfiles = "s_trunc@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 20 DD 44 24 28 C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 DD 5C 24 18 8B 54 24 1C C7 44 24 08 00 00 00 00 89 D0 C7 44 24 0C 00 00 00 00 C1 F8 14 C7 04 24 00 00 00 00 25 FF 07 00 00 C7 44 24 04 00 00 00 00 8B 5C 24 18 8D 88 01 FC FF FF 83 F9 13 7F 3D 89 D3 81 E3 00 00 00 80 85 C9 79 12 89 5C 24 14 C7 44 24 10 00 00 00 00 DD 44 24 10 EB 51 B8 FF FF 0F 00 C7 44 24 08 00 00 00 00 D3 F8 F7 D0 21 D0 09 D8 89 44 24 0C DD 44 24 08 EB 32 83 F9 33 7E 10 81 F9 00 04 00 00 75 29 DD 44 24 28 D8 C0 EB 1D 8D 88 ED FB FF FF 83 C8 FF D3 E8 F7 D0 8B 54 24 1C 21 D8 89 54 24 04 89 04 24 DD 04 24 DD }
	condition:
		$pattern
}

rule __pthread_initialize_manager_3cc767f5e7bf3ae19de83e2239e241de {
	meta:
		aliases = "__pthread_initialize_manager"
		size = "456"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 24 A1 ?? ?? ?? ?? C7 00 01 00 00 00 83 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 8D 44 00 E0 50 E8 ?? ?? ?? ?? 89 C2 A3 ?? ?? ?? ?? 59 83 C8 FF 85 D2 0F 84 84 01 00 00 A1 ?? ?? ?? ?? 8D 44 42 E0 A3 ?? ?? ?? ?? 8D 44 24 1C 50 E8 ?? ?? ?? ?? 5A 40 75 14 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C8 FF 5B E9 54 01 00 00 A1 ?? ?? ?? ?? 85 C0 74 05 A3 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 0F 84 80 00 00 00 A1 ?? ?? ?? ?? 8A 15 ?? ?? ?? ?? 08 C2 79 71 31 D2 A1 ?? ?? ?? ?? E8 ?? ?? ?? ?? FF 74 24 1C 68 00 0F 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 89 C3 83 F8 FF 74 32 }
	condition:
		$pattern
}

rule signal_815067e5ff5b7ee1f348a708733982bf {
	meta:
		aliases = "__GI_signal, bsd_signal, signal"
		size = "135"
		objfiles = "signal@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 28 8B 44 24 34 8B 5C 24 30 83 F8 FF 74 09 85 DB 7E 05 83 FB 40 7E 10 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 EB 56 89 44 24 14 C7 44 24 20 00 00 00 00 C7 44 24 24 00 00 00 00 53 8D 44 24 24 50 E8 ?? ?? ?? ?? 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 F8 01 19 C0 25 00 00 00 10 89 44 24 18 89 E0 50 8D 44 24 18 50 53 E8 ?? ?? ?? ?? 83 C4 0C 83 CA FF 85 C0 78 03 8B 14 24 89 D0 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule malloc_stats_f3b28c8f179fded2c7d003b636417cff {
	meta:
		aliases = "malloc_stats"
		size = "79"
		objfiles = "mallinfo@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 28 8B 5C 24 30 85 DB 75 06 8B 1D ?? ?? ?? ?? 89 E0 50 E8 ?? ?? ?? ?? 8B 4C 24 10 8B 44 24 1C 8B 14 24 FF 74 24 24 FF 74 24 24 FF 74 24 1C 50 51 FF 74 24 20 8D 04 01 52 01 CA 50 52 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 54 5B C3 }
	condition:
		$pattern
}

rule __GI_pmap_unset_a7be1081e40bcb69f55d7b0bb4f52248 {
	meta:
		aliases = "pmap_unset, __GI_pmap_unset"
		size = "173"
		objfiles = "pmap_clnt@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 28 8D 5C 24 10 C7 44 24 24 FF FF FF FF 89 D8 E8 ?? ?? ?? ?? 85 C0 0F 84 87 00 00 00 68 90 01 00 00 68 90 01 00 00 8D 44 24 2C 50 FF 35 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 6A 02 68 A0 86 01 00 53 E8 ?? ?? ?? ?? 83 C4 20 89 C3 85 C0 74 56 8B 44 24 30 C7 44 24 08 00 00 00 00 89 04 24 8B 44 24 34 89 44 24 04 C7 44 24 0C 00 00 00 00 89 E2 8B 4B 04 8D 44 24 20 FF 35 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 50 68 ?? ?? ?? ?? 52 68 ?? ?? ?? ?? 6A 02 53 FF 11 83 C4 20 8B 43 04 53 FF 50 10 8B 44 24 24 59 EB 02 31 C0 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule __GI_svcerr_progvers_9e3e9837d11cbb2f3d9ce00da9bf56a9 {
	meta:
		aliases = "svcerr_progvers, __GI_svcerr_progvers"
		size = "81"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 30 8B 5C 24 38 8D 54 24 0C C7 44 24 04 01 00 00 00 C7 44 24 08 00 00 00 00 8D 43 20 6A 0C 50 52 E8 ?? ?? ?? ?? 8B 44 24 48 89 44 24 28 8B 44 24 4C 89 44 24 2C C7 44 24 24 02 00 00 00 8B 53 08 8D 44 24 0C 50 53 FF 52 0C 83 C4 44 5B C3 }
	condition:
		$pattern
}

rule svc_sendreply_8877d180c27ed4c561631bdcc1340ed1 {
	meta:
		aliases = "__GI_svc_sendreply, svc_sendreply"
		size = "81"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 30 8B 5C 24 38 8D 54 24 0C C7 44 24 04 01 00 00 00 C7 44 24 08 00 00 00 00 8D 43 20 6A 0C 50 52 E8 ?? ?? ?? ?? 8B 44 24 4C 89 44 24 28 8B 44 24 48 89 44 24 2C C7 44 24 24 00 00 00 00 8B 53 08 8D 44 24 0C 50 53 FF 52 0C 83 C4 44 5B C3 }
	condition:
		$pattern
}

rule __GI_svcerr_noprog_48b751464da5a094928dcba9f78a8181 {
	meta:
		aliases = "svcerr_noprog, __GI_svcerr_noprog"
		size = "65"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 30 8B 5C 24 38 8D 54 24 0C C7 44 24 04 01 00 00 00 C7 44 24 08 00 00 00 00 8D 43 20 6A 0C 50 52 E8 ?? ?? ?? ?? C7 44 24 24 01 00 00 00 8B 53 08 8D 44 24 0C 50 53 FF 52 0C 83 C4 44 5B C3 }
	condition:
		$pattern
}

rule svcerr_noproc_a0efdc184e485292481ec0286d6ca44d {
	meta:
		aliases = "svcerr_noproc"
		size = "65"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 30 8B 5C 24 38 8D 54 24 0C C7 44 24 04 01 00 00 00 C7 44 24 08 00 00 00 00 8D 43 20 6A 0C 50 52 E8 ?? ?? ?? ?? C7 44 24 24 03 00 00 00 8B 53 08 8D 44 24 0C 50 53 FF 52 0C 83 C4 44 5B C3 }
	condition:
		$pattern
}

rule svcerr_decode_97952a3ee794c8d4840940380408b634 {
	meta:
		aliases = "__GI_svcerr_decode, svcerr_decode"
		size = "65"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 30 8B 5C 24 38 8D 54 24 0C C7 44 24 04 01 00 00 00 C7 44 24 08 00 00 00 00 8D 43 20 6A 0C 50 52 E8 ?? ?? ?? ?? C7 44 24 24 04 00 00 00 8B 53 08 8D 44 24 0C 50 53 FF 52 0C 83 C4 44 5B C3 }
	condition:
		$pattern
}

rule svcerr_systemerr_7a155c82909c54a879e7afdee6aaa6ad {
	meta:
		aliases = "svcerr_systemerr"
		size = "65"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 30 8B 5C 24 38 8D 54 24 0C C7 44 24 04 01 00 00 00 C7 44 24 08 00 00 00 00 8D 43 20 6A 0C 50 52 E8 ?? ?? ?? ?? C7 44 24 24 05 00 00 00 8B 53 08 8D 44 24 0C 50 53 FF 52 0C 83 C4 44 5B C3 }
	condition:
		$pattern
}

rule __GI_asinh_dabf23dfb4b1da11c8f4167f23cd0c9f {
	meta:
		aliases = "asinh, __GI_asinh"
		size = "314"
		objfiles = "s_asinh@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 34 DD 44 24 3C DD 54 24 1C 8B 5C 24 20 89 DA 81 E2 FF FF FF 7F 81 FA FF FF EF 7F 7E 07 D8 C0 E9 02 01 00 00 DD D8 81 FA FF FF 2F 3E 7F 19 DD 44 24 3C DC 05 ?? ?? ?? ?? D9 E8 D9 C9 DA E9 DF E0 9E 0F 87 E7 00 00 00 81 FA 00 00 B0 41 7E 22 FF 74 24 40 FF 74 24 40 E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? 58 DC 05 ?? ?? ?? ?? 5A E9 AB 00 00 00 DD 44 24 3C D8 C8 81 FA 00 00 00 40 DD 5C 24 0C 7E 4A FF 74 24 40 FF 74 24 40 E8 ?? ?? ?? ?? DD 5C 24 34 D9 E8 DD 44 24 14 D8 C1 DD 54 24 14 DD 1C 24 DD 5C 24 08 E8 ?? ?? ?? ?? DD 44 24 34 D8 C0 D9 C9 DC 44 24 34 DD 44 24 08 DE F1 83 EC 08 DE C1 DD 1C }
	condition:
		$pattern
}

rule __kernel_tan_c3c6b27a03eef91815d05f7c198e2d86 {
	meta:
		aliases = "__kernel_tan"
		size = "515"
		objfiles = "k_tan@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 38 DD 44 24 48 DD 44 24 40 8B 5C 24 50 DD 54 24 18 8B 54 24 1C 89 D1 81 E1 FF FF FF 7F 81 F9 FF FF 2F 3E 7F 66 D9 7C 24 36 66 8B 44 24 36 80 CC 0C 66 89 44 24 34 D9 6C 24 34 DB 54 24 30 D9 6C 24 36 8B 44 24 30 85 C0 75 7D DD D9 DD 54 24 10 0B 4C 24 10 8D 43 01 09 C1 75 18 83 EC 08 DD 1C 24 E8 ?? ?? ?? ?? 58 DC 3D ?? ?? ?? ?? 5A E9 80 01 00 00 DD D8 4B 0F 84 7B 01 00 00 DD 44 24 40 D8 3D ?? ?? ?? ?? E9 68 01 00 00 DD D8 81 F9 27 94 E5 3F 7E 34 85 D2 79 0C DD 44 24 40 D9 E0 DD 5C 24 40 D9 E0 DD 44 24 40 DC 2D ?? ?? ?? ?? DD 5C 24 40 DD 05 ?? ?? ?? ?? DE E1 DC 44 24 40 DD 5C 24 40 D9 EE }
	condition:
		$pattern
}

rule __GI_stat_66e5993732e4c6da4414faf1e7d5b0d5 {
	meta:
		aliases = "stat, __GI_stat"
		size = "67"
		objfiles = "stat@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 40 89 E1 8B 54 24 48 87 D3 B8 6A 00 00 00 CD 80 87 D3 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 CB FF EB 10 85 C0 75 0C FF 74 24 4C 51 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 40 5B C3 }
	condition:
		$pattern
}

rule __GI_lstat_0b93d962f38474ffdd5368f61c816332 {
	meta:
		aliases = "lstat, __GI_lstat"
		size = "67"
		objfiles = "lstat@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 40 89 E1 8B 54 24 48 87 D3 B8 6B 00 00 00 CD 80 87 D3 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 CB FF EB 10 85 C0 75 0C FF 74 24 4C 51 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 40 5B C3 }
	condition:
		$pattern
}

rule fstat_94ce7dfbf4f948402901013b0c09eeaa {
	meta:
		aliases = "__GI_fstat, fstat"
		size = "67"
		objfiles = "fstat@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 40 89 E1 8B 54 24 48 87 D3 B8 6C 00 00 00 CD 80 87 D3 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 CB FF EB 10 85 C0 75 0C FF 74 24 4C 51 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 40 5B C3 }
	condition:
		$pattern
}

rule vswprintf_499f2b4e3819bdd621d4c8c4ba104b9a {
	meta:
		aliases = "__GI_vswprintf, vswprintf"
		size = "155"
		objfiles = "vswprintf@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 50 8B 54 24 58 8B 44 24 5C 89 D3 C7 44 24 04 FD FF FF FF F7 D3 C1 EB 02 66 C7 04 24 50 08 C6 44 24 02 00 C7 44 24 2C 00 00 00 00 C7 44 24 20 00 00 00 00 39 C3 76 02 89 C3 8D 04 9A 89 54 24 08 89 44 24 0C 89 54 24 10 89 54 24 14 89 54 24 18 89 54 24 1C FF 74 24 64 FF 74 24 64 8D 44 24 08 50 E8 ?? ?? ?? ?? 89 C2 8B 44 24 1C 83 C4 0C 3B 44 24 0C 75 0E 83 CA FF 85 DB 74 15 83 E8 04 89 44 24 10 85 DB 74 0A 8B 44 24 10 C7 00 00 00 00 00 89 D0 83 C4 50 5B C3 }
	condition:
		$pattern
}

rule vswscanf_0cf791d4c0fa2696e7a5e3f77a3c363c {
	meta:
		aliases = "__GI_vswscanf, vswscanf"
		size = "116"
		objfiles = "vswscanf@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 50 8B 5C 24 58 89 5C 24 10 89 5C 24 08 53 E8 ?? ?? ?? ?? 5A 8D 04 83 89 44 24 0C 89 44 24 14 8D 44 24 38 89 5C 24 18 89 5C 24 1C C7 44 24 04 FD FF FF FF 66 C7 04 24 21 08 C6 44 24 02 00 C7 44 24 2C 00 00 00 00 C7 44 24 34 01 00 00 00 89 E3 50 E8 ?? ?? ?? ?? C7 44 24 24 00 00 00 00 FF 74 24 64 FF 74 24 64 53 E8 ?? ?? ?? ?? 83 C4 60 5B C3 }
	condition:
		$pattern
}

rule fdopendir_da358c6e56dedfb30e7379536aa10259 {
	meta:
		aliases = "fdopendir"
		size = "106"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 58 89 E0 8B 5C 24 60 50 53 E8 ?? ?? ?? ?? 5A 85 C0 59 75 4C 8B 44 24 10 25 00 F0 00 00 3D 00 40 00 00 74 0D E8 ?? ?? ?? ?? C7 00 14 00 00 00 EB 2F 6A 03 53 E8 ?? ?? ?? ?? 5A 83 F8 FF 59 74 20 83 E0 03 48 75 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 0D 8B 54 24 30 89 D8 E8 ?? ?? ?? ?? EB 02 31 C0 83 C4 58 5B C3 }
	condition:
		$pattern
}

rule ftok_b36f935e3a6e076712d9ad6113e632f1 {
	meta:
		aliases = "ftok"
		size = "55"
		objfiles = "ftok@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 58 89 E0 8B 5C 24 64 50 FF 74 24 64 E8 ?? ?? ?? ?? 5A 83 CA FF 59 85 C0 78 13 0F B6 14 24 0F B7 44 24 0C C1 E2 10 C1 E3 18 09 C2 09 DA 89 D0 83 C4 58 5B C3 }
	condition:
		$pattern
}

rule stat64_c5c5c27b3603575bac9a8e09cb1ebb8e {
	meta:
		aliases = "__GI_stat64, stat64"
		size = "67"
		objfiles = "stat64@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 60 89 E1 8B 54 24 68 87 D3 B8 C3 00 00 00 CD 80 87 D3 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 CB FF EB 10 85 C0 75 0C FF 74 24 6C 51 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 60 5B C3 }
	condition:
		$pattern
}

rule lstat64_be18fe66728874366088109686e3a0b7 {
	meta:
		aliases = "__GI_lstat64, lstat64"
		size = "67"
		objfiles = "lstat64@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 60 89 E1 8B 54 24 68 87 D3 B8 C4 00 00 00 CD 80 87 D3 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 CB FF EB 10 85 C0 75 0C FF 74 24 6C 51 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 60 5B C3 }
	condition:
		$pattern
}

rule __GI_fstat64_47bc7f41aa5fae69073bac2164fc6abc {
	meta:
		aliases = "fstat64, __GI_fstat64"
		size = "67"
		objfiles = "fstat64@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 60 89 E1 8B 54 24 68 87 D3 B8 C5 00 00 00 CD 80 87 D3 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 CB FF EB 10 85 C0 75 0C FF 74 24 6C 51 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 60 5B C3 }
	condition:
		$pattern
}
...
rule __ether_line_7b8f1a1681ee5369943915f471d88bdf {
	meta:
		aliases = "__ether_line"
		size = "58"
		objfiles = "ethers@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 89 C3 52 50 E8 ?? ?? ?? ?? 5A 85 C0 59 75 03 EB 22 43 8A 03 84 C0 74 0B 3C 20 74 07 3C 09 75 F1 EB 01 43 8A 03 84 C0 74 0A 3C 20 74 F5 3C 09 75 04 EB EF 31 DB 89 D8 5B C3 }
	condition:
		$pattern
}
...
rule scan_getwc_03e547d935f275401fabc03f417891c5 {
	meta:
		aliases = "scan_getwc"
		size = "118"
		objfiles = "vfwscanf@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 89 C3 C7 40 24 FF FF FF FF 8B 40 10 48 89 43 10 85 C0 78 38 80 7B 19 00 75 4A 8B 53 08 83 7A 04 FD 75 1B 8B 42 10 3B 42 0C 73 0A 8B 08 83 C0 04 89 42 10 EB 1D C6 43 19 02 83 C8 FF EB 35 52 E8 ?? ?? ?? ?? 89 C1 58 83 F9 FF 75 06 80 4B 19 02 EB E7 8B 43 08 C6 43 1A 01 89 4B 04 8A 40 02 88 43 18 EB 04 C6 43 19 00 FF 43 0C 8B 43 04 89 43 24 31 C0 5B C3 }
	condition:
		$pattern
}
...
rule clnt_pcreateerror_4fdb18028d5c736834e79cad156b011a {
	meta:
...
rule __GI_clnt_perror_ddbfa452b0006be980ec8a72509c415f {
	meta:
...
rule timer_gettime_a85d5ff5979c4496984c6a50a532674c {
	meta:
		aliases = "timer_gettime"
		size = "47"
		objfiles = "timer_gettime@librt.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 44 24 08 8B 4C 24 0C 8B 50 04 87 D3 B8 05 01 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}
...
rule pread_ab437036bdc503b3efe105177bd491a7 {
	meta:
		aliases = "mq_send, __libc_pread, mq_receive, pread"
		size = "35"
		objfiles = "pread_write@libc.a, mq_receive@librt.a, mq_send@librt.a"
	strings:
...
rule xdrrec_putint32_ce16cb14240da6c19301b944af3cb7c2 {
	meta:
		aliases = "xdrrec_putint32"
		size = "77"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 44 24 08 8B 58 0C 8B 53 10 89 D1 8D 42 04 89 43 10 3B 43 14 76 22 89 53 10 C7 43 1C 01 00 00 00 31 D2 89 D8 E8 ?? ?? ?? ?? 31 D2 85 C0 74 18 8B 4B 10 8D 41 04 89 43 10 8B 44 24 0C BA 01 00 00 00 8B 00 0F C8 89 01 89 D0 5B C3 }
	condition:
		$pattern
}

rule __GI_xdrrec_eof_fd72849aacf67bb54ab925f34c0234f8 {
	meta:
...
rule __GI_xdrrec_skiprecord_29fa3ef25e1a835417b2ea430ab2fb87 {
	meta:
		aliases = "xdrrec_skiprecord, __GI_xdrrec_skiprecord"
		size = "76"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 44 24 08 8B 58 0C EB 23 89 D8 E8 ?? ?? ?? ?? 85 C0 74 33 C7 43 34 00 00 00 00 83 7B 38 00 75 0B 89 D8 E8 ?? ?? ?? ?? 85 C0 74 1B 8B 53 34 85 D2 7F D6 83 7B 38 00 74 D0 B8 01 00 00 00 C7 43 38 00 00 00 00 EB 02 31 C0 5B C3 }
	condition:
		$pattern
}
...
rule clnttcp_control_106d199dd7a698f851a05b32734c9a47 {
	meta:
		aliases = "clnttcp_control"
		size = "167"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 44 24 08 8B 5C 24 10 8B 48 08 8B 44 24 0C 48 83 F8 0E 77 07 FF 24 85 ?? ?? ?? ?? 31 C0 E9 81 00 00 00 C7 41 04 01 00 00 00 EB 73 C7 41 04 00 00 00 00 EB 6A 8B 13 8B 43 04 89 41 0C 89 51 08 C7 41 10 01 00 00 00 EB 56 8B 51 08 8B 41 0C 89 43 04 89 13 EB 49 8D 41 14 6A 10 50 53 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 0C EB 38 8B 01 EB 24 8B 41 30 0F C8 EB 1D 8B 03 48 0F C8 89 41 30 8B 41 40 0F C8 EB 0E 8B 03 0F C8 89 41 40 EB 10 8B 41 3C 0F C8 89 03 EB 07 8B 03 0F C8 89 41 3C B8 01 00 00 00 5B C3 }
	condition:
		$pattern
}

rule clntunix_control_db2f2b12299bd418eeb64b071cccba00 {
	meta:
		aliases = "clntunix_control"
		size = "178"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 44 24 08 8B 5C 24 10 8B 48 08 8B 44 24 0C 48 83 F8 0E 77 07 FF 24 85 ?? ?? ?? ?? 31 C0 E9 8C 00 00 00 C7 41 04 01 00 00 00 EB 7E C7 41 04 00 00 00 00 EB 75 8B 13 8B 43 04 89 41 0C 89 51 08 EB 68 8B 51 08 8B 41 0C 89 43 04 89 13 EB 5B 8D 41 14 6A 6E 50 53 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 0C EB 4A 8B 01 EB 33 8B 81 90 00 00 00 0F C8 EB 29 8B 03 48 0F C8 89 81 90 00 00 00 8B 81 A0 00 00 00 0F C8 EB 14 8B 03 0F C8 89 81 A0 00 00 00 EB 16 8B 81 9C 00 00 00 0F C8 89 03 EB 0A 8B 03 0F C8 89 81 9C 00 00 00 B8 01 00 00 00 5B C3 }
	condition:
		$pattern
}

rule clntudp_control_90cdc68b7b1929d863bd530eee0920b7 {
	meta:
		aliases = "clntudp_control"
		size = "203"
		objfiles = "clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 44 24 08 8B 5C 24 10 8B 48 08 8B 44 24 0C 48 83 F8 0E 77 07 FF 24 85 ?? ?? ?? ?? 31 C0 E9 A5 00 00 00 C7 41 04 01 00 00 00 E9 94 00 00 00 C7 41 04 00 00 00 00 E9 88 00 00 00 8B 13 8B 43 04 89 41 28 89 51 24 EB 7B 8B 51 24 8B 41 28 EB 13 8B 13 8B 43 04 89 41 20 89 51 1C EB 66 8B 51 1C 8B 41 20 89 43 04 89 13 EB 59 8D 41 08 6A 10 50 53 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 0C EB 48 8B 01 EB 31 8B 41 58 8B 00 0F C8 EB 28 8B 51 58 8B 03 48 0F C8 89 02 8B 41 58 8B 40 10 0F C8 EB 14 8B 51 58 8B 03 0F C8 89 42 10 EB 16 8B 41 58 8B 40 0C 0F C8 89 03 EB 0A 8B 51 58 8B 03 0F C8 89 42 0C B8 01 00 00 }
	condition:
		$pattern
}
...
rule __GI_freeaddrinfo_fff30ef1883818390156dbdaafa20051 {
	meta:
...
rule tcsendbreak_ef2a680d89ca5c41bbb93ef77ad39dc1 {
	meta:
		aliases = "tcsendbreak"
		size = "52"
		objfiles = "tcsendbrk@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 44 24 0C 8B 4C 24 08 85 C0 7F 09 6A 00 68 09 54 00 00 EB 13 83 C0 63 BA 64 00 00 00 89 D3 99 F7 FB 50 68 25 54 00 00 51 E8 ?? ?? ?? ?? 83 C4 0C 5B C3 }
	condition:
		$pattern
}
...
rule __decode_header_5e7161398d6b8d0ab0ac7b0d4a4470f0 {
	meta:
...
rule mq_notify_de6ce9b0682116046b567274ccce3c1f {
	meta:
		aliases = "mq_notify"
		size = "67"
		objfiles = "mq_notify@librt.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 4C 24 0C 8B 54 24 08 85 C9 74 13 83 79 08 02 75 0D E8 ?? ?? ?? ?? C7 00 26 00 00 00 EB 1E 87 D3 B8 19 01 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}
...
rule __GI_towctrans_ffd94486e06dc719e20817477528e69c {
	meta:
		aliases = "towctrans, __GI_towctrans"
		size = "57"
		objfiles = "towctrans@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 4C 24 0C 8B 5C 24 08 8D 41 FF 83 F8 01 77 17 89 DA 83 CA 20 8D 42 9F 83 F8 19 77 15 83 F9 02 75 12 83 E2 DF EB 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 89 DA 89 D0 5B C3 }
	condition:
		$pattern
}

rule ustat_c1195691c987eadaa9219511ab370af6 {
	meta:
		aliases = "ustat"
		size = "44"
		objfiles = "ustat@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 4C 24 10 8B 44 24 08 53 89 C3 B8 3E 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}
...
rule __GI_clock_getres_e91f6d9fc917835c4cf15d132d5a3d60 {
	meta:
...
rule __GI_utime_a5f5f9b2084670e26f07706cff6f8c72 {
	meta:
...
rule __GI_kill_781af69f517408312bf43fd2337b872a {
	meta:
...
rule __GI_dup2_273c9e202a27fa9b3eed88af7d3e12ef {
	meta:
...
rule __GI_gettimeofday_7d330373b06b3d85194db0eca733ecb3 {
	meta:
...
rule __GI_settimeofday_d38570fec8d225b3cd679066b55b8376 {
	meta:
...
rule __GI_munmap_a458b3778cf792fc683b605c45fb405f {
	meta:
...
rule __GI_truncate_13cd5ee55280bf7267604b601730e6f7 {
	meta:
...
rule __GI_ftruncate_6befe00d7a8373b7cd3e519d450442e1 {
	meta:
...
rule __GI_getpriority_128e8caff37bc6fa8e5bfdc40181461d {
	meta:
...
rule __libc_statfs_b358acf49d4606aac2aa3f9bb673929e {
	meta:
...
rule __libc_fstatfs_e462e7ac8a1e8dad217f0c356208a420 {
	meta:
...
rule __GI_getrlimit_c6a91a20a90df7394afb401d3d6d3742 {
	meta:
...
rule __GI_getgroups_e7b60e14a8752d45d092b67cb7c458b4 {
	meta:
...
rule __GI_ether_ntoa_r_3c5a956ccefe9d6f9b78ca790ade80ff {
	meta:
		aliases = "ether_ntoa_r, __GI_ether_ntoa_r"
		size = "56"
		objfiles = "ether_addr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 54 24 08 8B 5C 24 0C 0F B6 42 05 50 0F B6 42 04 50 0F B6 42 03 50 0F B6 42 02 50 0F B6 42 01 50 0F B6 02 50 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 89 D8 83 C4 20 5B C3 }
	condition:
		$pattern
}

rule _dl_strdup_b45aa41b813537196549122d5f9827d9 {
	meta:
		aliases = "_dl_strdup"
		size = "45"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 54 24 08 8D 5A FF 89 D8 40 80 38 00 75 FA 29 D0 40 50 E8 ?? ?? ?? ?? 89 C1 8D 50 FF 58 43 42 8A 03 88 02 84 C0 75 F6 89 C8 5B C3 }
	condition:
		$pattern
}
...
rule __uc_malloc_fc83d91481ad112d3f1d627a342eb54d {
	meta:
		aliases = "__GI___uc_malloc, __uc_malloc"
		size = "44"
		objfiles = "__uc_malloc@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 53 E8 ?? ?? ?? ?? 5A 85 DB 74 1A 85 C0 75 16 A1 ?? ?? ?? ?? 85 C0 75 07 6A 01 E8 ?? ?? ?? ?? 53 FF D0 58 EB DB 5B C3 }
	condition:
		$pattern
}

rule re_exec_321d7eba2385ccbae3ff94dea5afb602 {
	meta:
		aliases = "re_exec"
		size = "43"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 53 E8 ?? ?? ?? ?? C7 04 24 00 00 00 00 50 6A 00 50 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 18 F7 D0 C1 E8 1F 5B C3 }
	condition:
		$pattern
}
...
rule mkdtemp_bd51dad484b3224b6d8d24f1b7e78c3b {
	meta:
		aliases = "mkdtemp"
		size = "31"
		objfiles = "mkdtemp@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 6A 02 53 E8 ?? ?? ?? ?? 85 C0 5A 0F 94 C0 0F B6 C0 F7 D8 21 C3 59 89 D8 5B C3 }
	condition:
		$pattern
}

rule fdopen_3201e8345f142893f8e714f836eb1850 {
	meta:
		aliases = "__GI_fdopen, fdopen"
		size = "44"
		objfiles = "fdopen@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 6A 03 53 E8 ?? ?? ?? ?? 5A 31 D2 59 83 F8 FF 74 12 53 6A 00 FF 74 24 14 50 E8 ?? ?? ?? ?? 83 C4 10 89 C2 89 D0 5B C3 }
	condition:
		$pattern
}

rule mktemp_447e0995e80c3e770ef56f7ec201fbe2 {
	meta:
		aliases = "mktemp"
		size = "26"
		objfiles = "mktemp@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 6A 03 53 E8 ?? ?? ?? ?? 5A 85 C0 59 79 03 C6 03 00 89 D8 5B C3 }
	condition:
		$pattern
}

rule putenv_862cc7437a0eb7d2829211e06c3fa70d {
	meta:
		aliases = "putenv"
		size = "44"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 6A 3D 53 E8 ?? ?? ?? ?? 5A 85 C0 59 74 0F 89 D8 B9 01 00 00 00 31 D2 5B E9 ?? ?? ?? ?? 89 5C 24 08 5B E9 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule tmpnam_r_89e5a9ac202e5c647a29760c3becef82 {
	meta:
		aliases = "tmpnam_r"
		size = "48"
		objfiles = "tmpnam_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 85 DB 74 21 6A 00 6A 00 6A 14 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 0E 6A 03 53 E8 ?? ?? ?? ?? 5A 85 C0 59 74 02 31 DB 89 D8 5B C3 }
	condition:
		$pattern
}
...
rule re_comp_07ced07581917d76e415fa714b13f13d {
	meta:
		aliases = "re_comp"
		size = "160"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 85 DB 75 14 BA ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 0F 84 81 00 00 00 EB 7D 83 3D ?? ?? ?? ?? 00 75 3C 68 C8 00 00 00 E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? BA ?? ?? ?? ?? 85 C0 74 5D 68 00 01 00 00 C7 05 ?? ?? ?? ?? C8 00 00 00 E8 ?? ?? ?? ?? 59 A3 ?? ?? ?? ?? BA ?? ?? ?? ?? 85 C0 74 3A 80 0D ?? ?? ?? ?? 80 53 E8 ?? ?? ?? ?? 8B 0D ?? ?? ?? ?? 89 C2 89 D8 C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A 85 C0 74 10 0F B7 84 00 ?? ?? ?? ?? 8D 90 ?? ?? ?? ?? EB 02 31 D2 89 D0 5B C3 }
	condition:
		$pattern
}
...
rule __scan_getc_7a01a181ef641e0b0ec876cc3bc20d4c {
	meta:
		aliases = "__scan_getc"
		size = "72"
		objfiles = "__scan_cookie@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 8B 43 10 C7 03 FF FF FF FF 48 89 43 10 85 C0 79 09 80 4B 19 02 83 C8 FF EB 27 80 7B 19 00 75 15 53 FF 53 2C 5A 83 F8 FF 75 06 80 4B 19 02 EB 11 89 43 04 EB 04 C6 43 19 00 FF 43 0C 8B 43 04 89 03 5B C3 }
	condition:
		$pattern
}
...
rule __stdio_trans2r_o_58320088ae82e39594ae151e1dbc34c1 {
	meta:
		aliases = "__stdio_trans2r_o"
		size = "91"
		objfiles = "_trans2r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 8B 4C 24 0C 8B 03 0F B7 D0 85 CA 75 0D 81 E2 80 08 00 00 75 0C 09 C8 66 89 03 0F B7 03 A8 10 74 14 E8 ?? ?? ?? ?? C7 00 09 00 00 00 66 83 0B 08 83 C8 FF EB 1F A8 40 74 15 53 E8 ?? ?? ?? ?? 5A 85 C0 75 E8 66 83 23 BF 8B 43 08 89 43 1C 66 83 0B 01 31 C0 5B C3 }
	condition:
		$pattern
}

rule __stdio_trans2w_o_b3f760ef3c1d871c571733fe42af1b33 {
	meta:
		aliases = "__stdio_trans2w_o"
		size = "153"
		objfiles = "_trans2w@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 8B 4C 24 0C 8B 03 0F B7 D0 85 CA 75 0D 81 E2 80 08 00 00 75 0D 09 C8 66 89 03 0F B7 13 F6 C2 20 74 14 E8 ?? ?? ?? ?? C7 00 09 00 00 00 66 83 0B 08 83 CA FF EB 5A F6 C2 03 74 40 F6 C2 04 75 2B 8B 43 14 3B 43 10 75 05 F6 C2 02 74 1E 81 E2 00 04 00 00 83 FA 01 19 C0 83 C0 02 50 6A 00 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 C2 66 83 23 FC 8B 43 08 89 43 18 89 43 10 89 43 14 8B 03 31 D2 83 C8 40 66 89 03 F6 C4 0B 75 06 8B 43 0C 89 43 1C 89 D0 5B C3 }
	condition:
		$pattern
}

rule sc_getc_a2a80f64fc4bc4dfc5eebb9360580406 {
	meta:
		aliases = "sc_getc"
		size = "96"
		objfiles = "vfwscanf@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 8B 53 08 83 7A 04 FD 75 1B 8B 42 10 3B 42 0C 73 0A 8B 08 83 C0 04 89 42 10 EB 1A 66 83 0A 04 83 C8 FF EB 35 52 E8 ?? ?? ?? ?? 89 C1 5A 83 C8 FF 83 F9 FF 74 24 8B 43 08 C6 43 1A 01 89 4B 28 3B 4B 38 8A 40 02 88 43 18 75 07 B9 2E 00 00 00 EB 06 89 4B 04 89 4B 24 89 C8 5B C3 }
	condition:
		$pattern
}

rule __stdio_rfill_12b71a47359843aa0228116ef5f1ebb2 {
	meta:
		aliases = "__stdio_rfill"
		size = "37"
		objfiles = "_rfill@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 8B 53 08 8B 43 0C 29 D0 50 52 53 E8 ?? ?? ?? ?? 8B 53 08 83 C4 0C 89 53 10 01 C2 89 53 14 5B C3 }
	condition:
		$pattern
}
...
rule pthread_start_thread_event_d4433be906a75bf3e9d413e15b9fd43a {
	meta:
		aliases = "pthread_start_thread_event"
		size = "37"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 E8 ?? ?? ?? ?? 31 D2 89 43 14 8B 43 1C E8 ?? ?? ?? ?? FF 73 1C E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_login_tty_3ae07ae7b421e7b13d1f3c886f36eba8 {
	meta:
...
rule __exit_handler_9eb9279139dd9000f13eb15aa70fe540 {
	meta:
		aliases = "__exit_handler"
		size = "88"
		objfiles = "__exit_handler@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 EB 38 48 A3 ?? ?? ?? ?? C1 E0 04 8D 04 02 8B 10 83 FA 02 74 07 83 FA 03 75 20 EB 11 8B 50 04 85 D2 74 17 FF 70 08 53 FF D2 5A 59 EB 0D 8B 50 04 85 D2 74 06 FF 70 08 FF D2 58 A1 ?? ?? ?? ?? 8B 15 ?? ?? ?? ?? 85 C0 75 B9 89 54 24 08 5B E9 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule jrand48_r_cd005c97c51685bfd3ed5b1a1e13b05d {
	meta:
		aliases = "__GI_jrand48_r, jrand48_r"
		size = "49"
		objfiles = "jrand48_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 FF 74 24 0C 53 E8 ?? ?? ?? ?? 5A 83 CA FF 59 85 C0 78 15 0F B7 43 04 0F B7 53 02 C1 E0 10 09 D0 8B 54 24 10 89 02 31 D2 89 D0 5B C3 }
	condition:
		$pattern
}

rule nrand48_r_aa6d1a36859cd032928d9be8efe29540 {
	meta:
		aliases = "__GI_nrand48_r, nrand48_r"
		size = "55"
		objfiles = "nrand48_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 FF 74 24 0C 53 E8 ?? ?? ?? ?? 5A 83 CA FF 59 85 C0 78 1B 66 8B 43 02 0F B7 53 04 66 D1 E8 C1 E2 0F 0F B7 C0 09 D0 8B 54 24 10 89 02 31 D2 89 D0 5B C3 }
	condition:
		$pattern
}
...
rule __GI___glibc_strerror_r_73db6f5c74b10bf5e054233c4b7799fd {
	meta:
		aliases = "__glibc_strerror_r, __GI___glibc_strerror_r"
		size = "26"
		objfiles = "__glibc_strerror_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 0C FF 74 24 10 53 FF 74 24 10 E8 ?? ?? ?? ?? 89 D8 83 C4 0C 5B C3 }
	condition:
		$pattern
}
...
rule gcvt_b6c4169eed5ca78f3b5b5cf9e85aa8e7 {
	meta:
		aliases = "gcvt"
		size = "46"
		objfiles = "gcvt@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 14 FF 74 24 0C FF 74 24 0C 8B 44 24 18 83 F8 11 7E 05 B8 11 00 00 00 50 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 89 D8 83 C4 14 5B C3 }
	condition:
		$pattern
}
...
rule __libc_system_9454ddab71c34e0bfe242daa37c2129c {
	meta:
		aliases = "system, __libc_system"
		size = "270"
		objfiles = "system@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 01 00 00 00 83 EC 10 83 7C 24 18 00 0F 84 F5 00 00 00 6A 01 6A 03 E8 ?? ?? ?? ?? 89 44 24 08 6A 01 6A 02 E8 ?? ?? ?? ?? 89 44 24 14 6A 00 6A 11 E8 ?? ?? ?? ?? 89 44 24 20 E8 ?? ?? ?? ?? 83 C4 18 89 C3 83 F8 00 7D 28 FF 34 24 6A 03 E8 ?? ?? ?? ?? FF 74 24 0C 6A 02 E8 ?? ?? ?? ?? FF 74 24 18 6A 11 E8 ?? ?? ?? ?? 83 C8 FF E9 94 00 00 00 75 3F 6A 00 6A 03 E8 ?? ?? ?? ?? 6A 00 6A 02 E8 ?? ?? ?? ?? 6A 00 6A 11 E8 ?? ?? ?? ?? 6A 00 FF 74 24 34 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 2C 6A 7F E8 ?? ?? ?? ?? 6A 01 6A 03 E8 ?? ?? ?? ?? 6A 01 6A 02 E8 ?? ?? ?? ?? 8D 44 24 }
	condition:
		$pattern
}
...
rule __GI_fork_31775a774d77c5d341de3c4c936664ec {
	meta:
...
rule __libc_getpid_16cf7f907e57d624e33d5f3b23e48822 {
	meta:
		aliases = "getpid, __GI_getpid, __libc_getpid"
		size = "32"
		objfiles = "getpid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 14 00 00 00 CD 80 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}

rule __libc_pause_323461b138eb282b75c2a9a5bea0c953 {
	meta:
		aliases = "pause, __libc_pause"
		size = "32"
		objfiles = "pause@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 1D 00 00 00 CD 80 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}
...
rule getppid_43da1ba9ad21c29a04d68559ef18d364 {
	meta:
		aliases = "getppid"
		size = "32"
		objfiles = "getppid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 40 00 00 00 CD 80 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}

rule getpgrp_39d9681e7d3f01d06eddcf2d7d86a561 {
	meta:
		aliases = "getpgrp"
		size = "32"
		objfiles = "getpgrp@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 41 00 00 00 CD 80 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}
...
rule getuid_d186bcc64a7a2c3495678d185e73c4d3 {
	meta:
		aliases = "__GI_getuid, getuid"
		size = "32"
		objfiles = "getuid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 C7 00 00 00 CD 80 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}

rule __GI_getgid_9591166b903c51c5a2fad5b6dfb7ac1b {
	meta:
		aliases = "getgid, __GI_getgid"
		size = "32"
		objfiles = "getgid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 C8 00 00 00 CD 80 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}

rule __GI_geteuid_39f79a21f396afb229634c1e9c0d36d3 {
	meta:
		aliases = "geteuid, __GI_geteuid"
		size = "32"
		objfiles = "geteuid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 C9 00 00 00 CD 80 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}

rule __GI_getegid_30304a5e607858cd129ed3d5e4ad4f84 {
	meta:
		aliases = "getegid, __GI_getegid"
		size = "32"
		objfiles = "getegid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 CA 00 00 00 CD 80 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}
...
rule set_input_fragment_e59b3cc9cf93536513d36811b03a93d5 {
	meta:
		aliases = "set_input_fragment"
		size = "63"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B9 04 00 00 00 83 EC 04 89 C3 89 E2 E8 ?? ?? ?? ?? 85 C0 74 24 8B 14 24 0F CA 89 D0 89 14 24 C1 E8 1F 85 D2 89 43 38 74 10 81 E2 FF FF FF 7F B8 01 00 00 00 89 53 34 EB 02 31 C0 5A 5B C3 }
	condition:
		$pattern
}

rule sigpending_bedc77644751ad3c5b05ce4937a8c017 {
	meta:
		aliases = "sigpending"
		size = "45"
		objfiles = "sigpending@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B9 08 00 00 00 8B 54 24 08 87 D3 B8 B0 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}

rule __libc_sigsuspend_c132e4879a3e7c4f009823f03272ce77 {
	meta:
		aliases = "sigsuspend, __GI_sigsuspend, __libc_sigsuspend"
		size = "45"
		objfiles = "sigsuspend@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B9 08 00 00 00 8B 54 24 08 87 D3 B8 B3 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}
...
rule __GI___uClibc_fini_c321cc52eacbcb14e53140df9f326853 {
	meta:
...
rule __pthread_reset_main_thread_fea80138b10baad4aa186f8210b4c03f {
	meta:
		aliases = "__pthread_reset_main_thread"
		size = "128"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) E8 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? FF 89 C3 74 4C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 FF 35 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? FF FF FF FF C7 05 ?? ?? ?? ?? FF FF FF FF 83 C4 0C E8 ?? ?? ?? ?? 89 43 14 89 1D ?? ?? ?? ?? 89 1B 89 5B 04 C7 43 44 ?? ?? ?? ?? C7 43 4C ?? ?? ?? ?? 5B C3 }
	condition:
		$pattern
}
...
rule __GI_getrpcent_fe266ce0b511b56372bda006e04281a3 {
	meta:
		aliases = "getrpcent, __GI_getrpcent"
		size = "52"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) E8 ?? ?? ?? ?? 89 C3 85 C0 74 24 83 38 00 75 17 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 03 85 C0 59 5A 74 08 89 D8 5B E9 ?? ?? ?? ?? 31 C0 5B C3 }
	condition:
		$pattern
}
...
rule _pthread_cleanup_push_defer_4a2ada044da2ae38e2539d7ad0602db7 {
	meta:
		aliases = "__pthread_cleanup_push_defer, _pthread_cleanup_push_defer"
		size = "62"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) E8 ?? ?? ?? ?? 8B 5C 24 08 89 C2 8B 44 24 0C 89 03 8B 44 24 10 89 43 04 0F B6 42 41 89 43 08 8B 42 3C 89 43 0C 85 C0 74 0B 39 C3 72 07 C7 43 0C 00 00 00 00 C6 42 41 00 89 5A 3C 5B C3 }
	condition:
		$pattern
}

rule _pthread_cleanup_push_c11b6dd3026985f20e388def7ca4bb79 {
	meta:
		aliases = "_pthread_cleanup_push"
		size = "51"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) E8 ?? ?? ?? ?? 8B 5C 24 08 89 C2 8B 44 24 0C 89 03 8B 44 24 10 89 43 04 8B 42 3C 89 43 0C 85 C0 74 0B 39 C3 72 07 C7 43 0C 00 00 00 00 89 5A 3C 5B C3 }
	condition:
		$pattern
}

rule __GI_pthread_attr_init_5886231edf1272e26612458362dc3754 {
	meta:
		aliases = "pthread_attr_init, __GI_pthread_attr_init"
		size = "75"
		objfiles = "attr@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) E8 ?? ?? ?? ?? 8B 5C 24 08 BA 00 00 20 00 29 C2 89 43 14 C7 03 00 00 00 00 C7 43 04 00 00 00 00 C7 43 08 00 00 00 00 C7 43 0C 01 00 00 00 C7 43 10 00 00 00 00 C7 43 1C 00 00 00 00 C7 43 18 00 00 00 00 89 53 20 31 C0 5B C3 }
	condition:
		$pattern
}

rule authnone_marshal_b3c7708bea35963a5faeedaaeed8834a {
	meta:
		aliases = "authnone_marshal"
		size = "45"
		objfiles = "auth_none@libc.a"
	strings:
		$pattern = { ( CC | 53 ) E8 ?? ?? ?? ?? 8B 5C 24 0C 31 D2 8B 80 98 00 00 00 85 C0 74 13 8B 53 04 FF 70 3C 83 C0 28 50 53 FF 52 0C 83 C4 0C 89 C2 89 D0 5B C3 }
	condition:
		$pattern
}

rule svcraw_recv_1ec0501eaf147adf8065006cc0642fd6 {
	meta:
		aliases = "svcraw_recv"
		size = "69"
		objfiles = "svc_raw@libc.a"
	strings:
		$pattern = { ( CC | 53 ) E8 ?? ?? ?? ?? 8B 90 BC 00 00 00 31 C0 85 D2 74 31 8D 9A 94 23 00 00 8B 82 98 23 00 00 C7 82 94 23 00 00 01 00 00 00 6A 00 53 FF 50 14 FF 74 24 14 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 95 C0 0F B6 C0 5B C3 }
	condition:
		$pattern
}
...
rule svcraw_create_7945a9c6ad3f0dfe3d007eb7fea8f308 {
	meta:
		aliases = "svcraw_create"
		size = "112"
		objfiles = "svc_raw@libc.a"
	strings:
		$pattern = { ( CC | 53 ) E8 ?? ?? ?? ?? 8B 98 BC 00 00 00 85 DB 75 16 68 3C 25 00 00 6A 01 E8 ?? ?? ?? ?? 5A 31 D2 59 85 C0 74 48 89 C3 8D 83 AC 23 00 00 C7 83 60 22 00 00 00 00 00 00 89 83 84 22 00 00 8D 83 94 23 00 00 66 C7 83 64 22 00 00 00 00 C7 83 68 22 00 00 ?? ?? ?? ?? 6A 02 68 60 22 00 00 53 50 E8 ?? ?? ?? ?? 8D 93 60 22 00 00 83 C4 10 89 D0 5B C3 }
	condition:
		$pattern
}

rule __GI_raise_6275daf246362165415fd98570c5cb9a {
	meta:
...
rule __udiv_w_sdiv_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "_Unwind_GetTextRelBase, _Unwind_FindEnclosingFunction, __gthread_active_p, _Unwind_GetRegionStart, _Unwind_GetDataRelBase, __udiv_w_sdiv"
		size = "7"
		objfiles = "unwind_sjlj@libgcc_eh.a, gthr_gnat@libgcc_eh.a, _udiv_w_sdiv@libgcc.a"
	strings:
...
rule __floatundixf_71671695b25f895c1862ed77f0312592 {
	meta:
...
rule bsearch_79369ae5a33178b3fa822009770b3d95 {
	meta:
		aliases = "bsearch"
		size = "81"
		objfiles = "bsearch@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 31 ED 8B 74 24 1C 83 7C 24 20 00 75 35 EB 37 89 F0 8B 7C 24 18 29 E8 D1 E8 8D 1C 28 8B 44 24 20 0F AF C3 01 C7 57 FF 74 24 18 FF 54 24 2C 5A 83 F8 00 59 7E 05 8D 6B 01 EB 08 75 04 89 F8 EB 08 89 DE 39 F5 72 C9 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_authunix_create_default_7fcb51a040e3b22a1c496361483ce1c6 {
	meta:
		aliases = "authunix_create_default, __GI_authunix_create_default"
		size = "151"
		objfiles = "auth_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 00 01 00 00 31 F6 6A 03 E8 ?? ?? ?? ?? 59 89 C3 85 C0 74 14 8D 04 85 00 00 00 00 50 E8 ?? ?? ?? ?? 5A 89 C6 85 C0 74 37 68 FF 00 00 00 8D 44 24 04 50 E8 ?? ?? ?? ?? 5F 40 5D 74 23 C6 84 24 FF 00 00 00 00 E8 ?? ?? ?? ?? 89 C5 E8 ?? ?? ?? ?? 56 89 C7 53 E8 ?? ?? ?? ?? 5A 85 C0 59 79 05 E8 ?? ?? ?? ?? 56 83 F8 10 7E 05 B8 10 00 00 00 50 57 55 8D 44 24 10 50 E8 ?? ?? ?? ?? 56 89 C3 E8 ?? ?? ?? ?? 81 C4 18 01 00 00 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_clnt_spcreateerror_f28587da0326ac80e19385ce837292cc {
	meta:
		aliases = "clnt_spcreateerror, __GI_clnt_spcreateerror"
		size = "218"
		objfiles = "clnt_perror@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 00 04 00 00 E8 ?? ?? ?? ?? 89 C5 85 C0 0F 84 B4 00 00 00 E8 ?? ?? ?? ?? FF B4 24 14 04 00 00 89 C7 68 ?? ?? ?? ?? 55 E8 ?? ?? ?? ?? FF 37 8D 5C 05 00 E8 ?? ?? ?? ?? 50 53 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 1C 01 C3 8B 07 83 F8 0C 74 35 83 F8 0E 75 6B 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 59 FF 77 04 01 C3 E8 ?? ?? ?? ?? 50 53 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 18 01 C3 EB 3B 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? C7 04 24 00 04 00 00 8D 34 03 8D 5C 24 0C 53 FF 77 08 E8 ?? ?? ?? ?? 53 56 E8 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 20 8D 1C 06 C6 03 }
	condition:
		$pattern
}

rule __GI_svc_getreq_common_d6abfa2820953dc36342816a528f08fe {
	meta:
		aliases = "svc_getreq_common, __GI_svc_getreq_common"
		size = "394"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 00 05 00 00 8D 84 24 90 01 00 00 89 A4 24 CC 04 00 00 89 84 24 D8 04 00 00 E8 ?? ?? ?? ?? 89 C5 8B 90 B4 00 00 00 8B 84 24 14 05 00 00 8B 1C 82 85 DB 0F 84 41 01 00 00 8B 43 08 8D 94 24 B0 04 00 00 52 53 FF 10 5F 85 C0 5A 0F 84 0C 01 00 00 8D 84 24 20 03 00 00 8D 94 24 EC 04 00 00 89 84 24 F8 04 00 00 8B 84 24 BC 04 00 00 89 84 24 E0 04 00 00 8B 84 24 C0 04 00 00 89 84 24 E4 04 00 00 8B 84 24 C4 04 00 00 89 84 24 E8 04 00 00 8D 84 24 C8 04 00 00 89 9C 24 FC 04 00 00 6A 0C 50 52 E8 ?? ?? ?? ?? 83 C4 0C 83 BC 24 C8 04 00 00 00 75 1F 8B 94 24 FC 04 00 00 A1 ?? ?? ?? ?? 89 42 20 }
	condition:
		$pattern
}

rule openpty_ad85d3b7755520a6f23ca1f743e24892 {
	meta:
		aliases = "__GI_openpty, openpty"
		size = "229"
		objfiles = "openpty@libutil.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 00 10 00 00 8B AC 24 20 10 00 00 6A 02 E8 ?? ?? ?? ?? 5F 89 C6 83 C8 FF 83 FE FF 0F 84 B3 00 00 00 56 E8 ?? ?? ?? ?? 5B 85 C0 0F 85 9A 00 00 00 56 E8 ?? ?? ?? ?? 59 85 C0 0F 85 8B 00 00 00 68 00 10 00 00 8D 7C 24 04 57 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 74 68 02 01 00 00 57 E8 ?? ?? ?? ?? 89 C3 58 83 FB FF 5A 74 60 85 ED 74 0C 55 6A 02 53 E8 ?? ?? ?? ?? 83 C4 0C 83 BC 24 24 10 00 00 00 74 15 FF B4 24 24 10 00 00 68 14 54 00 00 53 E8 ?? ?? ?? ?? 83 C4 0C 8B 84 24 14 10 00 00 89 30 8B 84 24 18 10 00 00 89 18 31 C0 83 BC 24 1C 10 00 00 00 74 1D 57 FF B4 24 20 10 00 00 E8 ?? ?? }
	condition:
		$pattern
}

rule __res_querydomain_88be813be5dd0b35334cbbf1491fd064 {
	meta:
		aliases = "__GI___res_querydomain, __res_querydomain"
		size = "229"
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 04 04 00 00 8B 9C 24 18 04 00 00 8B BC 24 1C 04 00 00 8B AC 24 28 04 00 00 85 DB 74 04 85 ED 75 0D E8 ?? ?? ?? ?? C7 00 FF FF FF FF EB 22 85 FF 75 48 53 E8 ?? ?? ?? ?? 89 C2 5E 8D 40 01 3D 01 04 00 00 76 10 E8 ?? ?? ?? ?? C7 00 03 00 00 00 83 C8 FF EB 7F 85 D2 74 5A 8D 72 FF 80 3C 33 2E 75 51 56 53 8D 5C 24 0B 53 E8 ?? ?? ?? ?? C6 44 34 0F 00 89 D8 83 C4 0C EB 3B 53 E8 ?? ?? ?? ?? 89 3C 24 89 C6 E8 ?? ?? ?? ?? 59 8D 44 06 02 3D 01 04 00 00 77 AF 57 53 68 ?? ?? ?? ?? 68 01 04 00 00 8D 5C 24 13 53 E8 ?? ?? ?? ?? 89 D8 83 C4 14 EB 02 89 D8 FF B4 24 2C 04 00 00 55 FF B4 24 2C 04 }
	condition:
		$pattern
}

rule ether_ntohost_317f4517f5eb41051b033ea89730452d {
	meta:
		aliases = "ether_ntohost"
		size = "147"
		objfiles = "ethers@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 08 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 89 C6 5B 83 CB FF 85 C0 74 62 EB 38 89 FA 89 E8 E8 ?? ?? ?? ?? 89 C3 85 C0 74 34 6A 06 57 FF B4 24 28 01 00 00 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 1E 53 31 DB FF B4 24 20 01 00 00 E8 ?? ?? ?? ?? 58 5A EB 21 8D 6C 24 02 8D BC 24 02 01 00 00 56 68 00 01 00 00 55 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 AA 83 CB FF 56 E8 ?? ?? ?? ?? 58 81 C4 08 01 00 00 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule clnt_sperror_a273d2336776ccfcf26c607df7869d5e {
	meta:
		aliases = "__GI_clnt_sperror, clnt_sperror"
		size = "357"
		objfiles = "clnt_perror@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 0C 04 00 00 8B 9C 24 20 04 00 00 E8 ?? ?? ?? ?? 89 C5 31 C0 85 ED 0F 84 38 01 00 00 8D 84 24 00 04 00 00 8B 53 04 50 53 FF 52 08 FF B4 24 2C 04 00 00 68 ?? ?? ?? ?? 55 E8 ?? ?? ?? ?? FF B4 24 14 04 00 00 8D 5C 05 00 E8 ?? ?? ?? ?? 50 53 E8 ?? ?? ?? ?? 83 C4 20 53 E8 ?? ?? ?? ?? 5E 8D 34 03 83 BC 24 00 04 00 00 11 0F 87 BE 00 00 00 8B 84 24 00 04 00 00 FF 24 85 ?? ?? ?? ?? 68 00 04 00 00 8D 5C 24 04 53 FF B4 24 0C 04 00 00 E8 ?? ?? ?? ?? 53 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 18 01 C6 E9 A2 00 00 00 8B 94 24 04 04 00 00 31 C0 EB 19 39 14 C5 ?? ?? ?? ?? 75 0F 8B 3C C5 ?? ?? }
	condition:
		$pattern
}

rule __getgrouplist_internal_bc2f59960a2cad7f72ae302e1151f781 {
	meta:
		aliases = "__getgrouplist_internal"
		size = "260"
		objfiles = "__getgrouplist_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 10 01 00 00 8B 84 24 2C 01 00 00 C7 00 01 00 00 00 6A 20 E8 ?? ?? ?? ?? 5D 31 ED 85 C0 0F 84 CE 00 00 00 89 C5 8B 84 24 28 01 00 00 89 45 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5B 89 C6 5F 85 C0 0F 84 A7 00 00 00 BF 01 00 00 00 C7 40 34 01 00 00 00 EB 61 8B 84 24 28 01 00 00 39 84 24 08 01 00 00 74 51 8B 9C 24 0C 01 00 00 EB 42 FF B4 24 24 01 00 00 50 E8 ?? ?? ?? ?? 5A 85 C0 59 75 2C F7 C7 07 00 00 00 75 16 8D 04 BD 20 00 00 00 50 55 E8 ?? ?? ?? ?? 5A 85 C0 59 74 41 89 C5 8B 84 24 08 01 00 00 89 44 BD 00 47 EB 09 83 C3 04 8B 03 85 C0 75 B8 56 68 00 01 00 00 8D 44 24 }
	condition:
		$pattern
}

rule clnt_broadcast_eb92989b413f600bca050907bccba39c {
	meta:
		aliases = "clnt_broadcast"
		size = "1375"
		objfiles = "pmap_rmt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 10 29 00 00 E8 ?? ?? ?? ?? C7 84 24 08 29 00 00 01 00 00 00 89 44 24 04 6A 11 6A 02 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 89 C5 85 C0 79 0A 68 ?? ?? ?? ?? E9 2B 03 00 00 6A 04 8D 84 24 0C 29 00 00 50 6A 06 6A 01 55 E8 ?? ?? ?? ?? 83 C4 14 85 C0 79 0A 68 ?? ?? ?? ?? E9 06 03 00 00 8D 44 24 1C 89 AC 24 FC 28 00 00 89 84 24 F8 28 00 00 8D 84 24 F4 28 00 00 66 C7 84 24 00 29 00 00 01 00 C7 84 24 F4 28 00 00 60 22 00 00 50 68 12 89 00 00 55 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 18 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 44 24 10 00 00 00 00 58 E9 DC 00 00 00 8B BC 24 F4 28 00 00 8B 9C 24 F8 28 00 00 }
	condition:
		$pattern
}

rule __GI_statvfs_baaf9c470f4da22b2025dc23c9f1ab8e {
	meta:
		aliases = "__GI_fstatvfs, fstatvfs, statvfs, __GI_statvfs"
		size = "644"
		objfiles = "fstatvfs@libc.a, statvfs@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 14 05 00 00 8B B4 24 28 05 00 00 8D 84 24 B8 04 00 00 8B 9C 24 2C 05 00 00 50 56 E8 ?? ?? ?? ?? 5F 83 CA FF 5D 85 C0 0F 88 44 02 00 00 8B 84 24 BC 04 00 00 8D 7B 30 89 03 89 43 04 8B 84 24 C0 04 00 00 89 43 08 8B 84 24 C4 04 00 00 89 43 0C 8B 84 24 C8 04 00 00 89 43 10 8B 84 24 CC 04 00 00 89 43 14 8B 84 24 D0 04 00 00 89 43 18 8B 84 24 D4 04 00 00 C7 43 24 00 00 00 00 89 43 20 8B 84 24 DC 04 00 00 89 43 2C 31 C0 AB AB AB AB AB AB 8B 43 18 C7 43 28 00 00 00 00 89 43 1C 8D 84 24 60 04 00 00 50 56 E8 ?? ?? ?? ?? 5A 31 D2 59 85 C0 0F 88 B9 01 00 00 E8 ?? ?? ?? ?? 89 04 24 8B 00 }
	condition:
		$pattern
}

rule realpath_820e25072a7dfa24e8a5d6431422839d {
	meta:
		aliases = "realpath"
		size = "572"
		objfiles = "realpath@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 1C 10 00 00 8B 9C 24 30 10 00 00 8B BC 24 34 10 00 00 85 DB 75 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 10 80 3B 00 75 12 E8 ?? ?? ?? ?? C7 00 02 00 00 00 31 FF E9 EF 01 00 00 53 E8 ?? ?? ?? ?? 5A 3D FD 0F 00 00 76 0D E8 ?? ?? ?? ?? C7 00 24 00 00 00 EB DE 8D AC 24 1B 10 00 00 53 29 C5 55 E8 ?? ?? ?? ?? 5E 58 89 EB 85 FF C7 44 24 08 00 00 00 00 75 11 68 00 10 00 00 E8 ?? ?? ?? ?? 89 44 24 0C 89 C7 59 8D 87 FE 0F 00 00 89 44 24 04 80 7D 00 2F 74 40 68 FF 0F 00 00 57 E8 ?? ?? ?? ?? 5D 85 C0 5A 0F 84 94 00 00 00 57 E8 ?? ?? ?? ?? 5E 8D 34 07 80 7E FF 2F 74 04 C6 06 2F 46 8D 94 24 }
	condition:
		$pattern
}

rule _dl_load_elf_shared_library_33ea7e9cd08897a7e6b876942f00d152 {
	meta:
		aliases = "_dl_load_elf_shared_library"
		size = "2838"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 28 01 00 00 31 C9 31 D2 8B BC 24 44 01 00 00 53 89 FB B8 05 00 00 00 CD 80 5B 89 44 24 30 3D 00 F0 FF FF 76 09 F7 D8 A3 ?? ?? ?? ?? EB 07 83 7C 24 30 00 79 0F C7 05 ?? ?? ?? ?? 01 00 00 00 E9 AE 0A 00 00 8D 8C 24 E4 00 00 00 8B 54 24 30 87 D3 B8 6C 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 76 09 F7 D8 A3 ?? ?? ?? ?? EB 04 85 C0 79 0C C7 05 ?? ?? ?? ?? 01 00 00 00 EB 14 83 BC 24 3C 01 00 00 00 74 1E F6 84 24 ED 00 00 00 08 75 14 8B 7C 24 30 53 89 FB B8 06 00 00 00 CD 80 5B E9 50 08 00 00 8B 2D ?? ?? ?? ?? EB 42 8B 84 24 E4 00 00 00 83 BD E0 00 00 00 00 75 2F 39 85 DC 00 00 00 75 27 }
	condition:
		$pattern
}

rule __GI_vsyslog_162f69e2648c609b069c571b384adb53 {
	meta:
		aliases = "vsyslog, __GI_vsyslog"
		size = "665"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 28 04 00 00 8B B4 24 3C 04 00 00 F7 C6 00 FC FF FF 0F 85 71 02 00 00 E8 ?? ?? ?? ?? 89 44 24 08 8B 28 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 1C 04 00 00 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F B6 05 ?? ?? ?? ?? 89 F1 83 C4 10 83 E1 07 D3 F8 A8 01 0F 84 1B 02 00 00 83 3D ?? ?? ?? ?? 00 78 09 80 3D ?? ?? ?? ?? 00 75 18 8A 15 ?? ?? ?? ?? B9 08 00 00 00 83 CA 08 31 C0 0F B6 D2 E8 ?? ?? ?? ?? F7 C6 F8 03 00 00 75 0C 0F B6 05 ?? ?? ?? ?? C1 E0 03 09 C6 8D 9C 24 24 04 00 00 53 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C0 04 50 56 68 ?? ?? ?? ?? 8D 5C 24 28 53 E8 ?? ?? ?? ?? 01 }
	condition:
		$pattern
}

rule get_myaddress_29a40e245ee50385fbbcfaff95ef3565 {
	meta:
		aliases = "get_myaddress"
		size = "280"
		objfiles = "get_myaddress@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 28 10 00 00 6A 00 6A 02 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 89 C7 85 C0 79 07 68 ?? ?? ?? ?? EB 31 8D 84 24 20 10 00 00 C7 84 24 20 10 00 00 00 10 00 00 89 A4 24 24 10 00 00 50 68 12 89 00 00 57 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 11 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 E8 ?? ?? ?? ?? 31 ED 8B 9C 24 24 10 00 00 8B B4 24 20 10 00 00 EB 7D 6A 20 53 8D 84 24 08 10 00 00 50 E8 ?? ?? ?? ?? 8D 84 24 0C 10 00 00 50 68 13 89 00 00 57 E8 ?? ?? ?? ?? 83 C4 18 85 C0 79 07 68 ?? ?? ?? ?? EB B1 0F BF 84 24 10 10 00 00 A8 01 74 3A 66 83 7B 10 02 75 33 A8 08 74 05 83 FD 01 75 2A 8D 43 10 6A 10 50 FF }
	condition:
		$pattern
}

rule __get_myaddress_436024e5a41bbbd3b6ffcfd2c35fb9c3 {
	meta:
		aliases = "__get_myaddress"
		size = "286"
		objfiles = "pmap_clnt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 2C 10 00 00 89 04 24 6A 00 6A 02 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 89 C7 85 C0 79 07 68 ?? ?? ?? ?? EB 3A 8D 44 24 04 C7 84 24 24 10 00 00 00 10 00 00 89 84 24 28 10 00 00 8D 84 24 24 10 00 00 50 68 12 89 00 00 57 E8 ?? ?? ?? ?? BD 01 00 00 00 83 C4 0C 85 C0 79 11 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 E8 ?? ?? ?? ?? 8B 9C 24 28 10 00 00 8B B4 24 24 10 00 00 EB 7B 6A 20 53 8D 84 24 0C 10 00 00 50 E8 ?? ?? ?? ?? 8D 84 24 10 10 00 00 50 68 13 89 00 00 57 E8 ?? ?? ?? ?? 83 C4 18 85 C0 79 07 68 ?? ?? ?? ?? EB B3 0F BF 84 24 14 10 00 00 A8 01 74 38 66 83 7B 10 02 75 31 A8 08 75 04 85 ED }
	condition:
		$pattern
}
...
rule statvfs64_92b69c4c2cee0c49d4eaea8f56049790 {
	meta:
		aliases = "fstatvfs64, statvfs64"
		size = "700"
		objfiles = "fstatvfs64@libc.a, statvfs64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 38 05 00 00 8B B4 24 4C 05 00 00 8D 84 24 C8 04 00 00 8B 9C 24 50 05 00 00 50 56 E8 ?? ?? ?? ?? 5F 83 CA FF 5D 85 C0 0F 88 7C 02 00 00 8B 84 24 CC 04 00 00 8D 7B 48 89 03 89 43 04 8B 84 24 D0 04 00 00 8B 94 24 D4 04 00 00 89 53 0C 89 43 08 8B 84 24 D8 04 00 00 8B 94 24 DC 04 00 00 89 53 14 89 43 10 8B 84 24 E0 04 00 00 8B 94 24 E4 04 00 00 89 53 1C 89 43 18 8B 84 24 E8 04 00 00 8B 94 24 EC 04 00 00 89 53 24 89 43 20 8B 84 24 F0 04 00 00 8B 94 24 F4 04 00 00 89 53 2C 89 43 28 8B 84 24 F8 04 00 00 C7 43 3C 00 00 00 00 89 43 38 8B 84 24 00 05 00 00 89 43 44 31 C0 AB AB AB AB AB }
	condition:
		$pattern
}

rule __kernel_rem_pio2_fc194c27ba05162b6565977e9eb82631 {
	meta:
		aliases = "__kernel_rem_pio2"
		size = "1473"
		objfiles = "k_rem_pio2@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 60 02 00 00 8B 8C 24 7C 02 00 00 8B 84 24 84 02 00 00 8B 9C 24 80 02 00 00 89 CE 8D 51 FD 8B 04 85 ?? ?? ?? ?? 89 44 24 14 4B 89 D0 89 5C 24 10 99 BB 18 00 00 00 8B 4C 24 14 F7 FB 89 44 24 1C 03 4C 24 10 F7 D0 C1 F8 1F 31 D2 21 44 24 1C 8B 44 24 1C 40 6B C0 18 29 C6 8B 44 24 1C 2B 44 24 10 EB 1B 85 C0 79 04 D9 EE EB 0A 8B 9C 24 88 02 00 00 DB 04 83 DD 9C D4 70 01 00 00 40 42 39 CA 7E E1 31 C9 EB 23 89 D8 8B BC 24 74 02 00 00 29 D0 DD 04 D7 DC 8C C4 70 01 00 00 42 DE C1 3B 54 24 10 7E E2 DD 5C CC 30 41 3B 4C 24 14 7F 0D 8B 6C 24 10 31 D2 D9 EE 8D 1C 29 EB E2 C7 44 24 0C 18 00 }
	condition:
		$pattern
}

rule _vfprintf_internal_66584151b993654425c60d4f4c5cf3e9 {
	meta:
		aliases = "_vfprintf_internal"
		size = "1508"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 68 01 00 00 8B 9C 24 80 01 00 00 53 8D 74 24 10 56 E8 ?? ?? ?? ?? 5F 85 C0 5D 79 38 8B 5C 24 0C 53 E8 ?? ?? ?? ?? 5E 85 C0 C7 04 24 FF FF FF FF 0F 84 9A 05 00 00 FF B4 24 7C 01 00 00 50 53 E8 ?? ?? ?? ?? C7 44 24 0C FF FF FF FF 83 C4 0C E9 7C 05 00 00 FF B4 24 84 01 00 00 56 E8 ?? ?? ?? ?? C7 44 24 08 00 00 00 00 89 DA 58 59 EB 01 43 8A 03 84 C0 74 04 3C 25 75 F5 39 D3 74 26 89 DE 31 C0 29 D6 85 F6 7E 11 FF B4 24 7C 01 00 00 56 52 E8 ?? ?? ?? ?? 83 C4 0C 39 F0 0F 85 28 05 00 00 01 04 24 80 3B 00 0F 84 23 05 00 00 8D 53 01 80 7B 01 25 0F 84 07 05 00 00 8D 44 24 0C 89 54 24 0C }
	condition:
		$pattern
}

rule universal_fc1d745322bf8214176b0c8f11823dd7 {
	meta:
		aliases = "universal"
		size = "313"
		objfiles = "svc_simple@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 68 22 00 00 8B 84 24 7C 22 00 00 8B B4 24 80 22 00 00 C7 84 24 64 22 00 00 00 00 00 00 8B 68 08 85 ED 75 2B 6A 00 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 0F 85 EC 00 00 00 6A 04 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? E9 84 00 00 00 8B 38 E8 ?? ?? ?? ?? 8B 98 C0 00 00 00 E9 8C 00 00 00 39 7B 04 0F 85 80 00 00 00 39 6B 08 75 7B 8D 6C 24 04 31 C0 B9 98 08 00 00 89 EF F3 AB 8B 46 08 55 FF 73 0C 56 FF 50 08 83 C4 0C 85 C0 75 0C 56 E8 ?? ?? ?? ?? 5B E9 8C 00 00 00 55 FF 13 59 85 C0 75 09 81 7B 10 ?? ?? ?? ?? 75 7B 50 FF 73 10 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 1C FF 73 04 68 }
	condition:
		$pattern
}

rule byte_regex_compile_fb3bb1d6f2a1725e3184b3fc55d39637 {
	meta:
		aliases = "byte_regex_compile"
		size = "8192"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 78 01 00 00 01 C2 8B BC 24 8C 01 00 00 89 44 24 1C 89 4C 24 18 89 84 24 74 01 00 00 89 54 24 28 8B 47 14 89 44 24 2C 68 80 02 00 00 E8 ?? ?? ?? ?? 89 44 24 68 85 C0 5D 0F 84 9C 1F 00 00 8B 54 24 18 C7 47 08 00 00 00 00 80 67 1C 97 89 57 0C C7 47 18 00 00 00 00 83 3D ?? ?? ?? ?? 00 75 45 68 00 01 00 00 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 D2 83 C4 0C EB 14 A1 ?? ?? ?? ?? F6 44 50 01 08 74 07 C6 82 ?? ?? ?? ?? 01 42 81 FA FF 00 00 00 7E E4 C6 05 ?? ?? ?? ?? 01 C7 05 ?? ?? ?? ?? 01 00 00 00 83 7F 04 00 75 3D 8B 07 85 C0 74 0E 6A 20 50 E8 ?? ?? ?? ?? 89 07 5B 5E EB 0A 6A 20 E8 }
	condition:
		$pattern
}

rule _vfwprintf_internal_5deafa4aad89cda9fefca9e9000c32e6 {
	meta:
		aliases = "_vfwprintf_internal"
		size = "1830"
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 7C 02 00 00 31 C0 B9 2F 00 00 00 8B B4 24 94 02 00 00 8D BC 24 10 01 00 00 F3 AB 8D 84 24 70 02 00 00 FF 8C 24 28 01 00 00 89 B4 24 10 01 00 00 C7 84 24 20 01 00 00 80 00 00 00 C7 84 24 70 02 00 00 00 00 00 00 89 B4 24 78 02 00 00 50 6A FF 8D 84 24 80 02 00 00 50 6A 00 E8 ?? ?? ?? ?? 83 C4 10 40 75 0D C7 84 24 10 01 00 00 ?? ?? ?? ?? EB 7B BA 09 00 00 00 8D 84 24 38 01 00 00 C7 00 08 00 00 00 83 C0 04 4A 75 F4 89 F0 8D 9C 24 10 01 00 00 EB 2B 83 FA 25 75 23 83 C0 04 83 38 25 74 1B 89 84 24 10 01 00 00 53 E8 ?? ?? ?? ?? 59 85 C0 78 39 8B 84 24 10 01 00 00 EB 03 83 C0 04 8B 10 }
	condition:
		$pattern
}

rule __GI_rexec_af_e09e10e7cb1b9f0fc3a9a2244e5984a7 {
	meta:
		aliases = "rexec_af, __GI_rexec_af"
		size = "1058"
		objfiles = "rexec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 80 01 00 00 8B 94 24 9C 01 00 00 8B BC 24 A0 01 00 00 8B 84 24 98 01 00 00 89 14 24 66 C1 C8 08 0F B7 C0 89 7C 24 04 0F B7 9C 24 AC 01 00 00 50 68 ?? ?? ?? ?? 8D B4 24 38 01 00 00 56 E8 ?? ?? ?? ?? 8D 94 24 5C 01 00 00 31 C0 B9 08 00 00 00 89 D7 F3 AB 8D 84 24 84 01 00 00 89 9C 24 60 01 00 00 C7 84 24 64 01 00 00 01 00 00 00 C7 84 24 5C 01 00 00 02 00 00 00 50 52 56 83 CF FF 8B 84 24 AC 01 00 00 FF 30 E8 ?? ?? ?? ?? 83 C4 1C 85 C0 0F 85 78 03 00 00 8B 84 24 78 01 00 00 8B 40 18 85 C0 74 4D 68 01 04 00 00 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 94 24 A0 01 00 00 8D 84 24 AC 01 00 }
	condition:
		$pattern
}

rule rendezvous_request_0d96b8141ea7486312940b270e16bfd0 {
	meta:
		aliases = "rendezvous_request"
		size = "136"
		objfiles = "svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 84 00 00 00 8B 9C 24 98 00 00 00 8D BC 24 80 00 00 00 8B 6B 2C C7 84 24 80 00 00 00 6E 00 00 00 57 8D 44 24 06 50 FF 33 E8 ?? ?? ?? ?? 83 C4 0C 89 C6 85 C0 79 0C E8 ?? ?? ?? ?? 83 38 04 75 35 EB D3 8D 5C 24 70 31 C0 89 DF AB AB AB AB 66 C7 44 24 70 01 00 89 F0 8B 4D 04 8B 55 00 E8 ?? ?? ?? ?? 89 DE 8D 78 10 A5 A5 A5 A5 8B 94 24 80 00 00 00 89 50 0C 81 C4 84 00 00 00 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_getnameinfo_126b7f83dd0f7847d9253dc4a79e5b2a {
	meta:
		aliases = "getnameinfo, __GI_getnameinfo"
		size = "843"
		objfiles = "getnameinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 94 02 00 00 E8 ?? ?? ?? ?? 89 04 24 8B AC 24 A8 02 00 00 8B 00 8B 9C 24 AC 02 00 00 89 44 24 08 83 C8 FF F7 84 24 C0 02 00 00 E0 FF FF FF 0F 85 06 03 00 00 85 ED 0F 84 F9 02 00 00 83 FB 01 0F 86 F0 02 00 00 66 8B 45 00 66 83 F8 01 74 1E 66 83 F8 02 75 05 83 FB 0F EB 0D 66 83 F8 0A 0F 85 D1 02 00 00 83 FB 1B 0F 86 C8 02 00 00 83 BC 24 B0 02 00 00 00 0F 95 44 24 05 83 BC 24 B4 02 00 00 00 0F 95 44 24 06 80 7C 24 05 00 0F 84 A8 01 00 00 80 7C 24 06 00 0F 84 9D 01 00 00 66 83 F8 02 74 13 66 83 F8 0A 74 0D 66 48 0F 85 89 01 00 00 E9 25 01 00 00 F6 84 24 C0 02 00 00 01 0F 85 B9 00 }
	condition:
		$pattern
}

rule _time_tzset_8f50505846441ae36b886b6d87d690ce {
	meta:
		aliases = "_time_tzset"
		size = "945"
		objfiles = "tzset@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 98 00 00 00 C7 84 24 94 00 00 00 00 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 8C 00 00 00 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 14 89 C6 85 C0 75 4A 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C7 58 85 FF 5A 78 32 6A 44 8D 5C 24 14 53 57 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 15 8D 04 03 39 D8 76 0E 80 78 FF 0A 75 08 89 DE C6 40 FF 00 EB 02 31 F6 57 E8 ?? ?? ?? ?? 5D 85 F6 74 06 8A 06 84 C0 75 2B C6 05 ?? ?? ?? ?? 00 31 C0 B9 0C 00 00 00 BF ?? ?? ?? ?? F3 AB 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5E 5F E9 A4 02 00 00 3C 3A 68 ?? }
	condition:
		$pattern
}

rule __open_nameservers_5b0060c1e7fafd290fa0984ee9b84b45 {
	meta:
		aliases = "__open_nameservers"
		size = "867"
		objfiles = "opennameservers@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC A4 01 00 00 83 3D ?? ?? ?? ?? 00 75 33 8D 44 24 08 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5F 85 C0 5D 74 08 C7 44 24 48 00 00 00 00 8B 44 24 48 39 05 ?? ?? ?? ?? 74 0A A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 0F 85 FA 02 00 00 68 ?? ?? ?? ?? C6 05 ?? ?? ?? ?? 05 68 ?? ?? ?? ?? C6 05 ?? ?? ?? ?? 03 E8 ?? ?? ?? ?? 89 44 24 0C 85 C0 5B 5E 0F 85 F7 01 00 00 E9 27 02 00 00 8D 84 24 08 01 00 00 E8 ?? ?? ?? ?? 89 C6 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 89 C5 56 E8 ?? ?? ?? ?? 5A 89 C3 59 85 C0 0F 85 B8 00 00 00 89 E8 E8 ?? ?? ?? ?? B9 07 00 00 00 C6 00 00 89 D8 8B 3C 24 }
	condition:
		$pattern
}

rule parse_printf_format_937f44d2b0abb508142e418e8ec726ea {
	meta:
		aliases = "parse_printf_format"
		size = "226"
		objfiles = "parse_printf_format@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC BC 00 00 00 31 ED 8B BC 24 D0 00 00 00 8B B4 24 D4 00 00 00 8B 9C 24 D8 00 00 00 57 8D 44 24 04 50 E8 ?? ?? ?? ?? 5A 85 C0 59 0F 88 9F 00 00 00 8B 44 24 18 85 C0 0F 8E 8D 00 00 00 89 C5 89 F2 39 C6 76 02 89 C2 31 C9 EB 0A 8B 44 8C 28 41 89 03 83 C3 04 39 D1 72 F2 EB 75 3C 25 75 6A 47 80 3F 25 74 64 8D 04 24 89 3C 24 50 E8 ?? ?? ?? ?? 8B 7C 24 04 58 81 7C 24 08 00 00 00 80 75 0F 45 85 F6 74 0A C7 03 00 00 00 00 4E 83 C3 04 81 7C 24 04 00 00 00 80 75 0F 45 85 F6 74 0A C7 03 00 00 00 00 4E 83 C3 04 31 D2 EB 15 8B 44 94 28 83 F8 08 74 0B 45 85 F6 74 06 89 03 4E 83 C3 04 42 3B 54 }
	condition:
		$pattern
}

rule _fpmaxtostr_03ec458ea7ff32d5968978775c495328 {
	meta:
		aliases = "_fpmaxtostr"
		size = "1464"
		objfiles = "_fpmaxtostr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC BC 00 00 00 8B 84 24 E0 00 00 00 8B 94 24 E0 00 00 00 DB AC 24 D4 00 00 00 8B 40 04 89 44 24 08 8A 4A 08 8B 2A 88 C8 88 4C 24 12 83 C8 20 C6 84 24 A6 00 00 00 65 3C 61 75 07 83 C1 06 88 4C 24 12 85 ED 79 05 BD 06 00 00 00 8B 94 24 E0 00 00 00 C6 84 24 B6 00 00 00 00 8B 42 0C A8 02 74 0A C6 84 24 B6 00 00 00 2B EB 0C A8 01 74 08 C6 84 24 B6 00 00 00 20 DD E0 DF E0 C6 84 24 B7 00 00 00 00 C7 44 24 3C 00 00 00 00 9E 7A 02 74 0C DD D8 C7 44 24 3C 08 00 00 00 EB 61 D9 EE D9 C9 DD E1 DF E0 9E 75 2A 7A 28 D9 E8 D8 F1 D9 CA C7 44 24 04 FF FF FF FF DD EA DF E0 DD D9 9E 0F 86 08 01 00 }
	condition:
		$pattern
}

rule __GI_authunix_create_52f72e26efcac1d2645eec009f6d1fd8 {
	meta:
		aliases = "authunix_create, __GI_authunix_create"
		size = "358"
		objfiles = "auth_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC C8 01 00 00 6A 28 E8 ?? ?? ?? ?? 68 B0 01 00 00 89 C7 E8 ?? ?? ?? ?? 5B 89 C6 5D 85 FF 74 04 85 C0 75 26 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 31 FF 83 C4 10 E9 0A 01 00 00 C7 47 20 ?? ?? ?? ?? 89 47 24 8D 58 0C 6A 0C 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 8D 47 0C 6A 0C 53 50 E8 ?? ?? ?? ?? 6A 00 C7 46 18 00 00 00 00 8D 84 24 DC 01 00 00 50 E8 ?? ?? ?? ?? 8B 84 24 E0 01 00 00 89 84 24 C8 01 00 00 8B 84 24 FC 01 00 00 89 84 24 CC 01 00 00 8B 84 24 00 02 00 00 89 84 24 D0 01 00 00 8B 84 24 04 02 00 00 89 84 24 D4 01 00 00 8B 84 24 08 02 }
	condition:
		$pattern
}

rule __psfs_do_numeric_274df506fd6a53136726ff4ff15f73a3 {
	meta:
		aliases = "__psfs_do_numeric"
		size = "1052"
		objfiles = "__psfs_do_numeric@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC CC 00 00 00 8B 84 24 E0 00 00 00 8B BC 24 E4 00 00 00 8B 40 3C 89 44 24 08 0F B6 A8 ?? ?? ?? ?? 48 75 5E BB ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 5A 85 C0 78 07 0F B6 03 3B 07 74 14 57 E8 ?? ?? ?? ?? 58 81 FB ?? ?? ?? ?? 76 38 E9 B4 03 00 00 43 80 3B 00 75 D4 8B 94 24 E0 00 00 00 80 7A 44 00 0F 84 A4 03 00 00 FF 42 34 6A 00 6A 00 FF 72 38 FF 72 2C E8 ?? ?? ?? ?? 31 C0 83 C4 10 E9 8A 03 00 00 57 E8 ?? ?? ?? ?? 8B 17 83 C8 FF 5E 85 D2 0F 88 76 03 00 00 83 FA 2B 74 09 8D 74 24 21 83 FA 2D 75 0F 88 54 24 21 57 8D 74 24 26 E8 ?? ?? ?? ?? 5B F7 C5 EF 00 00 00 75 59 83 3F 30 75 49 57 E8 ?? }
	condition:
		$pattern
}

rule __dns_lookup_1ce155504a66ea2b668a5f4f511ad0db {
	meta:
		aliases = "__dns_lookup"
		size = "1814"
		objfiles = "dnslookup@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC D0 01 00 00 8B 9C 24 E4 01 00 00 68 00 02 00 00 E8 ?? ?? ?? ?? 53 89 C5 E8 ?? ?? ?? ?? 89 44 24 14 3D 7E 03 00 00 59 5E 76 15 C7 44 24 1C FF FF FF FF C7 44 24 2C 00 00 00 00 E9 8D 06 00 00 8B 44 24 0C 05 82 00 00 00 50 E8 ?? ?? ?? ?? 85 ED 89 44 24 30 5A 0F 84 69 06 00 00 85 C0 0F 84 61 06 00 00 80 3B 00 0F 84 58 06 00 00 8B 44 24 0C 8A 44 18 FF 88 44 24 13 FF 74 24 0C 53 FF 74 24 34 E8 ?? ?? ?? ?? C7 44 24 28 FF FF FF FF C7 44 24 34 00 00 00 00 C7 44 24 3C FF FF FF FF C7 44 24 40 FF FF FF FF 83 C4 0C 8B 54 24 2C 8B 4C 24 0C 8D 54 0A 01 89 54 24 08 83 7C 24 1C FF 74 0A FF 74 }
	condition:
		$pattern
}

rule __GI_ttyname_r_2e0e59bd3c912bc990240b0bec97c9db {
	meta:
		aliases = "ttyname_r, __GI_ttyname_r"
		size = "353"
		objfiles = "ttyname@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC D4 00 00 00 8B 9C 24 E8 00 00 00 8D 44 24 5C 50 53 E8 ?? ?? ?? ?? 5E 85 C0 5F 79 0C E8 ?? ?? ?? ?? 8B 18 E9 26 01 00 00 53 E8 ?? ?? ?? ?? 59 BA ?? ?? ?? ?? 85 C0 0F 85 FC 00 00 00 E9 01 01 00 00 8D 7A 01 BD 1E 00 00 00 57 0F B6 D8 8D 84 24 B8 00 00 00 29 DD 50 E8 ?? ?? ?? ?? 8D 84 24 BC 00 00 00 01 D8 89 44 24 08 57 E8 ?? ?? ?? ?? 83 C4 0C 89 C6 85 C0 0F 85 9E 00 00 00 E9 AF 00 00 00 8D 58 0B 53 E8 ?? ?? ?? ?? 5A 39 E8 0F 87 87 00 00 00 53 FF 74 24 04 E8 ?? ?? ?? ?? 8D 44 24 0C 50 8D 84 24 C0 00 00 00 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 64 8B 44 24 14 25 00 F0 00 00 3D 00 20 }
	condition:
		$pattern
}

rule pow_4b970c35a87a6923c4502eb55c44f16b {
	meta:
		aliases = "__GI_pow, __ieee754_pow, pow"
		size = "1896"
		objfiles = "e_pow@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC D4 00 00 00 DD 84 24 E8 00 00 00 DD 5C 24 18 DD 84 24 F0 00 00 00 DD 5C 24 10 DD 44 24 18 DD 9C 24 98 00 00 00 DD 44 24 10 8B 84 24 98 00 00 00 8B AC 24 9C 00 00 00 DD 9C 24 90 00 00 00 89 84 24 B8 00 00 00 8B 84 24 94 00 00 00 89 C3 8B 94 24 90 00 00 00 81 E3 FF FF FF 7F 89 84 24 A0 00 00 00 89 D9 89 C7 09 D1 75 07 D9 E8 E9 DA 06 00 00 89 EE 8B 84 24 9C 00 00 00 81 E6 FF FF FF 7F 89 84 24 B4 00 00 00 81 FE 00 00 F0 7F 7F 22 0F 94 84 24 A7 00 00 00 75 0A 83 BC 24 B8 00 00 00 00 75 0E 81 FB 00 00 F0 7F 7F 06 75 11 85 D2 74 0D DD 44 24 10 DC 44 24 18 E9 8D 06 00 00 83 BC 24 B4 }
	condition:
		$pattern
}

rule __md5_crypt_60a52fc0fe7ac59b22b14c53853b3c1b {
	meta:
		aliases = "__md5_crypt"
		size = "695"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC D8 00 00 00 8B 9C 24 F0 00 00 00 6A 03 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 89 5C 24 08 75 07 83 C3 03 89 5C 24 08 8B 44 24 08 89 C1 83 C1 08 EB 01 40 8A 10 84 D2 74 09 80 FA 24 74 04 39 C8 72 F0 2B 44 24 08 8D 5C 24 6C 89 44 24 0C 89 D8 E8 ?? ?? ?? ?? FF B4 24 EC 00 00 00 E8 ?? ?? ?? ?? 5A 89 C5 89 C1 8B 94 24 EC 00 00 00 89 D8 E8 ?? ?? ?? ?? B9 03 00 00 00 BA ?? ?? ?? ?? 89 D8 8D 74 24 14 E8 ?? ?? ?? ?? 8B 4C 24 0C 8B 54 24 08 89 D8 8D BC 24 C7 00 00 00 E8 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 89 F0 89 E9 8B 94 24 EC 00 00 00 E8 ?? ?? ?? ?? 89 F0 8B 4C 24 0C 8B 54 24 }
	condition:
		$pattern
}

rule vfscanf_8fb4fce1c51884ff7d0785348b9c4dcb {
	meta:
		aliases = "__GI_vfscanf, vfscanf"
		size = "1578"
		objfiles = "vfscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC E8 01 00 00 31 C0 B9 09 00 00 00 C7 84 24 2C 01 00 00 FF FF FF FF 8D BC 24 08 01 00 00 F3 AB 8B 84 24 FC 01 00 00 8B 40 34 89 44 24 04 85 C0 75 26 8B 9C 24 FC 01 00 00 83 C3 38 53 68 ?? ?? ?? ?? 8D 84 24 DC 01 00 00 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 FF B4 24 FC 01 00 00 8D 9C 24 98 01 00 00 53 E8 ?? ?? ?? ?? 8B 84 24 A4 01 00 00 C7 84 24 C8 01 00 00 ?? ?? ?? ?? 8B BC 24 08 02 00 00 8A 40 03 C7 84 24 44 01 00 00 00 00 00 00 88 84 24 B4 01 00 00 8B 84 24 CC 01 00 00 89 84 24 D8 01 00 00 C6 44 24 0B 01 5D 89 DD 58 E9 D0 04 00 00 80 A4 24 AD 01 00 00 01 C6 84 24 4C 01 }
	condition:
		$pattern
}

rule __GI_vfwscanf_152951920c1dd215127046ee27a1c097 {
	meta:
		aliases = "vfwscanf, __GI_vfwscanf"
		size = "1654"
		objfiles = "vfwscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC FC 00 00 00 31 C0 B9 09 00 00 00 C7 44 24 38 FF FF FF FF 8D 7C 24 14 F3 AB 8B 84 24 10 01 00 00 8B 40 34 89 44 24 0C 85 C0 75 26 8B 9C 24 10 01 00 00 83 C3 38 53 68 ?? ?? ?? ?? 8D 84 24 E8 00 00 00 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 FF B4 24 10 01 00 00 8D 9C 24 A4 00 00 00 53 E8 ?? ?? ?? ?? 8B 84 24 B0 00 00 00 C7 84 24 D4 00 00 00 ?? ?? ?? ?? 8B BC 24 1C 01 00 00 8A 40 03 C7 84 24 E4 00 00 00 ?? ?? ?? ?? 88 84 24 C0 00 00 00 C7 44 24 50 00 00 00 00 C6 44 24 13 01 58 5A E9 08 05 00 00 80 A4 24 B9 00 00 00 01 C6 44 24 58 01 C6 44 24 59 00 C7 44 24 54 FF FF FF 7F C7 }
	condition:
		$pattern
}
...
rule __psfs_parse_spec_5aa317fc682a489461f438e4d8d29b63 {
	meta:
		aliases = "__psfs_parse_spec"
		size = "440"
		objfiles = "__psfs_parse_spec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 31 ED BF 01 00 00 00 8B 74 24 18 8B 46 30 89 04 24 8A 00 83 E8 30 3C 09 77 4B 81 FD CB CC CC 0C 7F 11 6B D5 0A 8B 46 30 0F B6 08 40 8D 6C 11 D0 89 46 30 8B 5E 30 8A 0B 8D 41 D0 3C 09 76 DB 80 F9 24 74 19 83 7E 24 00 0F 89 4F 01 00 00 89 6E 40 C7 46 24 FE FF FF FF E9 99 00 00 00 8D 43 01 31 FF 89 46 30 BB ?? ?? ?? ?? BA 10 00 00 00 8B 4E 30 8A 03 3A 01 75 0B 08 56 45 8D 41 01 89 46 30 EB E2 43 80 3B 00 74 04 01 D2 EB E2 F6 46 45 10 74 08 C6 46 44 00 31 D2 EB 4F 89 F8 84 C0 74 13 83 7E 24 00 0F 89 F2 00 00 00 C7 46 24 FE FF FF FF EB E3 83 7E 24 FE 0F 84 DF 00 00 00 8D 45 FF }
	condition:
		$pattern
}

rule svc_getreqset_01cf66ef3f4dc920c54a791c7dae1854 {
	meta:
		aliases = "__GI_svc_getreqset, svc_getreqset"
		size = "79"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 31 ED E8 ?? ?? ?? ?? 8B 7C 24 18 89 04 24 EB 2D 8B 37 EB 18 8D 58 FF 8D 04 2B 50 E8 ?? ?? ?? ?? B8 01 00 00 00 88 D9 D3 E0 31 C6 58 56 E8 ?? ?? ?? ?? 5B 85 C0 75 DD 83 C7 04 83 C5 20 3B 2C 24 7C CE 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __parsepwent_b3a3cc5bc3a42fd77b3e7fb6ec348e96 {
	meta:
		aliases = "__parsepwent"
		size = "112"
		objfiles = "__parsepwent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 31 F6 89 E5 8B 5C 24 1C 0F B6 86 ?? ?? ?? ?? 8B 7C 24 18 01 C7 89 F0 83 E0 06 83 F8 02 74 17 89 1F 83 FE 06 74 36 6A 3A 53 E8 ?? ?? ?? ?? 59 85 C0 5B 75 1F EB 2A 6A 0A 55 53 E8 ?? ?? ?? ?? 89 C2 8B 44 24 0C 83 C4 0C 39 D8 74 14 80 38 3A 75 0F 89 17 8D 58 01 46 C6 00 00 EB AC 31 C0 EB 03 83 C8 FF 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __parsespent_9e10b182eb599bcec379bb7292f0d228 {
	meta:
		aliases = "__parsespent"
		size = "120"
		objfiles = "__parsespent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 31 FF 89 E5 8B 74 24 1C 0F B6 87 ?? ?? ?? ?? 8B 5C 24 18 01 C3 83 FF 01 7F 12 89 33 6A 3A 56 E8 ?? ?? ?? ?? 59 85 C0 5B 75 31 EB 38 6A 0A 55 56 E8 ?? ?? ?? ?? 83 C4 0C 89 03 39 34 24 75 06 C7 03 FF FF FF FF 8B 04 24 83 FF 08 75 09 31 D2 80 38 00 74 15 EB 0E 80 38 3A 75 09 8D 70 01 47 C6 00 00 EB A4 BA 16 00 00 00 89 D0 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fork_cc5aa7c236f6e6c474a3f76fc27fe09a {
	meta:
		aliases = "__fork, fork"
		size = "218"
		objfiles = "ptfork@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 8B 2D ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5E 89 C7 58 85 FF 75 6D BE ?? ?? ?? ?? 85 F6 74 4C 89 E3 53 E8 ?? ?? ?? ?? 6A 01 53 E8 ?? ?? ?? ?? 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 18 85 F6 74 24 89 E3 53 E8 ?? ?? ?? ?? 6A 00 53 E8 ?? ?? ?? ?? 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 18 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 E8 E8 ?? ?? ?? ?? EB 22 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? }
	condition:
		$pattern
}

rule error_at_line_d34b5e0acdb870197223348214e35e7d {
	meta:
		aliases = "__error_at_line, error_at_line"
		size = "284"
		objfiles = "error@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 83 3D ?? ?? ?? ?? 00 8B 6C 24 18 8B 7C 24 1C 8B 5C 24 20 8B 74 24 24 74 32 39 35 ?? ?? ?? ?? 75 1E A1 ?? ?? ?? ?? 39 C3 0F 84 E1 00 00 00 53 50 E8 ?? ?? ?? ?? 59 85 C0 5A 0F 84 D0 00 00 00 89 1D ?? ?? ?? ?? 89 35 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 5A 85 C0 74 04 FF D0 EB 19 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 85 DB 74 15 56 53 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8D 44 24 2C 89 04 24 50 FF 74 24 2C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? FF 05 ?? ?? ?? ?? 83 C4 0C 85 FF 74 1A 57 E8 ?? ?? ?? ?? 50 }
	condition:
		$pattern
}

rule getoffset_0932c616c924c9f287bc7bf0677a4ddd {
	meta:
		aliases = "getoffset"
		size = "108"
		objfiles = "tzset@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 C1 BD ?? ?? ?? ?? 31 FF 89 14 24 83 CE FF 8A 11 45 8D 42 D0 3C 09 77 07 0F B6 C2 41 8D 70 D0 8A 19 8D 43 D0 3C 09 77 0B 6B D6 0A 0F B6 C3 41 8D 74 02 D0 8A 55 00 0F B6 C2 39 C6 72 04 31 C9 EB 1B 0F AF C7 8D 3C 06 31 F6 80 39 3A 75 04 41 83 CE FF 80 FA 01 77 B7 8B 04 24 89 38 89 C8 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule byte_group_match_null_string_p_4c5fd7784e7fc33ff63b7f157ccf0c76 {
	meta:
		aliases = "byte_group_match_null_string_p"
		size = "240"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 C5 8B 00 89 D7 83 C0 02 89 CE 89 04 24 E9 C3 00 00 00 8A 02 3C 07 0F 84 9D 00 00 00 3C 0F 0F 85 A2 00 00 00 8D 42 01 89 04 24 0F BE 40 01 0F B6 4A 01 C1 E0 08 83 C2 03 89 C3 89 14 24 01 CB 79 4A E9 8F 00 00 00 8D 54 18 FD 89 F1 E8 ?? ?? ?? ?? 84 C0 0F 84 87 00 00 00 89 D9 03 0C 24 89 0C 24 80 39 0F 75 2F 8D 41 01 89 04 24 0F BE 40 01 0F B6 51 01 C1 E0 08 8D 1C 10 8D 41 03 89 04 24 80 3C 19 0E 74 05 89 0C 24 EB 0A 8B 04 24 80 7C 18 FD 0E 74 B1 8B 04 24 0F BE 50 FF 0F B6 48 FE C1 E2 08 8D 1C 0A 89 F1 8D 14 18 E8 ?? ?? ?? ?? 84 C0 74 2C 01 1C 24 EB 1C 8D 42 02 89 45 00 B8 }
	condition:
		$pattern
}

rule _charpad_ae64ddcd01d89aa1087f89a39216fe20 {
	meta:
		aliases = "_charpad"
		size = "50"
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 C7 89 CE 89 CB 89 E5 89 14 24 EB 01 4B 85 DB 74 0F 57 6A 01 55 E8 ?? ?? ?? ?? 83 C4 0C 48 74 EC 29 DE 5A 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _charpad_0f590e8d0e45a148859c8fe7f458b3c1 {
	meta:
		aliases = "_charpad"
		size = "53"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 C7 89 CE 89 CB 8D 6C 24 03 88 54 24 03 EB 01 4B 85 DB 74 0F 57 6A 01 55 E8 ?? ?? ?? ?? 83 C4 0C 48 74 EC 29 DE 5A 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __fake_pread_write_3c5696df3aecb231fa8b061a49e94ed0 {
	meta:
		aliases = "__fake_pread_write"
		size = "128"
		objfiles = "pread_write@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 C7 89 D6 89 CB 6A 01 6A 00 50 E8 ?? ?? ?? ?? 89 44 24 0C 83 C4 0C 40 74 54 6A 00 FF 74 24 1C 57 E8 ?? ?? ?? ?? 83 C4 0C 40 74 42 83 7C 24 1C 01 75 0A 53 56 57 E8 ?? ?? ?? ?? EB 08 53 56 57 E8 ?? ?? ?? ?? 83 C4 0C 89 C6 E8 ?? ?? ?? ?? 89 C3 8B 28 6A 00 FF 74 24 04 57 E8 ?? ?? ?? ?? 83 C4 0C 40 75 05 83 FE FF 75 04 89 2B EB 03 83 CE FF 89 F0 5B 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __md5_Update_0463d5d2d9701040302bc915d561bd47 {
	meta:
		aliases = "__md5_Update"
		size = "151"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 CF 89 C6 89 14 24 8D 14 FD 00 00 00 00 8B 40 10 89 C1 C1 E9 03 8D 04 02 83 E1 3F 89 46 10 39 D0 73 03 FF 46 14 89 F8 BD 40 00 00 00 C1 E8 1D 29 CD 01 46 14 31 DB 39 EF 72 39 55 8D 5E 18 FF 74 24 04 8D 04 0B 50 E8 ?? ?? ?? ?? 89 DA 89 F0 E8 ?? ?? ?? ?? 89 EB 83 C4 0C EB 0F 8B 14 24 89 F0 01 DA 83 C3 40 E8 ?? ?? ?? ?? 8D 43 3F 39 F8 72 EA 31 C9 29 DF 57 8B 44 24 04 01 D8 50 8D 44 31 18 50 E8 ?? ?? ?? ?? 83 C4 10 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule makefd_xprt_013ed5cc37f812c27c5ba25ec9ed4c84 {
	meta:
		aliases = "makefd_xprt"
		size = "170"
		objfiles = "svc_tcp@libc.a, svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 CF 89 D5 89 04 24 68 34 01 00 00 E8 ?? ?? ?? ?? 68 B0 01 00 00 89 C3 E8 ?? ?? ?? ?? 59 89 C6 85 DB 58 74 04 85 F6 75 23 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 31 DB 83 C4 10 EB 4F 8D 46 08 68 ?? ?? ?? ?? C7 06 02 00 00 00 68 ?? ?? ?? ?? 53 57 55 50 E8 ?? ?? ?? ?? 8D 46 20 C7 43 30 00 00 00 00 89 73 2C 89 43 24 C7 43 0C 00 00 00 00 C7 43 08 ?? ?? ?? ?? 66 C7 43 04 00 00 8B 44 24 18 89 03 53 E8 ?? ?? ?? ?? 83 C4 1C 89 D8 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule byte_common_op_match_null_stri_caf0f303f1fd54dd3a2c4f576df90ddc {
	meta:
		aliases = "byte_common_op_match_null_string_p"
		size = "234"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 CF 8B 08 89 C5 89 0C 24 8A 01 8D 71 01 89 34 24 3C 0C 77 21 3C 09 0F 83 B1 00 00 00 3C 06 74 32 3C 08 0F 84 9B 00 00 00 84 C0 0F 84 9D 00 00 00 E9 A5 00 00 00 3C 15 74 5D 77 0A 3C 0D 0F 85 97 00 00 00 EB 3C 83 E8 1A 3C 03 0F 87 8A 00 00 00 EB 7B 0F B6 59 01 89 E0 89 F9 E8 ?? ?? ?? ?? 8D 0C 9F 89 C6 8A 01 83 E0 03 3C 03 75 0E 8A 01 89 F2 83 E2 03 83 E0 FC 09 D0 88 01 89 F0 84 C0 EB 4A 0F BE 46 01 0F B6 51 01 C1 E0 08 01 D0 78 4A 8D 44 08 03 EB 28 8D 59 03 89 1C 24 0F BE 43 01 0F B6 51 03 C1 E0 08 01 D0 75 2F 89 34 24 0F BE 46 01 0F B6 51 01 C1 E0 08 01 D0 8D 04 03 89 04 }
	condition:
		$pattern
}

rule inet_pton4_575619dea3d08820b5681a30adbe4f82 {
	meta:
		aliases = "inet_pton4"
		size = "119"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 D5 89 C3 31 FF 31 D2 89 E6 C6 04 24 00 EB 40 0F B6 C0 43 8D 48 D0 83 F9 09 77 20 0F B6 06 6B C0 0A 8D 04 01 3D FF 00 00 00 77 3C 88 06 85 D2 75 1E 47 83 FF 04 7F 30 B2 01 EB 14 83 F8 2E 75 27 85 D2 74 23 83 FF 04 74 1E 46 31 D2 C6 06 00 8A 03 84 C0 75 BA 83 FF 03 7E 0D 8B 04 24 89 45 00 B8 01 00 00 00 EB 02 31 C0 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __malloc_trim_d47e0a00a0f1c9717e5e969bae210ed7 {
	meta:
		aliases = "__malloc_trim"
		size = "125"
		objfiles = "free@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 D5 8B 8A 5C 03 00 00 8B 52 2C 8B 72 04 31 D2 83 E6 FC 8D 5C 31 EF 29 C3 89 D8 F7 F1 89 C3 4B 0F AF D9 85 DB 7E 47 6A 00 E8 ?? ?? ?? ?? 89 C7 89 F0 03 45 2C 5A 39 C7 75 34 F7 DB 53 E8 ?? ?? ?? ?? 6A 00 E8 ?? ?? ?? ?? 59 83 F8 FF 5B 74 1E 89 F9 29 C1 74 18 8B 45 2C 29 8D 68 03 00 00 29 CE 83 CE 01 89 70 04 B8 01 00 00 00 EB 02 31 C0 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_svc_unregister_01fa7ef06aad838c34b23831e1f6ccd9 {
	meta:
		aliases = "svc_unregister, __GI_svc_unregister"
		size = "84"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 E1 8B 6C 24 18 8B 7C 24 1C 89 FA 89 E8 E8 ?? ?? ?? ?? 89 C3 85 C0 74 2E 8B 04 24 8B 33 85 C0 75 0D E8 ?? ?? ?? ?? 89 B0 B8 00 00 00 EB 02 89 30 C7 03 00 00 00 00 53 E8 ?? ?? ?? ?? 57 55 E8 ?? ?? ?? ?? 83 C4 0C 58 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule svc_register_3f849c389ab17c35bae8775a683f0472 {
	meta:
		aliases = "__GI_svc_register, svc_register"
		size = "128"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 89 E1 8B 7C 24 1C 8B 74 24 20 89 F2 89 F8 8B 6C 24 24 E8 ?? ?? ?? ?? 85 C0 74 07 39 68 0C 75 51 EB 2A 6A 10 E8 ?? ?? ?? ?? 89 C3 58 85 DB 74 41 89 7B 04 89 73 08 89 6B 0C E8 ?? ?? ?? ?? 8B 90 B8 00 00 00 89 13 89 98 B8 00 00 00 B8 01 00 00 00 83 7C 24 28 00 74 1B 8B 44 24 18 0F B7 40 04 50 FF 74 24 2C 56 57 E8 ?? ?? ?? ?? 83 C4 10 EB 02 31 C0 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_xdr_union_cbe9517e17413768e186bc71a00df959 {
	meta:
		aliases = "xdr_union, __GI_xdr_union"
		size = "122"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 44 24 20 8B 74 24 18 8B 7C 24 1C 89 04 24 8B 5C 24 24 8B 6C 24 28 57 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 47 8B 07 EB 1C 39 03 75 15 8B 04 24 C7 44 24 20 FF FF FF FF 89 44 24 1C 89 74 24 18 EB 23 83 C3 08 8B 4B 04 85 C9 75 DD 85 ED 74 1C 8B 0C 24 C7 44 24 20 FF FF FF FF 89 4C 24 1C 89 74 24 18 89 E9 5B 5B 5E 5F 5D FF E1 31 C0 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule mbsnrtowcs_22f73abd2e6c6db41ea2f5e51cc231fb {
	meta:
		aliases = "__GI_mbsnrtowcs, mbsnrtowcs"
		size = "147"
		objfiles = "mbsnrtowcs@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 44 24 28 8B 54 24 18 8B 74 24 20 8B 5C 24 24 85 C0 75 05 B8 ?? ?? ?? ?? 85 D2 74 0F B9 01 00 00 00 39 C2 75 0D 89 E2 30 C9 EB 07 89 E2 83 CB FF 31 C9 89 DF 39 F3 76 02 89 F7 8B 44 24 1C 89 FE 8D 2C 8D 00 00 00 00 8B 18 EB 28 8A 03 0F B6 C8 89 0A 84 C0 75 04 31 DB EB 1D 83 F9 7F 7E 10 E8 ?? ?? ?? ?? C7 00 54 00 00 00 83 C8 FF EB 16 43 01 EA 4E 85 F6 75 D4 39 E2 74 06 8B 44 24 1C 89 18 89 F8 29 F0 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_inet_aton_37e76880b2660dfd63dba8e785912ac1 {
	meta:
		aliases = "inet_aton, __GI_inet_aton"
		size = "148"
		objfiles = "inet_aton@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 4C 24 18 85 C9 74 7D 31 F6 C7 04 24 01 00 00 00 EB 51 0F B6 01 8B 2D ?? ?? ?? ?? F6 44 45 00 08 74 62 31 FF EB 10 6B C7 0A 8D 7C 18 D0 81 FF FF 00 00 00 7F 4F 41 8A 11 0F B6 DA 0F B7 44 5D 00 A8 08 75 E2 83 3C 24 04 74 08 80 FA 2E 75 35 41 EB 09 41 84 D2 74 04 A8 20 74 29 C1 E6 08 FF 04 24 09 FE 83 3C 24 04 7E A9 B8 01 00 00 00 83 7C 24 1C 00 74 11 8B 44 24 1C 0F CE 89 30 B8 01 00 00 00 EB 02 31 C0 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _dl_fixup_66ec455a4a5d8f5269d7a8bc2653ee98 {
	meta:
		aliases = "_dl_fixup"
		size = "275"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 54 24 18 8B 42 10 85 C0 74 16 FF 74 24 1C 50 E8 ?? ?? ?? ?? 59 89 C6 5B 85 C0 0F 85 E3 00 00 00 8B 44 24 18 BE 01 00 00 00 8B 18 66 8B 43 22 83 7B 5C 00 0F 85 CA 00 00 00 8B B3 84 00 00 00 8B AB 88 00 00 00 85 F6 74 4A A8 01 75 46 8B 8B C8 00 00 00 89 F0 85 C9 74 23 8D 14 CD 00 00 00 00 89 14 24 8D 56 F8 8B 3B 83 C2 08 89 F8 03 02 01 38 49 75 F4 8B 04 24 2B 2C 24 01 F0 55 50 FF 74 24 20 E8 ?? ?? ?? ?? 83 C4 0C 66 83 4B 22 01 89 C6 EB 02 31 F6 83 BB A0 00 00 00 00 74 08 C7 44 24 1C 02 00 00 00 83 BB 9C 00 00 00 00 74 54 F6 43 22 02 74 10 83 7C 24 1C 00 74 47 8B 44 24 1C }
	condition:
		$pattern
}

rule _dl_linux_resolver_fc5a5e2f31bdcde191e2020635167e94 {
	meta:
		aliases = "_dl_linux_resolver"
		size = "137"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 5C 24 18 8B 44 24 1C 03 83 9C 00 00 00 8B 4B 58 8B 50 04 8B 00 C1 EA 08 C1 E2 04 8B 3C 0A 03 7B 54 89 04 24 8B 2B 6A 01 53 FF 73 1C 57 E8 ?? ?? ?? ?? 83 C4 10 89 C6 85 C0 75 37 FF 73 04 57 BF 01 00 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 53 89 FB B8 01 00 00 00 CD 80 5B 83 C4 14 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 8B 04 24 89 74 05 00 89 F0 5D 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule xdr_bytes_1bb9621d0c1f5f2db072b2e8871d1b5e {
	meta:
		aliases = "__GI_xdr_bytes, xdr_bytes"
		size = "178"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 6C 24 1C 8B 44 24 24 89 04 24 8B 7C 24 18 8B 74 24 20 8B 5D 00 56 57 E8 ?? ?? ?? ?? 5A 85 C0 59 74 79 8B 36 3B 34 24 76 05 83 3F 02 75 6D 8B 07 83 F8 01 74 09 72 35 83 F8 02 75 5F EB 44 85 F6 74 5D 85 DB 75 26 56 E8 ?? ?? ?? ?? 89 C3 89 45 00 58 85 DB 75 16 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5F 31 C0 5D EB 38 89 5C 24 1C 89 7C 24 18 89 74 24 20 5E 5B 5E 5F 5D E9 ?? ?? ?? ?? 85 DB 74 19 53 E8 ?? ?? ?? ?? C7 45 00 00 00 00 00 B8 01 00 00 00 5B EB 09 31 C0 EB 05 B8 01 00 00 00 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule regcomp_5559318a0fbe9c20bd5f24874a004f51 {
	meta:
		aliases = "regcomp"
		size = "298"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 6C 24 20 8B 74 24 18 89 E8 83 E0 01 C7 06 00 00 00 00 83 F8 01 C7 46 04 00 00 00 00 19 DB C7 46 08 00 00 00 00 68 00 01 00 00 E8 ?? ?? ?? ?? 81 E3 CA 4F FD 00 89 46 10 81 C3 FC B2 03 00 59 F7 C5 02 00 00 00 74 4D 68 00 01 00 00 E8 ?? ?? ?? ?? 89 46 14 31 C9 5A BF 0C 00 00 00 85 C0 75 2A E9 B5 00 00 00 8B 46 14 8D 3C 09 89 04 24 A1 ?? ?? ?? ?? 88 CA F6 04 38 01 74 08 A1 ?? ?? ?? ?? 8A 14 38 8B 04 24 88 14 08 41 81 F9 FF 00 00 00 76 D3 EB 07 C7 46 14 00 00 00 00 F7 C5 04 00 00 00 8A 46 1C 74 0B 83 E3 BF 83 C8 80 80 CF 01 EB 03 83 E0 7F C1 ED 03 88 46 1C 89 E8 8A 56 1C 83 }
	condition:
		$pattern
}

rule registerrpc_ff5853acf5f2106a8f83162a97376e41 {
	meta:
		aliases = "registerrpc"
		size = "257"
		objfiles = "svc_simple@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 6C 24 20 8B 7C 24 18 8B 74 24 1C 85 ED 75 19 6A 00 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 83 C4 0C E9 AD 00 00 00 E8 ?? ?? ?? ?? 89 C3 83 B8 C4 00 00 00 00 75 19 6A FF E8 ?? ?? ?? ?? 89 83 C4 00 00 00 85 C0 5A 75 07 68 ?? ?? ?? ?? EB 4B 56 57 E8 ?? ?? ?? ?? 6A 11 68 ?? ?? ?? ?? 56 57 FF B3 C4 00 00 00 E8 ?? ?? ?? ?? 83 C4 1C 85 C0 75 16 56 57 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 EB 4C 6A 18 E8 ?? ?? ?? ?? 5E 89 C2 85 C0 75 11 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 44 24 04 59 EB 2D 8B 44 24 24 89 7A 04 89 02 89 6A 08 8B 44 24 28 89 42 0C 8B 44 24 2C 89 }
	condition:
		$pattern
}

rule fread_unlocked_4317d8bc8f470afe92947ff5d4c058f0 {
	meta:
		aliases = "__GI_fread_unlocked, fread_unlocked"
		size = "260"
		objfiles = "fread_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 6C 24 24 8B 5C 24 20 0F B7 45 00 25 83 00 00 00 3D 80 00 00 00 77 15 68 80 00 00 00 55 E8 ?? ?? ?? ?? 5E 85 C0 5F 0F 85 C8 00 00 00 83 7C 24 1C 00 0F 84 BD 00 00 00 85 DB 0F 84 B5 00 00 00 83 C8 FF 31 D2 F7 74 24 1C 39 C3 0F 87 94 00 00 00 0F AF 5C 24 1C 8B 7C 24 18 89 DE 89 1C 24 EB 1B 83 E0 01 4E 8B 44 85 24 88 07 8D 42 FF 66 89 45 00 C7 45 28 00 00 00 00 74 5C 47 8B 55 00 0F B7 C2 A8 02 75 DB 8B 55 10 8B 45 14 29 D0 74 1C 89 F3 39 C6 76 02 89 C3 53 52 57 E8 ?? ?? ?? ?? 01 5D 10 83 C4 0C 29 DE 74 2D 01 DF 0F B7 45 00 F6 C4 03 74 13 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 EB }
	condition:
		$pattern
}

rule __GI_xdr_pmaplist_cb9b12f297ce53ea50d251b2319f9c57 {
	meta:
		aliases = "xdr_pmaplist, __GI_xdr_pmaplist"
		size = "119"
		objfiles = "pmap_prot2@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 74 24 18 8B 5C 24 1C 83 3E 02 0F 94 C0 0F B6 F8 31 ED 31 C0 83 3B 00 0F 95 C0 89 04 24 8D 04 24 50 56 E8 ?? ?? ?? ?? 59 85 C0 5A 74 3A 83 3C 24 00 75 07 B8 01 00 00 00 EB 2F 85 FF 74 05 8B 2B 83 C5 10 68 ?? ?? ?? ?? 6A 14 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0F 85 FF 74 04 89 EB EB B2 8B 1B 83 C3 10 EB AB 31 C0 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_vasprintf_35b8cb6880c35ae1cbf75520bbb7167d {
	meta:
		aliases = "vasprintf, __GI_vasprintf"
		size = "102"
		objfiles = "vasprintf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 74 24 20 8B 6C 24 1C 8B 7C 24 18 89 34 24 56 55 6A 00 6A 00 E8 ?? ?? ?? ?? 83 C4 10 89 C3 C7 07 00 00 00 00 85 C0 78 2E 43 53 E8 ?? ?? ?? ?? 89 07 85 C0 5A 74 20 56 55 53 50 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 79 0E FF 37 E8 ?? ?? ?? ?? C7 07 00 00 00 00 59 89 D8 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _dl_do_reloc_35da0c007f028ba6dd7ed3e9d31c23f2 {
	meta:
		aliases = "_dl_do_reloc"
		size = "225"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 7C 24 18 8B 44 24 20 8B 17 89 14 24 8B 28 8B 40 04 0F B6 D8 C1 E8 08 89 C6 C1 E6 04 03 74 24 24 85 C0 8B 0E 74 68 83 FB 07 74 19 83 FB 23 74 14 83 FB 24 74 0F 83 FB 25 74 0A 31 D2 83 FB 0E 0F 94 C2 EB 05 BA 01 00 00 00 31 C0 83 FB 05 0F 94 C0 01 C0 09 D0 50 57 FF 74 24 24 8B 44 24 34 01 C8 50 E8 ?? ?? ?? ?? 83 C4 10 89 C1 85 C0 75 1A 8A 56 0C 89 D0 83 E0 0F 83 F8 06 74 0D C0 EA 04 B8 01 00 00 00 80 FA 02 75 49 89 C8 EB 03 8B 46 04 8B 0C 24 83 FB 08 8D 54 0D 00 77 07 FF 24 9D ?? ?? ?? ?? 83 C8 FF EB 2A 29 D0 EB 06 89 02 EB 20 8B 07 01 02 EB 1A 85 C0 74 16 8D 4A FF 8B 5E }
	condition:
		$pattern
}

rule __getdents_8b7042fdd702b4693cc7fa13fdfb117d {
	meta:
		aliases = "__getdents"
		size = "130"
		objfiles = "getdents@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 7C 24 18 8B 4C 24 1C 8B 54 24 20 53 89 FB B8 8D 00 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? 83 CE FF F7 DB 89 18 EB 45 89 C6 83 F8 FF 74 3E 89 CF 8D 2C 01 EB 33 0F B7 47 08 8D 5F 0A 8A 44 07 FF 88 44 24 03 53 E8 ?? ?? ?? ?? 40 89 04 24 8D 47 0B 53 50 E8 ?? ?? ?? ?? 8A 44 24 0F 88 47 0A 83 C4 0C 0F B7 47 08 01 C7 39 EF 72 C9 89 F0 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_getmntent_r_42fcd6055fd913e2986f5cbf954e3f57 {
	meta:
		aliases = "getmntent_r, __GI_getmntent_r"
		size = "271"
		objfiles = "mntent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 7C 24 18 8B 5C 24 1C 8B 74 24 20 8B 6C 24 24 85 FF 0F 84 E6 00 00 00 85 DB 0F 84 DE 00 00 00 85 F6 0F 84 D6 00 00 00 EB 0A 8A 06 3C 23 74 04 3C 0A 75 14 57 55 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 E7 E9 B6 00 00 00 89 E7 C7 04 24 00 00 00 00 57 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 0C 89 03 85 C0 0F 84 94 00 00 00 57 68 ?? ?? ?? ?? 6A 00 E8 ?? ?? ?? ?? 83 C4 0C 89 43 04 85 C0 74 7D 57 68 ?? ?? ?? ?? 6A 00 E8 ?? ?? ?? ?? 83 C4 0C 89 43 08 85 C0 74 66 57 68 ?? ?? ?? ?? 6A 00 E8 ?? ?? ?? ?? 83 C4 0C 89 43 0C 85 C0 75 07 C7 43 0C ?? ?? ?? ?? 57 68 ?? ?? ?? ?? 6A 00 E8 ?? ?? }
	condition:
		$pattern
}
...
rule __pthread_alt_timedlock_766c3eea107c43e367137e5b11e6c948 {
	meta:
		aliases = "__pthread_alt_timedlock"
		size = "196"
		objfiles = "spinlock@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 B8 ?? ?? ?? ?? 31 F6 8B 7C 24 18 8B 6C 24 1C E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 85 C0 74 09 89 C6 8B 00 A3 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 85 F6 75 1E 6A 0C E8 ?? ?? ?? ?? 89 C6 58 85 F6 75 10 55 57 E8 ?? ?? ?? ?? 5D BA 01 00 00 00 58 EB 63 8B 1F BA 01 00 00 00 85 DB 74 10 85 ED 75 07 E8 ?? ?? ?? ?? 89 C5 89 6E 04 89 F2 C7 46 08 00 00 00 00 89 1E 89 D8 F0 0F B1 17 0F 94 C2 84 D2 74 CF 85 DB 74 22 FF 74 24 20 55 E8 ?? ?? ?? ?? 5B 85 C0 5F 75 12 B0 01 87 46 08 31 D2 85 C0 74 13 89 E8 E8 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? BA 01 00 00 00 89 D0 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule svc_run_700b183125dc5893ce2d63c8791685d6 {
	meta:
		aliases = "svc_run"
		size = "199"
		objfiles = "svc_run@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 E8 ?? ?? ?? ?? 89 04 24 8B 18 85 DB 75 0E E8 ?? ?? ?? ?? 83 38 00 0F 84 9E 00 00 00 8D 04 DD 00 00 00 00 31 ED 50 E8 ?? ?? ?? ?? 89 C7 58 EB 27 E8 ?? ?? ?? ?? 8D 1C ED 00 00 00 00 8D 34 1F 45 8B 10 8B 14 1A 89 16 8B 00 66 C7 46 06 00 00 8B 44 18 04 66 89 46 04 8B 14 24 8B 02 39 C5 7C D0 6A FF 50 57 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 FF 74 06 85 C0 74 24 EB 2E 57 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5E 83 38 04 0F 84 74 FF FF FF 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5B EB 21 57 E8 ?? ?? ?? ?? 59 E9 5B FF FF FF 50 57 E8 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 83 C4 0C E9 46 FF FF FF 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __prefix_array_e3bec6a5289862c32e6ed9254a11b720 {
	meta:
		aliases = "__prefix_array"
		size = "160"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 FF 74 24 18 E8 ?? ?? ?? ?? 59 89 C5 83 F8 01 75 0D 8B 44 24 18 80 38 2F 0F 95 C0 0F B6 E8 31 FF EB 69 8B 54 24 1C 8D 34 BA FF 36 E8 ?? ?? ?? ?? 5A 8D 50 01 8D 44 05 02 89 14 24 50 E8 ?? ?? ?? ?? 89 C3 58 85 DB 75 1B EB 0E 8B 44 24 1C 4F FF 34 B8 E8 ?? ?? ?? ?? 5B 85 FF 75 EE B8 01 00 00 00 EB 30 55 47 FF 74 24 1C 53 E8 ?? ?? ?? ?? C6 00 2F 40 FF 74 24 0C FF 36 50 E8 ?? ?? ?? ?? FF 36 E8 ?? ?? ?? ?? 89 1E 83 C4 1C 3B 7C 24 20 72 91 31 C0 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __pthread_destroy_specifics_df095d85b65c7d85b29598620114bf0c {
	meta:
		aliases = "__pthread_destroy_specifics"
		size = "192"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 31 ED E8 ?? ?? ?? ?? 89 C6 C7 44 24 04 01 00 00 00 EB 53 83 7C 9E 74 00 74 45 89 D8 31 FF C1 E0 05 89 04 24 EB 34 8B 04 24 01 F8 8B 0C C5 ?? ?? ?? ?? 8D 04 BD 00 00 00 00 03 44 9E 74 85 C9 8B 10 74 16 85 D2 74 12 C7 00 00 00 00 00 52 FF D1 C7 44 24 08 01 00 00 00 5A 47 83 FF 1F 7E C7 43 83 FB 1F 7E AE 45 83 7C 24 04 00 74 11 83 FD 03 7F 0C 31 DB C7 44 24 04 00 00 00 00 EB E2 8B 46 1C 89 F2 E8 ?? ?? ?? ?? 31 DB EB 18 8B 44 9E 74 85 C0 74 0F 50 E8 ?? ?? ?? ?? C7 44 9E 74 00 00 00 00 58 43 83 FB 1F 7E E3 FF 76 1C E8 ?? ?? ?? ?? 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __parsegrent_42ce274e0648ec734792fac98723c6e2 {
	meta:
		aliases = "__parsegrent"
		size = "216"
		objfiles = "__parsegrent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 31 F6 8B 6C 24 1C 8B 5C 24 20 8B 45 00 89 04 24 0F B6 86 ?? ?? ?? ?? 83 FE 01 8D 7C 05 00 7F 1D 89 1F 6A 3A 53 E8 ?? ?? ?? ?? 5B 85 C0 5F 0F 84 93 00 00 00 8D 58 01 46 C6 00 00 EB D3 6A 0A 8D 44 24 08 50 53 E8 ?? ?? ?? ?? 89 07 8B 4C 24 10 83 C4 0C 39 D9 74 70 80 39 3A 75 6B BB 01 00 00 00 80 79 01 00 74 2B C6 01 2C 80 39 2C 75 1D C6 01 00 41 8A 01 84 C0 74 4E 3C 2C 74 4A 0F B6 D0 A1 ?? ?? ?? ?? F6 04 50 20 75 3C 43 41 80 39 00 75 D8 8D 51 04 83 E2 FC 8D 04 9A 3B 04 24 77 27 89 D9 89 55 0C 49 74 15 8B 44 24 04 40 89 02 83 C2 04 49 74 08 40 80 38 00 75 FA EB EF 31 C0 C7 02 }
	condition:
		$pattern
}

rule __pthread_lock_bd526a93ba0b0f0fc956658d63103f61 {
	meta:
		aliases = "__pthread_lock"
		size = "142"
		objfiles = "spinlock@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 89 C3 89 D7 83 38 00 74 04 31 ED EB 16 31 D2 B9 01 00 00 00 89 D0 F0 0F B1 0B 0F 94 C2 84 D2 74 E8 EB 5D 8B 33 F7 C6 01 00 00 00 75 0C 89 F1 BA 01 00 00 00 83 C9 01 EB 12 85 FF 75 07 E8 ?? ?? ?? ?? 89 C7 89 F9 31 D2 83 C9 01 85 FF 74 03 89 77 0C 89 F0 F0 0F B1 0B 0F 94 C1 84 C9 74 C4 85 D2 75 17 89 F8 E8 ?? ?? ?? ?? 83 7F 0C 00 74 B3 45 EB F0 89 F8 E8 ?? ?? ?? ?? 4D 83 FD FF 75 F3 58 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule scan_getwc_330608e53f4920058cb75e6aa56f6b98 {
	meta:
		aliases = "scan_getwc"
		size = "148"
		objfiles = "vfscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 89 C3 8B 78 10 4F 89 78 10 85 FF 79 09 80 48 19 02 83 C8 FF EB 70 BE FD FF FF FF 8D 68 1C C7 40 10 FF FF FF 7F EB 2E 8B 03 88 44 24 07 55 6A 01 8D 44 24 0F 50 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 89 C6 85 C0 78 08 8B 04 24 89 43 24 EB 31 83 F8 FE 75 0B 53 E8 ?? ?? ?? ?? 5A 85 C0 79 C7 83 FE FD 75 0D 66 BE FF FF C7 43 24 FF FF FF FF EB 0F E8 ?? ?? ?? ?? C7 00 54 00 00 00 C6 43 1B 01 89 7B 10 89 F0 5A 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule do_dlclose_d98646a6319df76a112a8a9ce233d6a2 {
	meta:
		aliases = "do_dlclose"
		size = "520"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 89 C5 3B 05 ?? ?? ?? ?? 89 14 24 0F 84 E7 01 00 00 A1 ?? ?? ?? ?? 31 D2 EB 09 39 E8 74 1A 89 C2 8B 40 04 85 C0 75 F3 B0 01 C7 05 ?? ?? ?? ?? 0A 00 00 00 E9 C2 01 00 00 85 D2 8B 45 04 74 05 89 42 04 EB 05 A3 ?? ?? ?? ?? 8B 55 00 8B 42 20 C7 44 24 04 00 00 00 00 66 83 F8 01 0F 84 53 01 00 00 48 66 89 42 20 55 E8 ?? ?? ?? ?? 31 C0 5B E9 86 01 00 00 8B 45 08 8B 54 24 04 8B 3C 90 8B 47 20 48 66 85 C0 66 89 47 20 0F 85 21 01 00 00 83 7F 74 00 75 09 83 BF A8 00 00 00 00 74 27 83 3C 24 00 74 21 66 8B 47 22 A8 08 75 19 83 C8 08 66 89 47 22 57 E8 ?? ?? ?? ?? 8B 47 74 59 85 C0 74 04 }
	condition:
		$pattern
}

rule __fake_pread_write64_4b08bcb76a0a40e8c89a2a30bc788c77 {
	meta:
		aliases = "__fake_pread_write64"
		size = "167"
		objfiles = "pread_write@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 89 D5 89 CB 89 04 24 6A 01 6A 00 6A 00 50 E8 ?? ?? ?? ?? 83 C4 10 89 C6 89 D7 83 FA FF 75 05 83 F8 FF 74 70 6A 00 FF 74 24 24 FF 74 24 24 FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 10 42 75 03 40 74 54 83 7C 24 24 01 75 0D 53 55 FF 74 24 08 E8 ?? ?? ?? ?? EB 0B 53 55 FF 74 24 08 E8 ?? ?? ?? ?? 83 C4 0C 89 C5 E8 ?? ?? ?? ?? 89 C3 8B 00 89 44 24 04 6A 00 57 56 FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 10 42 75 08 40 75 05 83 FD FF 75 08 8B 44 24 04 89 03 EB 03 83 CD FF 89 E8 5A 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_strverscmp_4be8557f34a1970a7bf32e5d9fdd4751 {
	meta:
		aliases = "__GI_strverscmp"
		size = "245"
		objfiles = "strverscmp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 44 24 1C 8B 54 24 20 C7 04 24 00 00 00 00 39 D0 0F 84 CD 00 00 00 8A 18 8D 68 01 0F B6 C3 83 E8 30 8A 0A 8D 7A 01 31 D2 83 F8 09 0F 96 C2 31 C0 80 FB 30 0F 94 C0 8D 34 02 EB 2F 0F B6 B6 ?? ?? ?? ?? 89 74 24 04 31 D2 8A 5D 00 8A 0F 0F B6 C3 83 E8 30 45 47 83 F8 09 0F 96 C2 31 C0 80 FB 30 0F 94 C0 8D 34 02 0B 74 24 04 0F B6 D1 0F B6 C3 29 D0 89 04 24 75 04 84 DB 75 C0 8D 42 D0 31 D2 83 F8 09 0F 96 C2 31 C0 80 F9 30 0F 94 C0 01 C2 8D 04 B5 00 00 00 00 09 C2 8A 82 ?? ?? ?? ?? 3C 02 74 40 3C 03 74 1D 0F BE C0 89 04 24 EB 34 0F B6 07 83 E8 30 83 F8 09 76 09 C7 04 24 01 00 00 }
	condition:
		$pattern
}
...
rule __GI_strstr_d971e4ce45be11f0b6550ff8b729f364 {
	meta:
...
rule __GI_fgetwc_unlocked_b564ba6caa5a6e32786a8c4fce3e7276 {
	meta:
		aliases = "getwc_unlocked, fgetwc_unlocked, __GI_fgetwc_unlocked"
		size = "271"
		objfiles = "fgetwc_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 5C 24 1C 0F B7 03 25 03 08 00 00 3D 00 08 00 00 77 18 68 00 08 00 00 53 E8 ?? ?? ?? ?? 83 CE FF 5F 85 C0 5D 0F 85 D4 00 00 00 0F B7 03 A8 02 74 31 A8 01 75 06 83 7B 28 00 74 06 C6 43 02 00 EB 06 8A 43 03 88 43 02 8B 03 89 C2 48 83 E2 01 66 89 03 8B 74 93 24 C7 43 28 00 00 00 00 E9 8A 00 00 00 83 7B 08 00 75 0E 8D 54 24 07 89 D8 E8 ?? ?? ?? ?? FF 43 0C 83 7B 2C 00 75 04 C6 43 02 00 8D 7B 2C 89 E5 8B 43 14 8B 53 10 89 C6 29 D6 74 30 57 56 52 55 E8 ?? ?? ?? ?? 83 C4 10 83 F8 00 7C 12 75 05 B8 01 00 00 00 01 43 10 00 43 02 8B 34 24 EB 38 83 F8 FE 75 2C 89 F0 01 73 10 00 43 }
	condition:
		$pattern
}

rule _obstack_newchunk_fc73a5ec1dfeba5df071c55a2315fdd2 {
	meta:
		aliases = "_obstack_newchunk"
		size = "259"
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 5C 24 1C 8B 43 04 89 44 24 04 8B 6B 0C 8B 43 18 2B 6B 08 83 C0 64 01 E8 89 EA 03 44 24 20 8B 0B C1 FA 03 8D 3C 10 39 CF 7D 02 89 CF F6 43 28 01 8B 43 1C 74 0C 57 FF 73 24 FF D0 89 C6 58 5A EB 06 57 FF D0 59 89 C6 85 F6 75 05 E8 ?? ?? ?? ?? 89 73 04 8D 04 3E 8B 54 24 04 89 56 04 89 43 10 89 06 8B 53 18 89 D0 F7 D0 8D 7C 32 08 21 C7 31 C0 83 FA 02 7E 25 89 E9 C1 E9 02 89 0C 24 EB 10 8D 04 8D 00 00 00 00 8B 53 08 8B 14 02 89 14 07 49 85 C9 79 EB 8B 04 24 C1 E0 02 89 C2 EB 0A 8B 43 08 8A 04 10 88 04 17 42 39 EA 7C F2 F6 43 28 02 75 34 8B 43 18 8B 4C 24 04 8D 54 08 08 F7 D0 }
	condition:
		$pattern
}

rule __GI_xdr_rmtcall_args_a2dee6840e2ced6ea6e09f63794d902b {
	meta:
		aliases = "xdr_rmtcall_args, __GI_xdr_rmtcall_args"
		size = "196"
		objfiles = "pmap_rmt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 5C 24 1C 8B 74 24 20 56 53 E8 ?? ?? ?? ?? 5F 85 C0 5D 0F 84 9B 00 00 00 8D 46 04 50 53 E8 ?? ?? ?? ?? 5A 85 C0 59 0F 84 87 00 00 00 8D 46 08 50 53 E8 ?? ?? ?? ?? 5F 85 C0 5D 74 77 C7 44 24 04 00 00 00 00 8B 43 04 53 FF 50 10 89 44 24 04 8D 44 24 08 50 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 52 8B 43 04 53 FF 50 10 FF 76 10 89 C5 53 FF 56 14 83 C4 0C 85 C0 74 3B 8B 43 04 53 FF 50 10 89 C7 29 E8 89 46 0C 8B 43 04 FF 74 24 04 53 FF 50 14 8D 46 0C 50 53 E8 ?? ?? ?? ?? 83 C4 14 85 C0 74 11 8B 43 04 57 53 FF 50 14 5B B8 01 00 00 00 5E EB 02 31 C0 5A 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule setstate_r_13f35501a778723dd018d689e1994051 {
	meta:
		aliases = "__GI_setstate_r, setstate_r"
		size = "169"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 5C 24 20 8B 74 24 1C 83 C6 04 8A 53 0C 8B 4B 08 84 D2 75 09 C7 41 FC 00 00 00 00 EB 13 8B 43 04 29 C8 C1 F8 02 0F BE D2 8D 04 80 01 D0 89 41 FC 8B 46 FC BF 05 00 00 00 99 F7 FF 83 FA 04 77 4C 8A 82 ?? ?? ?? ?? 85 D2 88 43 0D 0F BE C8 8A 82 ?? ?? ?? ?? 88 44 24 07 88 43 0E 88 53 0C 74 1F 8B 6E FC 89 E8 99 F7 FF 89 C7 8D 04 86 89 43 04 0F BE 44 24 07 01 F8 99 F7 F9 8D 14 96 89 13 8D 04 8E 89 73 08 89 43 10 31 C0 EB 0E E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF 5A 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __stdio_fwrite_379c8268552c2ba9cc0ccc150457420c {
	meta:
		aliases = "__stdio_fwrite"
		size = "232"
		objfiles = "_fwrite@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 5C 24 24 8B 6C 24 1C 8B 74 24 20 F6 43 01 02 0F 85 AB 00 00 00 83 7B 04 FE 8B 53 10 8B 43 0C 75 1D 29 D0 89 F7 39 C6 76 02 89 C7 57 55 52 E8 ?? ?? ?? ?? 01 7B 10 83 C4 0C E9 99 00 00 00 29 D0 39 C6 77 68 56 55 52 E8 ?? ?? ?? ?? 01 73 10 83 C4 0C F6 43 01 01 74 7F 56 6A 0A 55 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 6F 53 E8 ?? ?? ?? ?? 89 C1 58 85 C9 74 62 89 0C 24 39 F1 76 03 89 34 24 89 F0 8B 0C 24 2B 04 24 01 C5 89 EF E3 09 B0 0A F2 AE 8D 7F FF 74 02 31 FF 85 FF 74 3B 8B 0C 24 8D 44 0D 00 29 F8 29 43 10 29 C6 EB 2B 3B 53 08 74 0F 53 E8 ?? ?? ?? ?? 5F 85 C0 74 04 31 F6 EB 17 }
	condition:
		$pattern
}

rule _stdlib_wcsto_l_82207d7ea3b5f7bbc823f8fc6ed7831b {
	meta:
		aliases = "_stdlib_wcsto_l"
		size = "306"
		objfiles = "_stdlib_wcsto_l@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 6C 24 1C 8B 74 24 24 89 EB EB 03 83 C3 04 FF 33 E8 ?? ?? ?? ?? 5F 85 C0 75 F1 8B 03 83 F8 2B 74 11 C6 44 24 06 00 83 F8 2D 75 0F C6 44 24 06 01 EB 05 C6 44 24 06 00 83 C3 04 89 EF F7 C6 EF FF FF FF 75 29 83 C6 0A 83 3B 30 75 17 83 C3 04 83 EE 02 89 DF 8B 03 83 C8 20 83 F8 78 75 05 01 F6 83 C3 04 83 FE 10 7E 05 BE 10 00 00 00 8D 46 FE 31 ED 83 F8 22 77 6F 83 C8 FF 31 D2 F7 F6 89 04 24 88 54 24 07 EB 02 89 DF 8B 0B 8D 41 D0 8D 51 D0 83 F8 09 76 14 89 C8 B2 28 83 C8 20 83 F8 60 76 08 88 C8 83 C8 20 8D 50 A9 0F B6 C2 39 F0 7D 35 83 C3 04 3B 2C 24 77 08 75 1E 3A 54 24 07 76 }
	condition:
		$pattern
}

rule pmap_getmaps_2da963980a9d7146ea55bb742748fe45 {
	meta:
		aliases = "pmap_getmaps"
		size = "145"
		objfiles = "pm_getmaps@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 6C 24 1C C7 44 24 04 00 00 00 00 C7 04 24 FF FF FF FF 66 C7 45 02 00 6F 68 F4 01 00 00 6A 32 8D 44 24 08 50 6A 02 68 A0 86 01 00 55 E8 ?? ?? ?? ?? 83 C4 18 89 C3 85 C0 74 3E 8B 50 04 31 FF 8D 44 24 04 BE 3C 00 00 00 57 56 50 68 ?? ?? ?? ?? 6A 00 68 ?? ?? ?? ?? 6A 04 53 FF 12 83 C4 20 85 C0 74 0D 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 5E 5F 8B 43 04 53 FF 50 10 5B 66 C7 45 02 00 00 8B 44 24 04 5A 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_qsort_6dfae1492c1c7336df7e752816694acc {
	meta:
		aliases = "qsort, __GI_qsort"
		size = "169"
		objfiles = "qsort@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 74 24 20 83 FE 01 0F 86 8E 00 00 00 83 7C 24 24 00 0F 84 83 00 00 00 31 C9 8D 5E FF 8D 04 49 BA 03 00 00 00 89 D5 31 D2 8D 48 01 89 D8 F7 F5 39 C1 72 E9 8B 5C 24 24 0F AF 74 24 24 0F AF D9 89 74 24 04 89 1C 24 8B 2C 24 8B 74 24 1C 29 DD 01 EE 8D 3C 1E 57 56 FF 54 24 30 59 85 C0 5A 7E 15 8B 4C 24 24 8A 16 8A 07 88 06 46 88 17 47 49 75 F3 39 DD 73 D4 8B 44 24 24 8B 74 24 04 01 04 24 39 34 24 72 C1 29 C3 BA 03 00 00 00 89 D8 89 D6 31 D2 F7 F6 89 C3 85 C0 75 A9 58 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _stdlib_strto_l_e682ea491d05a748c39c4299a84c8929 {
	meta:
		aliases = "_stdlib_strto_l"
		size = "276"
		objfiles = "_stdlib_strto_l@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 7C 24 1C 8B 74 24 24 89 FB EB 01 43 8A 0B A1 ?? ?? ?? ?? 0F B6 D1 F6 04 50 20 75 EF 80 F9 2B 74 0E 31 ED 80 F9 2D 75 0A BD 01 00 00 00 EB 02 31 ED 43 89 F9 F7 C6 EF FF FF FF 75 24 83 C6 0A 80 3B 30 75 12 43 83 EE 02 89 D9 8A 03 83 C8 20 3C 78 75 03 01 F6 43 83 FE 10 7E 05 BE 10 00 00 00 8D 46 FE 31 FF 83 F8 22 77 60 83 C8 FF 31 D2 F7 F6 89 04 24 88 54 24 07 EB 02 89 D9 8A 03 8D 50 D0 80 FA 09 76 0C 83 C8 20 B2 28 3C 60 76 03 8D 50 A9 0F B6 C2 39 F0 7D 31 43 3B 3C 24 77 08 75 1C 3A 54 24 07 76 16 8A 44 24 28 83 CF FF 21 C5 E8 ?? ?? ?? ?? C7 00 22 00 00 00 EB BD 89 F8 0F }
	condition:
		$pattern
}

rule __drand48_iterate_12422eaae25c3424d55b6841096b5f46 {
	meta:
		aliases = "__drand48_iterate"
		size = "160"
		objfiles = "drand48_iter@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 7C 24 20 8B 6C 24 1C 66 83 7F 0E 00 75 1A C7 47 10 6D E6 EC DE C7 47 14 05 00 00 00 66 C7 47 0C 0B 00 66 C7 47 0E 01 00 0F B7 45 04 0F B7 4D 00 31 D2 89 C2 B8 00 00 00 00 31 DB 09 C8 09 DA 0F B7 4D 02 89 C6 89 54 24 04 C1 E1 10 09 CE 89 34 24 89 D6 8B 0C 24 8B 04 24 F7 67 10 0F AF 4F 14 0F AF 77 10 01 CE 89 C1 0F B7 47 0C 8D 1C 16 31 D2 01 C8 11 DA 66 89 45 00 0F AC D0 10 C1 EA 10 66 89 45 02 0F AC D0 10 C1 EA 10 66 89 45 04 31 C0 5A 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __copy_rpcent_7ba6f24ff0a3d660303b5c97ef72736f {
	meta:
		aliases = "__copy_rpcent"
		size = "252"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 89 C6 89 D3 85 F6 8B 44 24 24 89 0C 24 C7 00 00 00 00 00 B8 02 00 00 00 0F 84 CF 00 00 00 30 C0 89 D7 AB AB AB FF 74 24 20 6A 00 51 E8 ?? ?? ?? ?? 8B 46 08 89 43 08 31 D2 83 C4 0C 8B 46 04 8B 04 90 42 85 C0 75 F5 8D 04 95 00 00 00 00 39 44 24 20 0F 82 90 00 00 00 8D 6A FF 8B 4C 24 20 8B 14 24 29 C1 89 53 04 01 C2 89 54 24 04 89 4C 24 08 EB 45 8B 46 04 8D 3C AD 00 00 00 00 FF 34 38 E8 ?? ?? ?? ?? 59 8D 50 01 39 54 24 08 72 59 8B 43 04 8B 4C 24 04 89 0C 38 01 D1 29 54 24 08 8B 46 04 89 4C 24 04 52 FF 34 38 8B 43 04 FF 34 38 E8 ?? ?? ?? ?? 83 C4 0C 4D 83 FD FF 75 B5 FF 36 E8 }
	condition:
		$pattern
}

rule getsubopt_5427d04a5a4884fe84a44b006765971f {
	meta:
		aliases = "getsubopt"
		size = "217"
		objfiles = "getsubopt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 20 8B 00 C7 44 24 08 FF FF FF FF 89 04 24 80 38 00 0F 84 AC 00 00 00 6A 2C 50 E8 ?? ?? ?? ?? 5A 59 89 C1 89 C3 2B 0C 24 8B 3C 24 E3 09 B0 3D F2 AE 8D 7F FF 74 02 31 FF 89 DD 85 FF 74 02 89 FD 89 E8 C7 44 24 08 00 00 00 00 2B 04 24 89 44 24 04 EB 41 FF 74 24 04 56 FF 74 24 08 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 28 8B 54 24 04 80 3C 16 00 75 1E 39 DD 74 03 8D 45 01 8B 7C 24 28 89 07 80 3B 00 74 04 C6 03 00 43 8B 44 24 20 89 18 EB 33 FF 44 24 08 8B 54 24 08 8B 7C 24 24 8B 34 97 85 F6 75 B0 8B 44 24 28 8B 14 24 89 10 80 3B 00 74 04 C6 03 00 43 8B 7C 24 20 89 1F C7 44 24 }
	condition:
		$pattern
}

rule __GI___ns_name_unpack_3ad26659857975e431533393fcc0a9bd {
	meta:
		aliases = "__ns_name_unpack, __GI___ns_name_unpack"
		size = "263"
		objfiles = "ns_name@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 2C 8B 54 24 30 01 C2 89 54 24 04 8B 54 24 20 39 54 24 28 0F 82 A4 00 00 00 8B 54 24 24 39 54 24 28 0F 83 96 00 00 00 2B 54 24 20 8B 7C 24 28 89 C3 31 ED C7 44 24 08 FF FF FF FF 89 14 24 E9 8F 00 00 00 0F B6 F1 89 F0 25 C0 00 00 00 74 09 3D C0 00 00 00 75 67 EB 29 8D 44 1E 01 3B 44 24 04 73 5B 8D 3C 32 3B 7C 24 24 73 52 88 0B 43 56 52 53 E8 ?? ?? ?? ?? 8D 6C 35 01 01 F3 83 C4 0C EB 51 3B 54 24 24 73 36 83 7C 24 08 00 79 09 2B 54 24 28 42 89 54 24 08 83 E6 3F 0F B6 47 01 C1 E6 08 8B 7C 24 20 09 C6 01 F7 3B 7C 24 20 72 0E 3B 7C 24 24 73 08 83 C5 02 3B 2C 24 7C 15 E8 }
	condition:
		$pattern
}
...
rule __decode_dotted_d88347dffdf8d13f79f82da18ed6da38 {
	meta:
		aliases = "__decode_dotted"
		size = "262"
		objfiles = "decoded@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 54 24 24 83 7C 24 20 00 0F 84 E5 00 00 00 31 ED C6 44 24 07 01 C7 44 24 08 00 00 00 00 EB 04 89 7C 24 08 3B 54 24 28 0F 8D C6 00 00 00 8B 4C 24 20 8A 04 11 84 C0 0F 84 AB 00 00 00 80 7C 24 07 01 0F B6 F0 89 F0 8D 4A 01 83 DD FF 25 C0 00 00 00 3D C0 00 00 00 75 2F 3B 4C 24 28 0F 8D 91 00 00 00 80 7C 24 07 01 8B 5C 24 20 89 F2 83 DD FF 83 E2 3F 0F B6 04 0B C1 E2 08 8B 7C 24 08 09 C2 C6 44 24 07 00 EB 98 8B 44 24 08 01 F0 89 C7 89 04 24 47 3B 7C 24 30 73 5A 8D 1C 0E 8D 43 01 3B 44 24 28 73 4E 56 8B 44 24 24 01 C8 50 8B 44 24 34 03 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 0C 89 DA }
	condition:
		$pattern
}

rule svcudp_reply_e1255ede34e57821d7d8b1d67b284889 {
	meta:
		aliases = "svcudp_reply"
		size = "469"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 6C 24 20 8B 5C 24 24 8B 7D 30 8B 47 0C C7 47 08 00 00 00 00 8D 77 08 6A 00 56 FF 50 14 8B 47 04 89 03 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 8F 01 00 00 8B 47 0C 56 FF 50 10 8D 55 3C 89 44 24 0C 5B 83 7A 0C 00 74 1D 8B 45 2C 89 45 34 8B 44 24 08 89 45 38 6A 00 52 FF 75 00 E8 ?? ?? ?? ?? 83 C4 0C EB 1B FF 75 0C 8D 45 10 50 6A 00 FF 74 24 14 FF 75 2C FF 75 00 E8 ?? ?? ?? ?? 83 C4 18 3B 44 24 08 0F 85 38 01 00 00 83 BF B0 01 00 00 00 74 07 83 7C 24 08 00 79 0A B8 01 00 00 00 E9 20 01 00 00 8B 7D 30 8B B7 B0 01 00 00 8B 56 0C 8B 46 08 8B 1C 90 85 DB 74 3C 8B 06 8B 0B 89 }
	condition:
		$pattern
}
...
rule readtcp_b10c528df304cf90618d45c597867ac3 {
	meta:
		aliases = "readtcp"
		size = "194"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C BB E8 03 00 00 8B 74 24 20 8B 6C 24 28 8B 4E 0C 89 C8 99 F7 FB 66 31 DB 89 C1 69 46 08 E8 03 00 00 85 ED 8D 3C 01 0F 84 85 00 00 00 8B 06 8D 5C 24 04 89 44 24 04 66 C7 44 24 08 01 00 57 6A 01 53 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 FF 74 0D 85 C0 75 24 C7 46 24 05 00 00 00 EB 16 E8 ?? ?? ?? ?? 83 38 04 74 D8 C7 46 24 04 00 00 00 8B 00 89 46 28 83 CB FF EB 3B 55 FF 74 24 28 FF 36 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 83 F8 FF 74 14 85 C0 75 21 C7 46 28 68 00 00 00 C7 46 24 04 00 00 00 EB D1 E8 ?? ?? ?? ?? 8B 00 C7 46 24 04 00 00 00 89 46 28 83 C4 0C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule readdir_r_5b37f2a13679f1765479806d3e2d8a60 {
	meta:
		aliases = "__GI_readdir_r, readdir_r"
		size = "190"
		objfiles = "readdir_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 31 FF 8B 74 24 24 8B 6C 24 2C 8D 5E 18 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 46 08 3B 46 04 77 35 FF 76 14 FF 76 0C FF 36 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 00 7F 16 C7 45 00 00 00 00 00 75 04 31 DB EB 46 E8 ?? ?? ?? ?? 8B 18 EB 3D 89 46 08 C7 46 04 00 00 00 00 8B 46 04 89 C7 03 7E 0C 0F B7 57 08 01 C2 89 56 04 8B 47 04 89 46 10 83 3F 00 74 A7 0F B7 47 08 50 57 FF 74 24 30 E8 ?? ?? ?? ?? 31 DB 89 45 00 83 C4 0C 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 31 C0 85 FF 0F 94 C0 F7 D8 21 C3 83 C4 18 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_readdir64_r_640468779bcb9830f403344d99410c0d {
	meta:
		aliases = "readdir64_r, __GI_readdir64_r"
		size = "192"
		objfiles = "readdir64_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 31 FF 8B 74 24 24 8B 6C 24 2C 8D 5E 18 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 46 08 3B 46 04 77 35 FF 76 14 FF 76 0C FF 36 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 00 7F 16 C7 45 00 00 00 00 00 75 04 31 DB EB 48 E8 ?? ?? ?? ?? 8B 18 EB 3F 89 46 08 C7 46 04 00 00 00 00 8B 56 04 89 D7 03 7E 0C 0F B7 47 10 01 D0 89 46 04 8B 47 08 89 46 10 8B 07 0B 47 04 74 A5 0F B7 47 10 50 57 FF 74 24 30 E8 ?? ?? ?? ?? 31 DB 89 45 00 83 C4 0C 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 31 C0 85 FF 0F 94 C0 F7 D8 21 C3 83 C4 18 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_srandom_r_589277939052857946789176d6e9c35d {
	meta:
		aliases = "srandom_r, __GI_srandom_r"
		size = "160"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 83 C9 FF 8B 74 24 28 8B 54 24 24 8A 46 0C 88 44 24 0B 0F BE C0 83 F8 04 77 75 8B 5E 08 85 D2 75 02 B2 01 89 13 80 7C 24 0B 00 74 61 0F BE 6E 0D 89 D9 BF 01 00 00 00 89 2C 24 EB 2A 89 D0 BD 1D F3 01 00 99 F7 FD 89 44 24 04 69 D2 A7 41 00 00 69 C0 14 0B 00 00 29 C2 79 06 81 C2 FF FF FF 7F 83 C1 04 47 89 11 3B 3C 24 7C D1 0F BE 46 0E 89 5E 04 8D 7C 24 0C 8D 04 83 89 06 6B 1C 24 0A EB 09 57 56 E8 ?? ?? ?? ?? 5D 58 4B 79 F4 31 C9 83 C4 10 89 C8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _dl_parse_7fb7dfaf210b24f4216a25bc9c1c3b20 {
	meta:
		aliases = "_dl_parse"
		size = "219"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 89 C5 89 CE C1 6C 24 24 03 89 14 24 8B 40 58 89 44 24 0C 8B 55 54 C7 44 24 04 00 00 00 00 89 54 24 08 E9 93 00 00 00 8B 5E 04 FF 74 24 08 FF 74 24 10 56 FF 74 24 0C 55 FF 54 24 3C 83 C4 14 89 C7 85 C0 74 6E FF 35 ?? ?? ?? ?? C1 EB 08 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 85 DB 74 1E 8B 54 24 0C 8B 44 24 08 C1 E3 04 03 04 13 50 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 83 FF 00 7D 19 FF 75 04 0F B6 46 04 50 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 83 C4 10 EB 2D 7E 14 FF 75 04 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 83 C4 0C EB 17 FF 44 24 04 83 C6 08 8B 44 24 24 39 44 24 }
	condition:
		$pattern
}

rule __GI_xdrrec_create_95e8a658e6e1201768876b2215071122 {
	meta:
		aliases = "xdrrec_create, __GI_xdrrec_create"
		size = "269"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 44 24 24 8B 74 24 28 89 44 24 0C 8B 44 24 30 89 44 24 08 8B 44 24 34 89 44 24 04 8B 44 24 38 8B 7C 24 2C 89 04 24 6A 44 E8 ?? ?? ?? ?? 5D 89 C3 83 FE 63 77 05 BE A0 0F 00 00 8D 6E 03 83 E5 FC 83 FF 63 77 05 BF A0 0F 00 00 83 C7 03 83 E7 FC 8D 44 3D 04 50 E8 ?? ?? ?? ?? 59 89 C6 85 DB 74 04 85 C0 75 26 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 89 74 24 30 83 C4 1C 5B 5E 5F 5D E9 ?? ?? ?? ?? 89 43 04 89 C2 83 E0 03 89 6B 3C 89 7B 40 74 05 29 C6 8D 56 04 8D 04 2A 89 53 0C 89 43 28 8B 44 24 0C C7 40 04 ?? ?? ?? ?? 89 58 0C 8B 44 24 08 89 03 8B 44 24 }
	condition:
		$pattern
}
...
rule getprotoent_r_aa7f81bcb6e84be32000686fa7efec96 {
	meta:
		aliases = "__GI_getprotoent_r, getprotoent_r"
		size = "415"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 44 24 30 8B 5C 24 2C 8B 6C 24 24 8B 7C 24 28 81 FB 8B 00 00 00 C7 00 00 00 00 00 77 15 E8 ?? ?? ?? ?? BB 22 00 00 00 C7 00 22 00 00 00 E9 5B 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 8D B7 8C 00 00 00 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8D 83 74 FF FF FF 83 C4 10 3D 00 10 00 00 77 15 E8 ?? ?? ?? ?? BB 22 00 00 00 C7 00 22 00 00 00 E9 04 01 00 00 83 3D ?? ?? ?? ?? 00 75 26 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5B A3 ?? ?? ?? ?? 5A 85 C0 75 0C E8 ?? ?? ?? ?? 8B 18 E9 D5 00 00 00 FF 35 ?? ?? ?? ?? 68 00 10 00 00 56 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 }
	condition:
		$pattern
}

rule wcsnrtombs_ab24d5138ac2265c9b85981036f7d41b {
	meta:
		aliases = "__GI_wcsnrtombs, wcsnrtombs"
		size = "127"
		objfiles = "wcsnrtombs@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 54 24 24 8B 6C 24 28 8B 4C 24 2C 8B 44 24 30 85 D2 74 10 BF 01 00 00 00 39 EA 75 0E 66 31 FF 89 E2 EB 07 89 E2 83 C8 FF 31 FF 89 C6 39 C8 76 02 89 CE 8B 4D 00 89 F3 EB 27 8B 01 83 F8 7F 76 10 E8 ?? ?? ?? ?? C7 00 54 00 00 00 83 C8 FF EB 1F 88 02 84 C0 75 04 31 C9 EB 0A 83 C1 04 01 FA 4B 85 DB 75 D5 39 E2 74 03 89 4D 00 89 F0 29 D8 83 C4 10 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __read_etc_hosts_r_e2c9e0363ef0f00e682edbef92ff625c {
	meta:
		aliases = "__read_etc_hosts_r"
		size = "542"
		objfiles = "read_etc_hosts_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 54 24 38 8B 4C 24 3C 89 D0 8B 74 24 44 F7 D8 83 E0 03 C7 06 FF FF FF FF 29 C1 8D 1C 02 89 C8 83 E8 20 89 44 24 08 0F 88 DB 01 00 00 8D 53 20 89 54 24 0C 83 7C 24 30 01 75 11 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 EB 55 83 E9 38 89 4C 24 08 83 F9 4F 0F 8E AC 01 00 00 E8 ?? ?? ?? ?? 89 44 24 24 85 C0 75 16 8B 44 24 40 C7 00 00 00 00 00 E8 ?? ?? ?? ?? 8B 28 E9 8E 01 00 00 8B 54 24 0C 8D 43 28 89 14 24 8D 53 38 89 44 24 04 89 54 24 0C 89 43 20 8B 04 24 C7 40 04 00 00 00 00 BD 01 00 00 00 C7 06 01 00 00 00 E9 28 01 00 00 6A 23 31 FF FF 74 24 10 E8 ?? ?? ?? ?? 5A 59 C6 }
	condition:
		$pattern
}

rule getprotobyname_r_f8ce662901d5a68eeac8aedc8aa3f828 {
	meta:
		aliases = "__GI_getprotobyname_r, getprotobyname_r"
		size = "182"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 6C 24 24 8B 74 24 28 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 14 EB 29 55 FF 36 E8 ?? ?? ?? ?? 59 85 C0 5B 74 36 8B 5E 04 EB 10 55 50 E8 ?? ?? ?? ?? 59 85 C0 5A 74 24 83 C3 04 8B 03 85 C0 75 EA FF 74 24 34 FF 74 24 34 FF 74 24 34 56 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 74 BC 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 8B 44 24 3C 83 38 00 0F 94 C0 0F B6 C0 F7 D8 83 C4 18 21 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule getservbyname_r_77982957ccd15ed35e0b7c67fffd0135 {
	meta:
		aliases = "__GI_getservbyname_r, getservbyname_r"
		size = "209"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 6C 24 28 8B 74 24 2C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 14 EB 44 FF 36 FF 74 24 28 E8 ?? ?? ?? ?? 5B 85 C0 5A 74 20 8B 5E 04 EB 13 50 FF 74 24 28 E8 ?? ?? ?? ?? 5A 85 C0 59 74 0B 83 C3 04 8B 03 85 C0 75 E7 EB 13 85 ED 74 2A 55 FF 76 0C E8 ?? ?? ?? ?? 59 85 C0 5B 74 1B FF 74 24 38 FF 74 24 38 FF 74 24 38 56 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 74 A1 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 8B 44 24 40 83 38 00 0F 94 C0 0F B6 C0 F7 D8 83 }
	condition:
		$pattern
}

rule fwide_5297e48770706a4aa67095ed5894a063 {
	meta:
		aliases = "fwide"
		size = "127"
		objfiles = "fwide@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 6C 24 28 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 85 ED 74 1D 8B 16 F7 C2 80 08 00 00 75 13 B8 00 08 00 00 85 ED 7F 05 B8 80 00 00 00 09 D0 66 89 06 0F B7 1E 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 89 D8 81 E3 80 00 00 00 25 00 08 00 00 83 C4 10 29 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule putgrent_564c9293e8fa1fe32b1dd6a17336ee62 {
	meta:
		aliases = "putgrent"
		size = "191"
		objfiles = "putgrent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 7C 24 28 85 F6 74 04 85 FF 75 13 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 E9 8B 00 00 00 8B 6F 34 85 ED 75 1C 8D 5F 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 FF 76 08 FF 76 04 FF 36 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 83 C4 14 85 C0 78 39 8B 5E 0C BA ?? ?? ?? ?? 8B 03 85 C0 75 12 57 6A 0A E8 ?? ?? ?? ?? 59 5B 31 DB 85 C0 79 1E EB 19 50 52 57 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 0A 83 C3 04 BA ?? ?? ?? ?? EB CF 83 CB FF 85 ED 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fgetpos_22d3177f14551a52028d9ea5f54919da {
	meta:
		aliases = "fgetpos"
		size = "115"
		objfiles = "fgetpos@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 7C 24 28 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 E8 ?? ?? ?? ?? 89 07 83 CB FF 59 85 C0 78 15 8B 46 2C 31 DB 89 47 04 8B 46 30 89 47 08 0F B6 46 02 89 47 0C 85 ED 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fgetpos64_21127bea4e40edf1b33e1a05489204e9 {
	meta:
		aliases = "fgetpos64"
		size = "118"
		objfiles = "fgetpos64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 7C 24 28 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 E8 ?? ?? ?? ?? 89 07 89 57 04 83 CB FF 59 85 D2 78 15 8B 46 2C 31 DB 89 47 08 8B 46 30 89 47 0C 0F B6 46 02 89 47 10 85 ED 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fsetpos_6b1653210da0687949cc5d1b0902e1d2 {
	meta:
		aliases = "fsetpos"
		size = "115"
		objfiles = "fsetpos@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 7C 24 28 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 6A 00 FF 37 56 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 C0 75 12 8B 47 04 89 46 2C 8B 47 08 89 46 30 8B 47 0C 88 46 02 85 ED 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fsetpos64_6be280bed40227769f6ee03ca59c6b41 {
	meta:
		aliases = "fsetpos64"
		size = "118"
		objfiles = "fsetpos64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 7C 24 28 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 6A 00 FF 77 04 FF 37 56 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 75 12 8B 47 08 89 46 2C 8B 47 0C 89 46 30 8B 47 10 88 46 02 85 ED 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_getprotobynumber_r_26887b3cea372f6ba996f46e05859c5e {
	meta:
		aliases = "getprotobynumber_r, __GI_getprotobynumber_r"
		size = "143"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 28 8B 6C 24 30 8B 7C 24 34 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 14 EB 09 8B 44 24 24 39 46 08 74 15 57 55 FF 74 24 34 56 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 74 E2 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 31 C0 83 3F 00 0F 94 C0 F7 D8 83 C4 18 21 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_ungetwc_f8f97c118c3fe31c6ed31af9f4a87c15 {
	meta:
		aliases = "ungetwc, __GI_ungetwc"
		size = "161"
		objfiles = "ungetwc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 28 8B 7C 24 24 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 03 08 00 00 3D 00 08 00 00 77 11 68 00 08 00 00 56 E8 ?? ?? ?? ?? 59 85 C0 5B 75 30 0F B7 06 A8 02 74 0A A8 01 75 25 83 7E 28 00 75 1F 83 FF FF 74 1A 8B 06 C7 46 28 01 00 00 00 40 66 89 06 83 E0 01 66 83 26 FB 89 7C 86 24 EB 03 83 CF FF 85 ED 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_ungetc_ce81b84959b4563b1bcd3e7e9582c5d8 {
	meta:
		aliases = "ungetc, __GI_ungetc"
		size = "198"
		objfiles = "ungetc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 28 8B 7C 24 24 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 46 10 3B 46 18 73 17 83 FF FF 74 12 3B 46 08 76 0D 89 FA 38 50 FF 75 06 48 89 46 10 EB 50 0F B7 06 25 83 00 00 00 3D 80 00 00 00 77 11 68 80 00 00 00 56 E8 ?? ?? ?? ?? 59 85 C0 5B 75 36 0F B7 06 A8 02 74 0A A8 01 75 2B 83 7E 28 00 75 25 83 FF FF 74 20 8B 46 08 C7 46 28 01 00 00 00 89 46 18 8B 06 40 66 89 06 83 E0 01 89 7C 86 24 66 83 26 FB EB 03 83 CF FF 85 ED 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule putspent_c074eb27cb48784f21b93026dcb57b27 {
	meta:
		aliases = "putspent"
		size = "207"
		objfiles = "putspent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 28 8B 7C 24 24 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 47 04 85 C0 75 05 B8 ?? ?? ?? ?? 50 31 DB FF 37 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 2B EB 59 0F B6 83 ?? ?? ?? ?? BA ?? ?? ?? ?? 8B 04 07 83 F8 FF 74 05 BA ?? ?? ?? ?? 50 52 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 31 43 83 FB 05 76 D2 8B 47 20 83 F8 FF 74 13 50 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 10 56 6A 0A E8 ?? ?? ?? ?? 59 5B 31 DB 85 C0 7F 03 83 CB FF 85 ED 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 }
	condition:
		$pattern
}

rule rresvport_24a7aa6cf50279bbcb2a4ad6e6021f6d {
	meta:
		aliases = "__GI_rresvport, rresvport"
		size = "137"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 7C 24 24 66 C7 04 24 02 00 C7 44 24 04 00 00 00 00 6A 00 6A 01 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 89 E5 85 C0 79 05 83 CB FF EB 4B 8B 07 66 C1 C8 08 66 89 44 24 02 6A 10 55 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 30 E8 ?? ?? ?? ?? 89 C6 83 38 62 74 08 53 E8 ?? ?? ?? ?? EB 18 8B 07 48 89 07 3D 00 02 00 00 75 C5 53 E8 ?? ?? ?? ?? C7 06 0B 00 00 00 83 CB FF 5E 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule unsetenv_25250d953346bf8f07f48b28d2c0a681 {
	meta:
		aliases = "__GI_unsetenv, unsetenv"
		size = "172"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 7C 24 24 85 FF 74 14 80 3F 00 74 0F 6A 3D 57 E8 ?? ?? ?? ?? 5B 5E 80 38 3D 75 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 71 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 89 C5 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 35 ?? ?? ?? ?? 29 FD 83 C4 10 85 F6 75 2C EB 30 55 57 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 18 80 3C 2B 3D 75 12 89 F2 8B 42 04 8D 4A 04 89 02 85 C0 74 07 89 CA EB F0 83 C6 04 8B 1E 85 DB 75 D0 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 5A 31 C0 59 83 C4 10 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule getservbyport_r_c090b9a324a2b2e39c3b1c553d0653c6 {
	meta:
		aliases = "__GI_getservbyport_r, getservbyport_r"
		size = "166"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 7C 24 28 8B 5C 24 2C 8B 6C 24 38 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 14 EB 1C 8B 44 24 24 39 43 08 75 13 85 FF 74 27 57 FF 73 0C E8 ?? ?? ?? ?? 59 85 C0 5A 74 18 55 FF 74 24 38 FF 74 24 38 53 E8 ?? ?? ?? ?? 83 C4 10 89 C6 85 C0 74 CC 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 31 C0 83 7D 00 00 0F 94 C0 F7 D8 83 C4 18 21 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _dl_load_shared_library_452904f68fa575a6553ae143ef5a2624 {
	meta:
		aliases = "_dl_load_shared_library"
		size = "474"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 C7 05 ?? ?? ?? ?? 00 00 00 00 8B 5C 24 30 8B 74 24 2C 8D 43 FF 40 80 38 00 75 FA 29 D8 3D 00 04 00 00 0F 87 87 01 00 00 8D 43 FF 31 C9 EB 07 80 FA 2F 75 02 89 C1 40 8A 10 84 D2 75 F2 89 DF 85 C9 74 03 8D 79 01 39 DF 74 19 53 FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 0C 85 C0 0F 85 68 01 00 00 85 F6 74 22 8B 4E 7C 85 C9 74 1B 03 4E 54 89 F8 FF 74 24 28 8B 54 24 28 E8 ?? ?? ?? ?? 5D 85 C0 0F 85 42 01 00 00 8B 0D ?? ?? ?? ?? 85 C9 74 18 FF 74 24 28 89 F8 8B 54 24 28 E8 ?? ?? ?? ?? 5B 85 C0 0F 85 20 01 00 00 85 F6 74 25 8B 8E B4 00 00 00 85 C9 74 1B 03 4E 54 89 F8 FF 74 24 }
	condition:
		$pattern
}

rule __GI_ceil_0561365aaee4b32537673cbf4d6f29fb {
	meta:
		aliases = "ceil, __GI_ceil"
		size = "310"
		objfiles = "s_ceil@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 DD 44 24 24 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 DD 54 24 08 8B 54 24 0C 8B 6C 24 08 89 D0 89 EE C1 F8 14 25 FF 07 00 00 8D 98 01 FC FF FF 83 FB 13 7F 7D 85 DB 79 38 DD 05 ?? ?? ?? ?? DE C1 D9 EE D9 C9 DA E9 DF E0 9E 0F 86 C4 00 00 00 85 D2 79 07 BA 00 00 00 80 EB 0F 89 E9 09 D1 0F 84 AF 00 00 00 BA 00 00 F0 3F 31 F6 E9 A3 00 00 00 DD D8 BF FF FF 0F 00 88 D9 D3 FF 89 F8 21 D0 09 E8 0F 84 9A 00 00 00 DD 44 24 24 DC 05 ?? ?? ?? ?? D9 EE D9 C9 DA E9 DF E0 9E 76 77 85 D2 7E 09 B8 00 00 10 00 D3 F8 01 C2 89 F8 F7 D0 21 C2 EB B8 DD D8 83 FB 33 7E 10 81 FB 00 04 00 00 75 }
	condition:
		$pattern
}

rule floor_ba8bff3e9d3fecff88c3b11a0e9d4834 {
	meta:
...
rule __GI_lround_312d4ca02e08251b4796d3e1989be423 {
	meta:
		aliases = "lround, __GI_lround"
		size = "198"
		objfiles = "s_lround@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 DD 44 24 24 DD 1C 24 8B 44 24 04 8B 2C 24 89 C1 89 C7 C1 E9 14 89 C2 81 E1 FF 07 00 00 81 E2 FF FF 0F 00 C1 FF 1F 81 CA 00 00 10 00 8D 99 01 FC FF FF 83 CF 01 83 FB 13 7F 23 85 DB 79 09 89 F8 43 74 74 31 C0 EB 70 88 D9 B8 00 00 08 00 D3 F8 B9 14 00 00 00 01 D0 29 D9 D3 E8 EB 57 83 FB 1E 7F 2B 81 E9 13 04 00 00 B8 00 00 00 80 D3 E8 8D 34 28 39 EE 83 D2 00 83 FB 14 89 D0 74 36 D3 E0 B9 34 00 00 00 29 D9 D3 EE 09 F0 EB 27 D9 7C 24 0E 66 8B 44 24 0E 80 CC 0C 66 89 44 24 0C DD 44 24 24 D9 6C 24 0C DB 5C 24 08 D9 6C 24 0E 8B 44 24 08 EB 03 0F AF C7 83 C4 10 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_ptsname_r_7d5ff45956865fe5e22e5eb75ebe4dfd {
	meta:
		aliases = "ptsname_r, __GI_ptsname_r"
		size = "144"
		objfiles = "ptsname@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 E8 ?? ?? ?? ?? 89 C7 8B 28 8D 44 24 0C 50 68 30 54 04 80 FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 53 6A 00 6A F6 8B 44 24 14 99 52 50 8D 5C 24 1B 53 E8 ?? ?? ?? ?? 83 C4 14 29 C3 83 C3 0A 89 C6 39 5C 24 2C 73 0D B8 22 00 00 00 C7 07 22 00 00 00 EB 2C 68 ?? ?? ?? ?? FF 74 24 2C E8 ?? ?? ?? ?? 56 FF 74 24 34 E8 ?? ?? ?? ?? 31 C0 83 C4 10 89 2F EB 0B C7 07 19 00 00 00 B8 19 00 00 00 83 C4 10 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule scandir_cdd370d88abc5c877d033ebb4a6efa6a {
	meta:
		aliases = "scandir"
		size = "322"
		objfiles = "scandir@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 FF 74 24 24 E8 ?? ?? ?? ?? 89 44 24 04 59 83 C8 FF 83 3C 24 00 0F 84 18 01 00 00 E8 ?? ?? ?? ?? 31 ED 89 C6 8B 00 89 44 24 0C C7 06 00 00 00 00 C7 44 24 04 00 00 00 00 C7 44 24 08 00 00 00 00 EB 76 83 7C 24 2C 00 74 12 57 FF 54 24 30 5A 85 C0 75 08 C7 06 00 00 00 00 EB 5D C7 06 00 00 00 00 3B 6C 24 08 75 2F C7 44 24 08 0A 00 00 00 85 ED 74 08 8D 54 2D 00 89 54 24 08 8B 44 24 08 C1 E0 02 50 FF 74 24 08 E8 ?? ?? ?? ?? 59 85 C0 5B 74 39 89 44 24 04 0F B7 5F 08 53 E8 ?? ?? ?? ?? 5A 85 C0 74 26 53 57 50 E8 ?? ?? ?? ?? 8B 54 24 10 83 C4 0C 89 04 AA 45 FF 34 24 E8 ?? ?? ?? ?? 5B }
	condition:
		$pattern
}

rule scandir64_0096efe4e846df35df63ac69d1309b07 {
	meta:
		aliases = "scandir64"
		size = "322"
		objfiles = "scandir64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 FF 74 24 24 E8 ?? ?? ?? ?? 89 44 24 04 59 83 C8 FF 83 3C 24 00 0F 84 18 01 00 00 E8 ?? ?? ?? ?? 31 ED 89 C6 8B 00 89 44 24 0C C7 06 00 00 00 00 C7 44 24 04 00 00 00 00 C7 44 24 08 00 00 00 00 EB 76 83 7C 24 2C 00 74 12 57 FF 54 24 30 5A 85 C0 75 08 C7 06 00 00 00 00 EB 5D C7 06 00 00 00 00 3B 6C 24 08 75 2F C7 44 24 08 0A 00 00 00 85 ED 74 08 8D 54 2D 00 89 54 24 08 8B 44 24 08 C1 E0 02 50 FF 74 24 08 E8 ?? ?? ?? ?? 59 85 C0 5B 74 39 89 44 24 04 0F B7 5F 10 53 E8 ?? ?? ?? ?? 5A 85 C0 74 26 53 57 50 E8 ?? ?? ?? ?? 8B 54 24 10 83 C4 0C 89 04 AA 45 FF 34 24 E8 ?? ?? ?? ?? 5B }
	condition:
		$pattern
}
...
rule svctcp_create_1af7a5c1a9c556fa016fb69f4f778831 {
	meta:
		aliases = "svctcp_create"
		size = "323"
		objfiles = "svc_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 31 ED 8B 5C 24 28 C7 44 24 10 10 00 00 00 83 FB FF 75 26 6A 06 6A 01 6A 02 E8 ?? ?? ?? ?? 66 BD 01 00 83 C4 0C 89 C3 85 C0 79 0E 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 F6 EB 6E 31 C0 89 E6 89 E7 AB AB AB AB 66 C7 04 24 02 00 56 53 E8 ?? ?? ?? ?? 5F 85 C0 5A 74 15 66 C7 44 24 02 00 00 FF 74 24 10 56 53 E8 ?? ?? ?? ?? 83 C4 0C 8D 44 24 10 50 56 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 0E 6A 02 53 E8 ?? ?? ?? ?? 5A 85 C0 59 74 21 68 ?? ?? ?? ?? 31 F6 E8 ?? ?? ?? ?? 58 85 ED 0F 84 91 00 00 00 53 E8 ?? ?? ?? ?? 58 E9 85 00 00 00 6A 08 E8 ?? ?? ?? ?? 68 34 01 00 00 89 C7 E8 ?? ?? ?? ?? 5D }
	condition:
		$pattern
}

rule fcloseall_0fa317a32bc157744f32ea3de020dc6e {
	meta:
		aliases = "fcloseall"
		size = "219"
		objfiles = "fcloseall@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 0C 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 6A 01 40 53 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 24 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 8B 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? C7 44 24 0C 00 00 00 00 83 C4 0C EB 57 8B 7E 34 8B 6E 20 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 83 E0 30 83 F8 30 74 12 56 E8 ?? ?? ?? ?? 59 85 C0 74 07 C7 04 24 FF FF FF FF 85 FF 75 0E 6A 01 8D 44 24 08 50 E8 ?? ?? ?? ?? 58 5A 89 EE 85 }
	condition:
		$pattern
}

rule rendezvous_request_09322c5c5176a55bafe8f268f4ad6c24 {
	meta:
		aliases = "rendezvous_request"
		size = "90"
		objfiles = "svc_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 89 E6 8B 5C 24 28 8D 6C 24 10 8B 7B 2C C7 44 24 10 10 00 00 00 55 56 FF 33 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 0C E8 ?? ?? ?? ?? 83 38 04 75 1A EB DC 8B 4F 04 8B 17 E8 ?? ?? ?? ?? 8D 78 10 A5 A5 A5 A5 8B 54 24 10 89 50 0C 83 C4 14 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_getservent_r_cbf2bbf6711b2e604c1d96c8fb1954e9 {
	meta:
		aliases = "getservent_r, __GI_getservent_r"
		size = "469"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 44 24 34 8B 5C 24 30 8B 7C 24 28 8B 6C 24 2C 81 FB 8B 00 00 00 C7 00 00 00 00 00 77 15 E8 ?? ?? ?? ?? BB 22 00 00 00 C7 00 22 00 00 00 E9 91 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8D 85 8C 00 00 00 89 44 24 10 8D 83 74 FF FF FF 83 C4 10 3D 00 10 00 00 77 15 E8 ?? ?? ?? ?? BB 22 00 00 00 C7 00 22 00 00 00 E9 36 01 00 00 83 3D ?? ?? ?? ?? 00 75 2F 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5B A3 ?? ?? ?? ?? 5E 85 C0 75 15 E8 ?? ?? ?? ?? BB 05 00 00 00 C7 00 05 00 00 00 E9 FE 00 00 00 FF 35 ?? ?? ?? ?? 68 00 10 }
	condition:
		$pattern
}

rule __GI_fflush_unlocked_48a54e28fc85132ce2889988d43312ea {
	meta:
		aliases = "fflush_unlocked, __GI_fflush_unlocked"
		size = "300"
		objfiles = "fflush_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 5C 24 28 66 C7 44 24 02 00 00 81 FB ?? ?? ?? ?? 74 0F 66 C7 44 24 02 00 01 85 DB 0F 85 D8 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 0C 31 FF 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 6A 01 40 53 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 24 89 DD 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 8B 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 0C EB 68 F6 06 40 74 60 83 3D ?? ?? ?? ?? 02 74 18 8D 5E 38 53 68 ?? ?? ?? ?? 55 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 66 8B 44 24 02 0B 06 66 35 40 01 A9 40 03 00 00 75 1A 56 E8 }
	condition:
		$pattern
}

rule sigaction_f96ff54e1135d0ba7549a2fbc8a0576a {
	meta:
		aliases = "__GI_sigaction, sigaction"
		size = "182"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 5C 24 28 8B 7C 24 2C 8B 6C 24 30 3B 1D ?? ?? ?? ?? 0F 84 84 00 00 00 3B 1D ?? ?? ?? ?? 74 7C 3B 1D ?? ?? ?? ?? 75 04 85 DB 7F 70 31 C0 85 FF 74 34 89 E6 6A 14 57 56 E8 ?? ?? ?? ?? 83 C4 0C 83 3F 01 76 1F 85 DB 7E 1B 83 FB 40 7F 16 F6 47 04 04 74 09 C7 04 24 ?? ?? ?? ?? EB 07 C7 04 24 ?? ?? ?? ?? 89 E0 55 50 53 E8 ?? ?? ?? ?? 83 C4 0C 83 CA FF 40 74 2E 8D 43 FF 83 F8 3F 77 24 85 ED 74 0A 8B 04 9D ?? ?? ?? ?? 89 45 00 85 FF 74 12 8B 07 89 04 9D ?? ?? ?? ?? EB 07 BA 16 00 00 00 EB 02 31 D2 83 C4 14 89 D0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_bindresvport_3ed4567c3c1a2f35a0450749ef23b4aa {
	meta:
		aliases = "bindresvport, __GI_bindresvport"
		size = "197"
		objfiles = "bindresvport@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 5C 24 2C 8B 6C 24 28 85 DB 75 17 8D 54 24 04 89 D8 89 D7 AB AB AB AB 89 D3 66 C7 44 24 04 02 00 EB 16 66 83 3B 02 74 10 E8 ?? ?? ?? ?? C7 00 60 00 00 00 83 C8 FF EB 7D 66 83 3D ?? ?? ?? ?? 00 75 1B E8 ?? ?? ?? ?? BA A8 01 00 00 89 D1 99 F7 F9 66 81 C2 58 02 66 89 15 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 FF 89 C6 C7 00 62 00 00 00 83 C8 FF EB 33 66 A1 ?? ?? ?? ?? 89 C2 40 66 C1 CA 08 66 3D FF 03 66 89 53 02 66 A3 ?? ?? ?? ?? 7E 09 66 C7 05 ?? ?? ?? ?? 58 02 6A 10 53 55 47 E8 ?? ?? ?? ?? 83 C4 0C 81 FF A7 01 00 00 7F 09 85 C0 79 05 83 3E 62 74 BC 83 C4 14 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule free_40677dfa3f1f19786ca72a9f11bfff66 {
	meta:
		aliases = "free"
		size = "399"
		objfiles = "free@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 6C 24 28 85 ED 0F 84 74 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8D 4D F8 A1 ?? ?? ?? ?? 83 C4 10 89 CF 8B 51 04 89 D3 83 E3 FC 39 C3 77 23 89 DA 83 C8 03 C1 EA 03 A3 ?? ?? ?? ?? 8B 04 95 ?? ?? ?? ?? 89 41 08 89 0C 95 ?? ?? ?? ?? E9 0C 01 00 00 80 E2 02 0F 85 E6 00 00 00 83 C8 01 8D 34 19 A3 ?? ?? ?? ?? 8B 46 04 89 04 24 F6 41 04 01 75 21 89 C8 8B 6D F8 29 E8 8B 48 08 8B 50 0C 8B 79 0C 39 C7 75 39 39 7A 08 75 34 01 EB 89 51 0C 89 4A 08 8B 0C 24 83 E1 FC 3B 35 ?? ?? ?? ?? 74 50 8B 44 0E 04 89 4E 04 83 E0 01 85 C0 }
	condition:
		$pattern
}

rule re_search_2_9174eed0357fb75ed3dac7d5a43c3c41 {
	meta:
		aliases = "__GI_re_search_2, re_search_2"
		size = "530"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 6C 24 28 8B 7C 24 38 03 7C 24 30 8B 5C 24 3C 8B 45 10 8B 74 24 40 89 44 24 10 85 DB 8B 55 14 89 7C 24 08 89 54 24 0C 0F 88 BE 01 00 00 39 FB 0F 8F B6 01 00 00 89 F0 01 D8 79 06 89 DE F7 DE EB 0C 3B 44 24 08 7E 06 8B 74 24 08 29 DE 83 7D 08 00 74 24 85 F6 7E 20 8B 45 00 8A 00 3C 0B 74 0A 3C 09 75 13 80 7D 1C 00 78 0D 85 DB 0F 8F 79 01 00 00 BE 01 00 00 00 83 7C 24 10 00 0F 84 11 01 00 00 F6 45 1C 08 75 10 55 E8 ?? ?? ?? ?? 59 83 F8 FE 0F 84 58 01 00 00 83 7C 24 10 00 0F 84 F0 00 00 00 3B 5C 24 08 0F 8D E6 00 00 00 F6 45 1C 01 0F 85 DC 00 00 00 85 F6 0F 8E 90 00 00 00 3B }
	condition:
		$pattern
}

rule __GI_getdelim_42a5291573fffaac8cd0c452f46823bf {
	meta:
		aliases = "getdelim, __GI_getdelim"
		size = "235"
		objfiles = "getdelim@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 6C 24 2C 8B 7C 24 34 83 7C 24 28 00 74 08 85 ED 74 04 85 FF 75 13 E8 ?? ?? ?? ?? 83 CF FF C7 00 16 00 00 00 E9 B0 00 00 00 8B 47 34 89 04 24 85 C0 75 1C 8D 5F 38 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 44 24 28 8B 18 85 DB 75 07 C7 45 00 00 00 00 00 BE 01 00 00 00 8B 45 00 39 C6 72 21 83 C0 40 50 53 E8 ?? ?? ?? ?? 5B 85 C0 5A 75 05 83 CF FF EB 44 83 45 00 40 89 C3 8B 44 24 28 89 18 8B 47 10 3B 47 18 73 09 0F B6 10 40 89 47 10 EB 0E 57 E8 ?? ?? ?? ?? 59 89 C2 83 F8 FF 74 0B 46 88 54 1E FE 3B 54 24 30 75 AE 89 F7 83 EF 02 78 07 8D 7E }
	condition:
		$pattern
}

rule memalign_b5cfef5b54281d6adf4e1e0edfbb8c46 {
	meta:
		aliases = "memalign"
		size = "359"
		objfiles = "memalign@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 74 24 28 8B 5C 24 2C 83 FE 08 77 0E 53 E8 ?? ?? ?? ?? 5D 89 C3 E9 3B 01 00 00 83 FE 0F 77 05 BE 10 00 00 00 8D 46 FF BA 10 00 00 00 85 C6 75 04 EB 08 01 D2 39 F2 72 FA 89 D6 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 FB DF 76 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 E3 00 00 00 8D 43 0B C7 04 24 10 00 00 00 83 F8 0F 76 06 83 E0 F8 89 04 24 8B 14 24 31 DB 8D 44 32 10 50 E8 ?? ?? ?? ?? 5F 89 C5 85 C0 0F 84 A6 00 00 00 31 D2 8D 78 F8 F7 F6 85 D2 74 5B 89 F2 8D 44 35 FF F7 DA 21 D0 8D 58 F8 89 D8 29 F8 83 F8 0F }
	condition:
		$pattern
}

rule setvbuf_48c8cab778dfe0d63ed272279179d84f {
	meta:
		aliases = "__GI_setvbuf, setvbuf"
		size = "241"
		objfiles = "setvbuf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 7C 24 28 8B 74 24 2C 8B 6C 24 34 8B 47 34 89 04 24 85 C0 75 1C 8D 5F 38 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 30 02 76 13 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 E9 80 00 00 00 8B 17 83 CB FF F7 C2 CF 08 00 00 75 73 8B 44 24 30 80 E6 FC C1 E0 08 09 C2 66 89 17 83 7C 24 30 02 74 04 85 ED 75 08 31 F6 31 ED 31 DB EB 21 31 DB 85 F6 75 1B 8B 47 0C 2B 47 08 39 E8 74 3F 55 E8 ?? ?? ?? ?? 5E 85 C0 74 34 89 C6 66 BB 00 40 8B 07 F6 C4 40 74 0F 80 E4 BF 66 89 07 FF 77 08 E8 ?? ?? ?? ?? 59 66 09 1F 8D 04 2E 89 77 08 89 47 0C 89 77 10 }
	condition:
		$pattern
}
...
rule authunix_validate_a41cc691182e95df8e7a3562c3bb8009 {
	meta:
		aliases = "authunix_validate"
		size = "148"
		objfiles = "auth_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 44 24 30 8B 6C 24 2C 83 38 02 75 73 8B 75 24 6A 01 FF 70 08 FF 70 04 8D 7C 24 0C 57 E8 ?? ?? ?? ?? 8B 46 10 83 C4 10 85 C0 74 0E 50 E8 ?? ?? ?? ?? C7 46 10 00 00 00 00 5B 8D 5E 0C 53 57 E8 ?? ?? ?? ?? 5A 85 C0 59 74 0E 6A 0C 53 55 E8 ?? ?? ?? ?? 83 C4 0C EB 21 C7 04 24 02 00 00 00 53 57 E8 ?? ?? ?? ?? C7 46 10 00 00 00 00 6A 0C 56 55 E8 ?? ?? ?? ?? 83 C4 14 89 E8 E8 ?? ?? ?? ?? 83 C4 18 B8 01 00 00 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule lockf64_9e744de7f8910367b5bf491684b1e4e6 {
	meta:
		aliases = "__GI_lockf64, lockf64"
		size = "253"
		objfiles = "lockf64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 4C 24 34 8B 5C 24 38 89 C8 8B 6C 24 2C 99 8B 74 24 30 39 D3 75 04 39 C9 74 10 E8 ?? ?? ?? ?? C7 00 4B 00 00 00 E9 A9 00 00 00 31 C0 89 E2 89 E7 AB AB AB AB AB AB 66 C7 44 24 02 01 00 C7 44 24 04 00 00 00 00 C7 44 24 08 00 00 00 00 89 4C 24 0C 89 5C 24 10 83 FE 01 74 54 7F 06 85 F6 74 46 EB 66 83 FE 02 74 54 83 FE 03 75 5C 66 C7 04 24 00 00 52 6A 0C 55 E8 ?? ?? ?? ?? 83 C4 0C 83 CA FF 85 C0 78 66 66 83 3C 24 02 74 5D 8B 5C 24 14 E8 ?? ?? ?? ?? 39 C3 74 50 E8 ?? ?? ?? ?? C7 00 0D 00 00 00 EB 2D 66 C7 04 24 02 00 EB 13 BA 07 00 00 00 66 C7 04 24 01 00 EB 1D 66 C7 04 24 01 }
	condition:
		$pattern
}

rule svcudp_recv_b8443949dda71d40b1678057a8bac9f5 {
	meta:
		aliases = "svcudp_recv"
		size = "495"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 6C 24 2C 8D 45 34 8B 7D 30 8D 5D 3C 89 44 24 04 8B 54 24 04 C7 44 24 14 10 00 00 00 89 54 24 0C 89 DE 83 7B 0C 00 8D 55 10 74 4D 8B 45 2C 89 45 34 8B 4C 24 0C 8B 07 89 41 04 8D 45 58 89 55 3C 89 4B 08 C7 43 0C 01 00 00 00 C7 43 04 10 00 00 00 89 43 10 C7 43 14 DC 00 00 00 6A 00 53 FF 75 00 E8 ?? ?? ?? ?? 83 C4 0C 89 C2 85 C0 78 23 8B 43 04 89 44 24 14 EB 1A 8D 44 24 14 50 52 6A 00 FF 37 FF 75 2C FF 75 00 E8 ?? ?? ?? ?? 83 C4 18 89 C2 8B 44 24 14 83 FA FF 89 45 0C 75 13 E8 ?? ?? ?? ?? 83 38 04 0F 85 31 01 00 00 E9 5F FF FF FF 83 FA 0F 0F 8E 23 01 00 00 8B 47 0C 8D 5F 08 }
	condition:
		$pattern
}

rule __wcstofpmax_fec7e32533ed14656254b176cff8863b {
	meta:
		aliases = "__wcstofpmax"
		size = "508"
		objfiles = "__wcstofpmax@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 7C 24 34 8B 5C 24 2C EB 03 83 C3 04 FF 33 E8 ?? ?? ?? ?? 5A 85 C0 75 F1 8B 03 83 F8 2B 74 0D 31 ED 83 F8 2D 75 0B 66 BD 01 00 EB 02 31 ED 83 C3 04 D9 EE 31 C9 83 CA FF EB 2D 81 FA 00 00 00 80 83 DA FF 85 D2 75 05 83 F8 30 74 18 42 83 FA 15 7F 12 D8 0D ?? ?? ?? ?? 83 E8 30 50 DB 04 24 DE C1 83 C4 04 83 C3 04 A1 ?? ?? ?? ?? 89 44 24 14 8B 03 8B 74 24 14 F6 04 46 08 75 BE 83 F8 2E 75 0B 85 C9 75 07 83 C3 04 89 D9 EB DB 85 D2 79 6A 85 C9 75 5D 31 F6 31 C9 8D 7E 01 EB 30 41 80 BC 39 ?? ?? ?? ?? 00 75 25 DD D8 56 DB 04 24 DC 35 ?? ?? ?? ?? 83 C4 04 85 ED 74 02 D9 E0 0F B6 86 }
	condition:
		$pattern
}

rule __GI_fseeko64_102c5981dd4b77379b6c259a45a299b2 {
	meta:
		aliases = "fseeko64, __GI_fseeko64"
		size = "212"
		objfiles = "fseeko64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 7C 24 38 8B 44 24 30 8B 54 24 34 8B 74 24 2C 89 44 24 10 89 54 24 14 83 FF 02 76 13 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 E9 93 00 00 00 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 F6 06 40 74 0B 56 E8 ?? ?? ?? ?? 5A 85 C0 75 4B 83 FF 01 75 11 8D 44 24 10 50 56 E8 ?? ?? ?? ?? 59 85 C0 5B 78 35 57 8D 44 24 14 50 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 22 66 83 26 B8 8B 46 08 31 DB 89 46 10 89 46 14 89 46 18 89 46 1C C7 46 2C 00 00 00 00 C6 46 02 00 EB 03 83 CB FF 85 ED 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __pgsreader_fb065debabcda474b8420fdc9b79aeef {
	meta:
		aliases = "__pgsreader"
		size = "265"
		objfiles = "__pgsreader@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 7C 24 38 8B 74 24 34 8B 6C 24 3C 81 FF FF 00 00 00 77 15 E8 ?? ?? ?? ?? BB 22 00 00 00 C7 00 22 00 00 00 E9 CF 00 00 00 8B 45 34 89 44 24 04 85 C0 74 0A 8D 14 3E 31 DB 89 14 24 EB 1E 8D 5D 38 53 68 ?? ?? ?? ?? 8D 44 24 10 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 EB D8 55 57 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 14 0F B7 45 00 83 E0 04 83 F8 01 19 DB 83 E3 20 83 C3 02 EB 64 56 E8 ?? ?? ?? ?? 59 8D 54 06 FF 80 3A 0A 75 05 C6 02 00 EB 08 40 39 F8 75 03 43 EB C0 85 DB 74 03 4B EB B9 8A 06 84 C0 74 B3 3C 23 74 AF 0F B6 D0 A1 ?? ?? ?? ?? F6 04 50 20 75 A1 81 7C 24 2C ?? ?? }
	condition:
		$pattern
}

rule __malloc_consolidate_1471c22ebab7e67a31a644b33d25620b {
	meta:
		aliases = "__malloc_consolidate"
		size = "379"
		objfiles = "free@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 BA 01 00 00 00 8B 6C 24 2C 8B 45 00 85 C0 0F 84 F9 00 00 00 83 E0 FD 8D 55 34 89 45 00 8D 5D 04 C1 E8 03 89 54 24 10 89 5C 24 04 8D 44 85 FC 89 44 24 08 8B 44 24 04 8B 08 85 C9 0F 84 B8 00 00 00 C7 00 00 00 00 00 8B 51 08 89 54 24 0C 8B 41 04 89 C7 83 E7 FE A8 01 8D 14 39 8B 5A 04 89 1C 24 75 28 8B 01 89 44 24 14 89 C8 2B 44 24 14 8B 70 08 8B 58 0C 8B 4E 0C 39 C1 75 38 39 4B 08 75 33 03 7C 24 14 89 5E 0C 89 73 08 8B 34 24 83 E6 FC 3B 55 2C 74 4B 8B 44 32 04 89 72 04 83 E0 01 85 C0 75 1D 8B 5A 08 8B 42 0C 39 53 0C 75 05 39 50 08 74 05 E8 ?? ?? ?? ?? 01 F7 89 43 0C 89 58 08 }
	condition:
		$pattern
}

rule __GI___res_init_7f38d222c984a6616e563f9c76c6eb7e {
	meta:
		aliases = "__res_init, __GI___res_init"
		size = "320"
		objfiles = "res_init@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 89 C3 8D 44 24 10 50 89 DF E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? 31 C0 B9 19 00 00 00 F3 AB C7 03 01 00 00 00 C6 43 52 05 C6 43 53 03 C6 43 51 01 A1 ?? ?? ?? ?? 83 C4 10 B9 07 00 00 00 83 F8 07 77 02 89 C1 31 D2 EB 0D A1 ?? ?? ?? ?? 8B 04 90 89 44 93 34 42 39 CA 7C EF 31 ED C7 44 24 04 00 00 00 00 C7 04 24 00 00 00 00 EB 70 6B 74 24 04 1C 89 F2 03 15 ?? ?? ?? ?? 66 83 3A 02 75 23 8B 04 24 6A 10 C1 E0 04 52 8D 7C 03 04 57 E8 ?? ?? ?? ?? 83 C4 0C 83 FD 02 77 05 89 }
	condition:
		$pattern
}

rule __GI_svcudp_bufcreate_8233c1a03f48e0d65c2c07f7d3db475a {
	meta:
		aliases = "svcudp_bufcreate, __GI_svcudp_bufcreate"
		size = "454"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 31 F6 8B 6C 24 30 C7 44 24 18 10 00 00 00 83 FD FF 75 24 6A 11 6A 02 6A 02 E8 ?? ?? ?? ?? 66 BE 01 00 83 C4 0C 89 C5 85 C0 79 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? EB 68 8D 5C 24 04 31 C0 89 DF AB AB AB AB 66 C7 44 24 04 02 00 53 55 E8 ?? ?? ?? ?? 5A 85 C0 59 74 15 66 C7 44 24 06 00 00 FF 74 24 18 53 55 E8 ?? ?? ?? ?? 83 C4 0C 8D 44 24 18 50 53 55 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 2E 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5F 85 F6 C7 04 24 00 00 00 00 0F 84 1B 01 00 00 55 E8 ?? ?? ?? ?? C7 44 24 04 00 00 00 00 5B E9 07 01 00 00 68 34 01 00 00 E8 ?? ?? ?? ?? 89 44 24 04 68 B4 01 00 00 E8 }
	condition:
		$pattern
}

rule __GI_hsearch_r_8a0494f843480decc1f364f75236173f {
	meta:
		aliases = "hsearch_r, __GI_hsearch_r"
		size = "368"
		objfiles = "hsearch_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 44 24 30 8B 54 24 34 89 54 24 14 89 44 24 10 50 E8 ?? ?? ?? ?? 5A 89 C1 EB 0F 8B 5C 24 10 89 C2 C1 E2 04 0F B6 04 0B 01 D0 49 83 F9 FF 75 EB 8B 54 24 40 8B 52 04 89 54 24 08 31 D2 F7 74 24 08 89 D6 85 D2 75 04 66 BE 01 00 6B C6 0C 8B 4C 24 40 8B 09 89 CB 89 4C 24 0C 01 C3 8B 03 85 C0 0F 84 8D 00 00 00 39 F0 75 1D FF 73 04 FF 74 24 14 E8 ?? ?? ?? ?? 5F 85 C0 5D 75 0B 8D 43 04 8B 5C 24 3C 89 03 EB 5C 8B 54 24 08 89 F0 83 EA 02 89 F3 89 D1 31 D2 F7 F1 8B 44 24 08 8D 6A 01 29 E8 89 44 24 04 39 EB 77 06 03 5C 24 04 EB 02 29 EB 39 F3 74 3E 6B C3 0C 8B 7C 24 0C 01 C7 8B 17 89 }
	condition:
		$pattern
}

rule _svcauth_unix_9c642b4f18f01541d166731d17025be9 {
	meta:
		aliases = "_svcauth_unix"
		size = "383"
		objfiles = "svc_authux@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 44 24 30 8B 78 18 8D 47 18 89 47 04 8D 87 18 01 00 00 89 47 14 8B 54 24 34 8B 52 20 89 14 24 6A 01 52 8B 4C 24 3C FF 71 1C 8D 5C 24 10 53 E8 ?? ?? ?? ?? FF 74 24 10 53 8B 44 24 20 FF 50 18 83 C4 18 89 C2 85 C0 0F 84 92 00 00 00 8B 00 0F C8 89 07 8B 72 04 0F CE 81 FE FF 00 00 00 0F 87 F2 00 00 00 8D 5A 08 56 53 8D 6E 03 FF 77 04 83 E5 FC E8 ?? ?? ?? ?? 8B 47 04 8D 14 2B 83 C4 0C C6 04 30 00 8B 02 0F C8 89 47 08 8B 42 04 0F C8 89 47 0C 8B 4A 08 0F C9 83 F9 10 0F 87 B5 00 00 00 8D 5A 0C 31 F6 89 4F 10 EB 0E 8B 57 14 8B 03 83 C3 04 0F C8 89 04 B2 46 39 CE 72 EE 8D 44 8D 14 }
	condition:
		$pattern
}

rule realloc_4cef2d11659cf216f9f0762e695018fb {
	meta:
		aliases = "realloc"
		size = "762"
		objfiles = "realloc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 5C 24 34 83 7C 24 30 00 75 0A 53 E8 ?? ?? ?? ?? 89 C3 EB 0D 85 DB 75 0F FF 74 24 30 E8 ?? ?? ?? ?? 58 E9 C1 02 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 14 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 FB DF 76 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 89 02 00 00 8D 43 0B C7 44 24 04 10 00 00 00 83 F8 0F 76 07 83 E0 F8 89 44 24 04 8B 7C 24 30 83 EF 08 8B 57 04 89 D5 83 E5 FC F6 C2 02 0F 85 83 01 00 00 89 EB 3B 6C 24 04 0F 83 23 01 00 00 8D 34 2F 3B 35 ?? ?? ?? ?? 75 3B 8B 46 04 83 E0 FC 8D 0C 28 8B 44 24 04 83 C0 10 39 C1 72 62 83 E2 01 0B 54 24 04 }
	condition:
		$pattern
}

rule __strtofpmax_07baebf2999fa7b728bbe159013f671a {
	meta:
		aliases = "__strtofpmax"
		size = "517"
		objfiles = "__strtofpmax@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 7C 24 38 8B 5C 24 30 EB 01 43 A1 ?? ?? ?? ?? 89 44 24 18 8A 13 8B 4C 24 18 0F B6 C2 F6 04 41 20 75 E7 80 FA 2B 74 15 C7 04 24 00 00 00 00 80 FA 2D 75 11 C7 04 24 01 00 00 00 EB 07 C7 04 24 00 00 00 00 43 D9 EE 31 F6 83 C9 FF EB 2F 81 F9 00 00 00 80 83 D9 FF 85 C9 75 05 80 FA 30 74 1C 41 83 F9 15 7F 16 8B 44 24 08 D8 0D ?? ?? ?? ?? 83 E8 30 50 DB 04 24 DE C1 83 C4 04 43 8A 13 8B 44 24 18 0F B6 EA 89 6C 24 08 F6 04 68 08 75 BE 80 FA 2E 75 09 85 F6 75 05 43 89 DE EB DF 85 C9 79 69 85 F6 75 5C 31 C9 31 D2 8D 71 01 EB 32 42 80 BC 32 ?? ?? ?? ?? 00 75 27 DD D8 51 DB 04 24 DC }
	condition:
		$pattern
}

rule __ieee754_sqrt_44d85e485a494a22753a9254ab6c1888 {
	meta:
		aliases = "sqrt, __GI_sqrt, __ieee754_sqrt"
		size = "449"
		objfiles = "e_sqrt@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C DD 44 24 30 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 DD 54 24 08 8B 54 24 0C 8B 5C 24 08 89 D0 25 00 00 F0 7F 3D 00 00 F0 7F 75 0B D8 C8 DC 44 24 30 E9 72 01 00 00 DD D8 85 D2 7F 20 89 D0 25 FF FF FF 7F 09 D8 0F 84 61 01 00 00 85 D2 74 0D DD 44 24 30 D8 E0 D8 F0 E9 4C 01 00 00 89 D7 31 C9 C1 FF 14 74 0D EB 36 89 DA 83 E9 15 C1 EA 0B C1 E3 15 85 D2 74 F1 31 F6 EB 03 01 D2 46 F7 C2 00 00 10 00 74 F5 8D 46 FF 89 CF B9 20 00 00 00 29 C7 29 F1 89 D8 D3 E8 89 F1 09 C2 D3 E3 81 EF FF 03 00 00 81 E2 FF FF 0F 00 89 7C 24 18 81 CA 00 00 10 00 83 E7 01 74 0A 89 D8 01 DB C1 E8 1F }
	condition:
		$pattern
}

rule __add_to_environ_1ed7bf914e4f34ad4ceed4cb4ba25ff1 {
	meta:
		aliases = "__add_to_environ"
		size = "331"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 89 C5 89 54 24 04 89 0C 24 6A 3D 50 E8 ?? ?? ?? ?? 59 5B 89 C7 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 18 29 EF 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8B 35 ?? ?? ?? ?? 85 F6 C7 44 24 08 00 00 00 00 74 32 EB 2A 57 55 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 14 80 3C 3B 3D 75 0E 31 DB 83 3C 24 00 0F 84 C1 00 00 00 EB 5F FF 44 24 08 83 C6 04 8B 1E 85 DB 75 D0 8B 74 24 08 C1 E6 02 8D 46 08 50 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C3 58 85 DB 5A 74 5D A1 ?? ?? ?? ?? 3B 05 ?? ?? ?? ?? 74 0B 56 50 53 E8 ?? ?? ?? ?? 83 C4 0C 8D 34 33 89 1D ?? ?? ?? ?? 89 1D ?? ?? ?? ?? }
	condition:
		$pattern
}

rule inet_pton_967b9d04f204c6a5060cf8943756fe67 {
	meta:
		aliases = "__GI_inet_pton, inet_pton"
		size = "458"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 44 24 34 8B 74 24 38 83 F8 02 74 0B 83 F8 0A 0F 85 97 01 00 00 EB 10 8B 54 24 3C 89 F0 E8 ?? ?? ?? ?? E9 93 01 00 00 8D 54 24 10 31 C0 89 D7 AB AB AB AB 80 3E 3A 75 0A 46 80 3E 3A 0F 85 66 01 00 00 89 74 24 0C 89 54 24 04 C7 44 24 08 00 00 00 00 E9 8B 00 00 00 0F B6 C3 83 C8 20 46 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 85 C0 5F 74 1B C1 E5 04 2D ?? ?? ?? ?? 09 C5 81 FD FF FF 00 00 0F 86 9A 00 00 00 E9 1E 01 00 00 80 FB 3A 75 5E 83 3C 24 00 75 19 83 7C 24 08 00 0F 85 08 01 00 00 8B 44 24 04 89 74 24 0C 89 44 24 08 EB 78 80 3E 00 0F 84 F1 00 00 00 8B 54 24 04 8D 4C 24 20 83 }
	condition:
		$pattern
}

rule fnmatch_e1a0834c68111a4b3b7d6d350b27d019 {
	meta:
		aliases = "__GI_fnmatch, fnmatch"
		size = "1188"
		objfiles = "fnmatch_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 44 24 3C 8B 4C 24 34 D1 E8 8B 7C 24 38 83 F0 01 89 04 24 E9 52 04 00 00 8B 5C 24 3C 83 E3 10 89 5C 24 0C 74 1D 0F B6 C2 A8 80 75 16 8D 1C 00 A1 ?? ?? ?? ?? F6 04 18 01 74 08 A1 ?? ?? ?? ?? 8A 14 18 41 80 FA 3F 74 24 77 0E 80 FA 2A 0F 85 E5 03 00 00 E9 C7 00 00 00 80 FA 5B 0F 84 C0 01 00 00 80 FA 5C 0F 85 CE 03 00 00 EB 49 8A 07 84 C0 0F 84 15 04 00 00 8A 54 24 3C 80 E2 01 74 08 3C 2F 0F 84 04 04 00 00 F6 44 24 3C 04 0F 84 D7 03 00 00 3C 2E 0F 85 CF 03 00 00 3B 7C 24 38 0F 84 E7 03 00 00 84 D2 0F 84 BD 03 00 00 80 7F FF 2F E9 4C 03 00 00 F6 44 24 3C 02 75 2F 8A 11 84 D2 }
	condition:
		$pattern
}

rule __GI___ns_name_ntop_313996427c10349543a6a56cbb47d073 {
	meta:
		aliases = "__ns_name_ntop, __GI___ns_name_ntop"
		size = "368"
		objfiles = "ns_name@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 4C 24 38 8B 6C 24 34 89 CF 89 CB 03 7C 24 3C E9 04 01 00 00 0F B6 C0 89 44 24 1C A8 C0 0F 85 12 01 00 00 39 CB 75 04 89 CB EB 0C 39 FB 0F 83 02 01 00 00 C6 03 2E 43 8B 54 24 1C 8D 04 13 39 F8 0F 83 EF 00 00 00 45 E9 C1 00 00 00 8A 55 00 80 FA 2E 74 1F 77 0A 80 FA 22 74 18 80 FA 24 EB 0D 80 FA 40 74 0E 80 FA 5C 74 09 80 FA 3B 0F 85 DC 00 00 00 8D 43 01 39 F8 0F 83 B7 00 00 00 C6 03 5C 88 53 01 83 C3 02 EB 7F 8D 43 03 39 F8 0F 83 A1 00 00 00 0F B6 D2 C6 03 5C 66 89 54 24 12 66 8B 44 24 12 B2 64 F6 F2 0F B6 C0 BE 64 00 00 00 31 D2 8A 80 ?? ?? ?? ?? 88 43 01 66 8B 44 24 12 }
	condition:
		$pattern
}

rule _stdio_fopen_de070e8e37c83ea2e51704e064822bd7 {
	meta:
		aliases = "_stdio_fopen"
		size = "534"
		objfiles = "_fopen@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 54 24 38 8B 74 24 34 8B 7C 24 3C 8B 6C 24 40 8A 02 3C 72 74 3C BB 41 02 00 00 3C 77 74 35 66 BB 41 04 3C 61 74 2D E8 ?? ?? ?? ?? 85 FF C7 00 16 00 00 00 0F 84 C9 01 00 00 F6 47 01 20 0F 84 BF 01 00 00 57 E8 ?? ?? ?? ?? 31 FF 58 E9 B3 01 00 00 31 DB 8D 42 01 80 7A 01 62 74 02 89 D0 80 78 01 2B 75 08 89 D8 83 C8 01 8D 58 01 85 FF 75 28 6A 50 E8 ?? ?? ?? ?? 89 C7 58 85 FF 0F 84 82 01 00 00 8D 47 38 66 C7 07 00 20 C7 47 08 00 00 00 00 50 E8 ?? ?? ?? ?? 58 85 ED 78 48 89 DA 8D 46 01 81 E2 03 80 00 00 89 6F 04 42 21 D0 39 D0 0F 85 71 FF FF FF 89 F0 F7 D0 25 00 04 00 00 85 C3 }
	condition:
		$pattern
}

rule __GI_fclose_6489038d650a1b08d72848025ff5cfa7 {
	meta:
		aliases = "fclose, __GI_fclose"
		size = "237"
		objfiles = "fclose@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 74 24 34 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 31 FF F6 06 40 74 09 56 E8 ?? ?? ?? ?? 89 C7 58 FF 76 04 E8 ?? ?? ?? ?? 5B 85 C0 79 03 83 CF FF C7 46 04 FF FF FF FF 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 6A 01 40 53 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 06 83 C4 18 66 25 00 60 83 C8 30 85 ED 66 89 06 75 0E 6A 01 8D 44 24 14 50 E8 ?? ?? ?? ?? 5A 59 F6 46 01 40 74 09 FF 76 08 E8 ?? ?? ?? ?? 58 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 68 ?? }
	condition:
		$pattern
}

rule freopen64_f99668e40070c1d4c1632bc875bf7590 {
	meta:
		aliases = "freopen64"
		size = "236"
		objfiles = "freopen64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 74 24 3C 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 7C 24 08 57 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 6A 01 40 57 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1E 83 C4 18 89 D8 80 E4 9F 66 89 06 83 E0 30 83 F8 30 74 31 56 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 57 FF 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 1C 6A FE 56 FF 74 24 40 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 75 05 66 C7 06 30 80 66 81 E3 00 60 }
	condition:
		$pattern
}

rule freopen_7e45a4f78da2eda8b0c21a95fe97c7f0 {
	meta:
		aliases = "freopen"
		size = "236"
		objfiles = "freopen@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 74 24 3C 8B 6E 34 85 ED 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 7C 24 08 57 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 6A 01 40 57 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1E 83 C4 18 89 D8 80 E4 9F 66 89 06 83 E0 30 83 F8 30 74 31 56 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 57 FF 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 1C 6A FF 56 FF 74 24 40 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 75 05 66 C7 06 30 80 66 81 E3 00 60 }
	condition:
		$pattern
}

rule _getopt_internal_7f6596935151d234c08eb5f96e5edf1a {
	meta:
		aliases = "_getopt_internal"
		size = "1747"
		objfiles = "getopt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 A1 ?? ?? ?? ?? 8B 15 ?? ?? ?? ?? 8B 4C 24 3C 89 44 24 0C A3 ?? ?? ?? ?? 89 15 ?? ?? ?? ?? 31 C0 80 39 3A 0F 95 C0 F7 D8 21 44 24 0C 83 7C 24 34 00 0F 8E 68 06 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 85 D2 74 0B 80 3D ?? ?? ?? ?? 00 75 74 EB 0A C7 05 ?? ?? ?? ?? 01 00 00 00 A1 ?? ?? ?? ?? 68 ?? ?? ?? ?? A3 ?? ?? ?? ?? A3 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 E8 ?? ?? ?? ?? 59 85 C0 0F 95 C0 8B 4C 24 3C A2 ?? ?? ?? ?? 8A 11 80 FA 2D 75 0E 41 C6 05 ?? ?? ?? ?? 02 89 4C 24 3C EB 1A 80 FA 2B 75 0D FF 44 24 3C C6 05 ?? ?? ?? ?? 00 EB 08 83 F0 01 A2 ?? ?? ?? ?? C6 05 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_llround_b79c5423ad40fd6f8bd07cff56569859 {
	meta:
		aliases = "llround, __GI_llround"
		size = "329"
		objfiles = "s_llround@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 DD 44 24 34 DD 5C 24 08 8B 44 24 0C 8B 7C 24 08 89 C5 C1 ED 14 99 83 CA 01 81 E5 FF 07 00 00 89 54 24 10 89 C2 81 E2 FF FF 0F 00 8D 9D 01 FC FF FF 81 CA 00 00 10 00 83 FB 13 7F 35 85 DB 79 19 31 F6 31 FF 43 0F 85 EB 00 00 00 8B 44 24 10 99 89 C6 89 D7 E9 DD 00 00 00 88 D9 B8 00 00 08 00 D3 F8 B9 14 00 00 00 01 D0 29 D9 D3 E8 89 C6 EB 4F 83 FB 3E 7F 73 83 FB 33 7E 29 89 D1 31 DB 89 CB B9 00 00 00 00 89 C8 8D 8D CD FB FF FF 09 F8 89 DF 89 C6 0F A5 F7 D3 E6 F6 C1 20 74 76 89 F7 31 F6 EB 70 8D 8D ED FB FF FF B8 00 00 00 80 D3 E8 8D 34 38 39 FE 83 D2 00 83 FB 14 75 06 89 D6 31 }
	condition:
		$pattern
}

rule inet_ntop4_c247f9f796c02d711c87934fe8b056a1 {
	meta:
		aliases = "inet_ntop4"
		size = "231"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 24 31 ED 31 F6 89 44 24 08 89 54 24 04 89 0C 24 C6 44 24 13 00 E9 86 00 00 00 8B 44 24 08 B1 64 01 E8 8D 7E 01 89 44 24 0C 89 F3 0F B6 10 89 D0 F6 F1 88 C1 8D 41 30 88 44 34 13 3C 30 75 23 B1 0A 89 D0 F6 F1 31 D2 B9 0A 00 00 00 0F B6 C0 66 F7 F1 83 C2 30 88 54 34 13 80 FA 30 74 21 89 FB EB 1D B1 0A 89 D0 F6 F1 0F B6 C0 B9 0A 00 00 00 31 D2 66 F7 F1 83 C2 30 8D 5E 02 88 54 3C 13 8B 54 24 0C B9 0A 00 00 00 8D 73 02 45 0F B6 02 31 D2 C6 44 1C 14 2E 66 F7 F1 83 C2 30 88 54 1C 13 83 FD 03 0F 8E 71 FF FF FF C6 44 34 12 00 8D 5C 24 13 53 E8 ?? ?? ?? ?? 59 3B 04 24 76 0F E8 ?? ?? ?? }
	condition:
		$pattern
}

rule __res_search_57f27c1beedeb1ab9fa677ed7b34dc9a {
	meta:
		aliases = "__res_search"
		size = "528"
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 24 83 7C 24 38 00 74 0B 8D 5C 24 14 83 7C 24 44 00 75 10 E8 ?? ?? ?? ?? C7 00 FF FF FF FF E9 CC 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 44 24 10 8B 28 0F B6 40 51 89 44 24 1C 6A 01 53 E8 ?? ?? ?? ?? 83 C4 18 F7 C5 01 00 00 00 75 07 E8 ?? ?? ?? ?? EB B9 E8 ?? ?? ?? ?? 31 FF 89 44 24 04 C7 00 00 00 00 00 E8 ?? ?? ?? ?? 89 C3 C7 00 01 00 00 00 8B 54 24 38 EB 0B 3C 2E 0F 94 C0 0F B6 C0 01 C7 42 8A 02 84 C0 75 EF 31 F6 3B 54 24 38 76 0A 80 7A FF 2E 0F 94 C0 0F B6 F0 C7 44 24 08 FF FF FF FF 3B 7C 24 0C 72 2F FF 74 24 }
	condition:
		$pattern
}

rule memcmp_33123168b4e8fc796c5c0d822fd64763 {
	meta:
...
rule __GI_tcsetattr_ec25343382e4ff6bda1e58fffae34b64 {
	meta:
		aliases = "tcsetattr, __GI_tcsetattr"
		size = "248"
		objfiles = "tcsetattr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 24 8B 44 24 3C 8B 5C 24 40 83 F8 01 74 10 83 F8 02 74 22 BD 02 54 00 00 85 C0 74 1E EB 07 BD 03 54 00 00 EB 15 E8 ?? ?? ?? ?? C7 00 16 00 00 00 E9 AC 00 00 00 BD 04 54 00 00 8B 03 8D 73 11 25 FF FF FF 7F 8D 7C 24 11 89 04 24 8B 43 04 89 44 24 04 8B 43 08 89 44 24 08 8B 43 0C 89 44 24 0C 8A 43 10 88 44 24 10 A5 A5 A5 A5 66 A5 A4 8D 04 24 50 55 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 0C 89 C6 85 C0 75 63 81 FD 02 54 00 00 75 5B E8 ?? ?? ?? ?? 89 C7 8B 28 8D 04 24 50 68 01 54 00 00 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 04 89 2F EB 35 8B 4B 08 8B 74 24 08 89 CA 89 F0 81 E2 80 01 }
	condition:
		$pattern
}

rule _dl_dprintf_7179cde7e1cc90f442674117f393eede {
	meta:
		aliases = "_dl_dprintf"
		size = "703"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 24 8B 5C 24 3C 85 DB 0F 84 A4 02 00 00 8B 0D ?? ?? ?? ?? C7 44 24 1C 00 00 00 00 31 C0 BA 03 00 00 00 BE 22 00 00 00 83 CF FF 53 89 C3 55 8B 6C 24 1C B8 C0 00 00 00 CD 80 5D 5B 3D 00 F0 FF FF 76 0C F7 D8 83 CD FF A3 ?? ?? ?? ?? EB 07 89 C5 83 F8 FF 75 45 B9 ?? ?? ?? ?? BA 1D 00 00 00 8B 7C 24 38 53 89 FB B8 04 00 00 00 CD 80 5B 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? BF 14 00 00 00 53 89 FB B8 01 00 00 00 CD 80 5B 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 8D 73 FF 89 F2 42 80 3A 00 75 FA A1 ?? ?? ?? ?? 29 DA 48 39 C2 72 45 B9 ?? ?? ?? ?? BA 0B 00 00 00 8B 7C 24 38 53 89 FB }
	condition:
		$pattern
}

rule __GI_rtime_0856b21179fdcc617552f6a108acde0b {
	meta:
		aliases = "rtime, __GI_rtime"
		size = "346"
		objfiles = "rtime@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 24 8B 6C 24 40 8B 7C 24 38 83 FD 01 6A 00 19 DB 83 C3 02 53 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 89 C6 85 C0 0F 88 21 01 00 00 66 C7 07 02 00 66 C7 47 02 00 25 83 FB 02 0F 85 A5 00 00 00 6A 10 57 6A 00 6A 04 8D 44 24 30 50 56 E8 ?? ?? ?? ?? 83 C4 18 85 C0 0F 88 98 00 00 00 8B 4D 04 BB E8 03 00 00 89 C8 31 D2 F7 F3 89 C1 69 45 00 E8 03 00 00 89 74 24 14 66 C7 44 24 18 01 00 8D 3C 01 8D 6C 24 14 57 6A 01 55 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 C0 79 0A E8 ?? ?? ?? ?? 83 38 04 74 E4 83 FB 00 7F 0F 75 4C E8 ?? ?? ?? ?? C7 00 6E 00 00 00 EB 3F 8D 54 24 1C 8D 44 24 04 C7 44 24 1C 10 00 00 00 }
	condition:
		$pattern
}

rule _stdlib_strto_ll_5122a552ea513063ddac9baf9646d3e9 {
	meta:
		aliases = "_stdlib_strto_ll"
		size = "531"
		objfiles = "_stdlib_strto_ll@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 8B 5C 24 3C 8B 6C 24 44 89 DF EB 01 47 8A 0F A1 ?? ?? ?? ?? 0F B6 D1 F6 04 50 20 75 EF 80 F9 2B 74 11 C6 44 24 27 00 80 F9 2D 75 0D C6 44 24 27 01 EB 05 C6 44 24 27 00 47 89 D9 F7 C5 EF FF FF FF 75 24 83 C5 0A 80 3F 30 75 12 47 83 ED 02 89 F9 8A 07 83 C8 20 3C 78 75 03 01 ED 47 83 FD 10 7E 05 BD 10 00 00 00 8D 45 FE C7 44 24 18 00 00 00 00 C7 44 24 1C 00 00 00 00 83 F8 22 0F 87 1A 01 00 00 89 E8 89 6C 24 10 C1 F8 1F 89 44 24 14 EB 02 89 F9 8A 17 8D 42 D0 3C 09 76 0D 83 CA 20 B0 28 80 FA 60 76 03 8D 42 A9 0F B6 F0 39 EE 0F 8D E8 00 00 00 47 81 7C 24 1C FF FF FF 03 77 3C 89 }
	condition:
		$pattern
}

rule _stdlib_wcsto_ll_9cdbdfc436a9383c701dae24e92d9704 {
	meta:
		aliases = "_stdlib_wcsto_ll"
		size = "551"
		objfiles = "_stdlib_wcsto_ll@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 8B 5C 24 3C 8B 6C 24 44 89 DF EB 03 83 C7 04 FF 37 E8 ?? ?? ?? ?? 5A 85 C0 75 F1 8B 07 83 F8 2B 74 11 C6 44 24 27 00 83 F8 2D 75 0F C6 44 24 27 01 EB 05 C6 44 24 27 00 83 C7 04 89 DA F7 C5 EF FF FF FF 75 29 83 C5 0A 83 3F 30 75 17 83 C7 04 83 ED 02 89 FA 8B 07 83 C8 20 83 F8 78 75 05 01 ED 83 C7 04 83 FD 10 7E 05 BD 10 00 00 00 8D 45 FE C7 44 24 18 00 00 00 00 C7 44 24 1C 00 00 00 00 83 F8 22 0F 87 27 01 00 00 89 E8 89 6C 24 10 C1 F8 1F 89 44 24 14 EB 02 89 FA 8B 1F 8D 43 D0 8D 4B D0 83 F8 09 76 14 89 D8 B1 28 83 C8 20 83 F8 60 76 08 88 D8 83 C8 20 8D 48 A9 0F B6 F1 39 EE }
	condition:
		$pattern
}

rule mallinfo_6cdac3f3d6d496ae4de3bd6beb59dbfd {
	meta:
		aliases = "__GI_mallinfo, mallinfo"
		size = "309"
		objfiles = "mallinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 8B 7C 24 3C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 20 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 0B 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 A1 ?? ?? ?? ?? 31 C9 8B 40 04 C7 44 24 04 00 00 00 00 89 04 24 C7 44 24 0C 00 00 00 00 EB 1F 8B 14 8D ?? ?? ?? ?? EB 11 FF 44 24 0C 8B 42 04 83 E0 FC 01 44 24 04 8B 52 08 85 D2 75 EB 41 83 F9 09 76 DC 8B 04 24 8B 6C 24 04 83 E0 FC BB 01 00 00 00 01 C5 C7 44 24 08 01 00 00 00 EB 20 8D 0C DD ?? ?? ?? ?? 8B 51 0C EB 0F FF 44 24 08 8B 42 04 8B 52 0C 83 E0 FC 01 C5 39 CA 75 ED 43 83 FB 5F 76 DB A1 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_nextafter_5206fb3cda4d75b37a2d553645843a11 {
	meta:
		aliases = "nextafter, __GI_nextafter"
		size = "378"
		objfiles = "s_nextafter@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 DD 44 24 3C C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 DD 5C 24 20 DD 44 24 44 8B 54 24 24 C7 44 24 08 00 00 00 00 DD 5C 24 18 89 D6 C7 44 24 0C 00 00 00 00 81 E6 FF FF FF 7F C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 8B 4C 24 20 8B 6C 24 1C 8B 7C 24 18 81 FE FF FF EF 7F 7E 0A 8D 86 00 00 10 80 09 C8 75 1B 8B 5C 24 1C 89 D8 25 FF FF FF 7F 3D FF FF EF 7F 7E 16 2D 00 00 F0 7F 09 F8 74 0D DD 44 24 3C DC 44 24 44 E9 CE 00 00 00 DD 44 24 3C DD 44 24 44 D9 C9 DA E9 DF E0 9E 7A 06 0F 84 BF 00 00 00 09 CE 75 37 81 E5 00 00 00 80 C7 44 24 10 01 00 00 00 89 6C 24 14 DD 44 24 }
	condition:
		$pattern
}

rule __GI_lrint_0b1635d1060bff394c35068479f34f9f {
	meta:
		aliases = "lrint, __GI_lrint"
		size = "270"
		objfiles = "s_lrint@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 DD 44 24 3C DD 5C 24 10 8B 44 24 14 C1 E8 14 89 C2 89 C5 C1 ED 0B 81 E2 FF 07 00 00 81 EA FF 03 00 00 83 FA 13 7F 4C 31 DB 42 0F 8C CD 00 00 00 DD 04 ED ?? ?? ?? ?? DD 44 24 3C D8 C1 B9 13 04 00 00 DD 5C 24 20 DD 44 24 20 DE E1 DD 5C 24 08 8B 44 24 0C 89 C3 C1 E8 14 81 E3 FF FF 0F 00 25 FF 07 00 00 81 CB 00 00 10 00 29 C1 D3 EB E9 84 00 00 00 83 FA 1E 7F 58 DD 04 ED ?? ?? ?? ?? DD 44 24 3C D8 C1 DD 5C 24 20 DD 44 24 20 DE E1 DD 1C 24 8B 44 24 04 8B 34 24 89 C2 25 FF FF 0F 00 C1 EA 14 0D 00 00 10 00 81 E2 FF 07 00 00 89 C3 8D BA 01 FC FF FF 83 FF 14 74 3C 8D 8A ED FB FF FF }
	condition:
		$pattern
}

rule __GI_sleep_d96f7c3ccfbcaf0538aa1cec241db342 {
	meta:
		aliases = "sleep, __GI_sleep"
		size = "242"
		objfiles = "sleep@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 31 C0 8B 54 24 40 85 D2 0F 84 D5 00 00 00 89 54 24 24 C7 44 24 1C 00 00 00 00 C7 44 24 20 00 00 00 00 C7 44 24 28 00 00 00 00 6A 11 8D 5C 24 20 53 E8 ?? ?? ?? ?? 8D 6C 24 1C 55 53 6A 00 E8 ?? ?? ?? ?? 6A 11 55 E8 ?? ?? ?? ?? 83 C4 1C 85 C0 75 6B C7 44 24 1C 00 00 00 00 C7 44 24 20 00 00 00 00 6A 11 53 E8 ?? ?? ?? ?? 8D 44 24 08 50 6A 00 6A 11 E8 ?? ?? ?? ?? 83 C4 14 83 3C 24 01 8D 5C 24 24 75 20 53 53 E8 ?? ?? ?? ?? 89 C7 E8 ?? ?? ?? ?? 89 C3 8B 30 6A 00 55 6A 02 E8 ?? ?? ?? ?? 89 33 EB 13 6A 00 55 6A 02 E8 ?? ?? ?? ?? 53 53 E8 ?? ?? ?? ?? 89 C7 83 C4 14 EB 0F 8D 44 24 24 }
	condition:
		$pattern
}

rule __GI_remainder_64042736c9c48070529e5a6399904eaf {
	meta:
		aliases = "__ieee754_remainder, remainder, drem, __GI_remainder"
		size = "343"
		objfiles = "e_remainder@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C DD 44 24 40 DD 5C 24 18 DD 44 24 48 8B 44 24 1C 8B 6C 24 18 DD 5C 24 10 8B 74 24 14 89 44 24 20 81 E6 FF FF FF 7F 8B 7C 24 10 89 F0 09 F8 74 24 8B 5C 24 20 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7F 12 81 FE FF FF EF 7F 7E 19 8D 86 00 00 10 80 09 F8 74 37 DD 44 24 40 DC 4C 24 48 D8 F0 E9 E5 00 00 00 81 FE FF FF DF 7F 7F 20 DD 44 24 48 D8 C0 83 EC 08 DD 1C 24 FF 74 24 4C FF 74 24 4C E8 ?? ?? ?? ?? DD 5C 24 50 83 C4 10 29 F3 29 FD 09 EB 75 0F DD 44 24 40 DC 0D ?? ?? ?? ?? E9 A6 00 00 00 FF 74 24 44 FF 74 24 44 E8 ?? ?? ?? ?? 59 5B DD 5C 24 24 FF 74 24 4C FF 74 24 4C E8 ?? ?? ?? }
	condition:
		$pattern
}

rule do_des_8003533109c8919c85fd4171e5cb5aa5 {
	meta:
		aliases = "do_des"
		size = "777"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 89 D5 BA 01 00 00 00 89 4C 24 04 83 7C 24 48 00 0F 84 E2 02 00 00 7E 12 C7 44 24 24 ?? ?? ?? ?? C7 44 24 28 ?? ?? ?? ?? EB 14 F7 5C 24 48 C7 44 24 24 ?? ?? ?? ?? C7 44 24 28 ?? ?? ?? ?? 89 C2 89 EB C1 EA 18 89 EE 89 54 24 08 89 C2 0F B6 CC 25 FF 00 00 00 89 4C 24 0C 89 44 24 10 89 E8 C1 E8 10 89 E9 25 FF 00 00 00 81 E1 FF 00 00 00 89 04 24 8B 44 24 08 0F B6 FF 8B 5C 24 10 8B 2C 85 ?? ?? ?? ?? C1 EA 10 8B 44 24 0C 81 E2 FF 00 00 00 0B 2C 9D ?? ?? ?? ?? 0B 2C 95 ?? ?? ?? ?? 8B 1C 24 C1 EE 18 0B 2C 85 ?? ?? ?? ?? 0B 2C B5 ?? ?? ?? ?? 8B 44 24 08 0B 2C 8D ?? ?? ?? ?? 0B 2C 9D }
	condition:
		$pattern
}

rule clnttcp_create_fe014781c93cf8c339e7961d68cd6e70 {
	meta:
		aliases = "__GI_clnttcp_create, clnttcp_create"
		size = "461"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 8B 5C 24 44 8B 6C 24 50 6A 0C E8 ?? ?? ?? ?? 6A 64 89 C7 E8 ?? ?? ?? ?? 85 FF 89 C6 58 5A 74 04 85 F6 75 2B E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 89 C3 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 03 0C 00 00 00 C7 43 08 0C 00 00 00 5B 5D E9 5D 01 00 00 66 83 7B 02 00 75 24 6A 06 FF 74 24 50 FF 74 24 50 53 E8 ?? ?? ?? ?? 83 C4 10 66 85 C0 0F 84 3A 01 00 00 66 C1 C8 08 66 89 43 02 83 7D 00 00 79 61 6A 06 6A 01 6A 02 E8 ?? ?? ?? ?? 89 45 00 6A 00 50 E8 ?? ?? ?? ?? 8B 45 00 83 C4 14 85 C0 78 10 6A 10 53 50 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 28 E8 ?? ?? ?? ?? 89 C3 C7 00 0C 00 00 00 E8 ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_clntunix_create_145b562d2a9bb339f59a44edfe8394ff {
	meta:
		aliases = "clntunix_create, __GI_clntunix_create"
		size = "450"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 8B 6C 24 44 68 C4 00 00 00 E8 ?? ?? ?? ?? 6A 0C 89 C6 E8 ?? ?? ?? ?? 89 C7 58 85 FF 5A 74 04 85 F6 75 2B E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 89 C3 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 03 0C 00 00 00 C7 43 08 0C 00 00 00 5B 5D E9 53 01 00 00 8B 44 24 50 83 38 00 79 6A 6A 00 6A 01 6A 01 E8 ?? ?? ?? ?? 8B 54 24 5C 89 C3 89 02 8D 45 02 50 E8 ?? ?? ?? ?? 83 C4 10 85 DB 78 12 83 C0 03 50 55 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 2C E8 ?? ?? ?? ?? 89 C3 C7 00 0C 00 00 00 E8 ?? ?? ?? ?? 8B 00 89 43 08 8B 54 24 50 8B 02 83 F8 FF 0F 84 EF 00 00 00 50 E9 90 00 00 00 C7 46 04 01 00 00 00 EB 07 }
	condition:
		$pattern
}

rule __GI_regexec_9712fa1e19f490b46154e786558d8f45 {
	meta:
		aliases = "regexec, __GI_regexec"
		size = "260"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 8B 74 24 44 8B 5C 24 54 8B 6C 24 4C FF 74 24 48 E8 ?? ?? ?? ?? 5F 89 04 24 8A 46 1C 6A 20 83 F0 10 56 C0 E8 04 85 ED 0F 95 C2 89 D7 21 C7 8D 44 24 0C 50 E8 ?? ?? ?? ?? 88 DA 8A 44 24 2C 83 E2 01 83 E0 9F D1 EB C1 E2 05 83 E3 01 C1 E3 06 09 D0 09 D8 89 FA 83 E0 F9 83 C8 04 88 44 24 2C 83 C4 0C 31 C0 84 D2 74 2A 8D 04 ED 00 00 00 00 89 6C 24 24 50 E8 ?? ?? ?? ?? 5E BA 01 00 00 00 85 C0 74 70 89 44 24 28 8D 04 A8 89 44 24 2C 8D 44 24 24 50 FF 74 24 04 6A 00 FF 74 24 0C FF 74 24 58 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 C6 89 F8 83 C4 18 84 C0 74 38 31 DB 85 F6 79 24 EB 26 8B 54 24 }
	condition:
		$pattern
}

rule __ieee754_fmod_bb6cbd1196062eec618f60a42babd54c {
	meta:
		aliases = "fmod, __GI_fmod, __ieee754_fmod"
		size = "786"
		objfiles = "e_fmod@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 DD 44 24 44 C7 44 24 08 00 00 00 00 C7 44 24 0C 00 00 00 00 DD 5C 24 18 DD 44 24 4C 8B 4C 24 1C 8B 54 24 1C DD 5C 24 10 8B 6C 24 14 8B 44 24 10 81 E1 00 00 00 80 81 E5 FF FF FF 7F 89 44 24 2C 81 E2 FF FF FF 7F C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 8B 7C 24 18 89 4C 24 28 09 E8 74 1E 81 FA FF FF EF 7F 7F 16 8B 44 24 2C F7 D8 0B 44 24 2C C1 E8 1F 09 E8 3D 00 00 F0 7F 76 0F DD 44 24 44 DC 4C 24 4C D8 F0 E9 6D 02 00 00 39 EA 7F 27 0F 8C 67 02 00 00 3B 7C 24 2C 0F 82 5D 02 00 00 75 15 C1 6C 24 28 1F 8B 44 24 28 DD 04 C5 ?? ?? ?? ?? E9 42 02 00 00 81 FA FF FF 0F 00 7F 37 }
	condition:
		$pattern
}

rule malloc_5ecb214d00a5519b28699efc7f9507ba {
	meta:
		aliases = "malloc"
		size = "1930"
		objfiles = "malloc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 34 8B 5C 24 48 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 2C 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 FB DF 76 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 3D 07 00 00 8D 43 0B C7 44 24 08 10 00 00 00 83 F8 0F 76 07 83 E0 F8 89 44 24 08 8B 1D ?? ?? ?? ?? F6 C3 01 75 18 85 DB 0F 85 5D 03 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5D E9 4D 03 00 00 39 5C 24 08 77 1E 8B 4C 24 08 C1 E9 03 8B 14 8D ?? ?? ?? ?? 85 D2 74 0C 8B 42 08 89 04 8D ?? ?? ?? ?? EB 35 81 7C 24 08 FF 00 00 00 77 33 8B 6C 24 08 C1 ED 03 8D 0C ED ?? ?? ?? ?? 8B 51 0C 39 CA 0F 84 6D 01 00 00 8B 5C 24 08 }
	condition:
		$pattern
}

rule llrint_5dae46abba9918997ec86b05daae1d0b {
	meta:
		aliases = "__GI_llrint, llrint"
		size = "401"
		objfiles = "s_llrint@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 34 DD 44 24 48 DD 5C 24 14 8B 44 24 18 8B 74 24 14 89 C2 89 C1 C1 EA 14 C1 E9 1F 81 E2 FF 07 00 00 89 14 24 81 EA FF 03 00 00 89 4C 24 1C 83 FA 13 7F 54 DD 04 CD ?? ?? ?? ?? DD 44 24 48 D8 C1 31 FF 31 ED DD 5C 24 2C DD 44 24 2C DE E1 DD 5C 24 0C 8B 54 24 10 89 D0 C1 E8 14 25 FF 07 00 00 2D FF 03 00 00 0F 88 06 01 00 00 81 E2 FF FF 0F 00 B9 14 00 00 00 81 CA 00 00 10 00 29 C1 D3 EA 89 D7 E9 94 00 00 00 83 FA 3E 0F 8F B6 00 00 00 83 FA 33 7E 3D 25 FF FF 0F 00 31 DB 0D 00 00 10 00 89 C1 89 CB B9 00 00 00 00 89 C8 8B 0C 24 09 F0 81 E9 33 04 00 00 89 C7 89 DD 0F A5 FD D3 E7 F6 C1 }
	condition:
		$pattern
}

rule authunix_refresh_717f7656eb3cba0692782a637decc4cc {
	meta:
		aliases = "authunix_refresh"
		size = "209"
		objfiles = "auth_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 38 31 ED 8B 7C 24 4C 8B 5F 24 8B 47 04 3B 43 04 0F 84 AB 00 00 00 FF 43 18 C7 44 24 1C 00 00 00 00 C7 44 24 2C 00 00 00 00 6A 01 FF 73 08 FF 73 04 8D 74 24 0C 56 E8 ?? ?? ?? ?? 8D 44 24 28 50 56 E8 ?? ?? ?? ?? 83 C4 18 85 C0 74 4D 6A 00 8D 44 24 34 50 E8 ?? ?? ?? ?? 8B 44 24 38 C7 44 24 08 00 00 00 00 89 44 24 20 6A 00 56 8B 44 24 14 FF 50 14 8D 44 24 28 50 56 E8 ?? ?? ?? ?? 83 C4 18 89 C5 85 C0 74 13 6A 0C 53 57 E8 ?? ?? ?? ?? 89 F8 E8 ?? ?? ?? ?? 83 C4 0C 8D 44 24 18 C7 04 24 02 00 00 00 50 8D 5C 24 04 53 E8 ?? ?? ?? ?? 8B 44 24 0C 5E 5F 8B 40 1C 85 C0 74 04 53 FF D0 5B 83 }
	condition:
		$pattern
}

rule __GI_clntudp_bufcreate_a8b80205779ea5d5c237befa54c8c587 {
	meta:
		aliases = "clntudp_bufcreate, __GI_clntudp_bufcreate"
		size = "517"
		objfiles = "clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 38 6A 0C E8 ?? ?? ?? ?? 8B 7C 24 68 8B 5C 24 6C 83 C7 03 83 C3 03 83 E7 FC 83 E3 FC 89 C5 8D 44 1F 64 50 E8 ?? ?? ?? ?? 85 ED 89 C6 58 5A 74 04 85 F6 75 2B E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 89 C3 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 03 0C 00 00 00 C7 43 08 0C 00 00 00 5B 5F E9 7E 01 00 00 8D 44 33 60 89 46 58 8B 44 24 4C 66 83 78 02 00 75 28 6A 11 FF 74 24 58 FF 74 24 58 50 E8 ?? ?? ?? ?? 83 C4 10 66 85 C0 0F 84 50 01 00 00 8B 54 24 4C 66 C1 C8 08 66 89 42 02 C7 45 04 ?? ?? ?? ?? 89 75 08 6A 10 8D 46 08 FF 74 24 50 50 E8 ?? ?? ?? ?? 8B 54 24 64 8B 44 24 68 89 56 1C 89 5E 5C C7 46 }
	condition:
		$pattern
}

rule writeunix_b9e85010d39450abad2a98663c94c346 {
	meta:
		aliases = "writeunix"
		size = "249"
		objfiles = "svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 38 8D 44 24 24 8B 6C 24 50 8B 5C 24 54 89 04 24 E9 CA 00 00 00 8B 54 24 4C BF ?? ?? ?? ?? 8B 12 89 54 24 04 E8 ?? ?? ?? ?? 89 44 24 24 E8 ?? ?? ?? ?? 89 44 24 28 E8 ?? ?? ?? ?? 8B 34 24 89 44 24 2C A5 A5 A5 8D 44 24 30 C7 05 ?? ?? ?? ?? 01 00 00 00 C7 05 ?? ?? ?? ?? 02 00 00 00 C7 05 ?? ?? ?? ?? 18 00 00 00 89 6C 24 30 89 5C 24 34 89 44 24 10 C7 44 24 14 01 00 00 00 C7 44 24 08 00 00 00 00 C7 44 24 0C 00 00 00 00 C7 44 24 18 ?? ?? ?? ?? C7 44 24 1C 18 00 00 00 C7 44 24 20 00 00 00 00 8D 74 24 08 6A 00 56 FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 21 E8 ?? ?? ?? ?? 83 38 04 }
	condition:
		$pattern
}

rule gethostbyname_r_93d7be885bda6858f2e21eafa674e98b {
	meta:
		aliases = "__GI_gethostbyname_r, gethostbyname_r"
		size = "666"
		objfiles = "gethostbyname_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 38 BE 16 00 00 00 8B 44 24 5C 8B 6C 24 58 C7 00 00 00 00 00 83 7C 24 4C 00 0F 84 6B 02 00 00 E8 ?? ?? ?? ?? 89 C3 8B 38 C7 00 00 00 00 00 FF 74 24 60 FF 74 24 60 55 FF 74 24 60 FF 74 24 60 6A 02 FF 74 24 64 E8 ?? ?? ?? ?? 83 C4 1C 89 C6 85 C0 75 07 89 3B E9 30 02 00 00 8B 54 24 60 8B 02 83 F8 01 74 0E 83 F8 04 74 1F 40 0F 85 19 02 00 00 EB 0D 31 C0 83 FE 02 0F 94 C0 89 04 24 EB 10 83 3B 02 0F 85 01 02 00 00 C7 04 24 00 00 00 00 89 3B 8B 4C 24 60 C7 01 FF FF FF FF FF 74 24 4C E8 ?? ?? ?? ?? 59 8D 58 01 39 DD 0F 8E D4 01 00 00 53 29 DD FF 74 24 50 FF 74 24 5C E8 ?? ?? ?? ?? 8B }
	condition:
		$pattern
}

rule __ivaliduser2_78e8a11f307350b4c3eaa46f2f5ffa6b {
	meta:
		aliases = "__ivaliduser2"
		size = "685"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 89 44 24 08 89 54 24 04 89 0C 24 C7 44 24 38 00 00 00 00 C7 44 24 34 00 00 00 00 E9 4E 02 00 00 8B 54 24 34 8B 44 24 38 C6 44 02 FF 00 8B 5C 24 38 89 DE EB 01 46 8A 0E 84 C9 0F 84 2E 02 00 00 0F B6 D1 A1 ?? ?? ?? ?? F6 04 50 20 75 E7 80 F9 23 0F 84 17 02 00 00 6A 0A 53 E8 ?? ?? ?? ?? 5E 85 C0 5F 75 42 8B 54 24 08 8B 42 10 3B 42 18 73 0D 0F B6 10 8B 4C 24 08 40 89 41 10 EB 0C FF 74 24 08 E8 ?? ?? ?? ?? 59 89 C2 83 FA 0A 0F 84 DB 01 00 00 42 75 CF E9 D3 01 00 00 A1 ?? ?? ?? ?? 0F BF 04 08 88 03 43 8A 13 84 D2 74 11 0F B6 C2 8D 0C 00 A1 ?? ?? ?? ?? F6 04 08 20 74 DD 80 FA 20 }
	condition:
		$pattern
}

rule strerror_r_4f271b20d2435b9428cbc1dd7416ee67 {
	meta:
		aliases = "__xpg_strerror_r, __GI___xpg_strerror_r, strerror_r"
		size = "190"
		objfiles = "__xpg_strerror_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 8B 44 24 50 8B 5C 24 58 83 F8 7C 77 26 89 C1 C7 04 24 ?? ?? ?? ?? EB 0D 8B 14 24 80 3A 01 83 D9 00 42 89 14 24 85 C9 75 EF 8B 3C 24 31 ED 80 3F 00 75 2C 99 6A 00 6A F6 52 50 8D 44 24 4B BE ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 E8 0E 89 44 24 14 89 C7 A5 A5 A5 66 A5 BD 16 00 00 00 83 C4 14 31 C0 83 7C 24 54 00 FF 34 24 0F 95 C0 F7 D8 21 C3 E8 ?? ?? ?? ?? 40 5A 89 C6 39 D8 76 07 89 DE BD 22 00 00 00 85 F6 74 1A 56 FF 74 24 04 FF 74 24 5C E8 ?? ?? ?? ?? 8B 44 24 60 83 C4 0C C6 44 06 FF 00 85 ED 74 07 E8 ?? ?? ?? ?? 89 28 83 C4 3C 89 E8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_gethostbyname2_r_38b904e64eacbc449d2975538e183d69 {
	meta:
		aliases = "gethostbyname2_r, __GI_gethostbyname2_r"
		size = "668"
		objfiles = "gethostbyname2_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 8B 44 24 54 8B 7C 24 60 83 F8 02 75 22 FF 74 24 68 FF 74 24 68 57 FF 74 24 68 FF 74 24 68 FF 74 24 64 E8 ?? ?? ?? ?? 83 C4 18 E9 5E 02 00 00 8B 54 24 64 83 F8 0A C7 02 00 00 00 00 0F 85 46 02 00 00 83 7C 24 50 00 0F 84 3B 02 00 00 E8 ?? ?? ?? ?? 89 C6 8B 28 C7 00 00 00 00 00 FF 74 24 68 FF 74 24 68 57 FF 74 24 68 FF 74 24 68 6A 0A FF 74 24 68 E8 ?? ?? ?? ?? 83 C4 1C 85 C0 75 07 89 2E E9 07 02 00 00 8B 4C 24 68 8B 11 83 FA 01 74 0E 83 FA 04 74 1C 42 0F 85 F0 01 00 00 EB 0A 31 DB 83 F8 02 0F 94 C3 EB 0B 83 3E 02 0F 85 DB 01 00 00 31 DB 89 2E 8B 44 24 68 C7 00 FF FF FF FF B8 }
	condition:
		$pattern
}

rule __time_localtime_tzi_666623f5741acfbe95e65334e9a12f10 {
	meta:
		aliases = "__time_localtime_tzi"
		size = "690"
		objfiles = "_time_localtime_tzi@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C C7 44 24 18 00 00 00 00 6B 44 24 18 18 8B 4C 24 50 8B 5C 24 58 01 C3 B8 80 3A 09 00 8B 11 B9 F9 FF FF FF 2B 03 81 FA 7F C5 F6 7F 7E 07 F7 D8 B9 07 00 00 00 01 D0 89 44 24 38 FF 74 24 54 51 8D 74 24 40 56 E8 ?? ?? ?? ?? 8B 7C 24 60 8B 44 24 24 BE ?? ?? ?? ?? 83 C4 0C 89 47 20 8B 03 F7 D8 89 47 24 8D 7B 10 8D 5E 04 57 53 E8 ?? ?? ?? ?? 59 85 C0 5A 75 04 89 D8 EB 45 8B 36 85 F6 75 E6 6A 07 57 E8 ?? ?? ?? ?? 5E 83 F8 06 5A 7F 2B 83 C0 08 50 E8 ?? ?? ?? ?? 5B 89 C2 85 C0 74 1B A1 ?? ?? ?? ?? 89 02 8D 42 04 57 89 15 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 5A 59 EB 05 B8 ?? ?? ?? ?? 8B 54 }
	condition:
		$pattern
}

rule atan2_82c6744c29ccf6375a3ed8fa439bc858 {
	meta:
		aliases = "__GI_atan2, __ieee754_atan2, atan2"
		size = "580"
		objfiles = "e_atan2@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C DD 44 24 50 DD 5C 24 08 DD 44 24 58 DD 14 24 DD 5C 24 28 8B 44 24 2C 8B 4C 24 28 89 C7 89 44 24 38 89 C8 81 E7 FF FF FF 7F F7 D8 DD 44 24 08 09 C8 C1 E8 1F DD 5C 24 20 09 F8 8B 54 24 20 3D 00 00 F0 7F 77 1E 89 D0 8B 6C 24 24 F7 D8 09 D0 89 EE C1 E8 1F 81 E6 FF FF FF 7F 09 F0 3D 00 00 F0 7F 76 0C DD 44 24 08 DC 04 24 E9 BE 01 00 00 8B 44 24 38 2D 00 00 F0 3F 09 C8 75 14 DD 44 24 08 DD 5C 24 50 83 C4 3C 5B 5E 5F 5D E9 ?? ?? ?? ?? 8B 5C 24 38 89 E8 C1 FB 1E C1 E8 1F 83 E3 02 09 C3 09 F2 75 18 83 FB 02 0F 84 8C 00 00 00 0F 8E 7D 01 00 00 83 FB 03 0F 84 88 00 00 00 09 F9 0F 84 }
	condition:
		$pattern
}

rule __GI_gethostbyaddr_r_2600d33b79b3f2322436c91c1dcf49be {
	meta:
		aliases = "gethostbyaddr_r, __GI_gethostbyaddr_r"
		size = "678"
		objfiles = "gethostbyaddr_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 40 8B 44 24 6C 8B 7C 24 64 8B 5C 24 68 C7 00 00 00 00 00 83 7C 24 54 00 0F 84 75 02 00 00 83 7C 24 5C 02 74 0D 83 7C 24 5C 0A 0F 85 63 02 00 00 EB 07 83 7C 24 58 04 EB 05 83 7C 24 58 10 0F 85 4F 02 00 00 FF 74 24 70 FF 74 24 70 53 57 FF 74 24 70 FF 74 24 70 FF 74 24 70 FF 74 24 70 E8 ?? ?? ?? ?? 83 C4 20 85 C0 0F 84 2A 02 00 00 8B 4C 24 70 8B 11 83 FA 01 74 09 83 FA 04 0F 85 16 02 00 00 89 FE 8B 44 24 70 F7 DE 83 E6 03 C7 00 FF FF FF FF 01 F7 29 F3 89 7C 24 08 83 EB 38 8B 54 24 08 83 C7 20 83 C2 28 89 7C 24 0C 89 54 24 3C 89 5C 24 04 B8 22 00 00 00 81 FB FF 00 00 00 0F 8E D3 }
	condition:
		$pattern
}

rule clnttcp_call_00b135019735a1364f3ac5789a8fdb97 {
	meta:
		aliases = "clnttcp_call"
		size = "544"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 40 8B 4C 24 54 8B 44 24 6C 8B 54 24 70 8B 59 08 8D 4B 30 8D 73 4C 89 4C 24 04 83 7B 10 00 75 06 89 53 0C 89 43 08 83 7C 24 64 00 75 12 83 7B 08 00 75 0C 83 7B 0C 00 0F 95 C0 0F B6 F8 EB 05 BF 01 00 00 00 8D 43 30 C7 44 24 08 02 00 00 00 89 04 24 C7 43 4C 00 00 00 00 C7 43 24 00 00 00 00 8B 54 24 04 8B 02 48 89 02 0F C8 89 44 24 0C 8B 43 50 FF 73 48 FF 74 24 04 56 FF 50 0C 83 C4 0C 85 C0 74 35 8B 43 50 8D 4C 24 58 51 56 FF 50 04 5A 85 C0 59 74 23 8B 54 24 54 8B 02 8B 50 20 56 50 FF 52 04 59 85 C0 5D 74 0F FF 74 24 60 56 FF 54 24 64 5D 85 C0 5A 75 1F 83 7B 24 00 75 07 C7 43 24 }
	condition:
		$pattern
}

rule clntunix_call_eb65e993f5a147f5972e2914dcf29ce2 {
	meta:
		aliases = "clntunix_call"
		size = "613"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 40 8B 4C 24 54 8B 44 24 6C 8B 54 24 70 8B 59 08 8D 8B 90 00 00 00 8D B3 AC 00 00 00 89 4C 24 04 83 7B 10 00 75 06 89 53 0C 89 43 08 83 7C 24 64 00 75 12 83 7B 08 00 75 0C 83 7B 0C 00 0F 95 C0 0F B6 F8 EB 05 BF 01 00 00 00 8D 83 90 00 00 00 C7 44 24 08 02 00 00 00 89 04 24 C7 83 AC 00 00 00 00 00 00 00 C7 83 84 00 00 00 00 00 00 00 8B 54 24 04 8B 02 48 89 02 0F C8 89 44 24 0C 8B 83 B0 00 00 00 FF B3 A8 00 00 00 FF 74 24 04 56 FF 50 0C 83 C4 0C 85 C0 74 38 8B 83 B0 00 00 00 8D 4C 24 58 51 56 FF 50 04 5A 85 C0 59 74 23 8B 54 24 54 8B 02 8B 50 20 56 50 FF 52 04 59 85 C0 5D 74 0F }
	condition:
		$pattern
}

rule clntraw_call_0bcbfa40daad41467d3ba63dfcdbbb66 {
	meta:
		aliases = "clntraw_call"
		size = "386"
		objfiles = "clnt_raw@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 40 BF 10 00 00 00 E8 ?? ?? ?? ?? 8B 98 A0 00 00 00 85 DB 8D 73 0C 0F 84 56 01 00 00 8D 83 84 22 00 00 89 04 24 8B 43 10 C7 43 0C 00 00 00 00 6A 00 56 FF 50 14 8B 54 24 08 FF 02 8B 43 10 FF B3 9C 22 00 00 52 56 FF 50 0C 83 C4 14 85 C0 0F 84 FC 00 00 00 8B 43 10 8D 54 24 58 52 56 FF 50 04 59 85 C0 5F 0F 84 E6 00 00 00 8B 54 24 54 8B 02 8B 50 20 56 50 FF 52 04 5D 85 C0 5A 0F 84 CE 00 00 00 FF 74 24 60 56 FF 54 24 64 59 85 C0 5F 0F 84 BB 00 00 00 8B 43 10 56 FF 50 10 6A 01 E8 ?? ?? ?? ?? C7 43 0C 01 00 00 00 8B 43 10 6A 00 56 8D 6C 24 20 FF 50 14 6A 0C 68 ?? ?? ?? ?? 55 E8 ?? ?? }
	condition:
		$pattern
}

rule _dl_map_cache_4cd00a3a8ebc79ae0f4d6b85a4245dd7 {
	meta:
		aliases = "_dl_map_cache"
		size = "500"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 44 83 C8 FF 8B 15 ?? ?? ?? ?? 83 FA FF 0F 84 D3 01 00 00 85 D2 0F 85 C9 01 00 00 BE ?? ?? ?? ?? 89 E1 89 F0 53 89 C3 B8 6A 00 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 0D F7 DB 89 1D ?? ?? ?? ?? E9 90 01 00 00 85 C0 0F 85 88 01 00 00 B9 00 00 08 00 31 D2 53 89 F3 B8 05 00 00 00 CD 80 5B 89 C7 3D 00 F0 FF FF 76 0D F7 DF 89 3D ?? ?? ?? ?? E9 60 01 00 00 85 C0 0F 88 58 01 00 00 8B 4C 24 14 BE 01 00 00 00 89 0D ?? ?? ?? ?? C7 44 24 40 00 00 00 00 89 D8 89 F2 53 89 C3 55 8B 6C 24 40 B8 C0 00 00 00 CD 80 5D 5B 89 C1 89 C2 3D 00 F0 FF FF 76 0B F7 D9 89 0D ?? ?? ?? ?? 83 CA FF 89 15 ?? }
	condition:
		$pattern
}

rule timer_create_0a59fefad9d1988a16c84af83c5765f2 {
	meta:
		aliases = "timer_create"
		size = "148"
		objfiles = "timer_create@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 44 8B 74 24 5C 85 F6 75 12 C7 44 24 08 00 00 00 00 C7 44 24 04 0E 00 00 00 89 E6 83 7E 08 02 74 62 6A 08 E8 ?? ?? ?? ?? 59 89 C5 85 C0 74 54 89 04 24 8D 54 24 40 8B 7C 24 58 89 F1 53 89 FB B8 03 01 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 0B E8 ?? ?? ?? ?? F7 DB 89 18 EB 1C 83 F8 FF 74 17 8B 46 08 89 45 00 8B 44 24 40 89 45 04 8B 44 24 60 89 28 89 D8 EB 0F 55 E8 ?? ?? ?? ?? 83 C8 FF 5A EB 03 83 C8 FF 83 C4 44 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule sigwait_d6b5b05b2a53c39a16d6fc2ebff44eb3 {
	meta:
		aliases = "sigwait"
		size = "271"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 44 BE 01 00 00 00 E8 ?? ?? ?? ?? C7 44 24 38 FF FF FF FF 89 44 24 40 C7 44 24 3C FF FF FF FF FF 35 ?? ?? ?? ?? 8D 5C 24 3C 53 E8 ?? ?? ?? ?? 5F 5D 89 DD 8D 5C 24 24 EB 59 56 FF 74 24 5C E8 ?? ?? ?? ?? 5A 85 C0 59 74 48 3B 35 ?? ?? ?? ?? 74 40 3B 35 ?? ?? ?? ?? 74 38 3B 35 ?? ?? ?? ?? 74 30 56 55 E8 ?? ?? ?? ?? 5F 83 3C B5 ?? ?? ?? ?? 01 58 77 1D 31 C0 89 DF AB AB AB AB AB C7 44 24 24 ?? ?? ?? ?? 6A 00 53 56 E8 ?? ?? ?? ?? 83 C4 0C 46 83 FE 41 7E A2 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 5A 85 C0 59 75 39 8B 44 24 40 89 60 28 8B 44 24 40 80 78 42 00 74 0A 8B 44 24 40 80 78 40 00 }
	condition:
		$pattern
}

rule __md5_Final_9b3528c29575006653be068b211a754e {
	meta:
		aliases = "__md5_Final"
		size = "113"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 48 89 C5 89 D3 31 C0 B9 10 00 00 00 89 E7 F3 AB C6 04 24 80 8D 72 10 8D 7C 24 40 A5 A5 8B 42 10 B9 38 00 00 00 C1 E8 03 83 E0 3F 83 F8 37 76 05 B9 78 00 00 00 29 C1 89 E2 89 D8 89 DE E8 ?? ?? ?? ?? 8D 54 24 40 B9 08 00 00 00 89 D8 E8 ?? ?? ?? ?? 89 EF A5 A5 A5 A5 31 C0 B9 16 00 00 00 89 DF F3 AB 83 C4 48 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _wstdio_fwrite_5dd44ca7626647303535674b673ff963 {
	meta:
		aliases = "_wstdio_fwrite"
		size = "226"
		objfiles = "_wfwrite@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 48 8B 74 24 64 8B 6C 24 60 83 7E 04 FD 75 36 8B 46 10 8B 5E 0C 29 C3 C1 FB 02 39 EB 76 02 89 EB 85 DB 0F 84 AA 00 00 00 53 FF 74 24 60 50 E8 ?? ?? ?? ?? 8D 04 9D 00 00 00 00 83 C4 0C 01 46 10 E9 8D 00 00 00 0F B7 06 25 40 08 00 00 3D 40 08 00 00 74 13 68 00 08 00 00 56 E8 ?? ?? ?? ?? 31 FF 5A 85 C0 59 75 69 8B 44 24 5C 8D 56 2C 31 FF 89 44 24 44 89 14 24 EB 53 FF 34 24 89 E8 6A 40 29 F8 50 8D 44 24 50 50 8D 54 24 14 52 E8 ?? ?? ?? ?? 83 C4 14 89 C3 83 F8 FF 74 34 85 C0 75 0E 8B 54 24 5C B3 01 8D 44 BA 04 89 44 24 44 56 53 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 0C 39 D8 75 0F 8B }
	condition:
		$pattern
}

rule getaddrinfo_98fe9f21ceb60fde23cff26cd23f1085 {
	meta:
		aliases = "__GI_getaddrinfo, getaddrinfo"
		size = "625"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 8B 54 24 64 8B 5C 24 68 C7 44 24 48 00 00 00 00 83 7C 24 60 00 74 19 8B 44 24 60 80 38 2A 75 10 80 78 01 00 0F 95 C0 0F B6 C0 F7 D8 21 44 24 60 85 D2 74 12 80 3A 2A 75 0D 31 C0 80 7A 01 00 0F 95 C0 F7 D8 21 C2 8B 7C 24 60 09 D7 0F 84 06 02 00 00 85 DB 75 11 8D 74 24 1C B9 08 00 00 00 89 F7 89 D8 F3 AB 89 F3 8B 03 A9 C0 FB FF FF 0F 85 EB 01 00 00 A8 02 74 0B 83 7C 24 60 00 0F 84 DC 01 00 00 85 D2 74 61 80 3A 00 74 5C 89 54 24 3C 6A 0A 8D 44 24 48 50 52 E8 ?? ?? ?? ?? 89 44 24 4C 83 C4 0C 8B 44 24 44 80 38 00 74 1C F6 43 01 04 0F 85 A1 01 00 00 8D 44 24 3C C7 44 24 40 FF FF }
	condition:
		$pattern
}

rule readunix_1a4cc636a211d736900393b7db8f7c16 {
	meta:
		aliases = "readunix"
		size = "356"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C BB E8 03 00 00 8B 74 24 60 8B 6C 24 68 8B 4E 0C 89 C8 99 F7 FB 66 31 DB 89 C1 69 46 08 E8 03 00 00 85 ED 8D 3C 01 0F 84 27 01 00 00 8B 06 8D 5C 24 40 89 44 24 40 66 C7 44 24 44 01 00 57 6A 01 53 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 FF 74 10 85 C0 75 30 C7 86 84 00 00 00 05 00 00 00 EB 1C E8 ?? ?? ?? ?? 83 38 04 74 D5 C7 86 84 00 00 00 04 00 00 00 8B 00 89 86 88 00 00 00 83 CB FF E9 D1 00 00 00 8B 44 24 64 8B 3E 89 44 24 38 8D 44 24 38 89 44 24 0C 8D 44 24 20 89 44 24 14 89 6C 24 3C C7 44 24 10 01 00 00 00 C7 44 24 04 00 00 00 00 C7 44 24 08 00 00 00 00 C7 44 24 18 18 00 00 00 C7 }
	condition:
		$pattern
}

rule __GI_strftime_65f7d68cdccea2d5e97e722884a20320 {
	meta:
		aliases = "strftime, __GI_strftime"
		size = "1266"
		objfiles = "strftime@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 50 6A 00 FF 74 24 74 E8 ?? ?? ?? ?? 3D FF 4E 98 45 0F 9E C0 0F B6 C0 50 E8 ?? ?? ?? ?? 8B 44 24 74 8B 4C 24 78 89 44 24 20 C7 44 24 28 00 00 00 00 83 C4 0C 8D 54 24 38 89 54 24 04 83 7C 24 14 00 0F 84 9B 04 00 00 8A 01 84 C0 75 29 83 7C 24 1C 00 75 14 8B 4C 24 64 C6 01 00 8B 44 24 68 2B 44 24 14 E9 7C 04 00 00 FF 4C 24 1C 8B 5C 24 1C 8B 4C 9C 28 EB C6 3C 25 74 06 89 4C 24 10 EB 0E 8D 79 01 89 7C 24 10 8A 41 01 3C 25 75 0F 89 CE C7 44 24 18 01 00 00 00 E9 0D 04 00 00 3C 4F 74 10 3C 45 74 10 B3 3F C7 44 24 18 02 00 00 00 EB 17 B0 40 EB 02 B0 80 FF 44 24 10 88 C3 83 CB 3F C7 44 }
	condition:
		$pattern
}

rule vwarn_work_ea72cb465df434067bca3c211cbc6f86 {
	meta:
		aliases = "vwarn_work"
		size = "187"
		objfiles = "err@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 50 89 C7 89 D5 BB ?? ?? ?? ?? 85 C9 74 1B E8 ?? ?? ?? ?? 6A 40 8D 54 24 04 BB ?? ?? ?? ?? 52 FF 30 E8 ?? ?? ?? ?? 83 C4 0C A1 ?? ?? ?? ?? 8B 70 34 85 F6 75 24 83 C0 38 50 68 ?? ?? ?? ?? 8D 44 24 48 50 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C0 38 50 E8 ?? ?? ?? ?? 83 C4 10 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 85 FF 74 13 55 57 FF 35 ?? ?? ?? ?? 83 EB 02 E8 ?? ?? ?? ?? 83 C4 0C 89 E0 50 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 85 F6 75 0E 6A 01 8D 44 24 44 50 E8 ?? ?? ?? ?? 58 5A 83 C4 50 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_inet_ntop_b1cb5650638bb18d70d1b3cb47c72e85 {
	meta:
		aliases = "inet_ntop, __GI_inet_ntop"
		size = "430"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 54 8B 44 24 68 83 F8 02 74 0B 83 F8 0A 0F 85 7E 01 00 00 EB 18 8B 54 24 70 8B 4C 24 74 8B 44 24 6C E8 ?? ?? ?? ?? 89 C2 E9 71 01 00 00 31 C0 B9 08 00 00 00 8D 7C 24 34 F3 AB 31 C9 89 C8 BA 02 00 00 00 89 D6 99 F7 FE 8B 54 24 6C 89 C3 0F B6 04 0A 0F B6 54 11 01 C1 E0 08 83 C1 02 09 D0 83 F9 0F 89 44 9C 34 7E D4 31 D2 83 CE FF 83 C8 FF EB 2E 83 7C 94 34 00 75 11 83 F8 FF 75 09 89 D0 B9 01 00 00 00 EB 18 41 EB 15 83 F8 FF 74 10 83 FE FF 74 04 39 E9 7E 04 89 CD 89 C6 83 C8 FF 42 83 FA 07 7E CD 83 F8 FF 74 0D 83 FE FF 74 04 39 E9 7E 04 89 CD 89 C6 83 FE FF 74 08 83 FD 01 7F 03 83 }
	condition:
		$pattern
}

rule iruserfopen_0daad06214f7e2456c035f6f287853ae {
	meta:
		aliases = "iruserfopen"
		size = "132"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 58 89 C6 89 E7 89 D5 57 50 E8 ?? ?? ?? ?? 59 5B 31 DB 85 C0 75 5E 8B 44 24 10 25 00 F0 00 00 3D 00 80 00 00 75 4E 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 89 C3 58 85 DB 5A 74 3B 53 E8 ?? ?? ?? ?? 57 50 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 1A 8B 44 24 18 85 C0 74 04 39 E8 75 0E F6 44 24 10 12 75 07 83 7C 24 14 01 76 0D 85 DB 74 09 53 31 DB E8 ?? ?? ?? ?? 5D 83 C4 58 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _ppfs_parsespec_f36d7be0af3f9f640ef89061ba6a15c1 {
	meta:
		aliases = "_ppfs_parsespec"
		size = "1036"
		objfiles = "_ppfs_parsespec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 58 8B 44 24 6C C7 44 24 4C 00 00 00 00 C7 44 24 50 00 00 00 00 C7 44 24 30 08 00 00 00 C7 44 24 34 08 00 00 00 8B 54 24 6C 8B 40 18 89 44 24 08 8B 6A 10 81 E5 80 00 00 00 75 04 8B 12 EB 39 31 F6 8B 44 24 6C 8D 0C B5 00 00 00 00 8B 10 8B 44 11 FC 88 44 34 10 88 C3 0F B6 C0 3B 44 11 FC 0F 85 96 03 00 00 84 DB 74 06 46 83 FE 1F 76 D2 C6 44 24 2F 00 8D 54 24 11 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 EB 02 89 F2 89 D6 80 3A 2A 75 10 6B 44 24 04 FC 8D 72 01 C7 44 04 30 00 00 00 00 31 FF EB 24 81 FF CB CC CC 0C 7E 0D 81 FF CC CC CC 0C 75 0E 83 F9 37 7F 09 6B C7 0A 8D 7C 08 D0 }
	condition:
		$pattern
}

rule initshells_d518bf02e54e43f546243a69ffe293fb {
	meta:
		aliases = "initshells"
		size = "291"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 58 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5D 89 C7 58 85 FF B8 ?? ?? ?? ?? 0F 84 EF 00 00 00 57 E8 ?? ?? ?? ?? 8D 54 24 04 52 50 E8 ?? ?? ?? ?? 83 C4 0C 40 0F 84 C3 00 00 00 8B 44 24 2C 40 50 E8 ?? ?? ?? ?? 5E A3 ?? ?? ?? ?? 85 C0 0F 84 AA 00 00 00 6A 04 BA 03 00 00 00 8B 44 24 30 89 D1 31 D2 F7 F1 50 E8 ?? ?? ?? ?? 59 A3 ?? ?? ?? ?? 5B 85 C0 0F 84 84 00 00 00 6A 02 57 E8 ?? ?? ?? ?? 8B 6C 24 34 8B 35 ?? ?? ?? ?? 58 8B 1D ?? ?? ?? ?? 5A EB 3A 43 8A 03 3C 23 74 33 3C 2F 74 06 84 C0 75 F1 EB 29 84 C0 74 25 89 1E EB 01 43 8A 0B A1 ?? ?? ?? ?? 0F B6 D1 F6 04 }
	condition:
		$pattern
}

rule gamma_r_dc7dce16502fa7d29208f31ada4c9a87 {
	meta:
		aliases = "lgamma_r, __ieee754_lgamma_r, gamma_r"
		size = "1652"
		objfiles = "e_lgamma_r@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 5C DD 44 24 70 8B 6C 24 78 DD 54 24 28 8B 44 24 2C 89 C6 89 44 24 40 81 E6 FF FF FF 7F C7 45 00 01 00 00 00 81 FE FF FF EF 7F 7E 09 D9 C0 DE C9 E9 31 06 00 00 DD D8 8B 7C 24 28 89 F0 09 F8 74 58 81 FE FF FF 8F 3B 7F 36 83 7C 24 40 00 79 19 C7 45 00 FF FF FF FF DD 44 24 70 D9 E0 DD 54 24 70 83 EC 08 DD 1C 24 EB 08 FF 74 24 74 FF 74 24 74 E8 ?? ?? ?? ?? 59 D9 E0 5B E9 E7 05 00 00 83 7C 24 40 00 78 0B D9 EE DD 5C 24 38 E9 EA 01 00 00 81 FE FF FF 2F 43 7E 07 D9 EE E9 89 01 00 00 DD 44 24 70 DD 5C 24 20 8B 5C 24 24 81 E3 FF FF FF 7F 81 FB FF FF CF 3F 7F 27 6A 00 6A 00 6A 00 DD 44 }
	condition:
		$pattern
}

rule __GI_strptime_c01cd190c797ae8018c194ebe8444e78 {
	meta:
		aliases = "strptime, __GI_strptime"
		size = "954"
		objfiles = "strptime@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 60 31 C0 C7 44 84 14 00 00 00 80 40 83 F8 0C 7E F2 8B 7C 24 78 C7 44 24 08 00 00 00 00 8A 07 84 C0 75 47 83 7C 24 08 00 75 32 83 7C 24 2C 07 75 08 C7 44 24 2C 00 00 00 00 31 D2 8B 44 94 14 3D 00 00 00 80 74 07 8B 4C 24 7C 89 04 91 42 83 FA 07 7E E8 8B 44 24 74 E9 50 03 00 00 FF 4C 24 08 8B 5C 24 08 8B 7C 9C 48 EB B3 3C 25 0F 85 FF 02 00 00 47 8A 07 3C 25 0F 84 F4 02 00 00 3C 4F 74 08 B1 3F 3C 45 75 0E EB 04 B0 40 EB 02 B0 80 88 C1 47 83 C9 3F 8A 17 84 D2 0F 84 0B 03 00 00 88 D0 83 C8 20 83 E8 61 3C 19 0F 87 FB 02 00 00 0F B6 C2 8A 90 ?? ?? ?? ?? 21 D1 80 F9 3E 0F 87 E7 02 00 }
	condition:
		$pattern
}

rule lckpwdf_957e327a8e0f737df523875f0d057697 {
	meta:
		aliases = "lckpwdf"
		size = "320"
		objfiles = "lckpwdf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 60 83 C8 FF 83 3D ?? ?? ?? ?? FF 0F 85 21 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 38 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 01 00 08 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 18 A3 ?? ?? ?? ?? 83 F8 FF 0F 84 D3 00 00 00 6A 01 6A 02 50 31 F6 E8 ?? ?? ?? ?? 8D 54 24 14 89 D7 89 F0 AB AB AB AB AB 8D 44 24 28 C7 44 24 14 ?? ?? ?? ?? C7 44 24 20 FF FF FF FF C7 44 24 24 FF FF FF FF 50 52 6A 0E E8 ?? ?? ?? ?? C7 44 24 68 00 00 00 00 C7 44 24 6C 00 00 00 00 6A 0E 8D 5C 24 6C 53 E8 ?? ?? ?? ?? 83 C4 20 8D 6C 24 58 55 53 6A 01 E8 ?? ?? ?? ?? 6A 0F E8 ?? ?? ?? ?? 8D 54 }
	condition:
		$pattern
}

rule __pthread_manager_a961164134d86fd1a98cf2a3b201c1da {
	meta:
		aliases = "__pthread_manager"
		size = "1579"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 60 C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 44 24 50 FF FF FF FF C7 44 24 54 FF FF FF FF FF 35 ?? ?? ?? ?? 8D 5C 24 54 53 E8 ?? ?? ?? ?? 6A 05 53 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 74 12 A1 ?? ?? ?? ?? 85 C0 7E 09 50 53 E8 ?? ?? ?? ?? 58 5A 6A 00 8D 44 24 54 50 6A 02 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? FF 70 18 E8 ?? ?? ?? ?? 83 C4 10 8D 5C 24 34 6A 1C 53 FF 74 24 7C E8 ?? ?? ?? ?? 83 C4 0C 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E4 8B 44 24 74 66 C7 44 24 5C 01 00 89 44 24 58 68 D0 07 00 00 6A 01 8D 54 24 60 52 E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? ?? ?? 83 C4 }
	condition:
		$pattern
}

rule __md5_Transform_05d827ce111de92765b831c7a7a8ed3d {
	meta:
		aliases = "__md5_Transform"
		size = "312"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 64 89 C5 89 D6 B9 10 00 00 00 8D 7C 24 24 F3 A5 8B 00 8D 55 04 89 44 24 20 89 54 24 04 8D 45 08 8B 5D 04 8D 55 0C 89 44 24 08 8B 7D 08 89 54 24 0C 8B 75 0C 8B 4C 24 20 C7 44 24 10 ?? ?? ?? ?? C7 44 24 14 ?? ?? ?? ?? C7 44 24 18 ?? ?? ?? ?? C7 44 24 1C 00 00 00 00 E9 99 00 00 00 F6 44 24 1C 0F 75 05 83 44 24 10 04 8B 44 24 1C C1 F8 04 83 F8 01 74 1E 7F 06 85 C0 74 0E EB 37 83 F8 02 74 1F 83 F8 03 74 22 EB 2B 89 D8 89 FA F7 D0 21 F0 EB 08 89 F0 89 F2 F7 D0 21 F8 21 DA 09 D0 EB 10 89 F8 31 D8 31 F0 EB 08 89 F0 F7 D0 09 D8 31 F8 8D 0C 08 8B 44 24 18 8B 54 24 14 0F B6 00 89 04 24 }
	condition:
		$pattern
}

rule _time_mktime_tzi_051c55a831412c88fa915851a7859ca4 {
	meta:
		aliases = "_time_mktime_tzi"
		size = "695"
		objfiles = "_time_mktime_tzi@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 68 B9 0B 00 00 00 8D 6C 24 38 8B 74 24 7C 89 EF F3 A5 8B 84 24 84 00 00 00 80 78 28 00 75 08 C7 44 24 58 00 00 00 00 C7 44 24 34 00 00 00 00 83 7C 24 58 00 74 16 0F 9F C0 0F B6 C0 C7 44 24 34 01 00 00 00 8D 44 00 FF 89 44 24 58 8D 55 14 BF 90 01 00 00 89 54 24 24 8D 5D 18 8B 4D 14 89 5C 24 28 89 C8 8D 75 1C 99 F7 FF 8D 55 10 89 44 24 04 89 45 18 89 54 24 2C 8B 5D 10 89 D8 89 5C 24 14 99 BB 0C 00 00 00 F7 FB 89 44 24 10 89 45 1C 69 5C 24 04 90 01 00 00 01 C1 29 D9 89 4D 14 6B 44 24 10 0C 8B 54 24 14 29 C2 89 D0 89 55 10 85 D2 79 0C 83 C0 0C 89 45 10 8B 4C 24 24 FF 09 8B 4D 14 }
	condition:
		$pattern
}

rule svcunix_create_780769e41d14867b541656a09ff09e70 {
	meta:
		aliases = "svcunix_create"
		size = "358"
		objfiles = "svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 74 31 ED 8B B4 24 88 00 00 00 8B BC 24 94 00 00 00 C7 44 24 70 10 00 00 00 83 FE FF 75 29 6A 00 6A 01 6A 01 E8 ?? ?? ?? ?? 66 BD 01 00 83 C4 0C 89 C6 85 C0 79 11 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 FF E9 85 00 00 00 6A 6E 6A 00 8D 5C 24 0A 53 E8 ?? ?? ?? ?? 66 C7 44 24 0E 01 00 57 E8 ?? ?? ?? ?? 5A 40 89 44 24 7C 50 57 8D 44 24 18 50 E8 ?? ?? ?? ?? 8B 84 24 88 00 00 00 83 C0 02 89 84 24 88 00 00 00 50 53 56 E8 ?? ?? ?? ?? 83 C4 24 8D 44 24 70 50 53 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 0E 6A 02 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 21 68 ?? ?? ?? ?? 31 FF E8 ?? ?? ?? ?? 58 85 ED 0F 84 }
	condition:
		$pattern
}

rule _fp_out_wide_261346907f238c39e9a339e64b928cef {
	meta:
		aliases = "_fp_out_wide"
		size = "135"
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 78 31 ED 8B B4 24 90 00 00 00 8B 9C 24 94 00 00 00 89 F0 84 C0 79 30 FF B4 24 98 00 00 00 E8 ?? ?? ?? ?? 5F 29 C3 89 C7 85 DB 7E 19 83 E6 7F 89 D9 89 F2 8B 84 24 8C 00 00 00 E8 ?? ?? ?? ?? 89 C5 39 D8 75 32 89 FB 85 DB 7E 2C 31 D2 8B 8C 24 98 00 00 00 0F B6 04 11 89 04 94 42 39 DA 7C ED FF B4 24 8C 00 00 00 53 8D 44 24 08 50 E8 ?? ?? ?? ?? 83 C4 0C 01 C5 83 C4 78 89 E8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule getpass_0d8cf8b7de0af6e7ae53f4a596dda3c4 {
	meta:
		aliases = "getpass"
		size = "316"
		objfiles = "getpass@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 78 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5B 89 C6 5F 89 C3 85 C0 75 0C 8B 35 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 8D 7C 24 04 31 ED 57 50 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 43 8D 44 24 3C 6A 3C 57 50 E8 ?? ?? ?? ?? 83 64 24 18 F6 56 E8 ?? ?? ?? ?? 57 6A 02 50 E8 ?? ?? ?? ?? 83 C4 1C 85 C0 0F 94 C0 0F B6 E8 3B 35 ?? ?? ?? ?? 74 0F 6A 00 6A 02 6A 00 56 E8 ?? ?? ?? ?? 83 C4 10 53 FF B4 24 90 00 00 00 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 56 68 FF 00 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 1C 85 C0 79 09 C6 05 ?? ?? ?? ?? 00 EB 40 48 80 }
	condition:
		$pattern
}

rule __uClibc_main_44149fc8e4cce54b5c9534ed277a4dee {
	meta:
		aliases = "__uClibc_main"
		size = "480"
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 7C 8B 94 24 94 00 00 00 8B AC 24 98 00 00 00 C1 E2 02 8B 84 24 A8 00 00 00 A3 ?? ?? ?? ?? 8B 84 24 A4 00 00 00 A3 ?? ?? ?? ?? 8D 44 2A 04 A3 ?? ?? ?? ?? 3B 45 00 75 09 8D 44 15 00 A3 ?? ?? ?? ?? 31 C0 B9 1E 00 00 00 8D 7C 24 04 F3 AB A1 ?? ?? ?? ?? EB 02 89 F0 83 38 00 8D 70 04 75 F6 89 F1 8D 54 24 04 EB 11 8B 01 83 F8 0E 77 07 8D 3C C2 89 CE A5 A5 83 C1 08 83 39 00 75 EA 8D 44 24 04 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 38 85 C0 75 04 66 B8 00 10 A3 ?? ?? ?? ?? 83 7C 24 60 FF 75 20 E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? ?? ?? 39 C3 75 29 E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? ?? ?? 39 C3 75 }
	condition:
		$pattern
}

rule __gen_tempname_ee5f1042e53c2ab5859f78abdfb54fc7 {
	meta:
		aliases = "__gen_tempname"
		size = "605"
		objfiles = "tempname@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 7C E8 ?? ?? ?? ?? 89 44 24 04 8B 00 89 44 24 10 FF B4 24 90 00 00 00 E8 ?? ?? ?? ?? 5B 83 F8 05 76 2D 8B 94 24 90 00 00 00 8D 44 10 FA 89 44 24 08 68 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 5A 85 C0 59 75 0D C7 44 24 0C 00 00 00 00 E9 E5 01 00 00 8B 4C 24 04 C7 01 16 00 00 00 E9 EE 01 00 00 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5E 89 C7 5D 85 C0 79 17 68 00 08 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 89 C7 5B 85 C0 78 21 6A 06 8D 5C 24 7A 53 57 E8 ?? ?? ?? ?? 57 89 C3 E8 ?? ?? ?? ?? 83 C4 10 83 FB 06 0F 84 AB 00 00 00 6A 00 8D 44 24 20 50 E8 ?? ?? ?? ?? 8B 44 24 24 8B 15 ?? ?? ?? ?? 8B 0D }
	condition:
		$pattern
}
...
rule rwlock_have_already_f2fe815c6ab78fc95f72d6c3c75c9e20 {
	meta:
		aliases = "rwlock_have_already"
		size = "164"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 89 C7 89 D6 89 CD 8B 18 83 7A 18 01 74 06 31 C9 31 D2 EB 6F 85 DB 75 07 E8 ?? ?? ?? ?? 89 C3 8B 93 48 01 00 00 EB 07 39 72 04 74 08 8B 12 85 D2 75 F5 EB 04 85 D2 75 4F 83 BB 50 01 00 00 00 7F 46 8B 93 4C 01 00 00 85 D2 74 0A 8B 02 89 83 4C 01 00 00 EB 0A 6A 0C E8 ?? ?? ?? ?? 89 C2 58 85 D2 74 18 C7 42 08 01 00 00 00 89 72 04 8B 83 48 01 00 00 89 02 89 93 48 01 00 00 83 FA 01 19 C9 83 E1 01 31 F6 EB 07 31 C9 BE 01 00 00 00 8B 44 24 14 89 08 89 55 00 89 F0 89 1F 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __syscall_mq_timedsend_6897df56af951bca346f0c6b0a7f3558 {
	meta:
		aliases = "__syscall_mq_timedsend"
		size = "56"
		objfiles = "mq_send@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 89 D3 8B 74 24 14 89 CA 8B 7C 24 18 89 D9 53 89 C3 B8 17 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __syscall_mq_timedreceive_dd19ce3fd993cfe5298b97cf90ef06ff {
	meta:
		aliases = "__syscall_mq_timedreceive"
		size = "56"
		objfiles = "mq_receive@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 89 D3 8B 74 24 14 89 CA 8B 7C 24 18 89 D9 53 89 C3 B8 18 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule byte_compile_range_f3ee7d46b4171feaad5059afe8386ce4 {
	meta:
		aliases = "byte_compile_range"
		size = "204"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 89 D5 8B 12 89 C7 8B 5C 24 18 BE 0B 00 00 00 39 CA 0F 84 AA 00 00 00 81 E3 00 00 01 00 8D 42 01 83 FB 01 89 45 00 19 F6 F7 D6 83 E6 0B 83 7C 24 14 00 74 16 89 F9 0F B6 C1 8B 4C 24 14 0F B6 3C 01 0F B6 02 0F B6 2C 01 EB 03 0F B6 2A 89 FB EB 6C 83 7C 24 14 00 74 1B 0F B6 C3 8B 7C 24 14 BA 08 00 00 00 89 D1 0F B6 04 07 99 F7 F9 89 C6 89 C1 EB 19 0F B6 D3 89 D0 B9 08 00 00 00 99 F7 F9 0F B6 D3 89 C6 89 D0 99 F7 F9 89 C1 8B 7C 24 1C 83 7C 24 14 00 8A 14 0F 89 D9 74 0B 0F B6 C3 8B 7C 24 14 0F B6 0C 07 83 E1 07 B8 01 00 00 00 D3 E0 09 D0 8B 54 24 1C 43 88 04 32 31 F6 39 EB 76 90 89 F0 5B }
	condition:
		$pattern
}

rule xdrrec_getbytes_4b6037192f114c543c04b7cfda2415ed {
	meta:
		aliases = "xdrrec_getbytes"
		size = "95"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 44 24 14 8B 6C 24 18 8B 7C 24 1C 8B 70 0C EB 38 8B 46 34 85 C0 75 13 83 7E 38 00 75 36 89 F0 E8 ?? ?? ?? ?? 85 C0 75 20 EB 29 89 FB 39 C7 76 02 89 C3 89 D9 89 EA 89 F0 E8 ?? ?? ?? ?? 85 C0 74 12 29 5E 34 01 DD 29 DF 85 FF 75 C4 B8 01 00 00 00 EB 02 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule xdrrec_putbytes_b9f6650dbc5c79ac03d8d1bbaf8473b1 {
	meta:
		aliases = "xdrrec_putbytes"
		size = "103"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 44 24 14 8B 6C 24 18 8B 7C 24 1C 8B 70 0C EB 44 8B 56 10 8B 46 14 29 D0 89 FB 39 C7 76 02 89 C3 53 55 52 E8 ?? ?? ?? ?? 89 D8 01 DD 03 46 10 29 DF 83 C4 0C 89 46 10 3B 46 14 75 18 85 FF 74 18 31 D2 C7 46 1C 01 00 00 00 89 F0 E8 ?? ?? ?? ?? 85 C0 74 09 85 FF 75 B8 B8 01 00 00 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule regerror_8d67fd6f7f6693af2c1a0e2c597fe610 {
	meta:
		aliases = "regerror"
		size = "94"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 44 24 14 8B 6C 24 1C 8B 7C 24 20 83 F8 10 76 05 E8 ?? ?? ?? ?? 0F B7 84 00 ?? ?? ?? ?? 8D 98 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 5E 85 FF 8D 70 01 74 21 39 FE 76 12 8D 47 FF 50 53 55 E8 ?? ?? ?? ?? C6 44 3D FF 00 EB 08 56 53 55 E8 ?? ?? ?? ?? 83 C4 0C 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule svcudp_enablecache_b9ca0f6b1d09d2ee933d487fd8c6a5a0 {
	meta:
		aliases = "svcudp_enablecache"
		size = "172"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 44 24 14 8B 7C 24 18 8B 68 30 83 BD B0 01 00 00 00 74 07 68 ?? ?? ?? ?? EB 5D 6A 2C E8 ?? ?? ?? ?? 59 89 C3 85 C0 75 07 68 ?? ?? ?? ?? EB 48 89 FE 89 38 C1 E6 04 C7 40 0C 00 00 00 00 56 E8 ?? ?? ?? ?? 5A 89 43 04 85 C0 75 07 68 ?? ?? ?? ?? EB 25 56 8D 34 BD 00 00 00 00 6A 00 50 E8 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 10 89 43 08 85 C0 75 19 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 C0 EB 14 56 6A 00 50 E8 ?? ?? ?? ?? 89 9D B0 01 00 00 B8 01 00 00 00 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule xdr_array_acb321813b16e7de02e7474686342406 {
	meta:
		aliases = "__GI_xdr_array, xdr_array"
		size = "248"
		objfiles = "xdr_array@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 44 24 18 8B 74 24 1C 8B 18 56 FF 74 24 18 E8 ?? ?? ?? ?? 5A 85 C0 59 0F 84 C6 00 00 00 8B 3E 3B 7C 24 20 77 0D 83 C8 FF 31 D2 F7 74 24 24 39 C7 76 0D 8B 54 24 14 83 3A 02 0F 85 A4 00 00 00 85 DB 75 59 8B 54 24 14 8B 02 83 F8 01 74 0A 83 F8 02 75 49 E9 8F 00 00 00 85 FF 0F 84 87 00 00 00 8B 74 24 24 0F AF F7 56 E8 ?? ?? ?? ?? 89 C3 8B 44 24 1C 85 DB 89 18 5D 75 16 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 F6 5A 59 EB 5C 56 6A 00 53 E8 ?? ?? ?? ?? 83 C4 0C 31 ED BE 01 00 00 00 EB 15 6A FF 53 FF 74 24 1C FF 54 24 34 45 03 5C 24 30 89 C6 83 C4 0C 39 FD 73 04 85 F6 75 E3 8B }
	condition:
		$pattern
}

rule initstate_r_ece25db53196943faeafee7a78343e12 {
	meta:
		aliases = "__GI_initstate_r, initstate_r"
		size = "165"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 44 24 1C 8B 6C 24 18 8B 7C 24 20 83 F8 7F 76 0C 3D 00 01 00 00 19 DB 83 C3 04 EB 16 83 F8 1F 77 09 31 DB 83 F8 07 77 0A EB 58 83 F8 40 19 DB 83 C3 02 0F BE 83 ?? ?? ?? ?? 8D 75 04 88 47 0D 8A 93 ?? ?? ?? ?? 88 5F 0C 8D 04 86 88 57 0E 89 47 10 89 77 08 57 FF 74 24 18 E8 ?? ?? ?? ?? C7 45 00 00 00 00 00 58 31 C0 5A 85 DB 74 2E 8B 47 04 29 F0 C1 F8 02 8D 04 80 8D 04 03 89 45 00 31 C0 EB 19 E8 ?? ?? ?? ?? C7 00 16 00 00 00 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __stdio_adjust_position_a22ed10e380a8da83fb9dc91eb0d1b58 {
	meta:
		aliases = "__stdio_adjust_position"
		size = "153"
		objfiles = "_adjust_pos@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 5C 24 14 31 D2 8B 33 0F B7 C6 89 C1 83 E1 03 74 27 89 CA 4A 74 22 F6 C4 08 74 1D 83 FA 02 74 6A 83 7B 28 00 75 64 0F B6 53 03 F7 DA 83 7B 2C 00 7E 06 0F B6 43 02 29 C2 66 F7 C6 40 00 74 05 8B 43 08 EB 03 8B 43 14 2B 53 10 8D 34 02 8B 44 24 18 8B 08 8B 58 04 89 CF 89 F0 99 89 DD 29 F7 19 D5 89 EA 8B 6C 24 18 39 DA 89 7D 00 89 55 04 7C 08 7F 04 39 CF 76 02 F7 DE 85 F6 79 10 E8 ?? ?? ?? ?? C7 00 4B 00 00 00 EB 03 83 CE FF 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_memmem_7516de3ea3d8f9bbc9e7757cfc1398c9 {
	meta:
		aliases = "memmem, __GI_memmem"
		size = "87"
		objfiles = "memmem@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 5C 24 14 8B 4C 24 18 8B 54 24 20 89 D8 8D 34 0B 29 D6 85 D2 74 37 39 D1 73 25 EB 2F 8B 54 24 1C 8A 03 3A 02 75 16 8D 43 01 55 57 50 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 04 89 D8 EB 11 43 EB 08 8B 7C 24 1C 8D 6A FF 47 39 F3 76 D1 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule random_r_c10c131245f3ea9a155c0bb22f6f23a4 {
	meta:
		aliases = "__GI_random_r, random_r"
		size = "95"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 5C 24 14 8B 6C 24 18 8B 73 08 80 7B 0C 00 75 17 69 06 6D 4E C6 41 05 39 30 00 00 25 FF FF FF 7F 89 06 89 45 00 EB 2C 8B 03 8B 4B 04 8B 7B 10 8B 10 03 11 89 10 83 C0 04 D1 EA 39 F8 89 55 00 8D 51 04 72 04 89 F0 EB 06 39 FA 72 02 89 F2 89 03 89 53 04 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule ether_aton_r_645eb990635be3dd37a6d3014064dfd2 {
	meta:
		aliases = "__GI_ether_aton_r, ether_aton_r"
		size = "134"
		objfiles = "ether_addr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 5C 24 14 8B 7C 24 18 31 ED EB 66 8A 13 83 CA 20 8D 4A D0 80 F9 09 76 07 8D 42 9F 3C 05 77 59 89 CE 80 FA 39 76 03 8D 72 A9 8A 43 01 83 C3 02 83 FD 05 74 04 3C 3A EB 02 84 C0 74 2F 88 C2 83 CA 20 8D 4A D0 80 F9 09 76 07 8D 42 9F 3C 05 77 28 80 FA 39 76 03 8D 4A A9 89 F0 C1 E0 04 83 FD 05 8D 34 01 74 06 80 3B 3A 75 0E 43 89 F0 88 04 2F 45 83 FD 05 7E 95 EB 02 31 FF 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_asctime_r_62afdaa08128dccc1dba76ef7c8f84a1 {
	meta:
		aliases = "asctime_r, __GI_asctime_r"
		size = "191"
		objfiles = "asctime_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 14 8B 5C 24 18 6A 1A 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 8B 45 18 83 C4 0C 83 F8 06 77 0E 8D 34 40 89 DF 81 C6 ?? ?? ?? ?? 66 A5 A4 8B 45 10 83 F8 0B 77 0F 8D 34 40 8D 7B 04 81 C6 ?? ?? ?? ?? 66 A5 A4 8B 55 14 8D 4B 13 81 C2 6C 07 00 00 81 FA 0F 27 00 00 77 1A 8D 4B 17 89 D0 BB 0A 00 00 00 99 F7 FB 83 C2 30 88 11 49 89 C2 80 39 3F 74 E9 0F B6 41 FF 8D 71 FF 8B 54 05 00 83 FA 63 76 0A C6 41 FF 3F C6 46 FF 3F EB 13 89 D0 BB 0A 00 00 00 99 F7 FB 00 41 FE 83 C2 30 88 51 FF 8D 4E FE 80 79 FE 30 74 CA 80 7E FF 30 75 04 C6 46 FF 20 8D 46 F7 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_getcwd_b1eab32697dbe5cb86390f2b204fe153 {
	meta:
		aliases = "getcwd, __GI_getcwd"
		size = "163"
		objfiles = "getcwd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 18 8B 74 24 14 85 ED 75 26 85 F6 74 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 79 E8 ?? ?? ?? ?? 89 C3 3D 00 10 00 00 7D 0F BB 00 10 00 00 EB 08 89 EB 89 F7 85 F6 75 0D 53 E8 ?? ?? ?? ?? 5F 85 C0 74 51 89 C7 89 F8 89 D9 53 89 C3 B8 B7 00 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 0B E8 ?? ?? ?? ?? F7 DB 89 18 EB 1F 85 C0 78 1B 85 F6 75 26 85 ED 75 0F 50 57 E8 ?? ?? ?? ?? 5A 89 C6 59 85 C0 75 13 89 FE EB 0F 85 F6 75 09 57 E8 ?? ?? ?? ?? 58 EB 02 31 F6 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule xdr_reference_60d0f45a2b656b52def90f5e4f4d1b67 {
	meta:
		aliases = "__GI_xdr_reference, xdr_reference"
		size = "131"
		objfiles = "xdr_reference@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 18 8B 7C 24 14 8B 74 24 1C 8B 5D 00 85 DB 75 45 8B 07 83 F8 01 74 0C BE 01 00 00 00 83 F8 02 74 54 EB 32 56 E8 ?? ?? ?? ?? 89 C3 89 45 00 58 85 DB 75 16 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 F6 5A 59 EB 2C 56 6A 00 53 E8 ?? ?? ?? ?? 83 C4 0C 6A FF 53 57 FF 54 24 2C 83 C4 0C 89 C6 83 3F 02 75 0E 53 E8 ?? ?? ?? ?? C7 45 00 00 00 00 00 58 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __stdio_WRITE_54ba21183ba6dd97c357685a82a58dcf {
	meta:
		aliases = "__stdio_WRITE"
		size = "117"
		objfiles = "_WRITE@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 1C 8B 7C 24 14 8B 74 24 18 89 EB 83 FB 00 74 57 7D 07 B8 FF FF FF 7F EB 02 89 D8 50 56 FF 77 04 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 06 29 C3 01 C6 EB D9 8B 47 0C 8B 57 08 66 83 0F 08 89 C1 29 D1 74 23 39 D9 76 02 89 D9 8A 06 88 02 3C 0A 75 06 F6 47 01 01 75 07 42 49 74 03 46 EB EB 89 57 10 2B 57 08 29 D3 29 DD 89 E8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule getgrouplist_e8e5e3fc27ad9f8f7de2b50981ca92e0 {
	meta:
		aliases = "getgrouplist"
		size = "108"
		objfiles = "getgrouplist@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 20 8B 5C 24 18 8B 75 00 55 53 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 0C 89 C7 85 C0 75 11 85 F6 74 3B 8B 44 24 1C 89 18 BB 01 00 00 00 EB 31 8B 5D 00 39 F3 7E 02 89 F3 85 DB 74 15 8D 04 9D 00 00 00 00 50 57 FF 74 24 24 E8 ?? ?? ?? ?? 83 C4 0C 57 E8 ?? ?? ?? ?? 58 3B 5D 00 7D 03 83 CB FF 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_getpwuid_r_bd71f4213c840b6491270d73c0492b51 {
	meta:
		aliases = "getpwuid_r, getgrgid_r, __GI_getgrgid_r, __GI_getpwuid_r"
		size = "127"
		objfiles = "getpwuid_r@libc.a, getgrgid_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 24 8B 7C 24 18 C7 45 00 00 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A 89 C6 59 85 C0 75 09 E8 ?? ?? ?? ?? 8B 18 EB 45 C7 40 34 01 00 00 00 56 FF 74 24 24 FF 74 24 24 57 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 14 89 C3 85 C0 75 0E 8B 44 24 14 39 47 08 75 DA 89 7D 00 EB 0C 31 C0 83 FB 02 0F 95 C0 F7 D8 21 C3 56 E8 ?? ?? ?? ?? 58 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_getpwnam_r_58c1fbfb60120a75998e512e626f63ff {
	meta:
		aliases = "getspnam_r, __GI_getspnam_r, getpwnam_r, getgrnam_r, __GI_getgrnam_r, __GI_getpwnam_r"
		size = "135"
		objfiles = "getgrnam_r@libc.a, getpwnam_r@libc.a, getspnam_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 24 8B 7C 24 18 C7 45 00 00 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C6 5B 85 F6 58 75 09 E8 ?? ?? ?? ?? 8B 18 EB 4D C7 46 34 01 00 00 00 56 FF 74 24 24 FF 74 24 24 57 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 14 89 C3 85 C0 75 16 FF 74 24 14 FF 37 E8 ?? ?? ?? ?? 5A 85 C0 59 75 D2 89 7D 00 EB 0C 31 C0 83 FB 02 0F 95 C0 F7 D8 21 C3 56 E8 ?? ?? ?? ?? 58 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_sgetspent_r_c9832cc3cb55a32a0e026ecddc6f0a6e {
	meta:
		aliases = "sgetspent_r, __GI_sgetspent_r"
		size = "105"
		objfiles = "sgetspent_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 24 8B 7C 24 20 8B 5C 24 14 8B 74 24 1C 81 FF FF 00 00 00 C7 45 00 00 00 00 00 77 12 E8 ?? ?? ?? ?? C7 00 22 00 00 00 B8 22 00 00 00 EB 2F 39 F3 74 14 53 E8 ?? ?? ?? ?? 5A 39 F8 73 DF 53 56 E8 ?? ?? ?? ?? 5B 5F 56 FF 74 24 1C E8 ?? ?? ?? ?? 5A 85 C0 59 75 07 8B 54 24 18 89 55 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule pthread_cancel_27e3d770c534174914f856394a34a086 {
	meta:
		aliases = "pthread_cancel"
		size = "162"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 74 24 14 31 D2 89 F0 25 FF 03 00 00 C1 E0 04 8D B8 ?? ?? ?? ?? 89 F8 E8 ?? ?? ?? ?? 8B 5F 08 85 DB 74 05 39 73 10 74 5C 57 E8 ?? ?? ?? ?? B8 03 00 00 00 EB 3A 57 E8 ?? ?? ?? ?? EB 30 8B 83 44 01 00 00 31 F6 8B 6B 14 85 C0 74 10 53 FF 30 FF 50 04 88 83 40 01 00 00 89 C6 58 5A 57 E8 ?? ?? ?? ?? 58 85 F6 74 0B 53 E8 ?? ?? ?? ?? 31 C0 5F EB 26 FF 35 ?? ?? ?? ?? 55 E8 ?? ?? ?? ?? 5B 31 C0 5E EB 14 0F B6 43 42 80 7B 40 01 C6 43 42 01 74 A3 85 C0 75 9F EB A5 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __encode_answer_d8200c820d212f43c768faefbf9a45d5 {
	meta:
		aliases = "__encode_answer"
		size = "153"
		objfiles = "encodea@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 74 24 14 8B 6C 24 18 8B 5C 24 1C 53 55 FF 36 E8 ?? ?? ?? ?? 83 C4 0C 89 C7 85 C0 78 70 29 C3 8B 46 10 83 C0 0A 39 C3 7D 05 83 CF FF EB 5F 0F B6 46 05 8D 54 3D 00 88 02 8B 46 04 88 42 01 0F B6 46 09 88 42 02 8B 46 08 88 42 03 0F B6 46 0F 88 42 04 0F B6 46 0E 88 42 05 0F B6 46 0D 88 42 06 8B 46 0C 88 42 07 0F B6 46 11 88 42 08 8B 46 10 88 42 09 83 C2 0A FF 76 10 FF 76 14 52 E8 ?? ?? ?? ?? 8B 46 10 83 C4 0C 83 C0 0A 01 C7 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule register_printf_function_d83c20a4e68593df33323df72358bc6a {
	meta:
		aliases = "register_printf_function"
		size = "106"
		objfiles = "register_printf_function@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 74 24 14 8B 7C 24 18 8B 6C 24 1C 85 F6 74 4E 85 ED 74 4A 8B 0D ?? ?? ?? ?? 31 DB 8D 51 0A 4A 8A 02 84 C0 75 02 89 D3 0F B6 C0 39 F0 75 04 89 D3 89 CA 39 CA 77 E8 85 DB 74 23 85 FF 74 18 89 F0 88 03 89 D8 29 D0 89 3C 85 ?? ?? ?? ?? 89 2C 85 ?? ?? ?? ?? EB 03 C6 03 00 31 C0 EB 03 83 C8 FF 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule wcsncasecmp_753ce1164d9fd1eb259384af2f0a97f6 {
	meta:
		aliases = "__GI_wcsncasecmp, wcsncasecmp"
		size = "95"
		objfiles = "wcsncasecmp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 74 24 14 8B 7C 24 18 8B 6C 24 1C EB 0C 83 3E 00 74 0B 83 C6 04 83 C7 04 4D 85 ED 75 04 31 C0 EB 34 8B 06 3B 07 74 E6 50 E8 ?? ?? ?? ?? FF 37 89 C3 E8 ?? ?? ?? ?? 5A 39 C3 59 74 D1 FF 36 E8 ?? ?? ?? ?? FF 37 89 C3 E8 ?? ?? ?? ?? 39 C3 5A 19 C0 59 83 C8 01 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _fp_out_narrow_9c9354f78d9f99f9515e387fb1003bc4 {
	meta:
		aliases = "_fp_out_narrow"
		size = "94"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 74 24 18 31 ED 89 F0 8B 5C 24 1C 84 C0 79 2A FF 74 24 20 E8 ?? ?? ?? ?? 59 29 C3 89 C7 85 DB 7E 16 83 E6 7F 89 D9 89 F2 8B 44 24 14 E8 ?? ?? ?? ?? 89 C5 39 D8 75 1B 89 FB 31 C0 85 DB 7E 11 FF 74 24 14 53 FF 74 24 28 E8 ?? ?? ?? ?? 83 C4 0C 01 C5 89 E8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _obstack_begin_1_c0ab64bf23119547cba5aba24d2d6841 {
	meta:
		aliases = "_obstack_begin_1"
		size = "143"
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 74 24 1C 8B 5C 24 14 8B 54 24 18 8B 4C 24 20 8B 6C 24 28 85 F6 75 04 66 BE 04 00 85 D2 75 04 66 BA E0 0F 89 4B 1C 8D 7E FF 8B 44 24 24 89 13 80 4B 28 01 89 43 20 89 7B 18 89 6B 24 F6 43 28 01 74 0A 52 55 FF D1 89 C2 58 59 EB 06 52 FF D1 89 C2 58 89 53 04 85 D2 75 05 E8 ?? ?? ?? ?? 8D 44 3A 08 F7 DE 21 F0 89 43 08 89 43 0C 89 D0 03 03 89 02 89 43 10 C7 42 04 00 00 00 00 B8 01 00 00 00 80 63 28 F9 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule lldiv_f00e2ee514764ab5affc6f502585946f {
	meta:
		aliases = "imaxdiv, lldiv"
		size = "98"
		objfiles = "lldiv@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 74 24 1C 8B 5C 24 18 FF 74 24 24 FF 74 24 24 56 53 E8 ?? ?? ?? ?? 83 C4 10 FF 74 24 24 FF 74 24 24 56 53 89 C7 89 D5 E8 ?? ?? ?? ?? 83 C4 10 85 F6 78 12 85 D2 79 0E 83 C7 01 83 D5 00 2B 44 24 20 1B 54 24 24 8B 4C 24 14 89 41 08 89 51 0C 89 39 89 69 04 89 C8 5B 5E 5F 5D C2 04 00 }
	condition:
		$pattern
}

rule pthread_setschedparam_e1509a5089028b4e14db92decd6924c0 {
	meta:
		aliases = "__GI_pthread_setschedparam, pthread_setschedparam"
		size = "149"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 7C 24 14 31 D2 89 F8 8B 6C 24 18 25 FF 03 00 00 C1 E0 04 8D B0 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 8B 5E 08 85 DB 74 05 39 7B 10 74 4A 56 E8 ?? ?? ?? ?? B8 03 00 00 00 EB 0D 56 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 00 5A EB 42 31 C0 85 ED 74 06 8B 54 24 1C 8B 02 89 43 18 56 E8 ?? ?? ?? ?? 58 31 C0 83 3D ?? ?? ?? ?? 00 78 21 FF 73 18 E8 ?? ?? ?? ?? 31 C0 EB D0 FF 74 24 1C 55 FF 73 14 E8 ?? ?? ?? ?? 83 C4 0C 40 75 C0 EB AE 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __encode_dotted_c361bf674f22978f226ebcae73a462ce {
	meta:
		aliases = "__encode_dotted"
		size = "130"
		objfiles = "encoded@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 7C 24 14 31 DB EB 51 6A 2E 57 E8 ?? ?? ?? ?? 59 89 C5 5E 85 C0 74 06 89 C6 29 FE EB 09 57 E8 ?? ?? ?? ?? 5A 89 C6 85 F6 74 4B 8B 44 24 1C 29 D8 48 39 C6 73 40 8B 54 24 18 89 F0 88 04 1A 43 89 D0 56 01 D8 57 50 8D 1C 1E E8 ?? ?? ?? ?? 83 C4 0C 85 ED 74 0C 8D 7D 01 85 FF 74 05 80 3F 00 75 A6 83 7C 24 1C 00 7E 0D 8B 44 24 18 C6 04 18 00 8D 43 01 EB 03 83 C8 FF 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule fgets_unlocked_00575c22fd38234626768fd5183c1a95 {
	meta:
		aliases = "__GI_fgets_unlocked, fgets_unlocked"
		size = "94"
		objfiles = "fgets_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 7C 24 14 8B 74 24 18 8B 6C 24 1C 89 FB 85 F6 7F 33 EB 3D 8B 45 10 3B 45 18 73 0E 8A 10 40 88 13 43 80 FA 0A 89 45 10 EB 19 55 E8 ?? ?? ?? ?? 5A 83 F8 FF 75 08 F6 45 00 08 74 0C EB 13 88 03 43 3C 0A 74 03 4E 75 CC 39 FB 76 05 C6 03 00 EB 02 31 FF 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_fgetws_unlocked_f2cc12b65d9d458357c2508ca80503df {
	meta:
...
rule writetcp_cd504d73975a47b072b73a337ab7b637 {
	meta:
		aliases = "writetcp"
		size = "66"
		objfiles = "svc_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 7C 24 1C 8B 6C 24 14 8B 74 24 18 89 FB EB 23 53 56 FF 75 00 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 0E 8B 45 2C 83 CF FF C7 00 00 00 00 00 EB 08 29 C3 01 C6 85 DB 7F D9 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule writetcp_adb00fd9ae573e00a0f182cfbd8589b3 {
	meta:
		aliases = "writetcp"
		size = "75"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 7C 24 1C 8B 6C 24 14 8B 74 24 18 89 FB EB 2C 53 56 FF 75 00 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 FF 75 16 E8 ?? ?? ?? ?? 83 CF FF 8B 00 C7 45 24 03 00 00 00 89 45 28 EB 08 29 C3 01 C6 85 DB 7F D0 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule writeunix_7b4a44439b6a41a37ad3053da1860e58 {
	meta:
		aliases = "writeunix"
		size = "80"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 7C 24 1C 8B 6C 24 14 8B 74 24 18 89 FB EB 31 89 D9 89 F2 8B 45 00 E8 ?? ?? ?? ?? 83 F8 FF 75 1C E8 ?? ?? ?? ?? 83 CF FF 8B 00 C7 85 84 00 00 00 03 00 00 00 89 85 88 00 00 00 EB 08 29 C3 01 C6 85 DB 7F CB 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule xprt_register_51f0c262796e5f0f8835a39b165dee01 {
	meta:
		aliases = "__GI_xprt_register, xprt_register"
		size = "211"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 E8 ?? ?? ?? ?? 8B 74 24 14 89 C3 8B 2E 83 B8 B4 00 00 00 00 75 1D E8 ?? ?? ?? ?? C1 E0 02 50 E8 ?? ?? ?? ?? 89 83 B4 00 00 00 85 C0 5F 0F 84 97 00 00 00 E8 ?? ?? ?? ?? 39 C5 0F 8D 8A 00 00 00 8B 83 B4 00 00 00 81 FD FF 03 00 00 89 34 A8 7F 13 E8 ?? ?? ?? ?? 89 E9 C1 E9 05 89 EA 83 E2 1F 0F AB 14 88 31 DB EB 23 E8 ?? ?? ?? ?? 8D 0C DD 00 00 00 00 89 CA 03 10 83 3A FF 75 0D 89 2A 8B 00 66 C7 44 08 04 C3 00 EB 40 43 E8 ?? ?? ?? ?? 89 C7 8B 00 39 C3 7C D0 8D 58 01 89 1F C1 E3 03 E8 ?? ?? ?? ?? 53 89 C6 FF 30 E8 ?? ?? ?? ?? 89 C2 89 06 58 85 D2 59 74 11 8B 07 89 6C C2 F8 8B 17 8B 06 66 }
	condition:
		$pattern
}

rule __GI_getenv_7d186b154c0727c86ad32db8744bf5b3 {
	meta:
		aliases = "getenv, __GI_getenv"
		size = "71"
		objfiles = "getenv@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 8B 35 ?? ?? ?? ?? 53 85 F6 8B 6C 24 14 74 2E 55 E8 ?? ?? ?? ?? 5A 89 C7 EB 1D 57 53 55 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 0B 8D 04 3B 80 38 3D 75 03 40 EB 0B 83 C6 04 8B 1E 85 DB 75 DD 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule openlog_intern_42310fb04c74cd858737342b7082bc74 {
	meta:
		aliases = "openlog_intern"
		size = "205"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 85 C0 57 89 D5 56 53 74 05 A3 ?? ?? ?? ?? 89 E8 A2 ?? ?? ?? ?? F7 C1 07 FC FF FF 75 09 C1 E9 03 88 0D ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? BF 02 00 00 00 83 FB FF 75 4D BE 02 00 00 00 F7 C5 08 00 00 00 0F 84 80 00 00 00 6A 00 56 6A 01 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 A3 ?? ?? ?? ?? 83 F8 FF 74 67 6A 01 6A 02 50 E8 ?? ?? ?? ?? 6A 03 53 E8 ?? ?? ?? ?? 89 F7 80 CC 08 50 6A 04 53 E8 ?? ?? ?? ?? 83 C4 20 80 3D ?? ?? ?? ?? 00 75 3B 6A 10 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 0C 40 74 09 C6 05 ?? ?? ?? ?? 01 EB 1F 53 BE 01 00 00 00 E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? FF FF FF FF 5A 83 FF 02 0F 84 74 FF FF FF }
	condition:
		$pattern
}
...
rule get_input_bytes_6767237bf2c481ad0a006e2a70f619a1 {
	meta:
		aliases = "get_input_bytes"
		size = "75"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 89 C7 56 89 CE 53 EB 31 8B 57 2C 8B 47 30 29 D0 75 0D 89 F8 E8 ?? ?? ?? ?? 85 C0 75 1C EB 23 89 F3 39 C6 7E 02 89 C3 53 52 55 E8 ?? ?? ?? ?? 01 5F 2C 01 DD 29 DE 83 C4 0C 85 F6 7F CB B8 01 00 00 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule daemon_18ab144db535855cf7da0797fd1de783 {
	meta:
		aliases = "daemon"
		size = "136"
		objfiles = "daemon@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 E8 ?? ?? ?? ?? 83 F8 FF 74 62 85 C0 74 67 6A 00 E8 ?? ?? ?? ?? 83 7D 08 00 75 0B 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 83 7D 0C 00 75 45 6A 02 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 89 C3 58 83 FB FF 74 30 6A 00 53 E8 ?? ?? ?? ?? 6A 01 53 E8 ?? ?? ?? ?? 6A 02 53 E8 ?? ?? ?? ?? 83 C4 18 83 FB 02 7E 10 53 E8 ?? ?? ?? ?? 31 C0 5A EB 13 83 C8 FF EB 0E 31 C0 EB 0A E8 ?? ?? ?? ?? 40 75 98 EB ED 8B 5D FC C9 C3 }
	condition:
		$pattern
}

rule __GI_pthread_exit_af2d50f1b71cf886beb9fbaedaa8978d {
	meta:
...
rule __GI_execlp_5b11615a705e8ed872128db39ff1e1a5 {
	meta:
		aliases = "execlp, __GI_execlp"
		size = "95"
		objfiles = "execlp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 31 F6 8D 45 10 83 EC 04 89 45 F4 8B 55 F4 46 8D 42 04 89 45 F4 83 3A 00 75 F1 8D 04 B5 14 00 00 00 29 C4 8B 45 0C 8D 5C 24 0F 83 E3 F0 89 D9 89 03 8D 45 10 89 45 F4 8B 45 F4 83 C1 04 4E 8D 50 04 89 55 F4 8B 00 89 01 75 ED 53 FF 75 08 E8 ?? ?? ?? ?? 8D 65 F8 5B 5E 5D C3 }
	condition:
		$pattern
}

rule __GI_execl_3c27fcd8ffb18a2c154eb1585151ea85 {
	meta:
		aliases = "execl, __GI_execl"
		size = "101"
		objfiles = "execl@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 31 F6 8D 45 10 83 EC 04 89 45 F4 8B 55 F4 46 8D 42 04 89 45 F4 83 3A 00 75 F1 8D 04 B5 14 00 00 00 29 C4 8B 45 0C 8D 5C 24 0F 83 E3 F0 89 D9 89 03 8D 45 10 89 45 F4 8B 45 F4 83 C1 04 4E 8D 50 04 89 55 F4 8B 00 89 01 75 ED FF 35 ?? ?? ?? ?? 53 FF 75 08 E8 ?? ?? ?? ?? 8D 65 F8 5B 5E 5D C3 }
	condition:
		$pattern
}

rule sem_wait_1afd3a64e08b07d11a84f8386b5b2b4c {
	meta:
		aliases = "__new_sem_wait, sem_wait"
		size = "241"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 83 EC 0C E8 ?? ?? ?? ?? 8B 75 08 89 45 F4 89 F0 8B 55 F4 89 75 EC C7 45 F0 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 46 08 85 C0 7E 10 48 89 46 08 56 E8 ?? ?? ?? ?? 5B E9 AA 00 00 00 8B 45 F4 8D 55 EC C6 80 42 01 00 00 00 8B 45 F4 E8 ?? ?? ?? ?? 8B 45 F4 80 78 42 00 74 0E 8B 45 F4 BB 01 00 00 00 80 78 40 00 74 0D 8B 55 F4 8D 46 0C E8 ?? ?? ?? ?? 31 DB 56 E8 ?? ?? ?? ?? 59 85 DB 74 0C 8B 45 F4 31 D2 E8 ?? ?? ?? ?? EB 52 8B 45 F4 E8 ?? ?? ?? ?? 8B 45 F4 80 B8 42 01 00 00 00 75 15 8B 45 F4 80 B8 40 01 00 00 00 74 E0 8B 45 F4 80 78 40 00 75 D7 8B 45 F4 31 D2 E8 ?? ?? ?? ?? 8B 45 F4 80 B8 40 01 }
	condition:
		$pattern
}

rule pthread_start_thread_6d8c16a82d408ce28bd3dcd79f4b58f8 {
	meta:
		aliases = "pthread_start_thread"
		size = "163"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 83 EC 20 8B 75 08 E8 ?? ?? ?? ?? 89 46 14 8D 46 64 6A 00 50 6A 02 E8 ?? ?? ?? ?? 8B 56 6C 83 C4 0C 85 D2 78 07 8D 46 70 50 52 EB 16 83 3D ?? ?? ?? ?? 00 7E 18 8D 45 F4 C7 45 F4 00 00 00 00 50 6A 00 FF 76 14 E8 ?? ?? ?? ?? 83 C4 0C A1 ?? ?? ?? ?? 85 C0 74 3B 83 3D ?? ?? ?? ?? 00 7E 32 89 75 D8 C7 45 DC 05 00 00 00 8D 5D D8 6A 1C 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E2 56 E8 ?? ?? ?? ?? 59 FF 76 60 FF 56 5C 55 50 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __pthread_cleanup_pop_restore_eff9d5b81ce18e94b8ff14f77fc1dfb9 {
	meta:
		aliases = "_pthread_cleanup_pop_restore, __pthread_cleanup_pop_restore"
		size = "68"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 E8 ?? ?? ?? ?? 8B 5D 08 89 C6 83 7D 0C 00 74 06 FF 73 04 FF 13 59 8B 43 0C 89 46 3C 8B 43 08 88 46 41 80 7E 42 00 74 10 66 81 7E 40 00 01 75 08 55 6A FF E8 ?? ?? ?? ?? 8D 65 F8 5B 5E 5D C3 }
	condition:
		$pattern
}
...
rule ruserok_f1bf8095099d29b410b839966cc9690c {
	meta:
		aliases = "ruserok"
		size = "159"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 30 04 00 00 BB 00 04 00 00 8D 7D E8 8D 75 F0 8D 44 24 0F 83 E0 F0 EB 21 83 7D E8 FF 75 6E E8 ?? ?? ?? ?? 83 38 22 75 64 01 DB 8D 43 12 83 E0 FC 29 C4 8D 44 24 0F 83 E0 F0 57 56 53 50 8D 45 D4 50 FF 75 08 E8 ?? ?? ?? ?? 83 C4 18 85 C0 75 C8 8B 45 F0 85 C0 74 C1 8B 58 10 8D 75 EC EB 27 6A 04 50 56 E8 ?? ?? ?? ?? FF 75 08 FF 75 14 8B 45 EC 8B 4D 10 8B 55 0C E8 ?? ?? ?? ?? 83 C4 14 85 C0 74 0C 83 C3 04 8B 03 85 C0 75 D3 83 C8 FF 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule clntudp_call_96d1a10903d6a64137a9cbbaf4843d26 {
	meta:
		aliases = "clntudp_call"
		size = "1317"
		objfiles = "clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 38 23 00 00 BB E8 03 00 00 8B 45 08 8B 70 08 8B 4E 20 89 C8 99 F7 FB 89 C1 69 46 1C E8 03 00 00 01 C1 89 8D D4 DC FF FF 83 7E 28 FF 75 0E 8B 45 24 8B 55 20 89 85 E4 DC FF FF EB 0C 8B 46 28 89 85 E4 DC FF FF 8B 56 24 89 95 E8 DC FF FF 8D 46 38 8D 56 08 C7 85 D0 DC FF FF 00 00 00 00 C7 85 D8 DC FF FF 02 00 00 00 C7 85 E0 DC FF FF 00 00 00 00 C7 85 EC DC FF FF 00 00 00 00 89 85 C0 DC FF FF 89 95 BC DC FF FF 8B 85 C0 DC FF FF 89 85 CC DC FF FF 83 7D 10 00 0F 84 D7 00 00 00 C7 46 38 00 00 00 00 8B 46 3C FF 76 50 FF B5 CC DC FF FF FF 50 14 8B 46 58 FF 00 8D 45 0C 8B 56 3C 50 }
	condition:
		$pattern
}

rule getrpcport_3b49ba65339827314b725bc46aa7e088 {
	meta:
		aliases = "getrpcport"
		size = "160"
		objfiles = "getrpcport@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 3C 04 00 00 BB 00 04 00 00 8D 7D EC 8D 75 F0 8D 44 24 0F 83 E0 F0 EB 21 83 7D EC FF 75 70 E8 ?? ?? ?? ?? 83 38 22 75 66 01 DB 8D 43 12 83 E0 FC 29 C4 8D 44 24 0F 83 E0 F0 57 56 53 50 8D 45 C8 50 FF 75 08 E8 ?? ?? ?? ?? 83 C4 18 85 C0 75 C8 8B 45 F0 85 C0 74 C1 FF 70 0C 8B 40 10 8D 5D DC FF 30 8D 45 E0 50 E8 ?? ?? ?? ?? FF 75 14 FF 75 10 FF 75 0C 66 C7 45 DC 02 00 53 66 C7 45 DE 00 00 E8 ?? ?? ?? ?? 83 C4 1C 0F B7 C0 EB 02 31 C0 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule ruserpass_759cf26d091d2eb3c824a03a99d57217 {
	meta:
		aliases = "__GI_ruserpass, ruserpass"
		size = "789"
		objfiles = "ruserpass@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 5C 04 00 00 8B 7D 08 E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? ?? ?? 39 C3 0F 85 E5 02 00 00 E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? ?? ?? 39 C3 0F 85 D1 02 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 89 C6 85 C0 0F 84 BC 02 00 00 50 E8 ?? ?? ?? ?? 83 C0 1A 5A 83 E0 FC 29 C4 8D 5C 24 0F 56 83 E3 F0 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 18 A3 ?? ?? ?? ?? 85 C0 75 24 E8 ?? ?? ?? ?? 31 D2 83 38 02 0F 84 70 02 00 00 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5B 31 D2 5E E9 5C 02 00 00 8D 9D 9C FB FF FF 6A 02 50 E8 ?? ?? ?? ?? 68 00 04 00 00 53 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule gaih_inet_591ae6954f1294011f611fcf6b8dad9f {
	meta:
		aliases = "gaih_inet"
		size = "2388"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 88 00 00 00 8D 45 D4 8B 55 10 89 45 F0 C7 45 EC 00 00 00 00 8B 42 04 85 C0 74 0F C7 85 78 FF FF FF 00 00 00 00 83 F8 0A 75 16 8B 4D 10 8B 19 83 F3 08 C1 EB 03 F7 D3 83 E3 01 89 9D 78 FF FF FF 31 C0 8D 7D D4 AB AB AB AB 8B 7D 10 8B 4F 0C 85 C9 75 0D 83 7F 08 00 75 07 EB 5A 83 C3 07 EB 05 BB ?? ?? ?? ?? 8A 43 03 88 85 77 FF FF FF 84 C0 74 2C 8B 7D 10 8B 57 08 85 D2 74 07 0F BE 03 39 C2 75 D8 85 C9 74 0E F6 43 02 02 75 08 0F BE 43 01 39 C1 75 C6 80 BD 77 FF FF FF 00 75 1C 8B 55 10 B8 07 01 00 00 83 7A 08 00 0F 85 94 08 00 00 E9 78 08 00 00 BB ?? ?? ?? ?? 83 7D 0C 00 0F 84 }
	condition:
		$pattern
}
...
rule clnt_create_21fe5c30fc1f5a633d5a2487a8c7d8cc {
	meta:
		aliases = "clnt_create"
		size = "490"
		objfiles = "clnt_generic@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC B0 00 00 00 68 ?? ?? ?? ?? FF 75 14 E8 ?? ?? ?? ?? 5A 85 C0 59 75 4B 8D 9D 46 FF FF FF 6A 6E 6A 00 53 E8 ?? ?? ?? ?? 8D 85 48 FF FF FF FF 75 08 66 C7 85 46 FF FF FF 01 00 50 E8 ?? ?? ?? ?? 8D 45 E8 6A 00 6A 00 50 C7 45 E8 FF FF FF FF FF 75 10 FF 75 0C 53 E8 ?? ?? ?? ?? 83 C4 2C E9 78 01 00 00 81 EC 10 04 00 00 BB 00 04 00 00 8D 44 24 0F 83 E0 F0 EB 31 83 7D E4 FF 75 0A E8 ?? ?? ?? ?? 83 38 22 74 10 E8 ?? ?? ?? ?? C7 00 0D 00 00 00 E9 42 01 00 00 01 DB 8D 43 12 83 E0 FC 29 C4 8D 44 24 0F 83 E0 F0 8D 55 E4 52 8D 55 F0 52 53 50 8D 45 B4 50 FF 75 08 E8 ?? ?? ?? ?? 83 C4 18 }
	condition:
		$pattern
}

rule link_exists_p_d8330c10dedad514b39dfab865565584 {
	meta:
		aliases = "link_exists_p"
		size = "139"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC B8 00 00 00 89 85 3C FF FF FF 89 D3 89 CE 51 E8 ?? ?? ?? ?? 89 85 40 FF FF FF 5F 8D 44 18 14 83 E0 FC 29 C4 8D 7C 24 0F 53 FF B5 3C FF FF FF 83 E7 F0 57 E8 ?? ?? ?? ?? C6 00 2F 40 8B 95 40 FF FF FF 42 52 56 50 E8 ?? ?? ?? ?? 83 C4 18 F7 45 0C 00 02 00 00 74 0D 8D 45 9C 50 8B 45 08 57 FF 50 20 EB 0D 8D 85 44 FF FF FF 50 57 E8 ?? ?? ?? ?? 85 C0 5B 0F 94 C0 5E 8D 65 F4 0F B6 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule link_exists_p_454aefb19026444f264c806c904f1643 {
	meta:
		aliases = "link_exists_p"
		size = "139"
		objfiles = "glob64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC C8 00 00 00 89 85 2C FF FF FF 89 D3 89 CE 51 E8 ?? ?? ?? ?? 89 85 30 FF FF FF 5F 8D 44 18 14 83 E0 FC 29 C4 8D 7C 24 0F 53 FF B5 2C FF FF FF 83 E7 F0 57 E8 ?? ?? ?? ?? C6 00 2F 40 8B 95 30 FF FF FF 42 52 56 50 E8 ?? ?? ?? ?? 83 C4 18 F7 45 0C 00 02 00 00 74 0D 8D 45 94 50 8B 45 08 57 FF 50 20 EB 0D 8D 85 34 FF FF FF 50 57 E8 ?? ?? ?? ?? 85 C0 59 0F 94 C0 5B 8D 65 F4 0F B6 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule glob_15cae7ee83dcf7999a798bd44bf95c96 {
	meta:
		aliases = "__GI_glob, glob"
		size = "1301"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC D8 00 00 00 8B 7D 14 83 7D 08 00 74 0D 85 FF 74 09 F7 45 0C 00 81 FF FF 74 13 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 E9 D6 04 00 00 8B 45 0C 83 E0 08 89 85 24 FF FF FF 75 07 C7 47 08 00 00 00 00 6A 2F FF 75 08 E8 ?? ?? ?? ?? 5B 85 C0 5E 89 C6 75 38 F7 45 0C 00 50 00 00 0F 84 C9 00 00 00 8B 55 08 80 3A 7E 0F 85 BD 00 00 00 52 E8 ?? ?? ?? ?? 59 8B 5D 08 89 85 30 FF FF FF C7 85 2C FF FF FF 00 00 00 00 E9 B6 00 00 00 3B 45 08 75 1E 8B 4D 08 BB ?? ?? ?? ?? 41 C7 85 30 FF FF FF 01 00 00 00 89 8D 2C FF FF FF E9 93 00 00 00 2B 45 08 89 85 30 FF FF FF 83 C0 13 83 E0 FC 29 C4 }
	condition:
		$pattern
}

rule glob_in_dir_888c59f1ab9fc6bbad58ec93b09ae968 {
	meta:
		aliases = "glob_in_dir"
		size = "1184"
		objfiles = "glob64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC E8 00 00 00 89 8D 14 FF FF FF 89 95 18 FF FF FF 89 85 1C FF FF FF 52 E8 ?? ?? ?? ?? 8B 9D 14 FF FF FF 89 85 20 FF FF FF 83 E3 40 8B 75 08 0F 94 C0 0F B6 C0 89 04 24 FF B5 1C FF FF FF E8 ?? ?? ?? ?? 59 85 C0 5F 0F 85 B4 00 00 00 F7 85 14 FF FF FF 10 08 00 00 0F 85 98 00 00 00 85 DB 75 17 6A 5C FF B5 1C FF FF FF E8 ?? ?? ?? ?? 5F 85 C0 5A 0F 85 89 00 00 00 FF B5 1C FF FF FF E8 ?? ?? ?? ?? 8B 95 20 FF FF FF 5E 89 C6 8D 44 10 14 83 E0 FC 29 C4 8D 5C 24 0F 52 FF B5 18 FF FF FF 83 E3 F0 53 E8 ?? ?? ?? ?? 8D 56 01 C6 00 2F 52 FF B5 1C FF FF FF 40 50 E8 ?? ?? ?? ?? 83 C4 18 F7 }
	condition:
		$pattern
}

rule __GI_glob64_d7ac2aeec175c13c2258f506dd61c633 {
	meta:
		aliases = "glob64, __GI_glob64"
		size = "1301"
		objfiles = "glob64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC E8 00 00 00 8B 7D 14 83 7D 08 00 74 0D 85 FF 74 09 F7 45 0C 00 81 FF FF 74 13 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 E9 D6 04 00 00 8B 45 0C 83 E0 08 89 85 14 FF FF FF 75 07 C7 47 08 00 00 00 00 6A 2F FF 75 08 E8 ?? ?? ?? ?? 5B 85 C0 5E 89 C6 75 38 F7 45 0C 00 50 00 00 0F 84 C9 00 00 00 8B 55 08 80 3A 7E 0F 85 BD 00 00 00 52 E8 ?? ?? ?? ?? 59 8B 5D 08 89 85 20 FF FF FF C7 85 1C FF FF FF 00 00 00 00 E9 B6 00 00 00 3B 45 08 75 1E 8B 4D 08 BB ?? ?? ?? ?? 41 C7 85 20 FF FF FF 01 00 00 00 89 8D 1C FF FF FF E9 93 00 00 00 2B 45 08 89 85 20 FF FF FF 83 C0 13 83 E0 FC 29 C4 }
	condition:
		$pattern
}

rule glob_in_dir_6affe9b48640ccd3cb55d780dfb42978 {
	meta:
		aliases = "glob_in_dir"
		size = "1250"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC E8 01 00 00 89 8D 10 FE FF FF 89 95 14 FE FF FF 89 85 18 FE FF FF 52 E8 ?? ?? ?? ?? 8B 9D 10 FE FF FF 89 85 1C FE FF FF 83 E3 40 8B 75 08 0F 94 C0 0F B6 C0 89 04 24 FF B5 18 FE FF FF E8 ?? ?? ?? ?? 59 85 C0 5F 0F 85 B4 00 00 00 F7 85 10 FE FF FF 10 08 00 00 0F 85 98 00 00 00 85 DB 75 17 6A 5C FF B5 18 FE FF FF E8 ?? ?? ?? ?? 5F 85 C0 5A 0F 85 89 00 00 00 FF B5 18 FE FF FF E8 ?? ?? ?? ?? 8B 95 1C FE FF FF 5E 89 C6 8D 44 10 14 83 E0 FC 29 C4 8D 5C 24 0F 52 FF B5 14 FE FF FF 83 E3 F0 53 E8 ?? ?? ?? ?? 8D 56 01 C6 00 2F 52 FF B5 18 FE FF FF 40 50 E8 ?? ?? ?? ?? 83 C4 18 F7 }
	condition:
		$pattern
}

rule byte_re_match_2_internal_2928720ceac66f97c36c94fa2bda5887 {
	meta:
		aliases = "byte_re_match_2_internal"
		size = "6887"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC F4 00 00 00 89 85 58 FF FF FF 89 95 54 FF FF FF 89 8D 50 FF FF FF 8B 00 8B 95 58 FF FF FF 89 85 7C FF FF FF 8D 7C 24 0F 03 42 08 83 E7 F0 89 45 80 8B 5D 18 8B 4A 14 89 4D 88 8B 72 18 89 7D D8 46 89 75 8C 83 7A 18 00 75 41 C7 45 98 00 00 00 00 C7 45 9C 00 00 00 00 C7 45 A0 00 00 00 00 C7 45 A4 00 00 00 00 C7 45 A8 00 00 00 00 C7 45 B0 00 00 00 00 C7 45 B4 00 00 00 00 C7 45 C0 00 00 00 00 C7 45 C4 00 00 00 00 EB 76 8B 55 8C 8D 04 95 10 00 00 00 29 C4 8D 4C 24 0F 29 C4 83 E1 F0 8D 74 24 0F 29 C4 89 4D 98 83 E6 F0 8D 7C 24 0F 29 C4 89 75 9C 83 E7 F0 8D 54 24 0F 29 C4 89 7D }
	condition:
		$pattern
}

rule pthread_cleanup_upto_f8a13de5841e4d24d68f6b3cbb22f821 {
	meta:
		aliases = "pthread_cleanup_upto"
		size = "141"
		objfiles = "ptlongjmp@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 04 89 C7 BE ?? ?? ?? ?? 89 E8 3B 2D ?? ?? ?? ?? 73 32 3B 2D ?? ?? ?? ?? 72 0D BE ?? ?? ?? ?? 3B 2D ?? ?? ?? ?? 72 1D 83 3D ?? ?? ?? ?? 00 74 09 E8 ?? ?? ?? ?? 89 C6 EB 0B 0D FF FF 1F 00 8D B0 A1 FE FF FF 89 6D F0 8B 5E 3C EB 12 3B 5D F0 77 04 31 DB EB 12 FF 73 04 FF 13 8B 5B 0C 58 85 DB 74 05 3B 5F 10 72 E5 8B 46 54 89 5E 3C 85 C0 74 0C 3B 47 10 73 07 C7 46 54 00 00 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule sem_timedwait_126fb44c0000f9e39aea4c199fbf5079 {
	meta:
		aliases = "sem_timedwait"
		size = "345"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 0C E8 ?? ?? ?? ?? 8B 75 08 89 45 E8 89 C2 89 F0 E8 ?? ?? ?? ?? 8B 46 08 85 C0 7E 0E 48 89 46 08 56 E8 ?? ?? ?? ?? 31 C0 EB 20 8B 45 0C 81 78 04 FF C9 9A 3B 76 1A 56 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF 5A E9 F9 00 00 00 8B 45 E8 89 75 EC C7 45 F0 ?? ?? ?? ?? 8D 55 EC C6 80 42 01 00 00 00 8B 45 E8 E8 ?? ?? ?? ?? 8B 45 E8 80 78 42 00 74 0B BB 01 00 00 00 80 78 40 00 74 0D 8D 46 0C 8B 55 E8 E8 ?? ?? ?? ?? 31 DB 56 E8 ?? ?? ?? ?? 5F 85 DB 8D 7E 0C 74 0F 31 D2 8B 45 E8 E8 ?? ?? ?? ?? E9 92 00 00 00 FF 75 0C FF 75 E8 E8 ?? ?? ?? ?? 5A 85 C0 59 75 43 8B 55 }
	condition:
		$pattern
}

rule pthread_cond_wait_a916210ca4338bcbdd8b793470d8e3f3 {
	meta:
		aliases = "__GI_pthread_cond_wait, pthread_cond_wait"
		size = "293"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 0C E8 ?? ?? ?? ?? 8B 75 0C 89 45 F0 8B 5D 08 8B 46 0C 83 F8 03 74 15 85 C0 74 11 8B 45 F0 BA 16 00 00 00 39 46 08 0F 85 E7 00 00 00 8B 45 F0 89 5D E8 C7 45 EC ?? ?? ?? ?? 8D 55 E8 C6 80 41 01 00 00 00 8B 45 F0 E8 ?? ?? ?? ?? 89 D8 8B 55 F0 E8 ?? ?? ?? ?? 8B 45 F0 80 78 42 00 74 0E 8B 45 F0 BF 01 00 00 00 80 78 40 00 74 0D 8B 55 F0 8D 43 08 E8 ?? ?? ?? ?? 31 FF 53 E8 ?? ?? ?? ?? 58 85 FF 74 0C 8B 45 F0 31 D2 E8 ?? ?? ?? ?? EB 64 56 31 DB E8 ?? ?? ?? ?? 58 8B 45 F0 E8 ?? ?? ?? ?? 8B 45 F0 80 B8 41 01 00 00 00 75 18 8B 45 F0 80 B8 40 01 00 00 00 74 09 8B 45 F0 80 78 40 00 }
	condition:
		$pattern
}

rule __getdents64_cf105abd4744d52210de982a945133bc {
	meta:
		aliases = "__getdents64"
		size = "264"
		objfiles = "getdents64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 10 8B 55 10 8B 7D 08 8D 42 12 83 E0 FC 29 C4 8D 4C 24 0F 83 E1 F0 53 89 FB B8 DC 00 00 00 CD 80 5B 89 C6 3D 00 F0 FF FF 76 0B E8 ?? ?? ?? ?? F7 DE 89 30 EB 64 83 C8 FF 83 FE FF 0F 84 B7 00 00 00 8B 7D 0C 8D 34 31 01 FA 89 CB C7 45 EC FF FF FF FF C7 45 F0 FF FF FF FF 89 75 E8 89 55 E4 E9 86 00 00 00 0F B7 43 10 8D 48 03 83 E1 FC 8D 34 0F 3B 75 E4 76 28 6A 00 FF 75 F0 FF 75 EC FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 3B 7D 0C 75 65 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 5A 8B 43 08 8B 53 0C 89 55 F0 89 45 EC 8B 03 8B 53 04 89 57 04 89 07 8B 43 08 8B 53 0C 89 57 0C 89 47 08 }
	condition:
		$pattern
}

rule __GI_execvp_ef85177fd1b6a2dad86f711944255f55 {
	meta:
		aliases = "execvp, __GI_execvp"
		size = "412"
		objfiles = "execvp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 10 8B 75 08 80 3E 00 75 10 E8 ?? ?? ?? ?? C7 00 02 00 00 00 E9 70 01 00 00 6A 2F 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 71 FF 35 ?? ?? ?? ?? FF 75 0C 56 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 83 38 08 0F 85 42 01 00 00 31 C0 EB 01 40 8D 14 85 00 00 00 00 8B 4D 0C 83 3C 11 00 75 EF 8D 42 18 29 C4 8B 01 8D 5C 24 0F 83 E3 F0 89 03 89 C8 83 C0 04 89 73 04 52 50 8D 43 08 50 E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 18 E9 F1 00 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C7 58 85 FF 75 07 BF ?? ?? ?? ?? EB 09 80 3F 00 0F 84 50 FF FF FF 56 E8 ?? ?? ?? ?? 5B }
	condition:
		$pattern
}

rule pthread_cond_timedwait_dce3afd1eecb37c0c939e2d3477cea56 {
	meta:
		aliases = "__GI_pthread_cond_timedwait, pthread_cond_timedwait"
		size = "389"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 10 E8 ?? ?? ?? ?? 8B 7D 0C 89 45 F0 8B 47 0C 83 F8 03 74 15 85 C0 74 11 8B 45 F0 BA 16 00 00 00 39 47 08 0F 85 4A 01 00 00 8B 45 08 C7 45 EC ?? ?? ?? ?? 89 45 E8 8B 45 F0 8D 55 E8 C6 80 41 01 00 00 00 8B 45 F0 E8 ?? ?? ?? ?? 8B 45 08 8B 55 F0 E8 ?? ?? ?? ?? 8B 45 F0 80 78 42 00 74 0E 8B 45 F0 BB 01 00 00 00 80 78 40 00 74 10 8B 45 08 8B 55 F0 83 C0 08 31 DB E8 ?? ?? ?? ?? FF 75 08 E8 ?? ?? ?? ?? 5E 85 DB 74 0F 8B 45 F0 31 D2 E8 ?? ?? ?? ?? E9 BB 00 00 00 57 E8 ?? ?? ?? ?? 8B 45 08 31 F6 83 C0 08 5B 89 45 E4 FF 75 10 8B 45 F0 50 E8 ?? ?? ?? ?? 5A 85 C0 59 75 44 8B 55 F0 }
	condition:
		$pattern
}

rule search_for_named_library_eb166f9732e8cefed63dcb1ac9660800 {
	meta:
		aliases = "search_for_named_library"
		size = "269"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 14 89 55 E8 89 45 EC 89 CA 85 C9 0F 84 EA 00 00 00 8D 41 FF 40 80 38 00 75 FA 29 D0 4A 8D 70 01 8D 46 12 83 E0 FC 29 C4 8D 5C 24 0F 81 EC 14 08 00 00 83 E3 F0 8D 44 24 0F 89 DF 83 E0 F0 8D 4B FF 89 45 E4 EB 07 42 41 4E 8A 02 88 01 85 F6 75 F5 8B 55 E4 89 D8 C7 45 F0 00 00 00 00 8D 72 FF 8B 55 EC 4A 89 55 E0 80 3F 00 75 0A C6 07 3A C7 45 F0 01 00 00 00 80 3F 3A 75 74 C6 07 00 80 38 00 74 11 89 F1 8D 50 FF 42 41 8A 02 88 01 84 C0 74 13 EB F4 89 F2 B9 ?? ?? ?? ?? 41 42 8A 01 88 02 84 C0 75 F6 89 F3 89 F0 40 80 38 00 75 FA 8D 50 FF B9 ?? ?? ?? ?? 41 42 8A 01 88 02 84 C0 75 }
	condition:
		$pattern
}

rule if_nameindex_4af4261ff5af9383244fe7c9795aba3d {
	meta:
		aliases = "__GI_if_nameindex, if_nameindex"
		size = "377"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 18 E8 ?? ?? ?? ?? C7 45 E4 00 00 00 00 89 45 DC 85 C0 0F 88 4E 01 00 00 C7 45 F0 00 00 00 00 B9 80 00 00 00 8D 75 EC 8D 1C 09 8D 43 12 83 E0 FC 29 C4 8D 54 24 0F 83 E2 F0 8D 04 1A 3B 45 F0 75 02 01 CB 56 68 12 89 00 00 FF 75 DC 89 55 F0 89 5D EC E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 14 FF 75 DC E8 ?? ?? ?? ?? C7 45 E4 00 00 00 00 E9 F3 00 00 00 8B 45 EC 39 D8 75 04 89 C1 EB AA C1 E8 05 31 FF 89 45 E0 8D 04 C5 08 00 00 00 50 E8 ?? ?? ?? ?? 59 89 45 E4 85 C0 0F 85 A3 00 00 00 FF 75 DC E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 00 69 00 00 00 E9 AF 00 00 00 89 FB 8B 45 E4 C1 E3 05 03 5D }
	condition:
		$pattern
}
...
rule gaih_inet_serv_f389cd848cdf3b29bb8de08af38e703a {
	meta:
		aliases = "gaih_inet_serv"
		size = "145"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C 89 D3 89 45 DC 89 4D D8 8B 7D 08 BE 00 04 00 00 8D 46 12 8D 55 F0 83 E0 FC 29 C4 8D 44 24 0F 52 83 E0 F0 56 50 8D 45 E0 50 8D 43 03 50 FF 75 DC E8 ?? ?? ?? ?? 83 C4 18 85 C0 75 08 83 7D F0 00 75 0B EB 37 83 F8 22 75 32 01 F6 EB C3 C7 07 00 00 00 00 0F BE 03 89 47 04 F6 43 02 02 74 08 8B 55 D8 8B 42 0C EB 04 0F BE 43 01 89 47 08 8B 45 F0 8B 40 08 89 47 0C 31 C0 EB 05 B8 08 01 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule pthread_initialize_bd8d8f072e56a4effec4f902de13d0da {
	meta:
		aliases = "pthread_initialize"
		size = "364"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 24 83 3D ?? ?? ?? ?? 00 0F 85 4E 01 00 00 8D 85 00 00 C0 FF 25 00 00 E0 FF A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? A3 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 EB 10 83 7B 34 01 74 07 C7 43 34 00 00 00 00 8B 5B 20 85 DB 75 EC 8D 7D E4 57 6A 03 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? BA 00 00 20 00 01 C0 59 29 C2 5E 39 55 E4 76 0D 57 89 55 E4 6A 03 E8 ?? ?? ?? ?? 58 5A 8D 75 D0 89 D8 89 F7 AB AB AB AB AB 6A 00 56 FF 35 ?? ?? ?? ?? C7 45 D0 ?? ?? ?? ?? E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 8D 45 DC C7 45 D0 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule iruserok2_7ce0d6df30992b07f4d264f653a655fa {
	meta:
		aliases = "iruserok2"
		size = "300"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 2C 89 D6 89 45 CC 89 4D C8 85 D2 75 12 31 D2 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C3 85 C0 75 05 83 CF FF EB 24 FF 75 0C FF 75 C8 8B 4D 08 8B 55 CC E8 ?? ?? ?? ?? 53 89 C7 E8 ?? ?? ?? ?? 83 C4 0C 85 FF 0F 84 D2 00 00 00 0B 35 ?? ?? ?? ?? 0F 84 C3 00 00 00 6A 46 E8 ?? ?? ?? ?? 59 8D 50 12 83 E2 FC 29 D4 8D 55 F0 8D 4C 24 0F 52 83 E1 F0 50 8D 45 D4 51 50 FF 75 08 E8 ?? ?? ?? ?? 83 C4 14 85 C0 0F 85 8F 00 00 00 8B 45 F0 85 C0 0F 84 84 00 00 00 FF 70 14 E8 ?? ?? ?? ?? 83 C0 09 89 04 24 E8 ?? ?? ?? ?? 89 C3 8B 45 F0 FF 70 14 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? E8 }
	condition:
		$pattern
}

rule pthread_join_ad796a392b3a0af1307bfc4a94ff6b00 {
	meta:
		aliases = "pthread_join"
		size = "377"
		objfiles = "join@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 2C E8 ?? ?? ?? ?? 8B 7D 08 89 45 F0 89 F8 25 FF 03 00 00 8B 55 F0 C1 E0 04 C7 45 EC ?? ?? ?? ?? 8D 98 ?? ?? ?? ?? 89 D8 89 5D E8 E8 ?? ?? ?? ?? 8B 43 08 89 45 C8 85 C0 74 05 39 78 10 74 0D 53 E8 ?? ?? ?? ?? B8 03 00 00 00 EB 2F 8B 45 F0 39 45 C8 75 0D 53 E8 ?? ?? ?? ?? B8 23 00 00 00 EB 1A 8B 55 C8 80 7A 2D 00 75 06 83 7A 38 00 74 11 53 E8 ?? ?? ?? ?? B8 16 00 00 00 5A E9 E8 00 00 00 8B 45 C8 80 78 2C 00 0F 85 87 00 00 00 8B 45 F0 8D 55 E8 E8 ?? ?? ?? ?? 8B 45 F0 80 78 42 00 74 0E 8B 45 F0 BE 01 00 00 00 80 78 40 00 74 0B 8B 55 C8 8B 45 F0 31 F6 89 42 38 53 E8 ?? ?? ?? }
	condition:
		$pattern
}

rule callrpc_6abe1b7d3b094eb0caf931c3467f1003 {
	meta:
		aliases = "callrpc"
		size = "510"
		objfiles = "clnt_simple@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 3C C7 45 C0 00 00 00 00 C7 45 C4 00 00 00 00 C7 45 B8 00 00 00 00 C7 45 BC 00 00 00 00 E8 ?? ?? ?? ?? 89 C3 8B B0 A4 00 00 00 85 F6 75 1F 6A 18 6A 01 E8 ?? ?? ?? ?? 5E 89 C2 5F 31 C0 85 D2 0F 84 A9 01 00 00 89 D6 89 93 A4 00 00 00 83 7E 14 00 75 18 68 00 01 00 00 E8 ?? ?? ?? ?? 89 46 14 C6 00 00 C7 46 04 FF FF FF FF 59 83 7E 10 00 74 25 8B 45 0C 39 46 08 75 1D 8B 55 10 39 56 0C 75 15 FF 75 08 FF 76 14 E8 ?? ?? ?? ?? 5F 85 C0 5A 0F 84 18 01 00 00 8B 46 04 C7 46 10 00 00 00 00 83 F8 FF 74 0E 50 E8 ?? ?? ?? ?? C7 46 04 FF FF FF FF 5B 8B 16 85 D2 74 0E 8B 42 04 52 FF 50 10 }
	condition:
		$pattern
}

rule dlopen_071e62c154340823bd83989757dc20c7 {
	meta:
		aliases = "dlopen"
		size = "1085"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 3C C7 45 F0 00 00 00 00 F6 45 0C 03 75 0F C7 05 ?? ?? ?? ?? 0A 00 00 00 E9 0E 04 00 00 8B 7D 04 80 3D ?? ?? ?? ?? 00 75 1B C6 05 ?? ?? ?? ?? 01 C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? 83 7D 08 00 75 0A A1 ?? ?? ?? ?? E9 D9 03 00 00 E8 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? 89 D8 31 F6 EB 17 8B 08 8B 51 14 39 FA 73 0B 85 F6 74 05 39 56 14 73 02 89 CE 8B 40 10 85 C0 75 E5 89 5D F0 EB 03 89 45 F0 8B 45 F0 89 45 CC 85 C0 74 07 8B 40 10 85 C0 75 EC 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5F C7 45 DC 02 00 00 00 85 C0 75 09 8B 4D 0C 83 E1 02 89 4D DC 68 ?? ?? ?? ?? E8 ?? ?? }
	condition:
		$pattern
}
...
rule byte_re_compile_fastmap_e9d2e1e411fe73679b4fd8b73d8d6eed {
	meta:
		aliases = "byte_re_compile_fastmap"
		size = "804"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 48 89 C6 8B 40 10 31 FF 8D 4C 24 0F 8B 1E 8B 56 08 83 E1 F0 01 DA 68 00 01 00 00 89 45 E0 6A 00 89 55 E4 50 89 4D F0 E8 ?? ?? ?? ?? 8A 46 1C C6 45 EA 01 83 C8 08 C6 45 EB 00 83 E0 FE C7 45 EC 05 00 00 00 88 46 1C 8B 45 E0 83 C0 0A 83 C4 0C 89 45 D8 3B 5D E4 74 06 8A 03 3C 01 75 29 85 FF 8A 56 1C 0F 84 90 02 00 00 88 D0 83 E2 FE 83 E0 01 4F 08 45 EA 0A 55 EA 88 56 1C 8B 55 F0 8B 1C BA C6 45 EA 01 EB CC 43 3C 1D 0F 87 58 02 00 00 0F B6 C0 FF 24 85 ?? ?? ?? ?? 31 D2 E9 CF 00 00 00 31 D2 E9 E9 00 00 00 80 4E 1C 01 E9 5A 02 00 00 0F B6 43 01 8B 4D E0 C6 04 01 01 E9 2C 02 00 }
	condition:
		$pattern
}

rule __msgwrite_4129515a746cb668cd2f69658e168866 {
	meta:
		aliases = "__msgwrite"
		size = "176"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 64 89 55 BC 89 4D B8 89 45 C0 E8 ?? ?? ?? ?? 8D 5C 24 0F 89 45 E0 E8 ?? ?? ?? ?? 89 45 E4 E8 ?? ?? ?? ?? 83 E3 F0 89 45 E8 8D 75 E0 8D 7B 0C A5 A5 A5 C7 43 04 01 00 00 00 C7 43 08 02 00 00 00 C7 03 18 00 00 00 89 5D D4 8B 45 BC C7 45 D0 01 00 00 00 89 45 EC 8B 45 B8 89 45 F0 8D 45 EC 89 45 CC C7 45 C4 00 00 00 00 C7 45 C8 00 00 00 00 C7 45 D8 18 00 00 00 C7 45 DC 00 00 00 00 8D 5D C4 6A 00 53 FF 75 C0 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 0D E8 ?? ?? ?? ?? 83 38 04 74 E4 83 C8 FF 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule rcmd_b3c98a0232ea8563964f8e630304d91f {
	meta:
		aliases = "rcmd"
		size = "1108"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 70 BE 00 04 00 00 8B 45 0C 8D 7D E8 66 89 45 86 E8 ?? ?? ?? ?? 81 EC 10 04 00 00 89 45 90 8D 44 24 0F 83 E0 F0 EB 39 8B 5D EC 83 FB FF 75 0A E8 ?? ?? ?? ?? 83 38 22 74 16 E8 ?? ?? ?? ?? 89 18 8B 55 08 FF 32 E8 ?? ?? ?? ?? E9 9E 00 00 00 01 F6 8D 46 12 83 E0 FC 29 C4 8D 44 24 0F 83 E0 F0 8D 55 EC 52 57 56 50 8D 45 94 50 8B 45 08 FF 30 E8 ?? ?? ?? ?? 83 C4 18 85 C0 75 AB 83 7D E8 00 74 A5 8B 45 E8 66 C7 45 AC 01 00 66 C7 45 B4 01 00 8B 55 08 8B 00 BF 01 00 00 00 89 02 68 00 00 40 00 E8 ?? ?? ?? ?? C7 45 E4 FF 03 00 00 89 45 8C 5B 8D 45 E4 50 E8 ?? ?? ?? ?? 59 89 C6 85 C0 }
	condition:
		$pattern
}

rule nan_fed09e6a9d4061a7077de2b4c6a0b1d3 {
	meta:
		aliases = "__GI_nan, nan"
		size = "76"
		objfiles = "nan@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 8B 7D 08 80 3F 00 75 08 D9 05 ?? ?? ?? ?? EB 2E 89 E3 57 E8 ?? ?? ?? ?? 59 83 C0 18 83 E0 FC 29 C4 8D 74 24 0F 57 83 E6 F0 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 6A 00 56 E8 ?? ?? ?? ?? 89 DC 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_nanf_e0d91863fe9e60ebbed597199c5a2daa {
	meta:
		aliases = "nanf, __GI_nanf"
		size = "76"
		objfiles = "nan@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 8B 7D 08 80 3F 00 75 08 D9 05 ?? ?? ?? ?? EB 2E 89 E3 57 E8 ?? ?? ?? ?? 5A 83 C0 18 83 E0 FC 29 C4 8D 74 24 0F 57 83 E6 F0 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 6A 00 56 E8 ?? ?? ?? ?? 89 DC 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule execle_42a6bd8ba78ffc8dcf857c1f201876da {
	meta:
		aliases = "__GI_execle, execle"
		size = "107"
		objfiles = "execle@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 8D 45 10 83 EC 04 31 F6 89 45 F0 8B 55 F0 46 8D 42 04 89 45 F0 83 3A 00 75 F1 8D 42 08 89 45 F0 8D 04 B5 14 00 00 00 29 C4 8B 45 0C 8B 7A 04 8D 5C 24 0F 83 E3 F0 89 D9 89 03 8D 45 10 89 45 F0 8B 45 F0 83 C1 04 4E 8D 50 04 89 55 F0 8B 00 89 01 75 ED 57 53 FF 75 08 E8 ?? ?? ?? ?? 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule pthread_sighandler_04940cb9cbf7d179c6f8bbbeaa59e317 {
	meta:
		aliases = "pthread_sighandler"
		size = "91"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 E8 ?? ?? ?? ?? 8B 5D 08 89 C7 80 78 58 00 74 09 C6 40 58 00 89 58 20 EB 34 8B 70 54 85 F6 75 03 89 68 54 83 EC 58 8D 45 0C 89 E2 6A 58 50 52 E8 ?? ?? ?? ?? 83 C4 0C 53 FF 14 9D ?? ?? ?? ?? 83 C4 5C 85 F6 75 07 C7 47 54 00 00 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule pthread_sighandler_rt_3a1951e4e9e0dbbf2cc1b77f289cc073 {
	meta:
		aliases = "pthread_sighandler_rt"
		size = "77"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 E8 ?? ?? ?? ?? 8B 75 08 89 C7 80 78 58 00 74 09 C6 40 58 00 89 70 20 EB 26 8B 58 54 85 DB 75 03 89 68 54 FF 75 10 FF 75 0C 56 FF 14 B5 ?? ?? ?? ?? 83 C4 0C 85 DB 75 07 C7 47 54 00 00 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __gcov_flush_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gcov_merge_delta, __gcov_merge_single, __gcov_init, __clear_cache, __gnat_default_unlock, __enable_execute_stack, __gnat_default_lock, __gcov_merge_add, __gcov_flush"
		size = "5"
		objfiles = "_gcov_merge_delta@libgcov.a, _gcov_merge_add@libgcov.a, _gcov_merge_single@libgcov.a, _gcov@libgcov.a, _enable_execute_stack@libgcc.a"
	strings:
...
rule pthread_setcancelstate_a666989c5281bf50d451ce6ac88098f8 {
	meta:
		aliases = "__GI_pthread_setcancelstate, pthread_setcancelstate"
		size = "72"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 16 00 00 00 89 E5 56 53 8B 5D 08 8B 75 0C 83 FB 01 77 2C E8 ?? ?? ?? ?? 85 F6 89 C2 74 06 0F B6 40 40 89 06 88 5A 40 80 7A 42 00 74 10 66 81 7A 40 00 01 75 08 55 6A FF E8 ?? ?? ?? ?? 31 C0 8D 65 F8 5B 5E 5D C3 }
	condition:
		$pattern
}

rule pthread_setcanceltype_70a6cab8c69bc4c597522c252a43bf1c {
	meta:
		aliases = "__GI_pthread_setcanceltype, pthread_setcanceltype"
		size = "72"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 16 00 00 00 89 E5 56 53 8B 5D 08 8B 75 0C 83 FB 01 77 2C E8 ?? ?? ?? ?? 85 F6 89 C2 74 06 0F B6 40 41 89 06 88 5A 41 80 7A 42 00 74 10 66 81 7A 40 00 01 75 08 55 6A FF E8 ?? ?? ?? ?? 31 C0 8D 65 F8 5B 5E 5D C3 }
	condition:
		$pattern
}

rule __old_sem_wait_a42492fa0377b20f140fedbff35e7273 {
	meta:
		aliases = "__old_sem_wait"
		size = "281"
		objfiles = "oldsemaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 ?? ?? ?? ?? 89 E5 56 53 89 EA 83 EC 14 8B 5D 08 3B 2D ?? ?? ?? ?? 73 31 3B 2D ?? ?? ?? ?? 72 0D B8 ?? ?? ?? ?? 3B 2D ?? ?? ?? ?? 72 1C 83 3D ?? ?? ?? ?? 00 74 07 E8 ?? ?? ?? ?? EB 0C 81 CA FF FF 1F 00 8D 82 A1 FE FF FF 89 45 F4 C7 45 EC 00 00 00 00 C7 45 F0 ?? ?? ?? ?? 8D 75 EC 8B 45 F4 89 F2 E8 ?? ?? ?? ?? 8B 0B F6 C1 01 74 08 8D 51 FE 83 F9 01 75 09 8B 55 F4 8B 45 F4 89 48 08 89 C8 F0 0F B1 13 0F 94 C1 84 C9 74 DB 80 E2 01 75 73 8B 45 F4 50 E8 ?? ?? ?? ?? 31 D2 8B 45 F4 E8 ?? ?? ?? ?? 8B 45 F4 5A 80 78 42 00 74 AF 8B 45 F4 80 78 40 00 75 A6 8B 13 8B 45 F4 39 C2 75 13 8B 45 F4 8B 48 08 }
	condition:
		$pattern
}
...
rule thread_self_4d574e5856a30bb564cca31edbbe6aeb {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "mutex@libpthread.a, errno@libpthread.a, semaphore@libpthread.a, spinlock@libpthread.a, join@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 ?? ?? ?? ?? 89 E5 89 EA 3B 2D ?? ?? ?? ?? 73 30 3B 2D ?? ?? ?? ?? 72 0D B8 ?? ?? ?? ?? 3B 2D ?? ?? ?? ?? 72 1B 83 3D ?? ?? ?? ?? 00 74 06 5D E9 ?? ?? ?? ?? 81 CA FF FF 1F 00 8D 82 A1 FE FF FF 5D C3 }
	condition:
		$pattern
}
...
rule __floatdixf_d1dd229decd9b611dc5831094a8157ed {
	meta:
...
rule _stdio_term_290924f596430639bcfe695bef062ea9 {
	meta:
		aliases = "_stdio_term"
		size = "117"
		objfiles = "_stdio@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 8B 1D ?? ?? ?? ?? 5E EB 33 8D 73 38 56 E8 ?? ?? ?? ?? 5A 85 C0 74 14 8B 43 08 66 C7 03 30 00 89 43 18 89 43 1C 89 43 10 89 43 14 C7 43 34 01 00 00 00 56 E8 ?? ?? ?? ?? 8B 5B 20 58 85 DB 75 C9 8B 1D ?? ?? ?? ?? EB 0F F6 03 40 74 07 53 E8 ?? ?? ?? ?? 5E 8B 5B 20 85 DB 75 ED 5B 5E C3 }
	condition:
		$pattern
}

rule dlinfo_a529135ef53f9f6de3b9feb0bf646223 {
	meta:
		aliases = "dlinfo"
		size = "220"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 56 ) 53 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5E 8B 1D ?? ?? ?? ?? 58 EB 2F FF 73 04 0F B7 43 20 50 8B 43 18 8D 04 85 ?? ?? ?? ?? 50 FF 73 1C 53 FF 33 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 5B 0C 83 C4 20 85 DB 75 CD FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? 83 C4 0C EB 1C 8B 03 FF 70 04 50 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 5B 10 83 C4 10 85 DB 75 E0 8B 35 ?? ?? ?? ?? EB 3B 56 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 F3 83 C4 0C EB 1C 8B 03 FF 70 04 50 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 5B }
	condition:
		$pattern
}

rule __GI___ns_name_uncompress_e5450d2d47e9763bfee2d004d8d3556d {
	meta:
		aliases = "__ns_name_uncompress, __GI___ns_name_uncompress"
		size = "94"
		objfiles = "ns_name@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 00 01 00 00 68 FF 00 00 00 8D 74 24 05 56 FF B4 24 1C 01 00 00 FF B4 24 1C 01 00 00 FF B4 24 1C 01 00 00 E8 ?? ?? ?? ?? 83 C4 14 89 C3 83 F8 FF 74 1A FF B4 24 1C 01 00 00 FF B4 24 1C 01 00 00 56 E8 ?? ?? ?? ?? 83 C4 0C 40 75 03 83 CB FF 89 D8 81 C4 00 01 00 00 5B 5E C3 }
	condition:
		$pattern
}

rule tmpfile_d511eeeff396621da2aaa5551be25d14 {
	meta:
		aliases = "tmpfile64, tmpfile"
		size = "101"
		objfiles = "tmpfile@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 00 10 00 00 68 ?? ?? ?? ?? 6A 00 68 FF 0F 00 00 8D 5C 24 0D 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 33 6A 00 53 E8 ?? ?? ?? ?? 5A 89 C6 59 85 C0 78 23 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 C0 75 0B 56 E8 ?? ?? ?? ?? 58 EB 02 31 DB 89 D8 81 C4 00 10 00 00 5B 5E C3 }
	condition:
		$pattern
}

rule vdprintf_6f23c6464805da57f9934efb57c8fdb3 {
	meta:
		aliases = "__GI_vdprintf, vdprintf"
		size = "155"
		objfiles = "vdprintf@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 90 00 00 00 89 E6 8D 44 24 50 8D 94 24 90 00 00 00 89 44 24 08 89 44 24 18 89 44 24 1C 89 44 24 10 89 44 24 14 8B 84 24 9C 00 00 00 89 44 24 04 8D 44 24 38 89 54 24 0C 66 C7 04 24 D0 00 C6 44 24 02 00 C7 44 24 2C 00 00 00 00 C7 44 24 34 01 00 00 00 50 E8 ?? ?? ?? ?? C7 44 24 24 00 00 00 00 FF B4 24 A8 00 00 00 FF B4 24 A8 00 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 7E 0E 56 E8 ?? ?? ?? ?? 5A 85 C0 74 03 83 CB FF 89 D8 81 C4 90 00 00 00 5B 5E C3 }
	condition:
		$pattern
}

rule adjtime_b20a613d895f8e2e0c6174599272a802 {
	meta:
		aliases = "adjtime"
		size = "182"
		objfiles = "adjtime@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 C4 80 8B 8C 24 8C 00 00 00 8B B4 24 90 00 00 00 85 C9 74 43 8B 41 04 BB 40 42 0F 00 99 F7 FB 89 D3 89 C2 03 11 8D 82 61 08 00 00 3D C2 10 00 00 76 10 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 EB 69 69 C2 40 42 0F 00 01 D8 C7 04 24 01 80 00 00 89 44 24 04 EB 07 C7 04 24 00 00 00 00 89 E0 50 E8 ?? ?? ?? ?? 5A 83 CA FF 85 C0 78 3D 31 D2 85 F6 74 37 8B 4C 24 04 85 C9 79 1A 89 C8 BB 40 42 0F 00 F7 D8 99 F7 FB F7 DA 89 C8 89 56 04 99 F7 FB 89 C1 EB 11 89 C8 BA 40 42 0F 00 89 D3 99 F7 FB 89 C1 89 56 04 89 0E 31 D2 83 EC 80 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_pointer_4fc26764bc345053157b70223dd083c8 {
	meta:
		aliases = "xdr_pointer"
		size = "83"
		objfiles = "xdr_reference@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 31 C0 8B 5C 24 14 8B 74 24 10 83 3B 00 0F 95 C0 89 04 24 89 E0 50 56 E8 ?? ?? ?? ?? 59 5A 31 D2 85 C0 74 24 83 3C 24 00 75 0A B2 01 C7 03 00 00 00 00 EB 14 FF 74 24 1C FF 74 24 1C 53 56 E8 ?? ?? ?? ?? 83 C4 10 89 C2 89 D0 5A 5B 5E C3 }
	condition:
		$pattern
}

rule strlcat_e77520ce40bd79195cba68bed02c35e0 {
	meta:
		aliases = "__GI_strlcat, strlcat"
		size = "59"
		objfiles = "strlcat@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 31 C9 8B 54 24 10 8B 5C 24 14 8B 74 24 18 39 F1 72 06 8D 54 24 03 EB 10 80 3A 00 74 0B 42 41 EB ED 41 39 F1 83 D2 00 43 8A 03 88 02 84 C0 75 F1 89 C8 5A 5B 5E C3 }
	condition:
		$pattern
}

rule initgroups_2b85631a104231594bf8a4ba2199afb3 {
	meta:
		aliases = "initgroups"
		size = "67"
		objfiles = "initgroups@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 83 CE FF 89 E0 C7 04 24 FF FF FF 7F 50 FF 74 24 18 FF 74 24 18 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 C0 74 15 50 FF 74 24 04 E8 ?? ?? ?? ?? 53 89 C6 E8 ?? ?? ?? ?? 83 C4 0C 89 F0 5A 5B 5E C3 }
	condition:
		$pattern
}

rule lseek64_a96f0daba6a61f4c3373d86a2530af3a {
	meta:
		aliases = "lseek64"
		size = "61"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 89 E0 50 6A 01 E8 ?? ?? ?? ?? FF 74 24 24 FF 74 24 24 FF 74 24 24 FF 74 24 24 E8 ?? ?? ?? ?? 6A 00 FF 74 24 1C 89 C3 89 D6 E8 ?? ?? ?? ?? 89 D8 89 F2 83 C4 24 5B 5E C3 }
	condition:
		$pattern
}

rule __fresetlockfiles_011b862c4e7ca9a1caa80c07e66285f4 {
	meta:
		aliases = "__fresetlockfiles"
		size = "64"
		objfiles = "lockfile@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 89 E3 53 E8 ?? ?? ?? ?? 6A 01 53 E8 ?? ?? ?? ?? 8B 35 ?? ?? ?? ?? 83 C4 0C EB 0F 50 8D 46 38 50 E8 ?? ?? ?? ?? 59 8B 76 20 58 85 F6 89 D8 75 EB 53 E8 ?? ?? ?? ?? 58 5A 5B 5E C3 }
	condition:
		$pattern
}
...
rule __GI_wcsxfrm_531c207e747b0f75ca250818a7b364ec {
	meta:
		aliases = "wcsxfrm, __wcslcpy, __GI_wcsxfrm"
		size = "62"
		objfiles = "wcslcpy@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 44 24 18 8B 4C 24 10 8B 74 24 14 85 C0 8D 58 FF 75 04 89 E1 31 DB 89 F2 EB 0B 85 DB 74 04 4B 83 C1 04 83 C2 04 8B 02 89 01 85 C0 75 ED 29 F2 C1 FA 02 89 D0 5A 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_strlcpy_826df2c6b2fa4cf7a82b73280b7d3ba6 {
	meta:
		aliases = "__GI_strxfrm, strxfrm, strlcpy, __GI_strlcpy"
		size = "57"
		objfiles = "strlcpy@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 44 24 18 8B 4C 24 10 8B 74 24 14 85 C0 8D 58 FF 75 06 8D 4C 24 03 31 DB 89 F2 EB 07 85 DB 74 02 4B 41 42 8A 02 88 01 84 C0 75 F1 29 F2 89 D0 5A 5B 5E C3 }
	condition:
		$pattern
}

rule xdrrec_getint32_2068e75f577ba1a77a403b2956ad7da8 {
	meta:
		aliases = "xdrrec_getint32"
		size = "91"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 5C 24 10 8B 74 24 14 8B 53 0C 8B 4A 2C 83 7A 34 03 7E 1F 8B 42 30 29 C8 83 F8 03 7E 15 8B 01 0F C8 89 06 83 6A 34 04 83 42 2C 04 BA 01 00 00 00 EB 1D 89 E0 6A 04 50 53 E8 ?? ?? ?? ?? 83 C4 0C 31 D2 85 C0 74 09 8B 04 24 B2 01 0F C8 89 06 89 D0 59 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_xdr_rmtcallres_547b0940e298ce24b0cd5a818b24719d {
	meta:
		aliases = "xdr_rmtcallres, __GI_xdr_rmtcallres"
		size = "81"
		objfiles = "pmap_rmt@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 5C 24 14 8B 74 24 10 8B 03 89 04 24 68 ?? ?? ?? ?? 6A 04 8D 44 24 08 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 20 8D 43 04 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 10 8B 04 24 89 03 FF 73 08 56 FF 53 0C 59 5B EB 02 31 C0 5A 5B 5E C3 }
	condition:
		$pattern
}

rule __GI___fputc_unlocked_41f491c81c0dc935d6f1b2b6a74edb56 {
	meta:
		aliases = "__GI_fputc_unlocked, __GI_putc_unlocked, putc_unlocked, __fputc_unlocked, fputc_unlocked, __GI___fputc_unlocked"
		size = "181"
		objfiles = "fputc_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 5C 24 14 8B 74 24 10 8B 43 10 3B 43 1C 73 0D 89 F2 88 10 40 89 43 10 E9 87 00 00 00 0F B7 03 25 C0 00 00 00 3D C0 00 00 00 74 11 68 80 00 00 00 53 E8 ?? ?? ?? ?? 59 85 C0 5A 75 6C 83 7B 04 FE 75 07 89 F1 0F B6 C1 EB 62 8B 43 0C 3B 43 08 74 36 3B 43 10 75 0B 53 E8 ?? ?? ?? ?? 5A 85 C0 75 47 8B 43 10 89 F2 88 10 40 89 43 10 F6 43 01 01 74 2F 80 FA 0A 75 2A 53 E8 ?? ?? ?? ?? 59 85 C0 74 1F FF 4B 10 EB 21 89 F0 88 44 24 03 6A 01 8D 44 24 07 50 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 07 89 F2 0F B6 C2 EB 03 83 C8 FF 5A 5B 5E C3 }
	condition:
		$pattern
}
...
rule unlockpt_f28306adb15b91b214eae3b1b44773ef {
	meta:
		aliases = "unlockpt"
		size = "65"
		objfiles = "unlockpt@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 89 C3 8B 30 89 E0 C7 04 24 00 00 00 00 50 68 31 54 04 40 FF 74 24 18 E8 ?? ?? ?? ?? 83 C4 0C 31 D2 85 C0 74 0C 83 CA FF 83 3B 16 75 04 89 33 31 D2 89 D0 5A 5B 5E C3 }
	condition:
		$pattern
}

rule join_extricate_func_bd4bc3dc026b11170db7ad95b9249807 {
	meta:
		aliases = "join_extricate_func"
		size = "60"
		objfiles = "join@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 8B 5C 24 10 89 04 24 8B 14 24 89 D8 E8 ?? ?? ?? ?? 8B 43 08 83 78 38 00 C7 40 38 00 00 00 00 53 0F 95 C2 0F B6 F2 E8 ?? ?? ?? ?? 89 F0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule cond_extricate_func_19a73fd3aa7855d52fd1fce7c6ce9d11 {
	meta:
		aliases = "cond_extricate_func"
		size = "54"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 8B 5C 24 10 89 04 24 8B 14 24 89 D8 E8 ?? ?? ?? ?? 8B 54 24 14 8D 43 08 E8 ?? ?? ?? ?? 53 89 C6 E8 ?? ?? ?? ?? 89 F0 5B 5E 5B 5E C3 }
	condition:
		$pattern
}

rule new_sem_extricate_func_5e0ce190ddfea4e9568243890da0ccb0 {
	meta:
		aliases = "new_sem_extricate_func"
		size = "54"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 8B 5C 24 10 89 04 24 8B 14 24 89 D8 E8 ?? ?? ?? ?? 8B 54 24 14 8D 43 0C E8 ?? ?? ?? ?? 53 89 C6 E8 ?? ?? ?? ?? 89 F0 59 5B 5B 5E C3 }
	condition:
		$pattern
}

rule __pthread_wait_for_restart_sig_e289ef6913e2f61cdf794d0ba41cebcf {
	meta:
		aliases = "__pthread_wait_for_restart_signal"
		size = "66"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 89 E3 8B 74 24 14 53 6A 00 6A 02 E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? C7 46 20 00 00 00 00 83 C4 14 53 E8 ?? ?? ?? ?? 58 8B 46 20 3B 05 ?? ?? ?? ?? 75 EE 59 5B 5B 5E C3 }
	condition:
		$pattern
}

rule pthread_sigmask_7d471717d9f155872318641ac88e3ce4 {
	meta:
		aliases = "pthread_sigmask"
		size = "170"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 44 24 18 8B 74 24 14 85 C0 74 78 8B 10 8B 40 04 89 44 24 04 89 14 24 83 FE 01 74 4F 83 FE 02 74 06 85 F6 74 28 EB 5A FF 35 ?? ?? ?? ?? 8D 5C 24 04 53 E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 EB 17 FF 35 ?? ?? ?? ?? 8D 5C 24 04 53 E8 ?? ?? ?? ?? 59 A1 ?? ?? ?? ?? 5A 85 C0 7E 19 50 EB 0A FF 35 ?? ?? ?? ?? 8D 5C 24 04 53 E8 ?? ?? ?? ?? 89 D8 5B 5A EB 02 89 E0 FF 74 24 1C 50 56 E8 ?? ?? ?? ?? 83 C4 0C 31 D2 40 75 07 E8 ?? ?? ?? ?? 8B 10 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_uint64_t_33198e0b8f6112f171358026c6cd8843 {
	meta:
		aliases = "xdr_uint64_t"
		size = "163"
		objfiles = "xdr_intXX_t@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 5C 24 14 8B 74 24 18 8B 03 83 F8 01 74 43 72 0C BA 01 00 00 00 83 F8 02 74 7C EB 78 8B 46 04 89 44 24 04 8B 06 89 04 24 8D 44 24 04 8B 53 04 50 53 FF 52 24 5A 31 D2 59 85 C0 74 5A 8B 53 04 89 E0 50 53 FF 52 24 31 D2 5B 85 C0 5E 0F 95 C2 EB 45 8B 53 04 8D 44 24 04 50 53 FF 52 20 5A 85 C0 59 74 31 8B 53 04 89 E0 50 53 FF 52 20 5A 85 C0 59 74 21 8B 44 24 04 31 D2 89 C2 B8 00 00 00 00 89 56 04 89 06 8B 0C 24 89 56 04 BA 01 00 00 00 89 0E EB 02 31 D2 89 D0 59 5B 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_int64_t_2e8ddecaa40f500fd64486761111bbd3 {
	meta:
		aliases = "xdr_int64_t"
		size = "178"
		objfiles = "xdr_intXX_t@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 5C 24 14 8B 74 24 18 8B 03 83 F8 01 74 53 72 13 BA 01 00 00 00 83 F8 02 0F 84 87 00 00 00 E9 80 00 00 00 8B 56 04 8B 06 89 D0 89 44 24 04 89 C2 C1 FA 1F 8B 06 89 04 24 8D 44 24 04 8B 53 04 50 53 FF 52 24 5E 5A 31 D2 85 C0 74 59 8B 53 04 89 E0 50 53 FF 52 24 31 D2 59 85 C0 5B 0F 95 C2 EB 44 8B 43 04 8D 54 24 04 52 53 FF 50 20 59 85 C0 5A 74 30 8B 53 04 89 E0 50 53 FF 52 20 5B 85 C0 5A 74 20 8B 44 24 04 99 89 C2 B8 00 00 00 00 89 56 04 89 06 8B 0C 24 89 56 04 BA 01 00 00 00 89 0E EB 02 31 D2 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_u_hyper_e9b0b31e9d0df81b5b28d2108a87f170 {
	meta:
		aliases = "__GI_xdr_u_hyper, xdr_u_hyper"
		size = "160"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 5C 24 14 8B 74 24 18 8B 03 85 C0 75 33 8B 46 04 89 44 24 04 8B 06 89 04 24 8D 44 24 04 8B 53 04 50 53 FF 52 04 5A 31 D2 59 85 C0 74 66 8B 53 04 89 E0 50 53 FF 52 04 5B 85 C0 5E 0F 95 C0 EB 4C 83 F8 01 75 41 8B 53 04 8D 44 24 04 50 53 FF 12 5A 85 C0 59 74 3B 8B 53 04 89 E0 50 53 FF 12 5A 85 C0 59 74 2C 8B 44 24 04 31 D2 89 C2 B8 00 00 00 00 89 56 04 89 06 8B 0C 24 89 56 04 BA 01 00 00 00 89 0E EB 0D 83 F8 02 0F 94 C0 0F B6 D0 EB 02 31 D2 89 D0 5B 5E 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_hyper_930f760b48fbdbd325b0332ef5774201 {
	meta:
		aliases = "__GI_xdr_hyper, xdr_hyper"
		size = "168"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 5C 24 14 8B 74 24 18 8B 03 85 C0 75 3C 8B 56 04 8B 06 89 D0 89 44 24 04 89 C2 C1 FA 1F 8B 06 89 04 24 8D 44 24 04 8B 53 04 50 53 FF 52 04 5A 31 D2 59 85 C0 74 65 8B 53 04 89 E0 50 53 FF 52 04 5B 85 C0 5E 0F 95 C0 EB 4B 83 F8 01 75 40 8B 43 04 8D 54 24 04 52 53 FF 10 5A 85 C0 59 74 3A 8B 53 04 89 E0 50 53 FF 12 5A 85 C0 59 74 2B 8B 44 24 04 99 89 C2 B8 00 00 00 00 89 56 04 89 06 8B 0C 24 89 56 04 BA 01 00 00 00 89 0E EB 0D 83 F8 02 0F 94 C0 0F B6 D0 EB 02 31 D2 89 D0 5B 5E 5B 5E C3 }
	condition:
		$pattern
}

rule __GI___sigpause_7963049a6dc81ad460dab9e6f9911937 {
	meta:
		aliases = "__sigpause, __GI___sigpause"
		size = "76"
		objfiles = "sigpause@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 74 24 14 83 7C 24 18 00 74 1F 89 E3 53 6A 00 6A 00 E8 ?? ?? ?? ?? 56 53 E8 ?? ?? ?? ?? 83 C4 14 83 CA FF 85 C0 78 18 EB 0B C7 44 24 04 00 00 00 00 89 34 24 89 E0 50 E8 ?? ?? ?? ?? 5B 89 C2 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_erand48_r_ad60d9f86c66a95bd1259d92f650b168 {
	meta:
		aliases = "erand48_r, __GI_erand48_r"
		size = "135"
		objfiles = "erand48_r@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 8B 74 24 14 FF 74 24 18 56 E8 ?? ?? ?? ?? 5B 5A 83 CA FF 85 C0 78 55 8B 54 24 04 81 E2 FF FF 0F 00 81 CA 00 00 F0 3F 89 54 24 04 81 E2 00 00 F0 FF 66 8B 5E 02 0F B7 46 04 C1 E0 04 89 D9 66 C1 E9 0C 0F B7 C9 C1 E3 14 09 C1 09 CA 89 54 24 04 31 D2 0F B7 06 C1 E0 04 09 C3 8B 44 24 1C 89 1C 24 DD 04 24 DC 25 ?? ?? ?? ?? DD 18 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule setlogmask_5e7a16196eb3f369281128a9da8b1903 {
	meta:
		aliases = "setlogmask"
		size = "80"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 0F B6 35 ?? ?? ?? ?? 83 7C 24 1C 00 74 32 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8A 44 24 2C 6A 01 53 A2 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 18 89 F2 83 C4 10 0F B6 C2 5B 5E C3 }
	condition:
		$pattern
}

rule setstate_264dee14905de0ce23337ef28a51cb43 {
	meta:
		aliases = "setstate"
		size = "87"
		objfiles = "random@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 31 F6 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? FF 74 24 30 E8 ?? ?? ?? ?? 83 C4 18 85 C0 78 03 8D 73 FC 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 89 F0 83 C4 18 5B 5E C3 }
	condition:
		$pattern
}

rule getnetent_2266c14d4738dca040ff4b17d19a59c6 {
	meta:
		aliases = "__GI_getnetent, getnetent"
		size = "364"
		objfiles = "getnetent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 1E 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 A3 ?? ?? ?? ?? 5B 85 C0 0F 84 09 01 00 00 83 3D ?? ?? ?? ?? 00 75 19 68 01 10 00 00 E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 85 C0 75 05 E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 68 00 10 00 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 C0 0F 84 C4 00 00 00 80 38 23 74 B6 BA ?? ?? ?? ?? E8 ?? ?? ?? ?? 85 C0 74 A8 C6 00 00 BA ?? ?? ?? ?? 89 D8 89 1D ?? ?? ?? ?? E8 ?? ?? ?? ?? 85 C0 74 8F 8D 58 01 C6 00 00 EB 01 43 8A }
	condition:
		$pattern
}

rule getutline_4092c54f775cdef865602c0023d64a10 {
	meta:
		aliases = "getutline"
		size = "105"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8B 74 24 1C 83 C6 08 EB 1B 8B 03 83 E8 06 66 83 F8 01 77 10 8D 43 08 56 50 E8 ?? ?? ?? ?? 5A 85 C0 59 74 0B E8 ?? ?? ?? ?? 89 C3 85 C0 75 DA 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 89 D8 83 C4 18 5B 5E C3 }
	condition:
		$pattern
}

rule initstate_25fc5e7770e844b896316b6c8286506f {
	meta:
		aliases = "initstate"
		size = "85"
		objfiles = "random@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8B 35 ?? ?? ?? ?? FF 74 24 38 FF 74 24 38 FF 74 24 38 E8 ?? ?? ?? ?? 83 C4 20 6A 01 53 E8 ?? ?? ?? ?? 83 EE 04 89 F0 83 C4 18 5B 5E C3 }
	condition:
		$pattern
}

rule getrpcent_r_9e838a5e3506e40499f4946ec9f2bced {
	meta:
		aliases = "getrpcent_r"
		size = "79"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? FF 74 24 38 FF 74 24 38 8B 4C 24 38 8B 54 24 34 E8 ?? ?? ?? ?? 6A 01 89 C6 53 E8 ?? ?? ?? ?? 89 F0 83 C4 30 5B 5E C3 }
	condition:
		$pattern
}

rule getrpcbyname_r_13754be2b03e0868f7da06037e51d2b3 {
	meta:
		aliases = "getrpcbynumber_r, getrpcbyname_r"
		size = "83"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? FF 74 24 2C E8 ?? ?? ?? ?? FF 74 24 40 FF 74 24 40 8B 4C 24 40 8B 54 24 3C E8 ?? ?? ?? ?? 6A 01 89 C6 53 E8 ?? ?? ?? ?? 89 F0 83 C4 34 5B 5E C3 }
	condition:
		$pattern
}

rule getutid_259956e7eac6717e12dac93401c03ba2 {
	meta:
		aliases = "__GI_getutid, getutid"
		size = "62"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 74 24 08 56 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 2C E8 ?? ?? ?? ?? 6A 01 89 C3 56 E8 ?? ?? ?? ?? 89 D8 83 C4 28 5B 5E C3 }
	condition:
		$pattern
}

rule _time_mktime_e63ccc49a3f655d8df2741187c097820 {
	meta:
		aliases = "_time_mktime"
		size = "76"
		objfiles = "_time_mktime@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 74 24 08 56 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 34 FF 74 24 34 E8 ?? ?? ?? ?? 6A 01 89 C3 56 E8 ?? ?? ?? ?? 89 D8 83 C4 34 5B 5E C3 }
	condition:
		$pattern
}

rule getutent_d76980dfaa1372c8cf8b9a5c6d7da6e0 {
	meta:
		aliases = "getutent"
		size = "58"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 74 24 08 56 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 89 C3 56 E8 ?? ?? ?? ?? 89 D8 83 C4 28 5B 5E C3 }
	condition:
		$pattern
}

rule ulckpwdf_2257a6f2061c2edc9c58936a8e1c59ff {
	meta:
		aliases = "ulckpwdf"
		size = "89"
		objfiles = "lckpwdf@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 83 CE FF 83 3D ?? ?? ?? ?? FF 74 40 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 53 89 C6 C7 05 ?? ?? ?? ?? FF FF FF FF E8 ?? ?? ?? ?? 83 C4 1C 89 F0 83 C4 10 5B 5E C3 }
	condition:
		$pattern
}

rule dl_iterate_phdr_73d9abd9b52ad8637f8757d3c5780c96 {
	meta:
		aliases = "dl_iterate_phdr"
		size = "84"
		objfiles = "dl_iterate_phdr@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 15 ?? ?? ?? ?? 8B 74 24 1C 8B 5C 24 20 85 D2 74 2E A1 ?? ?? ?? ?? C7 04 24 00 00 00 00 89 44 24 08 C7 44 24 04 ?? ?? ?? ?? 66 89 54 24 0C 53 6A 10 8D 44 24 08 50 FF D6 83 C4 0C 85 C0 75 09 53 56 E8 ?? ?? ?? ?? 5A 59 83 C4 10 5B 5E C3 }
	condition:
		$pattern
}

rule getchar_1605a0ed16902e66ab08aeba353dd214 {
	meta:
		aliases = "getchar"
		size = "121"
		objfiles = "getchar@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 35 ?? ?? ?? ?? 83 7E 34 00 74 1C 8B 46 10 3B 46 18 73 09 0F B6 18 40 89 46 10 EB 4F 56 E8 ?? ?? ?? ?? 5E 89 C3 EB 44 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 8B 46 10 83 C4 10 3B 46 18 73 09 0F B6 18 40 89 46 10 EB 09 56 E8 ?? ?? ?? ?? 59 89 C3 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 10 5B 5E C3 }
	condition:
		$pattern
}

rule __libc_pselect_6dd36ccbdb5304ef00d4ad029273c899 {
	meta:
		aliases = "pselect, __libc_pselect"
		size = "124"
		objfiles = "pselect@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 5C 24 2C 8B 74 24 30 85 DB 74 17 8B 03 BA E8 03 00 00 89 44 24 08 89 D1 8B 43 04 99 F7 F9 89 44 24 0C 85 F6 74 0E 89 E0 50 56 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 31 C0 85 DB 74 04 8D 44 24 08 50 FF 74 24 2C FF 74 24 2C FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 14 89 C3 85 F6 74 11 6A 00 8D 44 24 04 50 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 89 D8 83 C4 10 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_exit_3ee16080c4dca89fcaa5705bbf74ca34 {
	meta:
		aliases = "exit, __GI_exit"
		size = "90"
		objfiles = "exit@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 74 24 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 74 04 56 FF D0 59 6A 01 53 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 B8 ?? ?? ?? ?? 5A 85 C0 74 05 E8 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __pthread_once_9edb7e1a818063675450f6c9999c895b {
	meta:
		aliases = "pthread_once, __pthread_once"
		size = "198"
		objfiles = "mutex@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 74 24 1C 83 3E 02 75 05 E9 AB 00 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 16 59 89 D0 83 E0 03 48 75 24 83 E2 FC 3B 15 ?? ?? ?? ?? 74 19 C7 06 00 00 00 00 EB 11 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 5A 8B 16 89 D0 83 E0 03 48 74 E5 31 DB 85 D2 75 48 A1 ?? ?? ?? ?? 83 C8 01 89 06 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 56 68 ?? ?? ?? ?? 8D 5C 24 0C 53 E8 ?? ?? ?? ?? FF 54 24 30 6A 00 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? BB 01 00 00 00 C7 06 02 00 00 00 83 C4 1C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 85 DB 74 0B 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 83 C4 10 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule fgetc_b201c844c2fa5bbf84a4162d1c4e3e1e {
	meta:
		aliases = "getc, __GI_fgetc, fgetc"
		size = "119"
		objfiles = "fgetc@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 74 24 1C 83 7E 34 00 74 1C 8B 46 10 3B 46 18 73 09 0F B6 18 40 89 46 10 EB 4F 56 E8 ?? ?? ?? ?? 5E 89 C3 EB 44 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 8B 46 10 83 C4 10 3B 46 18 73 09 0F B6 18 40 89 46 10 EB 09 56 E8 ?? ?? ?? ?? 59 89 C3 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 10 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_readdir_3e5b31e83c42d247bb79689289b80e10 {
	meta:
...
rule __GI_atan_3ec6f2013bb4a6fc2490fcfca6e7ee12 {
	meta:
		aliases = "atan, __GI_atan"
		size = "435"
		objfiles = "s_atan@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 DD 44 24 1C DD 54 24 08 8B 74 24 0C 89 F3 81 E3 FF FF FF 7F 81 FB FF FF 0F 44 7E 39 DD 1C 24 81 FB 00 00 F0 7F 8B 04 24 7F 06 75 0F 85 C0 74 0B DD 44 24 1C D8 C0 E9 65 01 00 00 85 F6 7F 0B DD 05 ?? ?? ?? ?? E9 56 01 00 00 DD 05 ?? ?? ?? ?? E9 4B 01 00 00 DD D8 81 FB FF FF DB 3F 7F 2A 81 FB FF FF 1F 3E 0F 8F A2 00 00 00 DD 44 24 1C DC 05 ?? ?? ?? ?? D9 E8 D9 C9 DA E9 DF E0 9E 0F 87 20 01 00 00 E9 84 00 00 00 FF 74 24 20 FF 74 24 20 E8 ?? ?? ?? ?? 58 D9 C0 5A 81 FB FF FF F2 3F 7F 37 81 FB FF FF E5 3F 7F 16 DC C1 D9 C9 31 C0 DC 25 ?? ?? ?? ?? D9 C9 D8 05 ?? ?? ?? ?? EB 3C DD D9 D9 }
	condition:
		$pattern
}

rule log2_5b13e219682ec47fc94ff1283a04e5e2 {
	meta:
		aliases = "__ieee754_log2, log2"
		size = "390"
		objfiles = "e_log2@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 18 31 F6 DD 44 24 24 DD 54 24 10 8B 4C 24 14 8B 54 24 10 81 F9 FF FF 0F 00 7F 4A 89 C8 25 FF FF FF 7F 09 D0 75 0F D9 C0 DE E1 D8 3D ?? ?? ?? ?? E9 47 01 00 00 DD D8 85 C9 79 0D DD 44 24 24 D8 E0 D8 F0 E9 34 01 00 00 DD 44 24 24 D8 0D ?? ?? ?? ?? BE CA FF FF FF DD 54 24 24 DD 5C 24 08 8B 4C 24 0C EB 02 DD D8 81 F9 FF FF EF 7F 7E 0B DD 44 24 24 D8 C0 E9 02 01 00 00 89 CB 81 E3 FF FF 0F 00 DD 44 24 24 C1 F9 14 8D 93 64 5F 09 00 81 E2 00 00 10 00 89 D0 35 00 00 F0 3F 09 D8 DD 1C 24 C1 FA 14 89 44 24 04 8D 84 0E 01 FC FF FF 01 D0 50 8D 43 02 DB 04 24 83 C4 04 25 FF FF 0F 00 83 F8 02 DD }
	condition:
		$pattern
}

rule log_07d16e61c595a89b39328e2d42b4ad1d {
	meta:
		aliases = "__GI_log, __ieee754_log, log"
		size = "523"
		objfiles = "e_log@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 18 31 F6 DD 44 24 24 DD 5C 24 10 8B 4C 24 14 8B 54 24 10 81 F9 FF FF 0F 00 7F 48 89 C8 25 FF FF FF 7F 09 D0 75 0D D9 EE D8 3D ?? ?? ?? ?? E9 CE 01 00 00 85 C9 79 11 DD 44 24 24 D8 E0 DC 35 ?? ?? ?? ?? E9 B9 01 00 00 DD 44 24 24 D8 0D ?? ?? ?? ?? BE CA FF FF FF DD 54 24 24 DD 5C 24 08 8B 4C 24 0C 81 F9 FF FF EF 7F 7E 0B DD 44 24 24 D8 C0 E9 8B 01 00 00 89 CB 81 E3 FF FF 0F 00 C1 F9 14 8D 93 64 5F 09 00 81 E2 00 00 10 00 89 D0 35 00 00 F0 3F DD 44 24 24 C1 FA 14 09 D8 DD 1C 24 89 44 24 04 8D 84 0E 01 FC FF FF DD 04 24 DC 25 ?? ?? ?? ?? 8D 0C 10 8D 43 02 25 FF FF 0F 00 83 F8 02 7F 75 }
	condition:
		$pattern
}

rule pthread_onexit_process_b0b2232f6080fd50bb75e12593d03489 {
	meta:
		aliases = "pthread_onexit_process"
		size = "134"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 1C 83 3D ?? ?? ?? ?? 00 78 72 E8 ?? ?? ?? ?? 89 E6 89 C3 89 04 24 8B 44 24 28 C7 44 24 04 02 00 00 00 89 44 24 08 6A 1C 56 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E2 89 D8 E8 ?? ?? ?? ?? 3B 1D ?? ?? ?? ?? 75 29 68 00 00 00 80 6A 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 83 C4 0C 83 C4 1C 5B 5E C3 }
	condition:
		$pattern
}

rule pthread_create_0a65f1bc2a6d03cc83cc059d201ab121 {
	meta:
		aliases = "pthread_create"
		size = "152"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 1C 83 3D ?? ?? ?? ?? 00 79 0E E8 ?? ?? ?? ?? BA 0B 00 00 00 85 C0 78 74 E8 ?? ?? ?? ?? C7 44 24 04 00 00 00 00 89 04 24 89 C3 8B 44 24 2C 89 44 24 08 8B 44 24 30 89 44 24 0C 8B 44 24 34 89 44 24 10 8D 44 24 14 50 6A 00 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 89 E6 6A 1C 56 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E2 89 D8 E8 ?? ?? ?? ?? 83 7B 34 00 75 09 8B 44 24 28 8B 53 30 89 10 8B 53 34 83 C4 1C 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule __pthread_do_exit_5312268fcf41250609234fe2711f8c09 {
	meta:
		aliases = "__pthread_do_exit"
		size = "214"
		objfiles = "join@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 1C E8 ?? ?? ?? ?? 89 C3 C6 40 40 01 C6 40 41 00 FF 74 24 2C E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 43 1C 89 DA E8 ?? ?? ?? ?? 8B 44 24 2C 89 43 30 58 83 BB 24 01 00 00 00 74 2B A1 ?? ?? ?? ?? 0B 83 28 01 00 00 F6 C4 01 74 1B C7 83 30 01 00 00 09 00 00 00 89 9B 34 01 00 00 89 1D ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 73 38 C6 43 2C 01 FF 73 1C E8 ?? ?? ?? ?? 58 85 F6 74 07 56 E8 ?? ?? ?? ?? 58 8B 35 ?? ?? ?? ?? 39 F3 75 42 83 3D ?? ?? ?? ?? 00 78 39 89 34 24 C7 44 24 04 03 00 00 00 89 E3 6A 1C 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E2 89 F0 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __new_sem_post_8b402bef8236d77706676758dce239d6 {
	meta:
		aliases = "sem_post, __new_sem_post"
		size = "213"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 1C E8 ?? ?? ?? ?? 8B 74 24 28 83 78 54 00 75 6B 89 C2 89 F0 E8 ?? ?? ?? ?? 83 7E 0C 00 75 2F 8B 46 08 3D FF FF FF 7F 75 16 E8 ?? ?? ?? ?? C7 00 22 00 00 00 56 E8 ?? ?? ?? ?? 83 C8 FF EB 0C 40 89 46 08 56 E8 ?? ?? ?? ?? 31 C0 59 EB 7D 8B 5E 0C 85 DB 74 0D 8B 43 08 89 46 0C C7 43 08 00 00 00 00 56 E8 ?? ?? ?? ?? C6 83 42 01 00 00 01 53 E8 ?? ?? ?? ?? 5E 31 C0 5A EB 50 83 3D ?? ?? ?? ?? 00 79 19 E8 ?? ?? ?? ?? 85 C0 79 10 E8 ?? ?? ?? ?? C7 00 0B 00 00 00 83 C8 FF EB 2E C7 44 24 04 04 00 00 00 89 74 24 08 89 E3 6A 1C 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 40 75 0A E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule _stdio_openlist_dec_use_6e23093ed4a387f68ecfe13e5008764a {
	meta:
		aliases = "_stdio_openlist_dec_use"
		size = "209"
		objfiles = "fflush_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 20 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 48 0F 85 82 00 00 00 83 3D ?? ?? ?? ?? 00 7E 79 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 31 F6 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 15 ?? ?? ?? ?? 83 C4 10 EB 32 0F B7 02 25 30 80 00 00 8B 5A 20 83 F8 30 74 04 89 D6 EB 1C 85 F6 75 08 89 1D ?? ?? ?? ?? EB 03 89 5E 20 F6 42 01 20 74 07 52 E8 ?? ?? ?? ?? 59 89 DA 85 D2 75 CA 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 C7 05 ?? ?? ?? ?? 00 00 00 00 5A A1 ?? ?? ?? ?? 6A 01 48 A3 ?? ?? ?? ?? 8D 44 24 14 50 E8 ?? }
	condition:
		$pattern
}

rule __GI_if_nametoindex_327e3575bc627f59c23a5a8aa4c7cd1c {
	meta:
		aliases = "if_nametoindex, __GI_if_nametoindex"
		size = "80"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 20 E8 ?? ?? ?? ?? 89 C6 31 C0 85 F6 78 38 6A 10 FF 74 24 30 8D 5C 24 08 53 E8 ?? ?? ?? ?? 53 68 33 89 00 00 56 E8 ?? ?? ?? ?? 83 C4 18 85 C0 79 0A 56 E8 ?? ?? ?? ?? 31 C0 EB 0A 56 E8 ?? ?? ?? ?? 8B 44 24 14 5A 83 C4 20 5B 5E C3 }
	condition:
		$pattern
}

rule remquo_8bcc4466f7a172d7d1a10a227d151f4d {
	meta:
		aliases = "__GI_remquo, remquo"
		size = "124"
		objfiles = "s_remquo@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 28 31 DB DD 44 24 34 8B 74 24 44 DD 5C 24 10 DD 44 24 3C DD 5C 24 08 DD 44 24 10 DD 5C 24 20 DD 44 24 08 8B 54 24 24 DD 5C 24 18 DD 44 24 10 DC 74 24 08 C1 EA 1F 8B 44 24 1C C1 E8 1F 39 C2 0F 94 C3 8D 5C 1B FF DD 1C 24 E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? 83 E0 7F 0F AF C3 89 06 DD 44 24 08 DD 5C 24 3C DD 44 24 10 DD 5C 24 34 83 C4 28 5B 5E E9 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule pmap_set_95d26b2da0093335d0fe5b77f3ee3ff5 {
	meta:
		aliases = "__GI_pmap_set, pmap_set"
		size = "203"
		objfiles = "pmap_clnt@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 28 8D 5C 24 10 8B 74 24 40 89 D8 C7 44 24 24 FF FF FF FF E8 ?? ?? ?? ?? 85 C0 0F 84 9F 00 00 00 68 90 01 00 00 68 90 01 00 00 8D 44 24 2C 50 FF 35 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 6A 02 68 A0 86 01 00 53 E8 ?? ?? ?? ?? 83 C4 20 89 C3 85 C0 74 6E 8B 44 24 34 89 E2 89 04 24 8B 44 24 38 89 44 24 04 8B 44 24 3C 89 44 24 08 0F B7 C6 89 44 24 0C 8D 44 24 20 8B 4B 04 FF 35 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 50 68 ?? ?? ?? ?? 52 68 ?? ?? ?? ?? 6A 01 53 FF 11 83 C4 20 85 C0 74 15 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? C7 44 24 28 00 00 00 00 5E 58 8B 43 04 53 FF 50 10 8B 44 24 24 5B EB 02 31 C0 83 C4 28 }
	condition:
		$pattern
}

rule popen_f8372050073576baa55ac59f71eea14b {
	meta:
		aliases = "popen"
		size = "453"
		objfiles = "popen@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 2C 8B 5C 24 3C 8A 03 3C 77 74 23 C7 44 24 10 01 00 00 00 3C 72 74 1F E8 ?? ?? ?? ?? C7 00 16 00 00 00 C7 04 24 00 00 00 00 E9 8A 01 00 00 C7 44 24 10 00 00 00 00 6A 0C E8 ?? ?? ?? ?? 5A 85 C0 C7 04 24 00 00 00 00 0F 84 6B 01 00 00 89 44 24 04 8D 44 24 24 50 E8 ?? ?? ?? ?? 5E 85 C0 0F 85 42 01 00 00 8B 44 24 10 8B 44 84 24 89 44 24 0C B8 01 00 00 00 2B 44 24 10 8B 44 84 24 89 44 24 08 53 50 E8 ?? ?? ?? ?? 89 44 24 08 85 C0 59 5B 75 19 FF 74 24 08 E8 ?? ?? ?? ?? FF 74 24 10 E8 ?? ?? ?? ?? 58 5A E9 FB 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 1C 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __get_hosts_byaddr_r_8241827715a82ff6993b9730f76937fc {
	meta:
		aliases = "__get_hosts_byaddr_r"
		size = "96"
		objfiles = "get_hosts_byaddr_r@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 30 8B 74 24 44 8B 44 24 40 83 FE 02 74 07 83 FE 0A 75 41 EB 05 83 F8 04 EB 03 83 F8 10 75 35 6A 2E 8D 5C 24 06 53 FF 74 24 44 56 E8 ?? ?? ?? ?? FF 74 24 68 FF 74 24 68 FF 74 24 68 FF 74 24 68 FF 74 24 68 6A 02 56 53 6A 00 E8 ?? ?? ?? ?? 83 C4 34 EB 02 31 C0 83 C4 30 5B 5E C3 }
	condition:
		$pattern
}

rule __pthread_timedsuspend_new_caf480e137ac596eeff37925a09e5b21 {
	meta:
		aliases = "__pthread_timedsuspend_new"
		size = "223"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 44 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 5A 85 C0 59 BA 01 00 00 00 0F 85 AC 00 00 00 8B 54 24 50 89 62 24 C7 42 20 00 00 00 00 C7 44 24 3C 00 00 00 00 C7 44 24 40 00 00 00 00 FF 35 ?? ?? ?? ?? 8D 5C 24 40 53 E8 ?? ?? ?? ?? 8D 44 24 3C 50 53 6A 01 E8 ?? ?? ?? ?? 83 C4 14 8D 74 24 2C 8D 5C 24 24 6A 00 56 E8 ?? ?? ?? ?? 8B 4C 24 5C 69 44 24 38 E8 03 00 00 8B 51 04 8B 09 2B 4C 24 34 29 C2 89 54 24 30 89 4C 24 2C 85 D2 58 58 79 11 8D 82 00 CA 9A 3B 89 44 24 28 8D 41 FF 89 44 24 24 83 7C 24 24 00 78 0E 6A 00 53 E8 ?? ?? ?? ?? 5A 85 C0 59 75 AD 6A 00 8D 44 24 38 50 6A 02 E8 ?? ?? ?? ?? 31 }
	condition:
		$pattern
}

rule __GI_erf_006e2428005d35ba735819dac4edbce1 {
	meta:
		aliases = "erf, __GI_erf"
		size = "849"
		objfiles = "s_erf@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 44 DD 44 24 50 DD 54 24 2C 8B 74 24 30 89 F3 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7E 23 C1 EE 1F BA 01 00 00 00 8D 04 36 29 C2 52 DB 04 24 D9 C9 DC 3D ?? ?? ?? ?? 83 C4 04 DE C1 E9 07 03 00 00 DD D8 81 FB FF FF EA 3F 0F 8F A8 00 00 00 81 FB FF FF 2F 3E 7F 35 81 FB FF FF 7F 00 7F 21 DD 44 24 50 D8 0D ?? ?? ?? ?? DD 44 24 50 DC 0D ?? ?? ?? ?? DE C1 D8 0D ?? ?? ?? ?? E9 C8 02 00 00 DD 44 24 50 DC 0D ?? ?? ?? ?? EB 62 DD 44 24 50 D8 C8 DD 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? DD 05 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? }
	condition:
		$pattern
}
...
rule vsscanf_9240f7af54297a0d0fd33902671ed431 {
	meta:
		aliases = "__GI_vsscanf, vsscanf"
		size = "118"
		objfiles = "vsscanf@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 50 89 E6 8D 44 24 38 8B 5C 24 5C C7 44 24 04 FE FF FF FF 66 C7 04 24 A1 00 C6 44 24 02 00 C7 44 24 2C 00 00 00 00 C7 44 24 34 01 00 00 00 50 E8 ?? ?? ?? ?? 89 5C 24 14 89 5C 24 0C C7 44 24 24 00 00 00 00 53 E8 ?? ?? ?? ?? 5A 8D 04 03 89 5C 24 20 89 44 24 10 89 44 24 18 89 44 24 1C FF 74 24 68 FF 74 24 68 56 E8 ?? ?? ?? ?? 83 C4 60 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_opendir_415a623af64347f4e8118a79ba5d23d0 {
	meta:
		aliases = "opendir, __GI_opendir"
		size = "108"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 58 68 00 08 09 00 FF 74 24 68 E8 ?? ?? ?? ?? 5E 89 C3 31 F6 58 85 DB 78 47 89 E0 50 53 E8 ?? ?? ?? ?? 5A 85 C0 59 79 08 53 E8 ?? ?? ?? ?? EB 2F 6A 01 6A 02 53 E8 ?? ?? ?? ?? 8B 54 24 3C 89 D8 E8 ?? ?? ?? ?? 83 C4 0C 89 C6 85 C0 75 12 53 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 00 0C 00 00 00 59 89 F0 83 C4 58 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_cbrt_0852f0b50ca07ebd3ba8d35998b91fd1 {
	meta:
		aliases = "cbrt, __GI_cbrt"
		size = "342"
		objfiles = "s_cbrt@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 68 DD 44 24 74 C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 DD 54 24 50 8B 4C 24 54 8B 5C 24 54 81 E1 FF FF FF 7F 81 E3 00 00 00 80 81 F9 FF FF EF 7F 7E 07 D8 C0 E9 04 01 00 00 DD D8 DD 44 24 74 DD 54 24 48 8B 44 24 48 09 C8 0F 84 F4 00 00 00 DD 5C 24 40 89 4C 24 44 81 F9 FF FF 0F 00 DD 44 24 40 7F 3D D9 EE BA 03 00 00 00 DD 5C 24 38 C7 44 24 3C 00 00 50 43 89 D6 DD 44 24 38 D8 C9 31 D2 DD 54 24 30 8B 44 24 34 F7 F6 89 C1 DD 5C 24 28 81 C1 93 78 7F 29 89 4C 24 2C DD 44 24 28 EB 22 89 C8 BA 03 00 00 00 89 D6 99 D9 EE F7 FE 89 C1 DD 5C 24 20 81 C1 93 78 9F 2A 89 4C 24 24 DD 44 24 }
	condition:
		$pattern
}

rule firstwhite_18cffcf829b353182f7ad0a6714ca961 {
	meta:
		aliases = "firstwhite"
		size = "45"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 89 C3 6A 20 50 E8 ?? ?? ?? ?? 59 5E 89 C6 6A 09 53 E8 ?? ?? ?? ?? 5B 85 F6 5A 74 08 85 C0 74 06 39 C6 76 02 89 C6 89 F0 5B 5E C3 }
	condition:
		$pattern
}

rule tdestroy_recurse_de6a318f909b62a8807b1e11053db7c4 {
	meta:
		aliases = "tdestroy_recurse"
		size = "47"
		objfiles = "tdestroy@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 89 C3 8B 40 04 89 D6 85 C0 74 05 E8 EE FF FF FF 8B 43 08 85 C0 74 07 89 F2 E8 E0 FF FF FF FF 33 FF D6 53 E8 ?? ?? ?? ?? 58 5A 5B 5E C3 }
	condition:
		$pattern
}

rule a64l_c1dbc29766bcb32a9291dc30fb67911b {
	meta:
		aliases = "a64l"
		size = "58"
		objfiles = "a64l@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 44 24 0C 31 DB 89 C2 31 C9 8D 70 06 0F B6 02 83 E8 2E 83 F8 4C 77 1B 8A 80 ?? ?? ?? ?? 3C 40 74 11 0F B6 C0 D3 E0 42 09 C3 39 F2 74 05 83 C1 06 EB DA 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule shm_unlink_ee044be952f44ba18427daaeec0347a7 {
	meta:
		aliases = "shm_unlink"
		size = "41"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 44 24 0C 83 CE FF E8 ?? ?? ?? ?? 89 C3 85 C0 74 10 50 E8 ?? ?? ?? ?? 53 89 C6 E8 ?? ?? ?? ?? 59 5B 89 F0 5B 5E C3 }
	condition:
		$pattern
}
...
rule svcunix_reply_16862abef5eaefa2100fd88c4c90b064 {
	meta:
		aliases = "svctcp_reply, svcunix_reply"
		size = "53"
		objfiles = "svc_tcp@libc.a, svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 44 24 0C 8B 54 24 10 8B 40 2C C7 40 08 00 00 00 00 8D 70 08 8B 40 04 89 02 52 56 E8 ?? ?? ?? ?? 6A 01 89 C3 56 E8 ?? ?? ?? ?? 89 D8 83 C4 10 5B 5E C3 }
	condition:
		$pattern
}
...
rule fill_input_buf_de333371542e146e656b430f55dcfe58 {
	meta:
		aliases = "fill_input_buf"
		size = "53"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 50 30 8B 70 28 83 E2 03 89 C3 8B 40 24 01 D6 29 D0 50 56 FF 33 FF 53 20 83 C4 0C 31 D2 83 F8 FF 74 0B 8D 04 06 89 73 2C 89 43 30 B2 01 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule _dl_run_fini_array_d530f0d42d4e50d5df6d850ad0a27470 {
	meta:
		aliases = "_dl_run_fini_array"
		size = "43"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 54 24 0C 8B 82 A8 00 00 00 85 C0 74 18 89 C6 8B 9A B0 00 00 00 C1 EB 02 03 32 EB 03 FF 14 9E 4B 83 FB FF 75 F7 5B 5E C3 }
	condition:
		$pattern
}

rule ether_line_d6ba91fa6bbbb1f5f96ce6a5ba9277bb {
	meta:
		aliases = "ether_line"
		size = "67"
		objfiles = "ethers@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 54 24 10 8B 44 24 0C 8B 74 24 14 E8 ?? ?? ?? ?? 89 C3 83 C8 FF 85 DB 74 24 EB 17 80 F9 23 74 18 0F B6 D1 A1 ?? ?? ?? ?? F6 04 50 20 75 0A 88 0E 43 46 8A 0B 84 C9 75 E3 C6 06 00 31 C0 5B 5E C3 }
	condition:
		$pattern
}
...
rule xdr_opaque_b6f75567a786ff983aea663dd374131a {
	meta:
		aliases = "__GI_xdr_opaque, xdr_opaque"
		size = "151"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 54 24 14 8B 5C 24 0C 8B 4C 24 10 85 D2 74 79 89 D0 31 F6 83 E0 03 74 06 66 BE 04 00 29 C6 8B 03 83 F8 01 74 09 72 33 83 F8 02 75 63 EB 5A 8B 43 04 52 51 53 FF 50 08 83 C4 0C 85 C0 74 51 85 F6 74 46 8B 43 04 89 74 24 14 C7 44 24 10 ?? ?? ?? ?? 89 5C 24 0C 8B 48 08 EB 2A 8B 43 04 52 51 53 FF 50 0C 83 C4 0C 85 C0 74 25 85 F6 74 1A 8B 43 04 89 74 24 14 C7 44 24 10 ?? ?? ?? ?? 89 5C 24 0C 8B 48 0C 5B 5E FF E1 B8 01 00 00 00 EB 02 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule pthread_free_c99286c32ef544c7716d08c6db588089 {
	meta:
		aliases = "pthread_free"
		size = "171"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 58 10 89 C6 81 E3 FF 03 00 00 31 D2 C1 E3 04 81 C3 ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? C7 43 08 00 00 00 00 C7 43 0C FF FF FF FF 53 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 48 A3 ?? ?? ?? ?? 8B 86 48 01 00 00 EB 0A 8B 18 50 E8 ?? ?? ?? ?? 89 D8 5B 85 C0 75 F1 8B 86 4C 01 00 00 EB 0B 8B 18 50 E8 ?? ?? ?? ?? 89 D8 59 85 C0 75 F1 81 FE ?? ?? ?? ?? 74 34 83 BE 10 01 00 00 00 75 2B 8B 86 18 01 00 00 85 C0 74 0E 50 FF B6 14 01 00 00 E8 ?? ?? ?? ?? 58 5A 8D 86 60 01 E0 FF 68 00 00 20 00 50 E8 ?? ?? ?? ?? 5B 5E 5B 5E C3 }
	condition:
		$pattern
}

rule pthread_kill_01a966fdcd96c4ac00fb7daea6b87d83 {
	meta:
		aliases = "pthread_kill"
		size = "96"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 31 D2 89 D8 25 FF 03 00 00 C1 E0 04 8D B0 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 8B 46 08 85 C0 74 05 39 58 10 74 17 56 E8 ?? ?? ?? ?? B8 03 00 00 00 5A EB 24 E8 ?? ?? ?? ?? 8B 00 EB 1B 8B 58 14 56 E8 ?? ?? ?? ?? FF 74 24 14 53 E8 ?? ?? ?? ?? 83 C4 0C 40 74 DE 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule pthread_rwlock_trywrlock_6b9f93c3e741eae4a765d883e3d884c5 {
	meta:
		aliases = "pthread_rwlock_trywrlock"
		size = "56"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 31 D2 89 D8 E8 ?? ?? ?? ?? 83 7B 08 00 75 12 83 7B 0C 00 75 0C E8 ?? ?? ?? ?? 31 F6 89 43 0C EB 05 BE 10 00 00 00 53 E8 ?? ?? ?? ?? 89 F0 59 5B 5E C3 }
	condition:
		$pattern
}

rule sem_trywait_59cef6584b02cb12564256eed60f3f51 {
	meta:
		aliases = "__new_sem_trywait, sem_trywait"
		size = "56"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 31 D2 89 D8 E8 ?? ?? ?? ?? 8B 43 08 85 C0 75 10 E8 ?? ?? ?? ?? 83 CE FF C7 00 0B 00 00 00 EB 06 48 31 F6 89 43 08 53 E8 ?? ?? ?? ?? 89 F0 5A 5B 5E C3 }
	condition:
		$pattern
}

rule pthread_cond_broadcast_34019ced877585a2dd97b221ca5af6ce {
	meta:
		aliases = "__GI_pthread_cond_broadcast, pthread_cond_broadcast"
		size = "69"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 31 D2 89 D8 E8 ?? ?? ?? ?? 8B 73 08 C7 43 08 00 00 00 00 53 E8 ?? ?? ?? ?? 59 EB 1A 8B 5E 08 C6 86 41 01 00 00 01 C7 46 08 00 00 00 00 89 F0 89 DE E8 ?? ?? ?? ?? 85 F6 75 E2 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule globfree64_d09646c5e5e6c3de32d478579a0abfb1 {
	meta:
		aliases = "__GI_globfree64, __GI_globfree, globfree, globfree64"
		size = "62"
		objfiles = "glob@libc.a, glob64@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 31 F6 83 7B 04 00 75 19 EB 2B 89 F2 8B 43 04 03 53 08 8B 04 90 85 C0 74 07 50 E8 ?? ?? ?? ?? 5A 46 3B 33 72 E5 FF 73 04 E8 ?? ?? ?? ?? C7 43 04 00 00 00 00 58 5B 5E C3 }
	condition:
		$pattern
}

rule fputws_unlocked_22452fc7191c0337d631cae0b3003579 {
	meta:
		aliases = "__GI_fputws_unlocked, fputws_unlocked"
		size = "41"
		objfiles = "fputws_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 53 E8 ?? ?? ?? ?? 5A 89 C6 FF 74 24 10 50 53 E8 ?? ?? ?? ?? 83 C4 0C 39 F0 5B 0F 94 C0 0F B6 C0 48 5E C3 }
	condition:
		$pattern
}
...
rule herror_91d6ff531193ef6636da77e84ad1a347 {
	meta:
		aliases = "__GI_herror, herror"
		size = "74"
		objfiles = "herror@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 85 DB 74 0A BE ?? ?? ?? ?? 80 3B 00 75 05 BE ?? ?? ?? ?? E8 ?? ?? ?? ?? BA ?? ?? ?? ?? 8B 00 83 F8 04 77 07 8B 14 85 ?? ?? ?? ?? 52 56 53 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 14 5B 5E C3 }
	condition:
		$pattern
}

rule _ppfs_prepargs_05c6ee70fd83525ceb1b49097d37647b {
	meta:
		aliases = "_ppfs_prepargs"
		size = "57"
		objfiles = "_ppfs_prepargs@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 8B 44 24 10 8B 73 18 89 43 4C 85 F6 7E 22 89 73 1C C7 43 18 00 00 00 00 C7 43 04 00 00 00 00 C7 43 08 00 00 00 00 53 E8 ?? ?? ?? ?? 89 73 18 58 5B 5E C3 }
	condition:
		$pattern
}

rule svctcp_destroy_30bbffb635bd9d53eea2bae75341825f {
	meta:
		aliases = "svcunix_destroy, svctcp_destroy"
		size = "74"
		objfiles = "svc_tcp@libc.a, svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 8B 73 2C 53 E8 ?? ?? ?? ?? FF 33 E8 ?? ?? ?? ?? 58 66 83 7B 04 00 5A 74 08 66 C7 43 04 00 00 EB 11 8B 46 0C 8B 50 1C 85 D2 74 07 8D 46 08 50 FF D2 58 56 E8 ?? ?? ?? ?? 58 89 5C 24 0C 5B 5E E9 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule svcudp_destroy_47292e7394bf1b0a3c93f3e4b275a74a {
	meta:
		aliases = "svcudp_destroy"
		size = "68"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 8B 73 30 53 E8 ?? ?? ?? ?? FF 33 E8 ?? ?? ?? ?? 8B 46 0C 8B 50 1C 58 85 D2 59 74 07 8D 46 08 50 FF D2 58 FF 73 2C E8 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 5E 58 89 5C 24 0C 5B 5E E9 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI__authenticate_f8d60e14e8f9df52241f1ba184aab874 {
	meta:
		aliases = "_authenticate, __GI__authenticate"
		size = "84"
		objfiles = "svc_auth@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 8B 74 24 10 6A 0C 8D 53 0C 8D 46 18 50 52 E8 ?? ?? ?? ?? 8B 53 1C A1 ?? ?? ?? ?? 83 C4 0C 89 42 20 8B 43 1C C7 40 28 00 00 00 00 8B 43 0C 83 F8 03 77 13 89 74 24 10 89 5C 24 0C 8B 0C 85 ?? ?? ?? ?? 5B 5E FF E1 B8 02 00 00 00 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_double_d4edb6b6a435104d4346c990ba35614b {
	meta:
		aliases = "xdr_double"
		size = "96"
		objfiles = "xdr_float@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 8B 74 24 10 8B 03 83 F8 01 74 27 72 08 83 F8 02 0F 94 C0 EB 3D 8B 43 04 8D 56 04 52 53 FF 50 04 5A 31 D2 59 85 C0 74 2D 8B 43 04 56 53 FF 50 04 EB 19 8B 43 04 8D 56 04 52 53 FF 10 5A 31 D2 59 85 C0 74 11 8B 43 04 56 53 FF 10 5A 85 C0 59 0F 95 C0 0F B6 D0 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule xdrmem_getbytes_afe8ec35984a685f43536df249555e2d {
	meta:
		aliases = "xdrmem_getbytes"
		size = "51"
		objfiles = "xdr_mem@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 8B 74 24 14 31 C0 8B 53 14 39 F2 72 1D 29 F2 89 53 14 56 FF 73 0C FF 74 24 18 E8 ?? ?? ?? ?? 01 73 0C B8 01 00 00 00 83 C4 0C 5B 5E C3 }
	condition:
		$pattern
}

rule xdrmem_putbytes_cb47d9f5d0d946a6a20b9b650f1fa979 {
	meta:
		aliases = "xdrmem_putbytes"
		size = "51"
		objfiles = "xdr_mem@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C 8B 74 24 14 31 C0 8B 53 14 39 F2 72 1D 29 F2 89 53 14 56 FF 74 24 14 FF 73 0C E8 ?? ?? ?? ?? 01 73 0C B8 01 00 00 00 83 C4 0C 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_pthread_attr_setschedpara_f32533726ac6096027de101afe897199 {
	meta:
		aliases = "pthread_attr_setschedparam, __GI_pthread_attr_setschedparam"
		size = "55"
		objfiles = "attr@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 0C FF 73 04 E8 ?? ?? ?? ?? FF 73 04 89 C6 E8 ?? ?? ?? ?? 8B 54 24 18 59 59 8B 12 39 C2 7C 0B 39 F2 7F 07 31 C0 89 53 08 EB 05 B8 16 00 00 00 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_tsearch_5145716861ff338f65d2ce4d78bc5bd9 {
	meta:
		aliases = "tsearch, __GI_tsearch"
		size = "89"
		objfiles = "tsearch@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 10 31 C0 8B 74 24 0C 85 DB 74 46 EB 20 FF 30 56 FF 54 24 1C 59 83 F8 00 5A 75 04 8B 03 EB 32 7D 07 8B 1B 83 C3 04 EB 05 8B 1B 83 C3 08 8B 03 85 C0 75 DA 6A 0C E8 ?? ?? ?? ?? 5A 85 C0 74 12 89 03 89 30 C7 40 08 00 00 00 00 C7 40 04 00 00 00 00 5B 5E C3 }
	condition:
		$pattern
}
...
rule __GI_tfind_a73f11e8fc5f95df4ae1381eb173af40 {
	meta:
		aliases = "tfind, __GI_tfind"
		size = "59"
		objfiles = "tfind@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 10 8B 74 24 0C 85 DB 74 28 EB 20 FF 30 56 FF 54 24 1C 5A 83 F8 00 59 75 04 8B 03 EB 16 7D 07 8B 1B 83 C3 04 EB 05 8B 1B 83 C3 08 8B 03 85 C0 75 DA 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_xdr_callhdr_cbc75f185c00dec600b6db858e11c436 {
	meta:
		aliases = "xdr_callhdr, __GI_xdr_callhdr"
		size = "113"
		objfiles = "rpc_prot@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 10 8B 74 24 0C C7 43 04 00 00 00 00 C7 43 08 02 00 00 00 83 3E 00 75 4F 53 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 42 8D 43 04 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 32 8D 43 08 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 22 8D 43 0C 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 12 8D 43 10 89 74 24 0C 89 44 24 10 5B 5E E9 ?? ?? ?? ?? 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule mempcpy_d55dad00779bc58ccec8cb071e35db2a {
	meta:
		aliases = "__GI_mempcpy, mempcpy"
		size = "30"
		objfiles = "mempcpy@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 14 8B 74 24 0C 53 FF 74 24 14 56 E8 ?? ?? ?? ?? 8D 04 1E 83 C4 0C 5B 5E C3 }
	condition:
		$pattern
}

rule fgetgrent_r_867a2d8b3238f5fbc1223b818c9f02c6 {
	meta:
		aliases = "fgetpwent_r, __GI_fgetgrent_r, __GI_fgetpwent_r, fgetspent_r, __GI_fgetspent_r, fgetgrent_r"
		size = "51"
		objfiles = "fgetspent_r@libc.a, fgetgrent_r@libc.a, fgetpwent_r@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 1C 8B 74 24 10 C7 03 00 00 00 00 FF 74 24 0C FF 74 24 1C FF 74 24 1C 56 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 14 85 C0 75 02 89 33 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_pthread_getschedparam_9af399dc1a53b86a9bf5c942a145542a {
	meta:
		aliases = "pthread_getschedparam, __GI_pthread_getschedparam"
		size = "120"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 31 D2 89 F0 25 FF 03 00 00 C1 E0 04 8D 98 ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? 8B 43 08 85 C0 74 05 39 70 10 74 30 53 E8 ?? ?? ?? ?? B8 03 00 00 00 5B EB 3C FF 74 24 14 56 E8 ?? ?? ?? ?? 5A 40 59 75 09 E8 ?? ?? ?? ?? 8B 00 EB 24 8B 44 24 10 89 18 31 C0 EB 1A 8B 70 14 53 E8 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 59 89 C3 58 83 FB FF 75 C6 EB D3 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_pthread_cond_signal_5908d0ad0caa14e9f40a533ed712a889 {
	meta:
...
rule __GI_sbrk_26c89f80a8071f4884c421b4ed1cd2d1 {
	meta:
...
rule seteuid_a4ed07171bea60b2d2303cad654d7073 {
	meta:
		aliases = "setegid, __GI_seteuid, seteuid"
		size = "74"
		objfiles = "setegid@libc.a, seteuid@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 83 FE FF 75 10 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 EB 2A 6A FF 56 6A FF E8 ?? ?? ?? ?? 83 C4 0C 89 C3 83 F8 FF 75 16 E8 ?? ?? ?? ?? 83 38 26 75 0C 56 6A FF E8 ?? ?? ?? ?? 89 C3 58 5A 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule if_freenameindex_52ba2b48f7df19dd3d027d48d955a36f {
	meta:
		aliases = "__GI_if_freenameindex, if_freenameindex"
		size = "43"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 89 F3 EB 0A 50 83 C3 08 E8 ?? ?? ?? ?? 58 8B 43 04 85 C0 75 EF 83 3B 00 75 EA 89 74 24 0C 5B 5E E9 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_xprt_unregister_7aee672a8361b86caa465ae7386500a2 {
	meta:
...
rule __GI_strsep_c8eb3e0cacb0f4db18a646e6d787add8 {
	meta:
...
rule pthread_mutex_lock_8ce21e36d3898fe5246ad8ad90534a0f {
	meta:
		aliases = "__pthread_mutex_lock, pthread_mutex_lock"
		size = "142"
		objfiles = "mutex@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 46 0C 83 F8 01 74 25 7F 06 85 C0 74 13 EB 0A 83 F8 02 74 41 83 F8 03 74 5C B8 16 00 00 00 EB 64 8D 46 10 31 D2 E8 ?? ?? ?? ?? EB 0F E8 ?? ?? ?? ?? 89 C3 39 46 08 75 07 FF 46 04 31 C0 EB 45 8D 46 10 89 DA E8 ?? ?? ?? ?? 89 5E 08 C7 46 04 00 00 00 00 EB E6 E8 ?? ?? ?? ?? 89 C3 B8 23 00 00 00 39 5E 08 74 1E 8D 46 10 53 50 E8 ?? ?? ?? ?? 89 5E 08 EB 0B 8D 46 10 6A 00 50 E8 ?? ?? ?? ?? 5A 31 C0 59 5B 5E C3 }
	condition:
		$pattern
}
...
rule xdr_opaque_auth_b726b971aec95691b1dd8900c5945d0a {
	meta:
		aliases = "__GI_xdr_opaque_auth, xdr_opaque_auth"
		size = "54"
		objfiles = "rpc_prot@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5C 24 10 53 56 E8 ?? ?? ?? ?? 5A 31 D2 59 85 C0 74 18 8D 43 08 68 90 01 00 00 50 8D 43 04 50 56 E8 ?? ?? ?? ?? 83 C4 10 89 C2 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_xdr_replymsg_83e48f505b2e612940713a32aa180301 {
	meta:
		aliases = "xdr_replymsg, __GI_xdr_replymsg"
		size = "76"
		objfiles = "rpc_prot@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5C 24 10 53 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 30 8D 43 04 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 20 83 7B 04 01 75 1A 8D 43 0C 6A 00 68 ?? ?? ?? ?? 50 8D 43 08 50 56 E8 ?? ?? ?? ?? 83 C4 14 EB 02 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_pmap_232ebe57941e43fe1d4d79e8b67d50a8 {
	meta:
		aliases = "__GI_xdr_pmap, xdr_pmap"
		size = "78"
		objfiles = "pmap_prot@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5C 24 10 53 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 32 8D 43 04 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 22 8D 43 08 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 12 8D 43 0C 89 74 24 0C 89 44 24 10 5B 5E E9 ?? ?? ?? ?? 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_rejected_reply_08ffe0d75bfc8ae85afb91ba0880d119 {
	meta:
		aliases = "__GI_xdr_rejected_reply, xdr_rejected_reply"
		size = "91"
		objfiles = "rpc_prot@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5C 24 10 53 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 3F 8B 03 85 C0 74 05 48 75 36 EB 22 8D 43 04 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 24 8D 43 08 89 74 24 0C 89 44 24 10 5B 5E E9 ?? ?? ?? ?? 8D 43 04 89 74 24 0C 89 44 24 10 5B 5E E9 ?? ?? ?? ?? 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_accepted_reply_33b8ebead507298afc1d3cbaf456dd9b {
	meta:
		aliases = "__GI_xdr_accepted_reply, xdr_accepted_reply"
		size = "115"
		objfiles = "rpc_prot@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5C 24 10 53 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 57 8D 43 0C 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 47 8B 53 0C 85 D2 74 0C B8 01 00 00 00 83 FA 02 75 38 EB 12 8B 43 10 89 74 24 0C 89 44 24 10 8B 4B 14 5B 5E FF E1 8D 43 10 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 12 8D 43 14 89 74 24 0C 89 44 24 10 5B 5E E9 ?? ?? ?? ?? 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_xdr_authunix_parms_b06ca3abe96e1549be6587df1b0e7384 {
	meta:
		aliases = "xdr_authunix_parms, __GI_xdr_authunix_parms"
		size = "118"
		objfiles = "authunix_prot@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5C 24 10 53 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 5A 8D 43 04 68 FF 00 00 00 50 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 44 8D 43 08 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 34 8D 43 0C 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 24 8D 43 10 68 ?? ?? ?? ?? 6A 04 6A 10 50 8D 43 14 50 56 E8 ?? ?? ?? ?? 83 C4 18 85 C0 0F 95 C0 0F B6 C0 EB 02 31 C0 5B 5E C3 }
	condition:
		$pattern
}
...
rule addmntent_c32042e82a4cc3538578e4e05c9b4087 {
	meta:
		aliases = "addmntent"
		size = "73"
		objfiles = "mntent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5C 24 10 6A 02 6A 00 56 E8 ?? ?? ?? ?? 83 C4 0C BA 01 00 00 00 85 C0 78 24 FF 73 14 FF 73 10 FF 73 0C FF 73 08 FF 73 04 FF 33 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 20 89 C2 C1 EA 1F 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_xdr_callmsg_691677b85ac84da6b555b30975fdcdd7 {
	meta:
		aliases = "xdr_callmsg, __GI_xdr_callmsg"
		size = "779"
		objfiles = "rpc_cmsg@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5C 24 10 83 3E 00 0F 85 DC 00 00 00 8B 53 20 81 FA 90 01 00 00 0F 87 DD 02 00 00 8B 43 2C 3D 90 01 00 00 0F 87 CF 02 00 00 83 C2 03 83 C0 03 83 E0 FC 83 E2 FC 8B 4E 04 8D 54 02 28 52 56 FF 51 18 89 C2 58 85 D2 59 0F 84 9B 00 00 00 8B 03 0F C8 89 02 8B 43 04 0F C8 89 42 04 83 7B 04 00 0F 85 93 02 00 00 8B 43 08 0F C8 89 42 08 83 7B 08 02 0F 85 81 02 00 00 8B 43 0C 8D 72 20 0F C8 89 42 0C 8B 43 10 0F C8 89 42 10 8B 43 14 0F C8 89 42 14 8B 43 18 0F C8 89 42 18 8B 43 20 0F C8 89 42 1C 8B 43 20 85 C0 74 18 50 FF 73 1C 56 E8 ?? ?? ?? ?? 8B 43 20 83 C4 0C 83 C0 03 83 E0 FC 01 C6 }
	condition:
		$pattern
}

rule siglongjmp_7d28f6943d4fb5439b29a882aee6266a {
	meta:
		aliases = "__libc_siglongjmp, __libc_longjmp, _longjmp, longjmp, siglongjmp"
		size = "45"
		objfiles = "longjmp@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5C 24 10 83 7E 18 00 74 10 8D 46 1C 6A 00 50 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 85 DB 75 02 B3 01 53 56 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule xdrrec_setpos_20046538150134d0a9edaad8ad6ac4af {
	meta:
		aliases = "xdrrec_setpos"
		size = "94"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5E 0C 56 E8 ?? ?? ?? ?? 5A 83 F8 FF 74 44 8B 16 2B 44 24 10 85 D2 74 05 4A 75 37 EB 14 8B 53 10 29 C2 3B 53 18 76 2B 3B 53 14 73 26 89 53 10 EB 1A 8B 53 2C 3B 43 34 7D 19 29 C2 3B 53 30 77 12 3B 53 28 72 0D 29 43 34 89 53 2C B8 01 00 00 00 EB 02 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule xdrrec_getpos_43a3dda725ecffeb56ede02e238affdc {
	meta:
		aliases = "xdrrec_getpos"
		size = "65"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5E 0C 6A 01 6A 00 FF 33 E8 ?? ?? ?? ?? 83 C4 0C 89 C1 83 C8 FF 83 F9 FF 74 1D 8B 16 85 D2 74 05 4A 75 14 EB 0A 8B 43 10 2B 43 0C 01 C8 EB 08 89 C8 2B 43 30 03 43 2C 5B 5E C3 }
	condition:
		$pattern
}

rule authunix_destroy_eef2e481c440752bc409e5dec5bcf172 {
	meta:
		aliases = "authunix_destroy"
		size = "66"
		objfiles = "auth_unix@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 8B 5E 24 FF 73 04 E8 ?? ?? ?? ?? 8B 43 10 85 C0 5B 74 07 50 E8 ?? ?? ?? ?? 59 FF 76 24 E8 ?? ?? ?? ?? 8B 46 10 5A 85 C0 74 07 50 E8 ?? ?? ?? ?? 58 89 74 24 0C 5B 5E E9 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_getrpcbynumber_70f454fccf82ce1c078a235d0b30189d {
	meta:
...
rule getttynam_fe93cb04155bd68beb8c09f190083a09 {
	meta:
		aliases = "getttynam"
		size = "48"
		objfiles = "getttyent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C E8 ?? ?? ?? ?? EB 0E FF 33 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 0B E8 ?? ?? ?? ?? 89 C3 85 C0 75 E7 E8 ?? ?? ?? ?? 89 D8 5B 5E C3 }
	condition:
		$pattern
}

rule updwtmp_46d347e56ffa6de035ee5ca91844c4a6 {
	meta:
		aliases = "updwtmp"
		size = "84"
		objfiles = "wtent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 10 68 01 04 00 00 FF 74 24 10 E8 ?? ?? ?? ?? 89 C3 58 85 DB 5A 78 35 6A 00 6A 01 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 24 68 80 01 00 00 56 53 E8 ?? ?? ?? ?? 6A 00 6A 00 53 E8 ?? ?? ?? ?? 83 C4 18 89 5C 24 0C 5B 5E E9 ?? ?? ?? ?? 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_hcreate_r_4a61e5bfb0ca7694b2e7009b947bdbef {
	meta:
		aliases = "hcreate_r, __GI_hcreate_r"
		size = "120"
		objfiles = "hcreate_r@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 10 85 F6 75 0F E8 ?? ?? ?? ?? C7 00 16 00 00 00 31 C0 EB 5C 31 C0 83 3E 00 75 55 8B 4C 24 0C 83 C9 01 EB 03 83 C1 02 BB 03 00 00 00 EB 03 83 C3 02 89 D8 0F AF C3 39 C8 73 0A 31 D2 89 C8 F7 F3 85 D2 75 EA 31 D2 89 C8 F7 F3 85 D2 74 D6 89 4E 04 C7 46 08 00 00 00 00 6A 0C 8B 46 04 40 50 E8 ?? ?? ?? ?? 89 06 85 C0 0F 95 C0 5A 59 0F B6 C0 5B 5E C3 }
	condition:
		$pattern
}

rule __libc_pread64_327143c83c685cef96a3d8e6c93b1405 {
	meta:
...
rule res_sync_func_db5cd54504d6ef3f14299d10b1f58326 {
	meta:
		aliases = "res_sync_func"
		size = "92"
		objfiles = "res_init@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 E8 ?? ?? ?? ?? 81 3D ?? ?? ?? ?? ?? ?? ?? ?? 89 C6 74 34 0F B6 40 60 39 05 ?? ?? ?? ?? 76 05 A3 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? EB 18 6B C3 1C 6A 1C 03 05 ?? ?? ?? ?? FF 74 9E 54 50 E8 ?? ?? ?? ?? 83 C4 0C 4B 79 E5 8A 46 52 5B A2 ?? ?? ?? ?? 8A 46 53 5E A2 ?? ?? ?? ?? C3 }
	condition:
		$pattern
}

rule sethostid_9890da525dd8d4bb0a0a3eb3db3d3a95 {
	meta:
		aliases = "sethostid"
		size = "103"
		objfiles = "hostid@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 E8 ?? ?? ?? ?? 85 C0 75 09 E8 ?? ?? ?? ?? 85 C0 74 12 E8 ?? ?? ?? ?? BE 01 00 00 00 C7 00 01 00 00 00 EB 3C 68 A4 01 00 00 6A 41 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 89 C6 85 C0 78 22 6A 04 31 DB 8D 44 24 10 50 56 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 04 56 0F 94 C3 4B E8 ?? ?? ?? ?? 89 DE 58 89 F0 5B 5E C3 }
	condition:
		$pattern
}
...
rule pthread_attr_setguardsize_702c56952c75c89a27e92a4a12bae9aa {
	meta:
		aliases = "__pthread_attr_setguardsize, pthread_attr_setguardsize"
		size = "50"
		objfiles = "attr@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 E8 ?? ?? ?? ?? 8B 54 24 10 89 C6 8B 5C 24 0C 8D 54 10 FF 89 D0 31 D2 F7 F6 89 C1 B8 16 00 00 00 0F AF CE 3B 4B 20 73 05 89 4B 14 30 C0 5B 5E C3 }
	condition:
		$pattern
}

rule clntraw_freeres_aa3bd744ac3b699bc53cef9f0fa51af9 {
	meta:
		aliases = "clntraw_freeres"
		size = "57"
		objfiles = "clnt_raw@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 E8 ?? ?? ?? ?? 8B 74 24 10 8B 5C 24 14 8B 80 A0 00 00 00 85 C0 74 18 C7 40 0C 02 00 00 00 83 C0 0C 89 5C 24 10 89 44 24 0C 89 F1 5B 5E FF E1 B8 10 00 00 00 5B 5E C3 }
	condition:
		$pattern
}

rule svcraw_getargs_04de2b5d86c7f85fd3b42f59288693b8 {
	meta:
		aliases = "svcraw_getargs"
		size = "49"
		objfiles = "svc_raw@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 E8 ?? ?? ?? ?? 8B 74 24 10 8B 5C 24 14 8B 80 BC 00 00 00 85 C0 74 13 05 94 23 00 00 89 5C 24 10 89 44 24 0C 89 F1 5B 5E FF E1 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule svcraw_freeargs_8be06b2f055879ba07c3fa6bf9e7ac65 {
	meta:
		aliases = "svcraw_freeargs"
		size = "59"
		objfiles = "svc_raw@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 E8 ?? ?? ?? ?? 8B 74 24 10 8B 5C 24 14 8B 80 BC 00 00 00 85 C0 74 1D C7 80 94 23 00 00 02 00 00 00 05 94 23 00 00 89 5C 24 10 89 44 24 0C 89 F1 5B 5E FF E1 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule svcraw_reply_b54791fcceda35368be07ac4324628e6 {
	meta:
		aliases = "svcraw_reply"
		size = "85"
		objfiles = "svc_raw@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 E8 ?? ?? ?? ?? 8B 98 BC 00 00 00 85 DB 74 3F 8B 83 98 23 00 00 8D B3 94 23 00 00 C7 83 94 23 00 00 00 00 00 00 6A 00 56 FF 50 14 FF 74 24 18 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 12 8B 83 98 23 00 00 56 FF 50 10 B8 01 00 00 00 5B EB 02 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule ftello_33f7bc8996c82d515dcb10a3c1bd2801 {
	meta:
		aliases = "__GI_ftell, ftell, ftello"
		size = "48"
		objfiles = "ftello@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 04 89 C3 89 C6 C1 FB 1F 39 D3 75 04 39 C0 74 0E E8 ?? ?? ?? ?? 83 CE FF C7 00 4B 00 00 00 89 F0 5B 5E C3 }
	condition:
		$pattern
}

rule __pthread_set_own_extricate_if_0f5ab980b3db3b21d9763f76a6fe489e {
	meta:
		aliases = "__pthread_set_own_extricate_if"
		size = "50"
		objfiles = "oldsemaphore@libpthread.a, condvar@libpthread.a, semaphore@libpthread.a, join@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 85 D2 53 89 D6 89 C3 74 08 80 78 40 00 75 1F EB 0A 8B 40 1C 89 DA E8 ?? ?? ?? ?? 89 B3 44 01 00 00 85 F6 75 09 FF 73 1C E8 ?? ?? ?? ?? 58 5B 5E C3 }
	condition:
		$pattern
}

rule skip_07a71675430a2f1dac3277b38e4c96e7 {
	meta:
		aliases = "skip"
		size = "133"
		objfiles = "getttyent@libc.a"
...
rule __check_one_fd_9876a4e6ed96e91db59ff3e227b1b41f {
	meta:
		aliases = "__check_one_fd"
		size = "44"
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 89 C6 53 89 D3 6A 01 50 E8 ?? ?? ?? ?? 5A 40 59 75 16 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A 39 F0 59 74 05 E8 ?? ?? ?? ?? 5B 5E C3 }
	condition:
		$pattern
}

rule skip_input_bytes_51035994e6e4b93bc80a073ba2c3f648 {
	meta:
		aliases = "skip_input_bytes"
		size = "59"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 89 C6 53 89 D3 EB 27 8B 4E 2C 8B 46 30 29 C8 75 0D 89 F0 E8 ?? ?? ?? ?? 85 C0 75 12 EB 19 89 DA 39 C3 7E 02 89 C2 8D 04 11 29 D3 89 46 2C 85 DB 7F D5 B8 01 00 00 00 5B 5E C3 }
	condition:
		$pattern
}

rule __ether_line_w_39ee74d7a19a146b242f9057ea901ea3 {
	meta:
		aliases = "__ether_line_w"
		size = "48"
		objfiles = "ethers@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 89 D6 53 89 C3 6A 23 50 E8 ?? ?? ?? ?? 5A 85 C0 59 75 0E 6A 0A 53 E8 ?? ?? ?? ?? 5A 85 C0 59 74 03 C6 00 00 89 F2 89 D8 5B 5E E9 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule svc_getreq_b4743976051df278452203c4470ffc26 {
	meta:
		aliases = "__GI_svc_getreq, svc_getreq"
		size = "48"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 81 EC 84 00 00 00 B9 20 00 00 00 8D 54 24 04 89 D7 FC F3 AB 8B 84 24 8C 00 00 00 89 44 24 04 52 E8 ?? ?? ?? ?? 81 C4 88 00 00 00 5F C3 }
	condition:
		$pattern
}

rule sigignore_23118bc19a220bab52e391a274efd415 {
	meta:
		aliases = "sigignore"
		size = "42"
		objfiles = "sigignore@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 83 EC 18 8D 54 24 04 89 D7 AB AB AB AB AB C7 44 24 04 01 00 00 00 6A 00 52 FF 74 24 28 E8 ?? ?? ?? ?? 83 C4 24 5F C3 }
	condition:
		$pattern
}

rule logout_dc9ad36d1b9cfd1452d1ac5e4ea9f8cd {
	meta:
		aliases = "logout"
		size = "150"
		objfiles = "logout@libutil.a"
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 80 01 00 00 31 DB 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A 40 74 73 E8 ?? ?? ?? ?? 66 C7 04 24 07 00 6A 20 FF B4 24 90 01 00 00 8D 5C 24 08 8D 44 24 10 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 74 3B 31 C0 B9 08 00 00 00 8D 7B 2C F3 AB B9 40 00 00 00 8D 7B 4C F3 AB 8D 83 54 01 00 00 6A 00 50 E8 ?? ?? ?? ?? 66 C7 03 08 00 53 E8 ?? ?? ?? ?? BB 01 00 00 00 83 C4 0C 85 C0 75 02 31 DB E8 ?? ?? ?? ?? 89 D8 81 C4 80 01 00 00 5B 5F C3 }
	condition:
		$pattern
}

rule sigqueue_adcae0f24c5d6a70d2ad769bd1d6ca30 {
	meta:
		aliases = "sigqueue"
		size = "129"
		objfiles = "sigqueue@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 84 00 00 00 31 C0 B9 20 00 00 00 8D 5C 24 04 89 DF F3 AB 8B 84 24 94 00 00 00 C7 44 24 0C FF FF FF FF 89 44 24 04 E8 ?? ?? ?? ?? 89 44 24 10 E8 ?? ?? ?? ?? 89 44 24 14 8B 84 24 98 00 00 00 89 44 24 18 8B BC 24 90 00 00 00 8B 8C 24 94 00 00 00 89 DA 53 89 FB B8 B2 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 81 C4 84 00 00 00 5B 5F C3 }
	condition:
		$pattern
}

rule __xstat_conv_2888b0ccd4947d38ee2c751709b4c67f {
	meta:
		aliases = "__xstat_conv"
		size = "141"
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 04 31 C0 B9 16 00 00 00 8B 5C 24 14 8B 54 24 10 89 DF F3 AB 8B 02 C7 43 04 00 00 00 00 89 03 8B 42 04 89 43 0C 0F B7 42 08 89 43 10 0F B7 42 0A 89 43 14 0F B7 42 0C 89 43 18 0F B7 42 0E 89 43 1C 0F B7 42 10 C7 43 24 00 00 00 00 89 43 20 8B 42 14 89 43 2C 8B 42 18 89 43 30 8B 42 1C 89 43 34 8B 42 24 8B 4A 20 89 43 3C 89 4B 38 8B 42 2C 8B 4A 28 89 43 44 89 4B 40 8B 42 34 8B 4A 30 89 43 4C 89 4B 48 5A 5B 5F C3 }
	condition:
		$pattern
}

rule open_68443a9fb4fb97ed862e936ac0914a0c {
	meta:
		aliases = "__libc_open, __GI_open, open"
		size = "68"
		objfiles = "open@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 04 31 D2 8B 4C 24 14 8B 7C 24 10 F6 C1 40 74 0B 8D 44 24 1C 8B 54 24 18 89 04 24 53 89 FB B8 05 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 5B 5F C3 }
	condition:
		$pattern
}

rule fcntl_da85f709305ed54422288aa9feffe344 {
	meta:
		aliases = "__GI_fcntl, __libc_fcntl, fcntl"
		size = "82"
		objfiles = "__syscall_fcntl@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 04 8B 4C 24 14 8D 44 24 1C 89 04 24 8B 7C 24 10 8D 41 F4 8B 54 24 18 83 F8 02 77 0D 52 51 57 E8 ?? ?? ?? ?? 83 C4 0C EB 21 53 89 FB B8 37 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 5B 5F C3 }
	condition:
		$pattern
}

rule truncate64_486c2d9cfb1657c2fd3b68604c3f1803 {
	meta:
		aliases = "truncate64"
		size = "76"
		objfiles = "truncate64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 08 8B 54 24 1C 8B 44 24 18 89 D0 8B 7C 24 14 89 C2 89 04 24 C1 FA 1F 8B 4C 24 18 89 54 24 04 8B 14 24 53 89 FB B8 C1 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5B 5F C3 }
	condition:
		$pattern
}

rule ftruncate64_b3396e78f59341ddc012b4690a7ededf {
	meta:
		aliases = "__GI_ftruncate64, ftruncate64"
		size = "76"
		objfiles = "ftruncate64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 08 8B 54 24 1C 8B 44 24 18 89 D0 8B 7C 24 14 89 C2 89 04 24 C1 FA 1F 8B 4C 24 18 89 54 24 04 8B 14 24 53 89 FB B8 C2 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5B 5F C3 }
	condition:
		$pattern
}

rule lockf_ad495dbb69f5cad5a72f19373cfeeea5 {
	meta:
		aliases = "__GI_lockf, lockf"
		size = "204"
		objfiles = "lockf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 10 31 C0 89 E1 89 E7 8B 5C 24 1C 8B 54 24 20 AB AB AB AB 8B 44 24 24 66 C7 44 24 02 01 00 C7 44 24 04 00 00 00 00 89 44 24 08 83 FA 01 74 54 7F 06 85 D2 74 46 EB 66 83 FA 02 74 54 83 FA 03 75 5C 66 C7 04 24 00 00 51 6A 05 53 E8 ?? ?? ?? ?? 83 C4 0C 83 CA FF 85 C0 78 66 66 83 3C 24 02 74 5D 8B 5C 24 0C E8 ?? ?? ?? ?? 39 C3 74 50 E8 ?? ?? ?? ?? C7 00 0D 00 00 00 EB 2D 66 C7 04 24 02 00 EB 13 BA 07 00 00 00 66 C7 04 24 01 00 EB 1D 66 C7 04 24 01 00 BA 06 00 00 00 EB 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 CA FF EB 13 89 E0 50 52 53 E8 ?? ?? ?? ?? 83 C4 0C 89 C2 EB 02 31 D2 83 C4 10 89 }
	condition:
		$pattern
}

rule __pthread_kill_other_threads_n_68c8e607ecaf9ba90cb06c2e86670a33 {
	meta:
		aliases = "pthread_kill_other_threads_np, __pthread_kill_other_threads_np"
		size = "90"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 18 6A 00 6A 00 8D 5C 24 0C E8 ?? ?? ?? ?? 89 DF E8 ?? ?? ?? ?? 31 C0 AB AB AB AB AB 6A 00 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 00 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 20 85 C0 7E 0C 6A 00 53 50 E8 ?? ?? ?? ?? 83 C4 0C 83 C4 18 5B 5F C3 }
	condition:
		$pattern
}

rule abort_f2062ab5d6578f8d4b2fe4527e64b5bf {
	meta:
		aliases = "__GI_abort, abort"
		size = "200"
		objfiles = "abort@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 20 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 44 24 1C 00 00 00 00 C7 44 24 20 00 00 00 00 6A 06 8D 5C 24 20 53 E8 ?? ?? ?? ?? 6A 00 53 6A 01 E8 ?? ?? ?? ?? 83 C4 18 80 3D ?? ?? ?? ?? 00 75 25 C6 05 ?? ?? ?? ?? 01 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 06 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C A0 ?? ?? ?? ?? 3C 01 75 33 8D 54 24 04 C6 05 ?? ?? ?? ?? 02 31 C0 89 D7 AB AB AB AB AB C7 44 24 10 FF FF FF FF C7 44 24 14 FF FF FF FF 6A 00 52 6A 06 E8 ?? ?? ?? ?? 83 C4 0C EB A6 3C 02 75 08 C6 05 ?? ?? ?? ?? 03 F4 80 3D ?? ?? ?? ?? 03 75 0E C6 05 ?? ?? ?? ?? 04 6A 7F E8 ?? ?? ?? ?? F4 EB FD }
	condition:
		$pattern
}
...
rule sigset_2d2e92a1f27e7c3f1ef11d0d6b1a75dd {
	meta:
		aliases = "sigset"
		size = "186"
		objfiles = "sigset@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 34 8B 54 24 44 8B 5C 24 40 83 FA FF 74 09 85 DB 7E 05 83 FB 40 7E 13 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 E9 84 00 00 00 83 FA 02 75 2C C7 44 24 2C 00 00 00 00 C7 44 24 30 00 00 00 00 53 8D 5C 24 30 53 E8 ?? ?? ?? ?? 6A 00 53 6A 00 E8 ?? ?? ?? ?? BA 02 00 00 00 EB 50 8D 4C 24 18 31 C0 89 CF AB AB AB AB AB 8D 44 24 04 89 54 24 18 50 51 53 E8 ?? ?? ?? ?? 83 C4 0C 83 CA FF 85 C0 78 2C C7 44 24 2C 00 00 00 00 C7 44 24 30 00 00 00 00 53 8D 5C 24 30 53 E8 ?? ?? ?? ?? 6A 00 53 6A 01 E8 ?? ?? ?? ?? 8B 54 24 18 83 C4 14 83 C4 34 89 D0 5B 5F C3 }
	condition:
		$pattern
}

rule gethostid_494b4e8b37b346f99950eb1457d71b6c {
	meta:
		aliases = "gethostid"
		size = "160"
		objfiles = "hostid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 70 C7 44 24 6C 00 00 00 00 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C7 5B 85 FF 58 78 1C 6A 04 8D 44 24 70 50 57 E8 ?? ?? ?? ?? 57 89 C3 E8 ?? ?? ?? ?? 83 C4 10 85 DB 7F 59 6A 40 8D 5C 24 0B 53 E8 ?? ?? ?? ?? 5A 85 C0 59 78 47 80 7C 24 07 00 74 40 8D 54 24 48 31 C0 B9 08 00 00 00 89 D7 F3 AB 8D 44 24 68 50 52 6A 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 1C 8B 54 24 68 85 D2 74 0D 8B 42 14 8B 40 04 C1 C8 10 89 44 24 6C 52 E8 ?? ?? ?? ?? 58 8B 44 24 6C 83 C4 70 5B 5F C3 }
	condition:
		$pattern
}
...
rule __GI__exit_f3bcedcc7113d478cf414c07ca2227b7 {
	meta:
		aliases = "_exit, _Exit, __GI__exit"
		size = "37"
		objfiles = "_exit@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 8B 7C 24 0C 53 89 FB B8 01 00 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 EC E8 ?? ?? ?? ?? F7 DB 89 18 EB E1 }
	condition:
		$pattern
}

rule logwtmp_979ce020fdaa6270582518147ba1e91d {
	meta:
		aliases = "logwtmp"
		size = "153"
		objfiles = "logwtmp@libutil.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 C0 81 EC 80 01 00 00 B9 60 00 00 00 89 E7 8B B4 24 94 01 00 00 F3 AB 85 F6 74 07 B0 07 80 3E 00 75 05 B8 08 00 00 00 66 89 04 24 E8 ?? ?? ?? ?? 89 44 24 04 6A 1F FF B4 24 94 01 00 00 8D 44 24 10 8D 5C 24 08 50 E8 ?? ?? ?? ?? 6A 1F 56 8D 44 24 40 50 E8 ?? ?? ?? ?? 68 FF 00 00 00 FF B4 24 B4 01 00 00 8D 44 24 6C 50 E8 ?? ?? ?? ?? 83 C4 24 6A 00 8D 84 24 58 01 00 00 50 E8 ?? ?? ?? ?? 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 81 C4 90 01 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __xstat32_conv_4e86211cdd6b5a798a23874930e8251a {
	meta:
		aliases = "__xstat32_conv"
		size = "138"
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 C0 83 EC 04 B9 16 00 00 00 8B 74 24 18 8B 5C 24 14 89 F7 F3 AB 8B 03 8B 53 04 89 56 04 89 06 8B 43 58 89 46 0C 8B 43 10 89 46 10 8B 43 14 89 46 14 8B 43 18 89 46 18 8B 43 1C 89 46 1C 0F B7 43 20 C7 46 24 00 00 00 00 89 46 20 8B 43 2C 89 46 2C 8B 43 34 89 46 30 8B 43 38 89 46 34 8B 53 40 8B 43 44 89 46 3C 89 56 38 8B 53 48 8B 43 4C 89 46 44 89 56 40 8B 53 50 8B 43 54 89 46 4C 89 56 48 59 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __xstat64_conv_aa72d87119f310bd0a757abc89366c22 {
	meta:
		aliases = "__xstat64_conv"
		size = "163"
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 C0 83 EC 04 B9 18 00 00 00 8B 74 24 18 8B 5C 24 14 89 F7 F3 AB 8B 03 8B 53 04 89 56 04 89 06 8B 43 58 8B 53 5C 89 56 5C 89 46 58 8B 43 0C 89 46 0C 8B 43 10 89 46 10 8B 43 14 89 46 14 8B 43 18 89 46 18 8B 43 1C 89 46 1C 0F B7 43 20 C7 46 24 00 00 00 00 89 46 20 8B 43 2C 8B 53 30 89 56 30 89 46 2C 8B 43 34 89 46 34 8B 43 38 C7 46 3C 00 00 00 00 89 46 38 8B 43 44 8B 53 40 89 46 44 89 56 40 8B 53 48 8B 43 4C 89 46 4C 89 56 48 8B 53 50 8B 43 54 89 46 54 89 56 50 58 5B 5E 5F C3 }
	condition:
		$pattern
}

rule _ppfs_init_85d136b30b37e06092cbf612283b3378 {
	meta:
		aliases = "_ppfs_init"
		size = "103"
		objfiles = "_ppfs_init@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 C0 83 EC 04 B9 2F 00 00 00 8B 74 24 14 8B 5C 24 18 89 F7 F3 AB FF 4E 18 89 1E 8D 46 28 BA 09 00 00 00 C7 00 08 00 00 00 83 C0 04 4A 75 F4 89 D8 EB 22 80 FA 25 75 1C 40 80 38 25 74 16 89 06 56 E8 ?? ?? ?? ?? 59 85 C0 79 05 83 C8 FF EB 0F 8B 06 EB 01 40 8A 10 84 D2 75 D8 89 1E 31 C0 5A 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __dl_iterate_phdr_02a03db640d3bf424caac8d9534ed410 {
	meta:
		aliases = "__GI___dl_iterate_phdr, __dl_iterate_phdr"
		size = "84"
		objfiles = "dl_iterate_phdr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 C0 83 EC 10 8B 1D ?? ?? ?? ?? 89 E6 8B 7C 24 24 EB 33 8B 03 89 04 24 8B 43 04 89 44 24 04 8B 83 D0 00 00 00 89 44 24 08 8B 83 CC 00 00 00 66 89 44 24 0C 57 6A 10 56 FF 54 24 2C 83 C4 0C 85 C0 75 07 8B 5B 0C 85 DB 75 C9 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_strncasecmp_d171ed62f4a5ea5463d531e81c9002e2 {
	meta:
...
rule cfsetspeed_69efa7313fee97b9fa8559fddfb61f8b {
	meta:
		aliases = "cfsetspeed"
		size = "90"
		objfiles = "cfsetspeed@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 C0 8B 7C 24 10 8B 74 24 14 EB 34 8B 1C C5 ?? ?? ?? ?? 39 DE 75 0A 56 57 E8 ?? ?? ?? ?? 56 EB 11 3B 34 C5 ?? ?? ?? ?? 75 15 53 57 E8 ?? ?? ?? ?? 53 57 E8 ?? ?? ?? ?? 31 C0 83 C4 10 EB 14 40 83 F8 1F 76 C7 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pthread_detach_b0f13256d7366bd66ab3c5c0ca937809 {
	meta:
		aliases = "pthread_detach"
		size = "184"
		objfiles = "join@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 D2 83 EC 1C 8B 7C 24 2C 89 F8 25 FF 03 00 00 C1 E0 04 8D B0 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 8B 46 08 85 C0 74 05 39 78 10 74 0D 56 E8 ?? ?? ?? ?? B8 03 00 00 00 EB 21 80 78 2D 00 74 0D 56 E8 ?? ?? ?? ?? B8 16 00 00 00 EB 0E 83 78 38 00 74 0B 56 E8 ?? ?? ?? ?? 31 C0 5B EB 51 8A 58 2C C6 40 2D 01 56 E8 ?? ?? ?? ?? 59 84 DB 74 3D 83 3D ?? ?? ?? ?? 00 78 34 E8 ?? ?? ?? ?? 89 E3 89 04 24 C7 44 24 04 01 00 00 00 89 7C 24 08 6A 1C 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E2 31 C0 83 C4 1C 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pthread_rwlock_destroy_26371705320e5c6147b8dd1d8b86d237 {
	meta:
		aliases = "pthread_rwlock_destroy"
		size = "48"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 D2 8B 5C 24 10 89 D8 E8 ?? ?? ?? ?? 8B 73 08 8B 7B 0C 53 E8 ?? ?? ?? ?? 58 85 F6 7F 06 31 C0 85 FF 74 05 B8 10 00 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pthread_rwlock_unlock_b4518dca88dc4c839a132d62eb4447ae {
	meta:
		aliases = "pthread_rwlock_unlock"
		size = "303"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 D2 8B 7C 24 10 89 F8 E8 ?? ?? ?? ?? 8B 5F 0C 85 DB 74 6A E8 ?? ?? ?? ?? 39 C3 75 68 C7 47 0C 00 00 00 00 83 7F 18 00 74 25 8B 5F 14 85 DB 74 1E 8B 43 08 89 47 14 C7 43 08 00 00 00 00 57 E8 ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? 31 C0 EB 41 8B 77 10 C7 47 10 00 00 00 00 57 E8 ?? ?? ?? ?? 59 EB 13 8B 5E 08 89 F0 C7 46 08 00 00 00 00 89 DE E8 ?? ?? ?? ?? 85 F6 75 E9 E9 A8 00 00 00 8B 47 08 85 C0 75 11 57 E8 ?? ?? ?? ?? B8 01 00 00 00 5A E9 92 00 00 00 48 31 DB 89 47 08 85 C0 75 14 8B 5F 14 85 DB 74 0D 8B 43 08 89 47 14 C7 43 08 00 00 00 00 57 E8 ?? ?? ?? ?? 58 85 DB 74 07 89 D8 E8 ?? ?? ?? }
	condition:
		$pattern
}

rule encrypt_1ba66548135f74732632404d823e671f {
	meta:
		aliases = "encrypt"
		size = "149"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 DB 83 EC 08 8B 7C 24 18 E8 ?? ?? ?? ?? 31 C0 E8 ?? ?? ?? ?? 89 F9 EB 22 31 D2 C7 04 9C 00 00 00 00 EB 11 F6 01 01 74 0A 8B 04 95 ?? ?? ?? ?? 09 04 9C 41 42 83 FA 1F 7E EA 43 83 FB 01 7E D9 83 7C 24 1C 01 19 DB 89 E1 83 E3 02 8B 54 24 04 4B 8B 04 24 53 8D 5C 24 08 53 E8 ?? ?? ?? ?? 31 DB 59 5E EB 19 89 CA 8B 04 9C 09 F2 85 04 8D ?? ?? ?? ?? 0F 95 04 17 41 83 F9 1F 7E E8 43 83 FB 01 7F 09 89 DE 31 C9 C1 E6 05 EB D9 58 5A 5B 5E 5F C3 }
	condition:
		$pattern
}

rule setkey_9a0f95da8f8f1da2cc1651fa423c79cd {
	meta:
		aliases = "setkey"
		size = "65"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 F6 83 EC 08 89 E7 8B 5C 24 18 EB 1F 8D 14 37 31 C9 C6 02 00 EB 0F F6 03 01 74 08 8A 81 ?? ?? ?? ?? 08 02 43 41 83 F9 07 7E EC 46 83 FE 07 7E DC 89 F8 E8 ?? ?? ?? ?? 59 5B 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_strcspn_2c0f793537e03b9cc2c22c5d342926f9 {
	meta:
		aliases = "strcspn, __GI_strcspn"
		size = "45"
		objfiles = "strcspn@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 F6 8B 5C 24 10 8B 7C 24 14 EB 12 0F B6 C0 50 57 E8 ?? ?? ?? ?? 5A 85 C0 59 75 08 43 46 8A 03 84 C0 75 E8 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule xdr_vector_dfe8f5e6e9ed4825a8e43c115d29a9d7 {
	meta:
		aliases = "xdr_vector"
		size = "50"
		objfiles = "xdr_array@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 F6 8B 7C 24 10 8B 5C 24 14 EB 14 6A FF 53 57 FF 54 24 2C 83 C4 0C 85 C0 74 10 03 5C 24 1C 46 3B 74 24 18 72 E6 B8 01 00 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_inet_ntoa_r_22ec723e176d1e449652697417b662e5 {
	meta:
		aliases = "inet_ntoa_r, __GI_inet_ntoa_r"
		size = "76"
		objfiles = "inet_ntoa@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 FF 8B 4C 24 14 8B 44 24 10 83 C1 0F 31 F6 0F C8 89 C3 EB 28 89 D8 31 D2 25 FF 00 00 00 6A 00 6A F6 52 50 51 E8 ?? ?? ?? ?? 83 C4 14 85 F6 8D 48 FF 74 03 C6 06 2E C1 EB 08 47 89 CE 83 FF 03 7E D3 8D 41 01 5B 5E 5F C3 }
	condition:
		$pattern
}

rule ether_hostton_82d8bcc8e4a3dff014aa0af7b2de2432 {
	meta:
		aliases = "ether_hostton"
		size = "122"
		objfiles = "ethers@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 81 EC 00 01 00 00 8B BC 24 10 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C6 5B 83 CB FF 58 85 F6 74 44 EB 23 8B 94 24 14 01 00 00 89 E0 E8 ?? ?? ?? ?? 85 C0 74 13 50 57 E8 ?? ?? ?? ?? 5A 85 C0 59 75 06 31 DB EB 18 89 E3 56 68 00 01 00 00 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 C8 83 CB FF 56 E8 ?? ?? ?? ?? 5E 81 C4 00 01 00 00 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule shm_open_f1cb3240174727f2280b31ab5183294e {
	meta:
		aliases = "shm_open"
		size = "59"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 CF FF 8B 44 24 10 8B 74 24 14 E8 ?? ?? ?? ?? 89 C3 85 C0 74 1C FF 74 24 18 81 CE 00 00 08 00 56 50 E8 ?? ?? ?? ?? 53 89 C7 E8 ?? ?? ?? ?? 83 C4 10 89 F8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule tcgetsid_86059e58df67cfa1170c0585388d7147 {
	meta:
		aliases = "tcgetsid"
		size = "118"
		objfiles = "tcgetsid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 04 80 3D ?? ?? ?? ?? 00 8B 7C 24 14 75 2C E8 ?? ?? ?? ?? 89 C3 8B 30 89 E0 50 68 29 54 00 00 57 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 38 83 3B 16 75 38 C6 05 ?? ?? ?? ?? 01 89 33 57 E8 ?? ?? ?? ?? 5B 83 F8 FF 74 23 50 E8 ?? ?? ?? ?? 89 44 24 04 59 40 75 10 E8 ?? ?? ?? ?? 83 38 03 75 06 C7 00 19 00 00 00 8B 04 24 EB 03 83 C8 FF 5A 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pthread_reap_children_54917d6f8adc97a83a82ede2978c85ff {
	meta:
		aliases = "pthread_reap_children"
		size = "231"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 04 89 E7 E9 BD 00 00 00 8B 0D ?? ?? ?? ?? 8B 31 EB 6F 39 46 14 8B 16 75 66 8B 46 04 89 42 04 8B 46 04 89 10 31 D2 8B 46 1C E8 ?? ?? ?? ?? C6 46 2E 01 83 BE 24 01 00 00 00 74 2B A1 ?? ?? ?? ?? 0B 86 28 01 00 00 F6 C4 08 74 1B C7 86 30 01 00 00 0C 00 00 00 89 B6 34 01 00 00 89 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8A 5E 2D FF 76 1C E8 ?? ?? ?? ?? 58 84 DB 74 0F 89 F0 E8 ?? ?? ?? ?? EB 06 89 D6 39 CE 75 8D 83 3D ?? ?? ?? ?? 00 74 12 A1 ?? ?? ?? ?? 8B 10 39 C2 75 07 89 D0 E8 ?? ?? ?? ?? 8B 0C 24 88 C8 83 E0 7F 40 D0 F8 84 C0 7E 16 83 E1 7F BA 01 00 00 00 89 C8 E8 ?? ?? ?? ?? 6A 00 E8 ?? ?? }
	condition:
		$pattern
}
...
rule __GI_xdr_string_f4a623cfe333e4f383204f10a4526dc1 {
	meta:
		aliases = "xdr_string, __GI_xdr_string"
		size = "194"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 04 8B 74 24 14 8B 7C 24 18 8B 06 8B 1F 85 C0 74 0E 83 F8 02 75 1B 85 DB 75 0D E9 90 00 00 00 85 DB 0F 84 8F 00 00 00 53 E8 ?? ?? ?? ?? 5A 89 04 24 89 E0 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 74 76 8B 04 24 3B 44 24 1C 77 6D 8B 16 83 FA 01 74 09 72 3A 83 FA 02 75 5F EB 42 40 74 53 85 DB 75 25 50 E8 ?? ?? ?? ?? 89 07 89 C3 59 85 C0 75 16 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5F 31 C0 5A EB 33 8B 04 24 C6 04 03 00 FF 34 24 53 56 E8 ?? ?? ?? ?? 83 C4 0C EB 1D 53 E8 ?? ?? ?? ?? C7 07 00 00 00 00 B8 01 00 00 00 5E EB 09 B8 01 00 00 00 EB 02 31 C0 5B 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __libc_lseek64_8007158c17920c35e4929b5b7ed70fdb {
	meta:
		aliases = "lseek64, __GI_lseek64, __libc_lseek64"
		size = "89"
		objfiles = "llseek@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 08 89 E6 8B 5C 24 20 8B 4C 24 1C 89 D9 8B 7C 24 24 89 CB 8B 44 24 18 C1 FB 1F 8B 54 24 1C 53 89 C3 B8 8C 00 00 00 CD 80 5B 89 C6 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF EB 04 85 C0 74 03 99 EB 07 8B 04 24 8B 54 24 04 59 5B 5B 5E 5F C3 }
	condition:
		$pattern
}

rule readtcp_05fd7e73a6c33f8d46445fcc96471979 {
	meta:
		aliases = "readtcp"
		size = "120"
		objfiles = "svc_tcp@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 08 89 E6 8B 7C 24 18 8B 1F 89 1C 24 66 C7 44 24 04 01 00 68 B8 88 00 00 6A 01 56 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 FF 74 06 85 C0 74 35 EB 0A E8 ?? ?? ?? ?? 83 38 04 EB 0B 0F BF 44 24 06 A8 18 75 20 A8 20 75 1C F6 44 24 06 01 74 BD FF 74 24 20 FF 74 24 20 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 7F 0C 8B 47 2C C7 00 00 00 00 00 83 C8 FF 5B 5E 5B 5E 5F C3 }
	condition:
		$pattern
}

rule readahead_9929eae04f8db67e881673ed1f544da2 {
	meta:
		aliases = "readahead"
		size = "82"
		objfiles = "readahead@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 08 8B 54 24 20 8B 44 24 1C 89 D0 8B 7C 24 18 89 C2 89 04 24 C1 FA 1F 8B 74 24 24 89 54 24 04 8B 0C 24 8B 54 24 1C 53 89 FB B8 E1 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5B 5E 5F C3 }
	condition:
		$pattern
}

rule ptrace_2a387c7cd7aaa5306ce181fe4ffab312 {
	meta:
		aliases = "ptrace"
		size = "109"
		objfiles = "ptrace@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 08 8B 7C 24 18 8D 44 24 28 89 04 24 8B 4C 24 1C 8D 47 FF 8B 54 24 20 8B 74 24 24 83 F8 02 77 04 8D 74 24 04 53 89 FB B8 1A 00 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF EB 1C 85 C0 78 18 85 FF 74 14 83 FF 03 77 0F E8 ?? ?? ?? ?? C7 00 00 00 00 00 8B 44 24 04 5A 59 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pthread_rwlock_rdlock_f8e49fe516b462e496e77a9d183408bb {
	meta:
		aliases = "pthread_rwlock_rdlock"
		size = "163"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 0C 89 E2 8B 5C 24 1C C7 44 24 08 00 00 00 00 8D 4C 24 04 8D 44 24 08 52 89 DA E8 ?? ?? ?? ?? 8D 7B 10 89 C6 58 83 7C 24 08 00 75 09 E8 ?? ?? ?? ?? 89 44 24 08 8B 54 24 08 89 D8 E8 ?? ?? ?? ?? 89 F2 89 D8 E8 ?? ?? ?? ?? 85 C0 75 1D 8B 54 24 08 89 F8 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 8B 44 24 0C E8 ?? ?? ?? ?? 58 EB BB FF 43 08 53 E8 ?? ?? ?? ?? 59 85 F6 75 06 83 3C 24 00 74 17 8B 44 24 04 85 C0 74 05 FF 40 08 EB 0A 8B 44 24 08 FF 80 50 01 00 00 83 C4 0C 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __old_sem_post_7aed29cf9d528615212e20788c394af5 {
	meta:
		aliases = "__old_sem_post"
		size = "162"
		objfiles = "oldsemaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 0C 8B 4C 24 1C 8B 11 89 D7 83 E7 01 75 07 BE 03 00 00 00 EB 1B 81 FA FF FF FF 7F 75 10 E8 ?? ?? ?? ?? C7 00 22 00 00 00 83 C8 FF EB 69 8D 72 02 89 D0 F0 0F B1 31 0F 94 C3 84 DB 74 C8 85 FF 75 53 89 D1 8D 7C 24 08 C7 44 24 08 00 00 00 00 EB 1F 8B 71 08 89 FB EB 03 8D 5A 08 8B 13 85 D2 74 08 8B 41 18 3B 42 18 7C EF 89 51 08 89 0B 89 F1 83 F9 01 75 DC EB 15 8B 42 08 89 44 24 08 C7 42 08 00 00 00 00 52 E8 ?? ?? ?? ?? 59 8B 54 24 08 85 D2 75 E3 31 C0 83 C4 0C 5B 5E 5F C3 }
	condition:
		$pattern
}

rule putchar_f5507e0555b4afe9b870c793aaa04b66 {
	meta:
		aliases = "putchar"
		size = "137"
		objfiles = "putchar@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 35 ?? ?? ?? ?? 8B 7C 24 20 83 7E 34 00 74 20 8B 46 10 3B 46 1C 73 0D 89 FA 88 10 40 0F B6 DA 89 46 10 EB 55 56 57 E8 ?? ?? ?? ?? 89 C3 EB 48 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 8B 46 10 83 C4 10 3B 46 1C 73 0D 89 FA 88 10 40 0F B6 DA 89 46 10 EB 0B 56 57 E8 ?? ?? ?? ?? 59 89 C3 5E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule puts_c627864c0b88905afaa1a497f0ea566b {
	meta:
		aliases = "puts"
		size = "112"
		objfiles = "puts@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 35 ?? ?? ?? ?? 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 FF 74 24 24 E8 ?? ?? ?? ?? 89 C3 58 83 FB FF 5A 74 13 56 6A 0A E8 ?? ?? ?? ?? 59 40 5E 75 05 83 CB FF EB 01 43 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule calloc_f2f3591e36e529e35cabb5f96cbcbf28 {
	meta:
		aliases = "calloc"
		size = "235"
		objfiles = "calloc@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 4C 24 24 8B 54 24 20 89 CB 0F AF DA 85 D2 74 1E 89 D7 89 D8 31 D2 F7 F7 39 C1 74 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 AD 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 14 89 C3 85 C0 74 72 8B 40 FC A8 02 75 6B 83 E0 FC 8D 50 FC 89 D0 C1 E8 02 83 F8 09 76 0E 52 6A 00 53 E8 ?? ?? ?? ?? 83 C4 0C EB 4D C7 03 00 00 00 00 C7 43 04 00 00 00 00 C7 43 08 00 00 00 00 83 F8 04 76 34 C7 43 0C 00 00 00 00 C7 43 10 00 00 00 00 83 F8 06 76 21 C7 43 14 00 00 00 00 C7 43 18 00 00 00 00 83 F8 09 75 0E C7 43 }
	condition:
		$pattern
}

rule localtime_r_f4c63ef00ec0cfd45ad701c063a0b253 {
	meta:
		aliases = "__GI_localtime_r, localtime_r"
		size = "93"
		objfiles = "localtime_r@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 5C 24 20 8B 7C 24 24 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 74 24 08 56 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 C0 81 3B FF 4E 98 45 0F 9E C0 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 57 53 E8 ?? ?? ?? ?? 83 C4 20 6A 01 56 E8 ?? ?? ?? ?? 83 C4 18 89 F8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __des_crypt_4835b70069a0f3aad7e590be439146c2 {
	meta:
		aliases = "__des_crypt"
		size = "384"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 5C 24 20 8B 7C 24 24 E8 ?? ?? ?? ?? 89 E2 89 E1 EB 0E 8A 03 01 C0 88 02 42 80 7A FF 01 83 DB FF 89 D0 29 C8 83 F8 08 75 E9 89 E0 E8 ?? ?? ?? ?? 8A 57 01 0F B6 37 89 F0 A2 ?? ?? ?? ?? 8A 47 01 84 C0 75 02 89 F0 A2 ?? ?? ?? ?? 0F B6 C2 E8 ?? ?? ?? ?? 89 F2 89 C3 0F B6 C2 C1 E3 06 E8 ?? ?? ?? ?? 09 C3 89 D8 E8 ?? ?? ?? ?? 8D 4C 24 0C 6A 19 31 D2 8D 44 24 0C 50 31 C0 E8 ?? ?? ?? ?? 5F 5A 31 D2 85 C0 0F 85 E5 00 00 00 8B 4C 24 0C 8B 5C 24 08 89 C8 89 CA C1 E8 1A C6 05 ?? ?? ?? ?? 00 C1 EA 08 8A 80 ?? ?? ?? ?? 83 E2 3F A2 ?? ?? ?? ?? 89 C8 C1 E8 14 83 E0 3F 8A 80 ?? ?? ?? ?? A2 }
	condition:
		$pattern
}
...
rule seekdir_784c48f09178c355646e1d72e3c647ad {
	meta:
		aliases = "seekdir"
		size = "80"
		objfiles = "seekdir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 5C 24 20 8D 73 18 56 68 ?? ?? ?? ?? 8D 7C 24 08 57 E8 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 6A 00 FF 74 24 38 FF 33 E8 ?? ?? ?? ?? C7 43 04 00 00 00 00 89 43 10 C7 43 08 00 00 00 00 6A 01 57 E8 ?? ?? ?? ?? 83 C4 34 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_fflush_31814a3d9118de464941cc309a51f6bb {
	meta:
		aliases = "fflush, __GI_fflush"
		size = "104"
		objfiles = "fflush@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 85 F6 74 48 81 FE ?? ?? ?? ?? 74 40 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 E8 ?? ?? ?? ?? 5E 89 C3 85 FF 75 19 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 5A 59 EB 09 56 E8 ?? ?? ?? ?? 89 C3 58 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_vfwprintf_60d5767518d3a5256845ec6668778999 {
	meta:
		aliases = "vfwprintf, __GI_vfwprintf"
		size = "126"
		objfiles = "vfwprintf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 40 08 00 00 3D 40 08 00 00 74 14 68 00 08 00 00 56 E8 ?? ?? ?? ?? 59 5B 83 CB FF 85 C0 75 13 FF 74 24 28 FF 74 24 28 56 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_vfprintf_d54f62d5508d83cd711d9bd9bb4769b4 {
	meta:
		aliases = "vfprintf, __GI_vfprintf"
		size = "126"
		objfiles = "vfprintf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 C0 00 00 00 3D C0 00 00 00 74 14 68 80 00 00 00 56 E8 ?? ?? ?? ?? 59 5B 83 CB FF 85 C0 75 13 FF 74 24 28 FF 74 24 28 56 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule fgetwc_f742656956ff575187512389884c869a {
	meta:
		aliases = "__GI_fgetwc, getwc, fileno, __GI_fileno, fgetwc"
		size = "81"
		objfiles = "fileno@libc.a, fgetwc@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 E8 ?? ?? ?? ?? 59 89 C3 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule clearerr_da4034e2c20d393263d5fb81e7fe2776 {
	meta:
		aliases = "clearerr"
		size = "74"
		objfiles = "clearerr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 66 83 26 F3 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_rewind_6be1b6a238be18a0005cb3c0095b8fd4 {
	meta:
		aliases = "rewind, __GI_rewind"
		size = "87"
		objfiles = "rewind@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 66 83 26 F7 6A 00 6A 00 56 E8 ?? ?? ?? ?? 83 C4 0C 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule feof_01420f3e74b999aa6a2972bed4651c79 {
	meta:
		aliases = "feof"
		size = "77"
		objfiles = "feof@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 1E 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 10 83 E0 04 5B 5E 5F C3 }
	condition:
		$pattern
}

rule ferror_d28edeafcbe666410245d316ddaa49f8 {
	meta:
		aliases = "ferror"
		size = "77"
		objfiles = "ferror@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 1E 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 10 83 E0 08 5B 5E 5F C3 }
	condition:
		$pattern
}

rule fputc_14eaaea6263612e6e05d80dd2179b2b4 {
	meta:
		aliases = "putc, __GI_fputc, __GI_putc, fputc"
		size = "135"
		objfiles = "fputc@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 24 8B 7C 24 20 83 7E 34 00 74 20 8B 46 10 3B 46 1C 73 0D 89 FA 88 10 40 0F B6 DA 89 46 10 EB 55 56 57 E8 ?? ?? ?? ?? 89 C3 EB 48 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 8B 46 10 83 C4 10 3B 46 1C 73 0D 89 FA 88 10 40 0F B6 DA 89 46 10 EB 0B 56 57 E8 ?? ?? ?? ?? 59 89 C3 5E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule putwc_67429af378f00be7a4fba4a1e2949451 {
	meta:
		aliases = "__GI_fputs, fputws, fputwc, __GI_fputws, fputs, putwc"
		size = "86"
		objfiles = "fputs@libc.a, fputws@libc.a, fputwc@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 24 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 FF 74 24 24 E8 ?? ?? ?? ?? 59 89 C3 5E 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule fgetws_ea22d2f5a28c9accff5f9a6f09cfbd61 {
	meta:
		aliases = "fgets, __GI_fgets, fgetws"
		size = "91"
		objfiles = "fgetws@libc.a, fgets@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 28 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 FF 74 24 28 FF 74 24 28 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_getgrent_r_6bab333f82d319da6905ccef85417dd1 {
	meta:
		aliases = "__GI_getspent_r, getspent_r, __GI_getpwent_r, getpwent_r, getgrent_r, __GI_getgrent_r"
		size = "161"
		objfiles = "getspent_r@libc.a, getpwent_r@libc.a, getgrent_r@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 2C 8B 7C 24 20 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 06 00 00 00 00 83 C4 10 83 3D ?? ?? ?? ?? 00 75 2A 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 59 85 C0 75 09 E8 ?? ?? ?? ?? 8B 18 EB 2B C7 40 34 01 00 00 00 FF 35 ?? ?? ?? ?? FF 74 24 2C FF 74 24 2C 57 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 14 89 C3 85 C0 75 02 89 3E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 83 C4 18 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule fread_9a2e687202b2ee0394488c0f955a024d {
	meta:
		aliases = "__GI_fwrite, __GI_fread, fwrite, fread"
		size = "95"
		objfiles = "fread@libc.a, fwrite@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 2C 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 FF 74 24 2C FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule closedir_0629d0d174d544e086a4ef705e0fdbff {
	meta:
		aliases = "__GI_closedir, closedir"
		size = "103"
		objfiles = "closedir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 7C 24 20 83 3F FF 75 10 E8 ?? ?? ?? ?? C7 00 09 00 00 00 83 C8 FF EB 41 8D 5F 18 53 68 ?? ?? ?? ?? 8D 74 24 08 56 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 8B 1F C7 07 FF FF FF FF 6A 01 56 E8 ?? ?? ?? ?? FF 77 0C E8 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 83 C4 20 53 E8 ?? ?? ?? ?? 5A 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule gets_4fe57ec466d0eafbbc7adc1d6d97452a {
	meta:
		aliases = "gets"
		size = "119"
		objfiles = "gets@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 A1 ?? ?? ?? ?? 8B 74 24 20 8B 78 34 85 FF 74 04 89 F3 EB 27 83 C0 38 50 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C0 38 50 E8 ?? ?? ?? ?? 83 C4 10 EB D6 43 E8 ?? ?? ?? ?? 83 F8 FF 74 0A 88 03 3C 0A 75 EF 39 DE 75 04 31 F6 EB 03 C6 03 00 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule round_f04424362a462e0764dacee0e6a4b163 {
	meta:
		aliases = "__GI_round, round"
		size = "288"
		objfiles = "s_round@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 DD 44 24 20 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 DD 54 24 08 8B 74 24 0C 8B 54 24 08 89 F0 C1 F8 14 25 FF 07 00 00 8D 98 01 FC FF FF 83 FB 13 7F 75 85 DB 79 31 DD 05 ?? ?? ?? ?? DE C1 D9 EE D9 C9 DA E9 DF E0 9E 0F 86 B2 00 00 00 81 E6 00 00 00 80 31 D2 43 0F 85 A3 00 00 00 81 CE 00 00 F0 3F E9 98 00 00 00 DD D8 BF FF FF 0F 00 88 D9 D3 FF 89 F8 21 F0 09 D0 0F 84 8F 00 00 00 DD 44 24 20 DC 05 ?? ?? ?? ?? D9 EE D9 C9 DA E9 DF E0 9E 76 6C B8 00 00 08 00 89 FA D3 F8 F7 D2 8D 34 30 21 D6 31 D2 EB 58 DD D8 83 FB 33 7E 10 81 FB 00 04 00 00 75 57 DD 44 24 20 D8 C0 EB 4B 83 CF }
	condition:
		$pattern
}

rule pclose_a383faa1089acbd021b11a049ebe9fcd {
	meta:
		aliases = "pclose"
		size = "178"
		objfiles = "popen@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 14 8B 7C 24 24 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? 83 C4 10 85 DB 74 2C 39 7B 04 75 09 8B 03 A3 ?? ?? ?? ?? EB 1E 89 DA 8B 1B 85 DB 75 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 09 39 7B 04 75 E6 8B 03 89 02 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 59 85 DB 5E 74 35 8B 73 08 53 E8 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 58 5A 8D 5C 24 10 6A 00 53 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 06 8B 44 24 10 EB 0D E8 ?? ?? ?? ?? 83 38 04 74 E0 83 C8 FF 83 C4 14 5B 5E 5F C3 }
	condition:
		$pattern
}

rule ftello64_24fb43b318085760cf1cbc930fd69416 {
	meta:
		aliases = "__GI_ftello64, ftello64"
		size = "162"
		objfiles = "ftello64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 18 8B 74 24 28 C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 8B 7E 34 85 FF 75 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 40 04 00 00 3D 40 04 00 00 0F 94 C0 0F B6 C0 40 50 8D 5C 24 14 53 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 0D 53 56 E8 ?? ?? ?? ?? 59 85 C0 5B 79 10 C7 44 24 10 FF FF FF FF C7 44 24 14 FF FF FF FF 85 FF 75 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 8B 44 24 10 8B 54 24 14 83 C4 18 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_pmap_getport_f7d747676420fbaa491f0a99d3b87783 {
	meta:
		aliases = "pmap_getport, __GI_pmap_getport"
		size = "224"
		objfiles = "pm_getport@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 18 8B 7C 24 28 66 C7 44 24 16 00 00 C7 44 24 10 FF FF FF FF 66 C7 47 02 00 6F 68 90 01 00 00 68 90 01 00 00 8D 44 24 18 50 FF 35 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 6A 02 68 A0 86 01 00 57 E8 ?? ?? ?? ?? 83 C4 20 89 C3 85 C0 74 7E E8 ?? ?? ?? ?? C7 44 24 0C 00 00 00 00 89 C6 8B 44 24 2C 89 04 24 8B 44 24 30 89 44 24 04 8B 44 24 34 89 44 24 08 89 E2 8D 44 24 16 8B 4B 04 FF 35 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 50 68 ?? ?? ?? ?? 52 68 ?? ?? ?? ?? 6A 03 53 FF 11 83 C4 20 85 C0 74 15 C7 06 0E 00 00 00 8D 46 04 8B 53 04 50 53 FF 52 08 5A 59 EB 0E 66 83 7C 24 16 00 75 06 C7 06 0F 00 00 00 8B 43 }
	condition:
		$pattern
}

rule __GI_authnone_create_5dd706c39cc5b81aa5ae3e2ff6eea263 {
	meta:
		aliases = "authnone_create, __GI_authnone_create"
		size = "161"
		objfiles = "auth_none@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 18 E8 ?? ?? ?? ?? 89 C3 8B B0 98 00 00 00 85 F6 75 19 6A 40 6A 01 E8 ?? ?? ?? ?? 5A 31 D2 59 85 C0 74 70 89 C6 89 83 98 00 00 00 83 7E 3C 00 75 60 8D 5E 0C 6A 0C 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 6A 0C 53 56 E8 ?? ?? ?? ?? 8D 46 28 C7 46 20 ?? ?? ?? ?? 6A 00 6A 14 50 8D 7C 24 24 57 E8 ?? ?? ?? ?? 83 C4 28 56 57 E8 ?? ?? ?? ?? 53 57 E8 ?? ?? ?? ?? 57 8B 44 24 18 FF 50 10 89 46 3C 8B 44 24 18 83 C4 14 8B 40 1C 85 C0 74 04 57 FF D0 58 89 F2 83 C4 18 89 D0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule if_indextoname_5461501f13f4957afda6f59c910b7f5b {
	meta:
		aliases = "if_indextoname"
		size = "105"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 20 E8 ?? ?? ?? ?? 89 C6 31 C0 85 F6 78 4F 8B 44 24 30 89 E3 89 44 24 10 53 68 10 89 00 00 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 1D E8 ?? ?? ?? ?? 89 C7 8B 18 56 E8 ?? ?? ?? ?? 58 83 FB 13 75 02 B3 06 31 C0 89 1F EB 15 56 E8 ?? ?? ?? ?? 6A 10 53 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 10 83 C4 20 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __res_query_5cf7795ff1bc9165a6a358a95050fd8b {
	meta:
		aliases = "__GI___res_query, __res_query"
		size = "169"
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 30 8B 54 24 40 8B 5C 24 48 C7 44 24 2C 00 00 00 00 85 D2 74 07 83 7C 24 44 01 74 10 E8 ?? ?? ?? ?? 83 CF FF C7 00 03 00 00 00 EB 6F 8D 74 24 04 31 C0 B9 0A 00 00 00 89 F7 F3 AB 56 8D 44 24 30 50 53 52 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 79 15 E8 ?? ?? ?? ?? 83 CF FF 83 38 00 75 3D C7 00 02 00 00 00 EB 35 FF 74 24 04 E8 ?? ?? ?? ?? 5A 39 5C 24 08 75 1B 3B 7C 24 50 7E 04 8B 7C 24 50 57 FF 74 24 30 FF 74 24 54 E8 ?? ?? ?? ?? 83 C4 0C FF 74 24 2C E8 ?? ?? ?? ?? 58 83 C4 30 89 F8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule readunix_65ac57e4c010d5741d731c27f6952c6f {
	meta:
		aliases = "readunix"
		size = "265"
		objfiles = "svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 30 8B 7C 24 40 8D 74 24 24 8B 1F 89 5C 24 24 66 C7 44 24 28 01 00 68 B8 88 00 00 6A 01 56 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 FF 74 0A 85 C0 0F 84 BE 00 00 00 EB 0A E8 ?? ?? ?? ?? 83 38 04 EB 0F 0F BF 44 24 2A A8 18 0F 85 A5 00 00 00 A8 20 0F 85 9D 00 00 00 F6 44 24 2A 01 74 B0 8B 44 24 44 C7 44 24 0C 01 00 00 00 89 44 24 1C 8B 44 24 48 89 44 24 20 8D 44 24 1C 89 44 24 08 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 C7 44 24 10 ?? ?? ?? ?? C7 44 24 14 1C 00 00 00 C7 44 24 18 00 00 00 00 C7 44 24 2C 01 00 00 00 6A 04 8D 44 24 30 50 6A 10 6A 01 53 E8 ?? ?? ?? ?? 83 C4 14 85 C0 75 2F 89 }
	condition:
		$pattern
}

rule rint_ba0c6e07d824efba56a795840443012e {
	meta:
		aliases = "__GI_nearbyint, __GI_rint, nearbyint, rint"
		size = "327"
		objfiles = "s_rint@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 30 DD 44 24 40 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 DD 54 24 20 8B 5C 24 24 8B 74 24 20 89 D8 89 DF C1 F8 14 C1 EF 1F 25 FF 07 00 00 8D 88 01 FC FF FF 83 F9 13 0F 8F A3 00 00 00 85 C9 79 69 89 D8 25 FF FF FF 7F 09 F0 0F 84 E4 00 00 00 89 DA 81 E3 00 00 FE FF 81 E2 FF FF 0F 00 09 F2 89 D0 F7 D8 09 D0 C1 E8 0C DD 5C 24 18 25 00 00 08 00 09 D8 89 44 24 1C DD 04 FD ?? ?? ?? ?? DD 44 24 18 D8 C1 C1 E7 1F DE E1 DD 54 24 10 8B 44 24 14 25 FF FF FF 7F DD 5C 24 08 09 C7 89 7C 24 0C DD 44 24 08 E9 84 00 00 00 DD D8 BA FF FF 0F 00 D3 FA 89 D0 21 D8 09 F0 74 7B D1 EA 89 D0 21 D8 09 }
	condition:
		$pattern
}

rule clntraw_create_85a30694db839f0031dbdb0dfcdb0d0e {
	meta:
		aliases = "clntraw_create"
		size = "211"
		objfiles = "clnt_raw@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 30 E8 ?? ?? ?? ?? 89 C6 8B 98 A0 00 00 00 89 DF 85 DB 75 20 68 A0 22 00 00 6A 01 E8 ?? ?? ?? ?? 5F 5A 31 D2 85 C0 0F 84 99 00 00 00 89 C7 89 86 A0 00 00 00 8B 44 24 40 8D 73 0C 89 44 24 0C 8B 44 24 44 89 44 24 10 8D 87 84 22 00 00 C7 44 24 04 00 00 00 00 C7 44 24 08 02 00 00 00 6A 00 6A 18 50 56 E8 ?? ?? ?? ?? 8D 44 24 10 50 56 E8 ?? ?? ?? ?? 83 C4 18 85 C0 75 0B 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 8B 43 10 56 FF 50 10 89 87 9C 22 00 00 8B 43 10 5A 8B 40 1C 85 C0 74 04 56 FF D0 58 8D 47 24 6A 02 68 60 22 00 00 50 56 E8 ?? ?? ?? ?? C7 43 04 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 DA 89 03 83 }
	condition:
		$pattern
}

rule __GI_erfc_d8cb45feefe114a1cf535aa17ce7329c {
	meta:
		aliases = "erfc, __GI_erfc"
		size = "884"
		objfiles = "s_erf@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 44 DD 44 24 54 DD 54 24 2C 8B 74 24 30 89 F3 89 F7 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7E 1D C1 EE 1F 31 D2 52 8D 04 36 50 DF 2C 24 D9 C9 DC 3D ?? ?? ?? ?? 83 C4 08 E9 5A 01 00 00 DD D8 81 FB FF FF EA 3F 0F 8F A8 00 00 00 81 FB FF FF 6F 3C 7F 0F DD 44 24 54 DC 2D ?? ?? ?? ?? E9 07 03 00 00 DD 44 24 54 D8 C8 81 FE FF FF CF 3F DD 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? DD 05 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? DE CA D9 E8 DC C2 D9 C9 DE F2 }
	condition:
		$pattern
}

rule __GI_vsnprintf_30a7cf2dafbacc323b531a7c7e565f45 {
	meta:
		aliases = "vsnprintf, __GI_vsnprintf"
		size = "161"
		objfiles = "vsnprintf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 50 89 E7 8D 44 24 38 8B 74 24 60 C7 44 24 04 FE FF FF FF 66 C7 04 24 D0 00 C6 44 24 02 00 C7 44 24 2C 00 00 00 00 C7 44 24 34 01 00 00 00 50 E8 ?? ?? ?? ?? C7 44 24 24 00 00 00 00 5A 89 F0 F7 D0 8B 5C 24 64 39 C3 76 02 89 C3 8D 04 1E 89 74 24 08 89 44 24 0C 89 74 24 10 89 74 24 14 89 74 24 18 89 44 24 1C FF 74 24 6C FF 74 24 6C 57 E8 ?? ?? ?? ?? 83 C4 0C 89 C2 85 DB 74 16 8B 44 24 10 3B 44 24 0C 75 05 48 89 44 24 10 8B 44 24 10 C6 00 00 83 C4 50 89 D0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_modf_5b7677b91109828086e71825d05f8474 {
	meta:
		aliases = "modf, __GI_modf"
		size = "400"
		objfiles = "s_modf@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 50 DD 44 24 60 C7 44 24 40 00 00 00 00 C7 44 24 44 00 00 00 00 DD 5C 24 48 8B 5C 24 4C C7 44 24 30 00 00 00 00 89 D8 C7 44 24 34 00 00 00 00 C1 F8 14 C7 44 24 28 00 00 00 00 25 FF 07 00 00 C7 44 24 2C 00 00 00 00 C7 44 24 18 00 00 00 00 C7 44 24 1C 00 00 00 00 8D 88 01 FC FF FF C7 44 24 08 00 00 00 00 C7 44 24 0C 00 00 00 00 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 8B 7C 24 68 8B 74 24 48 83 F9 13 7F 7A 85 C9 79 1D 81 E3 00 00 00 80 C7 44 24 40 00 00 00 00 89 5C 24 44 DD 44 24 40 DD 1F E9 D6 00 00 00 BA FF FF 0F 00 D3 FA 89 D0 21 D8 09 F0 75 28 DD 44 24 60 DD 17 C7 44 24 30 }
	condition:
		$pattern
}

rule pathconf_126e7218cbbc4303cbf51870c361dce0 {
	meta:
		aliases = "pathconf"
		size = "188"
		objfiles = "pathconf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 58 8B 74 24 68 8B 44 24 6C 80 3E 00 75 10 E8 ?? ?? ?? ?? C7 00 02 00 00 00 E9 81 00 00 00 83 F8 13 77 0E FF 24 85 ?? ?? ?? ?? B8 20 00 00 00 EB 7F E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 61 B8 7F 00 00 00 EB 6B E8 ?? ?? ?? ?? 89 C3 8B 38 89 E0 50 56 E8 ?? ?? ?? ?? 5E 85 C0 5A 79 09 83 3B 26 75 3D 89 3B EB 32 8B 44 24 24 EB 44 31 C0 EB 40 89 E0 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 78 20 8B 44 24 10 25 00 F0 00 00 3D 00 80 00 00 74 1C 3D 00 60 00 00 75 09 EB 13 B8 FF 00 00 00 EB 11 83 C8 FF EB 0C B8 00 10 00 00 EB 05 B8 01 00 00 00 83 C4 58 5B 5E 5F C3 }
	condition:
		$pattern
}

rule fpathconf_5a5a5bb18612e5f333b646ec27ea33d0 {
	meta:
		aliases = "fpathconf"
		size = "196"
		objfiles = "fpathconf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 58 8B 74 24 68 8B 54 24 6C 85 F6 79 10 E8 ?? ?? ?? ?? C7 00 09 00 00 00 E9 8A 00 00 00 B8 7F 00 00 00 85 D2 0F 84 8E 00 00 00 8D 42 FF 83 F8 12 77 0E FF 24 85 ?? ?? ?? ?? B8 20 00 00 00 EB 78 E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 5A E8 ?? ?? ?? ?? 89 C3 8B 38 89 E0 50 56 E8 ?? ?? ?? ?? 5E 85 C0 5A 79 09 83 3B 26 75 3D 89 3B EB 32 8B 44 24 24 EB 44 31 C0 EB 40 89 E0 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 78 20 8B 44 24 10 25 00 F0 00 00 3D 00 80 00 00 74 1C 3D 00 60 00 00 75 09 EB 13 B8 FF 00 00 00 EB 11 83 C8 FF EB 0C B8 00 10 00 00 EB 05 B8 01 00 00 00 83 C4 58 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __ieee754_rem_pio2_0a501f6e2f0f254f993aa3f351fdf3ed {
	meta:
		aliases = "__ieee754_rem_pio2"
		size = "728"
		objfiles = "e_rem_pio2@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 60 DD 44 24 70 8B 74 24 78 DD 54 24 28 8B 7C 24 2C 89 FB 81 E3 FF FF FF 7F 81 FB FB 21 E9 3F 7F 15 DD 1E C7 46 08 00 00 00 00 C7 46 0C 00 00 00 00 E9 C9 01 00 00 DD D8 81 FB 7B D9 02 40 0F 8F 80 00 00 00 85 FF 7E 3F DD 44 24 70 DC 25 ?? ?? ?? ?? 81 FB FB 21 F9 3F 74 08 DD 05 ?? ?? ?? ?? EB 0E DD 05 ?? ?? ?? ?? DE E9 DD 05 ?? ?? ?? ?? D9 C1 D8 E1 DD 16 DE EA DE E9 DD 5E 08 B9 01 00 00 00 E9 43 02 00 00 DD 44 24 70 DC 05 ?? ?? ?? ?? 81 FB FB 21 F9 3F 74 08 DD 05 ?? ?? ?? ?? EB 0E DD 05 ?? ?? ?? ?? DE C1 DD 05 ?? ?? ?? ?? D9 C1 D8 C1 DD 16 DE EA DE C1 DD 5E 08 83 C9 FF E9 06 02 00 }
	condition:
		$pattern
}

rule __pthread_acquire_8d8fa5259c6fb5c8c40ab363f0f76bdd {
	meta:
		aliases = "__pthread_acquire"
		size = "71"
		objfiles = "spinlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 89 C3 83 EC 08 31 F6 89 E7 EB 28 83 FE 31 7F 08 E8 ?? ?? ?? ?? 46 EB 1B C7 04 24 00 00 00 00 C7 44 24 04 81 84 1E 00 31 F6 6A 00 57 E8 ?? ?? ?? ?? 58 5A B8 01 00 00 00 87 03 85 C0 75 CD 5A 59 5B 5E 5F C3 }
	condition:
		$pattern
}

rule marshal_new_auth_b6b1092782f881e0433cc53b228f7eb7 {
	meta:
		aliases = "marshal_new_auth"
		size = "118"
		objfiles = "auth_unix@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 89 C3 83 EC 18 8B 78 24 6A 00 68 90 01 00 00 8D 47 1C 50 8D 74 24 0C 56 E8 ?? ?? ?? ?? 53 56 E8 ?? ?? ?? ?? 83 C4 18 85 C0 74 10 8D 43 0C 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 75 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? EB 0E 56 8B 44 24 08 FF 50 10 89 87 AC 01 00 00 5F 8B 44 24 04 8B 50 1C 85 D2 74 06 89 E0 50 FF D2 5E 83 C4 18 B8 01 00 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule byte_alt_match_null_string_p_db8d67582858ab5774823dfc48b67dfa {
	meta:
		aliases = "byte_alt_match_null_string_p"
		size = "81"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 89 CE 83 EC 04 89 D3 EB 1C 80 39 0F 75 1C 8D 41 01 89 04 24 0F BE 40 01 0F B6 51 01 C1 E0 08 01 D0 8D 44 01 03 89 04 24 EB 13 89 F1 89 DA 89 E0 E8 ?? ?? ?? ?? 84 C0 75 04 31 C0 EB 0C 8B 0C 24 39 D9 72 C5 B8 01 00 00 00 59 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule trecurse_dfbd083c738311072b76ea608b392203 {
	meta:
		aliases = "trecurse"
		size = "91"
		objfiles = "twalk@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 89 D7 89 C3 89 CE 83 78 04 00 75 0B 83 78 08 00 75 05 51 6A 03 EB 37 56 6A 00 53 FF D7 8B 43 04 83 C4 0C 85 C0 74 0A 8D 4E 01 89 FA E8 CC FF FF FF 56 6A 01 53 FF D7 8B 43 08 83 C4 0C 85 C0 74 0A 8D 4E 01 89 FA E8 B2 FF FF FF 56 6A 02 53 FF D7 83 C4 0C 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule svctcp_recv_6f4b2e3a4b99f0d9088a6952a599d26a {
	meta:
		aliases = "svctcp_recv"
		size = "68"
		objfiles = "svc_tcp@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 44 24 10 8B 7C 24 14 8B 70 2C 8D 5E 08 C7 46 08 01 00 00 00 53 E8 ?? ?? ?? ?? 57 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 0C 8B 07 89 46 04 B8 01 00 00 00 EB 08 C7 06 00 00 00 00 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule svcunix_recv_f32ec56801fdf93f3ae064100b58a46a {
	meta:
		aliases = "svcunix_recv"
		size = "89"
		objfiles = "svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 44 24 10 8B 7C 24 14 8B 70 2C 8D 5E 08 C7 46 08 01 00 00 00 53 E8 ?? ?? ?? ?? 57 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 21 8B 07 89 46 04 B8 01 00 00 00 C7 47 24 01 00 00 00 C7 47 28 ?? ?? ?? ?? C7 47 2C 1C 00 00 00 EB 08 C7 06 00 00 00 00 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule tdelete_fce89815878e4c8605fdc604429bfcb6 {
	meta:
		aliases = "tdelete"
		size = "141"
		objfiles = "tdelete@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 44 24 14 8B 5C 24 10 85 C0 74 78 8B 38 89 C6 85 FF EB 0F 89 C7 7D 05 8D 70 04 EB 03 8D 70 08 83 3E 00 74 5F 8B 06 FF 30 53 FF 54 24 20 59 83 F8 00 5A 8B 06 75 DD 8B 58 04 8B 48 08 85 DB 74 0E 85 C9 74 31 8B 51 04 85 D2 75 0B 89 59 04 89 CB EB 23 89 C2 89 D9 8B 42 04 89 D3 85 C0 75 F3 8B 42 08 89 41 04 8B 06 8B 40 04 89 42 04 8B 06 8B 40 08 89 42 08 FF 36 E8 ?? ?? ?? ?? 89 1E 89 F8 5A EB 02 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule lfind_5c53dcd5ed447aa0b659ea34bbd13b72 {
	meta:
		aliases = "__GI_lfind, lfind"
		size = "51"
		objfiles = "lfind@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 44 24 18 8B 7C 24 10 8B 74 24 14 8B 18 EB 14 56 57 FF 54 24 28 5A 85 C0 59 75 04 89 F0 EB 0C 03 74 24 1C 4B 83 FB FF 75 E6 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule dlsym_c2880b284ec725ca845b865a2560161e {
	meta:
		aliases = "dlsym"
		size = "142"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 54 24 10 85 D2 75 08 8B 0D ?? ?? ?? ?? EB 58 89 D1 83 FA FF 74 26 3B 15 ?? ?? ?? ?? 74 49 A1 ?? ?? ?? ?? EB 07 39 D0 74 3E 8B 40 04 85 C0 75 F5 C7 05 ?? ?? ?? ?? 0A 00 00 00 EB 4A 8B 7C 24 0C A1 ?? ?? ?? ?? 31 F6 EB 1A 8B 18 8B 53 14 39 FA 73 0E 85 F6 74 05 39 56 14 73 05 8B 48 10 89 DE 8B 40 10 85 C0 75 E2 6A 00 6A 00 51 FF 74 24 20 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 0A C7 05 ?? ?? ?? ?? 0B 00 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule pthread_setspecific_df5e887b80b1b907d28aaba994f83f23 {
	meta:
		aliases = "pthread_setspecific"
		size = "97"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 5C 24 10 81 FB FF 03 00 00 77 49 83 3C DD ?? ?? ?? ?? 00 74 3F E8 ?? ?? ?? ?? 89 DE C1 EE 05 89 C7 83 7C B0 74 00 75 1A 6A 04 6A 20 E8 ?? ?? ?? ?? 59 89 C2 58 85 D2 B8 0C 00 00 00 74 1B 89 54 B7 74 83 E3 1F 8B 54 B7 74 8B 44 24 14 89 04 9A 31 C0 EB 05 B8 16 00 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule obstack_free_0de684b15392fa72261010cda13fc9d7 {
	meta:
		aliases = "obstack_free"
		size = "93"
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 5C 24 10 8B 74 24 14 8B 53 04 EB 20 8B 7A 04 F6 43 28 01 8B 43 20 74 0A 52 FF 73 24 FF D0 58 5A EB 04 52 FF D0 59 80 4B 28 02 89 FA 85 D2 74 1C 39 F2 73 D8 39 32 72 D4 85 D2 74 10 89 73 0C 89 73 08 8B 02 89 53 04 89 43 10 EB 09 85 F6 74 05 E8 ?? ?? ?? ?? 5B 5E 5F C3 }
	condition:
		$pattern
}

rule wcstok_aa8841102ba72d8d415cccab2bde50cb {
	meta:
		aliases = "wcstok"
		size = "78"
		objfiles = "wcstok@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 5C 24 10 8B 74 24 14 8B 7C 24 18 85 DB 75 06 8B 1F 85 DB 74 2F 56 53 E8 ?? ?? ?? ?? 5A 59 8D 1C 83 83 3B 00 75 06 31 DB 31 C0 EB 16 56 53 E8 ?? ?? ?? ?? 5A 85 C0 59 74 09 C7 00 00 00 00 00 83 C0 04 89 07 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_strtok_r_f64060c5e96da715c7ae0969c70efc72 {
	meta:
		aliases = "strtok_r, __GI_strtok_r"
		size = "80"
		objfiles = "strtok_r@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 5C 24 10 8B 7C 24 14 8B 74 24 18 85 DB 75 02 8B 1E 57 53 E8 ?? ?? ?? ?? 59 01 C3 5A 80 3B 00 75 06 31 C0 89 1E EB 21 57 53 E8 ?? ?? ?? ?? 5F 85 C0 5A 75 0C 6A 00 53 E8 ?? ?? ?? ?? 5A 59 EB 04 C6 00 00 40 89 06 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule mknod_cfab4a13fb1e7ec85ad45e05710918bf {
	meta:
		aliases = "__GI_mknod, mknod"
		size = "54"
		objfiles = "mknod@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 5C 24 18 8B 7C 24 10 8B 4C 24 14 89 DA 53 89 FB B8 0E 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __encode_question_f31342f8c875366f7070422915fa7603 {
	meta:
		aliases = "__encode_question"
		size = "82"
		objfiles = "encodeq@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 10 8B 7C 24 14 8B 5C 24 18 53 57 FF 36 E8 ?? ?? ?? ?? 83 C4 0C 89 C1 85 C0 78 2B 29 C3 83 FB 03 7F 05 83 C9 FF EB 1F 8D 14 07 83 C1 04 0F B6 46 05 88 02 8B 46 04 88 42 01 0F B6 46 09 88 42 02 8B 46 08 88 42 03 89 C8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule wcscasecmp_d85cc9ad3b31747a80976d7629784c68 {
	meta:
		aliases = "__GI_wcscasecmp, wcscasecmp"
		size = "84"
		objfiles = "wcscasecmp@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 10 8B 7C 24 14 EB 0F 83 3E 00 75 04 31 C0 EB 3A 83 C6 04 83 C7 04 8B 06 3B 07 74 EB 50 E8 ?? ?? ?? ?? FF 37 89 C3 E8 ?? ?? ?? ?? 5A 39 C3 59 74 D6 FF 36 E8 ?? ?? ?? ?? FF 37 89 C3 E8 ?? ?? ?? ?? 39 C3 5A 19 C0 59 83 C8 01 5B 5E 5F C3 }
	condition:
		$pattern
}

rule sched_getaffinity_85008180f01c79ead6eef1ec42271641 {
	meta:
		aliases = "sched_getaffinity"
		size = "94"
		objfiles = "sched_getaffinity@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 14 8B 7C 24 10 89 F1 85 F6 79 05 B9 FF FF FF 7F 8B 54 24 18 53 89 FB B8 F2 00 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF EB 1E 83 C8 FF 83 FB FF 74 16 29 DE 56 6A 00 8B 44 24 20 01 D8 50 E8 ?? ?? ?? ?? 31 C0 83 C4 0C 5B 5E 5F C3 }
	condition:
		$pattern
}

rule _dl_add_elf_hash_table_0298053d42eb8f8f10953cfd88e91b0b {
	meta:
		aliases = "_dl_add_elf_hash_table"
		size = "169"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 14 8B 7C 24 18 68 E8 00 00 00 E8 ?? ?? ?? ?? BA E8 00 00 00 89 C3 59 EB 04 C6 00 00 40 4A 83 FA FF 75 F6 A1 ?? ?? ?? ?? 85 C0 75 0A 89 1D ?? ?? ?? ?? EB 0F 89 D0 8B 50 0C 85 D2 75 F7 89 58 0C 89 43 10 FF 74 24 10 C7 43 0C 00 00 00 00 66 C7 43 22 00 00 E8 ?? ?? ?? ?? C7 43 18 03 00 00 00 89 43 04 8B 44 24 20 89 43 08 58 8B 4F 10 85 C9 74 17 8B 01 89 43 28 8B 51 04 89 53 38 8D 51 08 89 53 2C 8D 04 82 89 43 3C 89 33 89 73 14 31 D2 8B 04 97 89 44 93 40 42 83 FA 22 7E F3 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule _obstack_begin_549c90c93bdce48f38432b3b1bdcecec {
	meta:
		aliases = "_obstack_begin"
		size = "135"
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 18 8B 5C 24 10 8B 54 24 14 8B 4C 24 1C 85 F6 75 04 66 BE 04 00 85 D2 75 04 66 BA E0 0F 89 4B 1C 8D 7E FF 8B 44 24 20 89 13 80 63 28 FE 89 43 20 89 7B 18 F6 43 28 01 74 0B 52 FF 73 24 FF D1 59 89 C2 EB 05 52 FF D1 89 C2 58 85 D2 89 53 04 75 05 E8 ?? ?? ?? ?? 8D 44 3A 08 F7 DE 21 F0 89 43 08 89 43 0C 89 D0 03 03 89 02 89 43 10 C7 42 04 00 00 00 00 B8 01 00 00 00 80 63 28 F9 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_fwrite_unlocked_31ebd11ab334e5a6408be9b588567d54 {
	meta:
		aliases = "fwrite_unlocked, __GI_fwrite_unlocked"
		size = "110"
		objfiles = "fwrite_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 1C 8B 7C 24 14 8B 5C 24 18 0F B7 06 25 C0 00 00 00 3D C0 00 00 00 74 11 68 80 00 00 00 56 E8 ?? ?? ?? ?? 5A 85 C0 59 75 39 85 FF 74 35 85 DB 74 31 83 C8 FF 31 D2 F7 F7 39 C3 77 17 0F AF DF 56 53 FF 74 24 18 E8 ?? ?? ?? ?? 31 D2 F7 F7 83 C4 0C EB 11 66 83 0E 08 E8 ?? ?? ?? ?? C7 00 16 00 00 00 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_getrpcbyname_3658af6c283afbb5106a0a2db2d4439c {
	meta:
		aliases = "getrpcbyname, __GI_getrpcbyname"
		size = "80"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 7C 24 10 6A 00 E8 ?? ?? ?? ?? 5E EB 29 57 FF 36 E8 ?? ?? ?? ?? 59 85 C0 5B 74 2B 8B 5E 04 EB 10 57 50 E8 ?? ?? ?? ?? 59 85 C0 5A 74 19 83 C3 04 8B 03 85 C0 75 EA E8 ?? ?? ?? ?? 89 C6 85 C0 75 CC E8 ?? ?? ?? ?? 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule strndup_6d589c13153fd3a2261cf42cfa9029a0 {
	meta:
		aliases = "__GI_strndup, strndup"
		size = "58"
		objfiles = "strndup@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 7C 24 10 FF 74 24 14 57 E8 ?? ?? ?? ?? 5A 89 C6 59 8D 40 01 50 E8 ?? ?? ?? ?? 89 C3 58 85 DB 74 0F 56 57 53 E8 ?? ?? ?? ?? C6 04 33 00 83 C4 0C 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pthread_mutex_timedlock_3d236a556ea494dc22d5418762334c4b {
	meta:
		aliases = "pthread_mutex_timedlock"
		size = "191"
		objfiles = "mutex@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 7C 24 14 8B 74 24 10 81 7F 04 FF C9 9A 3B 0F 87 9C 00 00 00 8B 46 0C 83 F8 01 74 23 7F 09 85 C0 74 11 E9 89 00 00 00 83 F8 02 74 3C 83 F8 03 75 7F EB 64 8D 46 10 31 D2 E8 ?? ?? ?? ?? EB 25 E8 ?? ?? ?? ?? 89 C3 39 46 08 75 05 FF 46 04 EB 14 8D 46 10 89 DA E8 ?? ?? ?? ?? 89 5E 08 C7 46 04 00 00 00 00 31 D2 EB 4D E8 ?? ?? ?? ?? BA 23 00 00 00 89 C3 39 46 08 74 3C 57 50 8D 46 10 50 E8 ?? ?? ?? ?? 83 C4 0C BA 6E 00 00 00 85 C0 74 25 30 D2 89 5E 08 EB 1E 8D 46 10 57 6A 00 50 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 01 19 D2 83 E2 6E EB 05 BA 16 00 00 00 89 D0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule ___path_search_58bceebf91afd7c782e8858ea5509a58 {
	meta:
		aliases = "___path_search"
		size = "188"
		objfiles = "tempname@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 7C 24 1C 8B 5C 24 18 85 FF 74 1A 80 3F 00 74 15 57 E8 ?? ?? ?? ?? 59 89 C6 83 F8 05 76 11 BE 05 00 00 00 EB 0A BF ?? ?? ?? ?? BE 04 00 00 00 85 DB 75 38 B8 ?? ?? ?? ?? BB ?? ?? ?? ?? E8 ?? ?? ?? ?? 85 C0 75 25 53 53 E8 ?? ?? ?? ?? 59 85 C0 5A 74 0B 89 D8 E8 ?? ?? ?? ?? 85 C0 75 0D E8 ?? ?? ?? ?? C7 00 02 00 00 00 EB 2D 53 E8 ?? ?? ?? ?? 5A 89 C2 EB 01 4A 83 FA 01 76 07 80 7C 1A FF 2F 74 F3 8D 44 16 08 39 44 24 14 73 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 17 57 56 53 52 68 ?? ?? ?? ?? FF 74 24 24 E8 ?? ?? ?? ?? 31 C0 83 C4 18 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_wctype_d5dd38db712d7423b6dd21670a2bcc31 {
	meta:
		aliases = "wctrans, __GI_wctrans, wctype, __GI_wctype"
		size = "58"
		objfiles = "wctype@libc.a, wctrans@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 B8 ?? ?? ?? ?? 8B 7C 24 10 BE 01 00 00 00 8D 58 01 53 57 E8 ?? ?? ?? ?? 5A 85 C0 59 75 04 89 F0 EB 11 0F B6 43 FF 8D 04 03 80 38 00 74 03 46 EB DD 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pthread_rwlock_tryrdlock_c2d34acac974f4e2e0f8f85bdc51c36f {
	meta:
		aliases = "pthread_rwlock_tryrdlock"
		size = "128"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 BE 10 00 00 00 83 EC 0C E8 ?? ?? ?? ?? 89 E2 8B 5C 24 1C 8D 4C 24 04 89 44 24 08 8D 44 24 08 52 89 DA E8 ?? ?? ?? ?? 8B 54 24 0C 89 C7 89 D8 E8 ?? ?? ?? ?? 31 D2 89 D8 E8 ?? ?? ?? ?? 5A 85 C0 74 06 66 31 F6 FF 43 08 53 E8 ?? ?? ?? ?? 58 85 F6 75 21 85 FF 75 06 83 3C 24 00 74 17 8B 44 24 04 85 C0 74 05 FF 40 08 EB 0A 8B 44 24 08 FF 80 50 01 00 00 83 C4 0C 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pmap_rmtcall_ef34cdcd29d3b74f3978fd6a9b75573e {
	meta:
		aliases = "pmap_rmtcall"
		size = "193"
		objfiles = "pmap_rmt@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 BE 10 00 00 00 83 EC 2C 8B 7C 24 3C 8D 44 24 28 C7 44 24 28 FF FF FF FF 66 C7 47 02 00 6F 50 FF 35 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 6A 02 68 A0 86 01 00 57 E8 ?? ?? ?? ?? 83 C4 18 89 C3 85 C0 74 6E 8B 44 24 40 89 E2 89 04 24 8B 44 24 44 89 44 24 04 8B 44 24 48 89 44 24 08 8B 44 24 50 89 44 24 10 8B 44 24 4C 89 44 24 14 8B 44 24 64 89 44 24 18 8B 44 24 58 89 44 24 20 8B 44 24 54 89 44 24 24 8D 44 24 18 8B 4B 04 FF 74 24 60 FF 74 24 60 50 68 ?? ?? ?? ?? 52 68 ?? ?? ?? ?? 6A 05 53 FF 11 83 C4 20 89 C6 8B 43 04 53 FF 50 10 5B 66 C7 47 02 00 00 89 F0 83 C4 2C 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pthread_rwlock_wrlock_58703977d030b6213e7fd34c4f0162b6 {
	meta:
		aliases = "pthread_rwlock_wrlock"
		size = "79"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 E8 ?? ?? ?? ?? 8B 5C 24 10 89 C6 8D 7B 14 89 F2 89 D8 E8 ?? ?? ?? ?? 83 7B 08 00 75 06 83 7B 0C 00 74 19 89 F2 89 F8 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 58 EB D2 89 73 0C 53 E8 ?? ?? ?? ?? 58 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule remove_4b1c7930347cb901867647a027b6a839 {
	meta:
		aliases = "__GI_remove, remove"
		size = "50"
		objfiles = "remove@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 E8 ?? ?? ?? ?? 8B 74 24 10 89 C3 8B 38 56 E8 ?? ?? ?? ?? 5A 85 C0 79 13 83 3B 14 75 0E 89 3B 89 74 24 10 5B 5E 5F E9 ?? ?? ?? ?? 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __pthread_perform_cleanup_cc919ec2439b0f0b13598ab26f5c021d {
	meta:
		aliases = "__pthread_perform_cleanup"
		size = "57"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 E8 ?? ?? ?? ?? 8B 7C 24 10 89 C6 8B 58 3C EB 0D 39 FB 76 0D FF 73 04 FF 13 8B 5B 0C 58 85 DB 75 EF 83 BE FC 00 00 00 00 74 08 5B 5E 5F E9 ?? ?? ?? ?? 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_strcat_638374c7e7fd7e837e293e891f9c4740 {
	meta:
...
rule strsignal_fe76676d1c6de30c56a1b072f0e743d6 {
	meta:
		aliases = "__GI_strsignal, strsignal"
		size = "81"
		objfiles = "strsignal@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 44 24 10 83 F8 1F 77 19 89 C1 BA ?? ?? ?? ?? EB 07 80 3A 01 83 D9 00 42 85 C9 75 F5 80 3A 00 75 24 99 6A 00 6A F6 52 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? BE ?? ?? ?? ?? 8D 50 F1 89 D7 A5 A5 A5 66 A5 A4 83 C4 14 89 D0 5A 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_memcpy_7e17e93cc22d2a5a48c31157460b23f5 {
	meta:
		aliases = "memcpy, __GI_memcpy"
		size = "41"
		objfiles = "memcpy@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 44 24 18 8B 74 24 14 89 C1 8B 7C 24 10 C1 E9 02 F3 A5 89 C1 83 E1 03 74 02 F3 A4 8B 44 24 10 5A 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_seed48_r_629b738ca68fd17473fcbd8fc31eebb5 {
	meta:
		aliases = "seed48_r, __GI_seed48_r"
		size = "75"
		objfiles = "seed48_r@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 4C 24 14 8B 54 24 10 89 CE 8D 79 06 A5 66 A5 66 8B 42 04 66 89 41 04 66 8B 42 02 66 89 41 02 66 8B 02 C7 41 10 6D E6 EC DE 66 89 01 C7 41 14 05 00 00 00 66 C7 41 0C 0B 00 66 C7 41 0E 01 00 31 C0 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule mq_open_2d6417c0945ba9b771c4152cc589ac05 {
	meta:
		aliases = "mq_open"
		size = "95"
		objfiles = "mq_open@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 7C 24 10 8B 4C 24 14 80 3F 2F 74 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 39 F6 C1 40 75 06 31 D2 31 F6 EB 0F 8D 44 24 20 8B 54 24 18 89 04 24 8B 74 24 1C 47 53 89 FB B8 15 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 5E 5F C3 }
	condition:
		$pattern
}

rule mknodat_52822dafa69fc665fa6ab0ae18558912 {
	meta:
		aliases = "__GI_mknodat, mknodat"
		size = "72"
		objfiles = "mknodat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 08 8B 44 24 20 8B 7C 24 14 8B 4C 24 18 89 04 24 C7 44 24 04 00 00 00 00 8B 54 24 1C 89 C6 53 89 FB B8 29 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_ppoll_b20fb00bf62d9361ae8b54372ebca169 {
	meta:
...
rule tmpnam_86575eb7d3d428ddcfb54c35ad75fc10 {
	meta:
		aliases = "tmpnam"
		size = "81"
		objfiles = "tmpnam@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 14 8B 7C 24 20 89 FE 85 FF 75 02 89 E6 6A 00 6A 00 6A 14 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 23 6A 03 56 E8 ?? ?? ?? ?? 5A 85 C0 59 75 15 85 FF 75 13 BF ?? ?? ?? ?? A5 A5 A5 A5 A5 BF ?? ?? ?? ?? EB 02 31 FF 89 F8 83 C4 14 5E 5F C3 }
	condition:
		$pattern
}

rule sigaction_8e9aa0c9dcdfe59bad990e54a7c9a7b5 {
	meta:
		aliases = "__GI_sigaction, __libc_sigaction, sigaction"
		size = "80"
		objfiles = "sigaction@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 18 31 C0 8B 54 24 28 85 D2 74 2B 8D 7C 24 04 89 D6 A5 A5 A5 A5 A5 81 4C 24 08 00 00 00 04 B8 ?? ?? ?? ?? F6 42 04 04 75 05 B8 ?? ?? ?? ?? 89 44 24 0C 8D 44 24 04 6A 08 FF 74 24 30 50 FF 74 24 30 E8 ?? ?? ?? ?? 83 C4 28 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_tcgetattr_a88b3a6f4fd050e14e751d1e5f32aa9d {
	meta:
		aliases = "tcgetattr, __GI_tcgetattr"
		size = "96"
		objfiles = "tcgetattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 24 89 E0 8B 7C 24 34 50 68 01 54 00 00 FF 74 24 38 E8 ?? ?? ?? ?? 83 C4 0C 89 C2 85 C0 75 35 8B 04 24 8D 74 24 11 89 07 8B 44 24 04 89 47 04 8B 44 24 08 89 47 08 8B 44 24 0C 89 47 0C 8A 44 24 10 88 47 10 83 C7 11 A5 A5 A5 A5 66 A5 A4 89 D0 AB AB AB AA 83 C4 24 89 D0 5E 5F C3 }
	condition:
		$pattern
}

rule fstatfs64_71a940087961497d2f01b916abc6b153 {
	meta:
		aliases = "__GI_fstatfs64, __GI_statfs64, statfs64, fstatfs64"
		size = "155"
		objfiles = "statfs64@libc.a, fstatfs64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 40 89 E0 8B 7C 24 50 50 FF 74 24 50 E8 ?? ?? ?? ?? 5A 83 CA FF 59 85 C0 78 75 8B 04 24 8D 74 24 2C 89 07 8B 44 24 04 89 47 04 8B 44 24 08 C7 47 0C 00 00 00 00 89 47 08 8B 44 24 0C C7 47 14 00 00 00 00 89 47 10 8B 44 24 10 C7 47 1C 00 00 00 00 89 47 18 8B 44 24 14 C7 47 24 00 00 00 00 89 47 20 8B 44 24 18 C7 47 2C 00 00 00 00 89 47 28 8B 44 24 20 89 47 34 8B 44 24 1C 89 47 30 8B 44 24 24 89 47 38 83 C7 40 A5 A5 A5 A5 A5 31 D2 83 C4 40 89 D0 5E 5F C3 }
	condition:
		$pattern
}

rule fstatat64_88c6980b6e300b0b3908083052291886 {
	meta:
		aliases = "fstatat, fstatat64"
		size = "77"
		objfiles = "fstatat@libc.a, fstatat64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 60 89 E2 8B 7C 24 6C 8B 4C 24 70 8B 74 24 78 53 89 FB B8 2C 01 00 00 CD 80 5B 89 C6 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DE 89 30 83 CE FF EB 10 85 C0 75 0C FF 74 24 74 52 E8 ?? ?? ?? ?? 58 5A 89 F0 83 C4 60 5E 5F C3 }
	condition:
		$pattern
}

rule pthread_kill_all_threads_90e1adfd5569b10a7f5ac78a1df3260d {
	meta:
		aliases = "pthread_kill_all_threads"
		size = "56"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 89 C6 A1 ?? ?? ?? ?? 53 89 D7 8B 18 EB 0D 56 FF 73 14 E8 ?? ?? ?? ?? 58 8B 1B 5A 3B 1D ?? ?? ?? ?? 75 EB 85 FF 74 0B 56 FF 73 14 E8 ?? ?? ?? ?? 59 5B 5B 5E 5F C3 }
	condition:
		$pattern
}

rule timer_settime_f82a72b0b04bc04f2c5ca39a9786268e {
	meta:
		aliases = "timer_settime"
		size = "57"
		objfiles = "timer_settime@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 44 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 8B 78 04 53 89 FB B8 04 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}
...
rule sigprocmask_c2d1fdd73b1d57f6658cbc01e97fcb50 {
	meta:
		aliases = "__GI_sigprocmask, sigprocmask"
		size = "77"
		objfiles = "sigprocmask@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 4C 24 10 8B 7C 24 0C 8B 54 24 14 85 C9 74 12 83 FF 02 76 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 23 BE 08 00 00 00 53 89 FB B8 AF 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}
...
rule epoll_wait_07f0cee9f98f0b71a28f2db2951b4c8f {
	meta:
		aliases = "epoll_wait"
		size = "54"
		objfiles = "epoll@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 00 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule openat_126f7625db5a8ce4cff4a5699bd944c1 {
	meta:
		aliases = "__GI_openat, openat"
		size = "54"
		objfiles = "openat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 27 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule renameat_fa0c7945a1d4fbf814d33ab1a49d49bf {
	meta:
		aliases = "renameat"
		size = "54"
		objfiles = "renameat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 2E 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule readlinkat_aeff3df3cb3096c360b0dcd79c58c82b {
	meta:
		aliases = "readlinkat"
		size = "54"
		objfiles = "readlinkat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 31 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule fchmodat_144e6c9bd513067c35bb95fd42141952 {
	meta:
		aliases = "fchmodat"
		size = "54"
		objfiles = "fchmodat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 32 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule faccessat_46da28a16c5e1338a3d657c718f7ad2a {
	meta:
		aliases = "faccessat"
		size = "54"
		objfiles = "faccessat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 33 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule tee_ad12d55892f84dc0e41a70f537fde731 {
	meta:
		aliases = "tee"
		size = "54"
		objfiles = "tee@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 3B 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule vmsplice_fde1aaed5307bc2aeb89e5337337b606 {
	meta:
		aliases = "vmsplice"
		size = "54"
		objfiles = "vmsplice@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 3C 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule utimensat_b8485a6d8dce40376003051f2dda8a97 {
	meta:
		aliases = "__GI_utimensat, utimensat"
		size = "54"
		objfiles = "utimensat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 40 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule timerfd_settime_fdfd12bf8c47c77b4b9f0a8de187ecb8 {
	meta:
		aliases = "timerfd_settime"
		size = "54"
		objfiles = "timerfd@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 45 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_wait4_02c2b346102ba7a4ed0c91c943c0668b {
	meta:
		aliases = "wait4, __GI_wait4"
		size = "54"
		objfiles = "wait4@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 72 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule quotactl_c41eb2993a7bd86c00142deaf5554fae {
	meta:
		aliases = "quotactl"
		size = "54"
		objfiles = "quotactl@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 83 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule __syscall_rt_sigaction_37faaf17674ed6b921695888134e1480 {
	meta:
		aliases = "__syscall_rt_sigaction"
		size = "54"
		objfiles = "__syscall_rt_sigaction@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 AE 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule sendfile_d3ad3c33f99b0d46c7ac1c9ffc2b1bc9 {
	meta:
		aliases = "sendfile"
		size = "54"
		objfiles = "sendfile@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 BB 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule getxattr_617bd409405e3f304315309d11635255 {
	meta:
		aliases = "getxattr"
		size = "54"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 E5 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule lgetxattr_867cd73b3f71c666232f5f5557864128 {
	meta:
		aliases = "lgetxattr"
		size = "54"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 E6 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule fgetxattr_bffafb8dc713d6b09aabb0b6af08aed6 {
	meta:
		aliases = "fgetxattr"
		size = "54"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 E7 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule sendfile64_688f8f53de70b3c4ee1acfe43b325399 {
	meta:
		aliases = "sendfile64"
		size = "54"
		objfiles = "sendfile64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 EF 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule epoll_ctl_0ced9df06a8a52efb7a388a9d09f6b29 {
	meta:
		aliases = "epoll_ctl"
		size = "54"
		objfiles = "epoll@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 53 89 FB B8 FF 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}

rule signalfd_9e0790d9528f20367ca02329778e73bd {
	meta:
		aliases = "signalfd"
		size = "55"
		objfiles = "signalfd@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 0C 8B 4C 24 10 8B 74 24 14 BA 08 00 00 00 53 89 FB B8 47 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5F C3 }
	condition:
		$pattern
}
...
rule confstr_73d298354f19b89dfe5610bb20574beb {
	meta:
		aliases = "confstr"
		size = "95"
		objfiles = "confstr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 7C 24 10 8B 74 24 14 83 7C 24 0C 00 75 0A 85 F6 74 24 85 FF 75 11 EB 1E E8 ?? ?? ?? ?? C7 00 16 00 00 00 31 C0 EB 32 83 FE 0D 76 11 BE ?? ?? ?? ?? A5 A5 A5 66 A5 B8 0E 00 00 00 EB 1C 8D 46 FF 50 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? C6 44 37 FF 00 B8 0E 00 00 00 83 C4 0C 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_ioctl_772bdadb03466d205485db38dd9ac571 {
	meta:
		aliases = "ioctl, __GI_ioctl"
		size = "59"
		objfiles = "ioctl@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 EC 04 8D 44 24 18 8B 7C 24 0C 8B 4C 24 10 89 04 24 8B 54 24 14 53 89 FB B8 36 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 5F C3 }
	condition:
		$pattern
}

rule __GI_fcntl64_e3e911159ea6261a77faa33752377e1b {
	meta:
		aliases = "fcntl64, __GI_fcntl64"
		size = "59"
		objfiles = "__syscall_fcntl64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 EC 04 8D 44 24 18 8B 7C 24 0C 8B 4C 24 10 89 04 24 8B 54 24 14 53 89 FB B8 DD 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 5F C3 }
	condition:
		$pattern
}

rule sysctl_1f1bd80ab8cc7633153c934a9400b7ef {
	meta:
		aliases = "sysctl"
		size = "91"
		objfiles = "sysctl@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 EC 28 89 E7 8B 44 24 30 89 04 24 8B 44 24 34 89 44 24 04 8B 44 24 38 89 44 24 08 8B 44 24 3C 89 44 24 0C 8B 44 24 40 89 44 24 10 8B 44 24 44 89 44 24 14 53 89 FB B8 95 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 83 C4 28 5F C3 }
	condition:
		$pattern
}
...
rule fd_to_DIR_3bd5b6c1e6f39935274e223f4405342b {
	meta:
		aliases = "fd_to_DIR"
		size = "113"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 89 C7 56 89 D6 53 6A 30 E8 ?? ?? ?? ?? 31 DB 5A 85 C0 74 56 89 C3 89 38 C7 40 10 00 00 00 00 C7 40 08 00 00 00 00 C7 40 04 00 00 00 00 89 70 14 81 FE FF 01 00 00 77 07 C7 40 14 00 02 00 00 FF 73 14 6A 01 E8 ?? ?? ?? ?? 89 43 0C 85 C0 5E 5F 75 0B 53 E8 ?? ?? ?? ?? 31 DB 59 EB 0D 8D 43 18 6A 00 50 E8 ?? ?? ?? ?? 58 5A 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __get_next_rpcent_5b83374aa66505ca50962eefdfc1d5ee {
	meta:
		aliases = "__get_next_rpcent"
		size = "239"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 89 C7 56 8D B0 A8 00 00 00 53 FF 37 68 00 10 00 00 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 0F 84 C8 00 00 00 56 E8 ?? ?? ?? ?? 5A C6 84 07 A7 00 00 00 0A 80 BF A8 00 00 00 23 74 D0 6A 23 56 E8 ?? ?? ?? ?? 5A 85 C0 59 75 0E 6A 0A 56 E8 ?? ?? ?? ?? 59 85 C0 5B 74 B4 C6 00 00 89 F0 E8 ?? ?? ?? ?? 85 C0 74 A6 8D 58 01 C6 00 00 89 B7 9C 00 00 00 EB 01 43 8A 03 3C 20 74 F9 3C 09 74 F5 53 E8 ?? ?? ?? ?? 8D 77 10 89 87 A4 00 00 00 89 B7 A0 00 00 00 89 D8 5A E8 ?? ?? ?? ?? 31 C9 85 C0 74 2E 8D 48 01 C6 00 00 EB 26 80 FA 20 74 1E 80 FA 09 74 19 39 DE 73 05 89 0E 83 C6 04 89 C8 E8 ?? ?? ?? ?? 89 C1 85 C0 74 }
	condition:
		$pattern
}

rule mq_unlink_2494e9a5038e8048d7cd9a30f6c1ace0 {
	meta:
		aliases = "mq_unlink"
		size = "82"
		objfiles = "mq_unlink@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 44 24 08 80 38 2F 74 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 36 8D 78 01 53 89 FB B8 16 01 00 00 CD 80 5B 89 C7 3D 00 F0 FF FF 76 0B E8 ?? ?? ?? ?? F7 DF 89 38 EB 04 85 C0 79 13 E8 ?? ?? ?? ?? 8B 10 83 FA 01 75 02 B2 0D 89 10 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule timer_getoverrun_02be8ec198a4c945d8ee8f285acb1307 {
	meta:
		aliases = "timer_getoverrun"
		size = "43"
		objfiles = "timer_getoverr@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 44 24 08 8B 78 04 53 89 FB B8 06 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule timer_delete_7e956a95ffadd3f50b33d7a380db6c28 {
	meta:
		aliases = "timer_delete"
		size = "60"
		objfiles = "timer_delete@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 54 24 08 8B 7A 04 53 89 FB B8 07 01 00 00 CD 80 5B 89 C7 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF EB 10 83 C8 FF 85 FF 75 09 52 E8 ?? ?? ?? ?? 31 C0 5A 5F C3 }
	condition:
		$pattern
}

rule close_a02017293cde43f33c14807fe58a266e {
	meta:
		aliases = "__GI_close, __libc_close, close"
		size = "40"
		objfiles = "close@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 06 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule unlink_07b29183d9319d402b3ca14df5ce5d0a {
	meta:
		aliases = "__GI_unlink, unlink"
		size = "40"
		objfiles = "unlink@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 0A 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule chdir_6baf44e630e0ddf5434b8850daa3a0f9 {
	meta:
		aliases = "__GI_chdir, chdir"
		size = "40"
		objfiles = "chdir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 0C 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule time_6500d57f69358fe03fd58517ed4a966e {
	meta:
		aliases = "__GI_time, time"
		size = "18"
		objfiles = "time@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 0D 00 00 00 CD 80 5B 5F C3 }
	condition:
		$pattern
}

rule umount_22584c1acb96440ee5d953f78a104b14 {
	meta:
		aliases = "umount"
		size = "40"
		objfiles = "umount@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 16 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule stime_9a79a042879228d8463c319013d5b08c {
	meta:
		aliases = "stime"
		size = "40"
		objfiles = "stime@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 19 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule alarm_a3c502f6052e2dbdcaef346d7e266354 {
	meta:
		aliases = "__GI_alarm, alarm"
		size = "40"
		objfiles = "alarm@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 1B 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule nice_056e5699b00eb81111dfe262125dc7c0 {
	meta:
		aliases = "nice"
		size = "59"
		objfiles = "nice@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 22 00 00 00 CD 80 5B 89 C7 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF EB 12 83 C8 FF 85 FF 75 0B 6A 00 6A 00 E8 ?? ?? ?? ?? 5A 59 5F C3 }
	condition:
		$pattern
}

rule rmdir_05f0d8dab89e7af22beee70ab5216c68 {
	meta:
		aliases = "__GI_rmdir, rmdir"
		size = "40"
		objfiles = "rmdir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 28 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule dup_832df3d62ff0d57189c13375a2b28733 {
	meta:
		aliases = "dup"
		size = "40"
		objfiles = "dup@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 29 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule __GI_pipe_ea0d78bc9535ed8c58158c688241ac41 {
	meta:
		aliases = "pipe, __GI_pipe"
		size = "40"
		objfiles = "pipe@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 2A 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule __GI_times_c7e77f149bb18b44ad7b40b84eaacc32 {
	meta:
		aliases = "times, __GI_times"
		size = "18"
		objfiles = "times@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 2B 00 00 00 CD 80 5B 5F C3 }
	condition:
		$pattern
}

rule acct_ae14bdfff36c6d3a3d8884c0bd28a636 {
	meta:
		aliases = "acct"
		size = "40"
		objfiles = "acct@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 33 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule umask_cb8b2da9c05c004bac09c26fbf097054 {
	meta:
		aliases = "umask"
		size = "43"
		objfiles = "umask@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 3C 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 0F B7 C0 5F C3 }
	condition:
		$pattern
}

rule chroot_e36022416d608ce68ca86a9ff7015c36 {
	meta:
		aliases = "chroot"
		size = "40"
		objfiles = "chroot@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 3D 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule iopl_84f0ea56dcebcf9c7591076f748b1137 {
	meta:
		aliases = "iopl"
		size = "40"
		objfiles = "iopl@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 6E 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule swapoff_b0d3c818a98d4323de1c07dcf452eae1 {
	meta:
		aliases = "swapoff"
		size = "40"
		objfiles = "swapoff@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 73 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule sysinfo_ffab5fab28b01a22211550ae5f35fd9a {
	meta:
		aliases = "sysinfo"
		size = "40"
		objfiles = "sysinfo@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 74 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule fsync_892ff4531ae8e4a3d205a6e8559bffe7 {
	meta:
		aliases = "__libc_fsync, fsync"
		size = "40"
		objfiles = "fsync@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 76 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule uname_d9dd5f18cbbed57baff285fd2025c325 {
	meta:
		aliases = "__GI_uname, uname"
		size = "40"
		objfiles = "uname@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 7A 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule ntp_adjtime_28efa0c61e56db2e2509b0639b7e498a {
	meta:
		aliases = "__GI_adjtimex, adjtimex, ntp_adjtime"
		size = "40"
		objfiles = "adjtimex@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 7C 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule getpgid_2cfad3b1f75654f82b73f33de9f1401d {
	meta:
		aliases = "getpgid"
		size = "40"
		objfiles = "getpgid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 84 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule fchdir_51d3fd19259c5eaa616029dded24645c {
	meta:
		aliases = "__GI_fchdir, fchdir"
		size = "40"
		objfiles = "fchdir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 85 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule personality_a70f24170e4d5472609bb04e28c229c7 {
	meta:
		aliases = "personality"
		size = "40"
		objfiles = "personality@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 88 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule getsid_265c5cb67e6badb4b1bcf641067bca08 {
	meta:
		aliases = "__GI_getsid, getsid"
		size = "40"
		objfiles = "getsid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 93 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule fdatasync_9adf0e402276b1f0ee3290906fa71c29 {
	meta:
		aliases = "fdatasync"
		size = "40"
		objfiles = "fdatasync@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 94 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule mlockall_1ff5959577f09362741b6fa8a5beb543 {
	meta:
		aliases = "mlockall"
		size = "40"
		objfiles = "mlockall@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 98 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule sched_getscheduler_3e53f82ab3e5adb8cbba8647f76eca3b {
	meta:
		aliases = "sched_getscheduler"
		size = "40"
		objfiles = "sched_getscheduler@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 9D 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule sched_get_priority_max_ae2a7b4fa08d705e5561ab28abd35400 {
	meta:
		aliases = "sched_get_priority_max"
		size = "40"
		objfiles = "sched_get_priority_max@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 9F 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule sched_get_priority_min_759b3af9bd179ae4fa3fb636a214714f {
	meta:
		aliases = "sched_get_priority_min"
		size = "40"
		objfiles = "sched_get_priority_min@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 A0 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule setuid_e074597ba009b2d1d1a2d30cff82ed13 {
	meta:
		aliases = "setuid"
		size = "40"
		objfiles = "setuid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 D5 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule setgid_1ed51dd16ab30e5108c6ded56b8b70c2 {
	meta:
		aliases = "setgid"
		size = "40"
		objfiles = "setgid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 D6 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule setfsuid_a98932f08c04f0620bc1c4512082ac98 {
	meta:
		aliases = "setfsuid"
		size = "40"
		objfiles = "setfsuid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 D7 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule setfsgid_a239241b6c189e8c9757a39025fa28c1 {
	meta:
		aliases = "setfsgid"
		size = "40"
		objfiles = "setfsgid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 D8 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule epoll_create_172123bfa8de7f0e845d5e2cdf7ab812 {
	meta:
		aliases = "epoll_create"
		size = "40"
		objfiles = "epoll@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 FE 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}
...
rule __libc_read_e868081ec3e176b22088c20162f785d6 {
	meta:
		aliases = "read, __GI_read, __libc_read"
		size = "48"
		objfiles = "read@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 03 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule write_e6e1c27559753b2051b4158f85614a49 {
	meta:
		aliases = "__libc_write, __GI_write, write"
		size = "48"
		objfiles = "write@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 04 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule execve_98ed76ca880027546f7bd8375d9eb19e {
	meta:
		aliases = "__GI_execve, execve"
		size = "48"
		objfiles = "execve@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 0B 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule lseek_74cc41bbf636237fd7de2859afe9d2e0 {
	meta:
		aliases = "__libc_lseek, __GI_lseek, lseek"
		size = "48"
		objfiles = "lseek@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 13 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule mq_setattr_6ded04c3d142d4a07dfdf4d81d900331 {
	meta:
		aliases = "__GI_mq_setattr, mq_setattr"
		size = "48"
		objfiles = "mq_getsetattr@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 1A 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule inotify_add_watch_e720615e3f6444add6b84a85fafd96b6 {
	meta:
		aliases = "inotify_add_watch"
		size = "48"
		objfiles = "inotify@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 24 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule mkdirat_d1be465dcbe647312977624bbdeb792f {
	meta:
		aliases = "mkdirat"
		size = "48"
		objfiles = "mkdirat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 28 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule futimesat_5723f6a1ae99f0507a70dbc8e9f1aae1 {
	meta:
		aliases = "futimesat"
		size = "48"
		objfiles = "futimesat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 2B 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule unlinkat_d9a90d7b87deb42683d8da204422a586 {
	meta:
		aliases = "unlinkat"
		size = "48"
		objfiles = "unlinkat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 2D 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule symlinkat_835c032b90257679ddec96f45f765803 {
	meta:
		aliases = "symlinkat"
		size = "48"
		objfiles = "symlinkat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 30 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule readlink_21edbc286df1e9f4b0f84ca78da85305 {
	meta:
		aliases = "__GI_readlink, readlink"
		size = "48"
		objfiles = "readlink@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 55 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule setpriority_d3387a747ccb4fe398d1cebbb42ec5ec {
	meta:
		aliases = "__GI_setpriority, setpriority"
		size = "48"
		objfiles = "setpriority@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 61 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule ioperm_4ae9d8b7b0096b61c5a820ff34576657 {
	meta:
		aliases = "ioperm"
		size = "48"
		objfiles = "ioperm@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 65 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule klogctl_ae616716e649a39b3105776caffbbd38 {
	meta:
		aliases = "klogctl"
		size = "48"
		objfiles = "klogctl@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 67 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule setitimer_8e33584d28bfaa2d013232fdc496d1c7 {
	meta:
		aliases = "__GI_setitimer, setitimer"
		size = "48"
		objfiles = "setitimer@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 68 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule modify_ldt_ce40efe034c4af42f4c532b3464b2b5e {
	meta:
		aliases = "modify_ldt"
		size = "48"
		objfiles = "modify_ldt@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 7B 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule mprotect_0619c9373b083b883c8d6769be27009e {
	meta:
		aliases = "mprotect"
		size = "48"
		objfiles = "mprotect@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 7D 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule __libc_msync_0cc714aafacffcf47d6056d3dfb288f8 {
	meta:
		aliases = "msync, __libc_msync"
		size = "48"
		objfiles = "msync@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 90 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule readv_b9ea15c9b40af07ed0fe7c48c3aef52a {
	meta:
		aliases = "readv"
		size = "48"
		objfiles = "readv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 91 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule writev_c04c4302162669686d29922fae611908 {
	meta:
		aliases = "writev"
		size = "48"
		objfiles = "writev@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 92 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule sched_setscheduler_2dbb54561889833cb2859c07917c1070 {
	meta:
		aliases = "sched_setscheduler"
		size = "48"
		objfiles = "sched_setscheduler@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 9C 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule __libc_poll_48385a8bf85973d94d488a4608ee1bb1 {
	meta:
		aliases = "__GI_poll, poll, __libc_poll"
		size = "48"
		objfiles = "poll@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 A8 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule lchown_9da4afffaed5ab17e617ce91de986e82 {
	meta:
		aliases = "lchown"
		size = "48"
		objfiles = "lchown@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 C6 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule fchown_90ad7ebb4b2d94c36520e590f02b7543 {
	meta:
		aliases = "fchown"
		size = "48"
		objfiles = "fchown@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 CF 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule __GI_setresuid_3430221c5affadf46d94bacdefd1a949 {
	meta:
		aliases = "setresuid, __GI_setresuid"
		size = "48"
		objfiles = "setresuid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 D0 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule getresuid_41308b98492d71cef044b05b5208bf99 {
	meta:
		aliases = "getresuid"
		size = "48"
		objfiles = "getresuid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 D1 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule __GI_setresgid_fc3a5c92f1c678a084f57bf8565a8888 {
	meta:
		aliases = "setresgid, __GI_setresgid"
		size = "48"
		objfiles = "setresgid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 D2 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule getresgid_b20ff6b089b3f0cf6ed7c6fab061fd4d {
	meta:
		aliases = "getresgid"
		size = "48"
		objfiles = "getresgid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 D3 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule __GI_chown_d28745cd73c8208e46d2274a3747f938 {
	meta:
		aliases = "chown, __GI_chown"
		size = "48"
		objfiles = "chown@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 D4 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule mincore_54a5931e21382845b59ce539ae25d201 {
	meta:
		aliases = "mincore"
		size = "48"
		objfiles = "mincore@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 DA 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule madvise_23a05511de8de00fa860d495de8bfd73 {
	meta:
		aliases = "madvise"
		size = "48"
		objfiles = "madvise@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 DB 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule listxattr_8501ed74dbe33bafbcb45b85e9f07b7e {
	meta:
		aliases = "listxattr"
		size = "48"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 E8 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule llistxattr_1430294b4f5441ea41e0d5593c34e3f4 {
	meta:
		aliases = "llistxattr"
		size = "48"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 E9 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule flistxattr_86b26c46a48fb4f6128fb76680250d39 {
	meta:
		aliases = "flistxattr"
		size = "48"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 8B 4C 24 0C 8B 54 24 10 53 89 FB B8 EA 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}

rule __getutid_e6ee934157d3df87bc8ddaf8e272518b {
	meta:
		aliases = "__getutid"
		size = "86"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8D 78 28 56 89 C6 53 EB 3B 8B 16 8D 42 FF 66 83 F8 03 77 05 66 39 13 74 36 66 83 FA 05 74 12 66 83 FA 08 74 0C 66 83 FA 06 74 06 66 83 FA 07 75 13 8D 43 28 6A 04 57 50 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 0B E8 ?? ?? ?? ?? 89 C3 85 C0 75 BA 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule reboot_b5d8e89264fa1015d14d8453c74c844b {
	meta:
		aliases = "reboot"
		size = "50"
		objfiles = "reboot@libc.a"
	strings:
		$pattern = { ( CC | 57 ) B9 69 19 12 28 8B 54 24 08 BF AD DE E1 FE 53 89 FB B8 58 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}
...
rule __GI_svcudp_create_4d6cf988d3f7d4c5719a88e84b0ac0a6 {
	meta:
...
rule __GI_clntudp_create_671122b88df312813229260f98c39983 {
	meta:
...
rule __open_etc_hosts_51a50c37d67a55bc1275a67733412f14 {
	meta:
		aliases = "__open_etc_hosts"
		size = "18"
		objfiles = "read_etc_hosts_r@libc.a"
	strings:
		$pattern = { ( CC | 68 ) ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A 59 C3 }
	condition:
		$pattern
}
...
rule hdestroy_c97d8f5517fef4824426922a1b3eb9e1 {
	meta:
		aliases = "_flushlbf, __pthread_once_fork_prepare, __pthread_once_fork_parent, hdestroy"
		size = "12"
		objfiles = "mutex@libpthread.a, hsearch@libc.a, _flushlbf@libc.a"
	strings:
...
rule getlogin_4b4b020f95e78d1c2d908fe427dc4a97 {
	meta:
		aliases = "__GI_getlogin, getlogin"
		size = "12"
		objfiles = "getlogin@libc.a"
	strings:
...
rule __GI_localtime_561e289bbb8d25a3dda9354419d8108d {
	meta:
		aliases = "seed48, localtime, __GI_localtime"
		size = "22"
		objfiles = "localtime@libc.a, seed48@libc.a"
	strings:
		$pattern = { ( CC | 68 ) ?? ?? ?? ?? FF 74 24 08 E8 ?? ?? ?? ?? 58 B8 ?? ?? ?? ?? 5A C3 }
	condition:
		$pattern
}

rule __GI_inet_ntoa_e214931d143cca1a32199edb31adc4a0 {
	meta:
		aliases = "asctime, ether_aton, inet_ntoa, __GI_asctime, hcreate, ether_ntoa, __GI_inet_ntoa"
		size = "17"
		objfiles = "ether_addr@libc.a, inet_ntoa@libc.a, asctime@libc.a, hsearch@libc.a"
	strings:
...
rule strtok_ce767ada53bd455cecd0660edb8a7c87 {
	meta:
		aliases = "lgamma, __GI_strtok, __GI_lgamma, __ieee754_lgamma, gamma, strtok"
		size = "22"
...
rule __libc_wait_e1443d85905223fdf5cfc41ace8141c5 {
	meta:
...
rule __GI_tzset_2e5dd0a140b50499694806fa7840c1be {
	meta:
...
rule mkstemp_0b2bdff5f5301a6617caee89402ffe9b {
	meta:
		aliases = "sigpause, mkstemp"
		size = "14"
		objfiles = "mkstemp@libc.a, sigpause@libc.a"
	strings:
...
rule sigwait_48e508d77eeeb3e444f53a7491cf935b {
	meta:
		aliases = "sigwait"
		size = "34"
		objfiles = "sigwait@libc.a"
	strings:
		$pattern = { ( CC | 6A ) 00 FF 74 24 08 E8 ?? ?? ?? ?? 89 C2 58 83 FA FF 59 B8 01 00 00 00 74 08 8B 44 24 08 89 10 31 C0 C3 }
	condition:
		$pattern
}
...
rule xdrstdio_setpos_9d2c4afe190b17eb5f87a9536cace235 {
	meta:
		aliases = "xdrstdio_setpos"
		size = "27"
		objfiles = "xdr_stdio@libc.a"
	strings:
		$pattern = { ( CC | 6A ) 00 FF 74 24 0C 8B 44 24 0C FF 70 0C E8 ?? ?? ?? ?? 83 C4 0C F7 D0 C1 E8 1F C3 }
	condition:
		$pattern
}

rule __GI_wcstold_218c186b4d9e0825b5f6d16570a16a45 {
	meta:
...
rule __GI_waitpid_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		aliases = "waitpid, __libc_waitpid, strtoull, strtoumax, __GI_strtoul, wcstouq, wcstoull, strtoul, wcstoul, __GI_strtoull, __GI_wcstoull, __GI_wcstoul, strtouq, wcstoumax, __GI_waitpid"
		size = "23"
		objfiles = "wcstoul@libc.a, strtoull@libc.a, strtoul@libc.a, wcstoull@libc.a, waitpid@libc.a"
	strings:
...
rule __libc_tcdrain_7f31bfab83c7e80ac18eb675a76212c2 {
	meta:
...
rule iswalnum_0410fd2bb80bbf0bc944c8d2d2133af7 {
	meta:
		aliases = "__GI_iswalnum, mkstemp64, timelocal, mktime, iswalnum"
		size = "14"
...
rule strtoll_fe8e5520a3eef7a03748f1ff8e71080f {
	meta:
		aliases = "wcstoll, wcstoimax, __GI_wcstoll, strtol, __GI_strtol, wcstoq, wcstol, __GI_wcstol, strtoimax, __GI_strtoll, strtoq, strtoll"
		size = "23"
...
rule iswalpha_60617713272f358c39f6fe181a7829f8 {
	meta:
		aliases = "gethostbyname, __GI_iswalpha, __GI_gethostbyname, iswalpha"
		size = "14"
...
rule __GI_iswcntrl_7417603aa9a58514d7404e7a8944260e {
	meta:
...
rule iswdigit_e83006ca42bcd5f8a005429c5301f208 {
	meta:
		aliases = "__GI_iswdigit, iswdigit"
		size = "14"
...
rule __GI_iswlower_5052853c04925b0531827fed4fc59dcb {
	meta:
...
rule __GI_iswprint_d38784d66d96bfdd9e465c741b60d9f4 {
	meta:
...
rule atol_40657ce09f1f30b9225c7cb14e45ae11 {
	meta:
		aliases = "__GI_atol, __GI_atoi, atoi, atoll, atol"
		size = "17"
...
rule __GI_iswupper_f03dd08dee06b701b3ac49e6f438e1bf {
	meta:
...
rule __GI_fopen64_dba6fc56a335bccbc0657c0736a115c0 {
	meta:
...
rule getusershell_77eac6bc2406946d306012ebe64b53af {
	meta:
		aliases = "getusershell"
		size = "41"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { ( CC | 83 ) 3D ?? ?? ?? ?? 00 75 0A E8 ?? ?? ?? ?? A3 ?? ?? ?? ?? A1 ?? ?? ?? ?? 8B 10 85 D2 74 08 83 C0 04 A3 ?? ?? ?? ?? 89 D0 C3 }
	condition:
		$pattern
}

rule __GI__rpc_dtablesize_85c2418f5ec722f9878718e2519e1865 {
	meta:
...
rule __initbuf_a4f30dceb7ecc13920d59147e930b59f {
	meta:
		aliases = "__initbuf"
		size = "35"
		objfiles = "getproto@libc.a, getservice@libc.a"
	strings:
		$pattern = { ( CC | 83 ) 3D ?? ?? ?? ?? 00 75 19 68 8D 10 00 00 E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 85 C0 75 05 E8 ?? ?? ?? ?? C3 }
	condition:
		$pattern
}

rule __GI___uClibc_init_4f87874b18609692697b338b25375015 {
	meta:
		aliases = "__uClibc_init, __GI___uClibc_init"
		size = "48"
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 83 ) 3D ?? ?? ?? ?? 00 75 26 B8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 10 00 00 85 C0 74 05 E8 ?? ?? ?? ?? B8 ?? ?? ?? ?? 85 C0 74 05 E9 ?? ?? ?? ?? C3 }
	condition:
		$pattern
}

rule __getutent_50ca30204cf4e38a7750ccdd0361312c {
	meta:
		aliases = "__getutent"
		size = "66"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 83 ) 3D ?? ?? ?? ?? 00 79 10 E8 ?? ?? ?? ?? 31 D2 83 3D ?? ?? ?? ?? 00 78 26 68 80 01 00 00 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C BA ?? ?? ?? ?? 3D 80 01 00 00 74 02 31 D2 89 D0 C3 }
	condition:
		$pattern
}
...
rule funlockfile_c8ec7981dc8c7ffca74d62d23a333721 {
	meta:
		aliases = "ftrylockfile, flockfile, funlockfile"
		size = "10"
...
rule open64_84136a8b413e29f3f6b18cba42f8f209 {
	meta:
		aliases = "__libc_open64, __GI_open64, open64"
		size = "43"
		objfiles = "open64@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 31 C0 8B 54 24 0C F6 C2 40 74 0B 8D 44 24 14 89 04 24 8B 44 24 10 80 CE 80 50 52 FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 10 C3 }
	condition:
		$pattern
}
...
rule getpwent_b0755d037b60fb5500574f607e9b1509 {
	meta:
...
rule getpwuid_55f8a496d4b651e19d576b899468cf9d {
	meta:
		aliases = "fgetgrent, sgetspent, fgetspent, getgrgid, getspnam, fgetpwent, getpwnam, getgrnam, getpwuid"
		size = "38"
		objfiles = "fgetpwent@libc.a, fgetgrent@libc.a, getpwnam@libc.a, getgrgid@libc.a, fgetspent@libc.a"
	strings:
...
rule __GI_tcgetpgrp_b86f33337acd6e90812ac2b03e3cccc0 {
	meta:
...
rule jrand48_df9bc9521ef7022b723480b842632cc1 {
	meta:
...
rule __GI_inet_addr_3226f4a9d5b8f99eb9dd5631f944505a {
	meta:
...
rule tgamma_0808fb28bd578809fde66446a7375bec {
	meta:
		aliases = "__GI_tgamma, tgamma"
		size = "32"
		objfiles = "e_lgamma_r@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 89 E0 50 FF 74 24 10 FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 0C 83 3C 24 00 79 02 D9 E0 58 C3 }
	condition:
		$pattern
}

rule xdrstdio_getlong_859a050c8f2bf9d7c405b3a4ea7be944 {
	meta:
		aliases = "xdrstdio_getlong"
		size = "52"
		objfiles = "xdr_stdio@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 8B 44 24 08 FF 70 0C 6A 01 6A 04 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 31 D2 48 75 10 8B 54 24 0C 8B 04 24 0F C8 89 02 BA 01 00 00 00 89 D0 59 C3 }
	condition:
		$pattern
}

rule xdrstdio_getint32_03f938b5c8d4de67754dc718d2a5ecc1 {
	meta:
		aliases = "xdrstdio_getint32"
		size = "52"
		objfiles = "xdr_stdio@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 8B 44 24 08 FF 70 0C 6A 01 6A 04 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 31 D2 48 75 10 8B 54 24 0C 8B 04 24 0F C8 89 02 BA 01 00 00 00 89 D0 5A C3 }
	condition:
		$pattern
}
...
rule __GI_inet_makeaddr_edbb59df5bf611c9c18be8dd3723629e {
	meta:
		aliases = "inet_makeaddr, __GI_inet_makeaddr"
		size = "82"
		objfiles = "inet_addr@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 8B 54 24 0C 8B 4C 24 08 8B 44 24 10 83 FA 7F 77 0A C1 E2 18 25 FF FF FF 00 EB 22 81 FA FF FF 00 00 77 0A C1 E2 10 25 FF FF 00 00 EB 10 81 FA FF FF FF 00 77 08 C1 E2 08 25 FF 00 00 00 09 D0 89 04 24 8B 04 24 0F C8 89 01 89 C8 5A C2 04 00 }
	condition:
		$pattern
}

rule warn_bad0905bf4c53056c9d6cb34f37f57de {
	meta:
		aliases = "warnx, warn"
		size = "24"
		objfiles = "err@libc.a"
...
rule wscanf_d49bdeb5a2c59b42a4876d324b1f6480 {
	meta:
		aliases = "wprintf, scanf, __GI_printf, printf, wscanf"
		size = "30"
...
rule err_9f143f07bfdb3664ba74449340512e6c {
	meta:
		aliases = "errx, err"
		size = "24"
		objfiles = "err@libc.a"
...
rule dprintf_3674412569e427ab0f649983548971e5 {
	meta:
		aliases = "fprintf, syslog, fscanf, __GI_fscanf, __GI_sscanf, swscanf, __GI_fprintf, __GI_fwprintf, fwscanf, asprintf, fwprintf, __GI_asprintf, sscanf, __GI_syslog, dprintf"
		size = "28"
		objfiles = "fwprintf@libc.a, asprintf@libc.a, dprintf@libc.a, sscanf@libc.a, fprintf@libc.a"
	strings:
...
rule fedisableexcept_726852d7a79c5733e2d74de0f136479c {
	meta:
		aliases = "fedisableexcept"
		size = "38"
		objfiles = "fedisblxcpt@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 9B D9 7C 24 02 8B 54 24 08 66 8B 44 24 02 83 E2 3D 09 C2 66 89 54 24 02 D9 6C 24 02 F7 D0 83 E0 3D 5A C3 }
	condition:
		$pattern
}

rule feenableexcept_b084a5f1647d52000bdf03d22b64d986 {
	meta:
		aliases = "feenableexcept"
		size = "40"
		objfiles = "feenablxcpt@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 9B D9 7C 24 02 8B 54 24 08 66 8B 44 24 02 83 E2 3D F7 D2 21 C2 66 89 54 24 02 D9 6C 24 02 F7 D0 83 E0 3D 5A C3 }
	condition:
		$pattern
}

rule fesetround_7fa3a2ed68e25c1309df5e1b077f7f70 {
	meta:
		aliases = "fesetround"
		size = "47"
		objfiles = "fesetround@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 B8 01 00 00 00 8B 54 24 08 F7 C2 FF F3 FF FF 75 19 D9 7C 24 02 66 8B 44 24 02 80 E4 F3 09 D0 66 89 44 24 02 D9 6C 24 02 31 C0 5A C3 }
	condition:
		$pattern
}

rule fegetround_0395b6fc724bd88df0a696f675d3e601 {
	meta:
		aliases = "fegetround"
		size = "16"
		objfiles = "fegetround@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 D9 3C 24 8B 04 24 5A 25 00 0C 00 00 C3 }
	condition:
		$pattern
}

rule __ieee754_scalb_b1852281c611bd2df1c857b156602767 {
	meta:
		aliases = "scalb, __ieee754_scalb"
		size = "40"
		objfiles = "e_scalb@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 D9 7C 24 02 66 8B 44 24 02 80 CC 0C 66 89 04 24 DD 44 24 10 D9 2C 24 DB 5C 24 10 D9 6C 24 02 58 E9 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule fegetexceptflag_7e637a291c3fa51e8a4841a6a88c42d7 {
	meta:
		aliases = "fegetexceptflag"
		size = "30"
		objfiles = "fgetexcptflg@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 DD 7C 24 02 8B 44 24 0C 8B 54 24 08 66 23 44 24 02 83 E0 3D 66 89 02 31 C0 5A C3 }
	condition:
		$pattern
}

rule gethostent_453cbcd4662b1745585d58dfed08a97a {
	meta:
		aliases = "gethostent"
		size = "42"
		objfiles = "gethostent@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 E8 ?? ?? ?? ?? 50 8D 44 24 04 50 68 8A 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 14 83 C4 18 C3 }
	condition:
		$pattern
}

rule gethostbyname2_c48f4ccac2008e169ebb41ba84a9b311 {
	meta:
		aliases = "__GI_gethostbyname2, gethostbyname2"
		size = "50"
		objfiles = "gethostbyname2@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 E8 ?? ?? ?? ?? 50 8D 44 24 04 50 68 D8 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 20 FF 74 24 20 E8 ?? ?? ?? ?? 8B 44 24 1C 83 C4 20 C3 }
	condition:
		$pattern
}

rule gethostbyaddr_eea9bb78d91b5da2ae187d26bb17a3e1 {
	meta:
		aliases = "__GI_gethostbyaddr, gethostbyaddr"
		size = "54"
		objfiles = "gethostbyaddr@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 E8 ?? ?? ?? ?? 50 8D 44 24 04 50 68 D8 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 24 FF 74 24 24 FF 74 24 24 E8 ?? ?? ?? ?? 8B 44 24 20 83 C4 24 C3 }
	condition:
		$pattern
}

rule getservent_26e22669bdbd404ee41052512e9cc05e {
	meta:
		aliases = "getprotoent, getservent"
		size = "40"
		objfiles = "getproto@libc.a, getservice@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 E8 ?? ?? ?? ?? 89 E0 50 68 8D 10 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 10 83 C4 14 C3 }
	condition:
		$pattern
}

rule getprotobyname_83b0b6ab744928ce61f3d8f5e9f87a1f {
	meta:
		aliases = "getprotobynumber, getprotobyname"
		size = "44"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 E8 ?? ?? ?? ?? 89 E0 50 68 8D 10 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 18 E8 ?? ?? ?? ?? 8B 44 24 14 83 C4 18 C3 }
	condition:
		$pattern
}

rule getservbyname_5b0e5662a54c4d8934751769ff0efbd8 {
	meta:
		aliases = "__GI_getservbyport, getservbyport, getservbyname"
		size = "48"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 E8 ?? ?? ?? ?? 89 E0 50 68 8D 10 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 1C FF 74 24 1C E8 ?? ?? ?? ?? 8B 44 24 18 83 C4 1C C3 }
	condition:
		$pattern
}
...
rule frexpf_52f7a84bc3ab9460e167cd68ace97b53 {
	meta:
...
rule __GI_strtof_8a2523e8a23a59f0c88500a8ca4cd794 {
	meta:
...
rule __GI_getdtablesize_d92a53a061e827509ce03df7a5afa39c {
	meta:
		aliases = "getdtablesize, __GI_getdtablesize"
		size = "32"
		objfiles = "getdtablesize@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 08 89 E0 50 6A 07 E8 ?? ?? ?? ?? 5A 85 C0 59 BA 00 01 00 00 78 03 8B 14 24 89 D0 5A 59 C3 }
	condition:
		$pattern
}

rule __GI_listen_e1486ac3ad13e0438cf99c5cdbd757f6 {
	meta:
...
rule setrlimit64_3a8e5f39ab4cdbb5d0de1efd48640e82 {
	meta:
		aliases = "setrlimit64"
		size = "80"
		objfiles = "setrlimit64@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 08 8B 4C 24 10 8B 51 04 8B 01 83 FA 00 77 05 83 F8 FE 76 09 C7 04 24 FF FF FF FF EB 03 89 04 24 8B 51 0C 8B 41 08 83 FA 00 77 05 83 F8 FE 76 0A C7 44 24 04 FF FF FF FF EB 04 89 44 24 04 89 E0 50 FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 10 C3 }
	condition:
		$pattern
}
...
rule usleep_f03be5854ff2270bdb82be71a61544ef {
	meta:
		aliases = "usleep"
		size = "47"
		objfiles = "usleep@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 08 BA 40 42 0F 00 89 D1 31 D2 8B 44 24 0C F7 F1 69 D2 E8 03 00 00 89 04 24 89 54 24 04 6A 00 8D 44 24 04 50 E8 ?? ?? ?? ?? 83 C4 10 C3 }
	condition:
		$pattern
}

rule logb_79cded344b389660ac6629e57dfd1bc4 {
	meta:
		aliases = "__GI_logb, logb"
		size = "92"
		objfiles = "s_logb@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 08 DD 44 24 0C DD 14 24 8B 44 24 04 8B 14 24 25 FF FF FF 7F 09 C2 75 15 83 EC 08 DD 1C 24 E8 ?? ?? ?? ?? 59 D8 3D ?? ?? ?? ?? 58 EB 2A DD D8 3D FF FF EF 7F 7E 08 DD 44 24 0C D8 C8 EB 19 C1 F8 14 75 08 D9 05 ?? ?? ?? ?? EB 0C 2D FF 03 00 00 50 DB 04 24 83 C4 04 58 5A C3 }
	condition:
		$pattern
}

rule __GI___isnan_4d82444e2516c5c60a268cbd4b93f571 {
	meta:
		aliases = "__isnan, __GI___isnan"
		size = "45"
		objfiles = "s_isnan@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 08 DD 44 24 0C DD 1C 24 8B 14 24 8B 44 24 04 F7 DA 0B 14 24 25 FF FF FF 7F C1 EA 1F 09 C2 B8 00 00 F0 7F 29 D0 5A C1 E8 1F 59 C3 }
	condition:
		$pattern
}

rule __GI___finite_46e437467d852192c35406e9fec235f8 {
	meta:
		aliases = "__finite, __GI___finite"
		size = "29"
		objfiles = "s_finite@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 08 DD 44 24 0C DD 1C 24 8B 44 24 04 5A 0D FF FF 0F 80 59 40 0F 95 C0 0F B6 C0 C3 }
	condition:
		$pattern
}

rule __GI___signbit_e99a583f9bf7ce82a98f071f48f63542 {
	meta:
		aliases = "__signbit, __GI___signbit"
		size = "22"
		objfiles = "s_signbit@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 08 DD 44 24 0C DD 1C 24 8B 44 24 04 5A 25 00 00 00 80 59 C3 }
	condition:
		$pattern
}

rule __isinf_5caf503ff3d9a246b19d444e159c2855 {
	meta:
		aliases = "__GI___isinf, __isinf"
		size = "50"
		objfiles = "s_isinf@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 08 DD 44 24 0C DD 1C 24 8B 4C 24 04 89 CA C1 F9 1E 81 E2 FF FF FF 7F 81 F2 00 00 F0 7F 0B 14 24 89 D0 F7 D8 09 D0 5A C1 F8 1F F7 D0 21 C8 59 C3 }
	condition:
		$pattern
}

rule __GI_socket_48d3f7eaed9089438bad450058349aa7 {
	meta:
...
rule __GI_accept_078c7229578416c75068cad7383ac69c {
	meta:
...
rule __GI_getsockname_dca9f8ddea1e838d4cbecf34b117f453 {
	meta:
...
rule __libc_sendmsg_33231d5410bb15145c0551f9d9f4c64b {
	meta:
...
rule mbstowcs_b383e28f7531de8438e778ceabf80c14 {
	meta:
		aliases = "mbstowcs"
		size = "43"
		objfiles = "mbstowcs@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C 8B 44 24 14 C7 04 24 00 00 00 00 89 44 24 08 89 E0 50 FF 74 24 1C 8D 44 24 10 50 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 1C C3 }
	condition:
		$pattern
}
...
rule significandf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		aliases = "asinhf, cosf, fabsf, coshf, logf, expm1f, log2f, expf, logbf, lgammaf, log10f, asinf, truncf, roundf, cbrtf, acosf, erfcf, ceilf, sinhf, sqrtf, acoshf, exp2f, tanhf, atanhf, erff, sinf, floorf, atanf, gammaf, tanf, log1pf, rintf, significandf"
		size = "27"
		objfiles = "exp2f@libm.a, atanhf@libm.a, log10f@libm.a, logbf@libm.a, truncf@libm.a"
	strings:
...
rule __GI_setnetent_4df162fa78943270536f2e1af5743cf4 {
	meta:
		aliases = "__GI_setservent, setnetent, setprotoent, setservent, __GI_setprotoent, __GI_setnetent"
		size = "106"
		objfiles = "getnetent@libc.a, getproto@libc.a, getservice@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 75 18 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A3 ?? ?? ?? ?? 58 5A EB 07 50 E8 ?? ?? ?? ?? 58 83 7C 24 14 00 74 07 C6 05 ?? ?? ?? ?? 01 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 83 C4 18 C3 }
	condition:
		$pattern
}
...
rule clock_e0ba5933fd5d31b03e03a2941e8a38a9 {
	meta:
		aliases = "clock"
		size = "34"
		objfiles = "clock@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 89 E0 50 E8 ?? ?? ?? ?? 8B 44 24 04 03 44 24 08 83 C4 14 69 C0 10 27 00 00 25 FF FF FF 7F C3 }
	condition:
		$pattern
}
...
rule sigblock_e227929bde1d9d72e2a6ec833c3cba50 {
	meta:
		aliases = "__GI_sigblock, sigblock"
		size = "42"
		objfiles = "sigblock@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 8B 44 24 14 C7 44 24 0C 00 00 00 00 89 44 24 08 89 E0 50 8D 44 24 0C 50 6A 00 E8 ?? ?? ?? ?? 8B 44 24 0C 83 C4 1C C3 }
	condition:
		$pattern
}

rule __GI_sigsetmask_82bc1b8dcefe4a797b44c01420666dc6 {
	meta:
		aliases = "sigsetmask, __GI_sigsetmask"
		size = "42"
		objfiles = "sigsetmask@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 8B 44 24 14 C7 44 24 0C 00 00 00 00 89 44 24 08 89 E0 50 8D 44 24 0C 50 6A 02 E8 ?? ?? ?? ?? 8B 44 24 0C 83 C4 1C C3 }
	condition:
		$pattern
}

rule __GI_copysign_516edf153e5d108277906bff2649e48c {
	meta:
		aliases = "copysign, __GI_copysign"
		size = "46"
		objfiles = "s_copysign@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 DD 44 24 14 8B 54 24 20 DD 54 24 08 8B 44 24 0C 81 E2 00 00 00 80 25 FF FF FF 7F DD 1C 24 09 C2 89 54 24 04 DD 04 24 83 C4 10 C3 }
	condition:
		$pattern
}

rule __kernel_sin_2daf0c02f8746d23910829ead70789b7 {
	meta:
		aliases = "__kernel_sin"
		size = "192"
		objfiles = "k_sin@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 DD 44 24 14 DD 14 24 8B 44 24 04 25 FF FF FF 7F 3D FF FF 3F 3E 7F 27 D9 7C 24 0E 66 8B 44 24 0E 80 CC 0C 66 89 44 24 0C D9 6C 24 0C DB 5C 24 08 D9 6C 24 0E 8B 44 24 08 85 C0 74 79 EB 02 DD D8 DD 44 24 14 D8 C8 83 7C 24 24 00 DD 44 24 14 D8 C9 DD 05 ?? ?? ?? ?? D8 CA DC 25 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? D8 CA DC 25 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? 75 12 DE CA D9 C9 DC 25 ?? ?? ?? ?? DE C9 DC 44 24 14 EB 26 DD 44 24 1C D8 0D ?? ?? ?? ?? D9 C9 D8 CA DE E9 DE CA D9 C9 DC 64 24 1C D9 C9 DC 0D ?? ?? ?? ?? DE C1 DC 6C 24 14 DD 5C 24 14 DD 44 24 14 83 C4 10 C3 }
	condition:
		$pattern
}

rule __GI_fabs_e973fe813e6562ab495c03a2546aed3b {
	meta:
		aliases = "fabs, __GI_fabs"
		size = "34"
		objfiles = "s_fabs@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 DD 44 24 14 DD 54 24 08 8B 44 24 0C DD 1C 24 25 FF FF FF 7F 89 44 24 04 DD 04 24 83 C4 10 C3 }
	condition:
		$pattern
}

rule __GI_setsockopt_e3000f0a40016e70ff62149ef4f5194a {
	meta:
...
rule fmodf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		aliases = "hypotf, powf, remainderf, atan2f, copysignf, scalbf, fmodf"
		size = "35"
		objfiles = "remainderf@libm.a, scalbf@libm.a, copysignf@libm.a, atan2f@libm.a, powf@libm.a"
	strings:
...
rule __GI_sendto_bfdff1979e67bfb60a49e18003972120 {
	meta:
...
rule __GI_recvfrom_1e269ffd214f9efcaee9dfdb8b996d42 {
	meta:
...
rule wcrtomb_061a8773cfdebc06a1f4616b7439163e {
	meta:
		aliases = "__GI_wcrtomb, wcrtomb"
		size = "63"
		objfiles = "wcrtomb@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 18 8B 54 24 1C 8B 4C 24 20 85 D2 75 04 89 E2 31 C9 8D 44 24 14 89 4C 24 14 89 44 24 10 FF 74 24 24 6A 10 6A 01 8D 44 24 1C 50 52 E8 ?? ?? ?? ?? 83 C4 14 85 C0 75 02 B0 01 83 C4 18 C3 }
	condition:
		$pattern
}
...
rule __kernel_cos_f15c7e2bfa26483105f254498fb19ca5 {
	meta:
		aliases = "__kernel_cos"
		size = "254"
		objfiles = "k_cos@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 18 DD 44 24 1C C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 DD 54 24 08 8B 54 24 0C 81 E2 FF FF FF 7F 81 FA FF FF 3F 3E 7F 2C D9 7C 24 16 66 8B 44 24 16 80 CC 0C 66 89 44 24 14 D9 6C 24 14 DB 5C 24 10 D9 6C 24 16 8B 44 24 10 85 C0 75 09 D9 E8 E9 A2 00 00 00 DD D8 DD 44 24 1C D8 C8 81 FA 32 33 D3 3F DD 05 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 7F 1C D9 C1 D8 0D ?? ?? ?? ?? D9 CA DE C9 DD 44 24 1C DC 4C 24 24 DE E9 DE E9 D9 E8 EB 44 81 FA 00 00 E9 3F 7E 08 D9 05 ?? ?? ?? ?? EB 14 81 EA 00 00 }
	condition:
		$pattern
}
...
rule __GI_sin_6b31e29a58e0c42c0df534d96ad32c11 {
	meta:
...
rule tan_353773b4a706c390f0b282d7d4874b81 {
	meta:
		aliases = "__GI_tan, tan"
		size = "124"
		objfiles = "s_tan@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 18 DD 44 24 1C DD 1C 24 8B 44 24 04 25 FF FF FF 7F 3D FB 21 E9 3F 7F 18 6A 01 6A 00 6A 00 FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 14 EB 46 3D FF FF EF 7F 7E 08 DD 44 24 1C D8 E0 EB 37 8D 44 24 08 50 FF 74 24 24 FF 74 24 24 E8 ?? ?? ?? ?? BA 01 00 00 00 83 E0 01 01 C0 29 C2 52 FF 74 24 24 FF 74 24 24 FF 74 24 24 FF 74 24 24 E8 ?? ?? ?? ?? 83 C4 20 83 C4 18 C3 }
	condition:
		$pattern
}

rule feholdexcept_65f0f1bd9cb50caa860f0f478f06ef00 {
	meta:
		aliases = "feholdexcept"
		size = "42"
		objfiles = "feholdexcpt@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C 89 E0 D9 34 24 6A 1C 50 FF 74 24 28 E8 ?? ?? ?? ?? 66 83 4C 24 0C 3F 66 83 64 24 10 C0 D9 64 24 0C 31 C0 83 C4 28 C3 }
	condition:
		$pattern
}
...
rule fesetexceptflag_34906b6c9a913ee74a580860842f5476 {
	meta:
		aliases = "fesetexceptflag"
		size = "47"
		objfiles = "fsetexcptflg@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C D9 34 24 8B 44 24 24 8B 4C 24 20 89 C2 66 23 01 83 E2 3D F7 D2 23 54 24 04 83 E0 3D 09 C2 66 89 54 24 04 D9 24 24 31 C0 83 C4 1C C3 }
	condition:
		$pattern
}

rule __ieee754_acosh_1ae327650ab2127e9721f40276c3f9f6 {
	meta:
		aliases = "acosh, __GI_acosh, __ieee754_acosh"
		size = "233"
		objfiles = "e_acosh@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C DD 44 24 20 DD 54 24 0C DD 54 24 14 8B 54 24 18 8B 4C 24 14 81 FA FF FF EF 3F 7F 09 D8 E0 D8 F0 E9 BD 00 00 00 DD D8 81 FA FF FF AF 41 7E 2D 81 FA FF FF EF 7F 7E 0B DD 44 24 0C D8 C0 E9 A0 00 00 00 FF 74 24 10 FF 74 24 10 E8 ?? ?? ?? ?? 58 DC 05 ?? ?? ?? ?? 5A E9 86 00 00 00 8D 82 00 00 10 C0 09 C8 75 04 D9 EE EB 78 81 FA 00 00 00 40 7E 3B DD 44 24 0C D8 C8 83 EC 08 DC 25 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? DD 44 24 14 D8 C0 D9 C9 DC 44 24 14 DD 54 24 14 D8 3D ?? ?? ?? ?? DE C1 DD 5C 24 28 83 C4 24 E9 ?? ?? ?? ?? DD 44 24 0C DC 25 ?? ?? ?? ?? 83 EC 08 D9 C0 D8 C1 D9 C1 D8 CA DE C1 DD }
	condition:
		$pattern
}

rule ualarm_4859599af4d87808b9283b80eaa61d19 {
	meta:
		aliases = "ualarm"
		size = "79"
		objfiles = "ualarm@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 20 8B 44 24 28 C7 04 24 00 00 00 00 89 44 24 04 8B 44 24 24 89 44 24 0C 8D 44 24 10 C7 44 24 08 00 00 00 00 50 8D 44 24 04 50 6A 00 E8 ?? ?? ?? ?? 83 C4 0C 83 CA FF 85 C0 78 0C 69 54 24 18 40 42 0F 00 03 54 24 1C 89 D0 83 C4 20 C3 }
	condition:
		$pattern
}

rule sysv_signal_2b4f72f791a0d1fc48860dd06aef79f0 {
	meta:
		aliases = "__sysv_signal, sysv_signal"
		size = "102"
		objfiles = "sysv_signal@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 28 8B 44 24 30 8B 54 24 2C 83 F8 FF 74 09 85 D2 7E 05 83 FA 40 7E 10 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 EB 37 89 44 24 14 89 E0 C7 44 24 20 00 00 00 00 C7 44 24 24 00 00 00 00 C7 44 24 18 00 00 00 E0 50 8D 44 24 18 50 52 E8 ?? ?? ?? ?? 83 C4 0C 83 CA FF 85 C0 78 03 8B 14 24 89 D0 83 C4 28 C3 }
	condition:
		$pattern
}

rule __GI_ctime_26271929dd4b9bd4e485401bec9e6513 {
	meta:
		aliases = "ctime, __GI_ctime"
		size = "25"
		objfiles = "ctime@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 2C 89 E0 50 FF 74 24 34 E8 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 38 C3 }
	condition:
		$pattern
}
...
rule __ieee754_acos_f665c4ad412800b071014f5c4dc4f365 {
	meta:
		aliases = "acos, __GI_acos, __ieee754_acos"
		size = "550"
...
rule svcerr_auth_29e5a8c4f2094cac44d6a836ca7bfd81 {
	meta:
		aliases = "__GI_svcerr_auth, svcerr_auth"
		size = "53"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 30 8B 44 24 38 8B 4C 24 34 89 44 24 10 C7 44 24 04 01 00 00 00 C7 44 24 08 01 00 00 00 C7 44 24 0C 01 00 00 00 8B 51 08 89 E0 50 51 FF 52 0C 83 C4 38 C3 }
	condition:
		$pattern
}

rule log1p_6b0720cf32d77ce3fb8e747b7bd55020 {
	meta:
		aliases = "__GI_log1p, log1p"
		size = "675"
		objfiles = "s_log1p@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 30 DD 44 24 34 DD 5C 24 20 8B 54 24 24 81 FA 79 82 DA 3F 0F 8F 9C 00 00 00 89 D1 81 E1 FF FF FF 7F 81 F9 FF FF EF 3F 7E 2D D9 05 ?? ?? ?? ?? DD 44 24 34 DA E9 DF E0 9E 75 0F 7A 0D D9 EE D8 3D ?? ?? ?? ?? E9 48 02 00 00 DD 44 24 34 D8 E0 D8 F0 E9 3B 02 00 00 81 F9 FF FF 1F 3E 7F 36 DD 44 24 34 D8 05 ?? ?? ?? ?? D9 EE D9 C9 DA E9 DF E0 9E 76 0C 81 F9 FF FF 8F 3C 0F 8E 1A 02 00 00 DD 44 24 34 D8 C8 D8 0D ?? ?? ?? ?? DC 44 24 34 E9 FD 01 00 00 8D 82 3C 41 2D 40 3D 3C 41 2D 40 76 27 DD 44 24 34 BA 01 00 00 00 31 C9 D9 EE D9 C9 E9 C6 00 00 00 81 FA FF FF EF 7F 7E 0B DD 44 24 34 D8 C0 E9 C9 01 }
	condition:
		$pattern
}
...
rule __ieee754_exp_e2a9a51437eb147b2e75e299f2dba266 {
	meta:
		aliases = "exp, __GI_exp, __ieee754_exp"
		size = "505"
		objfiles = "e_exp@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 40 DD 44 24 44 DD 54 24 28 8B 54 24 2C 89 D0 89 D1 C1 E9 1F 25 FF FF FF 7F 3D 41 2E 86 40 76 64 3D FF FF EF 7F 76 23 DD 54 24 20 81 E2 FF FF 0F 00 0B 54 24 20 74 07 D8 C0 E9 AD 01 00 00 DD D8 85 C9 0F 84 A7 01 00 00 EB 33 DD D8 DD 05 ?? ?? ?? ?? DD 44 24 44 DA E9 DF E0 9E 76 0D DD 05 ?? ?? ?? ?? D8 C8 E9 81 01 00 00 DD 05 ?? ?? ?? ?? DD 44 24 44 D9 C9 DA E9 DF E0 9E 76 32 D9 EE E9 67 01 00 00 DD D8 3D 42 2E D6 3F 76 7D 3D B1 A2 F0 3F 77 1B DD 44 24 44 DC 24 CD ?? ?? ?? ?? 89 C8 F7 D8 29 C8 DD 04 CD ?? ?? ?? ?? 40 EB 51 DD 44 24 44 D9 7C 24 3E DC 0D ?? ?? ?? ?? 66 8B 44 24 3E 80 CC 0C 66 }
	condition:
		$pattern
}

rule direxists_24c657cc8900262ebe4d2668aa20ae37 {
	meta:
		aliases = "direxists"
		size = "45"
		objfiles = "tempname@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 58 89 E2 52 50 E8 ?? ?? ?? ?? 5A 31 D2 59 85 C0 75 13 8B 44 24 10 31 D2 25 00 F0 00 00 3D 00 40 00 00 0F 94 C2 89 D0 83 C4 58 C3 }
	condition:
		$pattern
}

rule __GI_expm1_b154b222fb4d25eb37b5cc19b6f718d5 {
	meta:
		aliases = "expm1, __GI_expm1"
		size = "734"
		objfiles = "s_expm1@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 70 DD 44 24 74 DD 54 24 48 8B 54 24 4C 89 D0 89 D1 25 FF FF FF 7F 81 E1 00 00 00 80 3D 79 68 43 40 76 75 3D 41 2E 86 40 76 4A 3D FF FF EF 7F 76 23 DD 54 24 40 81 E2 FF FF 0F 00 0B 54 24 40 74 07 D8 C0 E9 88 02 00 00 DD D8 85 C9 0F 84 82 02 00 00 EB 39 DD D8 DD 05 ?? ?? ?? ?? DD 44 24 74 DA E9 DF E0 9E 76 0F DD 05 ?? ?? ?? ?? D8 C8 E9 5C 02 00 00 DD D8 85 C9 74 63 DD 44 24 74 DC 05 ?? ?? ?? ?? D9 EE DA E9 DF E0 9E 76 4C D9 05 ?? ?? ?? ?? E9 38 02 00 00 DD D8 3D 42 2E D6 3F 0F 86 9C 00 00 00 3D B1 A2 F0 3F 77 2D 85 C9 75 14 DD 44 24 74 DC 25 ?? ?? ?? ?? B1 01 DD 05 ?? ?? ?? ?? EB 6F DD 44 }
	condition:
		$pattern
}
...
rule __GI_getchar_unlocked_75c47541a7d5c00c85b3d0ef8462b780 {
	meta:
...
rule putwchar_1e470069265cfc60776f7040eb60ca96 {
	meta:
		aliases = "putwchar"
		size = "58"
		objfiles = "putwchar@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 15 ?? ?? ?? ?? 8B 4C 24 04 83 7A 34 00 74 1C 8B 42 10 3B 42 1C 73 0B 88 08 40 0F B6 C9 89 42 10 EB 14 52 51 E8 ?? ?? ?? ?? EB 07 52 51 E8 ?? ?? ?? ?? 89 C1 58 5A 89 C8 C3 }
	condition:
		$pattern
}

rule putchar_unlocked_8150606beb45f70d62decea21887c398 {
	meta:
		aliases = "putchar_unlocked"
		size = "43"
		objfiles = "putchar_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 15 ?? ?? ?? ?? 8B 4C 24 04 8B 42 10 3B 42 1C 73 0B 88 08 40 0F B6 C9 89 42 10 EB 0B 52 51 E8 ?? ?? ?? ?? 89 C1 58 5A 89 C8 C3 }
	condition:
		$pattern
}

rule endttyent_b0c4d07942bbc5fdfff2079cf619364d {
	meta:
		aliases = "__GI_endttyent, endttyent"
		size = "40"
		objfiles = "getttyent@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 15 ?? ?? ?? ?? B8 01 00 00 00 85 D2 74 18 52 E8 ?? ?? ?? ?? 40 5A 0F 95 C0 0F B6 C0 C7 05 ?? ?? ?? ?? 00 00 00 00 C3 }
	condition:
		$pattern
}
...
rule __GI_htonl_f0b2ac96b2a9c6535f6815b42030bed8 {
	meta:
		aliases = "htonl, ntohl, __GI_ntohl, __GI_htonl"
		size = "7"
...
rule sem_destroy_10e9a3f6e0aed68f5913ccc25b0c61e9 {
	meta:
		aliases = "__new_sem_destroy, sem_destroy"
		size = "29"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 31 D2 83 78 0C 00 74 0E E8 ?? ?? ?? ?? 83 CA FF C7 00 10 00 00 00 89 D0 C3 }
	condition:
		$pattern
}

rule __old_sem_destroy_60bf009b1ec46a5c51e38364acb7171c {
	meta:
		aliases = "__old_sem_destroy"
		size = "28"
		objfiles = "oldsemaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 31 D2 F6 00 01 75 0E E8 ?? ?? ?? ?? 83 CA FF C7 00 10 00 00 00 89 D0 C3 }
	condition:
		$pattern
}

rule sysconf_50c676c9d74c172ef7c80a304caa13bb {
	meta:
		aliases = "__GI_sysconf, sysconf"
		size = "241"
		objfiles = "sysconf@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 3D F0 00 00 00 77 0D FF 24 85 ?? ?? ?? ?? B8 01 00 00 00 C3 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF C3 B8 00 00 02 00 C3 B8 64 00 00 00 C3 B8 00 00 01 00 C3 E9 ?? ?? ?? ?? B8 06 00 00 00 C3 E9 ?? ?? ?? ?? B8 00 80 00 00 C3 B8 E8 03 00 00 C3 B8 00 40 00 00 C3 B8 00 10 00 00 C3 B8 F4 01 00 00 C3 B8 08 00 00 00 C3 31 C0 C3 B8 00 00 00 80 C3 B8 7F 00 00 00 C3 B8 80 FF FF FF C3 B8 00 80 FF FF C3 B8 FF FF 00 00 C3 B8 09 00 00 00 C3 6A 00 6A 01 E8 ?? ?? ?? ?? 5A 85 C0 59 79 0E EB 48 B8 FF FF FF 7F C3 B8 10 00 00 00 C3 B8 B0 0D 03 00 C3 B8 00 01 00 00 C3 B8 20 00 00 00 C3 B8 04 00 00 00 }
	condition:
		$pattern
}
...
rule ntohs_abb47f3111edd8b51bf0127264a91b58 {
	meta:
		aliases = "htons, __GI_ntohs, __GI_htons, ntohs"
		size = "12"
		objfiles = "ntohl@libc.a"
	strings:
...
rule __GI_perror_48e7c191b66db34a8b687bb7fb667927 {
	meta:
		aliases = "perror, __GI_perror"
		size = "47"
		objfiles = "perror@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 85 C0 74 0A BA ?? ?? ?? ?? 80 38 00 75 07 BA ?? ?? ?? ?? 89 D0 52 50 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 C3 }
	condition:
		$pattern
}
...
rule pthread_mutexattr_gettype_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, __GI_pthread_attr_getdetachstate, pthread_mutexattr_gettype"
		size = "15"
...
rule clntunix_geterr_d228862696409e46cb018968ddf1e7a6 {
	meta:
		aliases = "clntunix_geterr"
		size = "28"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 40 08 6A 0C 05 84 00 00 00 50 FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 0C C3 }
	condition:
		$pattern
}

rule clnttcp_geterr_2a9223b1ee4aa2df6eedace683ccaeb8 {
	meta:
		aliases = "clnttcp_geterr"
		size = "26"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 40 08 6A 0C 83 C0 24 50 FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 0C C3 }
	condition:
		$pattern
}

rule clntudp_geterr_3a4127ef5668d6e30dc9a7122be34bf4 {
	meta:
		aliases = "clntudp_geterr"
		size = "26"
		objfiles = "clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 40 08 6A 0C 83 C0 2C 50 FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule svctcp_freeargs_4281ac7ba9f123930dbca08b003c3316 {
	meta:
...
rule sem_getvalue_bf01487b64a973dd33d77632c300357d {
	meta:
		aliases = "__new_sem_getvalue, pthread_attr_getschedparam, __GI_pthread_attr_getschedparam, sem_getvalue"
		size = "16"
...
rule svcunix_stat_7a0f616380e8c4f74406a54da8552f14 {
	meta:
		aliases = "svctcp_stat, svcunix_stat"
		size = "33"
		objfiles = "svc_tcp@libc.a, svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 50 2C 31 C0 83 3A 00 74 12 8D 42 08 50 E8 ?? ?? ?? ?? 83 F8 01 59 19 C0 83 C0 02 C3 }
	condition:
		$pattern
}
...
rule authunix_marshal_a81479b146455dfab8f04233a78ce3c8 {
	meta:
		aliases = "authunix_marshal"
		size = "32"
		objfiles = "auth_unix@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 54 24 08 8B 40 24 8B 4A 04 FF B0 AC 01 00 00 83 C0 1C 50 52 FF 51 0C 83 C4 0C C3 }
	condition:
		$pattern
}

rule __GI_sigtimedwait_2d2bf51cea7cbd14135ec7717b69ec02 {
	meta:
...
rule __GI_setenv_e63fbd4454ec064dc8f9d0b775e2be85 {
	meta:
		aliases = "svcfd_create, svcunixfd_create, setenv, __GI_setenv"
		size = "17"
...
rule ffs_a33b31de334684ae134e31ce0e92ecf8 {
	meta:
		aliases = "__GI_ffs, ffs"
		size = "65"
		objfiles = "ffs@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 B2 01 66 85 C0 75 05 C1 F8 10 B2 11 84 C0 75 06 C1 F8 08 83 C2 08 A8 0F 75 06 C1 F8 04 83 C2 04 A8 03 75 06 C1 F8 02 83 C2 02 31 C9 85 C0 74 0A 40 83 E0 01 0F B6 D2 8D 0C 10 89 C8 C3 }
	condition:
		$pattern
}
...
rule sigdelset_016a84adaadaa75b24de597e41b23cce {
	meta:
...
rule __GI_re_search_15f6b841c36ec054a90439289c77596d {
	meta:
...
rule __GI_mbrlen_5cc209285f01f7ee7f966172a725a111 {
	meta:
...
rule __old_sem_init_0d881e98cf73c9f7b0a46fca467c9460 {
	meta:
		aliases = "__old_sem_init"
		size = "63"
		objfiles = "oldsemaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 0C 8B 54 24 04 85 C0 79 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 12 83 7C 24 08 00 74 0F E8 ?? ?? ?? ?? C7 00 26 00 00 00 83 C8 FF C3 8D 44 00 01 C7 42 04 00 00 00 00 89 02 31 C0 C3 }
	condition:
		$pattern
}

rule __GI___assert_c120ce0e52eb048154117785cf8a56f4 {
	meta:
...
rule __GI_mbsrtowcs_601a5834988a3975eb20803d2fd39bbf {
	meta:
...
rule mblen_65904738d1c8232c4c214c78e90f02bd {
	meta:
		aliases = "mblen"
		size = "64"
		objfiles = "mblen@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 85 D2 75 0D 31 C0 C7 05 ?? ?? ?? ?? 00 00 00 00 C3 31 C0 80 3A 00 74 23 68 ?? ?? ?? ?? FF 74 24 0C 52 E8 ?? ?? ?? ?? 83 C4 0C 83 F8 FE 75 0C C7 05 ?? ?? ?? ?? FF FF 00 00 B0 FF C3 }
	condition:
		$pattern
}
...
rule __GI_wcscoll_e91a61111c295dab6c061b7848cdcf0d {
	meta:
		aliases = "wcscoll, wcscmp, __GI_wcscmp, __GI_wcscoll"
		size = "36"
...
rule __GI___fpclassifyf_09749c32236500d95a770b7c26fc67aa {
	meta:
...
rule __GI_brk_405f291a269aeb9cf06be9b60d476d2a {
	meta:
		aliases = "brk, __GI_brk"
		size = "43"
		objfiles = "brk@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 B8 2D 00 00 00 31 C9 53 89 D3 CD 80 5B A3 ?? ?? ?? ?? 39 D0 73 0E E8 ?? ?? ?? ?? 83 C9 FF C7 00 0C 00 00 00 89 C8 C3 }
	condition:
		$pattern
}
...
rule l64a_849c065b862223138ac7c43ac2846a9b {
	meta:
		aliases = "l64a"
		size = "41"
		objfiles = "l64a@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 B9 ?? ?? ?? ?? EB 11 89 D0 C1 EA 06 83 E0 3F 8A 80 ?? ?? ?? ?? 88 01 41 85 D2 75 EB B8 ?? ?? ?? ?? C6 01 00 C3 }
	condition:
		$pattern
}

rule setbuf_e1e4435b71e12057a5e4983ba6cfc5f4 {
	meta:
		aliases = "setbuf"
		size = "32"
		objfiles = "setbuf@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 08 68 00 10 00 00 83 FA 01 19 C0 83 E0 02 50 52 FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 10 C3 }
	condition:
		$pattern
}

rule setlocale_0c91a71ebc64549290cc2b3175123600 {
	meta:
		aliases = "setlocale"
		size = "57"
		objfiles = "setlocale@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 08 83 7C 24 04 06 77 2B 85 D2 74 21 8A 02 84 C0 74 1B 3C 43 75 06 80 7A 01 00 74 11 68 ?? ?? ?? ?? 52 E8 ?? ?? ?? ?? 5A 85 C0 59 75 06 B8 ?? ?? ?? ?? C3 31 C0 C3 }
	condition:
		$pattern
}

rule setbuffer_32f6fd0254110e2dcc6693ad099f0aa2 {
	meta:
		aliases = "setbuffer"
		size = "31"
		objfiles = "setbuffer@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 08 83 FA 01 FF 74 24 0C 19 C0 83 E0 02 50 52 FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 10 C3 }
	condition:
		$pattern
}

rule mbtowc_72a06c26577cb8ba54eb75d0538137b3 {
	meta:
		aliases = "mbtowc"
		size = "68"
		objfiles = "mbtowc@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 08 85 D2 75 0D 31 C0 C7 05 ?? ?? ?? ?? 00 00 00 00 C3 31 C0 80 3A 00 74 27 68 ?? ?? ?? ?? FF 74 24 10 52 FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FE 75 0C C7 05 ?? ?? ?? ?? FF FF 00 00 B0 FF C3 }
	condition:
		$pattern
}
...
rule cfsetispeed_b2c24ce937f6228ffc1b8bfd35c394e9 {
	meta:
		aliases = "__GI_cfsetispeed, cfsetispeed"
		size = "77"
		objfiles = "speed@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 08 8B 4C 24 04 F7 C2 F0 EF FF FF 74 1A 8D 82 FF EF FF FF 83 F8 0E 76 0F E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF C3 85 D2 75 09 81 09 00 00 00 80 31 C0 C3 8B 41 08 81 21 FF FF FF 7F 25 F0 EF FF FF 09 C2 31 C0 89 51 08 C3 }
	condition:
		$pattern
}

rule __GI_cfsetospeed_0b9865f50b459123a1b44c3a26d6dbfa {
	meta:
		aliases = "cfsetospeed, __GI_cfsetospeed"
		size = "58"
		objfiles = "speed@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 08 8B 4C 24 04 F7 C2 F0 EF FF FF 74 1A 8D 82 FF EF FF FF 83 F8 0E 76 0F E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF C3 8B 41 08 25 F0 EF FF FF 09 C2 31 C0 89 51 08 C3 }
	condition:
		$pattern
}
...
rule posix_memalign_42a8ec785b0839857338e64ab579a98e {
	meta:
		aliases = "posix_memalign"
		size = "41"
		objfiles = "posix_memalign@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 08 B8 16 00 00 00 F6 C2 03 75 1A FF 74 24 0C 52 E8 ?? ?? ?? ?? 8B 54 24 0C 83 F8 01 89 02 19 C0 5A 83 E0 0C 59 C3 }
	condition:
		$pattern
}

rule re_compile_pattern_87908efb660d803e8a4dd00faea089e5 {
	meta:
		aliases = "re_compile_pattern"
		size = "60"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 0C 8A 42 1C 83 E0 E9 83 C8 80 88 42 1C 52 8B 54 24 0C 8B 0D ?? ?? ?? ?? 8B 44 24 08 E8 ?? ?? ?? ?? 31 D2 59 85 C0 74 0E 0F B7 84 00 ?? ?? ?? ?? 8D 90 ?? ?? ?? ?? 89 D0 C3 }
	condition:
		$pattern
}

rule __new_sem_init_acdb51d324237cc4b6210e03969a57f7 {
	meta:
		aliases = "sem_init, __new_sem_init"
		size = "73"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 0C 8B 44 24 04 85 D2 79 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 12 83 7C 24 08 00 74 0F E8 ?? ?? ?? ?? C7 00 26 00 00 00 83 C8 FF C3 C7 00 00 00 00 00 C7 40 04 00 00 00 00 89 50 08 C7 40 0C 00 00 00 00 31 C0 C3 }
	condition:
		$pattern
}

rule xdrstdio_getbytes_f6745f5acad771f00a8fe9bac2f3d64b {
	meta:
...
rule __close_nameservers_eb6aef87601a3b8bbd28b9bf80ce656d {
	meta:
		aliases = "__close_nameservers"
		size = "96"
		objfiles = "closenameservers@libc.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? 3D ?? ?? ?? ?? 74 07 50 E8 ?? ?? ?? ?? 59 C7 05 ?? ?? ?? ?? 00 00 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 EB 17 8D 50 FF A1 ?? ?? ?? ?? 89 15 ?? ?? ?? ?? FF 34 90 E8 ?? ?? ?? ?? 5A A1 ?? ?? ?? ?? 85 C0 75 E0 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 58 C3 }
	condition:
		$pattern
}

rule token_fd7d9b2c0b2e8f6cad2f2aaa4d35f7ad {
	meta:
		aliases = "token"
		size = "353"
		objfiles = "ruserpass@libc.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? 53 0F B7 00 A8 0C 0F 85 4C 01 00 00 8B 15 ?? ?? ?? ?? 8B 42 10 3B 42 18 73 09 0F B6 08 40 89 42 10 EB 12 52 E8 ?? ?? ?? ?? 89 C1 58 83 F9 FF 0F 84 23 01 00 00 8D 41 F7 83 F8 01 76 CF 83 F9 20 74 CA 83 F9 2C 74 C5 BB ?? ?? ?? ?? 83 F9 22 74 2A EB 54 83 FA 5C 75 20 8B 0D ?? ?? ?? ?? 8B 41 10 3B 41 18 73 09 0F B6 10 40 89 41 10 EB 09 51 E8 ?? ?? ?? ?? 89 C2 58 88 13 43 8B 0D ?? ?? ?? ?? 8B 41 10 3B 41 18 73 09 0F B6 10 40 89 41 10 EB 0E 51 E8 ?? ?? ?? ?? 89 C2 58 83 FA FF 74 75 83 FA 22 75 AE EB 6E BB ?? ?? ?? ?? 88 0D ?? ?? ?? ?? EB 28 83 FA 5C 75 20 8B 0D ?? ?? ?? ?? 8B 41 10 3B }
	condition:
		$pattern
}

rule __GI_setttyent_d499f86c6d12eca26ba438f2a42c4e56 {
	meta:
		aliases = "setttyent, __GI_setttyent"
		size = "68"
		objfiles = "getttyent@libc.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? 85 C0 74 0D 50 E8 ?? ?? ?? ?? BA 01 00 00 00 EB 2A 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 31 D2 59 85 C0 74 0F 6A 02 50 E8 ?? ?? ?? ?? BA 01 00 00 00 59 58 89 D0 C3 }
	condition:
		$pattern
}

rule _rpcdata_7bdb2058b7e4db70b242caad4199b158 {
	meta:
		aliases = "_rpcdata"
		size = "29"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? 85 C0 75 13 68 B0 10 00 00 6A 01 E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 59 C3 }
	condition:
		$pattern
}

rule __setutent_5cb8ce2bc67bdcbb40690623d4ba8989 {
	meta:
		aliases = "__setutent"
		size = "96"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? 85 C0 79 49 68 02 00 08 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 59 85 C0 79 1B 68 00 00 08 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 59 85 C0 78 20 6A 01 6A 02 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C C3 6A 00 6A 00 50 E8 ?? ?? ?? ?? 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule __pthread_getconcurrency_9306906a3a71020f26be39b72f98096c {
	meta:
		aliases = "__libc_current_sigrtmax, __libc_current_sigrtmin, pthread_getconcurrency, __pthread_getconcurrency"
		size = "6"
		objfiles = "allocrtsig@libc.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? C3 }
...
rule authnone_validate_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "floatformat_always_valid, old_sem_extricate_func, xdr_void, __GI_xdr_void, __GI__stdlib_mb_cur_max, _stdlib_mb_cur_max, authnone_validate"
		size = "6"
		objfiles = "floatformat@libiberty.a, xdr@libc.a, oldsemaphore@libpthread.a, auth_none@libc.a, _stdlib_mb_cur_max@libc.a"
	strings:
...
rule svcraw_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		aliases = "rendezvous_stat, _svcauth_short, svcudp_stat, svcraw_stat"
		size = "6"
		objfiles = "svc_authux@libc.a, svc_unix@libc.a, svc_raw@libc.a, svc_udp@libc.a, svc_tcp@libc.a"
	strings:
...
rule __rpc_thread_variables_f105bcff39a3052357cc990fc037a478 {
	meta:
		aliases = "__rpc_thread_variables"
		size = "196"
		objfiles = "rpc_thread@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? 53 85 C0 74 0A 6A 02 E8 ?? ?? ?? ?? 5A EB 05 A1 ?? ?? ?? ?? 89 C3 85 C0 0F 85 9D 00 00 00 B8 ?? ?? ?? ?? 85 C0 74 13 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 5B EB 18 83 3D ?? ?? ?? ?? 00 75 0F E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 01 00 00 00 B8 ?? ?? ?? ?? 85 C0 74 0A 6A 02 E8 ?? ?? ?? ?? 5A EB 05 A1 ?? ?? ?? ?? 89 C3 85 C0 75 4B 68 C8 00 00 00 6A 01 E8 ?? ?? ?? ?? 59 85 C0 5B 74 1F 89 C3 B8 ?? ?? ?? ?? 85 C0 74 0C 53 6A 02 E8 ?? ?? ?? ?? 58 5A EB 22 89 1D ?? ?? ?? ?? EB 1A B8 ?? ?? ?? ?? 85 C0 74 0A 6A 02 E8 ?? ?? ?? ?? 59 EB 05 A1 ?? ?? ?? ?? 89 C3 89 D8 5B C3 }
	condition:
		$pattern
}

rule __rpc_thread_destroy_e6f276ed418870e08f8d32069901f053 {
	meta:
		aliases = "__rpc_thread_destroy"
		size = "159"
		objfiles = "rpc_thread@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? 53 85 C0 74 0C 6A 02 E8 ?? ?? ?? ?? 89 C3 58 EB 06 8B 1D ?? ?? ?? ?? 85 DB 74 7D 81 FB ?? ?? ?? ?? 74 75 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? FF B3 98 00 00 00 E8 ?? ?? ?? ?? FF B3 9C 00 00 00 E8 ?? ?? ?? ?? FF B3 A0 00 00 00 E8 ?? ?? ?? ?? FF B3 BC 00 00 00 E8 ?? ?? ?? ?? FF B3 AC 00 00 00 E8 ?? ?? ?? ?? FF B3 B0 00 00 00 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? B8 ?? ?? ?? ?? 83 C4 1C 85 C0 74 0D 6A 00 6A 02 E8 ?? ?? ?? ?? 59 5B EB 0A C7 05 ?? ?? ?? ?? ?? ?? ?? ?? 5B C3 }
	condition:
		$pattern
}
...
rule __h_errno_location_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__res_state, __errno_location, __GI___errno_location, __GI___h_errno_location, __libc_pthread_init, __h_errno_location"
		size = "6"
		objfiles = "_res_state@libc.a, __errno_location@libc.a, __h_errno_location@libc.a, libc_pthread_init@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C3 }
	condition:
		$pattern
...
rule clntraw_geterr_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "__cyg_profile_func_enter, authunix_nextverf, __cyg_profile_func_exit, _pthread_cleanup_push_defer, clntunix_abort, pthread_handle_sigdebug, noop_handler, clnttcp_abort, __linuxthreads_death_event, xdrmem_destroy, __linuxthreads_create_event, __linuxthreads_reap_event, authnone_verf, pthread_null_sighandler, clntraw_destroy, __pthread_return_void, svcraw_destroy, _pthread_cleanup_pop_restore, clntraw_abort, authnone_destroy, clntudp_abort, clntraw_geterr"
		size = "1"
		objfiles = "events@libpthread.a, clnt_tcp@libc.a, xdr_mem@libc.a, clnt_raw@libc.a, noophooks@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule llrintf_50a91947cae998517b5cdd3fc44f02d3 {
	meta:
		aliases = "llroundf, llrintf"
		size = "18"
		objfiles = "llroundf@libm.a, llrintf@libm.a"
	strings:
...
rule lrintf_f5f2daa96b9e124cf33f93c469bdf2db {
	meta:
		aliases = "ilogbf, lroundf, lrintf"
		size = "18"
		objfiles = "lrintf@libm.a, lroundf@libm.a, ilogbf@libm.a"
	strings:
...
rule svctcp_rendezvous_abort_ae5fed6b8dcb4a035c3321eab387f4a2 {
	meta:
...
rule on_exit_0e3b8fb107a752cfcf70068e85af4076 {
	meta:
		aliases = "on_exit"
		size = "37"
		objfiles = "on_exit@libc.a"
	strings:
		$pattern = { ( CC | E8 ) ?? ?? ?? ?? 89 C2 83 C8 FF 85 D2 74 16 8B 44 24 04 89 42 04 8B 44 24 08 C7 02 02 00 00 00 89 42 08 31 C0 C3 }
	condition:
		$pattern
}
...
rule setusershell_f978d55b1c3afa3f9f39e2d020c376e3 {
	meta:
...
rule __GI___rpc_thread_svc_fdset_4da2cb06603d3f5bdf5f8c9dd8de006b {
	meta:
...
rule __GI___rpc_thread_createerr_024a094824dcfbecdf69afeb092da282 {
	meta:
...
rule __GI___rpc_thread_svc_pollfd_8d1b807f756056cf87e7019d67127eb1 {
	meta:
...
rule endusershell_527e91973fd0aeb0216b7d08b8358694 {
	meta:
		aliases = "endusershell"
		size = "16"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { ( CC | E8 ) ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 C3 }
	condition:
		$pattern
}

rule __GI_raise_fdf1f4eeabbc454044f76306b8595759 {
	meta:
		aliases = "raise, __GI_raise"
		size = "18"
...
rule mq_close_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "xdr_int, xdr_longlong_t, xdr_enum, partition_delete, __GI_cabs, __GI_setmntent, xdr_u_longlong_t, cabs, splay_tree_xmalloc_deallocate, vfork, rand, xdr_u_int, __GI_xdr_int, __GI_xdr_u_int, __GI_xdr_enum, setmntent, __pthread_initialize, mq_close"
		size = "5"
		objfiles = "rand@libc.a, mq_close@librt.a, xdr@libc.a, mntent@libc.a, ptfork@libpthread.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule _dl_app_fini_array_d0a919a1423a1611f85f059ef10ad627 {
	meta:
		aliases = "getwchar_unlocked, getwchar, _dl_app_fini_array"
		size = "13"
...
rule __free_initshell_memory_0579e046e4172a11e5b587670bf0bbd4 {
	meta:
		aliases = "__free_initshell_memory"
		size = "45"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { ( CC | FF ) 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 C7 05 ?? ?? ?? ?? 00 00 00 00 5A C3 }
	condition:
		$pattern
}
...
rule __GI_execv_82b716818f0867f9c21d2e5a6d1174c5 {
	meta:
...
rule putw_9b0d1f565ba4f9bdd72e3694c4327da8 {
	meta:
		aliases = "putw"
		size = "23"
		objfiles = "putw@libc.a"
	strings:
		$pattern = { ( CC | FF ) 74 24 08 6A 01 6A 04 8D 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 10 48 C3 }
	condition:
		$pattern
}
...
rule __GI_exp2_2217aae7994b9c57ff98a046d856d477 {
	meta:
...
rule __GI_fdim_64c9defb23930e7add12048ca4a272d4 {
	meta:
		aliases = "fdim, __GI_fdim"
		size = "56"
		objfiles = "s_fdim@libm.a"
	strings:
		$pattern = { ( CC | FF ) 74 24 08 FF 74 24 08 E8 ?? ?? ?? ?? 5A 83 F8 01 59 77 07 D9 05 ?? ?? ?? ?? C3 DD 44 24 04 DD 44 24 0C D9 C9 DA E9 DF E0 9E 77 03 D9 EE C3 DD 44 24 04 DC 64 24 0C C3 }
	condition:
		$pattern
}

rule __GI_fmax_b9c81aaddf890973b1976483fdd13880 {
	meta:
		aliases = "fmax, __GI_fmax"
		size = "74"
		objfiles = "s_fmax@libm.a"
	strings:
		$pattern = { ( CC | FF ) 74 24 08 FF 74 24 08 E8 ?? ?? ?? ?? 5A 85 C0 59 74 32 FF 74 24 10 FF 74 24 10 E8 ?? ?? ?? ?? 5A 85 C0 59 75 06 DD 44 24 0C EB 11 DD 44 24 04 DD 44 24 0C D9 C9 DD E9 DF E0 9E 77 06 DD 5C 24 04 EB 02 DD D8 DD 44 24 04 C3 }
	condition:
		$pattern
}

rule fmin_37c0b53ef473184550b357136d6c9efc {
	meta:
		aliases = "__GI_fmin, fmin"
		size = "76"
		objfiles = "s_fmin@libm.a"
	strings:
		$pattern = { ( CC | FF ) 74 24 08 FF 74 24 08 E8 ?? ?? ?? ?? 5A 85 C0 59 74 34 FF 74 24 10 FF 74 24 10 E8 ?? ?? ?? ?? 5A 85 C0 59 75 06 DD 44 24 0C EB 13 DD 44 24 0C DD 44 24 04 D9 C9 DD E1 DF E0 DD D9 9E 77 06 DD 5C 24 04 EB 02 DD D8 DD 44 24 04 C3 }
	condition:
		$pattern
}

rule __GI_ldexp_dec599ff2c252ef55f4caa38b8f3290c {
	meta:
		aliases = "ldexp, __GI_ldexp"
		size = "108"
		objfiles = "s_ldexp@libm.a"
	strings:
		$pattern = { ( CC | FF ) 74 24 08 FF 74 24 08 E8 ?? ?? ?? ?? 5A 85 C0 59 74 54 DD 44 24 04 D9 EE D9 C9 DA E9 DF E0 9E 7A 02 74 43 FF 74 24 0C FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? DD 54 24 10 83 EC 08 DD 1C 24 E8 ?? ?? ?? ?? 83 C4 14 85 C0 74 11 DD 44 24 04 D9 EE D9 C9 DA E9 DF E0 9E 75 0D 7A 0B E8 ?? ?? ?? ?? C7 00 22 00 00 00 DD 44 24 04 C3 }
	condition:
		$pattern
}

rule vwprintf_8656ba417f55ecd54498627fc6f064b6 {
	meta:
		aliases = "vscanf, vwscanf, __GI_vscanf, vprintf, vwprintf"
		size = "23"
...
rule __GI_fseek_c988c3466338bd611a4c400ed6b310ad {
	meta:
