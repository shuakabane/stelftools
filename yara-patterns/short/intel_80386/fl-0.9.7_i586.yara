...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "__GI_pthread_attr_destroy, __pthread_mutex_init, pthread_rwlockattr_destroy, __pthread_mutex_unlock, clntraw_control, __pthread_mutexattr_destroy, __GI_pthread_condattr_init, __pthread_return_0, __pthread_mutex_lock, pthread_condattr_destroy, _svcauth_null, pthread_mutexattr_destroy, grantpt, pthread_attr_destroy, wcsftime, __pthread_mutex_trylock, authnone_refresh, __GI_wcsftime, __GI_pthread_condattr_destroy, pthread_condattr_init, xdrstdio_inline"
		size = "3"
		objfiles = "__uClibc_main@libc.a, xdr_stdio@libc.a, rwlock@libpthread.a, mutex@libpthread.a, auth_none@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __GI___libc_getdomainname_697f99fee411f6ddffe6bd60370a0f43 {
	meta:
...
rule create_module_4a0428b5f3cab94ec3eb2b7bcd4bc274 {
	meta:
		aliases = "create_module"
		size = "79"
		objfiles = "create_module@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 7F 00 00 00 CD 80 87 D3 89 C3 3D 00 F0 FF FF 76 0B E8 ?? ?? ?? ?? F7 DB 89 18 EB 05 83 F8 FF 75 1B E8 ?? ?? ?? ?? 89 C1 8B 10 83 C8 FF 83 FA 7D 7E 0A 89 D0 C7 01 00 00 00 00 F7 D8 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __GI_nrand48_r_a81af4fea099a4f26cc7fe23c493e2fc {
	meta:
...
rule __GI_fgetc_unlocked_a8c421194d2423dabb3cc9829e1d3697 {
	meta:
		aliases = "__GI___fgetc_unlocked, __GI_getc_unlocked, getc_unlocked, __fgetc_unlocked, fgetc_unlocked, __GI_fgetc_unlocked"
		size = "220"
...
rule __GI_endservent_4534faf6da303f19be4e28c6b005a74d {
	meta:
...
rule tcdrain_f62998a482170cde13f7c89dcfb26a0d {
	meta:
		aliases = "wait, fsync, system, tcdrain"
		size = "48"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule accept_7fafe2d4042f052134436ac4f9e768f2 {
	meta:
		aliases = "waitpid, __GI_waitpid, lseek, sendmsg, accept"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule msync_f76fa2a31d5e51010722d3c9bb015e20 {
	meta:
		aliases = "recvmsg, read, connect, write, msync"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule send_6894871a989d3f602582424ca6f209e8 {
	meta:
...
rule __GI_fesetenv_23ef82075323aa3a1588dbb85e52d4e5 {
	meta:
...
rule __GI_trunc_b72eca406354aa8ebde620c06cc08322 {
	meta:
...
rule __GI_pmap_unset_70ae8c5b3bf4c1aa86425e39738467f7 {
	meta:
...
rule __GI_asinh_f850c830c191a7b99d207a0f7ecb1a3a {
	meta:
...
rule __GI_statfs64_bdaa2a93a7b943a45b4b2e0a2e535741 {
	meta:
...
rule __GI_vswprintf_4a86c3c2f9247105492ca9d91ce9c088 {
	meta:
...
rule __GI_brk_96a8dd69d54fc6d1396ff8dd54350fab {
	meta:
...
rule _Unwind_GetRegionStart_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "__udiv_w_sdiv, __gthread_active_p, _Unwind_FindEnclosingFunction, _Unwind_GetDataRelBase, _Unwind_GetTextRelBase, _Unwind_GetRegionStart"
		size = "7"
		objfiles = "unwind_sjlj@libgcc.a, gthr_gnat@libgcc.a, _udiv_w_sdiv@libgcc.a"
	strings:
...
rule __GI_vfwscanf_a7e61db9eb32b00b378edbe33435a54b {
	meta:
...
rule _dl_load_elf_shared_library_2c8dd6d4a699d92e7d4aa9ecf6975107 {
	meta:
		aliases = "_dl_load_elf_shared_library"
		size = "2731"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 1C 01 00 00 31 C9 31 D2 8B BC 24 38 01 00 00 53 89 FB B8 05 00 00 00 CD 80 5B 89 44 24 30 3D 00 F0 FF FF 76 09 F7 D8 A3 ?? ?? ?? ?? EB 07 83 7C 24 30 00 79 0F C7 05 ?? ?? ?? ?? 01 00 00 00 E9 47 0A 00 00 8D 8C 24 D8 00 00 00 8B 54 24 30 87 D3 B8 6C 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 76 09 F7 D8 A3 ?? ?? ?? ?? EB 04 85 C0 79 0C C7 05 ?? ?? ?? ?? 01 00 00 00 EB 14 83 BC 24 30 01 00 00 00 74 1E F6 84 24 E1 00 00 00 08 75 14 8B 7C 24 30 53 89 FB B8 06 00 00 00 CD 80 5B E9 E9 07 00 00 8B 2D ?? ?? ?? ?? EB 44 31 D2 0F B7 84 24 D8 00 00 00 39 95 E0 00 00 00 75 2F 39 85 DC 00 00 00 }
	condition:
		$pattern
}
...
rule fstatvfs_6eafe54c51900ba68fb84167c6522ad8 {
	meta:
...
rule fstatvfs64_325c5b4f29e6a8ede8ff98f0d0b39323 {
	meta:
...
rule _vfprintf_internal_7fabf786f73ff16889f4908a7de4c299 {
	meta:
		aliases = "_vfprintf_internal"
		size = "1472"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 64 01 00 00 8B 9C 24 7C 01 00 00 53 8D 74 24 1C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 3E 8B 5C 24 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 C7 04 24 FF FF FF FF 0F 84 70 05 00 00 52 FF B4 24 74 01 00 00 50 53 E8 ?? ?? ?? ?? C7 44 24 10 FF FF FF FF 83 C4 10 E9 51 05 00 00 50 50 FF B4 24 80 01 00 00 56 E8 ?? ?? ?? ?? C7 44 24 10 00 00 00 00 89 DA 83 C4 10 EB 01 43 8A 03 84 C0 74 04 3C 25 75 F5 39 D3 74 27 89 DE 31 C0 29 D6 85 F6 7E 12 50 FF B4 24 74 01 00 00 56 52 E8 ?? ?? ?? ?? 83 C4 10 39 F0 0F 85 F9 04 00 00 01 04 24 80 3B 00 0F 84 F4 04 00 00 8D 53 01 80 7B 01 25 0F 84 D8 }
	condition:
		$pattern
}

rule __GI_rexec_af_b31b57906a0b716c30f8e28e808a8c79 {
	meta:
...
rule __GI_getnameinfo_613f22513e741e598986df5d27b0617a {
	meta:
...
rule __GI_ttyname_r_33677fe423ae7893c1a36a2939a1edcf {
	meta:
...
rule __GI_authunix_create_c2126e373038033180a1acf8f2060937 {
	meta:
...
rule __GI_inet_aton_32666ab30b03c390581585dad1044276 {
	meta:
...
rule __GI_pthread_setschedparam_1b3a40f84b3c3875f0e8b0e2beb94ab3 {
	meta:
...
rule __GI_svc_getreqset_8e05f9a1ba649bc73847b2ecf0118b0e {
	meta:
...
rule rwlock_have_already_62f3aa0a02b7137e35f4baac0a444020 {
	meta:
		aliases = "rwlock_have_already"
		size = "175"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 89 C7 89 D6 89 CD 8B 18 83 7A 18 01 74 06 31 D2 31 C9 EB 74 85 DB 75 07 E8 ?? ?? ?? ?? 89 C3 8B 93 C0 01 00 00 EB 07 39 72 04 74 08 8B 12 85 D2 75 F5 EB 04 85 D2 75 54 83 BB C8 01 00 00 00 7F 4B 8B 93 C4 01 00 00 85 D2 74 0A 8B 02 89 83 C4 01 00 00 EB 0F 83 EC 0C 6A 0C E8 ?? ?? ?? ?? 83 C4 10 89 C2 85 D2 74 18 C7 42 08 01 00 00 00 89 72 04 8B 83 C0 01 00 00 89 02 89 93 C0 01 00 00 83 FA 01 19 C9 83 E1 01 31 F6 EB 07 31 C9 BE 01 00 00 00 8B 44 24 20 89 08 89 55 00 89 F0 89 1F 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI___ns_name_unpack_c6f9a44634d10b693eba726651f9b4aa {
	meta:
...
rule __GI_sgetspent_r_33dd0def94ef4e31f36fa082d8ec76f6 {
	meta:
...
rule __GI_wcsncasecmp_b66e88cb9267b1e98f13497d0256b995 {
	meta:
...
rule getgrgid_r_ed40c1faabc4a642f9697592d9ba9bd1 {
	meta:
...
rule __GI_getpwnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "getgrnam_r, getspnam_r, getpwnam_r, __GI_getspnam_r, __GI_getgrnam_r, __GI_getpwnam_r"
		size = "153"
...
rule __GI_srandom_r_37971e170acd7e552d6c51e7c79de2fb {
	meta:
...
rule inet_pton4_031fcd6bedcdc1e9eb9ec2410fcd9e19 {
	meta:
		aliases = "inet_pton4"
		size = "135"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 89 D5 89 C3 31 D2 31 FF 8D 74 24 18 C6 44 24 18 00 EB 40 0F BE C0 43 8D 48 D0 83 F9 09 77 20 0F B6 06 6B C0 0A 8D 04 01 3D FF 00 00 00 77 47 88 06 85 D2 75 1E 47 83 FF 04 7F 3B B2 01 EB 14 83 F8 2E 75 32 85 D2 74 2E 83 FF 04 74 29 46 31 D2 C6 06 00 8A 03 84 C0 75 BA 83 FF 03 7E 18 50 6A 04 8D 44 24 20 50 55 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 10 EB 02 31 C0 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_getprotoent_r_ab00ff47957760b9db7e49a5e9ce4909 {
	meta:
...
rule __GI_getservent_r_494fa0c8b152205e20171c18f617b8a5 {
	meta:
...
rule mbsnrtowcs_4f77dce0ece09bf25cdafcaabfe8c73c {
	meta:
		aliases = "__GI_mbsnrtowcs, mbsnrtowcs"
		size = "157"
		objfiles = "mbsnrtowcs@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 44 24 40 8B 54 24 30 8B 74 24 38 8B 5C 24 3C 85 C0 75 05 B8 ?? ?? ?? ?? 85 D2 74 11 B9 01 00 00 00 39 C2 75 11 8D 54 24 18 30 C9 EB 09 8D 54 24 18 83 CB FF 31 C9 89 DF 39 F3 76 02 89 F7 8B 44 24 34 89 FE 8D 2C 8D 00 00 00 00 8B 18 EB 28 8A 03 0F B6 C8 89 0A 84 C0 75 04 31 DB EB 1D 83 F9 7F 7E 10 E8 ?? ?? ?? ?? C7 00 54 00 00 00 83 C8 FF EB 1A 43 01 EA 4E 85 F6 75 D4 8D 44 24 18 39 C2 74 06 8B 44 24 34 89 18 89 F8 29 F0 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule wcsnrtombs_06129977af4c600ed67450052e374447 {
	meta:
		aliases = "__GI_wcsnrtombs, wcsnrtombs"
		size = "135"
		objfiles = "wcsnrtombs@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 54 24 30 8B 6C 24 34 8B 4C 24 38 8B 44 24 3C 85 D2 74 12 BF 01 00 00 00 39 EA 75 12 66 31 FF 8D 54 24 0C EB 09 31 FF 8D 54 24 0C 83 C8 FF 89 C6 39 C8 76 02 89 CE 8B 4D 00 89 F3 EB 27 8B 01 83 F8 7F 76 10 E8 ?? ?? ?? ?? C7 00 54 00 00 00 83 C8 FF EB 23 88 02 84 C0 75 04 31 C9 EB 0A 83 C1 04 01 FA 4B 85 DB 75 D5 8D 44 24 0C 39 C2 74 03 89 4D 00 89 F0 29 D8 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_xdr_pmaplist_449c0d309a81f277b8a1094fda98e22b {
	meta:
...
rule __GI_ungetwc_78ca5dbf78d16394ff4a3b9c20773293 {
	meta:
...
rule __GI_ungetc_295f4a46922900bc15c5253f6b2f16d8 {
	meta:
...
rule __GI_ceil_fedaf470d5d76645d590c105b47d92e2 {
	meta:
...
rule __GI_floor_d67a13ba65b73d5f121fe2edca05a52a {
	meta:
...
rule __GI_ptsname_r_85906e3d724a004e73e1987c0fc1e67c {
	meta:
...
rule __GI_rresvport_84689ccdc763c83e16bb746b9b971984 {
	meta:
...
rule __GI_xdrrec_create_d09a7c33c7adfff872e9f30f9a486b46 {
	meta:
...
rule __GI_svcudp_bufcreate_dfffa7cb5c2ac45b7c002ae65e75eeed {
	meta:
...
rule __GI_inet_pton_0d56f42db60637ecf4f01b5d0ce310ea {
	meta:
...
rule __GI___ns_name_ntop_d9b07895f591f44e79a634d8815d19c8 {
	meta:
...
rule __GI_fseeko64_fec3a3bd7f1b96d34adbdb99b141a928 {
	meta:
...
rule __GI_rtime_06cb6f84c6fd3e43f5d4f2385170db2b {
	meta:
...
rule __GI_mallinfo_5a8cd7995be61900e806d57052a58083 {
	meta:
...
rule inet_ntop4_3f2d77719e6c130b90174e1f5351161f {
	meta:
		aliases = "inet_ntop4"
		size = "260"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 31 ED FC 89 44 24 14 66 A1 ?? ?? ?? ?? 66 89 44 24 2B 8D 7C 24 2D 31 C0 89 54 24 10 89 4C 24 0C 31 DB AB AB AB 66 AB AA E9 86 00 00 00 8B 44 24 14 B1 64 01 E8 8D 73 01 89 44 24 18 89 DF 0F B6 10 89 D0 F6 F1 88 C1 8D 41 30 88 44 1C 2B 3C 30 75 23 B1 0A 89 D0 F6 F1 31 D2 B9 0A 00 00 00 0F B6 C0 66 F7 F1 83 C2 30 88 54 1C 2B 80 FA 30 74 21 89 F7 EB 1D B1 0A 89 D0 F6 F1 0F B6 C0 B9 0A 00 00 00 31 D2 66 F7 F1 83 C2 30 8D 7B 02 88 54 34 2B 8B 54 24 18 B9 0A 00 00 00 8D 5F 02 45 0F B6 02 31 D2 C6 44 3C 2C 2E 66 F7 F1 83 C2 30 88 54 3C 2B 83 FD 03 0F 8E 71 FF FF FF C6 44 1C 2A 00 }
	condition:
		$pattern
}
...
rule __GI_clnttcp_create_affea8611bfa15a8adc6b05e090482cb {
	meta:
...
rule __GI_clntunix_create_3be8d212b832d5ac73460e8f9994c4c7 {
	meta:
...
rule __GI___xpg_strerror_r_d4952ccdbde5f6c4420058ed88f24475 {
	meta:
...
rule __GI_gethostbyname_r_2c57b49ce803a2df93ffc086abff42a8 {
	meta:
...
rule __GI_getaddrinfo_351889e4f5caf3e1ef4c4e3378a2f543 {
	meta:
...
rule __GI_inet_ntop_6d74a11f2f38c63778021087d161190d {
	meta:
...
rule _ppfs_parsespec_f0906116f75c3487203f703eeb29893c {
	meta:
		aliases = "_ppfs_parsespec"
		size = "944"
		objfiles = "_ppfs_parsespec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 5C 8B 44 24 70 C7 44 24 44 00 00 00 00 C7 44 24 48 00 00 00 00 C7 44 24 50 08 00 00 00 C7 44 24 54 08 00 00 00 8B 54 24 70 8B 40 18 89 44 24 14 8B 6A 10 81 E5 80 00 00 00 75 04 8B 12 EB 39 31 F6 8B 44 24 70 8D 0C B5 00 00 00 00 8B 10 8B 44 11 FC 88 44 34 24 88 C3 0F BE C0 3B 44 11 FC 0F 85 3A 03 00 00 84 DB 74 06 46 83 FE 1F 76 D2 C6 44 24 43 00 8D 54 24 25 C7 44 24 0C 00 00 00 00 C7 44 24 10 00 00 00 00 EB 02 89 F2 89 D6 80 3A 2A 75 10 6B 44 24 10 FC 8D 72 01 C7 44 04 50 00 00 00 00 31 DB EB 10 81 FB FE 0F 00 00 7F 07 6B C3 0A 8D 5C 38 D0 46 8A 0E A1 ?? ?? ?? ?? 0F BE F9 F6 }
	condition:
		$pattern
}
...
rule __GI_gethostbyaddr_r_e343d596b38dcae602486c67b39ad14c {
	meta:
...
rule __GI_strftime_5f03e2a2ec9ea4cf80a280e4a3b28b70 {
	meta:
...
rule __GI_random_r_bdfc847281fa1aed34370a8358a98733 {
	meta:
...
rule __new_sem_wait_c12a729886216ce43bf3af67f7255350 {
	meta:
...
rule byte_re_match_2_internal_c6465bf762292bb434000487b6990882 {
	meta:
		aliases = "byte_re_match_2_internal"
		size = "7009"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 0C 01 00 00 89 85 4C FF FF FF 89 95 48 FF FF FF 89 8D 44 FF FF FF 8B 00 8B 95 4C FF FF FF 89 85 70 FF FF FF 8D 7C 24 0F 03 42 08 83 E7 F0 89 85 74 FF FF FF 8B 5D 18 8B 4A 14 89 8D 7C FF FF FF 8B 72 18 89 7D CC 46 89 75 80 83 7A 18 00 75 41 C7 45 8C 00 00 00 00 C7 45 90 00 00 00 00 C7 45 94 00 00 00 00 C7 45 98 00 00 00 00 C7 45 9C 00 00 00 00 C7 45 A4 00 00 00 00 C7 45 A8 00 00 00 00 C7 45 B4 00 00 00 00 C7 45 B8 00 00 00 00 EB 79 8B 55 80 8D 04 95 1E 00 00 00 83 E0 F0 29 C4 8D 4C 24 0F 29 C4 83 E1 F0 8D 74 24 0F 29 C4 89 4D 8C 83 E6 F0 8D 7C 24 0F 29 C4 89 75 90 83 E7 }
	condition:
		$pattern
}
...
rule __GI_ruserpass_1c61b436e55dd08b3934c6e3af9313f5 {
	meta:
...
rule __GI_execvp_9979608c49b26da7cb2a97c62a5b7896 {
	meta:
...
rule __GI_pthread_cond_wait_1efd4c42c372b353c253db5511a0bcce {
	meta:
...
rule __GI_pthread_cond_timedwait_cb1dc7a86ee9403f83f4138ae42cf731 {
	meta:
...
rule __GI_if_nameindex_4db0ca82c0e4cbd64297cb39da71164b {
	meta:
...
rule __gcov_merge_delta_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gcov_init, __gnat_default_lock, __gcov_merge_single, __gcov_merge_add, __gnat_default_unlock, __clear_cache, __gcov_flush, __enable_execute_stack, __gcov_merge_delta"
		size = "5"
		objfiles = "_gcov@libgcov.a, _gcov_merge_add@libgcov.a, _enable_execute_stack@libgcc.a, _gcov_merge_delta@libgcov.a, _gcov_merge_single@libgcov.a"
	strings:
...
rule __GI_pthread_setcancelstate_efd30b30a55e0154f8d6161c6795e34f {
	meta:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "semaphore@libpthread.a, rwlock@libpthread.a, cancel@libpthread.a, mutex@libpthread.a, errno@libpthread.a"
	strings:
...
rule strrchr_1064dcfd946443de55f2d95baa3ddb8b {
	meta:
...
rule tmpfile_71f42f699352b81a553f537fd7697e23 {
	meta:
...
rule __new_sem_post_f5e89c77a12e94543e183bed2caf6fda {
	meta:
...
rule __GI_tsearch_dd62047fd384e5a177a0e6b86ec3c708 {
	meta:
...
rule __GI_pthread_cond_signal_4f1374a2b6e2a344e7a8e8247134c0e9 {
	meta:
...
rule __GI_sbrk_5da6f61f4a99247f0e8249a8087cb0eb {
	meta:
...
rule setegid_eaccc4a129305672e7693e1a65c54c04 {
	meta:
...
rule __GI_xprt_unregister_9aa999b9f4f90fa5c74350ab71ca9879 {
	meta:
...
rule __pthread_mutex_lock_885e23d49abbd7b85d5e325b45c1d22f {
	meta:
...
rule siglongjmp_be9e6548214836180c2cfadd5a9f8fd0 {
	meta:
...
rule __GI__authenticate_df94f6e68188a959ec9787aba3410e7a {
	meta:
...
rule __GI_mempcpy_b930ef2d821c66b1e2908efada814b15 {
	meta:
...
rule __GI_xdr_opaque_auth_2b8a68d2f67bb93e97d3a79a3b69e311 {
	meta:
...
rule __GI_xdr_pmap_74a6e0c9086d7cf1ad7d564079f19c95 {
	meta:
...
rule fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetspent_r, fgetspent_r, __GI_fgetgrent_r, fgetgrent_r, __GI_fgetpwent_r, fgetpwent_r"
		size = "55"
...
rule ftell_c696decca2bd132fb15f420a442ba902 {
	meta:
...
rule __GI_putc_unlocked_3285cd6d795474f19a1a1b20ef0fa5ce {
	meta:
		aliases = "__fputc_unlocked, putc_unlocked, __GI___fputc_unlocked, fputc_unlocked, __GI_putc_unlocked"
		size = "197"
...
rule fgetc_28533b1cefabf1ab94ce337a9bba49c5 {
	meta:
...
rule __GI_readdir64_bd90089c675a5cd4281c19dd7bb2ebfe {
	meta:
...
rule __GI_atan_cd60429695f6b925c91b88adf452008b {
	meta:
...
rule __GI_remquo_955ebf69aa28338c914affa6fb0a06a5 {
	meta:
...
rule __GI_vsscanf_c310d5c4c2ffde34feb10dbb5ccaf5e2 {
	meta:
...
rule __GI_cbrt_b90f09b9c1b182f13fb073485fab2074 {
	meta:
...
rule __GI_rawmemchr_ba8eecbe4523993fe879a2197d2af6bc {
	meta:
...
rule __GI_memchr_1c0fb819850398050fc6f9ad07b87ec7 {
	meta:
...
rule mknod_ba7ee27594d01874d89d11445f9d47b2 {
	meta:
		aliases = "__GI_mknod, mknod"
		size = "86"
		objfiles = "mknod@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 04 8B 4C 24 18 8B 5C 24 1C 89 DA 89 C8 0F AC D0 08 C1 EA 08 89 C2 81 E2 FF 0F 00 00 8B 7C 24 10 0F B6 C1 C1 E2 08 8B 4C 24 14 09 C2 53 89 FB B8 0E 00 00 00 CD 80 5B 89 C7 3D 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 CF FF 89 F8 5A 5B 5F C3 }
	condition:
		$pattern
}
...
rule __GI_ftruncate64_677fd04184e4d6834a1d7df25522f7b2 {
	meta:
...
rule __GI_opendir_2ae5eb5632af36a6c7c9467c37191efe {
	meta:
		aliases = "opendir, __GI_opendir"
		size = "241"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 DB 83 EC 68 68 00 08 01 00 FF 74 24 7C E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 0F 88 C5 00 00 00 53 53 8D 44 24 10 50 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 12 51 6A 01 6A 02 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 16 E8 ?? ?? ?? ?? 83 EC 0C 89 C3 8B 30 57 E8 ?? ?? ?? ?? 89 33 EB 75 83 EC 0C 6A 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 50 89 C3 89 38 C7 40 10 00 00 00 00 C7 40 08 00 00 00 00 C7 40 04 00 00 00 00 8B 44 24 38 89 43 14 3D FF 01 00 00 77 07 C7 43 14 00 02 00 00 52 52 FF 73 14 6A 01 E8 ?? ?? ?? ?? 83 C4 10 89 43 0C 85 C0 75 24 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 57 E8 ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_lseek64_4585e21c0a7df5eb2224221695978297 {
	meta:
...
rule __GI_fflush_93a22b501911da46837877b2ae54b32f {
	meta:
...
rule fileno_47b2021f9ad3c9dae34d9b79ccbd71b9 {
	meta:
		aliases = "getwc, __GI_fgetwc, fgetwc, __GI_fileno, fileno"
		size = "92"
...
rule __GI_fputc_86c5438cba725a7dd860bf3f983c677e {
	meta:
...
rule fputwc_27a00bae78ad279095482cf1967e990f {
	meta:
		aliases = "fputws, putwc, __GI_fputws, __GI_fputs, fputs, fputwc"
		size = "95"
...
rule __GI_fgets_1c2fc372b815e752ffcd0a80282d91cc {
	meta:
...
rule getgrent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "__GI_getpwent_r, getspent_r, __GI_getgrent_r, getpwent_r, __GI_getspent_r, getgrent_r"
		size = "171"
		objfiles = "getspent_r@libc.a, getpwent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule __GI_ftello64_604e763f2b59696431950ca623ec14de {
	meta:
...
rule __GI_authnone_create_30fe8edd1a8c90c0137acbd5f61c214d {
	meta:
...
rule __GI_rint_6bef69894480930b6bbe611c186593ed {
	meta:
...
rule __GI_modf_14aabae875f1d524e8e15222410ece45 {
	meta:
...
rule __GI_vsnprintf_718ca6ad3f006d5ab02428a4fd38755a {
	meta:
...
rule __GI_erfc_ca7e44d704bbe12a8612fe8f08f4f469 {
	meta:
...
rule __getdents_13cda0d43eef31c59cbe1f9dcee64238 {
	meta:
		aliases = "__getdents"
		size = "111"
		objfiles = "getdents@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 5C 24 14 52 FF 74 24 1C 53 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 89 C6 85 C0 8D 3C 03 7F 43 EB 45 8B 43 08 89 43 04 8B 43 10 66 89 43 08 8A 43 12 88 43 0A 50 0F B7 43 08 83 E8 13 50 8D 43 13 50 8D 43 0B 50 E8 ?? ?? ?? ?? 83 C4 0C 0F B7 43 08 50 53 53 E8 ?? ?? ?? ?? 0F B7 43 08 83 C4 10 01 C3 39 FB 72 BB 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_wcscasecmp_07a7db35ef58bbe9a3c5fe5ce5ba64f2 {
	meta:
...
rule __GI_getrpcbyname_fbca9fa376ea67bbb7a6cd21baabdec0 {
	meta:
...
rule wctype_d6275519c949212fc55b1c924c9ebd87 {
	meta:
...
rule __GI___libc_fcntl64_dac7a519acf3cd3fd904a48f0f206f30 {
	meta:
...
rule strtoull_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "waitpid, __GI_wcstoull, wcstouq, __libc_waitpid, wcstoul, wcstoull, strtoumax, __GI_strtoul, wcstoumax, __GI_waitpid, strtouq, strtoul, __GI_wcstoul, __GI_strtoull, strtoull"
		size = "26"
		objfiles = "wcstoull@libc.a, waitpid@libc.a, wcstoul@libc.a, strtoul@libc.a, strtoull@libc.a"
	strings:
...
rule wcstoq_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "strtoq, __GI_strtoll, wcstol, wcstoimax, strtoimax, __GI_strtol, wcstoll, strtoll, __GI_wcstol, __GI_wcstoll, strtol, wcstoq"
		size = "26"
...
rule __GI_sigdelset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigismember, sigaddset, __GI_sigaddset, sigdelset, __GI_sigdelset"
		size = "42"
...
rule __GI___isinf_a50f4cf220a5bc6beaee760c8c40c7ca {
	meta:
...
rule __GI_strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__ieee754_lgamma, __ieee754_gamma, lgamma, gamma, __GI_lgamma, strtok, __GI_strtok"
		size = "25"
		objfiles = "w_gamma@libm.a, e_lgamma@libm.a, e_gamma@libm.a, strtok@libc.a, w_lgamma@libm.a"
	strings:
...
rule __GI_strtold_1da02766b2a304b7f969428fc4c15b06 {
	meta:
		aliases = "__GI_wcstold, wcstold, strtold, __GI_strtold"
		size = "22"
...
rule atoi_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "__GI_atol, atol, __GI_atoi, atoll, atoi"
		size = "20"
...
rule scalblnf_312f3131b70190222fba14e3c3defea1 {
	meta:
		...
		size = "34"
		objfiles = "scalbnf@libm.a, scalblnf@libm.a, ldexpf@libm.a, frexpf@libm.a"
	strings:
...
rule inet_ntoa_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "srand48, asctime, hcreate, __GI_inet_ntoa, ether_ntoa, __GI_asctime, inet_ntoa"
		size = "21"
		objfiles = "inet_ntoa@libc.a, hsearch@libc.a, srand48@libc.a, ether_addr@libc.a, asctime@libc.a"
	strings:
...
rule mktime_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "timelocal, __GI_iswalnum, iswalnum, mkstemp64, mktime"
		size = "18"
...
rule __GI_copysign_d260624d15229b7965a94dfb7eafef2f {
	meta:
...
rule pone_6fb2fdebeae7cd87f5fa825a727f92b4 {
	meta:
		aliases = "pzero, pone"
		size = "175"
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "semaphore@libpthread.a, rwlock@libpthread.a, manager@libpthread.a, spinlock@libpthread.a, condvar@libpthread.a"
	strings:
...
rule getlogin_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__pthread_once_fork_prepare, _flushlbf, __pthread_once_fork_parent, __GI_getlogin, hdestroy, getlogin"
		size = "17"
...
rule open64_9165478e24a6d5c355c5f08accf4b480 {
	meta:
		aliases = "__GI_open64, __GI___libc_open64, __libc_open64, open64"
		size = "45"
...
rule xdrstdio_putint32_7dc79e05c0a901da8f5fca95c692f5f8 {
	meta:
...
rule scanf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "printf, wprintf, __GI_printf, wscanf, scanf"
		size = "32"
...
rule __GI_fprintf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "asprintf, fscanf, __GI_syslog, syslog, __GI_sscanf, fwscanf, fwprintf, __GI_fscanf, sscanf, swscanf, __GI_asprintf, dprintf, fprintf, __GI_fprintf"
		size = "30"
		objfiles = "asprintf@libc.a, fprintf@libc.a, syslog@libc.a, swscanf@libc.a, fscanf@libc.a"
	strings:
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "lrintf, llrintf, llroundf, ilogbf, lroundf"
		size = "19"
		objfiles = "llrintf@libm.a, ilogbf@libm.a, lrintf@libm.a, llroundf@libm.a, lroundf@libm.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "logf, erfcf, lgammaf, cbrtf, acoshf, erff, coshf, asinf, acosf, tgammaf, rintf, ceilf, cosf, atanf, fabsf, logbf, log1pf, log10f, expf, sqrtf, sinhf, roundf, tanf, tanhf, atanhf, asinhf, sinf, expm1f, floorf, truncf"
		size = "27"
		objfiles = "erfcf@libm.a, tanhf@libm.a, cosf@libm.a, acosf@libm.a, rintf@libm.a"
	strings:
...
rule hypotf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "fmodf, atan2f, copysignf, remainderf, powf, nextafterf, hypotf"
		size = "35"
...
rule fgetgrent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetpwent, getpwuid, getspnam, fgetspent, getgrnam, getgrgid, getpwnam, sgetspent, fgetgrent"
		size = "40"
		objfiles = "getpwnam@libc.a, getspnam@libc.a, getgrnam@libc.a, fgetspent@libc.a, fgetgrent@libc.a"
	strings:
...
rule __GI_log1p_3623ef62101b0b952d24f6f43ac45cfa {
	meta:
...
rule __GI_expm1_be447a90bb4a767a30aa993588ab6bbc {
	meta:
...
rule pthread_mutexattr_gettype_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_rwlockattr_getkind_np, pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, pthread_mutexattr_gettype"
		size = "15"
...
rule __GI_xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "authnone_validate, old_sem_extricate_func, xdr_void, floatformat_always_valid, _stdlib_mb_cur_max, __GI__stdlib_mb_cur_max, __GI_xdr_void"
		size = "6"
		objfiles = "oldsemaphore@libpthread.a, auth_none@libc.a, _stdlib_mb_cur_max@libc.a, floatformat@libiberty.a, xdr@libc.a"
	strings:
...
rule svcraw_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_raw@libc.a, svc_tcp@libc.a, svc_authux@libc.a, svc_unix@libc.a, svc_udp@libc.a"
	strings:
...
rule __errno_location_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__GI___h_errno_location, __libc_pthread_init, __GI___errno_location, __h_errno_location, __errno_location"
		size = "6"
...
rule __linuxthreads_create_event_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "clntraw_destroy, clnttcp_abort, _pthread_cleanup_pop_restore, clntunix_abort, __stub2, __stub1, pthread_handle_sigdebug, authnone_verf, authunix_nextverf, __cyg_profile_func_exit, authnone_destroy, __cyg_profile_func_enter, clntraw_abort, xdrmem_destroy, _pthread_cleanup_push_defer, svcraw_destroy, __pthread_return_void, clntraw_geterr, pthread_null_sighandler, noop_handler, __linuxthreads_reap_event, clntudp_abort, __linuxthreads_death_event, __linuxthreads_create_event"
		size = "1"
		objfiles = "__uClibc_main@libc.a, xdr_mem@libc.a, resolv@libresolv.a, nsl@libnsl.a, lckpwdf@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule cosh_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "__GI_cabs, __GI_sinh, __GI_fmod, acos, __GI_pow, __GI_atan2, __GI_nearbyint, xdr_int, nearbyint, __GI_log, j1, mq_close, __decode_packet, sinh, atanh, j0, log, y1, __GI_acosh, __GI_xdr_u_int, __GI_xdr_int, atan2, yn, pow, xdr_longlong_t, cabs, splay_tree_xmalloc_deallocate, lgamma_r, y0, xdr_u_longlong_t, xdr_u_int, __GI_exp, __GI_asin, vfork, __pthread_initialize, __GI_atanh, exp, __ieee754_gamma_r, __GI_sqrt, __GI_acos, jn, rand, __GI_log10, hypot, __GI_hypot, partition_delete, log2, drem, asin, __GI_cosh"
		size = "5"
		objfiles = "w_cosh@libm.a, w_lgamma_r@libm.a, w_scalb@libm.a, w_log2@libm.a, rand@libc.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
