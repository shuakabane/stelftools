...
rule __GI_wcsftime_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "__pthread_mutex_lock, pthread_attr_destroy, _svcauth_null, clntraw_control, __pthread_mutex_init, pthread_condattr_init, __pthread_mutex_trylock, __pthread_mutexattr_destroy, pthread_mutexattr_destroy, authnone_refresh, __GI_pthread_condattr_destroy, __pthread_return_0, __GI_pthread_condattr_init, grantpt, pthread_condattr_destroy, xdrstdio_inline, wcsftime, pthread_rwlockattr_destroy, __pthread_mutex_unlock, __GI_pthread_attr_destroy, __GI_wcsftime"
		size = "3"
		objfiles = "svc_auth@libc.a, wcsftime@libc.a, grantpt@libc.a, attr@libpthread.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __GI___fgetc_unlocked_a8c421194d2423dabb3cc9829e1d3697 {
	meta:
		aliases = "__fgetc_unlocked, getc_unlocked, __GI_fgetc_unlocked, __GI_getc_unlocked, fgetc_unlocked, __GI___fgetc_unlocked"
		size = "220"
...
rule fsync_f62998a482170cde13f7c89dcfb26a0d {
	meta:
		aliases = "wait, system, tcdrain, fsync"
		size = "48"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule msync_f76fa2a31d5e51010722d3c9bb015e20 {
	meta:
		aliases = "read, write, recvmsg, connect, msync"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule pwrite_6894871a989d3f602582424ca6f209e8 {
	meta:
		aliases = "recv, pread, send, pwrite"
		size = "60"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __udiv_w_sdiv_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "_Unwind_FindEnclosingFunction, _Unwind_GetDataRelBase, __gthread_active_p, _Unwind_GetRegionStart, _Unwind_GetTextRelBase, __udiv_w_sdiv"
		size = "7"
...
rule shm_open_e9e4f1b5d6e51f99e5918d026f826659 {
	meta:
		aliases = "shm_open"
		size = "135"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 83 CF FF 8B 44 24 20 E8 ?? ?? ?? ?? 89 C5 85 C0 74 64 56 FF 74 24 2C FF 74 24 2C 50 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 78 35 53 6A 00 6A 01 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 14 83 C8 01 51 50 6A 02 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0F 83 EC 0C 57 83 CF FF E8 ?? ?? ?? ?? 83 C4 10 E8 ?? ?? ?? ?? 83 EC 0C 89 C3 8B 30 55 E8 ?? ?? ?? ?? 89 33 83 C4 10 83 C4 0C 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_getspnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "getgrnam_r, getpwnam_r, __GI_getgrnam_r, __GI_getpwnam_r, getspnam_r, __GI_getspnam_r"
		size = "153"
...
rule __GI_mbsnrtowcs_8039277dec93dd7f511719476529c23d {
	meta:
...
rule __GI_wcsnrtombs_d56483bdfc71df9f704061100853bf68 {
	meta:
...
rule __re_search_2_df4838d7cedbb3617c597aa2cdb0dcf4 {
	meta:
...
rule __GI_getservbyport_r_dd4d26cf37929f555c16395d791a53d1 {
	meta:
...
rule __regexec_b38baa016eb28040c8bcc50ce0d6ddbc {
	meta:
...
rule __GI___res_query_426c246664fe80e78ab4980b4ac06ec4 {
	meta:
...
rule __gcov_merge_single_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gnat_default_lock, __clear_cache, __gcov_merge_add, __gcov_flush, __gnat_default_unlock, __gcov_init, __gcov_merge_delta, __enable_execute_stack, __gcov_merge_single"
		size = "5"
		objfiles = "_clear_cache@libgcc.a, _gcov_merge_single@libgcov.a, _gcov@libgcov.a, _enable_execute_stack@libgcc.a, gthr_gnat@libgcc_eh.a"
	strings:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "join@libpthread.a, signals@libpthread.a, pthread@libpthread.a, semaphore@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule __libc_siglongjmp_be9e6548214836180c2cfadd5a9f8fd0 {
	meta:
		aliases = "siglongjmp, longjmp, __libc_longjmp, _longjmp, __libc_siglongjmp"
		size = "51"
...
rule __GI_fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "fgetgrent_r, __GI_fgetgrent_r, __GI_fgetspent_r, fgetpwent_r, fgetspent_r, __GI_fgetpwent_r"
		size = "55"
...
rule __GI_erf_7782de98d840aae40bd337bcd093afde {
	meta:
...
rule __GI_fputs_27a00bae78ad279095482cf1967e990f {
	meta:
		aliases = "fputs, fputwc, fputws, __GI_fputws, putwc, __GI_fputs"
		size = "95"
...
rule __GI_getspent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "getspent_r, getpwent_r, getgrent_r, __GI_getpwent_r, __GI_getgrent_r, __GI_getspent_r"
		size = "171"
		objfiles = "getspent_r@libc.a, getgrent_r@libc.a, getpwent_r@libc.a"
	strings:
...
rule __GI_mknod_c4b8bb50e4c6da372633c0af55c79899 {
	meta:
...
rule fstatat_49c6b0374e054cc236242306bd2332dd {
	meta:
		aliases = "fstatat"
		size = "82"
		objfiles = "fstatat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 44 8B 7C 24 50 8B 4C 24 54 8B 74 24 5C 8D 54 24 04 53 89 FB B8 2C 01 00 00 CD 80 5B 89 C6 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DE 89 30 83 CE FF EB 13 85 C0 75 0F 50 50 FF 74 24 60 52 E8 ?? ?? ?? ?? 83 C4 10 89 F0 83 C4 44 5E 5F C3 }
	condition:
		$pattern
}
...
rule __libc_fcntl64_dac7a519acf3cd3fd904a48f0f206f30 {
	meta:
		aliases = "fcntl64, __GI___libc_fcntl64, __GI_fcntl64, __libc_fcntl64"
		size = "63"
...
rule waitpid_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "__libc_waitpid, strtoull, __GI_wcstoull, __GI_waitpid, wcstoull, __GI_wcstoul, wcstoul, __GI_strtoull, strtoumax, strtouq, __GI_strtoul, wcstoumax, strtoul, wcstouq, waitpid"
		size = "26"
		objfiles = "strtoul@libc.a, wcstoull@libc.a, strtoull@libc.a, wcstoul@libc.a, waitpid@libc.a"
	strings:
...
rule __GI_wcstoll_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "strtoq, wcstoq, strtoll, strtoimax, __GI_strtoll, __GI_strtol, __GI_wcstol, wcstoimax, wcstoll, strtol, wcstol, __GI_wcstoll"
		size = "26"
...
rule __GI_sigdelset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigdelset, __GI_sigaddset, sigismember, sigaddset, __GI_sigdelset"
		size = "42"
...
rule __ieee754_lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "gamma, __GI_lgamma, strtok, __ieee754_gamma, lgamma, __GI_strtok, __ieee754_lgamma"
		size = "25"
		objfiles = "e_lgamma@libm.a, w_lgamma@libm.a, e_gamma@libm.a, w_gamma@libm.a, strtok@libc.a"
	strings:
...
rule atoi_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "__GI_atol, atoll, atol, __GI_atoi, atoi"
		size = "20"
...
rule vwscanf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "vscanf, __GI_vscanf, vprintf, vwprintf, vwscanf"
		size = "26"
...
rule hcreate_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "__GI_asctime, ether_ntoa, srand48, __GI_inet_ntoa, asctime, inet_ntoa, hcreate"
		size = "21"
...
rule __GI_sigpause_6bf719c25f6fbaef08052b0889ae3660 {
	meta:
		aliases = "sigpause, mkstemp, atof, __GI_sigpause"
		size = "18"
...
rule timelocal_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "__GI_iswalnum, mkstemp64, mktime, iswalnum, timelocal"
		size = "18"
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "manager@libpthread.a, join@libpthread.a, pthread@libpthread.a, semaphore@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule _flushlbf_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__GI_getlogin, hdestroy, __pthread_once_fork_parent, getlogin, __pthread_once_fork_prepare, _flushlbf"
		size = "17"
...
rule scanf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "__GI_printf, printf, wprintf, wscanf, scanf"
		size = "32"
...
rule sscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "fwprintf, __GI_fscanf, dprintf, fscanf, __GI_sscanf, __GI_asprintf, syslog, fwscanf, __GI_fprintf, fprintf, swscanf, __GI_syslog, asprintf, sscanf"
		size = "30"
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		size = "19"
		objfiles = "ilogbf@libm.a, llrintf@libm.a, lroundf@libm.a, lrintf@libm.a, llroundf@libm.a"
	strings:
...
rule erfcf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "logf, cosf, expf, sinf, rintf, tanf, log1pf, cbrtf, floorf, fabsf, truncf, lgammaf, sqrtf, erff, expm1f, tanhf, acosf, asinf, ceilf, roundf, atanf, acoshf, log10f, tgammaf, sinhf, asinhf, coshf, atanhf, logbf, erfcf"
		size = "27"
		objfiles = "expf@libm.a, ceilf@libm.a, logbf@libm.a, roundf@libm.a, asinf@libm.a"
	strings:
...
rule copysignf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "atan2f, hypotf, nextafterf, powf, remainderf, fmodf, copysignf"
		size = "35"
		objfiles = "atan2f@libm.a, fmodf@libm.a, hypotf@libm.a, powf@libm.a, nextafterf@libm.a"
	strings:
...
rule getspnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetgrent, getgrnam, fgetspent, getgrgid, fgetpwent, sgetspent, getpwuid, getpwnam, getspnam"
		size = "40"
		objfiles = "fgetgrent@libc.a, sgetspent@libc.a, getgrnam@libc.a, getpwnam@libc.a, getspnam@libc.a"
	strings:
...
rule __pthread_mutexattr_gettype_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_rwlockattr_getkind_np, pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, pthread_mutexattr_getkind_np, __GI_pthread_attr_getdetachstate, __pthread_mutexattr_gettype"
		size = "15"
...
rule authnone_validate_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "floatformat_always_valid, __GI__stdlib_mb_cur_max, xdr_void, old_sem_extricate_func, __GI_xdr_void, _stdlib_mb_cur_max, authnone_validate"
		size = "6"
		objfiles = "xdr@libc.a, floatformat@libiberty.a, oldsemaphore@libpthread.a, auth_none@libc.a, _stdlib_mb_cur_max@libc.a"
	strings:
...
rule __errno_location_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__GI___errno_location, __h_errno_location, __libc_pthread_init, __GI___h_errno_location, __errno_location"
		size = "6"
...
rule authnone_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "pthread_null_sighandler, clntraw_destroy, clnttcp_abort, clntraw_abort, authunix_nextverf, __stub1, pthread_handle_sigdebug, clntudp_abort, svcraw_destroy, _pthread_cleanup_push_defer, __stub2, _pthread_cleanup_pop_restore, __linuxthreads_create_event, __pthread_return_void, clntraw_geterr, xdrmem_destroy, __linuxthreads_reap_event, __linuxthreads_death_event, clntunix_abort, __cyg_profile_func_enter, authnone_verf, noop_handler, __cyg_profile_func_exit, authnone_destroy"
		size = "1"
		objfiles = "signals@libpthread.a, pthread@libpthread.a, svc_raw@libc.a, events@libpthread.a, lckpwdf@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "acos, xdr_u_int, setmntent, mq_close, __GI_nearbyint, __GI_log10, exp, jn, remainder, log10, __GI_xdr_u_int, vfork, cosh, sinh, __GI_xdr_int, __ieee754_gamma_r, cabs, __GI_sinh, atan2, acosh, y1, __GI_acosh, __GI_atan2, lgamma_r, sqrt, __GI_remainder, __GI_log, nearbyint, log2, __GI_asin, splay_tree_xmalloc_deallocate, partition_delete, __GI_atanh, __GI_fmod, pow, atanh, __decode_packet, __GI_acos, scalb, __GI_hypot, log, __GI_setmntent, __GI_sqrt, j0, drem, __GI_pow, __GI_cosh, asin, j1, xdr_longlong_t"
		size = "5"
		objfiles = "mq_close@librt.a, w_j0@libm.a, w_jn@libm.a, w_acosh@libm.a, xdr@libc.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
