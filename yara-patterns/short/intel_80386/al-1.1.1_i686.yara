...
rule htons_7b942809982b61be55aeb0f9cbfb815a {
	meta:
		aliases = "ntohs, __GI_ntohs, __GI_htons, htons"
		size = "13"
...
rule __libc_sa_len_f3eac5894f9e45a3edb88a8194c9406b {
	meta:
		aliases = "__libc_sa_len"
		size = "39"
		objfiles = "sa_len@libc.a"
	strings:
		$pattern = { ( CC | 0F ) B7 44 24 04 BA 10 00 00 00 66 83 F8 02 74 14 66 83 F8 0A B2 1C 74 0C 66 48 B2 6E B8 00 00 00 00 0F 45 D0 89 D0 C3 }
	condition:
		$pattern
}
...
rule __GI_pthread_condattr_init_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "__pthread_mutexattr_destroy, xdrstdio_inline, pthread_condattr_destroy, authnone_refresh, __GI_pthread_attr_destroy, pthread_mutexattr_destroy, pthread_condattr_init, __pthread_mutex_lock, __pthread_mutex_unlock, pthread_rwlockattr_destroy, grantpt, __pthread_mutex_init, pthread_attr_destroy, __GI_pthread_condattr_destroy, _svcauth_null, __pthread_return_0, __pthread_mutex_trylock, clntraw_control, wcsftime, __GI_pthread_condattr_init"
		size = "3"
		objfiles = "condvar@libpthread.a, attr@libpthread.a, auth_none@libc.a, rwlock@libpthread.a, clnt_raw@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule setup_salt_85142324c3cbebd9d12e8f6112b08be9 {
	meta:
		aliases = "setup_salt"
		size = "75"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 3B ) 05 ?? ?? ?? ?? 89 C2 56 53 74 3C BE 00 00 80 00 BB 01 00 00 00 31 C9 A3 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 EB 1A A1 ?? ?? ?? ?? 09 F0 85 DA 0F 44 05 ?? ?? ?? ?? 01 DB D1 EE 41 A3 ?? ?? ?? ?? 83 F9 17 7E E1 5B 5E C3 }
	condition:
		$pattern
}
...
rule __cxa_atexit_9cad7aea5399451845ad99a50317bb80 {
	meta:
		aliases = "__GI___cxa_atexit, __cxa_atexit"
		size = "57"
		objfiles = "__cxa_atexit@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 C0 83 EC 08 8B 5C 24 10 85 DB 74 27 E8 ?? ?? ?? ?? 89 C2 83 C8 FF 85 D2 74 19 89 5A 04 8B 44 24 14 C7 02 03 00 00 00 89 42 08 8B 44 24 18 89 42 0C 31 C0 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __GI_glob_pattern_p_8c5bf7ded8ba16741023e0f1eee79a50 {
	meta:
		aliases = "glob_pattern_p, __GI_glob_pattern_p"
		size = "85"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 C9 8B 5C 24 0C 8B 54 24 08 EB 37 3C 5B 74 16 77 0A 3C 2A 74 37 3C 3F 75 28 EB 31 3C 5C 74 0D 3C 5D 75 1E EB 18 B9 01 00 00 00 EB 15 85 DB 74 11 80 7A 01 00 8D 42 01 74 08 89 C2 EB 04 85 C9 75 0B 42 8A 02 84 C0 75 C3 31 C0 EB 05 B8 01 00 00 00 5B C3 }
	condition:
		$pattern
}

rule __GI_open_683dbe0625bda01b2f9f7235b0271ff6 {
	meta:
		aliases = "__libc_open, open, __GI_open"
		size = "69"
		objfiles = "open@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 D2 83 EC 18 8B 4C 24 24 F6 C1 40 74 0C 8B 54 24 28 8D 44 24 2C 89 44 24 14 8B 44 24 20 53 89 C3 B8 05 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule __pthread_manager_sighandler_7af48a928d9acbd7e3a1d3abc09f2ed9 {
	meta:
		aliases = "__pthread_manager_sighandler"
		size = "97"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 31 D2 83 EC 28 A1 ?? ?? ?? ?? 85 C0 75 0C 31 D2 83 3D ?? ?? ?? ?? 00 0F 95 C2 85 D2 C7 05 ?? ?? ?? ?? 01 00 00 00 74 33 C7 44 24 0C 00 00 00 00 8D 5C 24 0C C7 44 24 10 06 00 00 00 50 6A 1C 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E1 83 C4 28 5B C3 }
	condition:
		$pattern
}
...
rule __GI_sleep_c450cac51ba0ba7f0b87ebf483b04d29 {
	meta:
		aliases = "sleep, __GI_sleep"
		size = "159"
		objfiles = "sleep@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 DB 83 EC 38 8B 44 24 40 85 C0 0F 84 86 00 00 00 89 44 24 30 C7 44 24 2C 00 00 00 00 C7 44 24 28 00 00 01 00 C7 44 24 34 00 00 00 00 53 8D 44 24 18 50 6A 00 6A 11 E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 14 01 75 11 51 8D 44 24 2C 50 50 6A 00 E8 ?? ?? ?? ?? 83 C4 10 52 31 DB 52 8D 44 24 38 50 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 11 31 DB 81 7C 24 34 FF 64 CD 1D 0F 9F C3 03 5C 24 30 F6 44 24 2A 01 75 12 50 6A 00 8D 44 24 30 50 6A 02 E8 ?? ?? ?? ?? 83 C4 10 83 C4 38 89 D8 5B C3 }
	condition:
		$pattern
}

rule __GI_log10_f768502971406932090d910116144b2a {
	meta:
		aliases = "__ieee754_log10, log10, __GI_log10"
		size = "234"
		objfiles = "e_log10@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 31 DB 83 EC 38 DD 44 24 40 DD 54 24 10 DD 5C 24 28 8B 4C 24 2C 8B 54 24 28 81 F9 FF FF 0F 00 7F 48 89 C8 25 FF FF FF 7F 09 D0 75 0D D9 EE D8 3D ?? ?? ?? ?? E9 AB 00 00 00 85 C9 79 11 DD 44 24 10 D8 E0 DC 35 ?? ?? ?? ?? E9 96 00 00 00 DD 44 24 10 BB CA FF FF FF D8 0D ?? ?? ?? ?? DD 54 24 10 DD 5C 24 20 8B 4C 24 24 81 F9 FF FF EF 7F 7E 08 DD 44 24 10 D8 C0 EB 6B 89 C8 81 E1 FF FF 0F 00 C1 F8 14 8D 84 03 01 FC FF FF 89 C2 C1 EA 1F 8D 04 02 50 B8 FF 03 00 00 DB 04 24 29 D0 83 EC 04 DD 44 24 18 C1 E0 14 09 C8 DD 5C 24 20 89 44 24 24 FF 74 24 24 FF 74 24 24 DD 5C 24 10 E8 ?? ?? ?? ?? DD 44 24 10 }
	condition:
		$pattern
}
...
rule tempnam_0e57f80464f34af1b523e868d738387a {
	meta:
		aliases = "tempnam"
		size = "85"
		objfiles = "tempnam@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 81 EC 08 10 00 00 FF B4 24 14 10 00 00 FF B4 24 14 10 00 00 68 FF 0F 00 00 8D 5C 24 15 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 20 50 6A 00 6A 03 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 0E 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 EB 02 31 C0 81 C4 08 10 00 00 5B C3 }
	condition:
		$pattern
}
...
rule getdomainname_8b4ef73be17f423b0978b5e948c46812 {
	meta:
...
rule __ieee754_hypot_e30ae263b30d51abf54e7d76686c7637 {
	meta:
		aliases = "__GI_hypot, hypot, __ieee754_hypot"
		size = "769"
		objfiles = "e_hypot@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 81 EC A8 00 00 00 DD 84 24 B0 00 00 00 DD 54 24 08 DD 84 24 B8 00 00 00 DD 14 24 D9 C9 DD 94 24 80 00 00 00 D9 C9 DD 54 24 78 8B 8C 24 84 00 00 00 8B 54 24 7C 81 E1 FF FF FF 7F 81 E2 FF FF FF 7F 39 CA 7E 0F 89 D0 89 CA DD 9C 24 88 00 00 00 89 C1 EB 12 DD D8 DD D8 DD 44 24 08 DD 9C 24 88 00 00 00 DD 04 24 DD 9C 24 90 00 00 00 DD 84 24 88 00 00 00 89 C8 29 D0 DD 5C 24 70 3D 00 00 C0 03 89 4C 24 74 DD 44 24 70 DD 9C 24 98 00 00 00 DD 84 24 90 00 00 00 DD 5C 24 68 89 54 24 6C DD 44 24 68 DD 94 24 A0 00 00 00 7E 0E DD 84 24 98 00 00 00 DE C1 E9 3E 02 00 00 DD D8 31 DB 81 F9 00 00 30 5F 0F 8E 89 }
	condition:
		$pattern
}
...
rule __getutent_f121c1e00aa7d7a79fd13aa12da155f3 {
	meta:
		aliases = "__getutent"
		size = "95"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 83 3D ?? ?? ?? ?? 00 79 0E E8 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 78 3E 8B 1D ?? ?? ?? ?? B9 ?? ?? ?? ?? BA 80 01 00 00 89 D8 53 89 C3 B8 03 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0B E8 ?? ?? ?? ?? F7 DB 89 18 EB 0D 81 FB 80 01 00 00 B8 ?? ?? ?? ?? 74 02 31 C0 5B 5A 5B C3 }
	condition:
		$pattern
}
...
rule putwchar_18529c88eeaf462a402e866fc9d04216 {
	meta:
		aliases = "putwchar"
		size = "72"
		objfiles = "putwchar@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 0D ?? ?? ?? ?? 8B 5C 24 10 83 79 34 00 74 20 8B 51 10 3B 51 1C 73 0D 88 1A 8D 42 01 0F B6 DB 89 41 10 EB 19 50 50 51 53 E8 ?? ?? ?? ?? EB 09 50 50 51 53 E8 ?? ?? ?? ?? 89 C3 83 C4 10 5A 89 D8 59 5B C3 }
	condition:
		$pattern
}

rule putchar_unlocked_e2d7001a83766fb221ac6d801b13fe40 {
	meta:
		aliases = "putchar_unlocked"
		size = "55"
		objfiles = "putchar_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 0D ?? ?? ?? ?? 8B 5C 24 10 8B 51 10 3B 51 1C 73 0D 88 1A 8D 42 01 0F B6 DB 89 41 10 EB 0E 50 50 51 53 E8 ?? ?? ?? ?? 83 C4 10 89 C3 5A 89 D8 59 5B C3 }
	condition:
		$pattern
}

rule mq_unlink_07582a808730cc02f1dee8990f4e1e60 {
	meta:
		aliases = "mq_unlink"
		size = "91"
		objfiles = "mq_unlink@librt.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 44 24 10 80 38 2F 74 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 3A 8D 48 01 87 CB B8 16 01 00 00 CD 80 87 CB 3D 00 F0 FF FF 89 C3 76 0B E8 ?? ?? ?? ?? F7 DB 89 18 EB 04 85 C0 79 17 E8 ?? ?? ?? ?? B9 0D 00 00 00 8B 10 83 FA 01 0F 44 D1 89 10 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule timer_getoverrun_aecc967dfb8524b9c3e255156751741a {
	meta:
		aliases = "timer_getoverrun"
		size = "48"
		objfiles = "timer_getoverr@librt.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 44 24 10 8B 48 04 87 CB B8 06 01 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule timer_gettime_0aac79a343db19cde21ea6f74d6807bc {
	meta:
		aliases = "timer_gettime"
		size = "52"
		objfiles = "timer_gettime@librt.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 44 24 10 8B 4C 24 14 8B 50 04 87 D3 B8 05 01 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule xdrrec_eof_e18c662a76987d19602136da1e03de18 {
	meta:
		aliases = "__GI_xdrrec_eof, xdrrec_eof"
		size = "84"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 44 24 10 8B 58 0C EB 23 89 D8 E8 ?? ?? ?? ?? 85 C0 74 33 83 7B 38 00 C7 43 34 00 00 00 00 75 0B 89 D8 E8 ?? ?? ?? ?? 85 C0 74 1B 8B 53 34 85 D2 7F D6 83 7B 38 00 74 D0 8B 43 2C 3B 43 30 0F 94 C0 0F B6 C0 EB 05 B8 01 00 00 00 5A 59 5B C3 }
	condition:
		$pattern
}

rule xdrrec_skiprecord_26e62a2e15e6d8f7cd0b6ddaaf2ad43f {
	meta:
		aliases = "__GI_xdrrec_skiprecord, xdrrec_skiprecord"
		size = "81"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 44 24 10 8B 58 0C EB 23 89 D8 E8 ?? ?? ?? ?? 85 C0 74 33 83 7B 38 00 C7 43 34 00 00 00 00 75 0B 89 D8 E8 ?? ?? ?? ?? 85 C0 74 1B 8B 53 34 85 D2 7F D6 83 7B 38 00 74 D0 B8 01 00 00 00 C7 43 38 00 00 00 00 EB 02 31 C0 5B 5A 5B C3 }
	condition:
		$pattern
}

rule clnttcp_control_254b96fef20d449d1e2893c68cd35321 {
	meta:
		aliases = "clnttcp_control"
		size = "175"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 44 24 10 8B 5C 24 18 8B 48 08 8B 44 24 14 48 83 F8 0E 77 07 FF 24 85 ?? ?? ?? ?? 31 C0 E9 84 00 00 00 C7 41 04 01 00 00 00 EB 76 C7 41 04 00 00 00 00 EB 6D 8B 13 8B 43 04 C7 41 10 01 00 00 00 89 51 08 89 41 0C EB 59 8B 51 08 8B 41 0C 89 13 89 43 04 EB 4C 52 6A 10 8D 41 14 50 53 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 10 EB 3A 8B 01 EB 26 8B 41 30 0F C8 EB 1F 8B 03 48 0F C8 89 41 30 EB 20 8B 41 40 0F C8 EB 0E 8B 03 0F C8 89 41 40 EB 10 8B 41 3C 0F C8 89 03 EB 07 8B 03 0F C8 89 41 3C B8 01 00 00 00 5A 59 5B C3 }
	condition:
		$pattern
}

rule clntunix_control_7c3f60bbfa5f5f12615e2dce3332ea2d {
	meta:
		aliases = "clntunix_control"
		size = "189"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 44 24 10 8B 5C 24 18 8B 48 08 8B 44 24 14 48 83 F8 0E 77 07 FF 24 85 ?? ?? ?? ?? 31 C0 E9 92 00 00 00 C7 41 04 01 00 00 00 E9 81 00 00 00 C7 41 04 00 00 00 00 EB 78 8B 13 8B 43 04 89 51 08 89 41 0C EB 6B 8B 51 08 8B 41 0C 89 13 89 43 04 EB 5E 52 6A 6E 8D 41 14 50 53 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 10 EB 4C 8B 01 EB 35 8B 81 90 00 00 00 0F C8 EB 2B 8B 03 48 0F C8 89 81 90 00 00 00 EB 2C 8B 81 A0 00 00 00 0F C8 EB 14 8B 03 0F C8 89 81 A0 00 00 00 EB 16 8B 81 9C 00 00 00 0F C8 89 03 EB 0A 8B 03 0F C8 89 81 9C 00 00 00 B8 01 00 00 00 5A 59 5B C3 }
	condition:
		$pattern
}

rule clntudp_control_77e16cc96344f7011dbaf27dc5992a92 {
	meta:
		aliases = "clntudp_control"
		size = "211"
		objfiles = "clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 44 24 10 8B 5C 24 18 8B 48 08 8B 44 24 14 48 83 F8 0E 77 07 FF 24 85 ?? ?? ?? ?? 31 C0 E9 A8 00 00 00 C7 41 04 01 00 00 00 E9 97 00 00 00 C7 41 04 00 00 00 00 E9 8B 00 00 00 8B 13 8B 43 04 89 51 24 89 41 28 EB 7E 8B 51 24 8B 41 28 EB 13 8B 13 8B 43 04 89 51 1C 89 41 20 EB 69 8B 51 1C 8B 41 20 89 43 04 89 13 EB 5C 52 6A 10 8D 41 08 50 53 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 10 EB 4A 8B 01 EB 33 8B 41 58 8B 00 0F C8 EB 2A 8B 03 8B 51 58 48 0F C8 89 02 EB 2C 8B 41 58 8B 40 10 0F C8 EB 14 8B 51 58 8B 03 0F C8 89 42 10 EB 16 8B 41 58 8B 40 0C 0F C8 89 03 EB 0A 8B 51 58 8B 03 0F C8 89 }
	condition:
		$pattern
}
...
rule _Exit_b13c77f62a544976e4e0dfd23d615716 {
	meta:
		aliases = "_exit, __GI__exit, _Exit"
		size = "39"
		objfiles = "_exit@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 01 00 00 00 CD 80 87 CB 3D 00 F0 FF FF 89 C3 76 E8 E8 ?? ?? ?? ?? F7 DB 89 18 EB DD }
	condition:
		$pattern
}

rule close_0c9cbb9589fc4ab4c9479c2d3863c891 {
	meta:
		aliases = "__libc_close, __GI_close, close"
		size = "45"
		objfiles = "close@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 06 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule unlink_d00e062b322e5d32a2196b86e386188a {
	meta:
		aliases = "__GI_unlink, unlink"
		size = "45"
		objfiles = "unlink@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 0A 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule chdir_5ddadbfbd9dc2544350cfdcc3d4eb630 {
	meta:
		aliases = "__GI_chdir, chdir"
		size = "45"
		objfiles = "chdir@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 0C 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule umount_a8e82e59c854b062bec110bc2107369b {
	meta:
		aliases = "umount"
		size = "45"
		objfiles = "umount@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 16 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule stime_e3070e2d32eac5793c7f59ee3bed60bf {
	meta:
		aliases = "stime"
		size = "45"
		objfiles = "stime@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 19 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_alarm_9ec6f5e69c12d00e036f79e182c06a8d {
	meta:
		aliases = "alarm, __GI_alarm"
		size = "45"
		objfiles = "alarm@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 1B 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule nice_af02e3386706e5ff35069aab5a3e3adb {
	meta:
		aliases = "nice"
		size = "67"
		objfiles = "nice@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 22 00 00 00 CD 80 87 CB 3D 00 F0 FF FF 89 C3 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF EB 15 83 C8 FF 85 DB 75 0E 53 53 6A 00 6A 00 E8 ?? ?? ?? ?? 83 C4 10 5A 59 5B C3 }
	condition:
		$pattern
}

rule rmdir_cbb881b16402c7d6abeb6dff1d8d828f {
	meta:
		aliases = "__GI_rmdir, rmdir"
		size = "45"
		objfiles = "rmdir@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 28 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule dup_c654c6305a05789195395e631601a41f {
	meta:
		aliases = "dup"
		size = "45"
		objfiles = "dup@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 29 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule pipe_06dc478c3b896f13b863deff463823a6 {
	meta:
		aliases = "__GI_pipe, pipe"
		size = "45"
		objfiles = "pipe@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 2A 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule acct_42c0cc96caa9af860ce967104ad540d9 {
	meta:
		aliases = "acct"
		size = "45"
		objfiles = "acct@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 33 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule umask_e93ef4a4d814354d9028893f9a69fb2d {
	meta:
		aliases = "umask"
		size = "48"
		objfiles = "umask@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 3C 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 0F B7 C0 59 5B C3 }
	condition:
		$pattern
}

rule chroot_8afeb913b547386c72294d8330308677 {
	meta:
		aliases = "chroot"
		size = "45"
		objfiles = "chroot@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 3D 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule epoll_create1_f0c5372ca425018428d5ea93c22dddec {
	meta:
		aliases = "epoll_create1"
		size = "45"
		objfiles = "epoll@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 49 01 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 59 5B 5B C3 }
	condition:
		$pattern
}

rule inotify_init1_d91f1b19d363ac75bcf1fc28c989ac67 {
	meta:
		aliases = "inotify_init1"
		size = "45"
		objfiles = "inotify@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 4C 01 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 59 5B 5B C3 }
	condition:
		$pattern
}

rule iopl_919c81ac4333ec400c3e9a2b219bd7f0 {
	meta:
		aliases = "iopl"
		size = "45"
		objfiles = "iopl@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 6E 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule swapoff_3451b5daab76541d60af922a86b9a9c4 {
	meta:
		aliases = "swapoff"
		size = "45"
		objfiles = "swapoff@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 73 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule sysinfo_b73ad633fd528ff4afe603fd16754005 {
	meta:
		aliases = "sysinfo"
		size = "45"
		objfiles = "sysinfo@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 74 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __libc_fsync_c2c9c14bcc4a4e891341c73e5d1509c7 {
	meta:
		aliases = "fsync, __libc_fsync"
		size = "45"
		objfiles = "fsync@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 76 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_uname_10cdaa8d4a38a387d2b8a12a3f20fba7 {
	meta:
		aliases = "uname, __GI_uname"
		size = "45"
		objfiles = "uname@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 7A 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule ntp_adjtime_a5634291e6f52656956ab7ef74b641bf {
	meta:
		aliases = "adjtimex, __GI_adjtimex, ntp_adjtime"
		size = "45"
		objfiles = "adjtimex@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 7C 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule getpgid_7402303b32c303aa7bbb3877cf10d111 {
	meta:
		aliases = "__getpgid, getpgid"
		size = "45"
		objfiles = "getpgid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 84 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_fchdir_19128f345b3dade92947db15a2d7a690 {
	meta:
		aliases = "fchdir, __GI_fchdir"
		size = "45"
		objfiles = "fchdir@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 85 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule personality_9903d9f6fd4ec03be6be87fcb9316ac1 {
	meta:
		aliases = "personality"
		size = "45"
		objfiles = "personality@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 88 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_getsid_e534e8cc7d00e1ca87d90ca428fcad1b {
	meta:
		aliases = "getsid, __GI_getsid"
		size = "45"
		objfiles = "getsid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 93 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule fdatasync_16e97b4a04678ccd5247213788cdf458 {
	meta:
		aliases = "fdatasync"
		size = "45"
		objfiles = "fdatasync@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 94 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule mlockall_50a2afcab6ceb4658e9b032e1a04febe {
	meta:
		aliases = "mlockall"
		size = "45"
		objfiles = "mlockall@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 98 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule sched_getscheduler_b8badc38cd55fcbc11c8fb4a96a9822d {
	meta:
		aliases = "sched_getscheduler"
		size = "45"
		objfiles = "sched_getscheduler@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 9D 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule sched_get_priority_max_b5c06e345b38e1d97365249aedebd5fa {
	meta:
		aliases = "sched_get_priority_max"
		size = "45"
		objfiles = "sched_get_priority_max@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 9F 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule sched_get_priority_min_383456a8ed2410496e7882a1dfcdb08a {
	meta:
		aliases = "sched_get_priority_min"
		size = "45"
		objfiles = "sched_get_priority_min@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 A0 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule setuid_341a5503ee33a8dcca6beb9f4ee6fe1d {
	meta:
		aliases = "setuid"
		size = "45"
		objfiles = "setuid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 D5 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule setgid_79cb82ce9e071bddc5e8c7be358fdcf3 {
	meta:
		aliases = "setgid"
		size = "45"
		objfiles = "setgid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 D6 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule setfsuid_46e927c6c4efd291f1fec4255dc10b2f {
	meta:
		aliases = "setfsuid"
		size = "45"
		objfiles = "setfsuid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 D7 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule setfsgid_b9b5fee6db09259ee1138ccfa9993b1e {
	meta:
		aliases = "setfsgid"
		size = "45"
		objfiles = "setfsgid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 D8 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule epoll_create_8395442fc2196032396ae7fa46cf0849 {
	meta:
		aliases = "epoll_create"
		size = "45"
		objfiles = "epoll@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 87 CB B8 FE 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule ffsll_4e0cbabda420a67cfee15b2c2f2fcd4e {
	meta:
		aliases = "ffsll"
		size = "61"
		objfiles = "ffsll@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 10 8B 5C 24 14 89 C8 F7 D8 89 DA 83 D2 00 F7 DA 21 DA 83 FA 00 77 0C 89 4C 24 10 5A 59 5B E9 ?? ?? ?? ?? 83 EC 0C 89 D9 51 E8 ?? ?? ?? ?? 83 C4 18 5B 83 C0 20 C3 }
	condition:
		$pattern
}

rule mq_notify_eec5b935b65c03ca4a95276ed8984b5c {
	meta:
		aliases = "mq_notify"
		size = "72"
		objfiles = "mq_notify@librt.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 10 85 C9 74 13 83 79 08 02 75 0D E8 ?? ?? ?? ?? C7 00 26 00 00 00 EB 1E 87 D3 B8 19 01 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule read_da25ffcefbb795280d6a85dd56de2310 {
	meta:
		aliases = "__GI_read, __libc_read, read"
		size = "53"
		objfiles = "read@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 03 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __libc_write_18f4b7876969fbd86abf5db3707b21ef {
	meta:
		aliases = "write, __GI_write, __libc_write"
		size = "53"
		objfiles = "write@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 04 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule execve_f195de23b13165885c13d2027f07134a {
	meta:
		aliases = "__GI_execve, execve"
		size = "53"
		objfiles = "execve@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 0B 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule lseek_d8817a2b20d2b8a8527cf60ac853ffd1 {
	meta:
		aliases = "__GI_lseek, __libc_lseek, lseek"
		size = "53"
		objfiles = "lseek@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 13 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_mq_setattr_4a23a9da23f894caeb5ef47e23313cdb {
	meta:
		aliases = "mq_setattr, __GI_mq_setattr"
		size = "53"
		objfiles = "mq_getsetattr@librt.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 1A 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule inotify_add_watch_30ee2cc8b7a4343357390d0e5cbbc5b1 {
	meta:
		aliases = "inotify_add_watch"
		size = "53"
		objfiles = "inotify@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 24 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B 5A 5B C3 }
	condition:
		$pattern
}

rule mkdirat_2293a334f9d3ceff7c2c41c7da7a82dc {
	meta:
		aliases = "mkdirat"
		size = "53"
		objfiles = "mkdirat@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 28 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule futimesat_ec2bf8a02f616ea2b9d413c42e7fc456 {
	meta:
		aliases = "futimesat"
		size = "53"
		objfiles = "futimesat@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 2B 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule unlinkat_13484f13a3629e01727a7bb5a382c991 {
	meta:
		aliases = "unlinkat"
		size = "53"
		objfiles = "unlinkat@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 2D 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule symlinkat_1f177bc13bedb88a84806380b387a6d6 {
	meta:
		aliases = "symlinkat"
		size = "53"
		objfiles = "symlinkat@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 30 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_readlink_be5695c7fa26d81e671de177c3b4d021 {
	meta:
		aliases = "readlink, __GI_readlink"
		size = "53"
		objfiles = "readlink@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 55 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule setpriority_41f3bcc8cfb0c5f896b596c6bf4c541f {
	meta:
		aliases = "__GI_setpriority, setpriority"
		size = "53"
		objfiles = "setpriority@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 61 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule ioperm_85b3663e36a4153af771d26216b1d99a {
	meta:
		aliases = "ioperm"
		size = "53"
		objfiles = "ioperm@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 65 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule klogctl_ffb186b34d0388da828396e16115950b {
	meta:
		aliases = "klogctl"
		size = "53"
		objfiles = "klogctl@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 67 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_setitimer_2bd21ac25c7f4c8b86bdbff8645ce9ef {
	meta:
		aliases = "setitimer, __GI_setitimer"
		size = "53"
		objfiles = "setitimer@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 68 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule modify_ldt_f0ef372582560e1bc3c0fe3e4c27a3d1 {
	meta:
		aliases = "modify_ldt"
		size = "53"
		objfiles = "modify_ldt@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 7B 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule mprotect_424968dafc740ba5f40ed8a8ab1e6dce {
	meta:
		aliases = "mprotect"
		size = "53"
		objfiles = "mprotect@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 7D 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule msync_c80a21387f65be3246e4561aaf4f1d04 {
	meta:
		aliases = "__libc_msync, msync"
		size = "53"
		objfiles = "msync@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 90 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule readv_51cdc1f8832ff8a1092587f3abf7d6ce {
	meta:
		aliases = "readv"
		size = "53"
		objfiles = "readv@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 91 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule writev_9d5c888ba8e5dd0a81a02ef7ea21b044 {
	meta:
		aliases = "writev"
		size = "53"
		objfiles = "writev@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 92 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule sched_setscheduler_efe45d47a0bf666333ce49b6db8d4527 {
	meta:
		aliases = "sched_setscheduler"
		size = "53"
		objfiles = "sched_setscheduler@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 9C 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule poll_c101c9445ece9adf0c7615a42723dc4c {
	meta:
		aliases = "__GI_poll, poll"
		size = "53"
		objfiles = "poll@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 A8 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule lchown_675696bca1bf56486fa50b6991fe8d5a {
	meta:
		aliases = "lchown"
		size = "53"
		objfiles = "lchown@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 C6 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule fchown_88a1ef9cfc9128ebdb4b2c80939b0fc9 {
	meta:
		aliases = "fchown"
		size = "53"
		objfiles = "fchown@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 CF 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule setresuid_aed95c5eaaaba9d9e848a99e4c0f26b7 {
	meta:
		aliases = "__GI_setresuid, setresuid"
		size = "53"
		objfiles = "setresuid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 D0 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule getresuid_8eeba377641ae9a6b2d962245f5f920c {
	meta:
		aliases = "getresuid"
		size = "53"
		objfiles = "getresuid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 D1 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule setresgid_c43e86869e5e7e970d5ab0432d3c1c07 {
	meta:
		aliases = "__GI_setresgid, setresgid"
		size = "53"
		objfiles = "setresgid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 D2 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule getresgid_d36f3ccb47fa0f31ee2d36aa0a9f8f90 {
	meta:
		aliases = "getresgid"
		size = "53"
		objfiles = "getresgid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 D3 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule chown_0590e5bcf3e4a8be1649fa0414b6f260 {
	meta:
		aliases = "__GI_chown, chown"
		size = "53"
		objfiles = "chown@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 D4 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule mincore_c3c6abffc25f133df1d5ff5e7e90d616 {
	meta:
		aliases = "mincore"
		size = "53"
		objfiles = "mincore@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 DA 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule madvise_cf882277cc83567b2a2ab9f644b025b2 {
	meta:
		aliases = "madvise"
		size = "53"
		objfiles = "madvise@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 DB 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule listxattr_fd198d11cb8b7501151f0c1b13cac6f1 {
	meta:
		aliases = "listxattr"
		size = "53"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 E8 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 59 5B 5B C3 }
	condition:
		$pattern
}

rule llistxattr_2993e0adac1e56069d641889d93464a0 {
	meta:
		aliases = "llistxattr"
		size = "53"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 E9 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B 5A 5B C3 }
	condition:
		$pattern
}

rule flistxattr_bc50b57e72593fc86442ee77ef646dd9 {
	meta:
		aliases = "flistxattr"
		size = "53"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 EA 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_towctrans_8f781067286ebf2f5d25da1059622ab3 {
	meta:
		aliases = "towctrans, __GI_towctrans"
		size = "62"
		objfiles = "towctrans@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 4C 24 14 8B 5C 24 10 8D 41 FF 83 F8 01 77 17 89 DA 83 CA 20 8D 42 9F 83 F8 19 77 15 83 F9 02 75 12 83 E2 DF EB 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 89 DA 89 D0 5A 59 5B C3 }
	condition:
		$pattern
}

rule timer_delete_f6ba5d7d257a3fa6affe9de5b0c849ea {
	meta:
		aliases = "timer_delete"
		size = "70"
		objfiles = "timer_delete@librt.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4A 04 87 CB B8 07 01 00 00 CD 80 87 CB 3D 00 F0 FF FF 89 C3 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF EB 15 83 C8 FF 85 DB 75 0E 83 EC 0C 52 E8 ?? ?? ?? ?? 31 C0 83 C4 10 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule chmod_ca5581d1916473be4e6fd416de18b7d3 {
	meta:
		aliases = "__GI_chmod, chmod"
		size = "49"
		objfiles = "chmod@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 0F 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule kill_e7e2b3fbbf421c3bd17fae41fd2f1b60 {
	meta:
		aliases = "__GI_kill, kill"
		size = "49"
		objfiles = "kill@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 25 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule rename_72f7ce93d792fc9d1800fc8dc5093bc8 {
	meta:
		aliases = "rename"
		size = "49"
		objfiles = "rename@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 26 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule mkdir_a192b3546f06e38ca8c21131a6389809 {
	meta:
		aliases = "__GI_mkdir, mkdir"
		size = "49"
		objfiles = "mkdir@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 27 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __GI_setpgid_b547c224049d05c3d1c12351dabcb25c {
	meta:
		aliases = "setpgid, __GI_setpgid"
		size = "49"
		objfiles = "setpgid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 39 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule timerfd_create_368133540c1c821c67eee7d26f4184ce {
	meta:
		aliases = "timerfd_create"
		size = "49"
		objfiles = "timerfd@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 42 01 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 59 5B 5B C3 }
	condition:
		$pattern
}

rule timerfd_gettime_bf23316b48797e53c44a100ac40f88a7 {
	meta:
		aliases = "timerfd_gettime"
		size = "49"
		objfiles = "timerfd@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 46 01 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __GI_pipe2_9635586177f25f9b13426a9b0401cbf0 {
	meta:
		aliases = "pipe2, __GI_pipe2"
		size = "49"
		objfiles = "pipe2@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 4B 01 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __GI_munmap_28cf1e76b6f2c6b2b89fef340f3c1986 {
	meta:
...
rule fchmod_2a194db15ea38ff8933918dcca57f313 {
	meta:
		aliases = "fchmod"
		size = "49"
		objfiles = "fchmod@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 5E 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule getpriority_afb2c13c59c0a927838aa03a6b5e8188 {
	meta:
		aliases = "__GI_getpriority, getpriority"
		size = "61"
		objfiles = "getpriority@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 60 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 89 C3 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF EB 0B 85 DB 78 07 B8 14 00 00 00 29 D8 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __libc_fstatfs_be68736929ed9e4e1a0623b90d5be2a4 {
	meta:
		aliases = "fstatfs, __libc_fstatfs"
		size = "49"
...
rule flock_a6df13d564c78a4c3aa5499152e21302 {
	meta:
		aliases = "flock"
		size = "49"
		objfiles = "flock@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 8F 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule sched_setparam_7b5116f1c75b58b2591dd6da21754165 {
	meta:
		aliases = "sched_setparam"
		size = "49"
		objfiles = "sched_setparam@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 9A 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule sched_getparam_7937015157f38d2efbee3c1a80e55ce7 {
	meta:
		aliases = "sched_getparam"
		size = "49"
		objfiles = "sched_getparam@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 9B 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule sched_rr_get_interval_85cf10ddfaccb5a818cfdf300c7956bf {
	meta:
		aliases = "sched_rr_get_interval"
		size = "49"
		objfiles = "sched_rr_get_interval@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 A1 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __GI_getrlimit_375374846ba1c77cc6bce78fc54bfa9c {
	meta:
		aliases = "getrlimit, __GI_getrlimit"
		size = "49"
		objfiles = "getrlimit@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 BF 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __GI_setgroups_70582308d265b3d643d0249472ec9496 {
	meta:
...
rule __GI_ether_ntoa_r_81860319d895623c882370ad70a5ea83 {
	meta:
...
rule pthread_getspecific_22a23784f9709261ddbfa9daad047431 {
	meta:
		aliases = "pthread_getspecific"
		size = "58"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 5C 24 10 81 FB FF 03 00 00 77 24 E8 ?? ?? ?? ?? 89 DA C1 EA 05 8B 44 90 74 85 C0 74 12 83 3C DD ?? ?? ?? ?? 00 74 08 83 E3 1F 8B 04 98 EB 02 31 C0 5A 59 5B C3 }
	condition:
		$pattern
}

rule __uc_malloc_b373dfb6e3c5e1febbd1427468cd3e46 {
	meta:
		aliases = "__GI___uc_malloc, __uc_malloc"
		size = "75"
		objfiles = "__uc_malloc@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 5C 24 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 DB 74 2F 85 C0 75 2B 83 3D ?? ?? ?? ?? 00 75 0A 83 EC 0C 6A 01 E8 ?? ?? ?? ?? 83 EC 0C 6A 00 E8 ?? ?? ?? ?? 89 1C 24 FF 15 ?? ?? ?? ?? 83 C4 10 EB C1 5A 59 5B C3 }
	condition:
		$pattern
}

rule tmpnam_r_45cdf647b40cf6b4985f15af37d15699 {
	meta:
		aliases = "tmpnam_r"
		size = "57"
		objfiles = "tmpnam_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 5C 24 10 85 DB 74 25 6A 00 6A 00 6A 14 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 12 50 6A 00 6A 03 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 02 31 DB 5A 89 D8 59 5B C3 }
	condition:
		$pattern
}

rule __GI_config_close_9070eb18688f684694d76b7ed3b3e582 {
	meta:
		aliases = "__GI_config_close"
		size = "61"
		objfiles = "parse_config@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 5C 24 10 85 DB 74 2D 83 EC 0C FF 33 E8 ?? ?? ?? ?? 83 C4 10 80 7B 14 00 74 0E 83 EC 0C FF 73 04 E8 ?? ?? ?? ?? 83 C4 10 89 5C 24 10 59 5B 5B E9 ?? ?? ?? ?? 58 5A 5B C3 }
	condition:
		$pattern
}
...
rule re_comp_77df75bfa6084c77d00322bca481f23f {
	meta:
		aliases = "re_comp"
		size = "183"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 5C 24 10 85 DB 75 17 83 3D ?? ?? ?? ?? 00 BA ?? ?? ?? ?? 0F 84 93 00 00 00 E9 8C 00 00 00 83 3D ?? ?? ?? ?? 00 75 46 83 EC 0C 68 C8 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 BA ?? ?? ?? ?? 85 C0 A3 ?? ?? ?? ?? 74 67 83 EC 0C 68 00 01 00 00 C7 05 ?? ?? ?? ?? C8 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 BA ?? ?? ?? ?? 85 C0 A3 ?? ?? ?? ?? 74 3F 80 0D ?? ?? ?? ?? 80 83 EC 0C 53 E8 ?? ?? ?? ?? 8B 0D ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? 89 C2 89 D8 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 10 0F B7 84 00 ?? ?? ?? ?? 8D 90 ?? ?? ?? ?? EB 02 31 D2 89 D0 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __pthread_mutex_unlock_2e1ec6f4f16d6c83b5d7af13efb549f7 {
	meta:
...
rule __scan_getc_28785d11603f93e932f70f7306a529e1 {
	meta:
		aliases = "__scan_getc"
		size = "82"
		objfiles = "__scan_cookie@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 5C 24 10 8B 43 10 C7 03 FF FF FF FF 48 85 C0 89 43 10 79 09 80 4B 19 02 83 C8 FF EB 2C 80 7B 19 00 75 1A 83 EC 0C 53 FF 53 2C 83 C4 10 83 F8 FF 75 06 80 4B 19 02 EB 11 89 43 04 EB 04 C6 43 19 00 8B 43 04 FF 43 0C 89 03 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __stdio_trans2r_o_d40578fe83bb29d7154a431bea82ce97 {
	meta:
		aliases = "__stdio_trans2r_o"
		size = "110"
		objfiles = "_trans2r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 5C 24 10 8B 54 24 14 0F B7 03 85 D0 75 0C A9 80 08 00 00 75 0C 09 C2 66 89 13 0F B7 03 A8 10 74 18 E8 ?? ?? ?? ?? C7 00 09 00 00 00 8B 03 83 C8 08 66 89 03 83 C8 FF EB 2C A8 40 74 1E 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 DF 8B 43 08 89 43 1C 8B 03 83 E0 BF 66 89 03 8B 03 83 C8 01 66 89 03 31 C0 5A 59 5B C3 }
	condition:
		$pattern
}

rule __stdio_trans2w_o_8d010d07ec06c6ef04feb02649c3e000 {
	meta:
		aliases = "__stdio_trans2w_o"
		size = "167"
		objfiles = "_trans2w@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 5C 24 10 8B 54 24 14 0F B7 03 85 D0 75 0C A9 80 08 00 00 75 0D 09 C2 66 89 13 0F B7 13 F6 C2 20 74 18 E8 ?? ?? ?? ?? C7 00 09 00 00 00 8B 03 83 CA FF 83 C8 08 66 89 03 EB 62 F6 C2 03 74 45 F6 C2 04 75 2C 8B 43 14 3B 43 10 75 05 F6 C2 02 74 1F 81 E2 00 04 00 00 83 FA 01 19 C0 52 83 C0 02 50 6A 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 BD 8B 03 83 E0 FC 66 89 03 8B 43 08 89 43 18 89 43 10 89 43 14 8B 03 31 D2 83 C8 40 0F B7 C0 F6 C4 0B 66 89 03 75 06 8B 43 0C 89 43 1C 89 D0 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule token_f740e780fa44fdea9dcd956bf7178caf {
	meta:
		aliases = "token"
		size = "386"
		objfiles = "ruserpass@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 A1 ?? ?? ?? ?? 0F B7 00 A8 0C 0F 85 68 01 00 00 8B 0D ?? ?? ?? ?? 8B 41 10 3B 41 18 73 09 0F B6 10 40 89 41 10 EB 17 83 EC 0C 51 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C2 0F 84 3A 01 00 00 8D 42 F7 83 F8 01 76 CA 83 FA 20 74 C5 83 FA 2C 74 C0 83 FA 22 BB ?? ?? ?? ?? 74 2F EB 5E 83 FA 5C 75 25 8B 0D ?? ?? ?? ?? 8B 41 10 3B 41 18 73 09 0F B6 10 40 89 41 10 EB 0E 83 EC 0C 51 E8 ?? ?? ?? ?? 83 C4 10 89 C2 88 13 43 8B 0D ?? ?? ?? ?? 8B 41 10 3B 41 18 73 09 0F B6 10 40 89 41 10 EB 13 83 EC 0C 51 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C2 74 7F 83 FA 22 75 A4 EB 78 BB ?? ?? ?? ?? 88 15 ?? ?? ?? }
	condition:
		$pattern
}

rule __setutent_c265907d74d81b61a0cbe01786c35869 {
	meta:
		aliases = "__setutent"
		size = "155"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 A1 ?? ?? ?? ?? 85 C0 79 7C 8B 15 ?? ?? ?? ?? B9 02 00 08 00 87 D3 B8 05 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 85 C0 A3 ?? ?? ?? ?? 79 35 8B 15 ?? ?? ?? ?? B9 00 00 08 00 87 D3 B8 05 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 85 C0 A3 ?? ?? ?? ?? 78 20 51 6A 01 6A 02 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? EB 0B 52 6A 00 6A 00 50 E8 ?? ?? ?? ?? 83 C4 10 59 5B 5B C3 }
	condition:
		$pattern
}
...
rule __libc_fork_2527c0759d3c9058972affd170efda8f {
	meta:
...
rule inotify_init_61d2e9aa09a94b1e4a85820850b82838 {
	meta:
		aliases = "inotify_init"
		size = "37"
		objfiles = "inotify@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 B8 23 01 00 00 CD 80 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __pthread_reset_main_thread_463ff5a6b7ae448016a0233f5583db09 {
	meta:
		aliases = "__pthread_reset_main_thread"
		size = "138"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 E8 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? FF 89 C3 74 51 83 EC 0C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 C7 05 ?? ?? ?? ?? 00 00 00 00 FF 35 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 E8 ?? ?? ?? ?? 59 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 C7 05 ?? ?? ?? ?? FF FF FF FF C7 05 ?? ?? ?? ?? FF FF FF FF E8 ?? ?? ?? ?? 89 1D ?? ?? ?? ?? C7 43 44 ?? ?? ?? ?? 89 1B 89 5B 04 C7 43 4C ?? ?? ?? ?? 89 43 14 58 5A 5B C3 }
	condition:
		$pattern
}
...
rule endrpcent_164bf38bfd529affcaaa22b672a7176f {
	meta:
...
rule __pthread_cleanup_push_defer_8f318edd4400a23e551175726b7ab731 {
	meta:
		aliases = "_pthread_cleanup_push_defer, __pthread_cleanup_push_defer"
		size = "67"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 E8 ?? ?? ?? ?? 8B 5C 24 10 89 C2 8B 44 24 14 89 03 8B 44 24 18 89 43 04 0F B6 42 41 89 43 08 8B 42 3C 85 C0 89 43 0C 74 0B 39 C3 72 07 C7 43 0C 00 00 00 00 C6 42 41 00 89 5A 3C 58 5A 5B C3 }
	condition:
		$pattern
}
...
rule svcraw_recv_940101c0f8dfd4f394b0b825987741a5 {
	meta:
		aliases = "svcraw_recv"
		size = "78"
		objfiles = "svc_raw@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 E8 ?? ?? ?? ?? 8B 90 BC 00 00 00 31 C0 85 D2 74 35 C7 82 94 23 00 00 01 00 00 00 8D 9A 94 23 00 00 50 50 8B 82 98 23 00 00 6A 00 53 FF 50 14 59 58 FF 74 24 1C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 95 C0 0F B6 C0 5B 5A 5B C3 }
	condition:
		$pattern
}
...
rule svcraw_create_6ecc74cfaaee94881f23b37a58c68ef2 {
	meta:
		aliases = "svcraw_create"
		size = "120"
		objfiles = "svc_raw@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 E8 ?? ?? ?? ?? 8B 98 BC 00 00 00 85 DB 75 19 53 53 68 3C 25 00 00 6A 01 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 74 48 89 C3 8D 83 AC 23 00 00 89 83 84 22 00 00 8D 83 94 23 00 00 C7 83 60 22 00 00 00 00 00 00 66 C7 83 64 22 00 00 00 00 C7 83 68 22 00 00 ?? ?? ?? ?? 6A 02 68 60 22 00 00 53 50 E8 ?? ?? ?? ?? 8D 93 60 22 00 00 83 C4 10 89 D0 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule mkdtemp_febf864c74f45cb15ab9cee7ea80fdde {
	meta:
		aliases = "mkdtemp"
		size = "38"
		objfiles = "mkdtemp@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 0C 8B 5C 24 14 68 C0 01 00 00 6A 02 53 E8 ?? ?? ?? ?? 85 C0 B8 00 00 00 00 0F 45 D8 83 C4 18 89 D8 5B C3 }
	condition:
		$pattern
}

rule mktemp_fda515f7e5e41ae54d1f4af3142b81e3 {
	meta:
		aliases = "mktemp"
		size = "34"
		objfiles = "mktemp@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 0C 8B 5C 24 14 6A 00 6A 03 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 03 C6 03 00 5A 89 D8 59 5B C3 }
	condition:
		$pattern
}
...
rule __GI_config_open_a48510af2b0ff23260ab0ef651056d03 {
	meta:
		aliases = "__GI_config_open"
		size = "53"
		objfiles = "parse_config@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 89 C3 31 C0 85 DB 74 14 50 50 6A 18 6A 01 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 02 89 18 5A 59 5B C3 }
	condition:
		$pattern
}

rule nextafterf_5c6591be309f9b98343d8e0b4d4122d5 {
	meta:
		aliases = "nextafterf"
		size = "176"
		objfiles = "s_nextafterf@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 8B 4C 24 18 8B 54 24 1C 89 CB 81 E3 FF FF FF 7F 81 FB 00 00 80 7F 7F 0E 89 D0 25 FF FF FF 7F 3D 00 00 80 7F 7E 0A D9 44 24 1C D8 44 24 18 EB 58 D9 44 24 18 D9 44 24 1C D9 C9 DF E9 DD D8 7A 02 74 61 85 DB 75 0F 81 E2 00 00 00 80 83 CA 01 89 54 24 1C EB 4E 85 C9 78 0D 8D 59 FF 39 D1 8D 41 01 0F 4E D8 EB 0E 85 D2 79 07 39 D1 8D 59 01 7E 03 8D 59 FF 89 D8 25 00 00 80 7F 3D 00 00 80 7F 75 0C D9 44 24 18 D8 C0 D9 5C 24 1C EB 15 3D FF FF 7F 00 7F 0A D9 44 24 18 D8 C8 D9 5C 24 0C 89 5C 24 1C D9 44 24 1C 83 C4 10 5B C3 }
	condition:
		$pattern
}
...
rule putenv_d660c7abd384c59065aa97f75002547d {
	meta:
		aliases = "putenv"
		size = "52"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 8B 5C 24 18 6A 3D 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 11 89 D8 B9 01 00 00 00 5B 31 D2 5B 5B E9 ?? ?? ?? ?? 89 5C 24 10 58 5A 5B E9 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_nrand48_r_a32005692c3cdd0182b134e163c5d80c {
	meta:
		aliases = "nrand48_r, __GI_nrand48_r"
		size = "57"
		objfiles = "nrand48_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 8B 5C 24 18 FF 74 24 1C 53 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 17 0F B7 43 02 0F B7 53 04 D1 E8 C1 E2 0F 09 D0 8B 54 24 18 89 02 31 D2 89 D0 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_clnt_perror_889eb906880bb2fac48a298ea4a827f3 {
	meta:
...
rule re_exec_c75dba865561c4d7cda59f72a365430a {
	meta:
		aliases = "re_exec"
		size = "43"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 14 8B 5C 24 1C 53 E8 ?? ?? ?? ?? 5A 59 6A 00 50 6A 00 50 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 28 5B F7 D0 C1 E8 1F C3 }
	condition:
		$pattern
}
...
rule __GI_regfree_d1e81aca2240e7ee121d3a613c884cb4 {
	meta:
...
rule __GI_xdr_u_short_337ec9c36ce31daaba84281d713da132 {
	meta:
...
rule __GI_xdr_short_b552de83f06d952da7140353def130f2 {
	meta:
...
rule __fcntl_nocancel_27a71e017d47b8ecb37086c38a4cdf6a {
	meta:
		aliases = "__GI___fcntl_nocancel, fcntl, __libc_fcntl, __GI___libc_fcntl, __GI_fcntl, __fcntl_nocancel"
		size = "87"
		objfiles = "__syscall_fcntl@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 8B 4C 24 24 8D 44 24 2C 89 44 24 14 8B 54 24 28 8D 41 F4 83 F8 02 77 11 8B 44 24 20 53 89 C3 B8 DD 00 00 00 CD 80 5B EB 0F 8B 44 24 20 53 89 C3 B8 37 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule __pthread_manager_adjust_prio_6f9cf37541872233e8153fd4a55dd82e {
	meta:
		aliases = "__pthread_manager_adjust_prio"
		size = "73"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 8B 5C 24 20 3B 1D ?? ?? ?? ?? 7E 34 83 EC 0C 6A 01 E8 ?? ?? ?? ?? 83 C4 0C 8D 53 01 39 C3 0F 4D D3 8D 44 24 18 89 54 24 18 50 6A 01 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 89 1D ?? ?? ?? ?? 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule __GI___fgetc_unlocked_7234bf2292c7e7a4e6fb4c246bfcefbf {
	meta:
...
rule __GI_ioctl_4eb36ae44a70c07c5bab600470188f1c {
	meta:
		aliases = "ioctl, __GI_ioctl"
		size = "62"
		objfiles = "ioctl@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 8D 44 24 2C 8B 4C 24 24 89 44 24 14 8B 54 24 28 8B 44 24 20 53 89 C3 B8 36 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule fcntl64_714a98e066548dfcab7807f82a85a98a {
	meta:
		aliases = "__GI_fcntl64, fcntl64"
		size = "62"
		objfiles = "__syscall_fcntl64@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 8D 44 24 2C 8B 4C 24 24 89 44 24 14 8B 54 24 28 8B 44 24 20 53 89 C3 B8 DD 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 18 5B C3 }
	condition:
		$pattern
}
...
rule atanh_de86d0b0b160083eaf24dc1e52ecbfd9 {
	meta:
		aliases = "__GI_atanh, __ieee754_atanh, atanh"
		size = "207"
		objfiles = "e_atanh@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 DD 44 24 20 DD 14 24 DD 54 24 10 8B 44 24 10 8B 5C 24 14 F7 D8 0B 44 24 10 89 DA 81 E2 FF FF FF 7F C1 E8 1F 09 D0 3D 00 00 F0 3F 76 09 D8 E0 D8 F0 E9 8A 00 00 00 DD D8 81 FA 00 00 F0 3F 75 0B DD 04 24 DC 35 ?? ?? ?? ?? EB 75 81 FA FF FF 2F 3E 7F 13 DD 04 24 DC 05 ?? ?? ?? ?? D9 EE D9 C9 DF E9 DD D8 77 5D DD 04 24 81 FA FF FF DF 3F DD 5C 24 08 89 54 24 0C DD 44 24 08 D9 C0 D8 C1 7F 14 D9 C0 D8 CA D9 CA 52 52 DC 2D ?? ?? ?? ?? DE FA DE C1 EB 08 D9 E8 DE E2 50 50 DE F1 83 EC 08 DD 1C 24 E8 ?? ?? ?? ?? 83 C4 10 85 DB 0F 98 C0 84 C0 D8 0D ?? ?? ?? ?? D9 C0 D9 E0 DA C9 DD D9 DD 1C 24 DD }
	condition:
		$pattern
}

rule cosh_795af30ef0c93dea7bfe36a321fa520e {
	meta:
		aliases = "__GI_cosh, __ieee754_cosh, cosh"
		size = "293"
		objfiles = "e_cosh@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 DD 44 24 20 DD 14 24 DD 54 24 10 8B 5C 24 14 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 0F 8F F3 00 00 00 DD D8 81 FB 42 2E D6 3F 7F 3D 50 50 FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? 83 C4 10 81 FB FF FF 7F 3C D9 E8 D9 C1 D8 C1 0F 8E C1 00 00 00 D9 CA D8 C8 D9 CA D8 C0 DE FA DE C1 E9 B4 00 00 00 81 FB FF FF 35 40 7F 29 51 51 FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? D9 05 ?? ?? ?? ?? D9 C1 D8 C9 D9 C9 DE F2 DE C1 EB 70 81 FB 41 2E 86 40 7F 1F 52 52 FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? D8 0D ?? ?? ?? ?? EB 49 DD 04 24 81 }
	condition:
		$pattern
}

rule tanh_dad850c43b7cb02dfcfc68eb46a9eb16 {
	meta:
		aliases = "__GI_tanh, tanh"
		size = "219"
		objfiles = "s_tanh@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 DD 44 24 20 DD 54 24 08 DD 5C 24 10 8B 5C 24 14 89 D8 25 FF FF FF 7F 3D FF FF EF 7F 7E 22 85 DB 78 0F D9 E8 DD 44 24 08 D8 F9 DE C1 E9 A1 00 00 00 D9 E8 DD 44 24 08 D8 F9 DE E1 E9 92 00 00 00 3D FF FF 35 40 7E 04 D9 E8 EB 79 3D FF FF 7F 3C 7F 10 DD 44 24 08 DC 05 ?? ?? ?? ?? DC 4C 24 08 EB 70 3D FF FF EF 3F 7E 2D 52 52 FF 74 24 14 FF 74 24 14 E8 ?? ?? ?? ?? D8 C0 DD 1C 24 E8 ?? ?? ?? ?? D8 05 ?? ?? ?? ?? D8 3D ?? ?? ?? ?? DC 05 ?? ?? ?? ?? EB 2B 50 50 FF 74 24 14 FF 74 24 14 E8 ?? ?? ?? ?? D8 0D ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? D9 C0 D9 E0 D9 C9 D8 05 ?? ?? ?? ?? DE F9 83 C4 10 }
	condition:
		$pattern
}
...
rule closelog_544a046953e08fdc1efb7cc912c4bcaa {
	meta:
		aliases = "__GI_closelog, closelog"
		size = "58"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 C0 E8 ?? ?? ?? ?? 58 5A 6A 01 53 E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule srand_2ba6753950d552504adb42e45f782e94 {
	meta:
		aliases = "srandom, srand"
		size = "67"
		objfiles = "random@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 58 68 ?? ?? ?? ?? FF 74 24 2C E8 ?? ?? ?? ?? 58 5A 6A 01 53 E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule clearenv_57f1c3ada3d11f6b13588f8032c7201c {
	meta:
		aliases = "clearenv"
		size = "85"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 C7 05 ?? ?? ?? ?? 00 00 00 00 5A C7 05 ?? ?? ?? ?? 00 00 00 00 6A 01 53 E8 ?? ?? ?? ?? 83 C4 28 31 C0 5B C3 }
	condition:
		$pattern
}

rule sethostent_c1b23b28cb37d25cbe55ff60ed86658e {
	meta:
		aliases = "sethostent"
		size = "68"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 20 00 74 07 C6 05 ?? ?? ?? ?? 01 50 50 6A 01 53 E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule endutent_60f61d2ea7fe2d073e25de9de0a96ccd {
	meta:
		aliases = "__GI_endutent, endutent"
		size = "85"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 0D ?? ?? ?? ?? 83 C4 10 85 C9 78 0B 87 CB B8 06 00 00 00 CD 80 87 CB 52 52 6A 01 53 C7 05 ?? ?? ?? ?? FF FF FF FF E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule openlog_b6ea5e4d25a215a35e6f9f56b9cca17f {
	meta:
		aliases = "__GI_openlog, openlog"
		size = "68"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 54 24 34 8B 44 24 30 8B 4C 24 38 E8 ?? ?? ?? ?? 59 58 6A 01 53 E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule setgrent_c8677bf57d351f58f68849252919efb4 {
	meta:
...
rule setprotoent_a75f460ba1a57e8f72bf836bf9f6395f {
	meta:
		aliases = "setnetent, setservent, __GI_setservent, __GI_setnetent, __GI_setprotoent, setprotoent"
		size = "110"
		objfiles = "getnet@libc.a, getproto@libc.a, getservice@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 74 0C 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 20 00 A3 ?? ?? ?? ?? 74 07 C6 05 ?? ?? ?? ?? 01 52 52 6A 01 53 E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule endservent_f468964b8937d2560c1930edef041633 {
	meta:
		aliases = "__GI_endservent, __GI_endprotoent, endprotoent, endnetent, __GI_endnetent, endservent"
		size = "92"
		objfiles = "getnet@libc.a, getproto@libc.a, getservice@libc.a"
	strings:
...
rule endhostent_51ae5daeccb7e7f232b8eb9e34f0d707 {
	meta:
		aliases = "endhostent"
		size = "56"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 58 6A 01 53 E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}
...
rule __GI_utmpname_3632d5ad1e7f949842419dd364a60e32 {
	meta:
		aliases = "utmpname, __GI_utmpname"
		size = "151"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 8B 5C 24 24 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 14 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 DB 74 34 A1 ?? ?? ?? ?? 3D ?? ?? ?? ?? 74 0C 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 BA ?? ?? ?? ?? 85 C0 0F 45 D0 89 15 ?? ?? ?? ?? 8B 0D ?? ?? ?? ?? 85 C9 78 15 87 CB B8 06 00 00 00 CD 80 87 CB C7 05 ?? ?? ?? ?? FF FF FF FF 50 50 6A 01 8D 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 28 31 C0 5B C3 }
	condition:
		$pattern
}

rule mallopt_bab82f2383ce7617180645ca7cf73d6b {
	meta:
		aliases = "mallopt"
		size = "182"
		objfiles = "mallopt@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 8B 5C 24 28 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 14 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8B 44 24 20 83 C0 04 83 F8 05 77 5C FF 24 85 ?? ?? ?? ?? 83 FB 50 77 50 85 DB B9 08 00 00 00 74 10 8D 43 0B B1 10 89 C2 83 E2 F8 83 F8 0F 0F 47 CA A1 ?? ?? ?? ?? 83 E0 03 09 C1 89 0D ?? ?? ?? ?? EB 16 89 1D ?? ?? ?? ?? EB 0E 89 1D ?? ?? ?? ?? EB 06 89 1D ?? ?? ?? ?? BB 01 00 00 00 EB 0A 89 1D ?? ?? ?? ?? EB F1 31 DB 50 50 6A 01 8D 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 28 89 D8 5B C3 }
	condition:
		$pattern
}

rule gethostent_r_7a5f14048801c9785894f66aaf3692ad {
	meta:
		aliases = "__GI_gethostent_r, gethostent_r"
		size = "156"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 8B 5C 24 30 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 14 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 1B E8 ?? ?? ?? ?? 85 C0 A3 ?? ?? ?? ?? 75 0D C7 03 00 00 00 00 BB 02 00 00 00 EB 38 83 EC 0C FF 74 24 3C 53 FF 74 24 3C FF 74 24 3C FF 74 24 3C 6A 01 6A 02 6A 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 30 80 3D ?? ?? ?? ?? 00 89 C3 75 05 E8 ?? ?? ?? ?? 52 52 6A 01 8D 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 28 89 D8 5B C3 }
	condition:
		$pattern
}

rule pause_95b8b91380ad10e027d0c9a17fd29c3a {
	meta:
		aliases = "__libc_pause, pause"
		size = "31"
		objfiles = "pause@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 8D 5C 24 14 53 6A 00 6A 00 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule sigrelse_896d120f00b0da2a9b4232ccde885c14 {
	meta:
		aliases = "sighold, sigrelse"
		size = "63"
		objfiles = "sighold@libc.a, sigrelse@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 8D 5C 24 14 53 6A 00 6A 02 E8 ?? ?? ?? ?? 5A 59 FF 74 24 28 53 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 10 50 6A 00 53 6A 02 E8 ?? ?? ?? ?? 83 C4 10 89 C2 83 C4 18 89 D0 5B C3 }
	condition:
		$pattern
}
...
rule ftime_6bbbe7a66272500a5f7b6f3137e17418 {
	meta:
		aliases = "ftime"
		size = "75"
		objfiles = "ftime@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 20 8D 44 24 10 8B 5C 24 28 50 8D 44 24 1C 50 E8 ?? ?? ?? ?? 8B 44 24 20 BA E8 03 00 00 89 D1 89 03 8B 44 24 24 05 E7 03 00 00 99 F7 F9 66 89 43 04 8B 44 24 18 66 89 43 06 8B 44 24 1C 66 89 43 08 83 C4 28 31 C0 5B C3 }
	condition:
		$pattern
}
...
rule recvfrom_7d7d932a283d7deb651a01f723d18f3d {
	meta:
		aliases = "recvfrom"
		size = "70"
...
rule epoll_pwait_0146a2b606fb96af275cc87e5b5e64d1 {
	meta:
		aliases = "epoll_pwait"
		size = "65"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 20 8D 44 24 1C 50 6A 01 E8 ?? ?? ?? ?? 58 FF 74 24 3C FF 74 24 3C FF 74 24 3C FF 74 24 3C FF 74 24 3C E8 ?? ?? ?? ?? 83 C4 18 6A 00 FF 74 24 20 89 C3 E8 ?? ?? ?? ?? 83 C4 28 89 D8 5B C3 }
	condition:
		$pattern
}
...
rule sendto_8b4086bbc5ce90b60bdaf07aa9fff1ff {
	meta:
		aliases = "sendto"
		size = "70"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 20 8D 44 24 1C 50 6A 01 E8 ?? ?? ?? ?? 5A 59 FF 74 24 3C FF 74 24 3C FF 74 24 3C FF 74 24 3C FF 74 24 3C FF 74 24 3C E8 ?? ?? ?? ?? 83 C4 18 6A 00 FF 74 24 20 89 C3 E8 ?? ?? ?? ?? 83 C4 28 89 D8 5B C3 }
	condition:
		$pattern
}

rule recvmsg_74030486c498b35deba130245259f53b {
	meta:
		aliases = "write, lseek, connect, recvmsg"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule read_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "sendmsg, msync, accept, waitpid, __GI_waitpid, read"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule fcntl_32c69e35a007e966e25e2d358585a5d3 {
	meta:
...
rule pwrite_a442f4706a8c29f1a18c27f8c866616e {
	meta:
		aliases = "send, pread, epoll_wait, recv, pwrite"
		size = "60"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule frexp_d7290d43acaef44556c9cef51c5cf683 {
	meta:
		aliases = "__GI_frexp, frexp"
		size = "152"
		objfiles = "s_frexp@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 20 DD 44 24 28 8B 5C 24 30 DD 14 24 DD 54 24 18 8B 4C 24 1C 8B 44 24 18 C7 03 00 00 00 00 89 CA 81 E2 FF FF FF 7F 81 FA FF FF EF 7F 7F 5D 09 D0 74 59 81 FA FF FF 0F 00 7F 21 D8 0D ?? ?? ?? ?? C7 03 CA FF FF FF DD 14 24 DD 5C 24 10 8B 4C 24 14 89 CA 81 E2 FF FF FF 7F EB 02 DD D8 8B 03 81 E1 FF FF 0F 80 DD 04 24 81 C9 00 00 E0 3F C1 FA 14 DD 5C 24 08 89 4C 24 0C 2D FE 03 00 00 DD 44 24 08 01 D0 89 03 DD 1C 24 EB 02 DD D8 DD 04 24 83 C4 20 5B C3 }
	condition:
		$pattern
}
...
rule __GI_scalbln_fb3de27cecf8f253228eddf40f0dccab {
	meta:
		aliases = "scalbln, scalbn, __GI_scalbn, __GI_scalbln"
		size = "293"
		objfiles = "s_scalbn@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 28 DD 44 24 30 8B 5C 24 38 DD 14 24 DD 54 24 20 8B 54 24 24 8B 4C 24 20 89 D0 25 00 00 F0 7F C1 F8 14 75 2E 81 E2 FF FF FF 7F 09 CA 0F 84 E6 00 00 00 D8 0D ?? ?? ?? ?? DD 14 24 DD 5C 24 18 8B 54 24 1C 89 D0 25 00 00 F0 7F C1 F8 14 83 E8 36 EB 02 DD D8 3D FF 07 00 00 75 0A DD 04 24 D8 C0 E9 AE 00 00 00 01 D8 3D FE 07 00 00 7F 35 81 FB B0 3C FF FF 7C 52 85 C0 7E 1C DD 04 24 C1 E0 14 81 E2 FF FF 0F 80 09 D0 DD 5C 24 10 89 44 24 14 DD 44 24 10 EB 7D 83 F8 CA 7F 55 81 FB 50 C3 00 00 7E 25 FF 74 24 04 FF 74 24 04 68 3C E4 37 7E 68 9C 75 00 88 E8 ?? ?? ?? ?? 83 C4 10 DD 1C 24 DD 05 ?? ?? ?? }
	condition:
		$pattern
}

rule trunc_271cd1225ce2ecfc4690c5453540b39c {
	meta:
		aliases = "__GI_trunc, trunc"
		size = "215"
		objfiles = "s_trunc@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 28 DD 44 24 30 C7 44 24 18 00 00 00 00 DD 14 24 DD 5C 24 20 8B 54 24 24 C7 44 24 1C 00 00 00 00 8B 5C 24 20 C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 89 D0 C1 F8 14 25 FF 07 00 00 8D 88 01 FC FF FF 83 F9 13 C7 44 24 08 00 00 00 00 C7 44 24 0C 00 00 00 00 7F 3D 89 D3 81 E3 00 00 00 80 85 C9 79 12 89 5C 24 1C C7 44 24 18 00 00 00 00 DD 44 24 18 EB 52 B8 FF FF 0F 00 D3 F8 F7 D0 21 D0 09 D8 89 44 24 14 C7 44 24 10 00 00 00 00 DD 44 24 10 EB 33 83 F9 33 7E 0F 81 F9 00 04 00 00 75 29 DD 04 24 D8 C0 EB 1F 8D 88 ED FB FF FF 8B 54 24 24 83 C8 FF D3 E8 F7 D0 21 D8 89 54 24 0C 89 44 24 08 }
	condition:
		$pattern
}

rule sinh_1c35c4e6706ce0b82a255e622b797ea3 {
	meta:
		aliases = "__ieee754_sinh, __GI_sinh, sinh"
		size = "327"
		objfiles = "e_sinh@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 28 DD 44 24 30 DD 54 24 08 DD 54 24 18 8B 44 24 1C 89 C3 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7E 07 D8 C0 E9 0F 01 00 00 DD D8 85 C0 79 08 D9 05 ?? ?? ?? ?? EB 06 D9 05 ?? ?? ?? ?? DD 5C 24 20 81 FB FF FF 35 40 7F 6F 81 FB FF FF 2F 3E 7F 18 DD 44 24 08 DC 05 ?? ?? ?? ?? D9 E8 D9 C9 DF E9 DD D8 0F 87 D3 00 00 00 51 51 FF 74 24 14 FF 74 24 14 E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? 83 C4 10 81 FB FF FF EF 3F D9 C0 7F 16 D9 C1 D8 C2 D9 CA D8 C9 D9 C9 DC 05 ?? ?? ?? ?? DE F9 DE E9 EB 0A DD D9 D9 E8 D8 C1 D8 F9 DE C1 DD 44 24 20 DE C9 E9 80 00 00 00 81 FB 41 2E 86 40 7F 1D 52 52 FF 74 24 14 }
	condition:
		$pattern
}

rule _create_xid_d6d694f836136dc180f4ae3dff6c9cbb {
	meta:
		aliases = "_create_xid"
		size = "129"
		objfiles = "create_xid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 2C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 18 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 80 3D ?? ?? ?? ?? 00 75 2D 51 51 6A 00 8D 44 24 28 50 E8 ?? ?? ?? ?? 58 5A 68 ?? ?? ?? ?? 8B 44 24 28 33 44 24 2C 50 E8 ?? ?? ?? ?? 83 C4 10 C6 05 ?? ?? ?? ?? 01 51 51 8D 44 24 2C 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 5A 6A 01 53 E8 ?? ?? ?? ?? 8B 44 24 34 83 C4 38 5B C3 }
	condition:
		$pattern
}
...
rule siginterrupt_c3110e5e5e27bc0a313cf6efec443fe2 {
	meta:
		aliases = "siginterrupt"
		size = "110"
		objfiles = "sigintr@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 2C 8B 5C 24 34 8D 44 24 18 50 6A 00 53 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 48 83 7C 24 34 00 74 17 52 52 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 81 64 24 28 FF FF FF EF EB 15 50 50 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 81 4C 24 28 00 00 00 10 83 C4 0C 6A 00 8D 44 24 1C 50 53 E8 ?? ?? ?? ?? 83 C4 10 89 C2 83 C4 28 89 D0 5B C3 }
	condition:
		$pattern
}

rule sysctl_8ebaee23ea3653dcc88e312600be4d19 {
	meta:
		aliases = "sysctl"
		size = "94"
		objfiles = "sysctl@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 38 8B 44 24 40 8D 4C 24 10 89 44 24 10 8B 44 24 44 89 44 24 14 8B 44 24 48 89 44 24 18 8B 44 24 4C 89 44 24 1C 8B 44 24 50 89 44 24 20 8B 44 24 54 89 44 24 24 87 CB B8 95 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 38 5B C3 }
	condition:
		$pattern
}

rule signal_dfcab1d766cb0568fa9e1c7ab3e72086 {
	meta:
		aliases = "__GI_signal, bsd_signal, signal"
		size = "142"
		objfiles = "signal@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 38 8B 44 24 44 8B 5C 24 40 83 F8 FF 74 09 85 DB 7E 05 83 FB 40 7E 10 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 EB 5D 89 44 24 24 C7 44 24 30 00 00 00 00 C7 44 24 34 00 00 00 00 51 51 53 8D 44 24 3C 50 E8 ?? ?? ?? ?? 58 5A 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 83 F8 01 19 C0 25 00 00 00 10 89 44 24 2C 8D 44 24 14 50 8D 44 24 2C 50 53 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 04 8B 54 24 10 83 C4 38 89 D0 5B C3 }
	condition:
		$pattern
}

rule malloc_stats_706d3f6a28ae0647ab8e8f70d704c8d8 {
	meta:
		aliases = "malloc_stats"
		size = "87"
		objfiles = "mallinfo@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 38 8B 5C 24 40 8D 44 24 10 85 DB 0F 44 1D ?? ?? ?? ?? 83 EC 0C 50 E8 ?? ?? ?? ?? 8B 4C 24 2C 8B 44 24 38 8B 54 24 1C 83 EC 08 FF 74 24 48 FF 74 24 48 FF 74 24 40 50 51 FF 74 24 44 8D 04 01 52 01 CA 50 52 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 78 5B C3 }
	condition:
		$pattern
}

rule __GI_svcerr_progvers_34e71b089db5255958fc74bf8a63c936 {
	meta:
...
rule svc_sendreply_e4133af9987dfe6349a4143df0457bae {
	meta:
...
rule svcerr_noprog_21723abe4cd884e4a062d2e1e0b1ae34 {
	meta:
...
rule __pthread_initialize_manager_6e2d66ac5e2331fb92177f8ed36392ea {
	meta:
		aliases = "__pthread_initialize_manager"
		size = "484"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 38 A1 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 C7 00 01 00 00 00 75 05 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 EC 0C 8D 44 00 E0 50 E8 ?? ?? ?? ?? 83 C4 10 89 C2 A3 ?? ?? ?? ?? 83 C8 FF 85 D2 0F 84 9B 01 00 00 A1 ?? ?? ?? ?? 83 EC 0C 8D 44 42 E0 A3 ?? ?? ?? ?? 8D 44 24 3C 50 E8 ?? ?? ?? ?? 83 C4 10 40 75 13 83 EC 0C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? E9 E5 00 00 00 A1 ?? ?? ?? ?? 85 C0 0F 44 05 ?? ?? ?? ?? 85 C0 A3 ?? ?? ?? ?? 0F 84 85 00 00 00 A1 ?? ?? ?? ?? 8A 15 ?? ?? ?? ?? 08 C2 79 76 A1 ?? ?? ?? ?? 31 D2 E8 ?? ?? ?? ?? FF 74 24 30 68 00 0F 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 }
	condition:
		$pattern
}
...
rule asinh_de1e5320087573c39888f11630d59e6d {
	meta:
		aliases = "__GI_asinh, asinh"
		size = "314"
		objfiles = "s_asinh@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 48 DD 44 24 50 DD 54 24 20 DD 54 24 28 8B 5C 24 2C 89 D8 25 FF FF FF 7F 3D FF FF EF 7F 7E 07 D8 C0 E9 04 01 00 00 DD D8 3D FF FF 2F 3E 7F 18 DD 44 24 20 DC 05 ?? ?? ?? ?? D9 E8 D9 C9 DF E9 DD D8 0F 87 E7 00 00 00 3D 00 00 B0 41 7E 24 50 50 FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? DD 05 ?? ?? ?? ?? DE C1 E9 A6 00 00 00 DD 44 24 20 3D 00 00 00 40 D8 C8 DD 5C 24 10 7E 49 51 51 FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? DD 5C 24 48 D9 E8 DD 44 24 20 D8 C1 DD 54 24 20 DD 1C 24 DD 5C 24 10 E8 ?? ?? ?? ?? DD 44 24 48 D8 C0 D9 C9 DC 44 24 48 DD 44 24 10 DE F1 DE C1 DD 1C 24 }
	condition:
		$pattern
}

rule __GI_vswscanf_a36891d4f83bfa81cf91024c6e03625b {
	meta:
...
rule lstat64_ebc423f7424ae5712cb187031f0d6608 {
	meta:
...
rule ftok_3fb2abcd3ed711cd33ae87fe0ea85707 {
	meta:
		aliases = "ftok"
		size = "59"
		objfiles = "ftok@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 70 8D 44 24 18 8B 5C 24 7C 50 FF 74 24 7C E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 14 0F B6 54 24 10 C1 E3 18 0F B7 44 24 1C C1 E2 10 09 C2 09 DA 83 C4 68 89 D0 5B C3 }
	condition:
		$pattern
}

rule load_field_8e006f52cb390eda418486c8f97a3137 {
	meta:
		aliases = "load_field"
		size = "59"
		objfiles = "strftime@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 F8 07 8A 98 ?? ?? ?? ?? 8B 14 82 B9 6D 01 00 00 74 13 83 F8 05 0F B6 CB 75 0B 81 C2 6C 07 00 00 B9 0F 27 00 00 39 CA 77 09 83 F8 03 75 07 85 D2 75 03 83 CA FF 5B 89 D0 C3 }
	condition:
		$pattern
}
...
rule closelog_intern_ef57db50444ed7e6db928793f232b502 {
	meta:
		aliases = "closelog_intern"
		size = "84"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 89 C3 83 EC 08 A1 ?? ?? ?? ?? 83 F8 FF 74 0C 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 85 DB C7 05 ?? ?? ?? ?? FF FF FF FF C6 05 ?? ?? ?? ?? 00 75 1F C6 05 ?? ?? ?? ?? 00 C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C6 05 ?? ?? ?? ?? 01 C6 05 ?? ?? ?? ?? FF 5B 58 5B C3 }
	condition:
		$pattern
}

rule wait_node_free_d81f09f4b01f97c400738ae45faaa89c {
	meta:
		aliases = "wait_node_free"
		size = "43"
		objfiles = "spinlock@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 89 C3 83 EC 08 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 89 1D ?? ?? ?? ?? 89 03 C7 05 ?? ?? ?? ?? 00 00 00 00 59 5B 5B C3 }
	condition:
		$pattern
}

rule scan_getwc_56204def4cb7324f021a53a270f40300 {
	meta:
		aliases = "scan_getwc"
		size = "128"
		objfiles = "vfwscanf@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 89 C3 83 EC 08 C7 40 24 FF FF FF FF 8B 40 10 48 85 C0 89 43 10 78 3D 80 7B 19 00 75 4F 8B 53 08 83 7A 04 FD 75 1B 8B 42 10 3B 42 0C 73 0A 8B 08 83 C0 04 89 42 10 EB 22 C6 43 19 02 83 C8 FF EB 3A 83 EC 0C 52 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C1 75 06 80 4B 19 02 EB E2 8B 43 08 C6 43 1A 01 89 4B 04 8A 40 02 88 43 18 EB 04 C6 43 19 00 8B 43 04 FF 43 0C 89 43 24 31 C0 5A 59 5B C3 }
	condition:
		$pattern
}

rule __set_h_errno_5c0838bbedc598950816bec23c4123e0 {
	meta:
		aliases = "__set_h_errno"
		size = "19"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 89 C3 83 EC 08 E8 ?? ?? ?? ?? 89 18 89 D8 59 5B 5B C3 }
	condition:
		$pattern
}
...
rule __syscall_error_d5444ef9cd9417ec2a8050c69756aa62 {
	meta:
		aliases = "__syscall_error"
		size = "22"
		objfiles = "__syscall_error@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 89 C3 83 EC 08 F7 DB E8 ?? ?? ?? ?? 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __ether_line_2ad6b0c1daadfd53a056dc43c181028c {
	meta:
		aliases = "__ether_line"
		size = "64"
		objfiles = "ethers@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 89 C3 83 EC 10 52 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 03 EB 22 43 8A 03 84 C0 74 0B 3C 20 74 07 3C 09 75 F1 EB 01 43 8A 03 84 C0 74 0A 3C 20 74 F5 3C 09 75 04 EB EF 31 DB 5A 89 D8 59 5B C3 }
	condition:
		$pattern
}

rule skip_and_NUL_space_771a27dc4cb624f63bba7fd520a60288 {
	meta:
		aliases = "skip_and_NUL_space"
		size = "43"
		objfiles = "opennameservers@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 89 C3 8A 0B 84 C9 74 1E A1 ?? ?? ?? ?? 0F B6 D1 F6 04 50 20 74 10 80 F9 0A C6 03 00 74 08 80 F9 23 74 03 43 EB DC 89 D8 5B C3 }
	condition:
		$pattern
}

rule skip_nospace_d2f8cd1b29526efbfd12d5b0010dd9a4 {
	meta:
		aliases = "skip_nospace"
		size = "40"
		objfiles = "opennameservers@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 89 C3 EB 0B 80 F9 0A 75 05 C6 03 00 EB 15 43 8A 0B 84 C9 74 0E A1 ?? ?? ?? ?? 0F B6 D1 F6 04 50 20 74 E1 89 D8 5B C3 }
	condition:
		$pattern
}
...
rule swab_d724d3988a531678b72c85208161b828 {
	meta:
		aliases = "swab"
		size = "43"
		objfiles = "swab@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 44 24 10 8B 54 24 08 8B 4C 24 0C 83 E0 FE 8D 1C 02 EB 10 66 8B 02 83 C2 02 66 C1 C8 08 66 89 01 83 C1 02 39 DA 72 EC 5B C3 }
	condition:
		$pattern
}

rule __decode_header_dd6f7debdb3e121e73d640701cf27161 {
	meta:
		aliases = "__decode_header"
		size = "169"
		objfiles = "decodeh@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 4C 24 08 8B 5C 24 0C 0F B6 01 0F B6 51 01 C1 E0 08 09 C2 89 13 0F BE 41 02 C1 E8 1F 89 43 04 8A 41 02 C0 E8 03 0F B6 C0 83 E0 0F 89 43 08 0F B6 41 02 C1 E8 02 83 E0 01 89 43 0C 0F B6 41 02 D1 E8 83 E0 01 89 43 10 0F B6 41 02 83 E0 01 89 43 14 0F BE 41 03 C1 E8 1F 89 43 18 0F B6 41 03 83 E0 0F 89 43 1C 0F B6 41 04 0F B6 51 05 C1 E0 08 09 D0 89 43 20 0F B6 41 06 0F B6 51 07 C1 E0 08 09 D0 89 43 24 0F B6 41 08 0F B6 51 09 C1 E0 08 09 D0 89 43 28 0F B6 41 0A 0F B6 51 0B C1 E0 08 09 D0 89 43 2C 5B C3 }
	condition:
		$pattern
}
...
rule imaxabs_a80aab93f39bfc9b3615757885092c04 {
	meta:
...
rule sigorset_7d78352e4de1a75d8a633579919586f5 {
	meta:
		aliases = "sigorset"
		size = "32"
		objfiles = "sigorset@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 54 24 0C 8B 4C 24 10 8B 5C 24 08 8B 02 0B 01 89 03 8B 42 04 0B 41 04 89 43 04 31 C0 5B C3 }
	condition:
		$pattern
}

rule sigandset_e1d57573703d378995110f824f7b5cc5 {
	meta:
		aliases = "sigandset"
		size = "32"
		objfiles = "sigandset@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 54 24 0C 8B 4C 24 10 8B 5C 24 08 8B 02 23 01 89 03 8B 42 04 23 41 04 89 43 04 31 C0 5B C3 }
	condition:
		$pattern
}
...
rule rand_r_dc6cbb75c861de07ebb59e77bb0b0222 {
	meta:
		aliases = "rand_r"
		size = "84"
		objfiles = "rand_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 08 69 0B 6D 4E C6 41 81 C1 39 30 00 00 89 C8 69 C9 6D 4E C6 41 C1 E8 06 25 00 FC 1F 00 81 C1 39 30 00 00 89 CA 69 C9 6D 4E C6 41 C1 EA 10 81 E2 FF 03 00 00 31 D0 81 C1 39 30 00 00 89 CA 89 0B C1 EA 10 5B 81 E2 FF 03 00 00 C1 E0 0A 31 D0 C3 }
	condition:
		$pattern
}
...
rule wcsncat_3595f58d4f9bc2898cad0024517683f4 {
	meta:
		aliases = "wcsncat"
		size = "58"
		objfiles = "wcsncat@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 0C 8B 4C 24 10 8B 54 24 08 8B 02 83 C2 04 85 C0 75 F7 83 EA 04 EB 07 83 C3 04 49 83 C2 04 85 C9 74 08 8B 03 85 C0 89 02 75 ED 8B 44 24 08 C7 02 00 00 00 00 5B C3 }
	condition:
		$pattern
}

rule re_set_registers_5066b98a8cd623ea6f648ad6f3160909 {
	meta:
		aliases = "re_set_registers"
		size = "72"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 10 8B 4C 24 08 8B 54 24 0C 85 DB 8A 41 1C 74 19 24 F9 0C 02 88 41 1C 8B 44 24 14 89 1A 89 42 04 8B 44 24 18 89 42 08 EB 19 24 F9 88 41 1C C7 02 00 00 00 00 C7 42 08 00 00 00 00 C7 42 04 00 00 00 00 5B C3 }
	condition:
		$pattern
}
...
rule mq_send_4c7fdb29fd0d88a8091d52445b4b26c9 {
	meta:
		aliases = "__libc_pread, mq_receive, pread, mq_send"
		size = "35"
		objfiles = "pread_write@libc.a, mq_send@librt.a, mq_receive@librt.a"
	strings:
...
rule mq_timedsend_f43e4b84e8fd8c29e8cf51fdfd7b4207 {
	meta:
		aliases = "mq_timedreceive, mq_timedsend"
		size = "35"
		objfiles = "mq_send@librt.a, mq_receive@librt.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 18 8B 54 24 0C 8B 44 24 08 8B 4C 24 10 89 5C 24 0C 8B 5C 24 14 89 5C 24 08 5B E9 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI___sigismember_1e3ce8830f2033ddf0ba43e53074c277 {
	meta:
		aliases = "__sigismember, __GI___sigismember"
		size = "36"
...
rule __GI___sigaddset_0379e932dd433ec171494a833d079e2f {
	meta:
		aliases = "__sigaddset, __GI___sigaddset"
		size = "32"
		objfiles = "sigsetops@libc.a"
	strings:
...
rule __rpc_thread_variables_665a203ae20fce8abe1181e6f174285d {
	meta:
		aliases = "__rpc_thread_variables"
		size = "225"
		objfiles = "rpc_thread@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 ?? ?? ?? ?? 83 EC 08 85 C0 74 0F 83 EC 0C 6A 02 E8 ?? ?? ?? ?? 83 C4 10 EB 05 A1 ?? ?? ?? ?? 85 C0 89 C3 0F 85 B0 00 00 00 B8 ?? ?? ?? ?? 85 C0 74 16 50 50 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 EB 18 83 3D ?? ?? ?? ?? 00 75 0F E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 01 00 00 00 B8 ?? ?? ?? ?? 85 C0 74 0F 83 EC 0C 6A 02 E8 ?? ?? ?? ?? 83 C4 10 EB 05 A1 ?? ?? ?? ?? 85 C0 89 C3 75 56 50 50 68 C8 00 00 00 6A 01 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 22 89 C3 B8 ?? ?? ?? ?? 85 C0 74 0F 50 50 53 6A 02 E8 ?? ?? ?? ?? 83 C4 10 EB 27 89 1D ?? ?? ?? ?? EB 1F B8 ?? ?? ?? ?? 85 C0 74 0F 83 EC 0C }
	condition:
		$pattern
}
...
rule __GI_mbrtowc_7e0d23a3704f952b82e5f66f11b67d62 {
	meta:
		aliases = "mbrtowc, __GI_mbrtowc"
		size = "124"
		objfiles = "mbrtowc@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B8 ?? ?? ?? ?? 83 EC 18 8B 4C 24 2C 8B 54 24 24 8B 5C 24 20 85 C9 0F 44 C8 85 D2 75 0D 31 DB 8D 54 24 17 C6 44 24 17 00 EB 18 80 3A 00 75 0C 85 DB 74 3F C7 03 00 00 00 00 EB 37 83 7C 24 28 00 74 30 89 54 24 0C 83 EC 0C 51 6A 01 6A FF 8D 44 24 24 50 8D 44 24 2C 50 E8 ?? ?? ?? ?? 83 C4 20 85 C0 89 C2 78 0E 85 DB 74 0A 8B 44 24 10 89 03 EB 02 31 D2 83 C4 18 89 D0 5B C3 }
	condition:
		$pattern
}

rule __GI___sigdelset_738b54bb994f3bdda58ebdc448de54ba {
	meta:
...
rule __fpclassify_d98e4cc3164e6381ffa811be8f82114e {
	meta:
		aliases = "__GI___fpclassify, __fpclassify"
		size = "70"
		objfiles = "s_fpclassify@libm.a"
	strings:
		$pattern = { ( CC | 53 ) B9 02 00 00 00 83 EC 08 DD 44 24 10 DD 1C 24 8B 44 24 04 89 C2 25 00 00 F0 7F 81 E2 FF FF 0F 00 0B 14 24 89 D3 09 C3 74 16 85 C0 B1 03 74 10 3D 00 00 F0 7F B1 04 75 07 31 C9 85 D2 0F 94 C1 5A 89 C8 59 5B C3 }
	condition:
		$pattern
}
...
rule sigpending_703d97bb7b0f2f141fdc24e42933691a {
	meta:
		aliases = "sigpending"
		size = "50"
		objfiles = "sigpending@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B9 08 00 00 00 83 EC 08 8B 54 24 10 87 D3 B8 B0 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}

rule __GI_sigsuspend_c1c16f20ae8d929d59845bce9af87ba2 {
	meta:
		aliases = "sigsuspend, __GI_sigsuspend"
		size = "50"
		objfiles = "sigsuspend@libc.a"
	strings:
		$pattern = { ( CC | 53 ) B9 08 00 00 00 83 EC 08 8B 54 24 10 87 D3 B8 B3 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __GI___uClibc_fini_7420dc9aa618aef83c0f21bd110df823 {
	meta:
...
rule reboot_c2740615d3196d7da08fb393eb8a192e {
	meta:
		aliases = "reboot"
		size = "57"
		objfiles = "reboot@libc.a"
	strings:
		$pattern = { ( CC | 53 ) BB AD DE E1 FE 83 EC 08 B9 69 19 12 28 8B 54 24 10 89 D8 53 89 C3 B8 58 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule byte_regex_compile_512aab6c4eb245765d24869b236a579f {
	meta:
		aliases = "byte_regex_compile"
		size = "9316"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 01 C2 57 56 53 81 EC F8 01 00 00 89 84 24 F0 01 00 00 89 44 24 1C 8B 84 24 0C 02 00 00 89 4C 24 18 89 54 24 28 8B 40 14 89 44 24 2C 68 80 02 00 00 E8 ?? ?? ?? ?? 89 44 24 64 83 C4 10 85 C0 0F 84 FE 23 00 00 8B 94 24 00 02 00 00 8B 4C 24 0C 80 62 1C 97 89 4A 0C 80 3D ?? ?? ?? ?? 00 C7 42 08 00 00 00 00 C7 42 18 00 00 00 00 75 43 53 68 00 01 00 00 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 D2 83 C4 10 EB 14 A1 ?? ?? ?? ?? F6 44 50 01 08 74 07 C6 82 ?? ?? ?? ?? 01 42 81 FA FF 00 00 00 7E E4 C6 05 ?? ?? ?? ?? 01 C6 05 ?? ?? ?? ?? 01 8B 9C 24 00 02 00 00 83 7B 04 00 75 5A 8B 03 85 C0 74 0E 51 51 6A }
	condition:
		$pattern
}

rule setvbuf_0a0b9d49fa34bb16781eaa76f9cc0b59 {
	meta:
		aliases = "__GI_setvbuf, setvbuf"
		size = "275"
		objfiles = "setvbuf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C0 57 56 53 83 EC 1C 8B 74 24 30 8B 7C 24 34 8B 6C 24 3C 83 7E 34 00 0F 94 C0 85 C0 89 44 24 08 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 38 02 76 13 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 E9 94 00 00 00 0F B7 16 83 CB FF F7 C2 CF 08 00 00 0F 85 82 00 00 00 8B 44 24 38 80 E6 FC C1 E0 08 09 D0 66 89 06 83 7C 24 38 02 74 04 85 ED 75 08 31 FF 31 ED 31 DB EB 26 31 DB 85 FF 75 20 8B 46 0C 2B 46 08 39 E8 74 4E 83 EC 0C 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 3E 89 C7 66 BB 00 40 0F B7 06 F6 C4 40 74 14 83 EC 0C 80 E4 BF 66 89 06 }
	condition:
		$pattern
}

rule strptime_065fb2845992f2d6580e73ab35610cdb {
	meta:
		aliases = "strptime"
		size = "951"
		objfiles = "strptime@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C0 57 56 53 83 EC 6C 8B AC 24 80 00 00 00 C7 44 84 20 00 00 00 80 40 83 F8 0C 7E F2 8B BC 24 84 00 00 00 C7 44 24 08 00 00 00 00 8A 07 84 C0 75 4B 83 7C 24 08 00 75 36 83 7C 24 38 07 8B 44 24 08 0F 45 44 24 38 31 D2 89 44 24 38 8B 44 94 20 3D 00 00 00 80 74 0A 8B 8C 24 88 00 00 00 89 04 91 42 83 FA 07 7E E5 89 E8 E9 3F 03 00 00 FF 4C 24 08 8B 44 24 08 8B 7C 84 54 EB AF 3C 25 0F 85 FB 02 00 00 47 8A 07 3C 25 0F 84 F0 02 00 00 3C 4F 74 08 3C 45 B1 3F 75 0E EB 04 B0 40 EB 02 B0 80 88 C1 47 80 C9 3F 8A 17 84 D2 0F 84 FA 02 00 00 88 D0 0C 20 2C 61 3C 19 0F 87 EC 02 00 00 0F B6 C2 8A 90 ?? ?? }
	condition:
		$pattern
}

rule __GI_vfwscanf_309db1bc0549ebb22fe35d0eff293248 {
	meta:
		aliases = "vfwscanf, __GI_vfwscanf"
		size = "1693"
		objfiles = "vfwscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C0 57 B9 09 00 00 00 56 53 81 EC 0C 01 00 00 C7 44 24 48 FF FF FF FF 8D 7C 24 24 F3 AB 8B 84 24 20 01 00 00 83 78 34 00 0F 94 C0 0F B6 C0 85 C0 89 44 24 14 74 29 50 8B 9C 24 24 01 00 00 83 C3 38 53 68 ?? ?? ?? ?? 8D 84 24 FC 00 00 00 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 50 50 FF B4 24 28 01 00 00 8D 9C 24 BC 00 00 00 53 89 DD E8 ?? ?? ?? ?? 8B 84 24 C8 00 00 00 C7 84 24 EC 00 00 00 ?? ?? ?? ?? 8B BC 24 34 01 00 00 8A 40 03 C7 84 24 FC 00 00 00 ?? ?? ?? ?? C7 44 24 68 00 00 00 00 C6 44 24 23 01 88 84 24 D8 00 00 00 83 C4 10 E9 1A 05 00 00 80 A4 24 C9 00 00 00 01 C6 44 24 68 }
	condition:
		$pattern
}

rule vfscanf_ab974e08c109eab480bf6de67b3c0872 {
	meta:
		aliases = "__GI_vfscanf, vfscanf"
		size = "1651"
		objfiles = "vfscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C0 57 B9 09 00 00 00 56 53 81 EC EC 01 00 00 C7 84 24 30 01 00 00 FF FF FF FF 8D BC 24 0C 01 00 00 F3 AB 8B 84 24 00 02 00 00 83 78 34 00 0F 94 C0 0F B6 C0 85 C0 89 44 24 08 74 29 57 8B 9C 24 04 02 00 00 83 C3 38 53 68 ?? ?? ?? ?? 8D 84 24 E4 01 00 00 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 56 56 FF B4 24 08 02 00 00 8D 9C 24 A4 01 00 00 53 89 DD E8 ?? ?? ?? ?? 8B 84 24 B0 01 00 00 C7 84 24 D4 01 00 00 ?? ?? ?? ?? 8B B4 24 14 02 00 00 8A 40 03 C7 84 24 50 01 00 00 00 00 00 00 C6 44 24 17 01 88 84 24 C0 01 00 00 8B 84 24 D8 01 00 00 89 84 24 E4 01 00 00 83 C4 10 E9 06 05 00 00 }
	condition:
		$pattern
}

rule _vfwprintf_internal_8e63c474e4596d6f71c030ab7500f96b {
	meta:
		aliases = "_vfwprintf_internal"
		size = "1918"
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C0 57 B9 2F 00 00 00 56 53 81 EC 8C 02 00 00 8B B4 24 A4 02 00 00 8D BC 24 1C 01 00 00 F3 AB 8D 84 24 7C 02 00 00 FF 8C 24 34 01 00 00 89 B4 24 1C 01 00 00 C7 84 24 2C 01 00 00 80 00 00 00 C7 84 24 7C 02 00 00 00 00 00 00 89 B4 24 88 02 00 00 50 6A FF 8D 84 24 90 02 00 00 50 6A 00 E8 ?? ?? ?? ?? 83 C4 10 40 75 10 C7 84 24 1C 01 00 00 ?? ?? ?? ?? E9 80 00 00 00 BA 09 00 00 00 8D 84 24 44 01 00 00 C7 00 08 00 00 00 83 C0 04 4A 75 F4 89 F0 8D 9C 24 1C 01 00 00 EB 30 83 FA 25 75 28 83 C0 04 83 38 25 74 20 89 84 24 1C 01 00 00 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 39 8B 84 24 1C 01 00 }
	condition:
		$pattern
}
...
rule __ffssi2_3955bdfbd9cc4ea8761218a50526c99a {
	meta:
		aliases = "__ffssi2"
		size = "20"
		objfiles = "_ffssi2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C0 89 E5 8B 55 08 85 D2 74 06 0F BC C2 83 C0 01 5D C3 }
	condition:
		$pattern
}
...
rule _dl_load_elf_shared_library_f2985e739782f229549ef6a80af9a279 {
	meta:
		aliases = "_dl_load_elf_shared_library"
		size = "2790"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C9 57 31 D2 56 53 81 EC 2C 01 00 00 8B 84 24 48 01 00 00 53 89 C3 B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 44 24 30 76 09 F7 D8 A3 ?? ?? ?? ?? EB 07 83 7C 24 30 00 79 0F C7 05 ?? ?? ?? ?? 01 00 00 00 E9 82 0A 00 00 8D 8C 24 E8 00 00 00 8B 54 24 30 87 D3 B8 6C 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 76 09 F7 D8 A3 ?? ?? ?? ?? EB 04 85 C0 79 0F C7 05 ?? ?? ?? ?? 01 00 00 00 E9 18 08 00 00 83 BC 24 40 01 00 00 00 74 0E F6 84 24 F1 00 00 00 08 0F 84 00 08 00 00 8B 2D ?? ?? ?? ?? EB 46 83 BD E0 00 00 00 00 8B 84 24 E8 00 00 00 75 33 39 85 DC 00 00 00 75 2B 8B 85 E4 00 00 00 3B 84 24 EC 00 00 00 }
	condition:
		$pattern
}

rule __negdi2_b72a2601875475fb6b053b798c336cca {
	meta:
		aliases = "__negdi2"
		size = "54"
		objfiles = "_negdi2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C9 89 E5 83 EC 0C 89 75 F8 8B 75 08 89 7D FC 8B 7D 0C 89 75 F4 89 FE 8B 7D FC F7 DE 83 7D F4 00 0F 95 C1 29 CE F7 5D F4 89 F2 8B 45 F4 8B 75 F8 89 EC 5D C3 }
	condition:
		$pattern
}

rule __stdio_adjust_position_e8fc9fc23bc27b829026ce6986f69dda {
	meta:
		aliases = "__stdio_adjust_position"
		size = "155"
		objfiles = "_adjust_pos@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 D2 57 56 53 83 EC 0C 8B 5C 24 20 0F B7 0B 89 C8 83 E0 03 74 27 89 C2 4A 74 22 F6 C5 08 74 1D 83 FA 02 74 68 83 7B 28 00 75 62 0F B6 53 03 F7 DA 83 7B 2C 00 7E 06 0F B6 43 02 29 C2 F6 C1 40 74 05 8B 43 08 EB 03 8B 43 14 2B 53 10 8D 34 02 8B 44 24 24 8B 08 8B 58 04 89 F0 99 89 CF 29 F7 89 DD 19 D5 89 EA 8B 6C 24 24 39 DA 89 7D 00 89 55 04 7C 08 7F 04 39 CF 76 02 F7 DE 85 F6 79 10 E8 ?? ?? ?? ?? C7 00 4B 00 00 00 EB 03 83 CE FF 83 C4 0C 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule pthread_cancel_4edaf77392d2cf0a7b33d2d9bb376800 {
	meta:
		aliases = "pthread_cancel"
		size = "180"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 31 D2 57 56 53 83 EC 0C 8B 74 24 20 89 F0 25 FF 03 00 00 C1 E0 04 8D B8 ?? ?? ?? ?? 89 F8 E8 ?? ?? ?? ?? 8B 5F 08 85 DB 74 05 39 73 10 74 70 83 EC 0C 57 E8 ?? ?? ?? ?? B8 03 00 00 00 EB 58 83 EC 0C 57 E8 ?? ?? ?? ?? EB 4B 8B 83 44 01 00 00 31 F6 8B 6B 14 85 C0 74 13 52 52 53 FF 30 FF 50 04 83 C4 10 89 C6 88 83 40 01 00 00 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C4 10 85 F6 74 0B 83 EC 0C 53 E8 ?? ?? ?? ?? EB 0E 50 50 FF 35 ?? ?? ?? ?? 55 E8 ?? ?? ?? ?? 31 C0 83 C4 1C 5B 5E 5F 5D C3 80 7B 40 01 0F B6 43 42 C6 43 42 01 74 92 85 C0 75 8E EB 97 }
	condition:
		$pattern
}

rule pthread_setschedparam_475ea0078353398db0df40cb79c872b5 {
	meta:
...
rule __floatundidf_b31d866ee67859999833fb6bfff4e489 {
	meta:
		aliases = "__floatundixf, __floatundidf"
		size = "50"
		objfiles = "_floatundixf@libgcc.a, _floatundidf@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 D2 89 E5 8B 45 0C E8 ?? ?? ?? ?? 81 C1 ?? ?? ?? ?? 52 31 D2 50 8B 45 08 DF 2C 24 83 C4 08 52 D8 89 ?? ?? ?? ?? 50 DF 2C 24 83 C4 08 5D DE C1 C3 }
	condition:
		$pattern
}

rule __getgrouplist_internal_f39d1e125ac02db9ac4858ef245eb772 {
	meta:
		aliases = "__getgrouplist_internal"
		size = "279"
		objfiles = "__getgrouplist_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 81 EC 28 01 00 00 8B 84 24 44 01 00 00 C7 00 01 00 00 00 6A 20 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 DF 00 00 00 89 C5 8B 84 24 34 01 00 00 89 45 00 51 51 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 0F 84 B5 00 00 00 BF 01 00 00 00 C7 40 34 01 00 00 00 EB 67 8B 84 24 34 01 00 00 39 84 24 14 01 00 00 74 57 8B 9C 24 18 01 00 00 EB 48 52 52 FF B4 24 38 01 00 00 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 2F F7 C7 07 00 00 00 75 19 50 50 8D 04 BD 20 00 00 00 50 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 44 89 C5 8B 84 24 14 01 00 00 89 44 BD 00 47 EB 09 83 C3 04 8B 03 85 C0 }
	condition:
		$pattern
}
...
rule _fp_out_wide_ac06bffe887663976600808c6f8920d8 {
	meta:
		aliases = "_fp_out_wide"
		size = "148"
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 81 EC 8C 00 00 00 8B B4 24 A4 00 00 00 8B 9C 24 A8 00 00 00 89 F0 84 C0 79 35 83 EC 0C FF B4 24 B8 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 29 C3 89 C7 85 DB 7E 19 8B 84 24 A0 00 00 00 83 E6 7F 89 D9 89 F2 E8 ?? ?? ?? ?? 39 D8 89 C5 75 34 89 FB 85 DB 7E 2E 31 D2 8B 8C 24 AC 00 00 00 0F B6 04 11 89 44 94 14 42 39 DA 7C EC 50 FF B4 24 A4 00 00 00 53 8D 44 24 20 50 E8 ?? ?? ?? ?? 83 C4 10 01 C5 81 C4 8C 00 00 00 89 E8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule parse_printf_format_d3513017771569cac4df1f59409b693a {
	meta:
		aliases = "parse_printf_format"
		size = "233"
		objfiles = "parse_printf_format@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 81 EC D4 00 00 00 8B BC 24 E8 00 00 00 8B 9C 24 EC 00 00 00 8B B4 24 F0 00 00 00 57 8D 44 24 1C 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 88 A5 00 00 00 8B 44 24 28 85 C0 0F 8E 93 00 00 00 39 C3 89 C1 0F 46 CB 89 C5 31 D2 EB 0A 8B 44 94 38 42 89 06 83 C6 04 39 CA 72 F2 EB 7C 3C 25 75 71 47 80 3F 25 74 6B 89 7C 24 10 83 EC 0C 8D 44 24 1C 50 E8 ?? ?? ?? ?? 8B 7C 24 20 83 C4 10 81 7C 24 18 00 00 00 80 75 0F 45 85 DB 74 0A C7 06 00 00 00 00 4B 83 C6 04 81 7C 24 14 00 00 00 80 75 0F 45 85 DB 74 0A C7 06 00 00 00 00 4B 83 C6 04 31 D2 EB 15 8B 44 94 38 83 F8 08 74 0B 45 85 DB 74 06 89 06 }
	condition:
		$pattern
}

rule __GI_inet_network_128f05748ca3d69ba50c2e475a02cefb {
	meta:
		aliases = "inet_network, __GI_inet_network"
		size = "223"
		objfiles = "inet_net@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 83 EC 08 8B 4C 24 1C C7 44 24 04 00 00 00 00 80 39 30 74 0B 31 F6 C7 04 24 0A 00 00 00 EB 23 41 8A 01 3C 78 74 12 3C 58 74 0E BE 01 00 00 00 C7 04 24 08 00 00 00 EB 0A 41 31 F6 C7 04 24 10 00 00 00 31 FF EB 54 A1 ?? ?? ?? ?? 0F B6 DA 0F B7 04 58 A8 08 74 17 83 3C 24 08 75 05 80 FA 37 77 6C 8B 04 24 0F AF C7 8D 7C 03 D0 EB 1F 83 3C 24 10 75 2D A8 10 74 29 83 E0 02 83 F8 01 89 F8 19 D2 83 E2 E0 C1 E0 04 29 D0 8D 78 A9 81 FF FF 00 00 00 77 39 41 BE 01 00 00 00 8A 11 84 D2 75 A6 85 F6 74 29 89 E8 C1 E0 08 83 7C 24 04 00 0F 45 E8 09 FD 80 FA 2E 75 11 FF 44 24 04 83 7C 24 04 04 74 }
	condition:
		$pattern
}

rule bsearch_3fec60e9c996986f1f6c6c2443d6e9df {
	meta:
		aliases = "bsearch"
		size = "90"
		objfiles = "bsearch@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 83 EC 0C 83 7C 24 2C 00 8B 74 24 28 75 38 EB 3A 89 F0 8B 7C 24 24 29 E8 D1 E8 8D 1C 28 8B 44 24 2C 0F AF C3 01 C7 50 50 57 FF 74 24 2C FF 54 24 40 83 C4 10 83 F8 00 7E 05 8D 6B 01 EB 08 75 04 89 F8 EB 08 89 DE 39 F5 72 C6 31 C0 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _fp_out_narrow_026fe38bee34fb16ee7f81375f499a13 {
	meta:
		aliases = "_fp_out_narrow"
		size = "106"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 83 EC 0C 8B 74 24 24 8B 5C 24 28 89 F0 84 C0 79 2F 83 EC 0C FF 74 24 38 E8 ?? ?? ?? ?? 83 C4 10 29 C3 89 C7 85 DB 7E 16 8B 44 24 20 83 E6 7F 89 D9 89 F2 E8 ?? ?? ?? ?? 39 D8 89 C5 75 1C 89 FB 31 C0 85 DB 7E 12 52 FF 74 24 24 53 FF 74 24 38 E8 ?? ?? ?? ?? 83 C4 10 01 C5 83 C4 0C 89 E8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_svc_getreqset_f11f1ae801794b7773f84589d1393b61 {
	meta:
		aliases = "svc_getreqset, __GI_svc_getreqset"
		size = "93"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 83 EC 0C E8 ?? ?? ?? ?? 8B 7C 24 20 89 44 24 08 EB 37 8B 37 EB 1D 8D 58 FF 83 EC 0C 8D 04 2B 50 E8 ?? ?? ?? ?? B8 01 00 00 00 88 D9 D3 E0 83 C4 10 31 C6 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 D3 83 C7 04 83 C5 20 3B 6C 24 08 7C C3 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __pthread_destroy_specifics_714cc16dc604b0dc11a912147c606456 {
	meta:
		aliases = "__pthread_destroy_specifics"
		size = "207"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 83 EC 0C E8 ?? ?? ?? ?? C7 44 24 08 01 00 00 00 89 C6 EB 5A 83 7C 9E 74 00 74 4C 89 D8 31 FF C1 E0 05 89 44 24 04 EB 3A 8B 44 24 04 01 F8 8B 0C C5 ?? ?? ?? ?? 8D 04 BD 00 00 00 00 03 44 9E 74 85 C9 8B 10 74 1B 85 D2 74 17 83 EC 0C C7 00 00 00 00 00 52 FF D1 C7 44 24 18 01 00 00 00 83 C4 10 47 83 FF 1F 7E C1 43 83 FB 1F 7E A7 45 83 7C 24 08 00 74 11 83 FD 03 7F 0C 31 DB C7 44 24 08 00 00 00 00 EB E2 8B 46 1C 89 F2 31 DB E8 ?? ?? ?? ?? EB 1D 8B 44 9E 74 85 C0 74 14 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 C7 44 9E 74 00 00 00 00 43 83 FB 1F 7E DE 83 EC 0C FF 76 1C E8 ?? ?? ?? ?? 83 }
	condition:
		$pattern
}

rule svctcp_create_f19368caf6c34e95ef9a283abd0c42a8 {
	meta:
		aliases = "svctcp_create"
		size = "361"
		objfiles = "svc_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 83 EC 2C 8B 5C 24 40 C7 44 24 28 10 00 00 00 83 FB FF 75 2B 50 66 BD 01 00 6A 06 6A 01 6A 02 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 79 12 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E9 CD 00 00 00 8D 74 24 18 31 C0 89 F7 AB AB AB AB 66 C7 44 24 18 02 00 50 50 56 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 16 66 C7 44 24 1A 00 00 50 FF 74 24 2C 56 53 E8 ?? ?? ?? ?? 83 C4 10 57 8D 44 24 2C 50 56 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 11 56 56 6A 02 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 28 83 EC 0C 31 F6 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 ED 0F 84 A2 00 00 00 83 EC 0C 53 E8 ?? ?? ?? ?? E9 91 }
	condition:
		$pattern
}
...
rule svc_getreq_poll_508fbb38c9966f74f2b0cbc2e9a1969e {
	meta:
		aliases = "__GI_svc_getreq_poll, svc_getreq_poll"
		size = "101"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 31 FF 56 31 F6 53 83 EC 0C 8B 6C 24 20 EB 3D 8D 44 F5 00 8B 18 83 FB FF 74 31 0F BF 40 06 85 C0 74 29 47 A8 20 74 18 E8 ?? ?? ?? ?? 83 EC 0C 8B 80 B4 00 00 00 FF 34 98 E8 ?? ?? ?? ?? EB 09 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 46 E8 ?? ?? ?? ?? 3B 30 7D 06 3B 7C 24 24 7C B4 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule inet_ntop4_945010c5d7485a088dafe209d689090c {
	meta:
		aliases = "inet_ntop4"
		size = "266"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 31 FF 56 53 31 DB 83 EC 3C 89 44 24 18 89 54 24 14 89 4C 24 10 C6 44 24 2B 00 E9 9F 00 00 00 8B 6C 24 18 B1 64 8D 53 01 01 FD 0F B6 45 00 66 89 44 24 0A F6 F1 88 C1 80 C1 30 88 4C 1C 2B 89 D9 89 54 24 0C 80 7C 1C 2B 30 75 2D 66 8B 44 24 0A B2 0A F6 F2 BA 0A 00 00 00 89 D6 31 D2 88 44 24 0A 0F B6 C0 F7 F6 88 D0 04 30 3C 30 88 44 1C 2B 74 2C 8B 4C 24 0C EB 26 66 8B 44 24 0A B1 0A BA 0A 00 00 00 8B 74 24 0C F6 F1 89 D1 31 D2 0F B6 C0 F7 F1 8D 4B 02 88 D0 04 30 88 44 34 2B 0F B6 45 00 BA 0A 00 00 00 47 89 D3 31 D2 C6 44 0C 2C 2E F7 F3 8D 59 02 88 D0 04 30 88 44 0C 2B 83 FF 03 0F 8E 58 FF FF }
	condition:
		$pattern
}

rule __psfs_parse_spec_f9901540f830361f905fe720a367ec9c {
	meta:
		aliases = "__psfs_parse_spec"
		size = "461"
		objfiles = "__psfs_parse_spec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 31 FF 56 53 83 EC 0C 8B 74 24 20 8B 6E 30 8A 45 00 2C 30 3C 09 76 07 C6 44 24 0B 01 EB 4F 81 FF CB CC CC 0C 7F 11 8B 46 30 6B D7 0A 0F B6 08 40 89 46 30 8D 7C 11 D0 8B 5E 30 8A 0B 88 C8 2C 30 3C 09 76 DA 80 F9 24 74 19 83 7E 24 00 0F 89 62 01 00 00 89 7E 40 C7 46 24 FE FF FF FF E9 9E 00 00 00 8D 43 01 89 46 30 C6 44 24 0B 00 BB ?? ?? ?? ?? BA 10 00 00 00 8B 4E 30 8A 03 3A 01 75 0B 08 56 45 8D 41 01 89 46 30 EB E2 43 80 3B 00 74 04 01 D2 EB E2 F6 46 45 10 74 08 C6 46 44 00 31 D2 EB 50 80 7C 24 0B 00 74 13 83 7E 24 00 0F 89 01 01 00 00 C7 46 24 FE FF FF FF EB E2 83 7E 24 FE 0F 84 EE 00 00 }
	condition:
		$pattern
}

rule __parsespent_929391ac012f6298394565f5a93942a3 {
	meta:
		aliases = "__parsespent"
		size = "130"
		objfiles = "__parsespent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 31 FF 56 53 83 EC 1C 8B 74 24 34 8D 6C 24 18 0F B6 87 ?? ?? ?? ?? 8B 5C 24 30 01 C3 83 FF 01 7F 15 89 33 52 52 6A 3A 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 34 EB 3B 50 6A 0A 55 56 E8 ?? ?? ?? ?? 83 C4 10 39 74 24 18 89 03 75 06 C7 03 FF FF FF FF 83 FF 08 8B 44 24 18 75 09 31 D2 80 38 00 74 15 EB 0E 80 38 3A 75 09 8D 70 01 47 C6 00 00 EB 9E BA 16 00 00 00 83 C4 1C 89 D0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule readdir_r_f508534b7b169ad1a34d6c7e2644f745 {
	meta:
		aliases = "__GI_readdir_r, readdir_r"
		size = "192"
		objfiles = "readdir_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 31 FF 56 53 83 EC 20 8B 74 24 34 8B 6C 24 3C 8D 5E 18 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 46 08 3B 46 04 77 36 53 FF 76 14 FF 76 0C FF 36 E8 ?? ?? ?? ?? 83 C4 10 83 F8 00 7F 16 C7 45 00 00 00 00 00 75 04 31 DB EB 44 E8 ?? ?? ?? ?? 8B 18 EB 3B 89 46 08 C7 46 04 00 00 00 00 8B 46 04 89 C7 03 7E 0C 0F B7 57 08 8D 04 02 89 46 04 8B 47 04 89 46 10 83 3F 00 74 A5 51 31 DB 52 57 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 10 89 45 00 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 85 FF B8 00 00 00 00 0F 45 D8 83 C4 2C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_readdir64_r_dd96b8f6377a207c43b5c576ffd089d8 {
	meta:
		aliases = "readdir64_r, __GI_readdir64_r"
		size = "194"
		objfiles = "readdir64_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 31 FF 56 53 83 EC 20 8B 74 24 34 8B 6C 24 3C 8D 5E 18 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 46 08 3B 46 04 77 36 53 FF 76 14 FF 76 0C FF 36 E8 ?? ?? ?? ?? 83 C4 10 83 F8 00 7F 16 C7 45 00 00 00 00 00 75 04 31 DB EB 46 E8 ?? ?? ?? ?? 8B 18 EB 3D 89 46 08 C7 46 04 00 00 00 00 8B 46 04 89 C7 03 7E 0C 0F B7 57 10 8D 04 02 89 46 04 8B 47 08 89 46 10 8B 07 0B 47 04 74 A3 51 31 DB 52 57 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 10 89 45 00 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 85 FF B8 00 00 00 00 0F 45 D8 83 C4 2C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _dl_parse_dynamic_info_e1a20146f3b95dab650ec3a53a5ad5e8 {
	meta:
		aliases = "_dl_parse_dynamic_info"
		size = "274"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 31 FF 56 53 8B 54 24 14 8B 5C 24 18 8B 6C 24 1C 8B 74 24 20 E9 9A 00 00 00 83 F9 21 7F 58 8B 42 04 83 3A 15 89 04 8B 75 03 89 6A 04 83 3A 18 75 07 C7 43 60 01 00 00 00 83 3A 1E 75 0D F6 42 04 08 74 07 C7 43 60 01 00 00 00 83 3A 16 75 07 C7 43 58 01 00 00 00 83 3A 1D 75 07 C7 43 3C 00 00 00 00 83 3A 0F 75 49 83 7B 74 00 74 43 C7 43 3C 00 00 00 00 EB 3A 81 F9 FF FF FF 6F 7F 32 81 F9 FA FF FF 6F 75 09 8B 42 04 89 83 88 00 00 00 81 3A FB FF FF 6F 75 19 F6 42 04 01 74 07 C7 43 60 01 00 00 00 89 F8 80 CC 10 F6 42 04 08 0F 45 F8 83 C2 08 8B 0A 85 C9 0F 85 5C FF FF FF 85 F6 74 48 8B 43 10 85 C0 }
	condition:
		$pattern
}
...
rule dladdr_9df3af6a4483822f787274b124803ca2 {
	meta:
		aliases = "dladdr"
		size = "335"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 31 F6 53 83 EC 18 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? EB 17 8B 50 14 3B 54 24 2C 73 0B 85 F6 74 05 39 56 14 73 02 89 C6 8B 40 0C 85 C0 75 E5 85 F6 0F 84 0F 01 00 00 8B 46 04 8B 54 24 30 8B 6E 54 C7 44 24 08 00 00 00 00 C7 44 24 0C 00 00 00 00 89 02 8B 46 14 C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 89 42 04 8B 46 58 89 44 24 04 E9 86 00 00 00 8B 46 2C 8B 54 24 08 8B 1C 90 EB 72 8B 06 8B 4C 24 04 89 04 24 89 D8 C1 E0 04 01 C1 0F B7 79 0E 8B 51 04 85 FF 75 04 85 D2 74 4D 0F B6 41 0C 83 E0 0F 83 F8 06 74 41 03 14 24 39 54 24 2C 72 38 85 FF 74 06 83 79 08 00 75 06 39 54 24 2C 74 0B 89 D0 }
	condition:
		$pattern
}

rule __parsepwent_0a55967999cf9a76f9d508ae47f4bfb6 {
	meta:
		aliases = "__parsepwent"
		size = "120"
		objfiles = "__parsepwent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 31 F6 53 83 EC 1C 8B 5C 24 34 8D 6C 24 18 0F B6 86 ?? ?? ?? ?? 8B 7C 24 30 01 C7 89 F0 83 E0 06 83 F8 02 74 1A 83 FE 06 89 1F 74 3A 52 52 6A 3A 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 20 EB 2B 50 6A 0A 55 53 E8 ?? ?? ?? ?? 89 C2 8B 44 24 28 83 C4 10 39 D8 74 14 80 38 3A 75 0F 89 17 8D 58 01 46 C6 00 00 EB A8 31 C0 EB 03 83 C8 FF 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __parsegrent_2832726c08ba6203d49ba370fcd40f63 {
	meta:
		aliases = "__parsegrent"
		size = "223"
		objfiles = "__parsegrent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 31 F6 53 83 EC 1C 8B 6C 24 30 8B 5C 24 34 8B 45 00 89 44 24 08 0F B6 86 ?? ?? ?? ?? 83 FE 01 8D 7C 05 00 7F 20 89 1F 52 52 6A 3A 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 95 00 00 00 8D 58 01 46 C6 00 00 EB D0 50 6A 0A 8D 44 24 20 50 53 E8 ?? ?? ?? ?? 8B 4C 24 28 83 C4 10 39 D9 89 07 74 71 80 39 3A 75 6C 80 79 01 00 BB 01 00 00 00 74 2B C6 01 2C 80 39 2C 75 1D C6 01 00 41 8A 01 84 C0 74 4F 3C 2C 74 4B 0F B6 D0 A1 ?? ?? ?? ?? F6 04 50 20 75 3D 43 41 80 39 00 75 D8 8D 51 04 83 E2 FC 8D 04 9A 3B 44 24 08 77 27 89 D9 49 89 55 0C 74 15 8B 44 24 18 40 89 02 83 C2 04 49 74 08 40 80 38 00 75 FA }
	condition:
		$pattern
}

rule __encode_dotted_5cef6cb9e95ac147fadef3b27f6ad38e {
	meta:
		aliases = "__encode_dotted"
		size = "145"
		objfiles = "encoded@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 31 DB 83 EC 0C 8B 7C 24 20 EB 5A 52 52 6A 2E 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C5 74 06 89 C6 29 FE EB 0E 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C4 10 89 C6 85 F6 74 4C 8B 44 24 28 29 D8 48 39 C6 73 41 8B 54 24 24 89 F0 88 04 1A 43 50 89 D0 56 01 D8 57 50 E8 ?? ?? ?? ?? 83 C4 10 85 ED 8D 1C 1E 74 0C 8D 7D 01 85 FF 74 05 80 3F 00 75 9D 83 7C 24 28 00 7E 0D 8B 44 24 24 C6 04 18 00 8D 43 01 EB 03 83 C8 FF 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __open_nameservers_099176da2ab3c77602c6e2fc5850e743 {
	meta:
		aliases = "__open_nameservers"
		size = "963"
		objfiles = "opennameservers@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 0C 02 00 00 83 3D ?? ?? ?? ?? 00 75 3D 50 50 8D 84 24 A0 01 00 00 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 44 94 24 D8 01 00 00 39 15 ?? ?? ?? ?? 89 94 24 D8 01 00 00 74 0B 89 15 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 0F 85 50 03 00 00 55 55 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? C6 05 ?? ?? ?? ?? 05 C6 05 ?? ?? ?? ?? 03 E8 ?? ?? ?? ?? 89 44 24 18 83 C4 10 85 C0 0F 85 29 02 00 00 E9 60 02 00 00 8D 84 24 18 01 00 00 E8 ?? ?? ?? ?? 89 C6 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 57 57 68 ?? ?? ?? ?? 56 89 C5 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 0F 85 BF 00 00 00 89 E8 E8 ?? }
	condition:
		$pattern
}
...
rule svc_getreq_common_5803ba96f1ecceefca4628e199a7c561 {
	meta:
		aliases = "__GI_svc_getreq_common, svc_getreq_common"
		size = "419"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 0C 05 00 00 8D 44 24 0C 89 84 24 D8 04 00 00 8D 84 24 9C 01 00 00 89 84 24 E4 04 00 00 E8 ?? ?? ?? ?? 8B 90 B4 00 00 00 89 C5 8B 84 24 20 05 00 00 8B 1C 82 85 DB 0F 84 56 01 00 00 57 57 8B 43 08 8D 94 24 C4 04 00 00 52 53 FF 10 83 C4 10 85 C0 0F 84 14 01 00 00 8D 84 24 2C 03 00 00 89 84 24 04 05 00 00 8B 84 24 C8 04 00 00 8D 94 24 F8 04 00 00 89 9C 24 08 05 00 00 89 84 24 EC 04 00 00 8B 84 24 CC 04 00 00 89 84 24 F0 04 00 00 8B 84 24 D0 04 00 00 89 84 24 F4 04 00 00 8D 84 24 D4 04 00 00 56 6A 0C 50 52 E8 ?? ?? ?? ?? 83 C4 10 83 BC 24 D4 04 00 00 00 75 1F A1 ?? ?? ?? ?? 8B 94 }
	condition:
		$pattern
}

rule openpty_54547b339527c0861ba57d9a86d4a324 {
	meta:
...
rule __GI___res_querydomain_93a6b03139ae5e41662d13f09aaf75b6 {
	meta:
		aliases = "__res_querydomain, __GI___res_querydomain"
		size = "249"
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 1C 04 00 00 8B 9C 24 30 04 00 00 8B BC 24 34 04 00 00 8B AC 24 40 04 00 00 85 DB 74 04 85 ED 75 0D E8 ?? ?? ?? ?? C7 00 FF FF FF FF EB 27 85 FF 75 51 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 89 C2 8D 40 01 3D 01 04 00 00 76 13 E8 ?? ?? ?? ?? C7 00 03 00 00 00 83 C8 FF E9 8B 00 00 00 85 D2 74 63 8D 72 FF 80 3C 33 2E 75 5A 52 56 53 8D 5C 24 27 53 E8 ?? ?? ?? ?? 89 D8 C6 44 34 2B 00 83 C4 10 EB 43 83 EC 0C 53 E8 ?? ?? ?? ?? 89 3C 24 89 C6 E8 ?? ?? ?? ?? 83 C4 10 8D 44 06 02 3D 01 04 00 00 77 A6 83 EC 0C 57 53 68 ?? ?? ?? ?? 68 01 04 00 00 8D 5C 24 37 53 E8 ?? ?? ?? ?? 89 D8 83 C4 20 }
	condition:
		$pattern
}

rule __GI_clnt_sperror_3c8d4eab91da9992a227e80ebef55e43 {
	meta:
...
rule realpath_21a13ab0743b6f5d1b218bd3366d8d68 {
	meta:
		aliases = "__GI_realpath, realpath"
		size = "605"
		objfiles = "realpath@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 1C 10 00 00 8B 9C 24 30 10 00 00 8B AC 24 34 10 00 00 85 DB 75 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 10 80 3B 00 75 12 E8 ?? ?? ?? ?? C7 00 02 00 00 00 31 ED E9 10 02 00 00 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 3D FD 0F 00 00 76 0D E8 ?? ?? ?? ?? C7 00 24 00 00 00 EB D9 8D BC 24 1B 10 00 00 56 29 C7 56 53 89 FB 57 E8 ?? ?? ?? ?? 83 C4 10 85 ED C7 44 24 08 00 00 00 00 75 16 83 EC 0C 68 00 10 00 00 E8 ?? ?? ?? ?? 89 44 24 18 89 C5 83 C4 10 8D 85 FE 0F 00 00 89 44 24 04 80 3F 2F 74 49 51 51 68 FF 0F 00 00 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 9B 00 00 00 83 EC 0C 55 E8 ?? ?? ?? }
	condition:
		$pattern
}

rule clnt_broadcast_aff9ce1632e15e9818558cc0559098d4 {
	meta:
		aliases = "clnt_broadcast"
		size = "1465"
		objfiles = "pmap_rmt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 1C 29 00 00 E8 ?? ?? ?? ?? C7 84 24 14 29 00 00 01 00 00 00 89 44 24 04 55 6A 11 6A 02 6A 02 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C5 79 0D 83 EC 0C 68 ?? ?? ?? ?? E9 61 03 00 00 83 EC 0C 6A 04 8D 84 24 24 29 00 00 50 6A 06 6A 01 55 E8 ?? ?? ?? ?? 83 C4 20 85 C0 79 0D 83 EC 0C 68 ?? ?? ?? ?? E9 36 03 00 00 8D 44 24 28 89 84 24 04 29 00 00 8D 84 24 00 29 00 00 89 AC 24 08 29 00 00 66 C7 84 24 0C 29 00 00 01 00 C7 84 24 00 29 00 00 60 22 00 00 57 50 68 12 89 00 00 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 1D 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 44 24 1C 00 00 00 00 83 C4 10 E9 EF 00 }
	condition:
		$pattern
}

rule __GI_fstatvfs_2895ef6a5cac4ed657859fa2228c319f {
	meta:
		aliases = "fstatvfs, statvfs, __GI_statvfs, __GI_fstatvfs"
		size = "694"
		objfiles = "statvfs@libc.a, fstatvfs@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 24 05 00 00 8B B4 24 38 05 00 00 8D 84 24 C8 04 00 00 8B 9C 24 3C 05 00 00 50 56 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 0F 88 75 02 00 00 8B 84 24 C4 04 00 00 8D 7B 30 89 03 89 43 04 8B 84 24 C8 04 00 00 89 43 08 8B 84 24 CC 04 00 00 89 43 0C 8B 84 24 D0 04 00 00 89 43 10 8B 84 24 D4 04 00 00 89 43 14 8B 84 24 D8 04 00 00 89 43 18 8B 84 24 DC 04 00 00 C7 43 24 00 00 00 00 89 43 20 8B 84 24 E4 04 00 00 89 43 2C 31 C0 AB AB AB AB AB AB 8B 43 18 C7 43 28 00 00 00 00 89 43 1C 57 57 8D 84 24 70 04 00 00 50 56 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 88 E7 01 00 00 E8 ?? ?? ?? ?? 89 }
	condition:
		$pattern
}

rule des_init_1887d2513d4211e0d2328eb50667f30a {
	meta:
		aliases = "des_init"
		size = "977"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 30 02 00 00 83 3D ?? ?? ?? ?? 01 0F 84 AF 03 00 00 31 DB C7 05 ?? ?? ?? ?? 00 00 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 EB 3E 89 DE 31 C9 C1 E6 06 8D 84 24 30 02 00 00 8D 3C 06 89 CA 89 C8 83 E2 01 D1 F8 83 E0 0F C1 E2 04 09 C2 89 C8 83 E0 20 09 C2 8A 84 32 ?? ?? ?? ?? 88 84 39 00 FE FF FF 41 83 F9 3F 7E D4 43 83 FB 07 7E BD 31 ED EB 45 89 E9 89 F2 C1 E1 0C 89 4C 24 08 8B 4C 24 0C C1 E2 06 09 DA 0F B6 81 00 FE FF FF 8B 4C 24 10 C1 E0 04 0A 84 0B 00 FE FF FF 43 8B 4C 24 08 83 FB 3F 88 84 0A ?? ?? ?? ?? 7E C6 46 83 FE 3F }
	condition:
		$pattern
}

rule __GI_vsyslog_981225d4a2b2eda255ee593d5f29d6da {
	meta:
		aliases = "vsyslog, __GI_vsyslog"
		size = "683"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 3C 04 00 00 8B B4 24 50 04 00 00 F7 C6 00 FC FF FF 0F 85 83 02 00 00 E8 ?? ?? ?? ?? 89 44 24 10 8B 28 50 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 34 04 00 00 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F B6 05 ?? ?? ?? ?? 89 F1 83 E1 07 83 C4 10 D3 F8 A8 01 0F 84 27 02 00 00 83 3D ?? ?? ?? ?? 00 78 09 80 3D ?? ?? ?? ?? 00 75 1B A0 ?? ?? ?? ?? 0F B6 0D ?? ?? ?? ?? 0C 08 0F B6 D0 31 C0 C1 E1 03 E8 ?? ?? ?? ?? F7 C6 F8 03 00 00 75 0C 0F B6 05 ?? ?? ?? ?? C1 E0 03 09 C6 83 EC 0C 8D 9C 24 44 04 00 00 53 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C0 04 50 56 68 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule get_myaddress_88be755d98f7199747de5343f87fb072 {
	meta:
		aliases = "get_myaddress"
		size = "298"
		objfiles = "get_myaddress@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 40 10 00 00 6A 00 6A 02 6A 02 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 79 0A 83 EC 0C 68 ?? ?? ?? ?? EB 39 8D 44 24 14 89 84 24 38 10 00 00 8D 84 24 34 10 00 00 C7 84 24 34 10 00 00 00 10 00 00 53 50 68 12 89 00 00 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 19 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 04 24 01 00 00 00 E8 ?? ?? ?? ?? 31 ED 8B 9C 24 38 10 00 00 8B B4 24 34 10 00 00 EB 7D 51 6A 20 53 8D 84 24 20 10 00 00 50 E8 ?? ?? ?? ?? 83 C4 0C 8D 84 24 18 10 00 00 50 68 13 89 00 00 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0A 83 EC 0C 68 ?? ?? ?? ?? EB A5 0F BF 84 24 24 10 00 00 A8 01 74 33 }
	condition:
		$pattern
}

rule __get_myaddress_0fa073d36228edd15ceb030df5fb3608 {
	meta:
		aliases = "__get_myaddress"
		size = "315"
		objfiles = "pmap_clnt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 40 10 00 00 89 44 24 0C 6A 00 6A 02 6A 02 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 79 0A 83 EC 0C 68 ?? ?? ?? ?? EB 3E 8D 44 24 14 BD 01 00 00 00 89 84 24 38 10 00 00 8D 84 24 34 10 00 00 C7 84 24 34 10 00 00 00 10 00 00 53 50 68 12 89 00 00 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 19 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 04 24 01 00 00 00 E8 ?? ?? ?? ?? 8B 9C 24 38 10 00 00 8B B4 24 34 10 00 00 E9 82 00 00 00 51 6A 20 53 8D 84 24 20 10 00 00 50 E8 ?? ?? ?? ?? 83 C4 0C 8D 84 24 18 10 00 00 50 68 13 89 00 00 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0A 83 EC 0C 68 ?? ?? ?? ?? EB A4 0F BF }
	condition:
		$pattern
}

rule statvfs64_208e1b93809451e266b51015ff6c8d55 {
	meta:
		aliases = "fstatvfs64, statvfs64"
		size = "750"
		objfiles = "fstatvfs64@libc.a, statvfs64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 44 05 00 00 8B B4 24 58 05 00 00 8D 84 24 D4 04 00 00 8B 9C 24 5C 05 00 00 50 56 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 0F 88 AD 02 00 00 8B 84 24 D0 04 00 00 8D 7B 48 8B 94 24 D8 04 00 00 89 03 89 43 04 8B 84 24 D4 04 00 00 89 53 0C 89 43 08 8B 84 24 DC 04 00 00 8B 94 24 E0 04 00 00 89 43 10 89 53 14 8B 84 24 E4 04 00 00 8B 94 24 E8 04 00 00 89 43 18 89 53 1C 8B 84 24 EC 04 00 00 8B 94 24 F0 04 00 00 89 43 20 89 53 24 8B 84 24 F4 04 00 00 8B 94 24 F8 04 00 00 89 43 28 8B 84 24 FC 04 00 00 C7 43 3C 00 00 00 00 89 53 2C 89 43 38 8B 84 24 04 05 00 00 89 43 44 31 C0 AB AB AB AB }
	condition:
		$pattern
}

rule _vfprintf_internal_8b1aea41ae2bd0f2346a1618ae256690 {
	meta:
		aliases = "_vfprintf_internal"
		size = "1568"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 74 01 00 00 8B 9C 24 8C 01 00 00 53 8D 74 24 1C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 3E 8B 5C 24 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 C7 04 24 FF FF FF FF 85 C0 0F 84 D0 05 00 00 52 FF B4 24 84 01 00 00 50 53 E8 ?? ?? ?? ?? C7 44 24 10 FF FF FF FF 83 C4 10 E9 B1 05 00 00 50 50 FF B4 24 90 01 00 00 56 E8 ?? ?? ?? ?? 89 DA C7 44 24 10 00 00 00 00 83 C4 10 EB 01 43 8A 03 84 C0 74 04 3C 25 75 F5 39 D3 74 27 89 DE 31 C0 29 D6 85 F6 7E 12 50 FF B4 24 84 01 00 00 56 52 E8 ?? ?? ?? ?? 83 C4 10 39 F0 0F 85 59 05 00 00 01 04 24 80 3B 00 0F 84 54 05 00 00 80 7B 01 25 8D 53 01 0F 84 38 }
	condition:
		$pattern
}

rule universal_aa09762732027c9f9a6b37de7ccfffec {
	meta:
		aliases = "universal"
		size = "340"
		objfiles = "svc_simple@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 7C 22 00 00 8B 84 24 90 22 00 00 8B AC 24 94 22 00 00 C7 84 24 78 22 00 00 00 00 00 00 8B 78 08 85 FF 75 2D 56 6A 00 68 ?? ?? ?? ?? 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 06 01 00 00 53 6A 04 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? E9 93 00 00 00 8B 30 E8 ?? ?? ?? ?? 8B 98 C0 00 00 00 E9 A1 00 00 00 39 73 04 0F 85 95 00 00 00 39 7B 08 0F 85 8C 00 00 00 8D 74 24 18 31 C0 B9 98 08 00 00 89 F7 F3 AB 51 8B 45 08 56 FF 73 0C 55 FF 50 08 83 C4 10 85 C0 75 0B 83 EC 0C 55 E8 ?? ?? ?? ?? EB 5A 83 EC 0C 56 FF 13 83 C4 10 85 C0 75 0D 81 7B 10 ?? ?? ?? ?? 0F 85 87 00 00 00 52 50 FF 73 10 55 }
	condition:
		$pattern
}

rule __uClibc_main_17d3eef78f4b9b0293eed55c2ed8d8de {
	meta:
		aliases = "__uClibc_main"
		size = "497"
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 8C 00 00 00 8B 84 24 B8 00 00 00 8B 94 24 A4 00 00 00 8B AC 24 A8 00 00 00 A3 ?? ?? ?? ?? 8B 84 24 B4 00 00 00 C1 E2 02 A3 ?? ?? ?? ?? 8D 44 2A 04 3B 45 00 A3 ?? ?? ?? ?? 75 09 8D 44 15 00 A3 ?? ?? ?? ?? 31 C0 B9 1E 00 00 00 8D 7C 24 14 F3 AB A1 ?? ?? ?? ?? EB 02 89 F0 83 38 00 8D 70 04 75 F6 89 F1 8D 54 24 14 EB 11 8B 01 83 F8 0E 77 07 8D 3C C2 89 CE A5 A5 83 C1 08 83 39 00 75 EA 8D 44 24 14 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 48 BA 00 10 00 00 85 C0 0F 44 C2 83 7C 24 70 FF A3 ?? ?? ?? ?? 75 20 E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? ?? ?? 39 C3 75 2F E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? }
	condition:
		$pattern
}

rule __GI_rexec_af_2811284b63a49c15cb84262d65479822 {
	meta:
		aliases = "rexec_af, __GI_rexec_af"
		size = "1141"
		objfiles = "rexec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 90 01 00 00 8B 94 24 AC 01 00 00 8B BC 24 B0 01 00 00 8B 84 24 A8 01 00 00 66 C1 C8 08 0F B7 C0 0F B7 B4 24 BC 01 00 00 89 54 24 10 89 7C 24 14 50 68 ?? ?? ?? ?? 8D 9C 24 48 01 00 00 53 E8 ?? ?? ?? ?? 8D 94 24 6C 01 00 00 31 C0 B9 08 00 00 00 89 D7 F3 AB 8D 84 24 94 01 00 00 83 CF FF 89 B4 24 70 01 00 00 C7 84 24 74 01 00 00 01 00 00 00 C7 84 24 6C 01 00 00 02 00 00 00 50 52 53 8B 84 24 BC 01 00 00 FF 30 E8 ?? ?? ?? ?? 83 C4 20 85 C0 0F 85 CA 03 00 00 8B 84 24 84 01 00 00 8B 40 18 85 C0 74 4E 57 BB 01 00 00 00 68 01 04 00 00 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 94 24 B0 01 00 }
	condition:
		$pattern
}
...
rule rendezvous_request_bcf8afe740dbab44a8e6622d5b11f53c {
	meta:
		aliases = "rendezvous_request"
		size = "143"
		objfiles = "svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 9C 00 00 00 8B 9C 24 B0 00 00 00 8D BC 24 98 00 00 00 8B 6B 2C C7 84 24 98 00 00 00 6E 00 00 00 50 57 8D 44 24 22 50 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 79 0C E8 ?? ?? ?? ?? 83 38 04 75 3B EB D2 8D 9C 24 88 00 00 00 31 C0 89 DF AB AB AB AB 66 C7 84 24 88 00 00 00 01 00 89 F0 89 DE 8B 4D 04 8B 55 00 E8 ?? ?? ?? ?? 8D 78 10 A5 A5 A5 A5 8B 94 24 98 00 00 00 89 50 0C 81 C4 9C 00 00 00 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __gen_tempname_1ca43a523786428a578dbf68db572bac {
	meta:
		aliases = "__gen_tempname"
		size = "666"
		objfiles = "tempname@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 9C 00 00 00 E8 ?? ?? ?? ?? 89 44 24 10 8B 00 89 44 24 1C 83 EC 0C FF B4 24 BC 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 83 F8 05 76 30 8B 94 24 B0 00 00 00 8D 44 10 FA 89 44 24 14 52 52 68 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 0D C7 44 24 18 00 00 00 00 E9 14 02 00 00 8B 4C 24 10 C7 01 16 00 00 00 E9 1D 02 00 00 50 50 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 79 1A 50 50 68 00 08 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 78 27 50 6A 06 8D 9C 24 9A 00 00 00 53 57 E8 ?? ?? ?? ?? 89 3C 24 89 C3 E8 ?? ?? ?? ?? 83 C4 10 83 FB 06 0F 84 B8 00 00 00 55 }
	condition:
		$pattern
}

rule getnameinfo_f25681b22a9f93c0262dca91f6f2304d {
	meta:
		aliases = "__GI_getnameinfo, getnameinfo"
		size = "868"
		objfiles = "getnameinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 9C 02 00 00 E8 ?? ?? ?? ?? 8B AC 24 B0 02 00 00 8B 9C 24 B4 02 00 00 89 04 24 8B 00 89 44 24 08 83 C8 FF F7 84 24 C8 02 00 00 E0 FF FF FF 0F 85 1F 03 00 00 85 ED 0F 84 12 03 00 00 83 FB 01 0F 86 09 03 00 00 0F B7 45 00 66 83 F8 01 74 1E 66 83 F8 02 75 05 83 FB 0F EB 0D 66 83 F8 0A 0F 85 EA 02 00 00 83 FB 1B 0F 86 E1 02 00 00 83 BC 24 B8 02 00 00 00 0F 95 44 24 05 83 BC 24 BC 02 00 00 00 0F 95 44 24 06 80 7C 24 05 00 0F 84 BE 01 00 00 80 7C 24 06 00 0F 84 B3 01 00 00 66 83 F8 02 74 13 66 83 F8 0A 74 0D 66 48 0F 85 9F 01 00 00 E9 34 01 00 00 F6 84 24 C8 02 00 00 01 0F 85 C8 00 }
	condition:
		$pattern
}

rule _time_tzset_04e847c9467181dcc9270c7b58b8d661 {
	meta:
		aliases = "_time_tzset"
		size = "920"
		objfiles = "tzset@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC A0 00 00 00 C7 84 24 9C 00 00 00 00 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 94 00 00 00 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 59 50 31 DB 50 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 78 36 50 6A 44 8D 5C 24 1C 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 13 8D 04 03 39 D8 76 0C 80 78 FF 0A 75 06 C6 40 FF 00 EB 02 31 DB 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 DB 89 DE 0F 84 6C 02 00 00 8A 06 84 C0 0F 84 62 02 00 00 3C 3A 0F 94 C0 55 0F B6 C0 55 01 C6 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 }
	condition:
		$pattern
}

rule __psfs_do_numeric_6c2be9211e89d7cefdee37ad6f6c4156 {
	meta:
		aliases = "__psfs_do_numeric"
		size = "1152"
		objfiles = "__psfs_do_numeric@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC DC 00 00 00 8B 84 24 F0 00 00 00 8B BC 24 F4 00 00 00 8B 68 3C 8A 95 ?? ?? ?? ?? 83 FD 01 88 54 24 19 75 63 BB ?? ?? ?? ?? 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 07 0F B6 03 3B 07 74 19 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C4 10 81 FB ?? ?? ?? ?? 76 33 E9 0D 04 00 00 43 80 3B 00 75 CA 8B 84 24 F0 00 00 00 80 78 44 00 0F 84 FD 03 00 00 FF 40 34 6A 00 6A 00 FF 70 38 FF 70 2C E8 ?? ?? ?? ?? E9 C8 03 00 00 83 EC 0C 57 E8 ?? ?? ?? ?? 8B 17 83 C4 10 83 C8 FF 85 D2 0F 88 CF 03 00 00 83 FA 2B 74 09 83 FA 2D 8D 74 24 2D 75 14 88 54 24 2D 83 EC 0C 57 E8 ?? ?? ?? ?? 8D 74 24 3E 83 C4 10 }
	condition:
		$pattern
}

rule ttyname_r_f331c4ba14a42a281941578306697f52 {
	meta:
		aliases = "__GI_ttyname_r, ttyname_r"
		size = "393"
		objfiles = "ttyname@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC E4 00 00 00 8B 9C 24 F8 00 00 00 8D 44 24 6C 50 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0C E8 ?? ?? ?? ?? 8B 18 E9 4D 01 00 00 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 BA ?? ?? ?? ?? 85 C0 0F 85 1E 01 00 00 E9 23 01 00 00 0F B6 D8 BD 1E 00 00 00 50 29 DD 50 8D 7A 01 57 8D 84 24 C8 00 00 00 50 E8 ?? ?? ?? ?? 8D 84 24 CC 00 00 00 01 D8 89 44 24 18 89 3C 24 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 0F 85 B2 00 00 00 E9 CD 00 00 00 83 EC 0C 8D 58 0B 53 E8 ?? ?? ?? ?? 83 C4 10 39 E8 0F 87 96 00 00 00 50 50 53 FF 74 24 14 E8 ?? ?? ?? ?? 59 5B 8D 44 24 14 50 8D 84 24 C8 00 00 00 50 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule authunix_create_f84e5ec2db76463d4e05d9b5d23f5392 {
	meta:
...
rule _fpmaxtostr_e58bebcb0a07df5110824fee48f47cf0 {
	meta:
		aliases = "_fpmaxtostr"
		size = "1464"
		objfiles = "_fpmaxtostr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC EC 00 00 00 8B 94 24 10 01 00 00 8B 84 24 10 01 00 00 DB AC 24 04 01 00 00 8A 5A 08 8B 40 04 8B 2A C6 84 24 D2 00 00 00 65 88 5C 24 2D 89 44 24 24 88 D8 0C 20 3C 61 75 07 80 C3 06 88 5C 24 2D 8B BC 24 10 01 00 00 85 ED B8 06 00 00 00 C6 84 24 E2 00 00 00 00 0F 48 E8 8B 47 0C A8 02 74 0A C6 84 24 E2 00 00 00 2B EB 0C A8 01 74 08 C6 84 24 E2 00 00 00 20 DB E8 C6 84 24 E3 00 00 00 00 C7 44 24 68 00 00 00 00 7A 02 74 0C DD D8 C7 44 24 68 08 00 00 00 EB 55 D9 EE D9 C9 DB E9 75 27 7A 25 D9 E8 D8 F1 D9 CA C7 44 24 20 FF FF FF FF DF EA DD D9 0F 86 F4 00 00 00 C6 84 24 E2 00 00 00 2D }
	condition:
		$pattern
}

rule __md5_crypt_f683d8ea15c6313fa6861844de9c5757 {
	meta:
		aliases = "__md5_crypt"
		size = "700"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC F0 00 00 00 8B 9C 24 08 01 00 00 6A 03 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8D 53 03 85 C0 0F 44 DA 89 D9 89 D8 83 C1 08 89 5C 24 14 EB 01 40 8A 10 84 D2 74 09 80 FA 24 74 04 39 C8 72 F0 2B 44 24 14 8D 9C 24 80 00 00 00 89 44 24 18 89 D8 E8 ?? ?? ?? ?? 83 EC 0C FF B4 24 0C 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 8B 94 24 00 01 00 00 8D 74 24 28 8D BC 24 DB 00 00 00 89 C5 89 C1 89 D8 E8 ?? ?? ?? ?? B9 03 00 00 00 BA ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? 8B 4C 24 18 89 D8 8B 54 24 14 E8 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 8B 94 24 00 01 00 00 89 F0 89 E9 E8 ?? ?? ?? ?? 8B 4C 24 18 89 F0 }
	condition:
		$pattern
}

rule __dns_lookup_94d2a8f3a47d1335a4bee2fa11c547b6 {
	meta:
		aliases = "__dns_lookup"
		size = "1888"
		objfiles = "dnslookup@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC F8 01 00 00 8B 9C 24 0C 02 00 00 68 00 02 00 00 E8 ?? ?? ?? ?? 89 1C 24 89 C5 E8 ?? ?? ?? ?? 83 C4 10 3D 7E 03 00 00 89 44 24 10 76 15 C7 44 24 20 FF FF FF FF C7 44 24 30 00 00 00 00 E9 CC 06 00 00 83 EC 0C 8B 44 24 1C 05 82 00 00 00 50 E8 ?? ?? ?? ?? 89 44 24 40 83 C4 10 85 ED 0F 84 A3 06 00 00 85 C0 0F 84 9B 06 00 00 80 3B 00 0F 84 92 06 00 00 8B 44 24 10 8A 44 18 FF 88 44 24 17 57 FF 74 24 14 53 FF 74 24 3C E8 ?? ?? ?? ?? C7 44 24 30 FF FF FF FF C7 44 24 3C 00 00 00 00 C7 44 24 44 FF FF FF FF C7 44 24 48 FF FF FF FF 83 C4 10 8B 54 24 30 8B 4C 24 10 8D 54 0A 01 89 54 24 0C }
	condition:
		$pattern
}

rule __ieee754_pow_9fe5697af0c59e15bfe39656982c3880 {
	meta:
		aliases = "__GI_pow, pow, __ieee754_pow"
		size = "1938"
		objfiles = "e_pow@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC FC 00 00 00 DD 84 24 10 01 00 00 DD 54 24 30 DD 84 24 18 01 00 00 DD 5C 24 28 DD 9C 24 B0 00 00 00 8B AC 24 B4 00 00 00 8B 8C 24 B0 00 00 00 81 FD 00 00 F0 3F 89 AC 24 D0 00 00 00 89 8C 24 D4 00 00 00 75 08 85 C9 0F 84 30 07 00 00 DD 44 24 28 DD 9C 24 A8 00 00 00 8B 84 24 AC 00 00 00 8B 94 24 A8 00 00 00 89 C3 89 C7 81 E3 FF FF FF 7F 89 D9 09 D1 89 84 24 B8 00 00 00 0F 84 F6 06 00 00 89 EE 81 E6 FF FF FF 7F 81 FE 00 00 F0 7F 7F 22 0F 94 84 24 BF 00 00 00 75 0A 83 BC 24 D4 00 00 00 00 75 0E 81 FB 00 00 F0 7F 7F 06 75 11 85 D2 74 0D DD 44 24 30 DC 44 24 28 E9 B9 06 00 00 83 BC }
	condition:
		$pattern
}

rule ether_ntohost_7db35106bcad68e414bebf70da96bb24 {
	meta:
		aliases = "ether_ntohost"
		size = "158"
		objfiles = "ethers@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 CB FF 81 EC 24 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 74 6C EB 3C 89 FA 89 E8 E8 ?? ?? ?? ?? 85 C0 89 C3 74 38 50 6A 06 57 FF B4 24 40 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 21 57 57 53 31 DB FF B4 24 3C 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 EB 22 8D 6C 24 16 8D BC 24 16 01 00 00 51 56 68 00 01 00 00 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 A5 83 CB FF 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 81 C4 1C 01 00 00 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule inet_aton_8a31ebf39a761843dcab7724eba1b810 {
	meta:
		aliases = "__GI_inet_aton, inet_aton"
		size = "148"
		objfiles = "inet_aton@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 4C 24 18 85 C9 74 7D 31 F6 C7 04 24 01 00 00 00 EB 51 8B 2D ?? ?? ?? ?? 0F B6 01 F6 44 45 00 08 74 62 31 FF EB 10 6B C7 0A 8D 7C 18 D0 81 FF FF 00 00 00 7F 4F 41 8A 11 0F B6 DA 0F B7 44 5D 00 A8 08 75 E2 83 3C 24 04 74 08 80 FA 2E 75 35 41 EB 09 41 84 D2 74 04 A8 20 74 29 FF 04 24 C1 E6 08 09 FE 83 3C 24 04 7E A9 83 7C 24 1C 00 B8 01 00 00 00 74 11 8B 44 24 1C 0F CE 89 30 B8 01 00 00 00 EB 02 31 C0 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _dl_linux_resolver_446114056c403b7ee56c71becdec46db {
	meta:
		aliases = "_dl_linux_resolver"
		size = "139"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 74 24 18 8B 44 24 1C 03 86 9C 00 00 00 8B 4E 58 8B 2E 8B 50 04 8B 00 C1 EA 08 C1 E2 04 8B 1C 0A 03 5E 54 89 04 24 6A 00 6A 01 56 FF 76 1C 53 E8 ?? ?? ?? ?? 83 C4 14 85 C0 89 C7 75 37 FF 76 04 53 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? B9 01 00 00 00 87 CB B8 01 00 00 00 CD 80 87 CB 83 C4 14 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 8B 04 24 89 7C 05 00 89 F8 5F 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_strcasestr_51c6c062cc7d449b9f9177ba5abf02b0 {
	meta:
...
rule strverscmp_76c903ad547d581d6b16120534212fa0 {
	meta:
		aliases = "__GI_strverscmp, strverscmp"
		size = "245"
		objfiles = "strverscmp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 44 24 1C 8B 54 24 20 C7 04 24 00 00 00 00 39 D0 0F 84 CD 00 00 00 8A 18 8D 68 01 8A 0A 8D 7A 01 31 D2 0F B6 C3 83 E8 30 83 F8 09 0F 96 C2 31 C0 80 FB 30 0F 94 C0 8D 34 02 EB 2F 0F B6 B6 ?? ?? ?? ?? 31 D2 89 74 24 04 8A 5D 00 45 8A 0F 47 0F B6 C3 83 E8 30 83 F8 09 0F 96 C2 31 C0 80 FB 30 0F 94 C0 8D 34 02 0B 74 24 04 0F B6 D1 0F B6 C3 29 D0 89 04 24 75 04 84 DB 75 C0 8D 42 D0 31 D2 83 F8 09 0F 96 C2 31 C0 80 F9 30 0F 94 C0 01 C2 8D 04 B5 00 00 00 00 09 C2 8A 82 ?? ?? ?? ?? 3C 02 74 40 3C 03 74 1A 0F BE C0 EB 34 0F B6 07 83 E8 30 83 F8 09 76 09 C7 04 24 01 00 00 00 EB 23 }
	condition:
		$pattern
}

rule __GI_strstr_bdb33dace401f312d68d1aab7edfd552 {
	meta:
		aliases = "strstr, __GI_strstr"
		size = "197"
		objfiles = "strstr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 54 24 20 8B 5C 24 1C 8A 02 84 C0 0F B6 E8 0F 84 9C 00 00 00 4B 43 8A 03 84 C0 0F 84 94 00 00 00 0F B6 C0 39 E8 75 EE 8D 42 01 89 44 24 04 8A 42 01 84 C0 74 7B 0F B6 C0 89 04 24 8D 53 01 0F B6 43 01 EB 27 0F B6 43 01 8D 53 01 EB 16 85 C0 74 63 42 8A 0A 0F B6 C1 39 E8 74 0C 84 C9 74 55 42 0F B6 02 39 E8 75 E6 42 0F B6 02 3B 04 24 75 F3 8B 44 24 04 8D 72 01 8B 7C 24 04 8D 5A FF 0F B6 48 01 0F B6 42 01 47 39 C8 75 21 85 C9 74 21 8A 47 01 38 46 01 0F B6 C8 75 12 84 C0 74 12 83 C6 02 83 C7 02 0F B6 0F 0F B6 06 EB DB 85 C9 75 94 89 D8 EB 02 31 C0 5A 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __decode_dotted_ba41a07a7c4e58e7a5662aec52570269 {
	meta:
		aliases = "__decode_dotted"
		size = "262"
		objfiles = "decoded@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 83 7C 24 20 00 8B 54 24 24 0F 84 E5 00 00 00 31 ED C6 44 24 07 01 C7 44 24 08 00 00 00 00 EB 04 89 74 24 08 3B 54 24 28 0F 8D C6 00 00 00 8B 4C 24 20 8A 04 11 84 C0 0F 84 AB 00 00 00 80 7C 24 07 01 0F B6 D8 89 D8 8D 4A 01 83 DD FF 25 C0 00 00 00 3D C0 00 00 00 75 2F 3B 4C 24 28 0F 8D 91 00 00 00 89 DA 8B 5C 24 20 80 7C 24 07 01 8B 74 24 08 0F B6 04 0B 83 DD FF 83 E2 3F C1 E2 08 C6 44 24 07 00 09 C2 EB 98 8B 44 24 08 01 D8 89 C6 46 3B 74 24 30 89 04 24 73 5A 8D 3C 0B 3B 7C 24 28 73 51 50 53 8B 44 24 28 01 C8 50 8B 44 24 38 03 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 10 89 FA 8B 4C }
	condition:
		$pattern
}
...
rule xdrrec_getbytes_95e8776d69d355e84e62077284eb0f4a {
	meta:
		aliases = "xdrrec_getbytes"
		size = "100"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 20 8B 6C 24 24 8B 7C 24 28 8B 70 0C EB 37 8B 46 34 85 C0 75 13 83 7E 38 00 75 35 89 F0 E8 ?? ?? ?? ?? 85 C0 75 1F EB 28 39 C7 89 C3 0F 46 DF 89 EA 89 D9 89 F0 E8 ?? ?? ?? ?? 85 C0 74 12 29 5E 34 01 DD 29 DF 85 FF 75 C5 B8 01 00 00 00 EB 02 31 C0 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule xdrrec_putbytes_4d612ab3b1d5e8302a18f9dcd660e590 {
	meta:
		aliases = "xdrrec_putbytes"
		size = "107"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 20 8B 6C 24 24 8B 7C 24 28 8B 70 0C EB 42 8B 46 10 8B 5E 14 52 29 C3 39 DF 0F 46 DF 53 29 DF 55 01 DD 50 E8 ?? ?? ?? ?? 89 D8 83 C4 10 03 46 10 3B 46 14 89 46 10 75 18 85 FF 74 18 31 D2 89 F0 C7 46 1C 01 00 00 00 E8 ?? ?? ?? ?? 85 C0 74 09 85 FF 75 BA B8 01 00 00 00 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule regerror_7e57fe4f421c8cd6b992550c42f5e9e5 {
	meta:
		aliases = "regerror"
		size = "107"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 20 8B 6C 24 28 8B 7C 24 2C 83 F8 10 76 05 E8 ?? ?? ?? ?? 0F B7 84 00 ?? ?? ?? ?? 83 EC 0C 8D 98 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 85 FF 8D 70 01 74 23 39 FE 76 13 50 8D 47 FF 50 53 55 E8 ?? ?? ?? ?? C6 44 3D FF 00 EB 09 51 56 53 55 E8 ?? ?? ?? ?? 83 C4 10 83 C4 0C 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule getsubopt_625a86c6c4d163d2a6083e3c3f739ba5 {
	meta:
		aliases = "getsubopt"
		size = "223"
		objfiles = "getsubopt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 20 C7 44 24 08 FF FF FF FF 8B 00 89 04 24 80 38 00 0F 84 B2 00 00 00 52 52 6A 2C 50 E8 ?? ?? ?? ?? 83 C4 10 8B 3C 24 89 C1 89 C3 2B 0C 24 E3 09 B0 3D F2 AE 8D 7F FF 74 02 31 FF 85 FF 89 DD 0F 45 EF 89 E8 2B 04 24 C7 44 24 08 00 00 00 00 89 44 24 04 EB 45 50 FF 74 24 08 56 FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C2 75 29 8B 7C 24 04 80 3C 3E 00 75 1F 8D 45 01 39 DD 0F 45 D0 8B 44 24 28 89 10 80 3B 00 74 04 C6 03 00 43 8B 54 24 20 89 1A EB 33 FF 44 24 08 8B 7C 24 08 8B 44 24 24 8B 34 B8 85 F6 75 AC 8B 3C 24 8B 54 24 28 89 3A 80 3B 00 74 04 C6 03 00 43 8B 44 24 }
	condition:
		$pattern
}

rule __GI_initstate_r_39765c05ca1d4f9bb1606deaac097a73 {
	meta:
		aliases = "initstate_r, __GI_initstate_r"
		size = "171"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 28 8B 6C 24 24 8B 7C 24 2C 83 F8 7F 76 0C 3D 00 01 00 00 19 DB 83 C3 04 EB 16 83 F8 1F 77 09 31 DB 83 F8 07 77 0A EB 58 83 F8 40 19 DB 83 C3 02 0F BE 83 ?? ?? ?? ?? 8D 75 04 8A 93 ?? ?? ?? ?? 88 5F 0C 89 77 08 88 47 0D 8D 04 86 88 57 0E 89 47 10 57 FF 74 24 24 E8 ?? ?? ?? ?? C7 45 00 00 00 00 00 59 58 31 C0 85 DB 74 2E 8B 47 04 29 F0 C1 F8 02 8D 04 80 8D 04 03 89 45 00 31 C0 EB 19 E8 ?? ?? ?? ?? C7 00 16 00 00 00 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __ns_name_unpack_22ca98241acfad1f8d7d9b9519768cf7 {
	meta:
		aliases = "__GI___ns_name_unpack, __ns_name_unpack"
		size = "267"
		objfiles = "ns_name@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 2C 8B 54 24 30 01 C2 89 54 24 04 8B 54 24 20 39 54 24 28 0F 82 A5 00 00 00 8B 54 24 24 39 54 24 28 0F 83 97 00 00 00 8B 7C 24 28 89 C3 31 ED 2B 54 24 20 C7 44 24 08 FF FF FF FF 89 14 24 E9 90 00 00 00 0F B6 F1 89 F0 25 C0 00 00 00 74 09 3D C0 00 00 00 75 68 EB 2A 8D 44 1E 01 3B 44 24 04 73 5C 8D 3C 32 3B 7C 24 24 73 53 88 0B 43 50 56 52 53 01 F3 E8 ?? ?? ?? ?? 8D 6C 35 01 83 C4 10 EB 51 3B 54 24 24 73 36 83 7C 24 08 00 79 09 2B 54 24 28 42 89 54 24 08 0F B6 47 01 83 E6 3F 8B 7C 24 20 C1 E6 08 09 C6 01 F7 3B 7C 24 20 72 0E 3B 7C 24 24 73 08 83 C5 02 3B 2C 24 7C 15 }
	condition:
		$pattern
}
...
rule _dl_find_hash_fddb5fec6b90f71871fde14a928c678c {
	meta:
		aliases = "_dl_find_hash"
		size = "291"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 30 8B 6C 24 24 85 C0 74 06 8B 10 85 D2 75 12 8B 44 24 2C 83 CF FF 83 E0 02 89 04 24 E9 C9 00 00 00 0F B6 42 0D 83 E0 03 83 F8 03 75 E2 E9 C2 00 00 00 8B 75 00 F6 46 25 01 75 26 83 7C 24 28 00 74 1F 39 74 24 28 74 19 8B 54 24 28 8B 42 34 EB 07 39 70 04 74 0B 8B 00 85 C0 75 F5 E9 86 00 00 00 83 3C 24 00 74 06 83 7E 18 01 74 7A 8B 5E 28 85 DB 74 73 8B 46 58 83 FF FF 89 44 24 04 75 27 8B 4C 24 20 31 FF EB 19 0F B6 D0 41 C1 E7 04 01 FA 89 D0 25 00 00 00 F0 89 C7 31 D7 C1 E8 18 31 C7 8A 01 84 C0 75 E1 8B 56 54 89 F8 89 54 24 08 31 D2 F7 F3 8B 46 2C 8B 1C 90 EB 27 89 D8 }
	condition:
		$pattern
}

rule __getdents_597c5a1dc3d7a44354ff5b406b3ff21f {
	meta:
		aliases = "__getdents"
		size = "136"
		objfiles = "getdents@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 4C 24 24 8B 54 24 28 8B 44 24 20 53 89 C3 B8 8D 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0E E8 ?? ?? ?? ?? F7 DB 83 CF FF 89 18 EB 49 83 F8 FF 89 C7 74 42 89 CE 8D 2C 01 EB 37 0F B7 46 08 8D 5E 0A 8A 44 06 FF 88 44 24 0B 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 0C 40 50 53 8D 46 0B 50 E8 ?? ?? ?? ?? 8A 44 24 1B 83 C4 10 88 46 0A 0F B7 46 08 01 C6 39 EE 72 C5 83 C4 0C 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _dl_fixup_36fcdfbb7f6088620b3c01134226836e {
	meta:
		aliases = "_dl_fixup"
		size = "295"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 54 24 20 8B 42 10 85 C0 74 19 51 51 FF 74 24 2C 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 0F 85 F2 00 00 00 8B 44 24 20 BE 01 00 00 00 8B 18 83 7B 5C 00 0F B7 43 22 0F 85 D9 00 00 00 8B B3 84 00 00 00 8B AB 88 00 00 00 85 F6 74 54 A8 01 75 50 8B 8B C8 00 00 00 89 F0 85 C9 74 26 8B 3B 8D 14 CD 00 00 00 00 89 54 24 08 8D 56 F8 83 C2 08 89 F8 03 02 01 38 49 75 F4 8B 44 24 08 2B 6C 24 08 01 F0 52 55 50 FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 89 C6 66 8B 43 22 83 C8 01 66 89 43 22 EB 02 31 F6 83 BB A0 00 00 00 00 B8 02 00 00 00 0F 44 44 24 24 83 BB 9C 00 00 00 00 89 44 24 24 74 55 }
	condition:
		$pattern
}

rule memmem_2c8dfa9fff9b6bcd3a9b18fae336970c {
	meta:
		aliases = "memmem"
		size = "94"
		objfiles = "memmem@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 5C 24 20 8B 4C 24 24 8B 54 24 2C 89 D8 8D 34 0B 29 D6 85 D2 74 38 39 D1 73 26 EB 30 8B 54 24 28 8A 03 3A 02 75 17 50 55 57 8D 43 01 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 04 89 D8 EB 11 43 EB 08 8B 7C 24 28 8D 6A FF 47 39 F3 76 D0 31 C0 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule setstate_r_3e8dc7edb59ded119e421b6c85efcd7e {
	meta:
		aliases = "__GI_setstate_r, setstate_r"
		size = "170"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 5C 24 24 8B 74 24 20 8A 53 0C 83 C6 04 8B 4B 08 84 D2 75 09 C7 41 FC 00 00 00 00 EB 13 8B 43 04 0F BE D2 29 C8 C1 F8 02 8D 04 80 01 D0 89 41 FC 8B 46 FC BF 05 00 00 00 99 F7 FF 83 FA 04 77 4C 8A 82 ?? ?? ?? ?? 85 D2 88 43 0D 0F BE C8 8A 82 ?? ?? ?? ?? 88 44 24 0B 88 43 0E 88 53 0C 74 1F 8B 6E FC 89 E8 99 F7 FF 89 C7 8D 04 86 89 43 04 0F BE 44 24 0B 01 F8 99 F7 F9 8D 14 96 89 13 8D 04 8E 89 43 10 31 C0 89 73 08 EB 0E E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _stdlib_wcsto_l_6a909fee621b5c32b46c4cfa045d5c4e {
	meta:
		aliases = "_stdlib_wcsto_l"
		size = "322"
		objfiles = "_stdlib_wcsto_l@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 6C 24 20 8B 74 24 28 89 EB EB 03 83 C3 04 83 EC 0C FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 EC 8B 03 83 F8 2B 74 11 83 F8 2D C6 44 24 0A 00 75 0F C6 44 24 0A 01 EB 05 C6 44 24 0A 00 83 C3 04 F7 C6 EF FF FF FF 89 EF 75 2A 83 C6 0A 83 3B 30 75 17 83 C3 04 83 EE 02 8B 03 89 DF 83 C8 20 83 F8 78 75 05 01 F6 83 C3 04 83 FE 11 B8 10 00 00 00 0F 4D F0 8D 46 FE 31 ED 83 F8 22 77 75 83 C8 FF 31 D2 F7 F6 89 44 24 04 88 54 24 0B EB 02 89 DF 8B 0B 8D 41 D0 83 F8 09 77 07 88 CA 80 EA 30 EB 14 89 C8 B2 28 83 C8 20 83 F8 60 76 08 88 CA 80 CA 20 80 EA 57 0F B6 C2 39 F0 7D 36 83 C3 04 3B }
	condition:
		$pattern
}

rule __GI_getcwd_268ec49512df4ab4e6cd5f0b2ff7c9a2 {
	meta:
		aliases = "getcwd, __GI_getcwd"
		size = "184"
		objfiles = "getcwd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 6C 24 24 8B 74 24 20 85 ED 75 28 85 F6 74 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 E9 85 00 00 00 E8 ?? ?? ?? ?? BB 00 10 00 00 3D 00 10 00 00 0F 4D D8 EB 08 85 F6 89 EB 89 F7 75 12 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 59 89 C7 89 FA 89 D9 87 D3 B8 B7 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 89 C3 76 0B E8 ?? ?? ?? ?? F7 DB 89 18 EB 22 85 C0 78 1E 85 F6 75 2E 85 ED 75 12 50 50 53 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 18 89 FE EB 14 85 F6 75 0E 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C4 10 EB 02 31 F6 83 C4 0C 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __stdio_WRITE_4753d9b027a619ce55255d93dbaa2e6f {
	meta:
		aliases = "__stdio_WRITE"
		size = "124"
		objfiles = "_WRITE@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 6C 24 28 8B 7C 24 20 8B 74 24 24 89 EB 83 FB 00 74 58 B8 FF FF FF 7F 0F 4D C3 52 50 56 FF 77 04 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 06 29 C3 01 C6 EB DB 8B 07 8B 57 08 83 C8 08 66 89 07 8B 47 0C 89 C1 29 D1 74 22 39 D9 0F 47 CB 8A 06 3C 0A 88 02 75 06 F6 47 01 01 75 07 42 49 74 03 46 EB EB 89 57 10 2B 57 08 29 D3 29 DD 83 C4 0C 89 E8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule readahead_d76ff9ca5eab345f9565d705b3c3cbe8 {
	meta:
		aliases = "readahead"
		size = "81"
		objfiles = "readahead@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 6C 24 28 8B 7C 24 24 8B 74 24 2C 8B 44 24 20 89 EA C1 FA 1F 89 2C 24 89 54 24 04 8B 0C 24 89 FA 53 89 C3 B8 E1 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __pthread_alt_unlock_450c72d7a39bf23f753ef80857603912 {
	meta:
...
rule _obstack_newchunk_1bc2b7a0bf007b49f066a2a630c23a37 {
	meta:
		aliases = "_obstack_newchunk"
		size = "266"
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 74 24 20 8B 46 04 8B 6E 0C 2B 6E 08 89 44 24 08 8B 46 18 89 EA C1 FA 03 83 C0 64 01 E8 03 44 24 24 01 D0 8B 16 39 D0 89 D7 0F 4D F8 8B 46 1C F6 46 28 01 74 08 51 51 57 FF 76 24 EB 04 83 EC 0C 57 FF D0 83 C4 10 85 C0 89 C3 75 05 E8 ?? ?? ?? ?? 8B 54 24 08 89 46 04 89 50 04 8B 56 18 8D 04 38 89 46 10 89 03 89 D0 F7 D0 8D 7C 1A 08 21 C7 31 C0 83 FA 02 7E 27 89 E9 C1 E9 02 89 4C 24 04 EB 10 8B 56 08 8D 04 8D 00 00 00 00 8B 14 02 89 14 07 49 85 C9 79 EB 8B 44 24 04 C1 E0 02 89 C2 EB 0A 8B 46 08 8A 04 10 88 04 17 42 39 EA 7C F2 F6 46 28 02 75 37 8B 46 18 8B 4C 24 08 8D 54 08 }
	condition:
		$pattern
}

rule wcsncasecmp_0b466be5dd5446dbb762e9536397e8c1 {
	meta:
		aliases = "wcsncasecmp"
		size = "111"
		objfiles = "wcsncasecmp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 74 24 20 8B 7C 24 24 8B 6C 24 28 EB 0C 83 3E 00 74 0B 83 C6 04 83 C7 04 4D 85 ED 75 04 31 C0 EB 3E 8B 06 3B 07 74 E6 83 EC 0C 50 E8 ?? ?? ?? ?? 5A FF 37 89 C3 E8 ?? ?? ?? ?? 83 C4 10 39 C3 74 CC 83 EC 0C FF 36 E8 ?? ?? ?? ?? 89 C3 58 FF 37 E8 ?? ?? ?? ?? 83 C4 10 39 C3 19 C0 83 C8 01 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule qsort_ba69741254dbade86a6d37484f5aed8c {
	meta:
		aliases = "__GI_qsort, qsort"
		size = "177"
		objfiles = "qsort@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 74 24 24 83 FE 01 0F 86 95 00 00 00 83 7C 24 28 00 0F 84 8A 00 00 00 31 C9 8D 5E FF 8D 04 49 BA 03 00 00 00 8D 48 01 89 D5 89 D8 31 D2 F7 F5 39 C1 72 E9 8B 5C 24 28 0F AF 74 24 28 0F AF D9 89 74 24 08 89 5C 24 04 8B 6C 24 04 8B 74 24 20 29 DD 50 50 01 EE 8D 3C 1E 57 56 FF 54 24 3C 83 C4 10 85 C0 7E 15 8B 4C 24 28 8A 16 8A 07 88 06 46 88 17 47 49 75 F3 39 DD 73 D1 8B 44 24 28 01 44 24 04 8B 74 24 08 39 74 24 04 72 BB 29 C3 BA 03 00 00 00 89 D8 89 D6 31 D2 F7 F6 85 C0 89 C3 75 A2 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fgets_unlocked_d99d4954a8ef59046198b97511102d62 {
	meta:
		aliases = "__GI_fgets_unlocked, fgets_unlocked"
		size = "107"
		objfiles = "fgets_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 74 24 24 8B 7C 24 20 8B 6C 24 28 85 F6 89 FB 7F 3A EB 44 8B 45 10 3B 45 18 73 0E 8A 10 40 88 13 43 80 FA 0A 89 45 10 EB 20 83 EC 0C 55 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C2 75 08 F6 45 00 08 74 0C EB 13 88 13 43 3C 0A 74 03 4E 75 C5 39 FB 76 05 C6 03 00 EB 02 31 FF 83 C4 0C 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __stdio_fwrite_663a939d192c624a978f43fa701390f8 {
	meta:
		aliases = "__stdio_fwrite"
		size = "250"
		objfiles = "_fwrite@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 74 24 28 8B 7C 24 20 8B 6C 24 24 F6 46 01 02 0F 85 BB 00 00 00 83 7E 04 FE 8B 56 10 8B 46 0C 75 1D 89 C3 29 D3 39 DD 50 0F 46 DD 53 57 52 E8 ?? ?? ?? ?? 83 C4 10 01 5E 10 E9 AA 00 00 00 29 D0 39 C5 77 73 51 55 57 52 E8 ?? ?? ?? ?? 83 C4 10 01 6E 10 F6 46 01 01 0F 84 8B 00 00 00 50 55 6A 0A 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 7A 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 6A 39 E8 0F 47 C5 89 44 24 04 89 E8 2B 44 24 04 8B 4C 24 04 8D 1C 07 89 DF E3 09 B0 0A F2 AE 8D 7F FF 74 02 31 FF 85 FF 74 41 8B 4C 24 04 8D 04 0B 29 F8 29 46 10 29 C5 EB 31 3B 56 08 74 14 83 EC 0C 56 }
	condition:
		$pattern
}
...
rule _stdlib_strto_l_0118f0ff117ccc2a57f5f355d602a1cb {
	meta:
		aliases = "_stdlib_strto_l"
		size = "291"
		objfiles = "_stdlib_strto_l@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 7C 24 20 8B 74 24 28 89 FB EB 01 43 8A 0B A1 ?? ?? ?? ?? 0F B6 D1 F6 04 50 20 75 EF 80 F9 2B 74 11 80 F9 2D C6 44 24 0A 00 75 0D C6 44 24 0A 01 EB 05 C6 44 24 0A 00 43 F7 C6 EF FF FF FF 89 F9 75 24 83 C6 0A 80 3B 30 75 11 43 83 EE 02 8A 03 89 D9 0C 20 3C 78 75 03 01 F6 43 83 FE 11 B8 10 00 00 00 0F 4D F0 8D 46 FE 31 FF 83 F8 22 77 63 83 C8 FF 31 D2 F7 F6 89 C5 88 54 24 0B EB 02 89 D9 8A 03 88 C2 80 EA 30 80 FA 09 76 0D 0C 20 B2 28 3C 60 76 05 88 C2 80 EA 57 0F B6 C2 39 F0 7D 32 43 39 EF 77 08 75 1E 3A 54 24 0B 76 18 8A 44 24 2C 83 CF FF 20 44 24 0A E8 ?? ?? ?? ?? C7 00 }
	condition:
		$pattern
}

rule __drand48_iterate_fb672cecbc3ddd4ea125eee6cd20efc1 {
	meta:
		aliases = "__drand48_iterate"
		size = "156"
		objfiles = "drand48_iter@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 7C 24 24 8B 6C 24 20 66 83 7F 0E 00 75 1A C7 47 10 6D E6 EC DE C7 47 14 05 00 00 00 66 C7 47 0C 0B 00 66 C7 47 0E 01 00 0F B7 45 04 31 DB 0F B7 4D 00 89 C2 B8 00 00 00 00 09 C8 0F B7 4D 02 09 DA 89 C6 89 54 24 04 C1 E1 10 09 CE 89 34 24 89 D6 8B 0C 24 8B 04 24 F7 67 10 0F AF 4F 14 0F AF 77 10 01 CE 89 C1 0F B7 47 0C 8D 1C 16 31 D2 01 C8 11 DA 66 89 45 00 0F AC D0 10 C1 EA 10 66 89 45 02 0F AC D0 10 66 89 45 04 83 C4 0C 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule truncate64_fd8e9a13fc240e90699c3284b44eb24e {
	meta:
		aliases = "truncate64"
		size = "64"
		objfiles = "truncate64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 7C 24 24 8B 6C 24 28 8B 44 24 20 89 F9 89 EA 53 89 C3 B8 C1 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule ftruncate64_38830f33d44e63eb0739e7f700531f96 {
	meta:
		aliases = "__GI_ftruncate64, ftruncate64"
		size = "64"
		objfiles = "ftruncate64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 7C 24 24 8B 6C 24 28 8B 44 24 20 89 F9 89 EA 53 89 C3 B8 C2 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_mknodat_44f6a31d1319e0462eb8b6190cce4f7e {
	meta:
		aliases = "mknodat, __GI_mknodat"
		size = "66"
		objfiles = "mknodat@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 7C 24 2C 8B 4C 24 24 8B 44 24 20 8B 54 24 28 89 FE 53 89 C3 B8 29 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_xprt_register_0efacb5880dfd65d611ffc9f5d10f7fa {
	meta:
		aliases = "xprt_register, __GI_xprt_register"
		size = "225"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C E8 ?? ?? ?? ?? 8B 74 24 20 8B 2E 83 B8 B4 00 00 00 00 89 C3 75 22 E8 ?? ?? ?? ?? 83 EC 0C C1 E0 02 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 83 B4 00 00 00 0F 84 9A 00 00 00 E8 ?? ?? ?? ?? 39 C5 0F 8D 8D 00 00 00 8B 83 B4 00 00 00 81 FD FF 03 00 00 89 34 A8 7F 13 E8 ?? ?? ?? ?? 89 E9 89 EA C1 E9 05 83 E2 1F 0F AB 14 88 31 DB EB 23 E8 ?? ?? ?? ?? 8D 0C DD 00 00 00 00 89 CA 03 10 83 3A FF 75 0D 89 2A 8B 00 66 C7 44 08 04 C3 00 EB 43 43 E8 ?? ?? ?? ?? 89 C7 8B 00 39 C3 7C D0 8D 58 01 89 1F C1 E3 03 E8 ?? ?? ?? ?? 89 C6 50 50 53 FF 36 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C2 89 06 74 11 }
	condition:
		$pattern
}

rule __GI_asctime_r_72033e360ed0cd877bdc27fc87c5356b {
	meta:
		aliases = "asctime_r, __GI_asctime_r"
		size = "197"
		objfiles = "asctime_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 5C 24 28 8B 6C 24 24 6A 1A 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 8B 45 18 83 C4 10 83 F8 06 77 0E 8D 34 40 89 DF 81 C6 ?? ?? ?? ?? 66 A5 A4 8B 45 10 83 F8 0B 77 0F 8D 34 40 81 C6 ?? ?? ?? ?? 8D 7B 04 66 A5 A4 8B 55 14 8D 4B 13 81 C2 6C 07 00 00 81 FA 0F 27 00 00 77 1A 8D 4B 17 89 D0 BB 0A 00 00 00 99 F7 FB 80 C2 30 88 11 49 89 C2 80 39 3F 74 E9 0F B6 41 FF 8D 71 FF 8B 54 05 00 83 FA 63 76 0A C6 41 FF 3F C6 46 FF 3F EB 13 89 D0 BB 0A 00 00 00 99 F7 FB 00 41 FE 80 C2 30 88 51 FF 8D 4E FE 80 79 FE 30 74 CA 80 7E FF 30 75 04 C6 46 FF 20 83 C4 0C 5B 8D 46 F7 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule xdr_union_996e5899907fd33857c23c8710a94534 {
	meta:
...
rule svcudp_reply_8e68d32793b135d45a7a3dd89494fd6d {
	meta:
		aliases = "svcudp_reply"
		size = "490"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 6C 24 28 8B 5C 24 2C 8B 7D 30 8B 47 0C 8D 77 08 C7 47 08 00 00 00 00 6A 00 56 FF 50 14 8B 47 04 89 03 58 5A 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 A2 01 00 00 8B 47 0C 83 EC 0C 56 FF 50 10 8D 55 3C 89 44 24 18 83 C4 10 83 7A 0C 00 74 1E 8B 45 2C 89 45 34 8B 44 24 08 89 45 38 56 6A 00 52 FF 75 00 E8 ?? ?? ?? ?? 83 C4 10 EB 1D 53 53 FF 75 0C 8D 45 10 50 6A 00 FF 74 24 1C FF 75 2C FF 75 00 E8 ?? ?? ?? ?? 83 C4 20 3B 44 24 08 0F 85 43 01 00 00 83 BF B0 01 00 00 00 74 07 83 7C 24 08 00 79 0A B8 01 00 00 00 E9 2B 01 00 00 8B 7D 30 8B B7 B0 01 00 00 8B 56 0C 8B 46 08 8B 1C }
	condition:
		$pattern
}

rule getpwuid_r_93d25cc325f005cc326e65e0a7ae696e {
	meta:
...
rule __GI_getspnam_r_cc5f26c3b0fc4b0f9817cca9b8118eee {
	meta:
		aliases = "getgrnam_r, getspnam_r, __GI_getgrnam_r, __GI_getpwnam_r, getpwnam_r, __GI_getspnam_r"
		size = "152"
		objfiles = "getspnam_r@libc.a, getpwnam_r@libc.a, getgrnam_r@libc.a"
	strings:
...
rule __GI_fnmatch_c2c2a30dc9d6447653fd8efdba228fe9 {
	meta:
		aliases = "fnmatch, __GI_fnmatch"
		size = "1212"
		objfiles = "fnmatch_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 44 24 34 8B 4C 24 2C 8B 7C 24 30 83 E0 01 89 44 24 04 88 44 24 03 8B 44 24 34 D1 E8 83 F0 01 24 01 88 44 24 02 E9 58 04 00 00 8B 44 24 34 83 E0 10 89 44 24 08 74 1D 0F B6 C2 A8 80 75 16 8D 1C 00 A1 ?? ?? ?? ?? F6 04 18 01 74 08 A1 ?? ?? ?? ?? 8A 14 18 41 80 FA 3F 74 24 77 0E 80 FA 2A 0F 85 EB 03 00 00 E9 C8 00 00 00 80 FA 5B 0F 84 D4 01 00 00 80 FA 5C 0F 85 D4 03 00 00 EB 4A 8A 07 84 C0 0F 84 1B 04 00 00 80 7C 24 03 00 74 08 3C 2F 0F 84 0C 04 00 00 F6 44 24 34 04 0F 84 DF 03 00 00 3C 2E 0F 85 D7 03 00 00 3B 7C 24 30 0F 84 EF 03 00 00 80 7C 24 03 00 0F 84 C2 03 00 00 80 }
	condition:
		$pattern
}

rule _dl_do_reloc_7d15a7f9773f39539b1d9daebc79b8fa {
	meta:
		aliases = "_dl_do_reloc"
		size = "251"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 6C 24 2C 8B 44 24 34 C7 44 24 14 00 00 00 00 8B 55 00 89 14 24 8B 10 8B 40 04 89 54 24 04 0F B6 D8 C1 E8 08 89 C6 C1 E6 04 03 74 24 38 85 C0 89 74 24 10 8B 3E 74 6E 83 FB 07 74 19 83 FB 23 74 14 83 FB 24 74 0F 83 FB 25 74 0A 31 C9 83 FB 0E 0F 94 C1 EB 05 B9 01 00 00 00 31 C0 83 FB 05 0F 94 C0 8D 54 24 10 01 C0 52 09 C8 50 55 FF 74 24 3C 8B 44 24 4C 01 F8 50 E8 ?? ?? ?? ?? 83 C4 14 85 C0 89 C1 75 1B 8A 56 0C 0F B6 C2 83 E0 0F 83 F8 06 74 0D C0 EA 04 B8 01 00 00 00 80 FA 02 75 4A 89 C8 EB 03 8B 46 04 8B 54 24 04 03 14 24 83 FB 08 77 07 FF 24 9D ?? ?? ?? ?? 83 C8 FF EB 2B }
	condition:
		$pattern
}
...
rule regcomp_e57e05e947229505a5c11dc143701d92 {
	meta:
		aliases = "regcomp"
		size = "316"
		objfiles = "regex_old@libc.a"
...
rule _uintmaxtostr_f1b8af5cd8b46c89a13d63bbf0e273bc {
	meta:
		aliases = "_uintmaxtostr"
		size = "228"
		objfiles = "_uintmaxtostr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 7C 24 38 8B 6C 24 2C 8B 4C 24 30 8B 5C 24 34 85 FF 79 17 F7 DF 85 DB 79 11 F7 D9 83 D3 00 F7 DB C7 44 24 08 01 00 00 00 EB 08 C7 44 24 08 00 00 00 00 83 C8 FF 31 D2 F7 F7 C6 45 00 00 42 39 FA 89 44 24 0C 89 54 24 10 75 0D 40 89 44 24 0C C7 44 24 10 00 00 00 00 89 CE 89 D9 89 4C 24 14 83 7C 24 14 00 74 3B 8B 44 24 14 31 D2 F7 F7 89 44 24 14 8B 44 24 10 89 54 24 04 0F AF C2 31 D2 89 04 24 89 F0 F7 F7 89 C3 8B 04 24 01 D0 8B 54 24 04 0F AF 54 24 0C 01 D3 31 D2 F7 F7 8D 34 03 EB 08 89 F0 31 D2 F7 F7 89 C6 4D 83 FA 09 77 06 88 D0 04 30 EB 06 8A 44 24 3C 00 D0 88 45 00 8B 54 }
	condition:
		$pattern
}

rule __prefix_array_73fbcc0215b3d5fb5ec2a2307743a576 {
	meta:
		aliases = "__prefix_array"
		size = "180"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 83 F8 01 89 C5 75 0D 8B 44 24 20 80 38 2F 0F 95 C0 0F B6 E8 31 FF EB 79 8B 54 24 24 83 EC 0C 8D 34 BA FF 36 E8 ?? ?? ?? ?? 5B 8D 50 01 8D 44 05 02 89 54 24 14 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 75 20 EB 13 83 EC 0C 4F 8B 44 24 30 FF 34 B8 E8 ?? ?? ?? ?? 83 C4 10 85 FF 75 E9 B8 01 00 00 00 EB 35 51 47 55 FF 74 24 28 50 E8 ?? ?? ?? ?? 83 C4 0C C6 00 2F 40 FF 74 24 0C FF 36 50 E8 ?? ?? ?? ?? 5A FF 36 E8 ?? ?? ?? ?? 83 C4 10 89 1E 3B 7C 24 28 72 81 31 C0 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __error_at_line_a235c5d2664612f6ee31478bba10e6f8 {
	meta:
...
rule realloc_8d4faf1531db981a6a6789a8d214f60a {
	meta:
		aliases = "realloc"
		size = "823"
		objfiles = "realloc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 83 7C 24 30 00 8B 5C 24 34 75 10 83 EC 0C 53 E8 ?? ?? ?? ?? 89 C3 E9 08 03 00 00 85 DB 75 11 83 EC 0C FF 74 24 3C E8 ?? ?? ?? ?? E9 F3 02 00 00 57 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 FB DF 76 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 BB 02 00 00 8D 43 0B 8B 7C 24 30 89 C2 83 E2 F8 83 F8 0F C7 04 24 10 00 00 00 0F 46 14 24 83 EF 08 89 14 24 8B 57 04 89 D0 83 E0 FC F6 C2 02 89 44 24 04 0F 85 95 01 00 00 8B 0C 24 89 C3 39 C8 0F 83 33 01 00 00 8D 34 07 3B 35 ?? ?? ?? ?? 75 38 8B 46 04 83 E0 FC 8D 0C 18 }
	condition:
		$pattern
}

rule getdelim_bdccb64ce5967456dbe120da9c780289 {
	meta:
		aliases = "__GI_getdelim, getdelim"
		size = "257"
		objfiles = "getdelim@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 83 7C 24 30 00 8B 6C 24 34 8B 7C 24 3C 74 08 85 ED 74 04 85 FF 75 13 E8 ?? ?? ?? ?? 83 CF FF C7 00 16 00 00 00 E9 C6 00 00 00 31 C0 83 7F 34 00 0F 94 C0 85 C0 89 44 24 08 74 1F 8D 5F 38 51 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 44 24 30 8B 18 85 DB 75 07 C7 45 00 00 00 00 00 BE 01 00 00 00 8B 45 00 39 C6 72 24 52 83 C0 40 52 50 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 05 83 CF FF EB 49 89 C3 8B 44 24 30 83 45 00 40 89 18 8B 47 10 3B 47 18 73 09 0F B6 10 40 89 47 10 EB 13 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C2 74 0B 46 88 }
	condition:
		$pattern
}

rule __GI_wcsnrtombs_ab60cdc1ba8d459b5c7a4b87a624e03d {
	meta:
		aliases = "wcsnrtombs, __GI_wcsnrtombs"
		size = "138"
		objfiles = "wcsnrtombs@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 4C 24 30 8B 54 24 38 8B 44 24 3C 85 C9 74 14 3B 4C 24 34 BF 01 00 00 00 75 12 66 31 FF 8D 4C 24 0C EB 09 31 FF 83 C8 FF 8D 4C 24 0C 39 D0 89 D5 0F 46 E8 8B 44 24 34 89 EE 8B 18 EB 27 8B 13 83 FA 7F 76 10 E8 ?? ?? ?? ?? C7 00 54 00 00 00 83 C8 FF EB 26 84 D2 88 11 75 04 31 DB EB 0A 83 C3 04 01 F9 4E 85 F6 75 D5 8D 44 24 0C 39 C1 74 06 8B 44 24 34 89 18 89 E8 29 F0 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule getwc_unlocked_45bcdf6af301497df63f71f5b181b0ea {
	meta:
		aliases = "__GI_fgetwc_unlocked, fgetwc_unlocked, getwc_unlocked"
		size = "291"
		objfiles = "fgetwc_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 5C 24 30 0F B7 03 25 03 08 00 00 3D 00 08 00 00 77 1B 50 83 CE FF 50 68 00 08 00 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 E4 00 00 00 0F B7 03 A8 02 74 32 A8 01 75 06 83 7B 28 00 74 06 C6 43 02 00 EB 06 8A 43 03 88 43 02 0F B7 03 89 C2 48 83 E2 01 8B 74 93 24 66 89 03 C7 43 28 00 00 00 00 E9 99 00 00 00 83 7B 08 00 75 0E 8D 54 24 1B 89 D8 E8 ?? ?? ?? ?? FF 43 0C 83 7B 2C 00 75 04 C6 43 02 00 8D 7B 2C 8D 6C 24 14 8B 43 14 8B 53 10 89 C6 29 D6 74 34 57 56 52 55 E8 ?? ?? ?? ?? 83 C4 10 83 F8 00 89 C2 7C 14 B8 01 00 00 00 0F 44 D0 00 53 02 01 53 10 8B 74 24 14 EB 41 83 F8 }
	condition:
		$pattern
}

rule __GI_fflush_unlocked_e8af3554fa3c97d5b700c618bd8b2925 {
	meta:
		aliases = "fflush_unlocked, __GI_fflush_unlocked"
		size = "317"
		objfiles = "fflush_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 5C 24 30 C7 44 24 08 00 00 00 00 81 FB ?? ?? ?? ?? 74 10 85 DB C7 44 24 08 00 01 00 00 0F 85 DE 00 00 00 57 31 FF 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 18 53 89 DD E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 59 5E 40 A3 ?? ?? ?? ?? 6A 01 53 E8 ?? ?? ?? ?? 83 C4 0C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 35 ?? ?? ?? ?? 58 5A 6A 01 53 E8 ?? ?? ?? ?? 83 C4 10 EB 65 F6 06 40 74 5D 8D 5E 38 50 53 68 ?? ?? ?? ?? 55 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 8B 06 0B 44 24 18 83 C4 10 35 40 01 00 00 A9 40 03 00 }
	condition:
		$pattern
}

rule __GI_bindresvport_23f8ab394becd373592994d70b6b020f {
	meta:
		aliases = "bindresvport, __GI_bindresvport"
		size = "204"
		objfiles = "bindresvport@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 5C 24 34 8B 6C 24 30 85 DB 75 17 8D 54 24 0C 89 D8 89 D7 AB AB AB AB 89 D3 66 C7 44 24 0C 02 00 EB 19 66 83 3B 02 74 13 E8 ?? ?? ?? ?? C7 00 60 00 00 00 83 C8 FF E9 81 00 00 00 66 83 3D ?? ?? ?? ?? 00 75 1C E8 ?? ?? ?? ?? BA A8 01 00 00 89 D1 99 F7 F9 81 C2 58 02 00 00 66 89 15 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 FF 89 C6 C7 00 62 00 00 00 83 C8 FF EB 36 0F BF 05 ?? ?? ?? ?? 89 C2 40 98 66 C1 CA 08 66 3D FF 03 66 89 53 02 66 A3 ?? ?? ?? ?? 7E 09 66 C7 05 ?? ?? ?? ?? 58 02 50 47 6A 10 53 55 E8 ?? ?? ?? ?? 83 C4 10 81 FF A7 01 00 00 7F 09 85 C0 79 05 83 3E 62 74 B9 83 C4 1C 5B }
	condition:
		$pattern
}

rule _dl_load_shared_library_d8750e918d4d60edb0a02d3a0d4ba727 {
	meta:
		aliases = "_dl_load_shared_library"
		size = "503"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 5C 24 3C 8B 74 24 38 C7 05 ?? ?? ?? ?? 00 00 00 00 8D 43 FF 40 80 38 00 75 FA 29 D8 3D 00 04 00 00 0F 87 A4 01 00 00 8D 43 FF 31 C9 EB 06 80 FA 2F 0F 44 C8 40 8A 10 84 D2 75 F3 85 C9 89 DD 8D 41 01 0F 45 E8 39 DD 74 1A 50 53 FF 74 24 3C FF 74 24 3C E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 84 01 00 00 85 F6 74 27 8B 4E 7C 85 C9 74 20 83 EC 0C 89 E8 03 4E 54 FF 74 24 40 8B 54 24 40 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 59 01 00 00 8B 0D ?? ?? ?? ?? 85 C9 74 1D 83 EC 0C 89 E8 FF 74 24 40 8B 54 24 40 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 32 01 00 00 85 F6 74 2A 8B 8E B4 00 00 00 85 }
	condition:
		$pattern
}

rule __read_etc_hosts_r_1dca3a62a38dbf654d150b206411f4fc {
	meta:
		aliases = "__read_etc_hosts_r"
		size = "461"
		objfiles = "read_etc_hosts_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 5C 24 48 8B 74 24 50 8B 7C 24 30 8B 6C 24 40 81 FB 80 00 00 00 C7 44 24 18 00 00 00 00 C7 06 FF FF FF FF C7 44 24 08 22 00 00 00 0F 86 88 01 00 00 85 FF 75 25 E8 ?? ?? ?? ?? 85 C0 89 C7 75 1A 8B 44 24 4C C7 00 00 00 00 00 E8 ?? ?? ?? ?? 8B 00 89 44 24 08 E9 5F 01 00 00 8B 54 24 44 8D 43 D0 C7 47 08 30 00 00 00 89 47 10 C7 44 24 08 01 00 00 00 89 57 04 83 C2 18 C7 06 01 00 00 00 89 54 24 04 E9 F2 00 00 00 8B 74 24 18 83 C6 04 83 7C 24 3C 01 89 75 04 0F 84 1C 01 00 00 83 7C 24 3C 02 89 F3 75 34 51 51 8B 44 24 20 FF 30 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 B8 00 }
	condition:
		$pattern
}

rule free_39a8ac55b0016d05fe76b9a82929d49d {
	meta:
		aliases = "free"
		size = "415"
		objfiles = "free@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 6C 24 30 85 ED 0F 84 84 01 00 00 53 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 18 50 8D 5D F8 E8 ?? ?? ?? ?? 89 DF C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 53 04 83 C4 10 A1 ?? ?? ?? ?? 89 D1 83 E1 FC 39 C1 77 23 89 CA 83 C8 03 C1 EA 03 A3 ?? ?? ?? ?? 8B 04 95 ?? ?? ?? ?? 89 43 08 89 1C 95 ?? ?? ?? ?? E9 16 01 00 00 F6 C2 02 0F 85 ED 00 00 00 83 C8 01 A3 ?? ?? ?? ?? 8D 34 0B 8B 46 04 F6 43 04 01 89 44 24 08 75 21 8B 6D F8 89 D8 29 E8 8B 58 08 8B 50 0C 8B 7B 0C 39 C7 75 3A 39 7A 08 75 35 01 E9 89 53 0C 89 5A 08 8B 5C 24 08 83 E3 FC 3B 35 ?? ?? ?? ?? 74 50 8B 44 1E 04 89 5E 04 }
	condition:
		$pattern
}

rule __GI_re_search_2_f75877af709114739c3f24ff0453a001 {
	meta:
		aliases = "re_search_2, __GI_re_search_2"
		size = "544"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 6C 24 30 8B 5C 24 44 8B 7C 24 40 03 7C 24 38 8B 45 10 8B 55 14 85 DB 8B 74 24 48 89 7C 24 10 89 44 24 18 89 54 24 14 0F 88 CC 01 00 00 39 FB 0F 8F C4 01 00 00 89 F2 01 DA 79 06 89 DE F7 DE EB 0D 8B 44 24 10 29 D8 3B 54 24 10 0F 4F F0 83 7D 08 00 74 24 85 F6 7E 20 8B 45 00 8A 00 3C 0B 74 0A 3C 09 75 13 80 7D 1C 00 78 0D 85 DB 0F 8F 86 01 00 00 BE 01 00 00 00 83 7C 24 18 00 0F 84 1B 01 00 00 F6 45 1C 08 75 15 83 EC 0C 55 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FE 0F 84 60 01 00 00 83 7C 24 18 00 0F 84 F5 00 00 00 3B 5C 24 10 0F 8D EB 00 00 00 F6 45 1C 01 0F 85 E1 00 00 00 85 F6 0F }
	condition:
		$pattern
}

rule __GI_svc_unregister_f9eb12920c6f3928b9fff4dc8a673dcf {
	meta:
...
rule __ns_name_ntop_e86e7d2137c485e59a59b7fe73891ace {
	meta:
		aliases = "__GI___ns_name_ntop, __ns_name_ntop"
		size = "358"
		objfiles = "ns_name@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 6C 24 34 8B 7C 24 30 89 EE 89 E9 03 74 24 38 E9 F6 00 00 00 0F B6 C0 A8 C0 89 44 24 18 0F 85 04 01 00 00 39 E9 75 04 89 E9 EB 0C 39 F1 0F 83 F4 00 00 00 C6 01 2E 41 8B 54 24 18 8D 04 11 39 F0 0F 83 E1 00 00 00 47 E9 B3 00 00 00 8A 17 80 FA 2E 74 1F 77 0A 80 FA 22 74 18 80 FA 24 EB 0D 80 FA 40 74 0E 80 FA 5C 74 09 80 FA 3B 0F 85 CF 00 00 00 8D 41 01 39 F0 0F 83 AA 00 00 00 C6 01 5C 88 51 01 83 C1 02 EB 72 8D 41 03 39 F0 0F 83 94 00 00 00 0F B6 D2 BB 64 00 00 00 89 D0 B2 64 F6 F2 31 D2 C6 01 5C 88 44 24 13 0F B6 C0 8A 80 ?? ?? ?? ?? 88 41 01 8B 44 24 08 F7 F3 B3 0A 0F B6 }
	condition:
		$pattern
}
...
rule __GI_config_read_1115212944d3c58240f4c549dc656cca {
	meta:
		aliases = "__GI_config_read"
		size = "652"
		objfiles = "parse_config@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 30 85 F6 0F 84 6D 02 00 00 0F B6 44 24 38 8B 54 24 38 89 44 24 14 C1 E0 02 0F B6 D6 89 44 24 08 40 89 54 24 18 89 44 24 04 83 7E 04 00 75 3B 83 7E 10 00 75 07 C7 46 10 51 00 00 00 83 7E 08 00 75 07 8B 44 24 04 89 46 08 8B 46 08 83 EC 0C 03 46 10 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 46 04 0F 84 10 02 00 00 80 4E 14 01 8B 46 08 31 FF 03 46 04 89 46 0C 55 FF 36 8B 46 10 29 F8 50 89 F8 03 46 0C 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 18 53 31 ED FF 76 10 6A 00 FF 76 0C E8 ?? ?? ?? ?? 83 C4 10 E9 D0 01 00 00 8B 5E 0C 83 EC 0C 8D 04 3B 50 E8 ?? ?? ?? ?? 5A 59 6A 0A 01 C7 53 }
	condition:
		$pattern
}

rule __GI_xdr_pmaplist_9fd2c2075bc227ad4fa34bcc9be6fb2e {
	meta:
		aliases = "xdr_pmaplist, __GI_xdr_pmaplist"
		size = "127"
		objfiles = "pmap_prot2@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 30 8B 5C 24 34 83 3E 02 0F 94 C0 31 ED 0F B6 F8 31 C0 83 3B 00 0F 95 C0 89 44 24 18 50 50 8D 44 24 20 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 3B 83 7C 24 18 00 75 07 B8 01 00 00 00 EB 2F 85 FF 74 05 8B 2B 83 C5 10 68 ?? ?? ?? ?? 6A 14 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0F 85 FF 74 04 89 EB EB AC 8B 1B 83 C3 10 EB A5 31 C0 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule memalign_19bc3bb8303d2b9006e104ba85592b36 {
	meta:
		aliases = "memalign"
		size = "393"
		objfiles = "memalign@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 30 8B 5C 24 34 83 FE 08 77 10 83 EC 0C 53 E8 ?? ?? ?? ?? 89 C3 E9 58 01 00 00 83 FE 0F B8 10 00 00 00 0F 46 F0 BA 10 00 00 00 8D 46 FF 85 C6 75 04 EB 08 01 D2 39 F2 72 FA 89 D6 52 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 FB DF 76 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 FF 00 00 00 8D 43 0B 89 C2 C7 44 24 08 10 00 00 00 83 E2 F8 83 F8 0F 0F 46 54 24 08 31 DB 89 54 24 08 8D 44 32 10 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C5 0F 84 B6 00 00 00 31 D2 8D 78 F8 F7 F6 85 D2 74 62 89 F2 F7 DA 8D }
	condition:
		$pattern
}

rule fwide_507823edd2a82b1df3fa7eae705c63f9 {
	meta:
		aliases = "fwide"
		size = "142"
		objfiles = "fwide@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 30 8B 6C 24 34 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 85 ED 74 1F 0F B7 0E F7 C1 80 08 00 00 75 14 85 ED B8 00 08 00 00 BA 80 00 00 00 0F 4E C2 09 C8 66 89 06 85 FF 0F B7 1E 74 11 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 83 C4 10 89 D8 83 C4 1C 81 E3 80 00 00 00 25 00 08 00 00 29 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fsetpos_06456ecf56eb6e98abb07ae57c56f184 {
	meta:
		aliases = "fsetpos"
		size = "129"
		objfiles = "fsetpos@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 30 8B 7C 24 34 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5E 38 51 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 52 6A 00 FF 37 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 75 12 8B 47 04 89 46 2C 8B 47 08 89 46 30 8B 47 0C 88 46 02 85 ED 74 11 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 1C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fsetpos64_38b062787faf969fdaf28fae504cae84 {
	meta:
		aliases = "fsetpos64"
		size = "131"
		objfiles = "fsetpos64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 30 8B 7C 24 34 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 6A 00 FF 77 04 FF 37 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 75 12 8B 47 08 89 46 2C 8B 47 0C 89 46 30 8B 47 10 88 46 02 85 ED 74 11 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 1C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fgetpos_0367b0433a72fdf73c479e51032864c9 {
	meta:
		aliases = "fgetpos"
		size = "133"
		objfiles = "fgetpos@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 30 8B 7C 24 34 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 83 CB FF 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 07 78 15 8B 46 2C 31 DB 89 47 04 8B 46 30 89 47 08 0F B6 46 02 89 47 0C 85 ED 74 11 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 1C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fgetpos64_28781ed71ee582e435a624e8672d6b48 {
	meta:
		aliases = "fgetpos64"
		size = "136"
		objfiles = "fgetpos64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 30 8B 7C 24 34 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 83 CB FF 56 E8 ?? ?? ?? ?? 83 C4 10 85 D2 89 07 89 57 04 78 15 8B 46 2C 31 DB 89 47 08 8B 46 30 89 47 0C 0F B6 46 02 89 47 10 85 ED 74 11 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 1C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule putgrent_0dec456f9c95079143620969ad147696 {
	meta:
		aliases = "putgrent"
		size = "211"
		objfiles = "putgrent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 30 8B 7C 24 34 85 F6 74 04 85 FF 75 13 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 E9 9F 00 00 00 83 7F 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5F 38 50 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C FF 76 08 FF 76 04 FF 36 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 83 C4 20 85 C0 78 3D 8B 5E 0C BA ?? ?? ?? ?? 8B 03 85 C0 75 15 53 53 31 DB 57 6A 0A E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 1F EB 1A 51 50 52 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 0A 83 C3 04 BA ?? ?? ?? ?? EB CB 83 CB FF 85 ED 74 11 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 83 C4 }
	condition:
		$pattern
}

rule putspent_1955a52745a9097a162c0e2aab1c7661 {
	meta:
		aliases = "putspent"
		size = "227"
		objfiles = "putspent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 34 8B 7C 24 30 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5E 38 50 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 47 04 BA ?? ?? ?? ?? 85 C0 0F 44 C2 31 DB 50 FF 37 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 2D EB 5F 0F B6 83 ?? ?? ?? ?? BA ?? ?? ?? ?? 8B 0C 07 B8 ?? ?? ?? ?? 83 F9 FF 0F 45 D0 50 51 52 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 35 43 83 FB 05 76 D0 8B 47 20 83 F8 FF 74 14 51 50 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 13 52 31 DB 52 56 6A 0A E8 ?? ?? ?? ?? 83 C4 10 85 C0 7F 03 83 CB FF 85 ED 74 11 }
	condition:
		$pattern
}

rule __GI_ungetwc_575eed155b07ce08d1419641961e8c74 {
	meta:
		aliases = "ungetwc, __GI_ungetwc"
		size = "181"
		objfiles = "ungetwc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 34 8B 7C 24 30 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5E 38 51 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 03 08 00 00 3D 00 08 00 00 77 14 52 52 68 00 08 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 34 0F B7 06 A8 02 74 0A A8 01 75 29 83 7E 28 00 75 23 83 FF FF 74 1E 8B 06 C7 46 28 01 00 00 00 40 0F B7 C0 89 C2 83 E0 FB 83 E2 01 89 7C 96 24 66 89 06 EB 03 83 CF FF 85 ED 74 11 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 1C 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_ungetc_e74a1a50dc0bbd9b6a319395a5a404cd {
	meta:
		aliases = "ungetc, __GI_ungetc"
		size = "220"
		objfiles = "ungetc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 34 8B 7C 24 30 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5E 38 51 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 46 10 3B 46 18 73 19 83 FF FF 74 14 3B 46 08 76 0F 89 FA 38 50 FF 75 08 48 89 46 10 8B 06 EB 55 0F B7 06 25 83 00 00 00 3D 80 00 00 00 77 14 52 52 68 80 00 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 3A 0F B7 06 A8 02 74 0A A8 01 75 2F 83 7E 28 00 75 29 83 FF FF 74 24 8B 46 08 C7 46 28 01 00 00 00 89 46 18 8B 06 40 0F B7 C0 89 C2 83 E2 01 89 7C 96 24 83 E0 FB 66 89 06 EB 03 83 CF FF 85 ED 74 11 50 50 6A 01 8D 44 24 }
	condition:
		$pattern
}

rule __GI_vasprintf_3c09fe1ec2ed5e237d3145d138fc5493 {
	meta:
...
rule unsetenv_13bee081923d3e2fcda4c9febfac6725 {
	meta:
		aliases = "__GI_unsetenv, unsetenv"
		size = "182"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 7C 24 30 85 FF 74 17 80 3F 00 74 12 53 53 6A 3D 57 E8 ?? ?? ?? ?? 83 C4 10 80 38 3D 75 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 78 51 89 C5 68 ?? ?? ?? ?? 29 FD 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 35 ?? ?? ?? ?? 83 C4 10 85 F6 75 2D EB 31 52 55 57 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 18 80 3C 2B 3D 75 12 89 F2 8B 42 04 8D 4A 04 85 C0 89 02 74 07 89 CA EB F0 83 C6 04 8B 1E 85 DB 75 CF 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 31 C0 83 C4 10 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_getmntent_r_b631a909dbe19a7364fdf73c890affe3 {
	meta:
...
rule svc_register_65c16c993af2e17a680fb360f0394f84 {
	meta:
...
rule __pgsreader_10f9c448945e72d2ca130a15bcdfb400 {
	meta:
		aliases = "__pgsreader"
		size = "288"
		objfiles = "__pgsreader@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 7C 24 3C 8B 74 24 38 8B 6C 24 40 81 FF FF 00 00 00 77 15 E8 ?? ?? ?? ?? BB 22 00 00 00 C7 00 22 00 00 00 E9 E6 00 00 00 31 C0 83 7D 34 00 0F 94 C0 85 C0 89 44 24 08 75 0B 8D 04 3E 31 DB 89 44 24 04 EB 21 53 8D 5D 38 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 EB D4 51 55 57 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 14 0F B7 45 00 83 E0 04 83 F8 01 19 DB 83 E3 20 83 C3 02 EB 6D 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 8D 54 06 FF 80 3A 0A 75 05 C6 02 00 EB 08 40 39 F8 75 03 43 EB BA 85 DB 74 03 4B EB B3 8A 06 84 C0 74 AD 3C 23 74 A9 0F B6 D0 A1 }
	condition:
		$pattern
}

rule ceil_4e28ea71d081814e9fd88bfa9b9f8f65 {
	meta:
		aliases = "__GI_ceil, ceil"
		size = "318"
		objfiles = "s_ceil@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C DD 44 24 30 C7 44 24 08 00 00 00 00 DD 14 24 DD 54 24 10 8B 54 24 14 8B 6C 24 10 C7 44 24 0C 00 00 00 00 89 D0 C1 F8 14 89 EE 25 FF 07 00 00 8D 98 01 FC FF FF 83 FB 13 0F 8F 80 00 00 00 85 DB 79 39 DC 05 ?? ?? ?? ?? DD 1C 24 D9 EE DD 04 24 DF E9 DD D8 0F 86 C3 00 00 00 85 D2 79 07 BA 00 00 00 80 EB 0F 89 E8 09 D0 0F 84 AE 00 00 00 BA 00 00 F0 3F 31 F6 E9 A2 00 00 00 DD D8 BF FF FF 0F 00 88 D9 D3 FF 89 F8 21 D0 09 E8 0F 84 9A 00 00 00 DD 04 24 DC 05 ?? ?? ?? ?? DD 1C 24 D9 EE DD 04 24 DF E9 DD D8 76 74 85 D2 7E 09 B8 00 00 10 00 D3 F8 01 C2 89 F8 F7 D0 21 C2 EB B6 DD D8 83 }
	condition:
		$pattern
}

rule floor_44f0dc2f94d404cddc3b4c49f85f9aaf {
	meta:
		aliases = "__GI_floor, floor"
		size = "320"
		objfiles = "s_floor@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C DD 44 24 30 C7 44 24 08 00 00 00 00 DD 14 24 DD 54 24 10 8B 54 24 14 8B 6C 24 10 C7 44 24 0C 00 00 00 00 89 D0 C1 F8 14 89 EE 25 FF 07 00 00 8D 98 01 FC FF FF 83 FB 13 0F 8F 82 00 00 00 85 DB 79 3B DC 05 ?? ?? ?? ?? DD 1C 24 D9 EE DD 04 24 DF E9 DD D8 0F 86 C5 00 00 00 85 D2 78 04 31 D2 EB 14 89 D0 25 FF FF FF 7F 09 E8 0F 84 AE 00 00 00 BA 00 00 F0 BF 31 F6 E9 A2 00 00 00 DD D8 BF FF FF 0F 00 88 D9 D3 FF 89 F8 21 D0 09 E8 0F 84 9A 00 00 00 DD 04 24 DC 05 ?? ?? ?? ?? DD 1C 24 D9 EE DD 04 24 DF E9 DD D8 76 74 85 D2 79 09 B8 00 00 10 00 D3 F8 01 C2 89 F8 F7 D0 21 C2 EB B6 DD }
	condition:
		$pattern
}

rule __GI_lround_f3eed4984f4d9c3d754c46ad74146364 {
	meta:
		aliases = "lround, __GI_lround"
		size = "201"
		objfiles = "s_lround@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C DD 44 24 30 DD 14 24 DD 5C 24 08 8B 44 24 0C 8B 6C 24 08 89 C1 89 C7 C1 E9 14 89 C2 81 E1 FF 07 00 00 81 E2 FF FF 0F 00 C1 FF 1F 81 CA 00 00 10 00 8D 99 01 FC FF FF 83 CF 01 83 FB 13 7F 22 85 DB 79 08 31 C0 43 0F 44 C7 EB 6F 88 D9 B8 00 00 08 00 D3 F8 B9 14 00 00 00 01 D0 29 D9 D3 E8 EB 56 83 FB 1E 7F 2B 81 E9 13 04 00 00 B8 00 00 00 80 D3 E8 8D 34 28 39 EE 83 D2 00 83 FB 14 89 D0 74 35 D3 E0 B9 34 00 00 00 29 D9 D3 EE 09 F0 EB 26 D9 7C 24 16 DD 04 24 66 8B 44 24 16 80 CC 0C 66 89 44 24 14 D9 6C 24 14 DB 5C 24 10 D9 6C 24 16 8B 44 24 10 EB 03 0F AF C7 83 C4 1C 5B 5E 5F 5D }
	condition:
		$pattern
}

rule __res_init_154c69d16a2d1e46b247e20677def2e7 {
	meta:
		aliases = "__GI___res_init, __res_init"
		size = "336"
		objfiles = "res_init@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C E8 ?? ?? ?? ?? 89 C3 50 89 DF 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 C0 B9 19 00 00 00 C7 05 ?? ?? ?? ?? ?? ?? ?? ?? F3 AB C6 43 52 05 83 C4 10 B9 07 00 00 00 C6 43 53 03 C6 43 51 01 A1 ?? ?? ?? ?? C7 03 01 00 00 00 83 F8 08 0F 42 C8 31 D2 EB 0D A1 ?? ?? ?? ?? 8B 04 90 89 44 93 34 42 39 CA 7C EF 31 ED C7 44 24 08 00 00 00 00 C7 44 24 04 00 00 00 00 EB 79 6B 74 24 08 1C 89 F2 03 15 ?? ?? ?? ?? 66 83 3A 02 75 26 8B 44 24 04 C1 E0 04 8D 7C 03 04 50 6A 10 52 57 E8 ?? ?? ?? ?? 83 C4 10 83 }
	condition:
		$pattern
}

rule __GI_ptsname_r_a990e7ad925503924636e3469ae65c74 {
	meta:
		aliases = "ptsname_r, __GI_ptsname_r"
		size = "152"
		objfiles = "ptsname@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C E8 ?? ?? ?? ?? 8B 28 89 C6 53 8D 44 24 1C 50 68 30 54 04 80 FF 74 24 3C E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 5A 83 EC 0C 6A 00 6A F6 8B 44 24 2C 99 52 50 8D 5C 24 33 53 E8 ?? ?? ?? ?? 83 C4 20 29 C3 89 C7 83 C3 0A 39 5C 24 38 73 0D B8 22 00 00 00 C7 06 22 00 00 00 EB 30 51 51 68 ?? ?? ?? ?? FF 74 24 40 E8 ?? ?? ?? ?? 58 5A 57 FF 74 24 40 E8 ?? ?? ?? ?? 31 C0 83 C4 10 89 2E EB 0B C7 06 19 00 00 00 B8 19 00 00 00 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fcloseall_0f0271bfda3448521b0fef0b7bf51a85 {
	meta:
		aliases = "fcloseall"
		size = "243"
		objfiles = "fcloseall@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 18 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 5D 31 ED 40 A3 ?? ?? ?? ?? 58 6A 01 53 E8 ?? ?? ?? ?? 83 C4 0C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 35 ?? ?? ?? ?? 59 5F 6A 01 53 E8 ?? ?? ?? ?? 83 C4 10 EB 6E 8B 46 20 83 7E 34 00 89 44 24 08 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 83 E0 30 83 F8 30 74 16 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 B8 FF FF FF FF 0F 45 E8 85 }
	condition:
		$pattern
}

rule _dl_dprintf_62cf5e55690e93f1e5d3492bbbf49d82 {
	meta:
		aliases = "_dl_dprintf"
		size = "708"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 5C 24 38 85 DB 0F 84 A9 02 00 00 8B 0D ?? ?? ?? ?? 31 C0 BA 03 00 00 00 C7 44 24 18 00 00 00 00 BE 22 00 00 00 83 CF FF 53 89 C3 55 8B 6C 24 18 B8 C0 00 00 00 CD 80 5D 5B 3D 00 F0 FF FF 76 0C F7 D8 83 CD FF A3 ?? ?? ?? ?? EB 07 83 F8 FF 89 C5 75 48 B9 ?? ?? ?? ?? BA 1D 00 00 00 8B 44 24 34 53 89 C3 B8 04 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C2 76 08 F7 DA 89 15 ?? ?? ?? ?? B9 14 00 00 00 87 CB B8 01 00 00 00 CD 80 87 CB 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 8D 73 FF 89 F2 42 80 3A 00 75 FA A1 ?? ?? ?? ?? 29 DA 48 39 C2 72 48 B9 ?? ?? ?? ?? BA 0B 00 00 00 8B 44 24 34 }
	condition:
		$pattern
}

rule getprotobyname_r_ef52e89a92ef43e7f97fa4f5cac34803 {
	meta:
		aliases = "__GI_getprotobyname_r, getprotobyname_r"
		size = "194"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 6C 24 34 8B 7C 24 38 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 EB 2F 51 51 FF 37 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 39 8B 5F 04 EB 13 52 52 50 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 24 83 C3 04 8B 03 85 C0 75 E7 FF 74 24 40 FF 74 24 40 FF 74 24 40 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 74 B6 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 57 57 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 8B 44 24 50 83 38 00 B8 00 00 00 00 0F 45 F0 83 C4 2C 5B 89 F0 5E 5F 5D C3 }
	condition:
		$pattern
}

rule getservbyname_r_19e5034b5e191e0df37e4903c43a33fe {
	meta:
...
rule __GI_getprotobynumber_r_b33f5cad8006109e137aed63d9befd73 {
	meta:
		aliases = "getprotobynumber_r, __GI_getprotobynumber_r"
		size = "150"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 74 24 38 8B 6C 24 40 8B 7C 24 44 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 EB 09 8B 44 24 30 3B 46 08 74 15 57 55 FF 74 24 40 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 74 E2 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 56 56 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? B8 00 00 00 00 83 3F 00 0F 45 D8 83 C4 2C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule rresvport_3c6d772aef4ef59bdaacae18c480c6ec {
	meta:
		aliases = "__GI_rresvport, rresvport"
		size = "149"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 7C 24 34 66 C7 44 24 10 02 00 C7 44 24 14 00 00 00 00 6A 00 6A 01 6A 02 E8 ?? ?? ?? ?? 83 C4 10 8D 6C 24 0C 85 C0 89 C3 79 05 83 CB FF EB 54 8B 07 66 C1 C8 08 66 89 44 24 0E 51 6A 10 55 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 38 E8 ?? ?? ?? ?? 83 38 62 89 C6 74 0B 83 EC 0C 53 E8 ?? ?? ?? ?? EB 1B 8B 07 48 3D 00 02 00 00 89 07 75 C1 83 EC 0C 53 E8 ?? ?? ?? ?? C7 06 0B 00 00 00 83 CB FF 83 C4 10 83 C4 1C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_getservbyport_r_951df3020a194fa12eab1ddc375d3982 {
	meta:
...
rule bcmp_59308768507e091460e9d0dd5222f40a {
	meta:
		aliases = "__GI_memcmp, memcmp, bcmp"
		size = "679"
		objfiles = "memcmp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 24 8B 44 24 3C 83 7C 24 40 0F 8B 5C 24 38 89 04 24 77 20 E9 78 02 00 00 8B 0C 24 0F B6 13 0F B6 01 29 C2 89 D0 0F 85 6E 02 00 00 FF 04 24 43 FF 4C 24 40 8B 04 24 A8 03 89 44 24 04 75 DA 89 D8 83 E0 03 89 5C 24 08 0F 85 AD 00 00 00 8B 7C 24 40 C1 EF 02 89 F8 83 E0 03 83 F8 01 74 33 72 28 8B 0C 24 83 F8 03 8B 03 8B 11 74 0E 83 E9 08 83 EB 08 83 C7 02 89 0C 24 EB 4D 83 2C 24 04 89 C5 89 D6 83 EB 04 47 EB 32 8B 0C 24 8B 03 8B 11 EB 1C 8B 04 24 4F 8B 2B 83 C3 04 8B 30 83 C0 04 89 04 24 8B 0C 24 39 F5 8B 03 8B 11 75 3F 8B 0C 24 39 D0 8B 6B 04 8B 71 04 75 36 8B 0C 24 39 F5 8B 43 08 }
	condition:
		$pattern
}
...
rule xdr_rmtcall_args_bf85e41b1ecccfbbdb1cb9a1a3248c27 {
	meta:
...
rule fork_f7fd7f070cda491824ffd78cbc9f2aef {
	meta:
		aliases = "__fork, fork"
		size = "255"
		objfiles = "ptfork@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 8B 2D ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 0F 85 83 00 00 00 BE ?? ?? ?? ?? 85 F6 74 62 83 EC 0C 8D 5C 24 24 53 E8 ?? ?? ?? ?? 58 5A 6A 01 53 E8 ?? ?? ?? ?? 59 58 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 85 F6 74 2F 83 EC 0C 8D 5C 24 24 53 E8 ?? ?? ?? ?? 58 5A 6A 00 53 E8 ?? ?? ?? ?? 59 5E 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 E8 E8 ?? }
	condition:
		$pattern
}

rule hsearch_r_cf4ac15d700a6575220373a5932707cd {
	meta:
		aliases = "__GI_hsearch_r, hsearch_r"
		size = "387"
		objfiles = "hsearch_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 8B 44 24 3C 8B 54 24 40 89 44 24 1C 89 54 24 20 50 E8 ?? ?? ?? ?? 83 C4 10 89 C1 EB 0F 8B 5C 24 10 89 C2 C1 E2 04 0F B6 04 0B 01 D0 49 83 F9 FF 75 EB 8B 54 24 40 8B 4C 24 40 8B 52 04 8B 09 89 54 24 08 31 D2 F7 74 24 08 B8 01 00 00 00 89 CB 89 4C 24 0C 85 D2 89 D6 0F 44 F0 6B C6 0C 01 C3 8B 03 85 C0 0F 84 96 00 00 00 39 F0 75 1D 52 52 FF 73 04 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 08 8D 43 04 E9 CA 00 00 00 8B 54 24 08 89 F0 89 F3 83 EA 02 89 D1 31 D2 F7 F1 8B 44 24 08 8D 6A 01 29 E8 89 44 24 04 8B 4C 24 04 89 D8 29 E8 39 EB 8D 14 0B 89 D3 0F 47 D8 39 F3 74 41 6B C3 }
	condition:
		$pattern
}

rule __GI_xdrrec_create_3051e18b94297a4ab9c297b4fe42f215 {
	meta:
		aliases = "xdrrec_create, __GI_xdrrec_create"
		size = "275"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 8B 44 24 3C 8B 5C 24 40 8B 74 24 44 89 44 24 24 8B 44 24 48 89 44 24 20 8B 44 24 4C 89 44 24 1C 8B 44 24 50 89 44 24 18 6A 44 E8 ?? ?? ?? ?? 83 FB 63 89 C7 B8 A0 0F 00 00 0F 46 D8 8D 6B 03 83 E5 FC 83 FE 63 0F 46 F0 83 C6 03 83 E6 FC 8D 44 35 04 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 85 FF 89 C3 74 04 85 C0 75 2A 56 56 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 3C 24 E8 ?? ?? ?? ?? 89 5C 24 40 83 C4 2C 5B 5E 5F 5D E9 ?? ?? ?? ?? 89 47 04 89 C2 83 E0 03 89 6F 3C 89 77 40 74 05 29 C3 8D 53 04 8D 04 2A 89 47 28 89 57 0C 8B 44 24 18 C7 40 04 ?? ?? ?? ?? 89 78 0C 8B 44 24 14 }
	condition:
		$pattern
}

rule scandir_098ce6676ac855f8f3d86c6e8794e79a {
	meta:
		aliases = "scandir"
		size = "371"
		objfiles = "scandir@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 FF 74 24 3C E8 ?? ?? ?? ?? 89 44 24 1C 83 C4 10 83 C8 FF 83 7C 24 0C 00 0F 84 46 01 00 00 E8 ?? ?? ?? ?? 31 ED C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 89 C6 8B 00 C7 06 00 00 00 00 89 44 24 18 E9 87 00 00 00 83 7C 24 38 00 74 17 83 EC 0C 57 FF 54 24 48 83 C4 10 85 C0 75 08 C7 06 00 00 00 00 EB 69 3B 6C 24 14 C7 06 00 00 00 00 75 35 C7 44 24 14 0A 00 00 00 85 ED 8D 44 2D 00 0F 44 44 24 14 89 44 24 14 51 51 8B 44 24 1C C1 E0 02 50 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 45 89 44 24 10 0F B7 5F 08 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 2D 52 53 57 50 E8 ?? }
	condition:
		$pattern
}

rule scandir64_af5aa68549214cfd790717f55a1e865b {
	meta:
		aliases = "scandir64"
		size = "371"
...
rule __res_search_f62fcd451375ac21b5d3088f2b25cee8 {
	meta:
		aliases = "__res_search"
		size = "543"
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 83 7C 24 40 00 74 0B 83 7C 24 4C 00 8D 5C 24 1C 75 10 E8 ?? ?? ?? ?? C7 00 FF FF FF FF E9 DB 01 00 00 55 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 44 24 18 8B 28 0F B6 40 51 89 44 24 24 5E 5F 6A 01 53 E8 ?? ?? ?? ?? 83 C4 10 F7 C5 01 00 00 00 75 07 E8 ?? ?? ?? ?? EB B4 E8 ?? ?? ?? ?? 31 FF C7 00 00 00 00 00 89 44 24 0C E8 ?? ?? ?? ?? 8B 54 24 40 89 C3 C7 00 01 00 00 00 EB 0B 3C 2E 0F 94 C0 42 0F B6 C0 01 C7 8A 02 84 C0 75 EF 31 F6 3B 54 24 40 76 0A 80 7A FF 2E 0F 94 C0 0F B6 F0 3B 7C 24 14 C7 44 24 10 FF FF FF FF }
	condition:
		$pattern
}

rule __GI_inet_pton_78d81d57052c794f5af45d379ac7988c {
	meta:
		aliases = "inet_pton, __GI_inet_pton"
		size = "465"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 44 24 40 8B 74 24 44 83 F8 02 74 0B 83 F8 0A 0F 85 9E 01 00 00 EB 10 8B 54 24 48 89 F0 E8 ?? ?? ?? ?? E9 9A 01 00 00 8D 54 24 1C 31 C0 89 D7 AB AB AB AB 80 3E 3A 75 0A 46 80 3E 3A 0F 85 6D 01 00 00 89 74 24 18 C7 44 24 10 00 00 00 00 89 54 24 14 E9 8F 00 00 00 50 46 50 0F B6 C3 83 C8 20 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 1B C1 E5 04 2D ?? ?? ?? ?? 09 C5 81 FD FF FF 00 00 0F 86 9C 00 00 00 E9 22 01 00 00 80 FB 3A 75 60 83 7C 24 0C 00 75 19 83 7C 24 10 00 0F 85 0B 01 00 00 8B 44 24 14 89 74 24 18 89 44 24 10 EB 7A 80 3E 00 0F 84 F4 00 00 00 8B 54 24 14 8D }
	condition:
		$pattern
}
...
rule _stdio_fopen_8e14d602b5aa8f88eed6235a41bb818a {
	meta:
		aliases = "_stdio_fopen"
		size = "577"
		objfiles = "_fopen@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 54 24 44 8B 74 24 40 8B 7C 24 48 8B 6C 24 4C 8A 02 3C 72 74 3E 3C 77 BB 41 02 00 00 74 37 3C 61 66 BB 41 04 74 2F E8 ?? ?? ?? ?? 85 FF C7 00 16 00 00 00 0F 84 F4 01 00 00 F6 47 01 20 0F 84 EA 01 00 00 83 EC 0C 57 31 FF E8 ?? ?? ?? ?? E9 D5 01 00 00 31 DB 80 7A 01 62 8D 42 01 0F 45 C2 80 78 01 2B 75 08 89 D8 83 C8 01 8D 58 01 85 FF 75 32 83 EC 0C 6A 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 0F 84 A7 01 00 00 66 C7 00 00 20 83 EC 0C C7 40 08 00 00 00 00 8D 40 38 50 E8 ?? ?? ?? ?? 83 C4 10 85 ED 78 49 89 DA 81 E2 03 80 00 00 42 8D 46 01 21 D0 39 D0 89 6F 04 0F 85 66 FF FF FF }
	condition:
		$pattern
}

rule __GI_lockf64_7d94398f718dc328baf83efa79b36c0e {
	meta:
		aliases = "lockf64, __GI_lockf64"
		size = "268"
		objfiles = "lockf64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 54 24 48 8B 4C 24 4C 8B 6C 24 44 89 D6 C1 FE 1F 39 F1 75 04 39 D2 74 10 E8 ?? ?? ?? ?? C7 00 4B 00 00 00 E9 B4 00 00 00 8D 5C 24 14 31 C0 89 DF AB AB AB AB AB AB 83 FD 01 66 C7 44 24 16 01 00 C7 44 24 18 00 00 00 00 C7 44 24 1C 00 00 00 00 89 54 24 20 89 4C 24 24 74 5B 7F 06 85 ED 74 4C EB 6F 83 FD 02 74 5C 83 FD 03 75 65 66 C7 44 24 14 00 00 52 53 6A 0C FF 74 24 4C E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 70 66 83 7C 24 14 02 74 66 8B 5C 24 28 E8 ?? ?? ?? ?? 39 C3 74 59 E8 ?? ?? ?? ?? C7 00 0D 00 00 00 EB 30 66 C7 44 24 14 02 00 EB 15 BA 07 00 00 00 66 C7 44 24 14 01 }
	condition:
		$pattern
}

rule __GI_sigaction_31035d4d4deb54f99358a9e8254f2574 {
	meta:
		aliases = "sigaction, __GI_sigaction"
		size = "198"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 5C 24 40 3B 1D ?? ?? ?? ?? 8B 7C 24 44 8B 6C 24 48 0F 84 94 00 00 00 3B 1D ?? ?? ?? ?? 0F 84 88 00 00 00 3B 1D ?? ?? ?? ?? 75 04 85 DB 7F 7C 31 C0 85 FF 74 3F 8D 74 24 18 50 6A 14 57 56 E8 ?? ?? ?? ?? 83 C4 10 83 3F 01 76 25 85 DB 7E 21 83 FB 40 7F 1C F6 47 04 04 74 0A C7 44 24 18 ?? ?? ?? ?? EB 08 C7 44 24 18 ?? ?? ?? ?? 89 F0 EB 04 8D 44 24 18 56 55 50 53 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 40 74 2E 8D 43 FF 83 F8 3F 77 24 85 ED 74 0A 8B 04 9D ?? ?? ?? ?? 89 45 00 85 FF 74 12 8B 07 89 04 9D ?? ?? ?? ?? EB 07 BA 16 00 00 00 EB 02 31 D2 83 C4 2C 89 D0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _stdlib_strto_ll_e8013ec39f551371879ef899839add36 {
	meta:
		aliases = "_stdlib_strto_ll"
		size = "533"
		objfiles = "_stdlib_strto_ll@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 5C 24 40 8B 6C 24 48 89 DF EB 01 47 8A 0F A1 ?? ?? ?? ?? 0F B6 D1 F6 04 50 20 75 EF 80 F9 2B 74 11 80 F9 2D C6 44 24 27 00 75 0D C6 44 24 27 01 EB 05 C6 44 24 27 00 47 F7 C5 EF FF FF FF 89 D9 75 24 83 C5 0A 80 3F 30 75 11 47 83 ED 02 8A 07 89 F9 0C 20 3C 78 75 03 01 ED 47 83 FD 11 B8 10 00 00 00 0F 4D E8 8D 45 FE 83 F8 22 C7 44 24 18 00 00 00 00 C7 44 24 1C 00 00 00 00 0F 87 1C 01 00 00 89 E8 C1 F8 1F 89 6C 24 10 89 44 24 14 EB 02 89 F9 8A 17 88 D0 2C 30 3C 09 76 0E 80 CA 20 B0 28 80 FA 60 76 04 88 D0 2C 57 0F B6 F0 39 EE 0F 8D E8 00 00 00 47 81 7C 24 1C FF FF FF 03 77 }
	condition:
		$pattern
}

rule _stdlib_wcsto_ll_d1e60d706f05326f4cfb2ca0c5521012 {
	meta:
		aliases = "_stdlib_wcsto_ll"
		size = "561"
		objfiles = "_stdlib_wcsto_ll@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 5C 24 40 8B 6C 24 48 89 DF EB 03 83 C7 04 83 EC 0C FF 37 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 EC 8B 07 83 F8 2B 74 11 83 F8 2D C6 44 24 27 00 75 0F C6 44 24 27 01 EB 05 C6 44 24 27 00 83 C7 04 F7 C5 EF FF FF FF 89 DA 75 2A 83 C5 0A 83 3F 30 75 17 83 C7 04 83 ED 02 8B 07 89 FA 83 C8 20 83 F8 78 75 05 01 ED 83 C7 04 83 FD 11 B8 10 00 00 00 0F 4D E8 8D 45 FE 83 F8 22 C7 44 24 18 00 00 00 00 C7 44 24 1C 00 00 00 00 0F 87 2B 01 00 00 89 E8 C1 F8 1F 89 6C 24 10 89 44 24 14 EB 02 89 FA 8B 1F 8D 43 D0 83 F8 09 77 07 88 D9 80 E9 30 EB 14 89 D8 B1 28 83 C8 20 83 F8 60 76 08 88 D9 80 }
	condition:
		$pattern
}

rule rendezvous_request_3f8169fdb1540ad1ebcea67478d21ff5 {
	meta:
		aliases = "rendezvous_request"
		size = "93"
		objfiles = "svc_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 5C 24 40 8D 74 24 18 8D 6C 24 28 8B 7B 2C C7 44 24 28 10 00 00 00 50 55 56 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0C E8 ?? ?? ?? ?? 83 38 04 75 1A EB DB 8B 4F 04 8B 17 E8 ?? ?? ?? ?? 8D 78 10 A5 A5 A5 A5 8B 54 24 28 89 50 0C 83 C4 2C 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule svcudp_bufcreate_64eb311572d7619d0b2e0963a2e866a0 {
	meta:
		aliases = "__GI_svcudp_bufcreate, svcudp_bufcreate"
		size = "494"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 6C 24 40 8B 74 24 44 C7 44 24 28 10 00 00 00 C7 44 24 04 00 00 00 00 83 FD FF 75 2F 50 6A 11 6A 02 6A 02 E8 ?? ?? ?? ?? 83 C4 10 C7 44 24 04 01 00 00 00 85 C0 89 C5 79 12 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E9 F0 00 00 00 8D 5C 24 14 31 C0 89 DF AB AB AB AB 66 C7 44 24 14 02 00 50 50 53 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 16 66 C7 44 24 16 00 00 50 FF 74 24 2C 53 55 E8 ?? ?? ?? ?? 83 C4 10 50 8D 44 24 2C 50 53 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 2E 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 04 00 C7 44 24 08 00 00 00 00 0F 84 1F 01 00 00 83 EC 0C 55 E8 }
	condition:
		$pattern
}

rule svcudp_recv_9f4d11ae1e46d24a9b4afee387c69d40 {
	meta:
		aliases = "svcudp_recv"
		size = "506"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 6C 24 40 8D 45 34 8B 7D 30 8D 5D 3C 89 44 24 0C 8B 54 24 0C 89 DE C7 44 24 28 10 00 00 00 89 54 24 14 8D 55 10 83 7B 0C 00 74 4E 8B 45 2C 89 45 34 8B 07 8B 4C 24 14 89 41 04 8D 45 58 89 55 3C 89 43 10 89 4B 08 C7 43 0C 01 00 00 00 C7 43 04 10 00 00 00 C7 43 14 DC 00 00 00 50 6A 00 53 FF 75 00 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C2 78 25 8B 43 04 89 44 24 28 EB 1C 50 50 8D 44 24 30 50 52 6A 00 FF 37 FF 75 2C FF 75 00 E8 ?? ?? ?? ?? 83 C4 20 89 C2 8B 44 24 28 83 FA FF 89 45 0C 75 13 E8 ?? ?? ?? ?? 83 38 04 0F 85 39 01 00 00 E9 5C FF FF FF 83 FA 0F 0F 8E 2B 01 00 00 C7 47 08 }
	condition:
		$pattern
}

rule __GI_fclose_4b018e8d2033c1604ebfa50d483411ff {
	meta:
		aliases = "fclose, __GI_fclose"
		size = "278"
		objfiles = "fclose@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 74 24 40 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5E 38 51 53 68 ?? ?? ?? ?? 8D 44 24 28 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 31 FF F6 06 40 74 0E 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 89 C7 83 EC 0C FF 76 04 E8 ?? ?? ?? ?? 83 C4 0C C7 46 04 FF FF FF FF 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 18 53 85 C0 B8 FF FF FF FF 0F 48 F8 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 40 A3 ?? ?? ?? ?? 58 5A 6A 01 53 E8 ?? ?? ?? ?? 8B 06 83 C4 10 25 00 60 00 00 83 C8 30 85 ED 66 89 06 74 11 55 55 6A 01 8D 44 24 28 50 E8 ?? ?? ?? ?? 83 C4 10 F6 46 }
	condition:
		$pattern
}

rule freopen64_25a83100dbf90526c3f46db6c0944c52 {
	meta:
		aliases = "freopen64"
		size = "274"
		objfiles = "freopen64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 74 24 48 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5E 38 50 53 68 ?? ?? ?? ?? 8D 44 24 28 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 50 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 7C 24 18 57 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 5B 40 A3 ?? ?? ?? ?? 58 6A 01 57 E8 ?? ?? ?? ?? 0F B7 1E 83 C4 10 89 D8 25 FF 9F 00 00 66 89 06 89 D8 83 E0 30 83 F8 30 74 3B 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 0C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A FF 0D ?? ?? ?? ?? 59 6A 01 57 E8 ?? ?? ?? ?? 83 C4 10 6A FE 56 FF 74 }
	condition:
		$pattern
}

rule freopen_11c529546807572e9b24ef808126f0b9 {
	meta:
		aliases = "freopen"
		size = "274"
		objfiles = "freopen@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 74 24 48 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 8D 5E 38 50 53 68 ?? ?? ?? ?? 8D 44 24 28 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 50 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 7C 24 18 57 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 5B 40 A3 ?? ?? ?? ?? 58 6A 01 57 E8 ?? ?? ?? ?? 0F B7 1E 83 C4 10 89 D8 25 FF 9F 00 00 66 89 06 89 D8 83 E0 30 83 F8 30 74 3B 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 0C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A FF 0D ?? ?? ?? ?? 59 6A 01 57 E8 ?? ?? ?? ?? 83 C4 10 6A FF 56 FF 74 }
	condition:
		$pattern
}

rule fseeko64_7c6ac83692068a94fdad3dc0207e7783 {
	meta:
		aliases = "__GI_fseeko64, fseeko64"
		size = "238"
		objfiles = "fseeko64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 7C 24 4C 8B 44 24 44 8B 54 24 48 8B 74 24 40 83 FF 02 89 44 24 20 89 54 24 24 76 13 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 E9 AD 00 00 00 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1F 53 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 1C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 F6 06 40 74 10 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 53 83 FF 01 75 14 51 51 8D 44 24 28 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 3A 52 57 8D 44 24 28 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 26 8B 06 31 DB C7 46 2C 00 00 00 00 C6 46 02 00 83 E0 B8 66 89 06 8B 46 08 89 46 10 89 46 14 89 46 18 89 }
	condition:
		$pattern
}

rule _getopt_internal_9dd4a31901399b901f88607f75f5f9f5 {
	meta:
		aliases = "_getopt_internal"
		size = "1819"
		objfiles = "getopt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C A1 ?? ?? ?? ?? 8B 15 ?? ?? ?? ?? 8B 4C 24 48 89 44 24 18 A3 ?? ?? ?? ?? B8 00 00 00 00 89 15 ?? ?? ?? ?? 80 39 3A 0F 45 44 24 18 83 7C 24 40 00 89 44 24 18 0F 8E AD 06 00 00 85 D2 C7 05 ?? ?? ?? ?? 00 00 00 00 74 0B 80 3D ?? ?? ?? ?? 00 75 78 EB 0A C7 05 ?? ?? ?? ?? 01 00 00 00 A1 ?? ?? ?? ?? 83 EC 0C 68 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 A3 ?? ?? ?? ?? A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8B 4C 24 48 85 C0 0F 95 C0 A2 ?? ?? ?? ?? 8A 11 80 FA 2D 75 0E 41 C6 05 ?? ?? ?? ?? 02 89 4C 24 48 EB 19 80 FA 2B 75 0D FF 44 24 48 C6 05 ?? ?? ?? ?? 00 EB 07 34 01 A2 ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_sqrt_d4f2e8021838ae04fcdabb4f802d818e {
	meta:
		aliases = "__ieee754_sqrt, sqrt, __GI_sqrt"
		size = "458"
		objfiles = "e_sqrt@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C DD 44 24 40 C7 44 24 08 00 00 00 00 DD 14 24 DD 54 24 10 8B 54 24 14 C7 44 24 0C 00 00 00 00 8B 5C 24 10 89 D0 25 00 00 F0 7F 3D 00 00 F0 7F 75 0A D8 C8 DC 04 24 E9 7A 01 00 00 DD D8 85 D2 7F 1F 89 D0 25 FF FF FF 7F 09 D8 0F 84 68 01 00 00 85 D2 74 0C DD 04 24 D8 E0 D8 F0 E9 55 01 00 00 89 D7 31 C9 C1 FF 14 74 0D EB 36 89 DA 83 E9 15 C1 EA 0B C1 E3 15 85 D2 74 F1 31 F6 EB 03 01 D2 46 F7 C2 00 00 10 00 74 F5 8D 46 FF 89 CF B9 20 00 00 00 29 C7 29 F1 89 D8 D3 E8 89 F1 09 C2 D3 E3 81 EF FF 03 00 00 81 E2 FF FF 0F 00 89 7C 24 24 81 CA 00 00 10 00 83 E7 01 74 0A 89 D8 01 DB C1 }
	condition:
		$pattern
}

rule rtime_904cdf60aced36b15e5cb471307f19db {
	meta:
		aliases = "__GI_rtime, rtime"
		size = "353"
		objfiles = "rtime@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 8B 6C 24 4C 8B 7C 24 44 6A 00 83 FD 01 19 DB 83 C3 02 53 6A 02 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 0F 88 28 01 00 00 83 FB 02 66 C7 07 02 00 66 C7 47 02 00 25 0F 85 AA 00 00 00 50 50 6A 10 57 6A 00 6A 04 8D 44 24 40 50 56 E8 ?? ?? ?? ?? 83 C4 20 85 C0 0F 88 9C 00 00 00 8B 4D 04 BB E8 03 00 00 31 D2 89 C8 F7 F3 89 C1 69 45 00 E8 03 00 00 89 74 24 1C 8D 6C 24 1C 66 C7 44 24 20 01 00 8D 3C 01 53 57 6A 01 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 79 0A E8 ?? ?? ?? ?? 83 38 04 74 E3 83 FB 00 7F 0F 75 4F E8 ?? ?? ?? ?? C7 00 6E 00 00 00 EB 42 C7 44 24 24 10 00 00 00 8D 44 24 0C 51 }
	condition:
		$pattern
}

rule __GI_getnetbyaddr_r_6b62670d27cab3a5b05c83b0a1d7d5bf {
	meta:
		aliases = "getnetbyaddr_r, __GI_getnetbyaddr_r"
		size = "167"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 8B 74 24 4C 8B 6C 24 58 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 24 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 8D 7C 24 28 EB 12 8B 44 24 40 3B 46 0C 75 09 8B 44 24 44 3B 46 08 74 1C 83 EC 0C 57 55 FF 74 24 64 FF 74 24 64 56 E8 ?? ?? ?? ?? 83 C4 20 85 C0 89 C3 74 D2 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 50 50 6A 01 8D 44 24 24 50 E8 ?? ?? ?? ?? B8 00 00 00 00 83 7D 00 00 0F 45 D8 83 C4 3C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule mallinfo_63879d5cb1a01995edcdf6e12ace6f3e {
	meta:
		aliases = "__GI_mallinfo, mallinfo"
		size = "320"
		objfiles = "mallinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 8B 7C 24 44 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 28 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 10 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 A1 ?? ?? ?? ?? 31 C9 C7 44 24 08 00 00 00 00 C7 44 24 10 00 00 00 00 8B 40 04 89 44 24 04 EB 1F 8B 14 8D ?? ?? ?? ?? EB 11 8B 42 04 FF 44 24 10 8B 52 08 83 E0 FC 01 44 24 08 85 D2 75 EB 41 83 F9 09 76 DC 8B 44 24 04 BB 01 00 00 00 8B 6C 24 08 C7 44 24 0C 01 00 00 00 83 E0 FC 01 C5 EB 20 8D 0C DD ?? ?? ?? ?? 8B 51 0C EB 0F 8B 42 04 FF 44 24 0C 8B 52 0C 83 E0 FC 01 C5 39 CA 75 ED 43 83 }
	condition:
		$pattern
}

rule __GI_getnetbyname_r_7c9be3faeb21465ba5e26b9dafa85583 {
	meta:
		aliases = "getnetbyname_r, __GI_getnetbyname_r"
		size = "204"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 8B 7C 24 48 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 24 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 8D 6C 24 28 EB 35 51 51 FF 37 FF 74 24 4C E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 40 8B 5F 04 EB 16 52 52 50 FF 74 24 4C E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 28 83 C3 04 8B 03 85 C0 75 E4 83 EC 0C 55 FF 74 24 60 FF 74 24 60 FF 74 24 60 57 E8 ?? ?? ?? ?? 83 C4 20 85 C0 89 C6 74 AC 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 50 50 6A 01 8D 44 24 24 50 E8 ?? ?? ?? ?? 8B 44 24 60 83 38 00 B8 00 00 00 00 0F 45 F0 83 C4 3C 5B 89 F0 }
	condition:
		$pattern
}

rule llround_0a43be2acac6c7e4afd83abd67d033ff {
	meta:
		aliases = "__GI_llround, llround"
		size = "331"
		objfiles = "s_llround@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 34 DD 44 24 48 DD 54 24 08 DD 5C 24 10 8B 44 24 14 8B 7C 24 10 99 89 C5 83 CA 01 C1 ED 14 81 E5 FF 07 00 00 89 54 24 1C 89 C2 81 E2 FF FF 0F 00 8D 9D 01 FC FF FF 81 CA 00 00 10 00 83 FB 13 7F 35 85 DB 79 19 31 F6 31 FF 43 0F 85 E9 00 00 00 8B 44 24 1C 99 89 C6 89 D7 E9 DB 00 00 00 88 D9 B8 00 00 08 00 D3 F8 B9 14 00 00 00 01 D0 29 D9 D3 E8 89 C6 EB 4B 83 FB 3E 7F 71 83 FB 33 7E 25 B9 00 00 00 00 89 C8 09 F8 89 D7 8D 8D CD FB FF FF 89 C6 D3 E6 31 ED 0F A5 C7 F6 C1 20 0F 45 FE 0F 45 F5 EB 72 8D 8D ED FB FF FF B8 00 00 00 80 D3 E8 8D 34 38 39 FE 83 D2 00 83 FB 14 75 06 89 D6 31 }
	condition:
		$pattern
}

rule tcsetattr_36c993669e7a5e69405efc30e222b274 {
	meta:
		aliases = "__GI_tcsetattr, tcsetattr"
		size = "253"
		objfiles = "tcsetattr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 8B 44 24 54 8B 5C 24 58 83 F8 01 74 10 83 F8 02 74 22 85 C0 BD 02 54 00 00 74 1E EB 07 BD 03 54 00 00 EB 15 E8 ?? ?? ?? ?? C7 00 16 00 00 00 E9 B1 00 00 00 BD 04 54 00 00 8B 03 8D 73 11 8D 7C 24 29 25 FF FF FF 7F 89 44 24 18 8B 43 04 89 44 24 1C 8B 43 08 89 44 24 20 8B 43 0C 89 44 24 24 8A 43 10 88 44 24 28 A5 A5 A5 A5 66 A5 A4 52 8D 44 24 1C 50 55 FF 74 24 5C E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 65 81 FD 02 54 00 00 75 5D E8 ?? ?? ?? ?? 8B 28 89 C7 50 8D 44 24 1C 50 68 01 54 00 00 FF 74 24 5C E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 04 89 2F EB 35 8B 4B 08 8B 74 24 20 89 CA 89 }
	condition:
		$pattern
}

rule __GI_gethostbyaddr_r_7b78c2c764d49b806530042d48f9172d {
	meta:
		aliases = "gethostbyaddr_r, __GI_gethostbyaddr_r"
		size = "673"
		objfiles = "gethostbyaddr_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 8B 44 24 68 83 7C 24 50 00 8B 74 24 60 8B 5C 24 64 C7 00 00 00 00 00 0F 84 69 02 00 00 83 7C 24 58 02 74 0D 83 7C 24 58 0A 0F 85 57 02 00 00 EB 07 83 7C 24 54 04 EB 05 83 7C 24 54 10 0F 85 43 02 00 00 FF 74 24 6C FF 74 24 6C 53 56 FF 74 24 6C FF 74 24 6C FF 74 24 6C FF 74 24 6C E8 ?? ?? ?? ?? 83 C4 20 85 C0 0F 84 25 02 00 00 8B 4C 24 6C 8B 11 83 FA 01 74 09 83 FA 04 0F 85 11 02 00 00 8B 7C 24 6C C7 07 FF FF FF FF 83 7C 24 54 10 0F 87 F7 01 00 00 89 F0 F7 D8 83 E0 03 29 C3 83 EB 18 81 FB FF 00 00 00 89 5C 24 08 0F 8E DB 01 00 00 8D 2C 06 8D 45 08 8D 75 18 89 75 00 C7 45 04 }
	condition:
		$pattern
}

rule __res_query_7f3131ba851cce24e83d78b212a03a58 {
	meta:
		aliases = "__GI___res_query, __res_query"
		size = "181"
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 8B 54 24 50 8B 5C 24 58 8B 74 24 60 85 D2 74 07 83 7C 24 54 01 74 10 E8 ?? ?? ?? ?? 83 CF FF C7 00 03 00 00 00 EB 7D 8D 6C 24 10 31 C0 C7 44 24 38 00 00 00 00 B9 0A 00 00 00 89 EF F3 AB 55 8D 44 24 3C 50 53 52 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 79 15 E8 ?? ?? ?? ?? 83 CF FF 83 38 00 75 43 C7 00 02 00 00 00 EB 3B 83 EC 0C FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 39 5C 24 14 75 17 39 F7 0F 4F FE 50 57 FF 74 24 40 FF 74 24 68 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C FF 74 24 44 E8 ?? ?? ?? ?? 83 C4 10 83 C4 3C 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule writeunix_f4db03ca6cd30c30b0dd6963ad7dac1f {
	meta:
		aliases = "writeunix"
		size = "252"
		objfiles = "svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 8B 6C 24 54 8D 44 24 28 8B 5C 24 58 89 44 24 04 E9 CC 00 00 00 8B 54 24 50 BF ?? ?? ?? ?? 8B 12 89 54 24 08 E8 ?? ?? ?? ?? 89 44 24 28 E8 ?? ?? ?? ?? 89 44 24 2C E8 ?? ?? ?? ?? 8B 74 24 04 89 44 24 30 A5 A5 A5 8D 44 24 34 C7 05 ?? ?? ?? ?? 01 00 00 00 8D 74 24 0C C7 05 ?? ?? ?? ?? 02 00 00 00 C7 05 ?? ?? ?? ?? 18 00 00 00 89 6C 24 34 89 5C 24 38 89 44 24 14 C7 44 24 18 01 00 00 00 C7 44 24 0C 00 00 00 00 C7 44 24 10 00 00 00 00 C7 44 24 1C ?? ?? ?? ?? C7 44 24 20 18 00 00 00 C7 44 24 24 00 00 00 00 50 6A 00 56 FF 74 24 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 21 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __strtofpmax_9a618c260a68f9ddab9c8d5d47c8ad2e {
	meta:
		aliases = "__strtofpmax"
		size = "528"
		objfiles = "__strtofpmax@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 8B 7C 24 58 8B 5C 24 50 EB 01 43 A1 ?? ?? ?? ?? 89 44 24 2C 8A 13 8B 4C 24 2C 0F B6 C2 F6 04 41 20 75 E7 80 FA 2B 74 17 80 FA 2D C7 44 24 0C 00 00 00 00 75 13 C7 44 24 0C 01 00 00 00 EB 08 C7 44 24 0C 00 00 00 00 43 D9 EE 31 F6 83 C9 FF EB 2F 81 F9 00 00 00 80 83 D9 FF 85 C9 75 05 80 FA 30 74 1C 41 83 F9 15 7F 16 8B 44 24 1C D8 0D ?? ?? ?? ?? 83 E8 30 50 DB 04 24 83 C4 04 DE C1 43 8A 13 8B 44 24 2C 0F B6 EA F6 04 68 08 89 6C 24 1C 75 BE 80 FA 2E 75 09 85 F6 75 05 43 89 DE EB DF 85 C9 79 6D 85 F6 75 60 31 C9 31 D2 8D 71 01 EB 37 42 80 BC 32 ?? ?? ?? ?? 00 75 2C DD D8 51 0F }
	condition:
		$pattern
}

rule __wcstofpmax_e31313f6275965dc4faa3ca073290f9a {
	meta:
		aliases = "__wcstofpmax"
		size = "513"
		objfiles = "__wcstofpmax@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 8B 7C 24 58 8B 5C 24 50 EB 03 83 C3 04 83 EC 0C FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 EC 8B 03 83 F8 2B 74 0D 31 ED 83 F8 2D 75 0B 66 BD 01 00 EB 02 31 ED 83 C3 04 D9 EE 31 F6 83 C9 FF EB 2D 81 F9 00 00 00 80 83 D9 FF 85 C9 75 05 83 FA 30 74 18 41 83 F9 15 7F 12 D8 0D ?? ?? ?? ?? 8D 42 D0 50 DB 04 24 83 C4 04 DE C1 83 C3 04 A1 ?? ?? ?? ?? 8B 13 89 44 24 2C F6 04 50 08 75 C2 83 FA 2E 75 0B 85 F6 75 07 83 C3 04 89 DE EB DF 85 C9 79 6C 85 F6 75 5F 31 C9 8D 7E 01 EB 34 41 80 BC 39 ?? ?? ?? ?? 00 75 29 DD D8 56 0F B6 86 ?? ?? ?? ?? DB 04 24 83 C4 04 85 ED DC 35 ?? ?? ?? ?? 8D }
	condition:
		$pattern
}

rule nextafter_1cd649f5c14d565f40c2df0841d4abb3 {
	meta:
		aliases = "__GI_nextafter, nextafter"
		size = "379"
		objfiles = "s_nextafter@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C DD 44 24 50 C7 44 24 20 00 00 00 00 DD 54 24 08 DD 44 24 58 C7 44 24 24 00 00 00 00 DD 14 24 D9 C9 DD 5C 24 30 8B 54 24 34 DD 5C 24 28 C7 44 24 18 00 00 00 00 8B 4C 24 30 C7 44 24 1C 00 00 00 00 8B 6C 24 2C C7 44 24 10 00 00 00 00 8B 7C 24 28 89 D6 81 E6 FF FF FF 7F 81 FE FF FF EF 7F C7 44 24 14 00 00 00 00 7E 0A 8D 86 00 00 10 80 09 C8 75 1B 8B 5C 24 2C 89 D8 25 FF FF FF 7F 3D FF FF EF 7F 7E 15 2D 00 00 F0 7F 09 F8 74 0C DD 44 24 08 DC 04 24 E9 C6 00 00 00 DD 44 24 08 DD 04 24 D9 C9 DF E9 DD D8 7A 06 0F 84 B9 00 00 00 09 CE 75 30 81 E5 00 00 00 80 89 6C 24 24 C7 44 24 20 }
	condition:
		$pattern
}

rule __GI_lrint_953a722c4f31808c96fd016e6eb824d5 {
	meta:
		aliases = "lrint, __GI_lrint"
		size = "275"
		objfiles = "s_lrint@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C DD 44 24 50 DD 14 24 DD 5C 24 18 8B 44 24 1C C1 E8 14 89 C2 89 C5 81 E2 FF 07 00 00 81 EA FF 03 00 00 C1 ED 0B 83 FA 13 7F 4B 31 DB 42 0F 8C CF 00 00 00 DD 04 ED ?? ?? ?? ?? B9 13 04 00 00 DD 04 24 D8 C1 DD 5C 24 30 DD 44 24 30 DE E1 DD 5C 24 10 8B 44 24 14 89 C3 C1 E8 14 81 E3 FF FF 0F 00 25 FF 07 00 00 81 CB 00 00 10 00 29 C1 D3 EB E9 84 00 00 00 83 FA 1E 7F 59 DD 04 ED ?? ?? ?? ?? DD 04 24 D8 C1 DD 5C 24 30 DD 44 24 30 DE E1 DD 5C 24 08 8B 44 24 0C 8B 74 24 08 89 C2 25 FF FF 0F 00 C1 EA 14 0D 00 00 10 00 81 E2 FF 07 00 00 89 C3 8D BA 01 FC FF FF 83 FF 14 74 3B 8D 8A ED }
	condition:
		$pattern
}

rule malloc_ef21f5f75e39d17e4b7078caa329ecfe {
	meta:
		aliases = "malloc"
		size = "1973"
		objfiles = "malloc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 40 8B 5C 24 54 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 38 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 FB DF 76 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 66 07 00 00 8D 43 0B 8B 1D ?? ?? ?? ?? 89 C2 83 E2 F8 83 F8 0F C7 44 24 10 10 00 00 00 0F 46 54 24 10 F6 C3 01 89 54 24 10 75 1D 85 DB 0F 85 4E 03 00 00 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 E9 39 03 00 00 39 5C 24 10 77 1E 8B 4C 24 10 C1 E9 03 8B 14 8D ?? ?? ?? ?? 85 D2 74 0C 8B 42 08 89 04 8D ?? ?? ?? ?? EB 39 81 7C 24 10 FF 00 00 00 77 37 8B 44 24 10 C1 E8 03 8D 0C C5 ?? ?? ?? ?? 8B 51 0C }
	condition:
		$pattern
}

rule __GI_fmod_4e5655beffe0507eca74e8c584dd7f4f {
	meta:
		aliases = "__ieee754_fmod, fmod, __GI_fmod"
		size = "802"
		objfiles = "e_fmod@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 44 DD 44 24 58 C7 44 24 18 00 00 00 00 DD 5C 24 08 DD 44 24 60 C7 44 24 1C 00 00 00 00 DD 1C 24 DD 44 24 08 C7 44 24 10 00 00 00 00 DD 5C 24 28 DD 04 24 8B 4C 24 2C DD 5C 24 20 8B 54 24 2C 8B 6C 24 24 8B 44 24 20 81 E1 00 00 00 80 8B 7C 24 28 81 E2 FF FF FF 7F 81 E5 FF FF FF 7F 89 44 24 3C 09 E8 C7 44 24 14 00 00 00 00 89 4C 24 38 74 1E 81 FA FF FF EF 7F 7F 16 8B 44 24 3C F7 D8 0B 44 24 3C C1 E8 1F 09 E8 3D 00 00 F0 7F 76 0E DD 44 24 08 DC 0C 24 D8 F0 E9 6F 02 00 00 39 EA 7F 27 0F 8C 69 02 00 00 3B 7C 24 3C 0F 82 5F 02 00 00 75 15 C1 6C 24 38 1F 8B 44 24 38 DD 04 C5 ?? ?? ?? }
	condition:
		$pattern
}

rule clnttcp_create_2fd2f09b458b7629937f670ad1a7d0ea {
	meta:
		aliases = "__GI_clnttcp_create, clnttcp_create"
		size = "506"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 48 8B 5C 24 5C 8B 6C 24 68 6A 0C E8 ?? ?? ?? ?? C7 04 24 64 00 00 00 89 C7 E8 ?? ?? ?? ?? 83 C4 10 85 FF 89 C6 74 04 85 C0 75 2B E8 ?? ?? ?? ?? 89 C3 50 50 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 03 0C 00 00 00 C7 43 08 0C 00 00 00 E9 92 00 00 00 66 83 7B 02 00 75 26 6A 06 FF 74 24 5C FF 74 24 5C 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 C0 85 C0 0F 84 59 01 00 00 66 C1 C8 08 66 89 43 02 83 7D 00 00 79 70 50 6A 06 6A 01 6A 02 E8 ?? ?? ?? ?? 89 45 00 5A 59 6A 00 50 E8 ?? ?? ?? ?? 8B 45 00 83 C4 10 85 C0 78 11 51 6A 10 53 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 33 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_clntunix_create_8724f0f1e77617b5c1861ecbaf712a75 {
	meta:
		aliases = "clntunix_create, __GI_clntunix_create"
		size = "490"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 48 8B 6C 24 5C 68 C4 00 00 00 E8 ?? ?? ?? ?? C7 04 24 0C 00 00 00 89 C6 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 74 04 85 F6 75 28 E8 ?? ?? ?? ?? 55 55 FF 35 ?? ?? ?? ?? 89 C3 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 03 0C 00 00 00 C7 43 08 0C 00 00 00 EB 71 8B 44 24 5C 83 38 00 79 79 53 6A 00 6A 01 6A 01 E8 ?? ?? ?? ?? 8B 54 24 6C 89 C3 89 02 8D 45 02 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 85 DB 78 13 83 C0 03 51 50 55 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 37 E8 ?? ?? ?? ?? C7 00 0C 00 00 00 89 C3 E8 ?? ?? ?? ?? 8B 00 89 43 08 8B 54 24 5C 8B 02 83 F8 FF 0F 84 0A 01 00 00 83 EC 0C 50 E8 ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_regexec_0270e96b8b4110986bdbd332c01a09ef {
	meta:
		aliases = "regexec, __GI_regexec"
		size = "269"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 48 8B 74 24 5C 8B 5C 24 6C 8B 7C 24 64 FF 74 24 60 E8 ?? ?? ?? ?? 83 C4 0C 89 C5 8A 46 1C 34 10 C0 E8 04 85 FF 0F 95 44 24 0F 20 44 24 0F 6A 20 56 8D 44 24 1C 50 E8 ?? ?? ?? ?? 8A 44 24 3C 88 D9 D1 EB 80 E1 01 88 DA C0 E1 05 80 E2 01 24 9F C0 E2 06 08 C8 08 D0 24 F9 0C 04 88 44 24 3C 83 C4 10 31 C0 80 7C 24 0B 00 74 2F 89 7C 24 30 8D 04 FD 00 00 00 00 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 74 72 89 44 24 34 8D 04 B8 89 44 24 38 8D 44 24 30 53 53 50 55 6A 00 55 FF 74 24 6C 8D 44 24 2C 50 E8 ?? ?? ?? ?? 83 C4 20 80 7C 24 0B 00 89 C6 74 3D 31 DB 85 C0 79 24 EB }
	condition:
		$pattern
}

rule __GI_getaddrinfo_c5a8ee727bb93bdecdf30e93497996a8 {
	meta:
		aliases = "getaddrinfo, __GI_getaddrinfo"
		size = "618"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 83 7C 24 60 00 8B 54 24 64 8B 74 24 68 74 1B 8B 44 24 60 80 38 2A 75 12 80 78 01 00 B8 00 00 00 00 0F 45 44 24 60 89 44 24 60 85 D2 74 11 80 3A 2A 75 0C 80 7A 01 00 B8 00 00 00 00 0F 44 D0 8B 7C 24 60 09 D7 0F 84 06 02 00 00 85 F6 75 11 8D 5C 24 1C B9 08 00 00 00 89 DF 89 F0 F3 AB 89 DE 8B 06 A9 C0 FB FF FF 0F 85 EB 01 00 00 A8 02 74 0B 83 7C 24 60 00 0F 84 DC 01 00 00 85 D2 74 4D 80 3A 00 74 48 89 54 24 3C 53 6A 0A 8D 44 24 4C 50 52 E8 ?? ?? ?? ?? 89 44 24 50 83 C4 10 8B 44 24 44 80 38 00 75 0A 8D 44 24 3C 89 44 24 10 EB 24 F6 46 01 04 0F 85 96 01 00 00 8D 54 24 3C C7 44 }
	condition:
		$pattern
}

rule __ivaliduser2_b7887802d289403ce28ded9796a370a7 {
	meta:
		aliases = "__ivaliduser2"
		size = "733"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 89 44 24 10 89 54 24 0C 89 4C 24 08 C7 44 24 48 00 00 00 00 C7 44 24 44 00 00 00 00 E9 79 02 00 00 8B 54 24 44 8B 44 24 48 C6 44 02 FF 00 8B 5C 24 48 89 DE EB 01 46 8A 0E 84 C9 0F 84 59 02 00 00 A1 ?? ?? ?? ?? 0F B6 D1 F6 04 50 20 75 E7 80 F9 23 0F 84 42 02 00 00 57 57 6A 0A 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 47 8B 54 24 10 8B 42 10 3B 42 18 73 0D 0F B6 10 40 8B 4C 24 10 89 41 10 EB 11 83 EC 0C FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 89 C2 83 FA 0A 0F 84 FE 01 00 00 42 75 CA E9 F6 01 00 00 A1 ?? ?? ?? ?? 0F BF 04 08 88 03 43 8A 13 84 D2 74 11 0F B6 C2 8D 0C 00 A1 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __xpg_strerror_r_1056850e9364232993d8ab7498d5b02f {
	meta:
		aliases = "strerror_r, __GI___xpg_strerror_r, __xpg_strerror_r"
		size = "205"
		objfiles = "__xpg_strerror_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 8B 44 24 60 8B 5C 24 68 83 F8 7C 77 2A 89 C1 C7 44 24 04 ?? ?? ?? ?? EB 0F 8B 54 24 04 80 3A 01 83 D9 00 42 89 54 24 04 85 C9 75 ED 8B 7C 24 04 31 ED 80 3F 00 75 2F 83 EC 0C 99 6A 00 BE ?? ?? ?? ?? 6A F6 52 50 8D 44 24 67 50 E8 ?? ?? ?? ?? 83 E8 0E 89 44 24 24 89 C7 A5 A5 A5 66 A5 BD 16 00 00 00 83 C4 20 83 7C 24 64 00 B8 00 00 00 00 0F 44 D8 83 EC 0C FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 10 40 39 D8 89 C6 0F 47 F3 B8 22 00 00 00 0F 47 E8 85 F6 74 1B 50 56 FF 74 24 0C FF 74 24 70 E8 ?? ?? ?? ?? 8B 44 24 74 83 C4 10 C6 44 06 FF 00 85 ED 74 07 E8 ?? ?? ?? ?? 89 28 83 C4 4C 89 E8 }
	condition:
		$pattern
}

rule __GI_gethostbyname2_r_da48ffdcc0d22f0ae733c445e0011020 {
	meta:
		aliases = "gethostbyname2_r, __GI_gethostbyname2_r"
		size = "718"
		objfiles = "gethostbyname2_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 8B 44 24 64 8B 7C 24 70 83 F8 02 75 30 50 50 FF B4 24 80 00 00 00 FF B4 24 80 00 00 00 57 FF B4 24 80 00 00 00 FF B4 24 80 00 00 00 FF 74 24 7C E8 ?? ?? ?? ?? 83 C4 20 E9 82 02 00 00 8B 54 24 74 83 F8 0A C7 02 00 00 00 00 0F 85 6A 02 00 00 83 7C 24 60 00 0F 84 5F 02 00 00 E8 ?? ?? ?? ?? 8B 28 89 C6 C7 00 00 00 00 00 50 FF 74 24 7C FF 74 24 7C 57 FF 74 24 7C FF 74 24 7C 6A 0A FF 74 24 7C E8 ?? ?? ?? ?? 83 C4 20 85 C0 75 07 89 2E E9 2A 02 00 00 8B 4C 24 78 8B 11 83 FA 01 74 0E 83 FA 04 74 1C 42 0F 85 13 02 00 00 EB 0A 31 DB 83 F8 02 0F 94 C3 EB 0B 83 3E 02 0F 85 FE 01 00 00 }
	condition:
		$pattern
}

rule clnttcp_call_088631e231ebd66951fc12cd3119d853 {
	meta:
		aliases = "clnttcp_call"
		size = "587"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 8B 4C 24 60 8B 44 24 78 8B 54 24 7C 8B 59 08 8D 4B 30 89 4C 24 10 8D 73 4C 83 7B 10 00 75 06 89 53 0C 89 43 08 83 7C 24 70 00 75 12 83 7B 08 00 75 0C 83 7B 0C 00 0F 95 C0 0F B6 F8 EB 05 BF 01 00 00 00 8D 43 30 C7 44 24 14 02 00 00 00 89 44 24 0C C7 43 4C 00 00 00 00 C7 43 24 00 00 00 00 8B 54 24 10 8B 02 48 89 02 0F C8 89 44 24 18 55 8B 43 50 FF 73 48 FF 74 24 14 56 FF 50 0C 83 C4 10 85 C0 74 3E 51 51 8B 43 50 8D 4C 24 6C 51 56 FF 50 04 83 C4 10 85 C0 74 29 8B 54 24 60 8B 02 52 52 8B 50 20 56 50 FF 52 04 83 C4 10 85 C0 74 12 50 50 FF 74 24 74 56 FF 54 24 78 83 C4 10 85 C0 }
	condition:
		$pattern
}

rule clntunix_call_1e639ee3239ddd050ba1c650af172086 {
	meta:
		aliases = "clntunix_call"
		size = "656"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 8B 4C 24 60 8B 44 24 78 8B 54 24 7C 8B 59 08 8D 8B 90 00 00 00 89 4C 24 10 8D B3 AC 00 00 00 83 7B 10 00 75 06 89 53 0C 89 43 08 83 7C 24 70 00 75 12 83 7B 08 00 75 0C 83 7B 0C 00 0F 95 C0 0F B6 F8 EB 05 BF 01 00 00 00 8D 83 90 00 00 00 C7 44 24 14 02 00 00 00 89 44 24 0C C7 83 AC 00 00 00 00 00 00 00 C7 83 84 00 00 00 00 00 00 00 8B 54 24 10 8B 02 48 89 02 0F C8 89 44 24 18 55 8B 83 B0 00 00 00 FF B3 A8 00 00 00 FF 74 24 14 56 FF 50 0C 83 C4 10 85 C0 74 41 51 51 8B 83 B0 00 00 00 8D 4C 24 6C 51 56 FF 50 04 83 C4 10 85 C0 74 29 8B 54 24 60 8B 02 52 52 8B 50 20 56 50 FF 52 }
	condition:
		$pattern
}

rule __time_localtime_tzi_c8a95e3bb71c0148f7123e576a00faaf {
	meta:
		aliases = "__time_localtime_tzi"
		size = "738"
		objfiles = "_time_localtime_tzi@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C C7 44 24 20 00 00 00 00 8B 4C 24 60 6B 44 24 20 18 8B 5C 24 68 8B 11 B9 F9 FF FF FF 01 C3 B8 80 3A 09 00 2B 03 81 FA 7F C5 F6 7F 7E 07 F7 D8 B9 07 00 00 00 01 D0 89 44 24 48 8D 7B 10 56 FF 74 24 68 51 8D 74 24 54 56 BE ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 74 8B 54 24 30 8B 4C 24 74 83 C4 10 89 50 20 8B 03 F7 D8 89 41 24 51 51 57 8D 5E 04 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 04 89 D8 EB 50 8B 36 85 F6 75 E3 52 52 6A 07 57 E8 ?? ?? ?? ?? 83 C4 10 83 F8 06 7F 33 83 EC 0C 83 C0 08 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C2 74 1E A1 ?? ?? ?? ?? 89 02 50 50 57 8D 42 04 50 89 15 ?? ?? }
	condition:
		$pattern
}

rule __GI_nearbyint_e880e6d9c845e6d62b55a63d1131f51b {
	meta:
		aliases = "__GI_rint, rint, nearbyint, __GI_nearbyint"
		size = "346"
		objfiles = "s_rint@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C DD 44 24 60 C7 44 24 08 00 00 00 00 DD 14 24 DD 54 24 28 8B 44 24 2C C7 44 24 0C 00 00 00 00 8B 5C 24 28 C1 E8 14 25 FF 07 00 00 8D B0 01 FC FF FF 83 FE 33 0F 8F 0C 01 00 00 8B 6C 24 2C 89 EF C1 EF 1F 83 FE 13 0F 8F B0 00 00 00 85 F6 79 72 89 E8 25 FF FF FF 7F 09 D8 0F 84 E7 00 00 00 89 EA 81 E5 00 00 FE FF 81 E2 FF FF 0F 00 09 DA 89 D0 F7 D8 09 D0 C1 E8 0C 25 00 00 08 00 DD 5C 24 20 09 E8 DD 04 FD ?? ?? ?? ?? C1 E7 1F 89 44 24 24 DD 44 24 20 D8 C1 DD 5C 24 40 DD 44 24 40 DE E1 DD 54 24 30 DD 54 24 18 8B 44 24 1C DD 5C 24 10 25 FF FF FF 7F 09 C7 89 7C 24 14 DD 44 24 10 EB }
	condition:
		$pattern
}

rule __ieee754_remainder_09f81c3fd011841c6da9fb98ce19a2d6 {
	meta:
		aliases = "__GI_remainder, remainder, drem, __ieee754_remainder"
		size = "356"
		objfiles = "e_remainder@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C DD 44 24 60 DD 54 24 10 DD 44 24 68 DD 54 24 08 D9 C9 DD 54 24 30 D9 C9 DD 54 24 28 8B 44 24 34 8B 74 24 2C 8B 7C 24 28 8B 6C 24 30 89 44 24 3C 81 E6 FF FF FF 7F 89 F0 09 F8 75 04 DE C9 EB 30 DD D8 DD D8 8B 5C 24 3C 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7F 12 81 FE FF FF EF 7F 7E 19 8D 86 00 00 10 80 09 F8 74 37 DD 44 24 10 DC 4C 24 08 D8 F0 E9 DE 00 00 00 81 FE FF FF DF 7F 7F 20 DD 44 24 08 83 EC 08 D8 C0 DD 1C 24 FF 74 24 1C FF 74 24 1C E8 ?? ?? ?? ?? DD 5C 24 20 83 C4 10 29 F3 29 FD 09 EB 75 0F DD 44 24 10 DC 0D ?? ?? ?? ?? E9 9F 00 00 00 51 51 FF 74 24 1C FF 74 24 1C E8 }
	condition:
		$pattern
}

rule atan2_2b84b7aac911b7c7fbdd563f0db2d381 {
	meta:
		aliases = "__GI_atan2, __ieee754_atan2, atan2"
		size = "581"
		objfiles = "e_atan2@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C DD 44 24 60 DD 54 24 10 DD 44 24 68 DD 54 24 08 DD 5C 24 30 8B 44 24 34 DD 5C 24 28 8B 4C 24 30 8B 54 24 28 89 C7 89 44 24 44 89 C8 81 E7 FF FF FF 7F F7 D8 09 C8 C1 E8 1F 09 F8 3D 00 00 F0 7F 77 1E 8B 6C 24 2C 89 D0 F7 D8 09 D0 C1 E8 1F 89 EE 81 E6 FF FF FF 7F 09 F0 3D 00 00 F0 7F 76 0D DD 44 24 10 DC 44 24 08 E9 C1 01 00 00 8B 44 24 44 2D 00 00 F0 3F 09 C8 75 14 DD 44 24 10 DD 5C 24 60 83 C4 4C 5B 5E 5F 5D E9 ?? ?? ?? ?? 8B 5C 24 44 89 E8 C1 E8 1F C1 FB 1E 83 E3 02 09 C3 09 F2 75 18 83 FB 02 0F 84 8C 00 00 00 0F 8E 80 01 00 00 83 FB 03 0F 84 88 00 00 00 09 F9 0F 84 A5 00 }
	condition:
		$pattern
}

rule llrint_1079000bed9bf1c34623ca8a57366bda {
	meta:
		aliases = "__GI_llrint, llrint"
		size = "403"
		objfiles = "s_llrint@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 54 DD 44 24 68 DD 54 24 08 DD 5C 24 20 8B 44 24 24 8B 74 24 20 89 C2 89 C1 C1 EA 14 81 E2 FF 07 00 00 89 54 24 04 81 EA FF 03 00 00 C1 E9 1F 83 FA 13 89 4C 24 2C 7F 54 DD 04 CD ?? ?? ?? ?? 31 FF 31 ED DD 44 24 08 D8 C1 DD 5C 24 48 DD 44 24 48 DE E1 DD 5C 24 18 8B 54 24 1C 89 D0 C1 E8 14 25 FF 07 00 00 2D FF 03 00 00 0F 88 03 01 00 00 81 E2 FF FF 0F 00 B9 14 00 00 00 81 CA 00 00 10 00 29 C1 D3 EA 89 D7 E9 8F 00 00 00 83 FA 3E 0F 8F B3 00 00 00 83 FA 33 7E 38 25 FF FF 0F 00 B9 00 00 00 00 0D 00 00 10 00 89 C3 89 C8 8B 4C 24 04 09 F0 89 DD 89 C7 81 E9 33 04 00 00 0F A5 C5 31 C0 }
	condition:
		$pattern
}

rule __GI_clntudp_bufcreate_d506612c1be41fae3dca2b53155ece43 {
	meta:
		aliases = "clntudp_bufcreate, __GI_clntudp_bufcreate"
		size = "570"
		objfiles = "clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 58 6A 0C E8 ?? ?? ?? ?? 8B BC 24 88 00 00 00 8B 9C 24 8C 00 00 00 83 C7 03 83 C3 03 83 E7 FC 83 E3 FC 89 C5 8D 44 1F 64 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 85 ED 89 C6 74 04 85 C0 75 2E E8 ?? ?? ?? ?? 51 89 C3 51 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 C7 03 0C 00 00 00 C7 43 08 0C 00 00 00 E9 9D 01 00 00 8D 44 03 60 89 46 58 8B 44 24 60 66 83 78 02 00 75 2A 6A 11 FF 74 24 6C FF 74 24 6C 50 E8 ?? ?? ?? ?? 83 C4 10 0F B7 C0 85 C0 0F 84 6D 01 00 00 8B 54 24 60 66 C1 C8 08 66 89 42 02 C7 45 04 ?? ?? ?? ?? 8D 46 08 89 75 08 52 6A 10 FF 74 24 68 50 E8 ?? ?? ?? ?? 8B }
	condition:
		$pattern
}

rule __GI_inet_ntop_cb4794542bacd3224e804d5b701ea2bc {
	meta:
		aliases = "inet_ntop, __GI_inet_ntop"
		size = "458"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 5C 8B 44 24 70 83 F8 02 74 0B 83 F8 0A 0F 85 9A 01 00 00 EB 18 8B 54 24 78 8B 4C 24 7C 8B 44 24 74 E8 ?? ?? ?? ?? 89 C2 E9 8D 01 00 00 31 C0 B9 08 00 00 00 8D 7C 24 3C F3 AB 31 C9 89 C8 BA 02 00 00 00 89 D6 99 F7 FE 8B 54 24 74 89 C3 0F B6 04 0A 0F B6 54 11 01 83 C1 02 C1 E0 08 09 D0 83 F9 0F 89 44 9C 3C 7E D4 31 D2 83 CE FF 83 C8 FF EB 2E 83 7C 94 3C 00 75 11 83 F8 FF 75 09 89 D0 B9 01 00 00 00 EB 18 41 EB 15 83 F8 FF 74 10 83 FE FF 74 04 39 E9 7E 04 89 CD 89 C6 83 C8 FF 42 83 FA 07 7E CD 83 F8 FF 74 0D 83 FE FF 74 04 39 E9 7E 04 89 CD 89 C6 83 FE FF 74 0B 83 FD 01 B8 FF FF }
	condition:
		$pattern
}

rule _wstdio_fwrite_573a9b47e02b9e5bdfe0e1397221a83e {
	meta:
		aliases = "_wstdio_fwrite"
		size = "237"
		objfiles = "_wfwrite@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 5C 8B 74 24 78 8B 6C 24 74 83 7E 04 FD 75 38 8B 56 10 89 EB 8B 46 0C 29 D0 C1 F8 02 39 E8 0F 46 D8 85 DB 0F 84 B4 00 00 00 51 53 FF 74 24 78 52 E8 ?? ?? ?? ?? 8D 04 9D 00 00 00 00 83 C4 10 01 46 10 E9 96 00 00 00 0F B7 06 25 40 08 00 00 3D 40 08 00 00 74 16 52 31 FF 52 68 00 08 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 6F 8B 44 24 70 8D 56 2C 31 FF 89 54 24 08 89 44 24 58 EB 58 83 EC 0C 89 E8 FF 74 24 14 29 F8 6A 40 50 8D 44 24 70 50 8D 54 24 34 52 E8 ?? ?? ?? ?? 83 C4 20 83 F8 FF 89 C3 74 35 85 C0 75 0E 8B 54 24 70 B3 01 8D 44 BA 04 89 44 24 58 50 56 53 8D 44 24 24 50 E8 ?? }
	condition:
		$pattern
}

rule strftime_6ba510dc472d8ef65d60db1a78316876 {
	meta:
		aliases = "strftime"
		size = "1300"
		objfiles = "strftime@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 64 6A 00 FF B4 24 88 00 00 00 E8 ?? ?? ?? ?? 3D FF 4E 98 45 0F 9E C0 0F B6 C0 89 04 24 E8 ?? ?? ?? ?? 8B 84 24 84 00 00 00 8B 8C 24 88 00 00 00 C7 44 24 30 00 00 00 00 89 44 24 28 83 C4 10 8D 54 24 44 89 54 24 04 83 7C 24 18 00 0F 84 B2 04 00 00 8A 01 84 C0 75 29 83 7C 24 20 00 75 14 8B 4C 24 70 C6 01 00 8B 44 24 74 2B 44 24 18 E9 93 04 00 00 FF 4C 24 20 8B 5C 24 20 8B 4C 9C 34 EB C6 3C 25 74 06 89 4C 24 14 EB 0E 8D 79 01 89 7C 24 14 8A 41 01 3C 25 75 0F 89 CE C7 44 24 1C 01 00 00 00 E9 24 04 00 00 3C 4F 74 10 3C 45 74 10 B3 3F C7 44 24 1C 02 00 00 00 EB 17 B0 40 EB 02 B0 80 }
	condition:
		$pattern
}

rule vswprintf_9dae925b244fc04e02349dc8e53fa6c0 {
	meta:
		aliases = "__GI_vswprintf, vswprintf"
		size = "191"
		objfiles = "vswprintf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 68 8B 5C 24 7C 8D 44 24 50 8B B4 24 80 00 00 00 8D 7C 24 18 C7 44 24 1C FD FF FF FF 66 C7 44 24 18 50 08 89 DD F7 D5 C6 44 24 1A 00 C1 ED 02 C7 44 24 44 00 00 00 00 C7 44 24 4C 01 00 00 00 50 E8 ?? ?? ?? ?? C7 44 24 3C 00 00 00 00 83 C4 0C 39 F5 0F 47 EE 8D 04 AB 89 5C 24 18 89 44 24 1C 89 5C 24 20 89 5C 24 24 89 5C 24 28 89 5C 24 2C FF B4 24 80 00 00 00 FF B4 24 80 00 00 00 57 E8 ?? ?? ?? ?? 89 C2 8B 44 24 2C 83 C4 10 3B 44 24 18 75 0E 83 CA FF 85 ED 74 15 83 E8 04 89 44 24 1C 85 ED 74 0A 8B 44 24 1C C7 00 00 00 00 00 83 C4 5C 89 D0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _ppfs_parsespec_fe6a8b6db11a5c771029ca42324544d9 {
	meta:
		aliases = "_ppfs_parsespec"
		size = "1094"
		objfiles = "_ppfs_parsespec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 6C 8B 94 24 80 00 00 00 8B 84 24 80 00 00 00 C7 44 24 60 00 00 00 00 C7 44 24 64 00 00 00 00 C7 44 24 44 08 00 00 00 C7 44 24 48 08 00 00 00 8B 6A 10 8B 40 18 81 E5 80 00 00 00 89 44 24 14 75 04 8B 12 EB 3C 31 F6 8B 84 24 80 00 00 00 8D 0C B5 00 00 00 00 8B 10 8B 44 11 FC 88 44 34 24 88 C3 0F B6 C0 3B 44 11 FC 0F 85 C7 03 00 00 84 DB 74 06 46 83 FE 1F 76 CF C6 44 24 43 00 8D 54 24 25 C7 44 24 0C 00 00 00 00 C7 44 24 10 00 00 00 00 EB 02 89 F2 80 3A 2A 89 D6 75 10 6B 44 24 10 FC 8D 72 01 C7 44 04 44 00 00 00 00 31 FF EB 24 81 FF CB CC CC 0C 7E 0D 81 FF CC CC CC 0C 75 0E 83 F9 }
	condition:
		$pattern
}

rule __pthread_manager_906800fd3046b02625e94a43d4748c30 {
	meta:
		aliases = "__pthread_manager"
		size = "1646"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 74 C7 44 24 64 FF FF FF FF C7 44 24 68 FF FF FF FF FF 35 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? 8D 5C 24 68 53 E8 ?? ?? ?? ?? 59 5E 6A 05 53 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 74 15 A1 ?? ?? ?? ?? 85 C0 7E 0C 52 52 50 53 E8 ?? ?? ?? ?? 83 C4 10 50 6A 00 8D 44 24 64 50 6A 02 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 5D FF 70 18 E8 ?? ?? ?? ?? 83 C4 10 8D 5C 24 40 57 6A 1C 53 FF B4 24 8C 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E0 8B 84 24 80 00 00 00 66 C7 44 24 68 01 00 89 44 24 64 56 68 D0 07 00 00 6A 01 8D 54 24 70 }
	condition:
		$pattern
}

rule gamma_r_9a0e4b77eb2bc81c180419eb9a0dc9fc {
	meta:
		aliases = "__ieee754_lgamma_r, lgamma_r, gamma_r"
		size = "1710"
		objfiles = "e_lgamma_r@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 7C DD 84 24 90 00 00 00 8B AC 24 98 00 00 00 DD 54 24 20 DD 54 24 38 8B 44 24 3C C7 45 00 01 00 00 00 89 C6 81 E6 FF FF FF 7F 81 FE FF FF EF 7F 89 44 24 54 7E 09 D9 C0 DE C9 E9 61 06 00 00 DD D8 8B 7C 24 38 89 F0 09 F8 75 1F 50 50 FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 64 C7 45 00 FF FF FF FF EB 5B 81 FE FF FF 8F 3B 7F 39 83 7C 24 54 00 79 19 83 EC 10 DD 44 24 30 D9 E0 C7 45 00 FF FF FF FF DD 54 24 30 DD 1C 24 EB 0A 50 50 FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 D9 E0 E9 F5 05 00 00 83 7C 24 54 00 78 0B D9 EE DD 5C 24 48 E9 F0 01 00 00 81 FE FF FF 2F }
	condition:
		$pattern
}

rule scan_getwc_446411eb29ece560e428e7b16a2cc943 {
	meta:
		aliases = "scan_getwc"
		size = "155"
		objfiles = "vfscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 89 C3 83 EC 1C 8B 78 10 4F 85 FF 89 78 10 79 09 80 48 19 02 83 C8 FF EB 76 BE FD FF FF FF 8D 68 1C C7 40 10 FF FF FF 7F EB 2F 8B 03 88 44 24 1B 55 6A 01 8D 44 24 23 50 8D 44 24 20 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 78 09 8B 44 24 14 89 43 24 EB 36 83 F8 FE 75 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 C1 83 FE FD 75 0D 66 BE FF FF C7 43 24 FF FF FF FF EB 0F E8 ?? ?? ?? ?? C7 00 54 00 00 00 C6 43 1B 01 89 7B 10 89 F0 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule des_setkey_365cd097f8e6319f4316f9029adf8abc {
	meta:
		aliases = "des_setkey"
		size = "638"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 89 C3 83 EC 2C E8 ?? ?? ?? ?? 8B 43 04 0F C8 89 C1 8B 13 0F CA 09 D1 74 14 3B 15 ?? ?? ?? ?? 75 0C 3B 05 ?? ?? ?? ?? 0F 84 45 02 00 00 89 D5 89 D1 C1 ED 19 89 D6 C1 E9 11 89 C3 89 6C 24 04 83 E1 7F 89 C5 89 4C 24 08 C1 ED 19 89 D1 89 6C 24 0C 8B 6C 24 08 C1 E9 09 83 E1 7F 8B 3C 8D ?? ?? ?? ?? D1 EE 83 E6 7F 0B 3C AD ?? ?? ?? ?? 8B 6C 24 04 C1 EB 11 83 E3 7F 89 15 ?? ?? ?? ?? 89 C2 C1 EA 09 0B 3C AD ?? ?? ?? ?? 83 E2 7F 8B 6C 24 0C 0B 3C B5 ?? ?? ?? ?? A3 ?? ?? ?? ?? D1 E8 83 E0 7F 0B 3C AD ?? ?? ?? ?? 8B 2C 8D ?? ?? ?? ?? 8B 4C 24 08 0B 3C 9D ?? ?? ?? ?? C7 44 24 24 00 00 00 00 0B }
	condition:
		$pattern
}

rule __syscall_mq_timedsend_41fec84834d8aef81ecee0b08068394b {
	meta:
		aliases = "__syscall_mq_timedsend"
		size = "62"
		objfiles = "mq_send@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 89 D3 83 EC 0C 89 CA 8B 74 24 20 89 D9 8B 7C 24 24 53 89 C3 B8 17 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __syscall_mq_timedreceive_612b33105cdd61db84aa189d98b4c959 {
	meta:
		aliases = "__syscall_mq_timedreceive"
		size = "62"
		objfiles = "mq_receive@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 89 D3 83 EC 0C 89 CA 8B 74 24 20 89 D9 8B 7C 24 24 53 89 C3 B8 18 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule random_r_21df100edf4572ca634cf5fde9d73f4b {
	meta:
		aliases = "__GI_random_r, random_r"
		size = "94"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 5C 24 14 8B 6C 24 18 80 7B 0C 00 8B 73 08 75 17 69 06 6D 4E C6 41 05 39 30 00 00 25 FF FF FF 7F 89 06 89 45 00 EB 2B 8B 03 8B 4B 04 8B 7B 10 8B 10 03 11 89 10 83 C0 04 D1 EA 39 F8 89 55 00 8D 51 04 72 04 89 F0 EB 05 39 FA 0F 43 D6 89 03 89 53 04 5B 31 C0 5E 5F 5D C3 }
	condition:
		$pattern
}

rule wcpncpy_4f78ca777dc50dc87c6150285c77d88d {
	meta:
		aliases = "wcpncpy"
		size = "53"
		objfiles = "wcpncpy@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 14 8B 7C 24 18 8B 74 24 1C 89 EB 89 F9 EB 10 8B 01 8D 51 04 85 C0 0F 45 CA 4E 89 03 83 C3 04 85 F6 75 EC 5B 29 F9 8D 44 0D 00 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule register_printf_function_7760fd7479a7ad55081546087f31ba82 {
	meta:
		aliases = "register_printf_function"
		size = "105"
		objfiles = "register_printf_function@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 74 24 14 8B 7C 24 18 8B 6C 24 1C 85 F6 74 4D 85 ED 74 49 8B 1D ?? ?? ?? ?? 31 C9 8D 53 0A 4A 8A 02 84 C0 0F B6 C0 0F 44 CA 39 F0 75 04 89 D1 89 DA 39 DA 77 E9 85 C9 74 23 85 FF 74 18 89 F0 88 01 89 C8 29 D0 89 3C 85 ?? ?? ?? ?? 89 2C 85 ?? ?? ?? ?? EB 03 C6 01 00 31 C0 EB 03 83 C8 FF 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule getprotoent_r_d584d4857b08cdf1763db1ad333854b1 {
	meta:
		aliases = "__GI_getprotoent_r, getprotoent_r"
		size = "255"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 BB 22 00 00 00 83 EC 2C 8B 7C 24 48 8B 6C 24 4C 8B 74 24 40 C7 44 24 28 00 00 00 00 81 FF 2B 01 00 00 C7 45 00 00 00 00 00 0F 86 BB 00 00 00 53 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 24 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 13 0F BE 05 ?? ?? ?? ?? 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 8B 15 ?? ?? ?? ?? 85 D2 74 5B 8B 44 24 44 C7 42 08 2C 00 00 00 89 42 04 8D 47 D4 89 42 10 68 ?? ?? ?? ?? 68 0A 02 07 00 8D 44 24 30 50 52 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 2B 8B 5C 24 28 8B 03 89 06 8B 43 04 83 C3 08 89 5C 24 28 83 EC 0C 50 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_getservent_r_03c478b995fb712b22d33e9b816bf3a6 {
	meta:
		aliases = "getservent_r, __GI_getservent_r"
		size = "275"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 BB 22 00 00 00 83 EC 2C 8B 7C 24 48 8B 6C 24 4C 8B 74 24 40 C7 44 24 28 00 00 00 00 81 FF 2F 01 00 00 C7 45 00 00 00 00 00 0F 86 CF 00 00 00 53 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 24 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 13 0F BE 05 ?? ?? ?? ?? 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 8B 15 ?? ?? ?? ?? 85 D2 74 6F 8B 44 24 44 C7 42 08 30 00 00 00 89 42 04 8D 47 D0 89 42 10 68 ?? ?? ?? ?? 68 0B 03 07 00 8D 44 24 30 50 52 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 3F 8B 5C 24 28 8B 03 89 06 8D 43 08 8B 53 04 89 44 24 28 83 EC 0C 52 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule readtcp_532cfff28728ef95baf55d4feafc7a07 {
	meta:
		aliases = "readtcp"
		size = "196"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 BB E8 03 00 00 83 EC 1C 8B 74 24 30 8B 6C 24 38 8B 4E 0C 89 C8 99 F7 FB 66 31 DB 89 C1 69 46 08 E8 03 00 00 85 ED 8D 3C 01 0F 84 87 00 00 00 8B 06 8D 5C 24 14 66 C7 44 24 18 01 00 89 44 24 14 50 57 6A 01 53 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 74 0D 85 C0 75 24 C7 46 24 05 00 00 00 EB 16 E8 ?? ?? ?? ?? 83 38 04 74 D7 C7 46 24 04 00 00 00 8B 00 89 46 28 83 CB FF EB 3C 50 55 FF 74 24 3C FF 36 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C3 74 14 85 C0 75 21 C7 46 28 68 00 00 00 C7 46 24 04 00 00 00 EB D0 E8 ?? ?? ?? ?? 8B 00 C7 46 24 04 00 00 00 89 46 28 83 C4 1C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule readunix_fcd7b7405f0aa534bfc498fea3cb59bb {
	meta:
		aliases = "readunix"
		size = "361"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 BB E8 03 00 00 83 EC 5C 8B 74 24 70 8B 6C 24 78 8B 4E 0C 89 C8 99 F7 FB 66 31 DB 89 C1 69 46 08 E8 03 00 00 85 ED 8D 3C 01 0F 84 2C 01 00 00 8B 06 8D 5C 24 50 66 C7 44 24 54 01 00 89 44 24 50 50 57 6A 01 53 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 74 10 85 C0 75 30 C7 86 84 00 00 00 05 00 00 00 EB 1C E8 ?? ?? ?? ?? 83 38 04 74 D4 C7 86 84 00 00 00 04 00 00 00 8B 00 89 86 88 00 00 00 83 CB FF E9 D5 00 00 00 8B 44 24 74 8B 3E 89 6C 24 4C C7 44 24 20 01 00 00 00 89 44 24 48 8D 44 24 48 89 44 24 1C 8D 44 24 30 89 44 24 24 C7 44 24 14 00 00 00 00 C7 44 24 18 00 00 00 00 C7 44 24 28 18 00 00 00 }
	condition:
		$pattern
}

rule __copy_rpcent_c291b41172775a95ddea9db192426905 {
	meta:
		aliases = "__copy_rpcent"
		size = "265"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 89 C6 53 89 D3 83 EC 0C 85 F6 8B 44 24 24 89 0C 24 C7 00 00 00 00 00 B8 02 00 00 00 0F 84 DC 00 00 00 30 C0 89 D7 AB AB AB 50 FF 74 24 24 6A 00 51 E8 ?? ?? ?? ?? 8B 46 08 31 D2 83 C4 10 89 43 08 8B 46 04 8B 04 90 42 85 C0 75 F5 8D 04 95 00 00 00 00 39 44 24 20 0F 82 9C 00 00 00 8D 6A FF 8B 4C 24 20 8B 14 24 29 C1 89 53 04 01 C2 89 54 24 04 89 4C 24 08 EB 4B 8B 46 04 83 EC 0C 8D 3C AD 00 00 00 00 FF 34 38 E8 ?? ?? ?? ?? 83 C4 10 8D 50 01 39 54 24 08 72 60 8B 4C 24 04 8B 43 04 89 0C 38 01 D1 89 4C 24 04 29 54 24 08 50 8B 46 04 52 FF 34 38 8B 43 04 FF 34 38 E8 ?? ?? ?? ?? 83 C4 10 4D 83 }
	condition:
		$pattern
}

rule exchange_128e660276b450807b5fedc609b837d5 {
	meta:
		aliases = "exchange"
		size = "219"
		objfiles = "getopt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 89 D6 53 83 EC 18 89 44 24 04 8B 42 14 8B 52 18 89 44 24 08 8B 06 89 54 24 0C 89 44 24 10 E9 87 00 00 00 8B 6C 24 10 8B 7C 24 0C 2B 6C 24 0C 2B 7C 24 08 C7 44 24 14 00 00 00 00 39 FD 7E 61 8B 54 24 10 31 ED 29 FA 89 14 24 EB 20 8B 44 24 08 8B 54 24 04 8D 4C 05 00 8B 04 24 8D 0C 8A 8B 19 01 E8 45 8D 04 82 8B 10 89 11 89 18 39 FD 7C DC 29 7C 24 10 EB 34 8B 4C 24 14 8B 44 24 04 03 4C 24 08 8B 54 24 04 8D 0C 88 8B 44 24 14 03 44 24 0C 8B 19 FF 44 24 14 8D 04 82 8B 10 89 11 89 18 39 6C 24 14 7C D0 01 6C 24 08 8B 44 24 0C 39 44 24 10 7E 0C 8B 54 24 08 39 D0 0F 8F 63 FF FF FF 8B 46 14 03 06 }
	condition:
		$pattern
}

rule sigwait_86c87f9a9822658a017226aa788cbf05 {
	meta:
		aliases = "sigwait"
		size = "293"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 BE 01 00 00 00 53 83 EC 5C E8 ?? ?? ?? ?? C7 44 24 50 FF FF FF FF C7 44 24 54 FF FF FF FF 89 44 24 58 50 50 FF 35 ?? ?? ?? ?? 8D 5C 24 5C 53 89 DD E8 ?? ?? ?? ?? 83 C4 10 8D 5C 24 3C EB 60 50 50 56 FF 74 24 7C E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 4C 3B 35 ?? ?? ?? ?? 74 44 3B 35 ?? ?? ?? ?? 74 3C 3B 35 ?? ?? ?? ?? 74 34 50 50 56 55 E8 ?? ?? ?? ?? 83 C4 10 83 3C B5 ?? ?? ?? ?? 01 77 1E 31 C0 89 DF AB AB AB AB AB C7 44 24 3C ?? ?? ?? ?? 50 6A 00 53 56 E8 ?? ?? ?? ?? 83 C4 10 46 83 FE 41 7E 9B 50 50 6A 01 8D 44 24 24 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 42 8B 44 24 58 8D 54 24 18 89 50 28 8B }
	condition:
		$pattern
}

rule gethostbyname_r_b97d34d58813a8b77cc2561deb6f3ba1 {
	meta:
		aliases = "__GI_gethostbyname_r, gethostbyname_r"
		size = "690"
		objfiles = "gethostbyname_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 BE 16 00 00 00 53 83 EC 3C 8B 44 24 60 83 7C 24 50 00 8B 6C 24 5C C7 00 00 00 00 00 0F 84 83 02 00 00 E8 ?? ?? ?? ?? 8B 38 89 C3 C7 00 00 00 00 00 50 FF 74 24 68 FF 74 24 68 55 FF 74 24 68 FF 74 24 68 6A 02 FF 74 24 6C E8 ?? ?? ?? ?? 83 C4 20 85 C0 89 C6 75 07 89 3B E9 47 02 00 00 8B 54 24 64 8B 02 83 F8 01 74 0E 83 F8 04 74 1F 40 0F 85 30 02 00 00 EB 0D 31 C0 83 FE 02 0F 94 C0 89 04 24 EB 10 83 3B 02 0F 85 18 02 00 00 C7 04 24 00 00 00 00 8B 4C 24 64 83 EC 0C 89 3B C7 01 FF FF FF FF FF 74 24 5C E8 ?? ?? ?? ?? 83 C4 10 8D 58 01 39 DD 0F 8E E6 01 00 00 50 29 DD 53 FF 74 24 58 FF 74 24 }
	condition:
		$pattern
}

rule __kernel_rem_pio2_c2e5a0881d3e96f74926358e942cd3ff {
	meta:
		aliases = "__kernel_rem_pio2"
		size = "1471"
		objfiles = "k_rem_pio2@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 BE 18 00 00 00 53 81 EC 7C 02 00 00 8B 84 24 A0 02 00 00 8B 8C 24 98 02 00 00 8B 94 24 9C 02 00 00 C7 44 24 2C 00 00 00 00 8B 04 85 ?? ?? ?? ?? 8D 59 FD 4A 89 54 24 20 89 44 24 24 89 D8 99 F7 FE 89 CE 8B 4C 24 24 85 C0 89 C3 0F 48 5C 24 2C 31 D2 03 4C 24 20 89 D8 40 6B C0 18 89 5C 24 2C 29 C6 89 D8 2B 44 24 20 EB 1B 85 C0 79 04 D9 EE EB 0A 8B 9C 24 A4 02 00 00 DB 04 83 DD 9C D4 80 01 00 00 40 42 39 CA 7E E1 31 C9 EB 23 8B BC 24 90 02 00 00 89 D8 29 D0 DD 04 D7 42 DC 8C C4 80 01 00 00 DE C1 3B 54 24 20 7E E2 DD 5C CC 40 41 3B 4C 24 24 7F 0D 8B 6C 24 20 31 D2 D9 EE 8D 1C 29 EB E2 C7 44 }
	condition:
		$pattern
}

rule __getutid_d32e2a39a674ce2763485df45a81ac66 {
	meta:
		aliases = "__getutid"
		size = "80"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 89 C7 56 53 83 EC 0C 0F BF 00 8D 6F 28 8D 70 FF C1 EE 02 EB 24 85 F6 75 07 8B 03 66 3B 07 EB 17 83 FE 01 75 14 50 6A 04 55 8D 43 28 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0B E8 ?? ?? ?? ?? 85 C0 89 C3 75 D1 83 C4 0C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _charpad_d824bbe0f237add4fc47f2f1d33158d6 {
	meta:
		aliases = "_charpad"
		size = "56"
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 89 C7 56 89 CE 53 89 CB 83 EC 1C 8D 6C 24 18 89 54 24 18 EB 01 4B 85 DB 74 10 50 57 6A 01 55 E8 ?? ?? ?? ?? 83 C4 10 48 74 EB 83 C4 1C 29 DE 5B 89 F0 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _charpad_7cfb046b6e8097822d3b7790309abb2f {
	meta:
		aliases = "_charpad"
		size = "56"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 89 C7 56 89 CE 53 89 CB 83 EC 1C 8D 6C 24 1B 88 54 24 1B EB 01 4B 85 DB 74 10 50 57 6A 01 55 E8 ?? ?? ?? ?? 83 C4 10 48 74 EB 83 C4 1C 29 DE 5B 89 F0 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __md5_Update_eb7e44a8195d2ad641764a5add9bc1e6 {
	meta:
		aliases = "__md5_Update"
		size = "155"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 89 CF 56 89 C6 53 83 EC 0C 8B 40 10 89 54 24 08 8D 14 FD 00 00 00 00 89 C1 C1 E9 03 8D 04 02 83 E1 3F 39 D0 89 46 10 73 03 FF 46 14 89 F8 BD 40 00 00 00 C1 E8 1D 29 CD 01 46 14 31 DB 39 EF 72 3B 52 55 FF 74 24 10 8D 5E 18 8D 04 0B 50 E8 ?? ?? ?? ?? 89 DA 89 F0 E8 ?? ?? ?? ?? 89 EB 83 C4 10 EB 10 8B 54 24 08 89 F0 01 DA 83 C3 40 E8 ?? ?? ?? ?? 8D 43 3F 39 F8 72 E9 31 C9 29 DF 50 57 8B 44 24 10 01 D8 50 8D 44 31 18 50 E8 ?? ?? ?? ?? 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __pthread_lock_0ee9e5ca43ec53934603f971df787c05 {
	meta:
		aliases = "__pthread_lock"
		size = "143"
		objfiles = "spinlock@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 89 D7 56 53 89 C3 83 EC 0C 83 38 00 74 04 31 ED EB 16 31 C9 BA 01 00 00 00 89 C8 F0 0F B1 13 0F 94 C2 84 D2 74 E8 EB 5D 8B 33 F7 C6 01 00 00 00 75 0C 89 F1 BA 01 00 00 00 83 C9 01 EB 12 85 FF 75 07 E8 ?? ?? ?? ?? 89 C7 89 F9 31 D2 83 C9 01 85 FF 74 03 89 77 0C 89 F0 F0 0F B1 0B 0F 94 C1 84 C9 74 C4 85 D2 75 17 89 F8 E8 ?? ?? ?? ?? 83 7F 0C 00 74 B3 45 EB F0 89 F8 E8 ?? ?? ?? ?? 4D 83 FD FF 75 F3 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule clntraw_call_ae6894e8b899749bef4b5d07ec7a19d8 {
	meta:
		aliases = "clntraw_call"
		size = "436"
		objfiles = "clnt_raw@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 BF 10 00 00 00 56 53 83 EC 4C E8 ?? ?? ?? ?? 8B 98 A0 00 00 00 85 DB 8D 73 0C 0F 84 88 01 00 00 8D 83 84 22 00 00 89 44 24 08 C7 43 0C 00 00 00 00 57 57 8B 43 10 6A 00 56 FF 50 14 8B 54 24 18 83 C4 0C FF 02 8B 43 10 FF B3 9C 22 00 00 52 56 FF 50 0C 83 C4 10 85 C0 0F 84 25 01 00 00 51 51 8B 43 10 8D 54 24 6C 52 56 FF 50 04 83 C4 10 85 C0 0F 84 0C 01 00 00 8B 54 24 60 8B 02 52 52 8B 50 20 56 50 FF 52 04 83 C4 10 85 C0 0F 84 F1 00 00 00 55 55 FF 74 24 74 56 FF 54 24 78 83 C4 10 85 C0 0F 84 DB 00 00 00 8B 43 10 83 EC 0C 56 FF 50 10 C7 04 24 01 00 00 00 E8 ?? ?? ?? ?? 8B 43 10 C7 43 0C 01 00 }
	condition:
		$pattern
}

rule getnetent_r_60123557147529fe364591676fdf146f {
	meta:
		aliases = "__GI_getnetent_r, getnetent_r"
		size = "335"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 BF 22 00 00 00 56 53 83 EC 4C 8B 74 24 68 8B 6C 24 6C 8B 5C 24 60 C7 44 24 48 00 00 00 00 81 FE 2B 01 00 00 C7 45 00 00 00 00 00 0F 86 0B 01 00 00 57 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 40 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 13 0F BE 05 ?? ?? ?? ?? 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 8B 15 ?? ?? ?? ?? 85 D2 0F 84 A7 00 00 00 8B 44 24 64 C7 42 08 2C 00 00 00 89 42 04 8D 46 D4 89 42 10 68 ?? ?? ?? ?? 68 0A 02 07 00 8D 44 24 50 50 52 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 77 8B 44 24 48 8D 74 24 14 B9 08 00 00 00 89 F7 8B 10 83 C0 04 89 44 24 }
	condition:
		$pattern
}

rule _dl_map_cache_61c80df263bd1124d98ea8270301899a {
	meta:
		aliases = "_dl_map_cache"
		size = "507"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 83 C8 FF 57 56 53 83 EC 50 8B 15 ?? ?? ?? ?? 83 FA FF 0F 84 DA 01 00 00 85 D2 0F 85 D0 01 00 00 BE ?? ?? ?? ?? 8D 4C 24 0C 89 F2 87 D3 B8 6A 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 89 C3 76 0D F7 DB 89 1D ?? ?? ?? ?? E9 95 01 00 00 85 C0 0F 85 8D 01 00 00 B9 00 00 08 00 31 D2 89 F0 53 89 C3 B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0D F7 DF 89 3D ?? ?? ?? ?? E9 63 01 00 00 85 C0 0F 88 5B 01 00 00 8B 4C 24 20 BE 01 00 00 00 89 D8 C7 44 24 4C 00 00 00 00 89 F2 89 0D ?? ?? ?? ?? 53 89 C3 55 8B 6C 24 4C B8 C0 00 00 00 CD 80 5D 5B 3D 00 F0 FF FF 89 C1 89 C2 76 0B F7 D9 83 CA FF 89 0D ?? ?? ?? }
	condition:
		$pattern
}

rule lckpwdf_820af8f805fd08aaac0adedcfc3f6156 {
	meta:
		aliases = "lckpwdf"
		size = "341"
		objfiles = "lckpwdf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 83 C8 FF 57 56 53 83 EC 6C 83 3D ?? ?? ?? ?? FF 0F 85 36 01 00 00 50 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 48 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5D 58 68 01 00 08 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF A3 ?? ?? ?? ?? 0F 84 E0 00 00 00 57 31 DB 6A 01 6A 02 50 E8 ?? ?? ?? ?? 8D 54 24 24 89 D8 89 D7 AB AB AB AB AB C7 44 24 24 ?? ?? ?? ?? C7 44 24 30 FF FF FF FF C7 44 24 34 FF FF FF FF 83 C4 0C 8D 6C 24 2C 55 52 6A 0E E8 ?? ?? ?? ?? C7 44 24 70 00 00 00 00 C7 44 24 6C 00 20 00 00 83 C4 0C 8D 74 24 68 56 8D 44 24 64 50 6A 01 E8 ?? ?? ?? ?? C7 04 24 0F 00 00 00 E8 }
	condition:
		$pattern
}

rule srandom_r_3aa6382036d83744f1f3bb4170390292 {
	meta:
		aliases = "__GI_srandom_r, srandom_r"
		size = "168"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 83 C9 FF 57 56 53 83 EC 1C 8B 74 24 34 8B 54 24 30 8A 46 0C 88 44 24 0B 0F BE C0 83 F8 04 77 7D 85 D2 8B 5E 08 B8 01 00 00 00 0F 44 D0 80 7C 24 0B 00 89 13 74 65 0F BE 6E 0D 89 D9 BF 01 00 00 00 89 2C 24 EB 2E 89 D0 BD 1D F3 01 00 99 F7 FD 69 D2 A7 41 00 00 89 44 24 04 69 C0 14 0B 00 00 29 C2 83 FA FF 8D 82 FF FF FF 7F 0F 4E D0 83 C1 04 89 11 47 3B 3C 24 7C CD 0F BE 46 0E 8D 7C 24 18 89 5E 04 8D 04 83 6B 1C 24 0A 89 06 EB 09 57 56 E8 ?? ?? ?? ?? 58 5A 4B 79 F4 31 C9 83 C4 1C 89 C8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule getoffset_e34997d5e5b7f72df544adf3651031b5 {
	meta:
		aliases = "getoffset"
		size = "110"
		objfiles = "tzset@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 C1 57 BD ?? ?? ?? ?? 56 31 FF 53 83 CE FF 83 EC 04 89 14 24 8A 11 45 88 D0 2C 30 3C 09 77 07 0F B6 C2 41 8D 70 D0 8A 19 88 D8 2C 30 3C 09 77 0B 6B D6 0A 0F B6 C3 41 8D 74 02 D0 8A 55 00 0F B6 C2 39 C6 72 04 31 C9 EB 1B 0F AF C7 8D 3C 06 31 F6 80 39 3A 75 04 41 83 CE FF 80 FA 01 77 B5 8B 04 24 89 38 5A 89 C8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule do_dlclose_c04d4bee76203237cf9557192c72bc95 {
	meta:
		aliases = "do_dlclose"
		size = "597"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 89 C5 57 56 53 83 EC 0C 3B 05 ?? ?? ?? ?? 89 54 24 04 0F 84 32 02 00 00 A1 ?? ?? ?? ?? 31 D2 EB 09 39 E8 74 1A 89 C2 8B 40 04 85 C0 75 F3 B0 01 C7 05 ?? ?? ?? ?? 0A 00 00 00 E9 0D 02 00 00 85 D2 8B 45 04 74 05 89 42 04 EB 05 A3 ?? ?? ?? ?? 8B 55 00 0F B7 42 20 66 83 F8 01 75 12 F6 42 25 10 C7 44 24 08 00 00 00 00 0F 84 77 01 00 00 48 83 EC 0C 66 89 42 20 55 E8 ?? ?? ?? ?? 31 C0 83 C4 10 E9 C5 01 00 00 8B 45 08 8B 54 24 08 8B 3C 90 8B 47 20 48 0F B7 C0 85 C0 66 89 47 20 0F 85 3E 01 00 00 F6 47 25 10 0F 85 34 01 00 00 83 7F 74 00 75 09 83 BF A8 00 00 00 00 74 2D 83 7C 24 04 00 74 26 0F B7 47 }
	condition:
		$pattern
}

rule __add_to_environ_e9f27b4995af8c8e4b66bb8996a52dc5 {
	meta:
		aliases = "__add_to_environ"
		size = "352"
		objfiles = "setenv@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 C5 57 56 53 83 EC 34 89 54 24 18 89 4C 24 14 6A 3D 50 E8 ?? ?? ?? ?? 83 C4 0C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 89 C7 8D 44 24 28 29 EF 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 35 ?? ?? ?? ?? 83 C4 10 C7 44 24 14 00 00 00 00 85 F6 74 34 EB 2C 50 57 55 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 15 80 3C 3B 3D 75 0F 31 DB 83 7C 24 0C 00 0F 84 CE 00 00 00 EB 63 FF 44 24 14 83 C6 04 8B 1E 85 DB 75 CE 8B 74 24 14 53 53 C1 E6 02 8D 46 08 50 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 74 63 A1 ?? ?? ?? ?? 3B 05 ?? ?? ?? ?? 74 0C 51 56 50 53 E8 ?? ?? ?? ?? 83 C4 10 8D 34 33 89 1D }
	condition:
		$pattern
}

rule _dl_parse_56fe6f75560faec69784f7acd8774cac {
	meta:
		aliases = "_dl_parse"
		size = "223"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 89 C5 57 56 89 CE 53 83 EC 1C C1 6C 24 30 03 89 54 24 0C 8B 40 58 8B 55 54 C7 44 24 10 00 00 00 00 89 44 24 18 89 54 24 14 E9 96 00 00 00 83 EC 0C 8B 5E 04 FF 74 24 20 FF 74 24 28 56 FF 74 24 24 55 FF 54 24 54 83 C4 20 85 C0 89 C7 74 6E FF 35 ?? ?? ?? ?? C1 EB 08 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 85 DB 74 1E 8B 54 24 18 C1 E3 04 8B 44 24 14 03 04 13 50 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 83 FF 00 7D 19 FF 75 04 0F B6 46 04 50 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 83 C4 10 EB 2D 7E 14 FF 75 04 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 83 C4 0C EB 17 FF 44 24 10 83 C6 08 8B 44 24 }
	condition:
		$pattern
}

rule byte_common_op_match_null_stri_338d716fa6c4f142958e010a1ca24d4f {
	meta:
		aliases = "byte_common_op_match_null_string_p"
		size = "249"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 C5 57 89 CF 56 53 83 EC 1C 8B 08 89 4C 24 18 8D 71 01 8A 01 89 74 24 18 3C 0C 77 21 3C 09 0F 83 BB 00 00 00 3C 06 74 34 3C 08 0F 84 A5 00 00 00 84 C0 0F 84 A7 00 00 00 E9 B0 00 00 00 3C 15 74 64 77 0A 3C 0D 0F 85 A2 00 00 00 EB 43 2C 1A 3C 03 0F 87 96 00 00 00 E9 83 00 00 00 0F B6 59 01 8D 44 24 18 89 F9 E8 ?? ?? ?? ?? 8D 0C 9F 88 44 24 0B 8A 01 24 03 3C 03 75 0F 8A 54 24 0B 8A 01 80 E2 03 24 FC 08 D0 88 01 80 7C 24 0B 00 EB 4D 0F BE 46 01 0F B6 51 01 C1 E0 08 01 D0 78 4E 8D 44 08 03 EB 2A 8D 59 03 89 5C 24 18 0F BE 43 01 0F B6 51 03 C1 E0 08 01 D0 75 32 89 74 24 18 0F BE 46 01 0F B6 51 }
	condition:
		$pattern
}

rule byte_insert_op2_4492e139d4373ded7cc460122bfee912 {
	meta:
		aliases = "byte_insert_op2"
		size = "54"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 C5 57 89 CF 56 53 89 D3 8B 44 24 18 8B 74 24 14 8D 48 05 89 C2 EB 06 4A 49 8A 02 88 01 39 DA 75 F6 89 74 24 14 89 DA 89 F9 5B 89 E8 5E 5F 5D E9 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule byte_group_match_null_string_p_0b4ff43bf51675021b1a72676af83918 {
	meta:
		aliases = "byte_group_match_null_string_p"
		size = "256"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 C5 57 89 D7 56 89 CE 53 83 EC 1C 8B 00 83 C0 02 89 44 24 18 E9 CF 00 00 00 8A 02 3C 07 0F 84 A7 00 00 00 3C 0F 0F 85 AC 00 00 00 8D 42 01 89 44 24 18 0F BE 40 01 0F B6 4A 01 83 C2 03 89 54 24 18 C1 E0 08 89 C3 01 CB 79 4F E9 99 00 00 00 8D 54 18 FD 89 F1 E8 ?? ?? ?? ?? 84 C0 0F 84 92 00 00 00 89 D9 03 4C 24 18 89 4C 24 18 80 39 0F 75 33 8D 41 01 89 44 24 18 0F BE 40 01 0F B6 51 01 C1 E0 08 8D 1C 10 8D 41 03 89 44 24 18 80 3C 19 0E 74 06 89 4C 24 18 EB 0B 8B 44 24 18 80 7C 18 FD 0E 74 AB 8B 44 24 18 0F BE 50 FF 0F B6 48 FE C1 E2 08 8D 1C 0A 89 F1 8D 14 18 E8 ?? ?? ?? ?? 84 C0 74 30 01 5C }
	condition:
		$pattern
}

rule rwlock_have_already_70daab56b3de8f83e415cf2c27a80224 {
	meta:
		aliases = "rwlock_have_already"
		size = "175"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 CD 57 89 C7 56 89 D6 53 83 EC 0C 83 7A 18 01 8B 18 74 06 31 D2 31 C9 EB 74 85 DB 75 07 E8 ?? ?? ?? ?? 89 C3 8B 93 48 01 00 00 EB 07 39 72 04 74 08 8B 12 85 D2 75 F5 EB 04 85 D2 75 54 83 BB 50 01 00 00 00 7F 4B 8B 93 4C 01 00 00 85 D2 74 0A 8B 02 89 83 4C 01 00 00 EB 0F 83 EC 0C 6A 0C E8 ?? ?? ?? ?? 83 C4 10 89 C2 85 D2 74 18 8B 83 48 01 00 00 C7 42 08 01 00 00 00 89 72 04 89 02 89 93 48 01 00 00 83 FA 01 19 C9 83 E1 01 31 F6 EB 07 31 C9 BE 01 00 00 00 8B 44 24 20 89 55 00 89 1F 89 08 83 C4 0C 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule inet_pton4_6b2dd45adcaa1400e711a28ff3e453b6 {
	meta:
		aliases = "inet_pton4"
		size = "125"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 31 D2 56 31 FF 53 89 C3 83 EC 10 8D 74 24 0C C6 44 24 0C 00 EB 40 0F B6 C0 43 8D 48 D0 83 F9 09 77 20 0F B6 06 6B C0 0A 8D 04 01 3D FF 00 00 00 77 3D 85 D2 88 06 75 1E 47 83 FF 04 7F 31 B2 01 EB 14 83 F8 2E 75 28 85 D2 74 24 83 FF 04 74 1F 46 31 D2 C6 06 00 8A 03 84 C0 75 BA 83 FF 03 7E 0E 8B 44 24 0C 89 45 00 B8 01 00 00 00 EB 02 31 C0 83 C4 10 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule openlog_intern_65fb5a3aaea4bd4d2beae05dab4106c4 {
	meta:
		aliases = "openlog_intern"
		size = "228"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 56 53 83 EC 0C 85 C0 0F 44 05 ?? ?? ?? ?? F7 C1 07 FC FF FF 88 15 ?? ?? ?? ?? A3 ?? ?? ?? ?? 75 09 C1 E9 03 88 0D ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? BF 02 00 00 00 83 FB FF 75 54 BE 02 00 00 00 F7 C5 08 00 00 00 0F 84 8D 00 00 00 50 6A 00 56 6A 01 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C3 A3 ?? ?? ?? ?? 74 73 50 6A 01 6A 02 53 E8 ?? ?? ?? ?? 5F 89 F7 58 6A 03 53 E8 ?? ?? ?? ?? 83 C4 0C 80 CC 08 50 6A 04 53 E8 ?? ?? ?? ?? 83 C4 10 80 3D ?? ?? ?? ?? 00 75 41 51 6A 10 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 40 74 09 C6 05 ?? ?? ?? ?? 01 EB 24 83 EC 0C BE 01 00 00 00 53 E8 ?? ?? ?? ?? 83 C4 }
	condition:
		$pattern
}

rule __malloc_trim_5eb378da323aa107f8743507d0c1ee80 {
	meta:
		aliases = "__malloc_trim"
		size = "141"
		objfiles = "free@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 56 53 83 EC 0C 8B 8A 5C 03 00 00 8B 52 2C 8B 72 04 31 D2 83 E6 FC 8D 5C 31 EF 29 C3 89 D8 F7 F1 89 C3 4B 0F AF D9 85 DB 7E 55 83 EC 0C 6A 00 E8 ?? ?? ?? ?? 83 C4 10 89 C7 89 F0 03 45 2C 39 C7 75 3D 83 EC 0C F7 DB 53 E8 ?? ?? ?? ?? C7 04 24 00 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 74 1E 89 F9 29 C1 74 18 8B 45 2C 29 CE 29 8D 68 03 00 00 83 CE 01 89 70 04 B8 01 00 00 00 EB 02 31 C0 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule vwarn_work_e63e4d9332a4bfd62617a38631dbf6db {
	meta:
		aliases = "vwarn_work"
		size = "207"
		objfiles = "err@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 89 C7 56 53 BB ?? ?? ?? ?? 83 EC 5C 85 C9 74 1C E8 ?? ?? ?? ?? BB ?? ?? ?? ?? 52 6A 40 8D 54 24 14 52 FF 30 E8 ?? ?? ?? ?? 83 C4 10 8B 15 ?? ?? ?? ?? 83 7A 34 00 0F 94 C0 0F B6 F0 85 F6 74 27 50 8D 42 38 50 68 ?? ?? ?? ?? 8D 44 24 58 50 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C0 38 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 50 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 FF 74 14 51 83 EB 02 55 57 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 52 8D 44 24 10 50 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 F6 74 11 50 50 6A 01 8D 44 24 58 50 E8 ?? ?? ?? ?? 83 C4 10 83 }
	condition:
		$pattern
}

rule get_input_bytes_0c86d49db9dc3c9b2d72c5ea430b2b50 {
	meta:
		aliases = "get_input_bytes"
		size = "81"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 89 C7 56 89 CE 53 83 EC 0C EB 31 8B 57 2C 8B 47 30 29 D0 75 0D 89 F8 E8 ?? ?? ?? ?? 85 C0 75 1C EB 23 39 C6 89 C3 0F 4E DE 50 29 DE 53 52 55 01 DD E8 ?? ?? ?? ?? 83 C4 10 01 5F 2C 85 F6 7F CB B8 01 00 00 00 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule byte_compile_range_c0d917eae91fe5b647f30759a56e5596 {
	meta:
		aliases = "byte_compile_range"
		size = "204"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 89 C7 56 BE 0B 00 00 00 53 8B 12 8B 5C 24 18 39 CA 0F 84 AA 00 00 00 81 E3 00 00 01 00 83 FB 01 19 F6 8D 42 01 F7 D6 89 45 00 83 E6 0B 83 7C 24 14 00 74 16 89 F9 0F B6 C1 8B 4C 24 14 0F B6 3C 01 0F B6 02 0F B6 2C 01 EB 03 0F B6 2A 89 FB EB 6C 83 7C 24 14 00 74 1B 8B 7C 24 14 0F B6 C3 BA 08 00 00 00 89 D1 0F B6 04 07 99 F7 F9 89 C6 89 C1 EB 19 0F B6 D3 B9 08 00 00 00 89 D0 99 F7 F9 0F B6 D3 89 C6 89 D0 99 F7 F9 89 C1 8B 7C 24 1C 83 7C 24 14 00 8A 14 0F 89 D9 74 0B 8B 7C 24 14 0F B6 C3 0F B6 0C 07 83 E1 07 B8 01 00 00 00 D2 E0 43 08 D0 8B 54 24 1C 88 04 32 31 F6 39 EB 76 90 5B 89 F0 }
	condition:
		$pattern
}
...
rule do_des_5e648a6e4a917722d2e8993ea67c612a {
	meta:
		aliases = "do_des"
		size = "777"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 BA 01 00 00 00 56 53 83 EC 30 83 7C 24 48 00 89 4C 24 04 0F 84 E2 02 00 00 7E 12 C7 44 24 24 ?? ?? ?? ?? C7 44 24 28 ?? ?? ?? ?? EB 14 F7 5C 24 48 C7 44 24 24 ?? ?? ?? ?? C7 44 24 28 ?? ?? ?? ?? 89 C2 0F B6 CC C1 EA 18 89 EB 89 54 24 08 89 C2 25 FF 00 00 00 89 44 24 10 89 E8 0F B6 FF C1 E8 10 8B 5C 24 10 89 EE 25 FF 00 00 00 89 04 24 8B 44 24 08 C1 EA 10 89 4C 24 0C 89 E9 81 E2 FF 00 00 00 C1 EE 18 81 E1 FF 00 00 00 8B 2C 85 ?? ?? ?? ?? 0B 2C 9D ?? ?? ?? ?? 8B 44 24 0C 0B 2C 95 ?? ?? ?? ?? 8B 1C 24 0B 2C 85 ?? ?? ?? ?? 8B 44 24 08 0B 2C B5 ?? ?? ?? ?? 0B 2C 8D ?? ?? ?? ?? 0B 2C 9D }
	condition:
		$pattern
}
...
rule __negvsi2_e1df8a797dfd4dd30a2300011f4287ee {
	meta:
		aliases = "__negvsi2"
		size = "60"
		objfiles = "_negvsi2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 8B 45 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 C2 F7 DA 85 C0 78 13 85 D2 0F 9F C0 84 C0 75 11 83 C4 04 89 D0 5B 5D C3 89 F6 89 D0 C1 E8 1F EB EB E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __deregister_frame_15c0e34084ed70e58e8c07ff12c29668 {
	meta:
		aliases = "__deregister_frame"
		size = "49"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 8B 45 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 8B 10 85 D2 74 10 89 04 24 E8 ?? ?? ?? ?? 89 04 24 E8 ?? ?? ?? ?? 83 C4 04 5B 5D C3 }
	condition:
		$pattern
}

rule __addvsi3_f0db54e444d4325fc826b9062fa0dce3 {
	meta:
		aliases = "__addvsi3"
		size = "60"
		objfiles = "_addvsi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 8B 45 0C 8B 4D 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 85 C0 8D 14 08 78 11 39 CA 0F 9C C0 84 C0 75 0F 83 C4 04 89 D0 5B 5D C3 39 CA 0F 9F C0 EB ED E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule _Unwind_SetGR_33c000460c313b436d1ad1f65ea24057 {
	meta:
		aliases = "_Unwind_SetGR"
		size = "88"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 8B 45 0C E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 8B 55 08 83 F8 11 7F 36 F6 42 63 40 0F B6 8C 03 ?? ?? ?? ?? 75 15 80 F9 04 8B 04 82 75 20 8B 55 10 89 10 83 C4 04 5B 5D C3 89 F6 80 7C 02 6C 00 74 E4 8B 4D 10 89 0C 82 83 C4 04 5B 5D C3 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __subvsi3_8b32d1c01dca30a604cb2a6134f2c2c7 {
	meta:
		aliases = "__subvsi3"
		size = "61"
		objfiles = "_subvsi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 8B 4D 08 8B 45 0C E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 CA 29 C2 85 C0 78 11 39 CA 0F 9F C0 84 C0 75 0F 83 C4 04 89 D0 5B 5D C3 39 CA 0F 9C C0 EB ED E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __do_global_ctors_aux_8c6f249068444b4022b25d618d49a5f8 {
	meta:
		aliases = "__do_global_ctors_aux"
		size = "41"
		objfiles = "crtend"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 A1 ?? ?? ?? ?? 83 F8 FF 74 12 31 DB FF D0 8B 83 ?? ?? ?? ?? 83 EB 04 83 F8 FF 75 F0 83 C4 04 5B 5D C3 }
	condition:
		$pattern
}

rule __fixsfdi_25c23da860f712f03242677b470f725e {
	meta:
		aliases = "__fixsfdi"
		size = "71"
		objfiles = "_fixsfdi@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 D9 45 08 D9 EE DD E9 DF E0 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 9E 77 12 D9 1C 24 E8 ?? ?? ?? ?? 83 C4 04 5B 5D C3 8D 74 26 00 D9 E0 D9 1C 24 E8 ?? ?? ?? ?? F7 D8 83 D2 00 83 C4 04 5B F7 DA 5D C3 }
	condition:
		$pattern
}

rule pthread_handle_sigcancel_d0ff31548d48d9d980992326da8b6759 {
	meta:
		aliases = "pthread_handle_sigcancel"
		size = "138"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 E8 ?? ?? ?? ?? 3D ?? ?? ?? ?? 75 09 8B 5D FC C9 E9 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 74 2C 3B 05 ?? ?? ?? ?? 75 16 50 68 00 00 00 80 6A 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 80 78 42 00 74 2E 80 78 40 00 75 28 80 78 41 01 75 0A 50 50 55 6A FF E8 ?? ?? ?? ?? 8B 50 28 85 D2 74 11 C7 40 28 00 00 00 00 50 50 6A 01 52 E8 ?? ?? ?? ?? 8B 5D FC C9 C3 }
	condition:
		$pattern
}

rule base_from_object_436e4fec7818aa21103cc635315980c8 {
	meta:
		aliases = "base_from_object"
		size = "93"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 3C FF 74 23 83 E0 70 83 F8 20 74 23 7E 15 83 F8 30 74 25 83 F8 50 74 0F 8D B6 00 00 00 00 E8 ?? ?? ?? ?? 85 C0 75 1A 83 C4 04 31 C0 5B 5D C3 8B 42 04 83 C4 04 5B 5D C3 8B 42 08 83 C4 04 5B 5D C3 83 F8 10 74 E1 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule base_of_encoded_value_318f51e5d8200f25449bd12b99bdc306 {
	meta:
		aliases = "base_of_encoded_value"
		size = "124"
		objfiles = "unwind_dw2@libgcc_eh.a, unwind_c@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 3C FF 74 25 83 E0 70 83 F8 20 74 42 7E 17 83 F8 40 74 25 83 F8 50 74 11 83 F8 30 8D 76 00 74 3C E8 ?? ?? ?? ?? 85 C0 75 08 83 C4 04 31 C0 5B 5D C3 83 F8 10 75 EA EB F1 89 14 24 8D 76 00 E8 ?? ?? ?? ?? 83 C4 04 5B 5D C3 90 8D 74 26 00 89 14 24 E8 ?? ?? ?? ?? 83 C4 04 5B 5D C3 89 14 24 E8 ?? ?? ?? ?? 83 C4 04 5B 5D C3 }
	condition:
		$pattern
}

rule size_of_encoded_value_aecd2408740172ee1ee3e5063633851b {
	meta:
		aliases = "size_of_encoded_value"
		size = "95"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 3C FF 74 45 83 E0 07 83 F8 02 74 32 7E 15 83 F8 03 74 14 83 F8 04 74 1A 8D B6 00 00 00 00 E8 ?? ?? ?? ?? 85 C0 75 F1 B8 04 00 00 00 83 C4 04 5B 5D C3 83 C4 04 B8 08 00 00 00 5B 5D C3 90 83 C4 04 B8 02 00 00 00 5B 5D C3 31 C0 EB DF }
	condition:
		$pattern
}

rule __register_frame_info_578c55de9e647177702a645ab3ee6212 {
	meta:
		aliases = "__register_frame_info_table, __register_frame_info"
		size = "58"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 14 8B 45 0C E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? C7 44 24 0C 00 00 00 00 C7 44 24 08 00 00 00 00 89 44 24 04 8B 45 08 89 04 24 E8 ?? ?? ?? ?? 83 C4 14 5B 5D C3 }
	condition:
		$pattern
}

rule __fixxfdi_3f9224ffc0d01be4c84ccb0a40936a33 {
	meta:
		aliases = "__fixxfdi"
		size = "71"
		objfiles = "_fixxfdi@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 14 DB 6D 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? D9 EE DD E9 DF E0 9E 77 12 DB 3C 24 E8 ?? ?? ?? ?? 83 C4 14 5B 5D C3 8D 74 26 00 D9 E0 DB 3C 24 E8 ?? ?? ?? ?? F7 D8 83 D2 00 83 C4 14 5B F7 DA 5D C3 }
	condition:
		$pattern
}

rule __fixdfdi_5748169a759913bbed5beffc41fbefe9 {
	meta:
		aliases = "__fixdfdi"
		size = "71"
		objfiles = "_fixdfdi@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 14 DD 45 08 D9 EE DD E9 DF E0 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 9E 77 12 DD 1C 24 E8 ?? ?? ?? ?? 83 C4 14 5B 5D C3 8D 74 26 00 D9 E0 DD 1C 24 E8 ?? ?? ?? ?? F7 D8 83 D2 00 83 C4 14 5B F7 DA 5D C3 }
	condition:
		$pattern
}

rule _Unwind_FindEnclosingFunction_ca9d8d63bd12824b64fd9cbdc75c0b99 {
	meta:
		aliases = "_Unwind_FindEnclosingFunction"
		size = "55"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 24 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 8D 45 F0 89 44 24 04 8B 45 08 83 E8 01 89 04 24 E8 ?? ?? ?? ?? 83 F8 01 19 C0 F7 D0 23 45 F8 83 C4 24 5B 5D C3 }
	condition:
		$pattern
}
...
rule __do_global_dtors_aux_87b9b68bec5731281800e0a031577e3e {
	meta:
		aliases = "__do_global_dtors_aux"
		size = "229"
		objfiles = "crtbeginS"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 04 80 BB ?? ?? ?? ?? 00 75 50 8B 93 ?? ?? ?? ?? 85 D2 74 1B 8B 83 ?? ?? ?? ?? 89 04 24 E8 ?? ?? ?? ?? EB 0B 83 C0 04 89 83 ?? ?? ?? ?? FF D2 8B 83 ?? ?? ?? ?? 8B 10 85 D2 75 E9 8B 83 ?? ?? ?? ?? 85 C0 74 0E 8D 83 ?? ?? ?? ?? 89 04 24 E8 ?? ?? ?? ?? C6 83 ?? ?? ?? ?? 01 83 C4 04 5B 5D C3 EB 0D 90 90 90 90 90 90 90 90 90 90 90 90 90 55 89 E5 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 14 8B 83 ?? ?? ?? ?? 85 C0 74 24 8D 83 ?? ?? ?? ?? 89 44 24 04 8D 83 ?? ?? ?? ?? 89 5C 24 0C C7 44 24 08 00 00 00 00 89 04 24 E8 ?? ?? ?? ?? 8B 8B ?? ?? ?? ?? 85 C9 }
	condition:
		$pattern
}

rule __deregister_frame_info_3df984c02446a0de75f8a7a0c176e725 {
	meta:
		aliases = "__deregister_frame_info"
		size = "35"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 04 8B 45 08 89 04 24 E8 ?? ?? ?? ?? 83 C4 04 5B 5D C3 }
	condition:
		$pattern
}

rule __gthread_mutex_unlock_8e32d675115a89f09922963dd96d399e {
	meta:
		aliases = "__gthread_mutex_lock, __gthread_mutex_unlock"
		size = "32"
		objfiles = "gthr_gnat@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 04 FF 93 ?? ?? ?? ?? 83 C4 04 31 C0 5B 5D C3 }
	condition:
		$pattern
}

rule frame_dummy_6780e58e3211dfd3962026fd1b53fe5b {
	meta:
		aliases = "frame_dummy"
		size = "101"
		objfiles = "crtbeginS"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 14 8B 83 ?? ?? ?? ?? 85 C0 74 24 8D 83 ?? ?? ?? ?? 89 44 24 04 8D 83 ?? ?? ?? ?? 89 5C 24 0C C7 44 24 08 00 00 00 00 89 04 24 E8 ?? ?? ?? ?? 8B 8B ?? ?? ?? ?? 85 C9 74 15 8B 93 ?? ?? ?? ?? 85 D2 74 0B 8D 83 ?? ?? ?? ?? 89 04 24 FF D2 83 C4 14 5B 5D C3 }
	condition:
		$pattern
}
...
rule __GI_execlp_2ad83139375d83666942187646d9e0ee {
	meta:
...
rule __divsc3_b17cfe0ee64fb2e15941f684a462d2da {
	meta:
		aliases = "__divsc3"
		size = "907"
		objfiles = "_divsc3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 83 EC 04 D9 45 10 D9 E1 D9 45 14 D9 E1 DA E9 DF E0 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 9E 76 42 D9 45 10 D8 75 14 D9 45 10 D8 C9 D8 45 14 D9 45 08 D8 CA D8 45 0C D8 F1 D9 45 0C DE CB D9 CA D8 65 08 DE F1 D9 C9 DD E0 DF E0 9E 7A 3D 75 3B D9 5D F4 8B 45 F4 D9 5D F4 8B 55 F4 83 C4 04 5B 5E 5D C3 D9 45 14 D8 75 10 D9 45 14 D8 C9 D8 45 10 D9 45 0C D8 CA D8 45 08 D8 F1 D9 CA D8 4D 08 D9 45 0C DE E1 DE F1 D9 C9 EB BC D9 C9 DD E0 DF E0 9E 7A 06 75 04 D9 C9 EB B6 D9 EE D9 45 10 DD E9 DF E0 9E 0F 85 D7 02 00 00 0F 8A D1 02 00 00 D9 45 14 DA E9 DF E0 9E 0F 84 7E 02 00 00 D9 45 08 D8 E0 DD E8 }
	condition:
		$pattern
}

rule __deregister_frame_info_bases_6753ee81183bc9e7803b4fd4e424cdb5 {
	meta:
		aliases = "__deregister_frame_info_bases"
		size = "171"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 83 EC 10 8B 55 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 85 D2 75 09 83 C4 10 31 C0 5B 5E 5D C3 8B 02 85 C0 74 F1 8B B3 ?? ?? ?? ?? 85 F6 74 2C 39 56 0C 8D 8B ?? ?? ?? ?? 75 17 8B 46 14 89 01 89 F0 83 C4 10 5B 5E 5D C3 8D 74 26 00 39 56 0C 74 E9 8D 4E 14 8B 76 14 85 F6 75 F1 8B B3 ?? ?? ?? ?? 85 F6 74 3D 8D 8B ?? ?? ?? ?? EB 13 8B 46 0C 39 10 74 1A 8B 46 14 85 C0 74 27 8D 4E 14 89 C6 F6 46 10 01 75 E7 39 56 0C 75 E9 90 EB AC 8B 46 14 89 01 8B 46 0C 89 04 24 E8 ?? ?? ?? ?? 89 F0 EB 9F E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __new_sem_wait_f66d2635fe26f853e6d82fa7fd13f39b {
	meta:
		aliases = "sem_wait, __new_sem_wait"
		size = "253"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 83 EC 10 E8 ?? ?? ?? ?? 8B 75 08 C7 45 F0 ?? ?? ?? ?? 89 75 EC 89 45 F4 89 F0 8B 55 F4 E8 ?? ?? ?? ?? 8B 46 08 85 C0 7E 15 83 EC 0C 48 89 46 08 56 E8 ?? ?? ?? ?? 83 C4 10 E9 B1 00 00 00 8B 45 F4 8D 55 EC C6 80 42 01 00 00 00 8B 45 F4 E8 ?? ?? ?? ?? 8B 45 F4 80 78 42 00 74 0E 8B 45 F4 BB 01 00 00 00 80 78 40 00 74 0D 8B 55 F4 8D 46 0C 31 DB E8 ?? ?? ?? ?? 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 DB 74 0C 8B 45 F4 31 D2 E8 ?? ?? ?? ?? EB 52 8B 45 F4 E8 ?? ?? ?? ?? 8B 45 F4 80 B8 42 01 00 00 00 75 15 8B 45 F4 80 B8 40 01 00 00 00 74 E0 8B 45 F4 80 78 40 00 75 D7 8B 45 F4 31 D2 E8 ?? }
	condition:
		$pattern
}

rule pthread_start_thread_bbf04a0d3715e1956fe89f0ca785c99b {
	meta:
		aliases = "pthread_start_thread"
		size = "177"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 83 EC 20 8B 75 08 E8 ?? ?? ?? ?? 89 46 14 8D 46 64 53 6A 00 50 6A 02 E8 ?? ?? ?? ?? 8B 56 6C 83 C4 10 85 D2 78 08 8D 46 70 51 50 52 EB 17 83 3D ?? ?? ?? ?? 00 7E 19 50 8D 45 F4 50 6A 00 C7 45 F4 00 00 00 00 FF 76 14 E8 ?? ?? ?? ?? 83 C4 10 A1 ?? ?? ?? ?? 85 C0 74 41 83 3D ?? ?? ?? ?? 00 7E 38 89 75 D8 8D 5D D8 C7 45 DC 05 00 00 00 50 6A 1C 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E1 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C FF 76 60 FF 56 5C 5B 5E 55 50 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule daemon_16df03de5a3b4c52a5644b1e19223d8d {
	meta:
		aliases = "daemon"
		size = "285"
		objfiles = "daemon@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 83 EC 60 E8 ?? ?? ?? ?? 83 F8 FF 0F 84 E9 00 00 00 85 C0 0F 84 EA 00 00 00 83 EC 0C 6A 00 E8 ?? ?? ?? ?? 83 7D 08 00 75 10 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 7D 0C 00 0F 85 BC 00 00 00 BB ?? ?? ?? ?? B9 02 00 00 00 8B 55 0C 89 D8 53 89 C3 B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0E E8 ?? ?? ?? ?? F7 DB 83 CE FF 89 18 EB 79 83 F8 FF 89 C6 74 72 50 50 8D 45 98 50 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 5F 8B 45 A8 25 00 F0 00 00 3D 00 20 00 00 75 36 50 50 6A 00 53 E8 ?? ?? ?? ?? 59 5E 6A 01 53 E8 ?? ?? ?? ?? 58 5A 6A 02 53 E8 ?? ?? ?? ?? 83 C4 10 83 FB 02 7E 3C }
	condition:
		$pattern
}

rule __pthread_cleanup_pop_restore_209f53a55b56508aac7e6cecd3595499 {
	meta:
		aliases = "_pthread_cleanup_pop_restore, __pthread_cleanup_pop_restore"
		size = "75"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 8B 5D 08 E8 ?? ?? ?? ?? 83 7D 0C 00 89 C6 74 0B 83 EC 0C FF 73 04 FF 13 83 C4 10 8B 43 0C 80 7E 42 00 89 46 3C 8B 43 08 88 46 41 74 12 66 81 7E 40 00 01 75 0A 51 51 55 6A FF E8 ?? ?? ?? ?? 8D 65 F8 5B 5E 5D C3 }
	condition:
		$pattern
}

rule __do_global_ctors_aux_2e60708120e5b2eb17a414f913c4f8c2 {
	meta:
		aliases = "__do_global_ctors_aux"
		size = "52"
		objfiles = "crtendS"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 8D 83 ?? ?? ?? ?? 8D 50 FC 8B 40 FC 83 F8 FF 74 0F 89 D6 FF D0 8B 46 FC 83 EE 04 83 F8 FF 75 F3 5B 5E 5D C3 }
	condition:
		$pattern
}

rule read_uleb128_6b1ba2eb7f30574936c35dbf8461dcf2 {
	meta:
		aliases = "read_uleb128"
		size = "63"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a, unwind_dw2@libgcc_eh.a, unwind_c@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 31 FF 56 31 F6 83 EC 08 89 45 F0 89 55 F4 8B 45 F0 89 F1 83 C6 07 0F B6 10 83 C0 01 89 45 F0 89 D0 83 E0 7F D3 E0 09 C7 84 D2 78 E2 8B 45 F4 89 38 8B 45 F0 83 C4 08 5E 5F 5D C3 }
	condition:
		$pattern
}

rule read_sleb128_608b251d0db12df7bf4a7797e59f50ee {
	meta:
		aliases = "read_sleb128"
		size = "97"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a, unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 31 FF 56 83 EC 0C 89 45 EC 89 55 F0 C7 45 F4 00 00 00 00 8B 45 EC 89 F9 83 C7 07 0F B6 10 83 C0 01 89 45 EC 0F B6 F2 89 F0 83 E0 7F D3 E0 09 45 F4 84 D2 78 DE 83 FF 1F 77 11 83 E6 40 74 0C B8 FF FF FF FF 89 F9 D3 E0 09 45 F4 8B 45 F0 8B 55 F4 89 10 8B 45 EC 83 C4 0C 5E 5F 5D C3 }
	condition:
		$pattern
}

rule byte_re_compile_fastmap_d52d008375828464e16edf9bff9637f5 {
	meta:
		aliases = "byte_re_compile_fastmap"
		size = "805"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 31 FF 56 89 C6 53 83 EC 5C 8B 1E 8D 4C 24 0F 8B 56 08 83 E1 F0 8B 40 10 89 4D F0 01 DA 89 55 E4 52 68 00 01 00 00 6A 00 50 89 45 E0 E8 ?? ?? ?? ?? 8A 46 1C 83 C4 10 C6 45 EA 01 C6 45 EB 00 C7 45 EC 05 00 00 00 0C 08 24 FE 88 46 1C 8B 45 E0 83 C0 0A 89 45 D8 3B 5D E4 74 06 8A 03 3C 01 75 28 85 FF 8A 56 1C 0F 84 93 02 00 00 88 D0 80 E2 FE 24 01 4F 08 45 EA 0A 55 EA 88 56 1C 8B 55 F0 8B 1C BA C6 45 EA 01 EB CD 43 3C 1D 0F 87 5C 02 00 00 0F B6 C0 FF 24 85 ?? ?? ?? ?? 31 D2 E9 CF 00 00 00 31 D2 E9 E9 00 00 00 80 4E 1C 01 E9 5D 02 00 00 0F B6 43 01 8B 4D E0 C6 04 01 01 E9 30 02 00 00 0F }
	condition:
		$pattern
}

rule execle_900f9665e55760501035516b93e04462 {
	meta:
		aliases = "__GI_execle, execle"
		size = "105"
		objfiles = "execle@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 31 F6 53 8D 45 10 83 EC 1C 89 45 F0 8B 55 F0 46 8D 42 04 89 45 F0 83 3A 00 75 F1 8D 04 B5 22 00 00 00 8B 7A 04 83 E0 F0 29 C4 8B 45 0C 8D 5C 24 0F 83 E3 F0 89 D9 89 03 8D 45 10 89 45 F0 8B 45 F0 83 C1 04 4E 8D 50 04 89 55 F0 8B 00 89 01 75 ED 50 57 53 FF 75 08 E8 ?? ?? ?? ?? 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _Unwind_RaiseException_91e958bc31a3a0f131baf0ae244a0ca6 {
	meta:
		aliases = "_Unwind_RaiseException"
		size = "360"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 52 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 8D 55 08 50 81 EC E4 01 00 00 8B 4D 04 8D 85 6C FF FF FF 89 85 28 FE FF FF E8 50 FB FF FF 8D 95 EC FE FF FF 89 95 20 FE FF FF C7 44 24 08 80 00 00 00 8B B5 28 FE FF FF 89 14 24 89 74 24 04 E8 ?? ?? ?? ?? 8D 85 2C FE FF FF 89 85 24 FE FF FF EB 58 85 C0 75 75 8B 8D D4 FE FF FF 85 C9 74 39 8B 95 20 FE FF FF 89 54 24 14 8B 75 08 89 74 24 10 8B 06 8B 56 04 C7 44 24 04 01 00 00 00 C7 04 24 01 00 00 00 89 44 24 08 89 54 24 0C FF D1 83 F8 06 74 47 83 F8 08 75 32 8B 95 24 FE FF FF 8B 85 20 FE FF FF E8 64 FD FF FF 8B 95 24 FE FF FF 8B 85 20 FE FF FF }
	condition:
		$pattern
}

rule glob_in_dir_41110cb6525fa231f769f5ca672d9116 {
	meta:
		aliases = "glob_in_dir"
		size = "1341"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 08 02 00 00 52 8B 75 08 89 95 08 FE FF FF 89 8D 04 FE FF FF 89 85 0C FE FF FF E8 ?? ?? ?? ?? 8B 9D 04 FE FF FF 83 C4 10 83 E3 40 89 85 10 FE FF FF 0F 94 C0 0F B6 C0 50 FF B5 0C FE FF FF E8 ?? ?? ?? ?? 5A 59 85 C0 0F 85 C5 00 00 00 F7 85 04 FE FF FF 10 08 00 00 0F 85 A9 00 00 00 85 DB 75 1A 50 50 6A 5C FF B5 0C FE FF FF E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 97 00 00 00 83 EC 0C FF B5 0C FE FF FF E8 ?? ?? ?? ?? 8B 95 10 FE FF FF 83 C4 10 89 C6 8D 44 10 20 83 E0 F0 29 C4 8D 5C 24 0F 57 83 E3 F0 52 FF B5 08 FE FF FF 53 E8 ?? ?? ?? ?? 83 C4 0C 8D 56 01 C6 00 2F 40 52 FF B5 0C }
	condition:
		$pattern
}

rule glob_6650dbf8b49f7d7a3e7142009347fe27 {
	meta:
		aliases = "__GI_glob, glob"
		size = "1348"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 0C 01 00 00 83 7D 08 00 8B 7D 14 74 0D 85 FF 74 09 F7 45 0C 00 81 FF FF 74 13 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 E9 05 05 00 00 8B 45 0C 83 E0 08 89 85 F4 FE FF FF 75 07 C7 47 08 00 00 00 00 50 50 6A 2F FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 3D F7 45 0C 00 50 00 00 0F 84 CF 00 00 00 8B 55 08 80 3A 7E 0F 85 C3 00 00 00 83 EC 0C 52 E8 ?? ?? ?? ?? 8B 5D 08 83 C4 10 C7 85 FC FE FF FF 00 00 00 00 89 85 00 FF FF FF E9 B7 00 00 00 3B 45 08 75 1E 8B 4D 08 BB ?? ?? ?? ?? C7 85 00 FF FF FF 01 00 00 00 41 89 8D FC FE FF FF E9 94 00 00 00 2B 45 08 89 85 00 FF FF FF }
	condition:
		$pattern
}

rule byte_re_match_2_internal_68b9266211ff8826af7efba157cdae81 {
	meta:
		aliases = "byte_re_match_2_internal"
		size = "6945"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 0C 01 00 00 89 85 4C FF FF FF 8B 00 8D 7C 24 0F 89 95 48 FF FF FF 8B 95 4C FF FF FF 83 E7 F0 89 8D 44 FF FF FF 8B 5D 18 89 7D D0 89 85 74 FF FF FF 8B 72 18 8B 4A 14 03 42 08 46 83 7A 18 00 89 85 78 FF FF FF 89 4D 80 89 75 84 75 41 C7 45 90 00 00 00 00 C7 45 94 00 00 00 00 C7 45 98 00 00 00 00 C7 45 9C 00 00 00 00 C7 45 A0 00 00 00 00 C7 45 A8 00 00 00 00 C7 45 AC 00 00 00 00 C7 45 B8 00 00 00 00 C7 45 BC 00 00 00 00 EB 79 8B 55 84 8D 04 95 1E 00 00 00 83 E0 F0 29 C4 8D 4C 24 0F 29 C4 8D 74 24 0F 29 C4 8D 7C 24 0F 29 C4 83 E1 F0 83 E6 F0 8D 54 24 0F 29 C4 89 4D 90 8D 4C }
	condition:
		$pattern
}

rule __GI_glob64_dcf006b5f62b97e9d73ac2bdb5a6b22a {
	meta:
		aliases = "glob64, __GI_glob64"
		size = "1351"
		objfiles = "glob64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 1C 01 00 00 83 7D 08 00 8B 7D 14 74 0D 85 FF 74 09 F7 45 0C 00 81 FF FF 74 13 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 E9 08 05 00 00 8B 45 0C 83 E0 08 89 85 E4 FE FF FF 75 07 C7 47 08 00 00 00 00 53 53 6A 2F FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 3D F7 45 0C 00 50 00 00 0F 84 CF 00 00 00 8B 55 08 80 3A 7E 0F 85 C3 00 00 00 83 EC 0C 52 E8 ?? ?? ?? ?? 8B 5D 08 83 C4 10 C7 85 EC FE FF FF 00 00 00 00 89 85 F0 FE FF FF E9 B7 00 00 00 3B 45 08 75 1E 8B 4D 08 BB ?? ?? ?? ?? C7 85 F0 FE FF FF 01 00 00 00 41 89 8D EC FE FF FF E9 94 00 00 00 2B 45 08 89 85 F0 FE FF FF }
	condition:
		$pattern
}

rule ruserpass_a571707067cdcb2b6231ef43f31c1578 {
	meta:
		aliases = "ruserpass"
		size = "862"
		objfiles = "ruserpass@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 6C 04 00 00 8B 7D 08 E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? ?? ?? 39 C3 0F 85 2E 03 00 00 E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? ?? ?? 39 C3 0F 85 1A 03 00 00 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 0F 84 00 03 00 00 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C0 26 83 E0 F0 29 C4 8D 5C 24 0F 50 83 E3 F0 50 56 53 E8 ?? ?? ?? ?? 59 5E 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 58 5A 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 A3 ?? ?? ?? ?? 75 22 E8 ?? ?? ?? ?? 31 D2 83 38 02 0F 84 A9 02 00 00 56 56 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E9 8D 02 00 00 51 51 6A 02 50 E8 ?? ?? ?? ?? 8D }
	condition:
		$pattern
}

rule gaih_inet_53b8ce7b5198c1d509a4b4f879f27bc8 {
	meta:
		aliases = "gaih_inet"
		size = "2422"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 9C 00 00 00 8B 55 10 8B 42 04 85 C0 74 0F 83 F8 0A C7 85 6C FF FF FF 00 00 00 00 75 16 8B 4D 10 8B 19 83 F3 08 C1 EB 03 F7 D3 83 E3 01 89 9D 6C FF FF FF 31 C0 8D 7D D0 AB AB AB AB 8B 75 10 8B 5E 0C 85 DB 75 30 83 7E 08 00 75 2A EB 4A 8B 7D 10 8B 4F 08 85 C9 74 07 0F BE 02 39 C1 75 12 85 DB 74 3A 0F BE 42 01 39 C3 74 32 F6 42 02 02 75 2C 83 C2 07 EB 05 BA ?? ?? ?? ?? 80 7A 03 00 75 CD 8B 55 10 B8 07 01 00 00 83 7A 08 00 0F 85 D3 08 00 00 E9 B7 08 00 00 BA ?? ?? ?? ?? 83 7D 0C 00 8D 45 D0 89 45 F0 0F 84 26 01 00 00 F6 42 02 01 0F 85 98 08 00 00 8B 4D 0C 83 79 04 00 0F 89 }
	condition:
		$pattern
}

rule search_object_c94781e7b55b99c9a8ecf7e2cd648e93 {
	meta:
		aliases = "search_object"
		size = "1769"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC AC 00 00 00 89 85 7C FF FF FF 89 95 78 FF FF FF 0F B6 50 10 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? F6 C2 01 0F 85 0C 02 00 00 8B 48 10 89 C8 C1 E8 0B 85 C0 89 45 80 0F 84 32 03 00 00 8B 45 80 85 C0 0F 84 D1 01 00 00 8B 7D 80 8D 34 BD 08 00 00 00 89 34 24 E8 ?? ?? ?? ?? 85 C0 89 85 68 FF FF FF 89 45 E4 0F 84 AE 01 00 00 C7 40 04 00 00 00 00 89 34 24 E8 ?? ?? ?? ?? 85 C0 89 85 64 FF FF FF 89 45 E8 74 07 C7 40 04 00 00 00 00 8B 85 7C FF FF FF F6 40 10 02 0F 84 75 03 00 00 8B 95 7C FF FF FF 8B 42 0C 8B 08 85 C9 74 1C 89 C6 8D 7D E4 8B 85 7C FF FF FF 89 FA E8 6B F9 FF FF 8B 4E 04 }
	condition:
		$pattern
}

rule clnt_create_801f5ae366c043c9fb0475b2b7ffe209 {
	meta:
		aliases = "clnt_create"
		size = "506"
		objfiles = "clnt_generic@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC C4 00 00 00 68 ?? ?? ?? ?? FF 75 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 50 51 6A 6E 6A 00 8D 9D 46 FF FF FF 53 E8 ?? ?? ?? ?? 58 8D 85 48 FF FF FF 5A 66 C7 85 46 FF FF FF 01 00 FF 75 08 50 E8 ?? ?? ?? ?? 5F C7 45 E8 FF FF FF FF 58 8D 45 E8 6A 00 6A 00 50 FF 75 10 FF 75 0C 53 E8 ?? ?? ?? ?? 83 C4 20 E9 82 01 00 00 81 EC 10 04 00 00 BB 00 04 00 00 8D 44 24 0F 83 E0 F0 EB 31 83 7D E4 FF 75 0A E8 ?? ?? ?? ?? 83 38 22 74 10 E8 ?? ?? ?? ?? C7 00 0D 00 00 00 E9 4C 01 00 00 01 DB 8D 43 1E 83 E0 F0 29 C4 8D 44 24 0F 83 E0 F0 56 56 8D 55 E4 52 8D 55 F0 52 53 50 8D 45 B4 50 FF 75 08 }
	condition:
		$pattern
}

rule glob_in_dir_8d8db79d0e1b8ee6a4307ef109441fd2 {
	meta:
		aliases = "glob_in_dir"
		size = "1268"
		objfiles = "glob64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC F8 00 00 00 52 8B 75 08 89 95 18 FF FF FF 89 8D 14 FF FF FF 89 85 1C FF FF FF E8 ?? ?? ?? ?? 8B 9D 14 FF FF FF 5A 59 83 E3 40 89 85 20 FF FF FF 0F 94 C0 0F B6 C0 50 FF B5 1C FF FF FF E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 C5 00 00 00 F7 85 14 FF FF FF 10 08 00 00 0F 85 A9 00 00 00 85 DB 75 1A 50 50 6A 5C FF B5 1C FF FF FF E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 97 00 00 00 83 EC 0C FF B5 1C FF FF FF E8 ?? ?? ?? ?? 8B 95 20 FF FF FF 83 C4 10 89 C6 8D 44 10 20 83 E0 F0 29 C4 8D 5C 24 0F 50 83 E3 F0 52 FF B5 18 FF FF FF 53 E8 ?? ?? ?? ?? 83 C4 0C 8D 56 01 C6 00 2F 40 52 FF B5 1C }
	condition:
		$pattern
}

rule sched_setaffinity_1734c8edd7a7bff69d74921c07e80805 {
	meta:
		aliases = "sched_setaffinity"
		size = "208"
		objfiles = "sched_setaffinity@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 0C 83 3D ?? ?? ?? ?? 00 75 69 81 EC 90 00 00 00 BF 80 00 00 00 8D 74 24 0F 83 E6 F0 EB 21 8D 0C 3F 8D 41 1E 83 E0 F0 29 C4 8D 54 24 0F 83 E2 F0 8D 04 0A 8D 1C 0F 39 F0 89 CF 89 D6 0F 44 FB E8 ?? ?? ?? ?? 89 F9 89 F2 53 89 C3 B8 F2 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 05 83 F8 EA 74 BD 85 DB 74 4F 81 FB 00 F0 FF FF 77 47 89 1D ?? ?? ?? ?? A1 ?? ?? ?? ?? EB 17 8B 55 10 80 3C 02 00 74 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 2D 40 3B 45 0C 72 E4 8B 45 08 8B 4D 0C 8B 55 10 53 89 C3 B8 F1 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF }
	condition:
		$pattern
}

rule nan_5a7dda608ca112ca8f433356ebe0156e {
	meta:
...
rule nanf_5d49632284b73e35308d550d70b3b7bb {
	meta:
...
rule pthread_sighandler_4bc335250700f46bb14d12c7e12df780 {
	meta:
		aliases = "pthread_sighandler"
		size = "96"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 0C E8 ?? ?? ?? ?? 8B 5D 08 80 78 58 00 89 C7 74 09 C6 40 58 00 89 58 20 EB 36 8B 70 54 85 F6 75 03 89 68 54 83 EC 5C 89 E2 51 51 6A 58 8D 45 0C 50 52 E8 ?? ?? ?? ?? 83 C4 14 53 FF 14 9D ?? ?? ?? ?? 83 C4 60 85 F6 75 07 C7 47 54 00 00 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule pthread_sighandler_rt_92fa3e159d24acbec4e677ae78176b73 {
	meta:
		aliases = "pthread_sighandler_rt"
		size = "81"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 0C E8 ?? ?? ?? ?? 8B 75 08 80 78 58 00 89 C7 74 09 C6 40 58 00 89 70 20 EB 27 8B 58 54 85 DB 75 03 89 68 54 50 FF 75 10 FF 75 0C 56 FF 14 B5 ?? ?? ?? ?? 83 C4 10 85 DB 75 07 C7 47 54 00 00 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule search_for_named_library_fc055d43bea00a5c1ec29dbbb58307a2 {
	meta:
		aliases = "search_for_named_library"
		size = "270"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C 85 C9 89 55 E8 89 CA 89 45 EC 0F 84 EB 00 00 00 8D 41 FF 40 80 38 00 75 FA 29 D0 4A 8D 70 01 8D 46 1E 83 E0 F0 29 C4 8D 5C 24 0F 81 EC 20 08 00 00 83 E3 F0 8D 44 24 0F 89 DF 83 E0 F0 8D 4B FF 89 45 E4 EB 07 42 41 8A 02 4E 88 01 85 F6 75 F5 8B 55 E4 89 D8 C7 45 F0 00 00 00 00 8D 72 FF 8B 55 EC 4A 89 55 E0 80 3F 00 75 0A C6 07 3A C7 45 F0 01 00 00 00 80 3F 3A 75 75 C6 07 00 80 38 00 74 11 89 F1 8D 50 FF 42 41 8A 02 84 C0 88 01 74 13 EB F4 89 F2 B9 ?? ?? ?? ?? 41 42 8A 01 84 C0 88 02 75 F6 89 F3 89 F0 40 80 38 00 75 FA 8D 50 FF B9 ?? ?? ?? ?? 41 42 8A 01 84 C0 88 02 75 }
	condition:
		$pattern
}

rule __getdents64_cf44e4daa96f6fe09905a75945607afe {
	meta:
		aliases = "__getdents64"
		size = "265"
		objfiles = "getdents64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C 8B 55 10 8D 42 1E 83 E0 F0 29 C4 8B 45 08 8D 4C 24 0F 83 E1 F0 53 89 C3 B8 DC 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0B E8 ?? ?? ?? ?? F7 DE 89 30 EB 64 83 C8 FF 83 FE FF 0F 84 B8 00 00 00 8B 7D 0C 8D 34 31 89 CB C7 45 E8 FF FF FF FF C7 45 EC FF FF FF FF 89 75 E4 01 FA 89 55 E0 E9 87 00 00 00 0F B7 43 10 8D 48 03 83 E1 FC 8D 34 0F 3B 75 E0 76 28 6A 00 FF 75 EC FF 75 E8 FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 3B 7D 0C 75 66 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 5B 8B 43 08 8B 53 0C 66 89 4F 10 89 45 E8 8B 03 89 55 EC 8B 53 04 89 07 89 57 04 8B 43 08 8B 53 0C 89 47 }
	condition:
		$pattern
}
...
rule sem_timedwait_2310d16814306c3907ba9e4c8244eebe {
	meta:
		aliases = "sem_timedwait"
		size = "368"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C E8 ?? ?? ?? ?? 8B 75 08 89 45 E0 89 C2 89 F0 E8 ?? ?? ?? ?? 8B 46 08 85 C0 7E 11 48 83 EC 0C 89 46 08 56 E8 ?? ?? ?? ?? 31 C0 EB 23 8B 45 0C 81 78 04 FF C9 9A 3B 76 1F 83 EC 0C 56 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF 83 C4 10 E9 08 01 00 00 8B 45 E0 8D 55 EC 89 75 EC C7 45 F0 ?? ?? ?? ?? C6 80 42 01 00 00 00 8B 45 E0 E8 ?? ?? ?? ?? 8B 45 E0 80 78 42 00 74 0B 80 78 40 00 BB 01 00 00 00 74 0D 8B 55 E0 8D 46 0C 31 DB E8 ?? ?? ?? ?? 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 DB 8D 7E 0C 74 0F 8B 45 E0 31 D2 E8 ?? ?? ?? ?? E9 9A 00 00 00 51 51 FF 75 0C FF }
	condition:
		$pattern
}

rule pthread_cond_wait_23bf3d9a4fb2a4b79231c0d944676059 {
	meta:
		aliases = "__GI_pthread_cond_wait, pthread_cond_wait"
		size = "315"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C E8 ?? ?? ?? ?? 8B 75 0C 8B 5D 08 89 45 F0 8B 46 0C 83 F8 03 74 15 85 C0 74 11 8B 45 F0 BA 16 00 00 00 39 46 08 0F 85 FD 00 00 00 8B 45 F0 8D 55 E8 89 5D E8 C7 45 EC ?? ?? ?? ?? C6 80 41 01 00 00 00 8B 45 F0 E8 ?? ?? ?? ?? 8B 55 F0 89 D8 E8 ?? ?? ?? ?? 8B 45 F0 80 78 42 00 74 0E 8B 45 F0 BF 01 00 00 00 80 78 40 00 74 0D 8B 55 F0 8D 43 08 31 FF E8 ?? ?? ?? ?? 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 FF 74 0E 8B 45 F0 31 D2 E8 ?? ?? ?? ?? 57 57 EB 6E 83 EC 0C 31 DB 56 E8 ?? ?? ?? ?? 83 C4 10 8B 45 F0 E8 ?? ?? ?? ?? 8B 45 F0 80 B8 41 01 00 00 00 75 18 8B 45 F0 80 B8 40 01 }
	condition:
		$pattern
}

rule pthread_cond_timedwait_c31272212682db29ae4d82054702161c {
	meta:
		aliases = "__GI_pthread_cond_timedwait, pthread_cond_timedwait"
		size = "428"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C E8 ?? ?? ?? ?? 8B 7D 0C 89 45 F0 8B 47 0C 83 F8 03 74 15 85 C0 74 11 8B 45 F0 BA 16 00 00 00 39 47 08 0F 85 71 01 00 00 8B 45 08 8D 55 E8 C7 45 EC ?? ?? ?? ?? 89 45 E8 8B 45 F0 C6 80 41 01 00 00 00 8B 45 F0 E8 ?? ?? ?? ?? 8B 45 08 8B 55 F0 E8 ?? ?? ?? ?? 8B 45 F0 80 78 42 00 74 0E 8B 45 F0 BB 01 00 00 00 80 78 40 00 74 10 8B 45 08 31 DB 8B 55 F0 83 C0 08 E8 ?? ?? ?? ?? 83 EC 0C FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 85 DB 74 11 8B 45 F0 31 D2 E8 ?? ?? ?? ?? 51 51 E9 D6 00 00 00 83 EC 0C 31 F6 57 E8 ?? ?? ?? ?? 8B 45 08 83 C4 10 83 C0 08 89 45 E0 52 8B 45 F0 52 FF 75 10 50 }
	condition:
		$pattern
}

rule if_nameindex_c5b4041c90fdef1dd44d934bbc55b8e5 {
	meta:
		aliases = "__GI_if_nameindex, if_nameindex"
		size = "425"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 2C E8 ?? ?? ?? ?? C7 45 DC 00 00 00 00 85 C0 89 C7 0F 88 7F 01 00 00 C7 45 F0 00 00 00 00 B9 80 00 00 00 8D 75 EC 8D 1C 09 8D 43 1E 83 E0 F0 29 C4 8D 44 24 0F 83 E0 F0 8D 14 18 3B 55 F0 89 45 F0 8D 0C 0B 50 56 0F 44 D9 68 12 89 00 00 57 89 5D EC E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 12 89 F9 87 CB B8 06 00 00 00 CD 80 87 CB E9 E6 00 00 00 8B 45 EC 39 D8 75 04 89 C1 EB AB C1 E8 05 83 EC 0C 89 45 D4 8D 04 C5 08 00 00 00 50 E8 ?? ?? ?? ?? 83 C4 10 C7 45 D8 00 00 00 00 85 C0 89 45 DC 0F 85 C1 00 00 00 89 F9 87 CB B8 06 00 00 00 CD 80 87 CB E8 ?? ?? ?? ?? C7 00 69 00 00 00 E9 D3 }
	condition:
		$pattern
}

rule pthread_initialize_27d909f8aae52279f1ccea336d5e25ec {
	meta:
		aliases = "pthread_initialize"
		size = "388"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 3C 83 3D ?? ?? ?? ?? 00 0F 85 66 01 00 00 8D 85 00 00 C0 FF 25 00 00 E0 FF A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 A3 ?? ?? ?? ?? EB 10 83 7B 34 01 74 07 C7 43 34 00 00 00 00 8B 5B 20 85 DB 75 EC 50 50 8D 7D E4 57 6A 03 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? BA 00 00 20 00 83 C4 10 01 C0 29 C2 39 55 E4 76 10 50 50 57 6A 03 89 55 E4 E8 ?? ?? ?? ?? 83 C4 10 8D 75 D0 89 D8 89 F7 AB AB AB AB AB 50 6A 00 56 FF 35 ?? ?? ?? ?? C7 45 D0 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5F C7 45 D0 ?? ?? ?? ?? 58 }
	condition:
		$pattern
}

rule pthread_join_94266a9b95133c140bc753567b91404a {
	meta:
		aliases = "pthread_join"
		size = "401"
		objfiles = "join@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 3C E8 ?? ?? ?? ?? 8B 7D 08 C7 45 EC ?? ?? ?? ?? 89 45 F0 89 F8 25 FF 03 00 00 8B 55 F0 C1 E0 04 8D 98 ?? ?? ?? ?? 89 D8 89 5D E8 E8 ?? ?? ?? ?? 8B 43 08 85 C0 89 45 C0 74 05 39 78 10 74 10 83 EC 0C 53 E8 ?? ?? ?? ?? B8 03 00 00 00 EB 35 8B 45 F0 39 45 C0 75 10 83 EC 0C 53 E8 ?? ?? ?? ?? B8 23 00 00 00 EB 1D 8B 55 C0 80 7A 2D 00 75 06 83 7A 38 00 74 16 83 EC 0C 53 E8 ?? ?? ?? ?? B8 16 00 00 00 83 C4 10 E9 F5 00 00 00 8B 45 C0 80 78 2C 00 0F 85 8E 00 00 00 8B 45 F0 8D 55 E8 E8 ?? ?? ?? ?? 8B 45 F0 80 78 42 00 74 0E 8B 45 F0 BE 01 00 00 00 80 78 40 00 74 0B 8B 45 F0 31 F6 }
	condition:
		$pattern
}

rule callrpc_13a00e4d965a503e4978b2b2818714f9 {
	meta:
		aliases = "callrpc"
		size = "537"
		objfiles = "clnt_simple@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 4C C7 45 B8 00 00 00 00 C7 45 BC 00 00 00 00 C7 45 B0 00 00 00 00 C7 45 B4 00 00 00 00 E8 ?? ?? ?? ?? 8B B0 A4 00 00 00 89 C3 85 F6 75 22 56 56 6A 18 6A 01 E8 ?? ?? ?? ?? 83 C4 10 89 C2 31 C0 85 D2 0F 84 C1 01 00 00 89 D6 89 93 A4 00 00 00 83 7E 14 00 75 1D 83 EC 0C 68 00 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 89 46 14 C6 00 00 C7 46 04 FF FF FF FF 83 7E 10 00 74 28 8B 45 0C 39 46 08 75 20 8B 55 10 39 56 0C 75 18 53 53 FF 75 08 FF 76 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 28 01 00 00 8B 46 04 C7 46 10 00 00 00 00 83 F8 FF 74 13 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 C7 46 04 FF }
	condition:
		$pattern
}

rule dlopen_19db8ed2639ab9af85207a8728ad5523 {
	meta:
		aliases = "dlopen"
		size = "1126"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 4C F6 45 0C 03 75 0F C7 05 ?? ?? ?? ?? 0A 00 00 00 E9 3E 04 00 00 80 3D ?? ?? ?? ?? 00 C7 45 F0 00 00 00 00 8B 7D 04 75 1B C6 05 ?? ?? ?? ?? 01 C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? 83 7D 08 00 75 0A A1 ?? ?? ?? ?? E9 02 04 00 00 E8 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? 31 F6 89 D8 EB 17 8B 08 8B 51 14 39 FA 73 0B 85 F6 74 05 39 56 14 73 02 89 CE 8B 40 10 85 C0 75 E5 89 5D F0 EB 03 89 45 F0 8B 45 F0 85 C0 89 45 C0 74 07 8B 40 10 85 C0 75 EC 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 55 0C C7 45 D0 02 00 00 00 C7 04 24 ?? ?? ?? ?? 83 E2 02 85 C0 0F 45 55 D0 }
	condition:
		$pattern
}

rule __msgwrite_861bc14afd127382423b3583eb1b0f7c {
	meta:
		aliases = "__msgwrite"
		size = "177"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 6C 89 55 BC 8D 5C 24 0F 89 4D B8 83 E3 F0 89 45 C0 8D 75 E0 E8 ?? ?? ?? ?? 8D 7B 0C 89 45 E0 E8 ?? ?? ?? ?? 89 45 E4 E8 ?? ?? ?? ?? 89 45 E8 A5 A5 A5 C7 43 04 01 00 00 00 C7 43 08 02 00 00 00 C7 03 18 00 00 00 8B 45 BC 89 5D D4 8D 5D C4 C7 45 D0 01 00 00 00 C7 45 C4 00 00 00 00 89 45 EC 8B 45 B8 C7 45 C8 00 00 00 00 C7 45 D8 18 00 00 00 C7 45 DC 00 00 00 00 89 45 F0 8D 45 EC 89 45 CC 50 6A 00 53 FF 75 C0 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0D E8 ?? ?? ?? ?? 83 38 04 74 E3 83 C8 FF 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule ruserok_ed5cbb9f55a69942df267d96c7ca0054 {
	meta:
		aliases = "ruserok"
		size = "164"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 BB 00 04 00 00 81 EC 3C 04 00 00 8D 44 24 0F 83 E0 F0 8D 7D E8 8D 75 F0 EB 21 83 7D E8 FF 75 73 E8 ?? ?? ?? ?? 83 38 22 75 69 01 DB 8D 43 1E 83 E0 F0 29 C4 8D 44 24 0F 83 E0 F0 52 52 57 56 53 50 8D 45 D4 50 FF 75 08 E8 ?? ?? ?? ?? 83 C4 20 85 C0 75 C6 8B 45 F0 85 C0 74 BF 8B 58 10 8D 75 EC EB 2A 51 6A 04 50 56 E8 ?? ?? ?? ?? 8B 4D 10 58 8B 45 EC 5A 8B 55 0C FF 75 08 FF 75 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0C 83 C3 04 8B 03 85 C0 75 D0 83 C8 FF 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule getrpcport_7491688fa4f248e21e9ad513bd936c9a {
	meta:
		aliases = "getrpcport"
		size = "163"
		objfiles = "getrpcport@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 BB 00 04 00 00 81 EC 4C 04 00 00 8D 44 24 0F 83 E0 F0 8D 7D EC 8D 75 F0 EB 21 83 7D EC FF 75 73 E8 ?? ?? ?? ?? 83 38 22 75 69 01 DB 8D 43 1E 83 E0 F0 29 C4 8D 44 24 0F 83 E0 F0 51 51 57 56 53 50 8D 45 C8 50 FF 75 08 E8 ?? ?? ?? ?? 83 C4 20 85 C0 75 C6 8B 45 F0 85 C0 74 BF 52 FF 70 0C 8D 5D DC 8B 40 10 FF 30 8D 45 E0 50 E8 ?? ?? ?? ?? FF 75 14 66 C7 45 DC 02 00 FF 75 10 66 C7 45 DE 00 00 FF 75 0C 53 E8 ?? ?? ?? ?? 83 C4 20 0F B7 C0 EB 02 31 C0 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule clntudp_call_d6ce5dfc1bd49f7025fe448d0269ed35 {
	meta:
		aliases = "clntudp_call"
		size = "1373"
		objfiles = "clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 BB E8 03 00 00 81 EC 4C 23 00 00 8B 45 08 8B 70 08 8B 4E 20 89 C8 99 F7 FB 89 C1 69 46 1C E8 03 00 00 01 C1 89 8D C8 DC FF FF 83 7E 28 FF 75 0E 8B 45 24 8B 55 20 89 85 D8 DC FF FF EB 0C 8B 46 28 89 85 D8 DC FF FF 8B 56 24 89 95 DC DC FF FF 8D 46 38 8D 56 08 C7 85 C4 DC FF FF 00 00 00 00 C7 85 CC DC FF FF 02 00 00 00 C7 85 D4 DC FF FF 00 00 00 00 C7 85 E0 DC FF FF 00 00 00 00 89 85 B4 DC FF FF 89 95 B0 DC FF FF 8B 85 B4 DC FF FF 83 7D 10 00 89 85 C0 DC FF FF 0F 84 E8 00 00 00 C7 46 38 00 00 00 00 57 57 8B 46 3C FF 76 50 FF B5 C0 DC FF FF FF 50 14 8B 46 58 FF 00 8D 45 0C 59 8B }
	condition:
		$pattern
}

rule _Unwind_Find_FDE_cd8981117448733ab76742bce87bb8b2 {
	meta:
		aliases = "_Unwind_Find_FDE"
		size = "275"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 1C 8B BB ?? ?? ?? ?? 85 FF 74 24 8B 45 08 3B 07 72 16 E9 C7 00 00 00 8D B6 00 00 00 00 8B 55 08 39 17 0F 86 B6 00 00 00 8B 7F 14 85 FF 75 EE 8D 83 ?? ?? ?? ?? 31 F6 89 45 DC 8D 76 00 8B BB ?? ?? ?? ?? 85 FF 0F 84 89 00 00 00 8B 47 14 8B 55 08 89 83 ?? ?? ?? ?? 89 F8 E8 9F F8 FF FF 8B 55 DC 89 C6 8B 83 ?? ?? ?? ?? 85 C0 74 16 8B 0F 39 08 73 06 EB 0E 39 08 72 0A 8D 50 14 8B 40 14 85 C0 75 F2 85 F6 89 47 14 89 3A 74 B1 8B 47 04 8B 55 0C 89 02 8B 47 08 89 42 04 0F B7 47 10 66 C1 E8 03 F6 47 10 04 0F B6 C0 75 48 0F B6 C0 89 FA 89 45 E0 E8 85 }
	condition:
		$pattern
}

rule uw_frame_state_for_68dea7984550548f840504801f8a8b39 {
	meta:
		aliases = "uw_frame_state_for"
		size = "837"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 4C 89 14 24 89 55 C4 89 45 C8 C7 44 24 08 C0 00 00 00 C7 44 24 04 00 00 00 00 E8 ?? ?? ?? ?? 8B 45 C8 8B 50 4C C7 40 68 00 00 00 00 C7 40 50 00 00 00 00 85 D2 0F 84 EB 02 00 00 8B 4D C8 83 C0 54 89 44 24 04 8B 41 60 C1 E8 1F 8D 44 02 FF 89 04 24 E8 ?? ?? ?? ?? 85 C0 89 45 D0 0F 84 C4 02 00 00 8B 55 C8 8B 4D C4 8B 42 5C 8B 55 D0 89 81 A4 00 00 00 8B 45 D0 8B 52 04 83 C0 04 29 D0 89 C7 83 C7 09 89 45 D4 89 3C 24 E8 ?? ?? ?? ?? 8B 4D D4 80 79 09 65 8D 14 38 8D 42 01 0F 84 F8 01 00 00 8B 55 C4 81 C2 B0 00 00 00 E8 5D F6 FF FF 8B 55 C4 81 C2 }
	condition:
		$pattern
}

rule _Unwind_Backtrace_6c07cdbac68ad998607069fde6188b63 {
	meta:
		aliases = "_Unwind_Backtrace"
		size = "163"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 81 EC 60 01 00 00 8B 4D 04 8D 85 78 FF FF FF 8D 55 08 89 85 AC FE FF FF E8 CE FC FF FF 8D 85 B8 FE FF FF 89 85 B0 FE FF FF 89 F6 8B 95 B0 FE FF FF 8B 85 AC FE FF FF E8 7F EF FF FF 85 C0 89 85 B4 FE FF FF 74 25 83 F8 05 74 20 C7 85 B4 FE FF FF 03 00 00 00 8B 85 B4 FE FF FF 81 C4 60 01 00 00 5E 5F 5D C3 8D B6 00 00 00 00 8B 45 0C 89 44 24 04 8B 85 AC FE FF FF 89 04 24 FF 55 08 85 C0 75 C9 83 BD B4 FE FF FF 05 74 CA 8B 95 B0 FE FF FF 8B 85 AC FE FF FF E8 EF FE FF FF EB 8D }
	condition:
		$pattern
}

rule __fixunsxfdi_dc06bb67fecb5c49c59f0f3907103fbe {
	meta:
		aliases = "__fixunsxfdi"
		size = "180"
		objfiles = "_fixunsxfdi@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 10 DB 6D 08 E8 ?? ?? ?? ?? 81 C1 ?? ?? ?? ?? D9 EE DD E9 DF E0 9E 0F 87 84 00 00 00 D9 7D F6 D9 C0 31 FF D8 89 ?? ?? ?? ?? 0F B7 45 F6 B4 0C 66 89 45 F4 D9 6D F4 DF 7D E8 D9 6D F6 8B 45 E8 89 C6 89 F7 BE 00 00 00 00 57 56 DF 2C 24 83 C4 08 85 FF 78 25 DE E9 D9 EE DD E9 DF E0 9E 77 22 D9 6D F4 DF 7D E8 D9 6D F6 31 D2 8B 45 E8 01 F0 11 FA 83 C4 10 5E 5F 5D C3 90 D8 81 ?? ?? ?? ?? EB D3 D9 E0 31 D2 D9 6D F4 DF 7D E8 D9 6D F6 8B 45 E8 29 C6 19 D7 89 F0 83 C4 10 89 FA 5E 5F 5D C3 DD D8 83 C4 10 31 C0 5E 31 D2 5F 5D C3 }
	condition:
		$pattern
}

rule frame_downheap_89c03d2a6b54fdb6dc9f35ae27c55a0b {
	meta:
...
rule frame_heapsort_eb59f56aa29f33eed4a9a07b6494ac05 {
	meta:
		aliases = "frame_heapsort"
		size = "154"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 20 89 4D E4 83 C1 08 89 45 EC 8B 45 E4 89 55 E8 89 4D F0 8B 40 04 89 45 F4 D1 E8 89 C6 83 EE 01 78 24 8D B4 26 00 00 00 00 8B 55 F4 8B 4D F0 8B 45 EC 89 34 24 89 54 24 04 8B 55 E8 E8 F8 FE FF FF 83 EE 01 79 E3 8B 7D F4 83 EF 01 85 FF 7E 3C 8B 4D F4 8B 45 E4 8D 74 88 08 8B 4D E4 8B 46 FC 8B 51 08 89 41 08 8B 4D F0 8B 45 EC 89 56 FC 8B 55 E8 83 EE 04 89 7C 24 04 83 EF 01 C7 04 24 00 00 00 00 E8 B1 FE FF FF 85 FF 7F CE 83 C4 20 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __udivdi3_47b31cc79d3dc49c9060d76e06ecf4a9 {
	meta:
		aliases = "__udivdi3"
		size = "326"
		objfiles = "_udivdi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 20 8B 45 10 8B 55 14 C7 45 E0 00 00 00 00 8B 75 0C C7 45 E4 00 00 00 00 89 45 F4 89 C1 8B 45 08 85 D2 89 D7 89 45 EC 75 23 39 F1 0F 86 98 00 00 00 89 F2 F7 F1 89 C1 31 C0 89 4D E0 89 45 E4 8B 45 E0 8B 55 E4 83 C4 20 5E 5F 5D C3 39 F2 0F 87 B5 00 00 00 0F BD C2 83 F0 1F 89 45 E8 0F 84 96 00 00 00 B8 20 00 00 00 8B 55 F4 2B 45 E8 89 C1 D3 EA 0F B6 4D E8 89 45 F0 89 F8 8B 7D F4 D3 E0 09 C2 8B 45 EC D3 E7 0F B6 4D F0 89 55 DC 89 F2 D3 E8 0F B6 4D E8 D3 E2 0F B6 4D F0 09 D0 D3 EE 89 F2 F7 75 DC 89 D1 89 75 D8 89 45 D8 F7 E7 39 D1 89 C6 72 7D 39 CA 74 6C 8B 4D D8 31 C0 E9 76 FF }
	condition:
		$pattern
}

rule fde_mixed_encoding_compare_a87e461d7b6bd53a3fa928208b957fd1 {
	meta:
		aliases = "fde_mixed_encoding_compare"
		size = "145"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 20 8B 55 0C 8B 45 0C 8B 7D 08 83 C0 04 2B 42 04 E8 64 F8 FF FF 89 FA 89 C6 81 E6 FF 00 00 00 89 F0 E8 B3 F6 FF FF 8B 4D 0C 8D 55 F4 89 14 24 83 C1 08 89 C2 89 F0 E8 FE F6 FF FF 8B 55 10 8B 45 10 83 C0 04 2B 42 04 E8 2D F8 FF FF 89 FA 89 C6 81 E6 FF 00 00 00 89 F0 E8 7C F6 FF FF 8B 4D 10 8D 55 F0 89 14 24 83 C1 08 89 C2 89 F0 E8 C7 F6 FF FF 8B 45 F0 BA 01 00 00 00 39 45 F4 77 02 19 D2 83 C4 20 89 D0 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fde_single_encoding_compare_f5c5a71317a3de328687579e0edda284 {
	meta:
		aliases = "fde_single_encoding_compare"
		size = "115"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 20 8B 75 08 0F B7 46 10 89 F2 66 C1 E8 03 0F B6 C0 E8 C3 FE FF FF 8B 4D 0C 8D 55 F4 83 C1 08 89 C7 0F B7 46 10 89 14 24 89 FA 66 C1 E8 03 0F B6 C0 E8 03 FF FF FF 0F B7 46 10 8D 55 F0 8B 4D 10 89 14 24 89 FA 66 C1 E8 03 83 C1 08 0F B6 C0 E8 E5 FE FF FF 8B 45 F0 BA 01 00 00 00 39 45 F4 77 02 19 D2 83 C4 20 89 D0 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __umoddi3_5b16f6b38cd52baef29fc273d1cabd32 {
	meta:
		aliases = "__umoddi3"
		size = "368"
		objfiles = "_umoddi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 30 8B 45 10 8B 55 14 8B 75 08 8B 7D 0C 89 45 EC 89 C1 89 55 E8 8B 45 E8 C7 45 D0 00 00 00 00 C7 45 D4 00 00 00 00 89 FA 89 75 E4 85 C0 89 75 F0 89 7D E0 75 14 39 F9 76 60 89 F0 F7 F1 89 55 D0 C7 45 D4 00 00 00 00 EB 10 8B 4D E0 39 4D E8 76 18 89 75 D0 89 7D D4 89 F6 8B 45 D0 8B 55 D4 83 C4 30 5E 5F 5D C3 8D 76 00 0F BD 45 E8 83 F0 1F 89 45 D8 75 46 8B 45 E8 39 45 E0 0F 87 C9 00 00 00 8B 4D EC 39 4D E4 0F 83 BD 00 00 00 8B 4D F0 89 55 D4 89 4D D0 EB C1 90 8B 45 EC 85 C0 75 0C B8 01 00 00 00 31 D2 F7 75 EC 89 C1 8B 45 E0 8B 55 E8 F7 F1 8B 45 E4 F7 F1 EB 82 B8 20 00 00 00 8B }
	condition:
		$pattern
}

rule __divdi3_968db3fb8313c561db165566ca22df7f {
	meta:
		aliases = "__divdi3"
		size = "391"
		objfiles = "_divdi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 30 8B 55 0C 8B 45 08 8B 75 10 8B 7D 14 89 55 DC 8B 4D DC 89 45 D8 C7 45 D0 00 00 00 00 89 F0 C7 45 D4 00 00 00 00 89 FA 85 C9 C7 45 E4 00 00 00 00 0F 88 A4 00 00 00 85 FF 0F 88 BA 00 00 00 89 D7 89 C6 8B 55 D8 89 C1 8B 45 DC 85 FF 89 55 F0 89 45 EC 75 14 39 C6 76 41 89 D0 8B 55 EC F7 F6 89 C1 31 C0 EB 13 8D 76 00 3B 7D EC 76 4F 31 C9 31 C0 8D B4 26 00 00 00 00 89 4D D0 8B 4D E4 89 45 D4 8B 45 D0 8B 55 D4 85 C9 74 07 F7 D8 83 D2 00 F7 DA 83 C4 30 5E 5F 5D C3 85 F6 75 0B B8 01 00 00 00 31 D2 F7 F6 89 C1 8B 45 EC 89 FA F7 F1 89 C6 8B 45 F0 F7 F1 89 C1 89 F0 EB BC 0F BD C7 83 }
	condition:
		$pattern
}

rule __udivmoddi4_8edfc9ce5a1835407870977a243a1557 {
	meta:
		aliases = "__udivmoddi4"
		size = "545"
		objfiles = "_udivmoddi4@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 48 8B 55 14 8B 75 08 8B 7D 0C 8B 45 10 85 D2 C7 45 C0 00 00 00 00 C7 45 C4 00 00 00 00 C7 45 B8 00 00 00 00 C7 45 BC 00 00 00 00 89 45 C8 89 45 D8 89 55 B4 89 75 CC 89 75 E8 89 7D D0 89 7D DC 75 3D 39 F8 0F 86 C1 00 00 00 89 F0 89 FA 31 F6 F7 75 C8 89 D7 89 C1 83 7D 18 00 89 CA 89 F0 74 48 89 7D C0 8B 7D 18 8B 45 C0 C7 45 C4 00 00 00 00 8B 55 C4 89 07 89 F0 89 57 04 89 CA EB 2A 8B 45 D0 39 45 B4 76 35 8B 4D 18 31 D2 31 C0 85 C9 74 17 89 75 C0 8B 75 18 8B 55 C0 89 7D C4 8B 4D C4 89 16 31 D2 89 4E 04 90 89 55 B8 89 45 BC 8B 45 B8 8B 55 BC 83 C4 48 5E 5F 5D C3 0F BD 45 B4 83 }
	condition:
		$pattern
}

rule __moddi3_101b8d898e73d8a8dfc15a2fc0dd152f {
	meta:
		aliases = "__moddi3"
		size = "509"
		objfiles = "_moddi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 58 8B 4D 0C 8B 55 14 8B 45 10 C7 45 B0 00 00 00 00 85 C9 89 55 AC 8B 55 08 89 45 A8 8B 7D AC C7 45 B4 00 00 00 00 8B 75 A8 C7 45 BC 00 00 00 00 0F 88 F3 00 00 00 8B 45 AC 85 C0 0F 88 CF 00 00 00 8D 45 F0 85 FF 89 75 D8 89 75 CC 89 CE 89 45 C0 89 55 D4 89 55 DC 89 4D C8 75 2D 39 4D D8 0F 86 85 00 00 00 89 D0 89 CA F7 75 D8 89 55 B0 C7 45 B4 00 00 00 00 8B 75 C0 8B 55 B0 8B 4D B4 89 16 89 4E 04 EB 19 8D 76 00 39 CF 76 30 89 55 B0 8B 45 B0 89 4D B4 8B 55 B4 89 45 F0 89 55 F4 8B 45 BC 85 C0 74 0A F7 5D F0 83 55 F4 00 F7 5D F4 8B 45 F0 8B 55 F4 83 C4 58 5E 5F 5D C3 0F BD C7 83 }
	condition:
		$pattern
}

rule get_cie_encoding_22784b074d7b057cce273dedf5eb554a {
	meta:
		aliases = "get_cie_encoding"
		size = "184"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 89 C6 53 83 EC 1C E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 80 78 09 7A 74 0A 83 C4 1C 31 C0 5B 5E 5F 5D C3 8D 78 09 89 3C 24 E8 ?? ?? ?? ?? 8D 44 07 01 8D 7D EC 89 FA E8 F1 FB FF FF 8D 55 E8 E8 29 FC FF FF 80 7E 08 01 74 66 89 FA E8 DC FB FF FF 89 FA E8 D5 FB FF FF 0F B6 56 0A 80 FA 52 74 44 83 C6 0A 8D 7D F0 EB 18 8D 74 26 00 80 FA 4C 75 A7 0F B6 56 01 83 C0 01 83 C6 01 80 FA 52 74 24 80 FA 50 75 E7 8D 48 01 0F B6 00 31 D2 89 3C 24 83 E0 7F E8 24 FE FF FF 0F B6 56 01 83 C6 01 80 FA 52 75 DC 0F B6 00 83 C4 1C 5B 5E 5F 5D C3 83 C0 01 EB 9C }
	condition:
		$pattern
}

rule link_exists_p_5f41859fa9a7313d672c8e1e0e685d60 {
	meta:
		aliases = "link_exists_p"
		size = "150"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 89 CE 53 89 D3 81 EC C8 00 00 00 51 89 85 3C FF FF FF E8 ?? ?? ?? ?? 83 C4 10 89 85 40 FF FF FF 8D 44 18 20 83 E0 F0 29 C4 8D 7C 24 0F 50 83 E7 F0 53 FF B5 3C FF FF FF 57 E8 ?? ?? ?? ?? 83 C4 0C C6 00 2F 40 8B 95 40 FF FF FF 42 52 56 50 E8 ?? ?? ?? ?? 83 C4 10 F7 45 0C 00 02 00 00 74 0F 50 50 8D 45 9C 50 8B 45 08 57 FF 50 20 EB 0F 56 56 8D 85 44 FF FF FF 50 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 94 C0 8D 65 F4 0F B6 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule link_exists_p_bfbf4e2e6b259878b81b94048954ca39 {
	meta:
		aliases = "link_exists_p"
		size = "150"
		objfiles = "glob64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 89 CE 53 89 D3 81 EC D8 00 00 00 51 89 85 2C FF FF FF E8 ?? ?? ?? ?? 83 C4 10 89 85 30 FF FF FF 8D 44 18 20 83 E0 F0 29 C4 8D 7C 24 0F 50 83 E7 F0 53 FF B5 2C FF FF FF 57 E8 ?? ?? ?? ?? 83 C4 0C C6 00 2F 40 8B 95 30 FF FF FF 42 52 56 50 E8 ?? ?? ?? ?? 83 C4 10 F7 45 0C 00 02 00 00 74 0F 51 51 8D 45 94 50 8B 45 08 57 FF 50 20 EB 0F 52 52 8D 85 34 FF FF FF 50 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 94 C0 8D 65 F4 0F B6 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __gcc_bcmp_dc9a6ad5fe5c3bc9114491242ca04739 {
	meta:
		aliases = "__gcc_bcmp"
		size = "79"
		objfiles = "__gcc_bcmp@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 8B 55 10 8B 7D 0C 85 D2 74 2A 8B 45 08 31 F6 0F B6 08 0F B6 07 38 C1 74 16 EB 21 8B 45 08 0F B6 4C 06 01 0F B6 44 3E 01 83 C6 01 38 C1 75 0D 83 EA 01 75 E7 5E 31 D2 5F 89 D0 5D C3 0F B6 C0 0F B6 D1 5E 29 C2 5F 89 D0 5D C3 }
	condition:
		$pattern
}

rule rcmd_1794cd557d2144a1e5d78dfab8958550 {
	meta:
		aliases = "rcmd"
		size = "1181"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 BE 00 04 00 00 53 83 EC 7C 0F B7 45 0C 8D 7D E8 89 45 84 E8 ?? ?? ?? ?? 81 EC 10 04 00 00 89 45 8C 8D 44 24 0F 83 E0 F0 EB 3C 8B 5D EC 83 FB FF 75 0A E8 ?? ?? ?? ?? 83 38 22 74 19 E8 ?? ?? ?? ?? 83 EC 0C 89 18 8B 55 08 FF 32 E8 ?? ?? ?? ?? E9 2E 04 00 00 01 F6 8D 46 1E 83 E0 F0 29 C4 8D 44 24 0F 83 E0 F0 52 52 8D 55 EC 52 57 56 50 8D 45 94 50 8B 45 08 FF 30 E8 ?? ?? ?? ?? 83 C4 20 85 C0 75 A6 83 7D E8 00 74 A0 8B 45 E8 83 EC 0C BF 01 00 00 00 66 C7 45 AC 01 00 8B 55 08 66 C7 45 B4 01 00 8B 00 89 02 68 00 00 40 00 E8 ?? ?? ?? ?? C7 45 E4 FF 03 00 00 89 45 88 83 C4 10 83 EC 0C 8D }
	condition:
		$pattern
}

rule gaih_inet_serv_a1358bd00043cd81893252ab8f9b5829 {
	meta:
		aliases = "gaih_inet_serv"
		size = "147"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 BE 00 04 00 00 53 89 D3 83 EC 2C 8B 7D 08 89 45 D0 89 4D CC 8D 46 1E 83 E0 F0 29 C4 8D 44 24 0F 52 83 E0 F0 52 8D 55 F0 52 56 50 8D 45 E0 50 8D 43 03 50 FF 75 D0 E8 ?? ?? ?? ?? 83 C4 20 85 C0 75 08 83 7D F0 00 75 0B EB 37 83 F8 22 75 32 01 F6 EB C1 C7 07 00 00 00 00 0F BE 03 89 47 04 F6 43 02 02 74 08 8B 55 CC 8B 42 0C EB 04 0F BE 43 01 89 47 08 8B 45 F0 8B 40 08 89 47 0C 31 C0 EB 05 B8 08 01 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule execute_stack_op_9785c44f4a2ad8f1c49ce80d8f133e28 {
	meta:
		aliases = "execute_stack_op"
		size = "1496"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 C7 56 53 81 EC 4C 01 00 00 8B 45 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 39 D7 89 95 C4 FE FF FF 89 8D C0 FE FF FF 89 85 E0 FE FF FF 0F 83 9B 05 00 00 8D 45 E8 C7 85 C8 FE FF FF 01 00 00 00 89 85 BC FE FF FF 8D B4 26 00 00 00 00 0F B6 0F 83 C7 01 8D 41 FD 0F B6 F1 3C 93 76 05 E8 ?? ?? ?? ?? 0F B6 C0 8B 84 83 ?? ?? ?? ?? 01 D8 FF E0 8B 07 83 C7 04 89 45 F0 90 8D 74 26 00 83 BD C8 FE FF FF 3F 77 D7 8B 95 C8 FE FF FF 8B 45 F0 89 84 95 E0 FE FF FF 83 C2 01 89 95 C8 FE FF FF 39 BD C4 FE FF FF 77 A6 8B 85 C8 FE FF FF 85 C0 74 AC 8B 85 C8 FE FF FF 83 E8 01 8B 84 85 E0 FE FF FF 81 C4 4C 01 }
	condition:
		$pattern
}

rule execute_cfa_program_71814a8e50a608a141ce3b1ec9de8512 {
	meta:
		aliases = "execute_cfa_program"
		size = "1316"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 C7 56 53 83 EC 3C 8B 45 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 39 D7 89 55 D8 89 4D D4 C7 80 90 00 00 00 00 00 00 00 0F 83 8D 00 00 00 8B B0 A4 00 00 00 8B 41 60 C1 E8 1F 03 41 4C 39 F0 76 7A 8D 55 F0 C7 45 E0 00 00 00 00 89 55 D0 0F B6 0F 83 C7 01 0F B6 C1 89 C2 81 E2 C0 00 00 00 83 FA 40 74 1E 81 FA 80 00 00 00 74 77 81 FA C0 00 00 00 74 5A 80 F9 2F 76 4A 8D 74 26 00 E8 ?? ?? ?? ?? 8B 4D 08 83 E0 3F 0F AF 81 B0 00 00 00 8D 04 06 89 81 A4 00 00 00 90 8D 74 26 00 39 7D D8 76 19 8B 45 08 8B 55 D4 8B B0 A4 00 00 00 8B 42 60 C1 E8 1F 03 42 4C 39 C6 72 93 8D 65 F4 5B 5E 5F 5D C3 8B 84 }
	condition:
		$pattern
}

rule uw_update_context_1_56a0a9a6c3fec96c6472c629ede13128 {
	meta:
		aliases = "uw_update_context_1"
		size = "782"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 C7 56 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 8D 85 6C FF FF FF 81 EC AC 00 00 00 89 95 5C FF FF FF 89 85 58 FF FF FF C7 44 24 08 80 00 00 00 89 7C 24 04 89 04 24 E8 ?? ?? ?? ?? F6 45 CF 40 74 40 80 7D DC 00 8D 85 7C FF FF FF 74 34 85 C0 74 3A F6 47 63 40 74 04 C6 47 70 00 8B 95 5C FF FF FF C7 47 10 00 00 00 00 8B 82 A0 00 00 00 83 F8 01 74 42 83 F8 02 0F 84 34 02 00 00 E8 ?? ?? ?? ?? 8B 85 7C FF FF FF 85 C0 75 C6 80 BB ?? ?? ?? ?? 04 8B 47 48 75 E5 F6 45 CF 40 89 45 F0 74 04 C6 45 DC 00 8D 55 F0 B8 04 00 00 00 89 94 85 6C FF FF FF EB 9C 8B 8D 5C FF FF FF 8B 91 98 00 00 00 83 FA 11 }
	condition:
		$pattern
}

rule pthread_cleanup_upto_1aa34e4af1bf4e4e9e46fe9984e5a2da {
	meta:
		aliases = "pthread_cleanup_upto"
		size = "146"
		objfiles = "ptlongjmp@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 C7 56 89 E8 53 BE ?? ?? ?? ?? 83 EC 0C 3B 2D ?? ?? ?? ?? 73 32 3B 2D ?? ?? ?? ?? 72 0D 3B 2D ?? ?? ?? ?? BE ?? ?? ?? ?? 72 1D 83 3D ?? ?? ?? ?? 00 74 09 E8 ?? ?? ?? ?? 89 C6 EB 0B 0D FF FF 1F 00 8D B0 A1 FE FF FF 8B 5E 3C 89 6D F0 EB 17 3B 5D F0 77 04 31 DB EB 17 83 EC 0C FF 73 04 FF 13 8B 5B 0C 83 C4 10 85 DB 74 05 3B 5F 10 72 E0 8B 46 54 89 5E 3C 85 C0 74 0C 3B 47 10 73 07 C7 46 54 00 00 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule add_fdes_48a2a48641d87e5f8237f0d6c52f9321 {
	meta:
		aliases = "add_fdes"
		size = "266"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 CF 56 83 EC 30 89 55 D4 89 C2 89 45 D8 0F B7 40 10 66 C1 E8 03 0F B6 C0 89 45 E0 E8 EB FB FF FF 89 45 E4 8B 07 85 C0 0F 84 D1 00 00 00 8D 45 F4 C7 45 DC 00 00 00 00 89 45 D0 EB 31 8B 47 08 85 C0 74 18 8B 45 D4 8B 10 85 D2 74 0F 8B 42 04 89 7C 82 08 83 C0 01 89 42 04 89 F6 89 F8 03 07 8B 70 04 8D 78 04 85 F6 0F 84 91 00 00 00 8B 47 04 85 C0 74 E7 8B 55 D8 F6 42 10 04 74 26 8D 77 04 29 C6 39 75 DC 74 1C 89 F0 E8 1D FD FF FF 8B 55 D8 89 45 E0 0F B6 45 E0 E8 6E FB FF FF 89 75 DC 89 45 E4 8B 45 E0 85 C0 74 92 0F B6 75 E0 8D 4F 08 8B 45 D0 8B 55 E4 89 04 24 89 F0 E8 AA FB FF FF 89 F0 }
	condition:
		$pattern
}

rule uw_install_context_1_4b3f5dfc295c30a4f2c23e595bbc3167 {
	meta:
		aliases = "uw_install_context_1"
		size = "329"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 D7 56 53 83 EC 2C E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? F6 42 63 40 89 45 E0 0F 84 AF 00 00 00 80 7A 70 00 8D 42 10 0F 84 A2 00 00 00 85 C0 0F 84 E8 00 00 00 8D 83 ?? ?? ?? ?? BE 01 00 00 00 89 45 DC EB 30 84 C0 74 24 85 C9 74 20 39 D1 74 1C 8B 45 DC 0F B6 44 06 FF 89 4C 24 04 89 14 24 89 44 24 08 E8 ?? ?? ?? ?? 8D 74 26 00 83 C6 01 83 FE 12 74 3D 8B 45 E0 8B 4C B7 FC 80 7C 06 6B 00 8B 54 B0 FC 0F 85 8D 00 00 00 85 D2 0F 95 C0 80 7C 3E 6B 00 74 AE 84 C0 74 D2 8B 45 DC 80 7C 06 FF 04 75 73 83 C6 01 83 FE 12 89 4D EC 89 0A 75 C3 8B 55 E0 F6 42 63 40 75 1C 8B 45 E0 8B 50 10 31 C0 85 D2 }
	condition:
		$pattern
}

rule _Unwind_RaiseException_Phase2_cc4d64d0987c306d7f7ddf9e167c704f {
	meta:
		aliases = "_Unwind_RaiseException_Phase2"
		size = "188"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 D7 56 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 81 EC EC 00 00 00 89 85 2C FF FF FF 8D 85 30 FF FF FF 89 85 28 FF FF FF EB 54 8D 76 00 8B 4D D8 85 C9 74 39 8B 85 2C FF FF FF 89 7C 24 14 89 44 24 10 89 C2 8B 00 8B 52 04 C7 04 24 01 00 00 00 89 44 24 08 89 F0 83 C8 02 89 54 24 0C 89 44 24 04 FF D1 83 F8 07 74 41 83 F8 08 75 37 85 F6 75 43 8B 95 28 FF FF FF 89 F8 E8 5F FE FF FF 8B 95 28 FF FF FF 89 F8 E8 82 EE FF FF 8B 8D 2C FF FF FF 8B 57 4C 3B 51 10 0F 94 C2 0F B6 F2 C1 E6 02 85 C0 74 89 B8 02 00 00 00 81 C4 EC 00 00 00 5B 5E 5F 5D C3 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule _Unwind_ForcedUnwind_Phase2_2edaeffdadc8813ef556346c77740871 {
	meta:
		aliases = "_Unwind_ForcedUnwind_Phase2"
		size = "255"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 D7 56 81 EC 00 01 00 00 89 85 2C FF FF FF 8B 95 2C FF FF FF 8D B5 38 FF FF FF 8B 40 0C 89 B5 28 FF FF FF 8B 52 10 89 85 30 FF FF FF 89 95 34 FF FF FF 8B 95 28 FF FF FF 89 F8 E8 9C EC FF FF B9 0A 00 00 00 85 C0 89 C6 74 18 83 F8 05 74 11 BE 02 00 00 00 81 C4 00 01 00 00 89 F0 5E 5F 5D C3 B1 1A 8B 95 2C FF FF FF 8B 85 34 FF FF FF 89 7C 24 14 89 54 24 10 89 44 24 18 8B 02 8B 52 04 89 4C 24 04 C7 04 24 01 00 00 00 89 44 24 08 89 54 24 0C FF 95 30 FF FF FF 85 C0 75 B3 83 FE 05 74 B3 8B 4D E0 85 C9 74 40 8B B5 2C FF FF FF 89 7C 24 14 89 74 24 10 8B 06 8B 56 04 C7 44 24 04 0A 00 00 00 }
	condition:
		$pattern
}

rule classify_object_over_fdes_9063e8aff9400f5ebb3ce95d00d35083 {
	meta:
		aliases = "classify_object_over_fdes"
		size = "310"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 D7 56 83 EC 40 89 45 CC 8B 02 C7 45 D8 00 00 00 00 85 C0 0F 84 EE 00 00 00 8D 45 F4 C7 45 D4 00 00 00 00 C7 45 DC 00 00 00 00 C7 45 E0 00 00 00 00 89 45 C8 E9 B0 00 00 00 89 F6 89 F0 E8 59 FC FF FF 8B 55 CC 0F B6 C8 89 45 DC 88 45 D3 89 C8 89 4D E4 E8 A3 FA FF FF 8B 55 CC 89 45 E0 0F B7 42 10 66 25 F8 07 66 3D F8 07 0F 84 A1 00 00 00 8B 55 CC 0F B7 42 10 89 75 D4 66 C1 E8 03 0F B6 C0 39 45 DC 74 07 80 4A 10 04 89 75 D4 8B 45 C8 8D 4F 08 8B 55 E0 89 04 24 8B 45 E4 E8 BA FA FF FF 8B 45 E4 E8 B2 FC FF FF B9 FF FF FF FF 83 F8 03 77 11 8D 0C C5 00 00 00 00 B8 01 00 00 00 D3 E0 8D 48 }
	condition:
		$pattern
}

rule linear_search_fdes_3f575eb4d28de7a33095c97ac889b269 {
	meta:
		aliases = "linear_search_fdes"
		size = "290"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 D7 56 89 C2 83 EC 30 89 4D D4 89 45 D8 0F B7 40 10 66 C1 E8 03 0F B6 C0 89 45 E0 E8 1B FD FF FF 8B 0F 85 C9 89 45 E4 0F 84 E5 00 00 00 8D 45 F4 C7 45 DC 00 00 00 00 89 45 D0 EB 31 8B 57 08 89 55 F4 8B 47 0C 85 D2 89 45 F0 74 0F 8B 45 D4 2B 45 F4 3B 45 F0 0F 82 B9 00 00 00 89 F8 03 07 8D 78 04 8B 40 04 85 C0 0F 84 A5 00 00 00 8B 47 04 85 C0 74 E7 8B 55 D8 F6 42 10 04 74 26 8D 77 04 29 C6 39 75 DC 74 1C 89 F0 E8 4D FE FF FF 8B 55 D8 89 45 E0 0F B6 45 E0 E8 9E FC FF FF 89 75 DC 89 45 E4 8B 55 E0 85 D2 74 92 0F B6 75 E0 8D 4F 08 8B 45 D0 8B 55 E4 89 04 24 89 F0 E8 DA FC FF FF 8D 55 }
	condition:
		$pattern
}

rule __udiv_w_sdiv_e3f88eb12fa732a23c90a03cde66cde0 {
	meta:
		aliases = "__udiv_w_sdiv"
		size = "7"
		objfiles = "_udiv_w_sdiv@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 5D 31 C0 C3 }
	condition:
		$pattern
}
...
rule __gnat_default_lock_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__enable_execute_stack, __gnat_default_unlock, __gcov_flush, __gcov_merge_add, __gcov_merge_single, __gcov_merge_delta, __clear_cache, __gcov_init, __gnat_default_lock"
		size = "5"
		objfiles = "_gcov_merge_delta@libgcov.a, _gcov_merge_add@libgcov.a, _gcov@libgcov.a, _enable_execute_stack@libgcc.a, _gcov_merge_single@libgcov.a"
	strings:
...
rule _Unwind_Resume_or_Rethrow_ea31a7bcc96767ac69311f548d000255 {
	meta:
		aliases = "_Unwind_Resume_or_Rethrow"
		size = "214"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 81 EC 28 01 00 00 89 45 EC 8B 45 08 89 5D F4 89 55 F0 89 75 F8 89 7D FC 8B 40 0C E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 85 C0 74 5B 8B 4D 04 8D 85 6C FF FF FF 8D 55 08 89 85 E8 FE FF FF E8 CC F8 FF FF 8D 85 EC FE FF FF 89 85 E4 FE FF FF C7 44 24 08 80 00 00 00 8B 85 E8 FE FF FF 89 44 24 04 8B 85 E4 FE FF FF 89 04 24 E8 ?? ?? ?? ?? 8B 95 E4 FE FF FF 8B 45 08 E8 82 FE FF FF 83 F8 07 74 1D E8 ?? ?? ?? ?? 8B 45 08 89 04 24 E8 ?? ?? ?? ?? 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 8B 95 E4 FE FF FF 8B 85 E8 FE FF FF E8 AF F9 FF FF 89 C1 8B 85 38 FF FF FF 89 44 0D 04 8D 4C 0D 04 8B 45 EC 8B 55 F0 8B }
	condition:
		$pattern
}

rule _Unwind_ForcedUnwind_e96439a1068cbd2925b32a271e477b68 {
	meta:
		aliases = "_Unwind_ForcedUnwind"
		size = "197"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 81 EC 28 01 00 00 89 5D F4 8B 4D 04 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 45 EC 8D 85 6C FF FF FF 89 55 F0 8D 55 08 89 85 E8 FE FF FF 89 75 F8 89 7D FC E8 26 F7 FF FF 8D 95 EC FE FF FF 89 95 E4 FE FF FF C7 44 24 08 80 00 00 00 8B 85 E8 FE FF FF 89 14 24 89 44 24 04 E8 ?? ?? ?? ?? 8B 55 08 8B 45 0C 89 42 0C 8B 45 10 89 42 10 8B 95 E4 FE FF FF 8B 45 08 E8 D3 FC FF FF 83 F8 07 74 0D 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 8B 95 E4 FE FF FF 8B 85 E8 FE FF FF E8 10 F8 FF FF 89 C1 8B 85 38 FF FF FF 89 44 0D 04 8D 4C 0D 04 8B 45 EC 8B 55 F0 8B 5D F4 8B 75 F8 8B 7D FC 8B 6D 00 89 CC C3 }
	condition:
		$pattern
}

rule _Unwind_Resume_8a17c3e444ecf480406e8d16e69e5e9b {
	meta:
		aliases = "_Unwind_Resume"
		size = "203"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 81 EC 28 01 00 00 89 5D F4 8B 4D 04 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 45 EC 8D 85 6C FF FF FF 89 55 F0 8D 55 08 89 85 E8 FE FF FF 89 75 F8 89 7D FC E8 F6 F7 FF FF 8D 85 EC FE FF FF 89 85 E4 FE FF FF C7 44 24 08 80 00 00 00 8B 85 E8 FE FF FF 89 44 24 04 8B 85 E4 FE FF FF 89 04 24 E8 ?? ?? ?? ?? 8B 45 08 8B 50 0C 85 D2 75 15 8B 95 E4 FE FF FF E8 75 FB FF FF 83 F8 07 74 15 E8 ?? ?? ?? ?? 8B 95 E4 FE FF FF 8B 45 08 E8 8D FD FF FF EB E6 8B 95 E4 FE FF FF 8B 85 E8 FE FF FF E8 DA F8 FF FF 89 C1 8B 85 38 FF FF FF 89 44 0D 04 8D 4C 0D 04 8B 45 EC 8B 55 F0 8B 5D F4 8B 75 F8 8B 7D FC 8B 6D 00 }
	condition:
		$pattern
}

rule __frame_state_for_dad76cf50365dca56f0d9a26ab67858c {
	meta:
		aliases = "__frame_state_for"
		size = "232"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 81 EC 68 01 00 00 89 5D F4 8D 85 74 FF FF FF E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 75 F8 8D B5 B4 FE FF FF 89 7D FC 8B 7D 0C 89 85 B0 FE FF FF C7 44 24 08 80 00 00 00 C7 44 24 04 00 00 00 00 89 04 24 E8 ?? ?? ?? ?? 8B 45 08 89 F2 C7 45 D4 00 00 00 40 83 C0 01 89 45 C0 8B 85 B0 FE FF FF E8 49 FC FF FF 85 C0 74 11 31 FF 89 F8 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 83 BD 54 FF FF FF 02 74 E6 B9 01 00 00 00 EB 18 8D 74 26 00 3C 02 74 1C C7 44 8F 0C 00 00 00 00 83 C1 01 83 F9 13 74 16 8B 44 CE FC 3C 01 88 44 39 5B 75 E0 8B 44 CE F8 89 44 8F 0C EB E2 8B 85 48 FF FF FF 89 47 08 8B 85 4C FF FF }
	condition:
		$pattern
}

rule uw_init_context_1_2e5b643c430ec47906aa905fcb059a66 {
	meta:
		aliases = "uw_init_context_1"
		size = "330"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 81 EC F8 00 00 00 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 75 F8 8B 75 04 89 7D FC 89 C7 89 95 20 FF FF FF 89 8D 1C FF FF FF C7 44 24 08 80 00 00 00 C7 44 24 04 00 00 00 00 89 04 24 E8 ?? ?? ?? ?? 89 F8 89 77 4C 8D B5 30 FF FF FF C7 47 60 00 00 00 40 89 F2 E8 71 F2 FF FF 85 C0 0F 85 DE 00 00 00 80 BB ?? ?? ?? ?? 00 74 60 80 BB ?? ?? ?? ?? 04 0F 85 C8 00 00 00 8B 85 20 FF FF FF F6 47 63 40 89 45 F0 74 04 C6 47 70 00 8D 55 F0 B8 04 00 00 00 89 14 87 89 F8 89 F2 C7 45 D0 01 00 00 00 C7 45 C8 04 00 00 00 C7 45 C4 00 00 00 00 E8 37 FC FF FF 8B 85 1C FF FF FF 8B 5D F4 8B 75 F8 89 47 4C }
	condition:
		$pattern
}

rule __do_global_dtors_aux_0e1728a637008523133ba13c8eb23f25 {
	meta:
		aliases = "__do_global_dtors_aux"
		size = "168"
		objfiles = "crtbegin, crtbeginT"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 08 80 3D ?? ?? ?? ?? 00 74 0C EB 31 83 C0 04 A3 ?? ?? ?? ?? FF D2 A1 ?? ?? ?? ?? 8B 10 85 D2 75 EB B8 ?? ?? ?? ?? 85 C0 74 0C C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? C6 05 ?? ?? ?? ?? 01 C9 C3 8D B6 00 00 00 00 8D BF 00 00 00 00 55 B8 ?? ?? ?? ?? 89 E5 83 EC 18 E8 00 00 00 00 5A 81 C2 ?? ?? ?? ?? 85 C0 74 20 89 54 24 0C C7 44 24 08 00 00 00 00 C7 44 24 04 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 85 C0 74 12 B8 ?? ?? ?? ?? 85 C0 74 09 C7 04 24 ?? ?? ?? ?? FF D0 C9 C3 }
	condition:
		$pattern
}
...
rule __absvdi2_63d1998fa777d9760f9a07a845b59738 {
	meta:
		aliases = "__absvdi2"
		size = "49"
		objfiles = "_absvdi2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 08 8B 55 0C 8B 45 08 89 7C 24 04 89 34 24 89 D7 89 FF 89 C6 C1 FF 1F 89 FE 31 FA 31 F0 29 F0 8B 34 24 19 FA 8B 7C 24 04 89 EC 5D C3 }
	condition:
		$pattern
}
...
rule __popcountsi2_5bccd0ce93a7ccce78720bd03881b744 {
	meta:
		aliases = "__popcountsi2"
		size = "99"
		objfiles = "_popcountsi2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 0C 89 1C 24 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 74 24 04 8B 75 08 89 7C 24 08 89 F0 89 F2 8B BB ?? ?? ?? ?? C1 E8 10 25 FF 00 00 00 8B 1C 24 0F B6 0C 07 0F B6 C6 0F B6 04 07 01 C1 89 F0 25 FF 00 00 00 0F B6 14 07 C1 EE 18 0F B6 04 37 8B 74 24 04 8B 7C 24 08 89 EC 5D 01 CA 01 D0 C3 }
	condition:
		$pattern
}

rule __mulxc3_75228e214cb52ce26406ca9daa5ba104 {
	meta:
		aliases = "__mulxc3"
		size = "1273"
		objfiles = "_mulxc3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 0C DB 6D 0C 89 1C 24 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 8B 4D 08 DB 6D 24 89 74 24 04 89 7C 24 08 DC C9 DB 6D 18 DB 6D 30 DC C9 DB 6D 0C DE C9 DB 6D 18 DE CB D9 C3 D8 E2 D9 C1 D8 C4 D9 C9 DD E0 DF E0 9E 7A 22 75 20 DD DC DD DC DD D8 DD D8 DB 39 89 C8 DB 79 0C 8B 1C 24 8B 74 24 04 8B 7C 24 08 89 EC 5D C2 04 00 D9 C9 DD E0 DF E0 9E 7A 0C 75 0A DD DD DD DB DD D8 DD D8 EB D3 DB 6D 0C D8 E0 DB 6D 0C DD E8 DF E0 9E 0F 85 39 02 00 00 0F 8A 33 02 00 00 DD E8 DF E0 9E 0F 84 E0 01 00 00 F7 45 14 00 80 00 00 D9 E8 89 F6 74 08 DD D8 D9 83 ?? ?? ?? ?? DB 7D 0C DB 6D 18 D8 E0 DB 6D 18 DD E8 DF }
	condition:
		$pattern
}

rule __divxc3_68a0232bf135a712160f6fa9bfde1ae8 {
	meta:
		aliases = "__divxc3"
		size = "957"
		objfiles = "_divxc3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 0C DB 6D 24 89 1C 24 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? D9 E1 DB 6D 30 89 74 24 04 89 7C 24 08 8B 75 08 D9 E1 DA E9 DF E0 9E 76 50 DB 6D 24 DB 6D 30 DE F9 DB 6D 24 D8 C9 DB 6D 30 DE C1 DB 6D 0C D8 CA DB 6D 18 DC C1 D9 C9 D8 F2 D9 C9 DE CB DB 6D 0C DE EB D9 CA DE F1 D9 C9 DD E0 DF E0 9E 7A 49 75 47 DB 3E 89 F0 DB 7E 0C 8B 1C 24 8B 74 24 04 8B 7C 24 08 89 EC 5D C2 04 00 DB 6D 30 DB 6D 24 DE F9 DB 6D 30 D8 C9 DB 6D 24 DE C1 DB 6D 18 D8 CA DB 6D 0C DC C1 D9 C9 D8 F2 D9 CB DE C9 DB 6D 18 DE E1 DE F1 D9 C9 EB B0 D9 C9 DD E0 DF E0 9E 7A 0A 75 08 D9 C9 8D 74 26 00 EB A6 D9 EE DB 6D 24 DD }
	condition:
		$pattern
}
...
rule __floatdisf_16d7064a28075f144a6d841b48a63aa0 {
	meta:
		aliases = "__floatdisf"
		size = "151"
		objfiles = "_floatdisf@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 10 89 75 F8 8B 75 08 89 7D FC 8B 7D 0C 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 F0 83 C0 FF 89 FA 81 D2 FF FF 1F 00 81 FA FF FF 3F 00 72 20 76 59 31 D2 89 F0 25 FF 07 00 00 89 D1 09 C1 74 0F 89 F0 25 00 F8 FF FF 89 C6 81 CE 00 08 00 00 89 FA 89 F0 8B 7D FC 89 D0 50 89 C2 DB 04 24 C1 FA 1F 31 D2 D8 8B ?? ?? ?? ?? 89 14 24 8B 5D F4 56 8B 75 F8 DF 2C 24 83 C4 08 DE C1 D9 5D F0 D9 45 F0 89 EC 5D C3 90 8D 74 26 00 83 F8 FE 76 C0 EB A0 }
	condition:
		$pattern
}

rule __floatundisf_fff36e07b02bc930e0beb65e1744d96e {
	meta:
		aliases = "__floatundisf"
		size = "125"
		objfiles = "_floatundisf@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 10 89 7D FC 8B 7D 0C 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 75 F8 8B 75 08 81 FF FF FF 1F 00 72 20 76 1E 31 D2 89 F0 25 FF 07 00 00 89 D1 09 C1 74 0F 89 F0 25 00 F8 FF FF 89 C6 81 CE 00 08 00 00 89 FA 89 F0 8B 7D FC 89 D0 31 D2 52 31 D2 50 DF 2C 24 83 C4 08 D8 8B ?? ?? ?? ?? 52 8B 5D F4 56 8B 75 F8 DF 2C 24 83 C4 08 DE C1 D9 5D F0 D9 45 F0 89 EC 5D C3 }
	condition:
		$pattern
}

rule uw_update_context_416f3972b06ce7a9d2b813061b424ef6 {
	meta:
		aliases = "uw_update_context"
		size = "103"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 18 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 75 F8 89 D6 89 7D FC 89 C7 E8 2D FA FF FF 8B 86 B4 00 00 00 83 F8 11 7F 34 F6 47 63 40 0F B6 B4 03 ?? ?? ?? ?? 8B 0C 87 75 18 89 F0 3C 04 75 1D 8B 11 89 57 4C 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 80 7C 38 6C 00 89 CA 75 E7 EB DD E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __addvdi3_bd8f49cd835b89cfb02beed2ca86ec46 {
	meta:
		aliases = "__addvdi3"
		size = "106"
		objfiles = "_addvdi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 18 89 75 F8 8B 45 10 8B 75 08 89 7D FC 8B 55 14 8B 7D 0C 8B 4D 14 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 01 F0 11 FA 85 C9 89 45 E8 89 55 EC 78 10 39 FA 7C 07 7F 1A 39 F0 90 73 15 E8 ?? ?? ?? ?? 39 7D EC 7F F6 8D 74 26 00 7C 05 39 75 E8 77 EB 8B 45 E8 8B 55 EC 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 }
	condition:
		$pattern
}

rule __subvdi3_15068888e5a003a173a9c83f30c7af29 {
	meta:
		aliases = "__subvdi3"
		size = "106"
		objfiles = "_subvdi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 18 89 75 F8 8B 75 08 89 7D FC 8B 7D 0C 8B 4D 14 89 5D F4 89 F0 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 FA 2B 45 10 1B 55 14 85 C9 89 45 E8 89 55 EC 78 10 39 FA 7F 07 7C 1A 39 F0 90 76 15 E8 ?? ?? ?? ?? 39 7D EC 7C F6 8D 74 26 00 7F 05 39 75 E8 72 EB 8B 45 E8 8B 55 EC 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 }
	condition:
		$pattern
}
...
rule __ashldi3_92a98598877e8c6419d110e878bc11ad {
	meta:
		aliases = "__ashldi3"
		size = "122"
		objfiles = "_ashldi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 18 8B 45 10 89 75 F8 8B 75 08 89 7D FC 8B 7D 0C C7 45 F0 00 00 00 00 85 C0 C7 45 F4 00 00 00 00 74 33 BA 20 00 00 00 2B 55 10 85 D2 7E 35 0F B6 4D 10 89 F0 89 75 EC D3 E0 89 D1 D3 6D EC 89 FA 0F B6 4D 10 89 45 F0 D3 E2 0B 55 EC 89 55 F4 8B 75 F0 8B 7D F4 89 F0 89 FA 8B 75 F8 8B 7D FC 89 EC 5D C3 89 D1 F7 D9 D3 E6 C7 45 F0 00 00 00 00 89 75 F4 EB DA }
	condition:
		$pattern
}

rule __lshrdi3_b7c815f1c6cae0e4df4d94562d7b7dd5 {
	meta:
		aliases = "__lshrdi3"
		size = "124"
		objfiles = "_lshrdi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 18 8B 45 10 89 75 F8 8B 75 08 89 7D FC 8B 7D 0C C7 45 F0 00 00 00 00 85 C0 C7 45 F4 00 00 00 00 74 33 BA 20 00 00 00 2B 55 10 85 D2 7E 35 0F B6 4D 10 89 F8 89 7D EC D3 E8 89 D1 D3 65 EC 89 F2 0F B6 4D 10 89 45 F4 D3 EA 0B 55 EC 89 55 F0 8B 75 F0 8B 7D F4 89 F0 89 FA 8B 75 F8 8B 7D FC 89 EC 5D C3 89 D1 89 F8 F7 D9 D3 E8 C7 45 F4 00 00 00 00 89 45 F0 EB D8 }
	condition:
		$pattern
}

rule __muldi3_8a5f104d6603fa5e45f8854bd6f241dd {
	meta:
		aliases = "__muldi3"
		size = "72"
		objfiles = "_muldi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 18 8B 4D 08 89 75 F8 8B 75 10 C7 45 EC 00 00 00 00 C7 45 E8 00 00 00 00 89 C8 0F AF 4D 14 F7 E6 0F AF 75 0C 89 55 EC 8B 55 EC 89 7D FC 8B 7D FC 89 45 E8 8B 45 E8 01 F1 8B 75 F8 89 EC 5D 01 D1 89 CA C3 }
	condition:
		$pattern
}

rule _Unwind_GetGR_634da9086103329312a3d1eb47c6a5e9 {
	meta:
		aliases = "_Unwind_GetGR"
		size = "101"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 18 8B 55 0C 89 5D F4 8B 4D 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 75 F8 83 FA 11 89 7D FC 7F 36 F6 41 63 40 0F B6 BC 13 ?? ?? ?? ?? 8B 34 91 75 1A 89 F8 3C 04 75 1F 8B 06 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 90 8D 74 26 00 80 7C 11 6C 00 89 F0 75 E5 EB DB 90 8D 74 26 00 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __ashrdi3_bf8deda890a2a2e33bbfbb885ba25c6d {
	meta:
		aliases = "__ashrdi3"
		size = "122"
		objfiles = "_ashrdi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 18 8B 55 0C 8B 45 08 89 75 F8 89 7D FC 89 55 EC 8B 55 10 89 45 E8 85 D2 74 38 8B 55 10 C7 45 F4 20 00 00 00 29 55 F4 8B 45 F4 85 C0 7E 34 8B 45 EC 0F B6 4D 10 8B 55 E8 89 C7 D3 FF 0F B6 4D F4 D3 E0 0F B6 4D 10 89 C6 D3 EA 09 D6 89 75 E8 89 7D EC 8B 45 E8 8B 55 EC 8B 75 F8 8B 7D FC 89 EC 5D C3 8B 45 EC 8B 4D F4 89 C7 89 C6 F7 D9 C1 FF 1F D3 FE EB D7 }
	condition:
		$pattern
}

rule __mulsc3_8ca30d950dabcc0ed5e2ee7c89eff426 {
	meta:
		aliases = "__mulsc3"
		size = "1207"
		objfiles = "_mulsc3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 24 D9 45 08 D8 4D 10 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 75 F8 89 7D FC D9 5D F0 D9 45 0C D8 4D 14 D9 5D EC D9 45 08 D8 4D 14 D9 5D E8 D9 45 0C D8 4D 10 D9 5D E4 D9 45 F0 D9 45 EC D9 C1 D8 E1 D9 45 E8 D9 45 E4 D9 C1 D8 C1 D9 55 E0 D9 CB DD E0 DF E0 9E 7A 22 75 20 DD DC DD D8 DD D8 DD D8 DD D9 D9 5D DC 8B 55 E0 8B 45 DC 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 D9 CB DD E8 DF E0 9E 7A 0C 75 0A DD D8 DD D8 DD D9 DD D9 EB D5 D9 45 08 D8 E0 D9 45 08 DD E8 DF E0 9E 0F 85 17 02 00 00 0F 8A 11 02 00 00 DD E8 DF E0 9E 0F 84 C4 01 00 00 8B 75 08 B8 00 00 80 3F 85 F6 79 05 B8 00 00 }
	condition:
		$pattern
}

rule read_encoded_value_with_base_c37ce21a3d02dcb15c89c175b333848d {
	meta:
...
rule read_encoded_value_with_base_1e2e1bfe0cb149fb097ed908fa81027e {
	meta:
		aliases = "read_encoded_value_with_base"
		size = "186"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 28 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 3C 50 89 75 F8 89 CE 89 7D FC 89 C7 89 55 DC 74 4E 0F B6 C0 89 45 E0 83 E0 0F 83 F8 0C 76 05 E8 ?? ?? ?? ?? 8B 84 83 ?? ?? ?? ?? 01 D8 FF E0 8B 11 8D 41 04 85 D2 74 15 83 65 E0 70 83 7D E0 10 74 5F 89 F9 03 55 DC 84 C9 79 02 8B 12 8B 4D 08 89 11 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 8D 41 03 83 E0 FC 8B 10 83 C0 04 EB E1 8B 11 8D 41 08 EB C1 8D 55 F0 89 C8 E8 9F FD FF FF 8B 55 F0 EB B2 0F BF 11 8D 41 02 EB AA 0F B7 11 8D 41 02 EB A2 8D 55 F0 89 C8 E8 40 FD FF FF 8B 55 F0 EB 93 89 75 DC EB 9C }
	condition:
		$pattern
}

rule __divdc3_da373c6815208ed169b0f55d3b4014e4 {
	meta:
		aliases = "__divdc3"
		size = "939"
		objfiles = "_divdc3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 30 DD 45 0C DD 5D E8 DD 45 14 DD 5D E0 DD 45 1C DD 55 D8 DD 45 24 DD 55 D0 D9 C1 D9 E1 D9 C9 D9 E1 DA E9 DF E0 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 75 F8 8B 75 08 89 7D FC 9E 76 43 DD 45 D0 D8 F9 DC C9 D9 C9 DC 45 D0 DD 45 E8 D8 CA DC 45 E0 D8 F1 DD 45 E0 DE CB D9 CA DC 65 E8 DE F1 D9 C9 DD E0 DF E0 9E 7A 42 75 40 DD 1E 89 F0 DD 5E 08 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C2 04 00 DD D8 DD 45 D0 DC 75 D8 DD 45 D0 D8 C9 DC 45 D8 DD 45 E0 D8 CA DC 45 E8 D8 F1 D9 CA DC 4D E8 DD 45 E0 DE E1 DE F1 D9 C9 EB B7 D9 C9 DD E0 DF E0 9E 7A 08 75 06 D9 C9 89 F6 EB AF D9 EE DD 45 D8 DD }
	condition:
		$pattern
}

rule read_encoded_value_with_base_4f970cbc2878ee7c53b2b4d9cd41e502 {
	meta:
		aliases = "read_encoded_value_with_base"
		size = "347"
		objfiles = "unwind_c@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 38 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 3C 50 89 75 F8 89 7D FC 89 55 D0 89 4D CC 88 45 D7 74 29 8B 45 CC 0F B6 4D D7 89 45 DC 89 C8 83 E0 0F 83 F8 0C 89 4D D8 76 05 E8 ?? ?? ?? ?? 8B 84 83 ?? ?? ?? ?? 01 D8 FF E0 89 F6 89 C8 83 C0 03 83 E0 FC 8B 30 83 C0 04 89 45 CC 8B 4D 08 8B 45 CC 89 31 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 8B 45 CC 8B 30 83 C0 04 89 45 CC 85 F6 74 DC 83 65 D8 70 83 7D D8 10 0F 84 BE 00 00 00 03 75 D0 80 7D D7 00 79 C5 8B 36 EB C1 8B 4D CC 8B 31 83 C1 08 89 4D CC EB D4 8B 4D CC 0F BF 31 83 C1 02 89 4D CC EB C6 31 F6 C7 45 E0 00 00 00 00 8B 4D CC 0F B6 }
	condition:
		$pattern
}

rule __mulvdi3_bca90638e0723c5d53d715fa1fadc25c {
	meta:
		aliases = "__mulvdi3"
		size = "487"
		objfiles = "_mulvdi3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 48 89 75 F8 8B 45 10 8B 75 08 89 7D FC 8B 7D 0C 8B 55 14 89 45 C8 89 F0 C1 F8 1F 89 F9 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 39 C7 89 55 CC 89 75 E8 75 28 8B 75 C8 89 D1 89 F0 C1 F8 1F 39 C2 75 79 8B 45 E8 F7 EE 89 C6 89 D7 89 F0 89 FA 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 8B 45 C8 8B 55 CC 89 45 EC C1 F8 1F 39 C2 0F 85 B7 00 00 00 8B 45 E8 F7 65 EC 89 45 D8 8B 45 EC 89 55 C0 89 55 DC F7 E7 85 FF 89 45 D0 89 55 D4 0F 88 88 00 00 00 8B 45 EC 85 C0 78 61 8B 45 C0 31 D2 03 45 D0 13 55 D4 8B 75 D8 89 C1 C1 F9 1F 39 D1 89 45 DC 8B 7D DC 74 95 E8 ?? ?? ?? ?? 8B 45 E8 F7 E6 89 C6 }
	condition:
		$pattern
}

rule __muldc3_d61a3ef88b82ef3a1313ab893e612f35 {
	meta:
		aliases = "__muldc3"
		size = "1300"
		objfiles = "_muldc3@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 50 DD 45 0C DD 55 C8 8B 4D 08 DD 45 14 DD 55 C0 DD 45 1C DD 55 B8 DD 45 24 DD 55 B0 D9 CB D8 C9 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 75 F8 89 7D FC DD 5D E8 D9 C1 D8 CB DD 5D E0 DD 45 C8 DE CB D9 CA DD 5D D8 DE C9 DD 5D D0 DD 45 E8 DD 45 E0 D9 C1 D8 E1 DD 45 D8 DD 45 D0 D9 C1 D8 C1 D9 CB DD E0 DF E0 9E 7A 20 75 1E DD DC DD D8 DD D8 DD DA DD 19 89 C8 DD 59 08 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C2 04 00 D9 CB DD E0 DF E0 9E 7A 0C 75 0A DD DD DD D8 DD D8 DD D9 EB D5 DD 45 C8 D8 E0 DD 45 C8 DD E8 DF E0 9E 0F 85 22 02 00 00 0F 8A 1C 02 00 00 DD E8 DF E0 9E 0F 84 CD 01 00 00 }
	condition:
		$pattern
}

rule __register_frame_info_bases_2c0db877b103089ce4d90b527474147a {
	meta:
		aliases = "__register_frame_info_bases"
		size = "83"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 53 8B 55 0C E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 85 C0 74 37 8B 08 85 C9 74 31 8B 4D 10 C7 02 FF FF FF FF 89 4A 04 8B 4D 14 89 42 0C 8B 83 ?? ?? ?? ?? C7 42 10 00 00 00 00 66 81 4A 10 F8 07 89 42 14 89 4A 08 89 93 ?? ?? ?? ?? 5B 5D C3 }
	condition:
		$pattern
}

rule __ctzdi2_5c5980998195a61ff721f0a9620f98f0 {
	meta:
		aliases = "__ctzdi2"
		size = "32"
		objfiles = "_ctzdi2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 56 31 F6 8B 55 0C 85 C0 89 C1 75 06 89 D1 66 BE 20 00 0F BC C1 01 F0 5E 5D C3 }
	condition:
		$pattern
}
...
rule _Unwind_GetCFA_e74ee308d0a54f12073cada928fb3330 {
	meta:
		aliases = "_Unwind_GetCFA"
		size = "11"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 5D 8B 40 48 C3 }
	condition:
		$pattern
}

rule _Unwind_GetIP_d878916f924ffa8f0f5dabb735e46553 {
	meta:
		aliases = "_Unwind_GetIP"
		size = "11"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 5D 8B 40 4C C3 }
	condition:
		$pattern
}

rule _Unwind_GetLanguageSpecificDat_267eaf7be7b28d0815154619745b017a {
	meta:
		aliases = "_Unwind_GetLanguageSpecificData"
		size = "11"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 5D 8B 40 50 C3 }
	condition:
		$pattern
}

rule _Unwind_GetTextRelBase_0f8c6c2b69b91db6bcc9b180430a6601 {
	meta:
		aliases = "_Unwind_GetTextRelBase"
		size = "11"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 5D 8B 40 54 C3 }
	condition:
		$pattern
}

rule _Unwind_GetDataRelBase_88f76e44e3cfba350897aabacca72cf2 {
	meta:
		aliases = "_Unwind_GetDataRelBase"
		size = "11"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 5D 8B 40 58 C3 }
	condition:
		$pattern
}

rule _Unwind_GetRegionStart_a45ca93ee3421adae62ea297bf7b8597 {
	meta:
		aliases = "_Unwind_GetRegionStart"
		size = "11"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 5D 8B 40 5C C3 }
	condition:
		$pattern
}

rule __paritydi2_e8a3464942d6faba75700364c7a4cb42 {
	meta:
		aliases = "__paritydi2"
		size = "47"
		objfiles = "_paritydi2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 8B 55 0C 5D 31 C2 89 D0 C1 E8 10 31 D0 89 C2 C1 EA 08 31 C2 B8 96 69 00 00 89 D1 C1 E9 04 31 D1 83 E1 0F D3 F8 83 E0 01 C3 }
	condition:
		$pattern
}

rule __register_frame_info_table_ba_5a425ebb9b12b1ebcd998d120b902bd2 {
	meta:
		aliases = "__register_frame_info_table_bases"
		size = "75"
		objfiles = "unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 0C 8B 55 10 E8 ?? ?? ?? ?? 81 C1 ?? ?? ?? ?? C7 00 FF FF FF FF 89 50 04 8B 55 14 89 50 08 8B 55 08 C7 40 10 00 00 00 00 80 48 10 02 66 81 48 10 F8 07 89 50 0C 8B 91 ?? ?? ?? ?? 89 50 14 5D 89 81 ?? ?? ?? ?? C3 }
	condition:
		$pattern
}

rule _Unwind_GetIPInfo_0aeb1cf6cac39e71d12e40251d24f5f4 {
	meta:
		aliases = "_Unwind_GetIPInfo"
		size = "22"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 4D 08 8B 55 0C 8B 41 60 C1 E8 1F 89 02 8B 41 4C 5D C3 }
	condition:
		$pattern
}

rule __powisf2_633ffece46992c736393181e2f5445de {
	meta:
		aliases = "__powisf2"
		size = "87"
		objfiles = "_powisf2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 4D 0C 53 D9 45 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? D9 C0 89 C8 C1 F8 1F 89 C2 31 CA 29 C2 F6 C2 01 75 04 DD D8 D9 E8 89 D0 EB 03 90 D9 C9 D1 E8 74 12 D9 C9 A8 01 D8 C8 74 F2 D1 E8 DC C9 75 F4 DD D8 EB 02 DD D9 85 C9 79 06 D8 BB ?? ?? ?? ?? 5B 5D C3 }
	condition:
		$pattern
}

rule __powidf2_354f56d89f6f95c5d67606b37b46434b {
	meta:
		aliases = "__powidf2"
		size = "87"
		objfiles = "_powidf2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 4D 10 53 DD 45 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? D9 C0 89 C8 C1 F8 1F 89 C2 31 CA 29 C2 F6 C2 01 75 04 DD D8 D9 E8 89 D0 EB 03 90 D9 C9 D1 E8 74 12 D9 C9 A8 01 D8 C8 74 F2 D1 E8 DC C9 75 F4 DD D8 EB 02 DD D9 85 C9 79 06 DC BB ?? ?? ?? ?? 5B 5D C3 }
	condition:
		$pattern
}

rule __powixf2_573859f93f1dd874064ced4f5f9b5272 {
	meta:
		aliases = "__powixf2"
		size = "73"
		objfiles = "_powixf2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 4D 14 DB 6D 08 53 89 C8 C1 F8 1F 89 C2 31 CA 29 C2 F6 C2 01 D9 C0 75 04 DD D8 D9 E8 89 D0 EB 02 D9 C9 D1 E8 74 12 D9 C9 A8 01 D8 C8 74 F2 D1 E8 DC C9 75 F4 DD D8 EB 02 DD D9 85 C9 79 04 D9 E8 DE F1 5B 5D C3 }
	condition:
		$pattern
}

rule __ffsdi2_4228e0a92a51c58ec4af19f88bdf53c0 {
	meta:
		aliases = "__ffsdi2"
		size = "40"
		objfiles = "_ffsdi2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 55 08 56 31 F6 8B 4D 0C 85 D2 89 D0 75 0C 31 C0 85 C9 74 0D 89 C8 66 BE 20 00 0F BC C0 8D 44 06 01 5E 5D C3 }
	condition:
		$pattern
}
...
rule __clzdi2_99b5b0e04f2c1fb6212df67c925c870b {
	meta:
		aliases = "__clzdi2"
		size = "35"
		objfiles = "_clzdi2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 55 0C 56 31 F6 8B 45 08 85 D2 89 D1 75 06 89 C1 66 BE 20 00 0F BD C1 83 F0 1F 01 F0 5E 5D C3 }
	condition:
		$pattern
}
...
rule __gcc_personality_v0_75e39cadec9ed969b5c2047eb65aa254 {
	meta:
		aliases = "__gcc_personality_v0"
		size = "547"
		objfiles = "unwind_c@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) B8 03 00 00 00 89 E5 57 56 53 83 EC 4C E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 7D 08 01 74 08 83 C4 4C 5B 5E 5F 5D C3 F6 45 0C 02 75 0D 83 C4 4C B8 08 00 00 00 5B 5E 5F 5D C3 8B 45 1C C7 45 F0 00 00 00 00 89 04 24 E8 ?? ?? ?? ?? 85 C0 89 C6 74 DB 8B 55 1C 31 C0 85 D2 74 0B 8B 55 1C 89 14 24 E8 ?? ?? ?? ?? 89 45 C8 0F B6 16 8D 7E 01 80 FA FF 0F 84 3F 01 00 00 0F B6 F2 8B 55 1C 89 F0 E8 FB FE FF FF 8D 55 CC 89 F9 89 14 24 89 C2 89 F0 E8 8A FD FF FF 89 C7 0F B6 07 8D 4F 01 88 45 DC 04 01 0F 84 FC 00 00 00 8D 45 E0 89 45 BC 89 C2 89 C8 E8 28 FD FF FF 89 C1 03 45 E0 89 45 D4 0F B6 01 8B 55 BC 88 45 }
	condition:
		$pattern
}

rule _obstack_begin_1_57180df0aa44ced9f59d0e59f2cc21c9 {
	meta:
		aliases = "_obstack_begin_1"
		size = "153"
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 55 ) B8 04 00 00 00 57 56 53 83 EC 0C 8B 74 24 28 8B 54 24 24 8B 5C 24 20 8B 4C 24 2C 85 F6 8B 6C 24 34 0F 44 F0 85 D2 66 B8 E0 0F 0F 44 D0 8B 44 24 30 80 4B 28 01 8D 7E FF 89 4B 1C F6 43 28 01 89 43 20 89 13 89 7B 18 89 6B 24 74 06 50 50 52 55 EB 04 83 EC 0C 52 FF D1 83 C4 10 85 C0 89 C2 89 43 04 75 05 E8 ?? ?? ?? ?? 8D 44 38 08 F7 DE 21 F0 89 43 08 89 43 0C 89 D0 03 03 C7 42 04 00 00 00 00 89 02 80 63 28 F9 89 43 10 83 C4 0C B8 01 00 00 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_pthread_setcancelstate_f6dfc3e46ff600d6c6bfb696e3308826 {
	meta:
		aliases = "pthread_setcancelstate, __GI_pthread_setcancelstate"
		size = "74"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 16 00 00 00 89 E5 56 8B 75 0C 53 8B 5D 08 83 FB 01 77 2E E8 ?? ?? ?? ?? 85 F6 89 C2 74 06 0F B6 40 40 89 06 80 7A 42 00 88 5A 40 74 12 66 81 7A 40 00 01 75 0A 50 50 55 6A FF E8 ?? ?? ?? ?? 31 C0 8D 65 F8 5B 5E 5D C3 }
	condition:
		$pattern
}

rule __GI_pthread_setcanceltype_c94c1a076e9de667fd6f6740b62073e7 {
	meta:
		aliases = "pthread_setcanceltype, __GI_pthread_setcanceltype"
		size = "74"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 16 00 00 00 89 E5 56 8B 75 0C 53 8B 5D 08 83 FB 01 77 2E E8 ?? ?? ?? ?? 85 F6 89 C2 74 06 0F B6 40 41 89 06 80 7A 42 00 88 5A 41 74 12 66 81 7A 40 00 01 75 0A 50 50 55 6A FF E8 ?? ?? ?? ?? 31 C0 8D 65 F8 5B 5E 5D C3 }
	condition:
		$pattern
}
...
rule mbsnrtowcs_015191fdbe7a5e09f1ad14a470ffc2a9 {
	meta:
		aliases = "__GI_mbsnrtowcs, mbsnrtowcs"
		size = "157"
		objfiles = "mbsnrtowcs@libc.a"
	strings:
		$pattern = { ( CC | 55 ) B8 ?? ?? ?? ?? 57 56 53 83 EC 1C 8B 54 24 40 8B 4C 24 30 8B 74 24 38 8B 5C 24 3C 85 D2 0F 44 D0 85 C9 74 11 39 D1 B8 01 00 00 00 75 11 8D 4C 24 18 30 C0 EB 09 8D 4C 24 18 83 CB FF 31 C0 8B 54 24 34 39 F3 89 F5 0F 46 EB 89 EE 8D 3C 85 00 00 00 00 8B 1A EB 28 8A 03 0F B6 D0 84 C0 89 11 75 04 31 DB EB 1D 83 FA 7F 7E 10 E8 ?? ?? ?? ?? C7 00 54 00 00 00 83 C8 FF EB 1A 43 01 F9 4E 85 F6 75 D4 8D 44 24 18 39 C1 74 06 8B 44 24 34 89 18 89 E8 29 F0 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule thread_self_ff5ff5468472ed8724cee51a9db2fab4 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "condvar@libpthread.a, cancel@libpthread.a, pthread@libpthread.a, spinlock@libpthread.a, join@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 ?? ?? ?? ?? 89 E5 3B 2D ?? ?? ?? ?? 89 EA 73 30 3B 2D ?? ?? ?? ?? 72 0D 3B 2D ?? ?? ?? ?? B8 ?? ?? ?? ?? 72 1B 83 3D ?? ?? ?? ?? 00 74 06 5D E9 ?? ?? ?? ?? 81 CA FF FF 1F 00 8D 82 A1 FE FF FF 5D C3 }
	condition:
		$pattern
}

rule __old_sem_wait_985f6eaa128291f13408da424efd5266 {
	meta:
		aliases = "__old_sem_wait"
		size = "288"
		objfiles = "oldsemaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 ?? ?? ?? ?? 89 E5 56 89 EA 53 83 EC 20 3B 2D ?? ?? ?? ?? 8B 5D 08 73 31 3B 2D ?? ?? ?? ?? 72 0D 3B 2D ?? ?? ?? ?? B8 ?? ?? ?? ?? 72 1C 83 3D ?? ?? ?? ?? 00 74 07 E8 ?? ?? ?? ?? EB 0C 81 CA FF FF 1F 00 8D 82 A1 FE FF FF 89 45 F4 8D 75 EC C7 45 EC 00 00 00 00 C7 45 F0 ?? ?? ?? ?? 8B 45 F4 89 F2 E8 ?? ?? ?? ?? 8B 0B F6 C1 01 74 08 83 F9 01 8D 51 FE 75 09 8B 55 F4 8B 45 F4 89 48 08 89 C8 F0 0F B1 13 0F 94 C1 84 C9 74 DB F6 C2 01 75 7A 8B 45 F4 83 EC 0C 50 E8 ?? ?? ?? ?? 8B 45 F4 31 D2 E8 ?? ?? ?? ?? 8B 45 F4 83 C4 10 80 78 42 00 74 AA 8B 45 F4 80 78 40 00 75 A1 8B 13 8B 45 F4 39 C2 75 13 8B }
	condition:
		$pattern
}

rule frame_dummy_93473ba3e7ff6a0970b7249abe06f38b {
	meta:
		aliases = "frame_dummy"
		size = "88"
		objfiles = "crtbegin, crtbeginT"
	strings:
		$pattern = { ( CC | 55 ) B8 ?? ?? ?? ?? 89 E5 83 EC 18 E8 00 00 00 00 5A 81 C2 ?? ?? ?? ?? 85 C0 74 20 89 54 24 0C C7 44 24 08 00 00 00 00 C7 44 24 04 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 85 C0 74 12 B8 ?? ?? ?? ?? 85 C0 74 09 C7 04 24 ?? ?? ?? ?? FF D0 C9 C3 }
	condition:
		$pattern
}
...
rule __popcountdi2_38c1e062142d6c90640d801571e2f0af {
	meta:
		aliases = "__popcountdi2"
		size = "100"
		objfiles = "_popcountdi2@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) B9 08 00 00 00 89 E5 57 56 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 0C 8B 45 08 8B 55 0C 89 45 E8 0F B6 45 E8 89 55 EC 8B BB ?? ?? ?? ?? 0F B6 34 07 8B 55 EC 8B 45 E8 0F AD D0 D3 EA F6 C1 20 74 04 89 D0 31 D2 25 FF 00 00 00 83 C1 08 0F B6 04 07 01 C6 83 F9 40 75 D9 83 C4 0C 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _time_mktime_tzi_33b409494b6961e0fc810b5878ba7cb1 {
	meta:
		aliases = "_time_mktime_tzi"
		size = "706"
		objfiles = "_time_mktime_tzi@libc.a"
	strings:
		$pattern = { ( CC | 55 ) B9 0B 00 00 00 57 56 53 83 EC 6C 8D 6C 24 38 8B B4 24 80 00 00 00 89 EF F3 A5 8B 94 24 88 00 00 00 31 C0 80 7A 28 00 C7 44 24 34 00 00 00 00 0F 45 44 24 58 85 C0 89 44 24 58 74 18 85 C0 0F 9F C0 0F B6 C0 8D 44 00 FF 89 44 24 58 C7 44 24 34 01 00 00 00 8D 4D 14 BF 90 01 00 00 89 4C 24 24 8B 4D 14 8D 5D 18 89 5C 24 28 8B 5D 10 8D 75 1C 89 C8 99 F7 FF 89 5C 24 14 8D 55 10 89 54 24 2C 89 44 24 04 89 45 18 89 D8 BB 0C 00 00 00 99 F7 FB 8B 54 24 14 69 5C 24 04 90 01 00 00 01 C1 89 44 24 10 29 D9 89 45 1C 6B C0 0C 89 4D 14 29 C2 85 D2 89 D0 89 55 10 79 0C 8B 4C 24 24 83 C0 0C 89 45 10 FF 09 8B 4D }
	condition:
		$pattern
}

rule __md5_Final_e1174c05f95abe5c43d279a5c4bc656a {
	meta:
		aliases = "__md5_Final"
		size = "118"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) B9 10 00 00 00 57 89 C5 56 31 C0 53 89 D3 83 EC 5C 8D 7C 24 14 F3 AB C6 44 24 14 80 8D 72 10 8D 7C 24 54 A5 A5 8B 42 10 B9 38 00 00 00 C1 E8 03 83 E0 3F 83 F8 37 76 05 B9 78 00 00 00 29 C1 89 D8 8D 54 24 14 89 DE E8 ?? ?? ?? ?? 8D 54 24 54 B9 08 00 00 00 89 D8 89 EF E8 ?? ?? ?? ?? A5 A5 A5 A5 31 C0 B9 16 00 00 00 89 DF F3 AB 83 C4 5C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __md5_Transform_75513adbc9eedda351ba5803414f3691 {
	meta:
		aliases = "__md5_Transform"
		size = "321"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) B9 10 00 00 00 57 89 C5 56 89 D6 53 83 EC 64 8D 7C 24 24 F3 A5 8B 00 8D 55 04 8B 5D 04 8B 7D 08 8B 75 0C 89 44 24 20 8D 45 08 8B 4C 24 20 89 54 24 04 8D 55 0C 89 44 24 08 89 54 24 0C C7 44 24 10 ?? ?? ?? ?? C7 44 24 14 ?? ?? ?? ?? C7 44 24 18 ?? ?? ?? ?? C7 44 24 1C 00 00 00 00 E9 A2 00 00 00 8B 44 24 10 83 C0 04 F6 44 24 1C 0F 0F 45 44 24 10 89 44 24 10 8B 44 24 1C C1 F8 04 83 F8 01 74 1E 7F 06 85 C0 74 0E EB 37 83 F8 02 74 1F 83 F8 03 74 22 EB 2B 89 D8 89 FA F7 D0 21 F0 EB 08 89 F0 89 F2 F7 D0 21 F8 21 DA 09 D0 EB 10 89 F8 31 D8 31 F0 EB 08 89 F0 F7 D0 09 D8 31 F8 8D 0C 08 8B 44 24 18 8B }
	condition:
		$pattern
}
...
rule __malloc_consolidate_dc7e362c2824efc22d0283808860a0d2 {
	meta:
		aliases = "__malloc_consolidate"
		size = "386"
		objfiles = "free@libc.a"
	strings:
		$pattern = { ( CC | 55 ) BA 01 00 00 00 57 56 53 83 EC 1C 8B 6C 24 30 8B 45 00 85 C0 0F 84 FB 00 00 00 83 E0 FD 89 45 00 C1 E8 03 8D 55 34 8D 44 85 FC 8D 5D 04 89 54 24 14 89 44 24 0C 89 5C 24 08 8B 44 24 08 8B 08 85 C9 0F 84 BA 00 00 00 C7 00 00 00 00 00 8B 41 04 8B 51 08 89 C7 83 E7 FE A8 01 89 54 24 10 8D 14 39 8B 5A 04 89 5C 24 04 75 28 8B 01 89 44 24 18 89 C8 2B 44 24 18 8B 70 08 8B 58 0C 8B 4E 0C 39 C1 75 39 39 4B 08 75 34 03 7C 24 18 89 5E 0C 89 73 08 8B 74 24 04 83 E6 FC 3B 55 2C 74 4B 8B 44 32 04 89 72 04 83 E0 01 85 C0 75 1D 8B 5A 08 8B 42 0C 39 53 0C 75 05 39 50 08 74 05 E8 ?? ?? ?? ?? 01 F7 89 43 0C 89 }
	condition:
		$pattern
}
...
rule _time_t2tm_49f767a76385b2e871bcc364169fc901 {
	meta:
		aliases = "_time_t2tm"
		size = "348"
		objfiles = "_time_t2tm@libc.a"
	strings:
		$pattern = { ( CC | 55 ) BD ?? ?? ?? ?? 57 56 53 83 EC 10 8B 74 24 2C 8B 44 24 24 C7 46 1C 00 00 00 00 8B 18 8B 44 24 28 05 76 0E 02 00 89 44 24 04 0F B7 4D 00 66 83 F9 07 89 4C 24 08 75 23 89 D8 99 F7 F9 B9 07 00 00 00 03 5C 24 04 8D 42 0B 99 F7 F9 0F B7 45 02 8D 0C 85 01 00 00 00 89 54 24 0C 89 D8 99 F7 F9 89 C7 0F AF C1 29 C3 79 03 01 CB 4F 66 83 7C 24 08 07 75 0D 8D 41 FF 39 C3 75 06 FF 46 10 8D 59 FE 83 F9 3C 8D 4E 04 7F 08 89 1E 89 CE 89 FB EB 04 89 3E 89 CE 83 C5 02 66 83 7D 00 00 75 8B 83 79 FC 04 75 0C C7 41 FC 03 00 00 00 BB 6D 01 00 00 01 19 BF ?? ?? ?? ?? 8D 59 F8 8B 51 FC 8B 43 F8 81 EA 2B 01 00 00 C1 }
	condition:
		$pattern
}
...
rule __GI_strcasecmp_ae3fa8dd4f292224727b912b16d12bf1 {
	meta:
		aliases = "strcasecmp, __GI_strcasecmp"
		size = "54"
		objfiles = "strcasecmp@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 31 C0 53 8B 5C 24 0C 8B 74 24 10 39 F3 74 1A 8B 0D ?? ?? ?? ?? 0F B6 03 0F BF 14 41 0F B6 06 0F BF 04 41 29 C2 89 D0 75 09 80 3B 00 74 04 46 43 EB D9 5B 5E C3 }
	condition:
		$pattern
}

rule a64l_432c9da9bcd3778aa79624fe19162126 {
	meta:
		aliases = "a64l"
		size = "58"
		objfiles = "a64l@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 31 C9 53 31 DB 8B 44 24 0C 8D 70 06 89 C2 0F B6 02 83 E8 2E 83 F8 4C 77 1B 8A 80 ?? ?? ?? ?? 3C 40 74 11 0F B6 C0 42 D3 E0 09 C3 39 F2 74 05 83 C1 06 EB DA 89 D8 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_strlcat_b30c078614cacb714e3bc884207fe701 {
	meta:
...
rule _dl_do_lazy_reloc_657ec2a2145d30fbf4f831aaf16fbfa3 {
	meta:
		aliases = "_dl_do_lazy_reloc"
		size = "45"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 56 ) 31 C9 53 8B 54 24 14 8B 44 24 0C 8B 72 04 8B 00 8B 1A 81 E6 FF 00 00 00 74 0D 83 C9 FF 83 FE 07 75 05 01 04 03 31 C9 5B 89 C8 5E C3 }
	condition:
		$pattern
}

rule __GI_wcswidth_a8a8d41ac18fba6317bbb5bcefd8d7f3 {
	meta:
		aliases = "wcswidth, __GI_wcswidth"
		size = "86"
		objfiles = "wcswidth@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 31 C9 53 8B 74 24 0C 8B 5C 24 10 EB 0A 89 D0 83 E0 7F 39 C2 75 37 41 39 D9 73 24 8B 14 8E 85 D2 75 EB EB 1B 3D FF 00 00 00 7F 22 83 F8 1F 7E 1D 83 E8 7F 83 F8 20 76 15 83 C6 04 42 4B EB 02 31 D2 85 DB 74 0B 8B 06 85 C0 75 D9 EB 03 83 CA FF 5B 89 D0 5E C3 }
	condition:
		$pattern
}

rule pthread_kill_e8f8d901656356ec340b118ea9860953 {
	meta:
		aliases = "pthread_kill"
		size = "110"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 31 D2 53 83 EC 04 8B 5C 24 10 89 D8 25 FF 03 00 00 C1 E0 04 8D B0 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 8B 46 08 85 C0 74 05 39 58 10 74 1C 83 EC 0C 56 E8 ?? ?? ?? ?? B8 03 00 00 00 83 C4 10 EB 29 E8 ?? ?? ?? ?? 8B 00 EB 20 83 EC 0C 8B 58 14 56 E8 ?? ?? ?? ?? 59 5E FF 74 24 1C 53 E8 ?? ?? ?? ?? 83 C4 10 40 74 D9 31 C0 5A 5B 5E C3 }
	condition:
		$pattern
}
...
rule pthread_cond_broadcast_053445d62f7497565a84894d078ecded {
	meta:
		aliases = "__GI_pthread_cond_broadcast, pthread_cond_broadcast"
		size = "78"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 31 D2 53 83 EC 04 8B 5C 24 10 89 D8 E8 ?? ?? ?? ?? 83 EC 0C 8B 73 08 C7 43 08 00 00 00 00 53 E8 ?? ?? ?? ?? 83 C4 10 EB 1A 8B 5E 08 C6 86 41 01 00 00 01 C7 46 08 00 00 00 00 89 F0 89 DE E8 ?? ?? ?? ?? 85 F6 75 E2 5A 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule sem_trywait_332897ac00ae8d19161db1608ffc2eb7 {
	meta:
...
rule pthread_getschedparam_26e08ae21e31fbb8580070419a2701ea {
	meta:
		aliases = "__GI_pthread_getschedparam, pthread_getschedparam"
		size = "138"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 31 D2 53 83 EC 04 8B 74 24 10 89 F0 25 FF 03 00 00 C1 E0 04 8D 98 ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? 8B 43 08 85 C0 74 05 39 70 10 74 38 83 EC 0C 53 E8 ?? ?? ?? ?? B8 03 00 00 00 83 C4 10 EB 45 50 50 FF 74 24 20 56 E8 ?? ?? ?? ?? 83 C4 10 40 75 09 E8 ?? ?? ?? ?? 8B 00 EB 2A 8B 44 24 14 89 18 31 C0 EB 20 8B 70 14 83 EC 0C 53 E8 ?? ?? ?? ?? 89 34 24 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C3 75 BD EB CD 5B 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_pthread_cond_signal_0036150090a705282387549a518baa98 {
	meta:
		aliases = "pthread_cond_signal, __GI_pthread_cond_signal"
		size = "74"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 31 D2 53 83 EC 04 8B 74 24 10 89 F0 E8 ?? ?? ?? ?? 8B 5E 08 85 DB 74 0D 8B 43 08 89 46 08 C7 43 08 00 00 00 00 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 DB 74 0E C6 83 41 01 00 00 01 89 D8 E8 ?? ?? ?? ?? 5A 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule pthread_free_ee3c4267209c9c69c6a61511033ad56d {
	meta:
		aliases = "pthread_free"
		size = "194"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 31 D2 53 89 C6 83 EC 04 8B 58 10 81 E3 FF 03 00 00 C1 E3 04 81 C3 ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? 83 EC 0C C7 43 08 00 00 00 00 C7 43 0C FF FF FF FF 53 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 48 A3 ?? ?? ?? ?? 8B 86 48 01 00 00 EB 0D 8B 18 83 EC 0C 50 E8 ?? ?? ?? ?? 89 D8 83 C4 10 85 C0 75 EC 8B 86 4C 01 00 00 EB 10 8B 18 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 89 D8 85 C0 75 EC 81 FE ?? ?? ?? ?? 74 3A 83 BE 10 01 00 00 00 75 31 8B 86 18 01 00 00 85 C0 74 11 51 51 50 FF B6 14 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 52 52 68 00 00 20 00 8D 86 60 01 E0 FF 50 E8 ?? ?? ?? ?? 83 C4 10 5E 5B 5E C3 }
	condition:
		$pattern
}

rule sigwaitinfo_f186859f5c68ed036584959a1770f4a9 {
	meta:
		aliases = "__sigwaitinfo, __GI_sigwaitinfo, sigwaitinfo"
		size = "56"
		objfiles = "__rt_sigwaitinfo@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 31 D2 83 EC 08 BE 08 00 00 00 8B 4C 24 14 8B 44 24 10 53 89 C3 B8 B1 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule __GI_globfree_3e9560fbee530230acd5a885ce7f07b9 {
	meta:
		aliases = "globfree64, __GI_globfree64, globfree, __GI_globfree"
		size = "76"
...
rule __ieee754_log2_5300481bd45c81d504be853a1ff401e1 {
	meta:
		aliases = "log2, __ieee754_log2"
		size = "387"
		objfiles = "e_log2@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 31 F6 53 83 EC 24 DD 44 24 30 DD 14 24 DD 54 24 18 8B 4C 24 1C 8B 54 24 18 81 F9 FF FF 0F 00 7F 47 89 C8 25 FF FF FF 7F 09 D0 75 0F D9 C0 DE E1 D8 3D ?? ?? ?? ?? E9 41 01 00 00 DD D8 85 C9 79 0C DD 04 24 D8 E0 D8 F0 E9 2F 01 00 00 DD 04 24 BE CA FF FF FF D8 0D ?? ?? ?? ?? DD 14 24 DD 5C 24 10 8B 4C 24 14 EB 02 DD D8 81 F9 FF FF EF 7F 7E 0A DD 04 24 D8 C0 E9 00 01 00 00 89 CB DD 04 24 81 E3 FF FF 0F 00 8D 93 64 5F 09 00 81 E2 00 00 10 00 89 D0 35 00 00 F0 3F 09 D8 C1 F9 14 DD 5C 24 08 C1 FA 14 89 44 24 0C 8D 84 0E 01 FC FF FF 01 D0 50 8D 43 02 DB 04 24 83 C4 04 25 FF FF 0F 00 DD 44 24 08 83 }
	condition:
		$pattern
}

rule __ieee754_log_63f3470ea5d80d9455ca54bd4485ea37 {
	meta:
		aliases = "log, __GI_log, __ieee754_log"
		size = "520"
		objfiles = "e_log@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 31 F6 53 83 EC 24 DD 44 24 30 DD 14 24 DD 5C 24 18 8B 4C 24 1C 8B 54 24 18 81 F9 FF FF 0F 00 7F 45 89 C8 25 FF FF FF 7F 09 D0 75 0D D9 EE D8 3D ?? ?? ?? ?? E9 C8 01 00 00 85 C9 79 10 DD 04 24 D8 E0 DC 35 ?? ?? ?? ?? E9 B4 01 00 00 DD 04 24 BE CA FF FF FF D8 0D ?? ?? ?? ?? DD 14 24 DD 5C 24 10 8B 4C 24 14 81 F9 FF FF EF 7F 7E 0A DD 04 24 D8 C0 E9 89 01 00 00 89 CB DD 04 24 81 E3 FF FF 0F 00 8D 93 64 5F 09 00 81 E2 00 00 10 00 89 D0 35 00 00 F0 3F 09 D8 C1 F9 14 DD 5C 24 08 C1 FA 14 89 44 24 0C 8D 84 0E 01 FC FF FF 8D 0C 10 DD 44 24 08 8D 43 02 25 FF FF 0F 00 83 F8 02 DC 25 ?? ?? ?? ?? 7F 72 }
	condition:
		$pattern
}

rule strspn_eeb948c9f058b1c3b870bcea9e360217 {
	meta:
		aliases = "__GI_strspn, strspn"
		size = "42"
		objfiles = "strspn@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 31 F6 53 8B 44 24 0C EB 0F 38 CB 74 09 42 8A 0A 84 C9 75 F5 EB 0E 46 40 8A 18 84 DB 74 06 8B 54 24 10 EB EA 5B 89 F0 5E C3 }
	condition:
		$pattern
}

rule login_b116835bc7c12b3914e19a192d8d48d8 {
	meta:
		aliases = "login"
		size = "226"
		objfiles = "login@libutil.a"
	strings:
		$pattern = { ( CC | 56 ) 53 31 DB 81 EC B4 01 00 00 8D 44 24 0C 52 68 80 01 00 00 FF B4 24 C8 01 00 00 50 E8 ?? ?? ?? ?? 66 C7 44 24 1C 07 00 E8 ?? ?? ?? ?? 89 44 24 20 83 C4 10 8D B4 24 8E 01 00 00 EB 01 43 83 FB 03 74 13 50 6A 26 56 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 E9 EB 6E 50 6A 20 68 ?? ?? ?? ?? 8D 44 24 20 50 E8 ?? ?? ?? ?? EB 40 56 6A 1F 8D 84 24 9B 01 00 00 EB 0A 53 6A 1F 8D 84 24 96 01 00 00 50 8D 44 24 20 50 E8 ?? ?? ?? ?? 83 C4 10 C6 44 24 33 00 E8 ?? ?? ?? ?? 83 EC 0C 8D 44 24 18 50 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A 59 8D 44 24 14 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 81 C4 C4 01 00 00 5B 5E C3 50 6A 05 68 }
	condition:
		$pattern
}
...
rule remquo_7cd41d61db6695cfe360ee9ae739ea2b {
	meta:
		aliases = "__GI_remquo, remquo"
		size = "124"
		objfiles = "s_remquo@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 31 DB 83 EC 34 DD 44 24 40 8B 74 24 50 DD 5C 24 18 DD 44 24 48 DD 5C 24 10 DD 44 24 18 DD 5C 24 28 DD 44 24 10 8B 54 24 2C DD 5C 24 20 DD 44 24 18 DC 74 24 10 8B 44 24 24 C1 EA 1F C1 E8 1F 39 C2 0F 94 C3 8D 5C 1B FF DD 1C 24 E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? DD 44 24 10 83 E0 7F 0F AF C3 89 06 DD 5C 24 48 DD 44 24 18 DD 5C 24 40 83 C4 34 5B 5E E9 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule tmpfile64_4188dee6002e9b00f5dd13243113372c {
	meta:
		aliases = "tmpfile, tmpfile64"
		size = "137"
		objfiles = "tmpfile@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 04 10 00 00 68 ?? ?? ?? ?? 6A 00 68 FF 0F 00 00 8D 74 24 11 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 57 51 68 80 01 00 00 6A 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 78 40 83 EC 0C 56 E8 ?? ?? ?? ?? 58 5A 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 23 89 D9 87 CB B8 06 00 00 00 CD 80 87 CB 3D 00 F0 FF FF 89 C3 76 0D E8 ?? ?? ?? ?? F7 DB 89 18 EB 02 31 F6 81 C4 04 10 00 00 89 F0 5B 5E C3 }
	condition:
		$pattern
}
...
rule adjtime_99d855bd8a0c58db170f7fb3ee781ff9 {
	meta:
		aliases = "adjtime"
		size = "197"
		objfiles = "adjtime@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 84 00 00 00 8B 8C 24 90 00 00 00 8B B4 24 94 00 00 00 85 C9 74 44 8B 41 04 BB 40 42 0F 00 99 F7 FB 89 D3 89 C2 03 11 8D 82 61 08 00 00 3D C2 10 00 00 76 10 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 EB 72 69 C2 40 42 0F 00 C7 44 24 04 01 80 00 00 01 D8 89 44 24 08 EB 08 C7 44 24 04 00 00 00 00 83 EC 0C 8D 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 3D 31 D2 85 F6 74 37 8B 4C 24 08 85 C9 79 1A 89 C8 BB 40 42 0F 00 F7 D8 99 F7 FB 89 C8 F7 DA 89 56 04 99 F7 FB 89 C1 EB 11 89 C8 BA 40 42 0F 00 89 D3 99 F7 FB 89 C1 89 56 04 89 0E 31 D2 81 C4 84 00 00 00 89 D0 5B 5E C3 }
	condition:
		$pattern
}
...
rule _stdio_term_b1ab3169ee24a6356eb52a0b7008a86e {
	meta:
		aliases = "_stdio_term"
		size = "131"
		objfiles = "_stdio@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? 5E 58 EB 38 83 EC 0C 8D 73 38 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 14 8B 43 08 66 C7 03 30 00 89 43 18 89 43 1C 89 43 10 89 43 14 C7 43 34 01 00 00 00 56 E8 ?? ?? ?? ?? 8B 5B 20 59 85 DB 75 C4 8B 1D ?? ?? ?? ?? EB 14 F6 03 40 74 0C 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 8B 5B 20 85 DB 75 E8 5A 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_sbrk_920f697d6af899359cb45a5ef6151ba4 {
	meta:
...
rule __GI_sysconf_96e88744de8863305a8130baeb272506 {
	meta:
		aliases = "sysconf, __GI_sysconf"
		size = "448"
		objfiles = "sysconf@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 44 24 10 3D F0 00 00 00 77 11 FF 24 85 ?? ?? ?? ?? B8 01 00 00 00 E9 9B 01 00 00 E8 ?? ?? ?? ?? C7 00 16 00 00 00 E9 42 01 00 00 B8 64 00 00 00 E9 81 01 00 00 B8 00 00 01 00 E9 77 01 00 00 58 5B 5E E9 ?? ?? ?? ?? B8 06 00 00 00 E9 65 01 00 00 5E 5B 5E E9 ?? ?? ?? ?? B8 00 80 00 00 E9 53 01 00 00 B8 E8 03 00 00 E9 49 01 00 00 B8 00 40 00 00 E9 3F 01 00 00 83 EC 0C 31 F6 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 75 28 EB 44 66 81 78 12 04 63 75 1E 66 81 78 14 70 75 75 16 0F B6 50 16 A1 ?? ?? ?? ?? 0F B7 04 50 83 E0 08 83 F8 01 83 DE FF 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 }
	condition:
		$pattern
}

rule timer_settime_7f0bd938f71e6a270d813b0f9e45cf74 {
	meta:
		aliases = "timer_settime"
		size = "63"
		objfiles = "timer_settime@librt.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 44 24 10 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 58 04 89 D8 53 89 C3 B8 04 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 5B 5E C3 }
	condition:
		$pattern
}
...
rule ether_line_14721248b1f9145a01e0663926aa22ca {
	meta:
		aliases = "ether_line"
		size = "71"
		objfiles = "ethers@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 54 24 14 8B 44 24 10 8B 74 24 18 E8 ?? ?? ?? ?? 89 C3 83 C8 FF 85 DB 74 24 EB 17 80 F9 23 74 18 A1 ?? ?? ?? ?? 0F B6 D1 F6 04 50 20 75 0A 88 0E 43 46 8A 0B 84 C9 75 E3 C6 06 00 31 C0 5B 5B 5E C3 }
	condition:
		$pattern
}
...
rule ustat_456e90b8ba55c47fb1b7675457ee29ad {
	meta:
		aliases = "ustat"
		size = "52"
		objfiles = "ustat@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 5C 24 10 8B 4C 24 18 89 DA 87 D3 B8 3E 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 5B 5E C3 }
	condition:
		$pattern
}
...
rule __GI_mknod_ecc9170205b31d8a8863cec648392ca1 {
	meta:
		aliases = "mknod, __GI_mknod"
		size = "56"
		objfiles = "mknod@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 5C 24 18 8B 4C 24 14 8B 44 24 10 89 DA 53 89 C3 B8 0E 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 5B 5E C3 }
	condition:
		$pattern
}

rule seteuid_cf536b4e5af84c3c315cff82d88ed7c2 {
	meta:
...
rule __GI_xprt_unregister_fc978358d91d88946b3bcedf413f54be {
	meta:
		aliases = "xprt_unregister, __GI_xprt_unregister"
		size = "121"
		objfiles = "svc@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 74 24 10 8B 1E E8 ?? ?? ?? ?? 39 C3 7D 61 E8 ?? ?? ?? ?? 8D 14 9D 00 00 00 00 8B 80 B4 00 00 00 39 34 10 75 4A 81 FB FF 03 00 00 C7 04 10 00 00 00 00 7E 04 31 F6 EB 2E E8 ?? ?? ?? ?? 89 D9 89 DA C1 E9 05 83 E2 1F 0F B3 14 88 EB E7 E8 ?? ?? ?? ?? 8D 14 F5 00 00 00 00 03 10 39 1A 75 06 C7 02 FF FF FF FF 46 E8 ?? ?? ?? ?? 3B 30 7C DE 5B 5B 5E C3 }
	condition:
		$pattern
}

rule strsep_33ad1e3c101830e054300c53ed02310e {
	meta:
		aliases = "__GI_strsep, strsep"
		size = "96"
		objfiles = "strsep@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 74 24 10 8B 44 24 14 8B 1E 85 DB 74 47 8A 10 84 D2 74 3B 80 78 01 00 75 1D 8A 0B 89 D8 38 D1 74 21 84 C9 74 29 50 50 0F B6 C2 50 8D 43 01 50 E8 ?? ?? ?? ?? EB 09 51 51 50 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 08 C6 00 00 40 89 06 EB 06 C7 06 00 00 00 00 5A 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule xdr_callmsg_d13a8c310ddc6bef870fee3681ed0168 {
	meta:
		aliases = "__GI_xdr_callmsg, xdr_callmsg"
		size = "846"
		objfiles = "rpc_cmsg@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 74 24 10 8B 5C 24 14 83 3E 00 0F 85 E1 00 00 00 8B 53 20 81 FA 90 01 00 00 0F 87 1C 03 00 00 8B 43 2C 3D 90 01 00 00 0F 87 0E 03 00 00 51 83 C2 03 51 83 C0 03 8B 4E 04 83 E0 FC 83 E2 FC 8D 54 02 28 52 56 FF 51 18 83 C4 10 85 C0 89 C2 0F 84 9D 00 00 00 8B 03 0F C8 89 02 8B 43 04 0F C8 89 42 04 83 7B 04 00 0F 85 CF 02 00 00 8B 43 08 0F C8 89 42 08 83 7B 08 02 0F 85 BD 02 00 00 8B 43 0C 8D 72 20 0F C8 89 42 0C 8B 43 10 0F C8 89 42 10 8B 43 14 0F C8 89 42 14 8B 43 18 0F C8 89 42 18 8B 43 20 0F C8 89 42 1C 8B 43 20 85 C0 74 19 51 50 FF 73 1C 56 E8 ?? ?? ?? ?? 8B 43 20 83 C4 10 83 }
	condition:
		$pattern
}

rule _longjmp_7f4abd0851d75fdee71ce179f2eb7116 {
	meta:
		aliases = "__libc_siglongjmp, siglongjmp, __libc_longjmp, longjmp, _longjmp"
		size = "55"
...
rule getttynam_4192408b70ad20bb0697ee963935403e {
	meta:
		aliases = "getttynam"
		size = "55"
		objfiles = "getttyent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 74 24 10 E8 ?? ?? ?? ?? EB 11 50 50 FF 33 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0B E8 ?? ?? ?? ?? 85 C0 89 C3 75 E4 E8 ?? ?? ?? ?? 89 D8 5E 5B 5E C3 }
	condition:
		$pattern
}
...
rule res_sync_func_727f8c3ffedba84957878e8b10503585 {
	meta:
		aliases = "res_sync_func"
		size = "110"
		objfiles = "res_init@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 81 3D ?? ?? ?? ?? ?? ?? ?? ?? 89 C6 74 36 0F B6 40 60 39 05 ?? ?? ?? ?? 0F 46 05 ?? ?? ?? ?? 89 C3 A3 ?? ?? ?? ?? EB 19 6B C3 1C 52 6A 1C FF 74 9E 54 03 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 10 4B 79 E4 8A 46 52 84 C0 75 02 B0 05 A2 ?? ?? ?? ?? 8A 46 53 84 C0 75 02 B0 03 A2 ?? ?? ?? ?? 58 5B 5E C3 }
	condition:
		$pattern
}

rule _stdio_init_0946bf71d76e9870314350ca79fd247b {
	meta:
		aliases = "_stdio_init"
		size = "82"
		objfiles = "_stdio@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 83 EC 0C 8B 30 89 C3 6A 00 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 0E A1 ?? ?? ?? ?? 80 F4 01 66 A3 ?? ?? ?? ?? 83 EC 0C 6A 01 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 0E A1 ?? ?? ?? ?? 80 F4 01 66 A3 ?? ?? ?? ?? 89 33 58 5B 5E C3 }
	condition:
		$pattern
}

rule sethostid_28419c2bffcfe232223947dafe5c3ef8 {
	meta:
		aliases = "sethostid"
		size = "165"
		objfiles = "hostid@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 85 C0 75 09 E8 ?? ?? ?? ?? 85 C0 74 12 E8 ?? ?? ?? ?? C7 00 01 00 00 00 B8 01 00 00 00 EB 78 BB ?? ?? ?? ?? B9 41 00 00 00 BA A4 01 00 00 89 D8 53 89 C3 B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF EB 45 85 DB 78 41 BA 04 00 00 00 8D 4C 24 10 53 89 C3 B8 04 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0B E8 ?? ?? ?? ?? F7 DE 89 30 EB 07 31 D2 83 F8 04 74 03 83 CA FF 89 D9 87 CB B8 06 00 00 00 CD 80 87 CB 89 D0 5A 5B 5E C3 }
	condition:
		$pattern
}

rule __pthread_attr_setguardsize_d83c974d7a6908885f87f9753ebec218 {
	meta:
		aliases = "pthread_attr_setguardsize, __pthread_attr_setguardsize"
		size = "54"
		objfiles = "attr@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 8B 54 24 14 8B 5C 24 10 8D 54 10 FF 89 C6 89 D0 31 D2 F7 F6 89 C1 B8 16 00 00 00 0F AF CE 3B 4B 20 73 05 89 4B 14 30 C0 5B 5B 5E C3 }
	condition:
		$pattern
}

rule clntraw_freeres_cb3ce01b2676fbc6dfd3063c5908f385 {
	meta:
		aliases = "clntraw_freeres"
		size = "62"
		objfiles = "clnt_raw@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 8B 74 24 14 8B 5C 24 18 8B 80 A0 00 00 00 85 C0 74 19 C7 40 0C 02 00 00 00 83 C0 0C 89 F1 89 5C 24 14 89 44 24 10 5B 5B 5E FF E1 5A B8 10 00 00 00 5B 5E C3 }
	condition:
		$pattern
}
...
rule svcraw_freeargs_fab8600248a412d42e9652c6ae618ec0 {
	meta:
		aliases = "svcraw_freeargs"
		size = "64"
		objfiles = "svc_raw@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 8B 74 24 14 8B 5C 24 18 8B 80 BC 00 00 00 85 C0 74 1E C7 80 94 23 00 00 02 00 00 00 05 94 23 00 00 89 F1 89 5C 24 14 89 44 24 10 5B 5B 5E FF E1 5A 31 C0 5B 5E C3 }
	condition:
		$pattern
}

rule svcraw_reply_579abda6ec4b551f327f1fee915d5725 {
	meta:
		aliases = "svcraw_reply"
		size = "98"
		objfiles = "svc_raw@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 8B 98 BC 00 00 00 85 DB 74 48 C7 83 94 23 00 00 00 00 00 00 8D B3 94 23 00 00 51 51 8B 83 98 23 00 00 6A 00 56 FF 50 14 58 5A FF 74 24 1C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 17 8B 83 98 23 00 00 83 EC 0C 56 FF 50 10 B8 01 00 00 00 83 C4 10 EB 02 31 C0 5E 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_mempcpy_82148893339cd99e1dc6db22d11114e0 {
	meta:
...
rule xdrrec_getpos_687b7f473bde1b0b4eb6cfd002f895dd {
	meta:
		aliases = "xdrrec_getpos"
		size = "69"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 74 24 14 8B 5E 0C 6A 01 6A 00 FF 33 E8 ?? ?? ?? ?? 83 C4 10 89 C1 83 C8 FF 83 F9 FF 74 1D 8B 16 85 D2 74 05 4A 75 14 EB 0A 8B 43 10 2B 43 0C 01 C8 EB 08 89 C8 2B 43 30 03 43 2C 59 5B 5E C3 }
	condition:
		$pattern
}
...
rule dlinfo_ae015baa55c6248bfa883076af9663c1 {
	meta:
		aliases = "dlinfo"
		size = "221"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 0C 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? 83 C4 10 EB 2F FF 73 04 0F B7 43 20 50 8B 43 18 8D 04 85 ?? ?? ?? ?? 50 FF 73 1C 53 FF 33 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 5B 0C 83 C4 20 85 DB 75 CD 50 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? EB 19 8B 03 FF 70 04 50 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 5B 10 83 C4 10 85 DB 75 E0 8B 35 ?? ?? ?? ?? EB 39 50 89 F3 56 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? EB 19 8B 03 FF 70 04 50 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 5B }
	condition:
		$pattern
}
...
rule xdr_opaque_auth_a34ffbb1c931524c117261e99d5d45a3 {
	meta:
...
rule xdr_replymsg_2e83c2cd15fbbd6216d087224a9a6b0d {
	meta:
...
rule xdr_accepted_reply_6651e5240e46af8b7612e53d20501070 {
	meta:
...
rule __wcslcpy_aa5d1f8f32b3a50947add695212a1290 {
	meta:
		aliases = "wcsxfrm, __wcslcpy"
		size = "66"
		objfiles = "wcslcpy@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 44 24 24 8B 4C 24 1C 8B 74 24 20 85 C0 8D 58 FF 75 06 8D 4C 24 0C 31 DB 89 F2 EB 0B 85 DB 74 04 4B 83 C1 04 83 C2 04 8B 02 85 C0 89 01 75 ED 83 C4 10 29 F2 5B C1 FA 02 5E 89 D0 C3 }
	condition:
		$pattern
}

rule strlcpy_5f3d5198d069617a2c1546a336ce06cf {
	meta:
		aliases = "strxfrm, __GI_strlcpy, strlcpy"
		size = "59"
		objfiles = "strlcpy@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 44 24 24 8B 4C 24 1C 8B 74 24 20 85 C0 8D 58 FF 75 06 8D 4C 24 0F 31 DB 89 F2 EB 07 85 DB 74 02 4B 41 42 8A 02 84 C0 88 01 75 F1 83 C4 10 29 F2 5B 89 D0 5E C3 }
	condition:
		$pattern
}

rule fputs_unlocked_dde04e0e84154ddf5409548ff47f258c {
	meta:
...
rule pthread_key_delete_7099c5934d057ad90a94904706928692 {
	meta:
		aliases = "pthread_key_delete"
		size = "154"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 5C 24 1C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 81 FB FF 03 00 00 77 0A 83 3C DD ?? ?? ?? ?? 00 75 14 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? B8 16 00 00 00 EB 58 83 3D ?? ?? ?? ?? FF C7 04 DD ?? ?? ?? ?? 00 00 00 00 C7 04 DD ?? ?? ?? ?? 00 00 00 00 74 2A E8 ?? ?? ?? ?? 89 DE 83 E3 1F C1 EE 05 89 C2 80 7A 2C 00 75 0F 8B 4C B2 74 85 C9 74 07 C7 04 99 00 00 00 00 8B 12 39 C2 75 E5 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 C0 83 C4 14 5B 5E C3 }
	condition:
		$pattern
}
...
rule pthread_attr_setschedparam_633027be36e2431ac79e080045d37f93 {
	meta:
		aliases = "__GI_pthread_attr_setschedparam, pthread_attr_setschedparam"
		size = "61"
		objfiles = "attr@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 5C 24 1C FF 73 04 E8 ?? ?? ?? ?? 89 C6 58 FF 73 04 E8 ?? ?? ?? ?? 8B 54 24 24 83 C4 10 8B 12 39 C2 7C 0B 39 F2 7F 07 31 C0 89 53 08 EB 05 B8 16 00 00 00 5E 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "fgetpwent_r, __GI_fgetspent_r, fgetgrent_r, __GI_fgetgrent_r, fgetspent_r, __GI_fgetpwent_r"
		size = "55"
...
rule __GI_ftell_519d6b48fc6d3823748527299e8fb79e {
	meta:
...
rule __GI_getttyent_0398f651ff8945ec09b1916452a22cf8 {
	meta:
		aliases = "getttyent, __GI_getttyent"
		size = "668"
		objfiles = "getttyent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 83 3D ?? ?? ?? ?? 00 75 0F E8 ?? ?? ?? ?? 31 DB 85 C0 0F 84 77 02 00 00 83 3D ?? ?? ?? ?? 00 75 1E 83 EC 0C 68 00 10 00 00 E8 ?? ?? ?? ?? 83 C4 10 85 C0 A3 ?? ?? ?? ?? 75 05 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 53 83 C0 38 50 68 ?? ?? ?? ?? 8D 44 24 10 50 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C0 38 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 51 8B 1D ?? ?? ?? ?? FF 35 ?? ?? ?? ?? 68 00 10 00 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 07 31 DB E9 ED 01 00 00 52 52 6A 0A 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 30 8B 15 ?? ?? ?? ?? 8B 42 10 3B 42 18 73 09 0F B6 08 40 89 42 10 EB 0E 83 EC 0C 52 E8 ?? ?? ?? ?? 83 }
	condition:
		$pattern
}

rule __sigpause_46e301e31f46117eb1ee114c8744d648 {
	meta:
		aliases = "__GI___sigpause, __sigpause"
		size = "90"
		objfiles = "sigpause@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 83 7C 24 24 00 8B 74 24 20 74 24 51 8D 5C 24 10 53 6A 00 6A 00 E8 ?? ?? ?? ?? 58 5A 56 53 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 20 EB 0C C7 44 24 10 00 00 00 00 89 74 24 0C 83 EC 0C 8D 44 24 18 50 E8 ?? ?? ?? ?? 83 C4 10 89 C2 83 C4 14 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule dl_iterate_phdr_de7ce5ce4ab7568e9d057a3d270587ee {
	meta:
		aliases = "dl_iterate_phdr"
		size = "89"
		objfiles = "dl_iterate_phdr@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 15 ?? ?? ?? ?? 8B 74 24 20 8B 5C 24 24 85 D2 74 30 A1 ?? ?? ?? ?? C7 44 24 04 00 00 00 00 C7 44 24 08 ?? ?? ?? ?? 66 89 54 24 10 89 44 24 0C 51 53 6A 10 8D 44 24 10 50 FF D6 83 C4 10 85 C0 75 0C 52 52 53 56 E8 ?? ?? ?? ?? 83 C4 10 83 C4 14 5B 5E C3 }
	condition:
		$pattern
}
...
rule pthread_sigmask_d9ffc524607f0f03c45c31aa84ac6119 {
	meta:
		aliases = "pthread_sigmask"
		size = "173"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 44 24 24 8B 74 24 20 85 C0 74 79 8B 10 83 FE 01 8B 40 04 89 54 24 0C 89 44 24 10 74 4A 83 FE 02 74 06 85 F6 74 1E EB 58 51 51 FF 35 ?? ?? ?? ?? 8D 5C 24 18 53 E8 ?? ?? ?? ?? 58 5A FF 35 ?? ?? ?? ?? EB 0C 51 51 FF 35 ?? ?? ?? ?? 8D 5C 24 18 53 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 7E 1E 52 52 50 EB 0C 51 51 FF 35 ?? ?? ?? ?? 8D 5C 24 18 53 E8 ?? ?? ?? ?? 89 D8 83 C4 10 EB 04 8D 44 24 0C 52 FF 74 24 2C 50 56 E8 ?? ?? ?? ?? 83 C4 10 31 D2 40 75 07 E8 ?? ?? ?? ?? 8B 10 83 C4 14 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule mq_open_13ed512a7ddfbccab93aac11dce541c7 {
	meta:
		aliases = "mq_open"
		size = "100"
		objfiles = "mq_open@librt.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 20 8B 4C 24 24 80 3B 2F 74 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 3C F6 C1 40 75 06 31 D2 31 F6 EB 10 8B 54 24 28 8D 44 24 30 8B 74 24 2C 89 44 24 10 43 89 D8 53 89 C3 B8 15 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 14 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_uint64_t_51fb39dfb721a97060555d6852b7da42 {
	meta:
		aliases = "xdr_uint64_t"
		size = "189"
		objfiles = "xdr_intXX_t@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 20 8B 74 24 24 8B 03 83 F8 01 74 53 72 13 83 F8 02 BA 01 00 00 00 0F 84 91 00 00 00 E9 8A 00 00 00 8B 46 04 89 44 24 10 8B 06 89 44 24 0C 8D 44 24 10 52 52 8B 53 04 50 53 FF 52 24 83 C4 10 31 D2 85 C0 74 68 8D 44 24 0C 56 56 8B 53 04 50 53 FF 52 24 31 D2 83 C4 10 85 C0 0F 95 C2 EB 4E 8D 44 24 10 51 51 8B 53 04 50 53 FF 52 20 83 C4 10 85 C0 74 37 8D 44 24 0C 52 52 8B 53 04 50 53 FF 52 20 83 C4 10 85 C0 74 22 8B 44 24 10 31 D2 89 C2 B8 00 00 00 00 89 56 04 89 06 8B 4C 24 0C 89 56 04 BA 01 00 00 00 89 0E EB 02 31 D2 83 C4 14 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule xdr_int64_t_62f3e3da7547c393846b59de46765ae1 {
	meta:
		aliases = "xdr_int64_t"
		size = "189"
		objfiles = "xdr_intXX_t@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 20 8B 74 24 24 8B 03 83 F8 01 74 55 72 13 83 F8 02 BA 01 00 00 00 0F 84 91 00 00 00 E9 8A 00 00 00 8B 56 04 89 D0 89 44 24 10 8B 06 89 44 24 0C 50 50 8B 53 04 8D 44 24 18 50 53 FF 52 24 83 C4 10 31 D2 85 C0 74 66 8D 44 24 0C 56 56 8B 53 04 50 53 FF 52 24 31 D2 83 C4 10 85 C0 0F 95 C2 EB 4C 51 51 8B 43 04 8D 54 24 18 52 53 FF 50 20 83 C4 10 85 C0 74 35 8D 44 24 0C 52 52 8B 53 04 50 53 FF 52 20 83 C4 10 85 C0 74 20 8B 44 24 10 89 C2 B8 00 00 00 00 89 56 04 89 06 8B 4C 24 0C 89 56 04 BA 01 00 00 00 89 0E EB 02 31 D2 83 C4 14 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_xdr_u_hyper_8a5a366cdad91979fe20848b45c473e9 {
	meta:
...
rule __GI_xdr_hyper_b3605a153e494e1d1c85caac3e860d56 {
	meta:
		aliases = "xdr_hyper, __GI_xdr_hyper"
		size = "179"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 20 8B 74 24 24 8B 03 85 C0 75 3E 8B 56 04 89 D0 89 44 24 10 8B 06 89 44 24 0C 50 50 8B 53 04 8D 44 24 18 50 53 FF 52 04 83 C4 10 31 D2 85 C0 74 72 8D 44 24 0C 56 56 8B 53 04 50 53 FF 52 04 83 C4 10 85 C0 0F 95 C0 EB 53 83 F8 01 75 48 51 51 8B 43 04 8D 54 24 18 52 53 FF 10 83 C4 10 85 C0 74 3F 8D 44 24 0C 52 52 8B 53 04 50 53 FF 12 83 C4 10 85 C0 74 2B 8B 44 24 10 89 C2 B8 00 00 00 00 89 56 04 89 06 8B 4C 24 0C 89 56 04 BA 01 00 00 00 89 0E EB 0D 83 F8 02 0F 94 C0 0F B6 D0 EB 02 31 D2 83 C4 14 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule xdrrec_getint32_24df3a19c26c58155c95eef3e6d0295c {
	meta:
...
rule __des_crypt_250260b4613537a060ea6169944ecbf3 {
	meta:
		aliases = "__des_crypt"
		size = "387"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 20 8B 74 24 24 E8 ?? ?? ?? ?? 8D 54 24 04 89 D1 EB 0E 8A 03 00 C0 88 02 42 80 7A FF 01 83 DB FF 89 D0 29 C8 83 F8 08 75 E9 89 C8 E8 ?? ?? ?? ?? 8A 06 8A 56 01 88 44 24 03 A2 ?? ?? ?? ?? 8A 46 01 84 C0 75 04 8A 44 24 03 A2 ?? ?? ?? ?? 0F B6 C2 E8 ?? ?? ?? ?? 89 C3 0F B6 44 24 03 C1 E3 06 E8 ?? ?? ?? ?? 09 C3 89 D8 E8 ?? ?? ?? ?? 8D 4C 24 10 31 D2 6A 19 8D 44 24 10 50 31 C0 E8 ?? ?? ?? ?? 31 D2 59 5B 85 C0 0F 85 E5 00 00 00 8B 4C 24 10 8B 5C 24 0C C6 05 ?? ?? ?? ?? 00 89 C8 89 CA C1 E8 1A 8A 80 ?? ?? ?? ?? C1 EA 08 83 E2 3F A2 ?? ?? ?? ?? 89 C8 C1 E8 14 83 E0 3F 8A 80 ?? }
	condition:
		$pattern
}

rule ptrace_912633ee5750425a773c61bd0abe09ef {
	meta:
		aliases = "ptrace"
		size = "110"
		objfiles = "ptrace@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 20 8D 44 24 30 89 44 24 0C 8D 74 24 10 8B 4C 24 24 8B 54 24 28 8D 43 FF 83 F8 02 89 D8 0F 47 74 24 2C 53 89 C3 B8 1A 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0E E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF EB 1C 85 C0 78 18 85 DB 74 14 83 FB 03 77 0F E8 ?? ?? ?? ?? C7 00 00 00 00 00 8B 44 24 10 83 C4 14 5B 5E C3 }
	condition:
		$pattern
}
...
rule __GI___fputc_unlocked_37814e0cd8130bd524be30599725db3b {
	meta:
		aliases = "__GI_putc_unlocked, putc_unlocked, fputc_unlocked, __fputc_unlocked, __GI_fputc_unlocked, __GI___fputc_unlocked"
		size = "190"
		objfiles = "fputc_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 24 8B 74 24 20 8B 43 10 3B 43 1C 73 0D 89 F2 88 10 40 89 43 10 E9 8E 00 00 00 0F B7 03 25 C0 00 00 00 3D C0 00 00 00 74 14 52 52 68 80 00 00 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 70 83 7B 04 FE 74 63 8B 43 0C 3B 43 08 74 40 3B 43 10 75 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 4D 8B 43 10 89 F2 88 10 40 F6 43 01 01 89 43 10 74 35 80 FA 0A 75 30 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 20 FF 4B 10 EB 22 89 F1 88 4C 24 13 50 6A 01 8D 44 24 1B 50 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 07 89 F2 0F B6 C2 EB 03 83 C8 FF 83 C4 14 5B 5E C3 }
	condition:
		$pattern
}

rule pselect_6371b5e56158fee35dabecf30943a59a {
	meta:
		aliases = "pselect"
		size = "132"
		objfiles = "pselect@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 30 8B 74 24 34 85 DB 74 17 8B 03 BA E8 03 00 00 89 D1 89 44 24 0C 8B 43 04 99 F7 F9 89 44 24 10 85 F6 74 11 52 8D 44 24 08 50 56 6A 02 E8 ?? ?? ?? ?? 83 C4 10 8D 54 24 0C 31 C0 85 DB 0F 45 C2 83 EC 0C 50 FF 74 24 3C FF 74 24 3C FF 74 24 3C FF 74 24 3C E8 ?? ?? ?? ?? 83 C4 20 85 F6 89 C3 74 12 50 6A 00 8D 44 24 0C 50 6A 02 E8 ?? ?? ?? ?? 83 C4 10 83 C4 14 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule getc_bbdc3d7fc380d7d863393b4529cf21ba {
	meta:
...
rule getutline_ded94e4076628d71892eeb031ea0c98f {
	meta:
		aliases = "__GI_getutline, getutline"
		size = "113"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 18 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 10 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8B 74 24 20 83 C6 08 EB 1F 8B 03 83 E8 06 66 83 F8 01 77 14 50 6A 20 56 8D 43 08 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0B E8 ?? ?? ?? ?? 85 C0 89 C3 75 D6 51 51 6A 01 8D 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 24 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule getutent_5a6ac1b3b115cd17fed0c6c10f5be0b2 {
	meta:
		aliases = "__GI_getutent, getutent"
		size = "62"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 18 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 74 24 10 56 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 89 C3 58 6A 01 56 E8 ?? ?? ?? ?? 83 C4 24 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule readdir_8eabe4eb7c4125335b2685ab8c3dc4cd {
	meta:
		aliases = "__GI_readdir, readdir"
		size = "132"
		objfiles = "readdir@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 18 8B 74 24 24 8D 5E 18 53 68 ?? ?? ?? ?? 8D 44 24 10 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 46 08 3B 46 04 77 23 52 FF 76 14 FF 76 0C FF 36 E8 ?? ?? ?? ?? 83 C4 10 85 C0 7F 04 31 DB EB 26 89 46 08 C7 46 04 00 00 00 00 8B 46 04 89 C3 03 5E 0C 0F B7 53 08 01 C2 8B 43 04 89 56 04 89 46 10 83 3B 00 74 B9 50 50 6A 01 8D 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 24 89 D8 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_readdir64_989d580c821b18b73398f6aed891ecd3 {
	meta:
		aliases = "readdir64, __GI_readdir64"
		size = "134"
		objfiles = "readdir64@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 18 8B 74 24 24 8D 5E 18 53 68 ?? ?? ?? ?? 8D 44 24 10 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 46 08 3B 46 04 77 23 52 FF 76 14 FF 76 0C FF 36 E8 ?? ?? ?? ?? 83 C4 10 85 C0 7F 04 31 DB EB 28 89 46 08 C7 46 04 00 00 00 00 8B 56 04 89 D3 03 5E 0C 0F B7 43 10 01 D0 89 46 04 8B 43 08 89 46 10 8B 03 0B 43 04 74 B7 50 50 6A 01 8D 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 24 89 D8 5B 5E C3 }
	condition:
		$pattern
}

rule __pthread_wait_for_restart_sig_20b529b8f30009a7b59f90c9a9a9c959 {
	meta:
		aliases = "__pthread_wait_for_restart_signal"
		size = "76"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 18 8D 5C 24 10 8B 74 24 24 53 6A 00 6A 02 E8 ?? ?? ?? ?? 58 5A FF 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 C7 46 20 00 00 00 00 83 EC 0C 53 E8 ?? ?? ?? ?? 8B 46 20 83 C4 10 3B 05 ?? ?? ?? ?? 75 E9 83 C4 14 5B 5E C3 }
	condition:
		$pattern
}
...
rule erand48_r_4f3c40ae4c414f4bd1d948e079e126a6 {
	meta:
		aliases = "__GI_erand48_r, erand48_r"
		size = "132"
		objfiles = "erand48_r@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 1C C7 44 24 10 00 00 00 00 8B 74 24 28 C7 44 24 14 00 00 00 00 FF 74 24 2C 56 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 4F 0F B7 5E 02 0F B7 46 04 8B 54 24 0C 89 D9 C1 E0 04 C1 E9 0C 81 E2 FF FF 0F 00 09 C1 0F B7 06 81 CA 00 00 F0 3F 81 E2 00 00 F0 FF C1 E3 14 09 CA 89 54 24 0C 31 D2 C1 E0 04 09 C3 8B 44 24 28 89 5C 24 08 DD 44 24 08 DC 25 ?? ?? ?? ?? DD 18 83 C4 14 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_fesetenv_63bbfa6908ae9ac00d75ea3aa40fc441 {
	meta:
		aliases = "fesetenv, __GI_fesetenv"
		size = "255"
		objfiles = "fesetenv@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 20 8B 4C 24 2C D9 74 24 04 83 F9 FF 75 31 8B 44 24 04 C7 44 24 10 00 00 00 00 66 C7 44 24 14 00 00 83 C8 3D 80 E4 F3 66 89 44 24 04 8B 44 24 08 83 E0 C2 66 89 44 24 08 66 8B 44 24 16 EB 39 83 F9 FE 8B 54 24 04 8B 5C 24 08 66 8B 74 24 16 75 42 89 D0 25 C2 F3 FF FF 66 89 44 24 04 89 D8 83 E0 C2 66 89 44 24 08 89 F0 C7 44 24 10 00 00 00 00 66 C7 44 24 14 00 00 25 00 F8 FF FF 66 89 44 24 16 C7 44 24 18 00 00 00 00 66 C7 44 24 1C 00 00 EB 5C 8B 01 81 E2 C2 F3 FF FF 25 3D 0C 00 00 09 D0 89 DA 66 89 44 24 04 8B 41 04 83 E2 C2 83 E0 3D 09 D0 66 89 44 24 08 8B 41 0C 89 44 24 10 8B 41 10 66 }
	condition:
		$pattern
}

rule __error_f4e42e93e57c89f1cac3e464ea85c68b {
	meta:
...
rule pthread_onexit_process_03fafde33eec7daceb75ca8e8d90f7ef {
	meta:
		aliases = "pthread_onexit_process"
		size = "139"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 24 83 3D ?? ?? ?? ?? 00 78 77 E8 ?? ?? ?? ?? 8D 74 24 08 C7 44 24 0C 02 00 00 00 89 C3 89 44 24 08 8B 44 24 30 89 44 24 10 50 6A 1C 56 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E1 89 D8 E8 ?? ?? ?? ?? 3B 1D ?? ?? ?? ?? 75 2A 51 68 00 00 00 80 6A 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 C7 05 ?? ?? ?? ?? 00 00 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 83 C4 24 5B 5E C3 }
	condition:
		$pattern
}

rule pthread_create_6bd615e1e18a152612d6841ed320d552 {
	meta:
		aliases = "pthread_create"
		size = "157"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 24 83 3D ?? ?? ?? ?? 00 79 0E E8 ?? ?? ?? ?? BA 0B 00 00 00 85 C0 78 79 E8 ?? ?? ?? ?? C7 44 24 0C 00 00 00 00 89 44 24 08 89 C3 8B 44 24 34 89 44 24 10 8B 44 24 38 89 44 24 14 8B 44 24 3C 89 44 24 18 56 8D 44 24 20 50 6A 00 6A 02 E8 ?? ?? ?? ?? 83 C4 10 8D 74 24 08 51 6A 1C 56 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E1 89 D8 E8 ?? ?? ?? ?? 83 7B 34 00 75 09 8B 53 30 8B 44 24 30 89 10 8B 53 34 83 C4 24 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_tgamma_867fb17d86055635e0e2b5a76bb4241a {
	meta:
		aliases = "tgamma, __GI_tgamma"
		size = "169"
		objfiles = "e_lgamma_r@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 24 DD 44 24 30 DD 14 24 DD 54 24 08 8B 44 24 0C 8B 74 24 08 25 FF FF FF 7F 09 F0 75 08 DC 3D ?? ?? ?? ?? EB 7A DD D8 8B 5C 24 0C 85 DB 79 2D 81 FB FF FF EF FF 77 25 52 52 FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 10 DD 04 24 D9 C9 DF E9 75 08 7A 06 D8 E0 D8 F0 EB 45 DD D8 81 FB 00 00 F0 FF 75 0B 85 F6 75 07 DD 04 24 D8 E0 EB 30 50 8D 44 24 20 50 FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 1C FF 0F 9E C0 84 C0 D9 C0 D9 E0 DA C9 DD D9 83 C4 24 5B 5E C3 }
	condition:
		$pattern
}

rule atan_1330d91951f7ac849460e08bf4be9979 {
	meta:
		aliases = "__GI_atan, atan"
		size = "451"
		objfiles = "s_atan@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 24 DD 44 24 30 DD 54 24 08 DD 54 24 18 8B 74 24 1C 89 F3 81 E3 FF FF FF 7F 81 FB FF FF 0F 44 7E 39 DD 5C 24 10 81 FB 00 00 F0 7F 8B 44 24 10 7F 06 75 0F 85 C0 74 0B DD 44 24 08 D8 C0 E9 6F 01 00 00 85 F6 DD 05 ?? ?? ?? ?? 0F 9E C0 DD 05 ?? ?? ?? ?? 84 C0 E9 53 01 00 00 DD D8 81 FB FF FF DB 3F 7F 29 81 FB FF FF 1F 3E 0F 8F A6 00 00 00 DD 44 24 08 DC 05 ?? ?? ?? ?? D9 E8 D9 C9 DF E9 DD D8 0F 87 2D 01 00 00 E9 89 00 00 00 50 50 FF 74 24 14 FF 74 24 14 E8 ?? ?? ?? ?? 83 C4 10 81 FB FF FF F2 3F D9 C0 7F 39 81 FB FF FF E5 3F 7F 18 D9 C1 31 C0 DE C2 D9 C9 DC 25 ?? ?? ?? ?? D9 C9 D8 05 ?? }
	condition:
		$pattern
}

rule __pthread_do_exit_1eba1f13c4d1730648306b7267225c7b {
	meta:
		aliases = "__pthread_do_exit"
		size = "239"
		objfiles = "join@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 24 E8 ?? ?? ?? ?? 83 EC 0C C6 40 40 01 89 C3 C6 40 41 00 FF 74 24 40 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 43 1C 89 DA E8 ?? ?? ?? ?? 8B 44 24 40 83 C4 10 83 BB 24 01 00 00 00 89 43 30 74 2B A1 ?? ?? ?? ?? 0B 83 28 01 00 00 F6 C4 01 74 1B C7 83 30 01 00 00 09 00 00 00 89 9B 34 01 00 00 89 1D ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 EC 0C 8B 73 38 C6 43 2C 01 FF 73 1C E8 ?? ?? ?? ?? 83 C4 10 85 F6 74 0C 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 8B 35 ?? ?? ?? ?? 39 F3 75 49 83 3D ?? ?? ?? ?? 00 78 40 89 74 24 08 8D 5C 24 08 C7 44 24 0C 03 00 00 00 52 6A 1C 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 }
	condition:
		$pattern
}

rule if_indextoname_71113e65c7a3d7393f3ff1f2faea7412 {
	meta:
		aliases = "if_indextoname"
		size = "124"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 24 E8 ?? ?? ?? ?? 89 C3 31 C0 85 DB 78 64 8B 44 24 30 89 44 24 14 52 8D 74 24 08 56 68 10 89 00 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 27 E8 ?? ?? ?? ?? 89 D9 89 C6 8B 10 87 CB B8 06 00 00 00 CD 80 87 CB B9 06 00 00 00 83 FA 13 0F 44 D1 31 C0 89 16 EB 1D 89 D9 87 CB B8 06 00 00 00 CD 80 87 CB 50 6A 10 56 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 10 83 C4 24 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_if_nametoindex_a8ad4e146f5c65dd7de491489a0105bd {
	meta:
		aliases = "if_nametoindex, __GI_if_nametoindex"
		size = "97"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 24 E8 ?? ?? ?? ?? 89 C6 31 C0 85 F6 78 49 51 6A 10 FF 74 24 38 8D 5C 24 10 53 E8 ?? ?? ?? ?? 83 C4 0C 53 68 33 89 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 11 89 F1 87 CB B8 06 00 00 00 CD 80 87 CB 31 C0 EB 11 89 F1 87 CB B8 06 00 00 00 CD 80 87 CB 8B 44 24 14 83 C4 24 5B 5E C3 }
	condition:
		$pattern
}

rule __new_sem_post_7db2931ed9e069b249669a3ae2a8c50a {
	meta:
		aliases = "sem_post, __new_sem_post"
		size = "225"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 24 E8 ?? ?? ?? ?? 8B 74 24 30 83 78 54 00 75 74 89 C2 89 F0 E8 ?? ?? ?? ?? 83 7E 0C 00 75 32 8B 46 08 3D FF FF FF 7F 75 19 E8 ?? ?? ?? ?? 83 EC 0C C7 00 22 00 00 00 56 E8 ?? ?? ?? ?? 83 C8 FF EB 3D 40 83 EC 0C 89 46 08 56 E8 ?? ?? ?? ?? EB 2C 8B 5E 0C 85 DB 74 0D 8B 43 08 89 46 0C C7 43 08 00 00 00 00 83 EC 0C 56 E8 ?? ?? ?? ?? C6 83 42 01 00 00 01 89 1C 24 E8 ?? ?? ?? ?? 31 C0 83 C4 10 EB 53 83 3D ?? ?? ?? ?? 00 79 19 E8 ?? ?? ?? ?? 85 C0 79 10 E8 ?? ?? ?? ?? C7 00 0B 00 00 00 83 C8 FF EB 31 C7 44 24 0C 04 00 00 00 8D 5C 24 08 89 74 24 10 56 6A 1C 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? }
	condition:
		$pattern
}
...
rule pmap_set_d0193599b16b17dede3642d3920ec491 {
	meta:
...
rule __pthread_timedsuspend_new_a93e602477dbdc0b585f94e2fe7d62b7 {
	meta:
		aliases = "__pthread_timedsuspend_new"
		size = "240"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 5C 6A 01 8D 44 24 1C 50 E8 ?? ?? ?? ?? BA 01 00 00 00 83 C4 10 85 C0 0F 85 BC 00 00 00 8B 54 24 60 8D 44 24 10 C7 44 24 4C 00 00 00 00 C7 44 24 50 00 00 00 00 89 42 24 C7 42 20 00 00 00 00 53 53 FF 35 ?? ?? ?? ?? 8D 5C 24 58 53 E8 ?? ?? ?? ?? 83 C4 0C 8D 44 24 48 50 53 6A 01 E8 ?? ?? ?? ?? 83 C4 10 8D 74 24 3C 8D 5C 24 34 51 51 6A 00 56 E8 ?? ?? ?? ?? 8B 4C 24 74 69 44 24 50 E8 03 00 00 8B 51 04 8B 09 2B 4C 24 4C 29 C2 89 54 24 48 89 4C 24 44 83 C4 10 85 D2 79 11 8D 82 00 CA 9A 3B 89 44 24 38 8D 41 FF 89 44 24 34 83 7C 24 34 00 78 11 52 52 6A 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 }
	condition:
		$pattern
}

rule __GI_vsscanf_8876302da695eb8be78b4ec4f580177e {
	meta:
		aliases = "vsscanf, __GI_vsscanf"
		size = "125"
		objfiles = "vsscanf@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 60 8B 5C 24 6C 8D 44 24 48 8D 74 24 10 C7 44 24 14 FE FF FF FF 66 C7 44 24 10 A1 00 C6 44 24 12 00 C7 44 24 3C 00 00 00 00 C7 44 24 44 01 00 00 00 50 E8 ?? ?? ?? ?? 89 5C 24 24 89 5C 24 1C 89 1C 24 C7 44 24 34 00 00 00 00 E8 ?? ?? ?? ?? 83 C4 0C 89 5C 24 24 8D 04 03 89 44 24 14 89 44 24 1C 89 44 24 20 FF 74 24 6C FF 74 24 6C 56 E8 ?? ?? ?? ?? 83 C4 64 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_erf_8c6fdbc56bfa9ee92ff3a2861cad0caa {
	meta:
		aliases = "erf, __GI_erf"
		size = "856"
		objfiles = "s_erf@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 64 DD 44 24 70 DD 54 24 38 DD 54 24 48 8B 74 24 4C 89 F3 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7E 23 C1 EE 1F BA 01 00 00 00 8D 04 36 29 C2 52 DB 04 24 D9 C9 83 C4 04 DC 3D ?? ?? ?? ?? DE C1 E9 0A 03 00 00 DD D8 81 FB FF FF EA 3F 0F 8F A8 00 00 00 81 FB FF FF 2F 3E 7F 35 81 FB FF FF 7F 00 7F 21 DD 44 24 38 D8 0D ?? ?? ?? ?? DD 44 24 38 DC 0D ?? ?? ?? ?? DE C1 D8 0D ?? ?? ?? ?? E9 CB 02 00 00 DD 44 24 38 DC 0D ?? ?? ?? ?? EB 62 DD 44 24 38 D8 C8 DD 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? DD 05 ?? ?? ?? ?? D8 CA DC }
	condition:
		$pattern
}

rule __GI_asin_840155dd38d435ed8e4e4d71968036ef {
	meta:
		aliases = "__ieee754_asin, asin, __GI_asin"
		size = "548"
		objfiles = "e_asin@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 64 DD 44 24 70 DD 54 24 38 DD 54 24 50 8B 74 24 54 89 F3 81 E3 FF FF FF 7F 81 FB FF FF EF 3F 7E 36 DD 54 24 48 8D 83 00 00 10 C0 0B 44 24 48 75 17 DC 0D ?? ?? ?? ?? DD 44 24 38 DC 0D ?? ?? ?? ?? DE C1 E9 CA 01 00 00 DD D8 DD 44 24 38 D8 E0 D8 F0 E9 BB 01 00 00 DD D8 81 FB FF FF DF 3F 0F 8F 8F 00 00 00 81 FB FF FF 3F 3E 7F 1A DD 44 24 38 DC 05 ?? ?? ?? ?? D9 E8 D9 C9 DF E9 DD D8 0F 87 91 01 00 00 EB 6D DD 44 24 38 D8 C8 DD 05 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 DD 05 ?? ?? ?? ?? D8 }
	condition:
		$pattern
}

rule cbrt_287cde7cfee23fbaac9498e8aaf763c6 {
	meta:
		aliases = "__GI_cbrt, cbrt"
		size = "347"
		objfiles = "s_cbrt@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 74 DD 84 24 80 00 00 00 C7 44 24 18 00 00 00 00 DD 14 24 DD 54 24 58 8B 4C 24 5C 8B 5C 24 5C C7 44 24 1C 00 00 00 00 81 E1 FF FF FF 7F 81 E3 00 00 00 80 81 F9 FF FF EF 7F 7E 07 D8 C0 E9 05 01 00 00 DD D8 DD 04 24 DD 54 24 50 8B 44 24 50 09 C8 0F 84 F5 00 00 00 DD 5C 24 48 81 F9 FF FF 0F 00 89 4C 24 4C DD 44 24 48 7F 3D D9 EE BA 03 00 00 00 89 D6 31 D2 DD 5C 24 40 C7 44 24 44 00 00 50 43 DD 44 24 40 D8 C9 DD 54 24 38 8B 44 24 3C DD 5C 24 30 F7 F6 89 C1 81 C1 93 78 7F 29 89 4C 24 34 DD 44 24 30 EB 22 89 C8 BA 03 00 00 00 89 D6 99 F7 FE D9 EE DD 5C 24 28 89 C1 81 C1 93 78 9F 2A 89 4C }
	condition:
		$pattern
}
...
rule _ppfs_setargs_b7f34bb09f69e67a3300eb445e98a331 {
	meta:
		aliases = "_ppfs_setargs"
		size = "277"
		objfiles = "_ppfs_setargs@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 4C 24 0C 83 79 18 00 0F 85 B5 00 00 00 81 79 08 00 00 00 80 75 11 8B 41 4C 8D 50 04 8B 00 89 51 4C 89 41 50 89 41 08 81 79 04 00 00 00 80 8D 59 50 75 11 8B 41 4C 8D 50 04 8B 00 89 51 4C 89 41 50 89 41 04 31 F6 EB 73 8B 44 B1 28 46 83 F8 08 74 69 8B 51 4C 7F 0E 83 F8 02 74 52 7E 50 83 F8 07 75 4B EB 2B 3D 00 04 00 00 74 42 7E 40 3D 00 08 00 00 74 09 3D 07 08 00 00 75 32 EB 21 8D 42 08 89 41 4C 8B 02 8B 52 04 89 03 89 53 04 EB 28 8B 51 4C DD 02 8D 42 08 89 41 4C DD 1B EB 19 8B 51 4C DB 2A 8D 42 0C 89 41 4C DB 3B EB 0A 8D 42 04 89 41 4C 8B 02 89 03 83 C3 0C 3B 71 1C 7C 88 EB 2E 81 79 08 }
	condition:
		$pattern
}

rule wcsncpy_9bcee5df6e94ba19d33ecfc83f360e27 {
	meta:
		aliases = "wcsncpy"
		size = "43"
		objfiles = "wcsncpy@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 4C 24 10 8B 74 24 14 8B 5C 24 0C EB 10 8B 01 8D 51 04 85 C0 0F 45 CA 4E 89 03 83 C3 04 85 F6 75 EC 8B 44 24 0C 5B 5E C3 }
	condition:
		$pattern
}

rule re_match_dbe0af1c1dfae06a04059249e9bc41f8 {
	meta:
		aliases = "re_match"
		size = "53"
		objfiles = "regex_old@libc.a"
...
rule wcscspn_4f50783dfb3eda61ea239f2a7c03b564 {
	meta:
		aliases = "wcscspn"
		size = "46"
		objfiles = "wcscspn@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C 89 F0 EB 10 39 D9 74 18 83 C2 04 8B 0A 85 C9 75 F3 83 C0 04 8B 18 85 DB 74 06 8B 54 24 10 EB EB 5B 29 F0 C1 F8 02 5E C3 }
	condition:
		$pattern
}

rule wcsspn_09a702797af895da4157a54a396cb6f6 {
	meta:
...
rule __libc_pwrite64_c2d485262ef5fbcbba3479846c1fdea4 {
	meta:
...
rule shm_unlink_a0cf7ab1d41ec0a1730ef89d6ea71171 {
	meta:
		aliases = "shm_unlink"
		size = "51"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 56 ) 83 CE FF 53 83 EC 04 8B 44 24 10 E8 ?? ?? ?? ?? 85 C0 89 C3 74 16 83 EC 0C 50 E8 ?? ?? ?? ?? 89 1C 24 89 C6 E8 ?? ?? ?? ?? 83 C4 10 59 89 F0 5B 5E C3 }
	condition:
		$pattern
}
...
rule __libc_epoll_wait_5b1b385f9df22082d8b078ed7b926c2d {
	meta:
		aliases = "epoll_wait, __libc_epoll_wait"
		size = "57"
		objfiles = "epoll@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 00 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule __GI_openat_f2b818e77e529193a5411187c5a9adb6 {
	meta:
		aliases = "openat, __GI_openat"
		size = "57"
		objfiles = "openat@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 27 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule renameat_66118137ecf07e40cc9907a6b71fd012 {
	meta:
		aliases = "renameat"
		size = "57"
		objfiles = "renameat@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 2E 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule readlinkat_4bdeaa53f8aa56721fe7acf3a73ee7df {
	meta:
		aliases = "readlinkat"
		size = "57"
		objfiles = "readlinkat@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 31 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule fchmodat_a8966fbb60dbaaf8d3b2575322fc2520 {
	meta:
		aliases = "fchmodat"
		size = "57"
		objfiles = "fchmodat@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 32 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule faccessat_40812171f34cc64d3ab2eb08559d9df0 {
	meta:
		aliases = "faccessat"
		size = "57"
		objfiles = "faccessat@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 33 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule tee_36854e2431f1edd4fec7744ec9e84e93 {
	meta:
		aliases = "tee"
		size = "57"
		objfiles = "tee@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 3B 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule vmsplice_453d2985dcde0567ef1fdff2028553ec {
	meta:
		aliases = "vmsplice"
		size = "57"
		objfiles = "vmsplice@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 3C 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule __GI_utimensat_e381e03703ec2f70bb8ef03c513a090c {
	meta:
		aliases = "utimensat, __GI_utimensat"
		size = "57"
		objfiles = "utimensat@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 40 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule timerfd_settime_b565815448954a0aeacd1acc6563371e {
	meta:
		aliases = "timerfd_settime"
		size = "57"
		objfiles = "timerfd@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 45 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5A 5E C3 }
	condition:
		$pattern
}

rule __GI_wait4_11b24a1ec47bd6e5ac0fa431ceda6098 {
	meta:
		aliases = "wait4, __GI_wait4"
		size = "57"
		objfiles = "wait4@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 72 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule quotactl_876469bc9c102bfaaf94111935f9441b {
	meta:
		aliases = "quotactl"
		size = "57"
		objfiles = "quotactl@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 83 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule __syscall_rt_sigaction_ca71415406eef9f64a4d5134ee8a8bc2 {
	meta:
		aliases = "__syscall_rt_sigaction"
		size = "57"
		objfiles = "__syscall_rt_sigaction@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 AE 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule sendfile_3d28550b00973f6d4b4144fed9799190 {
	meta:
		aliases = "sendfile"
		size = "57"
		objfiles = "sendfile@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 BB 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule getxattr_aac99837ced9cb3fdd57a2befb23479a {
	meta:
		aliases = "getxattr"
		size = "57"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 E5 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule lgetxattr_013fd4435f7fbbbb984e7c0c359dfd77 {
	meta:
		aliases = "lgetxattr"
		size = "57"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 E6 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 59 5E 5E C3 }
	condition:
		$pattern
}

rule fgetxattr_7d9dd0402159876fef54b34f7709cb25 {
	meta:
		aliases = "fgetxattr"
		size = "57"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 E7 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5A 5E C3 }
	condition:
		$pattern
}

rule sendfile64_b4198900729be59b48449c62e10de40b {
	meta:
		aliases = "sendfile64"
		size = "57"
		objfiles = "sendfile64@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 EF 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule epoll_ctl_b3daa2f136d613154ec61de481441ab0 {
	meta:
		aliases = "epoll_ctl"
		size = "57"
		objfiles = "epoll@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 FF 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5A 5E C3 }
	condition:
		$pattern
}

rule fstatat_3bac4f4a20ce902803db444933ddee64 {
	meta:
		aliases = "fstatat64, fstatat"
		size = "83"
		objfiles = "fstatat@libc.a, fstatat64@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 68 8B 4C 24 74 8D 54 24 08 8B 74 24 7C 8B 44 24 70 53 89 C3 B8 2C 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0E E8 ?? ?? ?? ?? F7 DE 89 30 83 CE FF EB 16 85 C0 75 12 50 50 FF B4 24 80 00 00 00 52 E8 ?? ?? ?? ?? 83 C4 10 83 C4 68 89 F0 5E C3 }
	condition:
		$pattern
}

rule skip_3da9db5d5004c0e1abd7b282ba78b9bf {
	meta:
		aliases = "skip"
		size = "132"
		objfiles = "getttyent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 89 C2 53 31 F6 89 C3 EB 6B 80 F9 22 75 05 83 F6 01 EB 60 83 FE 01 75 0F 80 F9 5C 75 0A 80 7A 01 22 8D 42 01 0F 44 D0 8A 02 88 03 43 83 FE 01 74 42 80 F9 23 75 0C C6 05 ?? ?? ?? ?? 23 C6 02 00 EB 38 0F B6 C1 83 F8 09 74 0A 83 F8 20 74 05 80 F9 0A 75 1F 88 0D ?? ?? ?? ?? C6 02 00 42 8A 02 3C 09 0F B6 C8 74 F6 83 F9 20 74 F1 83 F9 0A 75 09 EB EA 42 8A 0A 84 C9 75 8F C6 43 FF 00 89 D0 5B 5E C3 }
	condition:
		$pattern
}
...
rule skip_input_bytes_1837195e8e76de41f176b9ae9da37f9b {
	meta:
		aliases = "skip_input_bytes"
		size = "62"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 89 C6 53 89 D3 83 EC 04 EB 26 8B 4E 2C 8B 46 30 29 C8 75 0D 89 F0 E8 ?? ?? ?? ?? 85 C0 75 11 EB 18 39 C3 89 C2 0F 4E D3 8D 04 11 29 D3 89 46 2C 85 DB 7F D6 B8 01 00 00 00 59 5B 5E C3 }
	condition:
		$pattern
}
...
rule __pthread_set_own_extricate_if_15fe20b0f009b98f21ee161d9596fd04 {
	meta:
		aliases = "__pthread_set_own_extricate_if"
		size = "59"
		objfiles = "join@libpthread.a, condvar@libpthread.a, oldsemaphore@libpthread.a, semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 89 D6 53 89 C3 83 EC 04 85 D2 74 08 80 78 40 00 75 24 EB 0A 8B 40 1C 89 DA E8 ?? ?? ?? ?? 85 F6 89 B3 44 01 00 00 75 0E 83 EC 0C FF 73 1C E8 ?? ?? ?? ?? 83 C4 10 58 5B 5E C3 }
	condition:
		$pattern
}
...
rule __GI_strchrnul_700e8ef0aa7b572b154b22a5db8a53d0 {
	meta:
...
rule __GI_strchr_a896babb1add290c02798b8a3eb170f5 {
	meta:
...
rule _dl_protect_relro_adced40660e2de549142bef0137bb7e1 {
	meta:
		aliases = "_dl_protect_relro"
		size = "130"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 56 ) A1 ?? ?? ?? ?? 53 8B 74 24 0C F7 D8 89 C3 8B 16 03 96 D4 00 00 00 89 D1 21 D3 03 8E D8 00 00 00 21 C1 39 CB 74 58 29 D9 BA 01 00 00 00 89 D8 53 89 C3 B8 7D 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C2 76 0A F7 DA 89 15 ?? ?? ?? ?? EB 04 85 C0 79 2D FF 76 04 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 31 C9 87 CB B8 01 00 00 00 CD 80 87 CB 83 C4 0C 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 5B 5E C3 }
	condition:
		$pattern
}

rule flush_out_1d39a4bc842b6ebd01a28c11d43b8bb2 {
	meta:
		aliases = "flush_out"
		size = "82"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 56 ) B9 00 00 00 80 53 89 C6 83 EC 08 B8 00 00 00 00 4A 8B 56 18 0F 45 C8 8B 46 10 29 D0 83 E8 04 09 C1 0F C9 89 0A 8B 46 0C 8B 5E 10 29 C3 53 50 FF 36 FF 56 08 31 D2 83 C4 10 39 D8 75 0E 8B 46 0C B2 01 89 46 18 83 C0 04 89 46 10 5B 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_opendir_63a029f963ec2ceccec2e0dc592da06b {
	meta:
		aliases = "opendir, __GI_opendir"
		size = "151"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 56 ) B9 00 08 09 00 53 83 EC 64 8B 54 24 70 87 D3 B8 05 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 89 C3 76 0D E8 ?? ?? ?? ?? F7 DB 31 F6 89 18 EB 60 31 F6 85 C0 78 5A 50 50 8D 44 24 14 50 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0F 89 D9 87 CB B8 06 00 00 00 CD 80 87 CB EB 37 51 6A 01 6A 02 53 E8 ?? ?? ?? ?? 8B 54 24 4C 89 D8 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 18 89 D9 87 CB B8 06 00 00 00 CD 80 87 CB E8 ?? ?? ?? ?? C7 00 0C 00 00 00 83 C4 64 89 F0 5B 5E C3 }
	condition:
		$pattern
}

rule updwtmp_2bbf635a45c092c7b32bae9054da00ce {
	meta:
		aliases = "__GI_updwtmp, updwtmp"
		size = "140"
		objfiles = "wtent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) B9 01 04 00 00 53 31 D2 83 EC 04 8B 44 24 10 53 89 C3 B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0B E8 ?? ?? ?? ?? F7 DE 89 30 EB 59 85 C0 78 55 51 6A 00 6A 01 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 43 BA 80 01 00 00 89 F0 8B 4C 24 14 53 89 C3 B8 04 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 09 E8 ?? ?? ?? ?? F7 DB 89 18 52 6A 00 6A 00 56 E8 ?? ?? ?? ?? 89 F1 87 CB B8 06 00 00 00 CD 80 87 CB 83 C4 10 58 5B 5E C3 }
	condition:
		$pattern
}

rule sched_getaffinity_c8e9e5b7291713f3f7a8bf54fad71682 {
	meta:
		aliases = "sched_getaffinity"
		size = "96"
		objfiles = "sched_getaffinity@libc.a"
	strings:
		$pattern = { ( CC | 56 ) B9 FF FF FF 7F 53 83 EC 04 8B 74 24 14 8B 44 24 10 8B 54 24 18 85 F6 0F 49 CE 53 89 C3 B8 F2 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF EB 1F 83 C8 FF 83 FB FF 74 17 29 DE 51 56 6A 00 8B 44 24 24 01 D8 50 E8 ?? ?? ?? ?? 31 C0 83 C4 10 5A 5B 5E C3 }
	condition:
		$pattern
}

rule signalfd_e406b4bded7340ff6f963adf137b5020 {
	meta:
		aliases = "signalfd"
		size = "58"
		objfiles = "signalfd@libc.a"
	strings:
		$pattern = { ( CC | 56 ) BA 08 00 00 00 83 EC 08 8B 4C 24 14 8B 74 24 18 8B 44 24 10 53 89 C3 B8 47 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule __GI_sigprocmask_8aa496bc2921a5e69f0d6308804281f9 {
	meta:
		aliases = "sigprocmask, __GI_sigprocmask"
		size = "58"
		objfiles = "sigprocmask@libc.a"
	strings:
		$pattern = { ( CC | 56 ) BE 08 00 00 00 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 AF 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule sigtimedwait_ec8486b266d5975c4a69d1bf36e092d1 {
	meta:
		aliases = "__GI_sigtimedwait, __sigtimedwait, sigtimedwait"
		size = "58"
		objfiles = "__rt_sigtimedwait@libc.a"
	strings:
		$pattern = { ( CC | 56 ) BE 08 00 00 00 83 EC 08 8B 4C 24 14 8B 54 24 18 8B 44 24 10 53 89 C3 B8 B1 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5E C3 }
	condition:
		$pattern
}

rule __GI_lockf_ad41319c8ff873a9e0d0629316b9fcb2 {
	meta:
		aliases = "lockf, __GI_lockf"
		size = "215"
		objfiles = "lockf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 53 83 EC 14 8D 4C 24 04 8B 5C 24 20 8B 54 24 24 89 CF AB AB AB AB 8B 44 24 28 83 FA 01 66 C7 44 24 06 01 00 C7 44 24 08 00 00 00 00 89 44 24 0C 74 58 7F 06 85 D2 74 49 EB 6C 83 FA 02 74 59 83 FA 03 75 62 66 C7 44 24 04 00 00 52 51 6A 05 53 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 6D 66 83 7C 24 04 02 74 63 8B 5C 24 10 E8 ?? ?? ?? ?? 39 C3 74 56 E8 ?? ?? ?? ?? C7 00 0D 00 00 00 EB 30 66 C7 44 24 04 02 00 EB 15 BA 07 00 00 00 66 C7 44 24 04 01 00 EB 1E 66 C7 44 24 04 01 00 BA 06 00 00 00 EB 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 CA FF EB 16 50 8D 44 24 08 50 52 53 E8 ?? ?? ?? ?? 83 C4 }
	condition:
		$pattern
}

rule timegm_6a4657f244dace2a92757c50fb116683 {
	meta:
		aliases = "timegm"
		size = "58"
		objfiles = "timegm@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 53 B9 0C 00 00 00 83 EC 34 8D 5C 24 04 89 DF F3 AB 50 50 68 ?? ?? ?? ?? 8D 44 24 20 50 E8 ?? ?? ?? ?? 83 C4 0C 53 6A 01 FF 74 24 4C E8 ?? ?? ?? ?? 83 C4 44 5B 5F C3 }
	condition:
		$pattern
}

rule __xstat_conv_3c63e5b56420e6f9c1e5590ede53f899 {
	meta:
		aliases = "__xstat_conv"
		size = "141"
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 53 B9 16 00 00 00 83 EC 04 8B 5C 24 14 8B 54 24 10 89 DF F3 AB 8B 02 C7 43 04 00 00 00 00 C7 43 24 00 00 00 00 89 03 8B 42 04 89 43 0C 0F B7 42 08 89 43 10 0F B7 42 0A 89 43 14 0F B7 42 0C 89 43 18 0F B7 42 0E 89 43 1C 0F B7 42 10 89 43 20 8B 42 14 89 43 2C 8B 42 18 89 43 30 8B 42 1C 89 43 34 8B 42 24 8B 4A 20 89 43 3C 89 4B 38 8B 42 2C 8B 4A 28 89 43 44 89 4B 40 8B 42 34 8B 4A 30 89 43 4C 89 4B 48 5A 5B 5F C3 }
	condition:
		$pattern
}

rule sigqueue_eb7e7790472e19808f181dec063be36e {
	meta:
		aliases = "sigqueue"
		size = "129"
		objfiles = "sigqueue@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 53 B9 20 00 00 00 81 EC 84 00 00 00 8D 5C 24 04 89 DF F3 AB 8B 84 24 94 00 00 00 C7 44 24 0C FF FF FF FF 89 44 24 04 E8 ?? ?? ?? ?? 89 44 24 10 E8 ?? ?? ?? ?? 8B 8C 24 94 00 00 00 89 DA 89 44 24 14 8B 84 24 98 00 00 00 89 44 24 18 8B 84 24 90 00 00 00 53 89 C3 B8 B2 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 81 C4 84 00 00 00 5B 5F C3 }
	condition:
		$pattern
}

rule __GI___dl_iterate_phdr_b4946b3de8d2f7c4df46e4ffe23e5c7d {
	meta:
		aliases = "__dl_iterate_phdr, __GI___dl_iterate_phdr"
		size = "85"
		objfiles = "dl_iterate_phdr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 56 53 83 EC 10 8B 7C 24 24 89 E6 8B 1D ?? ?? ?? ?? EB 34 8B 03 89 04 24 8B 43 04 89 44 24 04 8B 83 D0 00 00 00 89 44 24 08 8B 83 CC 00 00 00 66 89 44 24 0C 50 57 6A 10 56 FF 54 24 30 83 C4 10 85 C0 75 07 8B 5B 0C 85 DB 75 C8 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule strncasecmp_213d8e7c035beb9b05ae67906d89c3ed {
	meta:
		aliases = "__GI_strncasecmp, strncasecmp"
		size = "65"
		objfiles = "strncasecmp@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 56 53 8B 5C 24 10 8B 74 24 14 8B 7C 24 18 85 FF 74 28 39 F3 74 1A 8B 0D ?? ?? ?? ?? 0F B6 03 0F BF 14 41 0F B6 06 0F BF 04 41 29 C2 89 D0 75 0A 80 3B 00 74 05 4F 46 43 EB D4 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule strcat_41f9ad4adb30ab0bff966b9ff1513121 {
	meta:
		aliases = "__GI_strcat, strcat"
		size = "35"
		objfiles = "strcat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 56 83 C9 FF 83 EC 04 8B 74 24 14 8B 7C 24 10 F2 AE 4F AC AA 84 C0 75 FA 8B 44 24 10 5A 5E 5F C3 }
	condition:
		$pattern
}

rule __xstat32_conv_1506fce787c8e5132314106db22da633 {
	meta:
		aliases = "__xstat32_conv"
		size = "138"
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 56 B9 16 00 00 00 53 83 EC 04 8B 74 24 18 8B 5C 24 14 89 F7 F3 AB 8B 03 8B 53 04 89 06 89 56 04 8B 43 58 C7 46 24 00 00 00 00 89 46 0C 8B 43 10 89 46 10 8B 43 14 89 46 14 8B 43 18 89 46 18 8B 43 1C 89 46 1C 0F B7 43 20 89 46 20 8B 43 2C 89 46 2C 8B 43 34 89 46 30 8B 43 38 89 46 34 8B 53 40 8B 43 44 89 56 38 89 46 3C 8B 53 48 8B 43 4C 89 56 40 89 46 44 8B 53 50 8B 43 54 89 46 4C 89 56 48 59 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __xstat64_conv_15ed7a220802e842083f35aeea68e20f {
	meta:
		aliases = "__xstat64_conv"
		size = "163"
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 56 B9 18 00 00 00 53 83 EC 04 8B 74 24 18 8B 5C 24 14 89 F7 F3 AB 8B 03 8B 53 04 89 06 89 56 04 8B 43 58 8B 53 5C C7 46 24 00 00 00 00 89 46 58 8B 43 0C 89 56 5C 89 46 0C 8B 43 10 89 46 10 8B 43 14 89 46 14 8B 43 18 89 46 18 8B 43 1C 89 46 1C 0F B7 43 20 89 46 20 8B 43 2C 8B 53 30 C7 46 3C 00 00 00 00 89 46 2C 8B 43 34 89 56 30 89 46 34 8B 43 38 8B 53 40 89 46 38 8B 43 44 89 46 44 89 56 40 8B 53 48 8B 43 4C 89 56 48 89 46 4C 8B 53 50 8B 43 54 89 56 50 89 46 54 58 5B 5E 5F C3 }
	condition:
		$pattern
}

rule _ppfs_init_7d1a1a55556baae53187b5cd2958f5ef {
	meta:
		aliases = "_ppfs_init"
		size = "110"
		objfiles = "_ppfs_init@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 56 B9 2F 00 00 00 53 83 EC 10 8B 74 24 20 8B 5C 24 24 89 F7 F3 AB FF 4E 18 BA 09 00 00 00 8D 46 28 89 1E C7 00 08 00 00 00 83 C0 04 4A 75 F4 89 D8 EB 27 80 FA 25 75 21 40 80 38 25 74 1B 83 EC 0C 89 06 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 05 83 C8 FF EB 0F 8B 06 EB 01 40 8A 10 84 D2 75 D3 89 1E 31 C0 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule logwtmp_fbfd05a206b62173436786c58cb923c9 {
	meta:
		aliases = "logwtmp"
		size = "161"
		objfiles = "logwtmp@libutil.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 56 B9 60 00 00 00 53 81 EC 80 01 00 00 8B B4 24 94 01 00 00 89 E7 F3 AB 85 F6 74 07 80 3E 00 B0 07 75 05 B8 08 00 00 00 66 89 04 24 E8 ?? ?? ?? ?? 89 44 24 04 57 6A 1F FF B4 24 98 01 00 00 8D 44 24 14 8D 5C 24 0C 50 E8 ?? ?? ?? ?? 83 C4 0C 6A 1F 56 8D 44 24 38 50 E8 ?? ?? ?? ?? 83 C4 0C 68 FF 00 00 00 FF B4 24 A0 01 00 00 8D 44 24 58 50 E8 ?? ?? ?? ?? 59 5E 6A 00 8D 84 24 60 01 00 00 50 E8 ?? ?? ?? ?? 58 5A 53 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 81 C4 90 01 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule sigignore_e45e775918dd19aa76310d05de34fc9c {
	meta:
		aliases = "sigignore"
		size = "43"
		objfiles = "sigignore@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 83 EC 28 8D 54 24 14 89 D7 AB AB AB AB AB C7 44 24 14 01 00 00 00 50 6A 00 52 FF 74 24 3C E8 ?? ?? ?? ?? 83 C4 38 5F C3 }
	condition:
		$pattern
}

rule __GI_ctime_224181909b412f27d555899a9b7fc6a7 {
	meta:
		aliases = "ctime, __GI_ctime"
		size = "44"
		objfiles = "ctime@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 83 EC 38 B9 0B 00 00 00 8D 54 24 0C 89 D7 F3 AB 50 50 52 FF 74 24 4C E8 ?? ?? ?? ?? 89 04 24 E8 ?? ?? ?? ?? 83 C4 48 5F C3 }
	condition:
		$pattern
}

rule pthread_detach_d14d78d4267cdbce067738e42c9f8cbe {
	meta:
		aliases = "pthread_detach"
		size = "204"
		objfiles = "join@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 31 D2 56 53 83 EC 20 8B 7C 24 30 89 F8 25 FF 03 00 00 C1 E0 04 8D B0 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 8B 46 08 85 C0 74 05 39 78 10 74 10 83 EC 0C 56 E8 ?? ?? ?? ?? B8 03 00 00 00 EB 27 80 78 2D 00 74 10 83 EC 0C 56 E8 ?? ?? ?? ?? B8 16 00 00 00 EB 11 83 78 38 00 74 10 83 EC 0C 56 E8 ?? ?? ?? ?? 31 C0 83 C4 10 EB 5A 8A 58 2C 83 EC 0C C6 40 2D 01 56 E8 ?? ?? ?? ?? 83 C4 10 84 DB 74 41 83 3D ?? ?? ?? ?? 00 78 38 E8 ?? ?? ?? ?? 8D 5C 24 04 C7 44 24 08 01 00 00 00 89 7C 24 0C 89 44 24 04 56 6A 1C 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 E1 31 C0 83 C4 20 }
	condition:
		$pattern
}
...
rule pthread_rwlock_unlock_be985f24fb6b70304918fa75cd2f1046 {
	meta:
		aliases = "pthread_rwlock_unlock"
		size = "321"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 31 D2 56 53 8B 7C 24 10 89 F8 E8 ?? ?? ?? ?? 8B 5F 0C 85 DB 74 72 E8 ?? ?? ?? ?? 39 C3 75 70 83 7F 18 00 C7 47 0C 00 00 00 00 74 28 8B 5F 14 85 DB 74 21 8B 43 08 83 EC 0C 89 47 14 C7 43 08 00 00 00 00 57 E8 ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? 31 C0 EB 49 83 EC 0C 8B 77 10 C7 47 10 00 00 00 00 57 E8 ?? ?? ?? ?? 83 C4 10 EB 13 8B 5E 08 89 F0 C7 46 08 00 00 00 00 E8 ?? ?? ?? ?? 89 DE 85 F6 75 E9 E9 B2 00 00 00 8B 47 08 85 C0 75 16 83 EC 0C 57 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 10 E9 97 00 00 00 48 31 DB 85 C0 89 47 08 75 14 8B 5F 14 85 DB 74 0D 8B 43 08 89 47 14 C7 43 08 00 00 00 00 83 EC 0C 57 }
	condition:
		$pattern
}
...
rule __GI_ether_aton_r_c94a404ef3597e2034484bf5481d8ca6 {
	meta:
		aliases = "ether_aton_r, __GI_ether_aton_r"
		size = "171"
		objfiles = "ether_addr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 FF 56 53 83 EC 04 8B 4C 24 14 8B 74 24 18 E9 82 00 00 00 8A 01 3C 1F 0F 86 83 00 00 00 88 C2 80 CA 20 88 D3 80 EB 30 80 FB 09 76 08 88 D0 2C 61 3C 05 77 6C 80 FA 39 88 5C 24 03 76 07 80 EA 57 88 54 24 03 8A 41 01 83 C1 02 83 FF 05 74 04 3C 3A EB 02 84 C0 74 36 88 C2 80 CA 20 88 D3 80 EB 30 80 FB 09 76 08 88 D0 2C 61 3C 05 77 32 80 FA 39 88 D8 76 04 88 D0 2C 57 C0 64 24 03 04 00 44 24 03 83 FF 05 74 06 80 39 3A 75 14 41 8A 44 24 03 88 04 3E 47 83 FF 05 0F 8E 75 FF FF FF EB 02 31 F6 5A 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule waitid_5a1e3c7b0632b6717402088218f6c019 {
	meta:
		aliases = "waitid"
		size = "60"
		objfiles = "waitid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 FF 56 83 EC 04 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 1C 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 5E 5F C3 }
	condition:
		$pattern
}

rule sigaction_81a579fbc42273d774fcf9cfd3c69295 {
	meta:
		aliases = "__libc_sigaction, __GI_sigaction, sigaction"
		size = "81"
		objfiles = "sigaction@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 FF 56 83 EC 34 8B 54 24 44 85 D2 74 2C 8D 4C 24 20 89 D6 89 CF A5 A5 A5 A5 A5 81 4C 24 24 00 00 00 04 B8 ?? ?? ?? ?? 89 CF F6 42 04 04 BA ?? ?? ?? ?? 0F 44 C2 89 44 24 28 6A 08 FF 74 24 4C 57 FF 74 24 4C E8 ?? ?? ?? ?? 83 C4 44 5E 5F C3 }
	condition:
		$pattern
}

rule logout_8b4a0124f20757f907ff3cc435394d88 {
	meta:
		aliases = "logout"
		size = "142"
		objfiles = "logout@libutil.a"
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 84 01 00 00 E8 ?? ?? ?? ?? 66 C7 44 24 04 07 00 52 6A 20 FF B4 24 98 01 00 00 8D 44 24 18 8D 5C 24 10 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 74 3F 31 C0 B9 08 00 00 00 8D 7B 2C F3 AB B9 40 00 00 00 8D 7B 4C F3 AB 50 50 6A 00 8D 83 54 01 00 00 50 E8 ?? ?? ?? ?? 66 C7 03 08 00 89 1C 24 BB 01 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 02 31 DB E8 ?? ?? ?? ?? 81 C4 84 01 00 00 89 D8 5B 5F C3 }
	condition:
		$pattern
}

rule __pthread_kill_other_threads_n_127b807f6ca8995a3353ec6f9a547bc9 {
	meta:
		aliases = "pthread_kill_other_threads_np, __pthread_kill_other_threads_np"
		size = "97"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 2C 6A 00 6A 00 8D 5C 24 20 E8 ?? ?? ?? ?? 89 DF E8 ?? ?? ?? ?? 31 C0 AB AB AB AB AB 83 C4 0C 6A 00 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 6A 00 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 7E 0D 52 6A 00 53 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 24 5B 5F C3 }
	condition:
		$pattern
}

rule sigset_a02c6dbe3fb0f092c571e0d799828497 {
	meta:
		aliases = "sigset"
		size = "197"
		objfiles = "sigset@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 34 8B 54 24 44 8B 5C 24 40 83 FA FF 74 09 85 DB 7E 05 83 FB 40 7E 13 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 E9 8F 00 00 00 83 FA 02 75 31 C7 44 24 2C 00 00 00 00 C7 44 24 30 00 00 00 00 51 51 53 8D 5C 24 38 53 E8 ?? ?? ?? ?? 83 C4 0C 6A 00 53 6A 00 E8 ?? ?? ?? ?? BA 02 00 00 00 EB 56 8D 4C 24 18 31 C0 89 CF AB AB AB AB AB 89 54 24 18 52 8D 44 24 08 50 51 53 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 31 C7 44 24 2C 00 00 00 00 C7 44 24 30 00 00 00 00 50 50 53 8D 5C 24 38 53 E8 ?? ?? ?? ?? 83 C4 0C 6A 00 53 6A 01 E8 ?? ?? ?? ?? 8B 54 24 14 83 C4 10 83 C4 34 89 D0 5B 5F C3 }
	condition:
		$pattern
}
...
rule strcspn_a654a3750f115587d24d348acf958e70 {
	meta:
		aliases = "__GI_strcspn, strcspn"
		size = "48"
		objfiles = "strcspn@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 31 F6 53 8B 5C 24 10 8B 7C 24 14 EB 15 52 0F B6 C0 52 50 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 08 43 46 8A 03 84 C0 75 E5 5B 89 F0 5E 5F C3 }
	condition:
		$pattern
}

rule xdr_vector_37d2fae2f6b8c048b0429604c58e0c4b {
	meta:
		aliases = "xdr_vector"
		size = "51"
		objfiles = "xdr_array@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 31 F6 53 8B 7C 24 10 8B 5C 24 14 EB 15 50 6A FF 53 57 FF 54 24 30 83 C4 10 85 C0 74 10 03 5C 24 1C 46 3B 74 24 18 72 E5 B8 01 00 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}

rule encrypt_186000ef89c2f299268c9792956790f3 {
	meta:
		aliases = "encrypt"
		size = "156"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 DB 83 EC 10 8B 7C 24 20 E8 ?? ?? ?? ?? 31 C0 E8 ?? ?? ?? ?? 89 F9 EB 24 31 D2 C7 44 9C 08 00 00 00 00 EB 12 F6 01 01 74 0B 8B 04 95 ?? ?? ?? ?? 09 44 9C 08 41 42 83 FA 1F 7E E9 43 83 FB 01 7E D7 83 7C 24 24 01 8B 54 24 0C 8D 4C 24 08 8B 44 24 08 19 DB 83 E3 02 4B 53 8D 5C 24 10 53 31 DB E8 ?? ?? ?? ?? 58 5A EB 1A 89 CA 8B 44 9C 08 09 F2 85 04 8D ?? ?? ?? ?? 0F 95 04 17 41 83 F9 1F 7E E7 43 83 FB 01 7F 09 89 DE 31 C9 C1 E6 05 EB D8 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pathconf_2d1b793146648ad9744dfd09d7ffa0c8 {
	meta:
		aliases = "pathconf"
		size = "216"
		objfiles = "pathconf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 81 EC A0 00 00 00 8B B4 24 B0 00 00 00 8B 84 24 B4 00 00 00 80 3E 00 75 10 E8 ?? ?? ?? ?? C7 00 02 00 00 00 E9 91 00 00 00 83 F8 13 77 11 FF 24 85 ?? ?? ?? ?? B8 20 00 00 00 E9 8C 00 00 00 E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 6E B8 7F 00 00 00 EB 78 E8 ?? ?? ?? ?? 8B 38 89 C3 52 52 8D 44 24 68 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 09 83 3B 26 75 45 89 3B EB 3A 8B 84 24 84 00 00 00 EB 49 31 C0 EB 45 50 50 8D 44 24 10 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 20 8B 44 24 18 25 00 F0 00 00 3D 00 80 00 00 74 1C 3D 00 60 00 00 75 09 EB 13 B8 FF 00 00 00 EB 11 83 C8 FF EB 0C B8 00 10 00 00 EB }
	condition:
		$pattern
}

rule fpathconf_0a8592b8f59fede1e65b009643a61a2e {
	meta:
		aliases = "fpathconf"
		size = "224"
		objfiles = "fpathconf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 81 EC A0 00 00 00 8B B4 24 B0 00 00 00 8B 94 24 B4 00 00 00 85 F6 79 10 E8 ?? ?? ?? ?? C7 00 09 00 00 00 E9 9A 00 00 00 85 D2 B8 7F 00 00 00 0F 84 9E 00 00 00 8D 42 FF 83 F8 12 77 11 FF 24 85 ?? ?? ?? ?? B8 20 00 00 00 E9 85 00 00 00 E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 67 E8 ?? ?? ?? ?? 8B 38 89 C3 52 52 8D 44 24 68 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 09 83 3B 26 75 45 89 3B EB 3A 8B 84 24 84 00 00 00 EB 49 31 C0 EB 45 50 50 8D 44 24 10 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 20 8B 44 24 18 25 00 F0 00 00 3D 00 80 00 00 74 1C 3D 00 60 00 00 75 09 EB 13 B8 FF 00 00 00 EB 11 83 C8 FF }
	condition:
		$pattern
}

rule ether_hostton_ee80dd928eefcdfb1a976e2c8dabcbdb {
	meta:
		aliases = "ether_hostton"
		size = "132"
		objfiles = "ethers@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 CB FF 81 EC 08 01 00 00 8B BC 24 18 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 74 4D EB 26 8B 94 24 14 01 00 00 89 E0 E8 ?? ?? ?? ?? 85 C0 74 16 52 52 50 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 06 31 DB EB 19 89 E3 50 56 68 00 01 00 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 C4 83 CB FF 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 81 C4 00 01 00 00 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule div_8d91be5c1bbdf76f0fffcdc4b9d97509 {
	meta:
		aliases = "div"
		size = "44"
		objfiles = "div@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 04 8B 4C 24 18 8B 7C 24 1C 8B 74 24 14 89 C8 99 F7 FF 89 FA 0F AF D0 89 06 89 F0 29 D1 89 4E 04 5A 5B 5E 5F C2 04 00 }
	condition:
		$pattern
}
...
rule gets_960da78cd5a63b26779541e839586328 {
	meta:
		aliases = "gets"
		size = "135"
		objfiles = "gets@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 15 ?? ?? ?? ?? 8B 74 24 20 83 7A 34 00 0F 94 C0 0F B6 F8 85 FF 75 04 89 F3 EB 2A 8D 42 38 51 50 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C0 38 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 EB D3 43 E8 ?? ?? ?? ?? 83 F8 FF 89 C2 74 0A 3C 0A 88 13 75 ED 39 DE 75 04 31 F6 EB 03 C6 03 00 85 FF 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule puts_80522086414dd80476f166255103cbb4 {
	meta:
		aliases = "puts"
		size = "132"
		objfiles = "puts@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 35 ?? ?? ?? ?? 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 53 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 51 51 56 FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C3 74 17 52 52 56 6A 0A E8 ?? ?? ?? ?? 8D 53 01 83 C4 10 83 CB FF 40 0F 45 DA 85 FF 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule putchar_7215cd3e74d523dbbf28567838d271a3 {
	meta:
		aliases = "putchar"
		size = "152"
		objfiles = "putchar@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 35 ?? ?? ?? ?? 8B 7C 24 20 83 7E 34 00 74 24 8B 56 10 3B 56 1C 73 0F 89 F8 88 02 0F B6 D8 8D 42 01 89 46 10 EB 62 53 53 56 57 E8 ?? ?? ?? ?? 89 C3 EB 52 8D 5E 38 51 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 8B 56 10 83 C4 10 3B 56 1C 73 0F 89 F8 88 02 0F B6 D8 8D 42 01 89 46 10 EB 0E 52 52 56 57 E8 ?? ?? ?? ?? 83 C4 10 89 C3 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule dlsym_240bd1a24985cde5c06d87a95687ed66 {
	meta:
		aliases = "dlsym"
		size = "194"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 4C 24 20 C7 44 24 08 00 00 00 00 C7 44 24 0C 00 00 00 00 85 C9 75 08 8B 15 ?? ?? ?? ?? EB 5A 83 F9 FF 89 CA 74 28 3B 0D ?? ?? ?? ?? 74 4B A1 ?? ?? ?? ?? EB 07 39 C8 74 40 8B 40 04 85 C0 75 F5 31 D2 C7 05 ?? ?? ?? ?? 0A 00 00 00 EB 64 8B 7C 24 1C 31 F6 A1 ?? ?? ?? ?? EB 1A 8B 18 8B 4B 14 39 F9 73 0E 85 F6 74 05 39 4E 14 73 05 8B 50 10 89 DE 8B 40 10 85 C0 75 E2 31 C9 3B 15 ?? ?? ?? ?? 75 02 8B 0A 8D 44 24 08 50 68 00 00 00 80 51 52 FF 74 24 34 E8 ?? ?? ?? ?? 83 C4 14 89 C2 B8 0B 00 00 00 85 D2 0F 45 05 ?? ?? ?? ?? A3 ?? ?? ?? ?? 83 C4 10 89 D0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule calloc_316263fb82d11a95b81fdf49d07277c5 {
	meta:
		aliases = "calloc"
		size = "244"
		objfiles = "calloc@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 4C 24 24 8B 54 24 20 89 CB 0F AF DA 85 D2 74 1E 89 D7 89 D8 31 D2 F7 F7 39 C1 74 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 B6 00 00 00 56 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 74 73 8B 40 FC A8 02 75 6C 83 E0 FC 8D 50 FC 89 D0 C1 E8 02 83 F8 09 76 0F 51 52 6A 00 53 E8 ?? ?? ?? ?? 83 C4 10 EB 4D 83 F8 04 C7 03 00 00 00 00 C7 43 04 00 00 00 00 C7 43 08 00 00 00 00 76 34 83 F8 06 C7 43 0C 00 00 00 00 C7 43 10 00 00 00 00 76 21 83 F8 09 C7 43 14 00 00 00 00 C7 43 18 00 00 }
	condition:
		$pattern
}

rule __libc_lseek64_cbe320fc1c553c55b12ae25dd6759e01 {
	meta:
		aliases = "lseek64, __GI_lseek64, __libc_lseek64"
		size = "84"
		objfiles = "llseek@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 5C 24 28 8D 74 24 08 8B 7C 24 2C 8B 44 24 20 8B 54 24 24 89 D9 53 89 C3 B8 8C 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0E E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF EB 04 85 C0 74 03 99 EB 08 8B 44 24 08 8B 54 24 0C 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule vfwprintf_3c7d0f8685a44f9fd0f510e17432a462 {
	meta:
		aliases = "__GI_vfwprintf, vfwprintf"
		size = "143"
		objfiles = "vfwprintf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 53 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 40 08 00 00 3D 40 08 00 00 74 17 51 83 CB FF 51 68 00 08 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 14 52 FF 74 24 2C FF 74 24 2C 56 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 FF 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule vfprintf_961c6882b239b75a0ed0b57b19286bff {
	meta:
		aliases = "__GI_vfprintf, vfprintf"
		size = "143"
		objfiles = "vfprintf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 53 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 C0 00 00 00 3D C0 00 00 00 74 17 51 83 CB FF 51 68 80 00 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 14 52 FF 74 24 2C FF 74 24 2C 56 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 FF 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule rewind_feaf1b712804f7b362da7e07ecc0124f {
	meta:
		aliases = "__GI_rewind, rewind"
		size = "105"
		objfiles = "rewind@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 51 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 06 83 E0 F7 66 89 06 52 6A 00 6A 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 FF 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_fileno_39649a304ac71cdf4f647408584c6ce2 {
	meta:
		aliases = "getwc, fgetwc, __GI_fgetwc, fileno, __GI_fileno"
		size = "99"
		objfiles = "fgetwc@libc.a, fileno@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 FF 89 C3 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule feof_2f2bb0373fe7d70a6670aabb2ae56c37 {
	meta:
		aliases = "feof"
		size = "91"
		objfiles = "feof@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 85 FF 0F B7 1E 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 83 E3 04 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule ferror_a349cf5854b78017797f0419a87daa6c {
	meta:
		aliases = "ferror"
		size = "91"
		objfiles = "ferror@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 85 FF 0F B7 1E 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 83 E3 08 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule clearerr_2ea51ae3524a8f41c8f1a08c1d26c84a {
	meta:
		aliases = "clearerr"
		size = "91"
		objfiles = "clearerr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 06 83 E0 F3 85 FF 66 89 06 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule fflush_5359160e89a01786807f009b200932f8 {
	meta:
		aliases = "__GI_fflush, fflush"
		size = "124"
		objfiles = "fflush@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 85 F6 74 57 81 FE ?? ?? ?? ?? 74 4F 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 FF 89 C3 74 1E 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? EB 0B 83 EC 0C 56 E8 ?? ?? ?? ?? 89 C3 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_xdr_string_c7abd46001f04fac00be22df6c194749 {
	meta:
		aliases = "xdr_string, __GI_xdr_string"
		size = "222"
		objfiles = "xdr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 8B 7C 24 24 8B 06 8B 1F 85 C0 74 0E 83 F8 02 75 21 85 DB 75 0D E9 AA 00 00 00 85 DB 0F 84 A9 00 00 00 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 89 44 24 0C 50 50 8D 44 24 14 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 81 00 00 00 8B 44 24 0C 3B 44 24 28 77 77 8B 16 83 FA 01 74 09 72 40 83 FA 02 75 69 EB 47 40 74 5D 85 DB 75 2A 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 89 07 75 16 50 50 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 C0 EB 2A 8B 44 24 0C C6 04 03 00 50 FF 74 24 10 53 56 E8 ?? ?? ?? ?? EB 14 83 EC 0C 53 E8 ?? ?? ?? ?? B8 01 00 00 00 C7 07 00 00 00 }
	condition:
		$pattern
}

rule fputwc_93c608f5c03035cb7b8ea2b514c58aa7 {
	meta:
		aliases = "fputws, putwc, __GI_fputs, fputs, __GI_fputws, fputwc"
		size = "102"
		objfiles = "fputws@libc.a, fputwc@libc.a, fputs@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 24 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 51 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 52 52 56 FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 85 FF 89 C3 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule putc_281b52666df515955cee9f93dd40e500 {
	meta:
		aliases = "__GI_fputc, __GI_putc, fputc, putc"
		size = "150"
		objfiles = "fputc@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 24 8B 7C 24 20 83 7E 34 00 74 24 8B 56 10 3B 56 1C 73 0F 89 F8 88 02 0F B6 D8 8D 42 01 89 46 10 EB 62 53 53 56 57 E8 ?? ?? ?? ?? 89 C3 EB 52 8D 5E 38 51 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 8B 56 10 83 C4 10 3B 56 1C 73 0F 89 F8 88 02 0F B6 D8 8D 42 01 89 46 10 EB 0E 52 52 56 57 E8 ?? ?? ?? ?? 83 C4 10 89 C3 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_fgets_c7ab7cbc0955bbd63e6b83999394dd51 {
	meta:
		aliases = "fgetws, fgets, __GI_fgets"
		size = "105"
		objfiles = "fgetws@libc.a, fgets@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 28 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 51 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 52 56 FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 85 FF 89 C3 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule fwrite_de9382d5d68bece0a177a27b1bb63137 {
	meta:
		aliases = "__GI_fread, fread, __GI_fwrite, fwrite"
		size = "108"
		objfiles = "fwrite@libc.a, fread@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 2C 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 56 FF 74 24 2C FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 85 FF 89 C3 74 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_closedir_8bdc030e485bc537171a43972bc0f327 {
	meta:
		aliases = "closedir, __GI_closedir"
		size = "136"
		objfiles = "closedir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 7C 24 20 83 3F FF 75 0D E8 ?? ?? ?? ?? C7 00 09 00 00 00 EB 62 53 8D 5F 18 53 68 ?? ?? ?? ?? 8D 74 24 0C 56 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 8B 1F C7 07 FF FF FF FF 5A 59 6A 01 56 E8 ?? ?? ?? ?? 58 FF 77 0C E8 ?? ?? ?? ?? 89 3C 24 E8 ?? ?? ?? ?? 89 D9 87 CB B8 06 00 00 00 CD 80 87 CB 89 C3 83 C4 10 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule pthread_reap_children_5161e5183ca363d8428a2edf20a26841 {
	meta:
		aliases = "pthread_reap_children"
		size = "245"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8D 7C 24 0C E9 C6 00 00 00 8B 0D ?? ?? ?? ?? 8B 31 EB 74 39 46 14 8B 16 75 6B 8B 46 04 89 42 04 8B 46 04 89 10 8B 46 1C 31 D2 E8 ?? ?? ?? ?? 83 BE 24 01 00 00 00 C6 46 2E 01 74 2B A1 ?? ?? ?? ?? 0B 86 28 01 00 00 F6 C4 08 74 1B C7 86 30 01 00 00 0C 00 00 00 89 B6 34 01 00 00 89 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 EC 0C 8A 5E 2D FF 76 1C E8 ?? ?? ?? ?? 83 C4 10 84 DB 74 0F 89 F0 E8 ?? ?? ?? ?? EB 06 89 D6 39 CE 75 88 83 3D ?? ?? ?? ?? 00 74 12 A1 ?? ?? ?? ?? 8B 10 39 C2 75 07 89 D0 E8 ?? ?? ?? ?? 8B 4C 24 0C 88 C8 24 7F FE C0 D0 F8 84 C0 7E 19 83 E1 7F BA 01 00 00 00 89 C8 E8 ?? }
	condition:
		$pattern
}

rule setusershell_8de1e55e89a98b377a62cc1040d67b79 {
	meta:
		aliases = "setusershell"
		size = "181"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 E8 ?? ?? ?? ?? 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 A3 ?? ?? ?? ?? 75 0C C7 05 ?? ?? ?? ?? ?? ?? ?? ?? EB 7E 31 F6 8D 7C 24 0C C7 44 24 0C 00 00 00 00 EB 47 8D 1C B5 00 00 00 00 46 52 52 8D 43 08 50 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8D 1C 18 A3 ?? ?? ?? ?? 58 89 1D ?? ?? ?? ?? 8B 44 24 18 FF 30 E8 ?? ?? ?? ?? 83 C4 10 C7 43 04 00 00 00 00 89 03 8D 43 04 A3 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 01 01 07 00 57 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 9C A1 ?? ?? ?? ?? A3 ?? ?? ?? ?? 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule setstate_cd848bd4f2c75e1e87ba1bcecd40a3c7 {
	meta:
		aliases = "setstate"
		size = "89"
		objfiles = "random@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 14 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 7C 24 0C 57 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 35 ?? ?? ?? ?? 5B 31 DB 58 83 EE 04 68 ?? ?? ?? ?? FF 74 24 2C E8 ?? ?? ?? ?? 5A 59 6A 01 85 C0 57 0F 49 DE E8 ?? ?? ?? ?? 83 C4 20 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_getpwent_r_0ebd27d559293f3957ce17608b106181 {
	meta:
		aliases = "__GI_getspent_r, __GI_getgrent_r, getspent_r, getpwent_r, getgrent_r, __GI_getpwent_r"
		size = "171"
		objfiles = "getgrent_r@libc.a, getspent_r@libc.a, getpwent_r@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 14 8B 74 24 30 8B 7C 24 24 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 C7 06 00 00 00 00 75 2D 52 52 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 A3 ?? ?? ?? ?? 75 09 E8 ?? ?? ?? ?? 8B 18 EB 2E C7 40 34 01 00 00 00 83 EC 0C FF 35 ?? ?? ?? ?? FF 74 24 38 FF 74 24 38 57 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 20 85 C0 89 C3 75 02 89 3E 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 20 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule round_c15aef06ba13ca227c24a400c5cdaee6 {
	meta:
		aliases = "__GI_round, round"
		size = "292"
		objfiles = "s_round@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 18 DD 44 24 28 C7 44 24 08 00 00 00 00 DD 14 24 DD 54 24 10 8B 74 24 14 C7 44 24 0C 00 00 00 00 8B 54 24 10 89 F0 C1 F8 14 25 FF 07 00 00 8D 98 01 FC FF FF 83 FB 13 7F 78 85 DB 79 32 DC 05 ?? ?? ?? ?? DD 1C 24 D9 EE DD 04 24 DF E9 DD D8 0F 86 B1 00 00 00 81 E6 00 00 00 80 31 D2 43 0F 85 A2 00 00 00 81 CE 00 00 F0 3F E9 97 00 00 00 DD D8 BF FF FF 0F 00 88 D9 D3 FF 89 F8 21 F0 09 D0 0F 84 8F 00 00 00 DD 04 24 DC 05 ?? ?? ?? ?? DD 1C 24 D9 EE DD 04 24 DF E9 DD D8 76 69 B8 00 00 08 00 89 FA D3 F8 F7 D2 8D 34 30 21 D6 31 D2 EB 55 DD D8 83 FB 33 7E 0F 81 FB 00 04 00 00 75 55 DD 04 24 }
	condition:
		$pattern
}

rule pthread_rwlock_rdlock_be798f84b0e784ddc27bafd6a2e82538 {
	meta:
		aliases = "pthread_rwlock_rdlock"
		size = "178"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 1C 8B 5C 24 2C 8D 54 24 10 C7 44 24 18 00 00 00 00 8D 4C 24 14 8D 44 24 18 52 89 DA E8 ?? ?? ?? ?? 8D 7B 10 83 C4 10 89 C6 83 7C 24 0C 00 75 09 E8 ?? ?? ?? ?? 89 44 24 0C 8B 54 24 0C 89 D8 E8 ?? ?? ?? ?? 89 F2 89 D8 E8 ?? ?? ?? ?? 85 C0 75 22 8B 54 24 0C 89 F8 E8 ?? ?? ?? ?? 83 EC 0C 53 E8 ?? ?? ?? ?? 8B 44 24 1C E8 ?? ?? ?? ?? 83 C4 10 EB B6 FF 43 08 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 F6 75 07 83 7C 24 04 00 74 17 8B 44 24 08 85 C0 74 05 FF 40 08 EB 0A 8B 44 24 0C FF 80 50 01 00 00 83 C4 10 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule nprocessors_onln_b2056728c2760c60ece276cccf14b24f {
	meta:
		aliases = "nprocessors_onln"
		size = "221"
		objfiles = "sysconf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 1C C7 44 24 18 00 00 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 74 4F 31 DB 8D 7C 24 0C EB 2D 8B 44 24 0C 8B 00 80 38 63 75 22 80 78 01 70 75 1C 80 78 02 75 75 16 0F B6 50 03 A1 ?? ?? ?? ?? 0F B7 04 50 83 E0 08 83 F8 01 83 DB FF 68 ?? ?? ?? ?? 68 02 01 00 00 57 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 BB EB 51 83 EC 0C 31 DB 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8D 7C 24 0C 85 C0 89 C6 75 1D EB 33 50 50 8B 44 24 14 FF 30 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 F8 01 83 D3 00 68 ?? ?? ?? ?? 68 02 02 07 00 57 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 CD 83 EC 0C 56 E8 ?? ?? }
	condition:
		$pattern
}
...
rule __pthread_alt_lock_146ad80929cc0efb9802036e183db560 {
	meta:
		aliases = "__pthread_alt_lock"
		size = "89"
		objfiles = "spinlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 20 8B 74 24 30 8D 7C 24 14 8B 54 24 34 8B 1E B9 01 00 00 00 85 DB 74 11 85 D2 75 07 E8 ?? ?? ?? ?? 89 C2 89 54 24 18 89 F9 C7 44 24 1C 00 00 00 00 89 5C 24 14 89 D8 F0 0F B1 0E 0F 94 C1 84 C9 74 CB 85 DB 74 07 89 D0 E8 ?? ?? ?? ?? 83 C4 20 5B 5E 5F C3 }
	condition:
		$pattern
}

rule ftello64_b5650aaed67754868fafb3ee8bdda47d {
	meta:
		aliases = "__GI_ftello64, ftello64"
		size = "179"
		objfiles = "ftello64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 20 8B 74 24 30 C7 44 24 18 00 00 00 00 C7 44 24 1C 00 00 00 00 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1F 53 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 14 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 51 25 40 04 00 00 3D 40 04 00 00 0F 94 C0 0F B6 C0 40 50 8D 5C 24 20 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 10 52 52 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 10 C7 44 24 18 FF FF FF FF C7 44 24 1C FF FF FF FF 85 FF 74 11 50 50 6A 01 8D 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 10 8B 44 24 18 8B 54 24 1C 83 C4 20 5B 5E 5F C3 }
	condition:
		$pattern
}

rule pmap_getport_8f47a26f0ed949e6298277f650c3bc5e {
	meta:
...
rule authnone_create_6ed3770ab7d2dd4fe22f9079244c5b17 {
	meta:
		aliases = "__GI_authnone_create, authnone_create"
		size = "177"
		objfiles = "auth_none@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 20 E8 ?? ?? ?? ?? 8B B0 98 00 00 00 89 C3 85 F6 75 1C 50 50 6A 40 6A 01 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 74 7D 89 C6 89 83 98 00 00 00 83 7E 3C 00 75 6D 50 6A 0C 8D 5E 0C 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 0C 6A 0C 53 56 E8 ?? ?? ?? ?? 8D 46 28 C7 46 20 ?? ?? ?? ?? 6A 00 6A 14 50 8D 7C 24 24 57 E8 ?? ?? ?? ?? 83 C4 18 56 57 E8 ?? ?? ?? ?? 59 58 53 57 E8 ?? ?? ?? ?? 8B 44 24 1C 89 3C 24 FF 50 10 89 46 3C 8B 44 24 1C 83 C4 10 8B 40 1C 85 C0 74 09 83 EC 0C 57 FF D0 83 C4 10 89 F2 83 C4 20 89 D0 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule readunix_c6e1bfae66291b3f4f273b53f63b69c4 {
	meta:
		aliases = "readunix"
		size = "270"
		objfiles = "svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 30 8B 7C 24 40 8D 74 24 24 8B 1F 89 5C 24 24 66 C7 44 24 28 01 00 50 68 B8 88 00 00 6A 01 56 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 74 0A 85 C0 0F 84 C2 00 00 00 EB 0A E8 ?? ?? ?? ?? 83 38 04 EB 0F 0F BF 44 24 2A A8 18 0F 85 A9 00 00 00 A8 20 0F 85 A1 00 00 00 F6 44 24 2A 01 74 AF 8B 44 24 44 C7 44 24 0C 01 00 00 00 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 89 44 24 1C 8B 44 24 48 C7 44 24 10 ?? ?? ?? ?? C7 44 24 14 1C 00 00 00 C7 44 24 18 00 00 00 00 89 44 24 20 8D 44 24 1C 89 44 24 08 C7 44 24 2C 01 00 00 00 83 EC 0C 6A 04 8D 44 24 3C 50 6A 10 6A 01 53 E8 ?? ?? ?? ?? 83 C4 20 85 }
	condition:
		$pattern
}

rule clntraw_create_378b4a64d0aab234000d22a01f7800bd {
	meta:
		aliases = "clntraw_create"
		size = "231"
		objfiles = "clnt_raw@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 30 E8 ?? ?? ?? ?? 8B 98 A0 00 00 00 89 C6 85 DB 89 DF 75 23 51 51 68 A0 22 00 00 6A 01 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 84 AA 00 00 00 89 C7 89 86 A0 00 00 00 8B 44 24 40 8D 73 0C C7 44 24 04 00 00 00 00 C7 44 24 08 02 00 00 00 89 44 24 0C 8B 44 24 44 89 44 24 10 8D 87 84 22 00 00 6A 00 6A 18 50 56 E8 ?? ?? ?? ?? 58 5A 8D 44 24 08 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 10 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8B 43 10 83 EC 0C 56 FF 50 10 83 C4 10 89 87 9C 22 00 00 8B 43 10 8B 40 1C 85 C0 74 09 83 EC 0C 56 FF D0 83 C4 10 6A 02 68 60 22 00 00 8D 47 24 50 56 E8 ?? }
	condition:
		$pattern
}

rule __GI_modf_daba384ea35685ea41474506a7fb8681 {
	meta:
		aliases = "modf, __GI_modf"
		size = "398"
		objfiles = "s_modf@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 40 DD 44 24 50 C7 44 24 30 00 00 00 00 8B 7C 24 58 DD 14 24 DD 5C 24 38 8B 54 24 3C C7 44 24 34 00 00 00 00 8B 74 24 38 C7 44 24 28 00 00 00 00 C7 44 24 2C 00 00 00 00 89 D0 C1 F8 14 25 FF 07 00 00 8D 88 01 FC FF FF 83 F9 13 C7 44 24 20 00 00 00 00 C7 44 24 24 00 00 00 00 C7 44 24 18 00 00 00 00 C7 44 24 1C 00 00 00 00 C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 C7 44 24 08 00 00 00 00 C7 44 24 0C 00 00 00 00 7F 71 85 C9 79 1D 81 E2 00 00 00 80 89 54 24 34 C7 44 24 30 00 00 00 00 DD 44 24 30 DD 1F E9 D1 00 00 00 BB FF FF 0F 00 D3 FB 89 D8 21 D0 09 F0 75 20 DD 04 24 81 E2 00 }
	condition:
		$pattern
}

rule timer_create_a6d5374db3612df3b9d5d2a20f7127f7 {
	meta:
		aliases = "timer_create"
		size = "158"
		objfiles = "timer_create@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 50 8B 74 24 64 85 F6 75 14 C7 44 24 14 00 00 00 00 8D 74 24 0C C7 44 24 10 0E 00 00 00 83 7E 08 02 74 6C 83 EC 0C 6A 08 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 74 59 89 44 24 0C 8D 54 24 4C 8B 44 24 60 89 F1 53 89 C3 B8 03 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0B E8 ?? ?? ?? ?? F7 DB 89 18 EB 1B 83 F8 FF 74 16 8B 46 08 89 07 8B 44 24 4C 89 47 04 8B 44 24 68 89 38 89 D8 EB 14 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C8 FF 83 C4 10 EB 03 83 C8 FF 83 C4 50 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_vsnprintf_710f10cd7129fe0c283f3a31666dcd67 {
	meta:
		aliases = "vsnprintf, __GI_vsnprintf"
		size = "165"
		objfiles = "vsnprintf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 5C 8B 5C 24 6C 8D 44 24 44 8B 74 24 70 8D 7C 24 0C C7 44 24 10 FE FF FF FF 66 C7 44 24 0C D0 00 C6 44 24 0E 00 C7 44 24 38 00 00 00 00 C7 44 24 40 01 00 00 00 50 E8 ?? ?? ?? ?? 89 D8 F7 D0 C7 44 24 30 00 00 00 00 83 C4 0C 39 C6 0F 47 F0 8D 04 33 89 5C 24 0C 89 44 24 10 89 5C 24 14 89 5C 24 18 89 5C 24 1C 89 44 24 20 FF 74 24 70 FF 74 24 70 57 E8 ?? ?? ?? ?? 83 C4 10 85 F6 89 C2 74 16 8B 44 24 10 3B 44 24 0C 75 05 48 89 44 24 10 8B 44 24 10 C6 00 00 83 C4 50 89 D0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_erfc_1c9d009aec92743007b0add2b13bcd0e {
	meta:
		aliases = "erfc, __GI_erfc"
		size = "891"
		objfiles = "s_erf@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 60 DD 44 24 70 DD 54 24 38 DD 54 24 48 8B 74 24 4C 89 F3 89 F7 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7E 1D C1 EE 1F 31 D2 52 8D 04 36 50 DF 2C 24 D9 C9 83 C4 08 DC 3D ?? ?? ?? ?? E9 5D 01 00 00 DD D8 81 FB FF FF EA 3F 0F 8F A8 00 00 00 81 FB FF FF 6F 3C 7F 0F DD 44 24 38 DC 2D ?? ?? ?? ?? E9 0A 03 00 00 DD 44 24 38 81 FE FF FF CF 3F D8 C8 DD 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? DD 05 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? DE CA D9 E8 DC C2 }
	condition:
		$pattern
}

rule __ieee754_rem_pio2_ab086344f57faa9e6918144ef57087b3 {
	meta:
		aliases = "__ieee754_rem_pio2"
		size = "735"
		objfiles = "e_rem_pio2@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 70 DD 84 24 80 00 00 00 8B B4 24 88 00 00 00 DD 14 24 DD 54 24 30 8B 7C 24 34 89 FB 81 E3 FF FF FF 7F 81 FB FB 21 E9 3F 7F 15 DD 1E C7 46 08 00 00 00 00 C7 46 0C 00 00 00 00 E9 C5 01 00 00 DD D8 81 FB 7B D9 02 40 7F 7E 85 FF 7E 3E DD 04 24 81 FB FB 21 F9 3F DC 25 ?? ?? ?? ?? 74 08 DD 05 ?? ?? ?? ?? EB 0E DD 05 ?? ?? ?? ?? DE E9 DD 05 ?? ?? ?? ?? D9 C1 D8 E1 DD 16 DE EA DE E9 DD 5E 08 B9 01 00 00 00 E9 46 02 00 00 DD 04 24 81 FB FB 21 F9 3F DC 05 ?? ?? ?? ?? 74 08 DD 05 ?? ?? ?? ?? EB 0E DD 05 ?? ?? ?? ?? DE C1 DD 05 ?? ?? ?? ?? D9 C1 D8 C1 DD 16 DE EA DE C1 DD 5E 08 83 C9 FF E9 }
	condition:
		$pattern
}

rule __pthread_acquire_03019a7a5329f4c91da691f1e6eb8538 {
	meta:
		aliases = "__pthread_acquire"
		size = "78"
		objfiles = "spinlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 89 C3 83 EC 10 31 F6 8D 7C 24 08 EB 2C 83 FE 31 7F 08 E8 ?? ?? ?? ?? 46 EB 1F C7 44 24 08 00 00 00 00 31 F6 C7 44 24 0C 81 84 1E 00 52 52 6A 00 57 E8 ?? ?? ?? ?? 83 C4 10 B8 01 00 00 00 87 03 85 C0 75 C9 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule _dl_run_init_array_1b4b49b6bdb11fdb34cc5e6a44bd2c9c {
	meta:
		aliases = "_dl_run_init_array"
		size = "49"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 44 24 10 8B 08 8B 90 AC 00 00 00 8B 80 A4 00 00 00 85 C0 74 14 89 D7 31 DB C1 EF 02 8D 34 08 EB 04 FF 14 9E 43 39 FB 72 F8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule confstr_1289e00a48865d185dcb7df81e472f72 {
	meta:
		aliases = "confstr"
		size = "112"
		objfiles = "confstr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 44 24 10 8B 7C 24 14 8B 74 24 18 85 C0 74 07 83 F8 03 75 0E EB 1B BA ?? ?? ?? ?? BB 0E 00 00 00 EB 19 E8 ?? ?? ?? ?? 31 DB C7 00 16 00 00 00 EB 35 BA ?? ?? ?? ?? BB 12 00 00 00 85 F6 74 27 85 FF 74 23 39 F3 77 0B 51 53 52 57 E8 ?? ?? ?? ?? EB 11 50 8D 46 FF 50 52 57 E8 ?? ?? ?? ?? C6 44 37 FF 00 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule tdelete_6f4d580c033f7a970f4c9596c4beb1d4 {
	meta:
		aliases = "tdelete"
		size = "156"
		objfiles = "tdelete@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 44 24 14 8B 5C 24 10 85 C0 0F 84 83 00 00 00 8B 38 89 C6 85 FF EB 10 8D 70 04 85 D2 89 C7 8D 40 08 0F 49 F0 83 3E 00 74 69 50 50 8B 06 FF 30 53 FF 54 24 28 83 C4 10 83 F8 00 89 C2 8B 06 75 D7 8B 58 04 8B 48 08 85 DB 74 0E 85 C9 74 31 8B 51 04 85 D2 75 0B 89 59 04 89 CB EB 23 89 C2 89 D9 8B 42 04 89 D3 85 C0 75 F3 8B 42 08 89 41 04 8B 06 8B 40 04 89 42 04 8B 06 8B 40 08 89 42 08 83 EC 0C FF 36 E8 ?? ?? ?? ?? 89 F8 83 C4 10 89 1E EB 02 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_lfind_6e790be7a384fea298d7618589f3fb5d {
	meta:
...
rule pthread_setspecific_0618d668899de099e426c461f15043a5 {
	meta:
		aliases = "pthread_setspecific"
		size = "100"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 5C 24 10 81 FB FF 03 00 00 77 4C 83 3C DD ?? ?? ?? ?? 00 74 42 E8 ?? ?? ?? ?? 89 DE C1 EE 05 83 7C B0 74 00 89 C7 75 1D 50 50 6A 04 6A 20 E8 ?? ?? ?? ?? 83 C4 10 89 C2 B8 0C 00 00 00 85 D2 74 1B 89 54 B7 74 8B 44 24 14 83 E3 1F 8B 54 B7 74 89 04 9A 31 C0 EB 05 B8 16 00 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_strtok_r_743ac83a9d2bf117e1377539e9d52605 {
	meta:
...
rule wcscasecmp_677f8e0d9b771a6c3ddf93fc3a0b5fd8 {
	meta:
		aliases = "wcscasecmp"
		size = "94"
		objfiles = "wcscasecmp@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 10 8B 7C 24 14 EB 0F 83 3E 00 75 04 31 C0 EB 44 83 C6 04 83 C7 04 8B 06 3B 07 74 EB 83 EC 0C 50 E8 ?? ?? ?? ?? 5A FF 37 89 C3 E8 ?? ?? ?? ?? 83 C4 10 39 C3 74 D1 83 EC 0C FF 36 E8 ?? ?? ?? ?? 89 C3 58 FF 37 E8 ?? ?? ?? ?? 83 C4 10 39 C3 19 C0 83 C8 01 5B 5E 5F C3 }
	condition:
		$pattern
}

rule _dl_add_elf_hash_table_7f6f31f7274fddeeba3ede40114665ae {
	meta:
		aliases = "_dl_add_elf_hash_table"
		size = "179"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 14 8B 7C 24 18 83 EC 0C 68 E8 00 00 00 E8 ?? ?? ?? ?? BA E8 00 00 00 83 C4 10 89 C3 EB 04 C6 00 00 40 4A 83 FA FF 75 F6 A1 ?? ?? ?? ?? 85 C0 75 0A 89 1D ?? ?? ?? ?? EB 0F 89 D0 8B 50 0C 85 D2 75 F7 89 58 0C 89 43 10 83 EC 0C FF 74 24 1C C7 43 0C 00 00 00 00 66 C7 43 22 00 00 E8 ?? ?? ?? ?? 8B 4F 10 C7 43 18 03 00 00 00 89 43 04 8B 44 24 2C 83 C4 10 85 C9 89 43 08 74 17 8B 01 89 43 28 8B 51 04 89 53 38 8D 51 08 8D 04 82 89 53 2C 89 43 3C 89 33 31 D2 89 73 14 8B 04 97 89 44 93 40 42 83 FA 22 7E F3 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule fwrite_unlocked_674979cf4ec05d4ed2480497f7b0bb2d {
	meta:
		aliases = "__GI_fwrite_unlocked, fwrite_unlocked"
		size = "118"
		objfiles = "fwrite_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 1C 8B 7C 24 14 8B 5C 24 18 0F B7 06 25 C0 00 00 00 3D C0 00 00 00 74 14 52 52 68 80 00 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 3E 85 FF 74 3A 85 DB 74 36 83 C8 FF 31 D2 F7 F7 39 C3 77 18 0F AF DF 50 56 53 FF 74 24 1C E8 ?? ?? ?? ?? 31 D2 83 C4 10 F7 F7 EB 15 8B 06 83 C8 08 66 89 06 E8 ?? ?? ?? ?? C7 00 16 00 00 00 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule strndup_818872658d44b964b7c6f2088dba09ab {
	meta:
...
rule __GI_strdup_9d04a54082ec66fba106664f4404cfa8 {
	meta:
...
rule pthread_mutex_timedlock_2b026873e1b3098561731630ed3ac131 {
	meta:
		aliases = "pthread_mutex_timedlock"
		size = "197"
		objfiles = "mutex@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 7C 24 14 8B 74 24 10 81 7F 04 FF C9 9A 3B 0F 87 A2 00 00 00 8B 46 0C 83 F8 01 74 27 7F 09 85 C0 74 15 E9 8F 00 00 00 83 F8 02 74 40 83 F8 03 0F 85 81 00 00 00 EB 65 8D 46 10 31 D2 E8 ?? ?? ?? ?? EB 25 E8 ?? ?? ?? ?? 39 46 08 89 C3 75 05 FF 46 04 EB 14 8D 46 10 89 DA E8 ?? ?? ?? ?? 89 5E 08 C7 46 04 00 00 00 00 31 D2 EB 4F E8 ?? ?? ?? ?? BA 23 00 00 00 39 46 08 89 C3 74 3E 50 57 53 8D 46 10 50 E8 ?? ?? ?? ?? 83 C4 10 BA 6E 00 00 00 85 C0 74 26 30 D2 89 5E 08 EB 1F 51 57 6A 00 8D 46 10 50 E8 ?? ?? ?? ?? 83 C4 10 83 F8 01 19 D2 83 E2 6E EB 05 BA 16 00 00 00 5B 89 D0 5E 5F C3 }
	condition:
		$pattern
}

rule ___path_search_59c148008a401108c92a3f3f55d64cb6 {
	meta:
		aliases = "___path_search"
		size = "203"
		objfiles = "tempname@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 7C 24 1C 8B 5C 24 18 85 FF 74 1F 80 3F 00 74 1A 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C4 10 83 F8 05 89 C6 7E 11 BE 05 00 00 00 EB 0A BF ?? ?? ?? ?? BE 04 00 00 00 85 DB 75 3B B8 ?? ?? ?? ?? BB ?? ?? ?? ?? E8 ?? ?? ?? ?? 85 C0 75 28 50 50 53 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0B 89 D8 E8 ?? ?? ?? ?? 85 C0 75 0D E8 ?? ?? ?? ?? C7 00 02 00 00 00 EB 32 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 89 C2 EB 01 4A 83 FA 01 7E 07 80 7C 1A FF 2F 74 F3 8D 44 16 08 39 44 24 14 73 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 19 51 51 57 56 53 52 68 ?? ?? ?? ?? FF 74 24 2C E8 ?? ?? ?? ?? 31 C0 83 C4 20 5B }
	condition:
		$pattern
}
...
rule pthread_rwlock_wrlock_ce4b29293735ce0ca9eb145370383822 {
	meta:
		aliases = "pthread_rwlock_wrlock"
		size = "89"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 E8 ?? ?? ?? ?? 8B 74 24 10 8D 7E 14 89 C3 89 DA 89 F0 E8 ?? ?? ?? ?? 83 7E 08 00 75 06 83 7E 0C 00 74 1E 89 DA 89 F8 E8 ?? ?? ?? ?? 83 EC 0C 56 E8 ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? 83 C4 10 EB CD 83 EC 0C 89 5E 0C 56 E8 ?? ?? ?? ?? 83 C4 10 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __pthread_perform_cleanup_1c1e62499fff39603f4b53c904e79870 {
	meta:
		aliases = "__pthread_perform_cleanup"
		size = "62"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 E8 ?? ?? ?? ?? 8B 7C 24 10 8B 58 3C 89 C6 EB 12 39 FB 76 12 83 EC 0C FF 73 04 FF 13 8B 5B 0C 83 C4 10 85 DB 75 EA 83 BE FC 00 00 00 00 74 08 5B 5E 5F E9 ?? ?? ?? ?? 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_strsignal_c778e491ce54e12c17d3f3aece0e2595 {
	meta:
		aliases = "strsignal, __GI_strsignal"
		size = "84"
		objfiles = "strsignal@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 44 24 10 83 F8 1F 77 19 89 C1 BA ?? ?? ?? ?? EB 07 80 3A 01 83 D9 00 42 85 C9 75 F5 80 3A 00 75 27 83 EC 0C 99 6A 00 BE ?? ?? ?? ?? 6A F6 52 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8D 50 F1 89 D7 A5 A5 A5 66 A5 A4 83 C4 20 89 D0 5A 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_memcpy_9e7629742c90a05194006f450f288d9e {
	meta:
		aliases = "memcpy, __GI_memcpy"
		size = "41"
		objfiles = "memcpy@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 44 24 18 8B 74 24 14 8B 7C 24 10 89 C1 C1 E9 02 F3 A5 89 C1 83 E1 03 74 02 F3 A4 8B 44 24 10 5A 5E 5F C3 }
	condition:
		$pattern
}

rule seed48_r_b67349bf6504084299deacb5ac6c9f7a {
	meta:
		aliases = "__GI_seed48_r, seed48_r"
		size = "75"
		objfiles = "seed48_r@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 4C 24 14 8B 54 24 10 8D 79 06 89 CE A5 66 A5 66 8B 42 04 C7 41 10 6D E6 EC DE C7 41 14 05 00 00 00 66 89 41 04 66 8B 42 02 66 89 41 02 66 8B 02 66 C7 41 0C 0B 00 66 C7 41 0E 01 00 66 89 01 31 C0 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_mremap_5b645fc8fb566e3b6118c2b6be2da347 {
	meta:
...
rule setxattr_b536693c8bf1a748d47b1c3abea35370 {
	meta:
		aliases = "setxattr"
		size = "62"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 7C 24 20 8B 44 24 10 53 89 C3 B8 E2 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 5E 5F C3 }
	condition:
		$pattern
}

rule lsetxattr_48bd782afa32055bba39e6c098aade42 {
	meta:
		aliases = "lsetxattr"
		size = "62"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 7C 24 20 8B 44 24 10 53 89 C3 B8 E3 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5F 5E 5F C3 }
	condition:
		$pattern
}

rule fsetxattr_bad9341b4efd2b6cf455a521bc210f23 {
	meta:
		aliases = "fsetxattr"
		size = "62"
		objfiles = "xattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 7C 24 20 8B 44 24 10 53 89 C3 B8 E4 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_strncpy_12f93b7b48580efa90eb9711781dc110 {
	meta:
...
rule epoll_pwait_a5bb049eef584f2a9ab1fcfeb5bf9ef8 {
	meta:
		aliases = "__libc_epoll_pwait, epoll_pwait"
		size = "78"
		objfiles = "epoll@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 14 8B 4C 24 24 8B 54 24 28 8B 74 24 2C 8B 7C 24 30 C7 44 24 10 08 00 00 00 8B 44 24 20 53 89 C3 55 8B 6C 24 10 B8 3F 01 00 00 CD 80 5D 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 83 C4 14 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_ppoll_56e3ad2f495d14a57383672237245b4f {
	meta:
		aliases = "ppoll, __GI_ppoll"
		size = "86"
		objfiles = "ppoll@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 14 8B 54 24 28 8B 74 24 2C 85 D2 74 11 8B 0A 8B 42 04 8D 54 24 0C 89 4C 24 0C 89 44 24 10 BF 08 00 00 00 8B 44 24 20 8B 4C 24 24 53 89 C3 B8 35 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 83 C4 14 5E 5F C3 }
	condition:
		$pattern
}

rule tmpnam_066c185573fe0d47b434b8bccf324175 {
	meta:
		aliases = "tmpnam"
		size = "88"
		objfiles = "tmpnam@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 24 8B 7C 24 30 8D 44 24 10 6A 00 6A 00 6A 14 85 FF 89 FE 0F 44 F0 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 27 50 6A 00 6A 03 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 15 85 FF 75 13 BF ?? ?? ?? ?? A5 A5 A5 A5 A5 BF ?? ?? ?? ?? EB 02 31 FF 83 C4 24 89 F8 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_tcgetattr_1222b2e4e2e176d6a734cc6e811cbd5d {
	meta:
		aliases = "tcgetattr, __GI_tcgetattr"
		size = "99"
		objfiles = "tcgetattr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 38 8D 44 24 14 8B 7C 24 48 50 68 01 54 00 00 FF 74 24 4C E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C2 75 36 8B 44 24 10 8D 74 24 21 89 07 8B 44 24 14 89 47 04 8B 44 24 18 89 47 08 8B 44 24 1C 89 47 0C 8A 44 24 20 88 47 10 83 C7 11 A5 A5 A5 A5 66 A5 A4 89 D0 AB AB AB AA 83 C4 34 89 D0 5E 5F C3 }
	condition:
		$pattern
}

rule statfs64_e2fe8981872cbcd00c43d38bac0c8dbb {
	meta:
		aliases = "__GI_statfs64, __GI_fstatfs64, fstatfs64, statfs64"
		size = "159"
		objfiles = "statfs64@libc.a, fstatfs64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 4C 8D 44 24 0C 8B 7C 24 5C 50 FF 74 24 5C E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 76 8B 44 24 04 8D 74 24 30 C7 47 0C 00 00 00 00 C7 47 14 00 00 00 00 C7 47 1C 00 00 00 00 89 07 8B 44 24 08 C7 47 24 00 00 00 00 C7 47 2C 00 00 00 00 89 47 04 8B 44 24 0C 89 47 08 8B 44 24 10 89 47 10 8B 44 24 14 89 47 18 8B 44 24 18 89 47 20 8B 44 24 1C 89 47 28 8B 44 24 24 89 47 34 8B 44 24 20 89 47 30 8B 44 24 28 89 47 38 83 C7 40 A5 A5 A5 A5 A5 31 D2 83 C4 44 89 D0 5E 5F C3 }
	condition:
		$pattern
}

rule byte_alt_match_null_string_p_b97d86ad0c4480d9c5cebd995f190ebc {
	meta:
		aliases = "byte_alt_match_null_string_p"
		size = "94"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 89 CE 53 89 D3 83 EC 10 8D 7C 24 0C 89 44 24 0C EB 36 80 39 0F 75 1E 8D 41 01 89 44 24 0C 0F BE 40 01 0F B6 51 01 C1 E0 08 01 D0 8D 44 01 03 89 44 24 0C EB 13 89 F1 89 DA 89 F8 E8 ?? ?? ?? ?? 84 C0 75 04 31 C0 EB 0D 8B 4C 24 0C 39 D9 72 C2 B8 01 00 00 00 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule posix_fadvise_f98a250ba7dfdf368561fd7d795bd1f7 {
	meta:
		aliases = "posix_fadvise"
		size = "52"
		objfiles = "posix_fadvise@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 8B 4C 24 10 8B 74 24 14 8B 7C 24 18 89 C8 99 8B 44 24 0C 53 89 C3 B8 FA 00 00 00 CD 80 5B 5E 89 C1 89 C2 31 C0 5F F7 DA 81 F9 00 F0 FF FF 0F 47 C2 C3 }
	condition:
		$pattern
}
...
rule __stdio_init_mutex_647245557322ec0becaf79aac4227461 {
	meta:
		aliases = "__stdio_init_mutex"
		size = "20"
		objfiles = "_stdio@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 BE ?? ?? ?? ?? 8B 7C 24 0C A5 A5 A5 A5 A5 A5 5E 5F C3 }
	condition:
		$pattern
}

rule __encode_header_14f3a834c69814f103d1c7c8490e3a22 {
	meta:
		aliases = "__encode_header"
		size = "187"
		objfiles = "encodeh@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 C8 FF 56 53 83 EC 10 83 7C 24 28 0B 8B 74 24 20 8B 7C 24 24 0F 8E 98 00 00 00 0F B6 46 01 88 07 8B 06 88 47 01 83 7E 04 01 8B 56 08 19 C0 F6 D0 24 80 83 7E 0C 01 88 04 24 19 DB F6 D3 80 E3 04 83 7E 10 01 19 C9 83 E2 0F F6 D1 C1 E2 03 80 E1 02 83 7E 14 00 0F 95 C0 08 D0 0A 04 24 08 D8 08 C8 88 47 02 83 7E 18 01 8A 56 1C 19 C0 F6 D0 24 80 80 E2 0F 08 D0 88 47 03 0F B6 46 21 88 47 04 8B 46 20 88 47 05 0F B6 46 25 88 47 06 8B 46 24 88 47 07 0F B6 46 29 88 47 08 8B 46 28 88 47 09 0F B6 46 2D 88 47 0A 8B 46 2C 88 47 0B B8 0C 00 00 00 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_strncat_55bc14b5a698b3ece4ff7cdf0e0c119d {
	meta:
		aliases = "strncat, __GI_strncat"
		size = "39"
		objfiles = "strncat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 C9 FF 56 8B 7C 24 0C 8B 74 24 10 8B 54 24 14 31 C0 42 57 F2 AE 4F 4A 89 D0 74 01 AC AA 84 C0 75 F5 58 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_strlen_3a2fca38e1d7ecf9c9434ee73074e9be {
	meta:
		aliases = "strlen, __GI_strlen"
		size = "19"
		objfiles = "strlen@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 C9 FF 8B 7C 24 08 31 C0 F2 AE F7 D1 8D 41 FF 5F C3 }
	condition:
		$pattern
}

rule __GI_rawmemchr_678722102f23171778f35fe759a3867e {
	meta:
		aliases = "rawmemchr, __GI_rawmemchr"
		size = "19"
		objfiles = "rawmemchr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 C9 FF 8B 7C 24 08 8B 44 24 0C F2 AE 8D 47 FF 5F C3 }
	condition:
		$pattern
}

rule shm_open_032181505fb147563214b1aa4f1c2efd {
	meta:
		aliases = "shm_open"
		size = "62"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 83 CF FF 56 53 8B 44 24 10 8B 74 24 14 E8 ?? ?? ?? ?? 85 C0 89 C3 74 1F 57 81 CE 00 00 08 00 FF 74 24 1C 56 50 E8 ?? ?? ?? ?? 89 1C 24 89 C7 E8 ?? ?? ?? ?? 83 C4 10 5B 89 F8 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_memset_cba3fdeaa73d59af8f17534fa8d5aa11 {
	meta:
...
rule __GI_abort_12a651e613ef750d1fd88812ea5c11bf {
	meta:
		aliases = "abort, __GI_abort"
		size = "208"
		objfiles = "abort@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 EC 34 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 44 24 34 00 00 00 00 C7 44 24 30 20 00 00 00 83 C4 0C 6A 00 8D 44 24 28 50 6A 01 E8 ?? ?? ?? ?? 83 C4 10 80 3D ?? ?? ?? ?? 00 75 2F C6 05 ?? ?? ?? ?? 01 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 04 24 06 00 00 00 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 A0 ?? ?? ?? ?? 3C 01 75 34 8D 54 24 0C 31 C0 C6 05 ?? ?? ?? ?? 02 89 D7 AB AB AB AB AB C7 44 24 18 FF FF FF FF C7 44 24 1C FF FF FF FF 50 6A 00 52 6A 06 E8 ?? ?? ?? ?? 83 C4 10 EB 9B 3C 02 75 08 C6 05 ?? ?? ?? ?? 03 F4 80 3D ?? ?? ?? ?? 03 75 11 83 EC 0C 6A 7F C6 05 ?? ?? ?? ?? 04 }
	condition:
		$pattern
}

rule fd_to_DIR_9796f5631f2db13fd1ee6049f47a7cf0 {
	meta:
		aliases = "fd_to_DIR"
		size = "146"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 89 C7 56 31 F6 53 89 D3 83 EC 2C 6A 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 6F 89 38 81 FB FF 01 00 00 89 C6 C7 40 10 00 00 00 00 C7 40 08 00 00 00 00 C7 40 04 00 00 00 00 B8 00 02 00 00 0F 47 C3 89 46 14 52 52 50 6A 01 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 46 0C 75 0D 83 EC 0C 56 31 F6 E8 ?? ?? ?? ?? EB 21 8D 5C 24 08 50 6A 18 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 0C 6A 18 8D 46 18 53 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 20 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __get_next_rpcent_de58f04c8b5b3717b1102a84efd9f09d {
	meta:
		aliases = "__get_next_rpcent"
		size = "256"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 89 C7 56 53 8D B0 A8 00 00 00 50 FF 37 68 00 10 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 D8 00 00 00 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 C6 84 07 A7 00 00 00 0A 80 BF A8 00 00 00 23 74 CA 50 50 6A 23 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 11 50 50 6A 0A 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 A8 C6 00 00 89 F0 E8 ?? ?? ?? ?? 85 C0 74 9A 8D 58 01 C6 00 00 89 B7 9C 00 00 00 EB 01 43 8A 03 3C 20 74 F9 3C 09 74 F5 83 EC 0C 53 E8 ?? ?? ?? ?? 8D 77 10 83 C4 10 89 B7 A0 00 00 00 89 87 A4 00 00 00 89 D8 E8 ?? ?? ?? ?? 31 C9 85 C0 74 2E 8D 48 01 C6 00 00 EB 26 80 FA 20 74 1E 80 FA 09 74 19 39 DE 73 05 }
	condition:
		$pattern
}

rule byte_insert_op1_bdc329d0ac570fc1531ecfb93b4a87dd {
	meta:
		aliases = "byte_insert_op1"
		size = "44"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 89 C7 56 89 CE 53 89 D3 8B 44 24 10 8D 48 03 89 C2 EB 06 4A 49 8A 02 88 01 39 DA 75 F6 89 DA 89 F1 5B 89 F8 5E 5F E9 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule pthread_kill_all_threads_d8f87feb7955cfbf22812d527232cba3 {
	meta:
		aliases = "pthread_kill_all_threads"
		size = "62"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 89 D7 56 89 C6 A1 ?? ?? ?? ?? 53 8B 18 EB 10 51 51 56 FF 73 14 E8 ?? ?? ?? ?? 8B 1B 83 C4 10 3B 1D ?? ?? ?? ?? 75 E8 85 FF 74 0E 52 52 56 FF 73 14 E8 ?? ?? ?? ?? 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule _obstack_begin_a42b6de31974ba3ed714db346a05f8ae {
	meta:
		aliases = "_obstack_begin"
		size = "140"
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 57 ) B8 04 00 00 00 56 53 8B 74 24 18 8B 54 24 14 8B 5C 24 10 8B 4C 24 1C 85 F6 0F 44 F0 85 D2 66 B8 E0 0F 0F 44 D0 8B 44 24 20 80 63 28 FE 8D 7E FF 89 4B 1C F6 43 28 01 89 43 20 89 13 89 7B 18 74 08 50 50 52 FF 73 24 EB 04 83 EC 0C 52 FF D1 83 C4 10 85 C0 89 C2 89 43 04 75 05 E8 ?? ?? ?? ?? 8D 44 38 08 F7 DE 21 F0 89 43 08 89 43 0C 89 D0 03 03 C7 42 04 00 00 00 00 89 02 80 63 28 F9 89 43 10 B8 01 00 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_wctrans_50e80352cc999abf107e4f9290013692 {
	meta:
		aliases = "__GI_wctype, wctrans, wctype, __GI_wctrans"
		size = "61"
...
rule gethostid_f42c7e8d5c4ea9dbef0390ee37ee0611 {
	meta:
		aliases = "gethostid"
		size = "222"
		objfiles = "hostid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) BA ?? ?? ?? ?? 53 31 C9 83 EC 74 C7 44 24 70 00 00 00 00 87 D3 B8 05 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 89 C7 76 0B E8 ?? ?? ?? ?? F7 DF 89 38 EB 40 85 C0 78 3C 8D 4C 24 70 BA 04 00 00 00 53 89 C3 B8 03 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 89 C2 76 0C E8 ?? ?? ?? ?? F7 DB 83 CA FF 89 18 89 F9 87 CB B8 06 00 00 00 CD 80 87 CB 85 D2 7F 61 50 50 6A 40 8D 5C 24 17 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 4C 80 7C 24 0B 00 74 45 8D 54 24 4C 31 C0 B9 08 00 00 00 89 D7 F3 AB 8D 44 24 6C 50 52 6A 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 21 8B 54 24 6C 85 D2 74 0D 8B 42 14 8B 40 04 C1 C8 10 89 44 24 70 }
	condition:
		$pattern
}
...
rule _pthread_cleanup_pop_restore_18caac7cc0c9b26af6b09db17db43d04 {
	meta:
		aliases = "_pthread_cleanup_pop_restore"
		size = "23"
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 83 ) 7C 24 08 00 8B 54 24 04 74 0B 8B 42 04 89 44 24 04 8B 0A FF E1 C3 }
	condition:
		$pattern
}

rule _load_inttype_f0341d748e4a1ab464979ded31056146 {
	meta:
		aliases = "_load_inttype"
		size = "94"
		objfiles = "_load_inttype@libc.a"
	strings:
		$pattern = { ( CC | 83 ) 7C 24 0C 00 8B 4C 24 04 8B 44 24 08 78 25 F6 C5 08 75 25 81 F9 00 01 00 00 8B 10 75 05 0F B6 D2 EB 0C 0F B7 C2 81 F9 00 02 00 00 0F 44 D0 89 D0 31 D2 C3 F6 C5 08 74 06 8B 50 04 8B 00 C3 81 F9 00 01 00 00 8B 10 75 05 0F B6 D2 EB 0C 0F BF C2 81 F9 00 02 00 00 0F 44 D0 89 D0 99 C3 }
	condition:
		$pattern
}

rule __compare_and_swap_1a9ade1afd6acae381324ddadeb80102 {
	meta:
		aliases = "__compare_and_swap"
		size = "27"
		objfiles = "pt_machine@libpthread.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 8B 54 24 08 8B 4C 24 10 8B 44 24 0C F0 0F B1 0A 0F 94 C1 5A 0F B6 C1 C3 }
	condition:
		$pattern
}
...
rule __libc_waitpid_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "wcstoumax, strtouq, __GI_strtoul, wcstouq, strtoul, strtoull, wcstoul, __GI_waitpid, waitpid, wcstoull, strtoumax, __libc_waitpid"
		size = "26"
		objfiles = "wcstoul@libc.a, strtoul@libc.a, strtoull@libc.a, wcstoull@libc.a, waitpid@libc.a"
	strings:
...
rule __GI_strtoll_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "wcstoq, strtoimax, wcstol, strtol, __GI_strtol, wcstoimax, wcstoll, strtoll, strtoq, __GI_strtoll"
		size = "26"
...
rule __assert_0dbc25c30e20479d91ba937307f292b6 {
	meta:
...
rule endusershell_3e14ddc005bf52209d20899be1dc9562 {
	meta:
		aliases = "endusershell"
		size = "124"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C 83 3D ?? ?? ?? ?? 00 74 4A A1 ?? ?? ?? ?? A3 ?? ?? ?? ?? EB 14 83 EC 0C 83 C0 04 52 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 A1 ?? ?? ?? ?? 85 C0 74 06 8B 10 85 D2 75 DD 83 EC 0C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 C7 05 ?? ?? ?? ?? 00 00 00 00 83 EC 0C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 83 C4 1C C3 }
	condition:
		$pattern
}

rule getusershell_04202ec2afe0245c1c0a32f2a66971ce {
	meta:
		aliases = "getusershell"
		size = "42"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C 83 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 8B 10 85 D2 74 08 83 C0 04 A3 ?? ?? ?? ?? 89 D0 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule __initbuf_9c60751e7cc66a3c3ea13b4806828d43 {
	meta:
		aliases = "__initbuf"
		size = "51"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C 83 3D ?? ?? ?? ?? 00 75 15 83 EC 0C 68 30 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 A3 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 83 C4 0C C3 }
	condition:
		$pattern
}

rule __initbuf_af0dea88dd623e832b305564140fd62c {
	meta:
		aliases = "__initbuf"
		size = "46"
		objfiles = "getnet@libc.a, getproto@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C 83 3D ?? ?? ?? ?? 00 75 1E 83 EC 0C 68 2C 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 85 C0 A3 ?? ?? ?? ?? 75 05 E8 ?? ?? ?? ?? 83 C4 0C C3 }
	condition:
		$pattern
}

rule __uClibc_init_5bf2154ec772cfa85294eadc83004ab6 {
	meta:
		aliases = "__GI___uClibc_init, __uClibc_init"
		size = "57"
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C 83 3D ?? ?? ?? ?? 00 75 29 B8 ?? ?? ?? ?? 85 C0 C7 05 ?? ?? ?? ?? 00 10 00 00 74 05 E8 ?? ?? ?? ?? B8 ?? ?? ?? ?? 85 C0 74 08 83 C4 0C E9 ?? ?? ?? ?? 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule perror_7643d7541a4b544e17d554a52b43893a {
	meta:
...
rule __GI_sigaddset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigismember, __GI_sigdelset, sigdelset, sigaddset, __GI_sigaddset"
		size = "42"
...
rule __close_nameservers_785f4e426532776fe50891dbdc087c04 {
	meta:
		aliases = "__close_nameservers"
		size = "114"
		objfiles = "closenameservers@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C A1 ?? ?? ?? ?? 3D ?? ?? ?? ?? 74 0C 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 C7 05 ?? ?? ?? ?? 00 00 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 EB 1C 8D 50 FF A1 ?? ?? ?? ?? 83 EC 0C 89 15 ?? ?? ?? ?? FF 34 90 E8 ?? ?? ?? ?? 83 C4 10 A1 ?? ?? ?? ?? 85 C0 75 DB 83 EC 0C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 83 C4 1C C3 }
	condition:
		$pattern
}
...
rule endhostent_unlocked_9c81b865165727f24305825275bd496e {
	meta:
		aliases = "endhostent_unlocked"
		size = "45"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C A1 ?? ?? ?? ?? 85 C0 74 16 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 C7 05 ?? ?? ?? ?? 00 00 00 00 C6 05 ?? ?? ?? ?? 00 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule endttyent_b35779c574727cc62d5750bc2b33fc75 {
	meta:
...
rule brk_203b0a097b730bfe938c46da21d1173c {
	meta:
		aliases = "__GI_brk, brk"
		size = "49"
		objfiles = "brk@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C B8 2D 00 00 00 8B 54 24 10 31 C9 53 89 D3 CD 80 5B A3 ?? ?? ?? ?? 39 D0 73 0E E8 ?? ?? ?? ?? 83 C9 FF C7 00 0C 00 00 00 89 C8 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule __fp_range_check_b9f5ad932a59fe60ca093336923c7637 {
	meta:
		aliases = "__fp_range_check"
		size = "74"
		objfiles = "__fp_range_check@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C DB 6C 24 10 D9 05 ?? ?? ?? ?? D9 C1 D8 C9 D9 CA DB EA DD DA 75 29 7A 27 D9 EE D9 CA DF EA DD D9 7A 02 74 1D DB 6C 24 1C DC C9 DF E9 DD D8 7A 02 74 11 E8 ?? ?? ?? ?? C7 00 22 00 00 00 EB 04 DD D8 DD D8 83 C4 0C C3 }
	condition:
		$pattern
}

rule __isnan_334e36377d8603c6d7c007e4720414b4 {
	meta:
		aliases = "__GI___isnan, __isnan"
		size = "46"
		objfiles = "s_isnan@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C DD 44 24 10 DD 1C 24 8B 14 24 8B 44 24 04 F7 DA 0B 14 24 25 FF FF FF 7F 83 C4 0C C1 EA 1F 09 C2 B8 00 00 F0 7F 29 D0 C1 E8 1F C3 }
	condition:
		$pattern
}

rule __GI___finite_fffbf09343e0a0c6e3934379c3f2bc08 {
	meta:
		aliases = "__finite, __GI___finite"
		size = "30"
		objfiles = "s_finite@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C DD 44 24 10 DD 1C 24 8B 44 24 04 0D FF FF 0F 80 40 0F 95 C0 83 C4 0C 0F B6 C0 C3 }
	condition:
		$pattern
}
...
rule __GI___isinf_33a2034387dbd8d78c60a4830386bc8e {
	meta:
		aliases = "__isinf, __GI___isinf"
		size = "51"
		objfiles = "s_isinf@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C DD 44 24 10 DD 1C 24 8B 4C 24 04 89 CA 81 E2 FF FF FF 7F 81 F2 00 00 F0 7F 0B 14 24 83 C4 0C C1 F9 1E 89 D0 F7 D8 09 D0 C1 F8 1F F7 D0 21 C8 C3 }
	condition:
		$pattern
}
...
rule on_exit_3d90526508e5f54b32f83898969cd733 {
	meta:
		aliases = "on_exit"
		size = "43"
		objfiles = "on_exit@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C E8 ?? ?? ?? ?? 89 C2 83 C8 FF 85 D2 74 16 8B 44 24 10 C7 02 02 00 00 00 89 42 04 8B 44 24 14 89 42 08 31 C0 83 C4 0C C3 }
	condition:
		$pattern
}

rule __rpc_thread_svc_fdset_fdd5b14c4e349214cf7aa30a5601ba6f {
	meta:
...
rule __rpc_thread_createerr_83e8589a66e08e3d7f7ecd2ef782dabc {
	meta:
		aliases = "__GI___rpc_thread_createerr, __rpc_thread_createerr"
		size = "33"
		objfiles = "rpc_thread@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C E8 ?? ?? ?? ?? BA ?? ?? ?? ?? 3D ?? ?? ?? ?? 8D 88 80 00 00 00 0F 45 D1 83 C4 0C 89 D0 C3 }
	condition:
		$pattern
}

rule __GI___rpc_thread_svc_pollfd_8560cd79f4a37af90499daff3d0c403c {
	meta:
		aliases = "__rpc_thread_svc_pollfd, __GI___rpc_thread_svc_pollfd"
		size = "33"
		objfiles = "rpc_thread@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C E8 ?? ?? ?? ?? BA ?? ?? ?? ?? 3D ?? ?? ?? ?? 8D 88 90 00 00 00 0F 45 D1 83 C4 0C 89 D0 C3 }
	condition:
		$pattern
}

rule __GI___rpc_thread_svc_max_poll_6737293ba998fc2e4738c0fa72910ff3 {
	meta:
		aliases = "__rpc_thread_svc_max_pollfd, __GI___rpc_thread_svc_max_pollfd"
		size = "33"
		objfiles = "rpc_thread@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C E8 ?? ?? ?? ?? BA ?? ?? ?? ?? 3D ?? ?? ?? ?? 8D 88 94 00 00 00 0F 45 D1 83 C4 0C 89 D0 C3 }
	condition:
		$pattern
}
...
rule __GI_svcudp_create_be65e047c136afb13ba3dffdcef51965 {
	meta:
...
rule __ieee754_lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "strtok, gamma, __GI_lgamma, __GI_strtok, lgamma, __ieee754_lgamma"
		size = "25"
...
rule atoll_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "atoi, __GI_atoi, atol, atoll"
		size = "20"
...
rule __GI_strerror_9a1d611ea3b0860357aa95dfa5649b6b {
	meta:
...
rule drand48_r_c7069002931132f2dfc08888133d95bf {
	meta:
		aliases = "mrand48_r, __GI_lrand48_r, lrand48_r, drand48_r"
		size = "22"
...
rule fedisableexcept_e5d704a64020ab1b79d7b51159b5a4c1 {
	meta:
		aliases = "fedisableexcept"
		size = "40"
		objfiles = "fedisblxcpt@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 8B 54 24 14 9B D9 7C 24 0E 0F B7 44 24 0E 83 E2 3D 09 C2 66 89 54 24 0E D9 6C 24 0E F7 D0 83 C4 10 83 E0 3D C3 }
	condition:
		$pattern
}

rule feenableexcept_a8d7a8f98057c05e61c031a961b8373d {
	meta:
		aliases = "feenableexcept"
		size = "42"
		objfiles = "feenablxcpt@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 8B 54 24 14 9B D9 7C 24 0E 0F B7 44 24 0E 83 E2 3D F7 D2 21 C2 66 89 54 24 0E D9 6C 24 0E F7 D0 83 C4 10 83 E0 3D C3 }
	condition:
		$pattern
}

rule __GI_inet_makeaddr_a1ed8657b31e3725a6c4d3601565bd3b {
	meta:
		aliases = "inet_makeaddr, __GI_inet_makeaddr"
		size = "84"
		objfiles = "inet_addr@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 8B 54 24 18 8B 4C 24 14 8B 44 24 1C 83 FA 7F 77 0A 25 FF FF FF 00 C1 E2 18 EB 22 81 FA FF FF 00 00 77 0A 25 FF FF 00 00 C1 E2 10 EB 10 81 FA FF FF FF 00 77 08 25 FF 00 00 00 C1 E2 08 09 D0 89 44 24 0C 8B 44 24 0C 89 01 89 C8 83 C4 10 C2 04 00 }
	condition:
		$pattern
}
...
rule fesetround_ef4b3dd22f4129e256b27b9653bea338 {
	meta:
		aliases = "fesetround"
		size = "49"
		objfiles = "fesetround@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 B8 01 00 00 00 8B 54 24 14 F7 C2 FF F3 FF FF 75 19 D9 7C 24 0E 66 8B 44 24 0E 80 E4 F3 09 C2 66 89 54 24 0E D9 6C 24 0E 31 C0 83 C4 10 C3 }
	condition:
		$pattern
}
...
rule gmtime_r_1a2c0490f5b8cdeeb9221e9da900869e {
	meta:
		aliases = "bzero, mkostemp, mq_getattr, gmtime_r"
		size = "22"
		objfiles = "mq_getsetattr@librt.a, mkstemp@libc.a, bzero@libc.a, gmtime_r@libc.a"
	strings:
...
rule putwc_unlocked_cedf1dab072b80c7182498b4e44b629a {
	meta:
...
rule mkostemp64_a6f4589e6747d502f46d4681609a15f4 {
	meta:
		aliases = "mkostemp64"
		size = "22"
		objfiles = "mkstemp64@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 10 FF 74 24 18 6A 01 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 1C C3 }
	condition:
		$pattern
}
...
rule vwprintf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "vprintf, vwscanf, vscanf, vwprintf"
		size = "26"
		objfiles = "vscanf@libc.a, vprintf@libc.a, vwprintf@libc.a, vwscanf@libc.a"
	strings:
...
rule mkstemp64_f8ab71052a2c5ac93e65c0449d5ff783 {
	meta:
		aliases = "mkstemp, mkstemp64"
		size = "21"
		objfiles = "mkstemp@libc.a, mkstemp64@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 14 68 80 01 00 00 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 1C C3 }
	condition:
		$pattern
}
...
rule __GI_asctime_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "__GI_inet_ntoa, hcreate, srand48, ether_ntoa, inet_ntoa, asctime, __GI_asctime"
		size = "21"
		objfiles = "hsearch@libc.a, inet_ntoa@libc.a, asctime@libc.a, srand48@libc.a, ether_addr@libc.a"
	strings:
...
rule atof_6bf719c25f6fbaef08052b0889ae3660 {
	meta:
		aliases = "sigpause, atof"
		size = "18"
		objfiles = "sigpause@libc.a, atof@libc.a"
	strings:
...
rule timelocal_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "iswalnum, __GI_iswalnum, mktime, timelocal"
		size = "18"
		objfiles = "iswalnum@libc.a, mktime@libc.a"
	strings:
...
rule gethostbyname_44c9108329ea01c01c96bfbe167c0d14 {
	meta:
		aliases = "__GI_gethostbyname, iswalpha, gethostbyname"
		size = "18"
...
rule svcerr_weakauth_7720675966c0239ac00d65240257cbfe {
	meta:
		aliases = "iswdigit, svcerr_weakauth"
		size = "18"
...
rule __GI_copysign_f9539c5de89cf8410b0da67dc76e0047 {
	meta:
		aliases = "copysign, __GI_copysign"
		size = "46"
		objfiles = "s_copysign@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 14 DD 44 24 18 8B 54 24 24 DD 54 24 08 8B 44 24 0C DD 1C 24 81 E2 00 00 00 80 25 FF FF FF 7F 09 C2 89 54 24 04 DD 04 24 83 C4 14 C3 }
	condition:
		$pattern
}

rule __GI_fabs_21078a5c649b4c46afdba71a9069e1a1 {
	meta:
...
rule ldexp_1ec52d2acdc04796858d122054bb9a9d {
	meta:
...
rule __GI_verr_1c97125b3f40865ae46e521e13ed7a6f {
	meta:
		aliases = "verr, __GI_verr"
		size = "26"
		objfiles = "err@libc.a"
	strings:
...
rule verrx_7357e70f0c684d0d024a2980ee1de30e {
	meta:
		aliases = "__GI_verrx, verrx"
		size = "26"
		objfiles = "err@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 14 FF 74 24 20 FF 74 24 20 E8 ?? ?? ?? ?? 59 FF 74 24 1C E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "condvar@libpthread.a, pthread@libpthread.a, spinlock@libpthread.a, join@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule canonicalize_file_name_ac34f3de1dac81f2e4d0f721eb67c87c {
	meta:
		aliases = "canonicalize_file_name"
		size = "48"
		objfiles = "canonicalize@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 18 68 00 10 00 00 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 74 14 C6 00 00 52 52 50 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 89 C2 89 D0 83 C4 0C C3 }
	condition:
		$pattern
}

rule __GI_getlogin_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__open_etc_hosts, _flushlbf, __pthread_once_fork_prepare, getlogin, hdestroy, __pthread_once_fork_parent, __GI_getlogin"
		size = "17"
		objfiles = "hsearch@libc.a, read_etc_hosts_r@libc.a, mutex@libpthread.a, _flushlbf@libc.a, getlogin@libc.a"
	strings:
...
rule re_compile_pattern_b451e201ffa6a9ebfb23edda661c2b85 {
	meta:
		aliases = "re_compile_pattern"
		size = "66"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 18 8B 54 24 24 8A 42 1C 24 E9 0C 80 88 42 1C 52 8B 0D ?? ?? ?? ?? 8B 54 24 24 8B 44 24 20 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 74 0E 0F B7 84 00 ?? ?? ?? ?? 8D 90 ?? ?? ?? ?? 89 D0 83 C4 0C C3 }
	condition:
		$pattern
}

rule mbsrtowcs_d748ca9feaf7500fbb4c7cb8fe262435 {
	meta:
...
rule __libc_open64_269135a6a54274717e5aa83c9cce8bb2 {
	meta:
		aliases = "open64, __GI_open64, __libc_open64"
		size = "45"
...
rule xdrstdio_putlong_446f7039efc650c3a7d8de0845419b08 {
	meta:
		aliases = "xdrstdio_putint32, xdrstdio_putlong"
		size = "47"
		objfiles = "xdr_stdio@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C 8B 44 24 24 8B 00 0F C8 89 44 24 18 8B 44 24 20 FF 70 0C 6A 01 6A 04 8D 44 24 24 50 E8 ?? ?? ?? ?? 48 0F 94 C0 83 C4 2C 0F B6 C0 C3 }
	condition:
		$pattern
}
...
rule lutimes_60176202fb60d3c01c40e8d95b923c43 {
	meta:
		aliases = "lutimes"
		size = "117"
		objfiles = "lutimes@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C 8B 4C 24 24 85 C9 74 50 81 79 04 3F 42 0F 00 77 0F 8B 51 0C 85 D2 78 08 81 FA 3F 42 0F 00 7E 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 3E 8B 01 89 44 24 0C 69 41 04 E8 03 00 00 89 44 24 10 8B 41 08 89 44 24 14 69 C2 E8 03 00 00 89 44 24 18 8D 44 24 0C EB 02 31 C0 68 00 01 00 00 50 FF 74 24 28 6A 9C E8 ?? ?? ?? ?? 83 C4 10 83 C4 1C C3 }
	condition:
		$pattern
}
...
rule getspent_975d0e0bc0166ffe58a24e49d939ba0d {
	meta:
...
rule wprintf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "scanf, printf, wscanf, __GI_printf, wprintf"
		size = "32"
		objfiles = "scanf@libc.a, printf@libc.a, wscanf@libc.a, wprintf@libc.a"
	strings:
...
rule __GI_sscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "__GI_asprintf, dprintf, __GI_fprintf, fwscanf, fscanf, syslog, asprintf, fwprintf, __GI_fscanf, swscanf, __GI_syslog, fprintf, sscanf, __GI_sscanf"
		size = "30"
		objfiles = "sscanf@libc.a, fwprintf@libc.a, swscanf@libc.a, fscanf@libc.a, syslog@libc.a"
	strings:
...
rule llroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "ilogbf, lrintf, llrintf, lroundf, llroundf"
		size = "19"
		objfiles = "lrintf@libm.a, llroundf@libm.a, llrintf@libm.a, ilogbf@libm.a, lroundf@libm.a"
	strings:
...
rule acosf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "cosf, cbrtf, atanhf, truncf, tanf, ceilf, expm1f, log1pf, logf, erfcf, exp2f, tanhf, sqrtf, sinhf, log2f, expf, asinf, erff, significandf, sinf, coshf, asinhf, rintf, lgammaf, roundf, log10f, fabsf, logbf, floorf, acoshf, gammaf, atanf, acosf"
		size = "27"
		objfiles = "erfcf@libm.a, floorf@libm.a, asinf@libm.a, atanf@libm.a, roundf@libm.a"
	strings:
...
rule fmodf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "powf, hypotf, scalbf, remainderf, copysignf, atan2f, fmodf"
		size = "35"
		objfiles = "hypotf@libm.a, powf@libm.a, scalbf@libm.a, fmodf@libm.a, atan2f@libm.a"
	strings:
...
rule __GI_logb_65b09d064d612ca6db0374b9cf982cd9 {
	meta:
...
rule getnetbyname_54a8905ef74bd676c9a9b87fc81b1394 {
	meta:
		aliases = "getnetbyname"
		size = "53"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 50 50 8D 44 24 1C 50 8D 44 24 24 50 68 2C 01 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 3C E8 ?? ?? ?? ?? 8B 44 24 38 83 C4 3C C3 }
	condition:
		$pattern
}

rule getservbyname_f5f52c5a65a4a139c99a519427d2801d {
	meta:
		aliases = "getservbyport, __GI_getservbyport, getservbyname"
		size = "52"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 50 50 8D 44 24 20 50 68 30 01 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 3C FF 74 24 3C E8 ?? ?? ?? ?? 8B 44 24 38 83 C4 3C C3 }
	condition:
		$pattern
}

rule getnetbyaddr_7cf8741df5c411c7511f685e979a1d47 {
	meta:
		aliases = "getnetbyaddr"
		size = "56"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 50 8D 44 24 18 50 8D 44 24 20 50 68 2C 01 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 3C FF 74 24 3C E8 ?? ?? ?? ?? 8B 44 24 38 83 C4 3C C3 }
	condition:
		$pattern
}

rule __GI_gethostbyaddr_9503875047db4ec01f61bd9926376753 {
	meta:
		aliases = "gethostbyaddr, __GI_gethostbyaddr"
		size = "54"
		objfiles = "gethostbyaddr@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 50 8D 44 24 1C 50 68 B8 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 3C FF 74 24 3C FF 74 24 3C E8 ?? ?? ?? ?? 8B 44 24 38 83 C4 3C C3 }
	condition:
		$pattern
}

rule __GI_gethostbyname2_976e2bef461335cbce35b7dc80b5e740 {
	meta:
		aliases = "gethostbyname2, __GI_gethostbyname2"
		size = "51"
		objfiles = "gethostbyname2@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 52 50 8D 44 24 20 50 68 B8 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 3C FF 74 24 3C E8 ?? ?? ?? ?? 8B 44 24 38 83 C4 3C C3 }
	condition:
		$pattern
}

rule gethostent_f9066ecd2e42103d4c28bda9cfd523ad {
	meta:
		aliases = "gethostent"
		size = "42"
		objfiles = "gethostent@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 83 EC 0C 50 8D 44 24 28 50 6A 6A 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 38 83 C4 3C C3 }
	condition:
		$pattern
}

rule getnetent_e5689b287287aeb95ed668fcc8c92427 {
	meta:
		aliases = "getnetent"
		size = "50"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 83 EC 0C 8D 44 24 20 50 8D 44 24 28 50 68 2C 01 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 38 83 C4 3C C3 }
	condition:
		$pattern
}

rule getprotobyname_1c2ca1e9afd0068febc3199b68160d72 {
	meta:
		aliases = "getprotobynumber, getprotobyname"
		size = "49"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 83 EC 0C 8D 44 24 24 50 68 2C 01 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 3C E8 ?? ?? ?? ?? 8B 44 24 38 83 C4 3C C3 }
	condition:
		$pattern
}

rule getprotoent_dcac88e02eedf8ad89fa5c5c4e143e79 {
	meta:
		aliases = "getprotoent"
		size = "42"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 8D 44 24 18 50 68 2C 01 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 28 83 C4 2C C3 }
	condition:
		$pattern
}

rule getservent_e52b2181d922002a546cb54561a60b90 {
	meta:
		aliases = "getservent"
		size = "42"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 8D 44 24 18 50 68 30 01 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 28 83 C4 2C C3 }
	condition:
		$pattern
}
...
rule fesetexceptflag_2351cba7ad5166fd9a98ab06766e4659 {
	meta:
		aliases = "fesetexceptflag"
		size = "54"
		objfiles = "fsetexcptflg@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 20 0F BF 4C 24 28 D9 74 24 04 8B 54 24 08 89 C8 83 E0 3D F7 D0 21 D0 8B 54 24 24 66 8B 12 21 D1 83 E1 3D 09 C8 66 89 44 24 08 D9 64 24 04 31 C0 83 C4 20 C3 }
	condition:
		$pattern
}
...
rule strtod_933c5f43d5ab233ccdd1cdce8fe5644f {
	meta:
		aliases = "wcstod, __GI_strtod, strtod"
		size = "49"
...
rule __GI_sigblock_904d1e599f38bff431d2fd3826a3dd2d {
	meta:
		aliases = "sigblock, __GI_sigblock"
		size = "44"
		objfiles = "sigblock@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 20 8B 44 24 24 C7 44 24 1C 00 00 00 00 89 44 24 18 8D 44 24 10 50 8D 44 24 1C 50 6A 00 E8 ?? ?? ?? ?? 8B 44 24 1C 83 C4 2C C3 }
	condition:
		$pattern
}

rule sigsetmask_7b7d6858924bd21ed1e30fe76558a3ce {
	meta:
		aliases = "__GI_sigsetmask, sigsetmask"
		size = "44"
		objfiles = "sigsetmask@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 20 8B 44 24 24 C7 44 24 1C 00 00 00 00 89 44 24 18 8D 44 24 10 50 8D 44 24 1C 50 6A 02 E8 ?? ?? ?? ?? 8B 44 24 1C 83 C4 2C C3 }
	condition:
		$pattern
}
...
rule feraiseexcept_18c6f3a26360cf28ad7c75d91be4d451 {
	meta:
...
rule accept4_db3115b31f22f4e3ad4298b91bf2addc {
	meta:
		aliases = "accept4"
		size = "51"
		objfiles = "accept4@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 24 8B 44 24 28 89 44 24 14 8B 44 24 2C 89 44 24 18 8B 44 24 30 89 44 24 1C 8B 44 24 34 89 44 24 20 8D 44 24 14 50 6A 12 E8 ?? ?? ?? ?? 83 C4 2C C3 }
	condition:
		$pattern
}
...
rule __kernel_cos_564285f77a3373269bbb4347e2bebefb {
	meta:
		aliases = "__kernel_cos"
		size = "265"
		objfiles = "k_cos@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 24 DD 44 24 28 C7 44 24 08 00 00 00 00 DD 14 24 DD 44 24 30 D9 C9 DD 54 24 10 8B 54 24 14 C7 44 24 0C 00 00 00 00 81 E2 FF FF FF 7F 81 FA FF FF 3F 3E 7F 2E D9 7C 24 1E 66 8B 44 24 1E 80 CC 0C 66 89 44 24 1C D9 6C 24 1C DB 5C 24 18 D9 6C 24 1E 8B 44 24 18 85 C0 75 0B DD D8 D9 E8 E9 A1 00 00 00 DD D8 DD 04 24 81 FA 32 33 D3 3F D8 C8 DD 05 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 7F 1C D9 C1 D8 0D ?? ?? ?? ?? D9 CA DE C9 D9 CA DC 0C 24 DD 14 24 DE EA DE E1 D9 E8 EB 44 81 FA 00 00 E9 3F 7E 08 D9 }
	condition:
		$pattern
}

rule __GI_ilogb_78663a7c013b95fe5c3df254f23ac384 {
	meta:
		aliases = "ilogb, __GI_ilogb"
		size = "132"
		objfiles = "s_ilogb@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 24 DD 44 24 28 DD 14 24 DD 54 24 18 8B 54 24 1C 81 E2 FF FF FF 7F 81 FA FF FF 0F 00 7F 2B DD 5C 24 10 89 D0 8B 4C 24 10 09 C8 74 4D 85 D2 B8 ED FB FF FF 74 0E 89 D1 66 B8 02 FC C1 E1 0B EB 03 48 01 C9 85 C9 7F F9 EB 35 DD D8 81 FA FF FF EF 7F 7F 0B C1 FA 14 8D 82 01 FC FF FF EB 20 DD 04 24 81 FA 00 00 F0 7F DD 5C 24 08 75 0C 83 7C 24 08 00 B8 FF FF FF 7F 74 05 B8 00 00 00 80 83 C4 24 C3 }
	condition:
		$pattern
}

rule scalb_ff3a41152a62b90750a0f75bdaa1340e {
	meta:
		aliases = "__ieee754_scalb, scalb"
		size = "282"
		objfiles = "e_scalb@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 24 DD 44 24 28 DD 5C 24 10 DD 44 24 30 DD 5C 24 08 FF 74 24 14 FF 74 24 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 16 51 51 FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0C DD 44 24 08 DC 0C 24 E9 CD 00 00 00 52 52 FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 2C D9 EE DD 04 24 DB E9 DD D9 76 0B DD 44 24 08 DE C9 E9 A1 00 00 00 DD D8 DD 04 24 D9 E0 DD 1C 24 DD 44 24 08 DC 34 24 E9 8B 00 00 00 50 50 FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 10 DD 04 24 D9 C9 DF E9 7A 02 74 08 D9 C0 DE E1 D8 F0 EB 66 DD D8 D9 05 ?? ?? ?? ?? DD 04 24 DF E9 DD D8 76 0A C7 44 24 28 E8 FD 00 }
	condition:
		$pattern
}
...
rule fmin_4922489c17678736a5558ceb804536c3 {
	meta:
		aliases = "__GI_fmin, fmin"
		size = "95"
		objfiles = "s_fmin@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 24 DD 44 24 28 DD 5C 24 18 DD 44 24 30 DD 5C 24 10 FF 74 24 1C FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 30 50 50 FF 74 24 14 FF 74 24 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 06 DD 44 24 08 EB 10 DD 44 24 08 DD 44 24 10 D9 C9 DB E9 DB D1 DD D9 DD 5C 24 10 DD 44 24 10 83 C4 1C C3 }
	condition:
		$pattern
}

rule __GI_fmax_b77d1b1ca0f2412bf7bffc9a3bfd1eb1 {
	meta:
		aliases = "fmax, __GI_fmax"
		size = "95"
		objfiles = "s_fmax@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 24 DD 44 24 28 DD 5C 24 18 DD 44 24 30 DD 5C 24 10 FF 74 24 1C FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 30 50 50 FF 74 24 14 FF 74 24 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 06 DD 44 24 08 EB 10 DD 44 24 10 DD 44 24 08 D9 C9 DB E9 DA D1 DD D9 DD 5C 24 10 DD 44 24 10 83 C4 1C C3 }
	condition:
		$pattern
}
...
rule fgetgrent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetspent, sgetspent, getpwuid, getpwnam, fgetpwent, getgrgid, getgrnam, getspnam, fgetgrent"
		size = "40"
		objfiles = "getgrgid@libc.a, getpwnam@libc.a, getpwuid@libc.a, getspnam@libc.a, getgrnam@libc.a"
	strings:
...
rule wcrtomb_9de814eaee55569e5b2abb1187d40943 {
	meta:
...
rule __GI_tan_fa8398583f0bce8f998ae0c7188b89fa {
	meta:
...
rule __GI_sendto_410aaa21bf82c35acb5a8f5810fb2da5 {
	meta:
...
rule __sysv_signal_d437090813ef014c3051162533e7f1b1 {
	meta:
		aliases = "sysv_signal, __sysv_signal"
		size = "106"
		objfiles = "sysv_signal@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 3C 8B 44 24 44 8B 54 24 40 83 F8 FF 74 09 85 D2 7E 05 83 FA 40 7E 10 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 EB 3B 89 44 24 28 C7 44 24 34 00 00 00 00 C7 44 24 38 00 00 00 00 C7 44 24 2C 00 00 00 E0 50 8D 44 24 18 50 8D 44 24 30 50 52 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 04 8B 54 24 14 89 D0 83 C4 3C C3 }
	condition:
		$pattern
}

rule __GI_log1p_5f8c103a92a76772575c475840832dc1 {
	meta:
		aliases = "log1p, __GI_log1p"
		size = "651"
		objfiles = "s_log1p@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 3C DD 44 24 40 DD 14 24 DD 5C 24 28 8B 54 24 2C 81 FA 79 82 DA 3F 0F 8F 90 00 00 00 89 D0 25 FF FF FF 7F 3D FF FF EF 3F 7E 2A D9 05 ?? ?? ?? ?? DD 04 24 DF E9 DD D8 75 0F 7A 0D D9 EE D8 3D ?? ?? ?? ?? E9 33 02 00 00 DD 04 24 D8 E0 D8 F0 E9 27 02 00 00 3D FF FF 1F 3E 7F 31 DD 04 24 D8 05 ?? ?? ?? ?? D9 EE D9 C9 DF E9 DD D8 76 0B 3D FF FF 8F 3C 0F 8E 09 02 00 00 DD 04 24 D8 C8 D8 0D ?? ?? ?? ?? DC 04 24 E9 EF 01 00 00 8D 82 3C 41 2D 40 3D 3C 41 2D 40 76 25 DD 04 24 BA 01 00 00 00 31 C9 D9 EE D9 C9 E9 C1 00 00 00 81 FA FF FF EF 7F 7E 0A DD 04 24 D8 C0 E9 BD 01 00 00 81 FA FF FF 3F 43 7F 3C }
	condition:
		$pattern
}

rule __GI_svcerr_auth_ee4a0c2e5ba75143b9ec148d710219a7 {
	meta:
...
rule __GI_exp_3a89ca36e0cd59d0b24a53c3ad9716c8 {
	meta:
		aliases = "__ieee754_exp, exp, __GI_exp"
		size = "491"
		objfiles = "e_exp@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 4C DD 44 24 50 DD 14 24 DD 54 24 30 8B 54 24 34 89 D0 89 D1 25 FF FF FF 7F C1 E9 1F 3D 41 2E 86 40 76 60 3D FF FF EF 7F 76 23 DD 54 24 28 81 E2 FF FF 0F 00 0B 54 24 28 74 07 D8 C0 E9 9E 01 00 00 DD D8 85 C9 0F 84 97 01 00 00 EB 2F DD D8 DD 05 ?? ?? ?? ?? DD 04 24 DF E9 DD D8 76 0D DD 05 ?? ?? ?? ?? D8 C8 E9 74 01 00 00 DD 05 ?? ?? ?? ?? DD 04 24 D9 C9 DF E9 DD D8 76 31 D9 EE E9 5C 01 00 00 DD D8 3D 42 2E D6 3F 76 79 3D B1 A2 F0 3F 77 1A DD 04 24 89 C8 DC 24 CD ?? ?? ?? ?? F7 D8 29 C8 40 DD 04 CD ?? ?? ?? ?? EB 4F D9 7C 24 46 DD 04 24 DC 0D ?? ?? ?? ?? 66 8B 44 24 46 DC 04 CD ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __ieee754_acos_19f07b604fed0419d5b4c5d578ba0605 {
	meta:
		aliases = "__GI_acos, acos, __ieee754_acos"
		size = "556"
		objfiles = "e_acos@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 4C DD 44 24 50 DD 54 24 18 DD 54 24 30 8B 54 24 34 89 D0 25 FF FF FF 7F 3D FF FF EF 3F 7E 33 DD 5C 24 28 2D 00 00 F0 3F 0B 44 24 28 75 17 4A DD 05 ?? ?? ?? ?? 0F 9D C0 84 C0 D9 EE DA C9 DD D9 E9 E1 01 00 00 DD 44 24 18 D8 E0 D8 F0 E9 D4 01 00 00 DD D8 3D FF FF DF 3F 0F 8F 8B 00 00 00 3D 00 00 60 3C 7F 0B DD 05 ?? ?? ?? ?? E9 B5 01 00 00 DD 44 24 18 D8 C8 DD 05 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 DC 25 ?? ?? ?? ?? D8 C9 DC 05 ?? ?? ?? ?? D8 C9 DD 05 ?? ?? ?? ?? D8 CA DC 25 ?? ?? ?? ?? D8 CA DC 05 ?? ?? ?? ?? D8 CA DC 25 ?? ?? ?? ?? DE }
	condition:
		$pattern
}
...
rule expm1_c01435cf44eb49fcce938a1d618b6c5b {
	meta:
		aliases = "__GI_expm1, expm1"
		size = "712"
		objfiles = "s_expm1@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 7C DD 84 24 80 00 00 00 DD 14 24 DD 54 24 50 8B 54 24 54 89 D0 89 D1 25 FF FF FF 7F 81 E1 00 00 00 80 3D 79 68 43 40 76 71 3D 41 2E 86 40 76 48 3D FF FF EF 7F 76 23 DD 54 24 48 81 E2 FF FF 0F 00 0B 54 24 48 74 07 D8 C0 E9 6E 02 00 00 DD D8 85 C9 0F 84 67 02 00 00 EB 35 DD D8 DD 05 ?? ?? ?? ?? DD 04 24 DF E9 DD D8 76 0F DD 05 ?? ?? ?? ?? D8 C8 E9 44 02 00 00 DD D8 85 C9 74 5F DD 04 24 DC 05 ?? ?? ?? ?? D9 EE DF E9 DD D8 76 4A D9 05 ?? ?? ?? ?? E9 22 02 00 00 DD D8 3D 42 2E D6 3F 0F 86 97 00 00 00 3D B1 A2 F0 3F 77 2B 85 C9 75 13 DD 04 24 B1 01 DC 25 ?? ?? ?? ?? DD 05 ?? ?? ?? ?? EB 6C DD }
	condition:
		$pattern
}
...
rule pthread_insert_list_a824e9755f600fae681d7a318864b30f {
	meta:
		aliases = "pthread_insert_list"
		size = "36"
		objfiles = "ptfork@libpthread.a"
	strings:
		$pattern = { ( CC | 85 ) D2 53 89 C3 74 1B 83 7C 24 08 00 75 05 EB 09 8D 58 04 8B 03 85 C0 75 F7 8B 03 89 11 89 41 04 89 0B 5B C3 }
	condition:
		$pattern
}
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		aliases = "__i686.get_pc_thunk.cx"
		size = "4"
		objfiles = "_floatdidf@libgcc.a, _fixunssfdi@libgcc.a, _fixunsdfsi@libgcc.a, _floatdixf@libgcc.a, unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 8B ) 0C 24 C3 }
	condition:
		$pattern
}
...
rule __i686_DOT_get_pc_thunk_DOT_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		aliases = "__get_pc_thunk_bx, __i686.get_pc_thunk.bx"
		size = "4"
		objfiles = "unwind_dw2@libgcc_eh.a, unwind_c@libgcc_eh.a, crtn, _powidf2@libgcc.a, _floatundisf@libgcc.a"
	strings:
...
rule __GI___finitef_2619605be797367fc3a3ac36f7b890d3 {
	meta:
...
rule inet_lnaof_0bfacc960aaa76736f57f079f99ba6b4 {
	meta:
		aliases = "inet_lnaof"
		size = "48"
		objfiles = "inet_lnaof@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 0F C8 85 C0 78 0A 89 C1 81 E1 FF FF FF 00 EB 19 89 C2 0F B7 C8 81 E2 00 00 00 C0 25 FF 00 00 00 81 FA 00 00 00 80 0F 45 C8 89 C8 C3 }
	condition:
		$pattern
}

rule __GI_ntohl_f0b2ac96b2a9c6535f6815b42030bed8 {
	meta:
		aliases = "ntohl, htonl, __GI_htonl, __GI_ntohl"
		size = "7"
		objfiles = "ntohl@libc.a"
	strings:
...
rule __init_scan_cookie_2f2ed3462c967c20b69784a61475de46 {
	meta:
		aliases = "__init_scan_cookie"
		size = "72"
		objfiles = "__scan_cookie@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 31 C9 8B 54 24 08 C6 40 19 00 F6 02 02 89 50 08 C7 40 0C 00 00 00 00 74 03 8B 4A 28 89 48 14 C6 40 1A 00 C6 40 1B 00 C7 40 30 ?? ?? ?? ?? C7 40 3C ?? ?? ?? ?? C7 40 34 01 00 00 00 C7 40 38 2E 00 00 00 C3 }
	condition:
		$pattern
}
...
rule basename_772a062951b010633ccc5dc2da8d37f0 {
	meta:
...
rule pthread_mutexattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_mutexattr_gettype, __pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, __GI_pthread_attr_getdetachstate, pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, pthread_mutexattr_getkind_np"
		size = "15"
...
rule cfmakeraw_72fb607abe4b3fd8cdb2535646f54175 {
	meta:
		aliases = "cfmakeraw"
		size = "45"
		objfiles = "cfmakeraw@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 50 08 81 20 14 FA FF FF 83 60 04 FE 81 60 0C B4 7F FF FF 81 E2 CF FE FF FF 83 CA 30 89 50 08 C6 40 17 01 C6 40 16 00 C3 }
	condition:
		$pattern
}

rule __GI_pthread_attr_getschedpara_bf01487b64a973dd33d77632c300357d {
	meta:
		aliases = "sem_getvalue, __new_sem_getvalue, pthread_attr_getschedparam, __GI_pthread_attr_getschedparam"
		size = "16"
...
rule __GI_tdestroy_8964637c7b9ae7f838fe29aa782cfaa4 {
	meta:
...
rule __GI_setenv_e63fbd4454ec064dc8f9d0b775e2be85 {
	meta:
		aliases = "svcunixfd_create, setenv, svcfd_create, __GI_setenv"
		size = "17"
		objfiles = "setenv@libc.a, svc_unix@libc.a, svc_tcp@libc.a"
	strings:
...
rule clntudp_freeres_560969b37149ac7352850b061b79b67a {
	meta:
		aliases = "clntudp_freeres"
		size = "35"
		objfiles = "clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 54 24 0C 8B 4C 24 08 8B 40 08 C7 40 38 02 00 00 00 83 C0 38 89 54 24 08 89 44 24 04 FF E1 }
	condition:
		$pattern
}

rule clnttcp_freeres_78679f27b56d374ba227f2acb7b0e2e9 {
	meta:
		aliases = "clnttcp_freeres"
		size = "35"
		objfiles = "clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 54 24 0C 8B 4C 24 08 8B 40 08 C7 40 4C 02 00 00 00 83 C0 4C 89 54 24 08 89 44 24 04 FF E1 }
	condition:
		$pattern
}

rule clntunix_freeres_b62d97de5cd51d1fdafbe995d825c7a5 {
	meta:
		aliases = "clntunix_freeres"
		size = "40"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 54 24 0C 8B 4C 24 08 8B 40 08 C7 80 AC 00 00 00 02 00 00 00 05 AC 00 00 00 89 54 24 08 89 44 24 04 FF E1 }
	condition:
		$pattern
}

rule svcunix_freeargs_4ce5d86157217064988b419ad405a8f5 {
	meta:
		aliases = "svctcp_freeargs, svcunix_freeargs"
		size = "35"
		objfiles = "svc_unix@libc.a, svc_tcp@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 54 24 0C 8B 4C 24 08 8B 40 2C C7 40 08 02 00 00 00 83 C0 08 89 54 24 08 89 44 24 04 FF E1 }
	condition:
		$pattern
}

rule svcudp_freeargs_f833e27a0252f22ff5a7d22e2ca8595e {
	meta:
		aliases = "svcudp_freeargs"
		size = "35"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 54 24 0C 8B 4C 24 08 8B 40 30 C7 40 08 02 00 00 00 83 C0 08 89 54 24 08 89 44 24 04 FF E1 }
	condition:
		$pattern
}
...
rule vwarn_289e1366786f21d513af9ab6ffcc9814 {
	meta:
...
rule sigemptyset_9cccfab68f4bd16a32525f638f9dcc39 {
	meta:
		...
		size = "20"
		objfiles = "rwlock@libpthread.a, sigempty@libc.a"
	strings:
...
rule __GI_re_compile_fastmap_08954bb79c8aadcdb928571c8d2dfa6d {
	meta:
		aliases = "re_compile_fastmap, __GI_re_compile_fastmap"
		size = "9"
		objfiles = "regex_old@libc.a"
	strings:
...
rule __GI_pthread_attr_setscope_42b49a21112362d26f322023b3812ef1 {
	meta:
...
rule __GI_openat64_27fdaf8728193a1191e5f313db07dbf9 {
	meta:
		aliases = "openat64, __GI_openat64"
		size = "16"
...
rule __GI_times_c27ef60e06858f08745007bcafd5a7f1 {
	meta:
...
rule __GI___isinff_30cbee42609e1f01fef825ff04c3f450 {
	meta:
		aliases = "__isinff, __GI___isinff"
		size = "35"
		objfiles = "s_isinff@libm.a"
	strings:
		$pattern = { ( CC | 8B ) 4C 24 04 89 CA 81 E2 FF FF FF 7F 81 F2 00 00 80 7F 89 D0 F7 D8 09 D0 C1 F8 1F C1 F9 1E F7 D0 21 C8 C3 }
	condition:
		$pattern
}
...
rule __GI_ffs_feb723aec7491e08bab0f2405a8fa304 {
	meta:
		aliases = "ffsl, ffs, __GI_ffs"
		size = "66"
		objfiles = "ffs@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 4C 24 04 B2 01 66 85 C9 75 05 C1 F9 10 B2 11 84 C9 75 06 80 C2 08 C1 F9 08 F6 C1 0F 75 06 80 C2 04 C1 F9 04 F6 C1 03 75 06 80 C2 02 C1 F9 02 31 C0 85 C9 74 0B 8D 41 01 0F B6 D2 83 E0 01 01 D0 C3 }
	condition:
		$pattern
}
...
rule _dl_aux_init_b6e10270a306768560b0e70cc90f2046 {
	meta:
		aliases = "_dl_aux_init"
		size = "18"
		objfiles = "dl_support@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 50 1C 8B 40 2C 89 15 ?? ?? ?? ?? A3 ?? ?? ?? ?? C3 }
	condition:
		$pattern
}
...
rule rindex_fb9f22f37d91a10b97ddedcc2ae1d5b0 {
	meta:
		aliases = "strrchr, __GI_strrchr, rindex"
		size = "26"
		objfiles = "strrchr@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 31 C0 8B 4C 24 08 88 CD 8A 0A 38 CD 75 02 89 D0 42 84 C9 75 F3 C3 }
	condition:
		$pattern
}
...
rule wcsrchr_f01d892ada810a0b8bf54963412dc897 {
	meta:
		aliases = "wcsrchr"
		size = "27"
		objfiles = "wcsrchr@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 31 C9 8B 02 3B 44 24 08 0F 44 CA 85 C0 74 05 83 C2 04 EB EE 89 C8 C3 }
	condition:
		$pattern
}

rule __GI_btowc_8c3fda039e322768be4ebeeb0538551d {
	meta:
		aliases = "wctob, btowc, __GI_btowc"
		size = "17"
...
rule towupper_48138e3d9f8c60c2c473cafe14662f16 {
	meta:
		aliases = "__GI_towupper, __GI_towlower, towlower, towupper"
		size = "21"
...
rule __GI_wcscmp_e91a61111c295dab6c061b7848cdcf0d {
	meta:
		aliases = "wcscoll, __GI_wcscoll, wcscmp, __GI_wcscmp"
		size = "36"
...
rule __GI_toupper_d7d4521aee6b4c2c35428947fe099a90 {
	meta:
		aliases = "tolower, __GI_tolower, toupper, __GI_toupper"
		size = "29"
...
rule __GI_iscntrl_2dc04f106681d2b774e1ee052ef468e0 {
	meta:
		aliases = "iscntrl, __GI_iscntrl"
		size = "19"
...
rule __GI_ispunct_c3c3c53a2845a213d1fc619013cac873 {
	meta:
		aliases = "ispunct, __GI_ispunct"
		size = "19"
...
rule __GI_isalnum_175659f72d6ba97b50950d48352e9f19 {
	meta:
		aliases = "isalnum, __GI_isalnum"
		size = "19"
...
rule __GI_isgraph_49a9f6fcd3b0abca144dbbfe94b15c05 {
	meta:
...
rule __GI_isupper_77cef65e7bce598ddaaadae7de98a90e {
	meta:
...
rule __GI_islower_2d1974ca068d02645740cc133ae551f7 {
	meta:
		aliases = "islower, __GI_islower"
		size = "17"
...
rule __GI_isxdigit_e58c5ce5bf1ea730964dd0478cb4d0f7 {
	meta:
		aliases = "isxdigit, __GI_isxdigit"
		size = "17"
...
rule __GI_isspace_3135b1d20b0674a3cfa314f46d0b2e18 {
	meta:
...
rule l64a_5dce091da08de5a0051fb297d20c426c {
	meta:
		aliases = "l64a"
		size = "41"
		objfiles = "l64a@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 B9 ?? ?? ?? ?? EB 11 89 D0 83 E0 3F 8A 80 ?? ?? ?? ?? C1 EA 06 88 01 41 85 D2 75 EB B8 ?? ?? ?? ?? C6 01 00 C3 }
	condition:
		$pattern
}
...
rule __GI_strnlen_18f972568fb26357696ef3d20069b8cd {
	meta:
		aliases = "strnlen, __GI_strnlen"
		size = "24"
		objfiles = "strnlen@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 08 8B 4C 24 04 42 8D 41 FF 40 4A 74 05 80 38 00 75 F7 29 C8 C3 }
	condition:
		$pattern
}
...
rule set_fast_math_d44843d3772113a255eba48ba87f0162 {
	meta:
		aliases = "set_fast_math"
		size = "235"
		objfiles = "crtfastmath"
	strings:
		$pattern = { ( CC | 8D ) 4C 24 04 83 E4 F0 FF 71 FC 55 89 E5 81 EC 38 02 00 00 89 5D F4 89 4D F0 89 75 F8 89 7D FC E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 9C 9C 5A 89 D0 81 F2 00 00 20 00 52 9D 9C 5A 9D 31 D0 A9 00 00 20 00 74 54 31 C0 87 DE 0F A2 87 DE 85 C0 74 48 B8 01 00 00 00 87 DF 0F A2 87 DF F7 C2 00 00 00 02 89 D6 74 33 0F AE 9D E4 FD FF FF 8B BD E4 FD FF FF 89 F8 80 CC 80 81 E6 00 00 00 01 89 85 E0 FD FF FF 75 26 8B 95 E0 FD FF FF 89 95 E4 FD FF FF 0F AE 95 E4 FD FF FF 8B 4D F0 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D 8D 61 FC C3 8D 85 E8 FD FF FF C7 44 24 08 00 02 00 00 C7 44 24 04 00 00 00 00 89 04 24 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __libc_current_sigrtmin_9306906a3a71020f26be39b72f98096c {
	meta:
		aliases = "__libc_current_sigrtmax, __pthread_getconcurrency, pthread_getconcurrency, __libc_current_sigrtmin"
		size = "6"
		objfiles = "allocrtsig@libc.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? C3 }
...
rule _stdlib_mb_cur_max_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "old_sem_extricate_func, __GI__stdlib_mb_cur_max, authnone_validate, floatformat_always_valid, xdr_void, __GI_xdr_void, _stdlib_mb_cur_max"
		size = "6"
		objfiles = "auth_none@libc.a, oldsemaphore@libpthread.a, xdr@libc.a, floatformat@libiberty.a, _stdlib_mb_cur_max@libc.a"
	strings:
...
rule rendezvous_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		aliases = "svcraw_stat, svcudp_stat, _svcauth_short, rendezvous_stat"
		size = "6"
		objfiles = "svc_tcp@libc.a, svc_raw@libc.a, svc_udp@libc.a, svc_authux@libc.a, svc_unix@libc.a"
	strings:
...
rule __h_errno_location_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__errno_location, __GI___errno_location, __libc_pthread_init, __res_state, __GI___h_errno_location, __h_errno_location"
		size = "6"
		objfiles = "__errno_location@libc.a, libc_pthread_init@libc.a, __h_errno_location@libc.a, _res_state@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C3 }
	condition:
		$pattern
...
rule __GI_localeconv_910d4405aa4463b5e5308bfee7d955ef {
	meta:
		aliases = "localeconv, __GI_localeconv"
		size = "53"
		objfiles = "localeconv@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? 83 C0 04 3D ?? ?? ?? ?? C7 00 ?? ?? ?? ?? 72 F0 B8 ?? ?? ?? ?? C6 00 FF 40 3D ?? ?? ?? ?? 76 F5 B8 ?? ?? ?? ?? C3 }
	condition:
		$pattern
}

rule __GI_getuid_7c2320996163a5a91a92182337ed4a1a {
	meta:
...
rule __GI_geteuid_a2ef930678bc3005b23805f6b8f57651 {
	meta:
...
rule clntunix_abort_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "__linuxthreads_death_event, clntraw_geterr, authnone_verf, noop_handler, __cyg_profile_func_enter, __linuxthreads_reap_event, pthread_null_sighandler, xdrmem_destroy, __linuxthreads_create_event, authnone_destroy, clntraw_destroy, __stub1, __stub2, svcraw_destroy, clnttcp_abort, pthread_handle_sigdebug, clntudp_abort, __cyg_profile_func_exit, authunix_nextverf, clntraw_abort, clntunix_abort"
		size = "1"
		objfiles = "clnt_unix@libc.a, pthread@libpthread.a, auth_unix@libc.a, xdr_mem@libc.a, signals@libpthread.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule __fixunssfdi_0cb07d1b0a2bc4dc6ebc5a65b562afaf {
	meta:
		aliases = "__fixunssfdi"
		size = "102"
		objfiles = "_fixunssfdi@libgcc.a"
	strings:
		$pattern = { ( CC | E8 ) ?? ?? ?? ?? 81 C1 ?? ?? ?? ?? 55 89 E5 57 31 FF 56 83 EC 10 D9 7D F6 D9 45 08 D9 81 ?? ?? ?? ?? D8 C9 0F B7 45 F6 57 B4 0C 66 89 45 F4 D9 6D F4 DF 7D E8 D9 6D F6 8B 45 E8 50 89 C6 DF 2C 24 89 F7 BE 00 00 00 00 D8 89 ?? ?? ?? ?? 89 FA DE C1 D9 6D F4 DF 7D E8 D9 6D F6 8B 45 E8 83 C4 18 09 F0 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __fixunsdfdi_bfa3695242e20aa600a492f429f2b675 {
	meta:
		aliases = "__fixunsdfdi"
		size = "102"
		objfiles = "_fixunsdfdi@libgcc.a"
	strings:
		$pattern = { ( CC | E8 ) ?? ?? ?? ?? 81 C1 ?? ?? ?? ?? 55 89 E5 57 31 FF 56 83 EC 10 D9 7D F6 DD 45 08 D9 81 ?? ?? ?? ?? D8 C9 0F B7 45 F6 57 B4 0C 66 89 45 F4 D9 6D F4 DF 7D E8 D9 6D F6 8B 45 E8 50 89 C6 DF 2C 24 89 F7 BE 00 00 00 00 D8 89 ?? ?? ?? ?? 89 FA DE C1 D9 6D F4 DF 7D E8 D9 6D F6 8B 45 E8 83 C4 18 09 F0 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __fixunssfsi_7ac9d0e1ed2cb3d232fa6ea988caac55 {
	meta:
		aliases = "__fixunssfsi"
		size = "98"
		objfiles = "_fixunssfsi@libgcc.a"
	strings:
		$pattern = { ( CC | E8 ) ?? ?? ?? ?? 81 C1 ?? ?? ?? ?? 55 89 E5 83 EC 08 D9 45 08 D9 81 ?? ?? ?? ?? D9 C9 DD E1 DF E0 9E 72 22 D9 7D FE DE E1 0F B7 45 FE B4 0C 66 89 45 FC D9 6D FC DB 5D F8 D9 6D FE 8B 45 F8 C9 2D 00 00 00 80 C3 DD D9 D9 7D FE 0F B7 45 FE B4 0C 66 89 45 FC D9 6D FC DB 5D F8 D9 6D FE 8B 45 F8 C9 C3 }
	condition:
		$pattern
}

rule __fixunsxfsi_7a6b983f0d6dc1748cc101c65c9ca2c9 {
	meta:
		aliases = "__fixunsxfsi"
		size = "98"
		objfiles = "_fixunsxfsi@libgcc.a"
	strings:
		$pattern = { ( CC | E8 ) ?? ?? ?? ?? 81 C1 ?? ?? ?? ?? 55 89 E5 83 EC 08 DB 6D 08 D9 81 ?? ?? ?? ?? D9 C9 DD E1 DF E0 9E 72 22 D9 7D FE DE E1 0F B7 45 FE B4 0C 66 89 45 FC D9 6D FC DB 5D F8 D9 6D FE 8B 45 F8 C9 2D 00 00 00 80 C3 DD D9 D9 7D FE 0F B7 45 FE B4 0C 66 89 45 FC D9 6D FC DB 5D F8 D9 6D FE 8B 45 F8 C9 C3 }
	condition:
		$pattern
}

rule __fixunsdfsi_13f62b0598dc955f0f0f15a50ea94aff {
	meta:
		aliases = "__fixunsdfsi"
		size = "98"
		objfiles = "_fixunsdfsi@libgcc.a"
	strings:
		$pattern = { ( CC | E8 ) ?? ?? ?? ?? 81 C1 ?? ?? ?? ?? 55 89 E5 83 EC 08 DD 45 08 D9 81 ?? ?? ?? ?? D9 C9 DD E1 DF E0 9E 72 22 D9 7D FE DE E1 0F B7 45 FE B4 0C 66 89 45 FC D9 6D FC DB 5D F8 D9 6D FE 8B 45 F8 C9 2D 00 00 00 80 C3 DD D9 D9 7D FE 0F B7 45 FE B4 0C 66 89 45 FC D9 6D FC DB 5D F8 D9 6D FE 8B 45 F8 C9 C3 }
	condition:
		$pattern
}
...
rule xdr_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "xdr_int, xdr_u_int, __GI_xdr_int, rand, vfork, partition_delete, xdr_enum, mq_close, __GI_xdr_enum, __pthread_initialize, splay_tree_xmalloc_deallocate, __GI_cabs, setmntent, cabs, xdr_u_longlong_t, __GI_setmntent, __GI_xdr_u_int, xdr_longlong_t"
		size = "5"
		objfiles = "rand@libc.a, w_cabs@libm.a, pthread@libpthread.a, mntent@libc.a, ptfork@libpthread.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
