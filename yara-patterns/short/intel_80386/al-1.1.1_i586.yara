...
rule __pthread_return_0_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "pthread_rwlockattr_destroy, pthread_condattr_init, _svcauth_null, __GI_pthread_condattr_init, __GI_pthread_condattr_destroy, __pthread_mutex_trylock, pthread_condattr_destroy, __pthread_mutex_lock, __pthread_mutex_init, xdrstdio_inline, grantpt, wcsftime, __pthread_mutex_unlock, __GI_pthread_attr_destroy, __pthread_mutexattr_destroy, authnone_refresh, pthread_attr_destroy, clntraw_control, pthread_mutexattr_destroy, __pthread_return_0"
		size = "3"
		objfiles = "__uClibc_main@libc.a, condvar@libpthread.a, mutex@libpthread.a, wcsftime@libc.a, grantpt@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule restart_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		aliases = "suspend, restart"
		size = "8"
		objfiles = "condvar@libpthread.a, pthread@libpthread.a, join@libpthread.a, semaphore@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule restart_83f4df226a0b24d9da08621b3266c0dc {
	meta:
		aliases = "restart"
		size = "8"
		objfiles = "condvar@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule __cxa_atexit_d2b7173466c152d1b289f8749d834fc0 {
	meta:
		aliases = "__GI___cxa_atexit, __cxa_atexit"
		size = "52"
		objfiles = "__cxa_atexit@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 C0 8B 5C 24 08 85 DB 74 27 E8 ?? ?? ?? ?? 89 C2 83 C8 FF 85 D2 74 19 89 5A 04 C7 02 03 00 00 00 8B 44 24 0C 89 42 08 8B 44 24 10 89 42 0C 31 C0 5B C3 }
	condition:
		$pattern
}
...
rule __libc_open_3a295d5b56746ffad3926519986f3f53 {
	meta:
		aliases = "open, __GI_open, __libc_open"
		size = "66"
		objfiles = "open@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 D2 83 EC 04 8B 4C 24 10 F6 C1 40 74 0B 8D 44 24 18 8B 54 24 14 89 04 24 8B 44 24 0C 53 89 C3 B8 05 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 5B C3 }
	condition:
		$pattern
}
...
rule sleep_51583616e572f335911e89264fa8b484 {
	meta:
		aliases = "__GI_sleep, sleep"
		size = "146"
		objfiles = "sleep@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 DB 83 EC 24 8B 44 24 2C 85 C0 74 7D 89 44 24 1C 89 E0 C7 44 24 18 00 00 00 00 C7 44 24 14 00 00 01 00 C7 44 24 20 00 00 00 00 50 6A 00 6A 11 E8 ?? ?? ?? ?? 83 C4 0C 83 3C 24 01 75 10 8D 44 24 14 50 50 6A 00 E8 ?? ?? ?? ?? 83 C4 0C 8D 44 24 1C 31 DB 50 50 E8 ?? ?? ?? ?? 5A 85 C0 59 74 11 31 DB 81 7C 24 20 FF 64 CD 1D 0F 9F C3 03 5C 24 1C F6 44 24 16 01 75 11 6A 00 8D 44 24 18 50 6A 02 E8 ?? ?? ?? ?? 83 C4 0C 89 D8 83 C4 24 5B C3 }
	condition:
		$pattern
}

rule __ieee754_log10_0d34295cd09e25270017499239b9d477 {
	meta:
		aliases = "log10, __GI_log10, __ieee754_log10"
		size = "229"
...
rule setup_salt_067c8c42f74c07ffb80356ff456edff6 {
	meta:
		aliases = "setup_salt"
		size = "60"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 53 ) 3B 05 ?? ?? ?? ?? 74 31 31 DB B9 00 00 80 00 BA 01 00 00 00 A3 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 EB 0F 85 D0 74 06 09 0D ?? ?? ?? ?? 01 D2 43 D1 E9 83 FB 17 7E EC 5B C3 }
	condition:
		$pattern
}
...
rule __GI_config_open_0da0e748217f60cc1de108c35a5857e0 {
	meta:
		aliases = "__GI_config_open"
		size = "44"
		objfiles = "parse_config@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 68 ?? ?? ?? ?? FF 74 24 0C E8 ?? ?? ?? ?? 89 C3 58 31 C0 5A 85 DB 74 11 6A 18 6A 01 E8 ?? ?? ?? ?? 5A 85 C0 59 74 02 89 18 5B C3 }
	condition:
		$pattern
}
...
rule __GI_getdomainname_0d7cfce6d7a40946608ffa0ee19cd889 {
	meta:
...
rule close_0f16be773a16c7f1ada0f23bb98e42f6 {
	meta:
		aliases = "tcdrain, system, wait, fsync, close"
		size = "43"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_nanosleep_82bd8315edcf02aca8cdee56441e9b73 {
	meta:
...
rule recvmsg_7e8310e1353bbbc8133a54fecec14b99 {
	meta:
		aliases = "sendmsg, write, read, lseek, connect, __GI_waitpid, waitpid, msync, accept, recvmsg"
		size = "51"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule send_9682517cc44b317b96a763e93de956b5 {
	meta:
		aliases = "pwrite, recv, epoll_wait, pread, send"
		size = "55"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_xdr_short_2c72c66cb729e2ff3ac9f8dc815382f6 {
	meta:
...
rule __libc_fcntl_76652a2735a2b958640d7575b4657042 {
	meta:
		aliases = "fcntl, __GI_fcntl, __GI___libc_fcntl, __libc_fcntl"
		size = "84"
		objfiles = "__syscall_fcntl@libc.a"
	strings:
...
rule __fgetc_unlocked_51c788b0fa8040705eca5d5cfb82a5b7 {
	meta:
		aliases = "__GI___fgetc_unlocked, getc_unlocked, fgetc_unlocked, __GI_fgetc_unlocked, __GI_getc_unlocked, __fgetc_unlocked"
		size = "204"
...
rule ioctl_32751aa4525ef3b67048bcc18bbaf6fb {
	meta:
		aliases = "__GI_ioctl, ioctl"
		size = "59"
		objfiles = "ioctl@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8D 44 24 18 8B 4C 24 10 89 04 24 8B 54 24 14 8B 44 24 0C 53 89 C3 B8 36 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 5B C3 }
	condition:
		$pattern
}

rule __GI_fcntl64_dd171915b59dc95dbd1aa31a573fa92c {
	meta:
		aliases = "fcntl64, __GI_fcntl64"
		size = "59"
		objfiles = "__syscall_fcntl64@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8D 44 24 18 8B 4C 24 10 89 04 24 8B 54 24 14 8B 44 24 0C 53 89 C3 B8 DD 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 5B C3 }
	condition:
		$pattern
}
...
rule __GI_endutent_792dfceb56a73f60ac1880e2673496e7 {
	meta:
		aliases = "endutent, __GI_endutent"
		size = "81"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 0D ?? ?? ?? ?? 83 C4 10 85 C9 78 0B 87 CB B8 06 00 00 00 CD 80 87 CB 6A 01 C7 05 ?? ?? ?? ?? FF FF FF FF 53 E8 ?? ?? ?? ?? 83 C4 18 5B C3 }
	condition:
		$pattern
}
...
rule __GI_setservent_d716461598951d0849294acc7e5437cd {
	meta:
		aliases = "setservent, __GI_setservent"
		size = "96"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 74 07 50 E8 ?? ?? ?? ?? 58 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 A3 ?? ?? ?? ?? 83 7C 24 18 00 74 07 C6 05 ?? ?? ?? ?? 01 6A 01 53 E8 ?? ?? ?? ?? 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule setnetent_d93becebaefdfd2ceefb5b3142a474bd {
	meta:
		aliases = "__GI_setprotoent, __GI_setnetent, setprotoent, setnetent"
		size = "96"
...
rule setpwent_ce98578a56224f5e1c929d87665c5432 {
	meta:
...
rule __GI_endnetent_f833c6119cd87105f18bd9908407408c {
	meta:
		aliases = "endprotoent, endnetent, __GI_endprotoent, __GI_endnetent"
		size = "83"
		objfiles = "getproto@libc.a, getnet@libc.a"
	strings:
...
rule endservent_c1a0cdc6a82cf8dc60e6205610286527 {
	meta:
		aliases = "__GI_endservent, endservent"
		size = "83"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 74 11 50 E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 5A 6A 01 C6 05 ?? ?? ?? ?? 00 53 E8 ?? ?? ?? ?? 83 C4 18 5B C3 }
	condition:
		$pattern
}
...
rule setutent_11fafa420a8fa2ce780158be4170bf2c {
	meta:
		aliases = "endhostent, __GI_setutent, setutent"
		size = "52"
...
rule __GI_pututline_087c0cb1f13c060c8f648c469c50ab78 {
	meta:
...
rule __GI_utmpname_24136f32a6624796140e56b5be0bf4f8 {
	meta:
		aliases = "utmpname, __GI_utmpname"
		size = "140"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 8B 5C 24 18 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 DB 74 2D A1 ?? ?? ?? ?? 3D ?? ?? ?? ?? 74 07 50 E8 ?? ?? ?? ?? 59 53 E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 85 C0 75 0A C7 05 ?? ?? ?? ?? ?? ?? ?? ?? 8B 0D ?? ?? ?? ?? 85 C9 78 15 87 CB B8 06 00 00 00 CD 80 87 CB C7 05 ?? ?? ?? ?? FF FF FF FF 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 31 C0 83 C4 18 5B C3 }
	condition:
		$pattern
}
...
rule __GI_gethostent_r_55d6e5e11fe8bc7d6c5971c40b4b4bb8 {
	meta:
		aliases = "gethostent_r, __GI_gethostent_r"
		size = "149"
		objfiles = "gethostent_r@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 8B 5C 24 24 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 1B E8 ?? ?? ?? ?? A3 ?? ?? ?? ?? 85 C0 75 0D C7 03 00 00 00 00 BB 02 00 00 00 EB 35 FF 74 24 28 53 FF 74 24 28 FF 74 24 28 FF 74 24 28 6A 01 6A 02 6A 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 24 89 C3 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 89 D8 83 C4 18 5B C3 }
	condition:
		$pattern
}

rule __GI_atanh_b6a47c81d144659df098fb5361719940 {
	meta:
...
rule __GI_cosh_faf40f4d4b67bd5da2fe190946095f70 {
	meta:
...
rule __GI_getttyent_27b220ec6b459be287df56bb9f906f47 {
	meta:
...
rule frexp_7143e11d73d4084cd27c3234d23490eb {
	meta:
		aliases = "__GI_frexp, frexp"
		size = "151"
		objfiles = "s_frexp@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 DD 44 24 20 8B 5C 24 28 DD 54 24 10 8B 4C 24 14 8B 44 24 10 89 CA C7 03 00 00 00 00 81 E2 FF FF FF 7F 81 FA FF FF EF 7F 7F 5E 09 D0 74 5A 81 FA FF FF 0F 00 7F 22 D8 0D ?? ?? ?? ?? C7 03 CA FF FF FF DD 54 24 20 DD 5C 24 08 8B 4C 24 0C 89 CA 81 E2 FF FF FF 7F EB 02 DD D8 DD 44 24 20 81 E1 FF FF 0F 80 8B 03 DD 1C 24 81 C9 00 00 E0 3F 2D FE 03 00 00 C1 FA 14 89 4C 24 04 DD 04 24 01 D0 DD 5C 24 20 89 03 EB 02 DD D8 DD 44 24 20 83 C4 18 5B C3 }
	condition:
		$pattern
}
...
rule __GI_scalbln_eec6789731b74d15a05297db358b79c2 {
	meta:
		aliases = "scalbn, __GI_scalbn, scalbln, __GI_scalbln"
		size = "297"
...
rule __pthread_initialize_manager_c070319c86fba606d24035bb6f83c26e {
	meta:
		aliases = "__pthread_initialize_manager"
		size = "456"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 24 A1 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 C7 00 01 00 00 00 75 05 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 8D 44 00 E0 50 E8 ?? ?? ?? ?? 89 C2 A3 ?? ?? ?? ?? 59 83 C8 FF 85 D2 0F 84 84 01 00 00 A1 ?? ?? ?? ?? 8D 44 42 E0 A3 ?? ?? ?? ?? 8D 44 24 1C 50 E8 ?? ?? ?? ?? 5A 40 75 14 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C8 FF 5B E9 54 01 00 00 A1 ?? ?? ?? ?? 85 C0 74 05 A3 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 0F 84 80 00 00 00 A1 ?? ?? ?? ?? 8A 15 ?? ?? ?? ?? 08 C2 79 71 31 D2 A1 ?? ?? ?? ?? E8 ?? ?? ?? ?? FF 74 24 1C 68 00 0F 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 89 C3 83 F8 FF 74 32 }
	condition:
		$pattern
}

rule sysctl_19db722a5fd01f94e27d6ed0b885721b {
	meta:
		aliases = "sysctl"
		size = "91"
		objfiles = "sysctl@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 28 89 E1 8B 44 24 30 89 04 24 8B 44 24 34 89 44 24 04 8B 44 24 38 89 44 24 08 8B 44 24 3C 89 44 24 0C 8B 44 24 40 89 44 24 10 8B 44 24 44 89 44 24 14 87 CB B8 95 00 00 00 CD 80 87 CB 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule bsd_signal_815067e5ff5b7ee1f348a708733982bf {
	meta:
...
rule __GI_svc_sendreply_8877d180c27ed4c561631bdcc1340ed1 {
	meta:
...
rule __GI_fstat_94ce7dfbf4f948402901013b0c09eeaa {
	meta:
...
rule __GI_vswscanf_0cf791d4c0fa2696e7a5e3f77a3c363c {
	meta:
...
rule __GI_stat64_c5c5c27b3603575bac9a8e09cb1ebb8e {
	meta:
...
rule pthread_insert_list_97880be06676271cece864ec2afd37bd {
	meta:
		aliases = "pthread_insert_list"
		size = "36"
		objfiles = "ptfork@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 85 D2 89 C3 74 1B 83 7C 24 08 00 75 05 EB 09 8D 58 04 8B 03 85 C0 75 F7 8B 03 89 11 89 41 04 89 0B 5B C3 }
	condition:
		$pattern
}
...
rule mq_send_ab437036bdc503b3efe105177bd491a7 {
	meta:
		aliases = "mq_receive, pread, __libc_pread, mq_send"
		size = "35"
...
rule clnttcp_control_2c1819d0c70a52399d8e706ca8191ee2 {
	meta:
...
rule clntunix_control_feccd1755be1720c629b8ec2e3ac1aad {
	meta:
...
rule clntudp_control_3ac7096663c25ba3e2df0a67db5ee4e1 {
	meta:
		aliases = "clntudp_control"
		size = "205"
		objfiles = "clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 44 24 08 8B 5C 24 10 8B 48 08 8B 44 24 0C 48 83 F8 0E 77 07 FF 24 85 ?? ?? ?? ?? 31 C0 E9 A7 00 00 00 C7 41 04 01 00 00 00 E9 96 00 00 00 C7 41 04 00 00 00 00 E9 8A 00 00 00 8B 13 8B 43 04 89 41 28 89 51 24 EB 7D 8B 51 24 8B 41 28 EB 13 8B 13 8B 43 04 89 41 20 89 51 1C EB 68 8B 51 1C 8B 41 20 89 43 04 89 13 EB 5B 8D 41 08 6A 10 50 53 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 0C EB 4A 8B 01 EB 33 8B 41 58 8B 00 0F C8 EB 2A 8B 03 8B 51 58 48 0F C8 89 02 EB 2C 8B 41 58 8B 40 10 0F C8 EB 14 8B 51 58 8B 03 0F C8 89 42 10 EB 16 8B 41 58 8B 40 0C 0F C8 89 03 EB 0A 8B 51 58 8B 03 0F C8 89 42 0C B8 01 }
	condition:
		$pattern
}
...
rule __GI__exit_c0f8682d3d28e5ac9ce888c2da764d27 {
	meta:
...
rule __GI_alarm_872ea2bb33f6ee3cd118bb3701afd8ba {
	meta:
...
rule __GI_adjtimex_ad7dc23951e0d2e00f1a0f8c91dc5fa1 {
	meta:
...
rule __getpgid_969633136aa8a2de2d7b873ad0668010 {
	meta:
...
rule __GI_fchdir_3d947ea7fab523456771697a05530848 {
	meta:
...
rule __GI_getsid_0c374ffef357f16546f6988d3aab3a00 {
	meta:
...
rule ffsll_8cbb0cda282920e2bd910c3cdd1727b0 {
	meta:
		aliases = "ffsll"
		size = "56"
		objfiles = "ffsll@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 4C 24 08 8B 5C 24 0C 89 C8 89 DA F7 D8 83 D2 00 F7 DA 21 DA 83 FA 00 77 0A 89 4C 24 08 5B E9 ?? ?? ?? ?? 89 D9 89 CB 51 C1 FB 1F E8 ?? ?? ?? ?? 83 C0 20 5A 5B C3 }
	condition:
		$pattern
}
...
rule __libc_read_3a6e3b0576a05d8cd2cd08b7f0009672 {
	meta:
...
rule __libc_write_62fae76f46b8a81897ae25f0d018706b {
	meta:
...
rule __libc_lseek_9cabd2f8d7813d6f72821f63ea31623c {
	meta:
		aliases = "lseek, __GI_lseek, __libc_lseek"
		size = "48"
...
rule __GI_mq_setattr_0675b5b135a3c432e4845e2a8faa6f8e {
	meta:
...
rule __libc_msync_7c62e36927158ac04cddc07276279395 {
	meta:
...
rule __GI_setresuid_c1ee0a4d257cf8b6c18f1a8a0955dd16 {
	meta:
...
rule __GI_setresgid_003f20d62898003cff16ee8133714524 {
	meta:
...
rule __GI_chmod_b45ba1a85653330e392d03d9e1bf9408 {
	meta:
...
rule __GI_utimes_ff62db6f27f928050f8c67831bb02378 {
	meta:
...
rule __GI_setpgid_30470614b4fae28c0af69a83a77a8000 {
	meta:
...
rule __GI_setrlimit_c7336c3ca0886ac865fbb881d895f41a {
	meta:
...
rule __GI_pipe2_0f1bce31d1b153c41726b31910ddffc2 {
	meta:
...
rule __GI_nanosleep_66d8ad1e996b2f0928eecec048fcd516 {
	meta:
...
rule __GI_hdestroy_r_11f2d75781778816b483f4ca4e88b5a8 {
	meta:
...
rule longjmp_475a409d5d6ada9387382fdda67bcfc4 {
	meta:
		aliases = "siglongjmp, longjmp"
		size = "22"
...
rule __GI___fsetlocking_5d3630f74317fe8e044322da6d3ec7ed {
	meta:
...
rule __GI_regfree_8255f013d928058506992f1d663c5417 {
	meta:
...
rule wcsncat_070b10865ef18c161fa4dc8fcc1bdc49 {
	meta:
		aliases = "wcsncat"
		size = "58"
		objfiles = "wcsncat@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 8B 5C 24 0C 8B 4C 24 10 8B 54 24 08 8B 02 83 C2 04 85 C0 75 F7 83 EA 04 EB 07 83 C3 04 49 83 C2 04 85 C9 74 08 8B 03 89 02 85 C0 75 ED 8B 44 24 08 C7 02 00 00 00 00 5B C3 }
	condition:
		$pattern
}
...
rule __GI_wmemcpy_f4f538fd44ac6ad2caa16f5b50024a3e {
	meta:
...
rule __GI_wmempcpy_18fb2dfb65a0cd8d36b6ccd728c2b931 {
	meta:
...
rule __GI_setsid_f59dc5ff5c93b33e164eeda86a8d8172 {
	meta:
...
rule __GI___fpclassify_984c8517c91a68bf85deef4bc108d2ba {
	meta:
...
rule reboot_dae8a1af3268014c2f79156715a6e1a3 {
	meta:
		aliases = "reboot"
		size = "52"
		objfiles = "reboot@libc.a"
	strings:
		$pattern = { ( CC | 53 ) BB AD DE E1 FE 8B 54 24 08 B9 69 19 12 28 89 D8 53 89 C3 B8 58 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B C3 }
	condition:
		$pattern
}
...
rule __pthread_reset_main_thread_e1ea9683e376f36106d4612b75c6282c {
	meta:
		aliases = "__pthread_reset_main_thread"
		size = "128"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) E8 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? FF 89 C3 74 4C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 FF 35 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 E8 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? FF FF FF FF C7 05 ?? ?? ?? ?? FF FF FF FF 83 C4 0C E8 ?? ?? ?? ?? 89 1D ?? ?? ?? ?? 89 43 14 89 1B 89 5B 04 C7 43 44 ?? ?? ?? ?? C7 43 4C ?? ?? ?? ?? 5B C3 }
	condition:
		$pattern
}
...
rule __GI_endrpcent_2bfc174a49d390453b694b5f1fc8a1fb {
	meta:
...
rule __pthread_cleanup_push_defer_4a2ada044da2ae38e2539d7ad0602db7 {
	meta:
...
rule fstatvfs_baaf9c470f4da22b2025dc23c9f1ab8e {
	meta:
		aliases = "__GI_fstatvfs, __GI_statvfs, statvfs, fstatvfs"
		size = "644"
...
rule vsyslog_725edccba1a895e902954a78e3b5956e {
	meta:
		aliases = "__GI_vsyslog, vsyslog"
		size = "670"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 28 04 00 00 8B B4 24 3C 04 00 00 F7 C6 00 FC FF FF 0F 85 76 02 00 00 E8 ?? ?? ?? ?? 89 44 24 08 8B 28 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 1C 04 00 00 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F B6 05 ?? ?? ?? ?? 89 F1 83 C4 10 83 E1 07 D3 F8 A8 01 0F 84 20 02 00 00 83 3D ?? ?? ?? ?? 00 78 09 80 3D ?? ?? ?? ?? 00 75 1D 0F B6 0D ?? ?? ?? ?? 8A 15 ?? ?? ?? ?? 31 C0 C1 E1 03 83 CA 08 0F B6 D2 E8 ?? ?? ?? ?? F7 C6 F8 03 00 00 75 0C 0F B6 05 ?? ?? ?? ?? C1 E0 03 09 C6 8D 9C 24 24 04 00 00 53 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C0 04 50 56 68 ?? ?? ?? ?? 8D 5C 24 28 53 E8 }
	condition:
		$pattern
}
...
rule fstatvfs64_913b49ab6ad78eddd8025f6c6f3584d2 {
	meta:
		aliases = "statvfs64, fstatvfs64"
		size = "700"
		objfiles = "statvfs64@libc.a, fstatvfs64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 38 05 00 00 8B B4 24 4C 05 00 00 8D 84 24 C8 04 00 00 8B 9C 24 50 05 00 00 50 56 E8 ?? ?? ?? ?? 5F 83 CA FF 5D 85 C0 0F 88 7C 02 00 00 8B 84 24 CC 04 00 00 8B 94 24 D4 04 00 00 89 03 89 43 04 8B 84 24 D0 04 00 00 89 53 0C 89 43 08 8D 7B 48 8B 84 24 D8 04 00 00 8B 94 24 DC 04 00 00 89 53 14 89 43 10 8B 84 24 E0 04 00 00 8B 94 24 E4 04 00 00 89 53 1C 89 43 18 8B 84 24 E8 04 00 00 8B 94 24 EC 04 00 00 89 53 24 89 43 20 8B 84 24 F0 04 00 00 8B 94 24 F4 04 00 00 89 43 28 8B 84 24 F8 04 00 00 C7 43 3C 00 00 00 00 89 43 38 8B 84 24 00 05 00 00 89 53 2C 89 43 44 31 C0 AB AB AB AB AB }
	condition:
		$pattern
}
...
rule _vfprintf_internal_a2d29dad8240a8cd3b1e49dcb8b3c6a4 {
	meta:
		aliases = "_vfprintf_internal"
		size = "1529"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 68 01 00 00 8B 9C 24 80 01 00 00 53 8D 74 24 10 56 E8 ?? ?? ?? ?? 5F 85 C0 5D 79 38 8B 5C 24 0C 53 E8 ?? ?? ?? ?? 5E 85 C0 C7 04 24 FF FF FF FF 0F 84 AF 05 00 00 FF B4 24 7C 01 00 00 50 53 E8 ?? ?? ?? ?? C7 44 24 0C FF FF FF FF 83 C4 0C E9 91 05 00 00 FF B4 24 84 01 00 00 56 E8 ?? ?? ?? ?? C7 44 24 08 00 00 00 00 89 DA 58 59 EB 01 43 8A 03 84 C0 74 04 3C 25 75 F5 39 D3 74 26 89 DE 31 C0 29 D6 85 F6 7E 11 FF B4 24 7C 01 00 00 56 52 E8 ?? ?? ?? ?? 83 C4 0C 39 F0 0F 85 3D 05 00 00 01 04 24 80 3B 00 0F 84 38 05 00 00 8D 53 01 80 7B 01 25 0F 84 1C 05 00 00 8D 44 24 0C 89 54 24 0C }
	condition:
		$pattern
}
...
rule _vfwprintf_internal_1db8c90ea2c34e8675e7255d174fad4c {
	meta:
		aliases = "_vfwprintf_internal"
		size = "1860"
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 80 02 00 00 31 C0 B9 2F 00 00 00 8B B4 24 98 02 00 00 8D BC 24 10 01 00 00 F3 AB 8D 84 24 70 02 00 00 FF 8C 24 28 01 00 00 89 B4 24 10 01 00 00 C7 84 24 20 01 00 00 80 00 00 00 C7 84 24 70 02 00 00 00 00 00 00 89 B4 24 7C 02 00 00 50 6A FF 8D 84 24 84 02 00 00 50 6A 00 E8 ?? ?? ?? ?? 83 C4 10 40 75 0D C7 84 24 10 01 00 00 ?? ?? ?? ?? EB 7B BA 09 00 00 00 8D 84 24 38 01 00 00 C7 00 08 00 00 00 83 C0 04 4A 75 F4 89 F0 8D 9C 24 10 01 00 00 EB 2B 83 FA 25 75 23 83 C0 04 83 38 25 74 1B 89 84 24 10 01 00 00 53 E8 ?? ?? ?? ?? 59 85 C0 78 39 8B 84 24 10 01 00 00 EB 03 83 C0 04 8B 10 }
	condition:
		$pattern
}
...
rule __gen_tempname_8fa6bdd46f5d7d7b02d149c4176a6010 {
	meta:
		aliases = "__gen_tempname"
		size = "630"
		objfiles = "tempname@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 84 00 00 00 E8 ?? ?? ?? ?? 89 44 24 04 8B 00 89 44 24 10 FF B4 24 98 00 00 00 E8 ?? ?? ?? ?? 5B 83 F8 05 76 2D 8B 94 24 98 00 00 00 8D 44 10 FA 89 44 24 08 68 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 5A 85 C0 59 75 0D C7 44 24 0C 00 00 00 00 E9 F8 01 00 00 8B 4C 24 04 C7 01 16 00 00 00 E9 01 02 00 00 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5E 89 C7 5D 85 C0 79 17 68 00 08 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 89 C7 5B 85 C0 78 24 6A 06 8D 9C 24 82 00 00 00 53 57 E8 ?? ?? ?? ?? 57 89 C3 E8 ?? ?? ?? ?? 83 C4 10 83 FB 06 0F 84 AE 00 00 00 6A 00 8D 44 24 78 50 E8 ?? ?? ?? ?? 8B 44 24 7C 8B 15 }
	condition:
		$pattern
}
...
rule _time_tzset_69df4ec1b8430155eae75986085f4897 {
	meta:
		aliases = "_time_tzset"
		size = "927"
		objfiles = "tzset@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 98 00 00 00 C7 84 24 94 00 00 00 00 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 8C 00 00 00 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 14 89 C6 85 C0 75 4E 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C7 58 85 FF 5A 78 32 6A 44 8D 5C 24 14 53 57 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 15 8D 04 03 39 D8 76 0E 80 78 FF 0A 75 08 89 DE C6 40 FF 00 EB 02 31 F6 57 E8 ?? ?? ?? ?? 58 85 F6 0F 84 87 02 00 00 8A 06 84 C0 0F 84 7D 02 00 00 3C 3A 68 ?? ?? ?? ?? 0F 94 C0 0F B6 C0 01 C6 56 E8 ?? ?? ?? ?? 5F 85 C0 5D 0F 84 C5 02 00 00 6A 44 56 68 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule _fpmaxtostr_169f2ac5eeb6ca7cd9f3fb2a61b7f9e4 {
	meta:
		aliases = "_fpmaxtostr"
		size = "1479"
		objfiles = "_fpmaxtostr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC C4 00 00 00 8B 94 24 E8 00 00 00 8B 84 24 E8 00 00 00 DB AC 24 DC 00 00 00 8B 40 04 8A 4A 08 89 44 24 10 88 C8 83 C8 20 8B 2A 88 4C 24 1A C6 84 24 AE 00 00 00 65 3C 61 75 07 83 C1 06 88 4C 24 1A 85 ED 79 05 BD 06 00 00 00 8B BC 24 E8 00 00 00 C6 84 24 BE 00 00 00 00 8B 47 0C A8 02 74 0A C6 84 24 BE 00 00 00 2B EB 0C A8 01 74 08 C6 84 24 BE 00 00 00 20 DD E0 DF E0 C6 84 24 BF 00 00 00 00 C7 44 24 44 00 00 00 00 9E 7A 02 74 0C DD D8 C7 44 24 44 08 00 00 00 EB 61 D9 EE D9 C9 DD E1 DF E0 9E 75 2A 7A 28 D9 E8 D8 F1 D9 CA C7 44 24 0C FF FF FF FF DD EA DF E0 DD D9 9E 0F 86 08 01 00 }
	condition:
		$pattern
}
...
rule pow_f02d8168d76a74c30bc7c277cc5de1eb {
	meta:
		aliases = "__ieee754_pow, __GI_pow, pow"
		size = "1903"
		objfiles = "e_pow@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC D4 00 00 00 DD 84 24 E8 00 00 00 DD 5C 24 18 DD 84 24 F0 00 00 00 DD 5C 24 10 DD 44 24 18 DD 9C 24 98 00 00 00 8B AC 24 9C 00 00 00 8B 8C 24 98 00 00 00 89 AC 24 B4 00 00 00 89 8C 24 B8 00 00 00 81 FD 00 00 F0 3F 75 08 85 C9 0F 84 09 07 00 00 DD 44 24 10 DD 9C 24 90 00 00 00 8B 84 24 94 00 00 00 8B 94 24 90 00 00 00 89 C3 89 84 24 A0 00 00 00 81 E3 FF FF FF 7F 89 C7 89 D9 09 D1 0F 84 CF 06 00 00 89 EE 81 E6 FF FF FF 7F 81 FE 00 00 F0 7F 7F 22 0F 94 84 24 A7 00 00 00 75 0A 83 BC 24 B8 00 00 00 00 75 0E 81 FB 00 00 F0 7F 7F 06 75 11 85 D2 74 0D DD 44 24 18 DC 44 24 10 E9 92 06 }
	condition:
		$pattern
}
...
rule __dns_lookup_cda9555afac5fd074f26351a7ba78b0d {
	meta:
		aliases = "__dns_lookup"
		size = "1815"
		objfiles = "dnslookup@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC E0 01 00 00 8B 9C 24 F4 01 00 00 68 00 02 00 00 E8 ?? ?? ?? ?? 53 89 C5 E8 ?? ?? ?? ?? 89 44 24 14 3D 7E 03 00 00 59 5E 76 15 C7 44 24 1C FF FF FF FF C7 44 24 2C 00 00 00 00 E9 8E 06 00 00 8B 44 24 0C 05 82 00 00 00 50 E8 ?? ?? ?? ?? 85 ED 89 44 24 30 5A 0F 84 6A 06 00 00 85 C0 0F 84 62 06 00 00 80 3B 00 0F 84 59 06 00 00 8B 44 24 0C 8A 44 18 FF 88 44 24 13 FF 74 24 0C 53 FF 74 24 34 E8 ?? ?? ?? ?? C7 44 24 28 FF FF FF FF C7 44 24 34 00 00 00 00 C7 44 24 3C FF FF FF FF C7 44 24 40 FF FF FF FF 83 C4 0C 8B 54 24 2C 8B 4C 24 0C 8D 54 0A 01 89 54 24 08 83 7C 24 1C FF 74 0A FF 74 }
	condition:
		$pattern
}

rule vfscanf_613e60a45940ce870ad33da1c9ae5e2a {
	meta:
		aliases = "__GI_vfscanf, vfscanf"
		size = "1585"
		objfiles = "vfscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC E8 01 00 00 31 C0 B9 09 00 00 00 C7 84 24 2C 01 00 00 FF FF FF FF 8D BC 24 08 01 00 00 F3 AB 8B 84 24 FC 01 00 00 83 78 34 00 0F 94 C0 0F B6 C0 89 44 24 04 85 C0 74 26 8B 9C 24 FC 01 00 00 83 C3 38 53 68 ?? ?? ?? ?? 8D 84 24 DC 01 00 00 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 FF B4 24 FC 01 00 00 8D 9C 24 98 01 00 00 53 E8 ?? ?? ?? ?? 8B 84 24 A4 01 00 00 C7 84 24 C8 01 00 00 ?? ?? ?? ?? 8B BC 24 08 02 00 00 8A 40 03 C7 84 24 44 01 00 00 00 00 00 00 88 84 24 B4 01 00 00 8B 84 24 CC 01 00 00 89 84 24 D8 01 00 00 C6 44 24 0B 01 5D 89 DD 58 E9 D0 04 00 00 80 A4 24 AD 01 00 }
	condition:
		$pattern
}

rule __GI_vfwscanf_c1dc7dfeba75c8dd0f8197ac99985fb2 {
	meta:
		aliases = "vfwscanf, __GI_vfwscanf"
		size = "1661"
		objfiles = "vfwscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC FC 00 00 00 31 C0 B9 09 00 00 00 C7 44 24 38 FF FF FF FF 8D 7C 24 14 F3 AB 8B 84 24 10 01 00 00 83 78 34 00 0F 94 C0 0F B6 C0 89 44 24 0C 85 C0 74 26 8B 9C 24 10 01 00 00 83 C3 38 53 68 ?? ?? ?? ?? 8D 84 24 E8 00 00 00 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 FF B4 24 10 01 00 00 8D 9C 24 A4 00 00 00 53 E8 ?? ?? ?? ?? 8B 84 24 B0 00 00 00 C7 84 24 D4 00 00 00 ?? ?? ?? ?? 8B BC 24 1C 01 00 00 8A 40 03 C7 84 24 E4 00 00 00 ?? ?? ?? ?? 88 84 24 C0 00 00 00 C7 44 24 50 00 00 00 00 C6 44 24 13 01 58 5A E9 08 05 00 00 80 A4 24 B9 00 00 00 01 C6 44 24 58 01 C6 44 24 59 00 C7 44 }
	condition:
		$pattern
}

rule byte_regex_compile_4f56a2f0b4a157c76a384f84269e8cec {
	meta:
		aliases = "byte_regex_compile"
		size = "8219"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC FC 01 00 00 01 C2 8B BC 24 10 02 00 00 89 84 24 F4 01 00 00 89 44 24 1C 89 4C 24 18 8B 47 14 89 54 24 28 89 44 24 2C 68 80 02 00 00 E8 ?? ?? ?? ?? 89 44 24 68 85 C0 5D 0F 84 B7 1F 00 00 8B 54 24 18 C7 47 08 00 00 00 00 80 67 1C 97 89 57 0C C7 47 18 00 00 00 00 80 3D ?? ?? ?? ?? 00 75 42 68 00 01 00 00 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 D2 83 C4 0C EB 14 A1 ?? ?? ?? ?? F6 44 50 01 08 74 07 C6 82 ?? ?? ?? ?? 01 42 81 FA FF 00 00 00 7E E4 C6 05 ?? ?? ?? ?? 01 C6 05 ?? ?? ?? ?? 01 83 7F 04 00 75 3D 8B 07 85 C0 74 0E 6A 20 50 E8 ?? ?? ?? ?? 89 07 5B 5E EB 0A 6A 20 E8 ?? ?? ?? }
	condition:
		$pattern
}

rule __open_nameservers_93d64c64d01357cd8b14ecce3e2ef627 {
	meta:
		aliases = "__open_nameservers"
		size = "876"
		objfiles = "opennameservers@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC FC 01 00 00 83 3D ?? ?? ?? ?? 00 75 3C 8D 84 24 88 01 00 00 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5F 85 C0 5D 74 0B C7 84 24 C8 01 00 00 00 00 00 00 8B 84 24 C8 01 00 00 39 05 ?? ?? ?? ?? 74 0A A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 0F 85 FA 02 00 00 68 ?? ?? ?? ?? C6 05 ?? ?? ?? ?? 05 68 ?? ?? ?? ?? C6 05 ?? ?? ?? ?? 03 E8 ?? ?? ?? ?? 89 44 24 0C 85 C0 5B 5E 0F 85 F7 01 00 00 E9 27 02 00 00 8D 84 24 08 01 00 00 E8 ?? ?? ?? ?? 89 C6 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 89 C5 56 E8 ?? ?? ?? ?? 5A 89 C3 59 85 C0 0F 85 B8 00 00 00 89 E8 E8 ?? ?? ?? ?? B9 07 00 00 }
	condition:
		$pattern
}
...
rule __psfs_parse_spec_9c904684c1d18d56ed1eea2bb207434e {
	meta:
		aliases = "__psfs_parse_spec"
		size = "454"
		objfiles = "__psfs_parse_spec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 31 ED BF 01 00 00 00 8B 5C 24 18 8B 43 30 89 04 24 8A 00 83 E8 30 3C 09 77 4B 81 FD CB CC CC 0C 7F 11 6B D5 0A 8B 43 30 0F B6 08 40 8D 6C 11 D0 89 43 30 8B 73 30 8A 0E 8D 41 D0 3C 09 76 DB 80 F9 24 74 19 83 7B 24 00 0F 89 5D 01 00 00 89 6B 40 C7 43 24 FE FF FF FF E9 99 00 00 00 8D 46 01 31 FF 89 43 30 BE ?? ?? ?? ?? BA 10 00 00 00 8B 4B 30 8A 06 3A 01 75 0B 08 53 45 8D 41 01 89 43 30 EB E2 46 80 3E 00 74 04 01 D2 EB E2 F6 43 45 10 74 08 C6 43 44 00 31 D2 EB 4F 89 F8 84 C0 74 13 83 7B 24 00 0F 89 00 01 00 00 C7 43 24 FE FF FF FF EB E3 83 7B 24 FE 0F 84 ED 00 00 00 8D 45 FF }
	condition:
		$pattern
}
...
rule __fork_cc5aa7c236f6e6c474a3f76fc27fe09a {
	meta:
		aliases = "fork, __fork"
		size = "218"
		objfiles = "ptfork@libpthread.a"
...
rule __getdents_3d013cb3f6d4b47ea85423b037d04d96 {
	meta:
		aliases = "__getdents"
		size = "130"
		objfiles = "getdents@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 4C 24 1C 8B 54 24 20 8B 44 24 18 53 89 C3 B8 8D 00 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? 83 CF FF F7 DB 89 18 EB 45 89 C7 83 F8 FF 74 3E 89 CE 8D 2C 01 EB 33 0F B7 46 08 8D 5E 0A 8A 44 06 FF 88 44 24 03 53 E8 ?? ?? ?? ?? 40 89 04 24 8D 46 0B 53 50 E8 ?? ?? ?? ?? 8A 44 24 0F 88 46 0A 83 C4 0C 0F B7 46 08 01 C6 39 EE 72 C9 89 F8 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _dl_fixup_d0b97b5336e96916826fafe62f11303d {
	meta:
		aliases = "_dl_fixup"
		size = "275"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 54 24 18 8B 42 10 85 C0 74 16 FF 74 24 1C 50 E8 ?? ?? ?? ?? 5F 89 C6 5D 85 C0 0F 85 E3 00 00 00 8B 44 24 18 BE 01 00 00 00 8B 18 66 8B 43 22 83 7B 5C 00 0F 85 CA 00 00 00 8B B3 84 00 00 00 8B AB 88 00 00 00 85 F6 74 4A A8 01 75 46 8B 8B C8 00 00 00 89 F0 85 C9 74 23 8D 14 CD 00 00 00 00 8B 3B 89 14 24 8D 56 F8 83 C2 08 89 F8 03 02 01 38 49 75 F4 8B 04 24 2B 2C 24 01 F0 55 50 FF 74 24 20 E8 ?? ?? ?? ?? 83 C4 0C 66 83 4B 22 01 89 C6 EB 02 31 F6 83 BB A0 00 00 00 00 74 08 C7 44 24 1C 02 00 00 00 83 BB 9C 00 00 00 00 74 54 F6 43 22 02 74 10 83 7C 24 1C 00 74 47 8B 44 24 1C }
	condition:
		$pattern
}
...
rule _dl_linux_resolver_7de9043608a1939c9569d2b923b414c7 {
	meta:
		aliases = "_dl_linux_resolver"
		size = "139"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 74 24 18 8B 44 24 1C 03 86 9C 00 00 00 8B 4E 58 8B 2E 8B 50 04 8B 00 C1 EA 08 89 04 24 C1 E2 04 8B 1C 0A 03 5E 54 6A 00 6A 01 56 FF 76 1C 53 E8 ?? ?? ?? ?? 83 C4 14 89 C7 85 C0 75 37 FF 76 04 53 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? B9 01 00 00 00 87 CB B8 01 00 00 00 CD 80 87 CB 83 C4 14 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 8B 04 24 89 7C 05 00 89 F8 5D 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __parsegrent_ddc5b2f82c551632d889ff8e8bb7aad4 {
	meta:
		aliases = "__parsegrent"
		size = "216"
		objfiles = "__parsegrent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 31 F6 8B 6C 24 1C 8B 5C 24 20 8B 45 00 89 04 24 0F B6 86 ?? ?? ?? ?? 83 FE 01 8D 7C 05 00 7F 1D 89 1F 6A 3A 53 E8 ?? ?? ?? ?? 5B 85 C0 5F 0F 84 93 00 00 00 8D 58 01 46 C6 00 00 EB D3 6A 0A 8D 44 24 08 50 53 E8 ?? ?? ?? ?? 8B 4C 24 10 89 07 83 C4 0C 39 D9 74 70 80 39 3A 75 6B BB 01 00 00 00 80 79 01 00 74 2B C6 01 2C 80 39 2C 75 1D C6 01 00 41 8A 01 84 C0 74 4E 3C 2C 74 4A 0F B6 D0 A1 ?? ?? ?? ?? F6 04 50 20 75 3C 43 41 80 39 00 75 D8 8D 51 04 83 E2 FC 8D 04 9A 3B 04 24 77 27 89 D9 89 55 0C 49 74 15 8B 44 24 04 40 89 02 83 C2 04 49 74 08 40 80 38 00 75 FA EB EF 31 C0 C7 02 }
	condition:
		$pattern
}
...
rule do_dlclose_d27f1fc732d95d1e6a856b56d98a61a3 {
	meta:
		aliases = "do_dlclose"
		size = "557"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 89 C5 3B 05 ?? ?? ?? ?? 89 14 24 0F 84 0C 02 00 00 A1 ?? ?? ?? ?? 31 D2 EB 09 39 E8 74 1A 89 C2 8B 40 04 85 C0 75 F3 B0 01 C7 05 ?? ?? ?? ?? 0A 00 00 00 E9 E7 01 00 00 85 D2 8B 45 04 74 05 89 42 04 EB 05 A3 ?? ?? ?? ?? 8B 55 00 8B 42 20 66 83 F8 01 75 12 C7 44 24 04 00 00 00 00 F6 42 25 10 0F 84 5D 01 00 00 48 66 89 42 20 55 E8 ?? ?? ?? ?? 31 C0 5F E9 A5 01 00 00 8B 45 08 8B 54 24 04 8B 3C 90 8B 47 20 48 66 85 C0 66 89 47 20 0F 85 2B 01 00 00 F6 47 25 10 0F 85 21 01 00 00 83 7F 74 00 75 09 83 BF A8 00 00 00 00 74 27 83 3C 24 00 74 21 66 8B 47 22 A8 08 75 19 83 C8 08 66 89 }
	condition:
		$pattern
}
...
rule strverscmp_4be8557f34a1970a7bf32e5d9fdd4751 {
	meta:
...
rule __GI_inet_network_f9b8396fa96c82619fe650cdd10d7e85 {
	meta:
		aliases = "inet_network, __GI_inet_network"
		size = "220"
		objfiles = "inet_net@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 4C 24 1C C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 BD 0A 00 00 00 80 39 30 75 1D 41 8A 01 3C 78 74 10 3C 58 74 0C BD 08 00 00 00 BE 01 00 00 00 EB 08 41 BD 10 00 00 00 31 F6 31 FF EB 51 0F B6 DA A1 ?? ?? ?? ?? 0F B7 04 58 A8 08 74 15 83 FD 08 75 05 80 FA 37 77 68 89 F8 0F AF C5 8D 7C 03 D0 EB 1E 83 FD 10 75 2D A8 10 74 29 83 E0 02 83 F8 01 89 F8 19 D2 C1 E0 04 83 E2 E0 29 D0 8D 78 A9 81 FF FF 00 00 00 77 37 41 BE 01 00 00 00 8A 11 84 D2 75 A9 85 F6 74 27 83 3C 24 00 74 05 C1 64 24 04 08 09 7C 24 04 80 FA 2E 75 0F FF 04 24 83 3C 24 04 74 0A 41 E9 55 FF FF FF 84 D2 74 }
	condition:
		$pattern
}
...
rule __GI_setstate_r_13f35501a778723dd018d689e1994051 {
	meta:
...
rule readahead_b8b455f4328ae9064b648c4985ee031e {
	meta:
		aliases = "readahead"
		size = "86"
		objfiles = "readahead@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 6C 24 24 8B 7C 24 20 89 EA 89 F8 89 D0 8B 74 24 28 89 C2 89 04 24 C1 FA 1F 8B 44 24 1C 89 54 24 04 8B 0C 24 89 FA 53 89 C3 B8 E1 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule _dl_find_hash_e4659aff24c4177d46783a3e000f92c0 {
	meta:
		aliases = "_dl_find_hash"
		size = "290"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 30 8B 6C 24 24 85 C0 74 06 8B 10 85 D2 75 12 8B 44 24 2C 83 CF FF 83 E0 02 89 04 24 E9 C9 00 00 00 0F B6 42 0D 83 E0 03 83 F8 03 75 E2 E9 C2 00 00 00 8B 75 00 F6 46 25 01 75 26 83 7C 24 28 00 74 1F 39 74 24 28 74 19 8B 54 24 28 8B 42 34 EB 07 39 70 04 74 0B 8B 00 85 C0 75 F5 E9 86 00 00 00 83 3C 24 00 74 06 83 7E 18 01 74 7A 8B 5E 28 85 DB 74 73 8B 46 58 83 FF FF 89 44 24 04 75 27 8B 4C 24 20 31 FF EB 19 0F B6 D0 C1 E7 04 41 01 FA 89 D0 25 00 00 00 F0 89 C7 C1 E8 18 31 D7 31 C7 8A 01 84 C0 75 E1 8B 56 54 89 F8 89 54 24 08 31 D2 F7 F3 8B 46 2C 8B 1C 90 EB 27 89 D8 }
	condition:
		$pattern
}
...
rule __decode_dotted_6e4bb9be36321e811d80072648bb9a85 {
	meta:
		aliases = "__decode_dotted"
		size = "259"
		objfiles = "decoded@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 54 24 24 83 7C 24 20 00 0F 84 E2 00 00 00 31 ED C6 44 24 07 01 C7 44 24 08 00 00 00 00 EB 04 89 7C 24 08 3B 54 24 28 0F 8D C3 00 00 00 8B 4C 24 20 8A 04 11 84 C0 0F 84 A8 00 00 00 80 7C 24 07 01 0F B6 F0 89 F0 8D 4A 01 83 DD FF 25 C0 00 00 00 3D C0 00 00 00 75 2F 3B 4C 24 28 0F 8D 8E 00 00 00 80 7C 24 07 01 8B 5C 24 20 89 F2 83 DD FF 83 E2 3F 0F B6 04 0B C1 E2 08 8B 7C 24 08 09 C2 C6 44 24 07 00 EB 98 8B 44 24 08 01 F0 89 C7 89 04 24 47 3B 7C 24 30 73 57 8D 1C 0E 3B 5C 24 28 73 4E 56 8B 44 24 24 01 C8 50 8B 44 24 34 03 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 0C 89 DA 80 7C 24 }
	condition:
		$pattern
}
...
rule __read_etc_hosts_r_506faf6aaf5cb8601e582d0b13f3f9a8 {
	meta:
		aliases = "__read_etc_hosts_r"
		size = "446"
		objfiles = "read_etc_hosts_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 74 24 40 8B 5C 24 38 8B 7C 24 20 8B 6C 24 30 C7 44 24 08 00 00 00 00 C7 06 FF FF FF FF C7 44 24 04 22 00 00 00 81 FB 80 00 00 00 0F 86 79 01 00 00 85 FF 75 25 E8 ?? ?? ?? ?? 89 C7 85 C0 75 1A 8B 44 24 3C C7 00 00 00 00 00 E8 ?? ?? ?? ?? 8B 00 89 44 24 04 E9 50 01 00 00 8B 54 24 34 8D 43 D0 89 57 04 83 C2 18 C7 47 08 30 00 00 00 89 47 10 C7 44 24 04 01 00 00 00 C7 06 01 00 00 00 89 14 24 E9 E9 00 00 00 8B 74 24 08 83 C6 04 89 75 04 83 7C 24 2C 01 0F 84 0E 01 00 00 89 F3 83 7C 24 2C 02 75 2E 8B 44 24 08 FF 30 FF 74 24 28 E8 ?? ?? ?? ?? 5B 85 C0 5A 0F 85 B2 00 00 00 EB 1E }
	condition:
		$pattern
}
...
rule __GI_wcsnrtombs_ab24d5138ac2265c9b85981036f7d41b {
	meta:
...
rule _dl_do_reloc_ba1bf78cf10a61bec259ee50d215a16b {
	meta:
		aliases = "_dl_do_reloc"
		size = "250"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 6C 24 24 8B 44 24 2C C7 44 24 0C 00 00 00 00 8B 55 00 89 14 24 8B 10 8B 40 04 89 54 24 04 0F B6 D8 C1 E8 08 89 C6 C1 E6 04 03 74 24 30 85 C0 89 74 24 08 8B 3E 74 6D 83 FB 07 74 19 83 FB 23 74 14 83 FB 24 74 0F 83 FB 25 74 0A 31 C9 83 FB 0E 0F 94 C1 EB 05 B9 01 00 00 00 31 C0 83 FB 05 0F 94 C0 01 C0 8D 54 24 08 09 C8 52 50 55 FF 74 24 34 8B 44 24 44 01 F8 50 E8 ?? ?? ?? ?? 83 C4 14 89 C1 85 C0 75 1A 8A 56 0C 89 D0 83 E0 0F 83 F8 06 74 0D C0 EA 04 B8 01 00 00 00 80 FA 02 75 4A 89 C8 EB 03 8B 46 04 8B 54 24 04 03 14 24 83 FB 08 77 07 FF 24 9D ?? ?? ?? ?? 83 C8 FF EB 2B 29 }
	condition:
		$pattern
}

rule getprotobyname_r_31d029d86226851bd664faf974625de9 {
	meta:
		aliases = "__GI_getprotobyname_r, getprotobyname_r"
		size = "182"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 6C 24 24 8B 74 24 28 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 14 EB 29 FF 36 55 E8 ?? ?? ?? ?? 5B 85 C0 5A 74 36 8B 5E 04 EB 10 50 55 E8 ?? ?? ?? ?? 5A 85 C0 59 74 24 83 C3 04 8B 03 85 C0 75 EA FF 74 24 34 FF 74 24 34 FF 74 24 34 56 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 74 BC 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 8B 44 24 3C 83 38 00 0F 94 C0 0F B6 C0 F7 D8 83 C4 18 21 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule getservbyname_r_02d76275c071dff4c4f2b9b4289b1753 {
	meta:
		aliases = "__GI_getservbyname_r, getservbyname_r"
		size = "209"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 6C 24 28 8B 74 24 2C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 14 EB 44 FF 36 FF 74 24 28 E8 ?? ?? ?? ?? 59 85 C0 5B 74 20 8B 5E 04 EB 13 50 FF 74 24 28 E8 ?? ?? ?? ?? 59 85 C0 5A 74 0B 83 C3 04 8B 03 85 C0 75 E7 EB 13 85 ED 74 2A 55 FF 76 0C E8 ?? ?? ?? ?? 5B 85 C0 5A 74 1B FF 74 24 38 FF 74 24 38 FF 74 24 38 56 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 74 A1 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 8B 44 24 40 83 38 00 0F 94 C0 0F B6 C0 F7 D8 83 }
	condition:
		$pattern
}

rule fwide_59b0d9c50340004c3b86c3604f4bb33b {
	meta:
		aliases = "fwide"
		size = "134"
		objfiles = "fwide@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 6C 24 28 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 85 ED 74 1D 8B 16 F7 C2 80 08 00 00 75 13 B8 00 08 00 00 85 ED 7F 05 B8 80 00 00 00 09 D0 66 89 06 0F B7 1E 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 89 D8 81 E3 80 00 00 00 25 00 08 00 00 83 C4 10 29 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fgetpos_fa44d2d14d5314055a061bb3423b3acf {
	meta:
		aliases = "fgetpos"
		size = "122"
		objfiles = "fgetpos@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 7C 24 28 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 E8 ?? ?? ?? ?? 89 07 83 CB FF 59 85 C0 78 15 8B 46 2C 31 DB 89 47 04 8B 46 30 89 47 08 0F B6 46 02 89 47 0C 85 ED 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fgetpos64_866f48b0d90c4eda8a52235c9146089c {
	meta:
		aliases = "fgetpos64"
		size = "125"
		objfiles = "fgetpos64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 7C 24 28 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 E8 ?? ?? ?? ?? 89 07 89 57 04 83 CB FF 59 85 D2 78 15 8B 46 2C 31 DB 89 47 08 8B 46 30 89 47 0C 0F B6 46 02 89 47 10 85 ED 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fsetpos_c280cc6b8a13d44e4f967265387ddd8f {
	meta:
		aliases = "fsetpos"
		size = "122"
		objfiles = "fsetpos@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 7C 24 28 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 6A 00 FF 37 56 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 C0 75 12 8B 47 04 89 46 2C 8B 47 08 89 46 30 8B 47 0C 88 46 02 85 ED 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule fsetpos64_37aed20ead32ed886534302eacc912a6 {
	meta:
		aliases = "fsetpos64"
		size = "125"
		objfiles = "fsetpos64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 7C 24 28 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 6A 00 FF 77 04 FF 37 56 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 75 12 8B 47 08 89 46 2C 8B 47 0C 89 46 30 8B 47 10 88 46 02 85 ED 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule putgrent_b6b288357e71b451e58c02a221961946 {
	meta:
		aliases = "putgrent"
		size = "198"
		objfiles = "putgrent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 7C 24 28 85 F6 74 04 85 FF 75 13 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 E9 92 00 00 00 83 7F 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5F 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 FF 76 08 FF 76 04 FF 36 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 83 C4 14 85 C0 78 39 8B 5E 0C BA ?? ?? ?? ?? 8B 03 85 C0 75 12 57 6A 0A E8 ?? ?? ?? ?? 59 5B 31 DB 85 C0 79 1E EB 19 50 52 57 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 0A 83 C3 04 BA ?? ?? ?? ?? EB CF 83 CB FF 85 ED 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_getprotobynumber_r_d9b5ae1dc53693e4f67fc2309ecb39b3 {
	meta:
		aliases = "getprotobynumber_r, __GI_getprotobynumber_r"
		size = "143"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 28 8B 6C 24 30 8B 7C 24 34 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 14 EB 09 8B 44 24 24 3B 46 08 74 15 57 55 FF 74 24 34 56 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 74 E2 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 31 C0 83 3F 00 0F 94 C0 F7 D8 83 C4 18 21 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_ungetwc_9f98839a0559aa7ca627898e4d3907dc {
	meta:
		aliases = "ungetwc, __GI_ungetwc"
		size = "168"
		objfiles = "ungetwc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 28 8B 7C 24 24 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 03 08 00 00 3D 00 08 00 00 77 11 68 00 08 00 00 56 E8 ?? ?? ?? ?? 59 85 C0 5B 75 30 0F B7 06 A8 02 74 0A A8 01 75 25 83 7E 28 00 75 1F 83 FF FF 74 1A 8B 06 C7 46 28 01 00 00 00 40 66 89 06 83 E0 01 66 83 26 FB 89 7C 86 24 EB 03 83 CF FF 85 ED 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule ungetc_05554dc7bc7fd6b52b8cd7affd65ac26 {
	meta:
		aliases = "__GI_ungetc, ungetc"
		size = "205"
		objfiles = "ungetc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 28 8B 7C 24 24 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 46 10 3B 46 18 73 17 83 FF FF 74 12 3B 46 08 76 0D 89 FA 38 50 FF 75 06 48 89 46 10 EB 50 0F B7 06 25 83 00 00 00 3D 80 00 00 00 77 11 68 80 00 00 00 56 E8 ?? ?? ?? ?? 59 85 C0 5B 75 36 0F B7 06 A8 02 74 0A A8 01 75 2B 83 7E 28 00 75 25 83 FF FF 74 20 8B 46 08 C7 46 28 01 00 00 00 89 46 18 8B 06 40 66 89 06 83 E0 01 89 7C 86 24 66 83 26 FB EB 03 83 CF FF 85 ED 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 F8 }
	condition:
		$pattern
}

rule putspent_aff102b33601e5194e6c40664e8d1b48 {
	meta:
		aliases = "putspent"
		size = "214"
		objfiles = "putspent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 28 8B 7C 24 24 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 47 04 85 C0 75 05 B8 ?? ?? ?? ?? 50 31 DB FF 37 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 2B EB 59 0F B6 83 ?? ?? ?? ?? BA ?? ?? ?? ?? 8B 04 07 83 F8 FF 74 05 BA ?? ?? ?? ?? 50 52 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 31 43 83 FB 05 76 D2 8B 47 20 83 F8 FF 74 13 50 68 ?? ?? ?? ?? 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 10 56 6A 0A E8 ?? ?? ?? ?? 59 5B 31 DB 85 C0 7F 03 83 CB FF 85 ED 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? }
	condition:
		$pattern
}

rule _time_t2tm_3f62c28c41041dcbfae2a0e10e51ae61 {
	meta:
		aliases = "_time_t2tm"
		size = "364"
		objfiles = "_time_t2tm@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 2C 8B 44 24 24 C7 44 24 0C ?? ?? ?? ?? C7 46 1C 00 00 00 00 8B 18 8B 44 24 28 05 76 0E 02 00 89 44 24 04 8B 54 24 0C 66 8B 2A 0F B7 CD 66 83 FD 07 75 27 89 D8 03 5C 24 04 99 F7 F9 B9 07 00 00 00 8D 42 0B 99 F7 F9 89 54 24 08 8B 54 24 0C 0F B7 42 02 8D 0C 85 01 00 00 00 89 D8 99 F7 F9 89 C7 0F AF C1 29 C3 79 03 01 CB 4F 66 83 FD 07 75 0D 8D 41 FF 39 C3 75 06 FF 46 10 8D 59 FE 83 F9 3C 8D 4E 04 7F 08 89 1E 89 CE 89 FB EB 04 89 3E 89 CE 83 44 24 0C 02 8B 54 24 0C 66 83 3A 00 75 82 83 79 FC 04 75 0C C7 41 FC 03 00 00 00 BB 6D 01 00 00 01 19 8D 59 F8 8B 43 F8 8B 51 FC }
	condition:
		$pattern
}

rule __GI_rresvport_24a7aa6cf50279bbcb2a4ad6e6021f6d {
	meta:
...
rule scandir_63ef8457b8ae24fb05f75c3a8cbb4764 {
	meta:
		aliases = "scandir"
		size = "322"
		objfiles = "scandir@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 FF 74 24 24 E8 ?? ?? ?? ?? 89 44 24 04 59 83 C8 FF 83 3C 24 00 0F 84 18 01 00 00 E8 ?? ?? ?? ?? 31 ED 89 C6 C7 44 24 04 00 00 00 00 8B 00 C7 44 24 08 00 00 00 00 89 44 24 0C C7 06 00 00 00 00 EB 76 83 7C 24 2C 00 74 12 57 FF 54 24 30 5A 85 C0 75 08 C7 06 00 00 00 00 EB 5D C7 06 00 00 00 00 3B 6C 24 08 75 2F C7 44 24 08 0A 00 00 00 85 ED 74 08 8D 54 2D 00 89 54 24 08 8B 44 24 08 C1 E0 02 50 FF 74 24 08 E8 ?? ?? ?? ?? 59 85 C0 5B 74 39 89 44 24 04 0F B7 5F 08 53 E8 ?? ?? ?? ?? 5A 85 C0 74 26 53 57 50 E8 ?? ?? ?? ?? 8B 54 24 10 83 C4 0C 89 04 AA 45 FF 34 24 E8 ?? ?? ?? ?? 5B }
	condition:
		$pattern
}

rule scandir64_e1ffe95776e1c6b97cd8a9f0a8161f38 {
	meta:
		aliases = "scandir64"
		size = "322"
		objfiles = "scandir64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 FF 74 24 24 E8 ?? ?? ?? ?? 89 44 24 04 59 83 C8 FF 83 3C 24 00 0F 84 18 01 00 00 E8 ?? ?? ?? ?? 31 ED 89 C6 C7 44 24 04 00 00 00 00 8B 00 C7 44 24 08 00 00 00 00 89 44 24 0C C7 06 00 00 00 00 EB 76 83 7C 24 2C 00 74 12 57 FF 54 24 30 5A 85 C0 75 08 C7 06 00 00 00 00 EB 5D C7 06 00 00 00 00 3B 6C 24 08 75 2F C7 44 24 08 0A 00 00 00 85 ED 74 08 8D 54 2D 00 89 54 24 08 8B 44 24 08 C1 E0 02 50 FF 74 24 08 E8 ?? ?? ?? ?? 59 85 C0 5B 74 39 89 44 24 04 0F B7 5F 10 53 E8 ?? ?? ?? ?? 5A 85 C0 74 26 53 57 50 E8 ?? ?? ?? ?? 8B 54 24 10 83 C4 0C 89 04 AA 45 FF 34 24 E8 ?? ?? ?? ?? 5B }
	condition:
		$pattern
}

rule __GI_setvbuf_4c34c8cff3dec2b039bf9304084490e8 {
	meta:
		aliases = "setvbuf, __GI_setvbuf"
		size = "247"
		objfiles = "setvbuf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 31 C0 8B 7C 24 28 8B 74 24 2C 8B 6C 24 34 83 7F 34 00 0F 94 C0 89 04 24 85 C0 74 1C 8D 5F 38 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 30 02 76 13 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 E9 80 00 00 00 8B 17 83 CB FF F7 C2 CF 08 00 00 75 73 8B 44 24 30 80 E6 FC C1 E0 08 09 C2 66 89 17 83 7C 24 30 02 74 04 85 ED 75 08 31 ED 31 DB 31 F6 EB 21 31 DB 85 F6 75 1B 8B 47 0C 2B 47 08 39 E8 74 3F 55 E8 ?? ?? ?? ?? 5E 85 C0 74 34 89 C6 66 BB 00 40 8B 07 F6 C4 40 74 0F 80 E4 BF 66 89 07 FF 77 08 E8 ?? ?? ?? ?? 59 66 09 1F 8D 04 2E 89 77 08 }
	condition:
		$pattern
}
...
rule fcloseall_c602754f3eb5a0f481f5dfb7fff94509 {
	meta:
		aliases = "fcloseall"
		size = "226"
		objfiles = "fcloseall@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 0C 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 6A 01 40 53 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 24 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 8B 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? C7 44 24 0C 00 00 00 00 83 C4 0C EB 5E 83 7E 34 00 0F 94 C0 0F B6 F8 8B 6E 20 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 83 E0 30 83 F8 30 74 12 56 E8 ?? ?? ?? ?? 59 85 C0 74 07 C7 04 24 FF FF FF FF 85 FF 74 0E 6A 01 8D 44 24 08 50 E8 ?? ?? }
	condition:
		$pattern
}
...
rule __GI_fflush_unlocked_f3d38bdec2d16efd801b9a2bb08f39ce {
	meta:
		aliases = "fflush_unlocked, __GI_fflush_unlocked"
		size = "282"
		objfiles = "fflush_unlocked@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 5C 24 28 66 C7 44 24 02 00 00 81 FB ?? ?? ?? ?? 74 0F 66 C7 44 24 02 00 01 85 DB 0F 85 C6 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 0C 31 FF 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 6A 01 40 53 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 24 89 DD 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 8B 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 0C EB 56 F6 06 40 74 4E 8D 5E 38 53 68 ?? ?? ?? ?? 55 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 66 8B 44 24 12 83 C4 10 0B 06 66 35 40 01 A9 40 03 00 00 75 1A 56 E8 ?? ?? ?? ?? 59 85 C0 74 05 }
	condition:
		$pattern
}

rule __GI_sigaction_f96ff54e1135d0ba7549a2fbc8a0576a {
	meta:
...
rule free_65ce6129029dad824ad6179492d7609e {
	meta:
		aliases = "free"
		size = "399"
		objfiles = "free@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 6C 24 28 85 ED 0F 84 74 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8D 4D F8 A1 ?? ?? ?? ?? 83 C4 10 89 CF 8B 51 04 89 D3 83 E3 FC 39 C3 77 23 89 DA 83 C8 03 C1 EA 03 A3 ?? ?? ?? ?? 8B 04 95 ?? ?? ?? ?? 89 41 08 89 0C 95 ?? ?? ?? ?? E9 0C 01 00 00 80 E2 02 0F 85 E6 00 00 00 83 C8 01 8D 34 19 A3 ?? ?? ?? ?? 8B 46 04 F6 41 04 01 89 04 24 75 21 89 C8 8B 6D F8 29 E8 8B 48 08 8B 50 0C 8B 79 0C 39 C7 75 39 39 7A 08 75 34 01 EB 89 51 0C 89 4A 08 8B 0C 24 83 E1 FC 3B 35 ?? ?? ?? ?? 74 50 8B 44 0E 04 89 4E 04 83 E0 01 85 C0 }
	condition:
		$pattern
}

rule __GI_getnetbyname_r_087a109734abdefe9e9650368e8b47ef {
	meta:
		aliases = "getnetbyname_r, __GI_getnetbyname_r"
		size = "187"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 6C 24 28 8B 74 24 2C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 14 EB 29 FF 36 55 E8 ?? ?? ?? ?? 5B 85 C0 5A 74 3B 8B 5E 04 EB 10 50 55 E8 ?? ?? ?? ?? 5A 85 C0 59 74 29 83 C3 04 8B 03 85 C0 75 EA 8D 44 24 10 50 FF 74 24 3C FF 74 24 3C FF 74 24 3C 56 E8 ?? ?? ?? ?? 83 C4 14 89 C7 85 C0 74 B7 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 8B 44 24 40 83 38 00 0F 94 C0 0F B6 C0 F7 D8 83 C4 1C 21 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule re_search_2_f8b70e2c22fa804891a7d83fab9640ed {
	meta:
		aliases = "__GI_re_search_2, re_search_2"
		size = "530"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 6C 24 28 8B 7C 24 38 03 7C 24 30 8B 5C 24 3C 8B 45 10 8B 55 14 8B 74 24 40 89 44 24 10 89 54 24 0C 89 7C 24 08 85 DB 0F 88 BE 01 00 00 39 FB 0F 8F B6 01 00 00 89 F0 01 D8 79 06 89 DE F7 DE EB 0C 3B 44 24 08 7E 06 8B 74 24 08 29 DE 83 7D 08 00 74 24 85 F6 7E 20 8B 45 00 8A 00 3C 0B 74 0A 3C 09 75 13 80 7D 1C 00 78 0D 85 DB 0F 8F 79 01 00 00 BE 01 00 00 00 83 7C 24 10 00 0F 84 11 01 00 00 F6 45 1C 08 75 10 55 E8 ?? ?? ?? ?? 59 83 F8 FE 0F 84 58 01 00 00 83 7C 24 10 00 0F 84 F0 00 00 00 3B 5C 24 08 0F 8D E6 00 00 00 F6 45 1C 01 0F 85 DC 00 00 00 85 F6 0F 8E 90 00 00 00 3B }
	condition:
		$pattern
}

rule __GI_getdelim_073834abe671506281c015c95df6070b {
	meta:
		aliases = "getdelim, __GI_getdelim"
		size = "241"
		objfiles = "getdelim@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 6C 24 2C 8B 7C 24 34 83 7C 24 28 00 74 08 85 ED 74 04 85 FF 75 13 E8 ?? ?? ?? ?? 83 CF FF C7 00 16 00 00 00 E9 B6 00 00 00 31 C0 83 7F 34 00 0F 94 C0 89 04 24 85 C0 74 1C 8D 5F 38 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 44 24 28 8B 18 85 DB 75 07 C7 45 00 00 00 00 00 BE 01 00 00 00 8B 45 00 39 C6 72 21 83 C0 40 50 53 E8 ?? ?? ?? ?? 5B 85 C0 5A 75 05 83 CF FF EB 44 89 C3 83 45 00 40 8B 44 24 28 89 18 8B 47 10 3B 47 18 73 09 0F B6 10 40 89 47 10 EB 0E 57 E8 ?? ?? ?? ?? 59 89 C2 83 F8 FF 74 0B 46 88 54 1E FE 3B 54 24 30 75 AE 89 F7 83 }
	condition:
		$pattern
}
...
rule __GI_getnetbyaddr_r_e045129e0b930caef70f55ffff6b10de {
	meta:
		aliases = "getnetbyaddr_r, __GI_getnetbyaddr_r"
		size = "157"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 8B 74 24 30 8B 6C 24 3C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 14 8D 7C 24 10 EB 12 8B 44 24 28 3B 46 0C 75 09 8B 44 24 2C 3B 46 08 74 19 57 55 FF 74 24 40 FF 74 24 40 56 E8 ?? ?? ?? ?? 83 C4 14 89 C3 85 C0 74 D5 80 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 31 C0 83 7D 00 00 0F 94 C0 F7 D8 83 C4 1C 21 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule getprotoent_r_ec318be2b37578bd33933174edc97954 {
	meta:
		aliases = "__GI_getprotoent_r, getprotoent_r"
		size = "239"
		objfiles = "getproto@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 BB 22 00 00 00 8B 6C 24 34 8B 7C 24 30 8B 74 24 28 C7 44 24 10 00 00 00 00 C7 45 00 00 00 00 00 81 FF 2B 01 00 00 0F 86 AB 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 0E 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 5B 8B 15 ?? ?? ?? ?? 85 D2 74 56 8B 44 24 2C C7 42 08 2C 00 00 00 89 42 04 8D 47 D4 89 42 10 68 ?? ?? ?? ?? 68 0A 02 07 00 8D 44 24 18 50 52 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 26 8B 5C 24 10 8B 03 89 06 8B 43 04 83 C3 08 89 5C 24 10 50 E8 ?? ?? ?? ?? 59 89 5E 04 31 DB 89 46 08 89 75 }
	condition:
		$pattern
}

rule getservent_r_f995844d400a3c0c481fed03a7ec158f {
	meta:
		aliases = "__GI_getservent_r, getservent_r"
		size = "259"
		objfiles = "getservice@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 14 BB 22 00 00 00 8B 6C 24 34 8B 7C 24 30 8B 74 24 28 C7 44 24 10 00 00 00 00 C7 45 00 00 00 00 00 81 FF 2F 01 00 00 0F 86 BF 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 0E 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 5B 8B 15 ?? ?? ?? ?? 85 D2 74 6A 8B 44 24 2C C7 42 08 30 00 00 00 89 42 04 8D 47 D0 89 42 10 68 ?? ?? ?? ?? 68 0B 03 07 00 8D 44 24 18 50 52 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 3A 8B 5C 24 10 8B 03 89 06 8D 43 08 8B 53 04 89 44 24 10 52 E8 ?? ?? ?? ?? 66 C1 C8 08 59 89 75 00 0F B7 C0 }
	condition:
		$pattern
}

rule dladdr_5ffa99032c998756f9bc31804715ebd6 {
	meta:
		aliases = "dladdr"
		size = "337"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 31 F6 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? EB 17 8B 50 14 3B 54 24 2C 73 0B 85 F6 74 05 39 56 14 73 02 89 C6 8B 40 0C 85 C0 75 E5 85 F6 0F 84 11 01 00 00 8B 54 24 30 8B 46 04 8B 6E 54 C7 44 24 10 00 00 00 00 89 02 8B 46 14 89 42 04 8B 46 58 89 44 24 04 C7 44 24 08 00 00 00 00 C7 44 24 0C 00 00 00 00 C7 44 24 14 00 00 00 00 E9 88 00 00 00 8B 46 2C 8B 54 24 08 8B 1C 90 EB 74 8B 06 8B 4C 24 04 89 04 24 89 D8 C1 E0 04 01 C1 66 8B 79 0E 8B 51 04 66 85 FF 75 04 85 D2 74 4E 0F B6 41 0C 83 E0 0F 83 F8 06 74 42 03 14 24 39 54 24 2C 72 39 66 85 FF 74 06 83 79 08 00 75 06 39 54 24 2C 74 0B }
	condition:
		$pattern
}

rule exchange_ddb06f208a0eb1dae326c31c7de25cb5 {
	meta:
		aliases = "exchange"
		size = "219"
		objfiles = "getopt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 89 D6 89 44 24 04 8B 42 14 89 44 24 08 8B 52 18 8B 06 89 54 24 0C 89 44 24 10 E9 87 00 00 00 8B 6C 24 10 8B 7C 24 0C 2B 6C 24 0C 2B 7C 24 08 C7 44 24 14 00 00 00 00 39 FD 7E 61 8B 54 24 10 31 ED 29 FA 89 14 24 EB 20 8B 44 24 08 8B 54 24 04 8D 4C 05 00 8B 04 24 01 E8 45 8D 0C 8A 8D 04 82 8B 19 8B 10 89 11 89 18 39 FD 7C DC 29 7C 24 10 EB 34 8B 4C 24 14 8B 44 24 04 03 4C 24 08 8B 54 24 04 8D 0C 88 8B 44 24 14 03 44 24 0C FF 44 24 14 8D 04 82 8B 19 8B 10 89 11 89 18 39 6C 24 14 7C D0 01 6C 24 08 8B 44 24 0C 39 44 24 10 7E 0C 8B 54 24 08 39 D0 0F 8F 63 FF FF FF 8B 46 14 03 06 }
	condition:
		$pattern
}
...
rule __GI_config_read_58125397f7fe079868172c7988c36d17 {
	meta:
		aliases = "__GI_config_read"
		size = "615"
		objfiles = "parse_config@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 74 24 2C 85 F6 0F 84 48 02 00 00 0F B6 44 24 34 8B 54 24 34 89 44 24 10 C1 E0 02 0F B6 D6 89 44 24 04 40 89 54 24 14 89 04 24 83 7E 04 00 75 35 83 7E 10 00 75 07 C7 46 10 51 00 00 00 83 7E 08 00 75 06 8B 04 24 89 46 08 8B 46 08 03 46 10 50 E8 ?? ?? ?? ?? 89 46 04 85 C0 5F 0F 84 F2 01 00 00 80 4E 14 01 8B 46 08 31 FF 03 46 04 89 46 0C FF 36 8B 46 10 29 F8 50 89 F8 03 46 0C 50 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 17 FF 76 10 6A 00 31 ED FF 76 0C E8 ?? ?? ?? ?? 83 C4 0C E9 B4 01 00 00 8B 5E 0C 8D 04 3B 50 E8 ?? ?? ?? ?? C7 04 24 0A 00 00 00 01 C7 53 E8 ?? ?? ?? ?? 59 89 C2 5B }
	condition:
		$pattern
}
...
rule __GI_fseeko64_693788aa182d06dddb6766097c3dac9e {
	meta:
		aliases = "fseeko64, __GI_fseeko64"
		size = "219"
		objfiles = "fseeko64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 7C 24 38 8B 44 24 30 8B 54 24 34 8B 74 24 2C 89 44 24 10 89 54 24 14 83 FF 02 76 13 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 E9 9A 00 00 00 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 F6 06 40 74 0B 56 E8 ?? ?? ?? ?? 5A 85 C0 75 4B 83 FF 01 75 11 8D 44 24 10 50 56 E8 ?? ?? ?? ?? 59 85 C0 5B 78 35 57 8D 44 24 14 50 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 22 66 83 26 B8 8B 46 08 31 DB 89 46 10 89 46 14 89 46 18 89 46 1C C7 46 2C 00 00 00 00 C6 46 02 00 EB 03 83 CB FF 85 ED 74 0E 6A 01 8D 44 24 }
	condition:
		$pattern
}
...
rule __pgsreader_98aa79e04c56c8fec0e304e410ca6e4a {
	meta:
		aliases = "__pgsreader"
		size = "271"
		objfiles = "__pgsreader@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 8B 7C 24 38 8B 74 24 34 8B 6C 24 3C 81 FF FF 00 00 00 77 15 E8 ?? ?? ?? ?? BB 22 00 00 00 C7 00 22 00 00 00 E9 D5 00 00 00 31 C0 83 7D 34 00 0F 94 C0 89 44 24 04 85 C0 75 0A 8D 04 3E 31 DB 89 04 24 EB 1E 8D 5D 38 53 68 ?? ?? ?? ?? 8D 44 24 10 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 EB D8 55 57 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 14 0F B7 45 00 83 E0 04 83 F8 01 19 DB 83 E3 20 83 C3 02 EB 64 56 E8 ?? ?? ?? ?? 59 8D 54 06 FF 80 3A 0A 75 05 C6 02 00 EB 08 40 39 F8 75 03 43 EB C0 85 DB 74 03 4B EB B9 8A 06 84 C0 74 B3 3C 23 74 AF 0F B6 D0 A1 ?? ?? ?? ?? F6 04 50 20 75 A1 }
	condition:
		$pattern
}

rule __malloc_consolidate_cf84dddc83e5f1b1a0cf0210a1a005bc {
	meta:
		aliases = "__malloc_consolidate"
		size = "379"
		objfiles = "free@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 BA 01 00 00 00 8B 6C 24 2C 8B 45 00 85 C0 0F 84 F9 00 00 00 83 E0 FD 8D 55 34 89 45 00 8D 5D 04 C1 E8 03 89 54 24 10 89 5C 24 04 8D 44 85 FC 89 44 24 08 8B 44 24 04 8B 08 85 C9 0F 84 B8 00 00 00 C7 00 00 00 00 00 8B 41 04 8B 51 08 89 C7 89 54 24 0C 83 E7 FE A8 01 8D 14 39 8B 5A 04 89 1C 24 75 28 8B 01 89 44 24 14 89 C8 2B 44 24 14 8B 70 08 8B 58 0C 8B 4E 0C 39 C1 75 38 39 4B 08 75 33 03 7C 24 14 89 5E 0C 89 73 08 8B 34 24 83 E6 FC 3B 55 2C 74 4B 8B 44 32 04 89 72 04 83 E0 01 85 C0 75 1D 8B 5A 08 8B 42 0C 39 53 0C 75 05 39 50 08 74 05 E8 ?? ?? ?? ?? 01 F7 89 43 0C 89 58 08 }
	condition:
		$pattern
}

rule __GI___res_init_29362d17aa2e6651d032c73953f0a4fc {
	meta:
		aliases = "__res_init, __GI___res_init"
		size = "320"
		objfiles = "res_init@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 18 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 89 C3 8D 44 24 10 50 89 DF E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? 31 C0 B9 19 00 00 00 F3 AB C6 43 52 05 C6 43 53 03 C6 43 51 01 83 C4 10 A1 ?? ?? ?? ?? C7 03 01 00 00 00 B9 07 00 00 00 83 F8 07 77 02 89 C1 31 D2 EB 0D A1 ?? ?? ?? ?? 8B 04 90 89 44 93 34 42 39 CA 7C EF 31 ED C7 44 24 04 00 00 00 00 C7 04 24 00 00 00 00 EB 70 6B 74 24 04 1C 89 F2 03 15 ?? ?? ?? ?? 66 83 3A 02 75 23 8B 04 24 6A 10 C1 E0 04 52 8D 7C 03 04 57 E8 ?? ?? ?? ?? 83 C4 0C 83 FD 02 77 05 89 }
	condition:
		$pattern
}
...
rule hsearch_r_e28b32c9f73609be3432f95e4ef1452b {
	meta:
		aliases = "__GI_hsearch_r, hsearch_r"
		size = "371"
		objfiles = "hsearch_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 44 24 30 8B 54 24 34 89 54 24 14 89 44 24 10 50 E8 ?? ?? ?? ?? 5A 89 C1 EB 0F 8B 5C 24 10 89 C2 C1 E2 04 0F B6 04 0B 01 D0 49 83 F9 FF 75 EB 8B 54 24 40 8B 52 04 89 54 24 08 31 D2 F7 74 24 08 89 D7 85 D2 75 04 66 BF 01 00 6B C7 0C 8B 4C 24 40 8B 09 89 CB 89 4C 24 0C 01 C3 8B 03 85 C0 0F 84 8A 00 00 00 39 F8 75 1A FF 73 04 FF 74 24 14 E8 ?? ?? ?? ?? 5E 85 C0 5D 75 08 8D 43 04 E9 C1 00 00 00 8B 54 24 08 89 F8 83 EA 02 89 FB 89 D1 31 D2 F7 F1 8B 44 24 08 8D 6A 01 29 E8 89 44 24 04 39 EB 77 06 03 5C 24 04 EB 02 29 EB 39 FB 74 3E 6B C3 0C 8B 74 24 0C 01 C6 8B 16 89 54 24 18 }
	condition:
		$pattern
}
...
rule realloc_6172c78909d4255b09b674794b093c70 {
	meta:
		aliases = "realloc"
		size = "762"
		objfiles = "realloc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 5C 24 34 83 7C 24 30 00 75 0A 53 E8 ?? ?? ?? ?? 89 C3 EB 0D 85 DB 75 0F FF 74 24 30 E8 ?? ?? ?? ?? 58 E9 C1 02 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 14 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 FB DF 76 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 89 02 00 00 8D 43 0B C7 44 24 04 10 00 00 00 83 F8 0F 76 07 83 E0 F8 89 44 24 04 8B 7C 24 30 83 EF 08 8B 57 04 89 D5 83 E5 FC F6 C2 02 0F 85 83 01 00 00 89 EB 3B 6C 24 04 0F 83 23 01 00 00 8D 34 2F 3B 35 ?? ?? ?? ?? 75 3B 8B 46 04 83 E0 FC 8D 0C 28 8B 44 24 04 83 C0 10 39 C1 72 62 83 E2 01 8B 5C 24 30 }
	condition:
		$pattern
}
...
rule __GI_inet_pton_759bd56387e9534c3a4be84ff1d02308 {
	meta:
		aliases = "inet_pton, __GI_inet_pton"
		size = "467"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 44 24 34 8B 74 24 38 83 F8 02 74 0B 83 F8 0A 0F 85 A0 01 00 00 EB 10 8B 54 24 3C 89 F0 E8 ?? ?? ?? ?? E9 9C 01 00 00 8D 54 24 10 31 C0 89 D7 AB AB AB AB 80 3E 3A 75 0A 46 80 3E 3A 0F 85 6F 01 00 00 31 ED 89 74 24 0C 89 54 24 04 C7 04 24 00 00 00 00 C7 44 24 08 00 00 00 00 E9 CF 00 00 00 0F B6 C3 83 C8 20 46 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 85 C0 5F 74 1B C1 E5 04 2D ?? ?? ?? ?? 09 C5 81 FD FF FF 00 00 0F 86 9A 00 00 00 E9 1E 01 00 00 80 FB 3A 75 5E 83 3C 24 00 75 19 83 7C 24 08 00 0F 85 08 01 00 00 8B 44 24 04 89 74 24 0C 89 44 24 08 EB 78 80 3E 00 0F 84 F1 00 00 00 }
	condition:
		$pattern
}
...
rule _dl_dprintf_c3993e09927538416c4777c150e892a6 {
	meta:
		aliases = "_dl_dprintf"
		size = "705"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 5C 24 38 85 DB 0F 84 A6 02 00 00 8B 0D ?? ?? ?? ?? C7 44 24 18 00 00 00 00 31 C0 BA 03 00 00 00 BE 22 00 00 00 83 CF FF 53 89 C3 55 8B 6C 24 18 B8 C0 00 00 00 CD 80 5D 5B 3D 00 F0 FF FF 76 0C F7 D8 83 CD FF A3 ?? ?? ?? ?? EB 07 89 C5 83 F8 FF 75 48 B9 ?? ?? ?? ?? BA 1D 00 00 00 8B 44 24 34 53 89 C3 B8 04 00 00 00 CD 80 5B 89 C2 3D 00 F0 FF FF 76 08 F7 DA 89 15 ?? ?? ?? ?? B9 14 00 00 00 87 CB B8 01 00 00 00 CD 80 87 CB 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 8D 73 FF 89 F2 42 80 3A 00 75 FA A1 ?? ?? ?? ?? 29 DA 48 39 C2 72 48 B9 ?? ?? ?? ?? BA 0B 00 00 00 8B 44 24 34 }
	condition:
		$pattern
}

rule __GI_fclose_5297119a87e715676084c894fa7db389 {
	meta:
		aliases = "fclose, __GI_fclose"
		size = "244"
		objfiles = "fclose@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 74 24 34 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 31 FF F6 06 40 74 09 56 E8 ?? ?? ?? ?? 89 C7 58 FF 76 04 E8 ?? ?? ?? ?? 5B 85 C0 79 03 83 CF FF C7 46 04 FF FF FF FF 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 08 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 6A 01 40 53 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 06 83 C4 18 66 25 00 60 83 C8 30 85 ED 66 89 06 74 0E 6A 01 8D 44 24 14 50 E8 ?? ?? ?? ?? 5A 59 F6 46 01 40 74 09 FF 76 08 E8 ?? ?? ?? ?? 58 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 }
	condition:
		$pattern
}

rule freopen64_3ffe8a472c474c68fe25ef4b1e575ba7 {
	meta:
		aliases = "freopen64"
		size = "243"
		objfiles = "freopen64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 74 24 3C 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 7C 24 08 57 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 6A 01 40 57 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1E 83 C4 18 89 D8 80 E4 9F 66 89 06 83 E0 30 83 F8 30 74 31 56 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 57 FF 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 1C 6A FE 56 FF 74 24 40 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 75 05 66 C7 06 }
	condition:
		$pattern
}

rule freopen_986dd73d255707236f2c48895510555c {
	meta:
		aliases = "freopen"
		size = "243"
		objfiles = "freopen@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 74 24 3C 83 7E 34 00 0F 94 C0 0F B6 E8 85 ED 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 7C 24 08 57 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 6A 01 40 57 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 1E 83 C4 18 89 D8 80 E4 9F 66 89 06 83 E0 30 83 F8 30 74 31 56 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 6A 01 57 FF 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 1C 6A FF 56 FF 74 24 40 FF 74 24 40 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 75 05 66 C7 06 }
	condition:
		$pattern
}
...
rule __res_search_ea76385361bb13a7ecbfd5c6bf9d50c7 {
	meta:
		aliases = "__res_search"
		size = "528"
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 24 83 7C 24 38 00 74 0B 8D 5C 24 14 83 7C 24 44 00 75 10 E8 ?? ?? ?? ?? C7 00 FF FF FF FF E9 CC 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 44 24 10 8B 28 0F B6 40 51 89 44 24 1C 6A 01 53 E8 ?? ?? ?? ?? 83 C4 18 F7 C5 01 00 00 00 75 07 E8 ?? ?? ?? ?? EB B9 E8 ?? ?? ?? ?? 31 FF 89 44 24 04 C7 00 00 00 00 00 E8 ?? ?? ?? ?? 8B 54 24 38 89 C3 C7 00 01 00 00 00 EB 0B 3C 2E 0F 94 C0 0F B6 C0 01 C7 42 8A 02 84 C0 75 EF 31 F6 3B 54 24 38 76 0A 80 7A FF 2E 0F 94 C0 0F B6 F0 C7 44 24 08 FF FF FF FF 3B 7C 24 0C 72 2F FF 74 24 }
	condition:
		$pattern
}

rule __GI_memcmp_33123168b4e8fc796c5c0d822fd64763 {
	meta:
...
rule mallinfo_7efc5f06dec34677bed4c8e7353bc2f9 {
	meta:
		aliases = "__GI_mallinfo, mallinfo"
		size = "309"
		objfiles = "mallinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 8B 7C 24 3C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 20 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 0B 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 A1 ?? ?? ?? ?? 31 C9 C7 44 24 04 00 00 00 00 C7 44 24 0C 00 00 00 00 8B 40 04 89 04 24 EB 1F 8B 14 8D ?? ?? ?? ?? EB 11 8B 42 04 FF 44 24 0C 83 E0 FC 8B 52 08 01 44 24 04 85 D2 75 EB 41 83 F9 09 76 DC 8B 04 24 8B 6C 24 04 83 E0 FC BB 01 00 00 00 01 C5 C7 44 24 08 01 00 00 00 EB 20 8D 0C DD ?? ?? ?? ?? 8B 51 0C EB 0F 8B 42 04 FF 44 24 08 83 E0 FC 8B 52 0C 01 C5 39 CA 75 ED 43 83 FB 5F 76 DB A1 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule remainder_64042736c9c48070529e5a6399904eaf {
	meta:
		aliases = "drem, __ieee754_remainder, __GI_remainder, remainder"
		size = "343"
...
rule __GI_clnttcp_create_fe014781c93cf8c339e7961d68cd6e70 {
	meta:
...
rule malloc_4b7f56a7b078ede46ad58a2cd979de49 {
	meta:
		aliases = "malloc"
		size = "1926"
		objfiles = "malloc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 34 8B 5C 24 48 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 2C 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 FB DF 76 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 39 07 00 00 8D 43 0B C7 44 24 08 10 00 00 00 83 F8 0F 76 07 83 E0 F8 89 44 24 08 8B 1D ?? ?? ?? ?? F6 C3 01 75 18 85 DB 0F 85 59 03 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5D E9 49 03 00 00 39 5C 24 08 77 1E 8B 4C 24 08 C1 E9 03 8B 14 8D ?? ?? ?? ?? 85 D2 74 0C 8B 42 08 89 04 8D ?? ?? ?? ?? EB 35 81 7C 24 08 FF 00 00 00 77 33 8B 6C 24 08 C1 ED 03 8D 0C ED ?? ?? ?? ?? 8B 51 0C 39 CA 0F 84 69 01 00 00 8B 5C 24 08 }
	condition:
		$pattern
}
...
rule __GI_gethostbyname_r_de91be29943f4e109ccb708dad68255b {
	meta:
		aliases = "gethostbyname_r, __GI_gethostbyname_r"
		size = "666"
		objfiles = "gethostbyname_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 38 BE 16 00 00 00 8B 44 24 5C 8B 6C 24 58 83 7C 24 4C 00 C7 00 00 00 00 00 0F 84 6B 02 00 00 E8 ?? ?? ?? ?? 89 C3 8B 38 C7 00 00 00 00 00 FF 74 24 60 FF 74 24 60 55 FF 74 24 60 FF 74 24 60 6A 02 FF 74 24 64 E8 ?? ?? ?? ?? 83 C4 1C 89 C6 85 C0 75 07 89 3B E9 30 02 00 00 8B 54 24 60 8B 02 83 F8 01 74 0E 83 F8 04 74 1F 40 0F 85 19 02 00 00 EB 0D 31 C0 83 FE 02 0F 94 C0 89 04 24 EB 10 83 3B 02 0F 85 01 02 00 00 C7 04 24 00 00 00 00 8B 4C 24 60 89 3B C7 01 FF FF FF FF FF 74 24 4C E8 ?? ?? ?? ?? 59 8D 58 01 39 DD 0F 8E D4 01 00 00 53 29 DD FF 74 24 50 FF 74 24 5C E8 ?? ?? ?? ?? 8B }
	condition:
		$pattern
}

rule rint_6e1701269a93395fd6e2873c2b7a4748 {
	meta:
		aliases = "__GI_rint, __GI_nearbyint, nearbyint, rint"
		size = "342"
		objfiles = "s_rint@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 38 DD 44 24 4C C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 DD 54 24 20 8B 44 24 24 8B 5C 24 20 C1 E8 14 25 FF 07 00 00 8D B0 01 FC FF FF 83 FE 33 0F 8F 0B 01 00 00 8B 6C 24 24 89 EF C1 EF 1F 83 FE 13 0F 8F B0 00 00 00 85 F6 79 72 89 E8 25 FF FF FF 7F 09 D8 0F 84 E6 00 00 00 89 EA 81 E5 00 00 FE FF 81 E2 FF FF 0F 00 09 DA 89 D0 F7 D8 09 D0 C1 E8 0C DD 5C 24 18 25 00 00 08 00 09 E8 DD 04 FD ?? ?? ?? ?? C1 E7 1F 89 44 24 1C DD 44 24 18 D8 C1 DD 5C 24 30 DD 44 24 30 DE E1 DD 54 24 28 DD 54 24 10 8B 44 24 14 25 FF FF FF 7F DD 5C 24 08 09 C7 89 7C 24 0C DD 44 24 08 EB 7D DD D8 BA }
	condition:
		$pattern
}
...
rule __xpg_strerror_r_4f271b20d2435b9428cbc1dd7416ee67 {
	meta:
...
rule __GI_gethostbyname2_r_9c51323abd9b2021b71e9f800598cb53 {
	meta:
		aliases = "gethostbyname2_r, __GI_gethostbyname2_r"
		size = "668"
		objfiles = "gethostbyname2_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 8B 44 24 54 8B 7C 24 60 83 F8 02 75 22 FF 74 24 68 FF 74 24 68 57 FF 74 24 68 FF 74 24 68 FF 74 24 64 E8 ?? ?? ?? ?? 83 C4 18 E9 5E 02 00 00 8B 54 24 64 83 F8 0A C7 02 00 00 00 00 0F 85 46 02 00 00 83 7C 24 50 00 0F 84 3B 02 00 00 E8 ?? ?? ?? ?? 89 C6 8B 28 C7 00 00 00 00 00 FF 74 24 68 FF 74 24 68 57 FF 74 24 68 FF 74 24 68 6A 0A FF 74 24 68 E8 ?? ?? ?? ?? 83 C4 1C 85 C0 75 07 89 2E E9 07 02 00 00 8B 4C 24 68 8B 11 83 FA 01 74 0E 83 FA 04 74 1C 42 0F 85 F0 01 00 00 EB 0A 31 DB 83 F8 02 0F 94 C3 EB 0B 83 3E 02 0F 85 DB 01 00 00 31 DB 8B 54 24 5C 8B 44 24 68 F7 DA 83 E2 03 }
	condition:
		$pattern
}

rule __GI_getnetent_r_4cd4979117ea2e131e93a89436af3b5e {
	meta:
		aliases = "getnetent_r, __GI_getnetent_r"
		size = "322"
		objfiles = "getnet@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C BF 22 00 00 00 8B 6C 24 5C 8B 74 24 58 8B 5C 24 50 81 FE 2B 01 00 00 C7 45 00 00 00 00 00 0F 86 06 01 00 00 C7 44 24 38 00 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 2C 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 0E 0F BE 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 59 8B 15 ?? ?? ?? ?? 85 D2 0F 84 A5 00 00 00 8B 44 24 54 C7 42 08 2C 00 00 00 89 42 04 8D 46 D4 89 42 10 68 ?? ?? ?? ?? 68 0A 02 07 00 8D 44 24 40 50 52 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 75 8B 44 24 38 8D 74 24 04 B9 08 00 00 00 89 F7 8B 10 83 C0 04 89 44 24 38 89 13 31 C0 F3 AB 8B }
	condition:
		$pattern
}

rule __time_localtime_tzi_69b6f10f188f97f2cd8fb40c96d5925f {
	meta:
		aliases = "__time_localtime_tzi"
		size = "692"
		objfiles = "_time_localtime_tzi@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C C7 44 24 18 00 00 00 00 6B 44 24 18 18 8B 4C 24 50 8B 5C 24 58 01 C3 B8 80 3A 09 00 8B 11 B9 F9 FF FF FF 2B 03 81 FA 7F C5 F6 7F 7E 07 F7 D8 B9 07 00 00 00 01 D0 89 44 24 38 FF 74 24 54 51 8D 74 24 40 56 E8 ?? ?? ?? ?? 8B 7C 24 60 8B 44 24 24 BE ?? ?? ?? ?? 83 C4 0C 89 47 20 8B 03 F7 D8 89 47 24 8D 7B 10 8D 5E 04 57 53 E8 ?? ?? ?? ?? 59 85 C0 5A 75 04 89 D8 EB 45 8B 36 85 F6 75 E6 6A 07 57 E8 ?? ?? ?? ?? 5E 83 F8 06 5A 7F 2B 83 C0 08 50 E8 ?? ?? ?? ?? 5B 89 C2 85 C0 74 1B A1 ?? ?? ?? ?? 89 02 8D 42 04 57 89 15 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 5A 59 EB 05 B8 ?? ?? ?? ?? FF 44 }
	condition:
		$pattern
}

rule __ieee754_atan2_82c6744c29ccf6375a3ed8fa439bc858 {
	meta:
		aliases = "__GI_atan2, atan2, __ieee754_atan2"
		size = "580"
...
rule _dl_map_cache_b6317767a7131d9c8d2b31057eddb9c8 {
	meta:
		aliases = "_dl_map_cache"
		size = "505"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 44 83 C8 FF 8B 15 ?? ?? ?? ?? 83 FA FF 0F 84 D8 01 00 00 85 D2 0F 85 CE 01 00 00 BE ?? ?? ?? ?? 89 E1 89 F2 87 D3 B8 6A 00 00 00 CD 80 87 D3 89 C3 3D 00 F0 FF FF 76 0D F7 DB 89 1D ?? ?? ?? ?? E9 95 01 00 00 85 C0 0F 85 8D 01 00 00 B9 00 00 08 00 31 D2 89 F0 53 89 C3 B8 05 00 00 00 CD 80 5B 89 C7 3D 00 F0 FF FF 76 0D F7 DF 89 3D ?? ?? ?? ?? E9 63 01 00 00 85 C0 0F 88 5B 01 00 00 8B 4C 24 14 BE 01 00 00 00 89 0D ?? ?? ?? ?? C7 44 24 40 00 00 00 00 89 D8 89 F2 53 89 C3 55 8B 6C 24 40 B8 C0 00 00 00 CD 80 5D 5B 89 C1 89 C2 3D 00 F0 FF FF 76 0B F7 D9 89 0D ?? ?? ?? ?? 83 CA FF 89 }
	condition:
		$pattern
}
...
rule __GI_getaddrinfo_203e2c3c918cfa87da028950c1a16aeb {
	meta:
		aliases = "getaddrinfo, __GI_getaddrinfo"
		size = "604"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 8B 54 24 64 8B 74 24 68 83 7C 24 60 00 74 19 8B 44 24 60 80 38 2A 75 10 80 78 01 00 0F 95 C0 0F B6 C0 F7 D8 21 44 24 60 85 D2 74 12 80 3A 2A 75 0D 31 C0 80 7A 01 00 0F 95 C0 F7 D8 21 C2 8B 7C 24 60 09 D7 0F 84 F9 01 00 00 85 F6 75 11 8D 5C 24 1C B9 08 00 00 00 89 DF 89 F0 F3 AB 89 DE 8B 06 A9 C0 FB FF FF 0F 85 DE 01 00 00 A8 02 74 0B 83 7C 24 60 00 0F 84 CF 01 00 00 85 D2 74 4C 80 3A 00 74 47 89 54 24 3C 6A 0A 8D 44 24 48 50 52 E8 ?? ?? ?? ?? 89 44 24 4C 83 C4 0C 8B 44 24 44 80 38 00 75 0A 8D 44 24 3C 89 44 24 10 EB 24 F6 46 01 04 0F 85 8A 01 00 00 8D 54 24 3C C7 44 24 40 }
	condition:
		$pattern
}
...
rule vwarn_work_800c0aabb4769f9f5bf515e4241d67d9 {
	meta:
		aliases = "vwarn_work"
		size = "195"
		objfiles = "err@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 50 89 C7 89 D5 BB ?? ?? ?? ?? 85 C9 74 1B E8 ?? ?? ?? ?? 6A 40 8D 54 24 04 BB ?? ?? ?? ?? 52 FF 30 E8 ?? ?? ?? ?? 83 C4 0C 8B 15 ?? ?? ?? ?? 83 7A 34 00 0F 94 C0 0F B6 F0 85 F6 74 24 8D 42 38 50 68 ?? ?? ?? ?? 8D 44 24 48 50 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C0 38 50 E8 ?? ?? ?? ?? 83 C4 10 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 85 FF 74 13 55 57 FF 35 ?? ?? ?? ?? 83 EB 02 E8 ?? ?? ?? ?? 83 C4 0C 89 E0 50 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 85 F6 74 0E 6A 01 8D 44 24 44 50 E8 ?? ?? ?? ?? 58 5A 83 C4 50 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule vswprintf_009785f47accc09b1c3e8b8b7b4bbd53 {
	meta:
		aliases = "__GI_vswprintf, vswprintf"
		size = "178"
		objfiles = "vswprintf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 50 89 E5 8B 74 24 64 8D 44 24 38 89 F3 8B 7C 24 68 F7 D3 C7 44 24 04 FD FF FF FF 66 C7 04 24 50 08 C6 44 24 02 00 C7 44 24 2C 00 00 00 00 C1 EB 02 C7 44 24 34 01 00 00 00 50 E8 ?? ?? ?? ?? C7 44 24 24 00 00 00 00 39 FB 58 76 02 89 FB 8D 04 9E 89 74 24 08 89 44 24 0C 89 74 24 10 89 74 24 14 89 74 24 18 89 74 24 1C FF 74 24 70 FF 74 24 70 55 E8 ?? ?? ?? ?? 89 C2 8B 44 24 1C 83 C4 0C 3B 44 24 0C 75 0E 83 CA FF 85 DB 74 15 83 E8 04 89 44 24 10 85 DB 74 0A 8B 44 24 10 C7 00 00 00 00 00 83 C4 50 89 D0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule _ppfs_parsespec_a9604f4d72077d2aaabe06a48d185d79 {
	meta:
		aliases = "_ppfs_parsespec"
		size = "1036"
		objfiles = "_ppfs_parsespec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 58 8B 54 24 6C C7 44 24 4C 00 00 00 00 C7 44 24 50 00 00 00 00 C7 44 24 30 08 00 00 00 C7 44 24 34 08 00 00 00 8B 44 24 6C 8B 6A 10 8B 40 18 81 E5 80 00 00 00 89 44 24 08 75 04 8B 12 EB 39 31 F6 8B 44 24 6C 8D 0C B5 00 00 00 00 8B 10 8B 44 11 FC 88 44 34 10 88 C3 0F B6 C0 3B 44 11 FC 0F 85 96 03 00 00 84 DB 74 06 46 83 FE 1F 76 D2 C6 44 24 2F 00 8D 54 24 11 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 EB 02 89 F2 89 D6 80 3A 2A 75 10 6B 44 24 04 FC 8D 72 01 C7 44 04 30 00 00 00 00 31 FF EB 24 81 FF CB CC CC 0C 7E 0D 81 FF CC CC CC 0C 75 0E 83 F9 37 7F 09 6B C7 0A 8D 7C 08 D0 }
	condition:
		$pattern
}

rule gamma_r_741e423662c1c366d89e856ad9e14cdf {
	meta:
		aliases = "lgamma_r, __ieee754_lgamma_r, gamma_r"
		size = "1680"
		objfiles = "e_lgamma_r@libm.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 5C DD 44 24 70 8B 6C 24 78 DD 54 24 28 8B 44 24 2C C7 45 00 01 00 00 00 89 C6 89 44 24 40 81 E6 FF FF FF 7F 81 FE FF FF EF 7F 7E 09 D9 C0 DE C9 E9 4D 06 00 00 DD D8 8B 7C 24 28 89 F0 09 F8 75 1C FF 74 24 74 FF 74 24 74 E8 ?? ?? ?? ?? 5E 85 C0 5F 74 61 C7 45 00 FF FF FF FF EB 58 81 FE FF FF 8F 3B 7F 36 83 7C 24 40 00 79 19 DD 44 24 70 D9 E0 C7 45 00 FF FF FF FF DD 54 24 70 83 EC 08 DD 1C 24 EB 08 FF 74 24 74 FF 74 24 74 E8 ?? ?? ?? ?? 59 D9 E0 5B E9 E7 05 00 00 83 7C 24 40 00 78 0B D9 EE DD 5C 24 38 E9 EA 01 00 00 81 FE FF FF 2F 43 7E 07 D9 EE E9 89 01 00 00 DD 44 24 70 DD 5C }
	condition:
		$pattern
}

rule lckpwdf_57ce34d865d5e927233cda878da8ca86 {
	meta:
		aliases = "lckpwdf"
		size = "308"
		objfiles = "lckpwdf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 60 83 C8 FF 83 3D ?? ?? ?? ?? FF 0F 85 15 01 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 38 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 01 00 08 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 18 A3 ?? ?? ?? ?? 83 F8 FF 0F 84 C7 00 00 00 6A 01 6A 02 50 31 DB E8 ?? ?? ?? ?? 8D 54 24 14 89 D7 89 D8 AB AB AB AB AB 8D 6C 24 28 C7 44 24 14 ?? ?? ?? ?? C7 44 24 20 FF FF FF FF C7 44 24 24 FF FF FF FF 55 52 6A 0E E8 ?? ?? ?? ?? 8D 74 24 70 C7 44 24 6C 00 00 00 00 C7 44 24 68 00 20 00 00 56 8D 44 24 6C 50 6A 01 E8 ?? ?? ?? ?? 83 C4 24 6A 0F E8 ?? ?? ?? ?? 8D 54 24 44 89 D8 89 D7 AB AB }
	condition:
		$pattern
}
...
rule __md5_Transform_ae260b1649dc412f424bc9a3c0710ee5 {
	meta:
		aliases = "__md5_Transform"
		size = "312"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 64 89 C5 89 D6 B9 10 00 00 00 8D 7C 24 24 F3 A5 8B 00 8D 55 04 89 44 24 20 89 54 24 04 8D 45 08 8D 55 0C 8B 5D 04 8B 7D 08 8B 75 0C 8B 4C 24 20 89 44 24 08 89 54 24 0C C7 44 24 10 ?? ?? ?? ?? C7 44 24 14 ?? ?? ?? ?? C7 44 24 18 ?? ?? ?? ?? C7 44 24 1C 00 00 00 00 E9 99 00 00 00 F6 44 24 1C 0F 75 05 83 44 24 10 04 8B 44 24 1C C1 F8 04 83 F8 01 74 1E 7F 06 85 C0 74 0E EB 37 83 F8 02 74 1F 83 F8 03 74 22 EB 2B 89 D8 89 FA F7 D0 21 F0 EB 08 89 F0 89 F2 F7 D0 21 F8 21 DA 09 D0 EB 10 89 F8 31 D8 31 F0 EB 08 89 F0 F7 D0 09 D8 31 F8 8D 0C 08 8B 44 24 18 8B 54 24 14 0F B6 00 89 04 24 }
	condition:
		$pattern
}

rule _time_mktime_tzi_38ee9144d60506b1dd78e59819353a78 {
	meta:
		aliases = "_time_mktime_tzi"
		size = "693"
		objfiles = "_time_mktime_tzi@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 68 B9 0B 00 00 00 8D 6C 24 38 8B 74 24 7C 89 EF F3 A5 8B 84 24 84 00 00 00 80 78 28 00 75 08 C7 44 24 58 00 00 00 00 C7 44 24 34 00 00 00 00 83 7C 24 58 00 74 16 0F 9F C0 0F B6 C0 C7 44 24 34 01 00 00 00 8D 44 00 FF 89 44 24 58 8B 4D 14 8D 55 14 89 C8 8D 5D 18 89 54 24 24 BF 90 01 00 00 99 F7 FF 89 5C 24 28 8B 5D 10 89 44 24 04 8D 55 10 89 45 18 89 D8 89 5C 24 14 89 54 24 2C BB 0C 00 00 00 8D 75 1C 99 F7 FB 01 C1 89 44 24 10 69 5C 24 04 90 01 00 00 89 45 1C 8B 54 24 14 6B C0 0C 29 D9 29 C2 89 4D 14 89 D0 89 55 10 85 D2 79 0C 83 C0 0C 8B 4C 24 24 89 45 10 FF 09 8B 4D 14 BB ?? }
	condition:
		$pattern
}

rule strptime_c68f960f6924fb32d79de8fac087392a {
	meta:
		aliases = "strptime"
		size = "947"
		objfiles = "strptime@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 6C 31 C0 8B AC 24 80 00 00 00 C7 44 84 20 00 00 00 80 40 83 F8 0C 7E F2 8B BC 24 84 00 00 00 C7 44 24 08 00 00 00 00 8A 07 84 C0 75 48 83 7C 24 08 00 75 33 83 7C 24 38 07 75 08 C7 44 24 38 00 00 00 00 31 D2 8B 44 94 20 3D 00 00 00 80 74 0A 8B 8C 24 88 00 00 00 89 04 91 42 83 FA 07 7E E5 89 E8 E9 3E 03 00 00 FF 4C 24 08 8B 5C 24 08 8B 7C 9C 54 EB B2 3C 25 0F 85 FA 02 00 00 47 8A 07 3C 25 0F 84 EF 02 00 00 3C 4F 74 08 B1 3F 3C 45 75 0E EB 04 B0 40 EB 02 B0 80 88 C1 47 83 C9 3F 8A 17 84 D2 0F 84 F9 02 00 00 88 D0 83 C8 20 83 E8 61 3C 19 0F 87 E9 02 00 00 0F B6 C2 8A 90 ?? ?? ?? }
	condition:
		$pattern
}
...
rule __getutid_3a4f2a3a738779572bf18de152c390f0 {
	meta:
		aliases = "__getutid"
		size = "73"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 89 C7 0F BF 00 8D 6F 28 8D 70 FF C1 EE 02 EB 23 85 F6 75 07 8B 03 66 3B 07 EB 16 83 FE 01 75 13 8D 43 28 6A 04 55 50 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 0B E8 ?? ?? ?? ?? 89 C3 85 C0 75 D2 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule rwlock_have_already_3824bb6c81475dd7f108e276ea15a476 {
	meta:
		aliases = "rwlock_have_already"
		size = "164"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 89 C7 89 D6 89 CD 8B 18 83 7A 18 01 74 06 31 D2 31 C9 EB 6F 85 DB 75 07 E8 ?? ?? ?? ?? 89 C3 8B 93 48 01 00 00 EB 07 39 72 04 74 08 8B 12 85 D2 75 F5 EB 04 85 D2 75 4F 83 BB 50 01 00 00 00 7F 46 8B 93 4C 01 00 00 85 D2 74 0A 8B 02 89 83 4C 01 00 00 EB 0A 6A 0C E8 ?? ?? ?? ?? 89 C2 58 85 D2 74 18 8B 83 48 01 00 00 C7 42 08 01 00 00 00 89 02 89 72 04 89 93 48 01 00 00 83 FA 01 19 C9 83 E1 01 31 F6 EB 07 31 C9 BE 01 00 00 00 8B 44 24 14 89 55 00 89 1F 89 08 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule _dl_parse_dynamic_info_49bd3735a5697023fea3a21844ebdfff {
	meta:
		aliases = "_dl_parse_dynamic_info"
		size = "274"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 54 24 14 8B 5C 24 18 8B 6C 24 1C 8B 74 24 20 31 FF E9 9A 00 00 00 83 F9 21 7F 58 8B 42 04 83 3A 15 89 04 8B 75 03 89 6A 04 83 3A 18 75 07 C7 43 60 01 00 00 00 83 3A 1E 75 0D F6 42 04 08 74 07 C7 43 60 01 00 00 00 83 3A 16 75 07 C7 43 58 01 00 00 00 83 3A 1D 75 07 C7 43 3C 00 00 00 00 83 3A 0F 75 49 83 7B 74 00 74 43 C7 43 3C 00 00 00 00 EB 3A 81 F9 FF FF FF 6F 7F 32 81 F9 FA FF FF 6F 75 09 8B 42 04 89 83 88 00 00 00 81 3A FB FF FF 6F 75 19 F6 42 04 01 74 07 C7 43 60 01 00 00 00 F6 42 04 08 74 06 81 CF 00 10 00 00 83 C2 08 8B 0A 85 C9 0F 85 5C FF FF FF 85 F6 74 48 8B 43 10 85 C0 }
	condition:
		$pattern
}
...
rule __GI_random_r_c10c131245f3ea9a155c0bb22f6f23a4 {
	meta:
...
rule ether_aton_r_b4907d8b1145e2080a4471ed1f4c5334 {
	meta:
		aliases = "__GI_ether_aton_r, ether_aton_r"
		size = "140"
		objfiles = "ether_addr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 5C 24 14 8B 7C 24 18 31 ED EB 6C 8A 03 3C 1F 76 6D 88 C2 83 CA 20 8D 4A D0 80 F9 09 76 07 8D 42 9F 3C 05 77 59 89 CE 80 FA 39 76 03 8D 72 A9 8A 43 01 83 C3 02 83 FD 05 74 04 3C 3A EB 02 84 C0 74 2F 88 C2 83 CA 20 8D 4A D0 80 F9 09 76 07 8D 42 9F 3C 05 77 28 80 FA 39 76 03 8D 4A A9 89 F0 C1 E0 04 83 FD 05 8D 34 01 74 06 80 3B 3A 75 0E 43 89 F0 88 04 2F 45 83 FD 05 7E 8F EB 02 31 FF 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __GI_svc_getreq_poll_fe60ac6ea61ca03e23c39c550bf6ed3c {
	meta:
...
rule __GI_getcwd_badaf110ba096149d73f9759934bb378 {
	meta:
...
rule truncate64_b19e7eae6d01d2b4df8bdccb559230f4 {
	meta:
		aliases = "truncate64"
		size = "69"
		objfiles = "truncate64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 1C 8B 7C 24 18 89 EE 89 FB 89 F3 8B 44 24 14 89 DE 89 F9 C1 FE 1F 89 DA 53 89 C3 B8 C1 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule ftruncate64_93131e515cde60c89f7170f90907989f {
	meta:
		aliases = "__GI_ftruncate64, ftruncate64"
		size = "69"
		objfiles = "ftruncate64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 1C 8B 7C 24 18 89 EE 89 FB 89 F3 8B 44 24 14 89 DE 89 F9 C1 FE 1F 89 DA 53 89 C3 B8 C2 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule getpwuid_r_bd71f4213c840b6491270d73c0492b51 {
	meta:
		aliases = "getgrgid_r, __GI_getgrgid_r, __GI_getpwuid_r, getpwuid_r"
		size = "127"
...
rule getpwnam_r_58c1fbfb60120a75998e512e626f63ff {
	meta:
		aliases = "__GI_getgrnam_r, getspnam_r, __GI_getpwnam_r, __GI_getspnam_r, getgrnam_r, getpwnam_r"
		size = "135"
...
rule sgetspent_r_c943cd1357d3567b76d6598349e1f8ed {
	meta:
		aliases = "__GI_sgetspent_r, sgetspent_r"
		size = "105"
		objfiles = "sgetspent_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 6C 24 24 8B 7C 24 20 8B 5C 24 14 8B 74 24 1C C7 45 00 00 00 00 00 81 FF FF 00 00 00 77 12 E8 ?? ?? ?? ?? C7 00 22 00 00 00 B8 22 00 00 00 EB 2F 39 F3 74 14 53 E8 ?? ?? ?? ?? 5A 39 F8 73 DF 53 56 E8 ?? ?? ?? ?? 5B 5F 56 FF 74 24 1C E8 ?? ?? ?? ?? 5A 85 C0 59 75 07 8B 54 24 18 89 55 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule _obstack_begin_1_4f3b9dc6a608ce12b88ab00943d9dbe7 {
	meta:
		aliases = "_obstack_begin_1"
		size = "143"
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 74 24 1C 8B 5C 24 14 8B 54 24 18 8B 4C 24 20 8B 6C 24 28 85 F6 75 04 66 BE 04 00 85 D2 75 04 66 BA E0 0F 8B 44 24 24 8D 7E FF 80 4B 28 01 89 4B 1C 89 43 20 89 13 89 7B 18 89 6B 24 F6 43 28 01 74 0A 52 55 FF D1 89 C2 58 59 EB 06 52 FF D1 89 C2 58 89 53 04 85 D2 75 05 E8 ?? ?? ?? ?? 8D 44 3A 08 C7 42 04 00 00 00 00 F7 DE 21 F0 89 43 08 89 43 0C 89 D0 03 03 89 02 89 43 10 80 63 28 F9 B8 01 00 00 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_pthread_setschedparam_e1509a5089028b4e14db92decd6924c0 {
	meta:
...
rule __GI_fgets_unlocked_00575c22fd38234626768fd5183c1a95 {
	meta:
...
rule __GI_mknodat_0113ffa8767e15fc8403b8afcebcce14 {
	meta:
		aliases = "mknodat, __GI_mknodat"
		size = "60"
		objfiles = "mknodat@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 7C 24 20 8B 4C 24 18 8B 44 24 14 8B 54 24 1C 89 FE 53 89 C3 B8 29 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __new_sem_wait_1afd3a64e08b07d11a84f8386b5b2b4c {
	meta:
...
rule daemon_46b2861b7d48f37368986f3c25d8c285 {
	meta:
		aliases = "daemon"
		size = "263"
		objfiles = "daemon@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 83 EC 60 E8 ?? ?? ?? ?? 83 F8 FF 0F 84 D3 00 00 00 85 C0 0F 84 D4 00 00 00 6A 00 E8 ?? ?? ?? ?? 83 7D 08 00 75 0B 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 83 7D 0C 00 0F 85 AE 00 00 00 BB ?? ?? ?? ?? B9 02 00 00 00 89 D8 8B 55 0C 53 89 C3 B8 05 00 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? 83 CE FF F7 DB 89 18 EB 6B 89 C6 83 F8 FF 74 64 8D 45 98 50 53 E8 ?? ?? ?? ?? 59 85 C0 5A 75 54 8B 45 A8 25 00 F0 00 00 3D 00 20 00 00 75 2B 6A 00 53 E8 ?? ?? ?? ?? 6A 01 53 E8 ?? ?? ?? ?? 6A 02 53 E8 ?? ?? ?? ?? 83 C4 18 83 FB 02 7E 37 53 E8 ?? ?? ?? ?? 31 C0 5A EB 3E 89 D9 87 CB B8 06 }
	condition:
		$pattern
}
...
rule read_uleb128_f200068803a17451bb061a46ee0fe3f8 {
	meta:
		...
		size = "59"
		objfiles = "unwind_dw2@libgcc_eh.a, unwind_dw2_fde_glibc@libgcc_eh.a, unwind_c@libgcc_eh.a"
	strings:
...
rule glob64_bc490924f51e5a0131d3063c8edafa2f {
	meta:
		aliases = "__GI_glob64, glob64"
		size = "1298"
		objfiles = "glob64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 0C 01 00 00 8B 7D 14 83 7D 08 00 74 0D 85 FF 74 09 F7 45 0C 00 81 FF FF 74 13 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 E9 D3 04 00 00 8B 45 0C 83 E0 08 89 85 F0 FE FF FF 75 07 C7 47 08 00 00 00 00 6A 2F FF 75 08 E8 ?? ?? ?? ?? 5B 85 C0 5E 89 C6 75 38 F7 45 0C 00 50 00 00 0F 84 C9 00 00 00 8B 55 08 80 3A 7E 0F 85 BD 00 00 00 52 E8 ?? ?? ?? ?? 59 8B 5D 08 89 85 FC FE FF FF C7 85 F8 FE FF FF 00 00 00 00 E9 B6 00 00 00 3B 45 08 75 1E 8B 4D 08 BB ?? ?? ?? ?? 41 C7 85 FC FE FF FF 01 00 00 00 89 8D F8 FE FF FF E9 93 00 00 00 2B 45 08 89 85 FC FE FF FF 83 C0 13 83 E0 FC 29 C4 }
	condition:
		$pattern
}
...
rule gaih_inet_c9242fcaf5766108ba698f11dd3d3c8a {
	meta:
		aliases = "gaih_inet"
		size = "2324"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 88 00 00 00 8B 55 10 8B 42 04 85 C0 74 0F C7 85 74 FF FF FF 00 00 00 00 83 F8 0A 75 16 8B 4D 10 8B 19 83 F3 08 C1 EB 03 F7 D3 83 E3 01 89 9D 74 FF FF FF 31 C0 8D 7D D0 AB AB AB AB 8B 75 10 8B 5E 0C 85 DB 75 30 83 7E 08 00 75 2A EB 4A 8B 7D 10 8B 4F 08 85 C9 74 07 0F BE 02 39 C1 75 12 85 DB 74 3A 0F BE 42 01 39 C3 74 32 F6 42 02 02 75 2C 83 C2 07 EB 05 BA ?? ?? ?? ?? 80 7A 03 00 75 CD 8B 55 10 B8 07 01 00 00 83 7A 08 00 0F 85 71 08 00 00 E9 55 08 00 00 BA ?? ?? ?? ?? 8D 45 D0 89 45 F0 83 7D 0C 00 0F 84 1C 01 00 00 F6 42 02 01 0F 85 36 08 00 00 8B 4D 0C 83 79 04 00 0F 89 }
	condition:
		$pattern
}
...
rule byte_re_match_2_internal_b1cadf5c6befa6e94d778272ad272918 {
	meta:
		aliases = "byte_re_match_2_internal"
		size = "6887"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC F4 00 00 00 89 85 58 FF FF FF 89 95 54 FF FF FF 8B 95 58 FF FF FF 8B 00 8D 7C 24 0F 89 85 7C FF FF FF 8B 72 18 03 42 08 46 83 E7 F0 89 8D 50 FF FF FF 8B 4A 14 8B 5D 18 89 45 80 89 4D 88 89 75 8C 89 7D D8 83 7A 18 00 75 41 C7 45 98 00 00 00 00 C7 45 9C 00 00 00 00 C7 45 A0 00 00 00 00 C7 45 A4 00 00 00 00 C7 45 A8 00 00 00 00 C7 45 B0 00 00 00 00 C7 45 B4 00 00 00 00 C7 45 C0 00 00 00 00 C7 45 C4 00 00 00 00 EB 76 8B 55 8C 8D 04 95 10 00 00 00 29 C4 8D 4C 24 0F 29 C4 83 E1 F0 8D 74 24 0F 29 C4 89 4D 98 83 E6 F0 8D 7C 24 0F 29 C4 89 75 9C 83 E7 F0 8D 54 24 0F 29 C4 89 7D }
	condition:
		$pattern
}

rule glob_340ac2265bed518a6c8e53319646eb71 {
	meta:
		aliases = "__GI_glob, glob"
		size = "1298"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC FC 00 00 00 8B 7D 14 83 7D 08 00 74 0D 85 FF 74 09 F7 45 0C 00 81 FF FF 74 13 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 E9 D3 04 00 00 8B 45 0C 83 E0 08 89 85 00 FF FF FF 75 07 C7 47 08 00 00 00 00 6A 2F FF 75 08 E8 ?? ?? ?? ?? 5B 85 C0 5E 89 C6 75 38 F7 45 0C 00 50 00 00 0F 84 C9 00 00 00 8B 55 08 80 3A 7E 0F 85 BD 00 00 00 52 E8 ?? ?? ?? ?? 59 8B 5D 08 89 85 0C FF FF FF C7 85 08 FF FF FF 00 00 00 00 E9 B6 00 00 00 3B 45 08 75 1E 8B 4D 08 BB ?? ?? ?? ?? 41 C7 85 0C FF FF FF 01 00 00 00 89 8D 08 FF FF FF E9 93 00 00 00 2B 45 08 89 85 0C FF FF FF 83 C0 13 83 E0 FC 29 C4 }
	condition:
		$pattern
}

rule pthread_cleanup_upto_725561e1ceafde37740008d513789cc1 {
	meta:
		aliases = "pthread_cleanup_upto"
		size = "141"
		objfiles = "ptlongjmp@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 04 89 C7 BE ?? ?? ?? ?? 89 E8 3B 2D ?? ?? ?? ?? 73 32 3B 2D ?? ?? ?? ?? 72 0D BE ?? ?? ?? ?? 3B 2D ?? ?? ?? ?? 72 1D 83 3D ?? ?? ?? ?? 00 74 09 E8 ?? ?? ?? ?? 89 C6 EB 0B 0D FF FF 1F 00 8D B0 A1 FE FF FF 8B 5E 3C 89 6D F0 EB 12 3B 5D F0 77 04 31 DB EB 12 FF 73 04 FF 13 8B 5B 0C 58 85 DB 74 05 3B 5F 10 72 E5 8B 46 54 89 5E 3C 85 C0 74 0C 3B 47 10 73 07 C7 46 54 00 00 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule pthread_cond_wait_3c58b08ff36ac00b38704e0d724507e4 {
	meta:
		aliases = "__GI_pthread_cond_wait, pthread_cond_wait"
		size = "293"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 0C E8 ?? ?? ?? ?? 8B 75 0C 89 45 F0 8B 46 0C 8B 5D 08 83 F8 03 74 15 85 C0 74 11 8B 45 F0 BA 16 00 00 00 39 46 08 0F 85 E7 00 00 00 8B 45 F0 89 5D E8 C7 45 EC ?? ?? ?? ?? 8D 55 E8 C6 80 41 01 00 00 00 8B 45 F0 E8 ?? ?? ?? ?? 89 D8 8B 55 F0 E8 ?? ?? ?? ?? 8B 45 F0 80 78 42 00 74 0E 8B 45 F0 BF 01 00 00 00 80 78 40 00 74 0D 8B 55 F0 8D 43 08 E8 ?? ?? ?? ?? 31 FF 53 E8 ?? ?? ?? ?? 58 85 FF 74 0C 8B 45 F0 31 D2 E8 ?? ?? ?? ?? EB 64 56 31 DB E8 ?? ?? ?? ?? 58 8B 45 F0 E8 ?? ?? ?? ?? 8B 45 F0 80 B8 41 01 00 00 00 75 18 8B 45 F0 80 B8 40 01 00 00 00 74 09 8B 45 F0 80 78 40 00 }
	condition:
		$pattern
}

rule __getdents64_0466fd4bb168f37e69810b49b95c3f4d {
	meta:
		aliases = "__getdents64"
		size = "264"
		objfiles = "getdents64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 10 8B 55 10 8D 42 12 83 E0 FC 29 C4 8B 45 08 8D 4C 24 0F 83 E1 F0 53 89 C3 B8 DC 00 00 00 CD 80 5B 89 C6 3D 00 F0 FF FF 76 0B E8 ?? ?? ?? ?? F7 DE 89 30 EB 64 83 C8 FF 83 FE FF 0F 84 B7 00 00 00 8B 7D 0C 8D 34 31 01 FA 89 CB C7 45 EC FF FF FF FF C7 45 F0 FF FF FF FF 89 75 E8 89 55 E4 E9 86 00 00 00 0F B7 43 10 8D 48 03 83 E1 FC 8D 34 0F 3B 75 E4 76 28 6A 00 FF 75 F0 FF 75 EC FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 3B 7D 0C 75 65 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 5A 8B 43 08 8B 53 0C 89 45 EC 89 55 F0 8B 03 8B 53 04 89 57 04 89 07 8B 43 08 8B 53 0C 66 89 4F 10 89 47 }
	condition:
		$pattern
}
...
rule __GI_pthread_cond_timedwait_dce3afd1eecb37c0c939e2d3477cea56 {
	meta:
...
rule if_nameindex_4778b618eb7b45a0d0a1923d81399b24 {
	meta:
		aliases = "__GI_if_nameindex, if_nameindex"
		size = "397"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 18 E8 ?? ?? ?? ?? C7 45 E4 00 00 00 00 89 C7 85 C0 0F 88 63 01 00 00 C7 45 F0 00 00 00 00 B9 80 00 00 00 8D 75 EC 8D 1C 09 8D 43 12 83 E0 FC 29 C4 8D 54 24 0F 83 E2 F0 8D 04 1A 3B 45 F0 75 02 01 CB 56 89 55 F0 68 12 89 00 00 89 5D EC 57 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 12 89 F9 87 CB B8 06 00 00 00 CD 80 87 CB E9 CD 00 00 00 8B 45 EC 39 D8 75 04 89 C1 EB AE C1 E8 05 89 45 DC 8D 04 C5 08 00 00 00 50 E8 ?? ?? ?? ?? 5B 89 45 E4 C7 45 E0 00 00 00 00 85 C0 0F 85 AD 00 00 00 89 F9 87 CB B8 06 00 00 00 CD 80 87 CB E8 ?? ?? ?? ?? C7 00 69 00 00 00 E9 BF 00 00 00 8B 5D E0 8B 45 }
	condition:
		$pattern
}
...
rule __GI_nan_fed09e6a9d4061a7077de2b4c6a0b1d3 {
	meta:
...
rule execle_cd8bff838fb271ad8d726d92cc7eab66 {
	meta:
		aliases = "__GI_execle, execle"
		size = "101"
		objfiles = "execle@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 8D 45 10 83 EC 04 31 F6 89 45 F0 8B 55 F0 46 8D 42 04 89 45 F0 83 3A 00 75 F1 8D 04 B5 14 00 00 00 8B 7A 04 29 C4 8B 45 0C 8D 5C 24 0F 83 E3 F0 89 D9 89 03 8D 45 10 89 45 F0 8B 45 F0 83 C1 04 4E 8D 50 04 89 55 F0 8B 00 89 01 75 ED 57 53 FF 75 08 E8 ?? ?? ?? ?? 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __gcov_flush_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gcov_merge_delta, __gnat_default_lock, __gnat_default_unlock, __enable_execute_stack, __gcov_merge_add, __clear_cache, __gcov_merge_single, __gcov_init, __gcov_flush"
		size = "5"
		objfiles = "gthr_gnat@libgcc_eh.a, _enable_execute_stack@libgcc.a, _gcov_merge_delta@libgcov.a, _gcov@libgcov.a, _clear_cache@libgcc.a"
	strings:
...
rule __GI_pthread_setcanceltype_70a6cab8c69bc4c597522c252a43bf1c {
	meta:
...
rule thread_self_4d574e5856a30bb564cca31edbbe6aeb {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "condvar@libpthread.a, mutex@libpthread.a, errno@libpthread.a, pthread@libpthread.a, signals@libpthread.a"
	strings:
...
rule __sigwaitinfo_1303058ecda4e833738dce0b70cef66e {
	meta:
		aliases = "sigwaitinfo, __GI_sigwaitinfo, __sigwaitinfo"
		size = "51"
		objfiles = "__rt_sigwaitinfo@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 31 D2 8B 4C 24 0C BE 08 00 00 00 8B 44 24 08 53 89 C3 B8 B1 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E C3 }
	condition:
		$pattern
}
...
rule tmpfile64_2f0360a177bbce873fa644f0d610843c {
	meta:
		aliases = "tmpfile, tmpfile64"
		size = "131"
		objfiles = "tmpfile@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 00 10 00 00 68 ?? ?? ?? ?? 6A 00 68 FF 0F 00 00 8D 74 24 0D 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 51 68 80 01 00 00 6A 00 56 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 C0 78 3B 56 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 0C 89 C6 85 C0 75 23 89 D9 87 CB B8 06 00 00 00 CD 80 87 CB 89 C3 3D 00 F0 FF FF 76 0D E8 ?? ?? ?? ?? F7 DB 89 18 EB 02 31 F6 89 F0 81 C4 00 10 00 00 5B 5E C3 }
	condition:
		$pattern
}
...
rule login_199d432e282b7b69f79dfffbec35bf7c {
	meta:
		aliases = "login"
		size = "213"
		objfiles = "login@libutil.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC A8 01 00 00 31 DB 89 E0 68 80 01 00 00 FF B4 24 B8 01 00 00 50 E8 ?? ?? ?? ?? 66 C7 44 24 0C 07 00 E8 ?? ?? ?? ?? 89 44 24 10 83 C4 0C 8D B4 24 82 01 00 00 EB 01 43 83 FB 03 74 12 6A 26 56 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 75 EA EB 66 6A 20 68 ?? ?? ?? ?? 8D 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 0C EB 3A 6A 1F 8D 84 24 8B 01 00 00 EB 09 6A 1F 8D 84 24 86 01 00 00 50 8D 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 0C C6 44 24 27 00 E8 ?? ?? ?? ?? 89 E0 50 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 89 E0 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 81 C4 B0 01 00 00 5B 5E C3 6A 05 68 ?? ?? ?? ?? 8D 84 24 8A 01 00 00 50 E8 }
	condition:
		$pattern
}
...
rule __GI_strlcat_e77520ce40bd79195cba68bed02c35e0 {
	meta:
...
rule wcsxfrm_f211e4a066e05580a486727d09d09737 {
	meta:
		aliases = "__wcslcpy, wcsxfrm"
		size = "62"
		objfiles = "wcslcpy@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 44 24 18 8B 4C 24 10 8B 74 24 14 85 C0 8D 58 FF 75 04 31 DB 89 E1 89 F2 EB 0B 85 DB 74 04 4B 83 C1 04 83 C2 04 8B 02 89 01 85 C0 75 ED 29 F2 C1 FA 02 89 D0 5A 5B 5E C3 }
	condition:
		$pattern
}

rule strlcpy_826df2c6b2fa4cf7a82b73280b7d3ba6 {
	meta:
...
rule mq_open_b423c307eed5443673cb359cbc94916c {
	meta:
		aliases = "mq_open"
		size = "97"
		objfiles = "mq_open@librt.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 5C 24 10 8B 4C 24 14 80 3B 2F 74 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 3B F6 C1 40 75 06 31 D2 31 F6 EB 0F 8D 44 24 20 8B 54 24 18 89 04 24 8B 74 24 1C 43 89 D8 53 89 C3 B8 15 01 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 5B 5E C3 }
	condition:
		$pattern
}
...
rule __GI___fputc_unlocked_41f491c81c0dc935d6f1b2b6a74edb56 {
	meta:
		aliases = "__GI_putc_unlocked, putc_unlocked, __GI_fputc_unlocked, __fputc_unlocked, fputc_unlocked, __GI___fputc_unlocked"
		size = "181"
...
rule __error_6562e3650828767a138608a443490d5b {
	meta:
...
rule __GI_xdr_u_hyper_e9b0b31e9d0df81b5b28d2108a87f170 {
	meta:
...
rule __GI_xdr_hyper_930f760b48fbdbd325b0332ef5774201 {
	meta:
...
rule __GI_erand48_r_025b5f87e124ac9e31288a5364b8a061 {
	meta:
		aliases = "erand48_r, __GI_erand48_r"
		size = "131"
		objfiles = "erand48_r@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 8B 74 24 14 FF 74 24 18 56 E8 ?? ?? ?? ?? 5B 5A 83 CA FF 85 C0 78 51 66 8B 5E 02 8B 54 24 04 89 D9 81 E2 FF FF 0F 00 0F B7 46 04 66 C1 E9 0C 81 CA 00 00 F0 3F C1 E0 04 81 E2 00 00 F0 FF 0F B7 C9 C1 E3 14 09 C1 0F B7 06 C1 E0 04 09 CA 09 C3 89 54 24 04 89 1C 24 8B 44 24 1C DD 04 24 DC 25 ?? ?? ?? ?? 31 D2 DD 18 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule tgamma_1e9209e49691011156449984c18dca35 {
	meta:
		aliases = "__GI_tgamma, tgamma"
		size = "161"
		objfiles = "e_lgamma_r@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 0C DD 44 24 18 DD 14 24 8B 44 24 04 8B 34 24 25 FF FF FF 7F 09 F0 75 08 DC 3D ?? ?? ?? ?? EB 77 DD D8 8B 5C 24 04 85 DB 79 30 81 FB FF FF EF FF 77 28 FF 74 24 1C FF 74 24 1C E8 ?? ?? ?? ?? 58 5A DD 44 24 18 D9 C9 DD E9 DF E0 9E 75 0A 7A 08 D9 C0 DE E1 D8 F0 EB 3F DD D8 81 FB 00 00 F0 FF 75 0C 85 F6 75 08 DD 44 24 18 D8 E0 EB 29 8D 44 24 08 50 FF 74 24 20 FF 74 24 20 E8 ?? ?? ?? ?? 83 EC 08 DD 1C 24 E8 ?? ?? ?? ?? 83 C4 14 83 7C 24 08 00 79 02 D9 E0 83 C4 0C 5B 5E C3 }
	condition:
		$pattern
}
...
rule __GI_getutline_830f943b86eb5aafb5dba24710eb5d09 {
	meta:
		aliases = "getutline, __GI_getutline"
		size = "108"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8B 74 24 1C 83 C6 08 EB 1E 8B 03 83 E8 06 66 83 F8 01 77 13 8D 43 08 6A 20 56 50 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 0B E8 ?? ?? ?? ?? 89 C3 85 C0 75 D7 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 89 D8 83 C4 18 5B 5E C3 }
	condition:
		$pattern
}
...
rule __GI_getutent_d76980dfaa1372c8cf8b9a5c6d7da6e0 {
	meta:
...
rule readdir_16604f3b30a15b1c9e405baa62385a50 {
	meta:
		aliases = "__GI_readdir, readdir"
		size = "127"
		objfiles = "readdir@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 74 24 1C 8D 5E 18 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 46 08 3B 46 04 77 22 FF 76 14 FF 76 0C FF 36 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 7F 04 31 DB EB 26 89 46 08 C7 46 04 00 00 00 00 8B 46 04 89 C3 03 5E 0C 0F B7 53 08 01 C2 8B 43 04 89 46 10 89 56 04 83 3B 00 74 BA 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 89 D8 83 C4 18 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_readdir64_0a916aaee655995627b75b8b217838a2 {
	meta:
...
rule __ieee754_log2_5b13e219682ec47fc94ff1283a04e5e2 {
	meta:
...
rule if_indextoname_1a720cd291c7a8bf632be8ac4c593885 {
	meta:
		aliases = "if_indextoname"
		size = "116"
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 20 E8 ?? ?? ?? ?? 89 C3 31 C0 85 DB 78 5C 8B 44 24 2C 89 E6 89 44 24 10 56 68 10 89 00 00 53 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 79 23 E8 ?? ?? ?? ?? 89 D9 89 C6 8B 10 87 CB B8 06 00 00 00 CD 80 87 CB 83 FA 13 75 02 B2 06 31 C0 89 16 EB 1C 89 D9 87 CB B8 06 00 00 00 CD 80 87 CB 6A 10 56 FF 74 24 38 E8 ?? ?? ?? ?? 83 C4 0C 83 C4 20 5B 5E C3 }
	condition:
		$pattern
}
...
rule remquo_089bfafd825f847a9e7810cfd758ba76 {
	meta:
		aliases = "__GI_remquo, remquo"
		size = "124"
		objfiles = "s_remquo@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 28 31 DB DD 44 24 34 8B 74 24 44 DD 5C 24 10 DD 44 24 3C DD 5C 24 08 DD 44 24 10 DD 5C 24 20 DD 44 24 08 8B 54 24 24 DD 5C 24 18 DD 44 24 10 DC 74 24 08 C1 EA 1F 8B 44 24 1C C1 E8 1F 39 C2 0F 94 C3 8D 5C 1B FF DD 1C 24 E8 ?? ?? ?? ?? DD 1C 24 E8 ?? ?? ?? ?? 83 E0 7F 0F AF C3 DD 44 24 08 89 06 DD 5C 24 3C DD 44 24 10 DD 5C 24 34 83 C4 28 5B 5E E9 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule __GI_pmap_set_95d26b2da0093335d0fe5b77f3ee3ff5 {
	meta:
...
rule __pthread_timedsuspend_new_a52ee96851b14b8f6d036819cd21752b {
	meta:
		aliases = "__pthread_timedsuspend_new"
		size = "223"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 44 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 5A 85 C0 59 BA 01 00 00 00 0F 85 AC 00 00 00 8B 54 24 50 C7 44 24 3C 00 00 00 00 C7 44 24 40 00 00 00 00 89 62 24 C7 42 20 00 00 00 00 FF 35 ?? ?? ?? ?? 8D 5C 24 40 53 E8 ?? ?? ?? ?? 8D 44 24 3C 50 53 6A 01 E8 ?? ?? ?? ?? 83 C4 14 8D 74 24 2C 8D 5C 24 24 6A 00 56 E8 ?? ?? ?? ?? 8B 4C 24 5C 69 44 24 38 E8 03 00 00 8B 51 04 8B 09 2B 4C 24 34 29 C2 89 54 24 30 89 4C 24 2C 85 D2 58 58 79 11 8D 82 00 CA 9A 3B 89 44 24 28 8D 41 FF 89 44 24 24 83 7C 24 24 00 78 0E 6A 00 53 E8 ?? ?? ?? ?? 5A 85 C0 59 75 AD 6A 00 8D 44 24 38 50 6A 02 E8 ?? ?? ?? ?? 31 }
	condition:
		$pattern
}
...
rule __ieee754_asin_9d74f299d8479d4cae56f1700fea2ed2 {
	meta:
...
rule __GI_vsscanf_9240f7af54297a0d0fd33902671ed431 {
	meta:
...
rule opendir_e0242ccec63dc752dc9a1f65d9df41cc {
	meta:
		aliases = "__GI_opendir, opendir"
		size = "145"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 58 B9 00 08 09 00 8B 54 24 64 87 D3 B8 05 00 00 00 CD 80 87 D3 89 C3 3D 00 F0 FF FF 76 0D E8 ?? ?? ?? ?? 31 F6 F7 DB 89 18 EB 5A 31 F6 85 C0 78 54 89 E0 50 53 E8 ?? ?? ?? ?? 5A 85 C0 59 79 0F 89 D9 87 CB B8 06 00 00 00 CD 80 87 CB EB 36 6A 01 6A 02 53 E8 ?? ?? ?? ?? 8B 54 24 3C 89 D8 E8 ?? ?? ?? ?? 83 C4 0C 89 C6 85 C0 75 18 89 D9 87 CB B8 06 00 00 00 CD 80 87 CB E8 ?? ?? ?? ?? C7 00 0C 00 00 00 89 F0 83 C4 58 5B 5E C3 }
	condition:
		$pattern
}
...
rule timer_settime_a0711f6c530ad450139d75a08f35368b {
	meta:
		aliases = "timer_settime"
		size = "59"
		objfiles = "timer_settime@librt.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 44 24 0C 8B 4C 24 10 8B 54 24 14 8B 74 24 18 8B 58 04 89 D8 53 89 C3 B8 04 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5B 5E C3 }
	condition:
		$pattern
}

rule svctcp_reply_16862abef5eaefa2100fd88c4c90b064 {
	meta:
...
rule __GI_xdr_opaque_b6f75567a786ff983aea663dd374131a {
	meta:
...
rule __new_sem_trywait_59cef6584b02cb12564256eed60f3f51 {
	meta:
...
rule __GI_pthread_cond_broadcast_34019ced877585a2dd97b221ca5af6ce {
	meta:
...
rule __GI_globfree_d09646c5e5e6c3de32d478579a0abfb1 {
	meta:
		aliases = "__GI_globfree64, globfree64, globfree, __GI_globfree"
		size = "62"
...
rule __GI_fputws_unlocked_22452fc7191c0337d631cae0b3003579 {
	meta:
...
rule __GI_fputs_unlocked_6c27d0b1c060474f29b51d07a62f636d {
	meta:
...
rule __GI_herror_91d6ff531193ef6636da77e84ad1a347 {
	meta:
...
rule __GI_strcasecmp_997e19f7900621e7ef85dde3656dd031 {
	meta:
...
rule __GI_mknod_f1bc454f7923b9b594a6631c5d06cdd1 {
	meta:
		aliases = "mknod, __GI_mknod"
		size = "52"
		objfiles = "mknod@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 5C 24 14 8B 4C 24 10 8B 44 24 0C 89 DA 53 89 C3 B8 0E 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5B 5E C3 }
	condition:
		$pattern
}

rule __GI_mempcpy_d55dad00779bc58ccec8cb071e35db2a {
	meta:
...
rule __GI_fgetgrent_r_867a2d8b3238f5fbc1223b818c9f02c6 {
	meta:
		aliases = "__GI_fgetspent_r, fgetgrent_r, fgetpwent_r, __GI_fgetpwent_r, fgetspent_r, __GI_fgetgrent_r"
		size = "51"
...
rule __GI_if_freenameindex_52ba2b48f7df19dd3d027d48d955a36f {
	meta:
...
rule __GI_xdr_opaque_auth_b726b971aec95691b1dd8900c5945d0a {
	meta:
...
rule __GI_xdr_accepted_reply_33b8ebead507298afc1d3cbaf456dd9b {
	meta:
...
rule __libc_longjmp_7d28f6943d4fb5439b29a882aee6266a {
	meta:
		aliases = "siglongjmp, __libc_siglongjmp, longjmp, _longjmp, __libc_longjmp"
		size = "45"
...
rule _dl_protect_relro_5bb7877e3ff8d2681c025a428a8105c1 {
	meta:
		aliases = "_dl_protect_relro"
		size = "130"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8B 74 24 0C A1 ?? ?? ?? ?? F7 D8 8B 16 89 C3 03 96 D4 00 00 00 89 D1 21 D3 03 8E D8 00 00 00 21 C1 39 CB 74 58 29 D9 BA 01 00 00 00 89 D8 53 89 C3 B8 7D 00 00 00 CD 80 5B 89 C2 3D 00 F0 FF FF 76 0A F7 DA 89 15 ?? ?? ?? ?? EB 04 85 C0 79 2D FF 76 04 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 31 C9 87 CB B8 01 00 00 00 CD 80 87 CB 83 C4 0C 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 5B 5E C3 }
	condition:
		$pattern
}
...
rule res_sync_func_1ed1059132357fb1ed575898c78321c0 {
	meta:
		aliases = "res_sync_func"
		size = "104"
		objfiles = "res_init@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 E8 ?? ?? ?? ?? 81 3D ?? ?? ?? ?? ?? ?? ?? ?? 89 C6 74 34 0F B6 40 60 39 05 ?? ?? ?? ?? 76 05 A3 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? EB 18 6B C3 1C 6A 1C 03 05 ?? ?? ?? ?? FF 74 9E 54 50 E8 ?? ?? ?? ?? 83 C4 0C 4B 79 E5 8A 46 52 84 C0 75 02 B0 05 A2 ?? ?? ?? ?? 8A 46 53 84 C0 75 02 B0 03 5B A2 ?? ?? ?? ?? 5E C3 }
	condition:
		$pattern
}
...
rule __pthread_attr_setguardsize_702c56952c75c89a27e92a4a12bae9aa {
	meta:
...
rule fstatat_7d2d42ed1833cdc44e18e22f66bbd35b {
	meta:
		aliases = "fstatat64, fstatat"
		size = "75"
		objfiles = "fstatat@libc.a, fstatat64@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 83 EC 60 89 E2 8B 4C 24 6C 8B 74 24 74 8B 44 24 68 53 89 C3 B8 2C 01 00 00 CD 80 5B 89 C6 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DE 89 30 83 CE FF EB 10 85 C0 75 0C FF 74 24 70 52 E8 ?? ?? ?? ?? 58 5A 89 F0 83 C4 60 5E C3 }
	condition:
		$pattern
}
...
rule __libc_epoll_wait_df17beacf0c6845a788be755f4e427ae {
	meta:
...
rule __GI_openat_030ca9b09b5ea7191da5c1cbc3acbeb9 {
	meta:
...
rule __GI_utimensat_93d0c1df6f50a326cc0dc75fead94208 {
	meta:
...
rule __GI_wait4_3b1bf2ca56e739f2e687abd620b45896 {
	meta:
...
rule signalfd_f855d4b4e7b6986bc2f2b323a315e174 {
	meta:
		aliases = "signalfd"
		size = "53"
		objfiles = "signalfd@libc.a"
	strings:
		$pattern = { ( CC | 56 ) BA 08 00 00 00 8B 4C 24 0C 8B 74 24 10 8B 44 24 08 53 89 C3 B8 47 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E C3 }
	condition:
		$pattern
}

rule sigprocmask_f728ab3da42a3e78a7f5cd79500cdcab {
	meta:
		aliases = "__GI_sigprocmask, sigprocmask"
		size = "53"
		objfiles = "sigprocmask@libc.a"
	strings:
		$pattern = { ( CC | 56 ) BE 08 00 00 00 8B 4C 24 0C 8B 54 24 10 8B 44 24 08 53 89 C3 B8 AF 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E C3 }
	condition:
		$pattern
}

rule sigtimedwait_11b3785dea75a7f3c9c9daf86e34a44f {
	meta:
		aliases = "__GI_sigtimedwait, __sigtimedwait, sigtimedwait"
		size = "53"
		objfiles = "__rt_sigtimedwait@libc.a"
	strings:
		$pattern = { ( CC | 56 ) BE 08 00 00 00 8B 4C 24 0C 8B 54 24 10 8B 44 24 08 53 89 C3 B8 B1 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E C3 }
	condition:
		$pattern
}

rule __GI_svc_getreq_b4743976051df278452203c4470ffc26 {
	meta:
...
rule ctime_e1d3fa3a272ae009875e003df9e3c605 {
	meta:
		aliases = "__GI_ctime, ctime"
		size = "40"
		objfiles = "ctime@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 83 EC 30 B9 0B 00 00 00 8D 54 24 04 89 D7 F3 AB 52 FF 74 24 3C E8 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 3C 5F C3 }
	condition:
		$pattern
}

rule logout_be46779af5b8174d5bd5a4e99e705a64 {
	meta:
		aliases = "logout"
		size = "134"
		objfiles = "logout@libutil.a"
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 80 01 00 00 E8 ?? ?? ?? ?? 66 C7 04 24 07 00 6A 20 FF B4 24 90 01 00 00 8D 5C 24 08 8D 44 24 10 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 74 3B 31 C0 B9 08 00 00 00 8D 7B 2C F3 AB B9 40 00 00 00 8D 7B 4C F3 AB 8D 83 54 01 00 00 6A 00 50 E8 ?? ?? ?? ?? 66 C7 03 08 00 53 E8 ?? ?? ?? ?? BB 01 00 00 00 83 C4 0C 85 C0 75 02 31 DB E8 ?? ?? ?? ?? 89 D8 81 C4 80 01 00 00 5B 5F C3 }
	condition:
		$pattern
}

rule sigqueue_c15808aca87ff70f66f1fb0447f3069e {
	meta:
		aliases = "sigqueue"
		size = "129"
		objfiles = "sigqueue@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 84 00 00 00 31 C0 B9 20 00 00 00 8D 5C 24 04 89 DF F3 AB 8B 84 24 94 00 00 00 C7 44 24 0C FF FF FF FF 89 44 24 04 E8 ?? ?? ?? ?? 89 44 24 10 E8 ?? ?? ?? ?? 89 44 24 14 8B 84 24 98 00 00 00 89 44 24 18 8B 8C 24 94 00 00 00 8B 84 24 90 00 00 00 89 DA 53 89 C3 B8 B2 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 81 C4 84 00 00 00 5B 5F C3 }
	condition:
		$pattern
}

rule __xstat_conv_8fa6393cf6d540f3eee24c90df4c65d0 {
	meta:
		aliases = "__xstat_conv"
		size = "141"
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 04 31 C0 B9 16 00 00 00 8B 5C 24 14 8B 54 24 10 89 DF F3 AB 8B 02 C7 43 04 00 00 00 00 89 03 8B 42 04 89 43 0C C7 43 24 00 00 00 00 0F B7 42 08 89 43 10 0F B7 42 0A 89 43 14 0F B7 42 0C 89 43 18 0F B7 42 0E 89 43 1C 0F B7 42 10 89 43 20 8B 42 14 89 43 2C 8B 42 18 89 43 30 8B 42 1C 89 43 34 8B 42 24 8B 4A 20 89 43 3C 89 4B 38 8B 42 2C 8B 4A 28 89 43 44 89 4B 40 8B 42 34 8B 4A 30 89 43 4C 89 4B 48 5A 5B 5F C3 }
	condition:
		$pattern
}
...
rule gethostid_12b4210a63bf6ddb6e75bce58356579a {
	meta:
		aliases = "gethostid"
		size = "214"
		objfiles = "hostid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 70 BA ?? ?? ?? ?? 31 C9 C7 44 24 6C 00 00 00 00 87 D3 B8 05 00 00 00 CD 80 87 D3 89 C7 3D 00 F0 FF FF 76 0B E8 ?? ?? ?? ?? F7 DF 89 38 EB 40 85 C0 78 3C 8D 4C 24 6C BA 04 00 00 00 53 89 C3 B8 03 00 00 00 CD 80 5B 89 C3 89 C2 3D 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? 83 CA FF F7 DB 89 18 89 F9 87 CB B8 06 00 00 00 CD 80 87 CB 85 D2 7F 59 6A 40 8D 5C 24 0B 53 E8 ?? ?? ?? ?? 5A 85 C0 59 78 47 80 7C 24 07 00 74 40 8D 54 24 48 31 C0 B9 08 00 00 00 89 D7 F3 AB 8D 44 24 68 50 52 6A 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 1C 8B 54 24 68 85 D2 74 0D 8B 42 14 8B 40 04 C1 C8 10 89 44 24 6C 52 E8 ?? }
	condition:
		$pattern
}
...
rule __xstat32_conv_a09c7dfdd90ec863e0bb242784ce6ec8 {
	meta:
		aliases = "__xstat32_conv"
		size = "138"
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 C0 83 EC 04 B9 16 00 00 00 8B 74 24 18 8B 5C 24 14 89 F7 F3 AB 8B 03 8B 53 04 89 56 04 89 06 8B 43 58 C7 46 24 00 00 00 00 89 46 0C 8B 43 10 89 46 10 8B 43 14 89 46 14 8B 43 18 89 46 18 8B 43 1C 89 46 1C 0F B7 43 20 89 46 20 8B 43 2C 89 46 2C 8B 43 34 89 46 30 8B 43 38 89 46 34 8B 53 40 8B 43 44 89 46 3C 89 56 38 8B 53 48 8B 43 4C 89 46 44 89 56 40 8B 53 50 8B 43 54 89 46 4C 89 56 48 59 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __xstat64_conv_ede882036ac11a697b28011cff1a6f06 {
	meta:
		aliases = "__xstat64_conv"
		size = "163"
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 C0 83 EC 04 B9 18 00 00 00 8B 74 24 18 8B 5C 24 14 89 F7 F3 AB 8B 03 8B 53 04 89 56 04 89 06 8B 43 58 8B 53 5C 89 46 58 8B 43 0C 89 46 0C 8B 43 10 89 46 10 89 56 5C 8B 43 14 C7 46 24 00 00 00 00 89 46 14 8B 43 18 89 46 18 8B 43 1C 89 46 1C 0F B7 43 20 89 46 20 8B 43 2C 8B 53 30 89 46 2C 8B 43 34 89 46 34 89 56 30 8B 43 38 8B 53 40 89 46 38 8B 43 44 89 46 44 C7 46 3C 00 00 00 00 89 56 40 8B 53 48 8B 43 4C 89 56 48 89 46 4C 8B 53 50 8B 43 54 89 56 50 89 46 54 58 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule pathconf_cd08d20ed4b7cd26de819f635b661d98 {
	meta:
		aliases = "pathconf"
		size = "205"
		objfiles = "pathconf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 81 EC 98 00 00 00 8B B4 24 A8 00 00 00 8B 84 24 AC 00 00 00 80 3E 00 75 10 E8 ?? ?? ?? ?? C7 00 02 00 00 00 E9 86 00 00 00 83 F8 13 77 11 FF 24 85 ?? ?? ?? ?? B8 20 00 00 00 E9 81 00 00 00 E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 63 B8 7F 00 00 00 EB 6D E8 ?? ?? ?? ?? 89 C3 8B 38 8D 44 24 58 50 56 E8 ?? ?? ?? ?? 5E 85 C0 5A 79 09 83 3B 26 75 3D 89 3B EB 32 8B 44 24 7C EB 44 31 C0 EB 40 89 E0 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 78 20 8B 44 24 10 25 00 F0 00 00 3D 00 80 00 00 74 1C 3D 00 60 00 00 75 09 EB 13 B8 FF 00 00 00 EB 11 83 C8 FF EB 0C B8 00 10 00 00 EB 05 B8 01 00 00 00 81 C4 98 00 00 }
	condition:
		$pattern
}

rule fpathconf_f5f1e60274861d73a7b6c1bb1c53eb18 {
	meta:
		aliases = "fpathconf"
		size = "210"
		objfiles = "fpathconf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 81 EC 98 00 00 00 8B B4 24 A8 00 00 00 8B 94 24 AC 00 00 00 85 F6 79 10 E8 ?? ?? ?? ?? C7 00 09 00 00 00 E9 8C 00 00 00 B8 7F 00 00 00 85 D2 0F 84 90 00 00 00 8D 42 FF 83 F8 12 77 0E FF 24 85 ?? ?? ?? ?? B8 20 00 00 00 EB 7A E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 5C E8 ?? ?? ?? ?? 89 C3 8B 38 8D 44 24 58 50 56 E8 ?? ?? ?? ?? 5E 85 C0 5A 79 09 83 3B 26 75 3D 89 3B EB 32 8B 44 24 7C EB 44 31 C0 EB 40 89 E0 50 56 E8 ?? ?? ?? ?? 5A 85 C0 59 78 20 8B 44 24 10 25 00 F0 00 00 3D 00 80 00 00 74 1C 3D 00 60 00 00 75 09 EB 13 B8 FF 00 00 00 EB 11 83 C8 FF EB 0C B8 00 10 00 00 EB 05 B8 01 00 00 00 }
	condition:
		$pattern
}
...
rule nprocessors_onln_7cf9e2871f5040f231faeb2a7b985467 {
	meta:
		aliases = "nprocessors_onln"
		size = "196"
		objfiles = "sysconf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 04 C7 04 24 00 00 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5F 89 C6 85 C0 74 4C 31 DB 89 E7 EB 2C 8B 04 24 8B 00 80 38 63 75 22 80 78 01 70 75 1C 80 78 02 75 75 16 0F B6 50 03 A1 ?? ?? ?? ?? 0F B7 04 50 83 E0 08 83 F8 01 83 DB FF 68 ?? ?? ?? ?? 68 02 01 00 00 57 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 BC EB 46 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5B 89 C6 31 DB 89 E7 85 C0 75 19 EB 2F 8B 04 24 FF 30 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 F8 01 5A 83 D3 00 59 68 ?? ?? ?? ?? 68 02 02 07 00 57 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 D1 56 E8 ?? ?? ?? ?? 59 85 DB 75 02 B3 01 89 D8 5A 5B 5E 5F C3 }
	condition:
		$pattern
}

rule setusershell_347169a80f0c48cc01cedd590e53435e {
	meta:
		aliases = "setusershell"
		size = "168"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 04 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5E A3 ?? ?? ?? ?? 85 C0 75 0C C7 05 ?? ?? ?? ?? ?? ?? ?? ?? EB 78 31 F6 89 E7 C7 04 24 00 00 00 00 EB 44 8D 1C B5 00 00 00 00 46 8D 43 08 50 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? A3 ?? ?? ?? ?? 8D 1C 18 8B 44 24 08 89 1D ?? ?? ?? ?? FF 30 E8 ?? ?? ?? ?? C7 43 04 00 00 00 00 89 03 8D 43 04 A3 ?? ?? ?? ?? 83 C4 0C 68 ?? ?? ?? ?? 68 01 01 07 00 57 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 9F A1 ?? ?? ?? ?? A3 ?? ?? ?? ?? 5B 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule dlsym_9f33bb77123ad842494656cf30888479 {
	meta:
		aliases = "dlsym"
		size = "179"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 08 8B 4C 24 18 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 85 C9 75 08 8B 15 ?? ?? ?? ?? EB 58 89 CA 83 F9 FF 74 26 3B 0D ?? ?? ?? ?? 74 49 A1 ?? ?? ?? ?? EB 07 39 C8 74 3E 8B 40 04 85 C0 75 F5 C7 05 ?? ?? ?? ?? 0A 00 00 00 EB 5B 8B 7C 24 14 A1 ?? ?? ?? ?? 31 F6 EB 1A 8B 18 8B 4B 14 39 F9 73 0E 85 F6 74 05 39 4E 14 73 05 8B 50 10 89 DE 8B 40 10 85 C0 75 E2 31 C9 3B 15 ?? ?? ?? ?? 75 02 8B 0A 89 E0 50 68 00 00 00 80 51 52 FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 14 85 C0 75 0A C7 05 ?? ?? ?? ?? 0B 00 00 00 5A 59 5B 5E 5F C3 }
	condition:
		$pattern
}

rule ptrace_fb8f07e2e90b28ffcdceceea012ab44c {
	meta:
		aliases = "ptrace"
		size = "113"
		objfiles = "ptrace@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 08 8B 7C 24 18 8D 44 24 28 89 04 24 8B 5C 24 1C 8D 47 FF 8B 54 24 20 8B 74 24 24 83 F8 02 77 04 8D 74 24 04 89 F8 89 D9 53 89 C3 B8 1A 00 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 0E E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF EB 1C 85 C0 78 18 85 FF 74 14 83 FF 03 77 0F E8 ?? ?? ?? ?? C7 00 00 00 00 00 8B 44 24 04 5A 59 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule gets_623e30a86d0607399ae4cce5fa988c2d {
	meta:
		aliases = "gets"
		size = "127"
		objfiles = "gets@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 15 ?? ?? ?? ?? 8B 74 24 20 83 7A 34 00 0F 94 C0 0F B6 F8 85 FF 75 04 89 F3 EB 27 8D 42 38 50 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C0 38 50 E8 ?? ?? ?? ?? 83 C4 10 EB D6 43 E8 ?? ?? ?? ?? 83 F8 FF 74 0A 88 03 3C 0A 75 EF 39 DE 75 04 31 F6 EB 03 C6 03 00 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}

rule puts_2fde4e2ebf96a52abee233680c966dce {
	meta:
		aliases = "puts"
		size = "119"
		objfiles = "puts@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 35 ?? ?? ?? ?? 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 FF 74 24 24 E8 ?? ?? ?? ?? 89 C3 58 83 FB FF 5A 74 13 56 6A 0A E8 ?? ?? ?? ?? 59 40 5E 75 05 83 CB FF EB 01 43 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_localtime_r_f4c63ef00ec0cfd45ad701c063a0b253 {
	meta:
...
rule vfwprintf_5c40da0d49fbd52377f7c8aeef889447 {
	meta:
		aliases = "__GI_vfwprintf, vfwprintf"
		size = "133"
		objfiles = "vfwprintf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 40 08 00 00 3D 40 08 00 00 74 14 68 00 08 00 00 56 E8 ?? ?? ?? ?? 59 5B 83 CB FF 85 C0 75 13 FF 74 24 28 FF 74 24 28 56 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule vfprintf_e4b626a9f9b762e08bdbb918f0fefaf7 {
	meta:
		aliases = "__GI_vfprintf, vfprintf"
		size = "133"
		objfiles = "vfprintf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 C0 00 00 00 3D C0 00 00 00 74 14 68 80 00 00 00 56 E8 ?? ?? ?? ?? 59 5B 83 CB FF 85 C0 75 13 FF 74 24 28 FF 74 24 28 56 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule fileno_0a75ddc87c4aea60d140217f8ec57027 {
	meta:
		aliases = "getwc, __GI_fileno, fgetwc, __GI_fgetwc, fileno"
		size = "88"
		objfiles = "fgetwc@libc.a, fileno@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 E8 ?? ?? ?? ?? 59 89 C3 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_rewind_b3b64a9ac4c12b1df60e8532c2dd5150 {
	meta:
...
rule feof_f05fdc17531163f0b184f9bf16f6c013 {
	meta:
		aliases = "feof"
		size = "84"
		objfiles = "feof@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 1E 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 10 83 E0 04 5B 5E 5F C3 }
	condition:
		$pattern
}

rule ferror_374408bf5f74500721f91c1b47a18daa {
	meta:
		aliases = "ferror"
		size = "84"
		objfiles = "ferror@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8B 1E 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 89 D8 83 C4 10 83 E0 08 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_fflush_dce87e25b18f5e48493a12096baf9b8b {
	meta:
		aliases = "fflush, __GI_fflush"
		size = "111"
		objfiles = "fflush@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 85 F6 74 4F 81 FE ?? ?? ?? ?? 74 47 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 E8 ?? ?? ?? ?? 5E 89 C3 85 FF 74 19 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 5A 59 EB 09 56 E8 ?? ?? ?? ?? 89 C3 58 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule putwc_86b4d74f9690b5f44470619e581c4d7e {
	meta:
		aliases = "fputs, fputwc, __GI_fputs, __GI_fputws, fputws, putwc"
		size = "93"
		objfiles = "fputs@libc.a, fputwc@libc.a, fputws@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 24 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 FF 74 24 24 E8 ?? ?? ?? ?? 59 89 C3 5E 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule fgetws_304b1b2126f2cca456100d94eda2de43 {
	meta:
		aliases = "__GI_fgets, fgets, fgetws"
		size = "98"
		objfiles = "fgetws@libc.a, fgets@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 28 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 FF 74 24 28 FF 74 24 28 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule fread_85c852565cd287354c8d6fba48cb7fae {
	meta:
		aliases = "__GI_fread, fwrite, __GI_fwrite, fread"
		size = "102"
		objfiles = "fwrite@libc.a, fread@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 2C 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 56 FF 74 24 2C FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_getpwent_r_343fc5878297abdfbd7a84dc38cc5e15 {
	meta:
		aliases = "__GI_getspent_r, getgrent_r, getspent_r, __GI_getgrent_r, getpwent_r, __GI_getpwent_r"
		size = "161"
		objfiles = "getgrent_r@libc.a, getpwent_r@libc.a, getspent_r@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 2C 8B 7C 24 20 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 C7 06 00 00 00 00 83 3D ?? ?? ?? ?? 00 75 2A 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 59 85 C0 75 09 E8 ?? ?? ?? ?? 8B 18 EB 2B C7 40 34 01 00 00 00 FF 35 ?? ?? ?? ?? FF 74 24 2C FF 74 24 2C 57 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 14 89 C3 85 C0 75 02 89 3E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 83 C4 18 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_closedir_d1f4d87f6ac77564842c6a6d983c3bc5 {
	meta:
...
rule __GI_round_f04424362a462e0764dacee0e6a4b163 {
	meta:
...
rule ftello64_10ea365dc4707ab0fe45bfbf23541580 {
	meta:
		aliases = "__GI_ftello64, ftello64"
		size = "169"
		objfiles = "ftello64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 18 8B 74 24 28 C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 83 7E 34 00 0F 94 C0 0F B6 F8 85 FF 74 1C 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 08 50 E8 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 25 40 04 00 00 3D 40 04 00 00 0F 94 C0 0F B6 C0 40 50 8D 5C 24 14 53 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 78 0D 53 56 E8 ?? ?? ?? ?? 59 85 C0 5B 79 10 C7 44 24 10 FF FF FF FF C7 44 24 14 FF FF FF FF 85 FF 74 0E 6A 01 8D 44 24 04 50 E8 ?? ?? ?? ?? 58 5A 8B 44 24 10 8B 54 24 14 83 C4 18 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_modf_116c15eec3382d0a00ac1bee1e8dd962 {
	meta:
		aliases = "modf, __GI_modf"
		size = "398"
		objfiles = "s_modf@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 38 DD 44 24 48 C7 44 24 28 00 00 00 00 C7 44 24 2C 00 00 00 00 DD 5C 24 30 8B 54 24 34 C7 44 24 20 00 00 00 00 89 D0 C7 44 24 24 00 00 00 00 C1 F8 14 C7 44 24 18 00 00 00 00 25 FF 07 00 00 C7 44 24 1C 00 00 00 00 C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 8D 88 01 FC FF FF C7 44 24 08 00 00 00 00 C7 44 24 0C 00 00 00 00 C7 04 24 00 00 00 00 C7 44 24 04 00 00 00 00 8B 7C 24 50 8B 74 24 30 83 F9 13 7F 73 85 C9 79 1D 81 E2 00 00 00 80 C7 44 24 28 00 00 00 00 89 54 24 2C DD 44 24 28 DD 1F E9 D4 00 00 00 BB FF FF 0F 00 D3 FB 89 D8 21 D0 09 F0 75 21 DD 44 24 48 81 E2 00 00 00 80 }
	condition:
		$pattern
}

rule timer_create_83a9c09f1bd77fae2c53310ebbd19e4c {
	meta:
		aliases = "timer_create"
		size = "145"
		objfiles = "timer_create@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 44 8B 74 24 58 85 F6 75 12 C7 44 24 08 00 00 00 00 C7 44 24 04 0E 00 00 00 89 E6 83 7E 08 02 74 61 6A 08 E8 ?? ?? ?? ?? 59 89 C7 85 C0 74 53 89 04 24 8D 54 24 40 8B 44 24 54 89 F1 53 89 C3 B8 03 01 00 00 CD 80 5B 89 C3 3D 00 F0 FF FF 76 0B E8 ?? ?? ?? ?? F7 DB 89 18 EB 1B 83 F8 FF 74 16 8B 46 08 89 07 8B 44 24 40 89 47 04 8B 44 24 5C 89 38 89 D8 EB 0F 57 E8 ?? ?? ?? ?? 83 C8 FF 5A EB 03 83 C8 FF 83 C4 44 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule fd_to_DIR_9d46d67d300cf393d43ef17ece84dfeb {
	meta:
		aliases = "fd_to_DIR"
		size = "136"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 89 C7 83 EC 18 89 D3 6A 30 E8 ?? ?? ?? ?? 5E 31 F6 85 C0 74 67 89 C6 89 38 C7 40 10 00 00 00 00 C7 40 08 00 00 00 00 C7 40 04 00 00 00 00 89 58 14 81 FB FF 01 00 00 77 07 C7 40 14 00 02 00 00 FF 76 14 6A 01 E8 ?? ?? ?? ?? 89 46 0C 85 C0 5A 59 75 0B 56 E8 ?? ?? ?? ?? 31 F6 58 EB 1E 89 E3 6A 18 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 8D 46 18 6A 18 53 50 E8 ?? ?? ?? ?? 83 C4 18 83 C4 18 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule confstr_57942dae054069a51b34275eed576c52 {
	meta:
		aliases = "confstr"
		size = "110"
		objfiles = "confstr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 44 24 10 8B 7C 24 14 8B 74 24 18 85 C0 74 07 83 F8 03 75 0E EB 1B BA ?? ?? ?? ?? BB 0E 00 00 00 EB 19 E8 ?? ?? ?? ?? 31 DB C7 00 16 00 00 00 EB 33 BA ?? ?? ?? ?? BB 12 00 00 00 85 F6 74 25 85 FF 74 21 39 F3 77 0A 53 52 57 E8 ?? ?? ?? ?? EB 10 8D 46 FF 50 52 57 E8 ?? ?? ?? ?? C6 44 37 FF 00 83 C4 0C 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_lfind_5c53dcd5ed447aa0b659ea34bbd13b72 {
	meta:
...
rule _dl_add_elf_hash_table_57353d7fec4b5c57e0bcea392488268e {
	meta:
		aliases = "_dl_add_elf_hash_table"
		size = "169"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 14 8B 7C 24 18 68 E8 00 00 00 E8 ?? ?? ?? ?? BA E8 00 00 00 89 C3 59 EB 04 C6 00 00 40 4A 83 FA FF 75 F6 A1 ?? ?? ?? ?? 85 C0 75 0A 89 1D ?? ?? ?? ?? EB 0F 89 D0 8B 50 0C 85 D2 75 F7 89 58 0C 89 43 10 FF 74 24 10 C7 43 0C 00 00 00 00 66 C7 43 22 00 00 E8 ?? ?? ?? ?? 8B 4F 10 89 43 04 8B 44 24 20 89 43 08 C7 43 18 03 00 00 00 58 85 C9 74 17 8B 01 89 43 28 8B 51 04 89 53 38 8D 51 08 89 53 2C 8D 04 82 89 43 3C 89 33 89 73 14 31 D2 8B 04 97 89 44 93 40 42 83 FA 22 7E F3 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule _obstack_begin_869b93e4ba899259956efc70d178f7c5 {
	meta:
		aliases = "_obstack_begin"
		size = "135"
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 18 8B 5C 24 10 8B 54 24 14 8B 4C 24 1C 85 F6 75 04 66 BE 04 00 85 D2 75 04 66 BA E0 0F 8B 44 24 20 8D 7E FF 80 63 28 FE 89 4B 1C 89 43 20 89 13 89 7B 18 F6 43 28 01 74 0B 52 FF 73 24 FF D1 59 89 C2 EB 05 52 FF D1 89 C2 58 85 D2 89 53 04 75 05 E8 ?? ?? ?? ?? 8D 44 3A 08 C7 42 04 00 00 00 00 F7 DE 21 F0 89 43 08 89 43 0C 89 D0 03 03 89 02 89 43 10 80 63 28 F9 B8 01 00 00 00 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_strdup_7588b256d955dafd8fb4e8c4edccc671 {
	meta:
...
rule __GI_strndup_6d589c13153fd3a2261cf42cfa9029a0 {
	meta:
...
rule ___path_search_b0c9929b9e1b98ad26d7e74429ebe7af {
	meta:
		aliases = "___path_search"
		size = "188"
		objfiles = "tempname@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 7C 24 1C 8B 5C 24 18 85 FF 74 1A 80 3F 00 74 15 57 E8 ?? ?? ?? ?? 59 89 C6 83 F8 05 7E 11 BE 05 00 00 00 EB 0A BF ?? ?? ?? ?? BE 04 00 00 00 85 DB 75 38 B8 ?? ?? ?? ?? BB ?? ?? ?? ?? E8 ?? ?? ?? ?? 85 C0 75 25 53 53 E8 ?? ?? ?? ?? 59 85 C0 5A 74 0B 89 D8 E8 ?? ?? ?? ?? 85 C0 75 0D E8 ?? ?? ?? ?? C7 00 02 00 00 00 EB 2D 53 E8 ?? ?? ?? ?? 5A 89 C2 EB 01 4A 83 FA 01 7E 07 80 7C 1A FF 2F 74 F3 8D 44 16 08 39 44 24 14 73 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 17 57 56 53 52 68 ?? ?? ?? ?? FF 74 24 24 E8 ?? ?? ?? ?? 31 C0 83 C4 18 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_seed48_r_88b76737e28130625373c731b2b859e4 {
	meta:
		aliases = "seed48_r, __GI_seed48_r"
		size = "75"
		objfiles = "seed48_r@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 4C 24 14 8B 54 24 10 89 CE 8D 79 06 A5 66 A5 66 8B 42 04 C7 41 10 6D E6 EC DE 66 89 41 04 C7 41 14 05 00 00 00 66 8B 42 02 66 89 41 02 66 8B 02 66 C7 41 0C 0B 00 66 89 01 66 C7 41 0E 01 00 31 C0 5A 5E 5F C3 }
	condition:
		$pattern
}

rule __libc_epoll_pwait_e53bdc1790003cd822166f828b19fcf1 {
	meta:
...
rule __GI_sigaction_8e9aa0c9dcdfe59bad990e54a7c9a7b5 {
	meta:
...
rule fstatfs64_095fbf9f6896701eec527ee6f92d8102 {
	meta:
		aliases = "__GI_fstatfs64, statfs64, __GI_statfs64, fstatfs64"
		size = "155"
		objfiles = "statfs64@libc.a, fstatfs64@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 40 89 E0 8B 7C 24 50 50 FF 74 24 50 E8 ?? ?? ?? ?? 5A 83 CA FF 59 85 C0 78 75 8B 04 24 C7 47 0C 00 00 00 00 89 07 C7 47 14 00 00 00 00 8B 44 24 04 C7 47 1C 00 00 00 00 89 47 04 8B 44 24 08 89 47 08 8B 44 24 0C 89 47 10 8B 44 24 10 89 47 18 8B 44 24 14 89 47 20 8B 44 24 18 89 47 28 8B 44 24 20 89 47 34 C7 47 24 00 00 00 00 8B 44 24 1C C7 47 2C 00 00 00 00 89 47 30 8D 74 24 2C 8B 44 24 24 89 47 38 83 C7 40 A5 A5 A5 A5 A5 31 D2 83 C4 40 89 D0 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_select_e66bc1121c5404ac1a39196e83f9475a {
	meta:
...
rule __GI_strncat_6820425f2b92541a2ef04b74ca4e9877 {
	meta:
...
rule abort_c3ea0715cebe90ceebe87b54e3361aa6 {
	meta:
...
rule mkstemp_86f0e1c7e9c8f1931e7bd65e736d0ed1 {
	meta:
		aliases = "mkstemp64, mkstemp"
		size = "17"
		objfiles = "mkstemp@libc.a, mkstemp64@libc.a"
	strings:
		$pattern = { ( CC | 68 ) 80 01 00 00 FF 74 24 08 E8 ?? ?? ?? ?? 5A 59 C3 }
	condition:
		$pattern
}
...
rule hdestroy_c97d8f5517fef4824426922a1b3eb9e1 {
	meta:
		aliases = "__pthread_once_fork_prepare, _flushlbf, __pthread_once_fork_parent, hdestroy"
		size = "12"
		objfiles = "hsearch@libc.a, mutex@libpthread.a, _flushlbf@libc.a"
	strings:
...
rule __open_etc_hosts_4b4b020f95e78d1c2d908fe427dc4a97 {
	meta:
		aliases = "getlogin, __GI_getlogin, __open_etc_hosts"
		size = "12"
		objfiles = "getlogin@libc.a, read_etc_hosts_r@libc.a"
	strings:
...
rule localtime_561e289bbb8d25a3dda9354419d8108d {
	meta:
...
rule ether_aton_e214931d143cca1a32199edb31adc4a0 {
	meta:
		aliases = "ether_ntoa, asctime, __GI_asctime, __GI_inet_ntoa, hcreate, inet_ntoa, ether_aton"
		size = "17"
		objfiles = "hsearch@libc.a, asctime@libc.a, ether_addr@libc.a, inet_ntoa@libc.a"
	strings:
...
rule gamma_ce767ada53bd455cecd0660edb8a7c87 {
	meta:
		aliases = "__GI_strtok, lgamma, strtok, __ieee754_lgamma, __GI_lgamma, gamma"
		size = "22"
...
rule __GI_getopt_16692ebea0a8b167125d20849f433e58 {
	meta:
...
rule strtold_218c186b4d9e0825b5f6d16570a16a45 {
	meta:
...
rule __GI_strtoul_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		aliases = "wcstoull, strtouq, wcstouq, strtoull, wcstoumax, strtoumax, __GI_waitpid, strtoul, waitpid, __libc_waitpid, wcstoul, __GI_strtoul"
		size = "23"
		objfiles = "wcstoull@libc.a, strtoull@libc.a, waitpid@libc.a, wcstoul@libc.a, strtoul@libc.a"
	strings:
...
rule iswalnum_0410fd2bb80bbf0bc944c8d2d2133af7 {
	meta:
		aliases = "timelocal, __GI_iswalnum, mktime, iswalnum"
		size = "14"
...
rule wcstoll_fe8e5520a3eef7a03748f1ff8e71080f {
	meta:
		aliases = "strtoq, strtoimax, wcstol, __GI_strtoll, __GI_strtol, strtol, wcstoimax, strtoll, wcstoq, wcstoll"
		size = "23"
		objfiles = "strtoll@libc.a, wcstol@libc.a, strtol@libc.a, wcstoll@libc.a"
	strings:
...
rule iswalpha_60617713272f358c39f6fe181a7829f8 {
	meta:
		aliases = "gethostbyname, __GI_gethostbyname, iswalpha"
		size = "14"
...
rule atol_40657ce09f1f30b9225c7cb14e45ae11 {
	meta:
		aliases = "atoll, atoi, __GI_atoi, atol"
		size = "17"
...
rule __GI_strerror_35abbc3d6542f68153afe4cd3042295f {
	meta:
...
rule __GI_fopen_b6bff45319aab59876e06d70684e978f {
	meta:
...
rule endusershell_adce4df8443da5e7fe22d490a91392ad {
	meta:
		aliases = "endusershell"
		size = "106"
		objfiles = "usershell@libc.a"
	strings:
		$pattern = { ( CC | 83 ) 3D ?? ?? ?? ?? 00 74 40 A1 ?? ?? ?? ?? A3 ?? ?? ?? ?? EB 0F 83 C0 04 52 A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 A1 ?? ?? ?? ?? 85 C0 74 06 8B 10 85 D2 75 E2 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 5A FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 58 C3 }
	condition:
		$pattern
}
...
rule __initbuf_84c0a6fc6a17b54ea130d52322309a97 {
	meta:
		aliases = "__initbuf"
		size = "35"
		objfiles = "getproto@libc.a, getnet@libc.a"
	strings:
		$pattern = { ( CC | 83 ) 3D ?? ?? ?? ?? 00 75 19 68 2C 01 00 00 E8 ?? ?? ?? ?? 5A A3 ?? ?? ?? ?? 85 C0 75 05 E8 ?? ?? ?? ?? C3 }
	condition:
		$pattern
}
...
rule __GI_open64_84136a8b413e29f3f6b18cba42f8f209 {
	meta:
...
rule fgetgrent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		aliases = "fgetpwent, getspnam, sgetspent, getpwuid, getpwnam, getgrgid, fgetspent, getgrnam, fgetgrent"
		size = "38"
		objfiles = "getspnam@libc.a, getgrgid@libc.a, fgetgrent@libc.a, getgrnam@libc.a, fgetpwent@libc.a"
	strings:
...
rule xdrstdio_putint32_ee168bdd943675c3e8c44169ac168060 {
	meta:
...
rule inet_makeaddr_958d5a1e238fe469627f7e5194277b96 {
	meta:
		aliases = "__GI_inet_makeaddr, inet_makeaddr"
		size = "80"
		objfiles = "inet_addr@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 04 8B 54 24 0C 8B 4C 24 08 8B 44 24 10 83 FA 7F 77 0A C1 E2 18 25 FF FF FF 00 EB 22 81 FA FF FF 00 00 77 0A C1 E2 10 25 FF FF 00 00 EB 10 81 FA FF FF FF 00 77 08 C1 E2 08 25 FF 00 00 00 09 D0 89 04 24 8B 04 24 89 01 89 C8 5A C2 04 00 }
	condition:
		$pattern
}
...
rule __GI_printf_d49bdeb5a2c59b42a4876d324b1f6480 {
	meta:
		aliases = "printf, wscanf, scanf, wprintf, __GI_printf"
		size = "30"
...
rule __GI_sprintf_8f72134c6305447e47b2df080ad309d1 {
	meta:
...
rule asprintf_3674412569e427ab0f649983548971e5 {
	meta:
		aliases = "__GI_sscanf, __GI_syslog, syslog, __GI_asprintf, fwprintf, dprintf, __GI_fscanf, __GI_fprintf, sscanf, fprintf, swscanf, fwscanf, fscanf, asprintf"
		size = "28"
		objfiles = "fscanf@libc.a, sscanf@libc.a, syslog@libc.a, asprintf@libc.a, fwscanf@libc.a"
	strings:
...
rule __GI_gethostbyaddr_c70efe559458915bc93f497802d925aa {
	meta:
...
rule __GI_getservbyport_61e69dcc205699b7325339cd4ed92986 {
	meta:
...
rule __GI_bind_8d867ef4aadcd5f6ff4837defeaacbba {
	meta:
...
rule __GI_connect_391ad6447a9e0b5b8c769dfc035016cc {
	meta:
...
rule __GI_sendmsg_33231d5410bb15145c0551f9d9f4c64b {
	meta:
...
rule cosf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		aliases = "gammaf, rintf, logf, erfcf, floorf, fabsf, ceilf, expf, acoshf, asinf, sinf, log1pf, atanhf, expm1f, tanf, sinhf, atanf, significandf, tanhf, log10f, lgammaf, erff, roundf, coshf, sqrtf, acosf, log2f, cbrtf, asinhf, logbf, truncf, exp2f, cosf"
		size = "27"
		objfiles = "atanhf@libm.a, sqrtf@libm.a, roundf@libm.a, log10f@libm.a, exp2f@libm.a"
	strings:
...
rule __GI_recv_64d8a44c13c950ea781c6cd180b4b6b9 {
	meta:
...
rule __GI_sigblock_e227929bde1d9d72e2a6ec833c3cba50 {
	meta:
...
rule copysignf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		aliases = "atan2f, scalbf, hypotf, remainderf, fmodf, powf, copysignf"
		size = "35"
		objfiles = "remainderf@libm.a, atan2f@libm.a, fmodf@libm.a, hypotf@libm.a, powf@libm.a"
	strings:
...
rule __libc_sendto_bfdff1979e67bfb60a49e18003972120 {
	meta:
...
rule __GI_cos_f3f7494184c6322a4edfc75713bc53e1 {
	meta:
...
rule __GI_tan_353773b4a706c390f0b282d7d4874b81 {
	meta:
...
rule ilogb_3255fad3e845311563d91ee42cfbadee {
	meta:
		aliases = "__GI_ilogb, ilogb"
		size = "128"
		objfiles = "s_ilogb@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 18 DD 44 24 1C DD 54 24 10 8B 54 24 14 81 E2 FF FF FF 7F 81 FA FF FF 0F 00 7F 2B DD 5C 24 08 89 D0 8B 4C 24 08 09 C8 74 4C B8 ED FB FF FF 85 D2 74 0E 89 D1 66 B8 02 FC C1 E1 0B EB 03 48 01 C9 85 C9 7F F9 EB 34 DD D8 81 FA FF FF EF 7F 7F 0B C1 FA 14 8D 82 01 FC FF FF EB 1F DD 44 24 1C 81 FA 00 00 F0 7F DD 1C 24 75 0B B8 FF FF FF 7F 83 3C 24 00 74 05 B8 00 00 00 80 83 C4 18 C3 }
	condition:
		$pattern
}
...
rule __GI_feraiseexcept_fbb73d66c49dab17863fcac4f86762c5 {
	meta:
...
rule __ieee754_scalb_a340ad76e482c8ea690866034d72d342 {
	meta:
		aliases = "scalb, __ieee754_scalb"
		size = "275"
		objfiles = "e_scalb@libm.a"
	strings:
		$pattern = { ( CC | 83 ) EC 1C DD 44 24 20 DD 54 24 10 DD 44 24 28 DD 5C 24 08 DD 1C 24 E8 ?? ?? ?? ?? 59 85 C0 5A 75 13 FF 74 24 04 FF 74 24 04 E8 ?? ?? ?? ?? 59 85 C0 5A 74 0C DD 44 24 08 DC 0C 24 E9 CF 00 00 00 FF 74 24 04 FF 74 24 04 E8 ?? ?? ?? ?? 59 85 C0 5A 75 2F D9 EE DD 04 24 DD E1 DF E0 DD D9 9E 76 0B DD 44 24 08 DE C9 E9 A3 00 00 00 DD D8 DD 04 24 D9 E0 DD 1C 24 DD 44 24 08 DC 34 24 E9 8D 00 00 00 FF 74 24 04 FF 74 24 04 E8 ?? ?? ?? ?? 58 5A DD 04 24 D9 C9 DD E9 DF E0 9E 7A 02 74 08 D9 C0 DE E1 D8 F0 EB 68 DD D8 D9 05 ?? ?? ?? ?? DD 04 24 DA E9 DF E0 9E 76 0A C7 44 24 20 E8 FD 00 00 EB 3C D9 05 ?? ?? ?? }
	condition:
		$pattern
}
...
rule __GI_acos_f665c4ad412800b071014f5c4dc4f365 {
	meta:
		aliases = "acos, __ieee754_acos, __GI_acos"
		size = "550"
...
rule __GI_svcerr_auth_29e5a8c4f2094cac44d6a836ca7bfd81 {
	meta:
...
rule __GI_endttyent_b0c4d07942bbc5fdfff2079cf619364d {
	meta:
...
rule __GI_ntohs_abb47f3111edd8b51bf0127264a91b58 {
	meta:
		aliases = "htons, __GI_htons, ntohs, __GI_ntohs"
		size = "12"
		objfiles = "ntohl@libc.a"
	strings:
...
rule __GI_perror_3cb7defce9031aa5025a47110a3d5c64 {
	meta:
...
rule __pthread_mutexattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, pthread_mutexattr_gettype, __pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate, pthread_mutexattr_getkind_np, __pthread_mutexattr_getkind_np"
		size = "15"
...
rule sem_getvalue_bf01487b64a973dd33d77632c300357d {
	meta:
		aliases = "pthread_attr_getschedparam, __new_sem_getvalue, __GI_pthread_attr_getschedparam, sem_getvalue"
		size = "16"
...
rule svctcp_stat_7a0f616380e8c4f74406a54da8552f14 {
	meta:
...
rule __init_scan_cookie_7eb6ef63198cd7487c10046aee0a15dc {
	meta:
		aliases = "__init_scan_cookie"
		size = "72"
		objfiles = "__scan_cookie@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 44 24 04 8B 54 24 08 31 C9 C6 40 19 00 89 50 08 C7 40 0C 00 00 00 00 F6 02 02 74 03 8B 4A 28 89 48 14 C6 40 1A 00 C6 40 1B 00 C7 40 30 ?? ?? ?? ?? C7 40 3C ?? ?? ?? ?? C7 40 34 01 00 00 00 C7 40 38 2E 00 00 00 C3 }
	condition:
		$pattern
}
...
rule svcunixfd_create_e63fbd4454ec064dc8f9d0b775e2be85 {
	meta:
		aliases = "__GI_setenv, svcfd_create, setenv, svcunixfd_create"
		size = "17"
...
rule mrand48_r_b3aacb3ccfb17d803b012961cc545010 {
	meta:
		aliases = "lrand48_r, __GI_lrand48_r, drand48_r, mrand48_r"
		size = "19"
...
rule __GI_sigaddset_016a84adaadaa75b24de597e41b23cce {
	meta:
		aliases = "sigaddset, sigdelset, __GI_sigdelset, sigismember, __GI_sigaddset"
		size = "33"
...
rule __GI_time_a75c0269822a568fe8d440d967c5d852 {
	meta:
...
rule __GI_xdrmem_create_0cb9c6b61297d01958e32b28fd04af72 {
	meta:
...
rule wcscmp_e91a61111c295dab6c061b7848cdcf0d {
	meta:
		aliases = "__GI_wcscmp, __GI_wcscoll, wcscoll, wcscmp"
		size = "36"
...
rule __libc_sa_len_dca92028c52559f6bad819d89cce860b {
	meta:
		aliases = "__libc_sa_len"
		size = "37"
		objfiles = "sa_len@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 B8 10 00 00 00 66 83 FA 02 74 15 66 83 FA 0A B0 1C 74 0D 31 C0 66 83 FA 01 0F 95 C0 48 83 E0 6E C3 }
	condition:
		$pattern
}
...
rule srand48_r_959dec397fbe0727d98d1139b954def5 {
	meta:
		aliases = "__GI_srand48_r, srand48_r"
		size = "55"
		objfiles = "srand48_r@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 08 8B 44 24 04 89 C1 C1 F9 10 66 89 42 02 31 C0 66 89 4A 04 66 C7 02 0E 33 C7 42 10 6D E6 EC DE C7 42 14 05 00 00 00 66 C7 42 0C 0B 00 66 C7 42 0E 01 00 C3 }
	condition:
		$pattern
}
...
rule __setutent_f7ab960ef2435019bbfb42fb8b919711 {
	meta:
		aliases = "__setutent"
		size = "148"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? 53 85 C0 79 7B 8B 15 ?? ?? ?? ?? B9 02 00 08 00 87 D3 B8 05 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF A3 ?? ?? ?? ?? 85 C0 79 35 8B 15 ?? ?? ?? ?? B9 00 00 08 00 87 D3 B8 05 00 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF A3 ?? ?? ?? ?? 85 C0 78 1E 6A 01 6A 02 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? EB 0A 6A 00 6A 00 50 E8 ?? ?? ?? ?? 83 C4 0C 5B C3 }
	condition:
		$pattern
}
...
rule pthread_getconcurrency_9306906a3a71020f26be39b72f98096c {
	meta:
		aliases = "__pthread_getconcurrency, __libc_current_sigrtmax, __libc_current_sigrtmin, pthread_getconcurrency"
		size = "6"
		objfiles = "allocrtsig@libc.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? C3 }
...
rule authnone_validate_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "old_sem_extricate_func, _stdlib_mb_cur_max, __GI_xdr_void, floatformat_always_valid, __GI__stdlib_mb_cur_max, xdr_void, authnone_validate"
		size = "6"
		objfiles = "_stdlib_mb_cur_max@libc.a, xdr@libc.a, auth_none@libc.a, oldsemaphore@libpthread.a, floatformat@libiberty.a"
	strings:
...
rule svcraw_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_tcp@libc.a, svc_authux@libc.a, svc_unix@libc.a, svc_raw@libc.a, svc_udp@libc.a"
	strings:
...
rule __GI___errno_location_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__GI___h_errno_location, __libc_pthread_init, __errno_location, __res_state, __h_errno_location, __GI___errno_location"
		size = "6"
		objfiles = "_res_state@libc.a, __h_errno_location@libc.a, __errno_location@libc.a, libc_pthread_init@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C3 }
	condition:
		$pattern
...
rule clntraw_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "__linuxthreads_create_event, __linuxthreads_reap_event, authnone_verf, xdrmem_destroy, __cyg_profile_func_enter, __stub1, noop_handler, clntraw_abort, clnttcp_abort, authnone_destroy, svcraw_destroy, clntunix_abort, __cyg_profile_func_exit, clntudp_abort, pthread_handle_sigdebug, __linuxthreads_death_event, clntraw_geterr, authunix_nextverf, __stub2, pthread_null_sighandler, clntraw_destroy"
		size = "1"
		objfiles = "resolv@libresolv.a, pthread@libpthread.a, lckpwdf@libc.a, clnt_tcp@libc.a, clnt_raw@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule ilogbf_f5f2daa96b9e124cf33f93c469bdf2db {
	meta:
		aliases = "lrintf, lroundf, ilogbf"
		size = "18"
		objfiles = "ilogbf@libm.a, lrintf@libm.a, lroundf@libm.a"
	strings:
...
rule on_exit_2e9ac529efadd5082bb212f4d27afff5 {
	meta:
		aliases = "on_exit"
		size = "37"
		objfiles = "on_exit@libc.a"
	strings:
		$pattern = { ( CC | E8 ) ?? ?? ?? ?? 89 C2 83 C8 FF 85 D2 74 16 8B 44 24 04 C7 02 02 00 00 00 89 42 04 8B 44 24 08 89 42 08 31 C0 C3 }
	condition:
		$pattern
}
...
rule __GI___rpc_thread_svc_max_poll_f50b36dc9991fe51c11e183376565e86 {
	meta:
...
rule sem_close_7cc9779505d1c64f89de4f58094c2c65 {
	meta:
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "__GI_cabs, setmntent, __GI_xdr_enum, __GI_xdr_u_int, xdr_enum, __GI_setmntent, mq_close, __pthread_initialize, splay_tree_xmalloc_deallocate, vfork, xdr_u_int, cabs, xdr_longlong_t, __GI_xdr_int, rand, xdr_int, partition_delete, xdr_u_longlong_t"
		size = "5"
		objfiles = "pthread@libpthread.a, xdr@libc.a, partition@libiberty.a, mq_close@librt.a, mntent@libc.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule getwchar_unlocked_d0a919a1423a1611f85f059ef10ad627 {
	meta:
		aliases = "getwchar, _dl_app_fini_array, getwchar_unlocked"
		size = "13"
...
rule gmtime_r_4ffe811b206b5540a8cd0461ad5ed514 {
	meta:
		aliases = "mq_getattr, mkostemp, bzero, gmtime_r"
		size = "19"
		objfiles = "bzero@libc.a, mkstemp@libc.a, gmtime_r@libc.a, mq_getsetattr@librt.a"
	strings:
...
rule __GI_fputwc_unlocked_b086346fe2fcd137f3c4f541ac2d12da {
	meta:
...
rule mkostemp64_385e19feddabd46e40eff9cf71b6a903 {
	meta:
		aliases = "mkostemp64"
		size = "19"
		objfiles = "mkstemp64@libc.a"
	strings:
		$pattern = { ( CC | FF ) 74 24 08 6A 01 FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule __GI_fmin_37c0b53ef473184550b357136d6c9efc {
	meta:
...
rule vscanf_8656ba417f55ecd54498627fc6f064b6 {
	meta:
		aliases = "vprintf, vwscanf, vwprintf, vscanf"
		size = "23"
...
rule __GI_getline_8af70975a3b7202da3f0924b6a67d0cb {
	meta:
...
rule fseek_c988c3466338bd611a4c400ed6b310ad {
	meta:
		aliases = "fseeko, __GI_fseek, fseek"
		size = "24"
...
rule verr_e995d28d2bc805c6592260c44650cadd {
	meta:
...
rule __GI_wcsrtombs_16011af63c374c0fc46c99c13b47eb95 {
	meta:
