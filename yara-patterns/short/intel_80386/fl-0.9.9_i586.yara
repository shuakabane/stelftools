...
rule pthread_rwlockattr_destroy_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "__pthread_mutex_unlock, __pthread_return_0, __GI_pthread_condattr_init, __pthread_mutex_trylock, pthread_attr_destroy, wcsftime, __GI_pthread_condattr_destroy, __pthread_mutex_init, pthread_condattr_destroy, __pthread_mutex_lock, clntraw_control, xdrstdio_inline, grantpt, pthread_mutexattr_destroy, _svcauth_null, __GI_wcsftime, pthread_condattr_init, __pthread_mutexattr_destroy, authnone_refresh, __GI_pthread_attr_destroy, pthread_rwlockattr_destroy"
		size = "3"
		objfiles = "auth_none@libc.a, wcsftime@libc.a, grantpt@libc.a, __uClibc_main@libc.a, xdr_stdio@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __GI_getdomainname_697f99fee411f6ddffe6bd60370a0f43 {
	meta:
...
rule __GI___libc_statfs_66b9353b0907b20e9d3c17ba1263b522 {
	meta:
		aliases = "__libc_statfs, statfs, __GI_statfs, __GI___libc_statfs"
		size = "49"
...
rule endpwent_388f7d68c5e644cf15134cf29cd318ff {
	meta:
...
rule fsync_f62998a482170cde13f7c89dcfb26a0d {
	meta:
		aliases = "system, tcdrain, wait, fsync"
		size = "48"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule lseek_7fafe2d4042f052134436ac4f9e768f2 {
	meta:
		aliases = "sendmsg, __GI_waitpid, accept, waitpid, lseek"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule read_f76fa2a31d5e51010722d3c9bb015e20 {
	meta:
		aliases = "write, msync, recvmsg, connect, read"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_frexp_f4e30fbd92b4d358534592f1d1c1a6fb {
	meta:
...
rule __GI_scalbn_bab9bbc2d89359cfcb58d627cdbfebf0 {
	meta:
...
rule __libc_pread_ab437036bdc503b3efe105177bd491a7 {
	meta:
		aliases = "mq_send, mq_receive, pread, __libc_pread"
		size = "35"
...
rule __libc_sigsuspend_cfeb270bade9c6e47c7706f09109782c {
	meta:
...
rule __gthread_active_p_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "_Unwind_GetDataRelBase, __udiv_w_sdiv, _Unwind_GetRegionStart, _Unwind_FindEnclosingFunction, _Unwind_GetTextRelBase, __gthread_active_p"
		size = "7"
...
rule __GI_clnt_spcreateerror_10be61839cb9211d2c9adbbc13b00bcd {
	meta:
...
rule __GI_vsyslog_1322c06dee88aaf97a66d905f9dde9bc {
	meta:
...
rule _vfprintf_internal_4fb32faa4d53044a55c4a12af77cb293 {
	meta:
		aliases = "_vfprintf_internal"
		size = "1540"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 74 01 00 00 8B 9C 24 8C 01 00 00 53 8D 74 24 1C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 3E 8B 5C 24 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 C7 04 24 FF FF FF FF 0F 84 B4 05 00 00 52 FF B4 24 84 01 00 00 50 53 E8 ?? ?? ?? ?? C7 44 24 10 FF FF FF FF 83 C4 10 E9 95 05 00 00 50 50 FF B4 24 90 01 00 00 56 E8 ?? ?? ?? ?? C7 44 24 10 00 00 00 00 89 DA 83 C4 10 EB 01 43 8A 03 84 C0 74 04 3C 25 75 F5 39 D3 74 27 89 DE 31 C0 29 D6 85 F6 7E 12 50 FF B4 24 84 01 00 00 56 52 E8 ?? ?? ?? ?? 83 C4 10 39 F0 0F 85 3D 05 00 00 01 04 24 80 3B 00 0F 84 38 05 00 00 8D 53 01 80 7B 01 25 0F 84 1C }
	condition:
		$pattern
}
...
rule __GI_sleep_687ae9b4e154e6304f1b9ff2109d2b4f {
	meta:
...
rule __GI_vfscanf_b4031f61874266d59b73f02ac0051243 {
	meta:
...
rule __GI_ether_aton_r_b4299d7f0b0dd679119f9a3ba964b173 {
	meta:
...
rule __GI_inet_network_cd478ff289a43881271cfd2faf47aebc {
	meta:
...
rule __GI_svc_getreq_poll_9c5e14dddd41ebe8db9264f8a9a11f9b {
	meta:
...
rule shm_open_64fd7b71f76bf42dbc418456ace13787 {
	meta:
		aliases = "shm_open"
		size = "135"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 83 CF FF 8B 44 24 20 E8 ?? ?? ?? ?? 89 C5 85 C0 74 64 57 FF 74 24 2C FF 74 24 2C 50 E8 ?? ?? ?? ?? 83 C4 10 89 C7 85 C0 78 35 56 6A 00 6A 01 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 14 83 C8 01 53 50 6A 02 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0F 83 EC 0C 57 83 CF FF E8 ?? ?? ?? ?? 83 C4 10 E8 ?? ?? ?? ?? 83 EC 0C 89 C3 8B 30 55 E8 ?? ?? ?? ?? 89 33 83 C4 10 83 C4 0C 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_initstate_r_c45cb99f63e51588a3757e85ff18db3d {
	meta:
...
rule lldiv_9040d428900bd199969720bb2a395250 {
	meta:
...
rule __GI_setstate_r_baff7ff50edb41ea8a7a7f91f7f4fbe5 {
	meta:
...
rule __GI_qsort_7871739736d7e2bfac63a6ce2b592f01 {
	meta:
...
rule getpwnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "__GI_getgrnam_r, __GI_getspnam_r, getgrnam_r, getspnam_r, __GI_getpwnam_r, getpwnam_r"
		size = "153"
...
rule __regcomp_dd9e674d7fd4dc5f3ba3b18f540bc502 {
	meta:
...
rule wcsnrtombs_a0950682703bb68c5966382ce403bae3 {
	meta:
		aliases = "__GI_wcsnrtombs, wcsnrtombs"
		size = "131"
		objfiles = "wcsnrtombs@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 54 24 30 8B 6C 24 34 8B 4C 24 38 8B 44 24 3C 85 D2 74 0E BF 01 00 00 00 39 EA 75 0E 66 31 FF EB 05 83 C8 FF 31 FF 8D 54 24 0C 89 C6 39 C8 76 02 89 CE 8B 4D 00 89 F3 EB 27 8B 01 83 F8 7F 76 10 E8 ?? ?? ?? ?? C7 00 54 00 00 00 83 C8 FF EB 23 88 02 84 C0 75 04 31 C9 EB 0A 83 C1 04 01 FA 4B 85 DB 75 D5 8D 44 24 0C 39 C2 74 03 89 4D 00 89 F0 29 D8 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_fflush_unlocked_a97c97d5266d962eeb6fb96178d37ece {
	meta:
...
rule __GI_setvbuf_35e0163eb570949fe3adae6a912bc1f0 {
	meta:
...
rule __GI_lround_f4275a06bad22c915dfb05dde1bd6643 {
	meta:
...
rule __GI_readdir_r_e3a162793b922b71fa5935a35798aac4 {
	meta:
...
rule __GI_hsearch_r_ab4442ec5fc1716c6f8507547e82e671 {
	meta:
...
rule __GI_llround_dc62aaf8b9a0987d6e6200a1cc42b6fe {
	meta:
...
rule __GI_llrint_003203db02d4d2e6286dc7652316d99f {
	meta:
...
rule __GI_clntudp_bufcreate_32719c13a4094df39fb6754ccff78a37 {
	meta:
...
rule _pthread_cleanup_pop_restore_415db839a67a8ff35cc89089a173fe69 {
	meta:
...
rule __GI_glob_377b7c37cdba1b832c2ace7172401039 {
	meta:
...
rule __GI_glob64_4a7cce11d3828ce7093d818602915ed9 {
	meta:
...
rule __gcov_flush_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gnat_default_lock, __enable_execute_stack, __gnat_default_unlock, __gcov_merge_single, __clear_cache, __gcov_init, __gcov_merge_delta, __gcov_merge_add, __gcov_flush"
		size = "5"
		objfiles = "_clear_cache@libgcc.a, _gcov_merge_add@libgcov.a, _gcov_merge_delta@libgcov.a, _gcov@libgcov.a, _gcov_merge_single@libgcov.a"
	strings:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "condvar@libpthread.a, rwlock@libpthread.a, pthread@libpthread.a, signals@libpthread.a, mutex@libpthread.a"
	strings:
...
rule __GI_globfree_089f63f204780f378f815b0433f30f4b {
	meta:
...
rule shm_unlink_215ebac2065361c26f04d338648acd04 {
	meta:
		aliases = "shm_unlink"
		size = "51"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 83 CE FF 8B 44 24 10 E8 ?? ?? ?? ?? 89 C3 85 C0 74 16 83 EC 0C 50 E8 ?? ?? ?? ?? 89 1C 24 89 C6 E8 ?? ?? ?? ?? 83 C4 10 89 F0 59 5B 5E C3 }
	condition:
		$pattern
}
...
rule __libc_siglongjmp_be9e6548214836180c2cfadd5a9f8fd0 {
	meta:
...
rule __pthread_attr_setguardsize_d1af178eebf5aafd99910c0106afcef3 {
	meta:
...
rule __wcslcpy_4a95a75907db7d7c4642339d840435fd {
	meta:
...
rule __GI_strlcpy_0fda2a604b0b5c1c17a1edf68666a4c0 {
	meta:
...
rule __GI_fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "fgetspent_r, fgetgrent_r, __GI_fgetspent_r, fgetpwent_r, __GI_fgetgrent_r, __GI_fgetpwent_r"
		size = "55"
...
rule __GI_xdr_hyper_6f8b8d6e0fcc6b145f584f1836476211 {
	meta:
...
rule __fputc_unlocked_3285cd6d795474f19a1a1b20ef0fa5ce {
	meta:
...
rule __GI_erand48_r_6c14bfefeb3ef863fccd867f0bc5f099 {
	meta:
...
rule __re_match_e13552410118e48547e308ba7ec5672c {
	meta:
...
rule __GI___libc_open_d3dad7f46fcc1e13edfffe8dca3ae8ff {
	meta:
...
rule __GI_ppoll_defccf856d7006fc38a3d2eb7c424a74 {
	meta:
...
rule __GI_vfprintf_906987d35c95070e26c6e0d4bd8eca4f {
	meta:
...
rule __GI_fileno_47b2021f9ad3c9dae34d9b79ccbd71b9 {
	meta:
		aliases = "fgetwc, __GI_fgetwc, fileno, getwc, __GI_fileno"
		size = "92"
...
rule __GI_fputws_27a00bae78ad279095482cf1967e990f {
	meta:
		aliases = "putwc, fputs, fputws, fputwc, __GI_fputs, __GI_fputws"
		size = "95"
...
rule getpwent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "__GI_getgrent_r, getgrent_r, __GI_getspent_r, __GI_getpwent_r, getspent_r, getpwent_r"
		size = "171"
		objfiles = "getspent_r@libc.a, getpwent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule __GI_round_a6199184dea1a90ff39abf73046d4864 {
	meta:
...
rule __GI_fwrite_unlocked_e78da18a2ecfd881ed3489b9c3ed9539 {
	meta:
...
rule __GI_memcpy_399167b7ec8d2b63570d9329b15d0752 {
	meta:
...
rule __GI_futimes_fb7ed617d1ccc29447018b39f323fcfc {
	meta:
		aliases = "futimes, __GI_futimes"
		size = "101"
		objfiles = "futimes@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 14 31 D2 8B 4C 24 24 8B 7C 24 20 85 C9 74 27 8B 01 8D 54 24 04 89 44 24 04 69 41 04 E8 03 00 00 89 44 24 08 8B 41 08 89 44 24 0C 69 41 0C E8 03 00 00 89 44 24 10 31 F6 89 F1 53 89 FB B8 40 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 83 C4 14 5E 5F C3 }
	condition:
		$pattern
}
...
rule wcstouq_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "__GI_wcstoul, strtoumax, __libc_waitpid, strtoull, __GI_waitpid, wcstoul, __GI_strtoull, strtoul, wcstoumax, __GI_wcstoull, waitpid, wcstoull, __GI_strtoul, strtouq, wcstouq"
		size = "26"
...
rule __GI_strtol_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "__GI_strtoll, strtoimax, wcstoll, strtoq, wcstol, strtol, __GI_wcstol, strtoll, __GI_wcstoll, wcstoimax, wcstoq, __GI_strtol"
		size = "26"
...
rule __GI_setttyent_6b48c7dfe8b625af7cac2807c48ff520 {
	meta:
...
rule strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "lgamma, gamma, __ieee754_lgamma, __GI_strtok, __ieee754_gamma, __GI_lgamma, strtok"
		size = "25"
...
rule __GI_inet_makeaddr_4cb60d22c1b94755358e1daf237f7f54 {
	meta:
...
rule srand48_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "__GI_inet_ntoa, asctime, __GI_asctime, inet_ntoa, ether_ntoa, hcreate, srand48"
		size = "21"
		objfiles = "srand48@libc.a, hsearch@libc.a, asctime@libc.a, inet_ntoa@libc.a, ether_addr@libc.a"
	strings:
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "condvar@libpthread.a, rwlock@libpthread.a, pthread@libpthread.a, manager@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule __GI_getlogin_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__pthread_once_fork_parent, getlogin, __pthread_once_fork_prepare, hdestroy, _flushlbf, __GI_getlogin"
		size = "17"
...
rule __re_compile_pattern_f2ef2cf07b7a6e70161fcf829e276db6 {
	meta:
...
rule __GI_open64_9165478e24a6d5c355c5f08accf4b480 {
	meta:
...
rule printf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "wscanf, __GI_printf, scanf, wprintf, printf"
		size = "32"
...
rule sscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "__GI_sscanf, asprintf, swscanf, fscanf, dprintf, fwprintf, __GI_fscanf, fprintf, __GI_fprintf, syslog, fwscanf, __GI_asprintf, __GI_syslog, sscanf"
		size = "30"
		objfiles = "fwscanf@libc.a, fprintf@libc.a, dprintf@libc.a, fscanf@libc.a, swscanf@libc.a"
	strings:
...
rule ilogbf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "lroundf, llroundf, llrintf, lrintf, ilogbf"
		size = "19"
...
rule rintf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "acosf, floorf, fabsf, roundf, sqrtf, cosf, sinhf, cbrtf, tanf, acoshf, atanf, ceilf, tgammaf, log10f, erff, expf, truncf, atanhf, log1pf, asinf, logbf, erfcf, asinhf, tanhf, coshf, sinf, lgammaf, expm1f, logf, rintf"
		size = "27"
		objfiles = "sinhf@libm.a, tanf@libm.a, sqrtf@libm.a, atanhf@libm.a, logf@libm.a"
	strings:
...
rule hypotf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "fmodf, remainderf, nextafterf, copysignf, atan2f, powf, hypotf"
		size = "35"
...
rule fgetgrent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "getgrgid, getgrnam, getspnam, getpwnam, getpwuid, fgetpwent, sgetspent, fgetspent, fgetgrent"
		size = "40"
		objfiles = "fgetpwent@libc.a, getgrgid@libc.a, getgrnam@libc.a, fgetgrent@libc.a, getspnam@libc.a"
	strings:
...
rule __GI_pthread_attr_getdetachsta_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, pthread_rwlockattr_getkind_np, pthread_mutexattr_gettype, pthread_attr_getdetachstate, pthread_mutexattr_getkind_np, __GI_pthread_attr_getdetachstate"
		size = "15"
...
rule __GI_ffs_1cbebb8dcf051bf3b4fef88bddf37838 {
	meta:
...
rule pthread_mutexattr_setkind_np_c966b71060253b953a535d91cc13d1cf {
	meta:
		aliases = "__pthread_mutexattr_settype, __pthread_mutexattr_setkind_np, pthread_mutexattr_settype, pthread_mutexattr_setkind_np"
		size = "23"
		objfiles = "mutex@libpthread.a"
	strings:
...
rule __GI_xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "xdr_void, old_sem_extricate_func, _stdlib_mb_cur_max, __GI__stdlib_mb_cur_max, authnone_validate, floatformat_always_valid, __GI_xdr_void"
		size = "6"
		objfiles = "auth_none@libc.a, xdr@libc.a, floatformat@libiberty.a, _stdlib_mb_cur_max@libc.a, oldsemaphore@libpthread.a"
	strings:
...
rule __GI___h_errno_location_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__GI___errno_location, __errno_location, __libc_pthread_init, __h_errno_location, __GI___h_errno_location"
		size = "6"
...
rule clnttcp_abort_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "svcraw_destroy, __stub2, authnone_destroy, __cyg_profile_func_exit, _pthread_cleanup_pop_restore, __pthread_return_void, xdrmem_destroy, __linuxthreads_create_event, noop_handler, utimensat, clntraw_abort, clntraw_geterr, pthread_handle_sigdebug, clntraw_destroy, __linuxthreads_death_event, clntunix_abort, __stub1, clntudp_abort, authunix_nextverf, pthread_null_sighandler, _pthread_cleanup_push_defer, authnone_verf, __cyg_profile_func_enter, __linuxthreads_reap_event, clnttcp_abort"
		size = "1"
		objfiles = "auth_none@libc.a, auth_unix@libc.a, clnt_tcp@libc.a, __uClibc_main@libc.a, lckpwdf@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule xdr_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "__GI_acosh, jn, __GI_pow, j1, vfork, partition_delete, mq_close, __GI_cabs, sqrt, __GI_setmntent, log2, __GI_xdr_enum, splay_tree_xmalloc_deallocate, xdr_u_longlong_t, drem, __GI_atan2, __GI_asin, __GI_hypot, xdr_enum, __GI_sqrt, asin, __GI_cosh, __GI_acos, exp, __ieee754_gamma_r, sinh, y0, j0, yn, lgamma_r, remainder, __GI_xdr_u_int, cabs, __GI_exp, hypot, __decode_packet, setmntent, __GI_sinh, __pthread_initialize, __GI_log10, __GI_nearbyint, rand, atanh, log, __GI_xdr_int, __GI_remainder, __GI_fmod, xdr_u_int, acos, atan2"
		size = "5"
		objfiles = "w_fmod@libm.a, w_sinh@libm.a, splay_tree@libiberty.a, ptfork@libpthread.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
