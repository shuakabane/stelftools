...
rule pthread_rwlockattr_destroy_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "__GI_pthread_attr_destroy, clntraw_control, __pthread_mutexattr_destroy, grantpt, __pthread_mutex_lock, _svcauth_null, wcsftime, pthread_condattr_init, __pthread_mutex_unlock, __GI_pthread_condattr_destroy, pthread_mutexattr_destroy, authnone_refresh, xdrstdio_inline, __pthread_return_0, __pthread_mutex_init, __GI_wcsftime, __GI_pthread_condattr_init, __pthread_mutex_trylock, pthread_attr_destroy, pthread_condattr_destroy, pthread_rwlockattr_destroy"
		size = "3"
		objfiles = "wcsftime@libc.a, clnt_raw@libc.a, condvar@libpthread.a, xdr_stdio@libc.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule thread_self_c490e55fdc4e0d42e26befc1658d19a1 {
	meta:
		aliases = "thread_self"
		size = "63"
		objfiles = "semaphore@libpthread.a, join@libpthread.a, errno@libpthread.a, spinlock@libpthread.a, condvar@libpthread.a"
	strings:
...
rule glob_pattern_p_43c53de5a52395a20afd01d66ce758fa {
	meta:
...
rule signal_126cff4a00751967edf4b225069665be {
	meta:
		aliases = "__bsd_signal, __GI_signal, bsd_signal, signal"
		size = "175"
...
rule __GI_getdomainname_8b4ef73be17f423b0978b5e948c46812 {
	meta:
		aliases = "getdomainname, __GI___libc_getdomainname, __libc_getdomainname, __GI_getdomainname"
		size = "101"
...
rule pone_114ab530f4ff01d1e14a764dfc56fb3e {
	meta:
		aliases = "pzero, pone"
		size = "183"
...
rule __GI_mkdir_9b721ea198412e705f137276a2c2d8fa {
	meta:
...
rule __GI_utimes_5c29417dcfc07bd1b3abcdd8e969272b {
	meta:
...
rule __GI_utime_f2ca48482e591252c549dfe2a40a6035 {
	meta:
...
rule __GI_setrlimit_efa63936c1af1e8451f9fb6712233805 {
	meta:
...
rule __GI_gettimeofday_f77d26ff04e62e2f0092ac20d9145214 {
	meta:
...
rule munmap_6058e04be2d0416570da8bef50a34720 {
	meta:
...
rule __GI_fstatfs_b82c33a72680209b48b544d1edec1c80 {
	meta:
...
rule setgroups_7f0b4efd1e11b70909b9b66fa53f669c {
	meta:
...
rule __GI_fork_9d8a7d9235dcf23dd24b00a08a33a462 {
	meta:
...
rule __libc_pause_e8b2326e6608562587c72ec548cab527 {
	meta:
...
rule __GI_getuid_14e4adca89f9f587b00d2c025489c7b5 {
	meta:
...
rule getegid_ef8a3b3024764fe5c3341610d64754ea {
	meta:
...
rule nrand48_r_d2ad2ca32fe204bdbb09231bbac061e8 {
	meta:
...
rule cos_5efa2f17c840d523472e24f6f44bf173 {
	meta:
...
rule __GI_fgetc_unlocked_7234bf2292c7e7a4e6fb4c246bfcefbf {
	meta:
		aliases = "__GI_getc_unlocked, fgetc_unlocked, getc_unlocked, __GI___fgetc_unlocked, __fgetc_unlocked, __GI_fgetc_unlocked"
		size = "220"
...
rule endservent_f468964b8937d2560c1930edef041633 {
	meta:
		aliases = "endprotoent, __GI_endnetent, endnetent, __GI_endprotoent, __GI_endservent, endservent"
		size = "92"
...
rule system_bbe948c091b68f15128a29caf991f3c8 {
	meta:
		aliases = "fsync, wait, tcdrain, system"
		size = "48"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule sendmsg_74030486c498b35deba130245259f53b {
	meta:
		aliases = "lseek, waitpid, accept, __GI_waitpid, sendmsg"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule recvmsg_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "msync, write, read, connect, recvmsg"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_vswprintf_eefc5f12930df5c4a732724eb651b5ff {
	meta:
...
rule __isnan_2e948270bc091a5709464aab0f086307 {
	meta:
...
rule __isinf_8fae0a869cda9672f88bf94835574c14 {
	meta:
...
rule __fpclassify_86112f9c83306f93487d5d925aec313b {
	meta:
...
rule _Unwind_GetDataRelBase_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "_Unwind_GetRegionStart, __udiv_w_sdiv, _Unwind_FindEnclosingFunction, __gthread_active_p, _Unwind_GetTextRelBase, _Unwind_GetDataRelBase"
		size = "7"
...
rule svc_getreqset_07e0d8146aaf5b00f48465f7a0ca2e65 {
	meta:
...
rule fflush_unlocked_59cc81d502c5fe725a72df38bd3ef0d2 {
	meta:
...
rule __GI_erand48_r_faac60e1e633fb039f0dbe7acc77238b {
	meta:
...
rule svcudp_bufcreate_7de1f5cff7ac399750183a1436f4e25c {
	meta:
...
rule svc_getreq_common_30009be82dca1e4eda26b232f60fdef4 {
	meta:
...
rule clnt_broadcast_d22dc86372ee54ca6378b2cd5edf671b {
	meta:
		aliases = "clnt_broadcast"
		size = "1463"
		objfiles = "pmap_rmt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 1C 29 00 00 E8 ?? ?? ?? ?? C7 84 24 14 29 00 00 01 00 00 00 89 44 24 04 51 6A 11 6A 02 6A 02 E8 ?? ?? ?? ?? 89 44 24 1C 83 C4 10 85 C0 79 0A 83 EC 0C 68 ?? ?? ?? ?? EB 29 83 EC 0C 6A 04 8D 84 24 24 29 00 00 50 6A 06 6A 01 FF 74 24 28 E8 ?? ?? ?? ?? 83 C4 20 85 C0 79 1A 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? BB 03 00 00 00 83 C4 10 E9 18 05 00 00 8B 44 24 0C 66 C7 84 24 0C 29 00 00 01 00 C7 84 24 00 29 00 00 60 22 00 00 89 84 24 08 29 00 00 8D 44 24 28 89 84 24 04 29 00 00 8D 84 24 00 29 00 00 52 50 68 12 89 00 00 FF 74 24 18 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 1D 83 EC 0C 68 ?? }
	condition:
		$pattern
}

rule statvfs_f3a9d862d9df7c5f678b018888159b43 {
	meta:
...
rule vsyslog_1f26c09533d64ddf55d8f5c7f0f44278 {
	meta:
...
rule _vfprintf_internal_3cbc06d3f79784ab864a74e0e365763e {
	meta:
		aliases = "_vfprintf_internal"
		size = "1464"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 64 01 00 00 8B 9C 24 7C 01 00 00 53 8D 74 24 1C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 3E 8B 5C 24 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 C7 04 24 FF FF FF FF 85 C0 0F 84 68 05 00 00 52 FF B4 24 74 01 00 00 50 53 E8 ?? ?? ?? ?? C7 44 24 10 FF FF FF FF 83 C4 10 E9 49 05 00 00 50 50 FF B4 24 80 01 00 00 56 E8 ?? ?? ?? ?? 89 DA C7 44 24 10 00 00 00 00 83 C4 10 EB 01 43 8A 03 84 C0 74 04 3C 25 75 F5 39 D3 74 27 89 DE 31 C0 29 D6 85 F6 7E 12 55 FF B4 24 74 01 00 00 56 52 E8 ?? ?? ?? ?? 83 C4 10 39 F0 0F 85 F1 04 00 00 01 34 24 80 3B 00 0F 84 EC 04 00 00 80 7B 01 25 8D 53 01 0F 84 D0 }
	condition:
		$pattern
}

rule __GI_rexec_af_d65828ce36a7f502c65d3d112098d469 {
	meta:
		aliases = "rexec_af, __GI_rexec_af"
		size = "1143"
		objfiles = "rexec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 7C 01 00 00 8B 84 24 98 01 00 00 0F B7 BC 24 A8 01 00 00 89 44 24 04 8B 84 24 9C 01 00 00 89 44 24 08 0F B7 84 24 94 01 00 00 66 C1 C8 08 0F B7 C0 50 68 ?? ?? ?? ?? 6A 20 8D B4 24 38 01 00 00 56 E8 ?? ?? ?? ?? C6 84 24 5B 01 00 00 00 83 C4 0C 6A 20 6A 00 8D 9C 24 58 01 00 00 53 E8 ?? ?? ?? ?? 8D 84 24 84 01 00 00 89 BC 24 60 01 00 00 83 CF FF C7 84 24 64 01 00 00 01 00 00 00 C7 84 24 5C 01 00 00 02 00 00 00 50 53 56 8B 84 24 AC 01 00 00 FF 30 E8 ?? ?? ?? ?? 83 C4 20 85 C0 0F 85 BF 03 00 00 8B 84 24 74 01 00 00 8B 40 18 85 C0 74 4E 57 BB 01 00 00 00 68 01 04 00 00 50 68 ?? ?? }
	condition:
		$pattern
}
...
rule _fpmaxtostr_07549223adb0f0156a42e5335e043436 {
	meta:
		aliases = "_fpmaxtostr"
		size = "1451"
		objfiles = "_fpmaxtostr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC DC 00 00 00 8B 84 24 00 01 00 00 8B 94 24 00 01 00 00 DB AC 24 F4 00 00 00 8B 40 04 89 44 24 14 8A 5A 08 8B 2A C6 84 24 C2 00 00 00 65 88 D8 0C 20 3C 61 88 5C 24 1D 75 07 80 C3 06 88 5C 24 1D 8B 94 24 00 01 00 00 85 ED B8 06 00 00 00 C6 84 24 D2 00 00 00 00 0F 48 E8 8B 42 0C A8 02 74 0A C6 84 24 D2 00 00 00 2B EB 0C A8 01 74 08 C6 84 24 D2 00 00 00 20 DB E8 C6 84 24 D3 00 00 00 00 C7 44 24 58 00 00 00 00 7A 02 74 0C DD D8 C7 44 24 58 08 00 00 00 EB 59 D9 EE D9 C9 DB E9 75 27 7A 25 D9 E8 D8 F1 D9 CA C7 44 24 10 FF FF FF FF DF EA DD D9 0F 86 05 01 00 00 C6 84 24 D2 00 00 00 2D }
	condition:
		$pattern
}
...
rule inet_aton_1ce40689742bceca7eca43ec2125b68f {
	meta:
...
rule ether_aton_r_867a073d75ee7cd85038853809830940 {
	meta:
...
rule inet_network_8d250cad1b24a360fdba4b65c93ccca1 {
	meta:
...
rule __GI_strstr_8aa0dcfaf4a28834acfc382fd4103606 {
	meta:
		aliases = "strstr, __GI_strstr"
		size = "198"
		objfiles = "strstr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 54 24 20 8B 5C 24 1C 0F B6 2A 85 ED 0F 84 9F 00 00 00 4B 43 0F B6 03 85 C0 0F 84 96 00 00 00 39 E8 75 F0 8D 42 01 89 44 24 04 0F B6 52 01 85 D2 89 14 24 74 7C 0F B6 43 01 8D 4B 01 39 D0 EB 28 0F B6 43 01 8D 4B 01 EB 14 85 C0 74 68 41 0F B6 01 39 E8 74 0C 85 C0 74 5C 41 0F B6 01 39 E8 75 E8 41 0F B6 01 3B 04 24 75 F3 8B 5C 24 04 8D 71 01 8B 7C 24 04 0F B6 41 01 0F B6 53 01 8D 59 FF 47 39 D0 75 28 85 C0 74 28 0F B6 46 01 0F B6 57 01 39 D0 75 18 85 D2 74 18 83 C6 02 83 C7 02 0F B6 17 0F B6 06 39 D0 75 04 89 D0 EB D8 85 D2 75 8F 89 D8 EB 02 31 C0 5A 59 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule atan_1d113605bcf0feabe16671625fcad1be {
	meta:
...
rule scalbln_f2d20c47fa6ace3e8f29361d299d1e1c {
	meta:
...
rule __ns_name_unpack_50ffe655e81f48454052ecbee2220e5d {
	meta:
...
rule __GI_memmem_3aadc45623e5178bdd7527536911c4da {
	meta:
...
rule __GI_setstate_r_e131aa83151b6b70e60e79bc1f70d1a8 {
	meta:
...
rule __GI_getcwd_0c4988a96c7b9017d524983a6191d7aa {
	meta:
...
rule wcsncasecmp_d79a42cb3107f19f169834c893fc1aea {
	meta:
...
rule qsort_f3ecab42bb8b9092d58eb1fe5cb50443 {
	meta:
...
rule __GI_fgets_unlocked_80602fb1c9727374b174374506668f12 {
	meta:
...
rule getgrnam_r_cc5f26c3b0fc4b0f9817cca9b8118eee {
	meta:
		aliases = "getspnam_r, getpwnam_r, __GI_getspnam_r, __GI_getpwnam_r, __GI_getgrnam_r, getgrnam_r"
		size = "152"
...
rule rint_16a83604a1fe969eb8791c84a609b70b {
	meta:
...
rule __GI_getdelim_796cb0247cf6019dfda07ff25d3749c5 {
	meta:
...
rule __re_search_2_1a2a6d8ec99f5e90419917fe5b6c2f19 {
	meta:
...
rule wcsnrtombs_0bbdd47310c6b3ff6b06b68a71e9ffbb {
	meta:
...
rule __GI_getservent_r_18057c2e44843e2ab8b796481de93c2a {
	meta:
...
rule __GI_ptsname_r_d6f57155b2cba12140bb49f93b8e2234 {
	meta:
...
rule __GI_pthread_cond_timedwait_8fb1868a71374a58cd2c3876b5f42f61 {
	meta:
...
rule lrint_d354bc5f31abf28158de9b46eac272bb {
	meta:
...
rule fork_8719a89b2145d29beb71567d7cca855d {
	meta:
		aliases = "__fork, fork"
		size = "247"
		objfiles = "ptfork@libpthread.a"
...
rule __GI_xdrrec_create_b58e4610e85278cba5edea1e6f7ec8f4 {
	meta:
...
rule __GI_hsearch_r_32d9abd47bb0d960a75d12ba2de737df {
	meta:
...
rule __GI_memcmp_87abf526abfce9da2f3b3ab658c5f682 {
	meta:
...
rule __GI_lockf64_1c4c698a50883d45fff4e3b556427aaf {
	meta:
...
rule __GI_mallinfo_f7059050893a1656da078441e3c4c34a {
	meta:
...
rule malloc_9e134b32c6cdb1ecc39ff561d89cc076 {
	meta:
		aliases = "malloc"
		size = "1952"
		objfiles = "malloc@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 40 8B 5C 24 54 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 38 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 FB DF 76 12 E8 ?? ?? ?? ?? 31 DB C7 00 0C 00 00 00 E9 51 07 00 00 8D 43 0B 83 F8 0F C7 44 24 14 10 00 00 00 76 07 83 E0 F8 89 44 24 14 8B 1D ?? ?? ?? ?? F6 C3 01 75 1D 85 DB 0F 85 F6 02 00 00 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 E9 E1 02 00 00 39 5C 24 14 77 1B 8B 44 24 14 D1 E8 8D 88 ?? ?? ?? ?? 8B 51 FC 85 D2 74 08 8B 42 08 89 41 FC EB 39 81 7C 24 14 FF 00 00 00 77 37 8B 44 24 14 C1 E8 03 8D 0C C5 ?? ?? ?? ?? 89 44 24 24 8B 51 0C 39 CA 0F 84 }
	condition:
		$pattern
}
...
rule regexec_dd152386fcd40d880ec565d99b11885d {
	meta:
...
rule getaddrinfo_3adc05c5d1c0c0a5a9d2db5539d4aa78 {
	meta:
...
rule __GI___xpg_strerror_r_da1818b2da809f0679c2f8e4e838042c {
	meta:
...
rule gethostbyname_r_c5b7d740d24cd1fedf9b7db2f7f528c7 {
	meta:
...
rule random_r_a1626fb992b02a278324aba3af34f142 {
	meta:
...
rule srandom_r_6ddf7968febf9ad47ad869472f3d3562 {
	meta:
...
rule do_des_e756032329a5c2396c3c59be88977301 {
	meta:
		aliases = "do_des"
		size = "829"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 BA 01 00 00 00 56 53 83 EC 3C 83 7C 24 54 00 89 0C 24 0F 84 17 03 00 00 7E 12 C7 44 24 2C ?? ?? ?? ?? C7 44 24 30 ?? ?? ?? ?? EB 14 F7 5C 24 54 C7 44 24 2C ?? ?? ?? ?? C7 44 24 30 ?? ?? ?? ?? 89 C2 89 EB C1 EA 18 0F B6 DF 89 54 24 04 89 EE 89 EA 89 5C 24 0C 81 E5 FF 00 00 00 0F B6 FC 89 6C 24 10 C1 EE 18 8B 6C 24 0C 8B 1C B5 ?? ?? ?? ?? 89 C1 25 FF 00 00 00 0B 1C BD ?? ?? ?? ?? C1 E9 10 0B 1C AD ?? ?? ?? ?? 81 E1 FF 00 00 00 8B 6C 24 04 C1 EA 10 89 44 24 08 8B 04 8D ?? ?? ?? ?? 81 E2 FF 00 00 00 0B 04 AD ?? ?? ?? ?? 8B 6C 24 08 0B 04 AD ?? ?? ?? ?? 8B 6C 24 10 0B 04 95 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule search_object_b4075e45daee629934343a0115dc017d {
	meta:
		aliases = "search_object"
		size = "1676"
		objfiles = "unwind_dw2_fde_glibc@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 9C 00 00 00 89 45 8C 89 55 88 0F B6 50 10 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 88 D0 24 01 84 C0 0F 85 D1 01 00 00 8B 45 8C 8B 48 10 89 C8 C1 E8 0B 0F 84 43 02 00 00 89 45 9C 8B 45 9C 8D 34 85 08 00 00 00 89 34 24 E8 ?? ?? ?? ?? 85 C0 89 45 E4 0F 84 86 01 00 00 C7 40 04 00 00 00 00 89 34 24 E8 ?? ?? ?? ?? 85 C0 89 85 78 FF FF FF 89 45 E8 74 07 C7 40 04 00 00 00 00 8B 45 8C F6 40 10 02 0F 84 63 03 00 00 8B 55 8C 8B 42 0C 8B 08 85 C9 74 19 89 C6 8D 7D E4 8B 45 8C 89 FA E8 67 F9 FF FF 8B 4E 04 83 C6 04 85 C9 75 EC 8B 7D E4 85 FF 89 7D 98 74 0C 8B 45 9C 3B 47 04 0F 85 BE 05 00 }
	condition:
		$pattern
}
...
rule clnt_create_55754770c8a7cd20daad04aef733f7a0 {
	meta:
		aliases = "clnt_create"
		size = "503"
		objfiles = "clnt_generic@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC C4 00 00 00 68 ?? ?? ?? ?? FF 75 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 4D 51 6A 6E 8D 9D 46 FF FF FF 6A 00 53 E8 ?? ?? ?? ?? 58 8D 85 48 FF FF FF 5A 66 C7 85 46 FF FF FF 01 00 FF 75 08 50 E8 ?? ?? ?? ?? 5F C7 45 E8 FF FF FF FF 58 8D 45 E8 6A 00 6A 00 50 FF 75 10 FF 75 0C 53 E8 ?? ?? ?? ?? E9 41 01 00 00 81 EC 10 04 00 00 BB 00 04 00 00 8D 54 24 0F 83 E2 F0 EB 31 83 7D E4 FF 75 0A E8 ?? ?? ?? ?? 83 38 22 74 10 E8 ?? ?? ?? ?? C7 00 0D 00 00 00 E9 4C 01 00 00 01 DB 8D 43 1E 83 E0 F0 29 C4 8D 54 24 0F 83 E2 F0 56 56 8D 45 E4 50 8D 45 F0 50 53 52 8D 45 B4 50 FF 75 08 E8 ?? ?? }
	condition:
		$pattern
}

rule __GI_glob_4b3663ddbe5d61fba083b8221cdcec77 {
	meta:
...
rule glob64_1dd0f01c180a695a093279953117cf45 {
	meta:
...
rule __GI_pthread_cond_wait_b19739e2421c2e8542674b843577de99 {
	meta:
...
rule _Unwind_Find_FDE_5461391f9bc4ce4d17cbe01e56e8061b {
	meta:
		aliases = "_Unwind_Find_FDE"
		size = "270"
		objfiles = "unwind_dw2_fde_glibc@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 1C 8B 75 08 8B BB ?? ?? ?? ?? 85 FF 75 09 EB 76 8B 7F 14 85 FF 74 6F 3B 37 8D 74 26 00 72 F1 89 F2 89 F8 E8 35 F9 FF FF 85 C0 89 45 E0 74 57 8B 47 04 8B 55 0C 89 02 8B 47 08 89 42 04 0F B7 47 10 C1 E8 03 F6 47 10 04 0F B6 C0 0F 85 92 00 00 00 0F B6 F0 89 FA 89 F0 E8 10 EF FF FF 8B 4D E0 8D 55 F0 89 14 24 83 C1 08 89 C2 89 F0 E8 5B EF FF FF 8B 45 F0 8B 55 0C 89 42 08 8B 45 E0 83 C4 1C 5B 5E 5F 5D C3 C7 45 E0 00 00 00 00 8B BB ?? ?? ?? ?? 85 FF 74 E4 8B 47 14 89 F2 89 83 ?? ?? ?? ?? 89 F8 E8 B4 F8 FF FF 8D 8B ?? ?? ?? ?? 89 45 E0 8B 83 ?? }
	condition:
		$pattern
}
...
rule rcmd_d40427893c0c44542a5bb013835562e6 {
	meta:
		aliases = "rcmd"
		size = "1158"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 BE 00 04 00 00 53 83 EC 7C 0F B7 45 0C 89 45 84 E8 ?? ?? ?? ?? 81 EC 10 04 00 00 8D 54 24 0F 83 E2 F0 89 45 8C EB 3C 8B 5D EC 83 FB FF 75 0A E8 ?? ?? ?? ?? 83 38 22 74 19 E8 ?? ?? ?? ?? 83 EC 0C 89 18 8B 55 08 FF 32 E8 ?? ?? ?? ?? E9 1A 04 00 00 01 F6 8D 46 1E 83 E0 F0 29 C4 8D 54 24 0F 83 E2 F0 57 57 8D 45 EC 50 8D 45 E8 50 56 52 8D 45 94 50 8B 45 08 FF 30 E8 ?? ?? ?? ?? 83 C4 20 85 C0 75 A3 8B 45 E8 85 C0 74 9C 66 C7 45 AC 01 00 8B 55 08 83 EC 0C 66 C7 45 B4 01 00 BF 01 00 00 00 8B 00 89 02 68 00 00 40 00 E8 ?? ?? ?? ?? C7 45 E4 FF 03 00 00 89 45 88 83 C4 10 83 EC 0C 8D 75 E4 }
	condition:
		$pattern
}
...
rule __gnat_default_lock_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__enable_execute_stack, __gcov_merge_add, __gcov_merge_single, __clear_cache, __gnat_default_unlock, __gcov_flush, __gcov_merge_delta, __gcov_init, __gnat_default_lock"
		size = "5"
		objfiles = "_gcov_merge_add@libgcov.a, gthr_gnat@libgcc.a, _gcov@libgcov.a, _gcov_merge_single@libgcov.a, _gcov_merge_delta@libgcov.a"
	strings:
...
rule __floatdisf_e876309984bb577e3240555e100f2283 {
	meta:
		aliases = "__floatdisf"
		size = "157"
		objfiles = "_floatdisf@libgcc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 10 89 75 F8 8B 75 08 89 7D FC 8B 7D 0C 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 F0 83 C0 FF 89 FA 81 D2 FF FF 1F 00 81 FA FF FF 3F 00 72 2B 76 5F 31 D2 89 F0 25 FF 07 00 00 89 D1 09 C1 74 1A 89 F0 25 00 F8 FF FF 89 C6 81 CE 00 08 00 00 8D 74 26 00 8D BC 27 00 00 00 00 89 FA 89 F0 8B 7D FC 89 D0 50 89 C2 DB 04 24 C1 FA 1F 31 D2 D8 8B ?? ?? ?? ?? 89 14 24 8B 5D F4 56 8B 75 F8 DF 2C 24 83 C4 08 DE C1 D9 5D F0 D9 45 F0 89 EC 5D C3 83 F8 FE 76 C5 EB 9A }
	condition:
		$pattern
}
...
rule sleep_d05818a2a85f9196e3560cc9968de986 {
	meta:
...
rule __GI_wcswidth_c4657af78a7d397d4f2d2ba28ae2d5ba {
	meta:
		aliases = "wcswidth, __GI_wcswidth"
		size = "84"
		objfiles = "wcswidth@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 31 C9 53 8B 74 24 0C 8B 5C 24 10 EB 0A 89 D0 83 E0 7F 39 C2 75 35 41 39 D9 73 07 8B 14 8E 85 D2 75 EB 31 D2 EB 19 3D FF 00 00 00 7F 1E 83 F8 1F 7E 19 83 E8 7F 83 F8 20 76 11 83 C6 04 42 4B 85 DB 74 0B 8B 06 85 C0 75 DD EB 03 83 CA FF 5B 89 D0 5E C3 }
	condition:
		$pattern
}
...
rule __GI_pthread_getschedparam_02b71e92fc3277e8cb2c54a46c9ee547 {
	meta:
...
rule __GI_xprt_unregister_31f140d9441d655a620b62020f74328b {
	meta:
...
rule __libc_siglongjmp_7f4abd0851d75fdee71ce179f2eb7116 {
	meta:
		aliases = "longjmp, _longjmp, __libc_longjmp, siglongjmp, __libc_siglongjmp"
		size = "55"
...
rule wcsxfrm_37a9225f3624064bda0e10d4e86d0bf9 {
	meta:
...
rule __GI_strlcpy_cc28fde6a217fb7206145cb9a1baff29 {
	meta:
...
rule __GI_fgetgrent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetpwent_r, fgetgrent_r, fgetspent_r, fgetpwent_r, __GI_fgetspent_r, __GI_fgetgrent_r"
		size = "55"
...
rule fgetwc_unlocked_5c04aace4e5964e20b44c3411afd97fc {
	meta:
...
rule fputc_unlocked_8f40897f050da839500afb25c4130c6b {
	meta:
		aliases = "__GI___fputc_unlocked, putc_unlocked, __GI_putc_unlocked, __fputc_unlocked, fputc_unlocked"
		size = "187"
...
rule __GI_readdir64_34c1aa96f08271d791b76726319fd23d {
	meta:
...
rule erf_f298f306799625739c8cfb36a04d42e5 {
	meta:
...
rule vsscanf_1d0d8bfdc5613ccbe27b34742a2f11e1 {
	meta:
...
rule __GI_open_ba06cb787400df0dffd6649ff5a6d12f {
	meta:
		aliases = "open, __libc_open, __GI___libc_open, __GI_open"
		size = "75"
...
rule __GI___dl_iterate_phdr_bb6ace87e508a1473ec656a82e689308 {
	meta:
...
rule __GI_strncat_2929ef6b7125653ad2faba21444bcdc6 {
	meta:
...
rule __GI_strcat_27bbecb28e9449d9ada734b62f64c791 {
	meta:
...
rule __GI___libc_fcntl_067817a35140003195be9463c690719c {
	meta:
		aliases = "__GI_fcntl, __libc_fcntl, fcntl, __GI___libc_fcntl"
		size = "87"
...
rule __GI_ftruncate64_95b06b3d472e26aa20408ae86e0d2988 {
	meta:
...
rule fabs_dbab7381b227300e38753ba084268e4d {
	meta:
...
rule floor_93dfb1d223029e52523bb53cf3cd7fb7 {
	meta:
...
rule __GI_round_8ed2a58d4e5c4a9bd1665278a597ff78 {
	meta:
...
rule lockf_37cc61445f17cc74a9685d29046e5db5 {
	meta:
...
rule lseek64_15f8f44765d19bb5fec6920960413a45 {
	meta:
...
rule vfwprintf_ed2972b616f963225fb6af9f5b3bdfe9 {
	meta:
...
rule __GI_vfprintf_d77484f0c9bf544096428574809919f9 {
	meta:
...
rule __GI_fgetwc_d1aff121aa302794d76ffd1091af3fc3 {
	meta:
		aliases = "fgetwc, fileno, getwc, __GI_fileno, __GI_fgetwc"
		size = "92"
...
rule fputs_656d0461fb753b5b2210fd391d402010 {
	meta:
		aliases = "fputwc, __GI_fputws, putwc, __GI_fputs, fputws, fputs"
		size = "95"
...
rule getgrent_r_d8fe13829bbc6de00d0924445c5077f8 {
	meta:
		aliases = "__GI_getpwent_r, getspent_r, getpwent_r, __GI_getspent_r, __GI_getgrent_r, getgrent_r"
		size = "171"
		objfiles = "getspent_r@libc.a, getpwent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule rresvport_8dbc1a56cf88adacd60d637df8f44dce {
	meta:
...
rule __GI_ftello64_614bd251f831d5fa844c2673380fa104 {
	meta:
...
rule __GI_authnone_create_512249d4a0cb78a2beeeb06d68bd6c68 {
	meta:
...
rule __GI_fwrite_unlocked_8a7aafe5076dca91b4e32e7deca6866b {
	meta:
...
rule __GI_wcscasecmp_b545e7197ada98a9066b86b633755d31 {
	meta:
...
rule __GI_xprt_register_59295c4fc727184b18b593c89add6888 {
	meta:
...
rule __libc_select_a221afd30ee0d1b36e6ec3f9ba426c3c {
	meta:
...
rule __GI_mremap_4d60621f9f9da452e84f45e7d2b7e3c5 {
	meta:
...
rule memcpy_754ecebffab4c50a1057ffee53e12f4b {
	meta:
...
rule __GI_close_0b461328d02cf4abf607f4f99475e435 {
	meta:
...
rule unlink_7d725daad0ac6d7c91e68b106a8fc39e {
	meta:
...
rule __GI_time_0341df9249464b5eaa2086ebd794bc13 {
	meta:
...
rule fsync_44bdc5935720af3a4c1f1ba0cf192ca0 {
	meta:
...
rule uname_660b4724eda2f1a41f26fbc3eee593e2 {
	meta:
...
rule __GI_fchdir_ca4d6d4cd9ae9c8ee45f0b9ee63658d1 {
	meta:
...
rule __libc_write_8ada97812e6179a97f77a736db3ba9ea {
	meta:
...
rule __GI_lseek_f0210736af9ab2dbe6a658a87075a134 {
	meta:
...
rule readlink_aa79077ba661ee4998c3ed81a8a9885b {
	meta:
...
rule setpriority_9506211a543786471a9a6758f25e0ebd {
	meta:
...
rule setitimer_a2b946519abc0e5a8fc212b5a5b5176e {
	meta:
...
rule readv_36f7301bbebcbbc8a1c06586500e31a1 {
	meta:
...
rule poll_c3a743a93f3238f74f7f7e6034acecd8 {
	meta:
...
rule setresuid_55f20f73195a1f1ebaa810c67cf23725 {
	meta:
...
rule __GI___libc_fcntl64_579a8cd33a1bbf2fdfff054eae624ac8 {
	meta:
		aliases = "__GI_fcntl64, fcntl64, __libc_fcntl64, __GI___libc_fcntl64"
		size = "63"
...
rule strncasecmp_6ec7fa9bd31c4c5a6d6d9a2b152480a2 {
	meta:
...
rule wctype_50e80352cc999abf107e4f9290013692 {
	meta:
		aliases = "wctrans, __GI_wctrans, __GI_wctype, wctype"
		size = "61"
...
rule __GI_wcstoul_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "strtouq, strtoull, waitpid, wcstoumax, wcstoull, __GI_strtoull, __GI_wcstoull, strtoul, __libc_waitpid, wcstouq, strtoumax, __GI_waitpid, wcstoul, __GI_strtoul, __GI_wcstoul"
		size = "26"
		objfiles = "strtoul@libc.a, wcstoul@libc.a, strtoull@libc.a, wcstoull@libc.a, waitpid@libc.a"
	strings:
...
rule strtol_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "wcstoll, strtoimax, strtoq, strtoll, __GI_wcstol, wcstol, wcstoimax, __GI_strtol, wcstoq, __GI_wcstoll, __GI_strtoll, strtol"
		size = "26"
...
rule sigaddset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigdelset, sigismember, __GI_sigaddset, __GI_sigdelset, sigaddset"
		size = "42"
...
rule cfsetospeed_3b1f701ec3e7f14813bc7534122f7dd2 {
	meta:
...
rule lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "gamma, __GI_lgamma, __GI_strtok, __ieee754_gamma, strtok, __ieee754_lgamma, lgamma"
		size = "25"
		objfiles = "w_gamma@libm.a, w_lgamma@libm.a, e_lgamma@libm.a, e_gamma@libm.a, strtok@libc.a"
	strings:
...
rule atol_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "__GI_atoi, __GI_atol, atoi, atoll, atol"
		size = "20"
...
rule scalblnf_312f3131b70190222fba14e3c3defea1 {
	meta:
		...
		size = "34"
		objfiles = "scalbnf@libm.a, ldexpf@libm.a, scalblnf@libm.a, frexpf@libm.a"
	strings:
...
rule vscanf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "__GI_vscanf, vwprintf, vwscanf, vprintf, vscanf"
		size = "26"
...
rule __GI_asctime_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "hcreate, __GI_inet_ntoa, srand48, ether_ntoa, inet_ntoa, asctime, __GI_asctime"
		size = "21"
...
rule timelocal_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "iswalnum, __GI_iswalnum, mktime, mkstemp64, timelocal"
		size = "18"
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "manager@libpthread.a, semaphore@libpthread.a, join@libpthread.a, spinlock@libpthread.a, condvar@libpthread.a"
	strings:
...
rule __pthread_once_fork_prepare_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__pthread_once_fork_parent, getlogin, __GI_getlogin, hdestroy, _flushlbf, __pthread_once_fork_prepare"
		size = "17"
...
rule _dl_app_init_array_8d2509fbeabb04bc47cf41d0b9e2530e {
	meta:
		aliases = "getwchar_unlocked, _dl_app_fini_array, getwchar, _dl_app_init_array"
		size = "18"
...
rule xdrstdio_putlong_f12178a88d7440fed94be0dc4d88957c {
	meta:
...
rule __GI_printf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "scanf, wscanf, printf, wprintf, __GI_printf"
		size = "32"
...
rule __GI_fscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "asprintf, fwprintf, syslog, swscanf, fwscanf, __GI_sscanf, __GI_fprintf, fprintf, __GI_syslog, fscanf, dprintf, sscanf, __GI_asprintf, __GI_fscanf"
		size = "30"
		objfiles = "swscanf@libc.a, fwprintf@libc.a, sscanf@libc.a, syslog@libc.a, fscanf@libc.a"
	strings:
...
rule lrintf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "llrintf, ilogbf, lroundf, llroundf, lrintf"
		size = "19"
...
rule fabsf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "logf, sqrtf, atanhf, sinhf, lgammaf, atanf, log10f, expf, cbrtf, ceilf, erfcf, coshf, roundf, tanhf, cosf, truncf, tgammaf, erff, tanf, acosf, logbf, asinf, sinf, expm1f, log1pf, rintf, asinhf, acoshf, floorf, fabsf"
		size = "27"
		objfiles = "ceilf@libm.a, asinhf@libm.a, erfcf@libm.a, atanhf@libm.a, fabsf@libm.a"
	strings:
...
rule hypotf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "powf, fmodf, atan2f, copysignf, nextafterf, remainderf, hypotf"
		size = "35"
		objfiles = "hypotf@libm.a, atan2f@libm.a, nextafterf@libm.a, powf@libm.a, remainderf@libm.a"
	strings:
...
rule fmax_2f5710279cce3b45eccc1276c8442291 {
	meta:
...
rule getgrgid_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "getpwuid, getspnam, fgetpwent, getpwnam, getgrnam, fgetgrent, sgetspent, fgetspent, getgrgid"
		size = "40"
		objfiles = "getgrgid@libc.a, sgetspent@libc.a, getgrnam@libc.a, fgetgrent@libc.a, fgetspent@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		size = "4"
		objfiles = "unwind_sjlj@libgcc.a, _fixunsdfsi@libgcc.a, _floatdidf@libgcc.a, _fixunsxfsi@libgcc.a, gthr_gnat@libgcc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		size = "4"
		objfiles = "atexits@uclibc_nonshared.a, _powidf2@libgcc.a, _floatdisf@libgcc.a, crtendS, _powisf2@libgcc.a"
	strings:
...
rule __pthread_mutexattr_gettype_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_rwlockattr_getkind_np, pthread_attr_getdetachstate, pthread_mutexattr_getkind_np, __GI_pthread_attr_getdetachstate, pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype"
		size = "15"
...
rule svctcp_freeargs_bfec9dbc9e68cac70cd6ac3f54a6e76c {
	meta:
...
rule __GI_ffs_d06d3603981a61645a0cd65f31e572f5 {
	meta:
...
rule __isinff_3008b927f3adc9ce70ecb6608f718f86 {
	meta:
...
rule toupper_d7d4521aee6b4c2c35428947fe099a90 {
	meta:
		aliases = "tolower, __GI_toupper, __GI_tolower, toupper"
		size = "29"
...
rule __pthread_mutexattr_setkind_np_c966b71060253b953a535d91cc13d1cf {
	meta:
		aliases = "pthread_mutexattr_settype, __pthread_mutexattr_settype, pthread_mutexattr_setkind_np, __pthread_mutexattr_setkind_np"
		size = "23"
		objfiles = "mutex@libpthread.a"
	strings:
...
rule authnone_validate_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "__GI_xdr_void, floatformat_always_valid, xdr_void, _stdlib_mb_cur_max, __GI__stdlib_mb_cur_max, old_sem_extricate_func, authnone_validate"
		size = "6"
...
rule rendezvous_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_unix@libc.a, svc_raw@libc.a, svc_authux@libc.a, svc_tcp@libc.a, svc_udp@libc.a"
	strings:
...
rule __GI___errno_location_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__h_errno_location, __GI___h_errno_location, __errno_location, __libc_pthread_init, __GI___errno_location"
		size = "6"
...
rule svcraw_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "noop_handler, __linuxthreads_reap_event, __cyg_profile_func_exit, clntraw_destroy, clntunix_abort, authnone_destroy, __linuxthreads_create_event, clntraw_abort, __cyg_profile_func_enter, __stub1, clntudp_abort, pthread_handle_sigdebug, authunix_nextverf, clnttcp_abort, pthread_null_sighandler, __pthread_return_void, __stub2, xdrmem_destroy, _pthread_cleanup_push_defer, clntraw_geterr, _pthread_cleanup_pop_restore, authnone_verf, __linuxthreads_death_event, svcraw_destroy"
		size = "1"
		objfiles = "svc_raw@libc.a, clnt_raw@libc.a, noophooks@libc.a, clnt_tcp@libc.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule mq_close_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "xdr_u_longlong_t, scalb, remainder, yn, __GI_remainder, __ieee754_gamma_r, __GI_xdr_enum, cosh, partition_delete, splay_tree_xmalloc_deallocate, xdr_enum, y0, __GI_nearbyint, __GI_acosh, setmntent, drem, __GI_xdr_int, rand, __GI_sinh, log, __decode_packet, __GI_hypot, __GI_xdr_u_int, xdr_int, __GI_acos, nearbyint, j1, log2, __GI_setmntent, y1, xdr_longlong_t, pow, acosh, __pthread_initialize, __GI_cosh, xdr_u_int, j0, cabs, __GI_atan2, __GI_cabs, __GI_pow, __GI_log10, __GI_atanh, sinh, sqrt, lgamma_r, vfork, atan2, __GI_fmod, asin"
		size = "5"
		objfiles = "w_atanh@libm.a, w_sqrt@libm.a, w_cosh@libm.a, xdr@libc.a, e_gamma_r@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
