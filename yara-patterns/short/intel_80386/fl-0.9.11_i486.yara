...
rule __GI_wcsftime_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "pthread_attr_destroy, grantpt, __pthread_mutex_unlock, authnone_refresh, pthread_rwlockattr_destroy, pthread_condattr_init, __pthread_mutex_lock, _svcauth_null, __pthread_return_0, __pthread_mutex_init, __GI_pthread_condattr_init, __GI_pthread_condattr_destroy, __GI_pthread_attr_destroy, pthread_condattr_destroy, clntraw_control, pthread_mutexattr_destroy, xdrstdio_inline, __pthread_mutex_trylock, wcsftime, __pthread_mutexattr_destroy, __GI_wcsftime"
		size = "3"
		objfiles = "auth_none@libc.a, attr@libpthread.a, wcsftime@libc.a, rwlock@libpthread.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __GI_gethostname_26055035bb38fb1b5ac6786bbafed770 {
	meta:
...
rule getdomainname_dfc5d78b3ad798eb8be58989de887c2d {
	meta:
...
rule __GI_strsignal_99ea55dc6ea0fc240487036cdcd4b2e2 {
	meta:
...
rule freeaddrinfo_24d5026326742a6e550987ffb2d0dc27 {
	meta:
...
rule brk_c71cc48e1ebb66833d806df1647dc754 {
	meta:
...
rule pthread_attr_init_6c766544b51e58e5583224b8283cd472 {
	meta:
...
rule __GI_endrpcent_64d52b1b43cf32c3631ef021483c0b69 {
	meta:
...
rule __GI_setrpcent_441006847e7e51489a29b7dbb5423ebd {
	meta:
...
rule __GI_jrand48_r_11f3874b93b1169cbbf15b23c8825b7a {
	meta:
...
rule __GI_nrand48_r_6465f36196702099ad69c85456c93e51 {
	meta:
...
rule getc_unlocked_92bdc4c8003915a3ddbe7d653a878939 {
	meta:
		aliases = "__GI_getc_unlocked, __fgetc_unlocked, __GI___fgetc_unlocked, __GI_fgetc_unlocked, fgetc_unlocked, getc_unlocked"
		size = "220"
...
rule __GI_ilogb_f761977931dddcba673a5b3b42b293c1 {
	meta:
...
rule recvmsg_f76fa2a31d5e51010722d3c9bb015e20 {
	meta:
		aliases = "msync, read, connect, write, recvmsg"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule waitpid_b5bba3555d24a798c0dcf18747bdb9a3 {
	meta:
		aliases = "__GI_waitpid, lseek, sendmsg, accept, waitpid"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_svcerr_noprog_191164ee7de49f4a45e7d01102b34817 {
	meta:
...
rule svcerr_progvers_c0d86089f080a5e203734f7037a52413 {
	meta:
...
rule pread_8810fe4c8dbaf93db0b2807cdd400643 {
	meta:
		aliases = "__libc_pread, mq_send, mq_receive, pread"
		size = "35"
...
rule glob_pattern_p_f9defe124f82dbc1b9c06812650033cd {
	meta:
...
rule clnt_spcreateerror_39a61559a988d408ff47aba5c03cc9f0 {
	meta:
...
rule __GI_svc_getreq_common_c59f2e3a499e23b5108e3b99f68810a5 {
	meta:
...
rule openpty_b528617ca1876ac5539191845b63a915 {
	meta:
...
rule clnt_sperror_912a6e8105fe071d038c2510d148f2a4 {
	meta:
...
rule __GI_rexec_af_d3efd48bbe9fa3b26e9631bc995b0978 {
	meta:
...
rule __GI_sleep_ae719f65eab24bdf0878363c319fd0c0 {
	meta:
...
rule __GI_ttyname_r_a273ff26e896b29af598b023e8b5a27b {
	meta:
...
rule __GI_inet_aton_6720a484cd356159a78db2ca9532dc95 {
	meta:
...
rule regerror_97663fd4b2b36f16cb545a9f5e35cf97 {
	meta:
...
rule __ns_name_unpack_3dcb77db3a90707f3e9ac8954733d302 {
	meta:
...
rule __GI_sgetspent_r_e28c114c6f91c7dc0910a1a228c34307 {
	meta:
...
rule setstate_r_7fe532f1fafe94a9f188bdc094d3a9b6 {
	meta:
...
rule svc_getreq_poll_1e54a2a6bfea763f6285d8c20bc9e84c {
	meta:
...
rule getenv_5dcfd56dc7e5924bf2fc330b1a43d2e5 {
	meta:
...
rule __GI_qsort_bafae48377ebde27aabe139d7785f25b {
	meta:
...
rule __GI_fgetws_unlocked_d99141f9a41d1ac2ef5dfb6ee2b3178f {
	meta:
...
rule __GI_svc_getreqset_91e62f0926eb1599e1c85bb536593c41 {
	meta:
...
rule xdr_bytes_22acc711e442399613dffe1e339e974e {
	meta:
...
rule getpwuid_r_b6064fe98627534bbf7fad9a44387570 {
	meta:
...
rule __GI_getgrnam_r_520f0bca15a222178f21171c2fc55dbf {
	meta:
...
rule __GI_srandom_r_e875de7fc38d3225b1ff6c034e8b687a {
	meta:
...
rule fnmatch_74482755c072c7d24bfdf7593e67af5b {
	meta:
...
rule __GI_mbsnrtowcs_85ad3122d2f3f7a6298010b15c90a819 {
	meta:
...
rule getwc_unlocked_c23c63c63488ef714b1bad2d3155579c {
	meta:
...
rule getdelim_2bf86743842064a6c97e6e1d2715fad6 {
	meta:
...
rule setvbuf_5379b6eee0c89f7fe8b6dc62b07fa7dc {
	meta:
...
rule __GI_ungetwc_e23ba96952b32f960b1573650cf57f7d {
	meta:
...
rule ungetc_382824eaa075fde4bf23ffe6daf89d3a {
	meta:
...
rule svc_register_4472b2e5f1ee6e311462a224812f2c0e {
	meta:
...
rule ptsname_r_c93365cec3b5777bdc800dfd5a2b0997 {
	meta:
...
rule __GI_getprotobyname_r_763556cced7ac8564ae83910a4d9f0a2 {
	meta:
...
rule readdir64_r_f6a34d6e063c54f05fa1df5ccb9337a4 {
	meta:
...
rule xdrrec_create_8772771b2ea7c0eaf61f376c71dbc918 {
	meta:
...
rule inet_pton_f6f9b6efb2e94630b492a4553bf3340a {
	meta:
...
rule __GI___ns_name_ntop_40bb87efc8921f4b166e5ca8fffa66c4 {
	meta:
...
rule __GI_lockf64_a0ed670fc6cf6c337d50a9938b44cacf {
	meta:
...
rule rtime_afa72f1acb3ee976e4f038655395a5a7 {
	meta:
...
rule __GI_llround_9e6d3d92229bf5edfe6e19810a4170a1 {
	meta:
...
rule lrint_66b779f6f71fc3162e8590cb2a7c68a8 {
	meta:
...
rule __GI_clnttcp_create_c2d5016723b6213c964636351eef9888 {
	meta:
...
rule __GI_gethostbyname_r_577a4809eca1461f4f568cda7bdd4209 {
	meta:
...
rule __GI_clntudp_bufcreate_8c2d993965a8bacc11ba70933f5425ec {
	meta:
...
rule __GI_gethostbyaddr_r_06b247cdb23f20ecec32bc045987bd96 {
	meta:
...
rule strftime_59a9dacb29dece606ac3eee517f736d6 {
	meta:
...
rule strptime_a2aa17f4961902840714ba78a3d3e601 {
	meta:
...
rule random_r_f4380743c0cb10b41c9ed7bf8d26e5e0 {
	meta:
...
rule _Unwind_GetTextRelBase_140843736b3275eead73f559484bfef9 {
	meta:
		aliases = "_Unwind_GetRegionStart, __udiv_w_sdiv, _Unwind_FindEnclosingFunction, __gthread_active_p, _Unwind_GetDataRelBase, _Unwind_GetTextRelBase"
		size = "7"
...
rule execlp_d95bb4a820fb6e471e9dfc02c6dd0de0 {
	meta:
...
rule __GI_ruserpass_3845da2a83c605b7434081301d20e4a9 {
	meta:
...
rule nan_9bc31f50cd8270123206ef2030dcf46b {
	meta:
...
rule __GI_nanf_454b8f9a43331570e81b9637d10a4347 {
	meta:
...
rule __GI_pthread_cond_wait_418fe441485ce6526cced6e63bc4a70c {
	meta:
...
rule __GI_execvp_a79d91337e93696f82147998c30784ea {
	meta:
...
rule __GI_execle_398160867dcf5e08b9e53f596d308a53 {
	meta:
...
rule __GI_if_nameindex_0f87366271a49e86f9f314443570be86 {
	meta:
...
rule __enable_execute_stack_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gcov_merge_add, __gcov_flush, __gcov_merge_delta, __gnat_default_lock, __gcov_init, __clear_cache, __gnat_default_unlock, __gcov_merge_single, __enable_execute_stack"
		size = "5"
		objfiles = "gthr_gnat@libgcc_eh.a, _gcov_merge_delta@libgcov.a, _gcov_merge_add@libgcov.a, _gcov_merge_single@libgcov.a, _clear_cache@libgcc.a"
	strings:
...
rule thread_self_d71c1c543da7010362c2339043c20f2c {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "join@libpthread.a, rwlock@libpthread.a, pthread@libpthread.a, specific@libpthread.a, errno@libpthread.a"
	strings:
...
rule tmpfile64_8d4d83ff62fa028a608515104a723b4c {
	meta:
...
rule sigaction_7c4c0fb5708faab03709e6cd6f1ba20f {
	meta:
...
rule sem_post_def2f25588a40b228910d085fa1507da {
	meta:
...
rule __GI_strchrnul_42bd722abdcbc5006c6980de65076f17 {
	meta:
...
rule sem_trywait_34c79f28f3b08916bb1cd9a9c2d60b26 {
	meta:
...
rule pthread_cond_broadcast_cf20cc5bd91ece76ebc513c84b4ad47d {
	meta:
...
rule __GI_globfree64_d18ea5f3312296e271736973f89b424e {
	meta:
		aliases = "__GI_globfree, globfree, globfree64, __GI_globfree64"
		size = "76"
...
rule herror_9a2f9c53979935e193f96d9b7ff8f33a {
	meta:
...
rule pthread_attr_setguardsize_bb55cdebea2c7dec3a6981587089d857 {
	meta:
...
rule pthread_cond_signal_6505f463b6c56b45fa1b102172ea72c3 {
	meta:
...
rule setegid_eac46212fcce22296a0f5f5d314593e6 {
	meta:
...
rule tsearch_5720b721a5baf30c1446f2575b1e9335 {
	meta:
...
rule __GI_xdr_callmsg_b39d39b06ea14824a2e6aadbb5ee9df0 {
	meta:
...
rule siglongjmp_c6cf49351096c713c12b4029e4e28a99 {
	meta:
		aliases = "__libc_longjmp, longjmp, _longjmp, __libc_siglongjmp, siglongjmp"
		size = "51"
...
rule tfind_8ef44e36bbe4faca5acb8715d9aa0383 {
	meta:
...
rule xdr_callhdr_09295c3900c9bbfc91940914ec48f078 {
	meta:
...
rule hcreate_r_d79cb6f3f330e9aa15d02369ce2067b8 {
	meta:
...
rule __GI_mempcpy_fc1aa9b4268df2c2e5191bbb3a10dd56 {
	meta:
...
rule svcunix_reply_9132e91328c623d276b5b74e38fcf309 {
	meta:
...
rule __GI_xdr_opaque_auth_5e1dff17a3ebe6b7a389979d4d335a66 {
	meta:
...
rule xdr_replymsg_aff4d942266a12f8e1fefb038e08bc3b {
	meta:
...
rule __GI_xdr_accepted_reply_084ba190918286d1026e34270f66e635 {
	meta:
...
rule xdr_authunix_parms_3f4463dc51d054c821814c66bdc793ca {
	meta:
...
rule fputws_unlocked_7b4a4750f701305da94cb5bc7e694e5c {
	meta:
...
rule fgetspent_r_82a6a9c51768278cc2c69d0f50defec1 {
	meta:
		aliases = "fgetgrent_r, __GI_fgetgrent_r, fgetpwent_r, __GI_fgetpwent_r, __GI_fgetspent_r, fgetspent_r"
		size = "55"
...
rule __GI_ftell_1269a363713370ece21c4440adabd7d6 {
	meta:
...
rule __GI_xdr_u_hyper_01ddd05be95913152bda660d92058467 {
	meta:
...
rule getc_8b451145c5c85f5240f6ce41b4ff2173 {
	meta:
...
rule __GI_openlog_b9df32826e2ab5860b3ec9956d3b73de {
	meta:
...
rule __GI_erand48_r_9ed5c3ecbe5ad2fc4eebaa676062afe3 {
	meta:
...
rule pmap_set_ab33fb6712437a4ca99bbda0fba4290e {
	meta:
...
rule remquo_9f063c4de99c3de03ea6f1899a6c55da {
	meta:
...
rule __GI_tcgetattr_c89694447acf1925ab58d0d6ff8ad13d {
	meta:
...
rule __GI_erf_2fb4c6e8e3689b0fcf2fecadabee9981 {
	meta:
...
rule __GI_cbrt_2d20bb1ddff5e1f4de7d68067203f1c6 {
	meta:
...
rule __GI_strrchr_738aaa8a9844d021b20e0b9e74e6bb20 {
	meta:
...
rule __GI_open_9b664c97270d72c149d1365d6d26566d {
	meta:
...
rule __GI_xdr_string_73b8dc22b6a5bf76d1e5f2dce7c594fe {
	meta:
...
rule __GI_fgetwc_b689731659256f78e8cd210467d375a8 {
	meta:
...
rule fputs_eeac17f7362809bc8dda555980909188 {
	meta:
		aliases = "fputwc, putwc, __GI_fputws, fputws, __GI_fputs, fputs"
		size = "95"
...
rule fgetws_7cb02aab089f718e67bb8de99cea1e29 {
	meta:
...
rule fwrite_96f979affe6ac82a825dd73cb9bfe457 {
	meta:
...
rule __GI_fputc_82f0145acafa4972f0b86a77fbcaec6f {
	meta:
...
rule __GI___dl_iterate_phdr_d977e78ce6fa39deee2f96dfaadd9b2f {
	meta:
...
rule asctime_r_bfcbbfe8045804f5fa4e067aba6e3cf4 {
	meta:
...
rule __GI_localtime_r_dbc70031f9e99d21d84f741235ef5e46 {
	meta:
...
rule getgrent_r_55330fa262cb426b61ec2bf4b987d33f {
	meta:
		aliases = "getspent_r, __GI_getgrent_r, __GI_getspent_r, getpwent_r, __GI_getpwent_r, getgrent_r"
		size = "171"
		objfiles = "getspent_r@libc.a, getgrent_r@libc.a, getpwent_r@libc.a"
	strings:
...
rule ftello64_d7fe2d2ca6607a4834f73ce1631ba010 {
	meta:
...
rule __GI_if_nametoindex_ce164ff771686f826dabbea381a7b6d4 {
	meta:
...
rule __GI_rint_a2c84a0b3529e2a514e6dce1ea67581a {
	meta:
...
rule modf_a202645b8bfc1188ffe6a1e5544d854f {
	meta:
...
rule __GI_vsnprintf_f255c6ff5934a5d501527e392f3bbbca {
	meta:
...
rule opendir_1b6ed033a8bbdec1190b95c18395bf28 {
	meta:
...
rule strndup_f3499d35f179e80d3a367ff0caeb841e {
	meta:
...
rule __GI_strdup_8f030be86eee5afe9177a12a1330a4c2 {
	meta:
...
rule mknod_9f26d16c708d150accf3e135728fda1a {
	meta:
...
rule __GI_lfind_94e8ae75adf229abede616435c5312b5 {
	meta:
...
rule __GI_wctrans_8a4d087639cfab401aa2be368523356c {
	meta:
...
rule strncat_087bf8e3075fdca29d98967594d20f8f {
	meta:
...
rule __GI_sigprocmask_c9246d449d20e85ecafe84f8fe06c3ee {
	meta:
...
rule __GI_mknodat_5c586dfe9d5516067f96897a1f0dbfd1 {
	meta:
...
rule __GI_ioctl_014db8a7925058a6f77a73ba3b234ee1 {
	meta:
...
rule __GI___libc_fcntl64_9226c6c9fddd63826079fb38276bf98f {
	meta:
...
rule __GI_sigsetmask_4c8c9e34f1435221b9992a2e1ada46d5 {
	meta:
...
rule sysv_signal_f22ca379987e5ce1652dcb37603a1974 {
	meta:
...
rule __GI_wcstoul_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "__GI_waitpid, wcstouq, strtoul, wcstoumax, __GI_wcstoull, wcstoul, __libc_waitpid, wcstoull, waitpid, __GI_strtoul, strtoumax, __GI_strtoull, strtoull, strtouq, __GI_wcstoul"
		size = "26"
...
rule wcstoll_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "__GI_strtol, strtoimax, strtoq, __GI_wcstoll, wcstoq, strtoll, strtol, wcstol, wcstoimax, __GI_strtoll, __GI_wcstol, wcstoll"
		size = "26"
...
rule __GI_getchar_unlocked_ba7c93b352215253e7885b79ebd7ebaa {
	meta:
...
rule __GI_cfsetospeed_5df8d9ebecb9d856ede3bfbf86c057f4 {
	meta:
...
rule __GI___isnan_a6fcd1b1737635ad82f82d13290b7120 {
	meta:
...
rule __finite_0008bd168b8ffff7aeaad093f06f8bce {
	meta:
...
rule __isinf_e1fceb4644d854b85450d40707e6b5aa {
	meta:
...
rule __ieee754_gamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "strtok, __GI_strtok, __ieee754_lgamma, lgamma, __GI_lgamma, gamma, __ieee754_gamma"
		size = "25"
...
rule atoi_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "atol, __GI_atoi, atoll, __GI_atol, atoi"
		size = "20"
...
rule frexpf_312f3131b70190222fba14e3c3defea1 {
	meta:
		aliases = "ldexpf, scalbnf, scalblnf, frexpf"
		size = "34"
...
rule asctime_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "srand48, __GI_inet_ntoa, inet_ntoa, hcreate, ether_ntoa, __GI_asctime, asctime"
		size = "21"
		objfiles = "asctime@libc.a, inet_ntoa@libc.a, srand48@libc.a, hsearch@libc.a, ether_addr@libc.a"
	strings:
...
rule __GI_iswalnum_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "mktime, mkstemp64, timelocal, iswalnum, __GI_iswalnum"
		size = "18"
...
rule pone_4a5bbfcf7613b136b7891fc774fb20a7 {
	meta:
		aliases = "pzero, pone"
		size = "175"
...
rule __GI_fabs_05a32123bf082b052d4b26451d6753d1 {
	meta:
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "join@libpthread.a, rwlock@libpthread.a, pthread@libpthread.a, spinlock@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule __pthread_once_fork_prepare_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "getlogin, __pthread_once_fork_parent, _flushlbf, hdestroy, __GI_getlogin, __pthread_once_fork_prepare"
		size = "17"
...
rule __re_compile_pattern_54bb38dd9a2c6ee34c76a6dcd3f3f6da {
	meta:
...
rule xdrstdio_getint32_bcf753d65df04347dbad1b2cd0800d1b {
	meta:
...
rule __GI___libc_open64_065a259e65a14bc1252966bf022b8687 {
	meta:
...
rule wprintf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "wscanf, __GI_printf, printf, scanf, wprintf"
		size = "32"
...
rule sscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "syslog, __GI_syslog, __GI_fscanf, fwscanf, fwprintf, asprintf, fprintf, fscanf, __GI_fprintf, swscanf, __GI_sscanf, dprintf, __GI_asprintf, sscanf"
		size = "30"
		objfiles = "syslog@libc.a, sscanf@libc.a, fwscanf@libc.a, fscanf@libc.a, fwprintf@libc.a"
	strings:
...
rule lrintf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "lroundf, llroundf, ilogbf, llrintf, lrintf"
		size = "19"
...
rule logbf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "lgammaf, tanf, roundf, logf, expm1f, cbrtf, acosf, fabsf, expf, ceilf, sinf, log2f, atanhf, erff, tanhf, truncf, coshf, rintf, sinhf, log1pf, erfcf, exp2f, asinhf, floorf, log10f, sqrtf, asinf, cosf, atanf, acoshf, tgammaf, logbf"
		size = "27"
		objfiles = "atanhf@libm.a, atanf@libm.a, roundf@libm.a, log1pf@libm.a, logbf@libm.a"
	strings:
...
rule atan2f_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "remainderf, powf, fmodf, nextafterf, hypotf, copysignf, atan2f"
		size = "35"
		objfiles = "nextafterf@libm.a, hypotf@libm.a, atan2f@libm.a, fmodf@libm.a, powf@libm.a"
	strings:
...
rule __GI_wcstod_933c5f43d5ab233ccdd1cdce8fe5644f {
	meta:
		aliases = "__GI_strtod, wcstod, strtod, __GI_wcstod"
		size = "49"
...
rule getspnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetgrent, fgetpwent, getpwuid, getgrgid, getpwnam, fgetspent, sgetspent, getgrnam, getspnam"
		size = "40"
		objfiles = "getgrnam@libc.a, getpwuid@libc.a, getpwnam@libc.a, fgetspent@libc.a, fgetpwent@libc.a"
	strings:
...
rule wcrtomb_96bfa2933e3da723dc94e1de4e68ccb5 {
	meta:
...
rule __GI_expm1_d88154254719242540cfc0a6177173d1 {
	meta:
...
rule __GI_pthread_attr_getdetachsta_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, pthread_mutexattr_getkind_np, pthread_rwlockattr_getkind_np, pthread_mutexattr_gettype, __pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate"
		size = "15"
...
rule ffs_2b5de0c83bb80eca92d688540d0592ff {
	meta:
...
rule svctcp_getargs_5505a2426bca0e46df0666a9dde0cad6 {
	meta:
...
rule __GI_wcscpy_66594f22f089e8ab8867bac27481e917 {
	meta:
...
rule __pthread_attr_setstackaddr_a0613757e730bad6d782fdcbd86589ca {
	meta:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "floatformat_always_valid, _stdlib_mb_cur_max, authnone_validate, __GI__stdlib_mb_cur_max, old_sem_extricate_func, __GI_xdr_void, xdr_void"
		size = "6"
		objfiles = "auth_none@libc.a, floatformat@libiberty.a, _stdlib_mb_cur_max@libc.a, oldsemaphore@libpthread.a, xdr@libc.a"
	strings:
...
rule __libc_pthread_init_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__h_errno_location, __GI___errno_location, __GI___h_errno_location, __errno_location, __libc_pthread_init"
		size = "6"
...
rule localeconv_5103b042467f0d3949b3e064e2091f16 {
	meta:
...
rule _pthread_cleanup_push_defer_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "svcraw_destroy, clntunix_abort, clntraw_destroy, __linuxthreads_death_event, clntraw_geterr, xdrmem_destroy, __stub2, __linuxthreads_reap_event, authnone_destroy, clntraw_abort, clnttcp_abort, pthread_handle_sigdebug, authnone_verf, __stub1, clntudp_abort, __pthread_return_void, authunix_nextverf, __cyg_profile_func_enter, _pthread_cleanup_pop_restore, noop_handler, __cyg_profile_func_exit, __linuxthreads_create_event, pthread_null_sighandler, _pthread_cleanup_push_defer"
		size = "1"
		objfiles = "auth_none@libc.a, nsl@libnsl.a, clnt_udp@libc.a, noophooks@libc.a, events@libpthread.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule __GI_setmntent_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "acos, splay_tree_xmalloc_deallocate, hypot, xdr_u_longlong_t, __GI_xdr_int, sinh, setmntent, jn, j0, scalb, __decode_packet, xdr_int, rand, log, __GI_cabs, __pthread_initialize, nearbyint, atanh, __GI_xdr_u_int, __GI_cosh, __GI_sinh, y0, __GI_acos, pow, __GI_asin, atan2, xdr_u_int, y1, __GI_acosh, acosh, __GI_fmod, partition_delete, fmod, vfork, j1, xdr_longlong_t, __GI_pow, remainder, asin, log10, log2, exp, __ieee754_gamma_r, sqrt, __GI_hypot, __GI_atan2, __GI_exp, __GI_atanh, __GI_log10, xdr_enum"
		size = "5"
		objfiles = "w_j1@libm.a, w_scalb@libm.a, w_exp@libm.a, w_log2@libm.a, w_log@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
