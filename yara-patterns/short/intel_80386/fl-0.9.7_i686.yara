...
rule __pthread_return_0_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "__GI_pthread_condattr_init, __pthread_mutex_init, __GI_pthread_attr_destroy, pthread_condattr_destroy, clntraw_control, __pthread_mutex_unlock, __pthread_mutex_lock, xdrstdio_inline, pthread_attr_destroy, authnone_refresh, pthread_rwlockattr_destroy, wcsftime, _svcauth_null, __pthread_mutexattr_destroy, pthread_condattr_init, grantpt, __GI_pthread_condattr_destroy, __GI_wcsftime, __pthread_mutex_trylock, pthread_mutexattr_destroy, __pthread_return_0"
		size = "3"
		objfiles = "auth_none@libc.a, clnt_raw@libc.a, grantpt@libc.a, mutex@libpthread.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule signal_126cff4a00751967edf4b225069665be {
	meta:
		aliases = "__GI_signal, bsd_signal, __bsd_signal, signal"
		size = "175"
...
rule __libc_getdomainname_8b4ef73be17f423b0978b5e948c46812 {
	meta:
		aliases = "getdomainname, __GI_getdomainname, __GI___libc_getdomainname, __libc_getdomainname"
		size = "101"
...
rule __GI_fstatfs_be68736929ed9e4e1a0623b90d5be2a4 {
	meta:
		aliases = "__GI___libc_fstatfs, fstatfs, __libc_fstatfs, __GI_fstatfs"
		size = "49"
...
rule create_module_4cffba0eafbcc07d76c13126a301fea7 {
	meta:
		aliases = "create_module"
		size = "79"
		objfiles = "create_module@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 7F 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 89 C3 76 0B E8 ?? ?? ?? ?? F7 DB 89 18 EB 05 83 F8 FF 75 1B E8 ?? ?? ?? ?? 8B 10 89 C1 83 C8 FF 83 FA 7D 7E 0A 89 D0 F7 D8 C7 01 00 00 00 00 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule pzero_85f48d052004ea7fe280ee7efdb1c73b {
	meta:
		aliases = "pone, pzero"
		size = "184"
...
rule __GI_getc_unlocked_7234bf2292c7e7a4e6fb4c246bfcefbf {
	meta:
		aliases = "__GI_fgetc_unlocked, __fgetc_unlocked, fgetc_unlocked, __GI___fgetc_unlocked, getc_unlocked, __GI_getc_unlocked"
		size = "220"
...
rule endprotoent_f468964b8937d2560c1930edef041633 {
	meta:
		aliases = "__GI_endprotoent, endnetent, __GI_endnetent, endprotoent"
		size = "92"
...
rule __GI_endservent_156ae97268099fd93fb77aab1b44a9cf {
	meta:
...
rule __GI_waitpid_74030486c498b35deba130245259f53b {
	meta:
		aliases = "sendmsg, accept, lseek, waitpid, __GI_waitpid"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule msync_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "write, connect, read, recvmsg, msync"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __GI_sigsuspend_618d9a0a73b3d315039ee831baf24e65 {
	meta:
...
rule sleep_095ee5dbd5251b21e1cbfec4e20a2b4a {
	meta:
...
rule __gthread_active_p_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "_Unwind_GetDataRelBase, _Unwind_FindEnclosingFunction, __udiv_w_sdiv, _Unwind_GetTextRelBase, _Unwind_GetRegionStart, __gthread_active_p"
		size = "7"
		objfiles = "gthr_gnat@libgcc.a, unwind_sjlj@libgcc.a, _udiv_w_sdiv@libgcc.a"
	strings:
...
rule _dl_load_elf_shared_library_35c10134a9be55cd2a5ec398c8ab94c6 {
	meta:
		aliases = "_dl_load_elf_shared_library"
		size = "2741"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C9 57 31 D2 56 53 81 EC 1C 01 00 00 8B BC 24 38 01 00 00 53 89 FB B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 44 24 2C 76 09 F7 D8 A3 ?? ?? ?? ?? EB 07 83 7C 24 2C 00 79 0F C7 05 ?? ?? ?? ?? 01 00 00 00 E9 51 0A 00 00 8D 8C 24 D8 00 00 00 8B 54 24 2C 87 D3 B8 6C 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 76 09 F7 D8 A3 ?? ?? ?? ?? EB 04 85 C0 79 0C C7 05 ?? ?? ?? ?? 01 00 00 00 EB 14 83 BC 24 30 01 00 00 00 74 1E F6 84 24 E1 00 00 00 08 75 14 8B 7C 24 2C 53 89 FB B8 06 00 00 00 CD 80 5B E9 F2 07 00 00 8B 2D ?? ?? ?? ?? EB 48 31 D2 0F B7 84 24 D8 00 00 00 39 95 E0 00 00 00 75 33 39 85 DC 00 00 00 }
	condition:
		$pattern
}
...
rule inet_ntop4_b47e2c1bf5517a9935524e5ef75359c4 {
	meta:
		aliases = "inet_ntop4"
		size = "272"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 31 F6 53 83 EC 3C 89 44 24 18 66 A1 ?? ?? ?? ?? 8D 7C 24 2D FC 89 54 24 14 89 4C 24 10 66 89 44 24 2B 31 C0 AB AB AB 66 AB AA 31 FF E9 92 00 00 00 8B 6C 24 18 B1 64 01 F5 0F B6 55 00 89 D0 F6 F1 88 C1 80 C1 30 88 4C 3C 2B 8D 4F 01 89 4C 24 0C 89 F9 80 7C 3C 2B 30 75 26 89 D0 B3 0A F6 F3 BA 0A 00 00 00 89 D3 31 D2 0F B6 C0 F7 F3 88 D0 04 30 3C 30 88 44 3C 2B 74 29 8B 4C 24 0C EB 23 B1 0A 89 D0 8B 5C 24 0C F6 F1 BA 0A 00 00 00 89 D1 31 D2 0F B6 C0 F7 F1 8D 4F 02 88 D0 04 30 88 44 1C 2B 0F B6 45 00 BA 0A 00 00 00 46 89 D3 31 D2 C6 44 0C 2C 2E 8D 79 02 F7 F3 88 D0 04 30 88 44 0C 2B 83 FE }
	condition:
		$pattern
}
...
rule __GI_vfwscanf_29c97b8747f40a20f94ad344d2d4fbf5 {
	meta:
...
rule realpath_c9e988b9d0a4009d47faf6b764566d2f {
	meta:
		aliases = "realpath"
		size = "545"
		objfiles = "realpath@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 1C 10 00 00 8B B4 24 30 10 00 00 8B AC 24 34 10 00 00 85 F6 75 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 E9 E6 01 00 00 80 3E 00 75 10 E8 ?? ?? ?? ?? C7 00 02 00 00 00 E9 D1 01 00 00 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 3D FD 0F 00 00 0F 87 CB 00 00 00 8D 9C 24 1B 10 00 00 57 29 C3 57 56 53 E8 ?? ?? ?? ?? 8D 85 FE 0F 00 00 89 44 24 18 83 C4 10 80 3B 2F 74 4A 51 51 68 FF 0F 00 00 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 7E 01 00 00 83 EC 0C 55 E8 ?? ?? ?? ?? 83 C4 10 8D 74 05 00 80 7E FF 2F 74 04 C6 06 2F 46 8D 94 24 1B 10 00 00 C7 44 24 0C 00 00 00 00 89 54 24 04 E9 2B 01 00 00 8D 75 }
	condition:
		$pattern
}
...
rule __res_querydomain_821d8a92e7e0d4c1f95d8fc8ddcfb532 {
	meta:
...
rule _vfprintf_internal_fa8af51466dc89109b24d37f6c641dae {
	meta:
		aliases = "_vfprintf_internal"
		size = "1470"
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 64 01 00 00 8B 9C 24 7C 01 00 00 53 8D 74 24 1C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 3E 8B 5C 24 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 C7 04 24 FF FF FF FF 85 C0 0F 84 6E 05 00 00 52 FF B4 24 74 01 00 00 50 53 E8 ?? ?? ?? ?? C7 44 24 10 FF FF FF FF 83 C4 10 E9 4F 05 00 00 50 50 FF B4 24 80 01 00 00 56 E8 ?? ?? ?? ?? 89 DA C7 44 24 10 00 00 00 00 83 C4 10 EB 01 43 8A 03 84 C0 74 04 3C 25 75 F5 39 D3 74 27 89 DE 31 C0 29 D6 85 F6 7E 12 50 FF B4 24 74 01 00 00 56 52 E8 ?? ?? ?? ?? 83 C4 10 39 F0 0F 85 F7 04 00 00 01 04 24 80 3B 00 0F 84 F2 04 00 00 80 7B 01 25 8D 53 01 0F 84 D6 }
	condition:
		$pattern
}

rule rexec_af_c46b11a571daf387bb28926b0534844b {
	meta:
...
rule __GI_getgrgid_r_93d25cc325f005cc326e65e0a7ae696e {
	meta:
		aliases = "getpwuid_r, __GI_getpwuid_r, getgrgid_r, __GI_getgrgid_r"
		size = "141"
...
rule getspnam_r_cc5f26c3b0fc4b0f9817cca9b8118eee {
	meta:
		aliases = "getgrnam_r, getpwnam_r, __GI_getgrnam_r, __GI_getspnam_r, __GI_getpwnam_r, getspnam_r"
		size = "152"
...
rule regexec_b35340d91c047033059636ae82ad7e29 {
	meta:
		aliases = "__regexec, regexec"
		size = "270"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 48 8B 74 24 5C 8B 5C 24 6C 8B 7C 24 64 FF 74 24 60 E8 ?? ?? ?? ?? 83 C4 10 89 C5 8A 46 1C 34 10 C0 E8 04 85 FF 0F 95 44 24 0B 20 44 24 0B 8D 44 24 10 52 6A 20 56 50 E8 ?? ?? ?? ?? 8A 44 24 3C 88 D9 D1 EB 80 E1 01 88 DA C0 E1 05 80 E2 01 24 9F C0 E2 06 08 C8 08 D0 24 F9 0C 04 88 44 24 3C 83 C4 10 31 C0 80 7C 24 0B 00 74 2F 89 7C 24 30 8D 04 FD 00 00 00 00 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 74 72 89 44 24 34 8D 04 B8 89 44 24 38 8D 44 24 30 53 53 50 55 6A 00 55 FF 74 24 6C 8D 44 24 2C 50 E8 ?? ?? ?? ?? 83 C4 20 80 7C 24 0B 00 89 C6 74 3D 31 DB 85 C0 79 24 }
	condition:
		$pattern
}
...
rule strerror_r_da5602cb749e16e21be2efc03b177888 {
	meta:
...
rule gethostbyname2_r_4a619fb6bc8ab240b0154cde6a0037f5 {
	meta:
...
rule inet_ntop_ff5be40d52a87cfa020a6aafcd99cc51 {
	meta:
...
rule _ppfs_parsespec_03a4cddf7a5b11d6809a17981b76599c {
	meta:
		aliases = "_ppfs_parsespec"
		size = "945"
		objfiles = "_ppfs_parsespec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 5C 8B 44 24 70 C7 44 24 44 00 00 00 00 8B 54 24 70 C7 44 24 48 00 00 00 00 C7 44 24 50 08 00 00 00 C7 44 24 54 08 00 00 00 8B 40 18 89 44 24 14 8B 6A 10 81 E5 80 00 00 00 75 04 8B 12 EB 39 31 F6 8B 44 24 70 8D 0C B5 00 00 00 00 8B 10 8B 44 11 FC 88 44 34 24 88 C3 0F BE C0 3B 44 11 FC 0F 85 3B 03 00 00 84 DB 74 06 46 83 FE 1F 76 D2 C6 44 24 43 00 8D 54 24 25 C7 44 24 0C 00 00 00 00 C7 44 24 10 00 00 00 00 EB 02 89 F2 80 3A 2A 89 D6 75 10 6B 44 24 10 FC 8D 72 01 C7 44 04 50 00 00 00 00 31 DB EB 10 81 FB FE 0F 00 00 7F 07 6B C3 0A 8D 5C 38 D0 46 8A 0E A1 ?? ?? ?? ?? 0F BE F9 F6 }
	condition:
		$pattern
}
...
rule inet_pton4_798052dcb83c01c4db2f51c7ab5f13f4 {
	meta:
		aliases = "inet_pton4"
		size = "135"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 31 D2 56 31 F6 53 89 C3 83 EC 1C 8D 7C 24 18 C6 44 24 18 00 EB 40 0F BE C0 43 8D 48 D0 83 F9 09 77 20 0F B6 07 6B C0 0A 8D 04 01 3D FF 00 00 00 77 47 85 D2 88 07 75 1E 46 83 FE 04 7F 3B B2 01 EB 14 83 F8 2E 75 32 85 D2 74 2E 83 FE 04 74 29 47 31 D2 C6 07 00 8A 03 84 C0 75 BA 83 FE 03 7E 18 50 6A 04 8D 44 24 20 50 55 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 10 EB 02 31 C0 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __new_sem_wait_813fadfea88bdb78b11e43f3418340b8 {
	meta:
...
rule __GI_ruserpass_a571707067cdcb2b6231ef43f31c1578 {
	meta:
...
rule __gnat_default_lock_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gnat_default_unlock, __gcov_merge_single, __gcov_flush, __enable_execute_stack, __gcov_init, __gcov_merge_add, __clear_cache, __gcov_merge_delta, __gnat_default_lock"
		size = "5"
		objfiles = "_enable_execute_stack@libgcc.a, _gcov_merge_add@libgcov.a, _gcov@libgcov.a, gthr_gnat@libgcc.a, _gcov_merge_single@libgcov.a"
	strings:
...
rule pthread_setcanceltype_aa797c49dc2f4291ae2376559c4496ba {
	meta:
...
rule thread_self_8edc8dc4e86c2e49d2a4a127f12d8902 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "pthread@libpthread.a, spinlock@libpthread.a, signals@libpthread.a, semaphore@libpthread.a, mutex@libpthread.a"
	strings:
...
rule strrchr_acfebef016cd03d2c0084d0d95793de6 {
	meta:
...
rule __GI___sigpause_59414206340f1fbb474ef3a386cc6d9d {
	meta:
...
rule longjmp_7f4abd0851d75fdee71ce179f2eb7116 {
	meta:
		aliases = "_longjmp, siglongjmp, __libc_siglongjmp, __libc_longjmp, longjmp"
		size = "55"
...
rule __GI_strxfrm_1637d6799eadaafc3eac44e832f8abfc {
	meta:
		aliases = "strlcpy, strxfrm, __GI_strlcpy, __GI_strxfrm"
		size = "59"
...
rule __GI_fgetspent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "__GI_fgetgrent_r, __GI_fgetpwent_r, fgetgrent_r, fgetspent_r, fgetpwent_r, __GI_fgetspent_r"
		size = "55"
...
rule __GI_putc_unlocked_37814e0cd8130bd524be30599725db3b {
	meta:
		aliases = "putc_unlocked, __GI___fputc_unlocked, fputc_unlocked, __fputc_unlocked, __GI_putc_unlocked"
		size = "190"
...
rule __pthread_set_own_extricate_if_9959919f5723fdea472f77e9294d47f3 {
	meta:
		...
		size = "59"
		objfiles = "oldsemaphore@libpthread.a, join@libpthread.a, condvar@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule __GI___libc_open_4f7b0246496474908348cf9e5ead9d73 {
	meta:
		aliases = "__libc_open, open, __GI_open, __GI___libc_open"
		size = "72"
...
rule __GI_mknod_a6bf5527b8bb7be6af2228eff5338169 {
	meta:
		aliases = "mknod, __GI_mknod"
		size = "76"
		objfiles = "mknod@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 04 8B 4C 24 18 8B 5C 24 1C 8B 7C 24 10 89 C8 0F AC D8 08 0F B6 D0 0F B6 C1 8B 4C 24 14 C1 E2 08 09 C2 53 89 FB B8 0E 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 CF FF 5A 89 F8 5B 5F C3 }
	condition:
		$pattern
}
...
rule __GI___libc_fcntl_067817a35140003195be9463c690719c {
	meta:
...
rule __GI_opendir_1f57073421414f27bbf3279686a150bc {
	meta:
		aliases = "opendir, __GI_opendir"
		size = "238"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 DB 83 EC 68 68 00 08 01 00 FF 74 24 7C E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 0F 88 C2 00 00 00 56 56 8D 44 24 10 50 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 12 53 6A 01 6A 02 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 16 E8 ?? ?? ?? ?? 83 EC 0C 8B 30 89 C3 57 E8 ?? ?? ?? ?? 89 33 EB 72 83 EC 0C 6A 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 4D 89 38 89 C3 BA 00 02 00 00 C7 40 10 00 00 00 00 C7 40 08 00 00 00 00 C7 40 04 00 00 00 00 8B 44 24 38 3D FF 01 00 00 0F 47 D0 89 53 14 51 51 52 6A 01 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 43 0C 75 24 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 57 E8 ?? ?? ?? ?? E8 ?? }
	condition:
		$pattern
}
...
rule __GI_putc_281b52666df515955cee9f93dd40e500 {
	meta:
		aliases = "putc, fputc, __GI_fputc, __GI_putc"
		size = "150"
...
rule putwc_656d0461fb753b5b2210fd391d402010 {
	meta:
		aliases = "__GI_fputs, __GI_fputws, fputwc, fputs, fputws, putwc"
		size = "95"
...
rule __GI_getpwent_r_d8fe13829bbc6de00d0924445c5077f8 {
	meta:
...
rule __getdents_29b647ee66ad9f7654635975e62e7f61 {
	meta:
		aliases = "__getdents"
		size = "111"
		objfiles = "getdents@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 5C 24 14 52 FF 74 24 1C 53 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 8D 3C 03 7F 43 EB 45 8B 43 08 89 43 04 8B 43 10 66 89 43 08 8A 43 12 88 43 0A 50 0F B7 43 08 83 E8 13 50 8D 43 13 50 8D 43 0B 50 E8 ?? ?? ?? ?? 0F B7 43 08 83 C4 0C 50 53 53 E8 ?? ?? ?? ?? 0F B7 43 08 83 C4 10 01 C3 39 FB 72 BB 5B 89 F0 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_memcpy_13eee19ee5b22cb1cf7ddec5afe58b26 {
	meta:
...
rule query_module_e1995e9e31d79ff62539b5bb2c509a09 {
	meta:
		aliases = "query_module"
		size = "62"
		objfiles = "query_module@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 7C 24 20 8B 44 24 10 53 89 C3 B8 A7 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_sigprocmask_8e5edefd3d36201a85c061dfb27075e2 {
	meta:
...
rule waitid_5f7a2ba5cc98732ed83ba766ebc4ac7d {
	meta:
		aliases = "waitid"
		size = "58"
		objfiles = "waitid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 7C 24 10 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 53 89 FB B8 1C 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_time_481dc1ed84bcad904fc40504754fe51c {
	meta:
...
rule __GI_rmdir_9ba5eea834bd3a742eea3411166b4088 {
	meta:
...
rule get_kernel_syms_5957ca9c5f979f37637b2b52b0bac048 {
	meta:
		aliases = "get_kernel_syms"
		size = "45"
		objfiles = "get_kernel_syms@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 53 89 FB B8 82 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}
...
rule lseek_8e5a565fe0a5b32af31233427caa96c0 {
	meta:
		aliases = "__GI_lseek, __libc_lseek, __GI___libc_lseek, lseek"
		size = "53"
...
rule mq_setattr_b18bcc30491083566c0ea8223afbc205 {
	meta:
...
rule __GI_fcntl64_579a8cd33a1bbf2fdfff054eae624ac8 {
	meta:
		aliases = "__GI___libc_fcntl64, fcntl64, __libc_fcntl64, __GI_fcntl64"
		size = "63"
...
rule strtoull_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "__GI_strtoul, __GI_strtoull, strtouq, strtoul, strtoumax, __GI_wcstoull, wcstouq, wcstoul, wcstoumax, wcstoull, waitpid, __libc_waitpid, __GI_wcstoul, __GI_waitpid, strtoull"
		size = "26"
		objfiles = "wcstoull@libc.a, waitpid@libc.a, strtoull@libc.a, strtoul@libc.a, wcstoul@libc.a"
	strings:
...
rule __GI_wcstoll_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "strtoimax, wcstoll, strtoll, strtol, wcstoimax, __GI_wcstol, __GI_strtol, __GI_strtoll, strtoq, wcstoq, wcstol, __GI_wcstoll"
		size = "26"
		objfiles = "strtoll@libc.a, strtol@libc.a, wcstol@libc.a, wcstoll@libc.a"
	strings:
...
rule __GI_sigaddset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "__GI_sigdelset, sigismember, sigaddset, sigdelset, __GI_sigaddset"
		size = "42"
...
rule lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "gamma, __GI_strtok, __GI_lgamma, __ieee754_lgamma, strtok, __ieee754_gamma, lgamma"
		size = "25"
		objfiles = "w_lgamma@libm.a, w_gamma@libm.a, e_gamma@libm.a, strtok@libc.a, e_lgamma@libm.a"
	strings:
...
rule atol_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "__GI_atol, atoi, atoll, __GI_atoi, atol"
		size = "20"
...
rule __libc_creat_bb2a987ff4b1e8f90f178160074caed3 {
	meta:
...
rule scalblnf_312f3131b70190222fba14e3c3defea1 {
	meta:
		aliases = "frexpf, scalbnf, ldexpf, scalblnf"
		size = "34"
		objfiles = "ldexpf@libm.a, scalbnf@libm.a, frexpf@libm.a, scalblnf@libm.a"
	strings:
...
rule vwscanf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "vprintf, vscanf, __GI_vscanf, vwprintf, vwscanf"
		size = "26"
		objfiles = "vwprintf@libc.a, vwscanf@libc.a, vscanf@libc.a, vprintf@libc.a"
	strings:
...
rule hcreate_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "__GI_inet_ntoa, asctime, __GI_asctime, srand48, inet_ntoa, ether_ntoa, hcreate"
		size = "21"
		objfiles = "ether_addr@libc.a, hsearch@libc.a, inet_ntoa@libc.a, asctime@libc.a, srand48@libc.a"
	strings:
...
rule __GI_sigpause_6bf719c25f6fbaef08052b0889ae3660 {
	meta:
		aliases = "atof, sigpause, mkstemp, __GI_sigpause"
		size = "18"
...
rule mktime_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "timelocal, __GI_iswalnum, mkstemp64, iswalnum, mktime"
		size = "18"
...
rule verrx_1c97125b3f40865ae46e521e13ed7a6f {
	meta:
		aliases = "__GI_verr, verr, __GI_verrx, verrx"
		size = "26"
		objfiles = "err@libc.a"
	strings:
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "pthread@libpthread.a, spinlock@libpthread.a, semaphore@libpthread.a, join@libpthread.a, condvar@libpthread.a"
	strings:
...
rule hdestroy_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__pthread_once_fork_parent, __GI_getlogin, __pthread_once_fork_prepare, _flushlbf, getlogin, hdestroy"
		size = "17"
...
rule wprintf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "wscanf, printf, scanf, __GI_printf, wprintf"
		size = "32"
...
rule fscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "fwscanf, fwprintf, __GI_sscanf, dprintf, syslog, __GI_fscanf, __GI_asprintf, asprintf, fprintf, __GI_syslog, __GI_fprintf, sscanf, swscanf, fscanf"
		size = "30"
		objfiles = "sscanf@libc.a, syslog@libc.a, swscanf@libc.a, dprintf@libc.a, fwscanf@libc.a"
	strings:
...
rule lrintf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "llrintf, ilogbf, llroundf, lroundf, lrintf"
		size = "19"
		objfiles = "llroundf@libm.a, ilogbf@libm.a, llrintf@libm.a, lrintf@libm.a, lroundf@libm.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "sinf, atanhf, sinhf, logbf, erff, asinf, atanf, roundf, acoshf, expf, lgammaf, cbrtf, tanf, log10f, cosf, expm1f, tgammaf, floorf, logf, acosf, ceilf, erfcf, asinhf, fabsf, rintf, coshf, log1pf, sqrtf, tanhf, truncf"
		size = "27"
		objfiles = "coshf@libm.a, logbf@libm.a, asinhf@libm.a, tanf@libm.a, cosf@libm.a"
	strings:
...
rule powf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "remainderf, copysignf, nextafterf, atan2f, fmodf, hypotf, powf"
		size = "35"
		objfiles = "hypotf@libm.a, fmodf@libm.a, nextafterf@libm.a, powf@libm.a, copysignf@libm.a"
	strings:
...
rule getspnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetspent, getgrnam, fgetgrent, getgrgid, getpwnam, sgetspent, getpwuid, fgetpwent, getspnam"
		size = "40"
		objfiles = "fgetpwent@libc.a, getpwnam@libc.a, getpwuid@libc.a, fgetspent@libc.a, sgetspent@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		size = "4"
		objfiles = "_floatdixf@libgcc.a, _floatundidf@libgcc.a, unwind_dw2_fde_glibc@libgcc.a, gthr_gnat@libgcc.a, _fixunsxfdi@libgcc.a"
	strings:
...
rule __get_pc_thunk_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		size = "4"
		objfiles = "unwind_dw2_fde_glibc@libgcc.a, _mulsc3@libgcc.a, _negvdi2@libgcc.a, gthr_gnat@libgcc.a, _divxc3@libgcc.a"
	strings:
...
rule pthread_mutexattr_gettype_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__pthread_mutexattr_getkind_np, pthread_rwlockattr_getkind_np, __pthread_mutexattr_gettype, pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, __GI_pthread_attr_getdetachstate, pthread_mutexattr_gettype"
		size = "15"
...
rule authnone_validate_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "xdr_void, _stdlib_mb_cur_max, old_sem_extricate_func, __GI_xdr_void, __GI__stdlib_mb_cur_max, floatformat_always_valid, authnone_validate"
		size = "6"
...
rule _svcauth_short_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		aliases = "svcudp_stat, svcraw_stat, rendezvous_stat, _svcauth_short"
		size = "6"
		objfiles = "svc_raw@libc.a, svc_authux@libc.a, svc_udp@libc.a, svc_unix@libc.a, svc_tcp@libc.a"
	strings:
...
rule clntraw_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "pthread_null_sighandler, clnttcp_abort, __pthread_return_void, __cyg_profile_func_exit, _pthread_cleanup_push_defer, __linuxthreads_create_event, clntunix_abort, authnone_destroy, authnone_verf, clntraw_abort, __cyg_profile_func_enter, _pthread_cleanup_pop_restore, pthread_handle_sigdebug, noop_handler, __stub2, svcraw_destroy, __linuxthreads_death_event, xdrmem_destroy, __linuxthreads_reap_event, clntudp_abort, __stub1, clntraw_geterr, authunix_nextverf, clntraw_destroy"
		size = "1"
		objfiles = "svc_raw@libc.a, auth_none@libc.a, clnt_raw@libc.a, auth_unix@libc.a, noophooks@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule log_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "atan2, __GI_xdr_int, xdr_longlong_t, __GI_cabs, __GI_sinh, asin, jn, y0, xdr_int, __GI_hypot, __GI_acosh, __GI_xdr_enum, __ieee754_gamma_r, __GI_nearbyint, __GI_sqrt, nearbyint, lgamma_r, atanh, acosh, partition_delete, xdr_u_longlong_t, __GI_exp, cosh, __GI_setmntent, pow, __GI_atan2, __pthread_initialize, __GI_asin, xdr_enum, vfork, __GI_acos, mq_close, log10, cabs, rand, __GI_remainder, __GI_atanh, log2, yn, sqrt, __decode_packet, drem, __GI_fmod, setmntent, j0, __GI_xdr_u_int, y1, hypot, acos, __GI_pow"
		size = "5"
		objfiles = "w_j0@libm.a, w_fmod@libm.a, w_log2@libm.a, w_asin@libm.a, mq_close@librt.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
