...
rule __pthread_mutex_trylock_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "wcsftime, authnone_refresh, __GI_pthread_attr_destroy, _svcauth_null, __GI_pthread_condattr_destroy, pthread_condattr_destroy, __pthread_mutex_init, __pthread_mutexattr_destroy, __pthread_mutex_lock, pthread_rwlockattr_destroy, clntraw_control, __GI_wcsftime, __GI_pthread_condattr_init, pthread_attr_destroy, grantpt, pthread_condattr_init, pthread_mutexattr_destroy, __pthread_mutex_unlock, xdrstdio_inline, __pthread_return_0, __pthread_mutex_trylock"
		size = "3"
		objfiles = "clnt_raw@libc.a, wcsftime@libc.a, auth_none@libc.a, svc_auth@libc.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __GI_glob_pattern_p_32865b9452c40b0fed4aa00dde2cfdd7 {
	meta:
...
rule xdrrec_eof_2b519206d1ee5af5a16a3ea332c620bd {
	meta:
...
rule __GI_chmod_dd13498e4b7a1aa5f16cca6febaaebe2 {
	meta:
...
rule __libc_statfs_66b9353b0907b20e9d3c17ba1263b522 {
	meta:
		aliases = "__GI_statfs, __GI___libc_statfs, statfs, __libc_statfs"
		size = "49"
...
rule __GI___libc_fstatfs_be68736929ed9e4e1a0623b90d5be2a4 {
	meta:
		aliases = "__libc_fstatfs, __GI_fstatfs, fstatfs, __GI___libc_fstatfs"
		size = "49"
...
rule getrlimit_904dcbca81cd105fe177fbf67e811b16 {
	meta:
...
rule __fgetc_unlocked_7234bf2292c7e7a4e6fb4c246bfcefbf {
	meta:
		aliases = "__GI_getc_unlocked, __GI___fgetc_unlocked, fgetc_unlocked, getc_unlocked, __GI_fgetc_unlocked, __fgetc_unlocked"
		size = "220"
...
rule system_bbe948c091b68f15128a29caf991f3c8 {
	meta:
		aliases = "fsync, tcdrain, wait, system"
		size = "48"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule lseek_74030486c498b35deba130245259f53b {
	meta:
		aliases = "sendmsg, __GI_waitpid, waitpid, accept, lseek"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule connect_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "recvmsg, read, msync, write, connect"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule send_a442f4706a8c29f1a18c27f8c866616e {
	meta:
		aliases = "pwrite, recv, pread, send"
		size = "60"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule scalbln_bf96dbd27ebb10208a5de88a433a5f33 {
	meta:
...
rule __GI_scalbn_29f41d04e0028db1dffdb1502cc56d28 {
	meta:
...
rule __GI_statfs64_2cc403677fcb331e20c798d15c93d478 {
	meta:
...
rule __re_set_registers_9af8f5c76e5b010b4fb9c040a2244c61 {
	meta:
...
rule __libc_sigsuspend_618d9a0a73b3d315039ee831baf24e65 {
	meta:
		aliases = "__GI_sigsuspend, sigsuspend, __libc_sigsuspend"
		size = "51"
...
rule __GI_strptime_6d2d3ca662ea29ec5c54788372c4c37a {
	meta:
...
rule _Unwind_GetRegionStart_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "_Unwind_GetDataRelBase, __udiv_w_sdiv, __gthread_active_p, _Unwind_FindEnclosingFunction, _Unwind_GetTextRelBase, _Unwind_GetRegionStart"
		size = "7"
		objfiles = "_udiv_w_sdiv@libgcc.a, gthr_gnat@libgcc_eh.a, unwind_sjlj@libgcc_eh.a"
	strings:
...
rule __GI___libc_posix_fadvise64_1511e449734dfa79da8f4d5a23eebe5a {
	meta:
		aliases = "__libc_posix_fadvise64, posix_fadvise64, __GI___libc_posix_fadvise64"
		size = "42"
...
rule fstatvfs_89237744f68c9fe1a5b9b96564a0b590 {
	meta:
...
rule __GI_vsyslog_3af7f29f99fd0c613ecf22abe43afea9 {
	meta:
...
rule statvfs64_31d360358783573428a3400ec467a593 {
	meta:
...
rule sigaction_ba01e3f47b78ed8400b5ececfe658cc2 {
	meta:
...
rule ttyname_r_7fe7c4e01f431e6620b2651637eb7ffa {
	meta:
...
rule __GI_vfscanf_c8ce4cd7f59a09120612f6da2666cc0e {
	meta:
...
rule __GI_inet_aton_fcde9a4e350d277a82bcff0ea8a96b6e {
	meta:
...
rule ether_aton_r_fc48ddaf15f5d8673f6ac0fa369394b3 {
	meta:
...
rule initstate_r_419d9331946ed1e9c285886a042b4862 {
	meta:
...
rule __GI_getcwd_d9adc01a698c38bb42f236044957f28b {
	meta:
...
rule __GI_getpwuid_r_93d25cc325f005cc326e65e0a7ae696e {
	meta:
...
rule getspnam_r_cc5f26c3b0fc4b0f9817cca9b8118eee {
	meta:
		aliases = "getpwnam_r, __GI_getpwnam_r, getgrnam_r, __GI_getspnam_r, __GI_getgrnam_r, getspnam_r"
		size = "152"
...
rule __GI_fnmatch_89a86354d40ce17f5a5953a9f1ca83d4 {
	meta:
...
rule __GI_fflush_unlocked_40559a0ff731f9d3b708140c838e6dca {
	meta:
...
rule bindresvport_620b2e35fcba4081686dfd1396722339 {
	meta:
...
rule __re_search_2_6221fcfdc653b7d876d4d7cf9a67986d {
	meta:
...
rule __GI_getservbyport_r_ccd9256d38da896d52ed422530148dd2 {
	meta:
...
rule __GI_hsearch_r_d9642b3b761caba30fc013b13096a1d3 {
	meta:
...
rule inet_pton_905dd7a20208b6d7ef21cb00bb357ad8 {
	meta:
...
rule lockf64_8e296c309216b83ca1b3e52c249cec1a {
	meta:
...
rule __GI_fseeko64_ff531bc4f89c7ed531dbaeb7250c9bc3 {
	meta:
...
rule __GI_getaddrinfo_d4778bc58b6e087821b07236eebc5df3 {
	meta:
...
rule __GI_srandom_r_d8e0eb3afd074470962931f70c2bbac2 {
	meta:
...
rule shm_open_2a89bf336b6b994af9d6a40bd8b0a5a3 {
	meta:
		aliases = "shm_open"
		size = "81"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 83 CD FF 57 56 53 83 EC 0C 8B 44 24 20 8B 5C 24 24 E8 ?? ?? ?? ?? 85 C0 89 C7 74 2A 51 81 CB 00 00 08 00 FF 74 24 2C 53 50 E8 ?? ?? ?? ?? 89 C5 E8 ?? ?? ?? ?? 8B 30 89 C3 89 3C 24 E8 ?? ?? ?? ?? 83 C4 10 89 33 83 C4 0C 89 E8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_glob_f01130b3a7c82e135c717c5f8005b440 {
	meta:
...
rule pthread_cond_wait_56e90cb3e3843db1eaea6b6fe59b8800 {
	meta:
...
rule pthread_cond_timedwait_b3d2162e4e22037dd70a488d62679871 {
	meta:
...
rule __gnat_default_lock_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gcov_merge_add, __gcov_flush, __gnat_default_unlock, __enable_execute_stack, __gcov_merge_single, __gcov_merge_delta, __clear_cache, __gcov_init, __gnat_default_lock"
		size = "5"
		objfiles = "_gcov@libgcov.a, _gcov_merge_delta@libgcov.a, _gcov_merge_add@libgcov.a, _enable_execute_stack@libgcc.a, _gcov_merge_single@libgcov.a"
	strings:
...
rule thread_self_8edc8dc4e86c2e49d2a4a127f12d8902 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "semaphore@libpthread.a, errno@libpthread.a, rwlock@libpthread.a, specific@libpthread.a, pthread@libpthread.a"
	strings:
...
rule sigaction_554610f6d0e1ce66c9323d2f3d6805b9 {
	meta:
...
rule __new_sem_post_3befbd847043db4370d2772baa41b542 {
	meta:
...
rule siglongjmp_7f4abd0851d75fdee71ce179f2eb7116 {
	meta:
		aliases = "__libc_siglongjmp, __libc_longjmp, longjmp, _longjmp, siglongjmp"
		size = "55"
...
rule __GI_seed48_r_1d653e3cd75273dbec7039fcf1c0583b {
	meta:
...
rule __xstat32_conv_49904f0d66322208e092b83e0af82de1 {
	meta:
...
rule strlcpy_1637d6799eadaafc3eac44e832f8abfc {
	meta:
		aliases = "strxfrm, __GI_strlcpy, __GI_strxfrm, strlcpy"
		size = "59"
...
rule __GI_fgetpwent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "fgetgrent_r, fgetpwent_r, __GI_fgetspent_r, fgetspent_r, __GI_fgetgrent_r, __GI_fgetpwent_r"
		size = "55"
...
rule __GI___fputc_unlocked_37814e0cd8130bd524be30599725db3b {
	meta:
		aliases = "__fputc_unlocked, __GI_putc_unlocked, fputc_unlocked, putc_unlocked, __GI___fputc_unlocked"
		size = "190"
...
rule tcgetattr_41d53bcc1cf134613bbc759326cfd9aa {
	meta:
...
rule __GI_rawmemchr_a8e1ea154f6ff4270306262438bf4304 {
	meta:
...
rule __GI_open_4f7b0246496474908348cf9e5ead9d73 {
	meta:
		aliases = "open, __GI___libc_open, __libc_open, __GI_open"
		size = "72"
...
rule __GI_memchr_6488e8334f9ec802f3460e6457451ecb {
	meta:
...
rule __GI__exit_b2e8d618c8c2e35bafd0f8dea7552672 {
	meta:
...
rule __libc_fcntl_067817a35140003195be9463c690719c {
	meta:
...
rule __GI_strcspn_8a7c52d8d5e8e1c68cb9aae541937453 {
	meta:
...
rule __GI_opendir_af850fda92b18507096c350ad6b20fc7 {
	meta:
...
rule __GI_fileno_d1aff121aa302794d76ffd1091af3fc3 {
	meta:
		aliases = "fileno, __GI_fgetwc, getwc, fgetwc, __GI_fileno"
		size = "92"
...
rule __GI_putc_281b52666df515955cee9f93dd40e500 {
	meta:
		aliases = "fputc, putc, __GI_fputc, __GI_putc"
		size = "150"
...
rule __GI_fputs_656d0461fb753b5b2210fd391d402010 {
	meta:
		aliases = "fputs, putwc, __GI_fputws, fputws, fputwc, __GI_fputs"
		size = "95"
...
rule __GI_asctime_r_83c2f3680ee9e4ffa7892720ab8347e9 {
	meta:
...
rule __GI_getgrent_r_d8fe13829bbc6de00d0924445c5077f8 {
	meta:
		aliases = "getgrent_r, getspent_r, __GI_getspent_r, __GI_getpwent_r, getpwent_r, __GI_getgrent_r"
		size = "171"
		objfiles = "getspent_r@libc.a, getpwent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule if_nametoindex_dbf7654782cdd3d49d277a76e3a34eab {
	meta:
...
rule __GI_pthread_attr_setschedpara_228cce3559ede6a00d60e3cfb02627da {
	meta:
...
rule __GI_wait4_47eda218d3b837e828c38483c2167ca1 {
	meta:
...
rule lckpwdf_bec0270c37e8a0cd2af05a926327ee89 {
	meta:
		aliases = "lckpwdf"
		size = "482"
		objfiles = "lckpwdf@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 C8 FF 56 53 81 EC 40 02 00 00 83 3D ?? ?? ?? ?? FF 0F 85 BF 01 00 00 51 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 2C 02 00 00 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 5A 68 01 00 08 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF A3 ?? ?? ?? ?? 0F 84 63 01 00 00 57 6A 00 6A 01 50 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 0F 84 31 01 00 00 83 C8 01 56 50 6A 02 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 88 14 01 00 00 53 6A 01 6A 02 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 68 8C 00 00 00 6A 00 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 44 24 18 ?? ?? ?? ?? 59 8D 44 24 18 50 E8 ?? ?? }
	condition:
		$pattern
}
...
rule __GI_memset_2cede61e9952e182d0194cb6dba884fd {
	meta:
...
rule __GI_unlink_1b4c43d4a4f172d910e013afb1af848d {
	meta:
...
rule adjtimex_8508e6930e40d6c25f60dddb8be3797e {
	meta:
...
rule getsid_540386b2ca11f9885b4be67a1d2c05da {
	meta:
...
rule __GI_write_6a5564e27c1a91b1845d3b294792608c {
	meta:
...
rule __libc_lseek_8e5a565fe0a5b32af31233427caa96c0 {
	meta:
		aliases = "__GI___libc_lseek, __GI_lseek, lseek, __libc_lseek"
		size = "53"
...
rule fcntl64_579a8cd33a1bbf2fdfff054eae624ac8 {
	meta:
		aliases = "__libc_fcntl64, __GI___libc_fcntl64, __GI_fcntl64, fcntl64"
		size = "63"
...
rule __GI_strtoul_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "wcstoull, wcstouq, __GI_waitpid, waitpid, wcstoumax, wcstoul, strtoumax, __libc_waitpid, __GI_strtoull, strtoul, strtouq, __GI_wcstoul, strtoull, __GI_wcstoull, __GI_strtoul"
		size = "26"
...
rule strtoq_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "__GI_wcstoll, wcstoll, strtoll, __GI_strtol, strtoimax, strtol, __GI_wcstol, wcstoq, wcstol, wcstoimax, __GI_strtoll, strtoq"
		size = "26"
...
rule __GI_sigdelset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigaddset, sigdelset, sigismember, __GI_sigaddset, __GI_sigdelset"
		size = "42"
...
rule lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "strtok, __ieee754_gamma, gamma, __GI_strtok, __GI_lgamma, __ieee754_lgamma, lgamma"
		size = "25"
		objfiles = "e_gamma@libm.a, strtok@libc.a, w_gamma@libm.a, w_lgamma@libm.a, e_lgamma@libm.a"
	strings:
...
rule __GI_strtold_1da02766b2a304b7f969428fc4c15b06 {
	meta:
		aliases = "__GI_wcstold, strtold, wcstold, __GI_strtold"
		size = "22"
...
rule __GI_atol_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "__GI_atoi, atoll, atoi, atol, __GI_atol"
		size = "20"
...
rule __libc_creat64_bb2a987ff4b1e8f90f178160074caed3 {
	meta:
		aliases = "creat, creat64, __libc_creat, __libc_creat64"
		size = "25"
...
rule vprintf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "vwscanf, vscanf, __GI_vscanf, vwprintf, vprintf"
		size = "26"
		objfiles = "vprintf@libc.a, vscanf@libc.a, vwscanf@libc.a, vwprintf@libc.a"
	strings:
...
rule asctime_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "__GI_inet_ntoa, __GI_asctime, hcreate, inet_ntoa, ether_ntoa, srand48, asctime"
		size = "21"
		objfiles = "asctime@libc.a, hsearch@libc.a, ether_addr@libc.a, srand48@libc.a, inet_ntoa@libc.a"
	strings:
...
rule sigpause_6bf719c25f6fbaef08052b0889ae3660 {
	meta:
		aliases = "atof, __GI_sigpause, mkstemp, sigpause"
		size = "18"
		objfiles = "mkstemp@libc.a, sigpause@libc.a, atof@libc.a"
	strings:
...
rule __GI_iswalnum_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "mkstemp64, iswalnum, mktime, timelocal, __GI_iswalnum"
		size = "18"
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "semaphore@libpthread.a, rwlock@libpthread.a, join@libpthread.a, pthread@libpthread.a, condvar@libpthread.a"
	strings:
...
rule _flushlbf_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__pthread_once_fork_prepare, getlogin, __GI_getlogin, hdestroy, __pthread_once_fork_parent, _flushlbf"
		size = "17"
...
rule open64_269135a6a54274717e5aa83c9cce8bb2 {
	meta:
		aliases = "__libc_open64, __GI___libc_open64, __GI_open64, open64"
		size = "45"
...
rule __GI_printf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "printf, scanf, wprintf, wscanf, __GI_printf"
		size = "32"
		objfiles = "wprintf@libc.a, wscanf@libc.a, printf@libc.a, scanf@libc.a"
	strings:
...
rule asprintf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "__GI_syslog, sscanf, __GI_fprintf, swscanf, __GI_asprintf, dprintf, __GI_sscanf, fprintf, fscanf, fwprintf, fwscanf, __GI_fscanf, syslog, asprintf"
		size = "30"
		objfiles = "fprintf@libc.a, fscanf@libc.a, syslog@libc.a, asprintf@libc.a, swscanf@libc.a"
	strings:
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "lrintf, ilogbf, llroundf, llrintf, lroundf"
		size = "19"
		objfiles = "lrintf@libm.a, llrintf@libm.a, llroundf@libm.a, lroundf@libm.a, ilogbf@libm.a"
	strings:
...
rule logbf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "tanhf, exp2f, asinhf, atanhf, log10f, atanf, cbrtf, erff, roundf, fabsf, sinf, rintf, acosf, ceilf, sqrtf, erfcf, truncf, tgammaf, cosf, asinf, acoshf, log2f, lgammaf, expf, sinhf, logf, log1pf, floorf, coshf, tanf, expm1f, logbf"
		size = "27"
		objfiles = "erfcf@libm.a, floorf@libm.a, acoshf@libm.a, log2f@libm.a, acosf@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "nextafterf, fmodf, copysignf, powf, atan2f, hypotf, remainderf"
		size = "35"
...
rule getgrnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetgrent, fgetspent, getspnam, getgrgid, getpwnam, getpwuid, fgetpwent, sgetspent, getgrnam"
		size = "40"
		objfiles = "fgetspent@libc.a, getspnam@libc.a, fgetpwent@libc.a, getgrnam@libc.a, getgrgid@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		size = "4"
		objfiles = "_fixunsdfsi@libgcc.a, _floatdixf@libgcc.a, _floatundidf@libgcc.a, _fixunssfsi@libgcc.a, unwind_sjlj@libgcc_eh.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		size = "4"
		objfiles = "_negvsi2@libgcc.a, _mulxc3@libgcc.a, _powidf2@libgcc.a, _powisf2@libgcc.a, crtfastmath"
	strings:
...
rule pthread_rwlockattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__pthread_mutexattr_getkind_np, pthread_mutexattr_gettype, pthread_attr_getdetachstate, pthread_mutexattr_getkind_np, __pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np"
		size = "15"
...
rule __GI_toupper_d7d4521aee6b4c2c35428947fe099a90 {
	meta:
		aliases = "tolower, toupper, __GI_tolower, __GI_toupper"
		size = "29"
...
rule __libc_current_sigrtmax_9306906a3a71020f26be39b72f98096c {
	meta:
		aliases = "pthread_getconcurrency, __pthread_getconcurrency, __libc_current_sigrtmin, __libc_current_sigrtmax"
		size = "6"
		objfiles = "allocrtsig@libc.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? C3 }
...
rule _stdlib_mb_cur_max_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "__GI__stdlib_mb_cur_max, xdr_void, __GI_xdr_void, floatformat_always_valid, old_sem_extricate_func, authnone_validate, _stdlib_mb_cur_max"
		size = "6"
...
rule __GI___h_errno_location_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__GI___errno_location, __h_errno_location, __libc_pthread_init, __errno_location, __GI___h_errno_location"
		size = "6"
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "_pthread_cleanup_pop_restore, __pthread_return_void, authunix_nextverf, svcraw_destroy, authnone_destroy, clntunix_abort, clntraw_geterr, __linuxthreads_reap_event, __linuxthreads_death_event, clnttcp_abort, authnone_verf, noop_handler, pthread_null_sighandler, pthread_handle_sigdebug, clntudp_abort, __cyg_profile_func_enter, __stub2, clntraw_abort, __cyg_profile_func_exit, __linuxthreads_create_event, __stub1, _pthread_cleanup_push_defer, clntraw_destroy, xdrmem_destroy"
		size = "1"
		objfiles = "lckpwdf@libc.a, clnt_raw@libc.a, resolv@libresolv.a, auth_unix@libc.a, auth_none@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule vfork_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "__GI_atanh, atan2, cosh, exp, __GI_acos, __GI_cabs, __GI_cosh, __decode_packet, y1, xdr_int, __GI_setmntent, lgamma_r, acos, sinh, __GI_exp, pow, drem, __GI_xdr_u_int, xdr_u_int, __GI_sqrt, log10, __GI_log10, cabs, fmod, atanh, __pthread_initialize, __ieee754_gamma_r, setmntent, sqrt, j0, jn, remainder, __GI_hypot, hypot, xdr_u_longlong_t, __GI_xdr_enum, __GI_remainder, partition_delete, __GI_fmod, splay_tree_xmalloc_deallocate, __GI_atan2, j1, asin, rand, __GI_nearbyint, log, acosh, __GI_sinh, y0, __GI_log"
		size = "5"
		objfiles = "w_cosh@libm.a, w_acosh@libm.a, mq_close@librt.a, e_gamma_r@libm.a, w_log10@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
