...
rule authnone_refresh_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "pthread_condattr_destroy, _svcauth_null, pthread_attr_destroy, pthread_mutexattr_destroy, __pthread_return_0, __pthread_mutex_init, __GI_pthread_condattr_init, pthread_condattr_init, __pthread_mutexattr_destroy, __pthread_mutex_trylock, pthread_rwlockattr_destroy, wcsftime, __GI_wcsftime, __GI_pthread_condattr_destroy, __pthread_mutex_lock, __GI_pthread_attr_destroy, __pthread_mutex_unlock, xdrstdio_inline, clntraw_control, grantpt, authnone_refresh"
		size = "3"
		objfiles = "attr@libpthread.a, clnt_raw@libc.a, auth_none@libc.a, rwlock@libpthread.a, wcsftime@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule bsd_signal_126cff4a00751967edf4b225069665be {
	meta:
...
rule __GI___libc_getdomainname_8b4ef73be17f423b0978b5e948c46812 {
	meta:
...
rule fgetc_unlocked_7234bf2292c7e7a4e6fb4c246bfcefbf {
	meta:
		aliases = "__fgetc_unlocked, __GI___fgetc_unlocked, __GI_getc_unlocked, __GI_fgetc_unlocked, getc_unlocked, fgetc_unlocked"
		size = "220"
...
rule endnetent_f468964b8937d2560c1930edef041633 {
	meta:
		aliases = "__GI_endnetent, __GI_endprotoent, endprotoent, endnetent"
		size = "92"
...
rule tcdrain_bbe948c091b68f15128a29caf991f3c8 {
	meta:
		aliases = "fsync, system, wait, tcdrain"
		size = "48"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule lseek_74030486c498b35deba130245259f53b {
	meta:
		aliases = "accept, waitpid, __GI_waitpid, sendmsg, lseek"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule recvmsg_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "msync, connect, write, read, recvmsg"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule _Unwind_GetTextRelBase_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "__udiv_w_sdiv, _Unwind_FindEnclosingFunction, __gthread_active_p, _Unwind_GetDataRelBase, _Unwind_GetRegionStart, _Unwind_GetTextRelBase"
		size = "7"
...
rule svcudp_bufcreate_a567cbbf8de1e93550d7ebcc21a529cb {
	meta:
...
rule __GI_setstate_r_44094b8bdb76360b8d5f78e1c0c41bc1 {
	meta:
...
rule getgrgid_r_93d25cc325f005cc326e65e0a7ae696e {
	meta:
		aliases = "__GI_getpwuid_r, __GI_getgrgid_r, getpwuid_r, getgrgid_r"
		size = "141"
...
rule __GI_getpwnam_r_cc5f26c3b0fc4b0f9817cca9b8118eee {
	meta:
		aliases = "getspnam_r, getgrnam_r, __GI_getspnam_r, __GI_getgrnam_r, getpwnam_r, __GI_getpwnam_r"
		size = "152"
...
rule __GI_fgetwc_unlocked_79617156b6daadfdc361ec8d8f690db9 {
	meta:
...
rule __GI_fclose_71ec308450e445d4bd9002078da56a56 {
	meta:
...
rule __regexec_b35340d91c047033059636ae82ad7e29 {
	meta:
...
rule gethostbyname_r_e8fab4c90656bb714e2d08c3e2989a30 {
	meta:
...
rule __GI_random_r_cc7e0237ffa405be517b89667dbd582d {
	meta:
...
rule shm_open_91b10739e4faa16c091f576c8a8a1554 {
	meta:
		aliases = "shm_open"
		size = "135"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 83 CF FF 56 53 83 EC 0C 8B 44 24 20 E8 ?? ?? ?? ?? 85 C0 89 C5 74 64 57 FF 74 24 2C FF 74 24 2C 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 78 35 56 6A 00 6A 01 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 14 83 C8 01 53 50 6A 02 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0F 83 EC 0C 57 83 CF FF E8 ?? ?? ?? ?? 83 C4 10 E8 ?? ?? ?? ?? 83 EC 0C 8B 30 89 C3 55 E8 ?? ?? ?? ?? 83 C4 10 89 33 83 C4 0C 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __enable_execute_stack_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gcov_flush, __gnat_default_lock, __gcov_merge_single, __gnat_default_unlock, __gcov_merge_add, __gcov_init, __gcov_merge_delta, __clear_cache, __enable_execute_stack"
		size = "5"
		objfiles = "_gcov_merge_add@libgcov.a, _enable_execute_stack@libgcc.a, _gcov_merge_single@libgcov.a, _clear_cache@libgcc.a, gthr_gnat@libgcc_eh.a"
	strings:
...
rule thread_self_8edc8dc4e86c2e49d2a4a127f12d8902 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "semaphore@libpthread.a, rwlock@libpthread.a, cancel@libpthread.a, signals@libpthread.a, specific@libpthread.a"
	strings:
...
rule longjmp_7f4abd0851d75fdee71ce179f2eb7116 {
	meta:
		aliases = "siglongjmp, _longjmp, __libc_siglongjmp, __libc_longjmp, longjmp"
		size = "55"
...
rule strxfrm_1637d6799eadaafc3eac44e832f8abfc {
	meta:
...
rule fputc_unlocked_37814e0cd8130bd524be30599725db3b {
	meta:
		aliases = "putc_unlocked, __fputc_unlocked, __GI___fputc_unlocked, __GI_putc_unlocked, fputc_unlocked"
		size = "190"
...
rule strncat_af22a1e5842b19d835ae8d6a7ed9faed {
	meta:
...
rule futimes_517742e33c8bac81a623f0778b8b15c9 {
	meta:
		aliases = "__GI_futimes, futimes"
		size = "101"
		objfiles = "futimes@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 D2 56 83 EC 14 8B 4C 24 24 8B 7C 24 20 85 C9 74 27 8B 01 8D 54 24 04 89 44 24 04 69 41 04 E8 03 00 00 89 44 24 08 8B 41 08 89 44 24 0C 69 41 0C E8 03 00 00 89 44 24 10 31 F6 89 F1 53 89 FB B8 40 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 83 C4 14 5E 5F C3 }
	condition:
		$pattern
}
...
rule mknod_a6bf5527b8bb7be6af2228eff5338169 {
	meta:
...
rule __GI_ppoll_86ae1b5139a346505633e7ee862406bb {
	meta:
...
rule getwc_d1aff121aa302794d76ffd1091af3fc3 {
	meta:
		aliases = "__GI_fileno, fgetwc, fileno, __GI_fgetwc, getwc"
		size = "92"
...
rule fputws_656d0461fb753b5b2210fd391d402010 {
	meta:
		aliases = "__GI_fputws, putwc, fputwc, fputs, __GI_fputs, fputws"
		size = "95"
...
rule getspent_r_d8fe13829bbc6de00d0924445c5077f8 {
	meta:
		aliases = "getgrent_r, __GI_getgrent_r, __GI_getpwent_r, __GI_getspent_r, getpwent_r, getspent_r"
		size = "171"
		objfiles = "getgrent_r@libc.a, getspent_r@libc.a, getpwent_r@libc.a"
	strings:
...
rule wcsstr_ec45663db79afd91bcf650cbb59009d7 {
	meta:
...
rule __libc_readv_42d980f99c45cb4dc42e73f0acd98d16 {
	meta:
...
rule ioctl_b72d66e86a2ba29fe8e743c28bb3e1c2 {
	meta:
...
rule __GI_fcntl64_579a8cd33a1bbf2fdfff054eae624ac8 {
	meta:
		aliases = "fcntl64, __GI___libc_fcntl64, __libc_fcntl64, __GI_fcntl64"
		size = "63"
...
rule __GI_wctype_50e80352cc999abf107e4f9290013692 {
	meta:
		aliases = "__GI_wctrans, wctrans, wctype, __GI_wctype"
		size = "61"
...
rule strtoull_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "__GI_wcstoul, __GI_wcstoull, strtoumax, __GI_strtoull, strtouq, wcstoul, wcstoumax, wcstouq, __GI_strtoul, strtoul, __GI_waitpid, waitpid, wcstoull, __libc_waitpid, strtoull"
		size = "26"
		objfiles = "waitpid@libc.a, wcstoul@libc.a, wcstoull@libc.a, strtoull@libc.a, strtoul@libc.a"
	strings:
...
rule wcstoq_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "__GI_strtoll, __GI_strtol, strtoll, strtol, strtoimax, wcstoll, __GI_wcstol, wcstol, __GI_wcstoll, strtoq, wcstoimax, wcstoq"
		size = "26"
...
rule __GI_sigdelset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "sigaddset, sigismember, __GI_sigaddset, sigdelset, __GI_sigdelset"
		size = "42"
...
rule gamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__GI_lgamma, __ieee754_gamma, strtok, __GI_strtok, lgamma, __ieee754_lgamma, gamma"
		size = "25"
		objfiles = "strtok@libc.a, e_gamma@libm.a, e_lgamma@libm.a, w_gamma@libm.a, w_lgamma@libm.a"
	strings:
...
rule strtold_1da02766b2a304b7f969428fc4c15b06 {
	meta:
		aliases = "wcstold, __GI_strtold, __GI_wcstold, strtold"
		size = "22"
...
rule __GI_atoi_e6c5c8392e7b41865e74c28a5b36180c {
	meta:
		aliases = "atoll, atol, atoi, __GI_atol, __GI_atoi"
		size = "20"
...
rule ldexpf_312f3131b70190222fba14e3c3defea1 {
	meta:
		...
		size = "34"
		objfiles = "frexpf@libm.a, scalblnf@libm.a, scalbnf@libm.a, ldexpf@libm.a"
	strings:
...
rule __GI_vscanf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "vwprintf, vprintf, vwscanf, vscanf, __GI_vscanf"
		size = "26"
		objfiles = "vwscanf@libc.a, vscanf@libc.a, vprintf@libc.a, vwprintf@libc.a"
	strings:
...
rule ether_ntoa_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "__GI_asctime, hcreate, asctime, inet_ntoa, __GI_inet_ntoa, srand48, ether_ntoa"
		size = "21"
		objfiles = "hsearch@libc.a, srand48@libc.a, ether_addr@libc.a, inet_ntoa@libc.a, asctime@libc.a"
	strings:
...
rule __GI_verrx_1c97125b3f40865ae46e521e13ed7a6f {
	meta:
		aliases = "__GI_verr, verr, verrx, __GI_verrx"
		size = "26"
		objfiles = "err@libc.a"
	strings:
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "semaphore@libpthread.a, rwlock@libpthread.a, manager@libpthread.a, pthread@libpthread.a, join@libpthread.a"
	strings:
...
rule __pthread_once_fork_parent_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "_flushlbf, __GI_getlogin, hdestroy, __pthread_once_fork_prepare, getlogin, __pthread_once_fork_parent"
		size = "17"
...
rule __GI___libc_open64_269135a6a54274717e5aa83c9cce8bb2 {
	meta:
...
rule __GI_printf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "wprintf, wscanf, printf, scanf, __GI_printf"
		size = "32"
...
rule __GI_sscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "__GI_fscanf, syslog, __GI_fprintf, sscanf, fwprintf, swscanf, fwscanf, fprintf, dprintf, fscanf, __GI_asprintf, __GI_syslog, asprintf, __GI_sscanf"
		size = "30"
...
rule lrintf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "llroundf, lroundf, llrintf, ilogbf, lrintf"
		size = "19"
		objfiles = "llrintf@libm.a, llroundf@libm.a, ilogbf@libm.a, lroundf@libm.a, lrintf@libm.a"
	strings:
...
rule ceilf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "log1pf, cbrtf, erff, asinhf, sinf, acoshf, expm1f, tanf, sinhf, asinf, logbf, tanhf, sqrtf, logf, atanf, log10f, cosf, truncf, rintf, tgammaf, roundf, erfcf, coshf, expf, atanhf, lgammaf, floorf, acosf, fabsf, ceilf"
		size = "27"
		objfiles = "coshf@libm.a, log1pf@libm.a, cbrtf@libm.a, sinhf@libm.a, tgammaf@libm.a"
	strings:
...
rule fmodf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "nextafterf, copysignf, atan2f, remainderf, powf, hypotf, fmodf"
		size = "35"
...
rule getspnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "sgetspent, getpwuid, getgrnam, fgetgrent, getgrgid, fgetspent, getpwnam, fgetpwent, getspnam"
		size = "40"
		objfiles = "fgetpwent@libc.a, fgetspent@libc.a, fgetgrent@libc.a, getgrgid@libc.a, getpwnam@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		size = "4"
		objfiles = "unwind_sjlj@libgcc_eh.a, _fixunsdfsi@libgcc.a, _fixunsdfdi@libgcc.a, _floatdidf@libgcc.a, _floatdixf@libgcc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		size = "4"
		objfiles = "_addvsi3@libgcc.a, _addvdi3@libgcc.a, _powidf2@libgcc.a, _divsc3@libgcc.a, _muldc3@libgcc.a"
	strings:
...
rule __pthread_mutexattr_gettype_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_attr_getdetachstate, __GI_pthread_attr_getdetachstate, __pthread_mutexattr_getkind_np, pthread_mutexattr_gettype, pthread_mutexattr_getkind_np, pthread_rwlockattr_getkind_np, __pthread_mutexattr_gettype"
		size = "15"
...
rule toupper_d7d4521aee6b4c2c35428947fe099a90 {
	meta:
		aliases = "tolower, __GI_tolower, __GI_toupper, toupper"
		size = "29"
...
rule pthread_mutexattr_settype_c966b71060253b953a535d91cc13d1cf {
	meta:
		aliases = "__pthread_mutexattr_settype, __pthread_mutexattr_setkind_np, pthread_mutexattr_setkind_np, pthread_mutexattr_settype"
		size = "23"
		objfiles = "mutex@libpthread.a"
	strings:
...
rule __GI__stdlib_mb_cur_max_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "__GI_xdr_void, old_sem_extricate_func, authnone_validate, _stdlib_mb_cur_max, xdr_void, floatformat_always_valid, __GI__stdlib_mb_cur_max"
		size = "6"
...
rule _svcauth_short_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		aliases = "svcraw_stat, rendezvous_stat, svcudp_stat, _svcauth_short"
		size = "6"
		objfiles = "svc_tcp@libc.a, svc_raw@libc.a, svc_unix@libc.a, svc_udp@libc.a, svc_authux@libc.a"
	strings:
...
rule authnone_verf_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "_pthread_cleanup_pop_restore, pthread_handle_sigdebug, clntunix_abort, clntraw_destroy, __linuxthreads_death_event, __linuxthreads_reap_event, __pthread_return_void, clntraw_geterr, xdrmem_destroy, __stub2, authunix_nextverf, authnone_destroy, noop_handler, __linuxthreads_create_event, clntudp_abort, utimensat, __stub1, pthread_null_sighandler, __cyg_profile_func_exit, clnttcp_abort, __cyg_profile_func_enter, _pthread_cleanup_push_defer, clntraw_abort, svcraw_destroy, authnone_verf"
		size = "1"
		objfiles = "clnt_raw@libc.a, lckpwdf@libc.a, clnt_tcp@libc.a, futimes@libc.a, auth_none@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule __GI_xdr_u_int_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "atan2, nearbyint, y0, __GI_xdr_int, exp, xdr_int, __GI_sqrt, __ieee754_gamma_r, xdr_u_longlong_t, rand, acos, __GI_sinh, log10, lgamma_r, remainder, partition_delete, __GI_remainder, atanh, xdr_longlong_t, __GI_atan2, j0, asin, __GI_xdr_enum, __GI_hypot, __GI_log10, scalb, y1, cabs, __GI_log, __GI_nearbyint, __GI_cabs, sinh, vfork, __GI_atanh, splay_tree_xmalloc_deallocate, __GI_acosh, cosh, __decode_packet, pow, __GI_pow, __GI_setmntent, j1, xdr_enum, yn, drem, log, jn, __GI_exp, sqrt, __GI_asin"
		size = "5"
		objfiles = "w_jn@libm.a, w_atan2@libm.a, w_j0@libm.a, w_log10@libm.a, s_nearbyint@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
