...
rule __GI_pthread_attr_destroy_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "xdrstdio_inline, pthread_attr_destroy, __pthread_return_0, __pthread_mutexattr_destroy, clntraw_control, grantpt, pthread_mutexattr_destroy, __GI_pthread_condattr_init, __pthread_mutex_trylock, __pthread_mutex_unlock, wcsftime, _svcauth_null, pthread_rwlockattr_destroy, __pthread_mutex_lock, pthread_condattr_init, __GI_wcsftime, authnone_refresh, __pthread_mutex_init, pthread_condattr_destroy, __GI_pthread_condattr_destroy, __GI_pthread_attr_destroy"
		size = "3"
		objfiles = "__uClibc_main@libc.a, attr@libpthread.a, mutex@libpthread.a, auth_none@libc.a, xdr_stdio@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __GI_glob_pattern_p_cacd843fdc96a49e52a1b1beeea4f01f {
	meta:
...
rule __GI_utime_8b40c2c332e0723952335712e32d8bcd {
	meta:
...
rule fstatfs_626538cf26dc5d87ceb849275f79ae92 {
	meta:
...
rule __GI_setgroups_73180b4ad75ae77de6a2e96b98130ab4 {
	meta:
...
rule setsid_3d2d52970292609e348bccdc3e873edc {
	meta:
...
rule __fgetc_unlocked_a8c421194d2423dabb3cc9829e1d3697 {
	meta:
		aliases = "__GI_getc_unlocked, __GI___fgetc_unlocked, fgetc_unlocked, __GI_fgetc_unlocked, getc_unlocked, __fgetc_unlocked"
		size = "220"
...
rule endprotoent_0d96bf4fc2561ebab2649fbb03aaf667 {
	meta:
		aliases = "endnetent, __GI_endservent, endservent, __GI_endnetent, __GI_endprotoent, endprotoent"
		size = "92"
...
rule lseek_7fafe2d4042f052134436ac4f9e768f2 {
	meta:
		aliases = "accept, waitpid, sendmsg, __GI_waitpid, lseek"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule connect_f76fa2a31d5e51010722d3c9bb015e20 {
	meta:
		aliases = "write, recvmsg, read, msync, connect"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule __isinf_a046a0c5dae8872fc96349a6c5714414 {
	meta:
...
rule _Unwind_GetDataRelBase_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "_Unwind_FindEnclosingFunction, __udiv_w_sdiv, _Unwind_GetRegionStart, __gthread_active_p, _Unwind_GetTextRelBase, _Unwind_GetDataRelBase"
		size = "7"
...
rule __GI_statvfs_6f97e3d1543bb3ca051b5c303eeacc1d {
	meta:
...
rule _fpmaxtostr_0c4ccea422637cc5ee4caa9f9faf7b58 {
	meta:
		aliases = "_fpmaxtostr"
		size = "1476"
		objfiles = "_fpmaxtostr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC DC 00 00 00 8B 84 24 00 01 00 00 8B 94 24 00 01 00 00 DB AC 24 F4 00 00 00 8B 40 04 89 44 24 14 8A 4A 08 8B 2A 88 C8 88 4C 24 1E 83 C8 20 C6 84 24 C2 00 00 00 65 3C 61 75 07 83 C1 06 88 4C 24 1E 85 ED 79 05 BD 06 00 00 00 8B 94 24 00 01 00 00 C6 84 24 D2 00 00 00 00 8B 42 0C A8 02 74 0A C6 84 24 D2 00 00 00 2B EB 0C A8 01 74 08 C6 84 24 D2 00 00 00 20 DD E0 DF E0 C6 84 24 D3 00 00 00 00 C7 44 24 58 00 00 00 00 9E 7A 02 74 0C DD D8 C7 44 24 58 08 00 00 00 EB 61 D9 EE D9 C9 DD E1 DF E0 9E 75 2A 7A 28 D9 E8 D8 F1 D9 CA C7 44 24 10 FF FF FF FF DD EA DF E0 DD D9 9E 0F 86 19 01 00 }
	condition:
		$pattern
}
...
rule __GI_vfscanf_1bd03602e282eaed8390b478bbc03837 {
	meta:
...
rule __GI_ether_aton_r_06e7eee1e53da81311c3814af6a04f8e {
	meta:
...
rule __GI___ns_name_unpack_470fa5abd6ce80ce2f6f986e6c82a78a {
	meta:
...
rule __GI_getspnam_r_4b8fd72cde4f80875c48536dbf4b838a {
	meta:
		aliases = "getpwnam_r, __GI_getgrnam_r, getspnam_r, __GI_getpwnam_r, getgrnam_r, __GI_getspnam_r"
		size = "153"
...
rule __GI_lrint_633c6331d73fba216fd8b1b67ab9b5ab {
	meta:
...
rule __GI_fclose_c178141cbecb9a2b457cf9c42d953825 {
	meta:
...
rule clntunix_create_212f9f72cf3927b02d1ac6d1bcb11c78 {
	meta:
...
rule __GI_glob_2f0ffe4a73a8c16457cc4aac288c1153 {
	meta:
...
rule __enable_execute_stack_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gcov_merge_single, __gcov_init, __gcov_merge_delta, pex_unix_cleanup, __gcov_merge_add, hex_init, __gnat_default_unlock, __clear_cache, __gcov_flush, __gnat_default_lock, __enable_execute_stack"
		size = "5"
		objfiles = "hex@libiberty.a, _gcov_merge_delta@libgcov.a, gthr_gnat@libgcc.a, _enable_execute_stack@libgcc.a, _clear_cache@libgcc.a"
	strings:
...
rule __libc_siglongjmp_be9e6548214836180c2cfadd5a9f8fd0 {
	meta:
		aliases = "_longjmp, __libc_longjmp, siglongjmp, longjmp, __libc_siglongjmp"
		size = "51"
...
rule wcsxfrm_87774503142b2a3a63efa66630f9fa69 {
	meta:
...
rule fgetgrent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "fgetpwent_r, __GI_fgetpwent_r, __GI_fgetspent_r, __GI_fgetgrent_r, fgetspent_r, fgetgrent_r"
		size = "55"
...
rule getwc_unlocked_7d2e9d1399dac4935bcf0cbe2b7da6b5 {
	meta:
...
rule __GI_putc_unlocked_3285cd6d795474f19a1a1b20ef0fa5ce {
	meta:
		aliases = "putc_unlocked, __GI___fputc_unlocked, __fputc_unlocked, fputc_unlocked, __GI_putc_unlocked"
		size = "197"
...
rule __GI_frexp_a1dc49af7a1d72bfbdb8f40d0419cd8b {
	meta:
...
rule fputs_27a00bae78ad279095482cf1967e990f {
	meta:
		aliases = "__GI_fputws, fputws, putwc, __GI_fputs, fputwc, fputs"
		size = "95"
...
rule getgrent_r_1db372f6fd22c31d31dc4c3efa2abb1d {
	meta:
		aliases = "__GI_getpwent_r, getpwent_r, __GI_getspent_r, getspent_r, __GI_getgrent_r, getgrent_r"
		size = "171"
		objfiles = "getspent_r@libc.a, getpwent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule rresvport_9af63d0e454683725751c455ed5b96b1 {
	meta:
...
rule asinh_a54eeb54c2b60d33b7fb462d093194c4 {
	meta:
...
rule mknod_b8ef70435fdebbe8142f8c7577ab510d {
	meta:
...
rule select_496b7e3d4929e33baf36f6e39ca98718 {
	meta:
...
rule __GI_vmsplice_0ff8ada55d79614be90a00dc0aaa7c11 {
	meta:
...
rule read_4b71412f99e38164268c73d285ab1ab4 {
	meta:
...
rule __libc_write_51590a204e0c66e1f13d97d6a14da6be {
	meta:
...
rule lseek_b165ac9f0383693c824852ed6c2fea69 {
	meta:
...
rule __GI_poll_757e1bd210e1381650c2db4adb94a779 {
	meta:
...
rule __GI_wcstoul_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "__GI_strtoull, wcstouq, wcstoumax, waitpid, strtouq, __GI_strtoul, __GI_waitpid, strtoull, strtoumax, __libc_waitpid, __GI_wcstoull, strtoul, wcstoull, wcstoul, __GI_wcstoul"
		size = "26"
...
rule __GI_wcstol_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "strtoq, strtoll, __GI_wcstoll, wcstoll, wcstol, wcstoimax, wcstoq, __GI_strtoll, strtoimax, strtol, __GI_strtol, __GI_wcstol"
		size = "26"
...
rule __ieee754_lgamma_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__GI_lgamma, lgamma, gamma, strtok, __GI_strtok, __ieee754_gamma, __ieee754_lgamma"
		size = "25"
		objfiles = "e_gamma@libm.a, e_lgamma@libm.a, strtok@libc.a, w_gamma@libm.a, w_lgamma@libm.a"
	strings:
...
rule scalblnf_312f3131b70190222fba14e3c3defea1 {
	meta:
		...
		size = "34"
		objfiles = "scalblnf@libm.a, frexpf@libm.a, scalbnf@libm.a, ldexpf@libm.a"
	strings:
...
rule vprintf_207313f1bf35dacd417d7e4d154f43e5 {
	meta:
		aliases = "vwscanf, __GI_vscanf, vscanf, vwprintf, vprintf"
		size = "26"
...
rule hcreate_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "asctime, __GI_inet_ntoa, ether_ntoa, inet_ntoa, srand48, __GI_asctime, hcreate"
		size = "21"
...
rule restart_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "spinlock@libpthread.a, rwlock@libpthread.a, pthread@libpthread.a, condvar@libpthread.a, join@libpthread.a"
	strings:
...
rule __GI_getlogin_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "hdestroy, __pthread_once_fork_parent, _flushlbf, __pthread_once_fork_prepare, getlogin, __GI_getlogin"
		size = "17"
...
rule __GI_fscanf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "sscanf, __GI_syslog, fprintf, asprintf, syslog, swscanf, fscanf, __GI_asprintf, dprintf, __GI_fprintf, __GI_sscanf, fwprintf, fwscanf, __GI_fscanf"
		size = "30"
...
rule erfcf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "sinf, acoshf, tanf, ceilf, atanhf, sinhf, sqrtf, floorf, logbf, acosf, asinf, tgammaf, asinhf, cbrtf, erff, expf, coshf, lgammaf, cosf, rintf, roundf, log1pf, tanhf, logf, log10f, expm1f, fabsf, atanf, truncf, erfcf"
		size = "27"
		objfiles = "expf@libm.a, expm1f@libm.a, fabsf@libm.a, tanhf@libm.a, sinf@libm.a"
	strings:
...
rule hypotf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "powf, copysignf, atan2f, fmodf, remainderf, nextafterf, hypotf"
		size = "35"
		objfiles = "nextafterf@libm.a, hypotf@libm.a, fmodf@libm.a, powf@libm.a, remainderf@libm.a"
	strings:
...
rule getgrnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "getpwuid, fgetspent, getspnam, fgetgrent, sgetspent, getgrgid, fgetpwent, getpwnam, getgrnam"
		size = "40"
		objfiles = "fgetpwent@libc.a, getspnam@libc.a, getgrnam@libc.a, getgrgid@libc.a, getpwuid@libc.a"
	strings:
...
rule thread_self_e74c8f77ff3f89dbea0e2d9a5b4c5494 {
	meta:
		aliases = "thread_self"
		size = "63"
		objfiles = "specific@libpthread.a, cancel@libpthread.a, signals@libpthread.a, mutex@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule pthread_mutexattr_gettype_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "pthread_mutexattr_getkind_np, __pthread_mutexattr_getkind_np, pthread_attr_getdetachstate, __pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, pthread_mutexattr_gettype"
		size = "15"
...
rule old_sem_extricate_func_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "__GI_xdr_void, __GI__stdlib_mb_cur_max, authnone_validate, _stdlib_mb_cur_max, xdr_void, old_sem_extricate_func"
		size = "6"
...
rule clnttcp_abort_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "clntraw_abort, __stub2, pthread_handle_sigdebug, clntudp_abort, clntunix_abort, __linuxthreads_death_event, authnone_verf, svcraw_destroy, clntraw_destroy, __linuxthreads_create_event, _pthread_cleanup_pop_restore, clntraw_geterr, authunix_nextverf, __stub1, _pthread_cleanup_push_defer, noop_handler, __linuxthreads_reap_event, __pthread_return_void, __cyg_profile_func_enter, authnone_destroy, pthread_null_sighandler, xdrmem_destroy, __cyg_profile_func_exit, clnttcp_abort"
		size = "1"
		objfiles = "__uClibc_main@libc.a, clnt_tcp@libc.a, lckpwdf@libc.a, noophooks@libc.a, signals@libpthread.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule __decode_packet_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "__GI_exp, __GI_atan2, cabs, __GI_xdr_int, vfork, __GI_xdr_enum, hypot, xdr_u_int, setmntent, cosh, __pthread_initialize, __GI_log, acos, xdr_int, j0, __GI_xdr_u_int, fmod, __GI_log10, y1, xdr_enum, y0, log, __GI_sinh, lgamma_r, drem, acosh, jn, xdr_u_longlong_t, log2, __GI_sqrt, __GI_atanh, __GI_cabs, xdr_longlong_t, __GI_fmod, __GI_setmntent, remainder, __GI_cosh, rand, scalb, __GI_hypot, nearbyint, __GI_asin, __GI_pow, mq_close, asin, pow, atanh, sqrt, j1, log10"
		size = "5"
		objfiles = "w_sinh@libm.a, w_lgamma_r@libm.a, w_j1@libm.a, ptfork@libpthread.a, w_log@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
