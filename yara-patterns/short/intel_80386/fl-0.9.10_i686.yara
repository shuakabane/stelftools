...
rule pthread_condattr_init_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "__GI_pthread_attr_destroy, __pthread_mutexattr_destroy, __pthread_mutex_unlock, pthread_mutexattr_destroy, __pthread_return_0, __pthread_mutex_trylock, pthread_condattr_destroy, __GI_pthread_condattr_init, pthread_attr_destroy, authnone_refresh, __GI_wcsftime, wcsftime, clntraw_control, _svcauth_null, pthread_rwlockattr_destroy, __pthread_mutex_init, __pthread_mutex_lock, xdrstdio_inline, __GI_pthread_condattr_destroy, grantpt, pthread_condattr_init"
		size = "3"
		objfiles = "__uClibc_main@libc.a, xdr_stdio@libc.a, mutex@libpthread.a, rwlock@libpthread.a, attr@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule glob_pattern_p_32865b9452c40b0fed4aa00dde2cfdd7 {
	meta:
		aliases = "__GI_glob_pattern_p, glob_pattern_p"
		size = "85"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 31 C9 8B 5C 24 0C 8B 54 24 08 EB 37 3C 5B 74 16 7F 0A 3C 2A 74 37 3C 3F 75 28 EB 31 3C 5C 74 0D 3C 5D 75 1E EB 18 B9 01 00 00 00 EB 15 85 DB 74 11 80 7A 01 00 8D 42 01 74 08 89 C2 EB 04 85 C9 75 0B 42 8A 02 84 C0 75 C3 31 C0 EB 05 B8 01 00 00 00 5B C3 }
	condition:
		$pattern
}

rule __pthread_manager_sighandler_0fab6140fe164b0cdbf4054df66927ee {
	meta:
		aliases = "__pthread_manager_sighandler"
		size = "106"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 31 D2 81 EC A8 00 00 00 A1 ?? ?? ?? ?? 85 C0 75 0C 31 D2 83 3D ?? ?? ?? ?? 00 0F 95 C2 85 D2 C7 05 ?? ?? ?? ?? 01 00 00 00 74 36 C7 44 24 14 00 00 00 00 8D 5C 24 14 C7 44 24 18 06 00 00 00 50 68 94 00 00 00 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 DE 81 C4 A8 00 00 00 5B C3 }
	condition:
		$pattern
}
...
rule __ieee754_log10_f768502971406932090d910116144b2a {
	meta:
...
rule signal_126cff4a00751967edf4b225069665be {
	meta:
		aliases = "bsd_signal, __GI_signal, __bsd_signal, signal"
		size = "175"
...
rule __pthread_kill_other_threads_n_ef522cdd3f9ba471c81f8def25326919 {
	meta:
...
rule strsignal_686493510fce03410c3b7d5869ec6bd4 {
	meta:
...
rule xdrrec_skiprecord_65acb2b8cfb4f6de16dda1cef27957b9 {
	meta:
...
rule chmod_dd13498e4b7a1aa5f16cca6febaaebe2 {
	meta:
		aliases = "__GI_chmod, chmod"
		size = "50"
		objfiles = "chmod@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 0F 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 89 C3 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 CB FF 5A 89 D8 59 5B C3 }
	condition:
		$pattern
}
...
rule kill_b17889a35ca878babece7f32e0aab606 {
	meta:
...
rule __GI_mkdir_079b34a65369179e372432941c1fea11 {
	meta:
		aliases = "mkdir, __GI_mkdir"
		size = "50"
		objfiles = "mkdir@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 27 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 89 C3 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 CB FF 5A 89 D8 59 5B C3 }
	condition:
		$pattern
}
...
rule __GI_setpgid_fa39796010cd9590d14f57154a33e8c2 {
	meta:
...
rule fchmod_25e928d6730e7c673b5e840666c83a73 {
	meta:
		aliases = "fchmod"
		size = "50"
		objfiles = "fchmod@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 5E 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 89 C3 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 CB FF 5A 89 D8 59 5B C3 }
	condition:
		$pattern
}

rule getpriority_427427b842af1cf90b44a2e24e148e1d {
	meta:
...
rule statfs_66b9353b0907b20e9d3c17ba1263b522 {
	meta:
		aliases = "__libc_statfs, __GI___libc_statfs, __GI_statfs, statfs"
		size = "49"
...
rule __GI_fstatfs_be68736929ed9e4e1a0623b90d5be2a4 {
	meta:
		aliases = "__GI___libc_fstatfs, __libc_fstatfs, fstatfs, __GI_fstatfs"
		size = "49"
...
rule __GI_towctrans_29af773b6591ec9cd36b7ae2459e8392 {
	meta:
...
rule re_comp_e814f052ed67364af3d272b1a6979792 {
	meta:
		aliases = "re_comp"
		size = "182"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 5C 24 10 85 DB 75 17 83 3D ?? ?? ?? ?? 00 BA ?? ?? ?? ?? 0F 84 92 00 00 00 E9 8B 00 00 00 83 3D ?? ?? ?? ?? 00 75 46 83 EC 0C 68 C8 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 BA ?? ?? ?? ?? 85 C0 A3 ?? ?? ?? ?? 74 66 83 EC 0C 68 00 01 00 00 C7 05 ?? ?? ?? ?? C8 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 BA ?? ?? ?? ?? 85 C0 A3 ?? ?? ?? ?? 74 3E 80 0D ?? ?? ?? ?? 80 83 EC 0C 53 E8 ?? ?? ?? ?? 8B 0D ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? 89 C2 89 D8 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0F 8B 14 85 ?? ?? ?? ?? 81 C2 ?? ?? ?? ?? EB 02 31 D2 89 D0 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __libc_getpid_3a4771e029f93732bee14358f6609a4d {
	meta:
...
rule _pthread_cleanup_push_defer_30f6c6dbbe05ecdbb79580518e5ad117 {
	meta:
...
rule pone_85f48d052004ea7fe280ee7efdb1c73b {
	meta:
		aliases = "pzero, pone"
		size = "184"
		objfiles = "e_j1@libm.a, e_j0@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 DD 44 24 18 DD 14 24 DD 5C 24 08 8B 4C 24 0C 81 E1 FF FF FF 7F 81 F9 FF FF 1F 40 7E 0C BB ?? ?? ?? ?? B8 ?? ?? ?? ?? EB 42 81 F9 8A 2E 12 40 7E 0C BB ?? ?? ?? ?? B8 ?? ?? ?? ?? EB 2E 81 F9 6C DB 06 40 7E 0C BB ?? ?? ?? ?? B8 ?? ?? ?? ?? EB 1A 31 C0 BA ?? ?? ?? ?? 81 F9 00 00 00 40 89 C3 0F 4D DA BA ?? ?? ?? ?? 0F 4D C2 DD 04 24 D8 C8 D9 E8 DC F1 DD 43 28 D8 CA DC 43 20 D8 CA DC 43 18 D8 CA DC 43 10 D8 CA DC 43 08 D8 CA DC 03 DD 40 20 D8 CB DC 40 18 D8 CB DC 40 10 D8 CB DC 40 08 D8 CB DC 00 83 C4 10 5B DE CB D9 CA D8 C1 DE FA DE C1 C3 }
	condition:
		$pattern
}

rule qone_bc2e8844632c5920c19b8bafa1c64a70 {
	meta:
		aliases = "qone"
		size = "196"
		objfiles = "e_j1@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 DD 44 24 18 DD 14 24 DD 5C 24 08 8B 4C 24 0C 81 E1 FF FF FF 7F 81 F9 FF FF 1F 40 7E 0C BB ?? ?? ?? ?? B8 ?? ?? ?? ?? EB 42 81 F9 8A 2E 12 40 7E 0C BB ?? ?? ?? ?? B8 ?? ?? ?? ?? EB 2E 81 F9 6C DB 06 40 7E 0C BB ?? ?? ?? ?? B8 ?? ?? ?? ?? EB 1A 31 C0 BA ?? ?? ?? ?? 81 F9 00 00 00 40 89 C3 0F 4D DA BA ?? ?? ?? ?? 0F 4D C2 DD 04 24 D8 C8 D9 E8 DC F1 DD 43 28 D8 CA DC 43 20 D8 CA DC 43 18 D8 CA DC 43 10 D8 CA DC 43 08 D8 CA DC 03 DD 40 28 D8 CB DC 40 20 D8 CB DC 40 18 D8 CB DC 40 10 D8 CB DC 40 08 D8 CB DC 00 DE CB D9 CA DE C1 DE F9 D8 05 ?? ?? ?? ?? DC 34 24 83 C4 10 5B C3 }
	condition:
		$pattern
}

rule qzero_a9abe74c73d5bbebddc506fe6bb82717 {
	meta:
		aliases = "qzero"
		size = "196"
		objfiles = "e_j0@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 10 DD 44 24 18 DD 14 24 DD 5C 24 08 8B 4C 24 0C 81 E1 FF FF FF 7F 81 F9 FF FF 1F 40 7E 0C BB ?? ?? ?? ?? B8 ?? ?? ?? ?? EB 42 81 F9 8A 2E 12 40 7E 0C BB ?? ?? ?? ?? B8 ?? ?? ?? ?? EB 2E 81 F9 6C DB 06 40 7E 0C BB ?? ?? ?? ?? B8 ?? ?? ?? ?? EB 1A 31 C0 BA ?? ?? ?? ?? 81 F9 00 00 00 40 89 C3 0F 4D DA BA ?? ?? ?? ?? 0F 4D C2 DD 04 24 D8 C8 D9 E8 DC F1 DD 43 28 D8 CA DC 43 20 D8 CA DC 43 18 D8 CA DC 43 10 D8 CA DC 43 08 D8 CA DC 03 DD 40 28 D8 CB DC 40 20 D8 CB DC 40 18 D8 CB DC 40 10 D8 CB DC 40 08 D8 CB DC 00 DE CB D9 CA DE C1 DE F9 D8 25 ?? ?? ?? ?? DC 34 24 83 C4 10 5B C3 }
	condition:
		$pattern
}
...
rule __ieee754_atanh_de86d0b0b160083eaf24dc1e52ecbfd9 {
	meta:
...
rule __GI_endprotoent_f468964b8937d2560c1930edef041633 {
	meta:
		aliases = "__GI_endnetent, endprotoent, endnetent, __GI_endprotoent"
		size = "92"
...
rule __GI_gethostent_r_24827bfd5611d0f7ec641d64bce6c82f {
	meta:
...
rule accept_74030486c498b35deba130245259f53b {
	meta:
		aliases = "lseek, waitpid, sendmsg, __GI_waitpid, accept"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule read_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "recvmsg, connect, msync, write, read"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule _create_xid_9357af041f01d3b09bcbda51964ea9e4 {
	meta:
		aliases = "_create_xid"
		size = "129"
		objfiles = "create_xid@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 2C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 18 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 80 3D ?? ?? ?? ?? 00 75 2D 51 51 6A 00 8D 44 24 28 50 E8 ?? ?? ?? ?? 58 5A 68 ?? ?? ?? ?? 8B 44 24 28 33 44 24 2C 50 E8 ?? ?? ?? ?? 83 C4 10 C6 05 ?? ?? ?? ?? 01 8D 44 24 24 51 51 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 5A 6A 01 53 E8 ?? ?? ?? ?? 8B 44 24 34 83 C4 38 5B C3 }
	condition:
		$pattern
}
...
rule __ieee754_j0_51dcf15a2528a599dffa8468f5988f17 {
	meta:
		aliases = "__ieee754_j0"
		size = "520"
		objfiles = "e_j0@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 38 DD 44 24 40 DD 14 24 DD 54 24 08 8B 5C 24 0C 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7E 0D D8 C8 DC 3D ?? ?? ?? ?? E9 D5 01 00 00 DD D8 50 50 FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? 83 C4 10 81 FB FF FF FF 3F DD 5C 24 30 0F 8E FB 00 00 00 51 51 FF 74 24 3C FF 74 24 3C E8 ?? ?? ?? ?? DD 5C 24 20 58 5A FF 74 24 3C FF 74 24 3C E8 ?? ?? ?? ?? DD 5C 24 28 DD 44 24 20 DC 44 24 28 DD 5C 24 38 83 C4 10 81 FB FF FF DF 7F 7F 4A 83 EC 10 DD 44 24 40 D8 C0 DD 1C 24 E8 ?? ?? ?? ?? D9 E0 DD 44 24 20 DC 4C 24 28 83 C4 10 D9 EE DF E9 DD D8 76 14 DD 44 24 10 DC 64 24 18 DD 54 24 20 DE F9 DD 5C 24 28 EB }
	condition:
		$pattern
}
...
rule __ieee754_y1_3696eb0fea9927844a764721a136ca88 {
	meta:
		aliases = "__ieee754_y1"
		size = "550"
		objfiles = "e_j1@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 58 DD 44 24 60 DD 54 24 20 DD 54 24 28 8B 54 24 2C 8B 44 24 28 89 D3 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7E 11 D8 C8 DC 44 24 20 DC 3D ?? ?? ?? ?? E9 E8 01 00 00 DD D8 09 D8 75 0D D9 EE D8 3D ?? ?? ?? ?? E9 D5 01 00 00 85 D2 79 09 D9 EE D8 F0 E9 C8 01 00 00 81 FB FF FF FF 3F 0F 8E FA 00 00 00 51 51 FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? DD 5C 24 40 58 5A FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? DD 5C 24 48 DD 44 24 40 D9 E0 DC 64 24 48 DD 5C 24 50 83 C4 10 81 FB FF FF DF 7F 7F 4A 83 EC 10 DD 44 24 30 D8 C0 DD 1C 24 E8 ?? ?? ?? ?? DD 44 24 40 DC 4C 24 48 83 C4 10 D9 EE D9 C9 DF E9 DD D8 }
	condition:
		$pattern
}

rule __ieee754_y0_243890ba919d68a3f4a4c7fc5cfe8dfd {
	meta:
		aliases = "__ieee754_y0"
		size = "559"
		objfiles = "e_j0@libm.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 58 DD 44 24 60 DD 54 24 20 DD 54 24 28 8B 54 24 2C 8B 44 24 28 89 D3 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7E 11 D8 C8 DC 44 24 20 DC 3D ?? ?? ?? ?? E9 F1 01 00 00 DD D8 09 D8 75 0D D9 EE D8 3D ?? ?? ?? ?? E9 DE 01 00 00 85 D2 79 09 D9 EE D8 F0 E9 D1 01 00 00 81 FB FF FF FF 3F 0F 8E F8 00 00 00 51 51 FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? DD 5C 24 40 58 5A FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? DD 5C 24 48 DD 44 24 40 DC 64 24 48 DD 5C 24 50 83 C4 10 81 FB FF FF DF 7F 7F 4A 83 EC 10 DD 44 24 30 D8 C0 DD 1C 24 E8 ?? ?? ?? ?? D9 E0 DD 44 24 40 DC 4C 24 48 83 C4 10 D9 EE DF E9 DD D8 76 0A }
	condition:
		$pattern
}
...
rule __decode_header_9aef12f5150c72da95bdc651fcdba6d1 {
	meta:
...
rule mq_receive_4c7fdb29fd0d88a8091d52445b4b26c9 {
	meta:
		aliases = "pread, mq_send, __libc_pread, mq_receive"
		size = "35"
...
rule __GI_brk_3811fd887a7e7fa4c83a048c78717622 {
	meta:
...
rule __gthread_active_p_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "__udiv_w_sdiv, _Unwind_GetRegionStart, _Unwind_GetDataRelBase, _Unwind_GetTextRelBase, _Unwind_FindEnclosingFunction, __gthread_active_p"
		size = "7"
...
rule _dl_load_elf_shared_library_1dc1004bba12bdaabf681fa0d348a2a4 {
	meta:
		aliases = "_dl_load_elf_shared_library"
		size = "2797"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C9 57 31 D2 56 53 81 EC 2C 01 00 00 8B BC 24 48 01 00 00 53 89 FB B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 44 24 34 76 09 F7 D8 A3 ?? ?? ?? ?? EB 07 83 7C 24 34 00 79 0F C7 05 ?? ?? ?? ?? 01 00 00 00 E9 85 0A 00 00 8D 8C 24 E8 00 00 00 8B 54 24 34 87 D3 B8 6C 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 76 09 F7 D8 A3 ?? ?? ?? ?? EB 04 85 C0 79 0C C7 05 ?? ?? ?? ?? 01 00 00 00 EB 14 83 BC 24 40 01 00 00 00 74 1E F6 84 24 F1 00 00 00 08 75 14 8B 7C 24 34 53 89 FB B8 06 00 00 00 CD 80 5B E9 25 08 00 00 8B 2D ?? ?? ?? ?? EB 48 31 D2 0F B7 84 24 E8 00 00 00 39 95 E0 00 00 00 75 33 39 85 DC 00 00 00 }
	condition:
		$pattern
}

rule _dl_do_reloc_be546dd736f9ed1bcae3c6e7eed490f8 {
	meta:
		aliases = "_dl_do_reloc"
		size = "193"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C9 57 56 53 83 EC 08 8B 6C 24 1C 8B 44 24 24 8B 55 00 89 14 24 8B 10 89 54 24 04 8B 40 04 0F B6 F0 C1 E8 08 89 C3 C1 E3 04 03 5C 24 28 85 C0 8B 3B 74 3E 31 C0 83 FE 05 0F 94 C0 31 D2 01 C0 83 FE 07 0F 94 C2 09 D0 50 55 FF 74 24 28 8B 44 24 38 01 F8 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C1 75 0F 8A 43 0C BA 01 00 00 00 C0 E8 04 3C 02 75 45 8B 54 24 04 03 14 24 83 FE 08 77 07 FF 24 B5 ?? ?? ?? ?? 83 CA FF EB 2D 29 D1 01 0A EB 25 89 0A EB 21 8B 45 00 01 02 EB 1A 85 C9 74 16 8B 73 08 8D 5A FF 8D 51 FF EB 07 42 43 8A 02 4E 88 03 85 F6 75 F5 31 D2 5E 89 D0 5F 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule pthread_cancel_7a6061e77a86e486f21fbb987a576f34 {
	meta:
		aliases = "pthread_cancel"
		size = "180"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 31 D2 57 56 53 83 EC 0C 8B 74 24 20 89 F0 25 FF 03 00 00 C1 E0 04 8D B8 ?? ?? ?? ?? 89 F8 E8 ?? ?? ?? ?? 8B 5F 08 85 DB 74 05 39 73 10 74 70 83 EC 0C 57 E8 ?? ?? ?? ?? B8 03 00 00 00 EB 58 83 EC 0C 57 E8 ?? ?? ?? ?? EB 4B 8B 83 BC 01 00 00 31 F6 8B 6B 14 85 C0 74 13 52 52 53 FF 30 FF 50 04 83 C4 10 89 C6 88 83 B8 01 00 00 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C4 10 85 F6 74 0B 83 EC 0C 53 E8 ?? ?? ?? ?? EB 0E 50 50 FF 35 ?? ?? ?? ?? 55 E8 ?? ?? ?? ?? 31 C0 83 C4 1C 5B 5E 5F 5D C3 80 7B 40 01 0F BE 43 42 C6 43 42 01 74 92 85 C0 75 8E EB 97 }
	condition:
		$pattern
}
...
rule _fp_out_wide_4f52ceaaef1e2571be03fbd4c3cb5bd0 {
	meta:
		aliases = "_fp_out_wide"
		size = "148"
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 81 EC 8C 00 00 00 8B B4 24 A4 00 00 00 8B 9C 24 A8 00 00 00 89 F0 84 C0 79 35 83 EC 0C FF B4 24 B8 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 29 C3 89 C7 85 DB 7E 19 8B 84 24 A0 00 00 00 83 E6 7F 89 D9 89 F2 E8 ?? ?? ?? ?? 39 D8 89 C5 75 34 89 FB 85 DB 7E 2E 31 D2 8B 8C 24 AC 00 00 00 0F BE 04 11 89 44 94 14 42 39 DA 7C EC 50 FF B4 24 A4 00 00 00 53 8D 44 24 20 50 E8 ?? ?? ?? ?? 83 C4 10 01 C5 81 C4 8C 00 00 00 89 E8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __pthread_destroy_specifics_b4eff616f182615e0d9d8c78ec20da9d {
	meta:
		aliases = "__pthread_destroy_specifics"
		size = "219"
		objfiles = "specific@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 83 EC 0C E8 ?? ?? ?? ?? C7 44 24 08 01 00 00 00 89 C6 EB 60 83 BC 9E EC 00 00 00 00 74 4F 89 D8 31 FF C1 E0 05 89 44 24 04 EB 3D 8B 44 24 04 01 F8 8B 0C C5 ?? ?? ?? ?? 8D 04 BD 00 00 00 00 03 84 9E EC 00 00 00 85 C9 8B 10 74 1B 85 D2 74 17 83 EC 0C C7 00 00 00 00 00 52 FF D1 C7 44 24 18 01 00 00 00 83 C4 10 47 83 FF 1F 7E BE 43 83 FB 1F 7E A1 45 83 7C 24 08 00 74 11 83 FD 03 7F 0C 31 DB C7 44 24 08 00 00 00 00 EB E2 8B 46 1C 89 F2 31 DB E8 ?? ?? ?? ?? EB 23 8B 84 9E EC 00 00 00 85 C0 74 17 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 C7 84 9E EC 00 00 00 00 00 00 00 43 83 FB 1F 7E D8 }
	condition:
		$pattern
}

rule svctcp_create_41d8c274378c28e3ec0342519561e230 {
	meta:
		aliases = "svctcp_create"
		size = "364"
		objfiles = "svc_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 ED 57 56 53 83 EC 2C 8B 74 24 40 C7 44 24 28 10 00 00 00 83 FE FF 75 2B 53 66 BD 01 00 6A 06 6A 01 6A 02 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 79 12 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E9 D0 00 00 00 51 6A 10 6A 00 8D 5C 24 24 53 E8 ?? ?? ?? ?? 66 C7 44 24 28 02 00 58 5A 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 16 66 C7 44 24 1A 00 00 50 FF 74 24 2C 53 56 E8 ?? ?? ?? ?? 83 C4 10 57 8D 44 24 2C 50 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 11 53 53 6A 02 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 28 83 EC 0C 31 FF 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 ED 0F 84 A2 00 00 00 83 EC 0C 56 E8 ?? ?? ?? }
	condition:
		$pattern
}
...
rule __libc_posix_fadvise64_1511e449734dfa79da8f4d5a23eebe5a {
	meta:
		aliases = "__GI___libc_posix_fadvise64, posix_fadvise64, __libc_posix_fadvise64"
		size = "42"
...
rule __GI_svcudp_bufcreate_a567cbbf8de1e93550d7ebcc21a529cb {
	meta:
		aliases = "svcudp_bufcreate, __GI_svcudp_bufcreate"
		size = "484"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 31 F6 53 83 EC 2C 8B 6C 24 40 8B 7C 24 44 C7 44 24 28 10 00 00 00 83 FD FF 75 2B 53 66 BE 01 00 6A 11 6A 02 6A 02 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C5 79 12 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? E9 F0 00 00 00 51 6A 10 6A 00 8D 5C 24 20 53 E8 ?? ?? ?? ?? 66 C7 44 24 24 02 00 58 5A 53 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 16 66 C7 44 24 16 00 00 50 FF 74 24 2C 53 55 E8 ?? ?? ?? ?? 83 C4 10 50 8D 44 24 2C 50 53 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 2B 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 F6 C7 44 24 08 00 00 00 00 0F 84 1F 01 00 00 83 EC 0C 55 E8 ?? ?? ?? ?? EB 75 83 EC 0C 68 }
	condition:
		$pattern
}
...
rule __decode_question_2693fd904a0c30cc1b0e184b932dbfbf {
	meta:
		aliases = "__decode_question"
		size = "130"
		objfiles = "decodeq@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 0C 01 00 00 8B B4 24 20 01 00 00 8B BC 24 28 01 00 00 68 00 01 00 00 8D 6C 24 10 55 FF B4 24 2C 01 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 78 3D 83 EC 0C 55 E8 ?? ?? ?? ?? 89 D9 83 C3 04 89 07 03 8C 24 34 01 00 00 83 C4 10 0F B6 04 0E 0F B6 54 31 01 C1 E0 08 09 D0 89 47 04 0F B6 44 31 02 0F B6 54 31 03 C1 E0 08 09 D0 89 47 08 81 C4 0C 01 00 00 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule __decode_answer_4ed65e5ddca94e5ce6d94244307c6537 {
	meta:
		aliases = "__decode_answer"
		size = "240"
		objfiles = "decodea@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 0C 01 00 00 8B B4 24 24 01 00 00 8B 9C 24 28 01 00 00 8B BC 24 2C 01 00 00 68 00 01 00 00 8D 44 24 10 50 56 FF B4 24 2C 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C1 0F 88 A0 00 00 00 8D 68 0A 29 F3 29 EB 89 5C 24 08 79 07 89 D9 E9 8C 00 00 00 8B 9C 24 20 01 00 00 83 EC 0C 8D 34 30 8D 44 24 18 50 E8 ?? ?? ?? ?? 01 F3 83 C6 0A 8D 4B 04 83 C4 10 89 07 0F B6 03 0F B6 53 01 C1 E0 08 09 C2 89 57 04 0F B6 43 02 0F B6 53 03 C1 E0 08 09 C2 89 57 08 0F B6 43 04 0F B6 51 03 C1 E0 18 09 C2 0F B6 41 01 C1 E0 10 09 C2 0F B6 41 02 83 C9 FF C1 E0 08 09 C2 89 57 0C 0F B6 43 08 0F B6 53 09 83 }
	condition:
		$pattern
}
...
rule vfwscanf_29c97b8747f40a20f94ad344d2d4fbf5 {
	meta:
		aliases = "__GI_vfwscanf, vfwscanf"
		size = "1690"
		objfiles = "vfwscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 10 01 00 00 C7 44 24 4C FF FF FF FF 6A 24 6A 00 8D 44 24 30 50 E8 ?? ?? ?? ?? 8B 84 24 30 01 00 00 8B 40 34 89 44 24 24 83 C4 10 85 C0 75 29 50 8B 9C 24 24 01 00 00 83 C3 38 53 68 ?? ?? ?? ?? 8D 84 24 FC 00 00 00 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 50 50 FF B4 24 28 01 00 00 8D 9C 24 BC 00 00 00 53 89 DD E8 ?? ?? ?? ?? 8B 84 24 C8 00 00 00 C7 84 24 EC 00 00 00 ?? ?? ?? ?? 8B B4 24 34 01 00 00 8A 40 03 C7 84 24 FC 00 00 00 ?? ?? ?? ?? C7 44 24 68 00 00 00 00 C6 44 24 23 01 88 84 24 D8 00 00 00 83 C4 10 E9 1A 05 00 00 80 A4 24 C9 00 00 00 01 C6 44 24 68 01 C6 44 }
	condition:
		$pattern
}
...
rule clnt_broadcast_02b00ce917837d6795d8bf7b06da0ef2 {
	meta:
		aliases = "clnt_broadcast"
		size = "1470"
		objfiles = "pmap_rmt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 1C 29 00 00 E8 ?? ?? ?? ?? C7 84 24 14 29 00 00 01 00 00 00 89 44 24 04 56 6A 11 6A 02 6A 02 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C5 79 0D 83 EC 0C 68 ?? ?? ?? ?? E9 66 03 00 00 83 EC 0C 6A 04 8D 84 24 24 29 00 00 50 6A 06 6A 01 55 E8 ?? ?? ?? ?? 83 C4 20 85 C0 79 0D 83 EC 0C 68 ?? ?? ?? ?? E9 3B 03 00 00 8D 44 24 28 89 84 24 04 29 00 00 8D 84 24 00 29 00 00 89 AC 24 08 29 00 00 66 C7 84 24 0C 29 00 00 01 00 C7 84 24 00 29 00 00 60 22 00 00 53 50 68 12 89 00 00 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 1D 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 44 24 1C 00 00 00 00 83 C4 10 E9 EF 00 }
	condition:
		$pattern
}

rule statvfs_89237744f68c9fe1a5b9b96564a0b590 {
	meta:
		aliases = "__GI_statvfs, fstatvfs, statvfs"
		size = "697"
		objfiles = "fstatvfs@libc.a, statvfs@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 24 05 00 00 8B 9C 24 38 05 00 00 8D 84 24 C8 04 00 00 8B B4 24 3C 05 00 00 50 53 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 0F 88 78 02 00 00 8B 84 24 C4 04 00 00 89 06 89 46 04 8B 84 24 C8 04 00 00 89 46 08 8B 84 24 CC 04 00 00 89 46 0C 8B 84 24 D0 04 00 00 89 46 10 8B 84 24 D4 04 00 00 89 46 14 8B 84 24 D8 04 00 00 89 46 18 8B 84 24 DC 04 00 00 C7 46 24 00 00 00 00 89 46 20 8B 84 24 E4 04 00 00 89 46 2C 50 6A 18 6A 00 8D 46 30 50 E8 ?? ?? ?? ?? 8B 46 18 C7 46 28 00 00 00 00 89 46 1C 5F 5D 8D 84 24 70 04 00 00 50 53 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 88 E7 01 00 00 E8 ?? ?? }
	condition:
		$pattern
}
...
rule vsyslog_3af7f29f99fd0c613ecf22abe43afea9 {
	meta:
		aliases = "__GI_vsyslog, vsyslog"
		size = "752"
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 40 05 00 00 8B B4 24 54 05 00 00 68 8C 00 00 00 6A 00 8D 9C 24 A8 04 00 00 53 E8 ?? ?? ?? ?? C7 84 24 AC 04 00 00 ?? ?? ?? ?? 5D 8D 84 24 AC 04 00 00 50 E8 ?? ?? ?? ?? 83 C4 0C 8D 84 24 14 04 00 00 50 53 6A 0D E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 44 24 18 83 C4 0C 8B 28 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 34 05 00 00 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F B6 05 ?? ?? ?? ?? 89 F1 83 E1 07 83 C4 10 D3 F8 A8 01 0F 84 25 02 00 00 F7 C6 00 FC FF FF 0F 85 19 02 00 00 83 3D ?? ?? ?? ?? 00 78 09 80 3D ?? ?? ?? ?? 00 75 1C A0 ?? ?? ?? ?? 57 6A 00 0C 08 0F B6 C0 50 FF }
	condition:
		$pattern
}
...
rule fstatvfs64_31d360358783573428a3400ec467a593 {
	meta:
...
rule __pthread_manager_ecfdb24c875b7a472dac7539a4f47982 {
	meta:
		aliases = "__pthread_manager"
		size = "1649"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 58 01 00 00 8D 9C 24 D0 00 00 00 53 C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? E8 ?? ?? ?? ?? 5F 5D FF 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 59 5E 6A 05 53 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 74 15 A1 ?? ?? ?? ?? 85 C0 7E 0C 52 52 50 53 E8 ?? ?? ?? ?? 83 C4 10 50 6A 00 8D 84 24 CC 00 00 00 50 6A 02 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 5D FF 70 18 E8 ?? ?? ?? ?? 83 C4 10 8D 5C 24 30 57 68 94 00 00 00 53 FF B4 24 6C 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 DD 8B 84 24 60 01 00 00 66 C7 84 24 48 01 00 00 01 00 89 84 24 44 01 00 00 56 68 }
	condition:
		$pattern
}
...
rule __GI_rexec_af_c46b11a571daf387bb28926b0534844b {
	meta:
		aliases = "rexec_af, __GI_rexec_af"
		size = "1151"
		objfiles = "rexec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 7C 01 00 00 8B 94 24 98 01 00 00 8B 84 24 94 01 00 00 66 C1 C8 08 0F B7 C0 0F B7 BC 24 A8 01 00 00 89 14 24 8B 94 24 9C 01 00 00 89 54 24 04 50 68 ?? ?? ?? ?? 6A 20 8D B4 24 38 01 00 00 56 E8 ?? ?? ?? ?? C6 84 24 5B 01 00 00 00 83 C4 0C 6A 20 6A 00 8D 9C 24 58 01 00 00 53 E8 ?? ?? ?? ?? 8D 84 24 84 01 00 00 89 BC 24 60 01 00 00 83 CF FF C7 84 24 64 01 00 00 01 00 00 00 C7 84 24 5C 01 00 00 02 00 00 00 50 53 56 8B 84 24 AC 01 00 00 FF 30 E8 ?? ?? ?? ?? 83 C4 20 85 C0 0F 85 C9 03 00 00 8B 84 24 74 01 00 00 8B 40 18 85 C0 74 4E 57 BB 01 00 00 00 68 01 04 00 00 50 68 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __uClibc_main_600c35ccc3a7d4f5e72ebef6a4e5233e {
	meta:
		aliases = "__uClibc_main"
		size = "449"
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 8C 00 00 00 8B 84 24 B8 00 00 00 8B 94 24 A4 00 00 00 8B BC 24 A8 00 00 00 8B AC 24 AC 00 00 00 A3 ?? ?? ?? ?? 8B 84 24 B4 00 00 00 C1 E2 02 A3 ?? ?? ?? ?? 8D 44 3A 04 A3 ?? ?? ?? ?? 3B 07 75 08 8D 04 17 A3 ?? ?? ?? ?? 51 6A 78 6A 00 8D 44 24 20 50 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 83 38 00 8D 40 04 75 F8 89 C3 8D 74 24 14 EB 1A 8B 03 83 F8 0E 77 10 52 6A 08 53 8D 04 C6 50 E8 ?? ?? ?? ?? 83 C4 10 83 C3 08 83 3B 00 75 E1 8D 44 24 14 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 48 BA 00 10 00 00 85 C0 0F 44 C2 83 7C 24 70 FF A3 ?? ?? ?? ?? 75 20 E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? ?? }
	condition:
		$pattern
}
...
rule rendezvous_request_45bb28b27eafa6b56c0be38d421bfbc0 {
	meta:
		aliases = "rendezvous_request"
		size = "156"
		objfiles = "svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 9C 00 00 00 8B B4 24 B0 00 00 00 8D AC 24 98 00 00 00 8B 7E 2C C7 84 24 98 00 00 00 6E 00 00 00 50 55 8D 44 24 22 50 FF 36 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 79 0C E8 ?? ?? ?? ?? 83 38 04 75 48 EB D2 50 6A 10 6A 00 8D B4 24 94 00 00 00 56 E8 ?? ?? ?? ?? 89 D8 66 C7 84 24 98 00 00 00 01 00 8B 4F 04 8B 17 E8 ?? ?? ?? ?? 83 C4 0C 6A 10 56 89 C3 8D 40 10 50 E8 ?? ?? ?? ?? 8B 84 24 A8 00 00 00 83 C4 10 89 43 0C 81 C4 9C 00 00 00 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __open_nameservers_f0868b835d5f561891e75e2470227643 {
	meta:
		aliases = "__open_nameservers"
		size = "585"
		objfiles = "opennameservers@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC C0 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 B8 00 00 00 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 0F 8F F0 01 00 00 55 55 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C5 0F 85 98 01 00 00 57 57 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C5 0F 85 7A 01 00 00 E9 A4 01 00 00 43 8A 0B 84 C9 0F 84 6A 01 00 00 A1 ?? ?? ?? ?? 0F BE D1 F6 04 50 20 75 E7 80 F9 0A 0F 84 53 01 00 00 80 F9 23 C7 44 24 08 00 00 00 00 75 50 E9 41 01 00 00 8B 44 24 08 89 9C 84 98 00 00 00 40 89 44 24 08 EB 01 43 8A 0B 84 }
	condition:
		$pattern
}

rule _fpmaxtostr_90519a301b13310a57f5f3da6e20f50c {
	meta:
		aliases = "_fpmaxtostr"
		size = "1447"
		objfiles = "_fpmaxtostr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC DC 00 00 00 8B 84 24 00 01 00 00 8B 94 24 00 01 00 00 DB AC 24 F4 00 00 00 8B 40 04 89 44 24 18 8A 5A 08 8B 2A C6 84 24 C2 00 00 00 65 88 D8 0C 20 3C 61 88 5C 24 20 75 07 80 C3 06 88 5C 24 20 8B 94 24 00 01 00 00 85 ED B8 06 00 00 00 C6 84 24 D2 00 00 00 00 0F 48 E8 8B 42 0C A8 02 74 0A C6 84 24 D2 00 00 00 2B EB 0C A8 01 74 08 C6 84 24 D2 00 00 00 20 DB E8 C6 84 24 D3 00 00 00 00 C7 44 24 58 00 00 00 00 7A 02 74 0C DD D8 C7 44 24 58 08 00 00 00 EB 55 D9 EE D9 C9 DB E9 75 27 7A 25 D9 E8 D8 F1 D9 CA C7 44 24 14 FF FF FF FF DF EA DD D9 0F 86 F4 00 00 00 C6 84 24 D2 00 00 00 2D }
	condition:
		$pattern
}
...
rule __md5_crypt_b794b653a8ebe9e818f3fda8404e44f3 {
	meta:
		aliases = "__md5_crypt"
		size = "725"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC F0 00 00 00 8B 9C 24 08 01 00 00 6A 03 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8D 53 03 85 C0 0F 44 DA 89 DA 89 DE 83 C2 08 89 5C 24 18 EB 01 46 8A 06 84 C0 74 08 3C 24 74 04 39 D6 72 F1 8D 9C 24 80 00 00 00 89 D8 E8 ?? ?? ?? ?? 83 EC 0C FF B4 24 0C 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 8B 94 24 00 01 00 00 8D BC 24 DB 00 00 00 89 C5 89 C1 89 D8 E8 ?? ?? ?? ?? B9 03 00 00 00 BA ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? 8B 54 24 18 89 D8 2B 74 24 18 89 F1 89 74 24 10 8D 74 24 28 E8 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 8B 94 24 00 01 00 00 89 F0 89 E9 E8 ?? ?? ?? ?? 8B 4C 24 10 89 F0 8B 54 24 }
	condition:
		$pattern
}

rule vfscanf_c8ce4cd7f59a09120612f6da2666cc0e {
	meta:
		aliases = "__GI_vfscanf, vfscanf"
		size = "1660"
		objfiles = "vfscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC F0 01 00 00 C7 84 24 34 01 00 00 FF FF FF FF 6A 24 6A 00 8D 84 24 18 01 00 00 50 E8 ?? ?? ?? ?? 8B 84 24 10 02 00 00 8B 40 34 89 44 24 14 83 C4 10 85 C0 75 29 57 8B 9C 24 04 02 00 00 83 C3 38 53 68 ?? ?? ?? ?? 8D 84 24 E4 01 00 00 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 56 56 FF B4 24 08 02 00 00 8D 9C 24 A4 01 00 00 53 89 DD E8 ?? ?? ?? ?? 8B 84 24 B0 01 00 00 C7 84 24 D4 01 00 00 ?? ?? ?? ?? 8B B4 24 14 02 00 00 8A 40 03 C7 84 24 50 01 00 00 00 00 00 00 C6 44 24 13 01 88 84 24 C0 01 00 00 8B 84 24 D8 01 00 00 89 84 24 E4 01 00 00 83 C4 10 E9 12 05 00 00 80 A4 24 }
	condition:
		$pattern
}
...
rule inet_aton_fcde9a4e350d277a82bcff0ea8a96b6e {
	meta:
		aliases = "__GI_inet_aton, inet_aton"
		size = "148"
		objfiles = "inet_aton@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 4C 24 18 85 C9 74 7D 31 F6 C7 04 24 01 00 00 00 EB 51 8B 2D ?? ?? ?? ?? 0F BE 01 F6 44 45 00 08 74 62 31 FF EB 10 6B C7 0A 8D 7C 18 D0 81 FF FF 00 00 00 7F 4F 41 8A 11 0F BE DA 0F B7 44 5D 00 A8 08 75 E2 83 3C 24 04 74 08 80 FA 2E 75 35 41 EB 09 41 84 D2 74 04 A8 20 74 29 FF 04 24 C1 E6 08 09 FE 83 3C 24 04 7E A9 83 7C 24 1C 00 B8 01 00 00 00 74 11 8B 44 24 1C 0F CE 89 30 B8 01 00 00 00 EB 02 31 C0 5A 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_ether_aton_r_fc48ddaf15f5d8673f6ac0fa369394b3 {
	meta:
		aliases = "ether_aton_r, __GI_ether_aton_r"
		size = "231"
		objfiles = "ether_addr@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 08 8B 4C 24 1C C7 44 24 04 00 00 00 00 E9 AF 00 00 00 0F BE 01 8B 2D ?? ?? ?? ?? 8A 54 45 00 88 D0 2C 30 3C 09 76 0C 88 D0 2C 61 3C 05 0F 87 9B 00 00 00 8B 3D ?? ?? ?? ?? 0F BE C2 8D 50 A9 8D 58 D0 8D 71 01 F6 04 47 08 0F BE 41 01 0F 44 DA 83 7C 24 04 04 8A 54 45 00 0F 96 44 24 03 77 05 80 FA 3A 75 14 83 7C 24 04 05 75 42 84 D2 74 3E 0F BE C2 F6 04 47 20 75 35 88 D0 2C 30 3C 09 76 08 88 D0 2C 61 3C 05 77 45 0F BE C2 F6 04 47 08 8D 48 D0 8D 50 A9 0F 44 CA 46 80 7C 24 03 00 74 05 80 3E 3A 75 28 89 D8 C1 E0 04 8D 1C 01 8B 54 24 04 8D 4E 01 8B 44 24 20 88 1C 10 42 89 54 24 04 83 }
	condition:
		$pattern
}
...
rule __decode_dotted_178fea88669f65176c8e272c7a50d500 {
	meta:
		aliases = "__decode_dotted"
		size = "219"
		objfiles = "decoded@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 83 7C 24 20 00 8B 54 24 24 0F 84 BA 00 00 00 31 ED 31 C9 C6 44 24 0B 01 E9 91 00 00 00 80 7C 24 0B 01 0F B6 D8 89 D8 8D 72 01 83 DD FF 25 C0 00 00 00 3D C0 00 00 00 75 23 89 DA 8B 5C 24 20 89 CF 80 7C 24 0B 01 0F B6 04 33 83 DD FF 83 E2 3F C1 E2 08 C6 44 24 0B 00 09 C2 EB 50 8D 04 0B 89 C7 47 3B 7C 24 2C 89 44 24 04 73 5D 50 53 8B 44 24 28 01 F0 50 8B 44 24 34 01 C8 50 E8 ?? ?? ?? ?? 83 C4 10 8B 4C 24 20 8D 44 1D 00 80 7C 24 0B 00 8D 14 33 8B 5C 24 28 0F 45 E8 80 3C 11 01 8B 4C 24 04 19 C0 F6 D0 24 2E 88 04 0B 89 F9 8B 5C 24 20 8A 04 13 84 C0 0F 85 60 FF FF FF 80 7C 24 0B }
	condition:
		$pattern
}
...
rule getsubopt_67760977babac7c61735073e0a99fb72 {
	meta:
		aliases = "getsubopt"
		size = "206"
		objfiles = "getsubopt@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 44 24 20 8B 38 C7 44 24 08 FF FF FF FF 80 3F 00 0F 84 A4 00 00 00 52 52 6A 2C 57 E8 ?? ?? ?? ?? 83 C4 0C 89 C3 29 F8 50 89 DD 6A 3D 57 E8 ?? ?? ?? ?? 83 C4 10 C7 44 24 08 00 00 00 00 85 C0 0F 45 E8 89 EA 29 FA 89 54 24 04 EB 42 50 FF 74 24 08 56 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C2 75 29 8B 44 24 04 80 3C 06 00 75 1F 8D 45 01 39 DD 0F 45 D0 8B 44 24 28 89 10 80 3B 00 74 04 C6 03 00 43 8B 54 24 20 89 1A EB 30 FF 44 24 08 8B 44 24 08 8B 54 24 24 8B 34 82 85 F6 75 AF 8B 44 24 28 89 38 80 3B 00 74 04 C6 03 00 43 8B 54 24 20 89 1A C7 44 24 08 FF FF FF FF 8B 44 24 08 83 C4 }
	condition:
		$pattern
}
...
rule regerror_2a6fc7c9d98e8a7a5c4b20bb08219f5e {
	meta:
...
rule setstate_r_44094b8bdb76360b8d5f78e1c0c41bc1 {
	meta:
		aliases = "__GI_setstate_r, setstate_r"
		size = "155"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 5C 24 24 8B 74 24 20 8B 4B 0C 83 C6 04 8B 53 08 85 C9 75 09 C7 42 FC 00 00 00 00 EB 10 8B 43 04 29 D0 C1 F8 02 8D 04 80 01 C8 89 42 FC 8B 46 FC BF 05 00 00 00 99 F7 FF 83 FA 04 77 40 8B 0C 95 ?? ?? ?? ?? 85 D2 8B 2C 95 ?? ?? ?? ?? 89 53 0C 89 4B 10 89 6B 14 74 18 8B 46 FC 99 F7 FF 8D 14 86 8D 44 05 00 89 53 04 99 F7 F9 8D 14 96 89 13 8D 04 8E 89 43 18 31 C0 89 73 08 EB 0E E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __GI_qsort_ba69741254dbade86a6d37484f5aed8c {
	meta:
...
rule __stdio_fwrite_5350188c1758920310ef6c2609997af1 {
	meta:
		aliases = "__stdio_fwrite"
		size = "234"
		objfiles = "_fwrite@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 74 24 28 8B 6C 24 20 8B 7C 24 24 F6 46 01 02 0F 85 AB 00 00 00 83 7E 04 FE 8B 56 10 8B 46 0C 75 1D 89 C3 29 D3 39 DF 50 0F 46 DF 53 55 52 E8 ?? ?? ?? ?? 83 C4 10 01 5E 10 E9 9A 00 00 00 29 D0 39 C7 77 63 51 57 55 52 E8 ?? ?? ?? ?? 83 C4 10 01 7E 10 F6 46 01 01 74 7F 52 57 6A 0A 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 6E 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 5E 39 F8 89 FB 0F 46 D8 89 F8 29 D8 01 C5 50 53 6A 0A 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C2 74 3E 8D 44 1D 00 29 D0 29 46 10 29 C7 EB 31 3B 56 08 74 14 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 04 31 FF EB 18 }
	condition:
		$pattern
}

rule __getdents_f04be9704f7b256ffe0eb70260455519 {
	meta:
		aliases = "__getdents"
		size = "134"
		objfiles = "getdents@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 7C 24 20 8B 4C 24 24 8B 54 24 28 53 89 FB B8 8D 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0E E8 ?? ?? ?? ?? F7 DE 89 30 83 CE FF EB 47 83 F8 FF 74 42 89 CF 8D 2C 01 EB 37 0F B7 47 08 8D 5F 0A 8A 44 07 FF 88 44 24 0B 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 0C 40 50 53 8D 47 0B 50 E8 ?? ?? ?? ?? 8A 44 24 1B 83 C4 10 88 47 0A 0F B7 47 08 01 C7 39 EF 72 C5 83 C4 0C 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule _stdlib_strto_l_c8acf2eac489fc4ba555a16ef917f690 {
	meta:
...
rule svcudp_reply_3ffeeef82e080b1b56e2c6bccd678d86 {
	meta:
...
rule __GI_getgrnam_r_cc5f26c3b0fc4b0f9817cca9b8118eee {
	meta:
		aliases = "getgrnam_r, __GI_getpwnam_r, getspnam_r, getpwnam_r, __GI_getspnam_r, __GI_getgrnam_r"
		size = "152"
...
rule fnmatch_89a86354d40ce17f5a5953a9f1ca83d4 {
	meta:
		aliases = "__GI_fnmatch, fnmatch"
		size = "1193"
		objfiles = "fnmatch_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 44 24 38 8B 5C 24 30 8B 7C 24 34 83 E0 01 89 44 24 04 88 44 24 03 8B 44 24 38 D1 E8 83 F0 01 24 01 88 44 24 02 E9 45 04 00 00 8B 6C 24 38 83 E5 10 74 1D 84 D2 78 19 0F BE C2 8D 0C 00 A1 ?? ?? ?? ?? F6 04 08 01 74 08 A1 ?? ?? ?? ?? 8A 14 08 43 80 FA 3F 74 24 7F 0E 80 FA 2A 0F 85 DD 03 00 00 E9 C4 00 00 00 80 FA 5B 0F 84 CF 01 00 00 80 FA 5C 0F 85 C6 03 00 00 EB 4A 8A 07 84 C0 0F 84 0C 04 00 00 80 7C 24 03 00 74 08 3C 2F 0F 84 FD 03 00 00 F6 44 24 38 04 0F 84 D0 03 00 00 3C 2E 0F 85 C8 03 00 00 3B 7C 24 34 0F 84 E0 03 00 00 80 7C 24 03 00 0F 84 B3 03 00 00 80 7F FF 2F E9 }
	condition:
		$pattern
}
...
rule __GI_bindresvport_620b2e35fcba4081686dfd1396722339 {
	meta:
		aliases = "bindresvport, __GI_bindresvport"
		size = "208"
		objfiles = "bindresvport@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 5C 24 34 8B 6C 24 30 85 DB 75 1B 52 6A 10 6A 00 8D 5C 24 18 53 E8 ?? ?? ?? ?? 66 C7 44 24 1C 02 00 83 C4 10 EB 19 66 83 3B 02 74 13 E8 ?? ?? ?? ?? C7 00 60 00 00 00 83 C8 FF E9 81 00 00 00 66 83 3D ?? ?? ?? ?? 00 75 1C E8 ?? ?? ?? ?? BA A8 01 00 00 89 D1 99 F7 F9 81 C2 58 02 00 00 66 89 15 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 F6 89 C7 C7 00 62 00 00 00 83 C8 FF EB 36 0F BF 05 ?? ?? ?? ?? 89 C2 40 98 66 C1 CA 08 66 3D FF 03 66 89 53 02 66 A3 ?? ?? ?? ?? 7E 09 66 C7 05 ?? ?? ?? ?? 58 02 50 46 6A 10 53 55 E8 ?? ?? ?? ?? 83 C4 10 81 FE A7 01 00 00 7F 09 85 C0 79 05 83 3F 62 74 B9 }
	condition:
		$pattern
}

rule __GI_getprotoent_r_3d3389f7f2ae0f44cbef83fdf618dcc9 {
	meta:
...
rule __read_etc_hosts_r_a3145c2f55162c38aed6f9c5596596b5 {
	meta:
		aliases = "__read_etc_hosts_r"
		size = "717"
		objfiles = "read_etc_hosts_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 5C 24 44 8B 54 24 48 89 D8 F7 D8 83 E0 03 74 0C 39 C2 0F 82 99 02 00 00 01 C3 29 C2 83 FA 1F 0F 86 8C 02 00 00 83 7C 24 3C 01 8D 43 20 89 44 24 18 8D 6A E0 0F 84 9D 00 00 00 8B 44 24 50 83 FD 03 C7 00 FF FF FF FF 0F 86 64 02 00 00 8D 42 DC 83 F8 07 0F 86 58 02 00 00 83 FD 0F 0F 86 4F 02 00 00 8D 42 D0 83 F8 07 0F 86 43 02 00 00 8D 43 30 8D 6A D4 89 44 24 14 8D 42 C8 39 E8 8D 7B 24 8D 73 2C 73 05 8D 73 38 89 C5 83 FD 4F 0F 86 1E 02 00 00 E8 ?? ?? ?? ?? 85 C0 89 44 24 30 74 1D 8B 54 24 18 8B 44 24 14 89 7C 24 04 89 74 24 18 89 14 24 89 54 24 08 89 44 24 0C EB 39 8B 54 24 }
	condition:
		$pattern
}
...
rule unsetenv_92ed15fd77e9cc31d6396c7f8229898a {
	meta:
...
rule __pgsreader_4b5d6b791d5bf201b185ac206c62c280 {
	meta:
		aliases = "__pgsreader"
		size = "282"
...
rule __GI_memcmp_59308768507e091460e9d0dd5222f40a {
	meta:
		aliases = "memcmp, bcmp, __GI_memcmp"
		size = "679"
		objfiles = "memcmp@libc.a"
	strings:
...
rule hsearch_r_d9642b3b761caba30fc013b13096a1d3 {
	meta:
		aliases = "__GI_hsearch_r, hsearch_r"
		size = "397"
		objfiles = "hsearch_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 8B 44 24 3C 8B 54 24 40 89 44 24 1C 89 54 24 20 50 E8 ?? ?? ?? ?? 83 C4 10 89 C1 EB 0F 8B 5C 24 10 89 C2 C1 E2 04 0F BE 04 0B 01 D0 49 83 F9 FF 75 EB 8B 54 24 40 8B 4C 24 40 8B 52 04 89 54 24 08 31 D2 F7 74 24 08 B8 01 00 00 00 8B 09 89 CB 89 4C 24 0C 85 D2 89 D6 0F 44 F0 6B C6 0C 01 C3 8B 03 85 C0 0F 84 9C 00 00 00 39 F0 75 20 52 52 FF 73 04 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 0B 8D 43 04 8B 5C 24 3C 89 03 EB 65 8B 54 24 08 89 F0 89 F3 83 EA 02 89 D1 31 D2 F7 F1 8B 44 24 08 8D 6A 01 29 E8 89 44 24 04 8B 4C 24 04 89 D8 29 E8 39 EB 8D 14 0B 89 D3 0F 47 D8 39 F3 74 }
	condition:
		$pattern
}
...
rule _stdio_fopen_b435d88cf43eeba5ee634e4e49e8fa9f {
	meta:
		aliases = "_stdio_fopen"
		size = "572"
		objfiles = "_fopen@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 54 24 44 8B 5C 24 40 8B 6C 24 48 8B 7C 24 4C 8A 02 3C 72 74 3E 3C 77 BE 41 02 00 00 74 37 3C 61 66 BE 41 04 74 2F E8 ?? ?? ?? ?? 85 ED C7 00 16 00 00 00 0F 84 EF 01 00 00 F6 45 01 20 0F 84 E5 01 00 00 83 EC 0C 55 31 ED E8 ?? ?? ?? ?? E9 D0 01 00 00 31 F6 80 7A 01 62 8D 42 01 0F 45 C2 80 78 01 2B 75 08 89 F0 83 C8 01 8D 70 01 85 ED 75 32 83 EC 0C 6A 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C5 0F 84 A2 01 00 00 66 C7 00 00 20 83 EC 0C C7 40 08 00 00 00 00 8D 40 38 50 E8 ?? ?? ?? ?? 83 C4 10 85 FF 78 49 89 F2 81 E2 03 80 00 00 42 8D 43 01 21 D0 39 D0 89 7D 04 0F 85 66 FF FF FF }
	condition:
		$pattern
}

rule _stdlib_strto_ll_decd662338c29cbc547aef0ce0e61fa2 {
	meta:
...
rule __GI_lockf64_8e296c309216b83ca1b3e52c249cec1a {
	meta:
...
rule svcudp_recv_730216b0be9fa2a15a0695336f8263c8 {
	meta:
		aliases = "svcudp_recv"
		size = "507"
		objfiles = "svc_udp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 6C 24 40 8D 45 34 8B 75 30 8D 5D 3C 89 44 24 0C 8B 54 24 0C 89 DF C7 44 24 28 10 00 00 00 89 54 24 14 8D 55 10 83 7B 0C 00 74 4E 8B 45 2C 89 45 34 8B 06 8B 4C 24 14 89 41 04 8D 45 58 89 55 3C 89 43 10 89 4B 08 C7 43 0C 01 00 00 00 C7 43 04 10 00 00 00 C7 43 14 DC 00 00 00 50 6A 00 53 FF 75 00 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C2 78 25 8B 43 04 89 44 24 28 EB 1C 50 50 8D 44 24 30 50 52 6A 00 FF 36 FF 75 2C FF 75 00 E8 ?? ?? ?? ?? 83 C4 20 89 C2 8B 44 24 28 83 FA FF 89 45 0C 75 13 E8 ?? ?? ?? ?? 83 38 04 0F 85 3A 01 00 00 E9 5C FF FF FF 83 FA 0F 0F 8E 2C 01 00 00 C7 46 08 }
	condition:
		$pattern
}
...
rule rendezvous_request_a38670127083924b3dc3e3b6d3bf74f8 {
	meta:
		aliases = "rendezvous_request"
		size = "104"
		objfiles = "svc_tcp@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 74 24 40 8D 6C 24 18 8D 7C 24 28 8B 5E 2C C7 44 24 28 10 00 00 00 50 57 55 FF 36 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0C E8 ?? ?? ?? ?? 83 38 04 75 25 EB DB 8B 4B 04 8B 13 E8 ?? ?? ?? ?? 56 6A 10 55 89 C3 8D 40 10 50 E8 ?? ?? ?? ?? 8B 44 24 38 83 C4 10 89 43 0C 83 C4 2C 31 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __res_search_cc5cb25dda4742f52d006ff0667f2ddc {
	meta:
		aliases = "__res_search"
		size = "698"
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 28 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 35 ?? ?? ?? ?? 5F 5D 6A 01 53 E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 40 00 74 14 83 7C 24 4C 00 74 0D 83 E6 01 75 18 E8 ?? ?? ?? ?? 40 75 10 E8 ?? ?? ?? ?? C7 00 FF FF FF FF E9 3A 02 00 00 E8 ?? ?? ?? ?? 89 44 24 0C C7 00 00 00 00 00 E8 ?? ?? ?? ?? C7 00 01 00 00 00 89 C7 8B 54 24 40 C7 44 24 10 00 00 00 00 EB 0D 3C 2E 0F 94 C0 42 0F B6 C0 01 44 24 10 8A 02 84 C0 75 ED 31 ED 3B 54 24 40 76 0A 80 7A FF 2E 0F 94 C0 0F B6 E8 51 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 28 53 E8 ?? ?? ?? }
	condition:
		$pattern
}
...
rule tcsetattr_c11027d0ac9974be44d503fa0448d9a2 {
	meta:
...
rule writeunix_9bed97c6524c8e2b7231ffa4dcab6cdc {
	meta:
		aliases = "writeunix"
		size = "248"
		objfiles = "svc_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 3C 8B 7C 24 58 8B 74 24 54 89 FB E9 D0 00 00 00 8B 44 24 50 8B 00 89 44 24 08 E8 ?? ?? ?? ?? 89 44 24 28 E8 ?? ?? ?? ?? 89 44 24 2C E8 ?? ?? ?? ?? 89 44 24 30 50 6A 0C 8D 54 24 30 52 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8D 44 24 44 89 74 24 44 89 5C 24 48 89 44 24 24 C7 44 24 28 01 00 00 00 C7 44 24 1C 00 00 00 00 C7 44 24 20 00 00 00 00 C7 44 24 2C ?? ?? ?? ?? C7 44 24 30 18 00 00 00 C7 44 24 34 00 00 00 00 83 C4 10 C7 05 ?? ?? ?? ?? 01 00 00 00 8D 6C 24 0C C7 05 ?? ?? ?? ?? 02 00 00 00 C7 05 ?? ?? ?? ?? 18 00 00 00 50 6A 00 55 FF 74 24 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 1C E8 ?? }
	condition:
		$pattern
}
...
rule __regexec_0270e96b8b4110986bdbd332c01a09ef {
	meta:
...
rule __res_query_e2ae06079c3e74491326e79133ad9020 {
	meta:
...
rule __strtofpmax_cd0f9709892f8c3857fb4b6f4bf20f2f {
	meta:
		aliases = "__strtofpmax"
		size = "531"
		objfiles = "__strtofpmax@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 8B 7C 24 68 8B 5C 24 60 EB 01 43 A1 ?? ?? ?? ?? 89 44 24 38 8A 13 8B 4C 24 38 0F BE C2 F6 04 41 20 75 E7 80 FA 2B 74 17 80 FA 2D C7 44 24 3C 00 00 00 00 75 13 C7 44 24 3C 01 00 00 00 EB 08 C7 44 24 3C 00 00 00 00 43 D9 EE 31 F6 83 C9 FF EB 2B 81 F9 00 00 00 80 83 D9 FF 85 C9 75 05 80 FA 30 74 18 41 83 F9 15 7F 12 D8 0D ?? ?? ?? ?? 83 E8 30 50 DB 04 24 83 C4 04 DE C1 43 8A 13 8B 6C 24 38 0F BE C2 F6 44 45 00 08 75 C5 80 FA 2E 75 09 85 F6 75 05 43 89 DE EB E2 85 C9 79 77 85 F6 75 6A 31 FF 31 F6 8D 6F 01 EB 37 46 80 BC 2E ?? ?? ?? ?? 00 75 2C DD D8 57 0F BE 87 ?? ?? ?? ?? DB }
	condition:
		$pattern
}

rule __wcstofpmax_b0308f0247900b72d1c1f42b3846acac {
	meta:
		aliases = "__wcstofpmax"
		size = "542"
		objfiles = "__wcstofpmax@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 8B 7C 24 68 8B 5C 24 60 EB 03 83 C3 04 83 EC 0C FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 EC 8B 03 83 F8 2B 74 17 83 F8 2D C7 44 24 3C 00 00 00 00 75 15 C7 44 24 3C 01 00 00 00 EB 08 C7 44 24 3C 00 00 00 00 83 C3 04 D9 EE 31 F6 83 C9 FF EB 2D 81 F9 00 00 00 80 83 D9 FF 85 C9 75 05 83 FA 30 74 18 41 83 F9 15 7F 12 D8 0D ?? ?? ?? ?? 8D 42 D0 50 DB 04 24 83 C4 04 DE C1 83 C3 04 A1 ?? ?? ?? ?? 89 44 24 38 8B 13 F6 04 50 08 75 C2 83 FA 2E 75 0B 85 F6 75 07 83 C3 04 89 DE EB DF 85 C9 79 76 85 F6 75 69 31 FF 31 F6 8D 6F 01 EB 37 46 80 BC 2E ?? ?? ?? ?? 00 75 2C DD D8 57 0F BE 87 ?? }
	condition:
		$pattern
}

rule __time_localtime_tzi_c079136625c7915e7de93f8a034fb2bb {
	meta:
		aliases = "__time_localtime_tzi"
		size = "740"
		objfiles = "_time_localtime_tzi@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C C7 44 24 20 00 00 00 00 8B 4C 24 60 6B 44 24 20 18 8B 5C 24 68 8B 11 B9 F9 FF FF FF 01 C3 B8 80 3A 09 00 2B 03 81 FA 7F C5 F6 7F 7E 07 F7 D8 B9 07 00 00 00 01 D0 89 44 24 48 8D 7B 10 56 FF 74 24 68 51 8D 74 24 54 56 BE ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 74 8B 54 24 30 89 50 20 8B 03 8B 4C 24 74 83 C4 10 F7 D8 89 41 24 EB 19 51 51 57 8D 5E 04 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 04 89 D8 EB 50 8B 36 85 F6 75 E3 52 52 6A 07 57 E8 ?? ?? ?? ?? 83 C4 10 83 F8 06 77 33 83 EC 0C 6A 0C E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C2 74 20 A1 ?? ?? ?? ?? 8D 5A 04 89 02 50 50 57 53 89 15 ?? ?? }
	condition:
		$pattern
}
...
rule __GI_llrint_1079000bed9bf1c34623ca8a57366bda {
	meta:
...
rule __GI_inet_ntop_ff5be40d52a87cfa020a6aafcd99cc51 {
	meta:
		aliases = "inet_ntop, __GI_inet_ntop"
		size = "463"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 5C 8B 44 24 70 83 F8 02 74 0B 83 F8 0A 0F 85 9F 01 00 00 EB 18 8B 54 24 78 8B 4C 24 7C 8B 44 24 74 E8 ?? ?? ?? ?? 89 C2 E9 92 01 00 00 50 6A 20 6A 00 8D 44 24 48 50 E8 ?? ?? ?? ?? 31 C9 83 C4 10 89 C8 BA 02 00 00 00 89 D6 99 F7 FE 8B 54 24 74 89 C3 0F B6 04 0A 0F B6 54 11 01 83 C1 02 C1 E0 08 09 D0 83 F9 0F 89 44 9C 3C 7E D4 31 D2 83 CF FF 83 C8 FF EB 2E 83 7C 94 3C 00 75 11 83 F8 FF 75 09 89 D0 BB 01 00 00 00 EB 18 43 EB 15 83 F8 FF 74 10 83 FF FF 74 04 39 EB 7E 04 89 DD 89 C7 83 C8 FF 42 83 FA 07 7E CD 83 F8 FF 74 0D 83 FF FF 74 04 39 EB 7E 04 89 DD 89 C7 83 FF FF 74 0B 83 }
	condition:
		$pattern
}
...
rule __GI_gethostbyaddr_r_38deb6e56a55f08579dd8d67ba55b269 {
	meta:
		aliases = "gethostbyaddr_r, __GI_gethostbyaddr_r"
		size = "885"
		objfiles = "gethostbyaddr_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 5C 8B 74 24 70 8B 84 24 88 00 00 00 8B AC 24 80 00 00 00 8B 9C 24 84 00 00 00 85 F6 C7 00 00 00 00 00 0F 84 33 03 00 00 57 6A 28 6A 00 8D 44 24 2C 50 E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 78 02 74 0D 83 7C 24 78 0A 0F 85 0F 03 00 00 EB 07 83 7C 24 74 04 EB 05 83 7C 24 74 10 0F 85 FB 02 00 00 FF B4 24 8C 00 00 00 FF B4 24 8C 00 00 00 53 55 FF B4 24 8C 00 00 00 FF B4 24 8C 00 00 00 FF B4 24 8C 00 00 00 56 E8 ?? ?? ?? ?? 83 C4 20 85 C0 0F 84 D1 02 00 00 8B 8C 24 8C 00 00 00 8B 11 83 FA 01 74 09 83 FA 04 0F 85 BA 02 00 00 E8 ?? ?? ?? ?? 8B 84 24 8C 00 00 00 83 FB 03 C7 00 FF FF FF FF }
	condition:
		$pattern
}
...
rule _ppfs_parsespec_b093c6ba63154091cd476670b4c6a8b7 {
	meta:
		aliases = "_ppfs_parsespec"
		size = "1078"
		objfiles = "_ppfs_parsespec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 6C 8B 84 24 80 00 00 00 C7 44 24 60 00 00 00 00 8B 94 24 80 00 00 00 C7 44 24 64 00 00 00 00 C7 44 24 44 08 00 00 00 C7 44 24 48 08 00 00 00 8B 40 18 89 44 24 14 8B 6A 10 81 E5 80 00 00 00 75 04 8B 12 EB 3C 31 F6 8B 84 24 80 00 00 00 8D 0C B5 00 00 00 00 8B 10 8B 44 11 FC 88 44 34 24 88 C3 0F BE C0 3B 44 11 FC 0F 85 B7 03 00 00 84 DB 74 06 46 83 FE 1F 76 CF C6 44 24 43 00 8D 54 24 25 C7 44 24 0C 00 00 00 00 C7 44 24 10 00 00 00 00 EB 02 89 F2 80 3A 2A 89 D6 75 10 6B 44 24 10 FC 8D 72 01 C7 44 04 44 00 00 00 00 31 DB EB 10 81 FB FE 0F 00 00 7F 07 6B C3 0A 8D 5C 38 D0 46 8A 0E }
	condition:
		$pattern
}

rule _time_mktime_tzi_8e29c6a66824b04eb4d5a620d642742b {
	meta:
		aliases = "_time_mktime_tzi"
		size = "714"
		objfiles = "_time_mktime_tzi@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 6C 8D 6C 24 38 51 6A 2C FF B4 24 88 00 00 00 55 E8 ?? ?? ?? ?? 83 C4 10 31 C0 8B 94 24 88 00 00 00 80 7A 28 00 C7 44 24 34 00 00 00 00 0F 45 44 24 58 85 C0 89 44 24 58 74 18 85 C0 0F 9F C0 0F B6 C0 8D 44 00 FF 89 44 24 58 C7 44 24 34 01 00 00 00 8D 4D 14 BF 90 01 00 00 89 4C 24 24 8D 5D 18 8B 4D 14 8D 75 1C 89 5C 24 28 89 C8 99 F7 FF 8D 55 10 89 44 24 04 89 45 18 89 54 24 2C 8B 5D 10 89 D8 89 5C 24 14 99 BB 0C 00 00 00 F7 FB 89 44 24 10 01 C1 89 45 1C 69 5C 24 04 90 01 00 00 29 D9 89 4D 14 6B 44 24 10 0C 8B 54 24 14 29 C2 85 D2 89 D0 89 55 10 79 0C 83 C0 0C 89 45 10 8B 4C 24 }
	condition:
		$pattern
}
...
rule random_r_cc7e0237ffa405be517b89667dbd582d {
	meta:
		aliases = "__GI_random_r, random_r"
		size = "94"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 5C 24 14 8B 6C 24 18 83 7B 0C 00 8B 73 08 75 17 69 06 6D 4E C6 41 05 39 30 00 00 25 FF FF FF 7F 89 06 89 45 00 EB 2B 8B 03 8B 4B 04 8B 7B 18 8B 10 03 11 89 10 83 C0 04 D1 EA 39 F8 89 55 00 8D 51 04 72 04 89 F0 EB 05 39 FA 0F 43 D6 89 03 89 53 04 5B 31 C0 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule register_printf_function_b729eb86afb0b6ab7580fe51300b493c {
	meta:
		aliases = "register_printf_function"
		size = "103"
		objfiles = "register_printf_function@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 8B 74 24 14 8B 7C 24 18 8B 6C 24 1C 85 F6 74 4B 85 ED 74 47 8B 1D ?? ?? ?? ?? 31 C9 8D 53 0A 4A 0F BE 02 84 C0 0F 44 CA 39 F0 75 04 89 D1 89 DA 39 DA 77 EB 85 C9 74 23 85 FF 74 18 89 F0 88 01 89 C8 29 D0 89 3C 85 ?? ?? ?? ?? 89 2C 85 ?? ?? ?? ?? EB 03 C6 01 00 31 C0 EB 03 83 C8 FF 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule readunix_71b97b32376d42d47838788e0fd1f1eb {
	meta:
		aliases = "readunix"
		size = "361"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 BB E8 03 00 00 83 EC 3C 8B 74 24 50 8B 6C 24 58 8B 4E 0C 89 C8 99 F7 FB 66 31 DB 89 C1 69 46 08 E8 03 00 00 85 ED 8D 3C 01 0F 84 2C 01 00 00 8B 06 8D 5C 24 30 66 C7 44 24 34 01 00 89 44 24 30 50 57 6A 01 53 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 74 10 85 C0 75 30 C7 86 84 00 00 00 05 00 00 00 EB 1C E8 ?? ?? ?? ?? 83 38 04 74 D4 C7 86 84 00 00 00 04 00 00 00 8B 00 89 86 88 00 00 00 83 CB FF E9 D5 00 00 00 8B 44 24 54 8B 3E 89 6C 24 2C C7 44 24 18 01 00 00 00 89 44 24 28 8D 44 24 28 89 44 24 14 C7 44 24 0C 00 00 00 00 C7 44 24 10 00 00 00 00 C7 44 24 1C ?? ?? ?? ?? C7 44 24 20 18 00 00 00 }
	condition:
		$pattern
}
...
rule sigwait_6864661164f5ac89da77d57a0b6305e2 {
	meta:
		aliases = "sigwait"
		size = "355"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 BE 01 00 00 00 53 81 EC BC 01 00 00 E8 ?? ?? ?? ?? 8B AC 24 D0 01 00 00 89 84 24 B8 01 00 00 83 EC 0C 8D 9C 24 44 01 00 00 53 89 DF E8 ?? ?? ?? ?? 58 5A FF 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 8D 9C 24 AC 00 00 00 EB 74 50 50 56 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 63 3B 35 ?? ?? ?? ?? 74 5B 3B 35 ?? ?? ?? ?? 74 53 3B 35 ?? ?? ?? ?? 74 4B 50 50 56 57 E8 ?? ?? ?? ?? 83 C4 10 83 3C B5 ?? ?? ?? ?? 01 77 35 C7 84 24 AC 00 00 00 ?? ?? ?? ?? 83 EC 0C 8D 84 24 BC 00 00 00 50 E8 ?? ?? ?? ?? C7 84 24 40 01 00 00 00 00 00 00 83 C4 0C 6A 00 53 56 E8 ?? ?? ?? ?? 83 C4 10 46 83 FE 41 7E 87 50 }
	condition:
		$pattern
}
...
rule shm_open_f9a0fdfe33a2bc1ab0507581e80ca6df {
	meta:
		aliases = "shm_open"
		size = "135"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 57 83 CF FF 56 53 83 EC 0C 8B 44 24 20 E8 ?? ?? ?? ?? 85 C0 89 C5 74 64 56 FF 74 24 2C FF 74 24 2C 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 78 35 53 6A 00 6A 01 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 14 83 C8 01 51 50 6A 02 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0F 83 EC 0C 57 83 CF FF E8 ?? ?? ?? ?? 83 C4 10 E8 ?? ?? ?? ?? 83 EC 0C 8B 30 89 C3 55 E8 ?? ?? ?? ?? 83 C4 10 89 33 83 C4 0C 89 F8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __md5_Update_f1386175b7fd7def8464216738478243 {
	meta:
...
rule __copy_rpcent_201aabb901d8943e8120a397d2afd4b8 {
	meta:
		aliases = "__copy_rpcent"
		size = "267"
		objfiles = "getrpcent@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 89 D7 56 89 C6 53 89 CB 83 EC 0C 85 F6 8B 44 24 24 C7 00 00 00 00 00 B8 02 00 00 00 0F 84 DF 00 00 00 50 6A 0C 6A 00 52 E8 ?? ?? ?? ?? 83 C4 0C FF 74 24 24 6A 00 53 E8 ?? ?? ?? ?? 8B 46 08 31 D2 83 C4 10 89 47 08 8B 46 04 8B 04 90 42 85 C0 75 F5 8D 04 95 00 00 00 00 39 44 24 20 0F 82 99 00 00 00 8D 6A FF 8B 54 24 20 89 5F 04 01 C3 89 5C 24 08 29 C2 89 54 24 04 EB 4B 8B 46 04 83 EC 0C 8D 1C AD 00 00 00 00 FF 34 18 E8 ?? ?? ?? ?? 83 C4 10 8D 50 01 39 54 24 04 72 60 8B 4C 24 08 8B 47 04 89 0C 18 01 D1 89 4C 24 08 29 54 24 04 50 8B 46 04 52 FF 34 18 8B 47 04 FF 34 18 E8 ?? ?? ?? ?? 83 C4 10 }
	condition:
		$pattern
}
...
rule srandom_r_d8e0eb3afd074470962931f70c2bbac2 {
	meta:
		aliases = "__GI_srandom_r, srandom_r"
		size = "154"
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 83 C8 FF 57 56 53 83 EC 18 8B 74 24 30 8B 54 24 2C 8B 4E 0C 83 F9 04 77 78 8B 5E 08 85 D2 B8 01 00 00 00 0F 44 D0 85 C9 89 13 74 63 8B 46 10 89 D9 BF 01 00 00 00 89 04 24 EB 2E 89 D0 BD 1D F3 01 00 99 F7 FD 89 44 24 04 69 D2 A7 41 00 00 69 C0 14 0B 00 00 29 C2 83 FA FF 8D 82 FF FF FF 7F 0F 4E D0 83 C1 04 89 11 47 3B 3C 24 7C CD 8B 46 14 8D 7C 24 14 89 5E 04 8D 04 83 89 06 6B 1C 24 0A EB 09 57 56 E8 ?? ?? ?? ?? 58 5A 4B 79 F4 31 C0 83 C4 18 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _dl_map_cache_3c576e6b38f4905456e9d5957db5962b {
	meta:
		aliases = "_dl_map_cache"
		size = "497"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 83 C8 FF 57 56 53 83 EC 50 8B 15 ?? ?? ?? ?? 83 FA FF 0F 84 D0 01 00 00 85 D2 0F 85 C6 01 00 00 BE ?? ?? ?? ?? 8D 4C 24 0C 89 F0 53 89 C3 B8 6A 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0D F7 DB 89 1D ?? ?? ?? ?? E9 8B 01 00 00 85 C0 0F 85 83 01 00 00 31 D2 89 C1 53 89 F3 B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0D F7 DF 89 3D ?? ?? ?? ?? E9 5E 01 00 00 85 C0 0F 88 56 01 00 00 8B 4C 24 20 BE 01 00 00 00 89 D8 C7 44 24 4C 00 00 00 00 89 F2 89 0D ?? ?? ?? ?? 53 89 C3 55 8B 6C 24 4C B8 C0 00 00 00 CD 80 5D 5B 3D 00 F0 FF FF 89 C1 76 0B F7 D9 89 0D ?? ?? ?? ?? 83 C9 FF 89 0D ?? ?? ?? ?? }
	condition:
		$pattern
}

rule shm_unlink_d5ba0515ea4e682ade2d19ea1ccca9c7 {
	meta:
		aliases = "shm_unlink"
		size = "68"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 83 CD FF 57 56 53 83 EC 0C 8B 44 24 20 E8 ?? ?? ?? ?? 85 C0 89 C7 74 21 83 EC 0C 50 E8 ?? ?? ?? ?? 89 C5 E8 ?? ?? ?? ?? 8B 30 89 C3 89 3C 24 E8 ?? ?? ?? ?? 83 C4 10 89 33 83 C4 0C 89 E8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule getoffset_5ce5025cdf7bea0cc21bd317f896f701 {
	meta:
		aliases = "getoffset"
		size = "109"
		objfiles = "tzset@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 C1 57 BD ?? ?? ?? ?? 56 31 FF 53 83 CE FF 83 EC 04 89 14 24 8A 11 45 88 D0 2C 30 3C 09 77 07 0F BE C2 41 8D 70 D0 8A 19 88 D8 2C 30 3C 09 77 0B 6B D6 0A 0F BE C3 41 8D 74 02 D0 8A 55 00 0F BE C2 39 C6 72 04 31 C9 EB 1A 0F AF C7 8D 3C 06 31 F6 80 39 3A 75 04 41 83 CE FF FE CA 7F B6 8B 04 24 89 38 5A 89 C8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule do_dlclose_ab04c7db77040408a6fb5ac374d7946c {
	meta:
		aliases = "do_dlclose"
		size = "555"
		objfiles = "libdl@libdl.a"
...
rule __md5_Transform_5a9c35a10e525d17ce7fdf3f23e09405 {
	meta:
		aliases = "__md5_Transform"
		size = "329"
		objfiles = "md5@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 89 C5 57 56 53 83 EC 70 6A 40 52 8D 44 24 38 50 E8 ?? ?? ?? ?? 8B 45 00 8D 55 04 89 54 24 1C 8D 55 0C 89 44 24 38 8D 45 08 8B 7D 04 89 44 24 20 8B 4C 24 38 8B 75 08 89 54 24 24 8B 5D 0C C7 44 24 28 ?? ?? ?? ?? C7 44 24 2C ?? ?? ?? ?? C7 44 24 30 ?? ?? ?? ?? C7 44 24 34 00 00 00 00 83 C4 10 E9 A4 00 00 00 8B 44 24 18 83 C0 04 F6 44 24 24 0F 0F 45 44 24 18 89 44 24 18 8B 44 24 24 C1 F8 04 83 F8 01 74 1E 7F 06 85 C0 74 0E EB 37 83 F8 02 74 1F 83 F8 03 74 22 EB 2B 89 F8 89 F2 F7 D0 21 D8 EB 08 89 D8 89 DA F7 D0 21 F0 21 FA 09 D0 EB 10 89 F0 31 F8 31 D8 EB 08 89 D8 F7 D0 09 F8 31 F0 8D 0C 08 8B }
	condition:
		$pattern
}
...
rule rwlock_have_already_5e1689a32e65f76cfa09c69fb52beeda {
	meta:
		aliases = "rwlock_have_already"
		size = "175"
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 CD 57 89 C7 56 89 D6 53 83 EC 0C 83 7A 18 01 8B 18 74 06 31 D2 31 C9 EB 74 85 DB 75 07 E8 ?? ?? ?? ?? 89 C3 8B 93 C0 01 00 00 EB 07 39 72 04 74 08 8B 12 85 D2 75 F5 EB 04 85 D2 75 54 83 BB C8 01 00 00 00 7F 4B 8B 93 C4 01 00 00 85 D2 74 0A 8B 02 89 83 C4 01 00 00 EB 0F 83 EC 0C 6A 0C E8 ?? ?? ?? ?? 83 C4 10 89 C2 85 D2 74 18 C7 42 08 01 00 00 00 89 72 04 8B 83 C0 01 00 00 89 02 89 93 C0 01 00 00 83 FA 01 19 C9 83 E1 01 31 F6 EB 07 31 C9 BE 01 00 00 00 8B 44 24 20 89 08 89 F0 89 55 00 89 1F 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule inet_pton4_b8f5196a7ed56e215cffaff174751ee4 {
	meta:
		aliases = "inet_pton4"
		size = "135"
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 31 D2 56 31 FF 53 89 C3 83 EC 1C 8D 74 24 18 C6 44 24 18 00 EB 40 0F BE C0 43 8D 48 D0 83 F9 09 77 20 0F B6 06 6B C0 0A 8D 04 01 3D FF 00 00 00 77 47 85 D2 88 06 75 1E 47 83 FF 04 7F 3B B2 01 EB 14 83 F8 2E 75 32 85 D2 74 2E 83 FF 04 74 29 46 31 D2 C6 06 00 8A 03 84 C0 75 BA 83 FF 03 7E 18 50 6A 04 8D 44 24 20 50 55 E8 ?? ?? ?? ?? B8 01 00 00 00 83 C4 10 EB 02 31 C0 83 C4 1C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule get_input_bytes_9f176ba95481ae70f6a9418b5d1576ed {
	meta:
		aliases = "get_input_bytes"
		size = "81"
		objfiles = "xdr_rec@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 89 C7 56 89 CE 53 83 EC 0C EB 31 8B 57 2C 8B 47 30 29 D0 75 0D 89 F8 E8 ?? ?? ?? ?? 85 C0 75 1C EB 23 39 C6 89 C3 0F 4E DE 51 29 DE 53 52 55 01 DD E8 ?? ?? ?? ?? 83 C4 10 01 5F 2C 85 F6 7F CB B8 01 00 00 00 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule byte_compile_range_d7e366b01cc267ab96f36fc3f8904fc7 {
	meta:
		aliases = "byte_compile_range"
		size = "204"
		objfiles = "regex_old@libc.a"
...
rule do_des_40fadfa36abe8a2bef70d614a747f01a {
	meta:
		aliases = "do_des"
		size = "795"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 89 D5 57 BA 01 00 00 00 56 53 83 EC 34 83 7C 24 4C 00 89 4C 24 04 0F 84 F4 02 00 00 7E 12 C7 44 24 28 ?? ?? ?? ?? C7 44 24 2C ?? ?? ?? ?? EB 14 F7 5C 24 4C C7 44 24 28 ?? ?? ?? ?? C7 44 24 2C ?? ?? ?? ?? 89 C2 0F B6 CC C1 EA 18 89 EB 89 54 24 08 89 C2 25 FF 00 00 00 89 44 24 10 89 E8 89 EE C1 E8 10 0F B6 FF 89 4C 24 0C 25 FF 00 00 00 89 E9 8B 6C 24 08 C1 EA 10 81 E1 FF 00 00 00 89 04 24 8B 44 24 10 81 E2 FF 00 00 00 C1 EE 18 8B 1C AD ?? ?? ?? ?? 0B 1C 85 ?? ?? ?? ?? 8B 6C 24 0C 0B 1C 95 ?? ?? ?? ?? 8B 04 24 0B 1C AD ?? ?? ?? ?? 0B 1C B5 ?? ?? ?? ?? 0B 1C 8D ?? ?? ?? ?? 0B 1C 85 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule pthread_initialize_1b06cb49cecb2031ead4c7cc2b683788 {
	meta:
		aliases = "pthread_initialize"
		size = "415"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 81 EC 20 01 00 00 83 3D ?? ?? ?? ?? 00 0F 85 80 01 00 00 8D 85 00 00 C0 FF 25 00 00 E0 FF A3 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 A3 ?? ?? ?? ?? A1 ?? ?? ?? ?? EB 10 83 78 34 01 74 07 C7 40 34 00 00 00 00 8B 40 20 85 C0 75 EC 50 50 8D 5D F0 53 6A 03 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? BA 00 00 20 00 83 C4 10 01 C0 29 C2 39 55 F0 76 10 50 50 53 6A 03 89 55 F0 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 8D 9D E8 FE FF FF 53 8D B5 E4 FE FF FF C7 85 E4 FE FF FF ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 0C 6A 00 56 FF 35 ?? ?? ?? }
	condition:
		$pattern
}

rule pthread_start_thread_c7288ff2322d194c724062059a1973e7 {
	meta:
		aliases = "pthread_start_thread"
		size = "198"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 81 EC A0 00 00 00 8B 75 08 E8 ?? ?? ?? ?? 89 46 14 8D 46 64 53 6A 00 50 6A 02 E8 ?? ?? ?? ?? 8B 96 E4 00 00 00 83 C4 10 85 D2 78 0B 8D 86 E8 00 00 00 51 50 52 EB 17 83 3D ?? ?? ?? ?? 00 7E 19 50 8D 45 F4 50 6A 00 C7 45 F4 00 00 00 00 FF 76 14 E8 ?? ?? ?? ?? 83 C4 10 A1 ?? ?? ?? ?? 85 C0 74 4D 83 3D ?? ?? ?? ?? 00 7E 44 89 B5 60 FF FF FF 8D 9D 60 FF FF FF C7 85 64 FF FF FF 05 00 00 00 50 68 94 00 00 00 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 DE 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C FF 76 60 FF 56 5C 5B 5E 55 50 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule sem_wait_813fadfea88bdb78b11e43f3418340b8 {
	meta:
		aliases = "__new_sem_wait, sem_wait"
		size = "253"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 83 EC 10 E8 ?? ?? ?? ?? 8B 75 08 C7 45 F0 ?? ?? ?? ?? 89 75 EC 89 45 F4 89 F0 8B 55 F4 E8 ?? ?? ?? ?? 8B 46 08 85 C0 7E 15 83 EC 0C 48 89 46 08 56 E8 ?? ?? ?? ?? 83 C4 10 E9 B1 00 00 00 8B 45 F4 8D 55 EC C6 80 BA 01 00 00 00 8B 45 F4 E8 ?? ?? ?? ?? 8B 45 F4 80 78 42 00 74 0E 8B 45 F4 BB 01 00 00 00 80 78 40 00 74 0D 8B 55 F4 8D 46 0C 31 DB E8 ?? ?? ?? ?? 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 DB 74 0C 8B 45 F4 31 D2 E8 ?? ?? ?? ?? EB 52 8B 45 F4 E8 ?? ?? ?? ?? 8B 45 F4 80 B8 BA 01 00 00 00 75 15 8B 45 F4 80 B8 B8 01 00 00 00 74 E0 8B 45 F4 80 78 40 00 75 D7 8B 45 F4 31 D2 E8 ?? }
	condition:
		$pattern
}
...
rule __GI_execle_29075f91bbfe17132ea473f8a9ca2c55 {
	meta:
...
rule glob_in_dir_92a42c044b43f5a20607e4657d18978a {
	meta:
		aliases = "glob_in_dir"
		size = "1353"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 08 02 00 00 52 8B 75 08 89 95 08 FE FF FF 89 8D 04 FE FF FF 89 85 0C FE FF FF E8 ?? ?? ?? ?? 8B 9D 04 FE FF FF 83 C4 10 83 E3 40 89 85 10 FE FF FF 0F 94 C0 0F B6 C0 50 FF B5 0C FE FF FF E8 ?? ?? ?? ?? 5A 59 85 C0 0F 85 D1 00 00 00 F7 85 04 FE FF FF 10 08 00 00 0F 85 B5 00 00 00 85 DB 75 1A 50 50 6A 5C FF B5 0C FE FF FF E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 A3 00 00 00 83 EC 0C FF B5 0C FE FF FF E8 ?? ?? ?? ?? 8B 95 10 FE FF FF 83 C4 10 89 C6 8D 44 10 20 83 E0 F0 29 C4 8D 5C 24 0F 57 83 E3 F0 52 FF B5 08 FE FF FF 53 E8 ?? ?? ?? ?? 83 C4 0C 6A 01 68 ?? ?? ?? ?? 50 E8 ?? ?? }
	condition:
		$pattern
}

rule byte_re_match_2_internal_00fb96e5f195fb4c813f8f5c4de2d581 {
	meta:
		aliases = "byte_re_match_2_internal"
		size = "6980"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 0C 01 00 00 89 85 4C FF FF FF 8D 7C 24 0F 8B 5D 18 89 95 48 FF FF FF 8B 95 4C FF FF FF 83 E7 F0 89 8D 44 FF FF FF 8B 00 89 85 70 FF FF FF 03 42 08 89 85 74 FF FF FF 8B 4A 14 89 8D 7C FF FF FF 8B 72 18 89 7D CC 46 89 75 80 83 7A 18 00 75 41 C7 45 8C 00 00 00 00 C7 45 90 00 00 00 00 C7 45 94 00 00 00 00 C7 45 98 00 00 00 00 C7 45 9C 00 00 00 00 C7 45 A4 00 00 00 00 C7 45 A8 00 00 00 00 C7 45 B4 00 00 00 00 C7 45 B8 00 00 00 00 EB 79 8B 55 80 8D 04 95 1E 00 00 00 83 E0 F0 29 C4 8D 4C 24 0F 29 C4 8D 74 24 0F 29 C4 8D 7C 24 0F 29 C4 83 E1 F0 83 E6 F0 8D 54 24 0F 29 C4 89 4D }
	condition:
		$pattern
}

rule realpath_10adba1e25c3db2dc22d47c22beab2ca {
	meta:
		aliases = "realpath"
		size = "678"
		objfiles = "realpath@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 2C 10 00 00 8B 75 08 8B 7D 0C 85 F6 75 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 E9 74 02 00 00 80 3E 00 75 10 E8 ?? ?? ?? ?? C7 00 02 00 00 00 E9 5F 02 00 00 85 FF C7 85 E0 EF FF FF 00 00 00 00 75 17 81 EC 10 10 00 00 8D 7C 24 0F 83 E7 F0 C7 85 E0 EF FF FF 01 00 00 00 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 3D FD 0F 00 00 0F 87 DE 00 00 00 8D 5D F3 29 C3 50 50 56 53 E8 ?? ?? ?? ?? 8D 87 FE 0F 00 00 83 C4 10 89 85 D8 EF FF FF 80 3B 2F 74 49 51 51 68 FF 0F 00 00 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 E9 01 00 00 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C4 10 8D 34 07 80 7E FF 2F 74 04 C6 06 }
	condition:
		$pattern
}
...
rule gaih_inet_737bf97dc2dc22c59366f71cfae224af {
	meta:
		aliases = "gaih_inet"
		size = "2513"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 9C 00 00 00 8B 55 10 8D 45 D4 89 45 F0 8B 7D 0C C7 45 EC 00 00 00 00 8B 42 04 85 C0 74 0F 83 F8 0A C7 85 6C FF FF FF 00 00 00 00 75 16 8B 4D 10 8B 01 83 F0 08 C1 E8 03 F7 D0 83 E0 01 89 85 6C FF FF FF 56 6A 10 6A 00 8D 45 D4 50 E8 ?? ?? ?? ?? 8B 55 10 83 C4 10 8B 4A 0C 85 C9 75 0D 83 7A 08 00 75 07 EB 5A 83 C3 07 EB 05 BB ?? ?? ?? ?? 8A 43 03 84 C0 88 85 6B FF FF FF 74 2C 8B 45 10 8B 50 08 85 D2 74 07 0F BE 03 39 C2 75 D8 85 C9 74 0E F6 43 02 02 75 08 0F BE 43 01 39 C1 75 C6 80 BD 6B FF FF FF 00 75 1C 8B 55 10 B8 07 01 00 00 83 7A 08 00 0F 85 06 09 00 00 E9 EA 08 00 00 }
	condition:
		$pattern
}
...
rule glob_in_dir_b891c807a6a956411f612cd01553d46a {
	meta:
		aliases = "glob_in_dir"
		size = "1280"
		objfiles = "glob64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC F8 00 00 00 52 8B 75 08 89 95 18 FF FF FF 89 8D 14 FF FF FF 89 85 1C FF FF FF E8 ?? ?? ?? ?? 8B 9D 14 FF FF FF 5A 59 83 E3 40 89 85 20 FF FF FF 0F 94 C0 0F B6 C0 50 FF B5 1C FF FF FF E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 D1 00 00 00 F7 85 14 FF FF FF 10 08 00 00 0F 85 B5 00 00 00 85 DB 75 1A 50 50 6A 5C FF B5 1C FF FF FF E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 A3 00 00 00 83 EC 0C FF B5 1C FF FF FF E8 ?? ?? ?? ?? 8B 95 20 FF FF FF 83 C4 10 89 C6 8D 44 10 20 83 E0 F0 29 C4 8D 5C 24 0F 50 83 E3 F0 52 FF B5 18 FF FF FF 53 E8 ?? ?? ?? ?? 83 C4 0C 6A 01 68 ?? ?? ?? ?? 50 E8 ?? ?? }
	condition:
		$pattern
}
...
rule __getdents64_5bf080e537512f2a31c928006d7ef1aa {
	meta:
		aliases = "__getdents64"
		size = "274"
		objfiles = "getdents64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C 8B 45 0C 8B 55 10 8B 7D 08 89 45 DC 8D 42 1E 83 E0 F0 29 C4 8D 4C 24 0F 83 E1 F0 53 89 FB B8 DC 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0B E8 ?? ?? ?? ?? F7 DE 89 30 EB 60 83 F8 FF 74 5B 03 55 0C 89 CB 8D 34 01 C7 45 E8 FF FF FF FF C7 45 EC FF FF FF FF 89 75 E4 89 55 E0 E9 92 00 00 00 0F B7 43 10 8B 75 DC 8D 48 03 83 E1 FC 01 CE 3B 75 E0 76 2B 6A 00 FF 75 EC FF 75 E8 FF 75 08 E8 ?? ?? ?? ?? 8B 45 0C 83 C4 10 39 45 DC 75 6C E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 62 8B 43 08 8B 53 0C 8B 7D DC 89 45 E8 89 55 EC 8B 03 8B 53 04 89 07 89 57 04 8B 43 08 8B 53 0C 66 }
	condition:
		$pattern
}
...
rule sem_timedwait_47718f1c2dcbd6d8e805491a22882dc1 {
	meta:
		aliases = "sem_timedwait"
		size = "368"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C E8 ?? ?? ?? ?? 8B 75 08 89 45 E0 89 C2 89 F0 E8 ?? ?? ?? ?? 8B 46 08 85 C0 7E 11 48 83 EC 0C 89 46 08 56 E8 ?? ?? ?? ?? 31 C0 EB 23 8B 45 0C 81 78 04 FF C9 9A 3B 76 1F 83 EC 0C 56 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF 83 C4 10 E9 08 01 00 00 8B 45 E0 8D 55 EC 89 75 EC C7 45 F0 ?? ?? ?? ?? C6 80 BA 01 00 00 00 8B 45 E0 E8 ?? ?? ?? ?? 8B 45 E0 80 78 42 00 74 0B 80 78 40 00 BB 01 00 00 00 74 0D 8B 55 E0 8D 46 0C 31 DB E8 ?? ?? ?? ?? 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 DB 8D 7E 0C 74 0F 8B 45 E0 31 D2 E8 ?? ?? ?? ?? E9 9A 00 00 00 51 51 FF 75 0C FF }
	condition:
		$pattern
}

rule __GI_pthread_cond_wait_56e90cb3e3843db1eaea6b6fe59b8800 {
	meta:
		aliases = "pthread_cond_wait, __GI_pthread_cond_wait"
		size = "315"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C E8 ?? ?? ?? ?? 8B 75 0C 8B 5D 08 89 45 F0 8B 46 0C 83 F8 03 74 15 85 C0 74 11 8B 45 F0 BA 16 00 00 00 39 46 08 0F 85 FD 00 00 00 8B 45 F0 8D 55 E8 89 5D E8 C7 45 EC ?? ?? ?? ?? C6 80 B9 01 00 00 00 8B 45 F0 E8 ?? ?? ?? ?? 8B 55 F0 89 D8 E8 ?? ?? ?? ?? 8B 45 F0 80 78 42 00 74 0E 8B 45 F0 BF 01 00 00 00 80 78 40 00 74 0D 8B 55 F0 8D 43 08 31 FF E8 ?? ?? ?? ?? 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 FF 74 0E 8B 45 F0 31 D2 E8 ?? ?? ?? ?? 57 57 EB 6E 83 EC 0C 31 DB 56 E8 ?? ?? ?? ?? 83 C4 10 8B 45 F0 E8 ?? ?? ?? ?? 8B 45 F0 80 B8 B9 01 00 00 00 75 18 8B 45 F0 80 B8 B8 01 }
	condition:
		$pattern
}

rule __GI_pthread_cond_timedwait_b3d2162e4e22037dd70a488d62679871 {
	meta:
		aliases = "pthread_cond_timedwait, __GI_pthread_cond_timedwait"
		size = "428"
		objfiles = "condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C E8 ?? ?? ?? ?? 8B 7D 0C 89 45 F0 8B 47 0C 83 F8 03 74 15 85 C0 74 11 8B 45 F0 BA 16 00 00 00 39 47 08 0F 85 71 01 00 00 8B 45 08 8D 55 E8 C7 45 EC ?? ?? ?? ?? 89 45 E8 8B 45 F0 C6 80 B9 01 00 00 00 8B 45 F0 E8 ?? ?? ?? ?? 8B 45 08 8B 55 F0 E8 ?? ?? ?? ?? 8B 45 F0 80 78 42 00 74 0E 8B 45 F0 BB 01 00 00 00 80 78 40 00 74 10 8B 45 08 31 DB 8B 55 F0 83 C0 08 E8 ?? ?? ?? ?? 83 EC 0C FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 85 DB 74 11 8B 45 F0 31 D2 E8 ?? ?? ?? ?? 51 51 E9 D6 00 00 00 83 EC 0C 31 F6 57 E8 ?? ?? ?? ?? 8B 45 08 83 C4 10 83 C0 08 89 45 E0 52 8B 45 F0 52 FF 75 10 50 }
	condition:
		$pattern
}
...
rule dlopen_e9a40043e10b979728197935000aab6a {
	meta:
		aliases = "dlopen"
		size = "1133"
		objfiles = "libdl@libdl.a"
...
rule link_exists_p_2c9a543215b8758d3f681caa59d4debd {
	meta:
		aliases = "link_exists_p"
		size = "162"
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 89 C6 53 89 D3 81 EC C8 00 00 00 51 89 8D 3C FF FF FF E8 ?? ?? ?? ?? 83 C4 10 89 85 40 FF FF FF 8D 44 18 20 83 E0 F0 29 C4 8D 7C 24 0F 50 83 E7 F0 53 56 57 E8 ?? ?? ?? ?? 83 C4 0C 6A 01 68 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 8B 95 40 FF FF FF 83 C4 0C 42 52 FF B5 3C FF FF FF 50 E8 ?? ?? ?? ?? 83 C4 10 F7 45 0C 00 02 00 00 74 0F 50 50 8D 45 9C 50 8B 45 08 57 FF 50 20 EB 0F 56 56 8D 85 44 FF FF FF 50 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 94 C0 8D 65 F4 0F B6 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule link_exists_p_fb942f88e66b6ba5917c32a3006e7203 {
	meta:
		aliases = "link_exists_p"
		size = "162"
		objfiles = "glob64@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 89 C6 53 89 D3 81 EC D8 00 00 00 51 89 8D 2C FF FF FF E8 ?? ?? ?? ?? 83 C4 10 89 85 30 FF FF FF 8D 44 18 20 83 E0 F0 29 C4 8D 7C 24 0F 50 83 E7 F0 53 56 57 E8 ?? ?? ?? ?? 83 C4 0C 6A 01 68 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 8B 95 30 FF FF FF 83 C4 0C 42 52 FF B5 2C FF FF FF 50 E8 ?? ?? ?? ?? 83 C4 10 F7 45 0C 00 02 00 00 74 0F 51 51 8D 45 94 50 8B 45 08 57 FF 50 20 EB 0F 52 52 8D 85 34 FF FF FF 50 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 94 C0 8D 65 F4 0F B6 C0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule pthread_cleanup_upto_69da986a59fc60b6dba1041a188f6008 {
	meta:
		aliases = "pthread_cleanup_upto"
		size = "146"
		objfiles = "ptlongjmp@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 C7 56 89 E8 53 BE ?? ?? ?? ?? 83 EC 0C 3B 2D ?? ?? ?? ?? 73 32 3B 2D ?? ?? ?? ?? 72 0D 3B 2D ?? ?? ?? ?? BE ?? ?? ?? ?? 72 1D 83 3D ?? ?? ?? ?? 00 74 09 E8 ?? ?? ?? ?? 89 C6 EB 0B 0D FF FF 1F 00 8D B0 21 FE FF FF 89 6D F0 8B 5E 3C EB 17 3B 5D F0 77 04 31 DB EB 17 83 EC 0C FF 73 04 FF 13 8B 5B 0C 83 C4 10 85 DB 74 05 3B 5F 10 72 E0 8B 46 54 89 5E 3C 85 C0 74 0C 3B 47 10 73 07 C7 46 54 00 00 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __msgwrite_2eb2763480d3e7523bca73ba4938ef22 {
	meta:
		aliases = "__msgwrite"
		size = "179"
		objfiles = "clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 CF 56 89 D6 53 83 EC 6C 89 45 C0 8D 5C 24 0F E8 ?? ?? ?? ?? 83 E3 F0 89 45 E0 E8 ?? ?? ?? ?? 89 45 E4 E8 ?? ?? ?? ?? 89 45 E8 50 6A 0C 8D 45 E0 50 8D 43 0C 50 E8 ?? ?? ?? ?? 8D 45 EC 83 C4 10 C7 43 04 01 00 00 00 C7 43 08 02 00 00 00 C7 03 18 00 00 00 89 5D D4 8D 5D C4 89 75 EC 89 7D F0 89 45 CC C7 45 D0 01 00 00 00 C7 45 C4 00 00 00 00 C7 45 C8 00 00 00 00 C7 45 D8 18 00 00 00 C7 45 DC 00 00 00 00 50 6A 00 53 FF 75 C0 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0D E8 ?? ?? ?? ?? 83 38 04 74 E3 83 C8 FF 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __gnat_default_lock_939a034664c2b3234964a30decbd1f50 {
	meta:
		aliases = "__gcov_merge_single, __gcov_flush, __clear_cache, __gcov_init, __gnat_default_unlock, __gcov_merge_add, __gcov_merge_delta, __enable_execute_stack, __gnat_default_lock"
		size = "5"
		objfiles = "_gcov@libgcov.a, gthr_gnat@libgcc_eh.a, _gcov_merge_single@libgcov.a, _clear_cache@libgcc.a, _gcov_merge_add@libgcov.a"
	strings:
...
rule pthread_setcancelstate_fa9cea8dac595676601eb788a3afb13b {
	meta:
		aliases = "__GI_pthread_setcancelstate, pthread_setcancelstate"
		size = "74"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 16 00 00 00 89 E5 56 8B 75 0C 53 8B 5D 08 83 FB 01 77 2E E8 ?? ?? ?? ?? 85 F6 89 C2 74 06 0F BE 40 40 89 06 80 7A 42 00 88 5A 40 74 12 66 81 7A 40 00 01 75 0A 50 50 55 6A FF E8 ?? ?? ?? ?? 31 C0 8D 65 F8 5B 5E 5D C3 }
	condition:
		$pattern
}

rule __GI_pthread_setcanceltype_aa797c49dc2f4291ae2376559c4496ba {
	meta:
		aliases = "pthread_setcanceltype, __GI_pthread_setcanceltype"
		size = "74"
		objfiles = "cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 16 00 00 00 89 E5 56 8B 75 0C 53 8B 5D 08 83 FB 01 77 2E E8 ?? ?? ?? ?? 85 F6 89 C2 74 06 0F BE 40 41 89 06 80 7A 42 00 88 5A 41 74 12 66 81 7A 40 00 01 75 0A 50 50 55 6A FF E8 ?? ?? ?? ?? 31 C0 8D 65 F8 5B 5E 5D C3 }
	condition:
		$pattern
}
...
rule thread_self_8edc8dc4e86c2e49d2a4a127f12d8902 {
	meta:
		aliases = "thread_self"
		size = "68"
		objfiles = "condvar@libpthread.a, signals@libpthread.a, specific@libpthread.a, mutex@libpthread.a, cancel@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 ?? ?? ?? ?? 89 E5 3B 2D ?? ?? ?? ?? 89 EA 73 30 3B 2D ?? ?? ?? ?? 72 0D 3B 2D ?? ?? ?? ?? B8 ?? ?? ?? ?? 72 1B 83 3D ?? ?? ?? ?? 00 74 06 5D E9 ?? ?? ?? ?? 81 CA FF FF 1F 00 8D 82 21 FE FF FF 5D C3 }
	condition:
		$pattern
}

rule __old_sem_wait_ed5183fce5f20d4a2f6326ffa394dfef {
	meta:
		aliases = "__old_sem_wait"
		size = "288"
		objfiles = "oldsemaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) B8 ?? ?? ?? ?? 89 E5 56 89 EA 53 83 EC 20 3B 2D ?? ?? ?? ?? 8B 5D 08 73 31 3B 2D ?? ?? ?? ?? 72 0D 3B 2D ?? ?? ?? ?? B8 ?? ?? ?? ?? 72 1C 83 3D ?? ?? ?? ?? 00 74 07 E8 ?? ?? ?? ?? EB 0C 81 CA FF FF 1F 00 8D 82 21 FE FF FF 89 45 F4 8D 75 EC C7 45 EC 00 00 00 00 C7 45 F0 ?? ?? ?? ?? 8B 45 F4 89 F2 E8 ?? ?? ?? ?? 8B 0B F6 C1 01 74 08 83 F9 01 8D 51 FE 75 09 8B 55 F4 8B 45 F4 89 48 08 89 C8 F0 0F B1 13 0F 94 C1 84 C9 74 DB F6 C2 01 75 7A 8B 45 F4 83 EC 0C 50 E8 ?? ?? ?? ?? 8B 45 F4 31 D2 E8 ?? ?? ?? ?? 8B 45 F4 83 C4 10 80 78 42 00 74 AA 8B 45 F4 80 78 40 00 75 A1 8B 13 8B 45 F4 39 C2 75 13 8B }
	condition:
		$pattern
}
...
rule a64l_607b8501cc679bbc66bafc7f514e9bee {
	meta:
		aliases = "a64l"
		size = "58"
		objfiles = "a64l@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 31 C9 53 31 DB 8B 44 24 0C 8D 70 06 89 C2 0F BE 02 83 E8 2E 83 F8 4C 77 1B 8A 80 ?? ?? ?? ?? 3C 40 74 11 0F BE C0 42 D3 E0 09 C3 39 F2 74 05 83 C1 06 EB DA 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule pthread_kill_5fc7f66fa55a508d7782b5035fa6e6ed {
	meta:
		aliases = "pthread_kill"
		size = "110"
		objfiles = "signals@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 31 D2 53 83 EC 04 8B 5C 24 10 89 D8 25 FF 03 00 00 C1 E0 04 8D B0 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 8B 46 08 85 C0 74 05 39 58 10 74 1C 83 EC 0C 56 E8 ?? ?? ?? ?? B8 03 00 00 00 83 C4 10 EB 29 E8 ?? ?? ?? ?? 8B 00 EB 20 83 EC 0C 8B 58 14 56 E8 ?? ?? ?? ?? 5E 58 FF 74 24 1C 53 E8 ?? ?? ?? ?? 83 C4 10 40 74 D9 31 C0 59 5B 5E C3 }
	condition:
		$pattern
}
...
rule __GI_pthread_cond_broadcast_295c94f57cbc860b696be2b43e627bde {
	meta:
...
rule pthread_cond_signal_b3c43f85d992171f6f0e3fc7f29ddec1 {
	meta:
...
rule pthread_free_3215119af10c73fcfb88e27358059d02 {
	meta:
		aliases = "pthread_free"
		size = "194"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 31 D2 53 89 C6 83 EC 04 8B 58 10 81 E3 FF 03 00 00 C1 E3 04 81 C3 ?? ?? ?? ?? 89 D8 E8 ?? ?? ?? ?? 83 EC 0C C7 43 08 00 00 00 00 C7 43 0C FF FF FF FF 53 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 48 A3 ?? ?? ?? ?? 8B 86 C0 01 00 00 EB 0D 8B 18 83 EC 0C 50 E8 ?? ?? ?? ?? 89 D8 83 C4 10 85 C0 75 EC 8B 86 C4 01 00 00 EB 10 8B 18 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 89 D8 85 C0 75 EC 81 FE ?? ?? ?? ?? 74 3A 83 BE 88 01 00 00 00 75 31 8B 86 90 01 00 00 85 C0 74 11 51 51 50 FF B6 8C 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 52 52 68 00 00 20 00 8D 86 E0 01 E0 FF 50 E8 ?? ?? ?? ?? 83 C4 10 5E 5B 5E C3 }
	condition:
		$pattern
}
...
rule tmpfile_e34dc6bd930e7c8f7fcd423e7d73db59 {
	meta:
...
rule __libc_sigaction_554610f6d0e1ce66c9323d2f3d6805b9 {
	meta:
		aliases = "sigaction, __GI_sigaction, __libc_sigaction"
		size = "218"
		objfiles = "sigaction@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 24 01 00 00 8B 9C 24 34 01 00 00 8B B4 24 38 01 00 00 85 DB 74 50 8B 03 89 84 24 98 00 00 00 8D 43 04 52 68 80 00 00 00 50 8D 84 24 B0 00 00 00 50 E8 ?? ?? ?? ?? 8B 83 84 00 00 00 BA ?? ?? ?? ?? 0D 00 00 00 04 89 84 24 AC 00 00 00 83 C4 10 B8 ?? ?? ?? ?? F6 83 84 00 00 00 04 0F 44 C2 89 84 24 A0 00 00 00 8D 44 24 0C 31 D2 85 F6 8D 8C 24 98 00 00 00 0F 44 C2 6A 08 85 DB 0F 45 D1 50 52 FF B4 24 3C 01 00 00 E8 ?? ?? ?? ?? 83 C4 10 85 F6 89 C3 74 35 85 C0 78 31 8B 44 24 0C 89 06 50 68 80 00 00 00 8D 44 24 20 50 8D 46 04 50 E8 ?? ?? ?? ?? 8B 44 24 20 89 86 84 00 00 00 8B 44 24 24 83 C4 }
	condition:
		$pattern
}

rule __sigpause_59414206340f1fbb474ef3a386cc6d9d {
	meta:
		aliases = "__GI___sigpause, __sigpause"
		size = "120"
		objfiles = "sigpause@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 84 00 00 00 83 BC 24 94 00 00 00 00 8B B4 24 90 00 00 00 74 28 52 8D 5C 24 08 53 6A 00 6A 00 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 3D 50 50 56 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 1B EB 2B 89 74 24 04 BA 1E 00 00 00 8D 44 24 08 C7 00 00 00 00 00 83 C0 04 4A 79 F4 83 EC 0C 8D 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 10 EB 03 83 C8 FF 81 C4 84 00 00 00 5B 5E C3 }
	condition:
		$pattern
}
...
rule __pthread_wait_for_restart_sig_559b6cb428321913aac21a52666aadd8 {
	meta:
		aliases = "__pthread_wait_for_restart_signal"
		size = "85"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 88 00 00 00 8D 5C 24 08 8B B4 24 94 00 00 00 53 6A 00 6A 02 E8 ?? ?? ?? ?? 58 5A FF 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 10 C7 46 20 00 00 00 00 83 EC 0C 53 E8 ?? ?? ?? ?? 8B 46 20 83 C4 10 3B 05 ?? ?? ?? ?? 75 E9 81 C4 84 00 00 00 5B 5E C3 }
	condition:
		$pattern
}
...
rule pselect_1da3c4e696b77c266869dd292f2460c1 {
	meta:
		aliases = "__libc_pselect, pselect"
		size = "165"
		objfiles = "pselect@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 94 00 00 00 8B 9C 24 B0 00 00 00 8B B4 24 B4 00 00 00 85 DB 74 1D 8B 03 BA E8 03 00 00 89 D1 89 84 24 8C 00 00 00 8B 43 04 99 F7 F9 89 84 24 90 00 00 00 85 F6 74 11 52 8D 44 24 10 50 56 6A 02 E8 ?? ?? ?? ?? 83 C4 10 8D 94 24 8C 00 00 00 31 C0 85 DB 0F 45 C2 83 EC 0C 50 FF B4 24 BC 00 00 00 FF B4 24 BC 00 00 00 FF B4 24 BC 00 00 00 FF B4 24 BC 00 00 00 E8 ?? ?? ?? ?? 83 C4 20 85 F6 89 C3 74 12 50 6A 00 8D 44 24 14 50 6A 02 E8 ?? ?? ?? ?? 83 C4 10 81 C4 94 00 00 00 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule pthread_onexit_process_8f3a85bb74aa673796a00e85f910a4bf {
	meta:
		aliases = "pthread_onexit_process"
		size = "151"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC A4 00 00 00 83 3D ?? ?? ?? ?? 00 78 7D E8 ?? ?? ?? ?? 8D 74 24 10 C7 44 24 14 02 00 00 00 89 C3 89 44 24 10 8B 84 24 B0 00 00 00 89 44 24 18 50 68 94 00 00 00 56 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 DE 89 D8 E8 ?? ?? ?? ?? 3B 1D ?? ?? ?? ?? 75 2A 51 68 00 00 00 80 6A 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 C7 05 ?? ?? ?? ?? 00 00 00 00 C7 05 ?? ?? ?? ?? 00 00 00 00 81 C4 A4 00 00 00 5B 5E C3 }
	condition:
		$pattern
}

rule pthread_create_380defae055989127af1aaf531b4e04d {
	meta:
		aliases = "pthread_create"
		size = "182"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC A4 00 00 00 83 3D ?? ?? ?? ?? 00 79 12 E8 ?? ?? ?? ?? BA 0B 00 00 00 85 C0 0F 88 88 00 00 00 E8 ?? ?? ?? ?? C7 44 24 14 00 00 00 00 89 44 24 10 89 C3 8B 84 24 B4 00 00 00 89 44 24 18 8B 84 24 B8 00 00 00 89 44 24 1C 8B 84 24 BC 00 00 00 89 44 24 20 51 8D 44 24 28 50 6A 00 6A 02 E8 ?? ?? ?? ?? 83 C4 10 8D 74 24 10 52 68 94 00 00 00 56 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 38 04 74 DE 89 D8 E8 ?? ?? ?? ?? 83 7B 34 00 75 0C 8B 53 30 8B 84 24 B0 00 00 00 89 10 8B 53 34 81 C4 A4 00 00 00 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule __pthread_do_exit_126eb5813469ed3a71ccea27acaf0ecf {
	meta:
		aliases = "__pthread_do_exit"
		size = "251"
		objfiles = "join@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC A4 00 00 00 E8 ?? ?? ?? ?? 83 EC 0C C6 40 40 01 89 C3 C6 40 41 00 FF B4 24 C0 00 00 00 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 43 1C 89 DA E8 ?? ?? ?? ?? 8B 84 24 C0 00 00 00 83 C4 10 83 BB 9C 01 00 00 00 89 43 30 74 2B A1 ?? ?? ?? ?? 0B 83 A0 01 00 00 F6 C4 01 74 1B C7 83 A8 01 00 00 09 00 00 00 89 9B AC 01 00 00 89 1D ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 EC 0C 8B 73 38 C6 43 2C 01 FF 73 1C E8 ?? ?? ?? ?? 83 C4 10 85 F6 74 0C 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 8B 35 ?? ?? ?? ?? 39 F3 75 4C 83 3D ?? ?? ?? ?? 00 78 43 89 74 24 10 8D 5C 24 10 C7 44 24 14 03 00 00 00 52 68 94 00 00 00 53 FF 35 ?? }
	condition:
		$pattern
}

rule sem_post_3befbd847043db4370d2772baa41b542 {
	meta:
		aliases = "__new_sem_post, sem_post"
		size = "237"
		objfiles = "semaphore@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC A4 00 00 00 E8 ?? ?? ?? ?? 8B B4 24 B0 00 00 00 83 78 54 00 75 74 89 C2 89 F0 E8 ?? ?? ?? ?? 83 7E 0C 00 75 32 8B 46 08 3D FF FF FF 7F 75 19 E8 ?? ?? ?? ?? 83 EC 0C C7 00 22 00 00 00 56 E8 ?? ?? ?? ?? 83 C8 FF EB 3D 40 83 EC 0C 89 46 08 56 E8 ?? ?? ?? ?? EB 2C 8B 5E 0C 85 DB 74 0D 8B 43 08 89 46 0C C7 43 08 00 00 00 00 83 EC 0C 56 E8 ?? ?? ?? ?? C6 83 BA 01 00 00 01 89 1C 24 E8 ?? ?? ?? ?? 31 C0 83 C4 10 EB 56 83 3D ?? ?? ?? ?? 00 79 19 E8 ?? ?? ?? ?? 85 C0 79 10 E8 ?? ?? ?? ?? C7 00 0B 00 00 00 83 C8 FF EB 34 C7 44 24 14 04 00 00 00 8D 5C 24 10 89 74 24 18 56 68 94 00 00 00 53 FF }
	condition:
		$pattern
}

rule __pthread_timedsuspend_new_97b65db4646f6f551be930d8e9578d58 {
	meta:
		aliases = "__pthread_timedsuspend_new"
		size = "284"
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC BC 01 00 00 6A 01 8D 44 24 14 50 E8 ?? ?? ?? ?? BA 01 00 00 00 83 C4 10 85 C0 0F 85 DF 00 00 00 8B 94 24 C0 01 00 00 8D 44 24 08 83 EC 0C 8D 9C 24 30 01 00 00 89 42 24 C7 42 20 00 00 00 00 53 E8 ?? ?? ?? ?? 5E 58 FF 35 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? 83 C4 0C 8D 84 24 A8 00 00 00 50 53 6A 01 E8 ?? ?? ?? ?? 83 C4 10 8D B4 24 AC 01 00 00 8D 9C 24 A4 01 00 00 51 51 6A 00 56 E8 ?? ?? ?? ?? 8B 8C 24 D4 01 00 00 69 84 24 C0 01 00 00 E8 03 00 00 8B 51 04 8B 09 2B 8C 24 BC 01 00 00 29 C2 89 94 24 B8 01 00 00 89 8C 24 B4 01 00 00 83 C4 10 85 D2 79 17 8D 82 00 CA 9A 3B 89 84 24 A8 01 00 00 8D }
	condition:
		$pattern
}
...
rule __GI_strchrnul_5721394695d9fb8f603020906757152b {
	meta:
...
rule __GI_strsep_138cabfe157db83a8872e255266629d3 {
	meta:
...
rule longjmp_7f4abd0851d75fdee71ce179f2eb7116 {
	meta:
		aliases = "__libc_siglongjmp, __libc_longjmp, _longjmp, siglongjmp, longjmp"
		size = "55"
...
rule _ppfs_init_e96f7a4203e536e959fdf89302ce2af7 {
	meta:
		aliases = "_ppfs_init"
		size = "111"
		objfiles = "_ppfs_init@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 5C 24 14 8B 74 24 18 68 BC 00 00 00 6A 00 53 E8 ?? ?? ?? ?? 8D 43 28 BA 09 00 00 00 FF 4B 18 83 C4 10 89 33 C7 00 08 00 00 00 83 C0 04 4A 75 F4 89 F0 EB 27 80 FA 25 75 21 40 80 38 25 74 1B 83 EC 0C 89 03 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 05 83 C8 FF EB 0F 8B 03 EB 01 40 8A 10 84 D2 75 D3 89 33 31 C0 5A 5B 5E C3 }
	condition:
		$pattern
}
...
rule __xstat_conv_2632aaf5e4b12ed4231a2830a10ed02a {
	meta:
...
rule __xstat64_conv_4a7ad56522504321d27e7a510a2c87fb {
	meta:
		aliases = "__xstat64_conv"
		size = "164"
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 5C 24 18 8B 74 24 14 6A 60 6A 00 53 E8 ?? ?? ?? ?? 0F B7 06 C7 43 04 00 00 00 00 89 03 8B 46 58 8B 56 5C 89 43 58 89 53 5C 8B 46 0C 89 43 0C 8B 46 10 89 43 10 8B 46 14 89 43 14 8B 46 18 89 43 18 8B 46 1C 89 43 1C 0F B7 46 20 C7 43 24 00 00 00 00 89 43 20 8B 46 2C 8B 56 30 89 43 2C 89 53 30 8B 46 34 89 43 34 8B 46 38 C7 43 3C 00 00 00 00 89 43 38 8B 56 40 8B 46 44 89 53 40 89 43 44 8B 56 48 8B 46 4C 89 43 4C 8B 46 54 89 53 48 8B 56 50 89 43 54 89 53 50 83 C4 14 5B 5E C3 }
	condition:
		$pattern
}
...
rule wcsxfrm_3632be8b3a7b9737ccbcd52dde07460b {
	meta:
		aliases = "__wcslcpy, wcsxfrm"
		size = "66"
		objfiles = "wcslcpy@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 44 24 24 8B 4C 24 1C 8B 74 24 20 85 C0 8D 58 FF 75 06 31 DB 8D 4C 24 0C 89 F2 EB 0B 85 DB 74 04 4B 83 C1 04 83 C2 04 8B 02 85 C0 89 01 75 ED 83 C4 10 29 F2 5B C1 FA 02 5E 89 D0 C3 }
	condition:
		$pattern
}

rule __GI_strlcpy_1637d6799eadaafc3eac44e832f8abfc {
	meta:
		aliases = "strxfrm, strlcpy, __GI_strxfrm, __GI_strlcpy"
		size = "59"
		objfiles = "strlcpy@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 10 8B 44 24 24 8B 4C 24 1C 8B 74 24 20 85 C0 8D 58 FF 75 06 31 DB 8D 4C 24 0F 89 F2 EB 07 85 DB 74 02 4B 41 42 8A 02 84 C0 88 01 75 F1 83 C4 10 29 F2 5B 89 D0 5E C3 }
	condition:
		$pattern
}
...
rule __GI_fgetgrent_r_87d796c483507ca6907ec6bb79491b76 {
	meta:
		aliases = "fgetgrent_r, fgetpwent_r, __GI_fgetspent_r, __GI_fgetpwent_r, fgetspent_r, __GI_fgetgrent_r"
		size = "55"
...
rule __des_crypt_6b2b90fa93060c580eb6ed89aa2173ed {
	meta:
		aliases = "__des_crypt"
		size = "391"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 20 8B 74 24 24 E8 ?? ?? ?? ?? 8D 54 24 04 89 D1 EB 0E 8A 03 00 C0 88 02 42 80 7A FF 01 83 DB FF 89 D0 29 C8 83 F8 08 75 E9 89 C8 E8 ?? ?? ?? ?? 8A 16 8A 46 01 88 54 24 03 88 15 ?? ?? ?? ?? 8A 4C 24 03 8A 56 01 84 D2 74 02 88 D1 0F BE C0 88 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 C3 0F BE 44 24 03 C1 E3 06 E8 ?? ?? ?? ?? 09 C3 89 D8 E8 ?? ?? ?? ?? 8D 4C 24 10 31 D2 6A 19 8D 44 24 10 50 31 C0 E8 ?? ?? ?? ?? 31 D2 59 5B 85 C0 0F 85 E5 00 00 00 8B 4C 24 10 8B 5C 24 0C C6 05 ?? ?? ?? ?? 00 89 C8 89 CA C1 E8 1A 8A 80 ?? ?? ?? ?? C1 EA 08 83 E2 3F A2 ?? ?? ?? ?? 89 C8 C1 E8 14 83 E0 }
	condition:
		$pattern
}
...
rule fputc_unlocked_37814e0cd8130bd524be30599725db3b {
	meta:
		aliases = "__fputc_unlocked, putc_unlocked, __GI_putc_unlocked, __GI___fputc_unlocked, fputc_unlocked"
		size = "190"
...
rule getutline_5749c9daac82e42ffb74e96d6b08c0d0 {
	meta:
		aliases = "getutline"
		size = "117"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 18 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 10 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8B 74 24 20 83 C6 08 EB 1E 8B 03 83 E8 06 66 83 F8 01 77 13 50 50 56 8D 43 08 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 10 A1 ?? ?? ?? ?? E8 ?? ?? ?? ?? 85 C0 89 C3 75 D2 51 51 6A 01 8D 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 24 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule openlog_971c273a9aeb58605fd4dbea65e85b9f {
	meta:
...
rule tmpnam_9c7cd94636bd7e51fd55216fda37edf3 {
	meta:
		aliases = "tmpnam"
		size = "91"
		objfiles = "tmpnam@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 24 8B 5C 24 30 8D 44 24 10 6A 00 6A 00 6A 14 85 DB 89 DE 0F 44 F0 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 2A 52 52 6A 03 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 19 85 DB 75 17 50 6A 14 56 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 89 C3 EB 02 31 DB 83 C4 24 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule __res_init_3a02462d2abe10b9ae3f6475acafb966 {
	meta:
		aliases = "__GI___res_init, __res_init"
		size = "290"
		objfiles = "res_init@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 28 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 1C 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 05 00 00 00 C7 05 ?? ?? ?? ?? 04 00 00 00 C7 05 ?? ?? ?? ?? 01 00 00 00 E8 ?? ?? ?? ?? 8B 0D ?? ?? ?? ?? 83 C4 10 31 D2 C7 05 ?? ?? ?? ?? 00 00 00 00 66 C7 05 ?? ?? ?? ?? 02 00 66 C7 05 ?? ?? ?? ?? 00 35 C7 05 ?? ?? ?? ?? FF FF FF FF 66 A3 ?? ?? ?? ?? A0 ?? ?? ?? ?? 24 F0 0C 01 85 C9 A2 ?? ?? ?? ?? 75 11 EB 13 8B 04 95 ?? ?? ?? ?? 89 04 95 ?? ?? ?? ?? 42 39 CA 7C ED 83 3D ?? ?? ?? ?? 00 74 49 31 DB 8D 74 24 20 EB 39 52 52 56 FF 34 9D ?? }
	condition:
		$pattern
}
...
rule __ieee754_j1_8bb07eac18ed7e2aff832bae8f4319f4 {
	meta:
		aliases = "__ieee754_j1"
		size = "496"
		objfiles = "e_j1@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 44 DD 44 24 50 DD 54 24 08 DD 54 24 10 8B 74 24 14 89 F3 81 E3 FF FF FF 7F 81 FB FF FF EF 7F 7E 0B DC 3D ?? ?? ?? ?? E9 BA 01 00 00 DD D8 81 FB FF FF FF 3F 0F 8E 1A 01 00 00 50 50 FF 74 24 14 FF 74 24 14 E8 ?? ?? ?? ?? 59 58 DD 5C 24 40 FF 74 24 44 FF 74 24 44 E8 ?? ?? ?? ?? DD 5C 24 28 58 5A FF 74 24 44 FF 74 24 44 E8 ?? ?? ?? ?? DD 5C 24 30 DD 44 24 28 DC 64 24 30 DD 5C 24 40 83 C4 10 81 FB FF FF DF 7F 7F 4C 83 EC 10 DD 44 24 48 D8 C0 DD 1C 24 E8 ?? ?? ?? ?? DD 44 24 28 DC 4C 24 30 83 C4 10 D9 EE D9 C9 DF E9 DD D8 76 16 DD 44 24 18 D9 E0 DC 64 24 20 DD 54 24 28 DE F9 DD 5C 24 30 }
	condition:
		$pattern
}

rule __ieee754_yn_0e1c7e27365b6c3e482f186a83b422c2 {
	meta:
		aliases = "__ieee754_yn"
		size = "597"
		objfiles = "e_jn@libm.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 44 DD 44 24 54 8B 5C 24 50 DD 14 24 DD 54 24 18 8B 54 24 18 8B 74 24 1C 89 D0 F7 D8 89 F1 09 D0 81 E1 FF FF FF 7F C1 E8 1F 09 C8 3D 00 00 F0 7F 76 07 D8 C0 E9 0A 02 00 00 DD D8 09 CA 75 0D D9 EE D8 3D ?? ?? ?? ?? E9 F7 01 00 00 85 F6 79 09 D9 EE D8 F0 E9 EA 01 00 00 83 FB 00 7D 12 F7 DB BE 01 00 00 00 89 D8 83 E0 01 01 C0 29 C6 EB 18 75 11 DD 04 24 DD 5C 24 50 83 C4 44 5B 5E E9 ?? ?? ?? ?? BE 01 00 00 00 83 FB 01 75 21 50 50 FF 74 24 0C FF 74 24 0C E8 ?? ?? ?? ?? 56 DB 04 24 DE C9 DD 5C 24 3C 83 C4 14 E9 99 01 00 00 81 F9 00 00 F0 7F 75 07 D9 EE E9 86 01 00 00 81 F9 FF FF CF 52 0F }
	condition:
		$pattern
}
...
rule rawmemchr_a8e1ea154f6ff4270306262438bf4304 {
	meta:
		aliases = "__GI_rawmemchr, rawmemchr"
		size = "101"
		objfiles = "rawmemchr@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 8A 5C 24 10 8B 44 24 0C EB 05 38 18 74 52 40 A8 03 75 F7 0F B6 D3 89 C1 89 D0 C1 E0 08 09 D0 89 C6 C1 E6 10 09 C6 89 F2 33 11 83 C1 04 89 D0 81 C2 FF FE FE 7E F7 D0 31 D0 A9 00 01 01 81 74 E6 38 59 FC 8D 41 FC 74 18 38 59 FD 8D 41 FD 74 10 38 59 FE 8D 41 FE 74 08 38 59 FF 8D 41 FF 75 C6 5B 5E C3 }
	condition:
		$pattern
}
...
rule __pthread_set_own_extricate_if_9959919f5723fdea472f77e9294d47f3 {
	meta:
		...
		size = "59"
		objfiles = "condvar@libpthread.a, join@libpthread.a, oldsemaphore@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule sigorset_c01594bfa430c8073fa0fd16eb938b1e {
	meta:
		aliases = "sigorset"
		size = "38"
		objfiles = "sigorset@libc.a"
	strings:
		$pattern = { ( CC | 56 ) BA 20 00 00 00 53 8B 74 24 0C 8B 5C 24 10 8B 4C 24 14 EB 09 8B 04 93 0B 04 91 89 04 96 4A 79 F4 5B 31 C0 5E C3 }
	condition:
		$pattern
}

rule sigandset_aeb1945064e39cbf17cf3d33f4fdf8a0 {
	meta:
		aliases = "sigandset"
		size = "38"
		objfiles = "sigandset@libc.a"
	strings:
		$pattern = { ( CC | 56 ) BA 20 00 00 00 53 8B 74 24 0C 8B 5C 24 10 8B 4C 24 14 EB 09 8B 04 93 23 04 91 89 04 96 4A 79 F4 5B 31 C0 5E C3 }
	condition:
		$pattern
}
...
rule __GI_strncat_af22a1e5842b19d835ae8d6a7ed9faed {
	meta:
		aliases = "strncat, __GI_strncat"
		size = "48"
		objfiles = "strncat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 56 83 C9 FF 83 EC 04 8B 74 24 14 8B 7C 24 10 F2 AE 4F 8B 4C 24 18 41 49 74 08 AC AA 84 C0 75 F7 EB 03 31 C0 AA 8B 44 24 10 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_strlen_ec0d1b854e8a94f3e2304b98d9ae8043 {
	meta:
...
rule open_4f7b0246496474908348cf9e5ead9d73 {
	meta:
		aliases = "__libc_open, __GI_open, __GI___libc_open, open"
		size = "72"
		objfiles = "open@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 D2 53 83 EC 14 8B 4C 24 24 8B 7C 24 20 F6 C1 40 74 0C 8B 54 24 28 8D 44 24 2C 89 44 24 10 53 89 FB B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 CB FF 83 C4 14 89 D8 5B 5F C3 }
	condition:
		$pattern
}

rule pthread_detach_70f5f968faf0009989118f9e1a96a630 {
	meta:
		aliases = "pthread_detach"
		size = "216"
		objfiles = "join@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 31 D2 56 53 81 EC A0 00 00 00 8B BC 24 B0 00 00 00 89 F8 25 FF 03 00 00 C1 E0 04 8D B0 ?? ?? ?? ?? 89 F0 E8 ?? ?? ?? ?? 8B 46 08 85 C0 74 05 39 78 10 74 10 83 EC 0C 56 E8 ?? ?? ?? ?? B8 03 00 00 00 EB 27 80 78 2D 00 74 10 83 EC 0C 56 E8 ?? ?? ?? ?? B8 16 00 00 00 EB 11 83 78 38 00 74 10 83 EC 0C 56 E8 ?? ?? ?? ?? 31 C0 83 C4 10 EB 5D 8A 58 2C 83 EC 0C C6 40 2D 01 56 E8 ?? ?? ?? ?? 83 C4 10 84 DB 74 44 83 3D ?? ?? ?? ?? 00 78 3B E8 ?? ?? ?? ?? 8D 5C 24 0C C7 44 24 10 01 00 00 00 89 7C 24 14 89 44 24 0C 56 68 94 00 00 00 53 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 40 75 0A E8 ?? ?? ?? ?? 83 }
	condition:
		$pattern
}
...
rule waitid_2c2742fa99e023b857ffe6d988843bf2 {
	meta:
		aliases = "waitid"
		size = "61"
		objfiles = "waitid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 FF 56 83 EC 04 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 44 24 10 53 89 C3 B8 1C 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 CE FF 5A 89 F0 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_fcntl_067817a35140003195be9463c690719c {
	meta:
		aliases = "__GI___libc_fcntl, fcntl, __libc_fcntl, __GI_fcntl"
		size = "87"
...
rule opendir_af850fda92b18507096c350ad6b20fc7 {
	meta:
		aliases = "__GI_opendir, opendir"
		size = "142"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 31 DB 83 EC 68 68 00 08 01 00 FF 74 24 7C E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 78 66 53 53 8D 44 24 10 50 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 12 51 6A 01 6A 02 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 18 E8 ?? ?? ?? ?? 83 EC 0C 8B 30 89 C3 57 E8 ?? ?? ?? ?? 89 33 31 DB EB 25 8B 54 24 38 89 F8 E8 ?? ?? ?? ?? 85 C0 89 C3 75 17 83 EC 0C 57 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 00 0C 00 00 00 83 C4 10 83 C4 60 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule fileno_d1aff121aa302794d76ffd1091af3fc3 {
	meta:
		aliases = "__GI_fileno, getwc, fgetwc, __GI_fgetwc, fileno"
		size = "92"
...
rule fputs_656d0461fb753b5b2210fd391d402010 {
	meta:
		aliases = "__GI_fputs, fputwc, __GI_fputws, putwc, fputws, fputs"
		size = "95"
...
rule pthread_reap_children_d068034c9838a169fddd3450fa01efb5 {
	meta:
		aliases = "pthread_reap_children"
		size = "245"
		objfiles = "manager@libpthread.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8D 7C 24 0C E9 C6 00 00 00 8B 0D ?? ?? ?? ?? 8B 31 EB 74 39 46 14 8B 16 75 6B 8B 46 04 89 42 04 8B 46 04 89 10 8B 46 1C 31 D2 E8 ?? ?? ?? ?? 83 BE 9C 01 00 00 00 C6 46 2E 01 74 2B A1 ?? ?? ?? ?? 0B 86 A0 01 00 00 F6 C4 08 74 1B C7 86 A8 01 00 00 0C 00 00 00 89 B6 AC 01 00 00 89 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 EC 0C 8A 5E 2D FF 76 1C E8 ?? ?? ?? ?? 83 C4 10 84 DB 74 0F 89 F0 E8 ?? ?? ?? ?? EB 06 89 D6 39 CE 75 88 83 3D ?? ?? ?? ?? 00 74 12 A1 ?? ?? ?? ?? 8B 10 39 C2 75 07 89 D0 E8 ?? ?? ?? ?? 8B 4C 24 0C 88 C8 24 7F FE C0 D0 F8 84 C0 7E 19 83 E1 7F BA 01 00 00 00 89 C8 E8 ?? }
	condition:
		$pattern
}
...
rule __GI_lockf_a4b420b8e82548ecb96a76885f011cd4 {
	meta:
...
rule __GI_getspent_r_d8fe13829bbc6de00d0924445c5077f8 {
	meta:
		aliases = "getpwent_r, __GI_getgrent_r, getspent_r, getgrent_r, __GI_getpwent_r, __GI_getspent_r"
		size = "171"
		objfiles = "getspent_r@libc.a, getpwent_r@libc.a, getgrent_r@libc.a"
	strings:
...
rule pthread_rwlock_rdlock_e3fc4a992ca70651960f7cc41460eb78 {
	meta:
...
rule __form_query_3fea797e573558260057fedfcd23778b {
	meta:
		aliases = "__form_query"
		size = "128"
		objfiles = "formquery@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 44 8B 7C 24 60 8B 74 24 64 6A 30 6A 00 8D 5C 24 10 53 E8 ?? ?? ?? ?? 8B 44 24 60 C7 44 24 34 01 00 00 00 C7 44 24 4C 01 00 00 00 89 44 24 14 8B 44 24 64 89 44 24 44 8B 44 24 68 89 44 24 48 83 C4 0C 56 57 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 78 1F 29 DE 50 56 8D 04 1F 50 8D 44 24 40 50 E8 ?? ?? ?? ?? 83 C4 10 8D 14 03 85 C0 89 C3 0F 49 DA 83 C4 40 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __ieee754_jn_4ab5e814cbaa64f2fd7c47f362f53650 {
	meta:
		aliases = "__ieee754_jn"
		size = "962"
		objfiles = "e_jn@libm.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 50 DD 44 24 64 8B 74 24 60 DD 54 24 18 DD 54 24 20 8B 54 24 20 8B 7C 24 24 89 D0 F7 D8 89 FB 09 D0 81 E3 FF FF FF 7F C1 E8 1F 09 D8 3D 00 00 F0 7F 76 09 D9 C0 DE C1 E9 7A 03 00 00 DD D8 83 FE 00 7D 14 DD 44 24 18 F7 DE 81 EF 00 00 00 80 D9 E0 DD 5C 24 18 EB 15 75 13 DD 44 24 18 DD 5C 24 60 83 C4 50 5B 5E 5F E9 ?? ?? ?? ?? 83 FE 01 75 13 DD 44 24 18 DD 5C 24 60 83 C4 50 5B 5E 5F E9 ?? ?? ?? ?? 09 DA 0F 84 1B 03 00 00 81 FB FF FF EF 7F 0F 8F 0F 03 00 00 50 50 FF 74 24 24 FF 74 24 24 E8 ?? ?? ?? ?? 83 C4 10 DD 5C 24 48 56 DB 04 24 83 C4 04 DD 54 24 28 DD 44 24 48 DF E9 DD D8 0F 82 }
	condition:
		$pattern
}
...
rule _dl_add_elf_hash_table_aea837e802199f015a09f6b9e96c2791 {
	meta:
		aliases = "_dl_add_elf_hash_table"
		size = "217"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 1D ?? ?? ?? ?? 8B 74 24 14 8B 7C 24 18 85 DB 75 2C 83 EC 0C 68 E8 00 00 00 E8 ?? ?? ?? ?? BA E8 00 00 00 83 C4 10 89 C3 A3 ?? ?? ?? ?? EB 04 C6 00 00 40 4A 83 FA FF 75 F6 EB 35 89 C3 8B 43 0C 85 C0 75 F7 83 EC 0C 68 E8 00 00 00 E8 ?? ?? ?? ?? BA E8 00 00 00 83 C4 10 89 43 0C EB 04 C6 00 00 40 4A 83 FA FF 75 F6 8B 43 0C 89 58 10 89 C3 83 EC 0C C7 43 0C 00 00 00 00 66 C7 43 22 00 00 FF 74 24 1C E8 ?? ?? ?? ?? 89 43 04 8B 44 24 2C 83 C4 10 C7 43 18 03 00 00 00 89 43 08 8B 4F 10 85 C9 74 17 8B 01 89 43 28 8B 51 04 89 53 38 8D 51 08 8D 04 82 89 53 2C 89 43 3C 89 33 31 D2 89 73 14 8B 04 }
	condition:
		$pattern
}
...
rule mknod_df91a90a303f37976d8516d4f58c1dad {
	meta:
		aliases = "__GI_mknod, mknod"
		size = "55"
		objfiles = "mknod@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 5C 24 18 8B 7C 24 10 8B 4C 24 14 89 DA 53 89 FB B8 0E 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 CF FF 5B 89 F8 5E 5F C3 }
	condition:
		$pattern
}
...
rule __re_match_2_06655f3ffcca89205dc15e4b3e2cb5db {
	meta:
...
rule wcswcs_ec45663db79afd91bcf650cbb59009d7 {
	meta:
		aliases = "wcsstr, wcswcs"
		size = "54"
		objfiles = "wcsstr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 10 8B 7C 24 14 89 F8 89 F2 8B 18 85 DB 75 04 89 F0 EB 19 8B 0A 39 CB 75 08 83 C0 04 83 C2 04 EB E8 85 C9 74 05 83 C6 04 EB DB 31 C0 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule memcpy_13eee19ee5b22cb1cf7ddec5afe58b26 {
	meta:
		aliases = "__GI_memcpy, memcpy"
		size = "43"
		objfiles = "memcpy@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 44 24 18 8B 74 24 14 8B 7C 24 10 89 C1 C1 E9 02 F3 A5 A8 02 74 02 66 A5 A8 01 74 01 A4 8B 44 24 10 5A 5E 5F C3 }
	condition:
		$pattern
}

rule __GI_splice_378d4600fd6c2fc04e6b3bace07da612 {
	meta:
...
rule __GI_mknodat_180c71331eaf1a7365679b9d5c605c3f {
	meta:
...
rule __GI_ppoll_62cdf942917768b0ee5b51e6aefae1b8 {
	meta:
		aliases = "ppoll, __GI_ppoll"
		size = "87"
		objfiles = "ppoll@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 14 8B 54 24 28 8B 74 24 2C 85 D2 74 11 8B 0A 8B 42 04 8D 54 24 0C 89 4C 24 0C 89 44 24 10 BF 08 00 00 00 8B 44 24 20 8B 4C 24 24 53 89 C3 B8 35 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 CF FF 83 C4 14 89 F8 5E 5F C3 }
	condition:
		$pattern
}

rule mq_open_153076378fbfbc174283bf529d7fe9cc {
	meta:
		aliases = "mq_open"
		size = "102"
		objfiles = "mq_open@librt.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 14 8B 7C 24 20 8B 4C 24 24 80 3F 2F 74 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 3E F6 C1 40 75 06 31 D2 31 F6 EB 10 8B 54 24 28 8D 44 24 30 8B 74 24 2C 89 44 24 10 47 53 89 FB B8 15 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 CF FF 89 F8 83 C4 14 5E 5F C3 }
	condition:
		$pattern
}
...
rule fstatat_cb983c679bdadf48ab468effa82c07ad {
	meta:
		aliases = "fstatat"
		size = "82"
		objfiles = "fstatat@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 44 8B 7C 24 50 8D 54 24 04 8B 4C 24 54 8B 74 24 5C 53 89 FB B8 2C 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0E E8 ?? ?? ?? ?? F7 DE 89 30 83 CE FF EB 13 85 C0 75 0F 50 50 FF 74 24 60 52 E8 ?? ?? ?? ?? 83 C4 10 83 C4 44 89 F0 5E 5F C3 }
	condition:
		$pattern
}
...
rule __getutid_3dd53a07e6b7bd31e665fcc2c252a196 {
	meta:
		aliases = "__getutid"
		size = "93"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 89 C6 53 8D 78 28 EB 3D 0F BF 16 8D 42 FF 66 83 F8 03 77 05 66 39 13 74 3C 66 83 FA 05 74 12 66 83 FA 08 74 0C 66 83 FA 06 74 06 66 83 FA 07 75 14 51 6A 04 57 8D 43 28 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 10 A1 ?? ?? ?? ?? E8 ?? ?? ?? ?? 85 C0 89 C3 75 B3 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_strcoll_124e63b6cd601cb0633c0125291d4f19 {
	meta:
		aliases = "strcoll, __GI_strcmp, strcmp, __GI_strcoll"
		size = "29"
...
rule __length_dotted_ec4eb08aa28992cd1de158c21a0d72c6 {
	meta:
		aliases = "__length_dotted"
		size = "65"
		objfiles = "lengthd@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 C8 FF 56 53 8B 74 24 10 8B 7C 24 14 85 F6 89 FA 75 1B EB 27 0F B6 D8 89 D8 25 C0 00 00 00 3D C0 00 00 00 75 05 8D 4A 02 EB 0D 8D 14 0B 8A 04 16 8D 4A 01 84 C0 75 DD 89 C8 29 F8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_chdir_9643bae2242ae2341f1f6493c9713af7 {
	meta:
...
rule umask_8848b304348fa64e900559735dc04e8d {
	meta:
		aliases = "umask"
		size = "47"
		objfiles = "umask@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 53 89 FB B8 3C 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 CF FF 5A 0F B7 C7 59 5F C3 }
	condition:
		$pattern
}
...
rule __GI___libc_lseek_8e5a565fe0a5b32af31233427caa96c0 {
	meta:
...
rule __GI_fcntl64_579a8cd33a1bbf2fdfff054eae624ac8 {
	meta:
		aliases = "__GI___libc_fcntl64, __libc_fcntl64, fcntl64, __GI_fcntl64"
		size = "63"
...
rule sched_getaffinity_5bb99406c4e1fbb2e08b4bc455248f1b {
	meta:
		aliases = "sched_getaffinity"
		size = "92"
		objfiles = "sched_getaffinity@libc.a"
	strings:
		$pattern = { ( CC | 57 ) B9 FF FF FF 7F 53 83 EC 04 8B 5C 24 14 8B 7C 24 10 8B 54 24 18 85 DB 0F 49 CB 53 89 FB B8 F2 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0B E8 ?? ?? ?? ?? F7 DF 89 38 EB 05 83 F8 FF 75 05 83 C8 FF EB 14 29 C3 51 53 6A 00 8D 04 02 50 E8 ?? ?? ?? ?? 31 C0 83 C4 10 5A 5B 5F C3 }
	condition:
		$pattern
}

rule signalfd_ac4f8f74e237e9125ad681e3e8da8816 {
	meta:
		aliases = "signalfd"
		size = "60"
		objfiles = "signalfd@libc.a"
	strings:
		$pattern = { ( CC | 57 ) BA 08 00 00 00 56 83 EC 04 8B 7C 24 10 8B 4C 24 14 8B 74 24 18 53 89 FB B8 47 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 CE FF 5A 89 F0 5E 5F C3 }
	condition:
		$pattern
}
...
rule __GI_sigblock_6c831794e0d4eb591f0ebd72fe6ae513 {
	meta:
...
rule _load_inttype_41a8a282ac42f608131d76c3acdca71d {
	meta:
		aliases = "_load_inttype"
		size = "94"
		objfiles = "_load_inttype@libc.a"
	strings:
		$pattern = { ( CC | 83 ) 7C 24 0C 00 8B 4C 24 04 8B 44 24 08 78 25 F6 C5 08 75 25 81 F9 00 01 00 00 8B 10 75 05 0F B6 D2 EB 0C 0F B7 C2 81 F9 00 02 00 00 0F 44 D0 89 D0 31 D2 C3 F6 C5 08 74 06 8B 50 04 8B 00 C3 81 F9 00 01 00 00 8B 10 75 05 0F BE D2 EB 0C 0F BF C2 81 F9 00 02 00 00 0F 44 D0 89 D0 99 C3 }
	condition:
		$pattern
}
...
rule __libc_waitpid_94d3925005c9f6c3778188d300b054a5 {
	meta:
		aliases = "__GI_wcstoul, strtoul, waitpid, __GI_strtoul, wcstoull, __GI_strtoull, wcstouq, wcstoumax, strtoull, __GI_waitpid, wcstoul, strtouq, __GI_wcstoull, strtoumax, __libc_waitpid"
		size = "26"
		objfiles = "wcstoull@libc.a, strtoull@libc.a, wcstoul@libc.a, waitpid@libc.a, strtoul@libc.a"
	strings:
...
rule wcstoq_da26619b63cd9d4af4cd0f247526cc20 {
	meta:
		aliases = "strtoimax, strtol, wcstoimax, __GI_strtoll, wcstoll, strtoll, __GI_strtol, __GI_wcstol, __GI_wcstoll, strtoq, wcstol, wcstoq"
		size = "26"
...
rule __GI___uClibc_init_6ee83f1943aa12f738cdd3131b66f7db {
	meta:
...
rule __getutent_b677dd4fb1f03773e6bd971772d8aa89 {
	meta:
		aliases = "__getutent"
		size = "58"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C 83 F8 FF 75 09 E8 ?? ?? ?? ?? 31 D2 EB 23 52 68 80 01 00 00 68 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 31 D2 83 C4 10 3D 80 01 00 00 B8 ?? ?? ?? ?? 0F 44 D0 89 D0 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule sigaddset_f657b9531bb3871fec8523f286c72564 {
	meta:
		aliases = "__GI_sigaddset, sigdelset, sigismember, __GI_sigdelset, sigaddset"
		size = "42"
...
rule __GI_cfsetispeed_c4316f2e2d3a6be3bd9bebcbfb6f93e4 {
	meta:
...
rule __GI___finite_b83986ad5ba5cf5c3394a1174e1018d6 {
	meta:
...
rule __raise_a9ef0b92c90e6c96f4b1888939a72f32 {
	meta:
		aliases = "raise, __GI_raise, __raise"
		size = "24"
...
rule __GI_strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__ieee754_gamma, gamma, __GI_lgamma, lgamma, strtok, __ieee754_lgamma, __GI_strtok"
		size = "25"
		objfiles = "e_gamma@libm.a, w_gamma@libm.a, w_lgamma@libm.a, strtok@libc.a, e_lgamma@libm.a"
	strings:
...
rule __GI_strtof_2ff06c8b56e3ed2678dab280e38803b5 {
	meta:
		aliases = "wcstof, __GI_wcstof, strtof, __GI_strtof"
		size = "49"
...
rule mrand48_r_c7069002931132f2dfc08888133d95bf {
	meta:
		aliases = "lrand48_r, drand48_r, __GI_lrand48_r, mrand48_r"
		size = "22"
...
rule __libc_creat64_bb2a987ff4b1e8f90f178160074caed3 {
	meta:
		aliases = "__libc_creat, creat64, creat, __libc_creat64"
		size = "25"
...
rule ldexpf_312f3131b70190222fba14e3c3defea1 {
	meta:
		aliases = "scalbnf, scalblnf, frexpf, ldexpf"
		size = "34"
...
rule inet_ntoa_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		aliases = "asctime, srand48, __GI_inet_ntoa, hcreate, ether_ntoa, __GI_asctime, inet_ntoa"
		size = "21"
		objfiles = "inet_ntoa@libc.a, hsearch@libc.a, ether_addr@libc.a, asctime@libc.a, srand48@libc.a"
	strings:
...
rule timelocal_eaca46bf57de9d027c256de54e89e0bb {
	meta:
		aliases = "iswalnum, mktime, __GI_iswalnum, mkstemp64, timelocal"
		size = "18"
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "condvar@libpthread.a, semaphore@libpthread.a, spinlock@libpthread.a, pthread@libpthread.a, join@libpthread.a"
	strings:
...
rule __GI_getlogin_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__pthread_once_fork_prepare, __pthread_once_fork_parent, _flushlbf, getlogin, hdestroy, __GI_getlogin"
		size = "17"
		objfiles = "_flushlbf@libc.a, mutex@libpthread.a, hsearch@libc.a, getlogin@libc.a"
	strings:
...
rule re_compile_pattern_4fe3b5a2611c2b667bc2ac46c3036242 {
	meta:
...
rule wprintf_84203de9a76a1350b67c27a76abfb69a {
	meta:
		aliases = "__GI_printf, printf, scanf, wscanf, wprintf"
		size = "32"
...
rule fwprintf_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		aliases = "fscanf, __GI_fprintf, __GI_asprintf, asprintf, dprintf, swscanf, __GI_sscanf, __GI_fscanf, __GI_syslog, syslog, fwscanf, sscanf, fprintf, fwprintf"
		size = "30"
		objfiles = "fscanf@libc.a, fwprintf@libc.a, syslog@libc.a, fprintf@libc.a, swscanf@libc.a"
	strings:
...
rule llroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		aliases = "lrintf, lroundf, ilogbf, llrintf, llroundf"
		size = "19"
		objfiles = "lroundf@libm.a, llrintf@libm.a, ilogbf@libm.a, lrintf@libm.a, llroundf@libm.a"
	strings:
...
rule floorf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "sinhf, expf, roundf, cosf, coshf, sinf, acoshf, acosf, tanhf, log10f, truncf, atanhf, asinhf, erfcf, expm1f, log1pf, cbrtf, tgammaf, lgammaf, ceilf, tanf, fabsf, sqrtf, logbf, atanf, erff, logf, asinf, rintf, floorf"
		size = "27"
		objfiles = "tgammaf@libm.a, expf@libm.a, roundf@libm.a, erfcf@libm.a, acosf@libm.a"
	strings:
...
rule atan2f_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		aliases = "copysignf, hypotf, fmodf, powf, remainderf, nextafterf, atan2f"
		size = "35"
		objfiles = "nextafterf@libm.a, hypotf@libm.a, powf@libm.a, remainderf@libm.a, fmodf@libm.a"
	strings:
...
rule wcstod_933c5f43d5ab233ccdd1cdce8fe5644f {
	meta:
		aliases = "strtod, __GI_wcstod, __GI_strtod, wcstod"
		size = "49"
...
rule fgetpwent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		aliases = "fgetgrent, getspnam, sgetspent, getpwnam, getgrnam, getpwuid, getgrgid, fgetspent, fgetpwent"
		size = "40"
		objfiles = "getpwnam@libc.a, fgetpwent@libc.a, getgrgid@libc.a, fgetgrent@libc.a, getspnam@libc.a"
	strings:
...
rule __ieee754_acosh_de3c7e7b69d8e343cd5c68dbd96fd252 {
	meta:
...
rule __GI_isatty_95e23849c6f5dd3c2d3a517e3e5d5c04 {
	meta:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		size = "4"
		objfiles = "gthr_gnat@libgcc_eh.a, _floatdixf@libgcc.a, _floatundixf@libgcc.a, _fixunssfdi@libgcc.a, _fixunsdfsi@libgcc.a"
	strings:
...
rule __get_pc_thunk_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		size = "4"
		objfiles = "unwind_c@libgcc_eh.a, _mulsc3@libgcc.a, _negvsi2@libgcc.a, _popcountdi2@libgcc.a, _divxc3@libgcc.a"
	strings:
...
rule pthread_mutexattr_getkind_np_f1910983a54cef9177564bec55e19797 {
	meta:
		aliases = "__pthread_mutexattr_gettype, __pthread_mutexattr_getkind_np, pthread_mutexattr_gettype, __GI_pthread_attr_getdetachstate, pthread_attr_getdetachstate, pthread_rwlockattr_getkind_np, pthread_mutexattr_getkind_np"
		size = "15"
...
rule pthread_attr_setstackaddr_67d62548c4a2a726a4c25fb9ede3ae88 {
	meta:
...
rule __GI__seterr_reply_59c845979f0501151a6dcb4e2dbd5b63 {
	meta:
...
rule __GI_ffs_da59442744b201c66cbefa060664a855 {
	meta:
		aliases = "ffs, __GI_ffs"
		size = "66"
		objfiles = "ffs@libc.a"
	strings:
		$pattern = { ( CC | 8B ) 4C 24 04 B2 01 66 85 C9 75 05 C1 F9 10 B2 11 84 C9 75 06 80 C2 08 C1 F9 08 F6 C1 0F 75 06 80 C2 04 C1 F9 04 F6 C1 03 75 06 80 C2 02 C1 F9 02 31 C0 85 C9 74 0B 8D 41 01 0F BE D2 83 E0 01 01 D0 C3 }
	condition:
		$pattern
}
...
rule __libc_current_sigrtmax_9306906a3a71020f26be39b72f98096c {
	meta:
		aliases = "__pthread_getconcurrency, __libc_current_sigrtmin, pthread_getconcurrency, __libc_current_sigrtmax"
		size = "6"
		objfiles = "pthread@libpthread.a, allocrtsig@libc.a"
	strings:
		$pattern = { ( CC | A1 ) ?? ?? ?? ?? C3 }
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "authnone_validate, __GI_xdr_void, old_sem_extricate_func, floatformat_always_valid, __GI__stdlib_mb_cur_max, _stdlib_mb_cur_max, xdr_void"
		size = "6"
		objfiles = "oldsemaphore@libpthread.a, floatformat@libiberty.a, xdr@libc.a, _stdlib_mb_cur_max@libc.a, auth_none@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		aliases = "_svcauth_short, svcraw_stat, rendezvous_stat, svcudp_stat"
		size = "6"
		objfiles = "svc_unix@libc.a, svc_tcp@libc.a, svc_raw@libc.a, svc_authux@libc.a, svc_udp@libc.a"
	strings:
...
rule __pthread_return_void_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		aliases = "clntunix_abort, clntraw_abort, pthread_handle_sigdebug, __linuxthreads_death_event, xdrmem_destroy, authnone_destroy, __cyg_profile_func_exit, svcraw_destroy, noop_handler, clntraw_geterr, __cyg_profile_func_enter, pthread_null_sighandler, _pthread_cleanup_push_defer, _pthread_cleanup_pop_restore, authunix_nextverf, authnone_verf, clntraw_destroy, clnttcp_abort, __stub1, clntudp_abort, __linuxthreads_create_event, __stub2, __linuxthreads_reap_event, __pthread_return_void"
		size = "1"
		objfiles = "noophooks@libc.a, __uClibc_main@libc.a, resolv@libresolv.a, svc_raw@libc.a, clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule __decode_packet_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "hypot, cabs, __GI_atanh, __GI_fmod, __ieee754_gamma_r, xdr_int, partition_delete, sqrt, __GI_atan2, __GI_xdr_u_int, xdr_u_longlong_t, y0, __GI_acosh, cosh, __GI_xdr_enum, __GI_hypot, __pthread_initialize, __GI_log10, fmod, __GI_remainder, __GI_sinh, remainder, __GI_nearbyint, __GI_asin, atanh, rand, jn, drem, vfork, j1, yn, __GI_sqrt, log, j0, pow, exp, __GI_cabs, mq_close, y1, xdr_longlong_t, __GI_acos, __GI_xdr_int, log10, log2, atan2, acosh, __GI_exp, __GI_cosh, __GI_pow, __GI_log"
		size = "5"
		objfiles = "decodep@libc.a, w_acos@libm.a, w_cosh@libm.a, xdr@libc.a, w_sqrt@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
