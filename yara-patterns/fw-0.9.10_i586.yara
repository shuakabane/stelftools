...
rule pthread_attr_destroy_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		size = "3"
		objfiles = "condvar@libpthread.a, xdr_stdio@libc.a, attr@libpthread.a, clnt_raw@libc.a, mutex@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __gcov_flush_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		size = "5"
		objfiles = "_gcov@libgcov.a, _enable_execute_stack@libgcc.a, _gcov_merge_add@libgcov.a, _gcov_merge_single@libgcov.a, gthr_gnat@libgcc_eh.a"
	strings:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		...
		size = "68"
		objfiles = "condvar@libpthread.a, errno@libpthread.a, cancel@libpthread.a, mutex@libpthread.a, signals@libpthread.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		size = "13"
		objfiles = "condvar@libpthread.a, manager@libpthread.a, spinlock@libpthread.a, pthread@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		size = "30"
		objfiles = "syslog@libc.a, asprintf@libc.a, dprintf@libc.a, fwscanf@libc.a, swscanf@libc.a"
	strings:
...
rule ilogbf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		size = "19"
		objfiles = "lrintf@libm.a, lroundf@libm.a, llrintf@libm.a, ilogbf@libm.a, llroundf@libm.a"
	strings:
...
rule acosf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		size = "27"
		objfiles = "tanf@libm.a, acoshf@libm.a, erfcf@libm.a, fabsf@libm.a, sinhf@libm.a"
	strings:
...
rule atan2f_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		size = "35"
		objfiles = "copysignf@libm.a, nextafterf@libm.a, fmodf@libm.a, remainderf@libm.a, powf@libm.a"
	strings:
...
rule getgrnam_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		size = "40"
		objfiles = "fgetpwent@libc.a, getpwuid@libc.a, fgetspent@libc.a, getpwnam@libc.a, getgrgid@libc.a"
	strings:
...
rule floatformat_always_valid_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		size = "6"
		objfiles = "auth_none@libc.a, oldsemaphore@libpthread.a, xdr@libc.a, _stdlib_mb_cur_max@libc.a, floatformat@libiberty.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		size = "6"
		objfiles = "svc_udp@libc.a, svc_raw@libc.a, svc_authux@libc.a, svc_tcp@libc.a, svc_unix@libc.a"
	strings:
