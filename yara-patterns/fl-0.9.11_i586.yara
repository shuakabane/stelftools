...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "condvar@libpthread.a, xdr_stdio@libc.a, wcsftime@libc.a, svc_auth@libc.a, auth_none@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "condvar@libpthread.a, join@libpthread.a, specific@libpthread.a, cancel@libpthread.a, mutex@libpthread.a"
	strings:
...
rule srand48_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		...
		type = "func"
		size = "21"
		objfiles = "ether_addr@libc.a, inet_ntoa@libc.a, hsearch@libc.a, asctime@libc.a, srand48@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "condvar@libpthread.a, join@libpthread.a, manager@libpthread.a, pthread@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "fprintf@libc.a, asprintf@libc.a, sscanf@libc.a, fscanf@libc.a, swscanf@libc.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "logf@libm.a, expf@libm.a, coshf@libm.a, ceilf@libm.a, truncf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "fgetgrent@libc.a, fgetspent@libc.a, fgetpwent@libc.a, getspnam@libc.a, getpwuid@libc.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "noophooks@libc.a, clnt_udp@libc.a, xdr_mem@libc.a, auth_unix@libc.a, clnt_tcp@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "partition@libiberty.a, w_hypot@libm.a, w_lgamma_r@libm.a, w_pow@libm.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
