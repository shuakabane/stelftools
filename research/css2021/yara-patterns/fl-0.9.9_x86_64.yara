...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "rwlock@libpthread.a, gthr_gnat@libgcc_eh.a, wcsftime@libc.a, grantpt@libc.a, clnt_raw@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule shm_open_60f1190f851552eb2a71f66ee363d352 {
	meta:
		aliases = "shm_open"
		type = "func"
		size = "137"
	...
	strings:
		$pattern = { ( CC | 41 ) 55 41 54 41 89 F4 55 83 CD FF 53 89 D3 48 83 EC 08 E8 83 FF FF FF 48 85 C0 49 89 C5 74 60 48 89 C7 89 DA 31 C0 44 89 E6 E8 ?? ?? ?? ?? 85 C0 89 C5 78 35 31 D2 89 C7 BE 01 00 00 00 31 C0 E8 ?? ?? ?? ?? 85 C0 78 17 83 C8 01 BE 02 00 00 00 89 EF 89 C2 31 C0 E8 ?? ?? ?? ?? 85 C0 79 0A 89 EF 83 CD FF E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 44 8B 20 48 89 C3 4C 89 EF E8 ?? ?? ?? ?? 44 89 23 59 5B 89 E8 5D 41 5C 41 5D C3 }
	condition:
		$pattern
}
...
rule thread_self_fc567cf57d3f04fc77b3c53a5a9fe529 {
	meta:
		...
		type = "func"
		size = "69"
		objfiles = "rwlock@libpthread.a, join@libpthread.a, pthread@libpthread.a, errno@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule syslog_4f17e5776fd93321a6b366d662782192 {
	meta:
		...
		type = "func"
		size = "142"
		objfiles = "fwprintf@libc.a, dprintf@libc.a, fprintf@libc.a, asprintf@libc.a, syslog@libc.a"
	strings:
...
rule sgetspent_5abd21e9b7de4fda56e36ae3f07cbf5b {
	meta:
		...
		type = "func"
		size = "39"
		objfiles = "fgetpwent@libc.a, sgetspent@libc.a, fgetspent@libc.a, getgrgid@libc.a, getspnam@libc.a"
	strings:
...
rule futimes_55785ce62faea93f0c8970b595ca4e88 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 31 D2 48 83 EC 20 48 85 F6 74 2D 48 8B 06 48 89 E2 48 89 04 24 48 69 46 08 E8 03 00 00 48 89 44 24 08 48 8B 46 10 48 89 44 24 10 48 69 46 18 E8 03 00 00 48 89 44 24 18 45 31 D2 31 F6 48 63 FF B8 18 01 00 00 0F 05 48 89 C3 48 81 FB 00 F0 FF FF 76 0F E8 ?? ?? ?? ?? 89 DA F7 DA 89 10 48 83 C8 FF 48 83 C4 20 5B C3 }
	condition:
		$pattern
}
...
rule shm_unlink_6444c4c70390df5bf4b1bae1fc801200 {
	meta:
		aliases = "shm_unlink"
		type = "func"
		size = "46"
		objfiles = "shm@librt.a"
	strings:
		$pattern = { ( CC | 55 ) 83 CD FF 53 48 83 EC 08 E8 BA FF FF FF 48 85 C0 48 89 C3 74 12 48 89 C7 E8 ?? ?? ?? ?? 48 89 DF 89 C5 E8 ?? ?? ?? ?? 5A 5B 89 E8 5D C3 }
	condition:
		$pattern
}
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "oldsemaphore@libpthread.a, xdr@libc.a, floatformat@libiberty.a, _stdlib_mb_cur_max@libc.a, auth_none@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_tcp@libc.a, svc_unix@libc.a, svc_udp@libc.a, svc_raw@libc.a, svc_authux@libc.a"
	strings:
...
rule srand48_aedd30f4a92f36ce8e0b990c7b4f97a2 {
	meta:
		...
		type = "func"
		size = "10"
		objfiles = "hsearch@libc.a, ether_addr@libc.a, inet_ntoa@libc.a, srand48@libc.a, asctime@libc.a"
	strings:
		$pattern = { ( CC | BE ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule lgamma_8c47b9c6008fc75a3442b25215b4f0fe {
	meta:
		...
		type = "func"
		size = "10"
		objfiles = "w_gamma@libm.a, w_lgamma@libm.a, hsearch@libc.a, e_gamma@libm.a, e_lgamma@libm.a"
	strings:
		$pattern = { ( CC | BF ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "noophooks@libc.a, nsl@libnsl.a, clnt_tcp@libc.a, auth_unix@libc.a, lckpwdf@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_exp@libm.a, w_scalb@libm.a, join@libpthread.a, w_acos@libm.a, w_fmod@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule truncf_76fb52706816ef3df3c8d6c20b0aa675 {
	meta:
		...
		type = "func"
		size = "19"
		objfiles = "coshf@libm.a, ldexpf@libm.a, sqrtf@libm.a, sinhf@libm.a, roundf@libm.a"
	strings:
...
rule lroundf_d3b5b767a0285b8ef7c579a0959a22b2 {
	meta:
		...
		type = "func"
		size = "9"
		objfiles = "llrintf@libm.a, llroundf@libm.a, lrintf@libm.a, lroundf@libm.a, ilogbf@libm.a"
	strings:
...
rule remainderf_b655e1a82b86ef778f64370fab64b292 {
	meta:
		...
		type = "func"
		size = "23"
		objfiles = "fmodf@libm.a, nextafterf@libm.a, atan2f@libm.a, copysignf@libm.a, hypotf@libm.a"
	strings:
...
rule pex_unix_cleanup_32a093eff127b3eedaa06c147dc0694b {
	meta:
		...
		type = "func"
		size = "2"
		objfiles = "_clear_cache@libgcc.a, gthr_gnat@libgcc_eh.a, pex_unix@libiberty.a, _enable_execute_stack@libgcc.a, hex@libiberty.a"
	strings:
		$pattern = { ( CC | F3 ) C3 }
	condition:
		$pattern
