...
rule pthread_equal_c11f863d6be2c66fb42fa0367477969e {
	meta:
		...
		type = "func"
		size = "9"
		objfiles = "pthread@libpthread.a, hashtab@libiberty.a"
	strings:
...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "xdr_stdio@libc.a, attr@libpthread.a, condvar@libpthread.a, clnt_raw@libc.a, _udiv_w_sdiv@libgcc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule wcswidth_519caf6aaaa3a66af2973adae5223eb5 {
	meta:
...
rule wcscasecmp_927e133d075718c3177d3be609cda204 {
	meta:
...
rule __des_crypt_efe23db06f13b89df9c395197a75ce83 {
	meta:
		aliases = "__des_crypt"
		type = "func"
		size = "407"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 41 ) 54 55 48 89 F5 53 48 89 FB 48 83 EC 10 E8 9D F5 FF FF 48 89 E2 EB 11 8A 03 01 C0 88 02 48 FF C2 80 7A FF 01 48 83 DB FF 48 89 D0 48 89 E7 48 29 E0 48 83 F8 08 75 E0 E8 65 FD FF FF 44 0F BE 65 00 0F BE 7D 01 44 88 25 ?? ?? ?? ?? 8A 45 01 84 C0 41 0F 44 C4 88 05 ?? ?? ?? ?? E8 10 F5 FF FF 89 C3 44 89 E7 C1 E3 06 E8 03 F5 FF FF 09 C3 89 DF E8 3E F9 FF FF 48 8D 54 24 0C 48 8D 4C 24 08 31 F6 31 FF 41 B8 19 00 00 00 E8 6B F9 FF FF 31 D2 85 C0 0F 85 F3 00 00 00 8B 54 24 0C C6 05 ?? ?? ?? ?? 00 89 D0 89 D1 C1 E8 1A C1 E9 08 83 E0 3F 83 E1 3F 8A 80 ?? ?? ?? ?? 88 05 ?? ?? ?? ?? 89 D0 C1 E8 14 83 E0 }
	condition:
		$pattern
}
...
rule getwc_unlocked_54da1f507f3e8937212c8a6de3c67ff0 {
	meta:
...
rule getutid_0dccabcc0b6bab0806ff799f70aa9233 {
	meta:
...
rule clnt_sperror_09ca0ce47c89611b181406b4ba9f5a06 {
	meta:
...
rule fclose_e54d49b903ccf3012288f405459f36f0 {
	meta:
...
rule _Unwind_Find_FDE_1b2ed0f0b5ff7ac3fbfcacb7139aa616 {
	meta:
		...
		objfiles = "unwind_dw2_fde_glibc@libgcc.a"
	strings:
		$pattern = { ( CC | 41 ) 55 49 89 F5 41 54 55 53 48 89 FB 48 83 EC 18 48 8B 2D ?? ?? ?? ?? 48 85 ED 75 0E E9 80 00 00 00 48 8B 6D 28 48 85 ED 74 77 48 3B 5D 00 66 90 72 EF 48 89 DE 48 89 EF E8 73 F9 FF FF 48 85 C0 49 89 C4 74 5C 48 8B 45 08 49 89 45 00 48 8B 45 10 49 89 45 08 8B 45 20 66 C1 E8 03 F6 45 20 04 0F B6 C0 0F 85 A1 00 00 00 0F B6 D8 48 89 EE 89 DF E8 5A EF FF FF 48 8D 4C 24 10 49 8D 54 24 08 48 89 C6 89 DF E8 A6 EF FF FF 48 8B 44 24 10 49 89 45 10 48 83 C4 18 4C 89 E0 5B 5D 41 5C 41 5D C3 45 31 E4 48 8B 2D ?? ?? ?? ?? 48 85 ED 74 E3 48 8B 45 28 48 89 DE 48 89 EF 48 89 05 ?? ?? ?? ?? E8 EA F8 FF FF 49 89 }
	condition:
		$pattern
}
...
rule fputws_99a800bf3357b96d85730affeec177c2 {
	meta:
		...
		type = "func"
		size = "97"
		objfiles = "fputs@libc.a, fputws@libc.a"
	strings:
...
rule statvfs64_7b3c47063842b7177a64ae9fedf9f737 {
	meta:
...
rule fstatvfs64_829b77d2dde211c47259bd19112ec049 {
	meta:
...
rule pthread_setschedparam_51d21eae837b982e1a429fe9d8c79320 {
	meta:
...
rule vsscanf_17a24295c755c845701a15690ff11a72 {
	meta:
...
rule readdir_r_1b15cbe64007e0e7a6e6aa375c1d4ddb {
	meta:
...
rule rexec_af_ae519fc3b475ace9fce9c2b5a679ea8f {
	meta:
	...
	strings:
		$pattern = { ( CC | 41 ) 57 31 C0 4D 89 CF 66 C1 CE 08 41 56 49 89 FE 41 55 41 54 55 83 CD FF 53 48 81 EC D8 01 00 00 4C 8D AC 24 90 01 00 00 48 89 54 24 38 48 89 4C 24 30 48 89 54 24 18 48 89 4C 24 20 BA ?? ?? ?? ?? 0F B7 CE 4C 89 EF BE 20 00 00 00 4C 89 44 24 10 0F B7 9C 24 10 02 00 00 E8 ?? ?? ?? ?? 4C 8D A4 24 40 01 00 00 31 F6 BA 30 00 00 00 C6 84 24 AF 01 00 00 00 4C 89 E7 E8 ?? ?? ?? ?? 49 8B 3E 48 8D 8C 24 B8 01 00 00 4C 89 E2 4C 89 EE 89 9C 24 44 01 00 00 C7 84 24 48 01 00 00 01 00 00 00 C7 84 24 40 01 00 00 02 00 00 00 E8 ?? ?? ?? ?? 85 C0 0F 85 73 03 00 00 48 8B 84 24 B8 01 00 00 48 8B 70 20 48 85 F6 74 }
	condition:
		$pattern
}
...
rule inet_pton_205953922bc5748e69aa4d755d0b17f5 {
	meta:
		...
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 41 ) 57 41 56 41 55 41 54 55 48 89 F5 53 48 83 EC 38 83 FF 02 48 89 54 24 08 74 0B 83 FF 0A 0F 85 B2 01 00 00 EB 12 48 8B 74 24 08 48 89 EF E8 46 FF FF FF E9 B0 01 00 00 48 8D 7C 24 20 31 F6 BA 10 00 00 00 E8 ?? ?? ?? ?? 80 7D 00 3A 49 89 C4 4C 8D 70 10 75 0D 48 FF C5 80 7D 00 3A 0F 85 83 01 00 00 49 89 EF 48 C7 44 24 18 00 00 00 00 E9 86 00 00 00 89 DE BF ?? ?? ?? ?? 48 FF C5 E8 ?? ?? ?? ?? 48 85 C0 48 89 C2 74 20 B8 ?? ?? ?? ?? 41 C1 E5 04 29 C2 41 09 D5 41 81 FD FF FF 00 00 0F 86 8D 00 00 00 E9 3B 01 00 00 83 FB 3A 75 57 83 7C 24 14 00 75 16 48 83 7C 24 18 00 0F 85 23 01 00 00 49 89 EF 4C 89 }
	condition:
		$pattern
}
...
rule clnt_broadcast_eea6f520bc725fb95ffd888b6181a2a8 {
	meta:
		...
		objfiles = "pmap_rmt@libc.a"
	strings:
		$pattern = { ( CC | 41 ) 57 41 56 41 55 41 54 55 53 48 81 EC E8 29 00 00 48 89 7C 24 30 48 89 74 24 28 48 89 54 24 20 48 89 4C 24 18 4C 89 44 24 10 4C 89 4C 24 08 E8 ?? ?? ?? ?? BF 02 00 00 00 BA 11 00 00 00 BE 02 00 00 00 48 89 44 24 38 C7 84 24 D8 29 00 00 01 00 00 00 E8 ?? ?? ?? ?? 85 C0 41 89 C7 BF ?? ?? ?? ?? 78 28 48 8D 8C 24 D8 29 00 00 41 B8 04 00 00 00 BA 06 00 00 00 BE 01 00 00 00 89 C7 E8 ?? ?? ?? ?? 85 C0 79 14 BF ?? ?? ?? ?? BB 03 00 00 00 E8 ?? ?? ?? ?? E9 F8 04 00 00 48 8D 44 24 50 48 8D 94 24 90 29 00 00 BE 12 89 00 00 44 89 FF 44 89 BC 24 D0 29 00 00 66 C7 84 24 D4 29 00 00 01 00 48 89 84 24 98 29 }
	condition:
		$pattern
}
...
rule strftime_e624072cd0adf39f97549aa5856d903f {
	meta:
...
rule des_setkey_883897d1f27fadfdff725ae3df058989 {
	meta:
		aliases = "des_setkey"
		type = "func"
		size = "606"
...
rule setvbuf_98a18e8a04b6e35eea7e18a576b220a5 {
	meta:
...
rule memcmp_4e92cf00daf415d15793163566a7f321 {
	meta:
...
rule do_des_9401da0e1c6df707e35ad94d9ae96663 {
	meta:
		aliases = "do_des"
		type = "func"
		size = "760"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 41 ) 57 41 83 F8 00 89 F8 41 89 F3 41 56 49 89 D6 BA 01 00 00 00 41 55 41 54 45 89 C4 55 53 48 89 4C 24 F8 0F 84 C2 02 00 00 7E 0E 41 BF ?? ?? ?? ?? 41 BD ?? ?? ?? ?? EB 0F 41 F7 DC 41 BF ?? ?? ?? ?? 41 BD ?? ?? ?? ?? 44 89 DA 41 89 C1 48 89 C1 C1 EA 18 44 0F B6 C0 0F B6 C4 89 D2 49 89 C2 41 C1 E9 18 48 C1 E9 10 8B 1C 95 ?? ?? ?? ?? 0B 1C 85 ?? ?? ?? ?? 4C 89 D8 4C 89 DE 45 89 C9 0F B6 C4 81 E1 FF 00 00 00 41 0F B6 FB 0B 1C 85 ?? ?? ?? ?? 49 89 C3 45 89 C0 48 C1 EE 10 8B 04 8D ?? ?? ?? ?? 42 0B 04 8D ?? ?? ?? ?? 81 E6 FF 00 00 00 42 0B 04 85 ?? ?? ?? ?? 89 FF 0B 04 B5 ?? ?? ?? ?? 8B 2C 95 ?? ?? }
	condition:
		$pattern
}
...
rule xdr_array_e9b52c0159b7dff82ffa1f8bbd18c1f3 {
	meta:
...
rule __res_querydomain_c7c3c74a8c034c8c8d1d2537e37cfd76 {
	meta:
...
rule vsnprintf_335b3a66ebbed5f014bda33ae0dd0c84 {
	meta:
...
rule clntunix_create_44a12f4743e0e826c7335b866491fba9 {
	meta:
...
rule fread_unlocked_d7e3d44478a1a32f94c2001bfcba38d9 {
	meta:
...
rule _getopt_internal_3a0eb6585cd2f85db6816a031ca25652 {
	meta:
		...
		objfiles = "getopt@libc.a"
	strings:
		$pattern = { ( CC | 41 ) 57 49 89 F7 41 56 41 55 41 54 55 53 48 83 EC 48 8B 05 ?? ?? ?? ?? 48 89 54 24 18 48 89 4C 24 10 8B 15 ?? ?? ?? ?? 48 8B 4C 24 18 C7 44 24 2C 00 00 00 00 89 05 ?? ?? ?? ?? 89 7C 24 20 4C 89 44 24 08 44 89 4C 24 04 89 15 ?? ?? ?? ?? 80 39 3A 0F 44 44 24 2C 85 FF 89 44 24 2C 0F 8E 0C 07 00 00 85 D2 48 C7 05 ?? ?? ?? ?? 00 00 00 00 74 0F 83 3D ?? ?? ?? ?? 00 0F 85 92 00 00 00 EB 0A C7 05 ?? ?? ?? ?? 01 00 00 00 8B 05 ?? ?? ?? ?? BF ?? ?? ?? ?? 48 C7 05 ?? ?? ?? ?? 00 00 00 00 89 05 ?? ?? ?? ?? 89 05 ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8B 54 24 18 48 85 C0 0F 95 C0 0F B6 C0 89 05 ?? ?? ?? ?? 8A 02 3C }
	condition:
		$pattern
}
...
rule search_object_d9d7f40ddd964bf416f048b1d738de98 {
	meta:
		...
		objfiles = "unwind_dw2_fde_glibc@libgcc.a"
	strings:
		$pattern = { ( CC | 41 ) 57 49 89 FF 41 56 41 55 41 54 55 53 48 81 EC 98 00 00 00 48 89 74 24 20 0F B6 57 20 F6 C2 01 0F 85 E1 02 00 00 8B 4F 20 89 C8 C1 E8 0B 0F 84 49 03 00 00 89 C0 48 89 44 24 38 48 8B 44 24 38 48 8D 1C C5 10 00 00 00 48 89 DF E8 ?? ?? ?? ?? 48 85 C0 48 89 44 24 70 0F 84 91 02 00 00 48 C7 40 08 00 00 00 00 48 89 DF E8 ?? ?? ?? ?? 48 85 C0 48 89 44 24 78 74 08 48 C7 40 08 00 00 00 00 41 F6 47 20 02 0F 84 73 04 00 00 49 8B 47 18 48 8B 10 48 85 D2 74 20 48 8D 6C 24 70 48 89 C3 48 89 EE 4C 89 FF E8 26 FA FF FF 48 8B 53 08 48 83 C3 08 48 85 D2 75 E8 4C 8B 64 24 70 4D 85 E4 4C 89 64 24 30 74 10 48 8B }
	condition:
		$pattern
}
...
rule _fpmaxtostr_ee8db9e47ffde439782957c13edb2a26 {
	meta:
		aliases = "_fpmaxtostr"
		type = "func"
		size = "1610"
	...
	strings:
		$pattern = { ( CC | 41 ) 57 49 89 FF 41 56 49 89 D6 41 55 41 54 49 89 F4 55 53 48 81 EC 18 01 00 00 8A 5E 08 8B 2E 44 8B 6E 04 C6 84 24 F0 00 00 00 65 C6 84 24 00 01 00 00 00 89 D8 8D 53 06 83 C8 20 3C 61 B8 06 00 00 00 0F 44 DA 8B 56 0C 85 ED 0F 48 E8 DB AC 24 50 01 00 00 F6 C2 02 74 0A C6 84 24 00 01 00 00 2B EB 17 80 E2 01 B8 20 00 00 00 BA 00 00 00 00 0F 44 C2 88 84 24 00 01 00 00 DB E8 C6 84 24 01 01 00 00 00 48 C7 44 24 38 00 00 00 00 7A 02 74 0D DF C0 48 C7 44 24 38 08 00 00 00 EB 55 D9 EE D9 C9 DB E9 75 23 7A 21 D9 E8 41 83 C9 FF D8 F1 D9 CA DF EA DD D9 0F 86 04 01 00 00 C6 84 24 00 01 00 00 2D E9 F7 00 00 }
	condition:
		$pattern
}
...
rule mallinfo_04d9f96e7e012168e6c9f34592a48fd8 {
	meta:
...
rule strstr_e2a61712eef94ea248c9cd7454e03ca0 {
	meta:
	...
	strings:
		$pattern = { ( CC | 44 ) 0F B6 16 45 85 D2 0F 84 AD 00 00 00 48 FF CF 48 FF C7 0F B6 07 85 C0 0F 84 A0 00 00 00 44 39 D0 75 ED 4C 8D 5E 01 0F B6 76 01 85 F6 0F 84 87 00 00 00 0F B6 47 01 48 8D 4F 01 EB 2E 0F B6 47 01 48 8D 4F 01 EB 19 85 C0 74 73 48 FF C1 0F B6 01 44 39 D0 74 0F 85 C0 74 64 48 FF C1 0F B6 01 44 39 D0 75 E2 48 FF C1 0F B6 01 39 F0 75 F1 0F B6 41 01 41 0F B6 53 01 4D 8D 4B 01 4C 8D 41 01 48 8D 79 FF 39 D0 75 2E 85 C0 74 2E 41 0F B6 40 01 41 0F B6 51 01 39 D0 75 1C 85 D2 74 1C 49 83 C0 02 49 83 C1 02 41 0F B6 11 41 0F B6 00 39 D0 75 04 89 D0 EB D2 85 D2 75 83 48 89 F8 C3 31 C0 C3 }
	condition:
		$pattern
}
...
rule thread_self_fc567cf57d3f04fc77b3c53a5a9fe529 {
	meta:
		...
		type = "func"
		size = "69"
		objfiles = "spinlock@libpthread.a, signals@libpthread.a, condvar@libpthread.a, pthread@libpthread.a, errno@libpthread.a"
	strings:
...
rule sigblock_ae925dba31f92abc96a910e7e125c070 {
	meta:
...
rule sigsetmask_91547ba3c94c44ae5323dfd5b7bf8eae {
	meta:
...
rule sysv_signal_1e6110ddc5ccc3b61704f588fdcbf79d {
	meta:
...
rule syslog_4f17e5776fd93321a6b366d662782192 {
	meta:
		...
		type = "func"
		size = "142"
		objfiles = "fscanf@libc.a, fwscanf@libc.a, fprintf@libc.a, dprintf@libc.a, syslog@libc.a"
	strings:
...
rule scalbln_7f2b01ba77fe6a54825afad96b54c6b9 {
	meta:
...
rule sgetspent_5abd21e9b7de4fda56e36ae3f07cbf5b {
	meta:
		...
		type = "func"
		size = "39"
		objfiles = "getspnam@libc.a, fgetpwent@libc.a, fgetgrent@libc.a, getpwnam@libc.a, fgetspent@libc.a"
	strings:
...
rule xre_set_syntax_26e7b8d8a92ed76c586f2e06d4795b45 {
	meta:
		...
		type = "func"
		size = "15"
		objfiles = "regex@libiberty.a, regex_old@libc.a"
	strings:
...
rule strcasecmp_8fe85f92680913231b05e6521c25db04 {
	meta:
...
rule telldir_7a346892aa6f48c113696b74d69cab29 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "hashtab@libiberty.a, telldir@libc.a"
	strings:
...
rule memchr_d35910629fa8c09f8e52b50cfdacc7fb {
	meta:
...
rule gethostid_f5bbef18d58b834b26fb38e2f7c08c81 {
	meta:
		aliases = "gethostid"
		type = "func"
		size = "215"
...
rule sendto_72e74dc88aebe37f3d166d561afb55b3 {
	meta:
...
rule lseek_1ec563b9d349b6d0974e33d4cb38a869 {
	meta:
...
rule readv_d005ab35268a3de9f4d49f547d43d873 {
	meta:
...
rule writev_b127f7546d2af52ff74f248b4909d59e {
	meta:
...
rule sendmsg_fbf95158da3e194ae52596df7a414050 {
	meta:
...
rule setpriority_44ea68b9d4c336f1df669fbe619ddc48 {
	meta:
...
rule poll_e2e4d673cf7b6df9540aa4bceb06c219 {
	meta:
...
rule dup2_edd20583d7b3929ac91e667bbec1c79a {
	meta:
...
rule read_e71aabeec0afc202a527620e7d4a2651 {
	meta:
...
rule close_edaf20539e9c2f13a3fdf19621d2cbdb {
	meta:
...
rule ftruncate_7238cd3a63a102f0b4dcb3ce1fbdc3b2 {
	meta:
...
rule clock_getres_441c3d047e282c6bfd04e1087ae45ddd {
	meta:
...
rule vswprintf_9411d873d3c8c21c0aea40af948c937f {
	meta:
...
rule xdrrec_skiprecord_3a93b4b0b2d9afbec7bfb677582067bb {
	meta:
...
rule mremap_98392e30af61aa70463f4bdc36cacfdc {
	meta:
...
rule chown_51d1d08e6d98db7a3583b7bf78437ada {
	meta:
...
rule setrlimit64_044d8d16b11d93d40152196a35b4d2fc {
	meta:
...
rule nanosleep_e4f8ab62efc2d7c5ad4bbd99230229e2 {
	meta:
...
rule getpid_0f40364ebad8beae8392c01d0d3b08f6 {
	meta:
...
rule fork_6c680adadd5584219a39eae18e28dfb5 {
	meta:
...
rule execve_239305b7034b518a3dc13c27c7cbde6a {
	meta:
...
rule uname_41ae40ae263bd891d117d03ecc10a4a8 {
	meta:
...
rule gettimeofday_de9553582bbcff13af8f3852fc7e1126 {
	meta:
...
rule getuid_b43276c0b0a410bcae5b953dcf8c3351 {
	meta:
...
rule atan_36c47f571e504105475511b870a7cdc9 {
	meta:
...
rule erfc_56727873216500e67e10b0fb0a25e677 {
	meta:
...
rule strrchr_d66962a54c3282d1091d77823c6ae289 {
	meta:
...
rule nrand48_r_9028c9b8c293ef726b47bd4e26ceaad3 {
	meta:
...
rule erand48_r_8704fe162769d6a8dc6c68b3345b9992 {
	meta:
...
rule rcmd_866f50d5e1f81da392ee7376398a737b {
	meta:
		aliases = "rcmd"
		type = "func"
		size = "1316"
		objfiles = "rcmd@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 48 89 E5 41 57 41 56 41 55 41 54 41 BC 00 04 00 00 53 48 81 EC B8 00 00 00 48 89 95 38 FF FF FF 48 89 BD 48 FF FF FF 48 89 8D 30 FF FF FF 4C 89 85 28 FF FF FF 4C 89 8D 20 FF FF FF 66 89 B5 46 FF FF FF E8 ?? ?? ?? ?? 48 81 EC 10 04 00 00 89 85 58 FF FF FF 48 8D 54 24 0F 48 83 E2 F0 EB 45 8B 5D C8 83 FB FF 75 0A E8 ?? ?? ?? ?? 83 38 22 74 1B E8 ?? ?? ?? ?? 89 18 48 8B 85 48 FF FF FF 48 8B 38 E8 ?? ?? ?? ?? E9 80 04 00 00 4D 01 E4 49 8D 44 24 1E 48 83 E0 F0 48 29 C4 48 8D 54 24 0F 48 83 E2 F0 48 8B 85 48 FF FF FF 48 8D B5 60 FF FF FF 4C 8D 4D C8 4C 8D 45 B8 4C 89 E1 48 8B 38 E8 ?? ?? ?? ?? 85 }
	condition:
		$pattern
}
...
rule gaih_inet_581cf083df15b1026beef5cff2ce534f {
	meta:
		aliases = "gaih_inet"
		type = "func"
		size = "2715"
...
rule clnt_create_a52cc4f5303ddea4cce6d8dc6b79b0de {
	...
	strings:
		$pattern = { ( CC | 55 ) 48 89 E5 41 57 49 89 CF 41 56 49 89 FE 48 89 CF 41 55 49 89 F5 BE ?? ?? ?? ?? 41 54 49 89 D4 53 48 81 EC F8 00 00 00 E8 ?? ?? ?? ?? 85 C0 75 4F 48 8D 9D E0 FE FF FF BA 6E 00 00 00 31 F6 48 89 DF E8 ?? ?? ?? ?? 48 8D 7B 02 4C 89 F6 66 C7 85 E0 FE FF FF 01 00 E8 ?? ?? ?? ?? 48 8D 4D CC 45 31 C9 45 31 C0 4C 89 E2 4C 89 EE 48 89 DF C7 45 CC FF FF FF FF E8 ?? ?? ?? ?? E9 A6 01 00 00 48 81 EC 10 04 00 00 BB 00 04 00 00 48 8D 54 24 0F 48 83 E2 F0 EB 37 83 7D C8 FF 75 0A E8 ?? ?? ?? ?? 83 38 22 74 10 E8 ?? ?? ?? ?? C7 00 0D 00 00 00 E9 6D 01 00 00 48 01 DB 48 8D 43 1E 48 83 E0 F0 48 29 C4 48 8D 54 }
	condition:
		$pattern
}
...
rule __pthread_set_own_extricate_if_76da68e49fd047986d012f8c39b9f16a {
	meta:
		...
		type = "func"
		size = "65"
		objfiles = "join@libpthread.a, semaphore@libpthread.a, condvar@libpthread.a"
	strings:
...
rule encrypt_369f8e3c7d41242e7a88c8ad4ad0ef3b {
	meta:
		aliases = "encrypt"
		type = "func"
		size = "175"
		objfiles = "des@libcrypt.a"
	strings:
		$pattern = { ( CC | 55 ) 48 89 FD 53 89 F3 48 83 EC 18 E8 AD F8 FF FF 31 FF E8 AB FC FF FF 48 89 EE 31 FF EB 2F 48 63 C7 31 C9 C7 04 84 00 00 00 00 EB 1A F6 06 01 74 10 48 63 C7 48 63 D1 8B 14 95 ?? ?? ?? ?? 09 14 84 48 FF C6 FF C1 83 F9 1F 7E E1 FF C7 83 FF 01 7E CC 83 FB 01 8B 3C 24 8B 74 24 04 45 19 C0 48 8D 4C 24 04 48 89 E2 41 83 E0 02 41 FF C8 E8 95 FC FF FF 31 FF EB 28 89 FA 48 63 C6 48 63 CF C1 E2 05 8B 04 85 ?? ?? ?? ?? 09 F2 85 04 8C 48 63 D2 0F 95 44 15 00 FF C6 83 FE 1F 7E DA FF C7 83 FF 01 7F 04 31 F6 EB F0 48 83 C4 18 5B 5D C3 }
	condition:
		$pattern
}
...
rule signal_1521eb2f779f07de39542e237dddeb7c {
	meta:
...
rule _exit_74daa264a2f2a971f261a936c8472ec2 {
	meta:
...
rule nanf_0ced4d1dfcd68a7269be4badcb51e6e6 {
	meta:
...
rule getnetent_441990104e9b35871d7cfc367a423843 {
	meta:
...
rule ffs_ba7a988f94c4d6ffe6fa1ec18357896c {
	meta:
...
rule random_r_88e64ce3e011034f230ee1e50824b85b {
	meta:
...
rule xdrmem_putlong_201fe442643335908c2673f4c658389a {
	meta:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "xdr@libc.a, floatformat@libiberty.a, oldsemaphore@libpthread.a, _stdlib_mb_cur_max@libc.a, auth_none@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_tcp@libc.a, svc_authux@libc.a, svc_raw@libc.a, svc_unix@libc.a, svc_udp@libc.a"
	strings:
...
rule srand48_aedd30f4a92f36ce8e0b990c7b4f97a2 {
	meta:
		...
		type = "func"
		size = "10"
		objfiles = "srand48@libc.a, inet_ntoa@libc.a, hsearch@libc.a, asctime@libc.a, ether_addr@libc.a"
	strings:
		$pattern = { ( CC | BE ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule lgamma_8c47b9c6008fc75a3442b25215b4f0fe {
	meta:
		...
		type = "func"
		size = "10"
		objfiles = "hsearch@libc.a, _flushlbf@libc.a, mutex@libpthread.a, e_lgamma@libm.a, e_gamma@libm.a"
	strings:
		$pattern = { ( CC | BF ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "signals@libpthread.a, clnt_raw@libc.a, pthread@libpthread.a, auth_unix@libc.a, clnt_unix@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule re_match_2_a3ba4fc4df09b1a1ddd6bc4472ce28ec {
	meta:
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_lgamma_r@libm.a, w_acosh@libm.a, decodep@libc.a, w_atanh@libm.a, s_nearbyint@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule rint_09f69f3049d775016991af8b016c84a1 {
	meta:
...
rule log1p_2492e244850ae9e9930588a295e894ee {
	meta:
...
rule lround_fab6931e2431ee60b1e99942449752fc {
	meta:
...
rule frexp_838367f0272e48fb03780694d860b1e7 {
	meta:
...
rule carg_c05643826c82343dee55b99a4b6f1686 {
	meta:
...
rule truncf_76fb52706816ef3df3c8d6c20b0aa675 {
	meta:
		...
		type = "func"
		size = "19"
		objfiles = "roundf@libm.a, floorf@libm.a, log1pf@libm.a, acosf@libm.a, log10f@libm.a"
	strings:
...
rule lroundf_d3b5b767a0285b8ef7c579a0959a22b2 {
	meta:
		...
		type = "func"
		size = "9"
		objfiles = "llroundf@libm.a, llrintf@libm.a, lrintf@libm.a, lroundf@libm.a, ilogbf@libm.a"
	strings:
...
rule remainderf_b655e1a82b86ef778f64370fab64b292 {
	meta:
		...
		type = "func"
		size = "23"
		objfiles = "powf@libm.a, atan2f@libm.a, remainderf@libm.a, nextafterf@libm.a, fmodf@libm.a"
	strings:
...
rule pex_unix_cleanup_32a093eff127b3eedaa06c147dc0694b {
	meta:
		...
		type = "func"
		size = "2"
		objfiles = "_gcov@libgcov.a, _gcov_merge_add@libgcov.a, _gcov_merge_single@libgcov.a, gthr_gnat@libgcc.a, _enable_execute_stack@libgcc.a"
	strings:
		$pattern = { ( CC | F3 ) C3 }
	condition:
		$pattern
