...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "mutex@libpthread.a, grantpt@libc.a, wcsftime@libc.a, auth_none@libc.a, attr@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "gthr_gnat@libgcc_eh.a, _enable_execute_stack@libgcc.a, _gcov@libgcov.a, _gcov_merge_single@libgcov.a, _gcov_merge_delta@libgcov.a"
	strings:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "mutex@libpthread.a, semaphore@libpthread.a, pthread@libpthread.a, join@libpthread.a, specific@libpthread.a"
	strings:
...
rule strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		...
		type = "func"
		size = "25"
		objfiles = "strtok@libc.a, e_gamma@libm.a, w_gamma@libm.a, e_lgamma@libm.a, w_lgamma@libm.a"
	strings:
...
rule scalbnf_312f3131b70190222fba14e3c3defea1 {
	meta:
		...
		type = "func"
		size = "34"
		objfiles = "ldexpf@libm.a, scalbnf@libm.a, scalblnf@libm.a, frexpf@libm.a"
	strings:
...
rule srand48_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		...
		type = "func"
		size = "21"
		objfiles = "srand48@libc.a, ether_addr@libc.a, hsearch@libc.a, inet_ntoa@libc.a, asctime@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "semaphore@libpthread.a, pthread@libpthread.a, join@libpthread.a, spinlock@libpthread.a, condvar@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "fscanf@libc.a, sscanf@libc.a, swscanf@libc.a, fprintf@libc.a, dprintf@libc.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "sqrtf@libm.a, log10f@libm.a, erff@libm.a, acoshf@libm.a, asinf@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "powf@libm.a, nextafterf@libm.a, atan2f@libm.a, fmodf@libm.a, copysignf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "getspnam@libc.a, fgetpwent@libc.a, getgrnam@libc.a, getpwuid@libc.a, sgetspent@libc.a"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "auth_none@libc.a, xdr@libc.a, floatformat@libiberty.a, oldsemaphore@libpthread.a, _stdlib_mb_cur_max@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_unix@libc.a, svc_tcp@libc.a, svc_authux@libc.a, svc_raw@libc.a, svc_udp@libc.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "lckpwdf@libc.a, pthread@libpthread.a, events@libpthread.a, auth_unix@libc.a, clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_cosh@libm.a, w_exp@libm.a, w_asin@libm.a, w_acosh@libm.a, w_j0@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
