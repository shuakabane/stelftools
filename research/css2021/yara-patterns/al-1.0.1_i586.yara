...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		aliases = "__GI_pthread_attr_destroy, __GI_pthread_condattr_destroy, __GI_pthread_condattr_init, __GI_wcsftime, __pthread_mutex_init, __pthread_mutex_lock, __pthread_mutex_trylock, __pthread_mutex_unlock, __pthread_mutexattr_destroy, __pthread_return_0, _svcauth_null, authnone_refresh, clntraw_control, grantpt, pthread_attr_destroy, pthread_condattr_destroy, pthread_condattr_init, pthread_mutexattr_destroy, pthread_rwlockattr_destroy, td_init, td_log, td_thr_setprio, td_thr_setsigpending, td_thr_sigsetmask, wcsftime, xdrstdio_inline"
		type = "func"
		size = "3"
		objfiles = "attr@libpthread.a, td_thr_setprio@libthread_db.a, __uClibc_main@libc.a, condvar@libpthread.a, td_init@libthread_db.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		type = "func"
		size = "8"
		objfiles = "condvar@libpthread.a, pthread@libpthread.a, rwlock@libpthread.a, join@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule glob_pattern_p_187488d01d8f02adf1a170896b7e5be0 {
	meta:
...
rule log10_0d34295cd09e25270017499239b9d477 {
	meta:
...
rule gethostname_a2df3537eea71eb6eca7a6fb7ec0c8d8 {
	meta:
...
rule hypot_03bbde0c96b22368388ebeef125c0aec {
	meta:
...
rule wait_0f16be773a16c7f1ada0f23bb98e42f6 {
	meta:
...
rule write_7e8310e1353bbbc8133a54fecec14b99 {
	meta:
...
rule sendto_7dc26d3bd37d60f67a43dfc81df638df {
	meta:
...
rule xdr_u_long_31792c5aa1f2da0f64cb35a103eeeaa3 {
	meta:
...
rule xdr_u_short_83ae1282dc1aee41f28ee75116c39b86 {
	meta:
...
rule xdr_bool_ade373f96063a7fd14e0d01db2a4aafc {
	meta:
...
rule getc_unlocked_51c788b0fa8040705eca5d5cfb82a5b7 {
	meta:
...
rule td_thr_event_enable_7979263c6886bda9be35aef22b5a857c {
	meta:
		aliases = "td_thr_event_enable"
		type = "func"
		size = "94"
		objfiles = "td_thr_event_enable@libthread_db.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 5C 24 0C 8B 53 04 8B 0B 85 D2 75 29 89 E0 50 6A 0B FF 31 E8 ?? ?? ?? ?? 83 C4 0C BA 01 00 00 00 85 C0 75 30 6A 04 8D 44 24 14 50 FF 74 24 08 8B 03 FF 30 EB 10 6A 04 8D 44 24 14 50 8D 82 24 01 00 00 50 FF 31 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 89 D0 5A 5B C3 }
	condition:
		$pattern
}
...
rule td_ta_get_nthreads_06085a1bd7b8a425e2f9a38a3a76f581 {
	meta:
		aliases = "td_ta_get_nthreads"
		type = "func"
		size = "93"
		objfiles = "td_ta_get_nthreads@libthread_db.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 A1 ?? ?? ?? ?? 8B 5C 24 0C 85 DB 75 05 EB 40 8B 40 04 85 C0 74 39 39 18 75 F5 89 E0 50 6A 02 FF 33 E8 ?? ?? ?? ?? 83 C4 0C BA 01 00 00 00 85 C0 75 22 6A 04 FF 74 24 14 FF 74 24 08 FF 33 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 EB 05 BA 08 00 00 00 89 D0 5A 5B C3 }
	condition:
		$pattern
}
...
rule sigrelse_73e69e276044ac190a291aabe3ed6f53 {
	meta:
...
rule open64_13e566636ea64be5cace05d7b2d9be02 {
	meta:
...
rule mbrtowc_e6f7b72c005f0a216ca76c7fad54a956 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 0C 8B 54 24 20 8B 5C 24 14 8B 44 24 18 85 D2 75 05 BA ?? ?? ?? ?? 85 C0 75 0D 31 DB 8D 44 24 0B C6 44 24 0B 00 EB 18 80 38 00 75 0C 85 DB 74 3B C7 03 00 00 00 00 EB 33 83 7C 24 1C 00 74 2C 89 04 24 52 6A 01 6A FF 8D 44 24 0C 50 8D 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 14 89 C2 85 C0 78 0E 85 DB 74 0A 8B 44 24 04 89 03 EB 02 31 D2 89 D0 83 C4 0C 5B C3 }
	condition:
		$pattern
}
...
rule endservent_3507ba9dffddf7d42c1461ec63ab065f {
	meta:
		aliases = "__GI_endnetent, __GI_endservent, endnetent, endservent"
		type = "func"
		size = "83"
		objfiles = "getservice@libc.a, getnetent@libc.a"
	strings:
...
rule gethostent_r_ca23f7947e79f3272af80403050fde73 {
	meta:
...
rule sinh_10a57f98d85edc9d676d794ec8c08960 {
	meta:
...
rule scalbn_eec6789731b74d15a05297db358b79c2 {
	meta:
...
rule trunc_b02f962526bea788ad3ad3a00a700e49 {
	meta:
...
rule pmap_unset_a7be1081e40bcb69f55d7b0bb4f52248 {
	meta:
...
rule svcerr_progvers_9e3e9837d11cbb2f3d9ce00da9bf56a9 {
	meta:
...
rule svcerr_noprog_48b751464da5a094928dcba9f78a8181 {
	meta:
...
rule asinh_dabf23dfb4b1da11c8f4167f23cd0c9f {
	meta:
...
rule stat_66e5993732e4c6da4414faf1e7d5b0d5 {
	meta:
...
rule lstat_0b93d962f38474ffdd5368f61c816332 {
	meta:
...
rule fstat64_47bc7f41aa5fae69073bac2164fc6abc {
	meta:
...
rule xdrrec_skiprecord_29fa3ef25e1a835417b2ea430ab2fb87 {
	meta:
...
rule towctrans_ffd94486e06dc719e20817477528e69c {
	meta:
...
rule ether_ntoa_r_3c5a956ccefe9d6f9b78ca790ade80ff {
	meta:
...
rule __glibc_strerror_r_73db6f5c74b10bf5e054233c4b7799fd {
	meta:
...
rule mq_timedsend_f48038227456cd46c63217113fc8f015 {
	meta:
...
rule system_9454ddab71c34e0bfe242daa37c2129c {
	meta:
...
rule getpid_16cf7f907e57d624e33d5f3b23e48822 {
	meta:
...
rule pause_323461b138eb282b75c2a9a5bea0c953 {
	meta:
...
rule getgid_9591166b903c51c5a2fad5b6dfb7ac1b {
	meta:
...
rule geteuid_39f79a21f396afb229634c1e9c0d36d3 {
	meta:
...
rule getegid_30304a5e607858cd129ed3d5e4ad4f84 {
	meta:
...
rule sigsuspend_c132e4879a3e7c4f009823f03272ce77 {
	meta:
...
rule getrpcent_fe266ce0b511b56372bda006e04281a3 {
	meta:
...
rule pthread_attr_init_5886231edf1272e26612458362dc3754 {
	meta:
...
rule __udiv_w_sdiv_e0763f81f247ccb6313a6363fe1d24ce {
	meta:
		aliases = "_Unwind_FindEnclosingFunction, _Unwind_GetDataRelBase, _Unwind_GetRegionStart, _Unwind_GetTextRelBase, __gthread_active_p, __udiv_w_sdiv"
		type = "func"
		size = "7"
		objfiles = "gthr_gnat@libgcc_eh.a, _udiv_w_sdiv@libgcc.a, unwind_sjlj@libgcc_eh.a"
	strings:
...
rule authunix_create_default_7fcb51a040e3b22a1c496361483ce1c6 {
	meta:
...
rule clnt_spcreateerror_f28587da0326ac80e19385ce837292cc {
	meta:
...
rule svc_getreq_common_d6abfa2820953dc36342816a528f08fe {
	meta:
...
rule statvfs_baaf9c470f4da22b2025dc23c9f1ab8e {
	meta:
...
rule vsyslog_162f69e2648c609b069c571b384adb53 {
	meta:
...
rule handle_descr_b2c621b0c70bb0629ba6358d86f50e8b {
	meta:
		aliases = "handle_descr"
		type = "func"
		size = "229"
		objfiles = "td_ta_thr_iter@libthread_db.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 70 01 00 00 89 C6 89 CD 89 14 24 8B 9C 24 90 01 00 00 8B BC 24 8C 01 00 00 8B 40 18 85 DB 75 48 85 FF 75 3A 8D 54 24 08 B9 58 00 00 00 89 D7 89 D8 F3 AB 89 94 24 24 01 00 00 89 54 24 0C 89 54 24 08 C7 44 24 18 00 04 00 00 89 B4 24 68 01 00 00 C7 84 24 6C 01 00 00 00 00 00 00 EB 5A 31 D2 83 FF 01 0F 95 C2 EB 6A 50 8D 44 24 0C 50 53 FF 36 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 50 4F 75 07 83 7C 24 1C 00 74 44 8B 84 24 88 01 00 00 39 44 24 20 7C 37 83 BC 24 84 01 00 00 00 75 2D 80 7C 24 36 00 75 26 89 B4 24 68 01 00 00 89 9C 24 6C 01 00 00 55 8D 84 24 6C 01 00 00 50 FF }
	condition:
		$pattern
}

rule td_thr_validate_a68f5ebccbf99a2fc8e2117df31a01b8 {
	meta:
		aliases = "td_thr_validate"
		type = "func"
		size = "176"
		objfiles = "td_thr_validate@libthread_db.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 70 01 00 00 8B B4 24 84 01 00 00 8B 16 83 7E 04 00 8B 5A 04 8B 6A 0C 74 04 31 FF EB 79 6A 10 8D 84 24 64 01 00 00 50 53 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 64 83 BC 24 68 01 00 00 01 EB 49 6A 10 8D 84 24 64 01 00 00 50 53 8B 06 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 3F 8B 8C 24 68 01 00 00 85 C9 74 2C 3B 4E 04 75 27 8B 06 FF 70 18 8D 54 24 04 52 51 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 16 80 7C 24 2C 01 19 C0 F7 D0 83 E0 02 EB 0D 47 83 C3 10 39 EF 7C A6 B8 01 00 00 00 81 C4 70 01 00 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule td_thr_tsd_f6ea97a6b81c25328fbcf1ce07bce8f5 {
	meta:
		aliases = "td_thr_tsd"
		type = "func"
		size = "239"
		objfiles = "td_thr_tsd@libthread_db.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 70 01 00 00 8B BC 24 84 01 00 00 8B 9C 24 88 01 00 00 8B 17 8B 42 08 89 04 24 8B 4F 04 8B 72 10 8B 6A 14 85 C9 0F 84 A7 00 00 00 68 60 01 00 00 8D 44 24 08 50 51 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 91 00 00 00 39 F3 0F 83 82 00 00 00 6A 08 8D 84 24 68 01 00 00 50 8B 54 24 08 8D 04 DA 50 8B 07 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 67 83 BC 24 64 01 00 00 00 74 56 31 D2 89 D8 F7 F5 89 D1 8B 54 84 78 B8 11 00 00 00 85 D2 74 4D 6A 04 8D 84 24 70 01 00 00 50 8D 04 8A 50 8B 07 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 2A 8B 94 24 6C 01 00 00 85 D2 74 09 8B 84 24 8C 01 00 00 89 }
	condition:
		$pattern
}
...
rule rexec_af_e09e10e7cb1b9f0fc3a9a2244e5984a7 {
	meta:
...
rule getnameinfo_126b7f83dd0f7847d9253dc4a79e5b2a {
	meta:
...
rule authunix_create_52f72e26efcac1d2645eec009f6d1fd8 {
	meta:
...
rule ttyname_r_2e0e59bd3c912bc990240b0bec97c9db {
	meta:
...
rule vfwscanf_152951920c1dd215127046ee27a1c097 {
	meta:
...
rule inet_pton4_5a9f22cfeb867a279f5a093da443ec6e {
	meta:
		aliases = "inet_pton4"
		type = "func"
		size = "119"
...
rule svc_unregister_01fa7ef06aad838c34b23831e1f6ccd9 {
	meta:
...
rule xdr_union_cbe9517e17413768e186bc71a00df959 {
	meta:
...
rule inet_aton_37e76880b2660dfd63dba8e785912ac1 {
	meta:
...
rule xdr_pmaplist_cb9b12f297ce53ea50d251b2319f9c57 {
	meta:
...
rule vasprintf_35b8cb6880c35ae1cbf75520bbb7167d {
	meta:
...
rule getmntent_r_42fcd6055fd913e2986f5cbf954e3f57 {
	meta:
...
rule getwc_unlocked_b564ba6caa5a6e32786a8c4fce3e7276 {
	meta:
...
rule xdr_rmtcall_args_a2dee6840e2ced6ea6e09f63794d902b {
	meta:
...
rule qsort_6dfae1492c1c7336df7e752816694acc {
	meta:
...
rule __ns_name_unpack_3ad26659857975e431533393fcc0a9bd {
	meta:
...
rule readdir64_r_640468779bcb9830f403344d99410c0d {
	meta:
...
rule srandom_r_589277939052857946789176d6e9c35d {
	meta:
...
rule xdrrec_create_95e8a658e6e1201768876b2215071122 {
	meta:
...
rule td_ta_new_c367327708819034bfcb759bcfe85598 {
	meta:
		aliases = "td_ta_new"
		type = "func"
		size = "523"
		objfiles = "td_ta_new@libthread_db.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8D 6C 24 0C 8B 5C 24 28 55 6A 00 56 E8 ?? ?? ?? ?? 83 C4 0C B9 0C 00 00 00 85 C0 0F 85 D5 01 00 00 8D 44 24 08 50 6A 0C 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 0F 85 B8 01 00 00 6A 07 8D 7C 24 05 57 FF 74 24 10 56 E8 ?? ?? ?? ?? 83 C4 10 B9 01 00 00 00 85 C0 0F 85 9C 01 00 00 C6 44 24 07 00 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 5A 85 C0 59 0F 85 7D 01 00 00 6A 28 E8 ?? ?? ?? ?? 89 03 89 C2 5F B9 12 00 00 00 85 C0 0F 84 69 01 00 00 89 30 8B 44 24 0C 89 42 1C 8B 03 83 C0 20 50 6A 01 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 11 FF 33 E8 ?? ?? ?? ?? B9 01 00 00 00 E9 1C 01 00 00 8B }
	condition:
		$pattern
}

rule getprotobynumber_r_26887b3cea372f6ba996f46e05859c5e {
	meta:
...
rule ungetwc_f8f97c118c3fe31c6ed31af9f4a87c15 {
	meta:
...
rule ungetc_ce81b84959b4563b1bcd3e7e9582c5d8 {
	meta:
...
rule ceil_0561365aaee4b32537673cbf4d6f29fb {
	meta:
...
rule lround_312d4ca02e08251b4796d3e1989be423 {
	meta:
...
rule ptsname_r_7d5ff45956865fe5e22e5eb75ebe4dfd {
	meta:
...
rule getservent_r_cbf2bbf6711b2e604c1d96c8fb1954e9 {
	meta:
...
rule fflush_unlocked_48a54e28fc85132ce2889988d43312ea {
	meta:
...
rule bindresvport_3ed4567c3c1a2f35a0450749ef23b4aa {
	meta:
...
rule getdelim_42a5291573fffaac8cd0c452f46823bf {
	meta:
...
rule fseeko64_102c5981dd4b77379b6c259a45a299b2 {
	meta:
...
rule __res_init_7f38d222c984a6616e563f9c76c6eb7e {
	meta:
...
rule svcudp_bufcreate_8233c1a03f48e0d65c2c07f7d3db475a {
	meta:
...
rule hsearch_r_8a0494f843480decc1f364f75236173f {
	meta:
...
rule sqrt_44d85e485a494a22753a9254ab6c1888 {
	meta:
...
rule __ns_name_ntop_313996427c10349543a6a56cbb47d073 {
	meta:
...
rule fclose_6489038d650a1b08d72848025ff5cfa7 {
	meta:
...
rule llround_b79c5423ad40fd6f8bd07cff56569859 {
	meta:
...
rule tcsetattr_ec25343382e4ff6bda1e58fffae34b64 {
	meta:
...
rule rtime_0856b21179fdcc617552f6a108acde0b {
	meta:
...
rule nextafter_5206fb3cda4d75b37a2d553645843a11 {
	meta:
...
rule lrint_0b1635d1060bff394c35068479f34f9f {
	meta:
...
rule sleep_d96f7c3ccfbcaf0538aa1cec241db342 {
	meta:
...
rule remainder_64042736c9c48070529e5a6399904eaf {
	meta:
...
rule clntunix_create_145b562d2a9bb339f59a44edfe8394ff {
	meta:
...
rule regexec_9712fa1e19f490b46154e786558d8f45 {
	meta:
...
rule fmod_bb6cbd1196062eec618f60a42babd54c {
	meta:
...
rule clntudp_bufcreate_a8b80205779ea5d5c237befa54c8c587 {
	meta:
...
rule gethostbyname2_r_38b904e64eacbc449d2975538e183d69 {
	meta:
...
rule gethostbyaddr_r_2600d33b79b3f2322436c91c1dcf49be {
	meta:
...
rule strftime_65f7d68cdccea2d5e97e722884a20320 {
	meta:
...
rule inet_ntop_b1cb5650638bb18d70d1b3cb47c72e85 {
	meta:
...
rule lgamma_r_dc7dce16502fa7d29208f31ada4c9a87 {
	meta:
...
rule strptime_c01cd190c797ae8018c194ebe8444e78 {
	meta:
...
rule memmem_7516de3ea3d8f9bbc9e7757cfc1398c9 {
	meta:
...
rule asctime_r_62afdaa08128dccc1dba76ef7c8f84a1 {
	meta:
...
rule getcwd_b1eab32697dbe5cb86390f2b204fe153 {
	meta:
...
rule getpwuid_r_bd71f4213c840b6491270d73c0492b51 {
	meta:
...
rule getspnam_r_58c1fbfb60120a75998e512e626f63ff {
	meta:
...
rule sgetspent_r_c9832cc3cb55a32a0e026ecddc6f0a6e {
	meta:
...
rule getenv_7d186b154c0727c86ad32db8744bf5b3 {
	meta:
...
rule execlp_5b11615a705e8ed872128db39ff1e1a5 {
	meta:
...
rule execl_3c27fcd8ffb18a2c154eb1585151ea85 {
	meta:
...
rule _pthread_cleanup_pop_restore_eff9d5b81ce18e94b8ff14f77fc1dfb9 {
	meta:
...
rule td_ta_map_lwp2thr_7eea054e4d052e9e247e561b89217553 {
	meta:
		aliases = "td_ta_map_lwp2thr"
		type = "func"
		size = "259"
		objfiles = "td_ta_map_lwp2thr@libthread_db.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 70 01 00 00 8B 5D 08 89 A5 8C FE FF FF 8B 43 18 89 85 90 FE FF FF 8B 53 0C 89 95 88 FE FF FF C1 E2 04 8D 42 10 29 C4 A1 ?? ?? ?? ?? 8D 74 24 0F 83 E6 F0 EB 03 8B 40 04 85 C0 74 06 39 18 75 F5 EB 0A B8 08 00 00 00 E9 A1 00 00 00 52 56 FF 73 04 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 85 00 00 00 31 FF EB 72 89 F8 C1 E0 04 01 F0 89 85 84 FE FF FF 8B 40 08 85 C0 74 49 FF B5 90 FE FF FF 8D 95 94 FE FF FF 52 50 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 51 8B 85 A8 FE FF FF 85 C0 75 08 FF 33 E8 ?? ?? ?? ?? 5A 3B 45 0C 75 2A 8B 45 10 89 18 8B 95 84 FE FF FF 8B 42 08 8B 55 10 89 }
	condition:
		$pattern
}
...
rule glob64_d7ac2aeec175c13c2258f506dd61c633 {
	meta:
...
rule td_ta_thr_iter_28c5201a7264632f466e0b9dfefa6cb7 {
	meta:
		aliases = "td_ta_thr_iter"
		type = "func"
		size = "275"
		objfiles = "td_ta_thr_iter@libthread_db.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 04 A1 ?? ?? ?? ?? 83 7D 08 00 75 08 E9 E4 00 00 00 8B 40 04 85 C0 0F 84 D9 00 00 00 8B 55 08 39 10 75 EE 8B 42 0C 89 C7 89 45 F0 C1 E7 04 8D 47 10 29 C4 8D 74 24 0F 6A 20 83 E6 F0 56 FF 72 04 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 AA 00 00 00 FF 76 08 6A 00 8B 4D 10 FF 75 18 FF 75 14 8B 55 0C 8B 45 08 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 0F 85 89 00 00 00 FF 76 18 6A 01 8B 4D 10 FF 75 18 FF 75 14 8B 55 0C 8B 45 08 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 75 67 8D 47 E0 8B 55 08 50 8D 46 20 50 BF 02 00 00 00 8B 42 04 83 C0 20 50 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 2F EB }
	condition:
		$pattern
}
...
rule execvp_ef85177fd1b6a2dad86f711944255f55 {
	meta:
...
rule td_ta_event_getmsg_b770d38d1602b3ba7487c883117882b1 {
	meta:
		aliases = "td_ta_event_getmsg"
		type = "func"
		size = "419"
		objfiles = "td_ta_event_getmsg@libthread_db.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 24 8B 5D 08 A1 ?? ?? ?? ?? 85 DB 75 08 E9 73 01 00 00 8B 40 04 85 C0 0F 84 68 01 00 00 39 18 75 F1 8D 45 F0 6A 04 50 FF 73 20 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 50 01 00 00 8B 45 F0 BE 0A 00 00 00 85 C0 0F 84 45 01 00 00 05 28 01 00 00 8D 55 DC 6A 10 52 50 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 22 01 00 00 83 7D E4 00 0F 85 C3 00 00 00 89 65 D4 8B 43 0C C1 E0 04 83 C0 10 29 C4 8D 45 EC 8D 7C 24 0F 6A 04 50 83 E7 F0 FF 73 24 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 86 00 00 00 8B 43 0C C1 E0 04 50 57 FF 73 04 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 6D 31 F6 EB }
	condition:
		$pattern
}
...
rule nanf_e0d91863fe9e60ebbed597199c5a2daa {
	meta:
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_gcov_merge_single@libgcov.a, _enable_execute_stack@libgcc.a, _gcov@libgcov.a, gthr_gnat@libgcc_eh.a, _gcov_merge_add@libgcov.a"
	strings:
...
rule td_ta_tsd_iter_5c3974a388565a925a8853eca69f3879 {
	meta:
		aliases = "td_ta_tsd_iter"
		type = "func"
		size = "137"
		objfiles = "td_ta_tsd_iter@libthread_db.a"
	strings:
		$pattern = { ( CC | 55 ) A1 ?? ?? ?? ?? 89 E5 57 56 53 8B 4D 08 85 C9 75 05 EB 66 8B 40 04 85 C0 74 5F 39 08 75 F5 8B 79 10 31 F6 8D 04 FD 00 00 00 00 8D 50 10 29 D4 8D 5C 24 0F 50 83 E3 F0 53 FF 71 08 FF 31 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 74 23 EB 2E 8D 04 F3 83 38 00 74 18 FF 75 10 FF 70 04 56 FF 55 0C 83 C4 0C 85 C0 74 07 BA 0F 00 00 00 EB 0E 46 39 FE 7C DB 31 D2 EB 05 BA 08 00 00 00 8D 65 F4 89 D0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule thread_self_4d574e5856a30bb564cca31edbbe6aeb {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "errno@libpthread.a, condvar@libpthread.a, cancel@libpthread.a, pthread@libpthread.a, specific@libpthread.a"
	strings:
...
rule __ns_name_uncompress_e5450d2d47e9763bfee2d004d8d3556d {
	meta:
...
rule tmpfile64_d511eeeff396621da2aaa5551be25d14 {
	meta:
...
rule td_thr_setgregs_58a1fc82070d2360b6563636886af2c4 {
	meta:
		aliases = "td_thr_setfpregs, td_thr_setgregs"
		type = "func"
		size = "133"
		objfiles = "td_thr_setgregs@libthread_db.a, td_thr_setfpregs@libthread_db.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 60 01 00 00 89 E6 8B 9C 24 6C 01 00 00 68 60 01 00 00 6A 00 56 E8 ?? ?? ?? ?? 8B 43 04 83 C4 0C 85 C0 74 1C 68 60 01 00 00 56 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 36 31 D2 80 7C 24 2C 00 75 2D 8B 44 24 14 85 C0 75 0A 8B 03 FF 30 E8 ?? ?? ?? ?? 5A FF B4 24 70 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 31 D2 83 C4 0C 85 C0 0F 95 C2 81 C4 60 01 00 00 89 D0 5B 5E C3 }
	condition:
		$pattern
}
...
rule wcsxfrm_531c207e747b0f75ca250818a7b364ec {
	meta:
		aliases = "__GI_wcsxfrm, __wcslcpy, wcsxfrm"
		type = "func"
		size = "62"
...
rule strxfrm_826df2c6b2fa4cf7a82b73280b7d3ba6 {
	meta:
...
rule xdr_rmtcallres_547b0940e298ce24b0cd5a818b24719d {
	meta:
...
rule putc_unlocked_41f491c81c0dc935d6f1b2b6a74edb56 {
	meta:
...
rule td_ta_event_addr_dbde585db9d71f5a08db306410e2185e {
	meta:
		aliases = "td_ta_event_addr"
		type = "func"
		size = "128"
		objfiles = "td_ta_event_addr@libthread_db.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 A1 ?? ?? ?? ?? 8B 5C 24 10 8B 4C 24 14 8B 74 24 18 85 DB 75 05 EB 3D 8B 40 04 85 C0 74 36 39 18 75 F5 83 F9 09 74 16 83 F9 0C 74 2F B8 0D 00 00 00 BA 08 00 00 00 83 F9 08 74 25 EB 3A BA 09 00 00 00 EB 1C C7 06 00 00 00 00 8B 04 24 89 46 04 31 C0 EB 23 B8 08 00 00 00 EB 1C BA 0A 00 00 00 89 E0 50 52 FF 33 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 D2 B8 01 00 00 00 5A 5B 5E C3 }
	condition:
		$pattern
}
...
rule td_thr_clear_event_c09fe92fb5369f587a6aca5a92535575 {
	meta:
		aliases = "td_thr_clear_event"
		type = "func"
		size = "115"
		objfiles = "td_thr_clear_event@libthread_db.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 31 D2 8B 5C 24 14 8B 74 24 18 8B 4B 04 85 C9 74 56 6A 08 8D 44 24 04 50 8D 81 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 33 30 D2 8B 04 96 F7 D0 21 04 94 42 83 FA 01 74 F2 6A 08 8D 44 24 04 50 8B 43 04 05 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}
...
rule __sigpause_7963049a6dc81ad460dab9e6f9911937 {
	meta:
...
rule td_ta_set_event_cc0e6445cd0fce2eba402662b06a190d {
	meta:
		aliases = "td_ta_set_event"
		type = "func"
		size = "119"
		objfiles = "td_ta_set_event@libthread_db.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 A1 ?? ?? ?? ?? 8B 5C 24 14 8B 74 24 18 85 DB 75 05 EB 53 8B 40 04 85 C0 74 4C 39 18 75 F5 6A 08 8D 44 24 04 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 30 30 D2 8B 04 96 09 04 94 42 83 FA 01 74 F4 6A 08 8D 44 24 04 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 EB 05 BA 08 00 00 00 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule td_ta_clear_event_6551cb4d9f73976cbecc889a806c448f {
	meta:
		aliases = "td_ta_clear_event"
		type = "func"
		size = "121"
		objfiles = "td_ta_clear_event@libthread_db.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 A1 ?? ?? ?? ?? 8B 5C 24 14 8B 74 24 18 85 DB 75 05 EB 55 8B 40 04 85 C0 74 4E 39 18 75 F5 6A 08 8D 44 24 04 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 32 30 D2 8B 04 96 F7 D0 21 04 94 42 83 FA 01 74 F2 6A 08 8D 44 24 04 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 EB 05 BA 08 00 00 00 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule td_thr_set_event_33ea0a87b7656f95d38505f75cbe512c {
	meta:
		aliases = "td_thr_set_event"
		type = "func"
		size = "116"
		objfiles = "td_thr_set_event@libthread_db.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 BA 15 00 00 00 8B 5C 24 14 8B 74 24 18 8B 4B 04 85 C9 74 54 6A 08 8D 44 24 04 50 8D 81 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 31 30 D2 8B 04 96 09 04 94 42 83 FA 01 74 F4 6A 08 8D 44 24 04 50 8B 43 04 05 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule erand48_r_ad60d9f86c66a95bd1259d92f650b168 {
	meta:
...
rule getrpcbynumber_r_13754be2b03e0868f7da06037e51d2b3 {
	meta:
...
rule pselect_6dd36ccbdb5304ef00d4ad029273c899 {
	meta:
...
rule exit_3ee16080c4dca89fcaa5705bbf74ca34 {
	meta:
...
rule pthread_once_9edb7e1a818063675450f6c9999c895b {
	meta:
...
rule getc_b201c844c2fa5bbf84a4162d1c4e3e1e {
	meta:
...
rule atan_3ec6f2013bb4a6fc2490fcfca6e7ee12 {
	meta:
...
rule sem_post_8b402bef8236d77706676758dce239d6 {
	meta:
...
rule if_nametoindex_327e3575bc627f59c23a5a8aa4c7cd1c {
	meta:
...
rule erf_006e2428005d35ba735819dac4edbce1 {
	meta:
...
rule opendir_415a623af64347f4e8118a79ba5d23d0 {
	meta:
...
rule cbrt_0852f0b50ca07ebd3ba8d35998b91fd1 {
	meta:
...
rule svcunix_destroy_30bbffb635bd9d53eea2bae75341825f {
	meta:
...
rule _authenticate_f8d60e14e8f9df52241f1ba184aab874 {
	meta:
...
rule pthread_attr_setschedparam_f32533726ac6096027de101afe897199 {
	meta:
...
rule tsearch_5145716861ff338f65d2ce4d78bc5bd9 {
	meta:
...
rule tfind_a73f11e8fc5f95df4ae1381eb173af40 {
	meta:
...
rule xdr_callhdr_cbc75f185c00dec600b6db858e11c436 {
	meta:
...
rule fgetspent_r_867a2d8b3238f5fbc1223b818c9f02c6 {
	meta:
...
rule pthread_getschedparam_9af399dc1a53b86a9bf5c942a145542a {
	meta:
...
rule xdr_replymsg_83e48f505b2e612940713a32aa180301 {
	meta:
...
rule xdr_authunix_parms_b06ca3abe96e1549be6587df1b0e7384 {
	meta:
...
rule xdr_callmsg_691677b85ac84da6b555b30975fdcdd7 {
	meta:
...
rule hcreate_r_4a61e5bfb0ca7694b2e7009b947bdbef {
	meta:
...
rule td_thr_getgregs_292ccf41b956dff54d8534135cf6c3f0 {
	meta:
		aliases = "td_thr_getgregs"
		type = "func"
		size = "152"
		objfiles = "td_thr_getgregs@libthread_db.a"
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 60 01 00 00 8B 9C 24 6C 01 00 00 8B BC 24 70 01 00 00 8B 53 04 8B 0B 85 D2 75 17 FF 31 E8 ?? ?? ?? ?? 57 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 EB 50 68 60 01 00 00 8D 44 24 04 50 52 FF 31 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 39 80 7C 24 2C 00 74 0B B9 11 00 00 00 F3 AB 30 D2 EB 27 8B 44 24 14 85 C0 75 0A 8B 03 FF 30 E8 ?? ?? ?? ?? 5A 57 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 0C 31 D2 85 C0 0F 95 C2 81 C4 60 01 00 00 89 D0 5B 5F C3 }
	condition:
		$pattern
}

rule td_thr_getfpregs_8893f641b8050bfdfe6bf1d27f0da315 {
	meta:
		aliases = "td_thr_getfpregs"
		type = "func"
		size = "152"
		objfiles = "td_thr_getfpregs@libthread_db.a"
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 60 01 00 00 8B 9C 24 6C 01 00 00 8B BC 24 70 01 00 00 8B 53 04 8B 0B 85 D2 75 17 FF 31 E8 ?? ?? ?? ?? 57 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 EB 50 68 60 01 00 00 8D 44 24 04 50 52 FF 31 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 39 80 7C 24 2C 00 74 0B B9 1B 00 00 00 F3 AB 30 D2 EB 27 8B 44 24 14 85 C0 75 0A 8B 03 FF 30 E8 ?? ?? ?? ?? 5A 57 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 0C 31 D2 85 C0 0F 95 C2 81 C4 60 01 00 00 89 D0 5B 5F C3 }
	condition:
		$pattern
}
...
rule pthread_kill_other_threads_np_68c8e607ecaf9ba90cb06c2e86670a33 {
	meta:
...
rule _exit_f3bcedcc7113d478cf414c07ca2227b7 {
	meta:
...
rule strcspn_2c0f793537e03b9cc2c22c5d342926f9 {
	meta:
...
rule inet_ntoa_r_22ec723e176d1e449652697417b662e5 {
	meta:
...
rule td_thr_get_info_9c33475b2c370d9440543ab753472de0 {
	meta:
		aliases = "td_thr_get_info"
		type = "func"
		size = "251"
		objfiles = "td_thr_get_info@libthread_db.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 81 EC 60 01 00 00 89 E7 8B B4 24 70 01 00 00 8B 9C 24 74 01 00 00 8B 56 04 85 D2 75 13 B9 58 00 00 00 89 D0 F3 AB C7 44 24 10 00 04 00 00 EB 1E 8B 06 FF 70 18 57 52 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 0F 85 9E 00 00 00 31 C0 B9 18 00 00 00 89 DF F3 AB 83 BC 24 20 01 00 00 01 75 15 8B 06 8B 40 0C C7 43 2C 02 00 00 00 8D 44 00 01 89 43 08 EB 23 8B 44 24 10 89 43 08 8D 44 24 74 89 43 0C 8B 44 24 18 C7 43 2C 01 00 00 00 89 43 3C 80 7C 24 2C 00 75 09 C7 43 24 04 00 00 00 EB 0E 80 7C 24 2D 01 19 C0 83 E0 04 40 89 43 24 8B 44 24 14 85 C0 75 0A 8B 06 FF 30 E8 ?? ?? ?? ?? 5A 89 }
	condition:
		$pattern
}

rule td_ta_map_id2thr_810d86b95a36a495d4e0a3a476fac110 {
	meta:
		aliases = "td_ta_map_id2thr"
		type = "func"
		size = "220"
		objfiles = "td_ta_map_id2thr@libthread_db.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 81 EC 70 01 00 00 A1 ?? ?? ?? ?? 8B 9C 24 80 01 00 00 8B BC 24 88 01 00 00 85 DB 75 08 E9 9A 00 00 00 8B 40 04 85 C0 0F 84 8F 00 00 00 39 18 75 F1 8B 84 24 84 01 00 00 31 D2 F7 73 0C 6A 10 89 D6 8D 84 24 64 01 00 00 50 89 D0 C1 E0 04 03 43 04 50 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 63 8B 94 24 68 01 00 00 85 D2 75 0F 85 F6 75 5B 89 1F C7 47 04 00 00 00 00 EB 55 68 60 01 00 00 8D 44 24 04 50 52 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 30 8B 84 24 84 01 00 00 39 44 24 10 75 2A B8 02 00 00 00 80 7C 24 2C 00 75 23 89 1F 8B 84 24 68 01 00 00 89 47 04 31 C0 EB 13 B8 08 00 00 00 EB 0C B8 01 }
	condition:
		$pattern
}
...
rule xdr_string_f4a623cfe333e4f383204f10a4526dc1 {
	meta:
...
rule lseek64_8007158c17920c35e4929b5b7ed70fdb {
	meta:
...
rule fflush_31814a3d9118de464941cc309a51f6bb {
	meta:
...
rule td_thr_event_getmsg_5ea8322051d8f062b7e4b064468fb621 {
	meta:
		aliases = "td_thr_event_getmsg"
		type = "func"
		size = "131"
		objfiles = "td_thr_event_getmsg@libthread_db.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 8B 7C 24 24 8B 46 04 85 C0 74 62 6A 10 05 28 01 00 00 8D 5C 24 04 53 50 8B 06 FF 30 E8 ?? ?? ?? ?? 83 C4 10 89 C2 B8 01 00 00 00 85 D2 75 43 8B 44 24 08 85 C0 74 36 89 07 89 77 04 8B 44 24 0C 89 47 08 89 DF 89 D0 AB AB AB AB 6A 10 53 8B 46 04 05 28 01 00 00 50 8B 06 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 95 C0 0F B6 C0 EB 05 B8 0A 00 00 00 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}

rule vfwprintf_60d5767518d3a5256845ec6668778999 {
	meta:
...
rule vfprintf_d54f62d5508d83cd711d9bd9bb4769b4 {
	meta:
...
rule getwc_f742656956ff575187512389884c869a {
	meta:
...
rule rewind_6be1b6a238be18a0005cb3c0095b8fd4 {
	meta:
...
rule putc_14eaaea6263612e6e05d80dd2179b2b4 {
	meta:
...
rule getspent_r_6bab333f82d319da6905ccef85417dd1 {
	meta:
...
rule fwrite_9a2e687202b2ee0394488c0f955a024d {
	meta:
...
rule pmap_getport_f7d747676420fbaa491f0a99d3b87783 {
	meta:
...
rule authnone_create_5dd706c39cc5b81aa5ae3e2ff6eea263 {
	meta:
...
rule erfc_d8cb45feefe114a1cf535aa17ce7329c {
	meta:
...
rule vsnprintf_30a7cf2dafbacc323b531a7c7e565f45 {
	meta:
...
rule modf_5b7677b91109828086e71825d05f8474 {
	meta:
...
rule strtok_r_f64060c5e96da715c7ae0969c70efc72 {
	meta:
...
rule fwrite_unlocked_31ebd11ab334e5a6408be9b588567d54 {
	meta:
...
rule getrpcbyname_3658af6c283afbb5106a0a2db2d4439c {
	meta:
...
rule wctype_d5dd38db712d7423b6dd21670a2bcc31 {
	meta:
...
rule memcpy_7e17e93cc22d2a5a48c31157460b23f5 {
	meta:
...
rule seed48_r_629b738ca68fd17473fcbd8fc31eebb5 {
	meta:
...
rule tcgetattr_a88b3a6f4fd050e14e751d1e5f32aa9d {
	meta:
...
rule statfs64_71a940087961497d2f01b916abc6b153 {
	meta:
...
rule wait4_02c2b346102ba7a4ed0c91c943c0668b {
	meta:
...
rule ioctl_772bdadb03466d205485db38dd9ac571 {
	meta:
...
rule fcntl64_e3e911159ea6261a77faa33752377e1b {
	meta:
...
rule pipe_ea0d78bc9535ed8c58158c688241ac41 {
	meta:
...
rule times_c7e77f149bb18b44ad7b40b84eaacc32 {
	meta:
...
rule inotify_init1_e90d0e79b34184d35bd39c324978dd15 {
	meta:
		...
		objfiles = "inotify@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 8B 7C 24 08 53 89 FB B8 4C 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5F C3 }
	condition:
		$pattern
}
...
rule read_e868081ec3e176b22088c20162f785d6 {
	meta:
...
rule msync_0cc714aafacffcf47d6056d3dfb288f8 {
	meta:
...
rule poll_48385a8bf85973d94d488a4608ee1bb1 {
	meta:
...
rule setresuid_3430221c5affadf46d94bacdefd1a949 {
	meta:
...
rule setresgid_fc3a5c92f1c678a084f57bf8565a8888 {
	meta:
...
rule chown_d28745cd73c8208e46d2274a3747f938 {
	meta:
...
rule hdestroy_c97d8f5517fef4824426922a1b3eb9e1 {
	meta:
		...
		type = "func"
		size = "12"
		objfiles = "hsearch@libc.a, _flushlbf@libc.a, mutex@libpthread.a"
	strings:
...
rule seed48_561e289bbb8d25a3dda9354419d8108d {
	meta:
...
rule wcstouq_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		aliases = "__GI_strtoul, __GI_strtoull, __GI_waitpid, __GI_wcstoul, __GI_wcstoull, __libc_waitpid, strtoul, strtoull, strtoumax, strtouq, waitpid, wcstoul, wcstoull, wcstoumax, wcstouq"
		type = "func"
		size = "23"
		objfiles = "wcstoull@libc.a, waitpid@libc.a, strtoul@libc.a, strtoull@libc.a, wcstoul@libc.a"
	strings:
...
rule iswalpha_60617713272f358c39f6fe181a7829f8 {
	meta:
		aliases = "__GI_gethostbyname, __GI_iswalpha, gethostbyname, iswalpha"
		type = "func"
		size = "14"
...
rule __uClibc_init_4f87874b18609692697b338b25375015 {
	meta:
...
rule sgetspent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		...
		type = "func"
		size = "38"
		objfiles = "fgetgrent@libc.a, getgrgid@libc.a, getpwuid@libc.a, fgetspent@libc.a, getpwnam@libc.a"
	strings:
...
rule inet_makeaddr_edbb59df5bf611c9c18be8dd3723629e {
	meta:
...
rule syslog_3674412569e427ab0f649983548971e5 {
	meta:
		aliases = "__GI_asprintf, __GI_fprintf, __GI_fscanf, __GI_fwprintf, __GI_sscanf, __GI_syslog, asprintf, dprintf, fprintf, fscanf, fwprintf, fwscanf, sscanf, swscanf, syslog"
		type = "func"
		size = "28"
		objfiles = "sscanf@libc.a, fwprintf@libc.a, fscanf@libc.a, asprintf@libc.a, fprintf@libc.a"
	strings:
...
rule scalb_b1852281c611bd2df1c857b156602767 {
	meta:
...
rule getprotobynumber_83b0b6ab744928ce61f3d8f5e9f87a1f {
	meta:
...
rule getservbyport_5b0e5662a54c4d8934751769ff0efbd8 {
	meta:
...
rule getdtablesize_d92a53a061e827509ce03df7a5afa39c {
	meta:
...
rule __isnan_4d82444e2516c5c60a268cbd4b93f571 {
	meta:
...
rule __finite_46e437467d852192c35406e9fec235f8 {
	meta:
...
rule __signbit_e99a583f9bf7ce82a98f071f48f63542 {
	meta:
...
rule truncf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "fabsf@libm.a, expm1f@libm.a, erfcf@libm.a, asinf@libm.a, erff@libm.a"
	strings:
...
rule setservent_4df162fa78943270536f2e1af5743cf4 {
	meta:
...
rule sigsetmask_82bc1b8dcefe4a797b44c01420666dc6 {
	meta:
...
rule copysign_516edf153e5d108277906bff2649e48c {
	meta:
...
rule fabs_e973fe813e6562ab495c03a2546aed3b {
	meta:
...
rule scalbf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "hypotf@libm.a, remainderf@libm.a, copysignf@libm.a, atan2f@libm.a, fmodf@libm.a"
	strings:
...
rule acosh_1ae327650ab2127e9721f40276c3f9f6 {
	meta:
...
rule ctime_26271929dd4b9bd4e485401bec9e6513 {
	meta:
...
rule exp_e2a9a51437eb147b2e75e299f2dba266 {
	meta:
...
rule expm1_b154b222fb4d25eb37b5cc19b6f718d5 {
	meta:
...
rule perror_48e7c191b66db34a8b687bb7fb667927 {
	meta:
...
rule td_ta_delete_b34bc0c586f97056a9c6a645cde4a821 {
	meta:
		aliases = "td_ta_delete"
		type = "func"
		size = "67"
		objfiles = "td_ta_delete@libthread_db.a"
	strings:
		$pattern = { ( CC | 8B ) 4C 24 04 85 C9 74 35 8B 15 ?? ?? ?? ?? 85 D2 74 2B 3B 0A 75 0C 8B 42 04 A3 ?? ?? ?? ?? EB 13 89 C2 8B 42 04 85 C0 74 14 39 08 75 F3 8B 40 04 89 42 04 51 E8 ?? ?? ?? ?? 31 C0 5A C3 B8 08 00 00 00 C3 }
	condition:
		$pattern
}
...
rule td_ta_reset_stats_f16174bde39fec0230028e098044db3b {
	meta:
		aliases = "td_ta_enable_stats, td_ta_get_stats, td_ta_reset_stats"
		type = "func"
		size = "35"
		objfiles = "td_ta_enable_stats@libthread_db.a, td_ta_reset_stats@libthread_db.a, td_ta_get_stats@libthread_db.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 A1 ?? ?? ?? ?? 85 D2 75 05 EB 0E 8B 40 04 85 C0 74 07 39 10 75 F5 31 C0 C3 B8 08 00 00 00 C3 }
	condition:
		$pattern
}

rule td_ta_setconcurrency_7b85c4e9296c8dd584189329f15ab5a8 {
	meta:
		aliases = "td_ta_setconcurrency"
		type = "func"
		size = "38"
		objfiles = "td_ta_setconcurrency@libthread_db.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 A1 ?? ?? ?? ?? 85 D2 75 05 EB 11 8B 40 04 85 C0 74 0A 39 10 75 F5 B8 0E 00 00 00 C3 B8 08 00 00 00 C3 }
	condition:
		$pattern
}

rule td_ta_get_ph_e5499ab54fb791e4aad2f286959e5eb9 {
	meta:
		aliases = "td_ta_get_ph"
		type = "func"
		size = "43"
		objfiles = "td_ta_get_ph@libthread_db.a"
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 A1 ?? ?? ?? ?? 85 D2 75 05 EB 16 8B 40 04 85 C0 74 0F 39 10 75 F5 8B 44 24 08 8B 12 89 10 31 C0 C3 B8 08 00 00 00 C3 }
	condition:
		$pattern
}
...
rule brk_405f291a269aeb9cf06be9b60d476d2a {
	meta:
...
rule cfsetospeed_0b9865f50b459123a1b44c3a26d6dbfa {
	meta:
...
rule sem_init_acdb51d324237cc4b6210e03969a57f7 {
	meta:
...
rule setttyent_d499f86c6d12eca26ba438f2a42c4e56 {
	meta:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "__GI__stdlib_mb_cur_max, __GI_xdr_void, _stdlib_mb_cur_max, authnone_validate, floatformat_always_valid, old_sem_extricate_func, td_thr_tls_get_addr, xdr_void"
		type = "func"
		size = "6"
		objfiles = "_stdlib_mb_cur_max@libc.a, auth_none@libc.a, floatformat@libiberty.a, td_thr_tls_get_addr@libthread_db.a, xdr@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_unix@libc.a, svc_tcp@libc.a, svc_authux@libc.a, svc_udp@libc.a, svc_raw@libc.a"
	strings:
...
rule td_thr_dbsuspend_08be1c88184ee32705029d47d1b14826 {
	meta:
		aliases = "td_thr_dbresume, td_thr_dbsuspend"
		type = "func"
		size = "6"
		objfiles = "td_thr_dbresume@libthread_db.a, td_thr_dbsuspend@libthread_db.a"
	strings:
		$pattern = { ( CC | B8 ) 0E 00 00 00 C3 }
	condition:
		$pattern
}

rule td_thr_setxregs_4163547a7751f2ea8b1988a1b157df4e {
	meta:
		aliases = "td_thr_getxregs, td_thr_getxregsize, td_thr_setxregs"
		type = "func"
		size = "6"
		objfiles = "td_thr_getxregs@libthread_db.a, td_thr_setxregs@libthread_db.a, td_thr_getxregsize@libthread_db.a"
	strings:
		$pattern = { ( CC | B8 ) 14 00 00 00 C3 }
	condition:
		$pattern
}
...
rule td_symbol_list_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		aliases = "__GI___errno_location, __GI___h_errno_location, __errno_location, __h_errno_location, __libc_pthread_init, __res_state, td_symbol_list"
		type = "func"
		size = "6"
		objfiles = "_res_state@libc.a, libc_pthread_init@libc.a, __errno_location@libc.a, td_symbol_list@libthread_db.a, __h_errno_location@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C3 }
	condition:
		$pattern
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "mntent@libc.a, partition@libiberty.a, ptfork@libpthread.a, rand@libc.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule fdim_64c9defb23930e7add12048ca4a272d4 {
	meta:
...
rule fmax_b9c81aaddf890973b1976483fdd13880 {
	meta:
...
rule ldexp_dec599ff2c252ef55f4caa38b8f3290c {
	meta:
...
rule td_lookup_7b9e490f09260ba603ad15977b6eeaa0 {
	meta:
		aliases = "td_lookup"
		type = "func"
		size = "33"
		objfiles = "td_symbol_list@libthread_db.a"
	strings:
		$pattern = { ( CC | FF ) 74 24 0C 8B 44 24 0C FF 34 85 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 10 E8 ?? ?? ?? ?? 83 C4 10 C3 }
	condition:
		$pattern
}
