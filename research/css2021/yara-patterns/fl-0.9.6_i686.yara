...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "__uClibc_main@libc.a, clnt_raw@libc.a, svc_auth@libc.a, wcsftime@libc.a, auth_none@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule thread_self_c490e55fdc4e0d42e26befc1658d19a1 {
	meta:
		...
		type = "func"
		size = "63"
		objfiles = "pthread@libpthread.a, semaphore@libpthread.a, condvar@libpthread.a, errno@libpthread.a, specific@libpthread.a"
	strings:
...
rule logb_7c045b1d354dc0a669994af13c636bd5 {
	meta:
...
rule settimeofday_54c3ca7e80ebe751dc1b21d4290a24ec {
	meta:
...
rule statfs_fe4c4ed6da0f7c02e800f2646b568a0e {
	meta:
...
rule nanosleep_5abb4c31fc964b91fb91c97a7bf7befd {
	meta:
...
rule sin_01aca0f84931ae0daf3641226444cb4a {
	meta:
...
rule getttyent_c60cbd56b1772bd5e3b1b7f4cafdba75 {
	meta:
...
rule vfwscanf_909a12c69335e118e85a550ff5919945 {
	meta:
...
rule fnmatch_ea218c8bf17a623b9636f6b3bff6408b {
	meta:
...
rule bindresvport_b4094c1c9b690edc3eb3e28b9cb11d8d {
	meta:
...
rule llround_de681c0dc372a766f272385ba25de157 {
	meta:
...
rule memcmp_87abf526abfce9da2f3b3ab658c5f682 {
	meta:
...
rule rtime_4eb19d2563c38dc1064a45094cf693ed {
	meta:
...
rule llrint_e01c2d67142a35374a1b35421582ae5a {
	meta:
...
rule clnttcp_create_f7b2f98c153cb56b1b87a87f6f8eaf5c {
	meta:
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_gcov_merge_delta@libgcov.a, _clear_cache@libgcc.a, _gcov_merge_add@libgcov.a, _gcov_merge_single@libgcov.a, gthr_gnat@libgcc.a"
	strings:
...
rule mbsnrtowcs_c5b7eb42f0833dde1fa46f155b71ac1a {
	meta:
...
rule wcswidth_c4657af78a7d397d4f2d2ba28ae2d5ba {
	meta:
...
rule sigaction_1fcdb0492ecb4a35c05c89da6e6e7dd2 {
	meta:
...
rule pselect_c51078ca6537ce5f34a396514455df4c {
	meta:
...
rule ilogb_fe9524a94c8a5ffa39485f8c492ab532 {
	meta:
...
rule xdr_hyper_01d81d4c56a69f5a7fa24b5dd70e60bc {
	meta:
...
rule putc_unlocked_8f40897f050da839500afb25c4130c6b {
	meta:
...
rule remquo_88071cae1674d12838147c12a19dba0e {
	meta:
...
rule erfc_7510fae911946bc8e37f580f0fd938c4 {
	meta:
...
rule open_ba06cb787400df0dffd6649ff5a6d12f {
	meta:
...
rule tsearch_0b9aa8cdd5449f71249ccba53d049c6c {
	meta:
...
rule strspn_3173a829901f55cff5d057063746b490 {
	meta:
...
rule putc_5cbbfd0580f428cba5f80ac4f86f73d5 {
	meta:
...
rule select_a221afd30ee0d1b36e6ec3f9ba426c3c {
	meta:
...
rule vmsplice_5bf5d3dfe3378c913e47b9df6ae4401a {
	meta:
...
rule read_a624654b7c7f02ef299a8e0337f04994 {
	meta:
...
rule lseek_f0210736af9ab2dbe6a658a87075a134 {
	meta:
...
rule wcstouq_94d3925005c9f6c3778188d300b054a5 {
	meta:
		...
		type = "func"
		size = "26"
		objfiles = "strtoull@libc.a, wcstoull@libc.a, strtoul@libc.a, wcstoul@libc.a, waitpid@libc.a"
	strings:
...
rule strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		...
		type = "func"
		size = "25"
		objfiles = "w_lgamma@libm.a, e_gamma@libm.a, e_lgamma@libm.a, w_gamma@libm.a, strtok@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "manager@libpthread.a, pthread@libpthread.a, semaphore@libpthread.a, condvar@libpthread.a, join@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "swscanf@libc.a, dprintf@libc.a, sscanf@libc.a, fwscanf@libc.a, fwprintf@libc.a"
	strings:
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		type = "func"
		size = "19"
		objfiles = "lroundf@libm.a, ilogbf@libm.a, llroundf@libm.a, llrintf@libm.a, lrintf@libm.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "asinf@libm.a, tgammaf@libm.a, acosf@libm.a, log1pf@libm.a, cbrtf@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "copysignf@libm.a, powf@libm.a, atan2f@libm.a, remainderf@libm.a, nextafterf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "getgrgid@libc.a, sgetspent@libc.a, fgetgrent@libc.a, getspnam@libc.a, getpwuid@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		type = "func"
		size = "4"
		objfiles = "_fixunsxfsi@libgcc.a, unwind_dw2_fde_glibc@libgcc.a, _fixunssfsi@libgcc.a, _fixunsxfdi@libgcc.a, gthr_gnat@libgcc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		type = "func"
		size = "4"
		objfiles = "_powixf2@libgcc.a, _absvsi2@libgcc.a, crtendS, _divdc3@libgcc.a, gthr_gnat@libgcc.a"
	strings:
...
rule wcschrnul_19c6d19b76da9d919789b1e1b5734ae6 {
	meta:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "xdr@libc.a, _stdlib_mb_cur_max@libc.a, oldsemaphore@libpthread.a, floatformat@libiberty.a, auth_none@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_tcp@libc.a, svc_unix@libc.a, svc_authux@libc.a, svc_udp@libc.a, svc_raw@libc.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "__uClibc_main@libc.a, clnt_udp@libc.a, events@libpthread.a, auth_unix@libc.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "xdr@libc.a, w_asin@libm.a, pthread@libpthread.a, rand@libc.a, w_lgamma_r@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
