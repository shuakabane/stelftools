...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "td_init@libthread_db.a, grantpt@libc.a, __uClibc_main@libc.a, mutex@libpthread.a, rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		type = "func"
		size = "8"
		objfiles = "rwlock@libpthread.a, semaphore@libpthread.a, manager@libpthread.a, condvar@libpthread.a, join@libpthread.a"
	strings:
...
rule td_thr_event_enable_6bc860a585bf8c290745a84fb27156b3 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 5C 24 0C 8B 53 04 85 D2 8B 0B 75 29 89 E0 50 6A 0B FF 31 E8 ?? ?? ?? ?? 83 C4 0C BA 01 00 00 00 85 C0 75 30 6A 04 8D 44 24 14 50 FF 74 24 08 8B 03 FF 30 EB 10 6A 04 8D 44 24 14 50 8D 82 24 01 00 00 50 FF 31 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 95 C2 89 D0 5A 5B C3 }
	condition:
		$pattern
}

rule td_ta_get_nthreads_199ea59897bee8b93b6e063f18aa6f18 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 04 8B 5C 24 0C A1 ?? ?? ?? ?? 85 DB 75 05 EB 40 8B 40 04 85 C0 74 39 39 18 75 F5 89 E0 50 6A 02 FF 33 E8 ?? ?? ?? ?? 83 C4 0C BA 01 00 00 00 85 C0 75 22 6A 04 FF 74 24 14 FF 74 24 08 FF 33 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 95 C2 EB 05 BA 08 00 00 00 89 D0 5A 5B C3 }
	condition:
		$pattern
}
...
rule handle_descr_4c85bdd337bc851b2a28947e2cc2758d {
	meta:
...
rule td_thr_validate_dd2d83ff4a5019c47335dfdc01dc1f2e {
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 70 01 00 00 8B B4 24 84 01 00 00 8B 16 8B 5A 04 8B 6A 0C 83 7E 04 00 74 04 31 FF EB 79 6A 10 8D 84 24 64 01 00 00 50 53 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 64 83 BC 24 68 01 00 00 01 EB 49 6A 10 8D 84 24 64 01 00 00 50 53 8B 06 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 3F 8B 8C 24 68 01 00 00 85 C9 74 2C 3B 4E 04 75 27 8B 06 FF 70 18 8D 54 24 04 52 51 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 16 80 7C 24 2C 01 19 C0 F7 D0 83 E0 02 EB 0D 47 83 C3 10 39 EF 7C A6 B8 01 00 00 00 81 C4 70 01 00 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule td_thr_tsd_3eae8da0d8bb42932e0fe2ca81e7d887 {
	meta:
		aliases = "td_thr_tsd"
		type = "func"
		size = "239"
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 70 01 00 00 8B BC 24 84 01 00 00 8B 9C 24 88 01 00 00 8B 17 8B 42 08 89 04 24 8B 72 10 8B 6A 14 8B 4F 04 85 C9 0F 84 A7 00 00 00 68 60 01 00 00 8D 44 24 08 50 51 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 91 00 00 00 39 F3 0F 83 82 00 00 00 6A 08 8D 84 24 68 01 00 00 50 8B 54 24 08 8D 04 DA 50 8B 07 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 67 83 BC 24 64 01 00 00 00 74 56 89 D8 31 D2 F7 F5 89 D1 8B 54 84 78 B8 11 00 00 00 85 D2 74 4D 6A 04 8D 84 24 70 01 00 00 50 8D 04 8A 50 8B 07 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 2A 8B 94 24 6C 01 00 00 85 D2 74 09 8B 84 24 8C 01 00 00 89 }
	condition:
		$pattern
}
...
rule pow_211572ad36c9bb18e72d21d2bca46c61 {
	meta:
...
rule inet_pton4_97df22246a40975640b72e5919b2d6cf {
	meta:
		aliases = "inet_pton4"
		type = "func"
		size = "119"
...
rule getprotoent_r_7cec24832cb8a92046e95af2bee6fced {
	meta:
...
rule td_ta_new_6d8f711baa0db7981653eb1403899332 {
	meta:
		aliases = "td_ta_new"
		type = "func"
		size = "523"
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 10 8B 74 24 24 8B 5C 24 28 8D 6C 24 0C 55 6A 00 56 E8 ?? ?? ?? ?? 83 C4 0C B9 0C 00 00 00 85 C0 0F 85 D5 01 00 00 8D 44 24 08 50 6A 0C 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 0F 85 B8 01 00 00 6A 07 8D 7C 24 05 57 FF 74 24 10 56 E8 ?? ?? ?? ?? 83 C4 10 B9 01 00 00 00 85 C0 0F 85 9C 01 00 00 C6 44 24 07 00 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 5A 59 85 C0 0F 85 7D 01 00 00 6A 28 E8 ?? ?? ?? ?? 89 C2 89 03 5F B9 12 00 00 00 85 C0 0F 84 69 01 00 00 89 30 8B 44 24 0C 89 42 1C 8B 03 83 C0 20 50 6A 01 56 E8 ?? ?? ?? ?? 83 C4 0C 85 C0 74 11 FF 33 E8 ?? ?? ?? ?? B9 01 00 00 00 E9 1C 01 00 00 8B }
	condition:
		$pattern
}
...
rule readdir_r_327ce9f361062c1cb60313159f86acd4 {
	meta:
...
rule ungetwc_a6662f968dca82b84ffd574c3410bfb0 {
	meta:
...
rule fflush_unlocked_f4729ddad3b99376cce0da6fe21e2646 {
	meta:
...
rule getservent_r_7d86d3f40fe6b3d340dc350d970a04a5 {
	meta:
...
rule fseeko64_03a38c041985e1238da78fa848dbf850 {
	meta:
...
rule hsearch_r_108ac4ca44692572913c62f2c107be70 {
	meta:
...
rule gethostbyaddr_r_97a077f5eb793c656112222695364749 {
	meta:
...
rule strptime_b6f524552e0469fbe871e3b07d6fc4cd {
	meta:
...
rule ether_aton_r_deb35b8732eca94dfb71c23bd06567cb {
	meta:
...
rule td_ta_map_lwp2thr_77fb6eda856a899915216a58df4baf3a {
	meta:
...
rule td_ta_thr_iter_a3fc958547cc8a78c709c327d074dfa5 {
	meta:
		...
		objfiles = "td_ta_thr_iter@libthread_db.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 04 A1 ?? ?? ?? ?? 83 7D 08 00 75 08 E9 E4 00 00 00 8B 40 04 85 C0 0F 84 D9 00 00 00 8B 55 08 39 10 75 EE 8B 42 0C 89 45 F0 89 C7 C1 E7 04 8D 47 10 29 C4 8D 74 24 0F 83 E6 F0 6A 20 56 FF 72 04 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 AA 00 00 00 FF 76 08 6A 00 FF 75 18 FF 75 14 8B 4D 10 8B 55 0C 8B 45 08 E8 ?? ?? ?? ?? 83 C4 10 89 C3 85 C0 0F 85 89 00 00 00 FF 76 18 6A 01 FF 75 18 FF 75 14 8B 4D 10 8B 55 0C 8B 45 08 E8 ?? ?? ?? ?? 89 C3 83 C4 10 85 C0 75 67 8D 47 E0 50 8D 46 20 50 8B 55 08 8B 42 04 83 C0 20 50 FF 32 E8 ?? ?? ?? ?? 83 C4 10 BF 02 00 00 00 85 C0 74 2F EB }
	condition:
		$pattern
}
...
rule td_ta_event_getmsg_7311180cad603d1d5b99ed06844ce010 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 24 8B 5D 08 A1 ?? ?? ?? ?? 85 DB 75 08 E9 73 01 00 00 8B 40 04 85 C0 0F 84 68 01 00 00 39 18 75 F1 6A 04 8D 45 F0 50 FF 73 20 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 50 01 00 00 8B 45 F0 BE 0A 00 00 00 85 C0 0F 84 45 01 00 00 6A 10 8D 55 DC 52 05 28 01 00 00 50 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 22 01 00 00 83 7D E4 00 0F 85 C3 00 00 00 89 65 D4 8B 43 0C C1 E0 04 83 C0 10 29 C4 8D 7C 24 0F 83 E7 F0 6A 04 8D 45 EC 50 FF 73 24 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 86 00 00 00 8B 43 0C C1 E0 04 50 57 FF 73 04 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 6D 31 F6 EB }
	condition:
		$pattern
}
...
rule td_ta_tsd_iter_ad400ed3ca7f673ce5c28f9c42e3a8d7 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 8B 4D 08 A1 ?? ?? ?? ?? 85 C9 75 05 EB 66 8B 40 04 85 C0 74 5F 39 08 75 F5 8B 79 10 8D 04 FD 00 00 00 00 8D 50 10 29 D4 8D 5C 24 0F 83 E3 F0 50 53 FF 71 08 FF 31 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 31 F6 85 C0 74 23 EB 2E 8D 04 F3 83 38 00 74 18 FF 75 10 FF 70 04 56 FF 55 0C 83 C4 0C 85 C0 74 07 BA 0F 00 00 00 EB 0E 46 39 FE 7C DB 31 D2 EB 05 BA 08 00 00 00 89 D0 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "gthr_gnat@libgcc_eh.a, _gcov_merge_add@libgcov.a, _clear_cache@libgcc.a, _enable_execute_stack@libgcc.a, _gcov_merge_delta@libgcov.a"
	strings:
...
rule thread_self_dd5dae98b7dbe953d0d7e291f00b93db {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "cancel@libpthread.a, mutex@libpthread.a, signals@libpthread.a, semaphore@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule td_thr_setgregs_3e7d8b249441653558e2bdafcd111672 {
	meta:
	...
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 60 01 00 00 8B 9C 24 6C 01 00 00 89 E6 68 60 01 00 00 6A 00 56 E8 ?? ?? ?? ?? 8B 43 04 83 C4 0C 85 C0 74 1C 68 60 01 00 00 56 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 36 31 D2 80 7C 24 2C 00 75 2D 8B 44 24 14 85 C0 75 0A 8B 03 FF 30 E8 ?? ?? ?? ?? 5A FF B4 24 70 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 0C 31 D2 85 C0 0F 95 C2 89 D0 81 C4 60 01 00 00 5B 5E C3 }
	condition:
		$pattern
}
...
rule td_ta_event_addr_2352a1144fcac0343cb50a76ea00520e {
	meta:
...
rule td_thr_clear_event_b51e519c34adbf27051454a7714ce442 {
	meta:
	...
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 5C 24 14 8B 74 24 18 8B 4B 04 31 D2 85 C9 74 56 6A 08 8D 44 24 04 50 8D 81 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 33 30 D2 8B 04 96 F7 D0 21 04 94 42 83 FA 01 74 F2 6A 08 8D 44 24 04 50 8B 43 04 05 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 95 C2 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule td_thr_set_event_48df5036067baca3aa2b0e4d6622151e {
	meta:
	...
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 5C 24 14 8B 74 24 18 8B 4B 04 BA 15 00 00 00 85 C9 74 54 6A 08 8D 44 24 04 50 8D 81 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 31 30 D2 8B 04 96 09 04 94 42 83 FA 01 74 F4 6A 08 8D 44 24 04 50 8B 43 04 05 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 95 C2 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule td_ta_set_event_44e2bab6913305b4b68e06655be98391 {
	meta:
	...
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 5C 24 14 8B 74 24 18 A1 ?? ?? ?? ?? 85 DB 75 05 EB 53 8B 40 04 85 C0 74 4C 39 18 75 F5 6A 08 8D 44 24 04 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 30 30 D2 8B 04 96 09 04 94 42 83 FA 01 74 F4 6A 08 8D 44 24 04 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 95 C2 EB 05 BA 08 00 00 00 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}

rule td_ta_clear_event_0fc9e63371f93912a37ed8c3b8595f8a {
	meta:
	...
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 08 8B 5C 24 14 8B 74 24 18 A1 ?? ?? ?? ?? 85 DB 75 05 EB 55 8B 40 04 85 C0 74 4E 39 18 75 F5 6A 08 8D 44 24 04 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 32 30 D2 8B 04 96 F7 D0 21 04 94 42 83 FA 01 74 F2 6A 08 8D 44 24 04 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 95 C2 EB 05 BA 08 00 00 00 89 D0 5A 59 5B 5E C3 }
	condition:
		$pattern
}
...
rule getnetent_3291f869854fbd9357955f772834a586 {
	meta:
...
rule td_thr_getgregs_e1818c3447ba68b9119f4433c6c66eab {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 60 01 00 00 8B 9C 24 6C 01 00 00 8B BC 24 70 01 00 00 8B 53 04 85 D2 8B 0B 75 17 FF 31 E8 ?? ?? ?? ?? 57 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 EB 50 68 60 01 00 00 8D 44 24 04 50 52 FF 31 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 39 80 7C 24 2C 00 74 0B B9 11 00 00 00 F3 AB 30 D2 EB 27 8B 44 24 14 85 C0 75 0A 8B 03 FF 30 E8 ?? ?? ?? ?? 5A 57 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 0C 31 D2 85 C0 0F 95 C2 89 D0 81 C4 60 01 00 00 5B 5F C3 }
	condition:
		$pattern
}

rule td_thr_getfpregs_9ea05a4c0169b88380d61c3bdfa78366 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 60 01 00 00 8B 9C 24 6C 01 00 00 8B BC 24 70 01 00 00 8B 53 04 85 D2 8B 0B 75 17 FF 31 E8 ?? ?? ?? ?? 57 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 EB 50 68 60 01 00 00 8D 44 24 04 50 52 FF 31 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 39 80 7C 24 2C 00 74 0B B9 1B 00 00 00 F3 AB 30 D2 EB 27 8B 44 24 14 85 C0 75 0A 8B 03 FF 30 E8 ?? ?? ?? ?? 5A 57 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 0C 31 D2 85 C0 0F 95 C2 89 D0 81 C4 60 01 00 00 5B 5F C3 }
	condition:
		$pattern
}
...
rule open_c7ea7255401774be8b6f1b668400b2fd {
	meta:
...
rule abort_139c6b4607c8bc8b054bc8446ec706b5 {
	meta:
...
rule td_thr_get_info_f3c58547b67a193a172e0d037b962476 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 81 EC 60 01 00 00 8B B4 24 70 01 00 00 8B 9C 24 74 01 00 00 8B 56 04 85 D2 89 E7 75 13 B9 58 00 00 00 89 D0 F3 AB C7 44 24 10 00 04 00 00 EB 1E 8B 06 FF 70 18 57 52 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 0F 85 9E 00 00 00 31 C0 B9 18 00 00 00 89 DF F3 AB 83 BC 24 20 01 00 00 01 75 15 8B 06 8B 40 0C 8D 44 00 01 89 43 08 C7 43 2C 02 00 00 00 EB 23 8B 44 24 10 89 43 08 8D 44 24 74 89 43 0C 8B 44 24 18 89 43 3C C7 43 2C 01 00 00 00 80 7C 24 2C 00 75 09 C7 43 24 04 00 00 00 EB 0E 80 7C 24 2D 01 19 C0 83 E0 04 40 89 43 24 8B 44 24 14 85 C0 75 0A 8B 06 FF 30 E8 ?? ?? ?? ?? 5A 89 }
	condition:
		$pattern
}

rule td_ta_map_id2thr_f3329c5f203328207aebad58c0ec2475 {
	meta:
...
rule td_thr_event_getmsg_0ef1aa6c7cfaab23a57e2605551f1f19 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 74 24 20 8B 7C 24 24 8B 46 04 85 C0 74 62 6A 10 8D 5C 24 04 53 05 28 01 00 00 50 8B 06 FF 30 E8 ?? ?? ?? ?? 89 C2 83 C4 10 B8 01 00 00 00 85 D2 75 43 8B 44 24 08 85 C0 74 36 89 07 89 77 04 8B 44 24 0C 89 47 08 89 DF 89 D0 AB AB AB AB 6A 10 53 8B 46 04 05 28 01 00 00 50 8B 06 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 95 C0 0F B6 C0 EB 05 B8 0A 00 00 00 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule getwc_114aa4157b4b9566192d34ac8548075b {
	meta:
...
rule putwc_7d61cd477258541349acca99333ccc23 {
	meta:
...
rule fwrite_e64e0c6a030ccd39c5f6aff237204ea1 {
	meta:
...
rule rint_fdb847fb272d9befe638b0a435d08156 {
	meta:
...
rule mknod_4d7d5c3414773db5eaaf7327ce1ea1ce {
	meta:
...
rule sigprocmask_bf39f38edb163f87b6f052348f763d3a {
	meta:
...
rule ioctl_c359df500a651d7c323acc5e7b6cc2d0 {
	meta:
...
rule inet_ntoa_e214931d143cca1a32199edb31adc4a0 {
	meta:
		...
		type = "func"
		size = "17"
		objfiles = "asctime@libc.a, ether_addr@libc.a, hsearch@libc.a, inet_ntoa@libc.a"
	strings:
...
rule wcstouq_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		...
		type = "func"
		size = "23"
		objfiles = "strtoull@libc.a, wcstoul@libc.a, wcstoull@libc.a, strtoul@libc.a, waitpid@libc.a"
	strings:
...
rule sgetspent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		...
		type = "func"
		size = "38"
		objfiles = "getgrnam@libc.a, fgetpwent@libc.a, fgetspent@libc.a, sgetspent@libc.a, getgrgid@libc.a"
	strings:
...
rule truncf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "sqrtf@libm.a, expf@libm.a, asinf@libm.a, roundf@libm.a, logbf@libm.a"
	strings:
...
rule scalbf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "powf@libm.a, remainderf@libm.a, copysignf@libm.a, hypotf@libm.a, scalbf@libm.a"
	strings:
...
rule td_ta_reset_stats_f16174bde39fec0230028e098044db3b {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "td_ta_reset_stats@libthread_db.a, td_ta_enable_stats@libthread_db.a, td_ta_get_stats@libthread_db.a"
	strings:
...
rule td_ta_get_ph_d9dfc05c442e4e20a1c0dda09e7c56d2 {
	meta:
	...
	strings:
		$pattern = { ( CC | 8B ) 54 24 04 A1 ?? ?? ?? ?? 85 D2 75 05 EB 16 8B 40 04 85 C0 74 0F 39 10 75 F5 8B 12 8B 44 24 08 89 10 31 C0 C3 B8 08 00 00 00 C3 }
	condition:
		$pattern
}
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "floatformat@libiberty.a, xdr@libc.a, auth_none@libc.a, _stdlib_mb_cur_max@libc.a, td_thr_tls_get_addr@libthread_db.a"
	strings:
...
rule td_symbol_list_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "libc_pthread_init@libc.a, td_symbol_list@libthread_db.a, __h_errno_location@libc.a, __errno_location@libc.a, _res_state@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C3 }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "auth_unix@libc.a, __uClibc_main@libc.a, xdr_mem@libc.a, signals@libpthread.a, noophooks@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_cabs@libm.a, mntent@libc.a, xdr@libc.a, rand@libc.a, mq_close@librt.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
