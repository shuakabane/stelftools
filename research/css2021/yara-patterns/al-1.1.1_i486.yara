...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "condvar@libpthread.a, rwlock@libpthread.a, grantpt@libc.a, xdr_stdio@libc.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		type = "func"
		size = "8"
		objfiles = "condvar@libpthread.a, rwlock@libpthread.a, join@libpthread.a, manager@libpthread.a, pthread@libpthread.a"
	strings:
...
rule getnetent_r_93d96bfa4ee101b0d8ba35070d85d722 {
	meta:
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_gcov@libgcov.a, _gcov_merge_add@libgcov.a, gthr_gnat@libgcc_eh.a, _gcov_merge_delta@libgcov.a, _gcov_merge_single@libgcov.a"
	strings:
...
rule thread_self_dd5dae98b7dbe953d0d7e291f00b93db {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "condvar@libpthread.a, rwlock@libpthread.a, signals@libpthread.a, join@libpthread.a, specific@libpthread.a"
	strings:
...
rule sgetspent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		...
		type = "func"
		size = "38"
		objfiles = "sgetspent@libc.a, fgetspent@libc.a, getgrnam@libc.a, getpwuid@libc.a, getpwnam@libc.a"
	strings:
...
rule syslog_3674412569e427ab0f649983548971e5 {
	meta:
		...
		type = "func"
		size = "28"
		objfiles = "dprintf@libc.a, sscanf@libc.a, fwscanf@libc.a, fwprintf@libc.a, asprintf@libc.a"
	strings:
...
rule truncf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "atanhf@libm.a, truncf@libm.a, tanf@libm.a, roundf@libm.a, acoshf@libm.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_raw@libc.a, svc_authux@libc.a, svc_udp@libc.a, svc_tcp@libc.a, svc_unix@libc.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "signals@libpthread.a, clnt_raw@libc.a, clnt_tcp@libc.a, lckpwdf@libc.a, svc_raw@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_cabs@libm.a, partition@libiberty.a, mq_close@librt.a, pthread@libpthread.a, splay_tree@libiberty.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
