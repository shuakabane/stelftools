...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "attr@libpthread.a, svc_auth@libc.a, auth_none@libc.a, rwlock@libpthread.a, condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		type = "func"
		size = "8"
		objfiles = "rwlock@libpthread.a, condvar@libpthread.a, spinlock@libpthread.a, join@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_gcov@libgcov.a, _enable_execute_stack@libgcc.a, gthr_gnat@libgcc_eh.a, _gcov_merge_single@libgcov.a, _clear_cache@libgcc.a"
	strings:
...
rule thread_self_dd5dae98b7dbe953d0d7e291f00b93db {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "rwlock@libpthread.a, signals@libpthread.a, condvar@libpthread.a, specific@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule inet_ntoa_e214931d143cca1a32199edb31adc4a0 {
	meta:
		...
		type = "func"
		size = "17"
		objfiles = "inet_ntoa@libc.a, asctime@libc.a, ether_addr@libc.a, hsearch@libc.a"
	strings:
...
rule sgetspent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		...
		type = "func"
		size = "38"
		objfiles = "fgetspent@libc.a, getpwnam@libc.a, getpwuid@libc.a, getgrnam@libc.a, fgetgrent@libc.a"
	strings:
...
rule syslog_3674412569e427ab0f649983548971e5 {
	meta:
		...
		type = "func"
		size = "28"
		objfiles = "sscanf@libc.a, fwprintf@libc.a, fwscanf@libc.a, fscanf@libc.a, fprintf@libc.a"
	strings:
...
rule truncf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "log1pf@libm.a, expm1f@libm.a, cosf@libm.a, fabsf@libm.a, floorf@libm.a"
	strings:
...
rule scalbf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "remainderf@libm.a, copysignf@libm.a, atan2f@libm.a, scalbf@libm.a, fmodf@libm.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_udp@libc.a, svc_unix@libc.a, svc_raw@libc.a, svc_tcp@libc.a, svc_authux@libc.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "clnt_tcp@libc.a, events@libpthread.a, auth_none@libc.a, clnt_unix@libc.a, signals@libpthread.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "mntent@libc.a, mq_close@librt.a, ptfork@libpthread.a, partition@libiberty.a, rand@libc.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
