...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "condvar@libpthread.a, __uClibc_main@libc.a, clnt_raw@libc.a, attr@libpthread.a, svc_auth@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule thread_self_c490e55fdc4e0d42e26befc1658d19a1 {
	meta:
		...
		type = "func"
		size = "63"
		objfiles = "condvar@libpthread.a, signals@libpthread.a, semaphore@libpthread.a, cancel@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule pex_unix_cleanup_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_gcov_merge_single@libgcov.a, _gcov@libgcov.a, _gcov_merge_delta@libgcov.a, pex_unix@libiberty.a, _gcov_merge_add@libgcov.a"
	strings:
...
rule splay_tree_xmalloc_deallocate_1f11c58b08f2de469ecd0e8fde9b9319 {
	meta:
		aliases = "partition_delete, splay_tree_xmalloc_allocate, splay_tree_xmalloc_deallocate"
		type = "func"
		size = "9"
...
rule srand48_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		...
		type = "func"
		size = "21"
		objfiles = "inet_ntoa@libc.a, srand48@libc.a, hsearch@libc.a, asctime@libc.a, ether_addr@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "condvar@libpthread.a, semaphore@libpthread.a, spinlock@libpthread.a, join@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "fscanf@libc.a, sscanf@libc.a, fwprintf@libc.a, fwscanf@libc.a, asprintf@libc.a"
	strings:
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		type = "func"
		size = "19"
		objfiles = "ilogbf@libm.a, llroundf@libm.a, lroundf@libm.a, llrintf@libm.a, lrintf@libm.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "erfcf@libm.a, logf@libm.a, tanhf@libm.a, sinhf@libm.a, rintf@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "copysignf@libm.a, atan2f@libm.a, hypotf@libm.a, nextafterf@libm.a, fmodf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "getgrgid@libc.a, sgetspent@libc.a, getpwnam@libc.a, fgetgrent@libc.a, fgetspent@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		type = "func"
		size = "4"
		objfiles = "_floatdixf@libgcc.a, _fixunsdfsi@libgcc.a, _fixunsdfdi@libgcc.a, _fixunsxfsi@libgcc.a, unwind_dw2_fde_glibc@libgcc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		type = "func"
		size = "4"
		objfiles = "_fixdfdi@libgcc.a, _popcountdi2@libgcc.a, crtbeginS, _absvdi2@libgcc.a, crtendS"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		aliases = "__GI__stdlib_mb_cur_max, __GI_xdr_void, _stdlib_mb_cur_max, authnone_validate, old_sem_extricate_func, xdr_void"
		type = "func"
		size = "6"
		objfiles = "xdr@libc.a, auth_none@libc.a, oldsemaphore@libpthread.a, _stdlib_mb_cur_max@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_tcp@libc.a, svc_authux@libc.a, svc_unix@libc.a, svc_udp@libc.a, svc_raw@libc.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "xdr_mem@libc.a, noophooks@libc.a, nsl@libnsl.a, clnt_unix@libc.a, __uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
