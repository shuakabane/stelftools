...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "__uClibc_main@libc.a, xdr_stdio@libc.a, wcsftime@libc.a, clnt_raw@libc.a, rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		type = "func"
		size = "8"
		objfiles = "spinlock@libpthread.a, manager@libpthread.a, pthread@libpthread.a, semaphore@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_gcov_merge_delta@libgcov.a, _clear_cache@libgcc.a, _gcov_merge_add@libgcov.a, _enable_execute_stack@libgcc.a, _gcov_merge_single@libgcov.a"
	strings:
...
rule thread_self_4d574e5856a30bb564cca31edbbe6aeb {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "cancel@libpthread.a, spinlock@libpthread.a, pthread@libpthread.a, semaphore@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule __pthread_set_own_extricate_if_0f5ab980b3db3b21d9763f76a6fe489e {
	meta:
		...
		type = "func"
		size = "50"
		objfiles = "oldsemaphore@libpthread.a, semaphore@libpthread.a, condvar@libpthread.a, join@libpthread.a"
	strings:
...
rule wcstouq_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		...
		type = "func"
		size = "23"
		objfiles = "strtoull@libc.a, strtoul@libc.a, wcstoull@libc.a, waitpid@libc.a, wcstoul@libc.a"
	strings:
...
rule sgetspent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		...
		type = "func"
		size = "38"
		objfiles = "fgetgrent@libc.a, getpwuid@libc.a, sgetspent@libc.a, getgrnam@libc.a, getgrgid@libc.a"
	strings:
...
rule syslog_3674412569e427ab0f649983548971e5 {
	meta:
		...
		type = "func"
		size = "28"
		objfiles = "swscanf@libc.a, fwprintf@libc.a, asprintf@libc.a, dprintf@libc.a, syslog@libc.a"
	strings:
...
rule truncf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "significandf@libm.a, logf@libm.a, log1pf@libm.a, cbrtf@libm.a, erff@libm.a"
	strings:
...
rule scalbf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "atan2f@libm.a, hypotf@libm.a, copysignf@libm.a, powf@libm.a, scalbf@libm.a"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "xdr@libc.a, auth_none@libc.a, oldsemaphore@libpthread.a, floatformat@libiberty.a, _stdlib_mb_cur_max@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_authux@libc.a, svc_udp@libc.a, svc_raw@libc.a, svc_tcp@libc.a, svc_unix@libc.a"
	strings:
...
rule __res_state_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "__h_errno_location@libc.a, _res_state@libc.a, __errno_location@libc.a, libc_pthread_init@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C3 }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "lckpwdf@libc.a, clnt_raw@libc.a, events@libpthread.a, clnt_udp@libc.a, pthread@libpthread.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "xdr@libc.a, rand@libc.a, pthread@libpthread.a, ptfork@libpthread.a, splay_tree@libiberty.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
