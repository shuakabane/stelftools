...
rule __libc_sa_len_6a9bbbd9964c961148a482a5e6f94a87 {
	meta:
	...
	strings:
		$pattern = { ( CC | 0F ) B7 44 24 04 66 83 F8 02 74 25 77 06 66 48 75 16 EB 0E 66 83 F8 04 74 17 66 83 F8 0A 75 08 EB 09 B8 6E 00 00 00 C3 31 C0 C3 B8 1C 00 00 00 C3 B8 10 00 00 00 C3 }
	condition:
		$pattern
}
...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "td_init@libthread_db.a, condvar@libpthread.a, svc_auth@libc.a, xdr_stdio@libc.a, td_thr_setsigpending@libthread_db.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule timerfd_create_2d25e7f578777636c8d0c888d079a325 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 8B 54 24 10 8B 4C 24 14 87 D3 B8 42 01 00 00 CD 80 87 D3 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 59 5B C3 }
	condition:
		$pattern
}
...
rule __pthread_reset_main_thread_077be0f7e385ab55eb914f479dfee7ae {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 08 E8 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? FF 89 C3 74 51 83 EC 0C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 58 C7 05 ?? ?? ?? ?? 00 00 00 00 FF 35 ?? ?? ?? ?? C7 05 ?? ?? ?? ?? 00 00 00 00 E8 ?? ?? ?? ?? 59 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 C7 05 ?? ?? ?? ?? FF FF FF FF C7 05 ?? ?? ?? ?? FF FF FF FF E8 ?? ?? ?? ?? 89 43 14 89 1D ?? ?? ?? ?? 89 1B 89 5B 04 C7 43 44 ?? ?? ?? ?? C7 43 4C ?? ?? ?? ?? 58 5A 5B C3 }
	condition:
		$pattern
}
...
rule td_thr_event_enable_3c824fe95feb0971940ea22f68506581 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 8B 5C 24 20 8B 53 04 8B 0B 85 D2 75 2C 50 8D 44 24 18 50 6A 0B FF 31 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 30 6A 04 8D 44 24 28 50 FF 74 24 1C 8B 03 FF 30 EB 10 6A 04 8D 44 24 28 50 8D 82 24 01 00 00 50 FF 31 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 83 C4 18 89 D0 5B C3 }
	condition:
		$pattern
}

rule td_ta_get_nthreads_349cea1ea7ee46666634ccbd29c95248 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 8B 5C 24 20 A1 ?? ?? ?? ?? 85 DB 75 05 EB 43 8B 40 04 85 C0 74 3C 39 18 75 F5 50 8D 44 24 18 50 6A 02 FF 33 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 22 6A 04 FF 74 24 28 FF 74 24 1C FF 33 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 EB 05 BA 08 00 00 00 83 C4 18 89 D0 5B C3 }
	condition:
		$pattern
}
...
rule ilogb_72b77f04c090b6819074ea9d80e3f4a3 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 18 DD 44 24 20 DD 14 24 DD 54 24 10 8B 54 24 14 81 E2 FF FF FF 7F 81 FA FF FF 0F 00 7F 3A DD 5C 24 08 89 D3 8B 4C 24 08 B8 01 00 00 80 09 CB 74 3F 85 D2 B8 ED FB FF FF 74 05 EB 09 48 01 C9 85 C9 7F F9 EB 2B C1 E2 0B B8 02 FC FF FF EB 03 48 01 D2 85 D2 7F F9 EB 18 DD D8 81 FA FF FF EF 7F B8 FF FF FF 7F 7F 09 C1 FA 14 8D 82 01 FC FF FF 83 C4 18 5B C3 }
	condition:
		$pattern
}
...
rule sethostent_f6cccc90354b380aaac46c54b0bad4d0 {
	meta:
		aliases = "sethostent"
		type = "func"
		size = "63"
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A 59 83 7C 24 28 00 6A 01 53 0F 95 05 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}
...
rule endservent_156ae97268099fd93fb77aab1b44a9cf {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 74 16 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 C7 05 ?? ?? ?? ?? 00 00 00 00 52 52 6A 01 53 C6 05 ?? ?? ?? ?? 00 E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}

rule endutent_ec7df37188bdc2dd527eba52bbc28493 {
	meta:
		aliases = "endutent"
		type = "func"
		size = "85"
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 14 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 10 85 C0 78 0C 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 52 52 6A 01 53 C7 05 ?? ?? ?? ?? FF FF FF FF E8 ?? ?? ?? ?? 83 C4 28 5B C3 }
	condition:
		$pattern
}
...
rule utmpname_149a3e37126c2899cf0c46db46805cbc {
	meta:
		aliases = "utmpname"
		type = "func"
		size = "151"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 1C 8B 5C 24 24 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 14 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 DB 74 34 A1 ?? ?? ?? ?? 3D ?? ?? ?? ?? 74 0C 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 BA ?? ?? ?? ?? 85 C0 0F 45 D0 89 15 ?? ?? ?? ?? A1 ?? ?? ?? ?? 85 C0 78 16 83 EC 0C 50 E8 ?? ?? ?? ?? 83 C4 10 C7 05 ?? ?? ?? ?? FF FF FF FF 50 50 6A 01 8D 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 28 31 C0 5B C3 }
	condition:
		$pattern
}
...
rule gethostent_r_17918cdd28da6628e13b2958c7455b3e {
	meta:
...
rule wait_bbe948c091b68f15128a29caf991f3c8 {
	meta:
		aliases = "fsync, system, tcdrain, wait"
		type = "func"
		size = "48"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule waitpid_74030486c498b35deba130245259f53b {
	meta:
		aliases = "__GI_waitpid, accept, lseek, sendmsg, waitpid"
		type = "func"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule write_45f0888e75ef40da6adf54cc4cfa9af7 {
	meta:
		aliases = "connect, msync, read, recvmsg, write"
		type = "func"
		size = "58"
		objfiles = "wrapsyscall@libpthread.a"
	strings:
...
rule frexp_258b8524758b8ba405a23bfe2704d4e3 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 83 EC 20 DD 44 24 28 8B 5C 24 30 DD 14 24 DD 54 24 18 8B 4C 24 1C 8B 44 24 18 C7 03 00 00 00 00 89 CA 81 E2 FF FF FF 7F 81 FA FF FF EF 7F 7F 5D 09 D0 74 59 81 FA FF FF 0F 00 7F 21 D8 0D ?? ?? ?? ?? DD 14 24 DD 5C 24 10 8B 4C 24 14 C7 03 CA FF FF FF 89 CA 81 E2 FF FF FF 7F EB 02 DD D8 8B 03 C1 FA 14 81 E1 FF FF 0F 80 81 C9 00 00 E0 3F 2D FE 03 00 00 01 D0 89 03 DD 04 24 DD 5C 24 08 89 4C 24 0C DD 44 24 08 DD 1C 24 EB 02 DD D8 DD 04 24 83 C4 20 5B C3 }
	condition:
		$pattern
}
...
rule __pthread_initialize_manager_52d14774e3e23e72dab9beff6eb1715e {
	meta:
		...
		objfiles = "pthread@libpthread.a"
	strings:
		$pattern = { ( CC | 53 ) 83 EC 38 A1 ?? ?? ?? ?? C7 00 01 00 00 00 83 3D ?? ?? ?? ?? 00 75 05 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 EC 0C 8D 44 00 E0 50 E8 ?? ?? ?? ?? 83 C4 10 89 C2 A3 ?? ?? ?? ?? 83 C8 FF 85 D2 0F 84 9B 01 00 00 A1 ?? ?? ?? ?? 83 EC 0C 8D 44 42 E0 A3 ?? ?? ?? ?? 8D 44 24 3C 50 E8 ?? ?? ?? ?? 83 C4 10 40 75 13 83 EC 0C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? E9 E5 00 00 00 A1 ?? ?? ?? ?? 85 C0 0F 44 05 ?? ?? ?? ?? 85 C0 A3 ?? ?? ?? ?? 0F 84 85 00 00 00 A1 ?? ?? ?? ?? 8A 15 ?? ?? ?? ?? 08 C2 79 76 A1 ?? ?? ?? ?? 31 D2 E8 ?? ?? ?? ?? FF 74 24 30 68 00 0F 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 }
	condition:
		$pattern
}
...
rule byte_regex_compile_54b81b73ce3d96f48b9eb04c3fca4f47 {
	meta:
		aliases = "byte_regex_compile"
		type = "func"
		size = "9298"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 01 C2 57 56 53 81 EC 78 01 00 00 89 44 24 1C 89 84 24 74 01 00 00 8B 84 24 8C 01 00 00 89 4C 24 18 89 54 24 28 8B 40 14 89 44 24 2C 68 80 02 00 00 E8 ?? ?? ?? ?? 89 44 24 64 83 C4 10 85 C0 0F 84 EC 23 00 00 8B 94 24 80 01 00 00 8B 4C 24 0C 80 62 1C 97 89 4A 0C C7 42 08 00 00 00 00 C7 42 18 00 00 00 00 83 3D ?? ?? ?? ?? 00 75 46 53 68 00 01 00 00 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 D2 83 C4 10 EB 14 A1 ?? ?? ?? ?? F6 44 50 01 08 74 07 C6 82 ?? ?? ?? ?? 01 42 81 FA FF 00 00 00 7E E4 C6 05 ?? ?? ?? ?? 01 C7 05 ?? ?? ?? ?? 01 00 00 00 8B 9C 24 80 01 00 00 83 7B 04 00 75 5A 8B 03 85 C0 74 0E }
	condition:
		$pattern
}

rule sleep_456dbc42bbceedf9f52b22c5cd596ec6 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 31 C0 57 56 53 83 EC 3C 8B 54 24 50 85 D2 0F 84 E3 00 00 00 89 54 24 34 C7 44 24 2C 00 00 00 00 C7 44 24 30 00 00 00 00 C7 44 24 38 00 00 00 00 51 51 6A 11 8D 5C 24 38 53 E8 ?? ?? ?? ?? 83 C4 0C 8D 6C 24 28 55 53 6A 00 E8 ?? ?? ?? ?? 58 5A 6A 11 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 6F C7 44 24 2C 00 00 00 00 C7 44 24 30 00 00 00 00 50 50 6A 11 53 E8 ?? ?? ?? ?? 83 C4 0C 8D 44 24 14 50 6A 00 6A 11 E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 10 01 8D 5C 24 34 75 25 57 57 53 53 E8 ?? ?? ?? ?? 89 C7 E8 ?? ?? ?? ?? 83 C4 0C 8B 30 89 C3 6A 00 55 6A 02 E8 ?? ?? ?? ?? 89 33 EB 20 56 6A 00 55 6A 02 E8 ?? ?? ?? }
	condition:
		$pattern
}

rule strptime_04c989c35f5905a5f7a68c43b5527d5d {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 31 C0 57 56 53 83 EC 6C 8B AC 24 80 00 00 00 C7 44 84 20 00 00 00 80 40 83 F8 0C 7E F2 8B BC 24 84 00 00 00 C7 44 24 0C 00 00 00 00 8A 07 84 C0 75 4B 83 7C 24 0C 00 75 36 83 7C 24 38 07 8B 44 24 0C 0F 45 44 24 38 31 D2 89 44 24 38 8B 44 94 20 3D 00 00 00 80 74 0A 8B 8C 24 88 00 00 00 89 04 91 42 83 FA 07 7E E5 89 E8 E9 38 03 00 00 FF 4C 24 0C 8B 44 24 0C 8B 7C 84 54 EB AF 3C 25 0F 85 F4 02 00 00 47 8A 07 3C 25 0F 84 E9 02 00 00 3C 4F 74 08 3C 45 B1 3F 75 0E EB 04 B0 40 EB 02 B0 80 88 C1 47 80 C9 3F 8A 17 84 D2 0F 84 F3 02 00 00 88 D0 0C 20 2C 61 3C 19 0F 87 E5 02 00 00 0F B6 C2 8A 90 ?? ?? }
	condition:
		$pattern
}

rule vfwscanf_80cb056ed7a474e6ea9bd63dc44b843f {
	meta:
		...
		objfiles = "vfwscanf@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C0 57 B9 09 00 00 00 56 53 81 EC 0C 01 00 00 C7 44 24 48 FF FF FF FF 8D 7C 24 24 F3 AB 8B 84 24 20 01 00 00 8B 40 34 85 C0 89 44 24 14 75 29 50 8B 9C 24 24 01 00 00 83 C3 38 53 68 ?? ?? ?? ?? 8D 84 24 FC 00 00 00 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 50 50 FF B4 24 28 01 00 00 8D 9C 24 BC 00 00 00 53 89 DD E8 ?? ?? ?? ?? 8B 84 24 C8 00 00 00 C7 84 24 EC 00 00 00 ?? ?? ?? ?? 8B BC 24 34 01 00 00 8A 40 03 C7 84 24 FC 00 00 00 ?? ?? ?? ?? C7 44 24 68 00 00 00 00 C6 44 24 23 01 88 84 24 D8 00 00 00 83 C4 10 E9 1A 05 00 00 80 A4 24 C9 00 00 00 01 C6 44 24 68 01 C6 44 24 69 00 C7 }
	condition:
		$pattern
}

rule vfscanf_39f1f157e34df01b3ec58864d2052244 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 31 C0 57 B9 09 00 00 00 56 53 81 EC EC 01 00 00 C7 84 24 30 01 00 00 FF FF FF FF 8D BC 24 0C 01 00 00 F3 AB 8B 84 24 00 02 00 00 8B 40 34 85 C0 89 44 24 08 75 29 57 8B 9C 24 04 02 00 00 83 C3 38 53 68 ?? ?? ?? ?? 8D 84 24 E4 01 00 00 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 56 56 FF B4 24 08 02 00 00 8D 9C 24 A4 01 00 00 53 89 DD E8 ?? ?? ?? ?? 8B 84 24 B0 01 00 00 C7 84 24 D4 01 00 00 ?? ?? ?? ?? 8B B4 24 14 02 00 00 8A 40 03 C7 84 24 50 01 00 00 00 00 00 00 C6 44 24 17 01 88 84 24 C0 01 00 00 8B 84 24 D8 01 00 00 89 84 24 E4 01 00 00 83 C4 10 E9 06 05 00 00 80 A4 24 B1 01 00 00 }
	condition:
		$pattern
}

rule _vfwprintf_internal_bfaa7361e990e8e37e817cbc8f893bad {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 31 C0 57 B9 2F 00 00 00 56 53 81 EC 8C 02 00 00 8B B4 24 A4 02 00 00 8D BC 24 20 01 00 00 F3 AB 8D 84 24 80 02 00 00 FF 8C 24 38 01 00 00 89 B4 24 20 01 00 00 C7 84 24 30 01 00 00 80 00 00 00 C7 84 24 80 02 00 00 00 00 00 00 89 B4 24 88 02 00 00 50 6A FF 8D 84 24 90 02 00 00 50 6A 00 E8 ?? ?? ?? ?? 83 C4 10 40 75 10 C7 84 24 20 01 00 00 ?? ?? ?? ?? E9 80 00 00 00 BA 09 00 00 00 8D 84 24 48 01 00 00 C7 00 08 00 00 00 83 C0 04 4A 75 F4 89 F0 8D 9C 24 20 01 00 00 EB 30 83 FA 25 75 28 83 C0 04 83 38 25 74 20 89 84 24 20 01 00 00 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 39 8B 84 24 20 01 00 }
	condition:
		$pattern
}
...
rule _dl_load_elf_shared_library_014cde4d1ff65fe35108145b38abc805 {
	meta:
		...
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 31 C9 57 31 D2 56 53 81 EC 2C 01 00 00 8B BC 24 48 01 00 00 53 89 FB B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 44 24 34 76 09 F7 D8 A3 ?? ?? ?? ?? EB 07 83 7C 24 34 00 79 0F C7 05 ?? ?? ?? ?? 01 00 00 00 E9 D0 0A 00 00 8D 8C 24 E8 00 00 00 8B 54 24 34 87 D3 B8 6C 00 00 00 CD 80 87 D3 3D 00 F0 FF FF 76 09 F7 D8 A3 ?? ?? ?? ?? EB 04 85 C0 79 0C C7 05 ?? ?? ?? ?? 01 00 00 00 EB 14 83 BC 24 40 01 00 00 00 74 1E F6 84 24 F1 00 00 00 08 75 14 8B 7C 24 34 53 89 FB B8 06 00 00 00 CD 80 5B E9 71 08 00 00 8B 2D ?? ?? ?? ?? EB 46 83 BD E0 00 00 00 00 8B 84 24 E8 00 00 00 75 33 39 85 DC 00 00 00 75 2B }
	condition:
		$pattern
}
...
rule __psfs_parse_spec_1b9ffe21b0b2d8b94e30f7829a746259 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 31 FF 56 53 83 EC 0C 8B 74 24 20 8B 6E 30 8A 45 00 2C 30 3C 09 76 07 C6 44 24 0B 01 EB 4F 81 FF CB CC CC 0C 7F 11 8B 46 30 6B D7 0A 0F B6 08 40 89 46 30 8D 7C 11 D0 8B 5E 30 8A 0B 88 C8 2C 30 3C 09 76 DA 80 F9 24 74 19 83 7E 24 00 0F 89 54 01 00 00 89 7E 40 C7 46 24 FE FF FF FF E9 9E 00 00 00 8D 43 01 89 46 30 C6 44 24 0B 00 BB ?? ?? ?? ?? BA 10 00 00 00 8B 4E 30 8A 03 3A 01 75 0B 08 56 45 8D 41 01 89 46 30 EB E2 43 80 3B 00 74 04 01 D2 EB E2 F6 46 45 10 74 08 C6 46 44 00 31 D2 EB 50 80 7C 24 0B 00 74 13 83 7E 24 00 0F 89 F3 00 00 00 C7 46 24 FE FF FF FF EB E2 83 7E 24 FE 0F 84 E0 00 00 }
	condition:
		$pattern
}

rule __parsespent_4869db5eaa80ca26adf79e9d9c793d4e {
	meta:
...
rule readdir64_r_7e670edd4f67269360dc1e3098e70921 {
	meta:
...
rule __parsegrent_06251a1589237cb39f822196e7da6503 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 31 F6 53 83 EC 1C 8B 6C 24 30 8B 5C 24 34 8B 45 00 89 44 24 08 0F B6 86 ?? ?? ?? ?? 83 FE 01 8D 7C 05 00 7F 20 89 1F 52 52 6A 3A 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 84 95 00 00 00 8D 58 01 46 C6 00 00 EB D0 50 6A 0A 8D 44 24 20 50 53 E8 ?? ?? ?? ?? 89 07 8B 4C 24 28 83 C4 10 39 D9 74 71 80 39 3A 75 6C 80 79 01 00 BB 01 00 00 00 74 2B C6 01 2C 80 39 2C 75 1D C6 01 00 41 8A 01 84 C0 74 4F 3C 2C 74 4B 0F B6 D0 A1 ?? ?? ?? ?? F6 04 50 20 75 3D 43 41 80 39 00 75 D8 8D 51 04 83 E2 FC 8D 04 9A 3B 44 24 08 77 27 89 D9 49 89 55 0C 74 15 8B 44 24 18 40 89 02 83 C2 04 49 74 08 40 80 38 00 75 FA }
	condition:
		$pattern
}
...
rule dladdr_63dcc96813382c9ff1ff49cfaf62fc7e {
	meta:
		aliases = "dladdr"
		type = "func"
		size = "255"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 31 DB 83 EC 14 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? EB 17 8B 50 14 3B 54 24 28 73 0B 85 DB 74 05 39 53 14 73 02 89 C3 8B 40 0C 85 C0 75 E5 85 DB 0F 84 BF 00 00 00 8B 43 04 31 FF 31 ED 8B 54 24 2C 89 02 8B 43 14 89 42 04 8B 73 58 89 74 24 08 8B 43 54 C7 44 24 0C 00 00 00 00 C7 44 24 10 00 00 00 00 89 04 24 EB 47 8B 43 2C 8B 0C B8 EB 3A 89 CA 8B 44 24 08 C1 E2 04 89 54 24 04 8B 74 24 04 8B 13 03 54 06 04 3B 54 24 28 77 17 85 ED 74 06 39 54 24 10 73 0D 89 4C 24 0C BD 01 00 00 00 89 54 24 10 8B 43 3C 8B 0C 88 85 C9 75 C2 47 3B 7B 28 72 B4 85 ED 74 26 C1 64 24 0C 04 8B 74 24 08 8B 54 24 0C 8B }
	condition:
		$pattern
}
...
rule vsyslog_0fd112ad1598471926d11e30518666f8 {
	meta:
		...
		objfiles = "syslog@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 3C 04 00 00 8B B4 24 50 04 00 00 F7 C6 00 FC FF FF 0F 85 7E 02 00 00 E8 ?? ?? ?? ?? 89 44 24 10 8B 28 50 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 34 04 00 00 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 0F B6 05 ?? ?? ?? ?? 89 F1 83 E1 07 83 C4 10 D3 F8 A8 01 0F 84 22 02 00 00 83 3D ?? ?? ?? ?? 00 78 09 80 3D ?? ?? ?? ?? 00 75 16 A0 ?? ?? ?? ?? B9 08 00 00 00 0C 08 0F B6 D0 31 C0 E8 ?? ?? ?? ?? F7 C6 F8 03 00 00 75 0C 0F B6 05 ?? ?? ?? ?? C1 E0 03 09 C6 83 EC 0C 8D 9C 24 44 04 00 00 53 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C0 04 50 56 68 ?? ?? ?? ?? 8D 5C 24 44 53 }
	condition:
		$pattern
}
...
rule statvfs64_44295a301b61df23f2c02f881540fd6d {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 44 05 00 00 8B B4 24 58 05 00 00 8D 84 24 D4 04 00 00 8B 9C 24 5C 05 00 00 50 56 E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 0F 88 AD 02 00 00 8B 84 24 D0 04 00 00 8D 7B 48 89 03 89 43 04 8B 84 24 D4 04 00 00 8B 94 24 D8 04 00 00 89 43 08 89 53 0C 8B 84 24 DC 04 00 00 8B 94 24 E0 04 00 00 89 43 10 89 53 14 8B 84 24 E4 04 00 00 8B 94 24 E8 04 00 00 89 43 18 89 53 1C 8B 84 24 EC 04 00 00 8B 94 24 F0 04 00 00 89 43 20 89 53 24 8B 84 24 F4 04 00 00 8B 94 24 F8 04 00 00 89 43 28 89 53 2C 8B 84 24 FC 04 00 00 C7 43 3C 00 00 00 00 89 43 38 8B 84 24 04 05 00 00 89 43 44 31 C0 AB AB AB AB }
	condition:
		$pattern
}

rule _vfprintf_internal_5ea2c75e32d1dbdb55829cf3fa2c42df {
	meta:
		...
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 74 01 00 00 8B 9C 24 8C 01 00 00 53 8D 74 24 1C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 3E 8B 5C 24 10 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 C7 04 24 FF FF FF FF 85 C0 0F 84 B9 05 00 00 52 FF B4 24 84 01 00 00 50 53 E8 ?? ?? ?? ?? C7 44 24 10 FF FF FF FF 83 C4 10 E9 9A 05 00 00 50 50 FF B4 24 90 01 00 00 56 E8 ?? ?? ?? ?? 89 DA C7 44 24 10 00 00 00 00 83 C4 10 EB 01 43 8A 03 84 C0 74 04 3C 25 75 F5 39 D3 74 27 89 DE 31 C0 29 D6 85 F6 7E 12 50 FF B4 24 84 01 00 00 56 52 E8 ?? ?? ?? ?? 83 C4 10 39 F0 0F 85 42 05 00 00 01 04 24 80 3B 00 0F 84 3D 05 00 00 80 7B 01 25 8D 53 01 0F 84 21 }
	condition:
		$pattern
}

rule td_thr_validate_dde6d1c29d7ff83ef635c558966ed397 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 7C 01 00 00 8B B4 24 90 01 00 00 8B 16 83 7E 04 00 8B 5A 04 8B 6A 0C 74 04 31 FF EB 79 6A 10 8D 84 24 64 01 00 00 50 53 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 64 83 BC 24 68 01 00 00 01 EB 49 6A 10 8D 84 24 64 01 00 00 50 53 8B 06 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 3F 8B 8C 24 68 01 00 00 85 C9 74 2C 3B 4E 04 75 27 8B 06 FF 70 18 8D 54 24 04 52 51 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 16 80 7C 24 2C 01 19 C0 F7 D0 83 E0 02 EB 0D 47 83 C3 10 39 EF 7C A6 B8 01 00 00 00 81 C4 7C 01 00 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __uClibc_main_34f473f3edbe417a13b45770d23f360a {
	meta:
		...
		objfiles = "__uClibc_main@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 8C 00 00 00 8B 84 24 B8 00 00 00 8B 94 24 A4 00 00 00 8B AC 24 A8 00 00 00 A3 ?? ?? ?? ?? 8B 84 24 B4 00 00 00 C1 E2 02 A3 ?? ?? ?? ?? 8D 44 2A 04 A3 ?? ?? ?? ?? 3B 45 00 75 09 8D 44 15 00 A3 ?? ?? ?? ?? 31 C0 B9 1E 00 00 00 8D 7C 24 14 F3 AB A1 ?? ?? ?? ?? EB 02 89 F0 83 38 00 8D 70 04 75 F6 89 F1 8D 54 24 14 EB 11 8B 01 83 F8 0E 77 07 8D 3C C2 89 CE A5 A5 83 C1 08 83 39 00 75 EA 8D 44 24 14 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 48 BA 00 10 00 00 85 C0 0F 44 C2 83 7C 24 70 FF A3 ?? ?? ?? ?? 75 20 E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? ?? ?? 39 C3 75 2F E8 ?? ?? ?? ?? 89 C3 E8 ?? ?? }
	condition:
		$pattern
}

rule __gen_tempname_1ef5df6cf8b900dc8501f73ede4ed843 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 8C 00 00 00 E8 ?? ?? ?? ?? 89 44 24 10 8B 00 89 44 24 1C 83 EC 0C FF B4 24 AC 00 00 00 E8 ?? ?? ?? ?? 83 C4 10 83 F8 05 76 30 8B 94 24 A0 00 00 00 8D 44 10 FA 89 44 24 14 52 52 68 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 0D C7 44 24 18 00 00 00 00 E9 FE 01 00 00 8B 4C 24 10 C7 01 16 00 00 00 E9 07 02 00 00 50 50 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 79 1A 50 50 68 00 08 00 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 78 27 50 6A 06 8D 9C 24 8A 00 00 00 53 57 E8 ?? ?? ?? ?? 89 3C 24 89 C3 E8 ?? ?? ?? ?? 83 C4 10 83 FB 06 0F 84 AF 00 00 00 55 }
	condition:
		$pattern
}

rule td_thr_tsd_46bf625ec59cfd29b328ceab48c70640 {
	meta:
		aliases = "td_thr_tsd"
		type = "func"
		size = "243"
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC 8C 01 00 00 8B BC 24 A0 01 00 00 8B 9C 24 A4 01 00 00 8B 17 8B 42 08 89 44 24 0C 8B 4F 04 8B 72 10 8B 6A 14 85 C9 0F 84 AA 00 00 00 68 60 01 00 00 8D 44 24 14 50 51 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 94 00 00 00 39 F3 0F 83 85 00 00 00 6A 08 8D 84 24 78 01 00 00 50 8B 54 24 14 8D 04 DA 50 8B 07 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 6A 83 BC 24 74 01 00 00 00 74 59 31 D2 89 D8 F7 F5 89 D1 8B 94 84 84 00 00 00 B8 11 00 00 00 85 D2 74 4D 6A 04 8D 84 24 80 01 00 00 50 8D 04 8A 50 8B 07 FF 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 2A 8B 94 24 7C 01 00 00 85 D2 74 09 8B 84 24 A8 }
	condition:
		$pattern
}
...
rule _time_tzset_eb1bf8d72ae1aeab87155fa7285116b1 {
	meta:
		aliases = "_time_tzset"
		type = "func"
		size = "942"
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC A0 00 00 00 C7 84 24 9C 00 00 00 00 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 84 24 94 00 00 00 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 55 50 31 DB 50 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 78 36 50 6A 44 8D 5C 24 1C 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 13 8D 04 03 39 D8 76 0C 80 78 FF 0A 75 06 C6 40 FF 00 EB 02 31 DB 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 DB 89 DE 74 06 8A 06 84 C0 75 2E C6 05 ?? ?? ?? ?? 00 31 C0 B9 0C 00 00 00 BF ?? ?? ?? ?? F3 AB 55 55 68 ?? ?? ?? ?? 68 ?? ?? ?? }
	condition:
		$pattern
}

rule __open_nameservers_2d9464a5b286ab73ac62270c57e65c4e {
	meta:
		...
		objfiles = "opennameservers@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC AC 01 00 00 83 3D ?? ?? ?? ?? 00 75 34 50 50 8D 44 24 18 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 0F 44 54 24 50 39 15 ?? ?? ?? ?? 89 54 24 50 74 0B 89 15 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 3D ?? ?? ?? ?? 00 0F 85 50 03 00 00 55 55 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? C6 05 ?? ?? ?? ?? 05 C6 05 ?? ?? ?? ?? 03 E8 ?? ?? ?? ?? 89 44 24 18 83 C4 10 85 C0 0F 85 29 02 00 00 E9 60 02 00 00 8D 84 24 10 01 00 00 E8 ?? ?? ?? ?? 89 C6 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 57 57 68 ?? ?? ?? ?? 56 89 C5 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 0F 85 BF 00 00 00 89 E8 E8 ?? ?? ?? ?? B9 07 00 00 00 C6 }
	condition:
		$pattern
}

rule _fpmaxtostr_a272011c53765419eb5ca0310a8a26b4 {
	meta:
		aliases = "_fpmaxtostr"
		type = "func"
		size = "1444"
...
rule __dns_lookup_2ae07d621d126b05bfaaa75648fb3f41 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC E8 01 00 00 8B 9C 24 FC 01 00 00 68 00 02 00 00 E8 ?? ?? ?? ?? 89 1C 24 89 C5 E8 ?? ?? ?? ?? 83 C4 10 3D 7E 03 00 00 89 44 24 10 76 15 C7 44 24 20 FF FF FF FF C7 44 24 30 00 00 00 00 E9 CD 06 00 00 83 EC 0C 8B 44 24 1C 05 82 00 00 00 50 E8 ?? ?? ?? ?? 89 44 24 40 83 C4 10 85 ED 0F 84 A4 06 00 00 85 C0 0F 84 9C 06 00 00 80 3B 00 0F 84 93 06 00 00 8B 44 24 10 8A 44 18 FF 88 44 24 17 57 FF 74 24 14 53 FF 74 24 3C E8 ?? ?? ?? ?? C7 44 24 30 FF FF FF FF C7 44 24 3C 00 00 00 00 C7 44 24 44 FF FF FF FF C7 44 24 48 FF FF FF FF 83 C4 10 8B 54 24 30 8B 4C 24 10 8D 54 0A 01 89 54 24 0C }
	condition:
		$pattern
}
...
rule pow_c64f3a18f556709beb697ff13d985eb0 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 81 EC FC 00 00 00 DD 84 24 10 01 00 00 DD 54 24 30 DD 84 24 18 01 00 00 DD 54 24 28 D9 C9 DD 9C 24 B0 00 00 00 DD 9C 24 A8 00 00 00 8B 84 24 B0 00 00 00 8B 8C 24 AC 00 00 00 8B 94 24 A8 00 00 00 8B AC 24 B4 00 00 00 89 84 24 D4 00 00 00 89 CB 89 CF 81 E3 FF FF FF 7F 89 D8 09 D0 89 8C 24 B8 00 00 00 75 07 D9 E8 E9 FC 06 00 00 8B 84 24 B4 00 00 00 89 EE 81 E6 FF FF FF 7F 81 FE 00 00 F0 7F 89 84 24 D0 00 00 00 7F 22 0F 94 84 24 BF 00 00 00 75 0A 83 BC 24 D4 00 00 00 00 75 0E 81 FB 00 00 F0 7F 7F 06 75 11 85 D2 74 0D DD 44 24 28 DC 44 24 30 E9 AF 06 00 00 83 BC 24 D0 00 00 00 00 0F 89 }
	condition:
		$pattern
}
...
rule _dl_linux_resolver_0ad5171a84d8d54c7b564dc5f837d631 {
	meta:
		...
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 5C 24 18 8B 44 24 1C 03 83 9C 00 00 00 8B 4B 58 8B 50 04 8B 00 C1 EA 08 C1 E2 04 8B 3C 0A 03 7B 54 89 04 24 8B 2B 6A 01 53 FF 73 1C 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 37 FF 73 04 57 BF 01 00 00 00 FF 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 53 89 FB B8 01 00 00 00 CD 80 5B 83 C4 14 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 8B 04 24 89 74 05 00 89 F0 5F 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _dl_do_reloc_73dca4834f3237e1ef4e0e9a840d4fc8 {
	meta:
		...
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 04 8B 7C 24 18 8B 44 24 20 8B 17 89 14 24 8B 28 8B 40 04 0F B6 D8 C1 E8 08 89 C6 C1 E6 04 03 74 24 24 85 C0 8B 0E 74 69 83 FB 07 74 19 83 FB 23 74 14 83 FB 24 74 0F 83 FB 25 74 0A 31 D2 83 FB 0E 0F 94 C2 EB 05 BA 01 00 00 00 31 C0 83 FB 05 0F 94 C0 01 C0 09 D0 50 57 FF 74 24 24 8B 44 24 34 01 C8 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C1 75 1B 8A 56 0C 0F B6 C2 83 E0 0F 83 F8 06 74 0D C0 EA 04 B8 01 00 00 00 80 FA 02 75 49 89 C8 EB 03 8B 46 04 8B 0C 24 83 FB 08 8D 54 0D 00 77 07 FF 24 9D ?? ?? ?? ?? 83 C8 FF EB 2A 29 D0 EB 06 89 02 EB 20 8B 07 01 02 EB 1A 85 C0 74 16 8B 5E 08 8D }
	condition:
		$pattern
}
...
rule __decode_dotted_cfc86eae99fd2a259c0f672384b3a99b {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 83 7C 24 20 00 8B 54 24 24 0F 84 E8 00 00 00 31 ED C6 44 24 07 01 C7 44 24 08 00 00 00 00 EB 04 89 74 24 08 3B 54 24 28 0F 8D C9 00 00 00 8B 4C 24 20 8A 04 11 84 C0 0F 84 AE 00 00 00 80 7C 24 07 01 0F B6 D8 89 D8 8D 4A 01 83 DD FF 25 C0 00 00 00 3D C0 00 00 00 75 2F 3B 4C 24 28 0F 8D 94 00 00 00 89 DA 8B 5C 24 20 80 7C 24 07 01 8B 74 24 08 0F B6 04 0B 83 DD FF 83 E2 3F C1 E2 08 C6 44 24 07 00 09 C2 EB 98 8B 44 24 08 01 D8 89 C6 46 3B 74 24 30 89 04 24 73 5D 8D 3C 0B 8D 47 01 3B 44 24 28 73 51 50 53 8B 44 24 28 01 C8 50 8B 44 24 38 03 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 10 89 }
	condition:
		$pattern
}
...
rule getsubopt_3f6fa4caa9951cbac70bdfd75a1cd248 {
	meta:
		aliases = "getsubopt"
		type = "func"
		size = "223"
...
rule _dl_fixup_ac76b317452c445fca458a135198d3a0 {
	meta:
		aliases = "_dl_fixup"
		type = "func"
		size = "295"
...
rule getcwd_d9adc01a698c38bb42f236044957f28b {
	meta:
...
rule _obstack_newchunk_41806967e24cc71c7c241711c75d1ae6 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 74 24 20 8B 46 04 89 44 24 08 8B 46 18 8B 6E 0C 2B 6E 08 83 C0 64 01 E8 89 EA 03 44 24 24 C1 FA 03 01 D0 8B 16 39 D0 89 D7 0F 4D F8 8B 46 1C F6 46 28 01 74 08 51 51 57 FF 76 24 EB 04 83 EC 0C 57 FF D0 83 C4 10 85 C0 89 C3 75 05 E8 ?? ?? ?? ?? 89 46 04 8B 54 24 08 89 50 04 8D 04 38 89 46 10 89 03 8B 56 18 89 D0 F7 D0 8D 7C 1A 08 21 C7 31 C0 83 FA 02 7E 27 89 E9 C1 E9 02 89 4C 24 04 EB 10 8B 56 08 8D 04 8D 00 00 00 00 8B 14 02 89 14 07 49 85 C9 79 EB 8B 44 24 04 C1 E0 02 89 C2 EB 0A 8B 46 08 8A 04 10 88 04 17 42 39 EA 7C F2 F6 46 28 02 75 37 8B 46 18 8B 4C 24 08 8D 54 08 }
	condition:
		$pattern
}
...
rule __getdents_6ad4e8c801ccc07d2dca9c9e0c0b3a88 {
	meta:
		aliases = "__getdents"
		type = "func"
		size = "136"
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 0C 8B 7C 24 20 8B 4C 24 24 8B 54 24 28 53 89 FB B8 8D 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0E E8 ?? ?? ?? ?? F7 DB 83 CE FF 89 18 EB 49 83 F8 FF 89 C6 74 42 89 CF 8D 2C 01 EB 37 0F B7 47 08 8D 5F 0A 8A 44 07 FF 88 44 24 0B 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 0C 40 50 53 8D 47 0B 50 E8 ?? ?? ?? ?? 8A 44 24 1B 83 C4 10 88 47 0A 0F B7 47 08 01 C7 39 EF 72 C5 83 C4 0C 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule realloc_4cc5a11209407495a773cb74cc33b6f8 {
	meta:
		aliases = "realloc"
		type = "func"
		size = "823"
...
rule getdelim_d4aea402200299c61df07d9069900992 {
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 83 7C 24 30 00 8B 6C 24 34 8B 7C 24 3C 74 08 85 ED 74 04 85 FF 75 13 E8 ?? ?? ?? ?? 83 CF FF C7 00 16 00 00 00 E9 C0 00 00 00 8B 47 34 85 C0 89 44 24 08 75 1F 8D 5F 38 51 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 44 24 30 8B 18 85 DB 75 07 C7 45 00 00 00 00 00 BE 01 00 00 00 8B 45 00 39 C6 72 24 52 83 C0 40 52 50 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 05 83 CF FF EB 49 83 45 00 40 89 C3 8B 44 24 30 89 18 8B 47 10 3B 47 18 73 09 0F B6 10 40 89 47 10 EB 13 83 EC 0C 57 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C2 74 0B 46 88 54 1E FE 3B 54 24 }
	condition:
		$pattern
}
...
rule __read_etc_hosts_r_24bd964a3b17e3b366b92a9dd8d97693 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 54 24 44 8B 4C 24 48 8B 74 24 50 89 D0 F7 D8 83 E0 03 29 C1 8D 1C 02 89 C8 83 E8 20 C7 06 FF FF FF FF 89 44 24 14 0F 88 F0 01 00 00 83 7C 24 3C 01 8D 53 20 89 54 24 18 75 12 C7 44 24 0C 00 00 00 00 C7 44 24 10 00 00 00 00 EB 57 83 E9 38 83 F9 4F 89 4C 24 14 0F 8E C0 01 00 00 E8 ?? ?? ?? ?? 85 C0 89 44 24 30 75 16 8B 44 24 4C C7 00 00 00 00 00 E8 ?? ?? ?? ?? 8B 28 E9 A2 01 00 00 8B 54 24 18 8D 43 28 89 44 24 10 89 54 24 0C 8D 53 38 89 54 24 18 89 43 20 8B 44 24 0C C7 40 04 00 00 00 00 BD 01 00 00 00 C7 06 01 00 00 00 E9 34 01 00 00 50 31 FF 50 6A 23 FF 74 24 24 E8 ?? ?? }
	condition:
		$pattern
}

rule getwc_unlocked_79617156b6daadfdc361ec8d8f690db9 {
	meta:
...
rule fflush_unlocked_40559a0ff731f9d3b708140c838e6dca {
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 5C 24 30 C7 44 24 08 00 00 00 00 81 FB ?? ?? ?? ?? 74 10 85 DB C7 44 24 08 00 01 00 00 0F 85 F0 00 00 00 57 31 FF 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 5C 24 18 53 89 DD E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 59 5E 40 A3 ?? ?? ?? ?? 6A 01 53 E8 ?? ?? ?? ?? 83 C4 0C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 35 ?? ?? ?? ?? 58 5A 6A 01 53 E8 ?? ?? ?? ?? 83 C4 10 EB 77 F6 06 40 74 6F 83 3D ?? ?? ?? ?? 02 74 1B 8D 5E 38 50 53 68 ?? ?? ?? ?? 55 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 06 0B 44 24 08 }
	condition:
		$pattern
}
...
rule getprotoent_r_3d3389f7f2ae0f44cbef83fdf618dcc9 {
	meta:
...
rule free_06ff041e67d0e3a943dac6e0509b1683 {
	meta:
		aliases = "free"
		type = "func"
		size = "415"
		objfiles = "free@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 6C 24 30 85 ED 0F 84 84 01 00 00 53 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 18 50 8D 5D F8 E8 ?? ?? ?? ?? 89 DF C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 53 04 83 C4 10 A1 ?? ?? ?? ?? 89 D1 83 E1 FC 39 C1 77 23 83 C8 03 89 CA A3 ?? ?? ?? ?? C1 EA 03 8B 04 95 ?? ?? ?? ?? 89 43 08 89 1C 95 ?? ?? ?? ?? E9 16 01 00 00 F6 C2 02 0F 85 ED 00 00 00 83 C8 01 A3 ?? ?? ?? ?? 8D 34 0B 8B 46 04 89 44 24 08 F6 43 04 01 75 21 8B 6D F8 89 D8 29 E8 8B 58 08 8B 50 0C 8B 7B 0C 39 C7 75 3A 39 7A 08 75 35 01 E9 89 53 0C 89 5A 08 8B 5C 24 08 83 E3 FC 3B 35 ?? ?? ?? ?? 74 50 8B 44 1E 04 89 5E 04 }
	condition:
		$pattern
}

rule re_search_2_6221fcfdc653b7d876d4d7cf9a67986d {
	meta:
		...
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 6C 24 30 8B 5C 24 44 8B 7C 24 40 03 7C 24 38 8B 45 10 85 DB 8B 74 24 48 89 44 24 18 8B 55 14 89 7C 24 10 89 54 24 14 0F 88 CC 01 00 00 39 FB 0F 8F C4 01 00 00 89 F2 01 DA 79 06 89 DE F7 DE EB 0D 8B 44 24 10 29 D8 3B 54 24 10 0F 4F F0 83 7D 08 00 74 24 85 F6 7E 20 8B 45 00 8A 00 3C 0B 74 0A 3C 09 75 13 80 7D 1C 00 78 0D 85 DB 0F 8F 86 01 00 00 BE 01 00 00 00 83 7C 24 18 00 0F 84 1B 01 00 00 F6 45 1C 08 75 15 83 EC 0C 55 E8 ?? ?? ?? ?? 83 C4 10 83 F8 FE 0F 84 60 01 00 00 83 7C 24 18 00 0F 84 F5 00 00 00 3B 5C 24 10 0F 8D EB 00 00 00 F6 45 1C 01 0F 85 E1 00 00 00 85 F6 0F }
	condition:
		$pattern
}
...
rule fwide_a9fbff4b28b015b8cc8f99aebd5ccfba {
	meta:
		aliases = "fwide"
		type = "func"
		size = "135"
...
rule fgetpos64_ff9bb5fb6c6a8267edc225d2d791760b {
	meta:
		aliases = "fgetpos64"
		type = "func"
		size = "129"
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 30 8B 7C 24 34 8B 6E 34 85 ED 75 1F 8D 5E 38 52 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 83 EC 0C 83 CB FF 56 E8 ?? ?? ?? ?? 83 C4 10 85 D2 89 07 89 57 04 78 15 8B 46 2C 31 DB 89 47 08 8B 46 30 89 47 0C 0F B6 46 02 89 47 10 85 ED 75 11 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 1C 89 D8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule ungetwc_c53f42b8af826b3f1e5c7d8bfbb958fb {
	meta:
...
rule ungetc_056f5e213d9b340edd88ee2753ebadea {
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 74 24 34 8B 7C 24 30 8B 6E 34 85 ED 75 1F 8D 5E 38 51 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 8B 46 10 3B 46 18 73 19 83 FF FF 74 14 3B 46 08 76 0F 89 FA 38 50 FF 75 08 48 89 46 10 8B 06 EB 55 0F B7 06 25 83 00 00 00 3D 80 00 00 00 77 14 52 52 68 80 00 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 3A 0F B7 06 A8 02 74 0A A8 01 75 2F 83 7E 28 00 75 29 83 FF FF 74 24 8B 46 08 C7 46 28 01 00 00 00 89 46 18 8B 06 40 0F B7 C0 89 C2 83 E2 01 89 7C 96 24 83 E0 FB 66 89 06 EB 03 83 CF FF 85 ED 75 11 50 50 6A 01 8D 44 24 18 50 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule setvbuf_2890471b15bd174453f095f263d28b74 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 1C 8B 7C 24 30 8B 74 24 34 8B 6C 24 3C 8B 47 34 85 C0 89 44 24 08 75 1F 8D 5F 38 52 53 68 ?? ?? ?? ?? 8D 44 24 18 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 83 7C 24 38 02 76 13 E8 ?? ?? ?? ?? 83 CB FF C7 00 16 00 00 00 E9 94 00 00 00 0F B7 17 83 CB FF F7 C2 CF 08 00 00 0F 85 82 00 00 00 8B 44 24 38 80 E6 FC C1 E0 08 09 D0 66 89 07 83 7C 24 38 02 74 04 85 ED 75 08 31 F6 31 ED 31 DB EB 26 31 DB 85 F6 75 20 8B 47 0C 2B 47 08 39 E8 74 4E 83 EC 0C 55 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 3E 89 C6 66 BB 00 40 0F B7 07 F6 C4 40 74 14 83 EC 0C 80 E4 BF 66 89 07 FF 77 08 E8 ?? ?? }
	condition:
		$pattern
}
...
rule __pgsreader_bc21c03b50d95ffcc9fed951f16925bb {
	meta:
		aliases = "__pgsreader"
		type = "func"
		size = "282"
...
rule __res_init_349f5188f64ab793455b92a734fd04cc {
	meta:
...
rule getprotobyname_r_0e29dc2176250d91d07652ec1717cbe4 {
	meta:
...
rule td_ta_new_9b31276fafae8b64f0bb87c7d16ff82a {
	meta:
		aliases = "td_ta_new"
		type = "func"
		size = "552"
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 20 8B 74 24 34 8D 6C 24 1C 8B 5C 24 38 55 6A 00 56 E8 ?? ?? ?? ?? 83 C4 10 B9 0C 00 00 00 85 C0 0F 85 F2 01 00 00 50 8D 44 24 18 50 6A 0C 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 D4 01 00 00 6A 07 8D 7C 24 11 57 FF 74 24 1C 56 E8 ?? ?? ?? ?? 83 C4 10 B9 01 00 00 00 85 C0 0F 85 B8 01 00 00 C6 44 24 13 00 50 50 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 96 01 00 00 83 EC 0C 6A 28 E8 ?? ?? ?? ?? 83 C4 10 B9 12 00 00 00 85 C0 89 C2 89 03 0F 84 7D 01 00 00 89 30 8B 44 24 18 89 42 1C 50 8B 03 83 C0 20 50 6A 01 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 14 83 EC 0C FF 33 E8 ?? ?? }
	condition:
		$pattern
}
...
rule getservbyport_r_ccd9256d38da896d52ed422530148dd2 {
	meta:
...
rule _dl_dprintf_738df097be31ae123c4b2fd699466fbf {
	meta:
		aliases = "_dl_dprintf"
		type = "func"
		size = "714"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 24 8B 5C 24 3C 85 DB 0F 84 AF 02 00 00 8B 0D ?? ?? ?? ?? 31 C0 BA 03 00 00 00 C7 44 24 1C 00 00 00 00 BE 22 00 00 00 83 CF FF 53 89 C3 55 8B 6C 24 1C B8 C0 00 00 00 CD 80 5D 5B 3D 00 F0 FF FF 76 0C F7 D8 83 CD FF A3 ?? ?? ?? ?? EB 07 83 F8 FF 89 C5 75 45 B9 ?? ?? ?? ?? BA 1D 00 00 00 8B 7C 24 38 53 89 FB B8 04 00 00 00 CD 80 5B 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? BF 14 00 00 00 53 89 FB B8 01 00 00 00 CD 80 5B 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 8D 73 FF 89 F2 42 80 3A 00 75 FA A1 ?? ?? ?? ?? 29 DA 48 39 C2 72 45 B9 ?? ?? ?? ?? BA 0B 00 00 00 8B 7C 24 38 53 89 FB }
	condition:
		$pattern
}
...
rule hsearch_r_e0c9c2bee32f6bbdc2f835695a45aec1 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 8B 44 24 3C 8B 54 24 40 89 44 24 1C 89 54 24 20 50 E8 ?? ?? ?? ?? 83 C4 10 89 C1 EB 0F 8B 5C 24 10 89 C2 C1 E2 04 0F B6 04 0B 01 D0 49 83 F9 FF 75 EB 8B 54 24 40 8B 4C 24 40 8B 52 04 89 54 24 08 31 D2 F7 74 24 08 B8 01 00 00 00 8B 09 89 CB 89 4C 24 0C 85 D2 89 D6 0F 44 F0 6B C6 0C 01 C3 8B 03 85 C0 0F 84 9C 00 00 00 39 F0 75 20 52 52 FF 73 04 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 0B 8D 43 04 8B 5C 24 3C 89 03 EB 65 8B 54 24 08 89 F0 89 F3 83 EA 02 89 D1 31 D2 F7 F1 8B 44 24 08 8D 6A 01 29 E8 89 44 24 04 8B 4C 24 04 89 D8 29 E8 39 EB 8D 14 0B 89 D3 0F 47 D8 39 F3 74 }
	condition:
		$pattern
}
...
rule scandir_493e4cfe92b0316d2b805df51e88b594 {
	meta:
		aliases = "scandir"
		type = "func"
		size = "371"
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 28 FF 74 24 3C E8 ?? ?? ?? ?? 89 44 24 1C 83 C4 10 83 C8 FF 83 7C 24 0C 00 0F 84 46 01 00 00 E8 ?? ?? ?? ?? 31 ED 89 C6 8B 00 89 44 24 18 C7 06 00 00 00 00 C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 E9 87 00 00 00 83 7C 24 38 00 74 17 83 EC 0C 57 FF 54 24 48 83 C4 10 85 C0 75 08 C7 06 00 00 00 00 EB 69 C7 06 00 00 00 00 3B 6C 24 14 75 35 C7 44 24 14 0A 00 00 00 85 ED 8D 44 2D 00 0F 44 44 24 14 89 44 24 14 51 51 8B 44 24 1C C1 E0 02 50 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 45 89 44 24 10 0F B7 5F 08 83 EC 0C 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 2D 52 53 57 50 E8 ?? }
	condition:
		$pattern
}

rule scandir64_85b7b8578f9a1669a1905d73b76c14d5 {
	meta:
		aliases = "scandir64"
		type = "func"
		size = "371"
...
rule __res_search_3d07f73ee7cbcccb0da311b0de6985a4 {
	meta:
		...
		objfiles = "res_query@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 83 7C 24 40 00 74 0B 83 7C 24 4C 00 8D 5C 24 1C 75 10 E8 ?? ?? ?? ?? C7 00 FF FF FF FF E9 DB 01 00 00 55 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 53 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 44 24 18 8B 28 0F B6 40 51 89 44 24 24 5E 5F 6A 01 53 E8 ?? ?? ?? ?? 83 C4 10 F7 C5 01 00 00 00 75 07 E8 ?? ?? ?? ?? EB B4 E8 ?? ?? ?? ?? 31 FF 89 44 24 0C C7 00 00 00 00 00 E8 ?? ?? ?? ?? C7 00 01 00 00 00 89 C3 8B 54 24 40 EB 0B 3C 2E 0F 94 C0 42 0F B6 C0 01 C7 8A 02 84 C0 75 EF 31 F6 3B 54 24 40 76 0A 80 7A FF 2E 0F 94 C0 0F B6 F0 3B 7C 24 14 C7 44 24 10 FF FF FF FF }
	condition:
		$pattern
}

rule inet_pton_a090c92e87b5cb334f16aab9e36ba555 {
	meta:
		...
		objfiles = "ntop@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 44 24 40 8B 74 24 44 83 F8 02 74 0B 83 F8 0A 0F 85 A8 01 00 00 EB 10 8B 54 24 48 89 F0 E8 ?? ?? ?? ?? E9 A4 01 00 00 8D 54 24 1C 31 C0 89 D7 AB AB AB AB 80 3E 3A 75 0A 46 80 3E 3A 0F 85 77 01 00 00 31 ED 89 74 24 18 C7 44 24 0C 00 00 00 00 89 54 24 10 C7 44 24 14 00 00 00 00 E9 D5 00 00 00 50 46 50 0F B6 C3 83 C8 20 50 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 1B C1 E5 04 2D ?? ?? ?? ?? 09 C5 81 FD FF FF 00 00 0F 86 9C 00 00 00 E9 22 01 00 00 80 FB 3A 75 60 83 7C 24 0C 00 75 19 83 7C 24 14 00 0F 85 0B 01 00 00 8B 44 24 10 89 74 24 18 89 44 24 14 EB 7A 80 3E 00 0F }
	condition:
		$pattern
}
...
rule freopen64_34615f1a7d56d789da73262559a1d1b1 {
	meta:
		aliases = "freopen64"
		type = "func"
		size = "267"
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 74 24 48 8B 6E 34 85 ED 75 1F 8D 5E 38 50 53 68 ?? ?? ?? ?? 8D 44 24 28 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 50 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 7C 24 18 57 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 5B 40 A3 ?? ?? ?? ?? 58 6A 01 57 E8 ?? ?? ?? ?? 0F B7 1E 83 C4 10 89 D8 25 FF 9F 00 00 66 89 06 89 D8 83 E0 30 83 F8 30 74 3B 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 0C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A FF 0D ?? ?? ?? ?? 59 6A 01 57 E8 ?? ?? ?? ?? 83 C4 10 6A FE 56 FF 74 24 4C FF 74 24 4C E8 }
	condition:
		$pattern
}

rule freopen_c65b1cf0410396488f658ba2cb7fe56f {
	meta:
		aliases = "freopen"
		type = "func"
		size = "267"
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 2C 8B 74 24 48 8B 6E 34 85 ED 75 1F 8D 5E 38 50 53 68 ?? ?? ?? ?? 8D 44 24 28 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 50 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 7C 24 18 57 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 5B 40 A3 ?? ?? ?? ?? 58 6A 01 57 E8 ?? ?? ?? ?? 0F B7 1E 83 C4 10 89 D8 25 FF 9F 00 00 66 89 06 89 D8 83 E0 30 83 F8 30 74 3B 83 EC 0C 56 E8 ?? ?? ?? ?? 83 C4 0C 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 5A FF 0D ?? ?? ?? ?? 59 6A 01 57 E8 ?? ?? ?? ?? 83 C4 10 6A FF 56 FF 74 24 4C FF 74 24 4C E8 }
	condition:
		$pattern
}

rule fseeko64_ff531bc4f89c7ed531dbaeb7250c9bc3 {
	meta:
...
rule mallinfo_fd1811ddb5bd7d8268a5c3352922dea9 {
	meta:
		...
		objfiles = "mallinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 30 8B 7C 24 44 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 28 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 3D ?? ?? ?? ?? 00 75 10 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 A1 ?? ?? ?? ?? 31 C9 8B 40 04 C7 44 24 08 00 00 00 00 C7 44 24 10 00 00 00 00 89 44 24 04 EB 1F 8B 14 8D ?? ?? ?? ?? EB 11 FF 44 24 10 8B 42 04 83 E0 FC 01 44 24 08 8B 52 08 85 D2 75 EB 41 83 F9 09 76 DC 8B 44 24 04 BB 01 00 00 00 8B 6C 24 08 C7 44 24 0C 01 00 00 00 83 E0 FC 01 C5 EB 20 8D 0C DD ?? ?? ?? ?? 8B 51 0C EB 0F FF 44 24 0C 8B 42 04 8B 52 0C 83 E0 FC 01 C5 39 CA 75 ED 43 83 }
	condition:
		$pattern
}
...
rule __res_query_e1db66752bc116e6c1ec77961369d49f {
	meta:
...
rule __strtofpmax_047348b2207cff4c88fda6f9e4c4d8b6 {
	meta:
...
rule malloc_e7e574cc0bae22e8ad49a909e02f20fd {
	meta:
		aliases = "malloc"
		type = "func"
		size = "1973"
...
rule getaddrinfo_1885ed7d0bd6972505e52b09e0322b48 {
	meta:
		...
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 83 7C 24 60 00 8B 54 24 64 8B 5C 24 68 C7 44 24 48 00 00 00 00 74 1B 8B 44 24 60 80 38 2A 75 12 80 78 01 00 B8 00 00 00 00 0F 45 44 24 60 89 44 24 60 85 D2 74 11 80 3A 2A 75 0C 80 7A 01 00 B8 00 00 00 00 0F 44 D0 8B 7C 24 60 09 D7 0F 84 13 02 00 00 85 DB 75 11 8D 74 24 1C B9 08 00 00 00 89 F7 89 D8 F3 AB 89 F3 8B 03 A9 C0 FB FF FF 0F 85 F8 01 00 00 A8 02 74 0B 83 7C 24 60 00 0F 84 E9 01 00 00 85 D2 74 62 80 3A 00 74 5D 89 54 24 3C 56 6A 0A 8D 44 24 4C 50 52 E8 ?? ?? ?? ?? 89 44 24 50 83 C4 10 8B 44 24 44 80 38 00 74 1C F6 43 01 04 0F 85 AD 01 00 00 8D 44 24 3C C7 44 24 40 }
	condition:
		$pattern
}
...
rule gethostbyaddr_r_f12a7bbd71bf813246152275f1c7f237 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C 8B 44 24 78 8B 7C 24 70 8B 5C 24 74 C7 00 00 00 00 00 83 7C 24 60 00 0F 84 91 02 00 00 83 7C 24 68 02 74 0D 83 7C 24 68 0A 0F 85 7F 02 00 00 EB 07 83 7C 24 64 04 EB 05 83 7C 24 64 10 0F 85 6B 02 00 00 FF 74 24 7C FF 74 24 7C 53 57 FF 74 24 7C FF 74 24 7C FF 74 24 7C FF 74 24 7C E8 ?? ?? ?? ?? 83 C4 20 85 C0 0F 84 46 02 00 00 8B 4C 24 7C 8B 11 83 FA 01 74 09 83 FA 04 0F 85 32 02 00 00 8B 44 24 7C 89 FE F7 DE 83 E6 03 01 F7 29 F3 C7 00 FF FF FF FF 83 EB 38 B8 22 00 00 00 89 7C 24 14 83 C7 20 8B 54 24 14 89 7C 24 18 89 5C 24 10 83 C2 28 81 FB FF 00 00 00 89 54 24 48 0F 8E EF }
	condition:
		$pattern
}
...
rule __time_localtime_tzi_12d9efdfcafbeb50f0fbc0f471a51a5d {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 4C C7 44 24 20 00 00 00 00 8B 4C 24 60 6B 44 24 20 18 8B 5C 24 68 8B 11 B9 F9 FF FF FF 01 C3 B8 80 3A 09 00 2B 03 81 FA 7F C5 F6 7F 7E 07 F7 D8 B9 07 00 00 00 01 D0 89 44 24 48 8D 7B 10 56 FF 74 24 68 51 8D 74 24 54 56 BE ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 74 8B 54 24 30 89 50 20 8B 03 8B 4C 24 74 83 C4 10 F7 D8 89 41 24 51 51 57 8D 5E 04 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 04 89 D8 EB 50 8B 36 85 F6 75 E3 52 52 6A 07 57 E8 ?? ?? ?? ?? 83 C4 10 83 F8 06 7F 33 83 EC 0C 83 C0 08 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C2 74 1E A1 ?? ?? ?? ?? 89 02 50 50 57 8D 42 04 50 89 15 ?? ?? }
	condition:
		$pattern
}
...
rule timer_create_18838f1faa731010b5db765685ea298a {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 5C 8B 74 24 74 85 F6 75 14 C7 44 24 20 00 00 00 00 8D 74 24 18 C7 44 24 1C 0E 00 00 00 83 7E 08 02 74 6D 83 EC 0C 6A 08 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C5 74 5A 89 44 24 18 8D 54 24 58 8B 7C 24 70 89 F1 53 89 FB B8 03 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0B E8 ?? ?? ?? ?? F7 DB 89 18 EB 1C 83 F8 FF 74 17 8B 46 08 89 45 00 8B 44 24 58 89 45 04 8B 44 24 78 89 28 89 D8 EB 14 83 EC 0C 55 E8 ?? ?? ?? ?? 83 C8 FF 83 C4 10 EB 03 83 C8 FF 83 C4 5C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule _ppfs_parsespec_0dbc8fb43118cddf28cc971d4534b072 {
	meta:
...
rule initshells_f05de27475c1e2f2f3b3021f8be878dd {
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 6C E8 ?? ?? ?? ?? 50 50 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 89 C7 B8 ?? ?? ?? ?? 85 FF 0F 84 08 01 00 00 83 EC 0C 57 E8 ?? ?? ?? ?? 5E 5D 8D 54 24 1C 52 50 E8 ?? ?? ?? ?? 83 C4 10 40 0F 84 D2 00 00 00 83 EC 0C 8B 44 24 4C 40 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 A3 ?? ?? ?? ?? 0F 84 B4 00 00 00 53 BA 03 00 00 00 53 89 D1 6A 04 31 D2 8B 44 24 4C F7 F1 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 A3 ?? ?? ?? ?? 0F 84 8B 00 00 00 51 51 6A 02 57 E8 ?? ?? ?? ?? 8B 6C 24 50 83 C4 10 8B 35 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? EB 3A 43 8A 03 3C 23 74 33 3C 2F 74 06 84 C0 75 F1 EB 29 84 C0 }
	condition:
		$pattern
}
...
rule lgamma_r_dcd2577c0ed36bc9168a2bfe155bb6fa {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 53 83 EC 7C DD 84 24 90 00 00 00 8B AC 24 98 00 00 00 DD 54 24 20 DD 54 24 38 8B 44 24 3C 89 C6 81 E6 FF FF FF 7F 81 FE FF FF EF 7F 89 44 24 54 C7 45 00 01 00 00 00 7E 09 D9 C0 DE C9 E9 42 06 00 00 DD D8 8B 7C 24 38 89 F0 09 F8 74 5B 81 FE FF FF 8F 3B 7F 39 83 7C 24 54 00 79 19 C7 45 00 FF FF FF FF 83 EC 10 DD 44 24 30 D9 E0 DD 54 24 30 DD 1C 24 EB 0A 56 56 FF 74 24 2C FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 D9 E0 E9 F5 05 00 00 83 7C 24 54 00 78 0B D9 EE DD 5C 24 48 E9 F0 01 00 00 81 FE FF FF 2F 43 7E 07 D9 EE E9 8F 01 00 00 DD 44 24 20 DD 5C 24 30 8B 5C 24 34 81 E3 FF FF FF 7F 81 FB FF }
	condition:
		$pattern
}
...
rule exchange_8b729c5f4350bf041617382f24ed1642 {
	meta:
		aliases = "exchange"
		type = "func"
		size = "219"
...
rule gethostbyname_r_99202ccdd5a8ca9dffb092babce7d576 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 57 56 BE 16 00 00 00 53 83 EC 3C 8B 44 24 60 8B 6C 24 5C C7 00 00 00 00 00 83 7C 24 50 00 0F 84 83 02 00 00 E8 ?? ?? ?? ?? 8B 38 89 C3 C7 00 00 00 00 00 50 FF 74 24 68 FF 74 24 68 55 FF 74 24 68 FF 74 24 68 6A 02 FF 74 24 6C E8 ?? ?? ?? ?? 83 C4 20 85 C0 89 C6 75 07 89 3B E9 47 02 00 00 8B 54 24 64 8B 02 83 F8 01 74 0E 83 F8 04 74 1F 40 0F 85 30 02 00 00 EB 0D 31 C0 83 FE 02 0F 94 C0 89 04 24 EB 10 83 3B 02 0F 85 18 02 00 00 C7 04 24 00 00 00 00 89 3B 8B 4C 24 64 83 EC 0C C7 01 FF FF FF FF FF 74 24 5C E8 ?? ?? ?? ?? 83 C4 10 8D 58 01 39 DD 0F 8E E6 01 00 00 50 29 DD 53 FF 74 24 58 FF 74 24 }
	condition:
		$pattern
}
...
rule _dl_lookup_hash_7835b46434ba031528993f478bac6d9a {
	meta:
		...
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 57 83 CF FF 56 53 83 EC 0C 8B 44 24 2C 8B 6C 24 24 83 E0 02 89 04 24 E9 B8 00 00 00 8B 75 00 F6 46 25 01 75 26 83 7C 24 28 00 74 1F 39 74 24 28 74 19 8B 54 24 28 8B 42 34 EB 07 39 70 04 74 0B 8B 00 85 C0 75 F5 E9 86 00 00 00 83 3C 24 00 74 06 83 7E 18 01 74 7A 8B 5E 28 85 DB 74 73 8B 46 58 83 FF FF 89 44 24 04 75 27 8B 4C 24 20 31 FF EB 19 0F B6 D0 41 C1 E7 04 01 FA 89 D0 25 00 00 00 F0 89 C7 31 D7 C1 E8 18 31 C7 8A 01 84 C0 75 E1 8B 56 54 89 F8 89 54 24 08 31 D2 F7 F3 8B 46 2C 8B 1C 90 EB 27 89 D8 C1 E0 04 03 44 24 04 FF 74 24 2C 8B 54 24 0C 8B 4C 24 24 E8 ?? ?? ?? ?? 59 85 C0 89 C2 75 17 }
	condition:
		$pattern
}
...
rule __md5_Update_b863e25d75d7e23def97d14c08cd2950 {
	meta:
...
rule _dl_map_cache_20d8ea57ff0faed2931f0a7273fa3c1e {
	meta:
		...
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 83 C8 FF 57 56 53 83 EC 50 8B 15 ?? ?? ?? ?? 83 FA FF 0F 84 D5 01 00 00 85 D2 0F 85 CB 01 00 00 BE ?? ?? ?? ?? 8D 4C 24 0C 89 F0 53 89 C3 B8 6A 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 0D F7 DB 89 1D ?? ?? ?? ?? E9 90 01 00 00 85 C0 0F 85 88 01 00 00 B9 00 00 08 00 31 D2 53 89 F3 B8 05 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0D F7 DF 89 3D ?? ?? ?? ?? E9 60 01 00 00 85 C0 0F 88 58 01 00 00 8B 4C 24 20 BE 01 00 00 00 89 D8 C7 44 24 4C 00 00 00 00 89 F2 89 0D ?? ?? ?? ?? 53 89 C3 55 8B 6C 24 4C B8 C0 00 00 00 CD 80 5D 5B 3D 00 F0 FF FF 89 C1 89 C2 76 0B F7 D9 83 CA FF 89 0D ?? ?? ?? ?? 89 }
	condition:
		$pattern
}

rule lckpwdf_d6aba4026e1938a802f0f89c2588616c {
	meta:
		aliases = "lckpwdf"
		type = "func"
		size = "355"
	...
	strings:
		$pattern = { ( CC | 55 ) 83 C8 FF 57 56 53 83 EC 6C 83 3D ?? ?? ?? ?? FF 0F 85 44 01 00 00 56 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 48 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 59 5B 68 01 00 08 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF A3 ?? ?? ?? ?? 0F 84 EE 00 00 00 52 31 F6 6A 01 6A 02 50 E8 ?? ?? ?? ?? 8D 54 24 24 89 F0 89 D7 AB AB AB AB AB C7 44 24 24 ?? ?? ?? ?? C7 44 24 30 FF FF FF FF C7 44 24 34 FF FF FF FF 83 C4 0C 8D 44 24 2C 50 52 6A 0E E8 ?? ?? ?? ?? C7 44 24 6C 00 00 00 00 C7 44 24 70 00 00 00 00 5F 5D 6A 0E 8D 5C 24 68 53 E8 ?? ?? ?? ?? 83 C4 0C 8D 6C 24 68 55 53 6A 01 E8 ?? ?? }
	condition:
		$pattern
}

rule srandom_r_e6d4d3e41bbf5d3094a7cddf7398a323 {
	meta:
		...
		objfiles = "random_r@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 83 C9 FF 57 56 53 83 EC 1C 8B 74 24 34 8B 54 24 30 8A 46 0C 88 44 24 0B 0F BE C0 83 F8 04 77 7D 8B 5E 08 85 D2 B8 01 00 00 00 0F 44 D0 89 13 80 7C 24 0B 00 74 65 0F BE 6E 0D 89 D9 BF 01 00 00 00 89 2C 24 EB 2E 89 D0 BD 1D F3 01 00 99 F7 FD 89 44 24 04 69 D2 A7 41 00 00 69 C0 14 0B 00 00 29 C2 83 FA FF 8D 82 FF FF FF 7F 0F 4E D0 83 C1 04 89 11 47 3B 3C 24 7C CD 0F BE 46 0E 8D 7C 24 18 89 5E 04 8D 04 83 89 06 6B 1C 24 0A EB 09 57 56 E8 ?? ?? ?? ?? 58 5A 4B 79 F4 31 C9 83 C4 1C 89 C8 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule do_dlclose_1ce7bfc3d1fac51c37ae13e08d3c0c64 {
	meta:
		aliases = "do_dlclose"
		type = "func"
		size = "555"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 89 C5 57 56 53 83 EC 0C 3B 05 ?? ?? ?? ?? 89 54 24 04 0F 84 08 02 00 00 A1 ?? ?? ?? ?? 31 D2 EB 09 39 E8 74 1A 89 C2 8B 40 04 85 C0 75 F3 B0 01 C7 05 ?? ?? ?? ?? 0A 00 00 00 E9 E3 01 00 00 85 D2 8B 45 04 74 05 89 42 04 EB 05 A3 ?? ?? ?? ?? 8B 55 00 0F B7 42 20 C7 44 24 08 00 00 00 00 66 83 F8 01 0F 84 6D 01 00 00 48 83 EC 0C 66 89 42 20 55 E8 ?? ?? ?? ?? 31 C0 83 C4 10 E9 A1 01 00 00 8B 45 08 8B 54 24 08 8B 3C 90 8B 47 20 48 0F B7 C0 85 C0 66 89 47 20 0F 85 34 01 00 00 83 7F 74 00 75 09 83 BF A8 00 00 00 00 74 2D 83 7C 24 04 00 74 26 0F B7 47 22 A8 08 75 1E 83 C8 08 83 EC 0C 66 89 47 22 57 }
	condition:
		$pattern
}
...
rule handle_descr_a3a30c13134a3345e350d73a8ee757fb {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 CD 57 56 89 C6 53 81 EC 8C 01 00 00 8B 9C 24 AC 01 00 00 89 54 24 08 8B BC 24 A8 01 00 00 8B 40 18 85 DB 75 48 85 FF 75 3A 8D 54 24 10 B9 58 00 00 00 89 D7 89 D8 F3 AB 89 94 24 2C 01 00 00 89 54 24 14 89 54 24 10 C7 44 24 20 00 04 00 00 89 B4 24 78 01 00 00 C7 84 24 7C 01 00 00 00 00 00 00 EB 5A 31 D2 83 FF 01 0F 95 C2 EB 6D 50 8D 44 24 14 50 53 FF 36 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 53 4F 75 07 83 7C 24 24 00 74 47 8B 84 24 A4 01 00 00 39 44 24 28 7C 3A 83 BC 24 A0 01 00 00 00 75 30 80 7C 24 3E 00 75 29 89 B4 24 78 01 00 00 89 9C 24 7C 01 00 00 50 50 55 8D 84 24 84 01 00 }
	condition:
		$pattern
}

rule rwlock_have_already_c9f1258baaf18b665d918f74bf4a5cc4 {
	meta:
		...
		objfiles = "rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 CD 57 89 C7 56 89 D6 53 83 EC 0C 83 7A 18 01 8B 18 74 06 31 D2 31 C9 EB 74 85 DB 75 07 E8 ?? ?? ?? ?? 89 C3 8B 93 48 01 00 00 EB 07 39 72 04 74 08 8B 12 85 D2 75 F5 EB 04 85 D2 75 54 83 BB 50 01 00 00 00 7F 4B 8B 93 4C 01 00 00 85 D2 74 0A 8B 02 89 83 4C 01 00 00 EB 0F 83 EC 0C 6A 0C E8 ?? ?? ?? ?? 83 C4 10 89 C2 85 D2 74 18 C7 42 08 01 00 00 00 89 72 04 8B 83 48 01 00 00 89 02 89 93 48 01 00 00 83 FA 01 19 C9 83 E1 01 31 F6 EB 07 31 C9 BE 01 00 00 00 8B 44 24 20 89 08 89 F0 89 55 00 89 1F 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule daemon_df9b02072df3fde9f945a6809001232f {
	meta:
		aliases = "daemon"
		type = "func"
		size = "161"
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 E8 ?? ?? ?? ?? 83 F8 FF 74 78 85 C0 74 7D 83 EC 0C 6A 00 E8 ?? ?? ?? ?? 83 7D 08 00 75 10 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 7D 0C 00 75 53 50 50 6A 02 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C3 74 3B 50 50 6A 00 53 E8 ?? ?? ?? ?? 59 58 6A 01 53 E8 ?? ?? ?? ?? 58 5A 6A 02 53 E8 ?? ?? ?? ?? 83 C4 10 83 FB 02 7E 15 83 EC 0C 53 E8 ?? ?? ?? ?? 31 C0 83 C4 10 EB 13 83 C8 FF EB 0E 31 C0 EB 0A E8 ?? ?? ?? ?? 40 75 85 EB ED 8B 5D FC C9 C3 }
	condition:
		$pattern
}
...
rule uw_install_context_7538f7c8c7f18aa0822670f761a87cf5 {
	meta:
		...
		objfiles = "unwind_sjlj@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 8B 02 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 8D 50 20 8B 4A 04 89 83 ?? ?? ?? ?? 8B 68 20 8B 62 08 FF E1 }
	condition:
		$pattern
}
...
rule byte_re_match_2_internal_21f66e5dc97dfe9ba1496209b3389d87 {
	meta:
		aliases = "byte_re_match_2_internal"
		type = "func"
		size = "6945"
...
rule td_ta_map_lwp2thr_bd4b1ea6ce9c0651caa18ba57758fca1 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 7C 01 00 00 8B 5D 08 89 A5 80 FE FF FF 8B 43 18 89 85 84 FE FF FF 8B 53 0C 89 95 7C FE FF FF C1 E2 04 8D 42 10 29 C4 A1 ?? ?? ?? ?? 8D 74 24 0F 83 E6 F0 EB 03 8B 40 04 85 C0 74 06 39 18 75 F5 EB 0A B8 08 00 00 00 E9 A6 00 00 00 52 56 FF 73 04 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 8A 00 00 00 31 FF EB 77 89 F8 C1 E0 04 01 F0 89 85 78 FE FF FF 8B 40 08 85 C0 74 4E FF B5 84 FE FF FF 8D 95 88 FE FF FF 52 50 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 56 8B 85 9C FE FF FF 85 C0 75 0D 83 EC 0C FF 33 E8 ?? ?? ?? ?? 83 C4 10 3B 45 0C 75 2A 8B 45 10 89 18 8B 95 78 FE FF FF 8B 42 }
	condition:
		$pattern
}

rule gaih_inet_5dadff2595c065119a0b22dd6109956b {
	meta:
		aliases = "gaih_inet"
		type = "func"
		size = "2516"
		objfiles = "getaddrinfo@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 9C 00 00 00 8B 55 10 8D 45 D4 89 45 F0 C7 45 EC 00 00 00 00 8B 42 04 85 C0 74 0F 83 F8 0A C7 85 6C FF FF FF 00 00 00 00 75 16 8B 4D 10 8B 19 83 F3 08 C1 EB 03 F7 D3 83 E3 01 89 9D 6C FF FF FF 31 C0 8D 7D D4 AB AB AB AB 8B 7D 10 8B 4F 0C 85 C9 75 0D 83 7F 08 00 75 07 EB 5A 83 C3 07 EB 05 BB ?? ?? ?? ?? 8A 43 03 84 C0 88 85 6B FF FF FF 74 2C 8B 7D 10 8B 57 08 85 D2 74 07 0F BE 03 39 C2 75 D8 85 C9 74 0E F6 43 02 02 75 08 0F BE 43 01 39 C1 75 C6 80 BD 6B FF FF FF 00 75 1C 8B 55 10 B8 07 01 00 00 83 7A 08 00 0F 85 14 09 00 00 E9 F8 08 00 00 BB ?? ?? ?? ?? 83 7D 0C 00 0F 84 }
	condition:
		$pattern
}
...
rule glob_f01130b3a7c82e135c717c5f8005b440 {
	meta:
		...
		objfiles = "glob@libc.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC DC 00 00 00 83 7D 08 00 8B 7D 14 74 0D 85 FF 74 09 F7 45 0C 00 81 FF FF 74 13 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 E9 08 05 00 00 8B 45 0C 83 E0 08 89 85 24 FF FF FF 75 07 C7 47 08 00 00 00 00 50 50 6A 2F FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 3D F7 45 0C 00 50 00 00 0F 84 CF 00 00 00 8B 55 08 80 3A 7E 0F 85 C3 00 00 00 83 EC 0C 52 E8 ?? ?? ?? ?? 8B 5D 08 83 C4 10 C7 85 2C FF FF FF 00 00 00 00 89 85 30 FF FF FF E9 B7 00 00 00 3B 45 08 75 1E 8B 4D 08 BB ?? ?? ?? ?? C7 85 30 FF FF FF 01 00 00 00 41 89 8D 2C FF FF FF E9 94 00 00 00 2B 45 08 89 85 30 FF FF FF }
	condition:
		$pattern
}

rule glob64_092cdaca48b4e57418fa536172998b25 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC EC 00 00 00 83 7D 08 00 8B 7D 14 74 0D 85 FF 74 09 F7 45 0C 00 81 FF FF 74 13 E8 ?? ?? ?? ?? 83 CA FF C7 00 16 00 00 00 E9 0B 05 00 00 8B 45 0C 83 E0 08 89 85 14 FF FF FF 75 07 C7 47 08 00 00 00 00 53 53 6A 2F FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 3D F7 45 0C 00 50 00 00 0F 84 CF 00 00 00 8B 55 08 80 3A 7E 0F 85 C3 00 00 00 83 EC 0C 52 E8 ?? ?? ?? ?? 8B 5D 08 83 C4 10 C7 85 1C FF FF FF 00 00 00 00 89 85 20 FF FF FF E9 B7 00 00 00 3B 45 08 75 1E 8B 4D 08 BB ?? ?? ?? ?? C7 85 20 FF FF FF 01 00 00 00 41 89 8D 1C FF FF FF E9 94 00 00 00 2B 45 08 89 85 20 FF FF FF }
	condition:
		$pattern
}
...
rule sched_setaffinity_011fd6ae3e8bfe91040d603674f69918 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 0C 83 3D ?? ?? ?? ?? 00 75 73 81 EC 90 00 00 00 8D 74 24 0F 83 E6 F0 C7 45 F0 80 00 00 00 EB 26 8B 4D F0 8B 5D F0 01 C9 8D 41 1E 01 CB 83 E0 F0 29 C4 8D 54 24 0F 83 E2 F0 8D 04 0A 39 F0 89 D6 0F 44 CB 89 4D F0 E8 ?? ?? ?? ?? 8B 4D F0 89 F2 89 C7 53 89 FB B8 F2 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C3 76 05 83 F8 EA 74 B5 85 DB 74 4F 81 FB 00 F0 FF FF 77 47 89 1D ?? ?? ?? ?? A1 ?? ?? ?? ?? EB 17 8B 7D 10 80 3C 07 00 74 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 2D 40 3B 45 0C 72 E4 8B 7D 08 8B 4D 0C 8B 55 10 53 89 FB B8 F1 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? }
	condition:
		$pattern
}

rule td_ta_thr_iter_897a0bb3044589fe6adcee3f8165957c {
	meta:
		...
		objfiles = "td_ta_thr_iter@libthread_db.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 0C 83 7D 08 00 A1 ?? ?? ?? ?? 75 08 E9 E4 00 00 00 8B 40 04 85 C0 0F 84 D9 00 00 00 8B 55 08 39 10 75 EE 8B 42 0C 89 C7 C1 E7 04 89 45 F0 8D 47 10 29 C4 8D 74 24 0F 83 E6 F0 6A 20 56 FF 72 04 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 AA 00 00 00 FF 76 08 8B 4D 10 8B 55 0C 8B 45 08 6A 00 FF 75 18 FF 75 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 0F 85 89 00 00 00 FF 76 18 8B 4D 10 8B 55 0C 8B 45 08 6A 01 FF 75 18 FF 75 14 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 75 67 8B 55 08 8D 47 E0 BF 02 00 00 00 50 8D 46 20 50 8B 42 04 83 C0 20 50 FF 32 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 2F EB }
	condition:
		$pattern
}

rule td_ta_tsd_iter_a718bbd13783020e2cefb1cd24c3ffbd {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 0C 8B 4D 08 A1 ?? ?? ?? ?? 85 C9 75 05 EB 6A 8B 40 04 85 C0 74 63 39 08 75 F5 8B 79 10 31 F6 8D 04 FD 00 00 00 00 8D 50 1E 83 E2 F0 29 D4 8D 5C 24 0F 83 E3 F0 50 53 FF 71 08 FF 31 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 74 24 EB 2F 8D 04 F3 83 38 00 74 19 52 FF 75 10 FF 70 04 56 FF 55 0C 83 C4 10 85 C0 74 07 BA 0F 00 00 00 EB 0E 46 39 FE 7C DA 31 D2 EB 05 BA 08 00 00 00 8D 65 F4 89 D0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __getdents64_fbae2fd02b1772dd07a5a98000c20b73 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C 8B 55 10 8B 7D 08 8D 42 1E 83 E0 F0 29 C4 8D 4C 24 0F 83 E1 F0 53 89 FB B8 DC 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0B E8 ?? ?? ?? ?? F7 DE 89 30 EB 64 83 C8 FF 83 FE FF 0F 84 B8 00 00 00 8B 7D 0C 8D 34 31 89 CB C7 45 E8 FF FF FF FF C7 45 EC FF FF FF FF 89 75 E4 01 FA 89 55 E0 E9 87 00 00 00 0F B7 43 10 8D 48 03 83 E1 FC 8D 34 0F 3B 75 E0 76 28 6A 00 FF 75 EC FF 75 E8 FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 3B 7D 0C 75 66 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 5B 8B 43 08 8B 53 0C 89 45 E8 89 55 EC 8B 03 8B 53 04 89 07 89 57 04 8B 43 08 8B 53 0C 66 89 4F 10 89 47 }
	condition:
		$pattern
}
...
rule td_ta_event_getmsg_3d4bb416654e57343261a0dc4c2c6a16 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 2C 8B 5D 08 A1 ?? ?? ?? ?? 85 DB 75 08 E9 74 01 00 00 8B 40 04 85 C0 0F 84 69 01 00 00 39 18 75 F1 6A 04 8D 45 F0 50 FF 73 20 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 51 01 00 00 8B 45 F0 BE 0A 00 00 00 85 C0 0F 84 46 01 00 00 6A 10 05 28 01 00 00 8D 55 DC 52 50 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 23 01 00 00 83 7D E4 00 0F 85 C4 00 00 00 89 65 CC 8B 43 0C C1 E0 04 83 C0 10 29 C4 8D 7C 24 0F 8D 45 EC 83 E7 F0 6A 04 50 FF 73 24 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 0F 85 87 00 00 00 8B 43 0C C1 E0 04 50 57 FF 73 04 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 6E 31 F6 EB }
	condition:
		$pattern
}

rule if_nameindex_abbb11545cec24930b311c2ffd9d5c63 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 2C E8 ?? ?? ?? ?? C7 45 DC 00 00 00 00 85 C0 89 45 D4 0F 88 71 01 00 00 C7 45 F0 00 00 00 00 B9 80 00 00 00 8D 75 EC 8D 1C 09 8D 43 1E 83 E0 F0 29 C4 8D 44 24 0F 83 E0 F0 8D 14 18 3B 55 F0 89 45 F0 8D 0C 0B 50 56 0F 44 D9 68 12 89 00 00 FF 75 D4 89 5D EC E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 17 83 EC 0C FF 75 D4 E8 ?? ?? ?? ?? C7 45 DC 00 00 00 00 E9 0E 01 00 00 8B 45 EC 39 D8 75 04 89 C1 EB A4 C1 E8 05 83 EC 0C 89 45 D8 8D 04 C5 08 00 00 00 31 FF 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 45 DC 0F 85 B6 00 00 00 83 EC 0C FF 75 D4 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 00 69 00 00 00 E9 }
	condition:
		$pattern
}
...
rule dlopen_42da9f00309051ae8b945bc2e604ca77 {
	meta:
		aliases = "dlopen"
		type = "func"
		size = "1133"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 4C F6 45 0C 03 C7 45 F0 00 00 00 00 75 0F C7 05 ?? ?? ?? ?? 0A 00 00 00 E9 3E 04 00 00 80 3D ?? ?? ?? ?? 00 8B 7D 04 75 1B C6 05 ?? ?? ?? ?? 01 C7 05 ?? ?? ?? ?? ?? ?? ?? ?? C7 05 ?? ?? ?? ?? ?? ?? ?? ?? 83 7D 08 00 75 0A A1 ?? ?? ?? ?? E9 09 04 00 00 E8 ?? ?? ?? ?? 8B 1D ?? ?? ?? ?? 31 F6 89 D8 EB 17 8B 08 8B 51 14 39 FA 73 0B 85 F6 74 05 39 56 14 73 02 89 CE 8B 40 10 85 C0 75 E5 89 5D F0 EB 03 89 45 F0 8B 45 F0 85 C0 89 45 C0 74 07 8B 40 10 85 C0 75 EC 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 55 0C C7 45 D0 02 00 00 00 C7 04 24 ?? ?? ?? ?? 83 E2 02 85 C0 0F 45 55 D0 }
	condition:
		$pattern
}
...
rule _Unwind_Backtrace_929a8b737dc97136c47b86fe2cc07876 {
	meta:
		...
		objfiles = "unwind_sjlj@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 1C 8D 7D F0 8B 83 ?? ?? ?? ?? 89 45 F0 EB 0D 83 FE 05 74 27 8B 45 F0 8B 00 89 45 F0 8B 45 0C 83 7D F0 01 89 3C 24 19 F6 89 44 24 04 83 E6 05 FF 55 08 85 C0 74 D9 BE 03 00 00 00 83 C4 1C 89 F0 5B 5E 5F 5D C3 }
	condition:
		$pattern
}

rule _Unwind_SjLj_RaiseException_35201296e504c71bf55919b019278cda {
	meta:
		...
		objfiles = "unwind_sjlj@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 2C 8B 75 08 8B 83 ?? ?? ?? ?? 85 C0 89 45 F0 89 45 EC 74 4C 8D 7D EC EB 07 8D 74 26 00 89 45 EC 8B 48 18 85 C9 74 30 89 7C 24 14 89 74 24 10 8B 06 8B 56 04 C7 44 24 04 01 00 00 00 C7 04 24 01 00 00 00 89 44 24 08 89 54 24 0C FF D1 83 F8 06 74 1B 83 F8 08 75 46 8B 45 EC 8B 00 85 C0 75 BD B8 05 00 00 00 83 C4 2C 5B 5E 5F 5D C3 8B 45 EC 89 FA C7 46 0C 00 00 00 00 89 46 10 8B 45 F0 89 45 EC 89 F0 E8 D4 FD FF FF 83 F8 07 75 D7 8D 45 F0 89 FA E8 65 FE FF FF 90 8D 74 26 00 83 C4 2C B8 03 00 00 00 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule __udivdi3_a8ae3aa88bd6d969f77828af692b7fb3 {
	meta:
		aliases = "__udivdi3"
		type = "func"
		size = "326"
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 20 8B 45 10 8B 55 14 C7 45 E0 00 00 00 00 8B 75 0C C7 45 E4 00 00 00 00 89 45 F4 89 C1 8B 45 08 85 D2 89 D7 89 45 EC 75 23 39 F1 0F 86 98 00 00 00 89 F2 F7 F1 89 C1 31 C0 89 45 E4 8B 55 E4 89 4D E0 8B 45 E0 83 C4 20 5E 5F 5D C3 39 F2 0F 87 B5 00 00 00 0F BD C2 83 F0 1F 89 45 E8 0F 84 96 00 00 00 B8 20 00 00 00 8B 55 F4 2B 45 E8 89 C1 D3 EA 0F B6 4D E8 89 45 F0 89 F8 8B 7D F4 D3 E0 09 C2 8B 45 EC D3 E7 0F B6 4D F0 89 55 DC 89 F2 D3 E8 0F B6 4D E8 D3 E2 0F B6 4D F0 09 D0 D3 EE 89 F2 F7 75 DC 89 D1 89 75 D8 89 45 D8 F7 E7 39 D1 89 C6 72 7D 39 CA 74 6C 8B 4D D8 31 C0 E9 76 FF }
	condition:
		$pattern
}
...
rule __umoddi3_e1e179aa42a58a02f0fe5d2eece6dfe7 {
	meta:
		aliases = "__umoddi3"
		type = "func"
		size = "408"
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 30 8B 45 10 8B 55 14 8B 75 08 8B 7D 0C 89 45 EC 89 C1 89 55 E8 8B 45 E8 C7 45 D0 00 00 00 00 C7 45 D4 00 00 00 00 89 FA 89 75 E4 85 C0 89 75 F0 89 7D E0 75 24 39 F9 0F 86 7C 00 00 00 89 F0 F7 F1 89 55 D0 8B 45 D0 C7 45 D4 00 00 00 00 8B 55 D4 83 C4 30 5E 5F 5D C3 90 8B 4D E0 39 4D E8 76 18 89 75 D0 8B 45 D0 89 7D D4 8B 55 D4 83 C4 30 5E 5F 5D C3 90 8D 74 26 00 0F BD 45 E8 83 F0 1F 89 45 D8 75 59 8B 45 E8 39 45 E0 0F 87 E1 00 00 00 8B 4D EC 39 4D E4 0F 83 D5 00 00 00 8B 4D F0 89 55 D4 8B 55 D4 89 4D D0 8B 45 D0 83 C4 30 5E 5F 5D C3 8D B6 00 00 00 00 8B 45 EC 85 C0 75 0C B8 }
	condition:
		$pattern
}
...
rule pthread_cleanup_upto_7ba5ce434c855d73c2e6aebb1d1c96f4 {
	meta:
		...
		objfiles = "ptlongjmp@libpthread.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 C7 56 89 E8 53 BE ?? ?? ?? ?? 83 EC 0C 3B 2D ?? ?? ?? ?? 73 32 3B 2D ?? ?? ?? ?? 72 0D 3B 2D ?? ?? ?? ?? BE ?? ?? ?? ?? 72 1D 83 3D ?? ?? ?? ?? 00 74 09 E8 ?? ?? ?? ?? 89 C6 EB 0B 0D FF FF 1F 00 8D B0 A1 FE FF FF 89 6D F0 8B 5E 3C EB 17 3B 5D F0 77 04 31 DB EB 17 83 EC 0C FF 73 04 FF 13 8B 5B 0C 83 C4 10 85 DB 74 05 3B 5F 10 72 E0 8B 46 54 89 5E 3C 85 C0 74 0C 3B 47 10 73 07 C7 46 54 00 00 00 00 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule _Unwind_ForcedUnwind_Phase2_f278833cf18c32a3e36078228eb82029 {
	meta:
		...
		objfiles = "unwind_sjlj@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 D7 56 53 83 EC 3C 89 45 E0 8B 40 0C 8B 55 E0 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 45 E4 8B 07 8B 52 10 89 55 E8 E9 91 00 00 00 90 8B 40 18 B9 0A 00 00 00 31 F6 89 45 EC 8B 55 E0 8B 45 E8 89 7C 24 14 89 54 24 10 89 44 24 18 8B 02 8B 52 04 89 4C 24 04 C7 04 24 01 00 00 00 89 44 24 08 89 54 24 0C FF 55 E4 85 C0 75 70 83 FE 05 74 70 8B 45 EC 85 C0 74 36 8B 4D E0 89 7C 24 14 89 4C 24 10 8B 01 8B 51 04 C7 44 24 04 0A 00 00 00 C7 04 24 01 00 00 00 89 44 24 08 89 54 24 0C FF 55 EC 83 F8 07 89 C6 74 38 83 F8 08 75 2E 8B 07 89 04 24 E8 ?? ?? ?? ?? 8B 07 8B 00 89 07 85 C0 0F 85 68 FF FF FF }
	condition:
		$pattern
}

rule _Unwind_RaiseException_Phase2_28e927c1abd77700091f2416a840425c {
	meta:
		...
		objfiles = "unwind_sjlj@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 89 D7 56 53 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 EC 2C 89 45 EC 8B 02 EB 4B 8D 76 00 85 C9 74 36 8B 45 EC 89 7C 24 14 89 44 24 10 89 C2 8B 00 8B 52 04 C7 04 24 01 00 00 00 89 44 24 08 89 F0 83 C8 02 89 54 24 0C 89 44 24 04 FF D1 83 F8 07 74 3B 83 F8 08 75 31 85 F6 8D 74 26 00 75 36 8B 07 8B 00 89 07 31 C9 85 C0 BA 05 00 00 00 74 05 8B 48 18 30 D2 8B 75 EC 3B 46 10 0F 94 C0 0F B6 F0 C1 E6 02 85 D2 74 95 B8 02 00 00 00 83 C4 2C 5B 5E 5F 5D C3 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "gthr_gnat@libgcc_eh.a, _gcov_merge_delta@libgcov.a, _enable_execute_stack@libgcc.a, _clear_cache@libgcc.a, _gcov@libgcov.a"
	strings:
...
rule _Unwind_SjLj_Resume_d827226963fb368fa16881ae713c6ba1 {
	meta:
		...
		objfiles = "unwind_sjlj@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 18 89 5D F8 8B 4D 08 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 89 75 FC 8B 51 0C 8B 83 ?? ?? ?? ?? 85 D2 89 45 F4 89 45 F0 75 16 8D 75 F0 89 C8 89 F2 E8 F7 FE FF FF 83 F8 07 74 13 E8 ?? ?? ?? ?? 8D 75 F0 89 C8 89 F2 E8 D1 FD FF FF EB E8 8D 45 F4 89 F2 E8 75 FF FF FF }
	condition:
		$pattern
}
...
rule _Unwind_SjLj_Resume_or_Rethrow_d97d38a9cf6f44ffd0e9722d3c3dea77 {
	meta:
		...
		objfiles = "unwind_sjlj@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 83 EC 28 8B 4D 08 89 5D F8 89 75 FC E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 8B 71 0C 85 F6 74 22 8B 83 ?? ?? ?? ?? 8D 75 F0 89 F2 89 45 F4 89 45 F0 89 C8 E8 67 FC FF FF 83 F8 07 74 17 E8 ?? ?? ?? ?? 89 0C 24 E8 ?? ?? ?? ?? 8B 5D F8 8B 75 FC 89 EC 5D C3 8D 45 F4 89 F2 E8 F1 FD FF FF }
	condition:
		$pattern
}
...
rule _Unwind_GetIP_d1707cedd41989a46ac746cb07cd06f7 {
	meta:
		...
		objfiles = "unwind_sjlj@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 5D 8B 00 8B 40 04 83 C0 01 C3 }
	condition:
		$pattern
}
...
rule _Unwind_SetIP_aa14e9ed64d07985e89705d79eaf918a {
	meta:
		...
		objfiles = "unwind_sjlj@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 8B 10 8B 45 0C 83 E8 01 89 42 04 5D C3 }
	condition:
		$pattern
}
...
rule _Unwind_GetIPInfo_659bda2a705dab810c22fdd692fe0522 {
	meta:
		...
		objfiles = "unwind_sjlj@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 0C C7 00 00 00 00 00 8B 45 08 5D 8B 00 8B 40 04 83 C0 01 C3 }
	condition:
		$pattern
}
...
rule __gcc_personality_sj0_f2943c01324c5b2d581fa23c2972701c {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) B8 03 00 00 00 89 E5 83 EC 38 89 5D F4 E8 ?? ?? ?? ?? 81 C3 ?? ?? ?? ?? 83 7D 08 01 89 75 F8 89 7D FC 74 0D 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 F6 45 0C 02 75 08 B8 08 00 00 00 EB E6 90 8B 45 1C C7 45 F0 00 00 00 00 89 04 24 E8 ?? ?? ?? ?? 85 C0 89 C6 74 E0 8B 45 1C 85 C0 74 0B 8B 55 1C 89 14 24 E8 ?? ?? ?? ?? 0F B6 3E 83 C6 01 89 F8 3C FF 74 7A 0F B6 D0 89 D0 83 E0 70 83 F8 20 89 55 E0 0F 84 79 01 00 00 0F 8E 23 01 00 00 83 F8 40 0F 84 7A 01 00 00 83 F8 50 8D 74 26 00 74 14 83 F8 30 0F 85 1B 01 00 00 8B 55 1C 89 14 24 E8 ?? ?? ?? ?? 89 FA 80 FA 50 0F 84 34 01 00 00 8B 45 E0 83 E0 0F 83 }
	condition:
		$pattern
}

rule _obstack_begin_1_f3aa9a4b43ef30fa3af51a9d6280f9b1 {
	meta:
		...
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 55 ) B8 04 00 00 00 57 56 53 83 EC 0C 8B 74 24 28 8B 54 24 24 8B 5C 24 20 8B 4C 24 2C 85 F6 8B 6C 24 34 0F 44 F0 85 D2 66 B8 E0 0F 89 4B 1C 0F 44 D0 8B 44 24 30 8D 7E FF 80 4B 28 01 89 13 F6 43 28 01 89 43 20 89 7B 18 89 6B 24 74 06 50 50 52 55 EB 04 83 EC 0C 52 FF D1 83 C4 10 85 C0 89 C2 89 43 04 75 05 E8 ?? ?? ?? ?? 8D 44 38 08 F7 DE 21 F0 89 43 08 89 43 0C 89 D0 03 03 89 02 89 43 10 B8 01 00 00 00 C7 42 04 00 00 00 00 80 63 28 F9 83 C4 0C 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule thread_self_ff5ff5468472ed8724cee51a9db2fab4 {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "pthread@libpthread.a, condvar@libpthread.a, spinlock@libpthread.a, mutex@libpthread.a, cancel@libpthread.a"
	strings:
...
rule _time_mktime_tzi_bc1c8a37fbc57d1b0999d335349cb753 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) B9 0B 00 00 00 57 56 53 83 EC 6C 8D 6C 24 38 8B B4 24 80 00 00 00 89 EF F3 A5 8B 94 24 88 00 00 00 31 C0 80 7A 28 00 C7 44 24 34 00 00 00 00 0F 45 44 24 58 85 C0 89 44 24 58 74 18 85 C0 0F 9F C0 0F B6 C0 8D 44 00 FF 89 44 24 58 C7 44 24 34 01 00 00 00 8D 4D 14 BF 90 01 00 00 89 4C 24 24 8D 5D 18 8B 4D 14 8D 75 1C 89 5C 24 28 89 C8 99 F7 FF 8D 55 10 89 44 24 04 89 45 18 89 54 24 2C 8B 5D 10 89 D8 89 5C 24 14 99 BB 0C 00 00 00 F7 FB 89 44 24 10 01 C1 89 45 1C 69 5C 24 04 90 01 00 00 29 D9 89 4D 14 6B 44 24 10 0C 8B 54 24 14 29 C2 85 D2 89 D0 89 55 10 79 0C 83 C0 0C 89 45 10 8B 4C 24 24 FF 09 }
	condition:
		$pattern
}
...
rule __md5_Transform_5c203a1d11b3a98fa9778b5cbed2c2e0 {
	meta:
...
rule __malloc_consolidate_3cde0957882d5746f489f7ed1ec0a406 {
	meta:
		...
		objfiles = "free@libc.a"
	strings:
		$pattern = { ( CC | 55 ) BA 01 00 00 00 57 56 53 83 EC 1C 8B 6C 24 30 8B 45 00 85 C0 0F 84 FB 00 00 00 83 E0 FD 89 45 00 C1 E8 03 8D 55 34 8D 44 85 FC 8D 5D 04 89 54 24 14 89 44 24 0C 89 5C 24 08 8B 44 24 08 8B 08 85 C9 0F 84 BA 00 00 00 C7 00 00 00 00 00 8B 51 08 89 54 24 10 8B 41 04 89 C7 83 E7 FE A8 01 8D 14 39 8B 5A 04 89 5C 24 04 75 28 8B 01 89 44 24 18 89 C8 2B 44 24 18 8B 70 08 8B 58 0C 8B 4E 0C 39 C1 75 39 39 4B 08 75 34 03 7C 24 18 89 5E 0C 89 73 08 8B 74 24 04 83 E6 FC 3B 55 2C 74 4B 8B 44 32 04 89 72 04 83 E0 01 85 C0 75 1D 8B 5A 08 8B 42 0C 39 53 0C 75 05 39 50 08 74 05 E8 ?? ?? ?? ?? 01 F7 89 43 0C 89 }
	condition:
		$pattern
}
...
rule _time_t2tm_065003450024ea3fd65f1bb9d13b241a {
	meta:
		aliases = "_time_t2tm"
		type = "func"
		size = "352"
	...
	strings:
		$pattern = { ( CC | 55 ) BD ?? ?? ?? ?? 57 56 53 83 EC 10 8B 44 24 24 8B 74 24 2C 8B 18 C7 46 1C 00 00 00 00 8B 44 24 28 05 76 0E 02 00 89 44 24 04 0F B7 4D 00 66 83 F9 07 89 4C 24 08 75 23 89 D8 99 F7 F9 B9 07 00 00 00 03 5C 24 04 8D 42 0B 99 F7 F9 89 54 24 0C 0F B7 45 02 8D 0C 85 01 00 00 00 89 D8 99 F7 F9 89 C7 0F AF C1 29 C3 79 03 01 CB 4F 66 83 7C 24 08 07 75 0D 8D 41 FF 39 C3 75 06 FF 46 10 8D 59 FE 83 F9 3C 8D 4E 04 7F 08 89 1E 89 CE 89 FB EB 04 89 3E 89 CE 83 C5 02 66 83 7D 00 00 75 8B 83 79 FC 04 75 0C C7 41 FC 03 00 00 00 BB 6D 01 00 00 01 19 BF ?? ?? ?? ?? 8D 59 F8 8B 51 FC 8B 43 F8 81 EA 2B 01 00 00 C1 }
	condition:
		$pattern
}
...
rule td_thr_clear_event_e794ee3d769dea7496da5c1b45857b3b {
	meta:
	...
	strings:
		$pattern = { ( CC | 56 ) 31 D2 53 83 EC 14 8B 5C 24 20 8B 74 24 24 8B 4B 04 85 C9 74 57 6A 08 8D 44 24 10 50 8D 81 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 34 30 D2 8B 04 96 F7 D0 21 44 94 0C 42 83 FA 01 74 F1 6A 08 8D 44 24 10 50 8B 43 04 05 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 83 C4 14 89 D0 5B 5E C3 }
	condition:
		$pattern
}
...
rule opendir_4de9bff6f5cbb8308e812fbf8480bd55 {
	meta:
		...
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 31 F6 53 83 EC 6C 68 00 08 09 00 FF 74 24 7C E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 78 55 50 50 8D 44 24 14 50 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0B 83 EC 0C 53 E8 ?? ?? ?? ?? EB 33 51 6A 01 6A 02 53 E8 ?? ?? ?? ?? 8B 54 24 4C 89 D8 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 75 17 83 EC 0C 53 E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 00 0C 00 00 00 83 C4 10 83 C4 64 89 F0 5B 5E C3 }
	condition:
		$pattern
}
...
rule remquo_43802ffa6d369d2244ed491d14a51f2c {
	meta:
...
rule td_thr_setgregs_c3bc04a0e3bcda9c9ee9c86aa8b48688 {
	meta:
		aliases = "td_thr_setfpregs, td_thr_setgregs"
		type = "func"
		size = "140"
		objfiles = "td_thr_setfpregs@libthread_db.a, td_thr_setgregs@libthread_db.a"
	strings:
		$pattern = { ( CC | 56 ) 53 81 EC 64 01 00 00 8B 9C 24 70 01 00 00 89 E6 51 68 60 01 00 00 6A 00 56 E8 ?? ?? ?? ?? 8B 43 04 83 C4 10 85 C0 74 1C 68 60 01 00 00 56 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 3C 31 D2 80 7C 24 2C 00 75 33 8B 44 24 14 85 C0 75 0F 8B 03 83 EC 0C FF 30 E8 ?? ?? ?? ?? 83 C4 10 52 FF B4 24 78 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 81 C4 64 01 00 00 89 D0 5B 5E C3 }
	condition:
		$pattern
}
...
rule ustat_7e3c4cc45c11ecb756928f37fd465c69 {
	meta:
		aliases = "ustat"
		type = "func"
		size = "52"
	...
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 8B 5C 24 10 8B 4C 24 18 89 D8 53 89 C3 B8 3E 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 5A 5B 5E C3 }
	condition:
		$pattern
}
...
rule res_sync_func_36b2bab8171d1b2f8b2dc5151e68f2ca {
	meta:
		...
		objfiles = "res_init@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 81 3D ?? ?? ?? ?? ?? ?? ?? ?? 89 C6 74 36 0F B6 40 60 39 05 ?? ?? ?? ?? 0F 46 05 ?? ?? ?? ?? 89 C3 A3 ?? ?? ?? ?? EB 19 6B C3 1C 52 6A 1C FF 74 9E 54 03 05 ?? ?? ?? ?? 50 E8 ?? ?? ?? ?? 83 C4 10 4B 79 E4 8A 46 52 A2 ?? ?? ?? ?? 8A 46 53 A2 ?? ?? ?? ?? 58 5B 5E C3 }
	condition:
		$pattern
}
...
rule sethostid_708ef6c98896ea03148d794b4f701264 {
	meta:
		aliases = "sethostid"
		type = "func"
		size = "110"
	...
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 04 E8 ?? ?? ?? ?? 85 C0 75 09 E8 ?? ?? ?? ?? 85 C0 74 12 E8 ?? ?? ?? ?? BE 01 00 00 00 C7 00 01 00 00 00 EB 3F 56 68 A4 01 00 00 6A 41 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C6 78 24 53 31 DB 6A 04 8D 44 24 18 50 56 E8 ?? ?? ?? ?? 89 34 24 83 F8 04 0F 94 C3 4B E8 ?? ?? ?? ?? 89 DE 83 C4 10 59 89 F0 5B 5E C3 }
	condition:
		$pattern
}
...
rule updwtmp_6d425062fc74a47a6e4cf937e5c5363b {
	meta:
		aliases = "updwtmp"
		type = "func"
		size = "94"
	...
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 0C 8B 74 24 1C 68 01 04 00 00 FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C3 78 3A 51 6A 00 6A 01 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 28 52 68 80 01 00 00 56 53 E8 ?? ?? ?? ?? 83 C4 0C 6A 00 6A 00 53 E8 ?? ?? ?? ?? 89 5C 24 20 83 C4 14 5B 5E E9 ?? ?? ?? ?? 58 5B 5E C3 }
	condition:
		$pattern
}
...
rule td_ta_event_addr_06f732395c2a0d5e50d6ec7d9b5a8bc3 {
	meta:
	...
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 20 8B 4C 24 24 8B 74 24 28 A1 ?? ?? ?? ?? 85 DB 75 05 EB 3E 8B 40 04 85 C0 74 37 39 18 75 F5 83 F9 09 74 16 83 F9 0C 74 30 83 F9 08 B8 0D 00 00 00 BA 08 00 00 00 74 26 EB 3E BA 09 00 00 00 EB 1D C7 06 00 00 00 00 8B 44 24 10 89 46 04 31 C0 EB 26 B8 08 00 00 00 EB 1F BA 0A 00 00 00 50 8D 44 24 14 50 52 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 CE B8 01 00 00 00 83 C4 14 5B 5E C3 }
	condition:
		$pattern
}
...
rule td_ta_set_event_36f6b16ca300902dd42adadd19ce7553 {
	meta:
	...
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 20 8B 74 24 24 A1 ?? ?? ?? ?? 85 DB 75 05 EB 54 8B 40 04 85 C0 74 4D 39 18 75 F5 6A 08 8D 44 24 10 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 31 30 D2 8B 04 96 09 44 94 0C 42 83 FA 01 74 F3 6A 08 8D 44 24 10 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 EB 05 BA 08 00 00 00 83 C4 14 89 D0 5B 5E C3 }
	condition:
		$pattern
}

rule td_ta_clear_event_bbd12bb97a1eb844428a2154dce624d9 {
	meta:
	...
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 14 8B 5C 24 20 8B 74 24 24 A1 ?? ?? ?? ?? 85 DB 75 05 EB 56 8B 40 04 85 C0 74 4F 39 18 75 F5 6A 08 8D 44 24 10 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 33 30 D2 8B 04 96 F7 D0 21 44 94 0C 42 83 FA 01 74 F1 6A 08 8D 44 24 10 50 FF 73 1C FF 33 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 EB 05 BA 08 00 00 00 83 C4 14 89 D0 5B 5E C3 }
	condition:
		$pattern
}
...
rule getnetent_82b8604e1c18559af44e3c49668accf7 {
	meta:
...
rule getutline_39deec339fc37fd5a794cdd1f2e0e42e {
	meta:
		aliases = "getutline"
		type = "func"
		size = "112"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 18 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 10 50 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 8B 74 24 20 83 C6 08 EB 1E 8B 03 83 E8 06 66 83 F8 01 77 13 50 50 56 8D 43 08 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0B E8 ?? ?? ?? ?? 85 C0 89 C3 75 D7 51 51 6A 01 8D 44 24 10 50 E8 ?? ?? ?? ?? 83 C4 24 89 D8 5B 5E C3 }
	condition:
		$pattern
}
...
rule readdir_35def38fec6b528c2568cb1f0e2dbca8 {
	meta:
...
rule erand48_r_de9910ddb55fef4b0806a2cc748dcda6 {
	meta:
...
rule if_nametoindex_51b6cfb499a7d224086d4cd3bc090b24 {
	meta:
		...
		objfiles = "if_index@libc.a"
	strings:
		$pattern = { ( CC | 56 ) 53 83 EC 24 E8 ?? ?? ?? ?? 89 C6 31 C0 85 F6 78 44 52 6A 10 FF 74 24 38 8D 5C 24 10 53 E8 ?? ?? ?? ?? 83 C4 0C 53 68 33 89 00 00 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 0D 83 EC 0C 56 E8 ?? ?? ?? ?? 31 C0 EB 0D 83 EC 0C 56 E8 ?? ?? ?? ?? 8B 44 24 24 83 C4 10 83 C4 24 5B 5E C3 }
	condition:
		$pattern
}
...
rule popen_1a5705a8f1724aaa42c998d6838c41ee {
	meta:
		aliases = "popen"
		type = "func"
		size = "506"
...
rule __pthread_timedsuspend_new_bb69a4ba5a1ef2354692fa3b6b54ba13 {
	meta:
...
rule _ppfs_setargs_ebb4ac3428e362c0c2f3d0125c468be6 {
	meta:
...
rule td_thr_set_event_aae4160ca8ff27e74fb7fe7819432423 {
	meta:
	...
	strings:
		$pattern = { ( CC | 56 ) BA 15 00 00 00 53 83 EC 14 8B 5C 24 20 8B 74 24 24 8B 4B 04 85 C9 74 55 6A 08 8D 44 24 10 50 8D 81 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 32 30 D2 8B 04 96 09 44 94 0C 42 83 FA 01 74 F3 6A 08 8D 44 24 10 50 8B 43 04 05 28 01 00 00 50 8B 03 FF 30 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 83 C4 14 89 D0 5B 5E C3 }
	condition:
		$pattern
}
...
rule __xstat_conv_8ce0de630de07720e8a14f1ad71473a8 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 31 C0 53 B9 16 00 00 00 83 EC 04 8B 5C 24 14 8B 54 24 10 89 DF F3 AB 8B 02 C7 43 04 00 00 00 00 89 03 8B 42 04 89 43 0C 0F B7 42 08 89 43 10 0F B7 42 0A 89 43 14 0F B7 42 0C 89 43 18 0F B7 42 0E 89 43 1C 0F B7 42 10 C7 43 24 00 00 00 00 89 43 20 8B 42 14 89 43 2C 8B 42 18 89 43 30 8B 42 1C 89 43 34 8B 42 24 8B 4A 20 89 43 3C 89 4B 38 8B 42 2C 8B 4A 28 89 43 44 89 4B 40 8B 42 34 8B 4A 30 89 43 4C 89 4B 48 5A 5B 5F C3 }
	condition:
		$pattern
}

rule sigqueue_e240475f85d578f6f4359dc04dfe64d3 {
	meta:
		aliases = "sigqueue"
		type = "func"
		size = "129"
	...
	strings:
		$pattern = { ( CC | 57 ) 31 C0 53 B9 20 00 00 00 81 EC 84 00 00 00 8D 5C 24 04 89 DF F3 AB 8B 84 24 94 00 00 00 C7 44 24 0C FF FF FF FF 89 44 24 04 E8 ?? ?? ?? ?? 89 44 24 10 E8 ?? ?? ?? ?? 8B BC 24 90 00 00 00 89 DA 8B 8C 24 94 00 00 00 89 44 24 14 8B 84 24 98 00 00 00 89 44 24 18 53 89 FB B8 B2 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 81 C4 84 00 00 00 5B 5F C3 }
	condition:
		$pattern
}
...
rule __xstat32_conv_45be5d33ead747e5d5bcca47c6730d4a {
	meta:
		...
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 56 B9 16 00 00 00 53 83 EC 04 8B 74 24 18 8B 5C 24 14 89 F7 F3 AB 8B 03 8B 53 04 89 06 89 56 04 8B 43 58 89 46 0C 8B 43 10 89 46 10 8B 43 14 89 46 14 8B 43 18 89 46 18 8B 43 1C 89 46 1C 0F B7 43 20 C7 46 24 00 00 00 00 89 46 20 8B 43 2C 89 46 2C 8B 43 34 89 46 30 8B 43 38 89 46 34 8B 53 40 8B 43 44 89 56 38 89 46 3C 8B 53 48 8B 43 4C 89 56 40 89 46 44 8B 53 50 8B 43 54 89 46 4C 89 56 48 59 5B 5E 5F C3 }
	condition:
		$pattern
}

rule __xstat64_conv_3c6ad87727592d12b20989a53f586d0a {
	meta:
		...
		objfiles = "xstatconv@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 C0 56 B9 18 00 00 00 53 83 EC 04 8B 74 24 18 8B 5C 24 14 89 F7 F3 AB 8B 03 8B 53 04 89 06 89 56 04 8B 43 58 8B 53 5C 89 46 58 89 56 5C 8B 43 0C 89 46 0C 8B 43 10 89 46 10 8B 43 14 89 46 14 8B 43 18 89 46 18 8B 43 1C 89 46 1C 0F B7 43 20 C7 46 24 00 00 00 00 89 46 20 8B 43 2C 8B 53 30 89 46 2C 89 56 30 8B 43 34 89 46 34 8B 43 38 C7 46 3C 00 00 00 00 89 46 38 8B 43 44 8B 53 40 89 46 44 89 56 40 8B 53 48 8B 43 4C 89 56 48 89 46 4C 8B 53 50 8B 43 54 89 56 50 89 46 54 58 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule open_d4a512a0b7f58f9bfc6bd4520ac70fe9 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 31 D2 53 83 EC 14 8B 4C 24 24 8B 7C 24 20 F6 C1 40 74 0C 8B 54 24 28 8D 44 24 2C 89 44 24 10 53 89 FB B8 05 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 14 5B 5F C3 }
	condition:
		$pattern
}
...
rule ether_aton_r_2b54919aaba7d782c2348f7d82a22cec {
	meta:
		...
		objfiles = "ether_addr@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 31 FF 56 53 83 EC 04 8B 4C 24 14 8B 74 24 18 EB 78 8A 11 80 CA 20 88 D3 80 EB 30 80 FB 09 76 08 88 D0 2C 61 3C 05 77 68 80 FA 39 88 5C 24 03 76 07 80 EA 57 88 54 24 03 8A 41 01 83 C1 02 83 FF 05 74 04 3C 3A EB 02 84 C0 74 36 88 C2 80 CA 20 88 D3 80 EB 30 80 FB 09 76 08 88 D0 2C 61 3C 05 77 2E 80 FA 39 88 D8 76 04 88 D0 2C 57 C0 64 24 03 04 00 44 24 03 83 FF 05 74 06 80 39 3A 75 10 41 8A 44 24 03 88 04 3E 47 83 FF 05 7E 83 EB 02 31 F6 5A 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule logout_5b6cacd7593f9d46f3bb636fafe50fed {
	meta:
		aliases = "logout"
		type = "func"
		size = "160"
...
rule td_thr_getgregs_6142b459b38cbea7d48112f280411e09 {
	...
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 64 01 00 00 8B 9C 24 70 01 00 00 8B BC 24 74 01 00 00 8B 53 04 8B 0B 85 D2 75 0F 83 EC 0C FF 31 E8 ?? ?? ?? ?? 83 C4 0C EB 48 68 60 01 00 00 8D 44 24 04 50 52 FF 31 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 3F 80 7C 24 2C 00 74 0B B9 11 00 00 00 F3 AB 30 D2 EB 2D 8B 44 24 14 85 C0 75 0F 8B 03 83 EC 0C FF 30 E8 ?? ?? ?? ?? 83 C4 10 52 57 50 8B 03 FF 30 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 81 C4 64 01 00 00 89 D0 5B 5F C3 }
	condition:
		$pattern
}

rule td_thr_getfpregs_484bbb310da4116363d84362646216e4 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 53 81 EC 64 01 00 00 8B 9C 24 70 01 00 00 8B BC 24 74 01 00 00 8B 53 04 8B 0B 85 D2 75 0F 83 EC 0C FF 31 E8 ?? ?? ?? ?? 83 C4 0C EB 48 68 60 01 00 00 8D 44 24 04 50 52 FF 31 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 75 3F 80 7C 24 2C 00 74 0B B9 1B 00 00 00 F3 AB 30 D2 EB 2D 8B 44 24 14 85 C0 75 0F 8B 03 83 EC 0C FF 30 E8 ?? ?? ?? ?? 83 C4 10 52 57 50 8B 03 FF 30 E8 ?? ?? ?? ?? 31 D2 83 C4 10 85 C0 0F 95 C2 81 C4 64 01 00 00 89 D0 5B 5F C3 }
	condition:
		$pattern
}
...
rule fcntl_f9446f0ba6865ef36141367a0e4d0af5 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 14 8B 4C 24 24 8D 44 24 2C 89 44 24 10 8B 7C 24 20 8B 54 24 28 8D 41 F4 83 F8 02 77 0E 50 52 51 57 E8 ?? ?? ?? ?? 83 C4 10 EB 21 53 89 FB B8 37 00 00 00 CD 80 5B 89 C3 81 FB 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DB 89 18 83 C8 FF 83 C4 14 5B 5F C3 }
	condition:
		$pattern
}

rule truncate64_2dee58e98d8fbc25b9534b261c13e8c6 {
	meta:
		aliases = "truncate64"
		type = "func"
		size = "73"
	...
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 14 8B 54 24 28 8B 7C 24 20 8B 4C 24 24 89 D0 89 44 24 08 C1 FA 1F 89 54 24 0C 8B 54 24 08 53 89 FB B8 C1 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 83 C4 14 5B 5F C3 }
	condition:
		$pattern
}

rule ftruncate64_ece3dcbfc98ec20adb9acdae65c2642a {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 14 8B 54 24 28 8B 7C 24 20 8B 4C 24 24 89 D0 89 44 24 08 C1 FA 1F 89 54 24 0C 8B 54 24 08 53 89 FB B8 C2 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 83 C4 14 5B 5F C3 }
	condition:
		$pattern
}
...
rule abort_3ecba141796a34832748c605386ba37a {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 30 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 44 24 2C 00 00 00 00 C7 44 24 30 00 00 00 00 5A 59 6A 06 8D 5C 24 28 53 E8 ?? ?? ?? ?? 83 C4 0C 6A 00 53 6A 01 E8 ?? ?? ?? ?? 83 C4 10 80 3D ?? ?? ?? ?? 00 75 2F C6 05 ?? ?? ?? ?? 01 83 EC 0C 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 04 24 06 00 00 00 E8 ?? ?? ?? ?? C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 A0 ?? ?? ?? ?? 3C 01 75 34 8D 54 24 08 31 C0 C6 05 ?? ?? ?? ?? 02 89 D7 AB AB AB AB AB C7 44 24 14 FF FF FF FF C7 44 24 18 FF FF FF FF 50 6A 00 52 6A 06 E8 ?? ?? ?? ?? 83 C4 10 EB 9B 3C 02 75 08 C6 05 ?? ?? ?? ?? 03 F4 80 3D ?? ?? ?? ?? 03 75 11 83 }
	condition:
		$pattern
}
...
rule gethostid_925ff51436156aa873a7fc89a39ca3da {
	meta:
		aliases = "gethostid"
		type = "func"
		size = "172"
		objfiles = "hostid@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 53 83 EC 7C C7 44 24 78 00 00 00 00 6A 00 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 C7 78 1F 52 6A 04 8D 44 24 78 50 57 E8 ?? ?? ?? ?? 89 3C 24 89 C3 E8 ?? ?? ?? ?? 83 C4 10 85 DB 7F 61 50 50 6A 40 8D 5C 24 17 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 4C 80 7C 24 0B 00 74 45 8D 54 24 4C 31 C0 B9 08 00 00 00 89 D7 F3 AB 8D 44 24 6C 50 52 6A 00 53 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 21 8B 54 24 6C 85 D2 74 0D 8B 42 14 8B 40 04 C1 C8 10 89 44 24 70 83 EC 0C 52 E8 ?? ?? ?? ?? 83 C4 10 8B 44 24 70 83 C4 74 5B 5F C3 }
	condition:
		$pattern
}
...
rule td_thr_get_info_4a714c31cd671a49253ac4bb4f216450 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 81 EC 60 01 00 00 8B B4 24 70 01 00 00 89 E7 8B 9C 24 74 01 00 00 8B 56 04 85 D2 75 13 B9 58 00 00 00 89 D0 F3 AB C7 44 24 10 00 04 00 00 EB 1E 8B 06 FF 70 18 57 52 FF 30 E8 ?? ?? ?? ?? 83 C4 10 BA 01 00 00 00 85 C0 0F 85 A3 00 00 00 31 C0 B9 18 00 00 00 89 DF F3 AB 83 BC 24 20 01 00 00 01 75 15 8B 06 8B 40 0C C7 43 2C 02 00 00 00 8D 44 00 01 89 43 08 EB 23 8B 44 24 10 89 43 08 8D 44 24 74 89 43 0C 8B 44 24 18 C7 43 2C 01 00 00 00 89 43 3C 80 7C 24 2C 00 75 09 C7 43 24 04 00 00 00 EB 0E 80 7C 24 2D 01 19 C0 83 E0 04 40 89 43 24 8B 44 24 14 85 C0 75 0F 8B 06 83 EC 0C FF 30 E8 ?? ?? ?? }
	condition:
		$pattern
}

rule td_ta_map_id2thr_82b83d3e6d01803150d8bcfbd866d35e {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 81 EC 70 01 00 00 8B 9C 24 80 01 00 00 8B BC 24 88 01 00 00 A1 ?? ?? ?? ?? 85 DB 75 08 E9 9A 00 00 00 8B 40 04 85 C0 0F 84 8F 00 00 00 39 18 75 F1 8B 84 24 84 01 00 00 31 D2 F7 73 0C 6A 10 8D 84 24 64 01 00 00 50 89 D0 89 D6 C1 E0 04 03 43 04 50 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 63 8B 94 24 68 01 00 00 85 D2 75 0F 85 F6 75 5B 89 1F C7 47 04 00 00 00 00 EB 55 68 60 01 00 00 8D 44 24 04 50 52 FF 33 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 30 8B 84 24 84 01 00 00 39 44 24 10 75 2A 80 7C 24 2C 00 B8 02 00 00 00 75 23 89 1F 8B 84 24 68 01 00 00 89 47 04 31 C0 EB 13 B8 08 00 00 00 EB 0C B8 01 }
	condition:
		$pattern
}
...
rule puts_bb4d4bafc773a638b5382dd31562871c {
	meta:
		aliases = "puts"
		type = "func"
		size = "125"
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 35 ?? ?? ?? ?? 8B 7E 34 85 FF 75 1F 53 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 51 51 56 FF 74 24 2C E8 ?? ?? ?? ?? 83 C4 10 83 F8 FF 89 C3 74 17 52 52 56 6A 0A E8 ?? ?? ?? ?? 8D 53 01 83 C4 10 83 CB FF 40 0F 45 DA 85 FF 75 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule readahead_2adbaa398db42cc75c20c0bef4560ab2 {
	meta:
		aliases = "readahead"
		type = "func"
		size = "79"
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 8B 54 24 28 8B 7C 24 20 8B 74 24 2C 89 D0 89 44 24 08 C1 FA 1F 89 54 24 0C 8B 4C 24 08 8B 54 24 24 53 89 FB B8 E1 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 83 C4 10 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule fflush_4e28110b1d0cd370f16604db6180bd9d {
	meta:
...
rule vfwprintf_e8ed1a3951a46d379c78f49e17198c34 {
	meta:
...
rule vfprintf_35eeb07efd8c9f51b0a996645f957f8c {
	meta:
...
rule rewind_6b688b7e90515848aa766e6b14627cbe {
	meta:
...
rule getwc_d1aff121aa302794d76ffd1091af3fc3 {
	meta:
...
rule putwc_656d0461fb753b5b2210fd391d402010 {
	meta:
		aliases = "__GI_fputs, __GI_fputws, fputs, fputwc, fputws, putwc"
		type = "func"
		size = "95"
		objfiles = "fputwc@libc.a, fputs@libc.a, fputws@libc.a"
	strings:
...
rule fgetws_820ecad09b956c21fdeef764704814fc {
	meta:
...
rule fwrite_aa1dbd4f8b6a0663fc1225e12cf74bec {
	meta:
...
rule gets_6a66314d813d20e6eb30388b5092a03e {
	meta:
		aliases = "gets"
		type = "func"
		size = "127"
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 10 A1 ?? ?? ?? ?? 8B 74 24 20 8B 78 34 85 FF 74 04 89 F3 EB 2A 83 C0 38 52 50 68 ?? ?? ?? ?? 8D 44 24 0C 50 E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C0 38 89 04 24 E8 ?? ?? ?? ?? 83 C4 10 EB D3 43 E8 ?? ?? ?? ?? 83 F8 FF 89 C2 74 0A 3C 0A 88 13 75 ED 39 DE 75 04 31 F6 EB 03 C6 03 00 85 FF 75 11 50 50 6A 01 8D 44 24 0C 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 10 89 F0 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule getspent_r_d8fe13829bbc6de00d0924445c5077f8 {
	meta:
...
rule ftello64_29e7d1f4851096d8a8a8b48b23aff4f8 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 20 8B 74 24 30 C7 44 24 18 00 00 00 00 C7 44 24 1C 00 00 00 00 8B 7E 34 85 FF 75 1F 53 8D 5E 38 53 68 ?? ?? ?? ?? 8D 44 24 14 50 E8 ?? ?? ?? ?? 89 1C 24 E8 ?? ?? ?? ?? 83 C4 10 0F B7 06 51 25 40 04 00 00 3D 40 04 00 00 0F 94 C0 0F B6 C0 40 50 8D 5C 24 20 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 10 52 52 53 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 10 C7 44 24 18 FF FF FF FF C7 44 24 1C FF FF FF FF 85 FF 75 11 50 50 6A 01 8D 44 24 14 50 E8 ?? ?? ?? ?? 83 C4 10 8B 44 24 18 8B 54 24 1C 83 C4 20 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule rint_43d14f09cd1937d3c6566890fcfbdbc4 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 38 DD 44 24 48 C7 44 24 08 00 00 00 00 DD 14 24 DD 54 24 28 8B 5C 24 2C C7 44 24 0C 00 00 00 00 8B 74 24 28 89 D8 89 DF C1 F8 14 25 FF 07 00 00 8D 88 01 FC FF FF C1 EF 1F 83 F9 13 0F 8F A3 00 00 00 85 C9 79 69 89 D8 25 FF FF FF 7F 09 F0 0F 84 E4 00 00 00 89 DA 81 E3 00 00 FE FF 81 E2 FF FF 0F 00 09 F2 89 D0 F7 D8 09 D0 C1 E8 0C 25 00 00 08 00 DD 5C 24 20 09 D8 89 44 24 24 DD 04 FD ?? ?? ?? ?? C1 E7 1F DD 44 24 20 D8 C1 DE E1 DD 54 24 18 8B 44 24 1C DD 5C 24 10 25 FF FF FF 7F 09 C7 89 7C 24 14 DD 44 24 10 E9 85 00 00 00 DD D8 BA FF FF 0F 00 D3 FA 89 D0 21 D8 09 F0 74 7B D1 EA 89 }
	condition:
		$pattern
}

rule modf_edcc9775f294073eb584659fd53033d8 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 58 DD 44 24 68 C7 44 24 48 00 00 00 00 8B 7C 24 70 DD 14 24 DD 5C 24 50 8B 5C 24 54 C7 44 24 4C 00 00 00 00 8B 74 24 50 C7 44 24 38 00 00 00 00 C7 44 24 3C 00 00 00 00 89 D8 C1 F8 14 25 FF 07 00 00 8D 88 01 FC FF FF 83 F9 13 C7 44 24 30 00 00 00 00 C7 44 24 34 00 00 00 00 C7 44 24 20 00 00 00 00 C7 44 24 24 00 00 00 00 C7 44 24 10 00 00 00 00 C7 44 24 14 00 00 00 00 C7 44 24 08 00 00 00 00 C7 44 24 0C 00 00 00 00 7F 78 85 C9 79 1D 81 E3 00 00 00 80 89 5C 24 4C C7 44 24 48 00 00 00 00 DD 44 24 48 DD 1F E9 D3 00 00 00 BA FF FF 0F 00 D3 FA 89 D0 21 D8 09 F0 75 27 DD 04 24 DD 17 DD }
	condition:
		$pattern
}
...
rule pathconf_85ef09780fe32c70f7dfacacdea38de7 {
	meta:
		aliases = "pathconf"
		type = "func"
		size = "201"
...
rule fpathconf_4717d277f7e4cf0dd2c8c1eaa10d024f {
	...
	strings:
		$pattern = { ( CC | 57 ) 56 53 83 EC 60 8B 74 24 70 8B 54 24 74 85 F6 79 10 E8 ?? ?? ?? ?? C7 00 09 00 00 00 E9 97 00 00 00 85 D2 B8 7F 00 00 00 0F 84 9B 00 00 00 8D 42 FF 83 F8 12 77 11 FF 24 85 ?? ?? ?? ?? B8 20 00 00 00 E9 82 00 00 00 E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 64 E8 ?? ?? ?? ?? 8B 38 89 C3 52 52 8D 44 24 10 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 79 09 83 3B 26 75 42 89 3B EB 37 8B 44 24 2C EB 49 31 C0 EB 45 50 50 8D 44 24 10 50 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 78 20 8B 44 24 18 25 00 F0 00 00 3D 00 80 00 00 74 1C 3D 00 60 00 00 75 09 EB 13 B8 FF 00 00 00 EB 11 83 C8 FF EB 0C B8 00 10 00 00 EB 05 B8 01 00 }
	condition:
		$pattern
}
...
rule dlsym_d25caeb70b39ae11c79e2f707bf375ea {
	meta:
		aliases = "dlsym"
		type = "func"
		size = "153"
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 54 24 10 85 D2 75 08 8B 0D ?? ?? ?? ?? EB 5A 83 FA FF 89 D1 74 28 3B 15 ?? ?? ?? ?? 74 4B A1 ?? ?? ?? ?? EB 07 39 D0 74 40 8B 40 04 85 C0 75 F5 31 D2 C7 05 ?? ?? ?? ?? 0A 00 00 00 EB 51 8B 7C 24 0C 31 F6 A1 ?? ?? ?? ?? EB 1A 8B 18 8B 53 14 39 FA 73 0E 85 F6 74 05 39 56 14 73 05 8B 48 10 89 DE 8B 40 10 85 C0 75 E2 6A 00 6A 00 51 FF 74 24 20 E8 ?? ?? ?? ?? 83 C4 10 89 C2 B8 0B 00 00 00 85 D2 0F 45 05 ?? ?? ?? ?? A3 ?? ?? ?? ?? 5B 89 D0 5E 5F C3 }
	condition:
		$pattern
}
...
rule _dl_add_elf_hash_table_164eefc1c6ee5d48fa2cd37cdf1f874b {
	meta:
		...
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) 56 53 8B 74 24 14 8B 7C 24 18 83 EC 0C 68 E8 00 00 00 E8 ?? ?? ?? ?? BA E8 00 00 00 83 C4 10 89 C3 EB 04 C6 00 00 40 4A 83 FA FF 75 F6 A1 ?? ?? ?? ?? 85 C0 75 0A 89 1D ?? ?? ?? ?? EB 0F 89 D0 8B 50 0C 85 D2 75 F7 89 58 0C 89 43 10 83 EC 0C FF 74 24 1C C7 43 0C 00 00 00 00 66 C7 43 22 00 00 E8 ?? ?? ?? ?? C7 43 18 03 00 00 00 89 43 04 8B 44 24 2C 83 C4 10 89 43 08 8B 4F 10 85 C9 74 17 8B 01 89 43 28 8B 51 04 89 53 38 8D 51 08 8D 04 82 89 53 2C 89 43 3C 89 33 31 D2 89 73 14 8B 04 97 89 44 93 40 42 83 FA 22 7E F3 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule ___path_search_d1948175e9d8abfef7f0670a79324b2c {
	meta:
...
rule confstr_7be276602e0b64e26212b565b3a2e911 {
	meta:
		aliases = "confstr"
		type = "func"
		size = "100"
	...
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 83 7C 24 10 00 8B 7C 24 14 8B 74 24 18 75 0A 85 F6 74 24 85 FF 75 11 EB 1E E8 ?? ?? ?? ?? C7 00 16 00 00 00 31 C0 EB 33 83 FE 0D 76 11 BE ?? ?? ?? ?? A5 A5 A5 66 A5 B8 0E 00 00 00 EB 1D 8D 46 FF 51 50 68 ?? ?? ?? ?? 57 E8 ?? ?? ?? ?? B8 0E 00 00 00 83 C4 10 C6 44 37 FF 00 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule timer_settime_790c55a5cc393e2c163b3f88c38405d2 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 44 24 10 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 8B 78 04 53 89 FB B8 04 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule seed48_r_8539c1fb84f55975cd921d4f6c0cbe78 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 4C 24 14 8B 54 24 10 8D 79 06 89 CE A5 66 A5 66 8B 42 04 66 89 41 04 66 8B 42 02 66 89 41 02 66 8B 02 C7 41 10 6D E6 EC DE C7 41 14 05 00 00 00 66 C7 41 0C 0B 00 66 89 01 31 C0 66 C7 41 0E 01 00 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule sigprocmask_a145d14ad4a967771610d4a3bc14fd4b {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 4C 24 14 8B 7C 24 10 8B 54 24 18 85 C9 74 12 83 FF 02 76 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 23 BE 08 00 00 00 53 89 FB B8 AF 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule timerfd_settime_e1bf172d99a27096ee655e2d60d6d1ad {
	meta:
		...
		objfiles = "timerfd@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 7C 24 10 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 53 89 FB B8 45 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5E 5E 5F C3 }
	condition:
		$pattern
}

rule wait4_fefba7e2dd9f1ee25ba33bfc376598d0 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 04 8B 7C 24 10 8B 4C 24 14 8B 54 24 18 8B 74 24 1C 53 89 FB B8 72 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule mknodat_180c71331eaf1a7365679b9d5c605c3f {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 14 8B 44 24 2C 8B 7C 24 20 8B 4C 24 24 C7 44 24 0C 00 00 00 00 8B 54 24 28 89 44 24 08 89 C6 53 89 FB B8 29 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 83 C4 14 5E 5F C3 }
	condition:
		$pattern
}
...
rule mq_open_9c25e0788e9cfe7754cafdf245b61e6b {
	meta:
		aliases = "mq_open"
		type = "func"
		size = "98"
	...
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 14 8B 7C 24 20 8B 4C 24 24 80 3F 2F 74 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 3A F6 C1 40 75 06 31 D2 31 F6 EB 10 8B 54 24 28 8D 44 24 30 8B 74 24 2C 89 44 24 10 47 53 89 FB B8 15 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 83 C4 14 5E 5F C3 }
	condition:
		$pattern
}

rule ptrace_cca9a2943702d0e7c2509f257691d229 {
	meta:
		aliases = "ptrace"
		type = "func"
		size = "108"
...
rule tmpnam_44f6c8995cffd6b027dd2936da82c0bf {
	...
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 24 8B 7C 24 30 8D 44 24 10 6A 00 6A 00 6A 14 85 FF 89 FE 0F 44 F0 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 26 50 50 6A 03 56 E8 ?? ?? ?? ?? 83 C4 10 85 C0 75 15 85 FF 75 13 BF ?? ?? ?? ?? A5 A5 A5 A5 A5 BF ?? ?? ?? ?? EB 02 31 FF 83 C4 24 89 F8 5E 5F C3 }
	condition:
		$pattern
}
...
rule statfs64_1b0a7379468e8da522ba0fc6e0b8a195 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 4C 8D 44 24 0C 8B 7C 24 5C 50 FF 74 24 5C E8 ?? ?? ?? ?? 83 C4 10 83 CA FF 85 C0 78 76 8B 44 24 04 8D 74 24 30 89 07 8B 44 24 08 89 47 04 8B 44 24 0C C7 47 0C 00 00 00 00 89 47 08 8B 44 24 10 C7 47 14 00 00 00 00 89 47 10 8B 44 24 14 C7 47 1C 00 00 00 00 89 47 18 8B 44 24 18 C7 47 24 00 00 00 00 89 47 20 8B 44 24 1C C7 47 2C 00 00 00 00 89 47 28 8B 44 24 24 89 47 34 8B 44 24 20 89 47 30 8B 44 24 28 89 47 38 83 C7 40 A5 A5 A5 A5 A5 31 D2 83 C4 44 89 D0 5E 5F C3 }
	condition:
		$pattern
}

rule fstatat64_37ca31e271d3a16a6769f3d7061a6849 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 56 83 EC 64 8B 7C 24 70 8D 54 24 04 8B 4C 24 74 8B 74 24 7C 53 89 FB B8 2C 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C6 76 0E E8 ?? ?? ?? ?? F7 DE 89 30 83 CE FF EB 16 85 C0 75 12 50 50 FF B4 24 80 00 00 00 52 E8 ?? ?? ?? ?? 83 C4 10 83 C4 64 89 F0 5E 5F C3 }
	condition:
		$pattern
}

rule __getutid_765f377678692f3622d139c3e6c60fb7 {
	meta:
		aliases = "__getutid"
		type = "func"
		size = "88"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 56 89 C6 53 8D 78 28 EB 3D 0F BF 16 8D 42 FF 66 83 F8 03 77 05 66 39 13 74 37 66 83 FA 05 74 12 66 83 FA 08 74 0C 66 83 FA 06 74 06 66 83 FA 07 75 14 50 6A 04 57 8D 43 28 50 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 0B E8 ?? ?? ?? ?? 85 C0 89 C3 75 B8 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule __encode_header_b0039b8d97dd4490d8ee4649a1ef8143 {
	meta:
...
rule mq_unlink_a0ef308cd1ca6a61411bb1189bfe7133 {
	meta:
		aliases = "mq_unlink"
		type = "func"
		size = "91"
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 44 24 10 80 38 2F 74 0D E8 ?? ?? ?? ?? C7 00 16 00 00 00 EB 3A 8D 78 01 53 89 FB B8 16 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0B E8 ?? ?? ?? ?? F7 DF 89 38 EB 04 85 C0 79 17 E8 ?? ?? ?? ?? B9 0D 00 00 00 8B 10 83 FA 01 0F 44 D1 89 10 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}

rule timer_getoverrun_265eb968fea3c25eba2970394e18ca7b {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 44 24 10 8B 78 04 53 89 FB B8 06 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}

rule timer_delete_661eb3ea9c72f49255d5b4b8c53368b1 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 54 24 10 8B 7A 04 53 89 FB B8 07 01 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0E E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF EB 15 83 C8 FF 85 FF 75 0E 83 EC 0C 52 E8 ?? ?? ?? ?? 31 C0 83 C4 10 5A 59 5F C3 }
	condition:
		$pattern
}
...
rule chdir_c1a14666a2cca3ae8fdd430cdfdbed44 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 53 89 FB B8 0C 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}
...
rule nice_f2bc419a75c12f976a7aeb014c4a0247 {
	meta:
		aliases = "nice"
		type = "func"
		size = "67"
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 53 89 FB B8 22 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0E E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF EB 15 83 C8 FF 85 FF 75 0E 57 57 6A 00 6A 00 E8 ?? ?? ?? ?? 83 C4 10 5A 59 5F C3 }
	condition:
		$pattern
}
...
rule umask_773ee7ac9b93e5280ef51d9f560377b7 {
	meta:
		aliases = "umask"
		type = "func"
		size = "48"
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 53 89 FB B8 3C 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 0F B7 C0 59 5F C3 }
	condition:
		$pattern
}

rule chroot_920dea3a71b4ebcdbf5450930c101c2b {
	meta:
		aliases = "chroot"
		type = "func"
		size = "45"
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 53 89 FB B8 3D 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}

rule inotify_init1_de8b5f0788c3740ca793558655e040ff {
	meta:
		...
		objfiles = "inotify@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 53 89 FB B8 4C 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 59 5F 5F C3 }
	condition:
		$pattern
}
...
rule getpgid_26472cbf436f885a351a17961cfad4df {
	meta:
		aliases = "getpgid"
		type = "func"
		size = "45"
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 53 89 FB B8 84 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}
...
rule getsid_0c5ec82a4193c7a319f10ce5fbcde382 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 53 89 FB B8 93 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}
...
rule sched_getscheduler_d18e0a5e560d426a798ef1856493d879 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 53 89 FB B8 9D 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}
...
rule mq_setattr_bb809841140916e07eee4e2005670bec {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 8B 4C 24 14 8B 54 24 18 53 89 FB B8 1A 01 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}
...
rule klogctl_1f695b916efa2fc4f6304489668ab781 {
	meta:
		aliases = "klogctl"
		type = "func"
		size = "53"
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 8B 4C 24 14 8B 54 24 18 53 89 FB B8 67 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}
...
rule sched_setscheduler_6832d2979a6a8bbd6c89f45811c1acbb {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 08 8B 7C 24 10 8B 4C 24 14 8B 54 24 18 53 89 FB B8 9C 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}
...
rule ioctl_0e13d7dd0a0ee2cace76b12feab01343 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 18 8D 44 24 2C 8B 7C 24 20 8B 4C 24 24 89 44 24 14 8B 54 24 28 53 89 FB B8 36 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 83 C4 18 5F C3 }
	condition:
		$pattern
}

rule fcntl64_c04dad986dc679f43963e0d77590a3f4 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 83 EC 18 8D 44 24 2C 8B 7C 24 20 8B 4C 24 24 89 44 24 14 8B 54 24 28 53 89 FB B8 DD 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 83 C4 18 5F C3 }
	condition:
		$pattern
}
...
rule __rt_sigtimedwait_4098cb2c97786b060ee7e00bea200c49 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) 89 C7 56 53 89 D3 8B 74 24 10 89 CA 89 D9 53 89 FB B8 B1 00 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule fd_to_DIR_32400db53c8fa3639c3b8188b1d89d98 {
	meta:
		aliases = "fd_to_DIR"
		type = "func"
		size = "123"
		objfiles = "opendir@libc.a"
	strings:
		$pattern = { ( CC | 57 ) 89 C7 56 89 D6 53 31 DB 83 EC 0C 6A 30 E8 ?? ?? ?? ?? 83 C4 10 85 C0 74 5B 89 38 81 FE FF 01 00 00 89 C3 C7 40 10 00 00 00 00 C7 40 08 00 00 00 00 C7 40 04 00 00 00 00 B8 00 02 00 00 0F 47 C6 89 43 14 52 52 50 6A 01 E8 ?? ?? ?? ?? 83 C4 10 85 C0 89 43 0C 75 0D 83 EC 0C 53 31 DB E8 ?? ?? ?? ?? EB 0D 50 50 6A 00 8D 43 18 50 E8 ?? ?? ?? ?? 83 C4 10 89 D8 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule _dl_protect_relro_7e5ed5688b14b1175f33e5f665e1d59f {
	meta:
		...
		objfiles = "libdl@libdl.a"
	strings:
		$pattern = { ( CC | 57 ) A1 ?? ?? ?? ?? 53 8B 5C 24 0C F7 D8 89 C7 8B 13 03 93 D4 00 00 00 89 D1 21 D7 03 8B D8 00 00 00 21 C1 39 CF 74 53 29 F9 BA 01 00 00 00 53 89 FB B8 7D 00 00 00 CD 80 5B 3D 00 F0 FF FF 76 09 F7 D8 A3 ?? ?? ?? ?? EB 04 85 C0 79 2D FF 73 04 31 FF 68 ?? ?? ?? ?? 6A 02 E8 ?? ?? ?? ?? 53 89 FB B8 01 00 00 00 CD 80 5B 83 C4 0C 3D 00 F0 FF FF 76 07 F7 D8 A3 ?? ?? ?? ?? 5B 5F C3 }
	condition:
		$pattern
}

rule _obstack_begin_b4b455e60e991e12b2ef512a30608cb8 {
	meta:
		...
		objfiles = "obstack@libc.a"
	strings:
		$pattern = { ( CC | 57 ) B8 04 00 00 00 56 53 8B 74 24 18 8B 54 24 14 8B 5C 24 10 8B 4C 24 1C 85 F6 0F 44 F0 85 D2 66 B8 E0 0F 89 4B 1C 0F 44 D0 8B 44 24 20 8D 7E FF 80 63 28 FE 89 13 F6 43 28 01 89 43 20 89 7B 18 74 08 50 50 52 FF 73 24 EB 04 83 EC 0C 52 FF D1 83 C4 10 85 C0 89 C2 89 43 04 75 05 E8 ?? ?? ?? ?? 8D 44 38 08 F7 DE 21 F0 89 43 08 89 43 0C 89 D0 03 03 89 02 89 43 10 B8 01 00 00 00 C7 42 04 00 00 00 00 80 63 28 F9 5B 5E 5F C3 }
	condition:
		$pattern
}
...
rule reboot_50e122e731ed698e80f30f60bfb8c8f2 {
	meta:
		aliases = "reboot"
		type = "func"
		size = "55"
	...
	strings:
		$pattern = { ( CC | 57 ) B9 69 19 12 28 83 EC 08 BF AD DE E1 FE 8B 54 24 10 53 89 FB B8 58 00 00 00 CD 80 5B 89 C7 81 FF 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF 5A 59 5F C3 }
	condition:
		$pattern
}

rule sched_getaffinity_279e8f0dae99d112bf9dffbd2f0596d5 {
	meta:
	...
	strings:
		$pattern = { ( CC | 57 ) B9 FF FF FF 7F 53 83 EC 04 8B 5C 24 14 8B 7C 24 10 8B 54 24 18 85 DB 0F 49 CB 53 89 FB B8 F2 00 00 00 CD 80 5B 3D 00 F0 FF FF 89 C7 76 0E E8 ?? ?? ?? ?? F7 DF 89 38 83 C8 FF EB 1F 83 C8 FF 83 FF FF 74 17 29 FB 51 53 6A 00 8B 44 24 24 01 F8 50 E8 ?? ?? ?? ?? 31 C0 83 C4 10 5A 5B 5F C3 }
	condition:
		$pattern
}

rule signalfd_d4101388be93f766fea01e9d883407fe {
	meta:
		aliases = "signalfd"
		type = "func"
		size = "59"
	...
	strings:
		$pattern = { ( CC | 57 ) BA 08 00 00 00 56 83 EC 04 8B 7C 24 10 8B 4C 24 14 8B 74 24 18 53 89 FB B8 47 01 00 00 CD 80 5B 89 C6 81 FE 00 F0 FF FF 76 0C E8 ?? ?? ?? ?? F7 DE 89 30 83 C8 FF 5A 5E 5F C3 }
	condition:
		$pattern
}
...
rule scalb_9c6e4c416ed2ab998cc8b0c2d017f4f5 {
	meta:
	...
	strings:
		$pattern = { ( CC | 83 ) EC 04 D9 7C 24 02 DD 44 24 10 66 8B 44 24 02 80 CC 0C 66 89 04 24 D9 2C 24 DB 5C 24 10 D9 6C 24 02 58 E9 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule wcstouq_94d3925005c9f6c3778188d300b054a5 {
	meta:
		...
		type = "func"
		size = "26"
		objfiles = "wcstoull@libc.a, strtoull@libc.a, wcstoul@libc.a, strtoul@libc.a, waitpid@libc.a"
	strings:
...
rule __getutent_635effb3c4f5e6e7346946aac687b9c2 {
	meta:
		aliases = "__getutent"
		type = "func"
		size = "74"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C 83 3D ?? ?? ?? ?? 00 79 10 E8 ?? ?? ?? ?? 31 D2 83 3D ?? ?? ?? ?? 00 78 28 50 68 80 01 00 00 68 ?? ?? ?? ?? FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 31 D2 83 C4 10 3D 80 01 00 00 B8 ?? ?? ?? ?? 0F 44 D0 89 D0 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule sysconf_68f2f06ae3dd701afe9fbb67639a4748 {
	meta:
	...
	strings:
		$pattern = { ( CC | 83 ) EC 0C 8B 44 24 10 3D F0 00 00 00 77 11 FF 24 85 ?? ?? ?? ?? B8 01 00 00 00 E9 29 01 00 00 E8 ?? ?? ?? ?? C7 00 16 00 00 00 E9 16 01 00 00 B8 00 00 02 00 E9 0F 01 00 00 B8 64 00 00 00 E9 05 01 00 00 B8 00 00 01 00 E9 FB 00 00 00 83 C4 0C E9 ?? ?? ?? ?? B8 06 00 00 00 E9 E9 00 00 00 83 C4 0C E9 ?? ?? ?? ?? B8 00 80 00 00 E9 D7 00 00 00 B8 E8 03 00 00 E9 CD 00 00 00 B8 00 40 00 00 E9 C3 00 00 00 B8 00 10 00 00 E9 B9 00 00 00 B8 F4 01 00 00 E9 AF 00 00 00 B8 08 00 00 00 E9 A5 00 00 00 31 C0 E9 9E 00 00 00 B8 00 00 00 80 E9 94 00 00 00 B8 7F 00 00 00 E9 8A 00 00 00 B8 80 FF FF FF E9 80 00 00 00 }
	condition:
		$pattern
}
...
rule td_ta_delete_312957b9ff5135fe520edc312336cfb7 {
	meta:
	...
	strings:
		$pattern = { ( CC | 83 ) EC 0C 8B 4C 24 10 85 C9 74 3B 8B 15 ?? ?? ?? ?? 85 D2 74 31 3B 0A 75 0C 8B 42 04 A3 ?? ?? ?? ?? EB 13 89 C2 8B 42 04 85 C0 74 1A 39 08 75 F3 8B 40 04 89 42 04 83 EC 0C 51 E8 ?? ?? ?? ?? 31 C0 83 C4 10 EB 05 B8 08 00 00 00 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule __setutent_03e19c9c1d4ba96910866c5ef553eb2a {
	meta:
		aliases = "__setutent"
		type = "func"
		size = "108"
		objfiles = "utent@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 0C A1 ?? ?? ?? ?? 85 C0 79 4E 50 50 68 02 00 08 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 A3 ?? ?? ?? ?? 79 1E 50 50 68 00 00 08 00 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 85 C0 A3 ?? ?? ?? ?? 78 20 50 6A 01 6A 02 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? EB 0B 51 6A 00 6A 00 50 E8 ?? ?? ?? ?? 83 C4 10 83 C4 0C C3 }
	condition:
		$pattern
}
...
rule td_lookup_16a234d9cfb1740679616e4b26028013 {
	meta:
		aliases = "td_lookup"
		type = "func"
		size = "36"
	...
	strings:
		$pattern = { ( CC | 83 ) EC 0C FF 74 24 18 8B 44 24 18 FF 34 85 ?? ?? ?? ?? 68 ?? ?? ?? ?? FF 74 24 1C E8 ?? ?? ?? ?? 83 C4 1C C3 }
	condition:
		$pattern
}
...
rule inet_makeaddr_bba3dcc17c3c85d9462580979fe3c7e5 {
	meta:
	...
	strings:
		$pattern = { ( CC | 83 ) EC 10 8B 54 24 18 8B 4C 24 14 8B 44 24 1C 83 FA 7F 77 0A 25 FF FF FF 00 C1 E2 18 EB 22 81 FA FF FF 00 00 77 0A 25 FF FF 00 00 C1 E2 10 EB 10 81 FA FF FF FF 00 77 08 25 FF 00 00 00 C1 E2 08 09 D0 89 44 24 0C 8B 44 24 0C 0F C8 89 01 89 C8 83 C4 10 C2 04 00 }
	condition:
		$pattern
}
...
rule __open_etc_hosts_f6bae594d50fad2977d3c6487136d107 {
	meta:
		...
		objfiles = "read_etc_hosts_r@libc.a"
	strings:
		$pattern = { ( CC | 83 ) EC 14 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 1C C3 }
	condition:
		$pattern
}
...
rule srand48_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		...
		type = "func"
		size = "21"
		objfiles = "srand48@libc.a, ether_addr@libc.a, inet_ntoa@libc.a, hsearch@libc.a, asctime@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "pthread@libpthread.a, condvar@libpthread.a, spinlock@libpthread.a, manager@libpthread.a, join@libpthread.a"
	strings:
...
rule hdestroy_07f21806b50c232838a1f6ebf5d39e92 {
	meta:
		aliases = "__GI_getlogin, __pthread_once_fork_parent, __pthread_once_fork_prepare, _flushlbf, getlogin, hdestroy"
		type = "func"
		size = "17"
		objfiles = "hsearch@libc.a, mutex@libpthread.a, getlogin@libc.a, _flushlbf@libc.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "dprintf@libc.a, asprintf@libc.a, fprintf@libc.a, sscanf@libc.a, syslog@libc.a"
	strings:
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		type = "func"
		size = "19"
		objfiles = "llrintf@libm.a, ilogbf@libm.a, lroundf@libm.a, lrintf@libm.a, llroundf@libm.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "cosf@libm.a, acoshf@libm.a, coshf@libm.a, tanhf@libm.a, acosf@libm.a"
	strings:
...
rule scalbf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "hypotf@libm.a, atan2f@libm.a, copysignf@libm.a, fmodf@libm.a, powf@libm.a"
	strings:
...
rule gethostent_d19614ca8f9dda4ade9374c934781776 {
	meta:
		aliases = "gethostent"
		type = "func"
		size = "45"
	...
	strings:
		$pattern = { ( CC | 83 ) EC 1C E8 ?? ?? ?? ?? 83 EC 0C 50 8D 44 24 28 50 68 8A 00 00 00 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 44 24 38 83 C4 3C C3 }
	condition:
		$pattern
}
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "getgrgid@libc.a, getpwuid@libc.a, getgrnam@libc.a, sgetspent@libc.a, getpwnam@libc.a"
	strings:
...
rule ctime_22e2ac5213978e500b667f435534ebce {
	meta:
	...
	strings:
		$pattern = { ( CC | 83 ) EC 44 8D 44 24 18 50 FF 74 24 4C E8 ?? ?? ?? ?? 89 04 24 E8 ?? ?? ?? ?? 83 C4 4C C3 }
	condition:
		$pattern
}
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		type = "func"
		size = "4"
		objfiles = "gthr_gnat@libgcc_eh.a, unwind_sjlj@libgcc_eh.a, _fixunsxfsi@libgcc.a, _fixunsxfdi@libgcc.a, _floatundixf@libgcc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		type = "func"
		size = "4"
		objfiles = "_powisf2@libgcc.a, _divdc3@libgcc.a, unwind_sjlj@libgcc_eh.a, _subvsi3@libgcc.a, atexits@uclibc_nonshared.a"
	strings:
...
rule sigwaitinfo_b557b5a97389e6ae9d4d5ac514ea0b90 {
	meta:
...
rule td_ta_reset_stats_f16174bde39fec0230028e098044db3b {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "td_ta_get_stats@libthread_db.a, td_ta_reset_stats@libthread_db.a, td_ta_enable_stats@libthread_db.a"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "auth_none@libc.a, _stdlib_mb_cur_max@libc.a, floatformat@libiberty.a, td_thr_tls_get_addr@libthread_db.a, xdr@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_unix@libc.a, svc_tcp@libc.a, svc_udp@libc.a, svc_raw@libc.a, svc_authux@libc.a"
	strings:
...
rule td_thr_dbsuspend_08be1c88184ee32705029d47d1b14826 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "td_thr_dbsuspend@libthread_db.a, td_thr_dbresume@libthread_db.a"
	strings:
...
rule td_symbol_list_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "__errno_location@libc.a, libc_pthread_init@libc.a, td_symbol_list@libthread_db.a, _res_state@libc.a, __h_errno_location@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C3 }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "xdr_mem@libc.a, clnt_unix@libc.a, pthread@libpthread.a, auth_unix@libc.a, auth_none@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "mntent@libc.a, pthread@libpthread.a, partition@libiberty.a, rand@libc.a, splay_tree@libiberty.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
