...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "attr@libpthread.a, __uClibc_main@libc.a, condvar@libpthread.a, mutex@libpthread.a, grantpt@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_gcov_merge_delta@libgcov.a, gthr_gnat@libgcc_eh.a, _enable_execute_stack@libgcc.a, _gcov_merge_single@libgcov.a, _gcov_merge_add@libgcov.a"
	strings:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "pthread@libpthread.a, spinlock@libpthread.a, condvar@libpthread.a, signals@libpthread.a, mutex@libpthread.a"
	strings:
...
rule futimes_fb7ed617d1ccc29447018b39f323fcfc {
	meta:
...
rule strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		...
		type = "func"
		size = "25"
		objfiles = "w_lgamma@libm.a, e_lgamma@libm.a, strtok@libc.a, w_gamma@libm.a, e_gamma@libm.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "manager@libpthread.a, pthread@libpthread.a, spinlock@libpthread.a, condvar@libpthread.a, join@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "swscanf@libc.a, fscanf@libc.a, sscanf@libc.a, dprintf@libc.a, syslog@libc.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "floorf@libm.a, acosf@libm.a, truncf@libm.a, log1pf@libm.a, tanf@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "nextafterf@libm.a, atan2f@libm.a, hypotf@libm.a, fmodf@libm.a, powf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "getspnam@libc.a, getpwnam@libc.a, getgrgid@libc.a, fgetpwent@libc.a, getgrnam@libc.a"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "xdr@libc.a, oldsemaphore@libpthread.a, auth_none@libc.a, floatformat@libiberty.a, _stdlib_mb_cur_max@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_unix@libc.a, svc_raw@libc.a, svc_authux@libc.a, svc_udp@libc.a, svc_tcp@libc.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "clnt_udp@libc.a, nsl@libnsl.a, __uClibc_main@libc.a, pthread@libpthread.a, noophooks@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_asin@libm.a, mntent@libc.a, decodep@libc.a, w_cosh@libm.a, w_hypot@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
