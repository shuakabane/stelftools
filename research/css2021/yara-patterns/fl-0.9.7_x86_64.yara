...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "svc_auth@libc.a, grantpt@libc.a, rwlock@libpthread.a, mutex@libpthread.a, xdr_stdio@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule ___path_search_925523c6d34a756e44aca309d3c717a3 {
	meta:
	...
	strings:
		$pattern = { ( CC | 41 ) 56 48 85 C9 49 89 FE 41 55 49 89 F5 41 54 49 89 CC 55 53 48 89 D3 74 1D 80 39 00 74 18 48 89 CF E8 ?? ?? ?? ?? 48 83 F8 05 48 89 C5 76 12 BD 05 00 00 00 EB 0B BD 04 00 00 00 41 BC ?? ?? ?? ?? 48 85 DB 75 3B BF ?? ?? ?? ?? BB ?? ?? ?? ?? E8 4C FD FF FF 85 C0 75 28 48 89 DE 48 89 DF E8 ?? ?? ?? ?? 85 C0 74 0C 48 89 DF E8 31 FD FF FF 85 C0 75 0D E8 ?? ?? ?? ?? C7 00 02 00 00 00 EB 32 48 89 DF E8 ?? ?? ?? ?? 48 89 C2 EB 03 48 FF CA 48 83 FA 01 76 07 80 7C 1A FF 2F 74 F0 48 8D 44 15 08 49 39 C5 73 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 83 C8 FF EB 1A 4D 89 E1 49 89 E8 48 89 D9 BE ?? ?? ?? ?? 4C 89 }
	condition:
		$pattern
}
...
rule _vfprintf_internal_f067e9949970c21db70e7e016225bcad {
	meta:
		...
		objfiles = "_vfprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 41 ) 57 41 56 41 55 41 54 49 89 D4 55 53 48 89 F3 48 81 EC E8 01 00 00 48 8D 6C 24 40 48 89 7C 24 30 48 89 EF E8 ?? ?? ?? ?? 85 C0 79 33 48 8B 5C 24 40 48 89 DF E8 ?? ?? ?? ?? 48 85 C0 48 89 C6 C7 44 24 38 FF FF FF FF 0F 84 DD 05 00 00 48 8B 54 24 30 48 89 DF E8 ?? ?? ?? ?? E9 C3 05 00 00 48 89 EF 4C 89 E6 E8 ?? ?? ?? ?? 48 8D 44 24 40 48 89 DF C7 44 24 38 00 00 00 00 48 83 C0 08 48 89 44 24 28 48 8D 84 24 40 01 00 00 48 83 C0 7F 48 89 44 24 20 48 8D 44 24 40 48 83 C0 60 48 89 44 24 18 48 8D 44 24 40 48 83 C0 70 48 89 44 24 10 EB 03 48 FF C3 8A 03 84 C0 74 04 3C 25 75 F3 48 39 FB 74 2C 48 89 DD }
	condition:
		$pattern
}

rule _vfwprintf_internal_896503ae4db8b1ddfcf7f0355fc2b767 {
	meta:
		...
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 41 ) 57 41 56 41 55 41 54 49 89 D4 BA 00 01 00 00 55 48 89 F5 31 F6 53 48 81 EC 08 03 00 00 48 8D 9C 24 40 01 00 00 48 89 7C 24 28 48 89 DF E8 ?? ?? ?? ?? 48 8D 8C 24 F0 02 00 00 48 8D B4 24 C8 02 00 00 48 83 CA FF 31 FF FF 8C 24 5C 01 00 00 48 89 AC 24 40 01 00 00 C7 84 24 54 01 00 00 80 00 00 00 C7 84 24 F0 02 00 00 00 00 00 00 48 89 AC 24 C8 02 00 00 E8 ?? ?? ?? ?? 48 FF C0 75 11 48 C7 84 24 40 01 00 00 ?? ?? ?? ?? E9 85 00 00 00 48 8D 43 2C BA 09 00 00 00 C7 00 08 00 00 00 48 83 C0 04 FF CA 75 F2 48 8D 9C 24 40 01 00 00 48 89 E8 EB 30 83 FA 25 75 27 48 83 C0 04 83 38 25 74 1E 48 89 DF 48 89 }
	condition:
		$pattern
}
...
rule realpath_af57b7a516cca4f30cf42e62d87c013f {
	meta:
		aliases = "realpath"
		type = "func"
		size = "585"
	...
	strings:
		$pattern = { ( CC | 41 ) 57 41 56 41 55 49 89 F5 41 54 55 48 89 FD 53 48 81 EC 28 10 00 00 48 85 FF 75 10 E8 ?? ?? ?? ?? C7 00 16 00 00 00 E9 05 02 00 00 80 3F 00 75 10 E8 ?? ?? ?? ?? C7 00 02 00 00 00 E9 F0 01 00 00 E8 ?? ?? ?? ?? 48 3D FD 0F 00 00 0F 87 E3 00 00 00 48 8D 9C 24 1F 10 00 00 48 89 EE 48 29 C3 48 89 DF E8 ?? ?? ?? ?? 49 8D 85 FE 0F 00 00 48 89 44 24 10 80 3B 2F 74 55 BE FF 0F 00 00 4C 89 EF E8 ?? ?? ?? ?? 48 85 C0 0F 84 A2 01 00 00 4C 89 EF E8 ?? ?? ?? ?? 49 8D 6C 05 00 80 7D FF 2F 74 07 C6 45 00 2F 48 FF C5 48 8D 44 24 20 C7 44 24 18 00 00 00 00 48 05 FF 0F 00 00 48 89 44 24 08 49 8D 45 01 48 89 04 }
	condition:
		$pattern
}
...
rule _ppfs_parsespec_b4c5bb54f4fa80e32f6af2566de685f5 {
	meta:
	...
	strings:
		$pattern = { ( CC | 41 ) 57 41 56 41 55 49 89 FD 41 54 55 53 48 83 EC 58 C7 44 24 30 00 00 00 00 C7 44 24 34 00 00 00 00 C7 44 24 40 08 00 00 00 C7 44 24 44 08 00 00 00 8B 47 1C 89 44 24 0C 44 8B 4F 14 41 81 E1 80 00 00 00 75 05 48 8B 0F EB 42 45 31 C0 49 63 D0 49 8B 4D 00 48 8D 34 95 00 00 00 00 8B 44 0E FC 88 44 14 10 40 88 C7 0F BE C0 3B 44 0E FC 0F 85 76 03 00 00 40 84 FF 74 09 41 FF C0 41 83 F8 1F 76 CB 48 8D 4C 24 11 C6 44 24 2F 00 45 31 D2 45 31 C0 83 CB FF 41 BB 00 00 00 80 EB 03 48 89 E9 80 39 2A 48 89 CD 75 13 44 89 C0 48 8D 69 01 F7 D8 48 98 C7 44 84 40 00 00 00 00 31 FF EB 16 81 FF FE 0F 00 00 7F 0B 6B }
	condition:
		$pattern
}
...
rule byte_regex_compile_b95aca048764beefb16442b45e7c3517 {
	meta:
...
rule _fp_out_wide_755eb7b0a2021f429815b9cb352439f3 {
	meta:
		...
		objfiles = "_vfwprintf_internal@libc.a"
	strings:
		$pattern = { ( CC | 41 ) 57 49 89 FF 41 56 49 89 CE 41 55 45 31 ED 41 54 49 89 F4 55 53 48 89 D3 48 81 EC 88 00 00 00 40 84 F6 79 2F 48 89 CF E8 ?? ?? ?? ?? 48 63 E8 48 29 EB 48 85 DB 7E 19 44 89 E6 48 89 DA 4C 89 FF 83 E6 7F E8 F1 F7 FF FF 48 39 D8 49 89 C5 75 30 48 89 EB 48 85 DB 7E 28 31 C9 48 63 C1 FF C1 41 0F BE 14 06 89 14 84 48 63 C1 48 39 D8 7C EB 48 89 E7 4C 89 FA 48 89 DE E8 ?? ?? ?? ?? 49 01 C5 48 81 C4 88 00 00 00 4C 89 E8 5B 5D 41 5C 41 5D 41 5E 41 5F C3 }
	condition:
		$pattern
}
...
rule thread_self_fc567cf57d3f04fc77b3c53a5a9fe529 {
	meta:
		...
		type = "func"
		size = "69"
		objfiles = "specific@libpthread.a, pthread@libpthread.a, rwlock@libpthread.a, mutex@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule syslog_4f17e5776fd93321a6b366d662782192 {
	meta:
		...
		type = "func"
		size = "142"
		objfiles = "dprintf@libc.a, fscanf@libc.a, asprintf@libc.a, fwscanf@libc.a, syslog@libc.a"
	strings:
...
rule re_compile_pattern_9991fadf11909d74588c652e7accb424 {
	meta:
		...
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 48 ) 83 EC 08 8A 42 38 48 89 D1 83 E0 E9 83 C8 80 88 42 38 48 8B 15 ?? ?? ?? ?? E8 DA D7 FF FF 31 D2 85 C0 74 11 48 98 48 8B 14 C5 ?? ?? ?? ?? 48 81 C2 ?? ?? ?? ?? 41 5B 48 89 D0 C3 }
	condition:
		$pattern
}
...
rule sgetspent_5abd21e9b7de4fda56e36ae3f07cbf5b {
	meta:
		...
		type = "func"
		size = "39"
		objfiles = "getpwnam@libc.a, getgrnam@libc.a, getgrgid@libc.a, fgetspent@libc.a, fgetgrent@libc.a"
	strings:
...
rule re_comp_1d747c20258356ab8df00f4618b8af58 {
	meta:
		aliases = "re_comp"
		type = "func"
		size = "176"
		objfiles = "regex_old@libc.a"
	strings:
		$pattern = { ( CC | 48 ) 85 FF 53 48 89 FB 75 18 48 83 3D ?? ?? ?? ?? 00 BA ?? ?? ?? ?? 0F 84 8F 00 00 00 E9 88 00 00 00 48 83 3D ?? ?? ?? ?? 00 75 41 BF C8 00 00 00 E8 ?? ?? ?? ?? 48 85 C0 48 89 05 ?? ?? ?? ?? BA ?? ?? ?? ?? 74 65 BF 00 01 00 00 48 C7 05 ?? ?? ?? ?? C8 00 00 00 E8 ?? ?? ?? ?? 48 85 C0 48 89 05 ?? ?? ?? ?? BA ?? ?? ?? ?? 74 3F 80 0D ?? ?? ?? ?? 80 48 89 DF E8 ?? ?? ?? ?? 48 8B 15 ?? ?? ?? ?? 48 89 C6 B9 ?? ?? ?? ?? 48 89 DF E8 17 D8 FF FF 85 C0 74 13 48 98 48 8B 14 C5 ?? ?? ?? ?? 48 81 C2 ?? ?? ?? ?? EB 02 31 D2 5B 48 89 D0 C3 }
	condition:
		$pattern
}
...
rule a64l_ade4f01949472c6e3b5a2b4f70ec1f05 {
	meta:
		aliases = "a64l"
		type = "func"
		size = "56"
	...
	strings:
		$pattern = { ( CC | 48 ) 8D 77 06 31 C9 31 D2 0F BE 07 83 E8 2E 83 F8 4C 77 21 89 C0 8A 80 ?? ?? ?? ?? 3C 40 74 15 0F BE C0 48 FF C7 D3 E0 48 09 C2 48 39 F7 74 05 83 C1 06 EB D4 48 89 D0 C3 }
	condition:
		$pattern
}
...
rule query_module_9628b1cd138254a6dd167e100d0799c5 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) 49 89 CA 48 63 F6 B8 B2 00 00 00 0F 05 48 89 C3 48 81 FB 00 F0 FF FF 76 0F E8 ?? ?? ?? ?? 89 DA F7 DA 89 10 48 83 C8 FF 5B C3 }
	condition:
		$pattern
}
...
rule create_module_f7dc92f703999dfdc800e05137475c76 {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) B8 AE 00 00 00 0F 05 48 89 C3 48 81 FB 00 F0 FF FF 76 0F E8 ?? ?? ?? ?? 89 DA F7 DA 89 10 48 83 C8 FF 5B C3 }
	condition:
		$pattern
}

rule get_kernel_syms_993d4be03a4a187454e11c70d824ffbf {
	meta:
	...
	strings:
		$pattern = { ( CC | 53 ) B8 B1 00 00 00 0F 05 48 89 C3 48 81 FB 00 F0 FF FF 76 0F E8 ?? ?? ?? ?? 89 DA F7 DA 89 10 48 83 C8 FF 5B C3 }
	condition:
		$pattern
}
...
rule __pthread_set_own_extricate_if_76da68e49fd047986d012f8c39b9f16a {
	meta:
		...
		type = "func"
		size = "65"
		objfiles = "condvar@libpthread.a, semaphore@libpthread.a, join@libpthread.a"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "floatformat@libiberty.a, oldsemaphore@libpthread.a, xdr@libc.a, _stdlib_mb_cur_max@libc.a, auth_none@libc.a"
	strings:
...
rule srand48_aedd30f4a92f36ce8e0b990c7b4f97a2 {
	meta:
		...
		type = "func"
		size = "10"
		objfiles = "asctime@libc.a, srand48@libc.a, hsearch@libc.a, inet_ntoa@libc.a, ether_addr@libc.a"
	strings:
		$pattern = { ( CC | BE ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule lgamma_8c47b9c6008fc75a3442b25215b4f0fe {
	meta:
		...
		type = "func"
		size = "10"
		objfiles = "e_gamma@libm.a, mutex@libpthread.a, w_lgamma@libm.a, _flushlbf@libc.a, w_gamma@libm.a"
	strings:
		$pattern = { ( CC | BF ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "clnt_udp@libc.a, pthread@libpthread.a, lckpwdf@libc.a, svc_raw@libc.a, nsl@libnsl.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_exp@libm.a, ftruncate64@libc.a, semaphore@libpthread.a, splay_tree@libiberty.a, w_log@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule truncf_76fb52706816ef3df3c8d6c20b0aa675 {
	meta:
		...
		type = "func"
		size = "19"
		objfiles = "asinf@libm.a, frexpf@libm.a, expf@libm.a, logbf@libm.a, sinhf@libm.a"
	strings:
...
rule remainderf_b655e1a82b86ef778f64370fab64b292 {
	meta:
		...
		type = "func"
		size = "23"
		objfiles = "nextafterf@libm.a, hypotf@libm.a, copysignf@libm.a, atan2f@libm.a, remainderf@libm.a"
	strings:
...
rule pex_unix_cleanup_32a093eff127b3eedaa06c147dc0694b {
	meta:
		...
		type = "func"
		size = "2"
		objfiles = "_gcov_merge_delta@libgcov.a, _gcov_merge_add@libgcov.a, hex@libiberty.a, _enable_execute_stack@libgcc.a, _clear_cache@libgcc.a"
	strings:
		$pattern = { ( CC | F3 ) C3 }
	condition:
		$pattern
