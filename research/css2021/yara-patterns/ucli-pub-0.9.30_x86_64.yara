...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "mutex@libpthread.a, auth_none@libc.a, clnt_raw@libc.a, attr@libpthread.a, svc_auth@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule wcstoumax_0b8614121f4839ecf9cde74d5b6b8c69 {
	meta:
		...
		type = "func"
		size = "7"
		objfiles = "waitpid@libc.a, wcstoul@libc.a, strtoul@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C9 E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule dl_iterate_phdr_9bbfd535ed158bde63667297cc33e144 {
	meta:
...
rule thread_self_fc567cf57d3f04fc77b3c53a5a9fe529 {
	meta:
		...
		type = "func"
		size = "69"
		objfiles = "mutex@libpthread.a, cancel@libpthread.a, condvar@libpthread.a, join@libpthread.a, signals@libpthread.a"
	strings:
...
rule syslog_4f17e5776fd93321a6b366d662782192 {
	meta:
		...
		type = "func"
		size = "142"
		objfiles = "swscanf@libc.a, fscanf@libc.a, fwscanf@libc.a, asprintf@libc.a, dprintf@libc.a"
	strings:
...
rule sgetspent_5abd21e9b7de4fda56e36ae3f07cbf5b {
	meta:
		...
		type = "func"
		size = "39"
		objfiles = "fgetspent@libc.a, getgrnam@libc.a, getpwnam@libc.a, fgetpwent@libc.a, sgetspent@libc.a"
	strings:
...
rule __pthread_set_own_extricate_if_76da68e49fd047986d012f8c39b9f16a {
	meta:
		...
		type = "func"
		size = "65"
		objfiles = "semaphore@libpthread.a, condvar@libpthread.a, join@libpthread.a"
	strings:
...
rule finite_ecf4e9cdbf36c46dfe188a91483b410c {
	meta:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_authux@libc.a, svc_unix@libc.a, svc_raw@libc.a, svc_tcp@libc.a, svc_udp@libc.a"
	strings:
...
rule lgamma_8c47b9c6008fc75a3442b25215b4f0fe {
	meta:
		aliases = "__GI_gamma, __GI_getlogin, __GI_lgamma, __ieee754_gamma, __ieee754_lgamma, __pthread_once_fork_parent, __pthread_once_fork_prepare, _flushlbf, gamma, getlogin, hdestroy, lgamma"
		type = "func"
		size = "10"
		objfiles = "mutex@libpthread.a, e_gamma@libm.a, e_lgamma@libm.a, hsearch@libc.a, getlogin@libc.a"
	strings:
		$pattern = { ( CC | BF ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "clnt_unix@libc.a, noophooks@libc.a, auth_none@libc.a, xdr_mem@libc.a, svc_raw@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "__GI_acos, __GI_acosh, __GI_asin, __GI_atan2, __GI_atanh, __GI_cabs, __GI_cosh, __GI_drem, __GI_exp, __GI_fmod, __GI_fseek, __GI_ftell, __GI_ftruncate64, __GI_hypot, __GI_j0, __GI_j1, __GI_jn, __GI_lgamma_r, __GI_log, __GI_log10, __GI_log2, __GI_lseek64, __GI_nearbyint, __GI_pow, __GI_remainder, __GI_scalb, __GI_setmntent, __GI_sinh, __GI_sqrt, __GI_y0, __GI_y1, __GI_yn, __decode_packet, __deregister_frame_info, __ieee754_gamma_r, __libc_lseek64, acos, acosh, asin, atan2, atanh, cabs, cosh, drem, exp, fmod, fseek, fseeko, ftell, ftello, ftruncate64, hypot, j0, j1, jn, lgamma_r, log, log10, log2, lseek64, mmap64, mq_close, nearbyint, pow, remainder, restart, scalb, setmntent, sinh, sqrt"
		type = "func"
		size = "5"
		objfiles = "w_cosh@libm.a, llseek@libc.a, fseeko@libc.a, ftello@libc.a, w_hypot@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule isinf_834715cbceed0e539414bad977b171ed {
	meta:
...
rule truncf_76fb52706816ef3df3c8d6c20b0aa675 {
	meta:
		aliases = "acosf, acoshf, asinf, asinhf, atanf, atanhf, cbrtf, ceilf, cosf, coshf, erfcf, erff, expf, expm1f, fabsf, floorf, frexpf, ldexpf, lgammaf, log10f, log1pf, logbf, logf, rintf, roundf, scalbnf, sinf, sinhf, sqrtf, tanf, tanhf, truncf"
		type = "func"
		size = "19"
		objfiles = "expf@libm.a, expm1f@libm.a, fabsf@libm.a, erff@libm.a, logf@libm.a"
	strings:
...
rule lroundf_d3b5b767a0285b8ef7c579a0959a22b2 {
	meta:
		...
		type = "func"
		size = "9"
		objfiles = "llroundf@libm.a, lrintf@libm.a, lroundf@libm.a, ilogbf@libm.a, llrintf@libm.a"
	strings:
...
rule remainderf_b655e1a82b86ef778f64370fab64b292 {
	meta:
		...
		type = "func"
		size = "23"
		objfiles = "powf@libm.a, remainderf@libm.a, copysignf@libm.a, atan2f@libm.a, hypotf@libm.a"
	strings:
...
rule __gnat_default_unlock_32a093eff127b3eedaa06c147dc0694b {
	meta:
		...
		type = "func"
		size = "2"
		objfiles = "_gcov_merge_add@libgcov.a, _clear_cache@libgcc.a, _gcov_merge_single@libgcov.a, gthr_gnat@libgcc.a, _gcov_merge_delta@libgcov.a"
	strings:
		$pattern = { ( CC | F3 ) C3 }
	condition:
		$pattern
