...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "attr@libpthread.a, wcsftime@libc.a, clnt_raw@libc.a, auth_none@libc.a, mutex@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule thread_self_c490e55fdc4e0d42e26befc1658d19a1 {
	meta:
		...
		type = "func"
		size = "63"
		objfiles = "specific@libpthread.a, errno@libpthread.a, signals@libpthread.a, spinlock@libpthread.a, mutex@libpthread.a"
	strings:
...
rule isnan_2e948270bc091a5709464aab0f086307 {
	meta:
		aliases = "__GI___isnan, __GI_isnan, __isnan, isnan"
		type = "func"
		size = "40"
...
rule isinf_8fae0a869cda9672f88bf94835574c14 {
	meta:
		aliases = "__GI___isinf, __GI_isinf, __isinf, isinf"
		type = "func"
		size = "43"
...
rule setvbuf_2b794f478abde40172db37237d4082b8 {
	meta:
...
rule pex_unix_cleanup_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "gthr_gnat@libgcc.a, _gcov_merge_add@libgcov.a, pex_unix@libiberty.a, hex@libiberty.a, _gcov_merge_single@libgcov.a"
	strings:
...
rule strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		aliases = "__GI_gamma, __GI_lgamma, __GI_strtok, __ieee754_gamma, __ieee754_lgamma, gamma, lgamma, strtok"
		type = "func"
		size = "25"
		objfiles = "e_gamma@libm.a, e_lgamma@libm.a, w_gamma@libm.a, strtok@libc.a, w_lgamma@libm.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "semaphore@libpthread.a, spinlock@libpthread.a, join@libpthread.a, pthread@libpthread.a, manager@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "fscanf@libc.a, syslog@libc.a, fprintf@libc.a, fwprintf@libc.a, sscanf@libc.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "acosf, acoshf, asinf, asinhf, atanf, atanhf, cbrtf, ceilf, cosf, coshf, erfcf, erff, expf, expm1f, fabsf, floorf, lgammaf, log10f, log1pf, logbf, logf, rintf, roundf, sinf, sinhf, sqrtf, tanf, tanhf, truncf"
		type = "func"
		size = "27"
		objfiles = "lgammaf@libm.a, roundf@libm.a, erfcf@libm.a, expf@libm.a, erff@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "copysignf@libm.a, fmodf@libm.a, powf@libm.a, hypotf@libm.a, remainderf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "getpwnam@libc.a, getgrnam@libc.a, getgrgid@libc.a, fgetpwent@libc.a, fgetgrent@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		type = "func"
		size = "4"
		objfiles = "gthr_gnat@libgcc.a, _fixunsxfdi@libgcc.a, _floatdixf@libgcc.a, unwind_sjlj@libgcc.a, _fixunssfsi@libgcc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		type = "func"
		size = "4"
		objfiles = "_negvsi2@libgcc.a, crti, _powidf2@libgcc.a, _mulvsi3@libgcc.a, _popcountsi2@libgcc.a"
	strings:
...
rule finite_52f0fe301eafa063e375e8223ee96caa {
	meta:
		aliases = "__GI___finite, __GI_finite, __finite, finite"
		type = "func"
		size = "20"
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "oldsemaphore@libpthread.a, auth_none@libc.a, xdr@libc.a, _stdlib_mb_cur_max@libc.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "auth_unix@libc.a, svc_raw@libc.a, noophooks@libc.a, clnt_raw@libc.a, signals@libpthread.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule __fma_394493ef54a844d9006d78ae6390ed25 {
	meta:
		aliases = "__GI___fma, __GI_fma, __fma"
		type = "func"
		size = "13"
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		aliases = "__GI_acos, __GI_acosh, __GI_asin, __GI_atan2, __GI_atanh, __GI_cabs, __GI_cosh, __GI_drem, __GI_exp, __GI_fmod, __GI_hypot, __GI_j0, __GI_j1, __GI_jn, __GI_lgamma_r, __GI_log, __GI_log10, __GI_log2, __GI_nearbyint, __GI_pow, __GI_remainder, __GI_scalb, __GI_setmntent, __GI_sinh, __GI_sqrt, __GI_xdr_enum, __GI_xdr_int, __GI_xdr_u_int, __GI_y0, __GI_y1, __GI_yn, __decode_packet, __ieee754_gamma_r, __pthread_initialize, acos, acosh, asin, atan2, atanh, cabs, cosh, drem, exp, fmod, hypot, j0, j1, jn, lgamma_r, log, log10, log2, mq_close, nearbyint, pow, rand, remainder, scalb, setmntent, sinh, sqrt, vfork, xdr_enum, xdr_int, xdr_longlong_t, xdr_u_int, xdr_u_longlong_t, y0, y1, yn"
		type = "func"
		size = "5"
		objfiles = "decodep@libc.a, w_log2@libm.a, w_lgamma_r@libm.a, w_jn@libm.a, w_hypot@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
