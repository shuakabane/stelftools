...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "grantpt@libc.a, condvar@libpthread.a, __uClibc_main@libc.a, clnt_raw@libc.a, rwlock@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule pex_unix_cleanup_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_enable_execute_stack@libgcc.a, _gcov_merge_delta@libgcov.a, _clear_cache@libgcc.a, _gcov@libgcov.a, gthr_gnat@libgcc.a"
	strings:
...
rule strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		...
		type = "func"
		size = "25"
		objfiles = "e_lgamma@libm.a, w_gamma@libm.a, w_lgamma@libm.a, e_gamma@libm.a, strtok@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "manager@libpthread.a, condvar@libpthread.a, join@libpthread.a, semaphore@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "fwprintf@libc.a, sscanf@libc.a, fprintf@libc.a, dprintf@libc.a, fscanf@libc.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "lgammaf@libm.a, rintf@libm.a, asinf@libm.a, tanf@libm.a, erff@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "remainderf@libm.a, nextafterf@libm.a, copysignf@libm.a, hypotf@libm.a, atan2f@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "fgetgrent@libc.a, sgetspent@libc.a, getpwuid@libc.a, getspnam@libc.a, fgetspent@libc.a"
	strings:
...
rule thread_self_e74c8f77ff3f89dbea0e2d9a5b4c5494 {
	meta:
		...
		type = "func"
		size = "63"
		objfiles = "errno@libpthread.a, condvar@libpthread.a, join@libpthread.a, specific@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_unix@libc.a, svc_authux@libc.a, svc_tcp@libc.a, svc_udp@libc.a, svc_raw@libc.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "clnt_udp@libc.a, nsl@libnsl.a, clnt_unix@libc.a, __uClibc_main@libc.a, resolv@libresolv.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_drem@libm.a, w_sinh@libm.a, w_pow@libm.a, mq_close@librt.a, w_remainder@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
