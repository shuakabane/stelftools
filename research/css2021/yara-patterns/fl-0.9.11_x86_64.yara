...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "rwlock@libpthread.a, auth_none@libc.a, wcsftime@libc.a, gthr_gnat@libgcc_eh.a, condvar@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule thread_self_fc567cf57d3f04fc77b3c53a5a9fe529 {
	meta:
		...
		type = "func"
		size = "69"
		objfiles = "rwlock@libpthread.a, spinlock@libpthread.a, semaphore@libpthread.a, condvar@libpthread.a, cancel@libpthread.a"
	strings:
...
rule syslog_4f17e5776fd93321a6b366d662782192 {
	meta:
		...
		type = "func"
		size = "142"
		objfiles = "fprintf@libc.a, swscanf@libc.a, syslog@libc.a, dprintf@libc.a, fwprintf@libc.a"
	strings:
...
rule sgetspent_5abd21e9b7de4fda56e36ae3f07cbf5b {
	meta:
		...
		type = "func"
		size = "39"
		objfiles = "getgrgid@libc.a, fgetgrent@libc.a, getgrnam@libc.a, sgetspent@libc.a, getpwnam@libc.a"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "auth_none@libc.a, floatformat@libiberty.a, oldsemaphore@libpthread.a, _stdlib_mb_cur_max@libc.a, xdr@libc.a"
	strings:
...
rule lgamma_8c47b9c6008fc75a3442b25215b4f0fe {
	meta:
		...
		type = "func"
		size = "10"
		objfiles = "w_lgamma@libm.a, e_gamma@libm.a, _flushlbf@libc.a, hsearch@libc.a, e_lgamma@libm.a"
	strings:
		$pattern = { ( CC | BF ) ?? ?? ?? ?? E9 ?? ?? ?? ?? }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "auth_none@libc.a, svc_raw@libc.a, clnt_tcp@libc.a, resolv@libresolv.a, noophooks@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "rwlock@libpthread.a, ftello@libc.a, semaphore@libpthread.a, w_drem@libm.a, decodep@libc.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
...
rule truncf_76fb52706816ef3df3c8d6c20b0aa675 {
	meta:
		aliases = "acosf, acoshf, asinf, asinhf, atanf, atanhf, cbrtf, ceilf, cosf, coshf, erfcf, erff, exp2f, expf, expm1f, fabsf, floorf, frexpf, ldexpf, lgammaf, log10f, log1pf, log2f, logbf, logf, rintf, roundf, scalblnf, scalbnf, sinf, sinhf, sqrtf, tanf, tanhf, tgammaf, truncf"
		type = "func"
		size = "19"
		objfiles = "roundf@libm.a, expm1f@libm.a, log10f@libm.a, expf@libm.a, sinf@libm.a"
	strings:
...
rule lroundf_d3b5b767a0285b8ef7c579a0959a22b2 {
	meta:
		...
		type = "func"
		size = "9"
		objfiles = "lroundf@libm.a, ilogbf@libm.a, llrintf@libm.a, llroundf@libm.a, lrintf@libm.a"
	strings:
...
rule remainderf_b655e1a82b86ef778f64370fab64b292 {
	meta:
		...
		type = "func"
		size = "23"
		objfiles = "fmodf@libm.a, nextafterf@libm.a, remainderf@libm.a, atan2f@libm.a, powf@libm.a"
	strings:
...
rule pex_unix_cleanup_32a093eff127b3eedaa06c147dc0694b {
	meta:
		...
		type = "func"
		size = "2"
		objfiles = "_gcov@libgcov.a, gthr_gnat@libgcc_eh.a, hex@libiberty.a, _enable_execute_stack@libgcc.a, _clear_cache@libgcc.a"
	strings:
		$pattern = { ( CC | F3 ) C3 }
	condition:
		$pattern
