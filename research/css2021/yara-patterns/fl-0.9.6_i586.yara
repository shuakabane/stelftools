...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "mutex@libpthread.a, wcsftime@libc.a, condvar@libpthread.a, xdr_stdio@libc.a, attr@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule rexec_af_9589181c2cf52c342625ef527eee4dc0 {
	meta:
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_enable_execute_stack@libgcc.a, _gcov@libgcov.a, _clear_cache@libgcc.a, gthr_gnat@libgcc.a, _gcov_merge_single@libgcov.a"
	strings:
...
rule wcstouq_94d3925005c9f6c3778188d300b054a5 {
	meta:
		...
		type = "func"
		size = "26"
		objfiles = "strtoull@libc.a, wcstoull@libc.a, waitpid@libc.a, wcstoul@libc.a, strtoul@libc.a"
	strings:
...
rule srand48_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		...
		type = "func"
		size = "21"
		objfiles = "srand48@libc.a, inet_ntoa@libc.a, asctime@libc.a, hsearch@libc.a, ether_addr@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "spinlock@libpthread.a, pthread@libpthread.a, join@libpthread.a, condvar@libpthread.a, rwlock@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "asprintf@libc.a, fwscanf@libc.a, syslog@libc.a, fwprintf@libc.a, dprintf@libc.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "asinhf@libm.a, rintf@libm.a, tgammaf@libm.a, sinf@libm.a, expf@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "remainderf@libm.a, powf@libm.a, copysignf@libm.a, hypotf@libm.a, nextafterf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "fgetspent@libc.a, fgetpwent@libc.a, getpwnam@libc.a, getpwuid@libc.a, sgetspent@libc.a"
	strings:
...
rule thread_self_e74c8f77ff3f89dbea0e2d9a5b4c5494 {
	meta:
		...
		type = "func"
		size = "63"
		objfiles = "cancel@libpthread.a, errno@libpthread.a, spinlock@libpthread.a, mutex@libpthread.a, signals@libpthread.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "nsl@libnsl.a, signals@libpthread.a, pthread@libpthread.a, clnt_unix@libc.a, noophooks@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_hypot@libm.a, xdr@libc.a, w_jn@libm.a, w_log@libm.a, w_scalb@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
