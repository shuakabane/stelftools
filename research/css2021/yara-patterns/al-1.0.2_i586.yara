...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "condvar@libpthread.a, mutex@libpthread.a, wcsftime@libc.a, auth_none@libc.a, svc_auth@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		type = "func"
		size = "8"
		objfiles = "condvar@libpthread.a, spinlock@libpthread.a, join@libpthread.a, rwlock@libpthread.a, manager@libpthread.a"
	strings:
...
rule setspent_ce98578a56224f5e1c929d87665c5432 {
	meta:
		...
		type = "func"
		size = "66"
		objfiles = "getspent_r@libc.a, getgrent_r@libc.a, getpwent_r@libc.a"
	strings:
...
rule base_of_encoded_value_4e284ab1645bd1d759d437cbb7354d00 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 3C FF 74 22 83 E0 70 83 F8 20 74 39 7E 14 83 F8 40 74 21 83 F8 50 74 0E 83 F8 30 74 39 E8 ?? ?? ?? ?? 85 C0 75 07 31 C0 8B 5D FC C9 C3 83 F8 10 75 EB EB F2 83 EC 0C 52 E8 ?? ?? ?? ?? 83 C4 10 8B 5D FC C9 C3 83 EC 0C 52 E8 ?? ?? ?? ?? 83 C4 10 8B 5D FC C9 C3 83 EC 0C 52 E8 ?? ?? ?? ?? 83 C4 10 8B 5D FC C9 C3 }
	condition:
		$pattern
}
...
rule _Unwind_SetGR_46082f5fe69c23d5071d1db6cd7edc24 {
	meta:
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 04 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 8B 45 0C 8B 55 08 83 F8 11 7F 33 8A 8C 03 ?? ?? ?? ?? F6 42 63 40 75 15 8B 04 82 80 F9 04 75 1E 8B 55 10 89 10 58 5B 5D C3 8D 74 26 00 80 7C 02 6C 00 74 E4 8B 4D 10 89 0C 82 58 5B 5D C3 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule _Unwind_FindEnclosingFunction_1511219cce2ebccf9ee5c19f9e1e8e5c {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 53 83 EC 1C E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 8D 45 F0 50 8B 45 08 48 50 E8 ?? ?? ?? ?? 83 C4 10 31 D2 85 C0 74 03 8B 55 F8 89 D0 8B 5D FC C9 C3 }
	condition:
		$pattern
}
...
rule _Unwind_GetGR_4d86051419a2bdd7a3dd28fc06d23efd {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 56 53 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 83 EC 10 8B 55 0C 8B 4D 08 83 FA 11 7F 32 8A 84 13 ?? ?? ?? ?? 8B 34 91 88 45 F7 F6 41 63 40 75 0F 80 7D F7 04 75 19 8B 06 83 C4 10 5B 5E 5D C3 89 F0 80 7C 11 6C 00 74 E8 83 C4 10 5B 5E 5D C3 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule read_uleb128_f200068803a17451bb061a46ee0fe3f8 {
	meta:
		...
		type = "func"
		size = "59"
		objfiles = "unwind_c@libgcc_eh.a, unwind_dw2@libgcc_eh.a, unwind_dw2_fde_glibc@libgcc_eh.a"
	strings:
...
rule _Unwind_ForcedUnwind_7fc0b45266286bd7819f48883d589b91 {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 52 50 81 EC 14 01 00 00 8D 85 6C FF FF FF 8B 4D 04 89 85 E8 FE FF FF 8D 55 08 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? E8 8F F7 FF FF 8D 95 EC FE FF FF 89 95 E4 FE FF FF 50 68 80 00 00 00 8B BD E8 FE FF FF 57 52 E8 ?? ?? ?? ?? 8B 55 08 8B 45 0C 83 C4 10 89 42 0C 8B 45 10 89 42 10 8B 95 E4 FE FF FF 8B 45 08 E8 20 FD FF FF 83 F8 07 74 0D 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 8B 95 E4 FE FF FF 8B 85 E8 FE FF FF E8 6D F8 FF FF 89 C1 8B 85 38 FF FF FF 89 44 0D 04 8D 4C 0D 04 8B 45 EC 8B 55 F0 8B 5D F4 8B 75 F8 8B 7D FC 8B 6D 00 89 CC C3 }
	condition:
		$pattern
}

rule _Unwind_Resume_59d747817a3e4aa27a7adace35decdda {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 52 50 81 EC 14 01 00 00 8D 85 6C FF FF FF 8D 55 08 8B 4D 04 89 85 E8 FE FF FF E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? E8 4F F8 FF FF 8D 85 EC FE FF FF 89 85 E4 FE FF FF 56 68 80 00 00 00 8B 8D E8 FE FF FF 51 50 E8 ?? ?? ?? ?? 8B 45 08 8B 50 0C 83 C4 10 85 D2 75 15 8B 95 E4 FE FF FF E8 D8 FB FF FF 83 F8 07 74 15 E8 ?? ?? ?? ?? 8B 95 E4 FE FF FF 8B 45 08 E8 D0 FD FF FF EB E6 8B 95 E4 FE FF FF 8B 85 E8 FE FF FF E8 2D F9 FF FF 89 C1 8B 85 38 FF FF FF 89 44 0D 04 8D 4C 0D 04 8B 45 EC 8B 55 F0 8B 5D F4 8B 75 F8 8B 7D FC 8B 6D 00 89 CC C3 }
	condition:
		$pattern
}

rule _Unwind_Resume_or_Rethrow_ea68a7ad26efa0d784e1947dc9a0ad3f {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 52 50 81 EC 14 01 00 00 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 8B 45 08 8B 40 0C 85 C0 74 51 8D 85 6C FF FF FF 8B 4D 04 8D 55 08 89 85 E8 FE FF FF E8 15 F9 FF FF 8D 85 EC FE FF FF 89 85 E4 FE FF FF 57 68 80 00 00 00 8B B5 E8 FE FF FF 56 50 E8 ?? ?? ?? ?? 83 C4 10 8B 95 E4 FE FF FF 8B 45 08 E8 B5 FE FF FF 83 F8 07 74 1E E8 ?? ?? ?? ?? 83 EC 0C 8B 4D 08 51 E8 ?? ?? ?? ?? 8B 5D F4 8B 75 F8 8B 7D FC 89 EC 5D C3 8B 95 E4 FE FF FF 8B 85 E8 FE FF FF E8 F1 F9 FF FF 89 C1 8B 85 38 FF FF FF 89 44 0D 04 8D 4C 0D 04 8B 45 EC 8B 55 F0 8B 5D F4 8B 75 F8 8B 7D FC 8B 6D 00 89 CC C3 }
	condition:
		$pattern
}

rule _Unwind_RaiseException_a51bb84e5a92fe111d799f2bb82c9085 {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 52 50 81 EC D4 01 00 00 8D 85 6C FF FF FF 8B 4D 04 89 85 24 FE FF FF 8D 55 08 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? E8 5F FB FF FF 8D 95 EC FE FF FF 89 95 28 FE FF FF 56 68 80 00 00 00 8B 8D 24 FE FF FF 51 52 E8 ?? ?? ?? ?? 8D 85 2C FE FF FF 83 C4 10 89 85 20 FE FF FF EB 49 85 C0 75 66 8B 85 D4 FE FF FF 85 C0 74 2A 52 52 8B BD 28 FE FF FF 57 8B 75 08 56 8B 55 08 8B 4A 04 51 8B 12 52 6A 01 6A 01 FF D0 83 C4 20 83 F8 06 74 47 83 F8 08 75 32 8B 95 20 FE FF FF 8B 85 28 FE FF FF E8 96 FD FF FF 8B 95 20 FE FF FF 8B 85 28 FE FF FF E8 45 ED FF FF 83 F8 05 75 A1 8B 5D F4 8B 75 F8 8B 7D }
	condition:
		$pattern
}
...
rule execute_stack_op_5d4c0ce8b815d768e2ff44e64308492e {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 4C 01 00 00 89 C7 8B 45 08 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 89 95 C0 FE FF FF 89 8D BC FE FF FF 89 85 E0 FE FF FF 39 D7 0F 83 09 06 00 00 8D 45 E8 C7 85 C4 FE FF FF 01 00 00 00 89 85 B8 FE FF FF 8D B6 00 00 00 00 8A 0F 47 88 CA 81 E2 FF 00 00 00 8D 41 FD 89 D6 3C 93 76 0C E8 ?? ?? ?? ?? 8D B4 26 00 00 00 00 25 FF 00 00 00 8B 84 83 ?? ?? ?? ?? 01 D8 FF E0 8B 07 83 C7 04 89 45 F0 83 BD C4 FE FF FF 3F 77 D3 8B 95 C4 FE FF FF 8B 45 F0 89 84 95 E0 FE FF FF 42 89 95 C4 FE FF FF 39 BD C0 FE FF FF 77 A0 8B 85 C4 FE FF FF 85 C0 74 AA 8B 85 C4 FE FF FF 48 8B 84 85 E0 FE FF FF }
	condition:
		$pattern
}

rule __frame_state_for_0ad7881ff5c6acb6ba4f36d033a98b07 {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC 50 01 00 00 8D 85 74 FF FF FF E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 8B 7D 0C 68 80 00 00 00 89 85 B0 FE FF FF 6A 00 50 E8 ?? ?? ?? ?? 8B 45 08 40 8D B5 B4 FE FF FF 89 45 C0 83 C4 10 89 F2 8B 85 B0 FE FF FF C7 45 D4 00 00 00 40 E8 68 FC FF FF 85 C0 74 0C 31 FF 8D 65 F4 89 F8 5B 5E 5F 5D C3 83 BD 54 FF FF FF 02 74 EB B9 01 00 00 00 EB 12 3C 02 74 1A C7 44 8F 0C 00 00 00 00 41 83 F9 13 74 16 8B 44 CE FC 88 44 39 5B 3C 01 75 E2 8B 44 CE F8 89 44 8F 0C EB E4 8B 85 48 FF FF FF 89 47 08 8B 85 4C FF FF FF 66 89 47 58 8B 85 68 FF FF FF 66 89 47 5A 8B 45 DC 89 47 0C 8B 85 70 FF FF }
	condition:
		$pattern
}
...
rule uw_update_context_1_7fd13d8e74c375782ee9b2d766460da4 {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC B0 00 00 00 89 C7 8D 85 6C FF FF FF 89 95 58 FF FF FF 89 85 54 FF FF FF 68 80 00 00 00 57 50 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 F6 45 CF 40 74 40 8D 85 7C FF FF FF 80 7D DC 00 74 34 85 C0 74 3A F6 47 63 40 74 04 C6 47 70 00 8B 95 58 FF FF FF C7 47 10 00 00 00 00 8B 82 A0 00 00 00 83 F8 01 74 42 83 F8 02 0F 84 46 02 00 00 E8 ?? ?? ?? ?? 8B 85 7C FF FF FF 85 C0 75 C6 8B 47 48 80 BB ?? ?? ?? ?? 04 75 E5 89 45 F0 F6 45 CF 40 74 04 C6 45 DC 00 B8 04 00 00 00 8D 55 F0 89 94 85 6C FF FF FF EB 9C 8B 85 58 FF FF FF 8B 90 98 00 00 00 83 FA 11 7F B6 8A 84 }
	condition:
		$pattern
}
...
rule _Unwind_RaiseException_Phase2_be083ff648460dc4ecc07eabdf34c15e {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC CC 00 00 00 89 D7 89 85 30 FF FF FF 8D 85 34 FF FF FF E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 89 85 2C FF FF FF EB 3E 89 F6 8B 55 DC 85 D2 74 24 50 50 57 51 89 C8 8B 49 04 51 8B 00 50 89 F0 83 C8 02 50 6A 01 FF D2 83 C4 20 83 F8 07 74 46 83 F8 08 75 3C 85 F6 75 45 8B 95 2C FF FF FF 89 F8 E8 84 FE FF FF 8B 95 2C FF FF FF 89 F8 E8 37 EE FF FF 8B 8D 30 FF FF FF 8B 57 4C 3B 51 10 0F 94 C2 81 E2 FF 00 00 00 89 D6 C1 E6 02 85 C0 74 99 B8 02 00 00 00 8D 65 F4 5B 5E 5F 5D C3 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}
...
rule uw_init_context_1_db28b3fd2a8150da7727986a66d7330c {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 81 EC E0 00 00 00 89 C7 8B 75 04 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 68 80 00 00 00 89 95 20 FF FF FF 6A 00 89 8D 1C FF FF FF 50 E8 ?? ?? ?? ?? 89 77 4C 8D B5 30 FF FF FF 83 C4 10 C7 47 60 00 00 00 40 89 F2 89 F8 E8 1E F2 FF FF 85 C0 0F 85 DB 00 00 00 80 BB ?? ?? ?? ?? 00 74 5D 80 BB ?? ?? ?? ?? 04 0F 85 C5 00 00 00 8B 85 20 FF FF FF F6 47 63 40 89 45 F0 74 04 C6 47 70 00 B8 04 00 00 00 8D 55 F0 C7 45 D0 01 00 00 00 C7 45 C8 04 00 00 00 89 14 87 89 F8 89 F2 C7 45 C4 00 00 00 00 E8 24 FC FF FF 8B 85 1C FF FF FF 89 47 4C 8D 65 F4 5B 5E 5F 5D C3 8D 76 00 C6 83 ?? ?? ?? ?? 04 C6 }
	condition:
		$pattern
}
...
rule read_encoded_value_with_base_9fd55686f3c54e0d8ca9c79b06b3b727 {
	meta:
		aliases = "read_encoded_value_with_base"
		type = "func"
		size = "213"
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 1C E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 89 55 DC 89 CE 89 C7 3C 50 74 52 25 FF 00 00 00 89 45 E0 83 E0 0F 83 F8 0C 76 05 E8 ?? ?? ?? ?? 8B 84 83 ?? ?? ?? ?? 01 D8 FF E0 8B 11 8D 41 04 85 D2 74 1C 8B 4D E0 83 E1 70 89 4D E0 83 7D E0 10 74 78 8B 4D DC 01 CA 89 F9 84 C9 79 02 8B 12 8B 4D 08 89 11 83 C4 1C 5B 5E 5F 5D C3 8D 41 03 8B 4D 08 83 E0 FC 8B 10 83 C0 04 89 11 83 C4 1C 5B 5E 5F 5D C3 8B 11 8D 41 08 EB B4 8D 55 F0 89 C8 E8 A5 FD FF FF 8B 55 F0 EB A5 0F BF 11 8D 41 02 EB 9D 66 8B 01 89 C2 8D 41 02 81 E2 FF FF 00 00 EB 8D 8D 55 F0 89 C8 E8 3E FD FF FF 8B 55 F0 E9 7B FF }
	condition:
		$pattern
}
...
rule execute_cfa_program_56f33ecfe2151c6a25aecd93b6d75908 {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 2C 89 C7 8B 45 08 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 89 55 D8 89 4D D4 C7 80 90 00 00 00 00 00 00 00 39 D7 0F 83 8E 00 00 00 8B B0 A4 00 00 00 8B 41 60 C1 E8 1F 8B 51 4C 01 D0 39 F0 76 79 8D 55 F0 C7 45 E0 00 00 00 00 89 55 D0 8A 0F 31 C0 88 C8 47 89 C2 81 E2 C0 00 00 00 83 FA 40 74 1A 81 FA 80 00 00 00 74 78 81 FA C0 00 00 00 74 5B 80 F9 2F 76 4B E8 ?? ?? ?? ?? 8B 4D 08 83 E0 3F 8B 91 B0 00 00 00 0F AF C2 8D 04 06 89 81 A4 00 00 00 8D B6 00 00 00 00 39 7D D8 76 1B 8B 45 08 8B 55 D4 8B B0 A4 00 00 00 8B 42 60 C1 E8 1F 8B 4A 4C 01 C8 39 C6 72 94 8D 65 F4 5B 5E 5F 5D C3 }
	condition:
		$pattern
}
...
rule uw_install_context_1_80ae462d8d304022dde84a8b46eb7b4f {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 2C E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 89 45 E0 89 55 D4 F6 42 63 40 74 0A 80 7A 70 00 0F 85 F7 00 00 00 8B 55 D4 8B 42 10 85 C0 0F 84 F8 00 00 00 8D 83 ?? ?? ?? ?? BE 01 00 00 00 89 45 DC EB 2E 8D B4 26 00 00 00 00 84 C0 74 1D 85 C9 74 19 39 D1 74 15 8B 7D DC 31 C0 8A 44 3E FF 57 50 51 52 E8 ?? ?? ?? ?? 83 C4 10 46 83 FE 12 74 44 8B 4D E0 8B 7D D4 8B 45 E0 8B 54 B1 FC 8B 4C B7 FC 80 7C 06 6B 00 0F 85 99 00 00 00 8B 7D D4 85 D2 0F 95 C0 80 7C 3E 6B 00 74 AE 84 C0 74 CB 8B 45 DC 80 7C 06 FF 04 75 7C 46 89 4D EC 83 FE 12 89 0A 75 BC 8B 45 E0 F6 40 63 40 75 14 8B 4D E0 31 }
	condition:
		$pattern
}

rule read_encoded_value_with_base_b2909fdc57e6f383fc61f28beb48da60 {
	meta:
		aliases = "read_encoded_value_with_base"
		type = "func"
		size = "363"
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 2C E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 89 55 D0 89 CE 88 45 D7 3C 50 0F 84 7D 00 00 00 89 4D DC 8A 4D D7 81 E1 FF 00 00 00 89 C8 89 4D D8 83 E0 0F 83 F8 0C 76 05 E8 ?? ?? ?? ?? 8B 84 83 ?? ?? ?? ?? 01 D8 FF E0 89 F6 8B 06 83 C6 04 89 45 CC 8B 45 CC 85 C0 74 31 8B 45 D8 83 E0 70 89 45 D8 83 7D D8 10 0F 84 EE 00 00 00 8B 7D CC 8B 45 D0 01 C7 89 7D CC 80 7D D7 00 79 0D 8B 55 CC 8B 12 89 55 CC 90 8D 74 26 00 8B 4D 08 8B 45 CC 89 01 83 C4 2C 89 F0 5B 5E 5F 5D C3 8D 41 03 83 E0 FC 8B 10 8D 70 04 89 55 CC EB DE 8B 16 83 C6 08 89 55 CC EB 9C C7 45 CC 00 00 00 00 C7 45 E0 00 00 }
	condition:
		$pattern
}
...
rule uw_frame_state_for_2dc3c0b40fd90ec8556438c5457df528 {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 53 83 EC 40 E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 89 55 C4 89 45 C8 68 C0 00 00 00 6A 00 52 E8 ?? ?? ?? ?? 8B 45 C8 83 C4 10 8B 50 4C C7 40 68 00 00 00 00 C7 40 50 00 00 00 00 85 D2 0F 84 E4 02 00 00 83 C0 54 8B 4D C8 57 57 50 8B 41 60 C1 E8 1F 8D 44 02 FF 50 E8 ?? ?? ?? ?? 83 C4 10 89 45 D0 85 C0 0F 84 BD 02 00 00 8B 55 C8 8B 4D C4 83 EC 0C 8B 42 5C 8B 55 D0 89 81 A4 00 00 00 8B 45 D0 8B 52 04 83 C0 04 29 D0 89 C7 89 45 D4 83 C7 09 57 E8 ?? ?? ?? ?? 8B 4D D4 83 C4 10 8D 14 38 80 79 09 65 8D 42 01 0F 84 F1 01 00 00 8B 55 C4 81 C2 B0 00 00 00 E8 60 F6 FF FF 8B 55 C4 81 C2 AC 00 00 }
	condition:
		$pattern
}
...
rule _Unwind_Backtrace_b1d1b23017ec724fa1c27ea9838242b7 {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 81 EC 50 01 00 00 8D 85 78 FF FF FF 8B 4D 04 8D 55 08 89 85 AC FE FF FF E8 BE FC FF FF 8D 85 B8 FE FF FF 89 85 B0 FE FF FF 89 F6 8B 95 B0 FE FF FF 8B 85 AC FE FF FF E8 0F EF FF FF 89 85 B4 FE FF FF 85 C0 74 1C 83 F8 05 74 17 C7 85 B4 FE FF FF 03 00 00 00 8B 85 B4 FE FF FF 8D 65 F8 5E 5F 5D C3 50 50 8B 45 0C 50 8B 85 AC FE FF FF 50 FF 55 08 83 C4 10 85 C0 75 D2 83 BD B4 FE FF FF 05 74 D3 8B 95 B0 FE FF FF 8B 85 AC FE FF FF E8 F8 FE FF FF EB 96 }
	condition:
		$pattern
}
...
rule __udivdi3_5729d42d3c9adec155304be658c41822 {
	meta:
		aliases = "__udivdi3"
		type = "func"
		size = "323"
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 20 C7 45 E0 00 00 00 00 8B 45 10 8B 55 14 89 45 F4 89 C1 8B 45 08 C7 45 E4 00 00 00 00 89 D7 89 45 EC 8B 75 0C 85 D2 75 23 39 F1 0F 86 98 00 00 00 89 F2 F7 F1 89 C1 31 C0 89 4D E0 89 45 E4 8B 45 E0 8B 55 E4 83 C4 20 5E 5F 5D C3 39 F2 0F 87 B5 00 00 00 0F BD C2 83 F0 1F 89 45 E8 0F 84 96 00 00 00 8B 55 E8 B8 20 00 00 00 29 D0 8B 55 F4 89 45 F0 89 F8 8A 4D F0 8B 7D F4 D3 EA 8A 4D E8 D3 E0 09 C2 8B 45 EC D3 E7 8A 4D F0 89 55 DC D3 E8 89 F2 8A 4D E8 D3 E2 8A 4D F0 09 D0 D3 EE 89 F2 89 75 D8 F7 75 DC 89 D1 89 45 D8 F7 E7 89 C6 39 D1 72 7D 39 CA 74 6D 8B 4D D8 31 C0 E9 77 FF FF }
	condition:
		$pattern
}
...
rule __umoddi3_d3040cd523081cbc12eb0b2992410b28 {
	meta:
		aliases = "__umoddi3"
		type = "func"
		size = "365"
	...
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 83 EC 30 C7 45 D0 00 00 00 00 8B 55 14 8B 45 10 89 55 E8 8B 75 08 8B 7D 0C 89 45 EC 89 C1 8B 45 E8 C7 45 D4 00 00 00 00 89 75 E4 89 75 F0 89 7D E0 89 FA 85 C0 75 14 39 F9 76 60 89 F0 F7 F1 89 55 D0 C7 45 D4 00 00 00 00 EB 10 8B 4D E0 39 4D E8 76 18 89 75 D0 89 7D D4 89 F6 8B 45 D0 8B 55 D4 83 C4 30 5E 5F 5D C3 8D 76 00 0F BD 45 E8 83 F0 1F 89 45 D8 75 46 8B 45 E8 39 45 E0 0F 87 C6 00 00 00 8B 4D EC 39 4D E4 0F 83 BA 00 00 00 8B 4D F0 89 55 D4 89 4D D0 EB C1 90 8B 75 EC 85 F6 75 0C B8 01 00 00 00 31 D2 F7 75 EC 89 C1 8B 45 E0 8B 55 E8 F7 F1 8B 45 E4 F7 F1 EB 82 8B 55 D8 B8 20 00 }
	condition:
		$pattern
}

rule __udivmoddi4_637fda265dfd4c234467aeae1db89f7d {
	meta:
...
rule uw_update_context_43ff3b653970166a693df3a166c9ed06 {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 89 D6 53 89 C7 83 EC 0C E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? E8 02 FA FF FF 8B 86 B4 00 00 00 83 F8 11 7F 3B 8A 94 03 ?? ?? ?? ?? 8B 0C 87 88 55 F3 F6 47 63 40 75 14 80 7D F3 04 75 22 8B 11 89 57 4C 83 C4 0C 5B 5E 5F 5D C3 90 89 CA 80 7C 38 6C 00 74 E3 89 57 4C 83 C4 0C 5B 5E 5F 5D C3 E8 ?? ?? ?? ?? }
	condition:
		$pattern
}

rule _Unwind_ForcedUnwind_Phase2_e069b5720982e62f2cc6719eaf250ae9 {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 57 56 89 D7 81 EC D0 00 00 00 89 85 2C FF FF FF 8B 95 2C FF FF FF 8B 40 0C 89 85 30 FF FF FF 8D 85 38 FF FF FF 8B 52 10 89 85 28 FF FF FF 89 95 34 FF FF FF 8B 95 28 FF FF FF 89 F8 E8 5C EC FF FF 89 C6 B8 0A 00 00 00 85 F6 74 15 83 FE 05 74 0E BE 02 00 00 00 8D 65 F8 89 F0 5E 5F 5D C3 B0 1A 8B 8D 34 FF FF FF 52 8B 95 2C FF FF FF 51 57 52 8B 95 2C FF FF FF 8B 4A 04 51 8B 0A 51 50 6A 01 FF 95 30 FF FF FF 83 C4 20 85 C0 75 C3 83 FE 05 74 C3 8B 45 E0 85 C0 74 2C 8B B5 2C FF FF FF 52 52 8B 95 2C FF FF FF 57 56 8B 4A 04 51 8B 12 52 6A 0A 6A 01 FF D0 83 C4 20 89 C6 83 F8 07 74 95 83 F8 08 75 }
	condition:
		$pattern
}
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_enable_execute_stack@libgcc.a, _clear_cache@libgcc.a, _gcov_merge_delta@libgcov.a, _gcov_merge_add@libgcov.a, _gcov@libgcov.a"
	strings:
...
rule _Unwind_SetIP_249a552095cf7f1e845329572dedad14 {
	meta:
		...
		objfiles = "unwind_dw2@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) 89 E5 8B 45 08 8B 55 0C 89 50 4C 5D C3 }
	condition:
		$pattern
}
...
rule __gcc_personality_v0_ecf41697f5bcd818d87eaa049ef2335b {
	meta:
		...
		objfiles = "unwind_c@libgcc_eh.a"
	strings:
		$pattern = { ( CC | 55 ) B8 03 00 00 00 89 E5 57 56 53 83 EC 3C E8 00 00 00 00 5B 81 C3 ?? ?? ?? ?? 83 7D 08 01 74 08 8D 65 F4 5B 5E 5F 5D C3 F6 45 0C 02 75 0D 8D 65 F4 B8 08 00 00 00 5B 5E 5F 5D C3 83 EC 0C C7 45 F0 00 00 00 00 8B 4D 1C 51 E8 ?? ?? ?? ?? 83 C4 10 89 C6 85 C0 74 D7 8B 55 1C 31 C0 85 D2 74 0F 83 EC 0C 8B 7D 1C 57 E8 ?? ?? ?? ?? 83 C4 10 89 45 C8 8D 7E 01 8A 16 80 FA FF 0F 84 64 01 00 00 81 E2 FF 00 00 00 89 D6 8B 55 1C 89 F0 E8 EE FE FF FF 83 EC 0C 8D 55 CC 89 F9 52 89 C2 89 F0 E8 6C FD FF FF 83 C4 10 89 C7 8A 07 8D 4F 01 88 45 DC FE C0 0F 84 19 01 00 00 8D 45 E0 89 45 BC 89 C2 89 C8 E8 08 FD FF FF }
	condition:
		$pattern
}
...
rule thread_self_4d574e5856a30bb564cca31edbbe6aeb {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "specific@libpthread.a, errno@libpthread.a, condvar@libpthread.a, mutex@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule inet_ntoa_e214931d143cca1a32199edb31adc4a0 {
	meta:
		...
		type = "func"
		size = "17"
		objfiles = "ether_addr@libc.a, inet_ntoa@libc.a, hsearch@libc.a, asctime@libc.a"
	strings:
...
rule sigpause_0b2bdff5f5301a6617caee89402ffe9b {
	meta:
		...
		type = "func"
		size = "14"
		objfiles = "sigpause@libc.a, mkstemp@libc.a"
	strings:
...
rule wcstouq_a324739ecc8f201fcb11afb9bebf3b72 {
	meta:
		...
		type = "func"
		size = "23"
		objfiles = "waitpid@libc.a, wcstoul@libc.a, strtoull@libc.a, wcstoull@libc.a, strtoul@libc.a"
	strings:
...
rule sgetspent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		...
		type = "func"
		size = "38"
		objfiles = "getgrnam@libc.a, sgetspent@libc.a, fgetpwent@libc.a, getpwnam@libc.a, getgrgid@libc.a"
	strings:
...
rule syslog_3674412569e427ab0f649983548971e5 {
	meta:
		...
		type = "func"
		size = "28"
		objfiles = "fwscanf@libc.a, swscanf@libc.a, sscanf@libc.a, syslog@libc.a, fprintf@libc.a"
	strings:
...
rule truncf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "expm1f@libm.a, significandf@libm.a, acoshf@libm.a, expf@libm.a, lgammaf@libm.a"
	strings:
...
rule scalbf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "powf@libm.a, scalbf@libm.a, remainderf@libm.a, fmodf@libm.a, atan2f@libm.a"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "auth_none@libc.a, xdr@libc.a, oldsemaphore@libpthread.a, _stdlib_mb_cur_max@libc.a, floatformat@libiberty.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_unix@libc.a, svc_tcp@libc.a, svc_udp@libc.a, svc_authux@libc.a, svc_raw@libc.a"
	strings:
...
rule __res_state_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "libc_pthread_init@libc.a, __h_errno_location@libc.a, __errno_location@libc.a, _res_state@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C3 }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "auth_unix@libc.a, lckpwdf@libc.a, nsl@libnsl.a, noophooks@libc.a, clnt_udp@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "partition@libiberty.a, mntent@libc.a, ptfork@libpthread.a, w_cabs@libm.a, splay_tree@libiberty.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
