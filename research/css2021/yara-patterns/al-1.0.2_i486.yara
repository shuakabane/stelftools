...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "condvar@libpthread.a, wcsftime@libc.a, mutex@libpthread.a, auth_none@libc.a, svc_auth@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		type = "func"
		size = "8"
		objfiles = "manager@libpthread.a, condvar@libpthread.a, join@libpthread.a, semaphore@libpthread.a, pthread@libpthread.a"
	strings:
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "gthr_gnat@libgcc_eh.a, _gcov_merge_add@libgcov.a, _clear_cache@libgcc.a, _enable_execute_stack@libgcc.a, _gcov@libgcov.a"
	strings:
...
rule thread_self_dd5dae98b7dbe953d0d7e291f00b93db {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "condvar@libpthread.a, mutex@libpthread.a, cancel@libpthread.a, signals@libpthread.a, join@libpthread.a"
	strings:
...
rule inet_ntoa_e214931d143cca1a32199edb31adc4a0 {
	meta:
		...
		type = "func"
		size = "17"
		objfiles = "ether_addr@libc.a, hsearch@libc.a, inet_ntoa@libc.a, asctime@libc.a"
	strings:
...
rule sgetspent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		...
		type = "func"
		size = "38"
		objfiles = "fgetpwent@libc.a, getgrgid@libc.a, getpwnam@libc.a, fgetspent@libc.a, sgetspent@libc.a"
	strings:
...
rule syslog_3674412569e427ab0f649983548971e5 {
	meta:
		...
		type = "func"
		size = "28"
		objfiles = "fscanf@libc.a, fprintf@libc.a, syslog@libc.a, fwscanf@libc.a, dprintf@libc.a"
	strings:
...
rule truncf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "logbf@libm.a, sqrtf@libm.a, sinhf@libm.a, erfcf@libm.a, rintf@libm.a"
	strings:
...
rule scalbf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "scalbf@libm.a, fmodf@libm.a, copysignf@libm.a, atan2f@libm.a, powf@libm.a"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "auth_none@libc.a, oldsemaphore@libpthread.a, floatformat@libiberty.a, xdr@libc.a, _stdlib_mb_cur_max@libc.a"
	strings:
...
rule svcudp_stat_cca2f00a582595d7f5454d6d2948b3e3 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "svc_authux@libc.a, svc_udp@libc.a, svc_tcp@libc.a, svc_raw@libc.a, svc_unix@libc.a"
	strings:
...
rule __res_state_6df29da601a97e2ce0e822cd8a3c1c72 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "_res_state@libc.a, __errno_location@libc.a, libc_pthread_init@libc.a, __h_errno_location@libc.a"
	strings:
		$pattern = { ( CC | B8 ) ?? ?? ?? ?? C3 }
	condition:
		$pattern
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "nsl@libnsl.a, clnt_unix@libc.a, xdr_mem@libc.a, auth_none@libc.a, signals@libpthread.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_cabs@libm.a, splay_tree@libiberty.a, partition@libiberty.a, ptfork@libpthread.a, mntent@libc.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
