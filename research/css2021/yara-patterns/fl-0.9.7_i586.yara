...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "rwlock@libpthread.a, clnt_raw@libc.a, svc_auth@libc.a, condvar@libpthread.a, grantpt@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_gcov@libgcov.a, _enable_execute_stack@libgcc.a, _gcov_merge_delta@libgcov.a, _gcov_merge_single@libgcov.a, _clear_cache@libgcc.a"
	strings:
...
rule thread_self_c6b931fc4ef01e41c64141913807b5c6 {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "pthread@libpthread.a, rwlock@libpthread.a, spinlock@libpthread.a, semaphore@libpthread.a, condvar@libpthread.a"
	strings:
...
rule getwc_47b2021f9ad3c9dae34d9b79ccbd71b9 {
	meta:
...
rule wcstouq_94d3925005c9f6c3778188d300b054a5 {
	meta:
		...
		type = "func"
		size = "26"
		objfiles = "wcstoull@libc.a, strtoull@libc.a, waitpid@libc.a, strtoul@libc.a, wcstoul@libc.a"
	strings:
...
rule strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		...
		type = "func"
		size = "25"
		objfiles = "strtok@libc.a, e_lgamma@libm.a, w_gamma@libm.a, e_gamma@libm.a, w_lgamma@libm.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "syslog@libc.a, fwscanf@libc.a, sscanf@libc.a, swscanf@libc.a, fscanf@libc.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "atanf@libm.a, acoshf@libm.a, fabsf@libm.a, acosf@libm.a, coshf@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "nextafterf@libm.a, hypotf@libm.a, powf@libm.a, remainderf@libm.a, copysignf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "getpwnam@libc.a, getgrnam@libc.a, fgetpwent@libc.a, getgrgid@libc.a, fgetspent@libc.a"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "oldsemaphore@libpthread.a, xdr@libc.a, _stdlib_mb_cur_max@libc.a, auth_none@libc.a, floatformat@libiberty.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "pthread@libpthread.a, clnt_udp@libc.a, clnt_raw@libc.a, resolv@libresolv.a, auth_unix@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_hypot@libm.a, rand@libc.a, ptfork@libpthread.a, e_gamma_r@libm.a, w_atan2@libm.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
