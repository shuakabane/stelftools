...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "rwlock@libpthread.a, wcsftime@libc.a, auth_none@libc.a, grantpt@libc.a, mutex@libpthread.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_gcov@libgcov.a, _gcov_merge_single@libgcov.a, gthr_gnat@libgcc_eh.a, _enable_execute_stack@libgcc.a, _clear_cache@libgcc.a"
	strings:
...
rule thread_self_8edc8dc4e86c2e49d2a4a127f12d8902 {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "rwlock@libpthread.a, errno@libpthread.a, cancel@libpthread.a, specific@libpthread.a, spinlock@libpthread.a"
	strings:
...
rule strtok_6ef4550f4268b481d14e1b0dbb3bef41 {
	meta:
		...
		type = "func"
		size = "25"
		objfiles = "e_gamma@libm.a, e_lgamma@libm.a, w_gamma@libm.a, w_lgamma@libm.a, strtok@libc.a"
	strings:
...
rule scalbnf_312f3131b70190222fba14e3c3defea1 {
	meta:
		...
		type = "func"
		size = "34"
		objfiles = "scalblnf@libm.a, scalbnf@libm.a, ldexpf@libm.a, frexpf@libm.a"
	strings:
...
rule srand48_dec9bb6027f4362fd7a2fa48e394d09b {
	meta:
		...
		type = "func"
		size = "21"
		objfiles = "srand48@libc.a, inet_ntoa@libc.a, ether_addr@libc.a, hsearch@libc.a, asctime@libc.a"
	strings:
...
rule suspend_ecd6961fe1548a07e4419cf5eac61cc2 {
	meta:
		...
		type = "func"
		size = "13"
		objfiles = "rwlock@libpthread.a, semaphore@libpthread.a, spinlock@libpthread.a, join@libpthread.a, manager@libpthread.a"
	strings:
...
rule syslog_b8d2de1a3389a9ac7063fcf8ecd732a9 {
	meta:
		...
		type = "func"
		size = "30"
		objfiles = "syslog@libc.a, sscanf@libc.a, fprintf@libc.a, fscanf@libc.a, dprintf@libc.a"
	strings:
...
rule lroundf_ae59cb3ea4cc505a336a4a795ec11feb {
	meta:
		...
		type = "func"
		size = "19"
		objfiles = "llroundf@libm.a, ilogbf@libm.a, lroundf@libm.a, llrintf@libm.a, lrintf@libm.a"
	strings:
...
rule truncf_a4ed7d1ef71bac89a28737c2f33b4283 {
	meta:
		aliases = "acosf, acoshf, asinf, asinhf, atanf, atanhf, cbrtf, ceilf, cosf, coshf, erfcf, erff, exp2f, expf, expm1f, fabsf, floorf, lgammaf, log10f, log1pf, log2f, logbf, logf, rintf, roundf, sinf, sinhf, sqrtf, tanf, tanhf, tgammaf, truncf"
		type = "func"
		size = "27"
		objfiles = "log10f@libm.a, fabsf@libm.a, cosf@libm.a, logf@libm.a, expm1f@libm.a"
	strings:
...
rule remainderf_1e2978707d238f6fac2f7eea075fd954 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "remainderf@libm.a, powf@libm.a, hypotf@libm.a, atan2f@libm.a, nextafterf@libm.a"
	strings:
...
rule sgetspent_a7773e5d3145ef4863b1ee448a617097 {
	meta:
		...
		type = "func"
		size = "40"
		objfiles = "getspnam@libc.a, getpwuid@libc.a, fgetspent@libc.a, getgrgid@libc.a, getpwnam@libc.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_cx_32cbe704334585a576f9e5324faf3633 {
	meta:
		...
		type = "func"
		size = "4"
		objfiles = "_floatdixf@libgcc.a, _fixunsxfsi@libgcc.a, _floatundixf@libgcc.a, _floatdidf@libgcc.a, gthr_gnat@libgcc_eh.a"
	strings:
...
rule __i686_DOT_get_pc_thunk_DOT_bx_37f86caa53dde6570f57a89c5dd1662f {
	meta:
		...
		type = "func"
		size = "4"
		objfiles = "_fixdfdi@libgcc.a, _negvsi2@libgcc.a, crtn, _negvdi2@libgcc.a, gthr_gnat@libgcc_eh.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "resolv@libresolv.a, xdr_mem@libc.a, clnt_unix@libc.a, auth_none@libc.a, auth_unix@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule yn_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "s_nearbyint@libm.a, w_sqrt@libm.a, w_hypot@libm.a, w_cosh@libm.a, ptfork@libpthread.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
