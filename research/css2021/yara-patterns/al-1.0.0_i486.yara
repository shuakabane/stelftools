...
rule xdrstdio_inline_95da5d637ce2b37c162272462d63ab78 {
	meta:
		...
		type = "func"
		size = "3"
		objfiles = "mutex@libpthread.a, condvar@libpthread.a, __uClibc_main@libc.a, grantpt@libc.a, xdr_stdio@libc.a"
	strings:
		$pattern = { ( CC | 31 ) C0 C3 }
	condition:
		$pattern
...
rule suspend_7e7c6eb2f9410c7059cbbed1cb6911cf {
	meta:
		...
		type = "func"
		size = "8"
		objfiles = "condvar@libpthread.a, manager@libpthread.a, rwlock@libpthread.a, spinlock@libpthread.a, semaphore@libpthread.a"
	strings:
...
rule __gnat_default_unlock_939a034664c2b3234964a30decbd1f50 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "_gcov_merge_single@libgcov.a, _enable_execute_stack@libgcc.a, _gcov@libgcov.a, _clear_cache@libgcc.a, _gcov_merge_add@libgcov.a"
	strings:
...
rule thread_self_dd5dae98b7dbe953d0d7e291f00b93db {
	meta:
		...
		type = "func"
		size = "68"
		objfiles = "mutex@libpthread.a, condvar@libpthread.a, specific@libpthread.a, signals@libpthread.a, errno@libpthread.a"
	strings:
...
rule sgetspent_55f8a496d4b651e19d576b899468cf9d {
	meta:
		...
		type = "func"
		size = "38"
		objfiles = "getpwnam@libc.a, getpwuid@libc.a, getgrnam@libc.a, sgetspent@libc.a, fgetgrent@libc.a"
	strings:
...
rule syslog_3674412569e427ab0f649983548971e5 {
	meta:
		...
		type = "func"
		size = "28"
		objfiles = "fwscanf@libc.a, fwprintf@libc.a, fprintf@libc.a, sscanf@libc.a, syslog@libc.a"
	strings:
...
rule truncf_237deda38afdc1ba6e02b05f725d180f {
	meta:
		...
		type = "func"
		size = "27"
		objfiles = "fabsf@libm.a, roundf@libm.a, exp2f@libm.a, log2f@libm.a, sinf@libm.a"
	strings:
...
rule scalbf_d4f7c0b3360f99708eca867df6e90175 {
	meta:
		...
		type = "func"
		size = "35"
		objfiles = "atan2f@libm.a, copysignf@libm.a, remainderf@libm.a, fmodf@libm.a, hypotf@libm.a"
	strings:
...
rule xdr_void_62dea3be98d084788202ec199cbcebf6 {
	meta:
		...
		type = "func"
		size = "6"
		objfiles = "_stdlib_mb_cur_max@libc.a, floatformat@libiberty.a, xdr@libc.a, auth_none@libc.a, oldsemaphore@libpthread.a"
	strings:
...
rule xdrmem_destroy_2b6be1eb3c8d07c259f5da1535d26263 {
	meta:
		...
		type = "func"
		size = "1"
		objfiles = "xdr_mem@libc.a, signals@libpthread.a, clnt_tcp@libc.a, __uClibc_main@libc.a, auth_unix@libc.a"
	strings:
		$pattern = { ( CC | C3 ) }
	condition:
		$pattern
...
rule lroundf_f5f2daa96b9e124cf33f93c469bdf2db {
	meta:
		...
		type = "func"
		size = "18"
		objfiles = "lroundf@libm.a, lrintf@libm.a, ilogbf@libm.a"
	strings:
...
rule xdr_u_longlong_t_22aa66de8a720f160758a4fe68aab955 {
	meta:
		...
		type = "func"
		size = "5"
		objfiles = "w_cabs@libm.a, ptfork@libpthread.a, rand@libc.a, xdr@libc.a, splay_tree@libiberty.a"
	strings:
		$pattern = { ( CC | E9 ) ?? ?? ?? ?? }
	condition:
		$pattern
